...
Telegram - https://t.me/LearnBlockEntry
Twitter - https://twitter.com/LEARNBLOCK_ERC
Website - https://www.learnblock.fun/
...
contract LearnBlock is ERC20, Ownable {
    ...
    constructor() ERC20("LearnBlock", "LEARNBLOCK") {
		...
		developmentWallet = address(0x30e64BA39d423E99b9761be6522E45De79cB39B2); // set as development wallet
        marketingWallet = address(0xC45293be01E51BCCdD42F6B99cB87c602a5353a3); // set as marketing wallet
        devWallet = address(0xB27D9D35d7E10Ef07949bf370Fad03F2271a0ef1); // set as dev wallet
