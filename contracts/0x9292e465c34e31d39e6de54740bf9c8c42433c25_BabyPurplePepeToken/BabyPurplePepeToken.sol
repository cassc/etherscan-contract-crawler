...
// Telegram : https://t.me/BabyPupeErcPortal
// Twitter: https://twitter.com/BabyPupeERC
...
contract BabyPurplePepeToken is ERC20, Ownr {
    ...
    string public constant name = "Baby Purple Pepe";
    string public constant symbol = "BabyPUPE";
    ...
    mapping (address => bool) public isFeeExmp;
    mapping (address => bool) public isWalletLimitExmp;
    ...
    constructor () Ownr(msg.sender) {
        ...
        marktingWallet = 0xEa3205FdAe9C74f14fEb9A98E520FfaA6d8d76EE;
        WETH = router.WETH();

        pair = IDEXFeesy(router.factory()).createPair(WETH, address(this));
        _allowances[address(this)][address(router)] = type(uint256).max;

        isFeeExmp[msg.sender] = true;

        isWalletLimitExmp[msg.sender] = true;
        isWalletLimitExmp[address(this)] = true;
        isWalletLimitExmp[DEAD] = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!isWalletLimitExmp[sender] && !isWalletLimitExmp[recipient] && recipient != pair) {
        ...
        uint256 amountReceived = (isFeeExmp[sender] || isFeeExmp[recipient]) ? amount : takeFee(sender, amount, recipient);
