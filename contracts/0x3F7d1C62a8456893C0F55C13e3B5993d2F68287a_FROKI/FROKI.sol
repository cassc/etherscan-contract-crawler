...
contract FROKI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FROKI", "FROKI") {
        ...
        marketingWallet = address(0x41bFB95B141F09E398c84d07F067E855076c46c1); // set as marketing wallet
        devWallet = address(0x8f7F9aF884A52847d2624aC2b8BC40f70Fe307b9); // set as dev wallet
