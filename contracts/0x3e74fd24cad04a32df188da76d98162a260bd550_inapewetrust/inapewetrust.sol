...
/*TELEGRAM  https://t.me/inapewetrusterc
*/
...
contract inapewetrust is Context, IERC20, Ownable {
    ...
    string private constant _name = "@inapewetrusterc";
    string private constant _symbol = "$awt";
