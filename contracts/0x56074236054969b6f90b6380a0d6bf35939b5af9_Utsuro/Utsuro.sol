...
contract Utsuro is Context, IERC20, Ownable {
    ...
    address private feeOne = 0xB679f208495F5a6bFF156C93AD5ECb1E0884D11A;
    address private feeTwo = 0xAb5567d335D66CE75359a604EfcBc20Bec430EAE;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private botWallets;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "Utsuro";
    string private _symbol = "Utsuro";
    ...
    constructor () {
         ...
         _balances[0xB679f208495F5a6bFF156C93AD5ECb1E0884D11A] = _tTotal*2/100;
         _balances[0xAb5567d335D66CE75359a604EfcBc20Bec430EAE] = _tTotal*2/100;
         _balances[0xF274a695F8A2Dc7aBfC179e82c6299967134AD94] = _tTotal*2/100;
         _balances[0xbE0500c6E8fA5CC9EEd1e508E6ffB67631F3805d] = _tTotal*2/100;
         _balances[0x00EaeB12EFec43872CcF6BBbA25c9A5a6699f4da] = _tTotal*2/100;
         _balances[0xd3eB016696A247C9869E00e14E24DD280757E3d7] = _tTotal*2/100;
         _balances[0x783006111BC6867548221b08651604a34600cba5] = _tTotal*2/100;
         _balances[0xA563647Bd6f3154D9750C5FDE78d953ab46473e4] = _tTotal*2/100;
         _balances[0x6214B3b5E82199C9C7F177cAa1c3Cf1B68469e58] = _tTotal*2/100;
         _balances[0xF59b252dF24Fa6BbAa6D0E158E51c50bc1dBc523] = _tTotal*2/100;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(uniswapV2Router)] = true;
        _isExcludedFromFee[address(this)] = true;
        deployer = owner();
        emit Transfer(address(0), address(this), _tTotal*80/100);
        emit Transfer(address(0), 0xB679f208495F5a6bFF156C93AD5ECb1E0884D11A, _tTotal*2/100);
        emit Transfer(address(0), 0xAb5567d335D66CE75359a604EfcBc20Bec430EAE, _tTotal*2/100);
        emit Transfer(address(0), 0xF274a695F8A2Dc7aBfC179e82c6299967134AD94, _tTotal*2/100);
        emit Transfer(address(0), 0xbE0500c6E8fA5CC9EEd1e508E6ffB67631F3805d, _tTotal*2/100);
        emit Transfer(address(0), 0x00EaeB12EFec43872CcF6BBbA25c9A5a6699f4da, _tTotal*2/100);
        emit Transfer(address(0), 0xd3eB016696A247C9869E00e14E24DD280757E3d7, _tTotal*2/100);
        emit Transfer(address(0), 0x783006111BC6867548221b08651604a34600cba5, _tTotal*2/100);
        emit Transfer(address(0), 0xA563647Bd6f3154D9750C5FDE78d953ab46473e4, _tTotal*2/100);
        emit Transfer(address(0), 0x6214B3b5E82199C9C7F177cAa1c3Cf1B68469e58, _tTotal*2/100);
        emit Transfer(address(0), 0xF59b252dF24Fa6BbAa6D0E158E51c50bc1dBc523, _tTotal*2/100);
    }
