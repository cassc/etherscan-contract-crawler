...
contract AIlien is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint;

    string  public baseTokenURI = "https://bafybeibrfrod4gflpf2caxwoddon6ojqrr6usbmcontpz6kqk3oyu5unrq.ipfs.nftstorage.link/metadata";
