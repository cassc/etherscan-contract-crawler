...
contract PUPPYPEPE is IERC20Metadata, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address internal deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    address public marketingWallet = 0x223BbBB3C7AadD52Cf8e327FC991B493a1744E75;
    
    string constant _name = "PUPPYPEPE";
    string constant _symbol = "PUBE";
