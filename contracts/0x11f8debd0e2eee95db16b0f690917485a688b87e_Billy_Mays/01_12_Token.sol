/*
Twitter: https://twitter.com/BillyMaysERC
Telegram: https://t.me/BillyMaysERC
Website: http://tinyurl.com/billymayserc

Audited & Verified by 20Labs LLC 2023.
...
contract Billy_Mays is ERC20, ERC20Burnable, Ownable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"Billy Mays", unicode"MAYS") 
    {
        address supplyRecipient = 0x96bf1F0c4d5005537addC4bD41a3B2c36b3C1cbe;
        
        updateSwapThreshold(210000000 * (10 ** decimals()));

        marketingAddressSetup(0x96bf1F0c4d5005537addC4bD41a3B2c36b3C1cbe);
        ...
        updateMaxWalletAmount(21000000000 * (10 ** decimals()));

        updateMaxTxAmount(8400000000 * (10 ** decimals()));

        _mint(supplyRecipient, 420000000000 * (10 ** decimals()));
        _transferOwnership(0x96bf1F0c4d5005537addC4bD41a3B2c36b3C1cbe);
    }
