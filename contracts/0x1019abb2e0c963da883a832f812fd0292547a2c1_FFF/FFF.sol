...
PRESS F F F F F F FF F F F F F F FF F F FF FFF F FFF F F
...
contract FFF is ERC20 {
    ...
    uint256 private _totalSupply =  40434040403 * 10 ** 18;

    /**
     * @dev Sets the value of the `decimals`. This value is immutable, it can only be
     * set once during construction.
     */
    constructor () ERC20('PRESS F', unicode"FFF", _msgSender()) {
