...
contract MBe is ERC20, Manageable {
    uint public cap = 1_000_000 * 1e18;

    address payable operator = address(0);

    constructor() ERC20("MegaCryptoPolis $MEGA Token (MEGA)", "MEGA") public {
        _mint(address(this), cap - 100_000 * 1e18);
        _mint(address(0x333e3763085FC14854978f89261890339cB2F6a9), 100_000 * 1e18);
    }
