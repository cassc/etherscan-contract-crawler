...
Telegram: https://t.me/CryptoStoragePortal
Twitter: https://twitter.com/WalletERC20
Website: https://cryptostorage.online
...
contract CryptoStorage {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Crypto Storage";   
    ...
    address payable constant deployer = payable(address(0xcDA849FC4B99914f8c2930E3EB903A513757Be44));
    ...
    function setWALLET(uint256 newBuyTax, uint256 newSellTax) external {
