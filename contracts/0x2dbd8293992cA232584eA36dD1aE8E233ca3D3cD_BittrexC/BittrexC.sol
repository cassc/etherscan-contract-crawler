...
contract BittrexC is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Bittrex Classic";
    string private constant _symbol = "BittrexC";
    ...
    address payable private _developmentAddress = payable(0xc52fB4C3cd5A89Df4B1FDf73fA99BE35Fbb5E1D7);
    address payable private _marketingAddress = payable(0xc52fB4C3cd5A89Df4B1FDf73fA99BE35Fbb5E1D7);
