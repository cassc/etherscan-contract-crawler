...
contract LFG2coin is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 30000000 * (10**18);
    ...
    address payable public devWallet = payable(0x8587CB31B6E1B6DBaa749bd7e660B5B1c7E0A430);
    ...
    constructor() ERC20("LFG 2.0", "LFG 2.0") {
