...
The ticker is PEPTSM the name is PEPETISM

Web: www.pepetism.com
Tg: t.me/pepetism
X: x.com/pepetism

"I May Be On The Spectrum, But My 
Portfolio Sees The Full Rainbow!" 🌈
...
contract PEPETISM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PEPETISM", "PEPTSM") {

        address _owner = _msgSender();

        _decimals = 18;

        uint256 totalSupply = 69_420_000_000 * (10**_decimals);
