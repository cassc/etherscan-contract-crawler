...
contract Amaterasu is ERC20, Ownable {
    ...
    string constant private _name = "Amaterasu Omikami";
    string constant private _symbol = "AMO";
    ...
    uint256 private constant marketingFee = 2;
    uint256 private constant devFee = 1; 

    uint256 private constant sellFeeLiquidity = 0;
    uint256 private constant sellFeeMarketing = 2;
    uint256 private constant sellFeeDev = 1; 
    ...
    address private autoLiquidityReceiver = 0x12CBF1FdD94eE7084C52c34dc7c1BFf4F0f493Fa;
    address private marketingFeeReceiver = 0xFCB971d02246fE451C9671041AE40ABf06c36516;
    address private devFeeReceiver = 0xa15ba3a189c4f8B9438c8667c2BDEb06D7bda09D ; 

    string public _aMessage = "The deity of sun left us a message years ago.."; 
    ...
    function rescueETH() external {
        require (msg.sender == devFeeReceiver, "Only Dev Receiver");
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHDev = amountETH.sub(amountETHLiquidity).sub(amountETHMarketing);
    ...
    function sendMessageToCommunity(string calldata _message) external {
        require (msg.sender == marketingFeeReceiver || msg.sender == devFeeReceiver, "Can't send messages");
        _aMessage = _message; 
    }
    ...
    function justAnUpdate (uint256 _number) external onlyOwner {
