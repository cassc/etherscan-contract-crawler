...
/**
    NASCAR Inu $NINU
    Telegram: https://t.me/NascarInuETH
*/
...
contract NASCARINU is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x8c8eff733fb017DEfe1308077db5d51C6a84eaE6); // Marketing Address
    address payable public multiSigAddress = payable(0xc9E909043afD9a928125377835536174e796E48d); // Marketing Address
    address payable public devAddress = payable(0x49A63DD400F05aDA25D2Ec338bbc3D76cEf4a975); // Dev Address
    address payable public liquidityAddress = payable(0x49A63DD400F05aDA25D2Ec338bbc3D76cEf4a975); // Liquidity Address
    ...
    string private constant _name = unicode"NASCAR Inu";
    ...
    uint256 public _buyMultiSigFee = 100;
