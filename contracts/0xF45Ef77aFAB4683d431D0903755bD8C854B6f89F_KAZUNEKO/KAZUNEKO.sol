...
🐈 Whale Friend Connection
🐈 Massive Marketing CG CEX CMC and Dextools Trending
🐈 Safe with Unique Utility

Telegram :
https://t.me/KazunekoETH
Twitter :
https://twitter.com/KazunekoETH
Medium:
https://medium.com/@ETHKazuneko
Website :
Kazu-Neko.com
https://t.me/KazunekoETH
...
contract KAZUNEKO is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "Kazuneko";
string private _symbol = "KAZUNEKO";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0xfbF5e616D038D7Bd8cFCd5e9BFeF736Abae417a0); // Marketing Address
address payable private TeamWallet = payable(0xa81E64f20c3929C83005B7A9F958893E236fa9ea); // Buy Back Address
...
uint256 private _sellTeamFee = 2;
...
uint256 public _totalSupply = 100 *  10**4 * 10**_decimals;
uint256 public _maxTxAmount = _totalSupply.div(20); 
uint256 public _walletMax = _totalSupply.div(20);
uint256 public minimumTokensBeforeSwap = _totalSupply.div(500); 
