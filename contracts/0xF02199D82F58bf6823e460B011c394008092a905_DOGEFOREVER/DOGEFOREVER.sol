...
https://t.me/dogeforever_ERC

www.twitter.com/dogeforever_ERC
...
string private _name = "DOGE FOREVER";
string private _symbol = "DOGE4EVA";
...
address _owner;
address payable public marketingAddress = payable(0x59f56eD7Ea7E737A516439CD9cc4a64323B63692
);
...
uint256 DOGEFOREVERCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
   require(block.timestamp > DOGEFOREVERCOINDaycooldown, "You cant call DOGEFOREVERCOINCoinDay more than once a day");
   buyPrevmktFee = buymktFee;
   buyprevLiqFee = buyliqFee;
   buyliqFee = 0;
   buymktFee = 0;
}
function DOGEFOREVERCOINCoinDayOver() public onlyOwner{
   buyliqFee = buyprevLiqFee;
   buymktFee = buyPrevmktFee;
   DOGEFOREVERCOINDaycooldown = block.timestamp + 86400;
}
