...
library FixLib {
    ...
    /// Muliply two fixes and divide by a third
    /// Round down to 0 and up to FIX_MAX instead of underflow/overflow/div-by-zero
    ...
    function safeMulDiv(
        ...
        unchecked {
            ...
            if (hi >= c) revert UIntOutOfBounds();
