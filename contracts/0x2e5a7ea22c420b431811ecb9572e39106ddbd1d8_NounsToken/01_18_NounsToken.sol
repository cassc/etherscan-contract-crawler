...
contract NounsToken is INounsToken, Ownable, ERC721Checkpointable {
    ...
    string private _contractURIHash = 'Qma6tyc1qmGWPSa4PnQfFY1qTnYDohiCBdKWBqZgZiWyJV';
    ...
    modifier onlyNoundersDAO() {
        require(msg.sender == noundersDAO, 'Sender is not the Social Noun DAO');
        _;
    }
    ...
    ) ERC721('Social Noun', 'Social Noun') {
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        require(_exists(tokenId), 'Social Noun Token: URI query for nonexistent token');
