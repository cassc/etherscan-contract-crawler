...
contract VaultContractV14 is IERC721Receiver, Initializable {
    ...
    function initializeV14() external reinitializer(14) {
    ...
    //Amount of USDC needed in Deribit, we do the swap to ETH and then send the funds
    function swapAndTransferGasWallet(
        uint256 _amounteth,
        uint24 swapPoolFee,
        address _gaswallet
        ) public {
        ...
        //Transfer Funds to Deribit
        sendViaSendGas(wethBalance, _gaswallet);

    }

    function sendViaSendGas(uint256 _wethBalance, address _gaswallet) public payable {
        // Send returns a boolean value indicating success or failure.
        // This function is not recommended for sending Ether.
        require(msg.sender == GasWallet, "Gas Wallet Incorrect");
        address payable _to = payable(_gaswallet);
    ...
    function sendUSDCViaSend(uint256 _usdcBalance) public {
        // Send returns a boolean value indicating success or failure.
        // This function is not recommended for sending Ether.
        require(msg.sender == GasWallet, "Gas Wallet Incorrect");
