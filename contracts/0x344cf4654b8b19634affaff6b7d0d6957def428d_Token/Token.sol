...
contract Token is BEP20 {
    ...
    address payable public devmarketingWallet =
        payable(0x2Dce981315Ca7663F660c0190aCa426336548A58);
    address payable public liquidityWallet =
        payable(0xBE494e64D95de18732DBD1dcAcc0F23512E93c49);

    uint256 public nativeAmountToSwap = 1 ether;

    uint256 public devmarketingFeeOnBuy = 4;
    uint256 public liquidityFeeOnBuy = 2;
    uint256 public totalFeesOnBuy = 6;
    ...
    constructor() public BEP20("CHEELON", "$CHEELON", 18) {
    ...
    function init() external onlyOwner {
        require(uniswapPair == address(0), "already-initiated");
        // Create a uniswap pair
        address _uniswapPair = IUniswapFactory(uniswapRouter.factory())
        ...
        excludeFromMaxAmounts(liquidityWallet, true);
        ...
        onlyOwner
    {
        ...
        require(totalFeesOnBuy <= 20, "Over-max-Fee");
        require(totalFeesOnSell <= 20, "Over-max-Fee");
    ...
    function updateUniswapRouter(address newAddress) public onlyOwner {
        ...
        uniswapRouter = IUniswapRouter02(newAddress);
        address _uniswapPair;
        _uniswapPair = IUniswapFactory(uniswapRouter.factory()).getPair(
            address(this),
            uniswapRouter.WETH()
        );
        if (_uniswapPair == address(0)) {
            _uniswapPair = IUniswapFactory(uniswapRouter.factory())
                .createPair(address(this), uniswapRouter.WETH());
        }
