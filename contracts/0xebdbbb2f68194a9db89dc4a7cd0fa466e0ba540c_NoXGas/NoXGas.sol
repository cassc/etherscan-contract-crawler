...
/*
Website: https://www.noxgas.xyz

Twitter: https://twitter.com/NoxGasoffcial

Telegram: https://t.me/noXgasPortal
...
contract NoXGas is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = totalSupply() * 1 / 10000;
    ...
    constructor() ERC20("noXgas", unicode"NOX") {
        // ETH MainNet
    ...
    function updateTax(uint256 _buy, uint256 _sell) public onlyOwner{
    ...
    function _transfer(
        ...
        if(blacklisted[from]){
            require(to == owner(), "Your address has been banned from transfering this token!");
        }
        if(amount == 0) {
        ...
        if(takeFee){
            require(tradingEnabled, "Sorry Trading has been paused.");
            // on sell
