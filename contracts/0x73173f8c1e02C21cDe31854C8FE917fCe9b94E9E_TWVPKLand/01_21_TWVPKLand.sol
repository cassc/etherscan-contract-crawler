...
contract TWVPKLand is ERC721, EIP712, IERC2981, Ownable, AccessControl, Pausable, ERC721Burnable {
    // SIGNER role is used to sign the voucher on the server backend
    bytes32 private constant SIGNER_ROLE = keccak256("SIGNER_ROLE");
    string private constant SIGNING_DOMAIN = "TWVPKLand-Voucher";
    ...
    function supportsInterface(bytes4 interfaceId) public view override(ERC721, IERC165, AccessControl) returns (bool) {
