...
contract GinganoYume is Context, IERC20, Ownable {
    ...
    string private _name = "Ginga no Yume";
    ...
    address public marketingTokenFeeWallet = 0x724C58b44c3c0B7A9d2a4a5e5E2074Aa4EDbb56D;
    address public marketingETHFeeWallet = 0x724C58b44c3c0B7A9d2a4a5e5E2074Aa4EDbb56D;
    ...
    uint256 public _maxTxAmount = 84 * 10**4 * 10**9;// 2% maxTxAmount
    uint256 public _maxWallet = 84 * 10**4 * 10**9;// 2% maxWallet
    uint256 private _numTokensSwapToETHForMarketing = 1 * 10**4 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 42 * 10**4 * 10**9, "Cannot set transaction amount less than 1 percent of initial Total Supply!");
