...
contract PEPE52 is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPE52";
    string private constant _symbol = "PEPE52";
    ...
    address payable private _developmentAddress = payable(0x79fAa9fDD6D0E8204a014914e0A2c4F2B9A82f09);
    address payable private _marketingAddress = payable(0x41918D1fab268429EdF93D5a76193D29cf9eAdd1);
