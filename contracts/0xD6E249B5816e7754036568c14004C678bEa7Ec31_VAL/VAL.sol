...
contract VAL is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 39393939393 * 10**9;
    ...
    uint256 public _maxTxAmount = 393939393.93 * 10**9;
    uint256 public _maxWalletSize = 787878787.86 * 10**9;
    uint256 public _swapTokensAtAmount = 787878787.86 * 10**9;
