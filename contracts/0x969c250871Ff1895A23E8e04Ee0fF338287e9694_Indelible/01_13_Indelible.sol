// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Clothes", unicode"Headwear", unicode"Beak", unicode"Right Eye", unicode"Left Eye", unicode"Body", unicode"Background"];
        ...
        uint public publicMintPrice = 0.004 ether;
        ...
        ContractData public contractData = ContractData(unicode"ETHER BIRDS ON-CHAIN", unicode"EBOC is project have high complexity art Using vector ( non-pixel). 134 traits are picked randomly from  @Indelible_Labs . Art is created with variety. A homage to birds culture, let's Fly!!!", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/a8088af3-7d25-43e6-8323-581fd58e32da", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/a8088af3-7d25-43e6-8323-581fd58e32da", "", 700, "0xA873a3c0aeA4f1D2A6883F79b841203190bd01d8");

        constructor() ERC721A(unicode"ETHER BIRDS ON-CHAIN", unicode"EBOC") {
            TIERS[0] = [515,532,548,557,558,565,585,1140];
TIERS[1] = [36,36,41,45,46,57,62,91,93,135,153,179,200,217,231,243,322,437,442,476,720,738];
TIERS[2] = [22,33,49,53,70,80,104,139,141,156,186,189,201,256,270,415,431,466,498,598,643];
TIERS[3] = [18,30,40,41,56,106,122,132,147,162,169,183,208,221,288,356,367,443,579,635,697];
TIERS[4] = [20,38,43,56,88,115,157,180,186,206,219,253,264,279,292,312,318,326,415,600,633];
TIERS[5] = [15,23,57,59,72,96,108,189,204,221,223,225,260,295,319,357,476,831,970];
TIERS[6] = [238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,238,239,239];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"ETHER BIRDS ON-CHAIN #");
