...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x44A5C8709CfE5f143745A7e9ac26826b7b0b7186];
  address public erc20Payable = 0x44A5C8709CfE5f143745A7e9ac26826b7b0b7186;
...
abstract contract EarlyMintIncentive is Teams, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 12;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmQijdqp5di9BmqHg13gtEQ8ARPfHsFGRUhqwky4BupwAx/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/yn7wiaTeoayvOOm5ci1B/contract-metadata";
  }
...
// File: contracts/WrathbyHaneoTashiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WrathbyHaneoTashiContract is RamppERC721A {
    constructor() RamppERC721A("Wrath by Haneo Tashi", "Wrath"){}
}
