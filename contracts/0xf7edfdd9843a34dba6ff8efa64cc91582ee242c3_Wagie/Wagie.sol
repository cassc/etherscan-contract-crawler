...
/**
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| | _____  _____ | || |      __      | || |    ______    | || |     _____    | || |  _________   | |
| ||_   _||_   _|| || |     /  \     | || |  .' ___  |   | || |    |_   _|   | || | |_   ___  |  | |
| |  | | /\ | |  | || |    / /\ \    | || | / .'   \_|   | || |      | |     | || |   | |_  \_|  | |
| |  | |/  \| |  | || |   / ____ \   | || | | |    ____  | || |      | |     | || |   |  _|  _   | |
| |  |   /\   |  | || | _/ /    \ \_ | || | \ `.___]  _| | || |     _| |_    | || |  _| |___/ |  | |
| |  |__/  \__|  | || ||____|  |____|| || |  `._____.'   | || |    |_____|   | || | |_________|  | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
contract Wagie is ERC20, Ownable {
    ...
    constructor() ERC20("Wagie", "WAGIE") {
        ...
        devWallet = address(0xb53a14C9609a62f44C13B6fe0e5277666D09092e); // set as dev wallet
