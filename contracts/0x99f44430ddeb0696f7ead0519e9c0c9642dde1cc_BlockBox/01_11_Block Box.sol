...
/*
BlockBox $BOX - Ethereum Network

A comprehensive suite of crypto utilities built on the Ethereum network. With a focus on security, usability, and innovation.
Telegram: https://t.me/BlockBox_ETH
Twitter:  https://twitter.com/BlockBoxERC
Website:  https://www.block-box.net
*/
...
contract BlockBox is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = "Block Box";
    ...
    function initialize() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),initialTotalSupply.per(62),0,0,owner(),block.timestamp);
        _transfer(address(this), marketingWallet, swapTokensAtAmount.mul(13));
    }
