...
https://dollartokeneth.com
https://twitter.com/DollarTokenETH
...
contract LockToken is Ownable {
    ...
    function openTrade(bool Open) external onlyOwner
    {
        isOpen = Open;
    }
...
contract DOLLAR  is Context, IERC20, LockToken 
{

    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xdB0C63dC73BAD3172A2314AE20D776f421fDA86C);
    address payable public devAddress = payable(0xdB0C63dC73BAD3172A2314AE20D776f421fDA86C);
    address public newOwner = 0xdB0C63dC73BAD3172A2314AE20D776f421fDA86C;
    ...
    uint256 public _maxTxAmount = _tTotal.div(100).mul(2); //DOLLAR  of total supply
    uint256 public _walletHoldingMaxLimit =  _tTotal.div(200).mul(2); //DOLLAR  of total supply
