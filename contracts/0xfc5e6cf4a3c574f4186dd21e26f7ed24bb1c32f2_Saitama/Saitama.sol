...
contract Saitama is Context, IERC20, Ownable {
    ...
    string private _name = "Saitama Inu 2.0";
    string private _symbol = "SAITAMA2.0";
    ...
    uint256 public _maxTxAmount = 33000000000000000000000000; 
    uint256 public numTokensSellToAddToLiquidity = 330000000000000000000000;
    ...
    function setMarketingFeePercent(uint256 fee) public onlyOwner {
        require(fee < 90, "Marketing fee cannot be more than 50% of liquidity");
