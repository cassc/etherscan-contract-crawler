...
contract dorkmaul is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DORK MAUL";
    string private constant _symbol = unicode"DORKM";
