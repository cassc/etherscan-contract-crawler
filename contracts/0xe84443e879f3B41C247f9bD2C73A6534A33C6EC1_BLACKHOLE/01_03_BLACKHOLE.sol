...
/**
            Black Hole is a Degen Experiment.
            Before Uniswap listing we transferred 99% of total supply to 0X000000000000000000000000000000000000DEAD ADDRESS.
            All token fees are proportionally distributed to $HOLE holders within each transaction. Considering that >99%
            of the supply is held by the dead address, it will act as a black hole for 99% of the token fees.
            This concept will theoretically reduce the circulating supply forever, causing an ever-increasing price floor.
...
contract BLACKHOLE is Context, IERC20, AccessControl {
    ...
    uint256 private _tTotal = 100000 * 10**6 * 1 ether;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Black Hole";
    string private _symbol = "HOLE";
    ...
    address public _devFeeAddress = 0x22318B39B9c367E7f9c587D133eb3d4BE7e7d837;
    ...
    uint256 public _maxTxAmount = 200 * 10**6 * 1 ether;
    uint256 public numTokensSellToAddToLiquidity = 50 * 10**6 * 1 ether;
