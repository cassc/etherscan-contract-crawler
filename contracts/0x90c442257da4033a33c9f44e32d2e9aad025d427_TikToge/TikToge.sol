...
𝕋𝕚𝕜𝕋𝕠𝕘𝕖 𝕚𝕤 𝕋𝕙𝕖 𝕎𝕠𝕣𝕝𝕕 𝔽𝕚𝕣𝕤𝕥 ℙ𝕣𝕠𝕘𝕣𝕒𝕞 ℂ𝕒𝕝𝕝𝕖𝕕 𝕋𝕚𝕜𝕋𝕠𝕜 𝟚 𝔼𝕒𝕣𝕟.
*/
...
contract TikToge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TikToge","TIKTOGE") {
    ...
    function Limit() external onlyOwner returns (bool){
