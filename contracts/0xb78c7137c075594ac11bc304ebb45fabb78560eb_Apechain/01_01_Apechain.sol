...
// https://www.apechain.vip/

// https://swap.apechain.vip/

// https://scan.apechain.vip/

// https://twitter.com/apechainerc20

// hhttps://t.me/ApeChainERC20
...
contract Apechain is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Apechain";
  ...
  function removeLimits() external onlyOwner {
        _maxTxAmount = _tTotal; // Set maxTxAmount to the total supply
        _maxWalletSize = (_tTotal * 2) / 100;  // 2% of total supply
