...
Whenever I hear this word It reminds me of The Wolf Of The Wallstreet, How Jodan (Leo DiCaprio) tranfers his all to 
Black wealth to a Swiss Bank to avoid getting taxed and to hide his wealth.

Credit Suisse Bank and Deutsche Bank are on verge of Collapse and they both are swiss banks cenetred in Switzerland.
...
contract SwissBankInu is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Swiss Bank Inu";////////////////
    ...
    address payable private _developmentAddress = payable(0x096Cb3e34e1E568d09D6291107762E7936a0Ec44);////////////////////
    address payable private _marketingAddress = payable(0x096Cb3e34e1E568d09D6291107762E7936a0Ec44);/////////////////////
