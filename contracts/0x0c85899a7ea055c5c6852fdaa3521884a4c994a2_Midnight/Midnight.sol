...
Telegram: http://t.me/MidnightProjectOfficial                                                      
Twitter:  https://twitter.com/themidnighteth
Website:  https://midnighteth.com/
...
contract Midnight is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Midnight", "NIGHT") {
        ...
        devWallet = 0x3c9cf276C6d79b32a739A79dc471946020f69af5;
    ...
    function updateBuyFees(uint256 _communityFee, uint256 _liquidityFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _communityFee, uint256 _liquidityFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForBurn += fees * sellCommunityFee / sellTotalFees;
                tokensForDev += fees * sellLiquidityFee / sellTotalFees;
            }
            ...
            // on buy
        	    ...
        	    tokensForBurn += fees * buyCommunityFee / buyTotalFees;
                tokensForDev += fees * buyLiquidityFee / buyTotalFees;
            }
