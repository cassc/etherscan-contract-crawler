...
contract ceecee is Context, IERC20, Ownable { 
    ...
    address payable public Marketing_Wallet = payable(0xE1e1DAe1379fD27031AA56E2C0d7C8B3EdDE3d34);

    mapping (address => bool) public ExcludedFromFee;
    mapping (address => bool) public ExcludedFromTax;

    // Token Details
    string public _name = "CeeCee";
    string public _symbol = "CeeCee";
