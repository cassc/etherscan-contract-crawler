...
contract PUPE20TOKEN is IERC20, Ownable {
    ...
    string private constant _name = unicode"PUPE20 TOKEN";
    string private constant _symbol = unicode"PUPE20";
