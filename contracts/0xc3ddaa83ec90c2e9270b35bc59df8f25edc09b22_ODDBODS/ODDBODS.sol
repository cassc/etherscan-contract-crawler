...
LP BURN | 0/0 TAX | RENOUNCE

TG : https://t.me/oddbods_erc
...
contract ODDBODS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ODDBODS";
    string private constant _symbol = unicode"ODDS";
