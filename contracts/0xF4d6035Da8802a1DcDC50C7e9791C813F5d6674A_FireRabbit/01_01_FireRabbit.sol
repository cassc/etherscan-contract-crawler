/**
 * website: https://www.firerabbiteth.com/
 * tg: https://t.me/firerabbitEth
 * twitter: https://twitter.com/firerabbiteth
 * medium: https://medium.com/@firerabbiteth
 */
...
// Main Contract Logic 
// --------------------------------------------------------------
contract FireRabbit is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Fire Rabbit";
    ...
    uint256 public _walletMax = ~uint256(0);
    bool public checkWalletLimit = false;

    // wallets
    address payable public liquidityWallet = payable(0x4Ea4E4D6b0A6065C8F2a09082D8aD47fE87368bF);
    address payable public operationsWallet =  payable(0x4Ea4E4D6b0A6065C8F2a09082D8aD47fE87368bF);
