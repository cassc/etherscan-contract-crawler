...
contract DegenBallZERC is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"DegenBall Z";
    string private constant _symbol = unicode"$DGBZ";
    ...
    address payable private _developmentAddress = payable(0x1aa55EB6C574861a20e0d60F3223Dd17CEec435D);
    address payable private _marketingAddress = payable(0x1aa55EB6C574861a20e0d60F3223Dd17CEec435D);
