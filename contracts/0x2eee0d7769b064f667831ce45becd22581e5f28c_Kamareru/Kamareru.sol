...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x8Ff54bc32D701eDa2F1Fc8d05746a2EdA7c96990] = _marketingwallet;
    }
...
contract Kamareru is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Kaini-Teo Kamareru", "KAMARERU") {
        ...
        excludeFromFees(address(0xba283Ecb87c032B1145b3FF8aC95F8ea28a0814e), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xba283Ecb87c032B1145b3FF8aC95F8ea28a0814e), true);
