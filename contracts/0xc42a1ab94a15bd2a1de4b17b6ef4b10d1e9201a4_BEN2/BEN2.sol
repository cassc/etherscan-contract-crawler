...
contract BEN2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ben 2.0";
    string private constant _symbol = "BEN2.0";
    ...
    address payable private _developmentWalletAddress = payable(0xc4Cd20958E0729760c123Ed111aE962538b06AD1);
    address payable private _marketingWalletAddress = payable(0xc4Cd20958E0729760c123Ed111aE962538b06AD1);
