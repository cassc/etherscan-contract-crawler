...
contract TeslaCoin is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "TeslaCoin";
    string private constant _symbol = "TSLC";
    ...
    address payable private _developmentAddress = payable(0x5e2512117E3543323635388CE91ba6DC9cD7f563); 
    address payable private _marketingAddress = payable(0x5e2512117E3543323635388CE91ba6DC9cD7f563);
