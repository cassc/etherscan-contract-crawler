...
Twitter:   https://twitter.com/animetveth 
Telegram:  https://t.me/animetveth 
Website:   https://www.animetverc.xyz
...
contract AnimeTV is ERC20, Ownable {
    ...
    constructor() ERC20("Anime TV", "ANITV") {
        ...
        marketingWallet = address(0x1CCF7a1284eb4Fb7e31Ad9672875df178ab9584F); // set as marketing wallet
        devWallet = address(0xEa1EAefc3d7302306A81b7177fdd9218233c9Bfc); // set as dev wallet
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellMarketingFee, uint256 _earlySellLiquidityFee, uint256 _earlySellDevFee) external onlyOwner {
        ...
        require(earlySellTotalFees <= 35, "Must keep early fees at 35% or less");
    }
