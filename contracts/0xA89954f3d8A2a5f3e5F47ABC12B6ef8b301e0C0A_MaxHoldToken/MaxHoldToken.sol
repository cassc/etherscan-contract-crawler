...
contract MaxHoldToken {
    ...
    string public name = "SamsungToshibaNakamichiMotorolaINU";
    string public symbol = "SATOSHI";
    ...
    function transferFrom(address _from, address _to, uint256 _amount) public returns (bool success) {
        ...
        if(maxTokenSet && _to != pairAddress && _from != creatorWallet){
    ...
    function setFees(uint256 newBuyFee/**/, uint256 newSellFee/**/) public noJeetersAllowed {
