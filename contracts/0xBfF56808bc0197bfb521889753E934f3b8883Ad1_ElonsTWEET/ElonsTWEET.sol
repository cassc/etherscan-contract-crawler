...
contract ElonsTWEET is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Elons !";
    ...
    address payable private _developmentAddress = payable(0x48Cd06D2Ba4C0F33f0e2e77B3c6fF48FC8E194c2);
    address payable private _marketingAddress = payable(0x48Cd06D2Ba4C0F33f0e2e77B3c6fF48FC8E194c2);
