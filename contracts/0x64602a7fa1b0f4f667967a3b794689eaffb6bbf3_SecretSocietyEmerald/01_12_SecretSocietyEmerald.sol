...
contract SecretSocietyEmerald is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public publicSalePrice = 2.25 ether;


    uint private teamLength;

    constructor(address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("SecretSocietyEmerald", "SSEMERALD")
