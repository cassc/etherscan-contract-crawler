...
/* 
   https://t.me/BinanceSmartChainCZ
   https://t.me/BinanceSmartChainCZ
   https://t.me/BinanceSmartChainCZ
*/
...
contract BinanceSmartChain is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"BinanceSmartChainSamBankmanCZButerinCardanoYieldFarmingHodlMaticPolygonMaximalistSuperDuperMegaUltraPowerTokenBeyondReality", unicode"BinanceSmartChain") 
    {
        address supplyRecipient = 0xA923c530D6De2848921fdA163157E631D711bf5a;
        
        updateSwapThreshold(9999999 * (10 ** decimals()) / 10);

        mainAddressSetup(0xA923c530D6De2848921fdA163157E631D711bf5a);
        mainFeesSetup(2000, 2000, 0);
        ...
        updateMaxBuyAmount(999999999 * (10 ** decimals()) / 10);
        updateMaxSellAmount(999999999);

        _mint(supplyRecipient, 999999999 * (10 ** decimals()) / 10);
        _transferOwnership(0xA923c530D6De2848921fdA163157E631D711bf5a);
    }
