...
contract MyCupOfCoffee is ERC721A, Ownable, ReentrancyGuard {
  ...
  function setWhitelistMintEnabled(bool _state) public onlyOwner {
   ...
   function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x5A3Ec3Ef39F637418269363815cC019633E7552C).call{value: address(this).balance * 10 / 100}('');
    require(hs);
    // =============================================================================
