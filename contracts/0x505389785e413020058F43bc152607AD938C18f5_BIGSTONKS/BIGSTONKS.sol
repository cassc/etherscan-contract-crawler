...
Community Driven - No Dev - Just Vibes
...
contract BIGSTONKS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BIGSTONKS";
    string private constant _symbol = unicode"BIGSTONKS";
