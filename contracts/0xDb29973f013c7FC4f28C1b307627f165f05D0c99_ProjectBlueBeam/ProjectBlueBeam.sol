...
https://twitter.com/JenniferJablun1/status/1624591073103302656?s=20&t=LWHxn9RsGHtAu5GMTlZCjg
...
contract ProjectBlueBeam  is ERC20, Ownable {
    ...
    address payable marketingWallet = payable(address(0xdFfa0210412c69dE7ba26b5E35C2Dc678519cA7e)); // marketingWallet to receive ETH
    ...
    constructor() ERC20("Project Blue Beam", "ALIENS") {
   ...
   function enableTrading() external onlyOwner {
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "ALIENS: The uniswap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "ALIENS: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
...

    {
        buyFee.marketingFee = _market;
         ...
         totalBuyFee = _market ;
        require(totalBuyFee <= 75,"MaX buy fees limit  is 10%");
    }
...

    {
        ...
        require(totalSellFee <= 75,"MaX buy fees limit  is 15%");
    }
