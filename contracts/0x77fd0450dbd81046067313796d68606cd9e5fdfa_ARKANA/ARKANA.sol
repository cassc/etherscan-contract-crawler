...
Arkana is a decentralized multi-gaming platform which allows its users 
to earn rewards based on their gaming skills and performance.

https://linktr.ee/ArkanaGaming
...
contract ARKANA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Arkana Gaming Hub", "ARK") {
        ...
        marketingWallet = address(0xA02C9D79195F4b6677e1cd14394512C87404427f); // set as marketing wallet
        devWallet = address(0xC30C4c7baC0bC003fEACdc8FC1eeC778E2448086); // set as dev wallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees.div(feeDenominator) <= 5, "Must keep fees at 5% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees.div(feeDenominator) <= 5, "Must keep fees at 5% or less");
    }
