...
contract TheMeshLinesSalonofmagic is ERC721A {
    ...
    constructor() ERC721A("The Mesh Lines Salon of magic", "meshline") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeidej43lmtrk4ec475lfcyvgjggv555iz2norm4kfqjspyfyfodjgq/", _toString(tokenId), ".json"));
    }
