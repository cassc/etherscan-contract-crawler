...
contract KUCHICOIN is ERC20, Ownable {
    ...
    constructor() ERC20("Kuchi", "KUCHI") {
        ...
        uint256 totalSupply = 1001011 * 1e18;

        maxTransactionAmount = 30010 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 30010 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x69e1c4071A7e60C9d2C3fC4a207D072d46EC32bD); // set as charity wallet
        marketingWallet = address(0x502B14Cbf21c607b149798FDD17b52bb986c9E6c); // set as marketing wallet
        devWallet = address(0x502B14Cbf21c607b149798FDD17b52bb986c9E6c); // set as dev wallet
