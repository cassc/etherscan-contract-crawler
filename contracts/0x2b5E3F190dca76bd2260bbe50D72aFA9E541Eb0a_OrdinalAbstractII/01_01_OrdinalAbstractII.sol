...
contract OrdinalAbstractII is ERC721A {
    ...
    constructor() ERC721A("Ordinal Abstract II", "OAII") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmXYwe1CvWuKSX2gUvY1pruSY19T7p13xAmbjpcjTckuCB/", _toString(tokenId), ".json"));
    }
