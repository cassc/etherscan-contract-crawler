...
contract AirDoge2 is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0xF46E77312a5000fafBBd75B65D1C03c97e0B3F9A);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal =210000000000000000 * 10**16;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "AirDoge2.0";
    string private _symbol = "$ADOGE2.0";
    ...
    uint256 public _maxTxAmount = 20 * 10**9 * 10**16;

    // Liquify when 400m tokens are stored
    uint256 private numTokensSellToLiquify = 400 * 10**6 * 10**16;
