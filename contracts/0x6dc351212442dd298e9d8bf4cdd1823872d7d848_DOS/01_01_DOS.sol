...
// Hola Jeet, you want to snipe Dos Pepe? Well I wish luck my fren. 
// Dos Pepe does a dos Pepe tings.  You look for Dos Pepe Telegram link? 
// You not find it. Oh, you have wait for your favorite influencer to tweet it or call it. 
// Is soon happening degen. You can ape now or wait for de millions market cap. 
// Dos Pepe is the most interesting Pepe in de universe. 
// Don’t believe this. Copy these links for more info on what Dos Pepe is all about. 
// Follow Dos Pepe on YouTube and TikTok. You no believe is Alpha? 
// Den don’t Ape till later fren.  
// 1 billions market cap so you have lots of Dos Pepe to drink.  
// Stay thirsty degen. Stay thirsty. 

// https://youtube.com/shorts/pKcGu6CZbZk?feature=share
// https://www.tiktok.com/t/ZT8dXp21L/ 
...
contract DOS is IERC20, Ownable {
    /* -------------------------------------------------------------------------- */
    /*                                   events                                   */
    /* -------------------------------------------------------------------------- */
    ...
    //Set initial taxes high to discourage snipers and feed mw for marketing
    Fee public buyFee = Fee({reflection: 0, marketing: 15, lp: 0, buyback: 0, burn: 0, total: 15});
    ...
    constructor() {
        ...
        //marketing wallet
        marketingFeeReceiver = 0x3A1CB6fB9fC371CE7bCC40ebc0F3cf9051aCA66f;
        //deployer wallet receives LP and Buyback taxes
        lpFeeReceiver = 0xf04D9bc76409b608753342D6Bd0c405Dd91a6e46;
        buybackFeeReceiver = 0xf04D9bc76409b608753342D6Bd0c405Dd91a6e46;
