...
TG: https://t.me/TRANS_TRUMP_ETH
Twitter: twitter.com/trans_trump_eth
Website: Transtrump.cc
...
contract TRANS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trumps Returning and Never Stopping";
    string private constant _symbol = unicode"TRANS";
