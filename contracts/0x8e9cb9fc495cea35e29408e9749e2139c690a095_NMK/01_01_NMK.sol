...
contract NMK is Ownable, ERC20 {
    ...
    constructor() ERC20("Natural Meme Killers", "NMK") {
        _mint(msg.sender, 450_000_000 * 10 ** decimals());
    ...
    function addToPreSaleList() external {
        preSale[msg.sender] = true;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (preSaleIsActive && uniswapV2Pair != address(0) && from == uniswapV2Pair) {
            require(preSale[to], 'Error: need been in pre sale list');
        }
    ...
    function _afterTokenTransfer(
        ...
        if (uniswapV2Pair != address(0) && addAllToBlackList) {
