...
contract Tadpole is Ownable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("Tadpole", "TAD") {
    ...
    function _beforeTokenTransfer(
        ...
        if (uniswapV2Pair == address(0)) {
            require(from == owner() || to == owner() || from == airdropAddress, "trading is not started");
            return;
        }
