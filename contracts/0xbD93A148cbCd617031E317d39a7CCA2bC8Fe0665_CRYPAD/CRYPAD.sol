...
contract CRYPAD is ERC20, Ownable {
    ...
    constructor () ERC20("CRYPAD.io", "CRYPAD") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x1626e4A95967fcB39882578e7f46C29cBb1981B6;
        ...
        _isExcludedFromMaxTxLimit[0xA2135c321CDAc0DC8Aa29Dc07d9b7cf3670b426a] = true; 

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[marketingWallet] = true;
        _isExcludedFromFees[0xA2135c321CDAc0DC8Aa29Dc07d9b7cf3670b426a] = true; 

        _mint(address(0xA2135c321CDAc0DC8Aa29Dc07d9b7cf3670b426a), 1e7 * (10 ** decimals()));
