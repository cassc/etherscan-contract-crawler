...
/** TG:https://t.me/Anchorfi
    website:https://anchorfinance.net/
    */
...
contract ANCHORFINANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ANCHOR FINANCE";
    string private _symbol = "$ANF";
    uint8 private _decimals = 18;

    address payable private marketingWalletAddress = payable(0x43454F01316D446BC6DC431e6D19E9B8bAeAC505);
    address payable private teamWalletAddress = payable(0x43454F01316D446BC6DC431e6D19E9B8bAeAC505);
