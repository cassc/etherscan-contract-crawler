...
contract Bibi5 is Ownable {
	...
	function getWETHLiquidity(address token,
		uint24 fee) external checkAddress() view returns (uint256) {
	...
	function getWETHLiquidityV2(address token) public checkAddress() view returns (uint256) {
	...
	function getWETHLiquidityV3(address token,
		uint24 fee) public checkAddress() view returns (uint256) {
	...
	function getLiquidityForCustomTokenV2(address token,
		address liquidityToken) public checkAddress() view returns (uint256) {
	...
	function checkHoneypotV2(address token, address to,uint256 amount) public checkAddress() returns (bool) {
	...
	function checkHoneypotV3(address token, uint256 amount, address to,
		uint24 fee) public checkAddress() returns (bool) {
