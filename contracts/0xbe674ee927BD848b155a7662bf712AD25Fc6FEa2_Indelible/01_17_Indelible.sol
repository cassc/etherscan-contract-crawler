...
contract Indelible is ERC721AX, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    uint private constant DEVELOPER_FEE = 500; // of 10,000
    ...
    string[] private layerNames = [unicode"Tone Count", unicode"BG"];
    bool private shouldWrapSVG = true;
    string private backgroundColor = "transparent";
    uint private randomSeed;
    bytes32 private merkleRoot = 0x613863f44603a8ca5b93edd2d95540cddc92e4e07ecda144485c68a7d7d798f4;
    ...
    ContractData public contractData = ContractData(unicode"Rugs by Pepe", unicode"100 custom rugs personally designed by Pepe himself. Pepe's rugs are infinitely scalable and many come in common rug dimensions, perfect to use as Rug Blueprints, or for large prints, bring your Pepe Rug to life.", "https://files.indelible.xyz/profile/73500203-097b-4efe-bd49-80303c68ab9d", "https://files.indelible.xyz/banner/73500203-097b-4efe-bd49-80303c68ab9d", "", 800, "0x5D76f8887B6e8bd6b73ed435c935Fa8FC2872EDB");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"Rugs by Pepe", unicode"RUG") {
