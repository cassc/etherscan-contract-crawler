...
RETURN OF SHIB - JOIN THE FORCE

With abilities to produce one of the most 
valuable GEMS known as Return of Shib - JOIN THE FORCE.

Telegram: https://t.me/ReturnOfShib
Website: https://returnofshib.com/
Twitter: https://twitter.com/ReturnOfShib
...
contract RETURNOFSHIB is ERC20, Ownable {

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply;

    string private _name = "Return Of Shib";
    string private _symbol = "RTShib";
