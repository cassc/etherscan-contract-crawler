...
contract ElectronicBoy is ERC20, Ownable {
    ...
    constructor() ERC20("electronic boy", "e boy") {
        ...
        uint256 _sellTeamFee = 27;

        uint256 totalSupply = 420_000_000 * 1e18;

        maxTransactionAmount = 6300_000 * 1e18; // 1.5%
        maxWallet = 6300_000 * 1e18; // 1.5% 
        ...
        revShareWallet = address(0x68F88386E7746d792b9B3044b4E6788ede204B1d); //
        teamWallet = owner(); 
