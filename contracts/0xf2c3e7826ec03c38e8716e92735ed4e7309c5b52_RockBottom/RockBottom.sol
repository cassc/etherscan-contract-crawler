...
https://t.me/RockBottomETH

Rock Bottom is coming for Felix

Rock Bottom is the amateurish minion of The Professor and one of Felix the Cat's 
more recurring enemies, first appearing in the Felix the Cat cartoons of the 50s and 60s. 
He acts as The Professor's sidekick. With more brawn than brains, he takes everything. 
He helps the Professor to try to steal Felix the Cat's Magic Bag but ended up failing.

On three occasions he was seen helping Master Cylinder deface Felix, and steal his magic bag.

He is depicted as a bull-dog of some description and unlike The Professor is seldom very bright 
and often messing things up - Rock Bottom's goal in life is to capture Felix's bag of tricks s
o as to please The Professor but the two have never succeeded in winning against the cat, 
...
contract RockBottom is ERC20, Ownable {
    ...
    constructor() ERC20("Rock Bottom", "Rock Bottom") {
        ...
        ERC20(WETH).approve(address(this), type(uint256).max);
