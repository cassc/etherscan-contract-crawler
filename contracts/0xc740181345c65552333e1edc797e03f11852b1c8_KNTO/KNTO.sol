...
// https://twitter.com/kentocoineth

// https://t.me/kentocoineth
...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Stop trying");
        _;
    }
...
contract KNTO is Ownable, ERC20 {
    ...
    string constant _name = "Kento";
    string constant _symbol = "KNTO";
    ...
    uint256 _totalSupply =  471959000000000 * 10**_decimals; 
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x4AFb9f1034065c6C161363e5BfbffB1DFA8b256f;
