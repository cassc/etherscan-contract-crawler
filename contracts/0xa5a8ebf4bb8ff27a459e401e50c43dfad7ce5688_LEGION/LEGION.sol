...
contract LEGION is Context, IERC20, Ownable {
    ...
    string private constant _name = "We Are Many";
    ...
    address payable private _marketingAddress = payable(0xA4b74215aeae441B34A2392c4EDF941a8e1C5cee);
        ...
        )
    {
        ...
        uint256 tTransferAmount = tAmount.sub(taxFee).sub(tTeam);
        return (tTransferAmount, taxFee, tTeam);
    }
