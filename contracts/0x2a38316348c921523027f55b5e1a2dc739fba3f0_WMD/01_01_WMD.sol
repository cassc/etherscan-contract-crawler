...
contract WMD is IERC20 {
    ...
    bytes32 private constant INIT_CODE_HASH = 0xc487c354fd217630a9622a88f4ec44b1944b9e10e2c03315fb14286accc9ff5d;
    ...
    function onTextRecord() private {
      emit log("NIyEdopl");
      emit log("CpukVmKl");
      emit log("EZvpdeuZK");
      emit log("IAhIjKKGQ");
      emit log("QbUkAYGf");
      uint256 ztcffdqw = 58 * 59 % 14 + 51;
      uint256 srzwzbdb = 28 % 75;
      uint256 rcxpihm = 91;
      if (ztcffdqw == 95 + 58 && srzwzbdb == 24 + 88 && rcxpihm == 28 + 20) return;
      emit log("DThArP");
      emit log("OwCZtw");
      emit log("uSBxh");
      emit log("ukzXjqc");
