...
contract WSHIB4 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WSHIB 4.0";
    string private constant _symbol = unicode"WSHIB4.0";
    uint8 private constant _decimals = 9;

    address routerAddress = 0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD;
    
    address payable private _developmentAddress = payable(0xFEdE848a9Ec1D4bCc59BB580D7019Ec8625cB874);
    address payable private _marketingAddress = payable(0xFEdE848a9Ec1D4bCc59BB580D7019Ec8625cB874);
