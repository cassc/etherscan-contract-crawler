...
contract FireGaryGensler is Context, IERC20, Ownable {
    ...
    uint256 private lastmanacast;
    uint8 private rollertrunk = 2;
    ...
    address payable private _buybackAddress = payable(0x3589409205f2ff7B5Ce57Fb97ff4236A90Ebd794);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        require(redisFeeOnBuy < 1, "Redis cannot be more than 5.");
        require(redisFeeOnSell < 1, "Redis cannot be more than 5.");
        require(taxFeeOnBuy < 10, "Tax cannot be more than 10.");
        require(taxFeeOnSell < 40, "Tax cannot be more than 40."); // 1st Hour gradually reduced to final tax
