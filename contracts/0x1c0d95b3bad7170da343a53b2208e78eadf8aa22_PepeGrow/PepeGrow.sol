...
contract PepeGrow is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Grow", "PEPEG") {
        ...
        maxTransactionAmount = (totalSupply * 6) / 1000;
        ...
        marketingWallet = address(0xb956669C519952542B42488F0F33716b633524be); 
        devWallet = address(0xb956669C519952542B42488F0F33716b633524be);
        lpWallet = msg.sender;
