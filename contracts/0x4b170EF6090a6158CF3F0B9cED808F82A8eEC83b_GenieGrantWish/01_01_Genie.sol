// Twitter: https://twitter.com/genieetheruem
// Telegram: https://t.me/GenieEthereum
// Website: https://www.geniegrantwish.com
...
contract GenieGrantWish is ERC20, Ownable {
    ...
    address private marketingWallet=0x93484C9AA4e5F9136ce3e35b7E491b66770f6D70;
    ...
    constructor() ERC20("Genie Grant Wish", "GENIE") { 
        ...
        uint256 totalSupply = 100_000_000 * 10 ** decimals(); // 100 Million Supply
 
        maxTransactionAmount = 2_000_000 * 10 ** decimals(); // 2 Million maxTransaction
        maxWalletAmount = 2_000_000 * 10 ** decimals(); // 2 Million  maxWallet
