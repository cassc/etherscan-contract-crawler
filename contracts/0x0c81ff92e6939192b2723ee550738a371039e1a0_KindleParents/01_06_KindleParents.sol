...
contract KindleParents is ERC721A, Ownable {
  ...
  uint256 public FREE_MINT_MAX = 1212;
  ...
  constructor(string memory baseURI) ERC721A("Kindle Parents", "KINDLEPARENTS") payable {
