...
contract UniSwitch is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"UniSwitch"; 
    string private constant _symbol = unicode"US"; 
    ...
    address payable private _marketingWalletAddress = payable(0xA64E75b990A5766f54DbF3ec412EBfdc6298A273);
