...
contract StarlinkRepriceTHEWorld  is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Starlink Reprice THE world";
    string private _symbol = unicode"Starlink";
    bool active=false;  
