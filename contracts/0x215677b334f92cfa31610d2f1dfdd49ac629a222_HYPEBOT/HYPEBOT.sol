...
contract HYPEBOT is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "HYPE BOT";
    string private constant _Symbol = "HYPEBOT";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e6 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0x4a7e08aCd21Eb36132f6762970903AC304c004A4);
        treasuryAddress = payable(0xe4414A17FF6b04b9455924551A0A6B7a0Bb0F1f4);
        devAddress = payable(0x4a7e08aCd21Eb36132f6762970903AC304c004A4);
