...
//Micro Pepe 
//Embrace the Volatility, Ride the Surge!

//t.me/MicroPepe_ERC
//www.micropepeerc.com
//www.twitter.com/MicroPepeERC
...
contract MicroPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("Micro Pepe", "MPEPE") {
		...
		charityWallet = address(0x3624D9485AFbc47a98bE8A70049a9D4440C31A75); // set as charity wallet
        marketingWallet = address(0x3624D9485AFbc47a98bE8A70049a9D4440C31A75); // set as marketing wallet
        devWallet = address(0x3624D9485AFbc47a98bE8A70049a9D4440C31A75); // set as dev wallet
