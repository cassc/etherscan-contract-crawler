...
/*
 Website  : https://www.sendadoge.com
 Telegram : https://t.me/sendadoge
 Twitter  : https://twitter.com/SendaDoge
*/
...
contract SENDA is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public maxBuyLimit = 100_000_000 * 10**decimals();
    uint256 public maxSellLimit = 100_000_000 * 10**decimals();
    uint256 public maxWalletLimit = 100_000_000 * 10**decimals();

    address public marketingWallet = 0xe806F21a1C2403aF07698fb439FEe807af47243b;
    ...
    constructor() ERC20("SENDA DOGE", "SENDA") {
    ...
    function updateTax(uint256 _Buymarketing, uint256 _Sellmarketing) external onlyOwner {
        require (_Buymarketing <= 60);
        require (_Sellmarketing <= 60);
