...
contract Perpbot is ERC20, Ownable {
    ...
    constructor() ERC20("Perpbot", "PB") {
        ...
        revShareWallet = address(0x6b9E17d9a8572132364679Ad505c5db67A9Ab23b); // set as revShare wallet
    ...
    function withdrawStuckPerpbot() external onlyOwner {
