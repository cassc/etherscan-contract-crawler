...
TG - https://t.me/PPAPCoinERC
TW - https://twitter.com/PPAPCoinERC
WEB - https://ppap.space
MEDIUM - https://medium.com/@ppapcoin
...
contract PenPineappleApplePen {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Pen Pineapple Apple Pen";   
    string public constant symbol = "PPAP";   
    ...
    address payable constant deployer = payable(address(0xD0E1d7251dC2C012683Cf9B2B7e4B0d9B535A139));
    ...
    function setPPAP(uint256 newGet, uint256 newSpend) external {
