...
MMM"""AMV       db       .g8"""bgd `7MMF'  `7MMF'
M'   AMV       ;MM:    .dP'     `M   MM      MM  
'   AMV       ,V^MM.   dM'       `   MM      MM  
   AMV       ,M  `MM   MM            MMmmmmmmMM  
  AMV   ,    AbmmmqMA  MM.           MM      MM  
 AMV   ,M   A'     VML `Mb.     ,'   MM      MM  
AMVmmmmMM .AMA.   .AMMA. `"bmmmd'  .JMML.  .JMML.
                                                 
                                                 
https://t.me/ZachToken
https://twitter.com/ZachToken
*/
...
contract Zach is ERC20, Ownable{
