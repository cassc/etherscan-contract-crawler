...
// Other Variables
    ...
    string private constant _name = unicode"Testereum"; // Token Name (Editable)
    string private constant _symbol = unicode"TEST"; // Token Symbol (Editable)
    ...
    uint256 private _initialBuyTax = 20; // Initial Buy Tax Percentage (Editable)
    uint256 private _initialSellTax = 99; // Initial Sell Tax Percentage (Editable)
    ...
    uint256 private _reduceBuyTaxAt = 20; // Reduce Buy Tax Threshold (Editable)
    uint256 private _reduceSellTaxAt = 20; // Reduce Sell Tax Threshold (Editable)
    uint256 private _preventSwapBefore = 11; // Prevent Swap Before Threshold (Editable)
    uint256 public _maxTxAmount = 20000000 * 10**_decimals; // Maximum Transaction Amount (Editable)
    uint256 public _maxWalletSize = 20000000 * 10**_decimals; // Maximum Wallet Size (Editable)
