...
TG: https://t.me/carloscoin_portal
Web: https://carloscoin.vip
Twitter: https://twitter.com/Carloscoinerc20

I am the King of Crypto, Carlos!
*/
...
contract Carlos_Coin is ERC20, ERC20Burnable, Ownable, Initializable {
    ...
    constructor()
        ERC20(unicode"Carlos Coin", unicode"CARLOS") 
    {
        address supplyRecipient = 0x73924E1a118d46c4cb522F54717aFdA5572DB719;
        
        updateSwapThreshold(100000000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0xdffB2CfeD72EFAd5D75cd8ed013bbd1c846f0be0);
        ...
        updateMaxTransferAmount(100000000 * (10 ** decimals()) / 10);

        _mint(supplyRecipient, 10000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x73924E1a118d46c4cb522F54717aFdA5572DB719);
    }
