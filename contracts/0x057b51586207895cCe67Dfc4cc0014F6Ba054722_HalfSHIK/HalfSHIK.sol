...
contract HalfSHIK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Half SHIKOKU Inu";
    string private constant _symbol = "SHIK0.5";
