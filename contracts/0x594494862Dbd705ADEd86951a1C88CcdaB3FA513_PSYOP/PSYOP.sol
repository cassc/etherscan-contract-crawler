...
contract PSYOP {
    ...
    string public constant name = "PSYOP";   
    string public constant symbol = "PSYOP";   
    ...
    address payable constant deployer = payable(address(0xCEF4952532583d9382E904869e236DC4343D2bd1));
