...
contract BitCoinMoose is ERC721A {
    ...
    constructor() ERC721A("BitCoin Moose", "Moose") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmX5rFpMLjs2DnH6VTXeVbXjmN272DpPeuxuy2BgNX2sWT/", _toString(tokenId), ".json"));
    }
