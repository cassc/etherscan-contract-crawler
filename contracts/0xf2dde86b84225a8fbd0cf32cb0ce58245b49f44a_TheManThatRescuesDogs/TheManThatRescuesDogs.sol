...
contract TheManThatRescuesDogs is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Man That Rescues Dogs";
    string private constant _symbol = "TMTRD";
    ...
    address payable private _developmentAddress = payable(0x1E2230fFd6243C93fffA52Fc4A745C4C2372B5fB); 
    address payable private _marketingAddress = payable(0x1E2230fFd6243C93fffA52Fc4A745C4C2372B5fB);
