...
contract PackWoodERC1155V2 is ERC1155Upgradeable, OwnableUpgradeable {
    ...
    */
     ...
     */
    function updateCrossMintAddress(address _address, address _child_address) external onlyOwner {
    ...
    */
    ...
    function updateSKTCommunityWallet(
        address _account1,
        address _account2,
        address _account3
    ) external onlyOwner {
        SmartContractCommunity = _account1; // update commuinty wallet
        SmartContractCommunity2 = _account2;
        SmartContractCommunity3 = _account3;
    }
    ...
    */
        ...
        returns (bool)
    {
        ...
        tempValue = feeCalulation(msg.value);
        payable(SmartContractCommunity).transfer(tempValue);
        payable(SmartContractCommunity2).transfer(tempValue);
        payable(SmartContractCommunity3).transfer(tempValue);
        payable(owner()).transfer(msg.value - (tempValue * 3));
