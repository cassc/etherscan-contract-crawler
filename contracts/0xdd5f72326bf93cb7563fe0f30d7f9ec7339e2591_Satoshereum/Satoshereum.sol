...
satoshereum.xyz
https://t.me/Satoshereum
https://x.com/Satoshereum
...
contract Satoshereum is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 210800800000 * 10**_decimals;
    string private constant _name = unicode"Satoshereum";
    string private constant _symbol = unicode"BTC";
    uint256 public _maxTxAmount =   4216016000 * 10**_decimals;
    uint256 public _maxWalletSize = 4216016000 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=4216016000 * 10**_decimals;
