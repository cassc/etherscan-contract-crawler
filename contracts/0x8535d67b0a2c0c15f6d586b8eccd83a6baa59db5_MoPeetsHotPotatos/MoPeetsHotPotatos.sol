...
contract MoPeetsHotPotatos is ERC721r {
    uint256 public MAX_SUPPLY=1000;

    address public Owner = msg.sender;
    constructor () ERC721r("Mopeets Hot Potatos", "MHP", MAX_SUPPLY) {}
    ...
    bool DevelopmentWalletPaid=false;
    ...
    function mintOwnerReserved() external payable{
        require(totalSupply() + 50 <= MAX_SUPPLY, "Not enough tokens left");
        if(ReservedMint==false)
        {
            _mintRandom(msg.sender, 50);
            ReservedMint=true;
        }
    }
