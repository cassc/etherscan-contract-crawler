...
//--- Contract v2 ---//
contract NewShib is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 420_689_000_000_000_000 * 10**9;
    ...
    address payable private marketingAddress = payable(0xAFE96b7930819242c03De73D1Da540D633528756);
    address payable private marketing2Address = payable(0xAFE96b7930819242c03De73D1Da540D633528756);


    IRouter02 public swapRouter;
    string constant private _name = "New Shib";
    string constant private _symbol = "New Shib";
