...
WEBSITE: https://xslots.bet
     
TELEGRAM: https://t.me/XSlotsErc

TWITTER: https://t.me/XSlots_Game_Bot
⠀⠀⠀⠀
...
contract XSlots is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"X Slots";
    string private constant _symbol = unicode"XSLOTS";
    ...
    uint256 public _maxTaxSwap=  70 * (_tTotal/1000);
    ...
    constructor () {
        _taxWallet = payable(0x82aa69165f1781EC514D07402769cfd6A98145c3);
