...
contract FringeWatches is ERC1155, Ownable {
    string public name = "Watches - Fringe Drifters";
    string public symbol = "WFD";
    ...
    function changeCards(string calldata cardName, uint256 cardId)
        external
        onlyOwner
    {
    ...
    function gift(string calldata cardName, address[] calldata receivers)
        external
        onlyOwner
    {
