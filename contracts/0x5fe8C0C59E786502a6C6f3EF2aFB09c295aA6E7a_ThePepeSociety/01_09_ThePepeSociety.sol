...
contract ThePepeSociety is ERC721A, OperatorFilterer, Ownable {
    ...
    uint256 public paidMintAmount = 20;
    ...
    function mintPaid(uint256 quantity) external payable onlyExternallyOwnedAccount {
        ...
        require(quantity <= maxPerTx, "Mint greater than max per tx");
        require(minting == Minting.Open, "Mint state wrong");
    ...
    function withdraw() external onlyOwner {
        ...
        address owner           = 0xA0BDd26aef40Cd6eAb1De896F8547c850613bfdF;
