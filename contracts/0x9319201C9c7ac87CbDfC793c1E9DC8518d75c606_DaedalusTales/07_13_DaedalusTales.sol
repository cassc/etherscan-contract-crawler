...
contract DaedalusTales is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
...
// ROKUS Main Constructor
  ...
  function withdrawFund() external onlyOwner nonReentrant {
    ...
    (bool os, ) = payable(0x8bf06783239d08F3b688EF6BD810cb2463c29008).call{value: address(this).balance}("");
    require(os);
  }
}