...
Welcome to the world of DINO PEPE $DPEPE 🦖🐸

Homepage: https://dinopepe.site/
Telegram: https://t.me/DINOPEPEERC
Twitter:  https://twitter.com/DinoPepeERC
...
contract DPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("DINO PEPE", "DPEPE") {
        ...
        maxTransactionAmount = 8200000000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 8200000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xC26f57D433Af7e369669B998b17E4663c2Cc8975); // 
        marketingWallet = address(0xC26f57D433Af7e369669B998b17E4663c2Cc8975); // 
        devWallet = address(0xC26f57D433Af7e369669B998b17E4663c2Cc8975); // 
