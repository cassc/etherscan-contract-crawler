...
contract EternalFlame is Context, IERC20, Ownable {
    ...
    string private _name = "Eternal Flame";
    string private _symbol = "FLAME";
    uint8 private _decimals = 18;
    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) private _allowances;

    address payable private devMarketingWallet = payable(0xe7112d40fc68DF0957D6c483E1EdFb94b998629C);
    ...
    uint256 public _walletMax = 2 * 10**4 * 10**18;
    uint256 private minimumTokensBeforeSwap = 2 * 10**3 * 10**18;
...
constructor () {
    ...
    function adjustMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1 * 10**6 * 10**18), "Max wallet should be less");
