...
//  * INSTRUCTIONS:
//  * Each symbol in the output corresponds to a cell, and there are 32x32 cells arranged in a square grid.
...
contract EthGlyphs is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public TOKEN_LIMIT = '512';
  string public PRICE = '.015';
