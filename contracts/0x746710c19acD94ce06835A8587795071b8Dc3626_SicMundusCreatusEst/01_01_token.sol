...
contract SicMundusCreatusEst is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Sic Mundus Creatus Est";
    string private constant _symbol = unicode"SMCE";
