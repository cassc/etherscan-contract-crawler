...
contract ZOOMERV2 is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ZOOMER2.0";
    ...
    address payable private _developmentAddress = payable(0xF4b113A1A09aFB59fF75c83d3a7D7ecC6c399FAf); 
    address payable private _marketingAddress = payable(0xF4b113A1A09aFB59fF75c83d3a7D7ecC6c399FAf);
