...
contract PewPew is Context, IERC20, Ownable {
    ...
    string private constant _name = "PewPew"; 
    string private constant _symbol = "PewPew";
    ...
    Tax public buyTax = Tax(3,0);
    Tax public sellTax = Tax(3,0);
    
    address public marketingWallet = 0x5d7e082B54baFF34c2751aF4261ad26F9073AD8d;
