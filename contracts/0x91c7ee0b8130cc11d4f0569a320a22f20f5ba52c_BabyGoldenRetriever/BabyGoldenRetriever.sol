...
// File: BabyGoldenRetriever.sol


// 2% of every transaction gets sent to $GLDN deployer/wallet to support our Golden Daddy.


// https://t.me/BabyGoldenRetriever

// https://twitter.com/BabyGoldenEth
...
contract BabyGoldenRetriever is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby Golden Retriever", "BGLDN") {
        ...
        devOpsWallet = address(0xC233bc76617a89293F5f75B930203c51EBcf9D82); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xC233bc76617a89293F5f75B930203c51EBcf9D82), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xC233bc76617a89293F5f75B930203c51EBcf9D82), true);
