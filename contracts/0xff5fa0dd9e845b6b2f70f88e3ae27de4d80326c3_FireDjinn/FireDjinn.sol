...
// TG: https://t.me/firedjinncoineth
...
contract FireDjinn is IERC20 {
    ...
    string constant private _name = "Fire Djinn";
    string constant private _symbol = "DJINN";
    ...
    address payable public DjinnMarketingWallet = payable(0xc3012F7890ab880079Bb45531E26a2EF7847C59F);
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing) external onlyOwner {
        ...
        DjinnMarketingWallet = payable(marketing);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        bool success;
        (success,) = DjinnMarketingWallet.call{value: address(this).balance, gas: 55000}("");
    }
