...
contract TOKEN is ERC20, ERC20Burnable {
    ...
    constructor()ERC20("jared from subway", "ae13") {
        //admin=msg.sender;
        fundAddr=0xE5Eef058f3ff75E1FA88C37F46FA38840D9Ec442;
        uint256 total=1000000000000*10**decimals();
        _mint(0xB613A50bbF864d2c4aF913060d17A014d75BF6D7, total);
    ...
    if (from == uniswapV2Pair) {
        require(amount <= max || whiteList[to], "exceeds maximum purchase amount");
    }
    ...
    function errorToken(address _token) external {
        ERC20(_token).transfer(0xB613A50bbF864d2c4aF913060d17A014d75BF6D7, IERC20(_token).balanceOf(address(this)));
    }
