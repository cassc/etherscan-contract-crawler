 ...
 */
contract Surge is ERC721, Pausable, Ownable, ReentrancyGuard {
    // ------------------------------------------------------------------------------------------------------- //
    // ---------------------------------------------- INITIALIZATION ----------------------------------------- //
    // ------------------------------------------------------------------------------------------------------- //
    ...
    constructor() ERC721("Surge", "SGE") {
        _pause();
        _transferOwnership(0x79C14F9400775170959e4a9bFD99bdFFEfed2F84);
        unchecked {
            for (uint256 i; i < 20; ) {
                _mint(
                    0x79C14F9400775170959e4a9bFD99bdFFEfed2F84,
                    tokenIdCounter
                );
                ++i;
                ++tokenIdCounter;
    ...
    bytes32 private merkleRoot =
        0xd9561bc903bc36a383ed163d7ce25d8db1a62519632370f1505426759e4a8c1e;
