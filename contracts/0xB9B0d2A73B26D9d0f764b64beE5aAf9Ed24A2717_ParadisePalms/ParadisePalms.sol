...
contract ParadisePalms is Context, IERC20, Ownable {
  ...
  uint256 private _totalSupply = 1000000000 * 10**2;
  string private _symbol = "PPALM";
  string private _name = "Paradise Palms";
