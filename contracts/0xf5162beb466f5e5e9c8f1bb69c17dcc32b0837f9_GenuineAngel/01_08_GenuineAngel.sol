...
contract GenuineAngel is ERC721A, Ownable, ReentrancyGuard {
  ...
  // ~~~~~~~~~~~~~~~~~~~~ Mint Functions ~~~~~~~~~~~~~~~~~~~~
     ...
     function SummonGood(uint256 amount) external payable {
 ...
 function sacrificeGood(uint _cost) public onlyOwner {
    cost = _cost;
  }

  function goodRitual(uint _cost) public onlyOwner {
    cost = _cost;
  }
