...
https://t.me/DogeShrekEth

Doge Shrek is one the biggest coin on DogeChain with 24 hour volume of 800k
This is an ETH chain version of DogeShrek with same Tokenomics.
...
contract DogeShrek is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeShrek";
    string private constant _symbol = "DogeShrek";
