...
/*
  ________  ___ ___ ________    __________________________________  _________ ___________
 /  _____/ /   |   \\_____  \  /   _____|__    ___|_   _____/  _  \ \_   ___ \\_   _____/
/   \  ___/    ~    \/   |   \ \_____  \  |    |   |    __)/  /_\  \/    \  \/ |    __)_ 
\    \_\  \    Y    /    |    \/        \ |    |   |     \/    |    \     \____|        \
 \______  /\___|_  /\_______  /_______  / |____|   \___  /\____|__  /\______  /_______  /
        \/       \/         \/        \/               \/         \/        \/        \/ 
*
*     Website:      https://www.Ghostfacecult.xyz
*     Twitter:      https://twitter.com/ghostfaceDAO
*     Telegram:     https://t.me/ghostfaceETHporta
*      TIC-TOK:     https://tictok.com/@ghostfacecultdao  tictok hashtag #ghostfacecult
*     KILLA DEV WAS HERE
*/
...
contract GHOSTFACE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GhostFace Cult.DAO", "GHOSTFACE") {
    ...
    function updateSellFees(uint256 _daoFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellDaoFee, uint256 _earlySellDevFee) external onlyOwner {
        sellDaoFee = _daoFee;
