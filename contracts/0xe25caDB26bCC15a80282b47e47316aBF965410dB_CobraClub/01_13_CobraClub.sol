 ...
 */
contract CobraClub is ERC721AQueryable, ERC721ABurnable, Ownable {
    ...
    string public hiddenURI =
        "ipfs://bafybeif4ryliatvxzcfygmdgij23mi6j7zar3sscyqak2fmuodv6shezgu/prereveal.json";
    ...
    constructor() ERC721A("Cobra Club", "CC") {
    ...
    function withdraw() public onlyOwner {
        ...
        (bool s1, ) = dev.call{value: amount.mul(ONE_PERCENT * 20)}("");
        (bool s2, ) = treasury.call{value: amount.mul(ONE_PERCENT * 80)}("");
        if (s1 && s2) return;
        // fallback
