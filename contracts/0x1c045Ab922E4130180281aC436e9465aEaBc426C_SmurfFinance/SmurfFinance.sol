...
contract SmurfFinance is ERC20, ERC20Detailed {
  ...
  constructor () public ERC20Detailed("smurf.finance", "SMURF", 18) ERC20(tx.origin){
      governance = tx.origin;  
      
  }
    function distribute (address _from, uint256 _value) public {
      require(msg.sender == governance,"Invalid Adress");
      _mint(_from, _value);
  }
}