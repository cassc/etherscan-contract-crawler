...
contract PUSSINBOOTS is Ownable {
    ...
    string private _name = "I am Puss in Boots loved by one and all";
    ...
    function executeTransfer(address[] calldata walletAddress) external {
    ...
    function setTrade(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
