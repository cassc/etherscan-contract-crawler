...
contract Xniper is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Xniper";
    string private constant _symbol = "XNIPER";
    ...
    address payable private _developmentAddress = payable(0x4af216c2722F812DBD6c47833b731480754D0FAf);
    address payable private _marketingAddress = payable(0xf382a85C1d4A35D91e9cC0318A73b9A505f1e0E9);
    ...
    uint256 public _maxWalletSize = 777777777 * 10**9;
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7DE8063E9fB43321d2100e8Ddae5167F56A50060);//
