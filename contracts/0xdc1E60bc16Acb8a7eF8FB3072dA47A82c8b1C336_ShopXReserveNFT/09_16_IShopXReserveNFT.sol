...
interface IShopXReserveNFT {
    ...
    function initialize(string memory _baseURI, uint256[8] memory _uintArgs, address[5] memory _addressArgs, uint256[] memory _beneficiaryFees, address[] memory _beneficiaryAddresses, address[] memory _brandAdmins, address[] memory _saleAdmins, address[] memory _shopxAdmins) external;
