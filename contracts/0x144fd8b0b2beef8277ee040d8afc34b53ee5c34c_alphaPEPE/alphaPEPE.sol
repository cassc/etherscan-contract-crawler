...
This is an invitation to a discussion about the evolving meme coin space. 
More specifically, it’s about the sad spectacle we’ve seen unfold with the 
derivative, lazy, soulless spawn of the original Pepe coin that have been 
popping up like flies around trashcan devs.

Here’s the reality: in a world full of beta Pepes, it’s the Alpha Pepe that 
stands tall.

If being an alpha means standing up for originality, for creativity, and for 
revolution in a world that’s comfortable with repetition, then so be it.

// www.alpha-pepe.vip
// t.me/aPEPE_PORTAL
// medium.com/@alpha_pepe
...
contract alphaPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("ALPHA PEPE", unicode"αPEPE") {
        ...
        maxBuyAmount = totalSupply * 16 / 100; // 1.6% maxBuyAmount
        maxSellAmount = totalSupply * 16 / 100; // 1.6% maxSellAmount
        maxWalletAmount = totalSupply * 16 / 100; // 1.6% maxWallet
        ...
        marketingWallet = address(0xB2352a22c817Ad6C05c86aCE7bb762418861bBC9);
        developmentWallet = address(0xB2352a22c817Ad6C05c86aCE7bb762418861bBC9);
