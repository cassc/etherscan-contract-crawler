...
interface IRouter {
 ...
 contract ELON52 is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1000000 * 10**18; // 0.1%
    uint256 public MaxTxAmount = 20000000 * 10**18; // 1%
    uint256 public MaxWalletSize = 20000000 * 10**18; // 1%
    
    address public marketingWallet = 0xd38b76412B05b2315ecDAcEF060274B306C253c6;
    ...
    constructor() ERC20("ELON52", "ELON52") {
