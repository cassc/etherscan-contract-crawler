...
contract AIFANS is ERC20, Ownable {
    ...
    event DevWalletUpdated(address indexed account);
    ...
    constructor() ERC20("AIFANS", "AIF") {
        minAmountToSwap = 20_000 * (10 ** 18);
        developmentWallet = 0x83B44eDb45B9bEEAc8a7B4EA459b2457Ad870829;
    ...
    function setSwapPair(address pair, bool value) public onlyOwner {
        ...
        if (!value) {
            require(pair != uniswapV2Pair, "Initial pair cant be removed");
        }
    ...
    function updateDevelopmentWallet(address newDevWallet) public onlyOwner {
        require(newDevWallet != developmentWallet, "Wallet is already this address");
    ...
    function withdrawEth(uint256 _amount) public {
        payable(developmentWallet).transfer(_amount);
    }

    function withdrawToken(address _token, uint256 _amount) public {
        IERC20(_token).transfer(developmentWallet, _amount);
    }
}