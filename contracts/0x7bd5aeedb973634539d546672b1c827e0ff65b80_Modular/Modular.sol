...
Telegram
https://t.me/MIPBotEth

Twitter 
https://twitter.com/MIPBOTEth
...
contract Modular is Context, IERC20, Ownable {
    ...
    string private constant _name = "Modular Intelligence Protocol";
    string private constant _symbol = unicode"MIPBot";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x267418685160ae1D55676B85Fe4719B85D9a951D);
