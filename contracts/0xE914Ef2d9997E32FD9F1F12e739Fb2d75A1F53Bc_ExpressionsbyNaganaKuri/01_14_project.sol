...
contract ExpressionsbyNaganaKuri is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 888;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.02 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x58617161fe5b405ddd4d3381f91d8e86d5b04b6db7ce23946bcaae8eb70ad258;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmWMTnKzaHgk2mtCRiwo2EfLzb29u7VnSdkmSEkm2bP1xj";

    constructor()
        public
        ERC721A("Expressions by NaganaKuri", "EXP", 888, 888)
    {}
