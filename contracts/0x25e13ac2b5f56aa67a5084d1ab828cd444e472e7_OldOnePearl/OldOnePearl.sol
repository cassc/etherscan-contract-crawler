...
contract OldOnePearl is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Old One Pearl";
    ...
    address payable private _developmentAddress = payable(0xF3a363CEba5a82EEbE8804b76c06FF44Eb18bC14); 
    address payable private _marketingAddress = payable(0xF3a363CEba5a82EEbE8804b76c06FF44Eb18bC14);
