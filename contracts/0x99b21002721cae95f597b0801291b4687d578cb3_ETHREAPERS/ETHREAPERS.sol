...
---------- www.ethereumreapers.com ------------------
------- www.twitter.com/ethreapers ---------
---------- t.me/ethreapers ---------------------
...
contract ETHREAPERS is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(address(0xbAf040eBB61328C7502a4df2c9Af249b4d2632da));

    string private _name = "ETHREAPERS";
    string private _symbol = "REAPERS";
