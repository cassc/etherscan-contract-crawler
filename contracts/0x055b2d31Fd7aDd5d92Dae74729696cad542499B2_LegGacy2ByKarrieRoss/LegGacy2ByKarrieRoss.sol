...
contract LegGacy2ByKarrieRoss is ERC721A, Ownable, ERC2981 {
    uint256 public price = .035 ether;
    ...
    uint256 public immutable presaleSupply = 450;
    uint256 public immutable supply = 450;
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0x3B56DbE583314fD598F0045E146226a070b03963];
    uint256[] public withdrawPercentages = [5, 95];

    bytes32 public merkleRoot = 0xbedf813fcb42bc0aec460e6eac301bee760930f4ee5fc18146c87581768f9e08;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x3B56DbE583314fD598F0045E146226a070b03963, _royaltyAmount);
    }
