...
contract PEPELITE is ERC20, Ownable {
    ...
    constructor() ERC20("PEPE LITE", "PEPELITE") payable {
    	...
    	marketingWallet = address(0x6491D8E66A05550bB4Fe5c76E37953d53491787D); // set as Marketing wallet
        devWallet = address(0xe50Ea847A611026F9B4DfA929846E3Aad0d3Ca56); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x6491D8E66A05550bB4Fe5c76E37953d53491787D, true);
        excludeFromFees(0xe50Ea847A611026F9B4DfA929846E3Aad0d3Ca56, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x6491D8E66A05550bB4Fe5c76E37953d53491787D, true);
        excludeFromMaxTransaction(0xe50Ea847A611026F9B4DfA929846E3Aad0d3Ca56, true);
        
        /*
            _createInitialSupply is an internal function that is only called here,
            and CANNOT be called ever again
        */
        _createInitialSupply(0xe50Ea847A611026F9B4DfA929846E3Aad0d3Ca56, totalSupply*8/100);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xe50Ea847A611026F9B4DfA929846E3Aad0d3Ca56,
            block.timestamp
        );
    }
