...
contract FOURFOURTENETS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SHYTOSHIOBAMASONIC10INU";
    string private constant _symbol = unicode"44TENETS";
