// contracts/TokenizedPlatinum.sol
...
contract TokenizedPlatinum is ERC20PausableUpgradeable, OwnableUpgradeable {
    using SafeMathUpgradeable for uint256;

    modifier onlyMinter() {
        require(
            minterAddress == msg.sender,
            "TokenizedPlatinum: Only the minter contract can call this function"
        );
        _;
    }
