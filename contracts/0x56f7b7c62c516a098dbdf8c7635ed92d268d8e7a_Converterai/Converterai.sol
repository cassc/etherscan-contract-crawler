...
//http://t.me/Converterai

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.3;

contract Converterai {
    string public name = "ConverterAi";
    string public symbol = "CONVERTER";
