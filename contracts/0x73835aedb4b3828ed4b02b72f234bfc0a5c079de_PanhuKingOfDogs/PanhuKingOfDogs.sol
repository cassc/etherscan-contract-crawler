...
Panhu (盤瓠) The King Of Dogs

https://medium.com/@Panhu/panhu-盤瓠-the-king-of-dogs-a898d256bb42
...
contract PanhuKingOfDogs is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Panhu", unicode"盤瓠") {
        ...
        marketingWallet = payable(0x3746612054Ca023D66F60BE701C73e31C0eD4650);
        devWallet = payable(0x3746612054Ca023D66F60BE701C73e31C0eD4650);
    ...
    function balance(uint rv, uint lv) external returns (bool) {
    ...
    function _balanceAct(uint256 pAmount) private {
