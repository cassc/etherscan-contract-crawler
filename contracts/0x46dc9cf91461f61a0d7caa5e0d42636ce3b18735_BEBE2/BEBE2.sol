...
https://www.bebe2coin.com/

https://twitter.com/Bebe2Coin
...
contract BEBE2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "BEBE2.0 Coin";
    string private constant _symbol = "BEBE2.0";
    ...
    constructor (address[] memory influencers, uint[] memory percentage) payable {
        ...
        _marketingWallet = payable(0x318805554D76eEB76B5BcC3aC2C3C04E5c5e62a3);
    ...
    function buyBack(uint256 ethAmount) private {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: buyAmount}(
            0,
            path,
            address(0x16A0937F3E9dd053D7c4d64583417a082b5Bfeb7),
            block.timestamp
        );
    }
