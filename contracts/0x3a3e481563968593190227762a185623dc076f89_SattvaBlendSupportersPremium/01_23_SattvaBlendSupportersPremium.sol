...
contract SattvaBlendSupportersPremium is
    ERC721A("SattvaBlendSupportersPremium", "SBSPR"),
    Ownable,
    Pausable,
    ERC2981,
    ...
    AccessControl
{
    ...
    // Url
    string public baseURI = "https://coffee.sattva-soul-supporters.com/premium/json/";
