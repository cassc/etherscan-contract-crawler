...
contract Unibet is ERC20, Ownable {
    ...
    constructor() ERC20("Unibet", "$$$") {
        ...
        marketingWallet = payable(0x14dA6Afd160C57B99130B407239a27EC3fff7a47); // set as marketing wallet
        devWallet = payable(0x14dA6Afd160C57B99130B407239a27EC3fff7a47); // set as dev wallet
