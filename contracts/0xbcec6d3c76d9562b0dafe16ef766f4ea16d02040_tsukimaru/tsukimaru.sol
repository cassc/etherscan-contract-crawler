...
contract tsukimaru is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 30000 / 1000000;
    uint256 public _walletMax = _totalSupply * 30000 / 1000000;
    ...
    string constant _name = "Tsukimaru";
    string constant _symbol = "TSUKI";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x13e7FDe3e597De13D1aBef7BDcC18f0A8d25e3ba;
        marketingWallet = 0x20C8B7040c67e426C2740f80547DEEEA13BBF0A5;
        devWallet = 0x13e7FDe3e597De13D1aBef7BDcC18f0A8d25e3ba;
