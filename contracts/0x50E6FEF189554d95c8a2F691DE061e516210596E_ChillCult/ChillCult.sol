...
$CCULT is a tradable and liquid token built to do chill, 
transacting $CCULT will be contributing to the CHILL protocol by filling the CHILL treasury slowly, 
to fund investments into decentralised CHILLED technologies and reward the CHILL investors with the returns of these investments. 
This is SUPERCHILL due to a 5% tax on all $CCULT transactions and used for weed to chill(marketing),weapons to chill (listings) and weed parties (giveaways).
...
contract ChillCult is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xA2F04922C10224e672786513C97Dbc6326390738);
    address payable private _marketingAddress = payable(0xA2F04922C10224e672786513C97Dbc6326390738);
