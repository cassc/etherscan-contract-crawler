...
contract PEPEPUTIN is ERC20, ERC20Burnable, Pausable, Ownable {
    using SafeMath for uint256;
    uint256 private _maxCap = 195210719455900 * 10**decimals();

    bool public isAntiBot;
    uint256 public maxBuy = 195210719455900 * 10**decimals();
    uint256 public maxSell = 195210719455900 * 10**decimals();
