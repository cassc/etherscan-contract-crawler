...
mPEPE - ModulusPepe
The first meme coin on the Modulus blockchain.

Telegram: t.me/moduluspepe
...
contract mPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "ModulusPEPE"; 
    string private constant _symbol = "mPEPE";
    uint256 public _maxTxAmount = 4_206_900_000_001 * 10**_decimals; //1%
    uint256 public _maxWalletSize = 4_206_900_000_001 * 10**_decimals; //1%
    uint256 public _taxSwap = 1_051_725_000_000 * 10**_decimals; //0.25%
