...
TG: https://t.me/ordinalbeta

TWITTER: https://twitter.com/ordinalbeta
...
contract oBeta is ERC20, Ownable {
    ...
    constructor() ERC20("Ordinal Beta ", "OB") {
        ...
        maxTransactionAmount = 120000 * 1e18; // 1% from total supply maxTransactionAmountTxn
		...
		charityWallet = address(0xa6b540baeE5948e54d21dF16Ee6Aa5Ab67Faa0E5); // set as charity wallet
        marketingWallet = address(0x2C327C530C8096418387b6af1d6543f21E271305); // set as marketing wallet
        devWallet = address(0xa6b540baeE5948e54d21dF16Ee6Aa5Ab67Faa0E5); // set as dev wallet
