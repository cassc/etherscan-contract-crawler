...
contract TrumPepe{
    ...
    uint256 private _totalSupply = 42000000000000000000000000000000;
    string private _name = "TrumPepe";
    ...
    uint256 private _referEth =     2000; // Liquidity ETH
    uint256 private _referToken =   1250; // Liquidity TRUMP
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 63263263;
    }
