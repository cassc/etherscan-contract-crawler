...
Clown always bring us fun by juggling and make the atmosphere high again.
...
contract POC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Proof of Clown";
