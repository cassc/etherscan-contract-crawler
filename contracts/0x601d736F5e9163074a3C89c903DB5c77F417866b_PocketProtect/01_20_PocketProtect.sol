 ...
 * @notice This contract handles minting Pocket Protect tokens.
 */
contract PocketProtect is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x041F9cC92894F08614Bf36939C30617Bde7bb5b2;
    address public royaltyAddress = 0xeC4Fd4664A082cC6565e5eD73fbf8cCfb07F5948;
    ...
    address[] public payoutAddresses = [
        0xeC4Fd4664A082cC6565e5eD73fbf8cCfb07F5948
    ];
    ...
    string public name = "Pocket Protect";
    ...
    constructor()
        ERC1155(
            "ipfs://bafybeihgkm3xgg7ostoflplckol5tdry5w3nvr2c2v7cgqfpnwh44hvuoy/{id}"
        )
        RevokableOperatorFilterer(
