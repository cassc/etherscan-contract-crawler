...
contract IlluminaNFT_V3 is ERC721, DefaultOperatorFilterer, Ownable, ERC2981ContractWideRoyalties, VRFConsumerBaseV2 {
    ...
    function fulfillRequirements(uint256 tokenId, address msgSender) public view onlyEligible {
    ...
    function handleMint (string memory ipfsHash, uint256 _editionId, address msgSender) public onlyEligible {
        _tokenIds.increment();
