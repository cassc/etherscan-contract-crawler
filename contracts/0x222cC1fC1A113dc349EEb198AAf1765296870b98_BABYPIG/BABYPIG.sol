...
contract BABYPIG is ERC20, ERC20Burnable, Ownable {
    uint256 private constant INITIAL_SUPPLY = 420690000000 * 10**18;

    constructor() ERC20("Baby Pig Coin", "BABYPIG") {
