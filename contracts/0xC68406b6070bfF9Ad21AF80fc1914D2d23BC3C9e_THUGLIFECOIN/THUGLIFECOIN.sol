...
contract THUGLIFECOIN is ERC20, Ownable {
    ...
    constructor() ERC20("Thug Life", "THUG") {
        ...
        uint256 totalSupply = 69999999999 * 1e18;

        maxTransactionAmount = 699999999 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 699999999 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xF580623A0E70Ea1945304C429D23c66e9Cb33d98); // set as charity wallet
        marketingWallet = address(0xF580623A0E70Ea1945304C429D23c66e9Cb33d98); // set as marketing wallet
        devWallet = address(0xF580623A0E70Ea1945304C429D23c66e9Cb33d98); // set as dev wallet
