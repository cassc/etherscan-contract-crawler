...
contract TiffMutantApe is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint;

    string  public baseTokenURI = "https://bafybeidanpumqpvmpgmwaihaevkavb5ax7a5folftmnpdazvxswz52vtrm.ipfs.nftstorage.link/metadata-tiff-mayc";
    ...
    constructor() ERC721A("TiffMutantApe", "TMAYC") {}
