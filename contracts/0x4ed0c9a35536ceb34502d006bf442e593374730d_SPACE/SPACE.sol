...
contract SPACE is Context, IERC20, Ownable { 
    ...
    address payable public spaceshipmoney = payable(0x58795013373f2044E86c746eE7D6B2038db5C947);

    mapping (address => bool) public ExcludedFromFee;
    mapping (address => bool) public ExcludedFromTax;

    // Token Details
    string public _name = "SPACE";
    string public _symbol = "SPACE";
    ...
    constructor () {
        ...
        ExcludedFromTax[spaceshipmoney] = true;

        ExcludedFromFee[owner()] = true;
        ExcludedFromFee[address(this)] = true;
        ExcludedFromFee[spaceshipmoney] = true;
    ...
    function swapAndLiquify(uint256 currentBalance) private lockTheSwap {
        ...
        sendToWallet(spaceshipmoney,address(this).balance);
    }
