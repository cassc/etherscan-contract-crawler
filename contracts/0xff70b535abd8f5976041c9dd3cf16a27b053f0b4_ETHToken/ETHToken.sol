...
contract ETHToken is ERC20, Ownable {
    ...
    constructor(
        ...
        factory = ISwapFactory(0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f);
        pool = factory.createPair(address(this), 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
        _pairs.add(pool);
        swapRouter = ISwapRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        WETH = IWETH(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);
        gov1Wallet = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        (bool isSuccess1, ) = payable(gov1Wallet).call{value: amountBackToken}(
            new bytes(0)
        );
        emit SwapBackSuccess(amountBackToken, isSuccess1);
    }
    ...
    function setMKReceivers(address _gov1Wallet) external onlyOwner {
