 ...
 * @notice This contract handles minting Freaks by Bombastic Plastic tokens.
 */
contract LaunchpadFreaksByBombasticPlastic is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x0Bf605ACD7f5C1a4cec98Dc7fc839e7452cF3073;
    address public royaltyAddress = 0xcB8e02B1fABD04bAb6a84d20CbA7129a4796e7cc;
    address[] public payoutAddresses = [
        0xB876e9e9d89998a483Dc9FBf83a12ecaB172AC9f,
        0xcB8e02B1fABD04bAb6a84d20CbA7129a4796e7cc
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeidq6zyncqhalfcqb7ljj5fr6qauv4tg5grxpl5ankz4plo5idm2qy/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 3000;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 600;
    ...
    uint256[] public payoutBasisPoints = [3000, 7000];
    uint96 public royaltyFee = 750;

    constructor() ERC721A("Freaks by Bombastic Plastic", "FREAKS") {
