...
woof woof barkbark, arf woof bark arf woof arf woof ruff, woof bark bark woof bark, grrr bark bark.
...
contract HIDEAKI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Hideaki Inu";
    string private constant _symbol = unicode"HIDEAKI";
