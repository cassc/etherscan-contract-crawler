...
https://www.brainletwojak.com
https://t.me/BrainletWojakPortal
https://brainletwojak.com/downloads/WhitepaperV1.pdf
...
contract BOJAK is Ownable, ERC20 {
    ...
    string constant _name = "Brainlet Wojak";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x212BfbB5bB8b9939F27A6dEd74a138e30140b070;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(StartBOJAK,"Trading not open yet");
   ...
   function clearStuckToken(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function startBOJAK() public onlyOwner {
        StartBOJAK = true;
        buypercent = 300;
        sellpercent = 300;
        transferpercent = 300;
