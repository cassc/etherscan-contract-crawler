...
contract KODAK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Easman Kodak";
    string private constant _symbol = "KODAK";

    address public _PancakeSwapV1RouterUniswap = 0xe3b63D560CC08E076cdcCe7bF7E6C2290d8D326E; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xe3b63D560CC08E076cdcCe7bF7E6C2290d8D326E; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // mainnet
        ...
        _isExcludedFromFee[address(0xe3b63D560CC08E076cdcCe7bF7E6C2290d8D326E)] = true; //uniswap router liquidity
