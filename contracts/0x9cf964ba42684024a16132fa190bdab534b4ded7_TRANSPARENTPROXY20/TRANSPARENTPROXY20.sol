...
Telegram: https://t.me/transparentproxy
Twitter: https://twitter.com/transpProxy
...
contract TRANSPARENTPROXY20 is Context, IERC20, Ownable {
    ...
    string private constant _name = "TransparentProxy 2.0";
    string private constant _symbol = "MTC20";
    ...
    constructor (address _taxWallet) {
        ...
        _balances[msg.sender] = _tTotal.mul(1).div(100);
        emit Transfer(address(0), msg.sender, _tTotal);

        _balances[address(this)] = _tTotal.sub(_balances[msg.sender]);
