...
/*
Telegram: t.me/+my2kv8_Z_B4yMzNk
Twitter: twitter.com/ZACUCK_ERC
*/
...
contract ZACUCK is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "ZACUCK";
    string private constant _symbol = "ZACUCK";
    ...
    address payable private _developmentAddress = payable(0xc0B41c8e5A03F069F102Bc627053B6A993B0D8df);
    address payable private _marketingAddress = payable(0xc0B41c8e5A03F069F102Bc627053B6A993B0D8df);
    ...
    uint256 public _maxTxAmount = 8400001 * 10**9;
    uint256 public _maxWalletSize = 8400001 * 10**9;
