...
contract HAKUNA is ERC20, Ownable {
    ...
    constructor() ERC20("HAKUNA", "MATATA") payable {
    	...
    	marketingWallet = address(0x03BF78f43877CC20eF65BE4f704323a5c1Ee00Bd); // set as Marketing wallet
        devWallet = address(0x03BF78f43877CC20eF65BE4f704323a5c1Ee00Bd); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x03BF78f43877CC20eF65BE4f704323a5c1Ee00Bd, true);
        excludeFromFees(0x03BF78f43877CC20eF65BE4f704323a5c1Ee00Bd, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x03BF78f43877CC20eF65BE4f704323a5c1Ee00Bd, true);
        excludeFromMaxTransaction(0x03BF78f43877CC20eF65BE4f704323a5c1Ee00Bd, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x03BF78f43877CC20eF65BE4f704323a5c1Ee00Bd,
            block.timestamp
        );
    }
