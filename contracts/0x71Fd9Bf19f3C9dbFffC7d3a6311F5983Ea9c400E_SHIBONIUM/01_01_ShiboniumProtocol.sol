...
-----------------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------- 
http://www.shibonium.com

https://medium.com/@shibonium

The first DeFi protocol helping you become a Shibarium validator -  accumulate $Bone - Shibarium gas token & be ready for Shibarium launch

Read our story in our website: "Shibarium, Bone, and the Layer 2 Paradox: What it Means for the Future of Blockchain" 
-----------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0x9813037ee2218799597d83D4a5B6F3b6778218d9)); // Bone
...
contract SHIBONIUM is ERC20, Ownable {
    ...
    constructor() ERC20("ShiB0nium Prot0col", "Shib0nium") {

        uint256 totalSupply = 100 * 1e6 * 1e18;
        
        maxTransactionAmount = totalSupply * 15 / 1000; // 1.5% maxTransactionAmountTxn
        swapTokensAtAmount = totalSupply * 10 / 10000; // 0.10% swap tokens amount
 ...
 // Set launch mode
    ...
    function launchPhase(bool _launch) external onlyOwner {
        if(_launch) {
            rewardsBuyFee = 50;
            operationsBuyFee = 50;
            liquidityBuyFee = 0;
