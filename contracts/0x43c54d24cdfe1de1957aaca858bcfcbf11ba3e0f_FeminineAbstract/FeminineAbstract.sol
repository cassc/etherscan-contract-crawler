...
// File @openzeppelin/contracts/utils/Add[email protected]
...
contract FeminineAbstract is ERC721A, Ownable, ERC2981, OperatorFilterer {
    uint256 public price = 0.0017 ether;
    uint256 public presalePrice = 0.0017 ether;
    uint256 public maxPerWallet = 10;
    uint256 public maxPerTransaction = 10;
    uint256 public presaleMaxPerWallet = 10;
    uint256 public presaleMaxPerTransaction = 10;

    uint256 public immutable presaleSupply = 567;
    uint256 public immutable supply = 567;
    ...
    address[] public withdrawAddresses = [0x668F06F4e9B9FB6838E66fE923a653F07B4aF24c, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0xaa039d0a4b4555b0f9727382cb139468c3a98ab48917c8df2d1d9853b91e87f0;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x668F06F4e9B9FB6838E66fE923a653F07B4aF24c, _royaltyAmount);
    }
