...
contract NUMBER1PROTOCOL is Context,IERC20, Ownable{
    ...
    uint256 private _totalSupply = 1_111_111_111 * 10**_decimals; //1B supply
    ...
    address _owner;
    address payable public marketingAddress = payable(0x065c760ec93a47Cc75898d99AA50614dD554Cc07);
