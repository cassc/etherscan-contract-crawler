...
contract CHEEMS is ERC20, Ownable {
    ...
    constructor() ERC20("CHEEMS", "CHEEMS") {
        ...
        uint256 totalSupply = 1000000000000 * 1e18; // Total Supply
        ...
        marketingWallet = address(0x633A9A821E6Ef69044D47DB931d40370f13A1e60); 
        devWallet = address(0x633A9A821E6Ef69044D47DB931d40370f13A1e60);
        lpWallet = msg.sender;
