...
https://dapp.baked.quest/
https://twitter.com/BakedCoinErc
http://t.me/BakedCoinErc
...
contract BAKED is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baked Coin";
    string private constant _symbol = "BAKED";
    ...
    uint256 _totalSupply = 4200000000 * 10**9;
    ...
    address payable private _marketingAddress = payable(0x6Aa7A93FE6BBCf7a1632667d2835371D9C7d317c);
    ...
    uint256 public _maxTxAmount = 42000000 * 10**9; //0.75
    uint256 public _maxWalletSize = 42000000 * 10**9; //1.5
