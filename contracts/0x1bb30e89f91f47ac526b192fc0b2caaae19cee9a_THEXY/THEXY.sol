...
contract THEXY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xc74171f96b339F80dBe01C4e8ea0b279AE9153d3); // Marketing Address
    address payable public multiSigAddress = payable(0xc74171f96b339F80dBe01C4e8ea0b279AE9153d3); // Marketing Address
    address payable public devAddress = payable(0xc74171f96b339F80dBe01C4e8ea0b279AE9153d3); // Dev Address
    address payable public liquidityAddress = payable(0xc74171f96b339F80dBe01C4e8ea0b279AE9153d3); // Liquidity Address
    ...
    string private constant _name = unicode"THEXY";
    string private constant _symbol = unicode"THEXY";
