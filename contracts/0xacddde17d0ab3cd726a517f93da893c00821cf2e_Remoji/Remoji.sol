...
$REMOJI is an online game platform that allows users to user interaction that 
enables them to play program games that are created by other players.

Website: https://remoji.com/
...
contract Remoji is Context, IERC20, Ownable {
    ...
    string private constant _name = "Remoji";
    string private constant _symbol = "REMOJI";
