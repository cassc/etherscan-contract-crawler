    ...
    ReentrancyGuard
{
    ...
    event EulerLinearPoolCreated(address indexed pool, uint256 indexed protocolId);
    ...
    constructor(
        ...
        BasePoolFactory(
            ...
            type(EulerLinearPool).creationCode
        )
    ...
    function create(
        ...
        EulerLinearPool.ConstructorArgs memory args;
        args.vault = getVault();
        args.name = name;
        args.symbol = symbol;
        ...
        emit EulerLinearPoolCreated(address(pool), protocolId);
