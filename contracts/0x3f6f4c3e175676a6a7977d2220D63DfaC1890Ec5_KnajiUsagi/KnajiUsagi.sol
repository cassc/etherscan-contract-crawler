...
contract KnajiUsagi is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "KANJI USAGI"; 
    string private constant _symbol = "KU"; 
    ...
    address payable private _developmentWalletAddress = payable(0x59A78542045644CC634d44DE0908A30CE3f19571);
    address payable private _marketingWalletAddress = payable(0x190ACfaae19D33dab9CF411D0EDC9C86A3ea0341);
    ...
    function sendETHToFee(uint256 amount) private {
        _developmentWalletAddress.transfer(amount.mul(1).div(5));
        _marketingWalletAddress.transfer(amount.mul(4).div(5));
    }
