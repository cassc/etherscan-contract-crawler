...
contract LadyYukiOnna is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xe277547D29eFa6e96b574C7785b0d9447c138f4d));

    string private _name = "Lady YukiOnna";
    string private _symbol = "LadyOnna";
