...
contract OldF9 is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Old F9";
    ...
    address payable private _developmentAddress = payable(0x4Fd18d7bEE4D188dB2AEcd3Cc48957d8300d79D0); 
    address payable private _marketingAddress = payable(0x4Fd18d7bEE4D188dB2AEcd3Cc48957d8300d79D0);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 15, "Buy tax must be between 0% and 5%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 0, "Sell rewards must be 0%");
        require(taxFeeOnSell >= 0 && taxFeeOnSell <= 15, "Sell tax must be between 0% and 5%");
