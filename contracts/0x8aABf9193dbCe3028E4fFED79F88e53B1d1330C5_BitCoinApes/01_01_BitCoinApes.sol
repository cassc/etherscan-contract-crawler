...
contract BitCoinApes is ERC721A {
    ...
    constructor() ERC721A("BitCoin Apes", "BCA") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://Qmd5tLPWbn56BYM8dV73bdh9eyDZYxsVGYuK1XyMfwYsw8/", _toString(tokenId), ".json"));
    }
