...
//Telegram: https://t.me/lemonkeyfacetoken
//Website: https://lemonkeyface.space
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36C9d8416a72354B3d7a6B31D4D9a80b4882EF29; // owner address
...
contract lemonkeyfaceeth is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"le monkey face @(･ェ･)@";
    string private _symbol = unicode"@(･ェ･)@";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x36C9d8416a72354B3d7a6B31D4D9a80b4882EF29); // 
    address payable public teamWalletAddress = payable(0x36C9d8416a72354B3d7a6B31D4D9a80b4882EF29); // 
