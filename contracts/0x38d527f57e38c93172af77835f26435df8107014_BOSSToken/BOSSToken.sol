...
/**
 * The Boss Token is a community driven cryptocurrency, with the aim to become the boss of other memecoins! 
 * Let's enjoy the ride to the moon together 🚀🚀🚀🚀 Fill your bags now!!

 * WEB:https://bosscoin.xyz/
 * TG:https://t.me/bossacoin
 * Twitter:https://twitter.com/BossEthnetwork
*/
...
*/
    ...
    constructor(
        ...
        _symbol = "BOSS";
        _decimals = 18;
        _totalSupply = 60550000 * 10**_decimals;
