...
contract SF is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _marketingWalletAddress = 0xdA48f922A4EC0c4B78758Af9e83e69D1B687Edd1;
    ...
    function balanceOf(address account) public view override returns (uint256) {
        ...
        return tokenFromRefleion(_rOwned[account]);
    }
    ...
    function tokenFromRefleion(uint256 rAmount) public view returns(uint256) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        ...
        if(_rOwned[account] > 0) {
            _tOwned[account] = tokenFromRefleion(_rOwned[account]);
        }
