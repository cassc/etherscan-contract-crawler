...
contract EBT is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xfb23e7c935645c6aDE397166E4B44bC61fb195bE); 
    address payable public Wallet_Dev = payable(0x512848Cd7bDDA88bB10EdC3fe8ABc8c2Df39CC62);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 18;
    uint256 private _tTotal =100000000000 * 10**_decimals;
    string private constant _name = "EBT"; 
    string private constant _symbol = unicode"EBT"; 
    ...
    constructor () {
        _owner = 0x512848Cd7bDDA88bB10EdC3fe8ABc8c2Df39CC62;
