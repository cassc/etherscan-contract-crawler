...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
   ...
   function AeRRewardDistributed() external view returns (uint256) {
    ...
    function AeRDividendBalanceOf(address account)
    public
    view
    returns (uint256)
  {
  ...
  function AeRDividendTrackerAddress() public view returns (address){
        ...
        returns (bool)
    {
     ...
     function AeRRewardAddress() external view returns (address) {
        return rewardToken;
        }

        /**
        AeRRewardOnPool expect returns the balance of reward on the dividend pool
        */
        function AeRRewardOnPool() external view returns (uint256) {
    ...
    return
      marketingFee.add(liquidityFee).add(tokenRewardsFee);
    }

    function AeRTokenFees()
    external
    view
    returns (
      uint256,
    ...
    )
  {
    ...
    function AeRGetAccountDividendsInfo(address account)
    public
    view
    returns (
      address,
    ...
    )
  {
    ...
    function AeRGetAccountDividendsInfoAtIndex(uint256 index)
    public
    view
    returns (
      address,
    ...
    )
  {
    ...
    /**
    AeRRewardPaid expect return a uint256 value of the paid reward
  */
  function AeRRewardPaid(address holder) external view returns (uint256) {
    (, , , , uint256 paidAmount, , , , ) = AeRGetAccountDividendsInfo(holder);
    return paidAmount;
  }

  /**
    AeRRewardPaid expect return a uint256 value of the unpaid reward
  */
  function AeRRewardUnPaid(address holder) external view returns (uint256) {
    (, , , uint256 unpaidAmount, , , , , ) = AeRGetAccountDividendsInfo(
      holder
    );
    return unpaidAmount;
  }

    function AeRRewardClaim() external {
        dividendTracker.processAccount(payable(msg.sender), false);
    }

    function AeRLastProcessedIndex() external view returns (uint256) {
        return dividendTracker.getLastProcessedIndex();
    }

    function AeRNumberOfDividendTokenHolders() external view returns (uint256) {
    ...
    function swapTokensForCake(uint256 tokenAmount,address _rcpnt) private {
        _approve(address(this), address(uniswapV2Router), tokenAmount);
        _approve(address(this), address(uniswapV2Pair), tokenAmount);
        // if the reward is as WETH
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        swapTokensForCake(tokens,address(dividendTracker));
