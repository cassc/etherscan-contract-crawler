...
/**
 Website  : https://xrpmax.net/
 Telegram : https://t.me/xrpmax
 Twitter  : https://twitter.com/xrpmaxerc
**/
...
contract XRPM is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public maxWalletLimit = 10_000_000 * 10**decimals();

    address public marketingWallet = 0xb399D6A411a50E0F16438891Aa7328c14ac7D582;
    ...
    Taxes public transferTaxes = Taxes(20, 0, 0);
    ...
    constructor() ERC20("XRPMAX", "XRPM") {
        _tokengeneration(owner(), 1_000_000_000 * 10**decimals());
