...
contract Methane is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Methane";
    string private constant _symbol = unicode"CH4";
