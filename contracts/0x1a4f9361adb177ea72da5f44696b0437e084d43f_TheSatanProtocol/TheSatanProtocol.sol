...
/**
 ...
 Website : https://medium.com/@TheSatanProtocol

 Twiiter : https://twitter.com/TSPERC
...
contract TheSatanProtocol is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC05b0eed0eC2C24972532E787767C962772bA30d); 
    address payable public Wallet_Utility = payable(0xC05b0eed0eC2C24972532E787767C962772bA30d);
    ...
    string private constant _name = " The Satan Protocol"; 
    string private constant _symbol = unicode" TSP "; 
    ...
    constructor () {
        ...
        _owner = 0xC05b0eed0eC2C24972532E787767C962772bA30d;
