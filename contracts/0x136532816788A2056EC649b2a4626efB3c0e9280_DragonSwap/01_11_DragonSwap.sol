...
contract DragonSwap is ERC20, Ownable {
    ...
    constructor() ERC20("Dragon Swap", "DRGN") {
        _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);        
        _uniswapV2Pair = address(0);

        // Total supply 150,000,000 DRGN
        uint256 totalSupply = 150_000_000 * 1e18;

        // Set default fees
        _buyMarketingFee = 15; // 1.5%
        _buyLiquidityFee = 25; // 2.5%

        _sellMarketingFee = 25; // 2.5%
