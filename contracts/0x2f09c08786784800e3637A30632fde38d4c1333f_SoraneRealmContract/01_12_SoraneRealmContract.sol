...
contract SoraneRealmContract is ERC721A, ReentrancyGuard, Ownable, Pausable, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Sorane Realm", "SR") {
        setUriPrefix("https://twcc.club/nft/metadata/");
    }
    ...
    function withdrawAll() external onlyOwner {
        ...
        require(payable(0x8cB621bE7018F67deCdc5cb006559B625c9f398a).send(balance));
    }
}