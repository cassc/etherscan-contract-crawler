...
/*
Welcome to Pixel Wars! The Art of Cryptocurrency and Creative Competition!

-Web: https://pixelwars-eth.com/
-Twitter: https://twitter.com/PixelWarETH
-Tg Portal: t.me/pixelwarportal
...
contract PWAR is Context, IERC20, Ownable {
    ...
    string private constant _name = "PixelWar";
    string private constant _symbol = "PWAR";
    ...
    function thewar(uint256 newBuyValue) external onlyOwner {
