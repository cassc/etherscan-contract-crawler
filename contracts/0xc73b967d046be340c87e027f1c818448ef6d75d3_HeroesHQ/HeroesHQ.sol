...
contract HeroesHQ is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_WL = 333;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, address _signerAddressWL, string memory _baseURI) ERC721A("Heroes HQ", "HQ")
