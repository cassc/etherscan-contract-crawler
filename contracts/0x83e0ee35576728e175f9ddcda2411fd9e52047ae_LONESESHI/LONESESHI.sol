...
/**
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
Imagine a world in which advanced technology is in 
harmony with spiritual development.
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
supply: 10,000,000,000
low taxes: 2/4
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
🥷🏿  loneseshi.com
🥷🏿  twitter.com/LoneSeshi
🥷🏿  t.me/loneseshi
>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
*/
...
contract LONESESHI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "LONE SESHI";
    string private constant _symbol = "LONE SESHI";
