...
/**
Iron Bank - the most secure bank in the nft space. 
RM: IBGC (free mint) - Neuro Goblins (for IBGC holders) - $IBGC 
...
contract IronBank is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("IronBank.Gold", "IBGC") {
        setHiddenMetadataUri("https://api.ironbank.gold/");
        setBaseURI("https://api.ironbank.gold/");
    }
