...
https://t.me/DoPeTokenErc
https://twitter.com/DoPeTokenErc20

Two iconic internet sensations, one epic showdown! 🐕 Vs 🐸
...
contract DogeVsPepe is Context, IERC20, Ownable {
    ...
    uint256 private constant _TotalSupply = 42069000000000000000000 * 10 **_decimals;
    ...
    constructor () {
        _marketingWallet = payable(0xb3D8D6679aFC15a4317a3d00B440B466724F1775);
