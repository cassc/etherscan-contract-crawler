...
// FILE 14: OutlawsZuki.sol

contract OutlawsZuki is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint256 public salePrice = 0.0012 ether;
    uint256 public maxFree = 5;
    uint256 public maxTx = 20;
    uint256 public rescure = 2800;
    ...
    constructor() ERC721A("OutlawsZuki", "OLZ") {
