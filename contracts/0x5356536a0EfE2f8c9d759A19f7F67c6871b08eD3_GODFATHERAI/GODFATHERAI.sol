...
/**
    *Telegram - https://t.me/GodFatherAi_ERC20 

    *Twitter - https://twitter.com/GodFatherAIERC
...
contract GODFATHERAI is Context,IERC20, Ownable{
 using Address for address;
 string private _name = "GODFATHER AI ";
 ...
 address _owner;
 address payable public marketingAddress = payable(0x611055Db1B8a7006fCE07DEa20F4134D65F4a214);
 ...
 uint256 GODFATHERAIDaycooldown = 0;
 ...
 //Tokenomics related functions
  function GODFATHERAIDay() public onlyOwner{
      require(block.timestamp > GODFATHERAIDaycooldown, "GOD FATHER AI");
 ...
 function GODFATHERAICoinDayOver() public onlyOwner{
      buyliqFee = buyprevLiqFee;
      buymktFee = buyPrevmktFee;
      GODFATHERAIDaycooldown = block.timestamp + 86400;
 }
