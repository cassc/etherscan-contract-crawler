...
* Website: wedontcare.xyz
* Twitter: https://twitter.com/care_erc
* Telegram: http://t.me/care_erc
...
contract CareToken is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private _name = "CARE";
    ...
    address public Treasury = address(0xC97177A282494287694278Bf30a0B6F3fFC8f4E1);
    ...
    function setFee(uint _buyTreasury, uint _sellTreasury, uint _deno) external onlyOwner {    
        _buyTreasuryFee = _buyTreasury;
        _sellTreasuryFee = _sellTreasury;
