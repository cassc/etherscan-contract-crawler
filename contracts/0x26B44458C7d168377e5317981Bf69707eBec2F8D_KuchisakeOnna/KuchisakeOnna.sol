...
A Japanese legend about a slith mouthed women who wears a 
surgical mask and murders men. She approaches them and asks 
then if she is pretty, if they say no she slashes their face.
...
contract KuchisakeOnna is Context, IERC20, Ownable {
    ...
    string private constant _name = "Slith-Mouthed Woman";
    string private constant _symbol = "Kuchisake-Ona";
