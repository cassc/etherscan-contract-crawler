...
contract BoltBot is ERC20, Ownable {
    ...
    constructor() ERC20("BoltBot", "BOLTBOT") {
        ...
        revShareWallet = address(0x20590f29d5182029BA11344a732Eb5D38998Bc6E); // set as revShare wallet
    ...
    function withdrawStuckBoltBot() external onlyOwner {
