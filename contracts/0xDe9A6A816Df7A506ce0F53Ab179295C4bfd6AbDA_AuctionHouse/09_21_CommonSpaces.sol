...
contract CommonSpaces is IQF, Ownable, RevokableDefaultOperatorFilterer, ERC721 {
    ...
    // URI
    string public baseURI = "https://static.wild.xyz/tokens/1114/metadata/";
    ...
    constructor(address _minter) ERC721("Common Spaces", "CS") {
        minter = _minter;
    }
