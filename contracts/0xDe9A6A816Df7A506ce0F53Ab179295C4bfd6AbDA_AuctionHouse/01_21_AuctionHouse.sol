    ...
    Ownable
{
    ...
    uint256 public allowlistSupply      = 44;   // number allowlist supply
    uint256 public maxSupply            = 100;  // max supply 
    uint256 public promoSupply          = 29;   // promo supply

    uint256 public allowListStartDateTime = 1676314800; //allowListStartDateTime
    uint256 public allowListEndDateTime   = 1676404800; //allowListEndDateTime  
    uint256 public auctionStartDateTime   = 1676404800; //==allowListEndDateTime; 
    uint256 public auctionEndDateTime     = 1676491200; //auctionEndDateTime
    ...
    CommonSpaces public commonspaces; // The qf contract 
    ...
    constructor(CommonSpaces _commonspaces) {
        commonspaces = _commonspaces;
    ...
    function set721ContractAddress(CommonSpaces _commonspaces) public onlyOwner {
        commonspaces = _commonspaces;
    }
    ...
    function setRevealed(bool _newRevealed) public onlyOwner {
        commonspaces.setReveal(_newRevealed);
    }
    ...
    function promoMint(address _to, uint256 _qty) external onlyOwner {
        ...
        for (uint256 i = 0; i < _qty; i++) {
            commonspaces.mint(_to);
        }
        promoSupply -= _qty;
        auctionSupply = maxSupply - commonspaces.totalSupply() - raffleSupply;
    }
    ...
    function publicSaleMint() public payable nonReentrant onlyUnpaused {
        ...
        require(commonspaces.totalSupply() < commonspaces.max_supply());
