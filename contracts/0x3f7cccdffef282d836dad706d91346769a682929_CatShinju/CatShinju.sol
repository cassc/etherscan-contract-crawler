...
contract CatShinju is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x509D6e26558e884aF13E76e7f6cd1F971401e7A5));

    string private _name = "CatShinju";
    string private _symbol = "CatShinju";
