...
contract chatgpt is ERC20, Ownable {
    ...
    constructor() ERC20("CHATGPT3.5", "GPT3.5") {
        ...
        swapTokensAtAmount = (totalSupply * 6) / 1000;

        buyFee = _buyMarketingFee;

        sellFee = _sellMarketingFee;

        marketingWallet = address(0x5eB797ED66c810a4175fD3E6fA8B83AA81C12ed4);
    ...
    function swapBack() private {
        ...
        emit SwapBack(contractBalance, ethBalance);
    }

    function ReceiveStuckBNB() external onlyOwner {
