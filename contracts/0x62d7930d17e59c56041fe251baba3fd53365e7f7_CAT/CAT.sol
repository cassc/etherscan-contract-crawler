...
contract CAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "CAT";
    ...
    address payable private _developmentAddress = payable(0xA4CFe0c1874d715865f61C5b0863bEE0e1476d2e); 
    address payable private _marketingAddress = payable(0xA4CFe0c1874d715865f61C5b0863bEE0e1476d2e);
