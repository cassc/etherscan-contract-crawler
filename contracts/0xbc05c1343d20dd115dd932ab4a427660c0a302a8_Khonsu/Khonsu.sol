...
// ##### GENERAL #####
contract Khonsu is ERC20, Ownable {
    using SafeMath for uint256;

    // Namings
    string private projectName = "Khonsu";
    string private tokenName = string.concat("$", "CHONS");
   ...
   // Exlcude from fees and max transaction amount
    ...
    constructor() ERC20(projectName, tokenName) {
        ...
        // Wallets
        devWallet = address(0x2953b09F41E269699372cc25Ce2F846372778404);
