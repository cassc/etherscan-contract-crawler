...
contract JOHN is ERC20, Ownable {
    ...
    constructor() ERC20("John", "John") {
        ...
        marketingWallet = address(0x77157C94F56FA492B34b4bf94865678162EBe399); // mwallet
        devWallet = address(0x77157C94F56FA492B34b4bf94865678162EBe399); // dwallet
