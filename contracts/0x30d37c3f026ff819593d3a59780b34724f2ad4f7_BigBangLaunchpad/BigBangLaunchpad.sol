...
Telegram: https://t.me/BoomPadPortal
Website: https://www.bigbanglaunchpad.com/
Twitter: https://twitter.com/BBLaunchpad
LinkTree: https://linktr.ee/bigbanglaunchpad
...
contract BigBangLaunchpad is ERC20, Ownable {
    ...
    constructor() ERC20("Big Bang Launchpad", "Boom") {
        ...
        uint256 totalSupply = 13_700_000_000 * 1e18;

        maxTransactionAmount = 274_000_000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 274_000_000 * 1e18; // 2% from total supply maxWallet
        ...
        developmentWallet = address(0xC64C858a1fff417189cf967B2ff8311bF2b82EfF); // set as development wallet
        marketingWallet = address(0x971A517AeE3f0554602B29a5f0DEaeadf867B980); // set as marketing wallet
        devWallet = address(0x4fb0164C8FE96Bbd58Ee599B9411b7ceC9De1835); // set as dev wallet
