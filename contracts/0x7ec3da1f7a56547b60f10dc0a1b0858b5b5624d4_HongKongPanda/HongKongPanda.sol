...
-Chat- https://t.me/hongkongpanda
-Twitter- https://twitter.com/hkpandaeth
-Website- http://hongkongpanda.com/
...
contract HongKongPanda is IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;
    string  private constant _name = "HONG KONG PANDA";
    string  private constant _symbol = "HKP";
    uint8   private constant _decimals = 18;
    uint256 private _maxTxamntPercentage = 5000; // 30%
    uint256 private _maxWalletBalancePercentage = 5000; // 30%
