 ...
 * @notice This contract handles minting Karma One Questions tokens.
 */
contract KarmaOneQuestions is
    ERC1155Supply,
    Ownable,
    Pausable,
    ReentrancyGuard,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xf1EE4EE42A705054Ef35A397606a7Da7fd6488f9;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x9B2a2B57515d2dAD465A40A7150EaeA194624A28;
    address[] public payoutAddresses = [
        0x9B2a2B57515d2dAD465A40A7150EaeA194624A28
    ];
    ...
    string public name = "Karma One Questions";
    string public symbol = "KOQ";
    ...
    constructor(
        ...
        ERC1155(
            "ipfs://bafybeidtjv7lwhv3kwmilwtmly3dqjmcvyq6ercmoqavd6ehyy42hyeeya/{id}"
        )
        RevokableOperatorFilterer(
        ...
        )
    {
        ...
        tokenPublicMintsPerAddress[3] = 0;
        tokenPublicPrice[4] = 0 ether;
        tokenPublicMintsPerAddress[4] = 0;
        tokenPublicPrice[5] = 0 ether;
        tokenPublicMintsPerAddress[5] = 0;
        tokenPublicPrice[6] = 0 ether;
        tokenPublicMintsPerAddress[6] = 0;
        tokenPublicPrice[7] = 0 ether;
        tokenPublicMintsPerAddress[7] = 0;
        tokenPublicPrice[8] = 0 ether;
        tokenPublicMintsPerAddress[8] = 0;
        tokenPublicPrice[9] = 0 ether;
        tokenPublicMintsPerAddress[9] = 0;
        tokenPublicPrice[10] = 0 ether;
        tokenPublicMintsPerAddress[10] = 0;
        tokenPublicPrice[11] = 0 ether;
        tokenPublicMintsPerAddress[11] = 0;
        tokenPublicPrice[12] = 0 ether;
        tokenPublicMintsPerAddress[12] = 0;
        require(
