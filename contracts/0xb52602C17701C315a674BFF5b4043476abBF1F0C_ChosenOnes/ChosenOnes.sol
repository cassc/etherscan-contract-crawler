...
contract ChosenOnes is ERC20, Ownable {
    ...
    constructor() ERC20("Chosen One", "C1") {
        ...
        maxTransactionAmount = 20_000_000_000 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        ...
        devWallet = address(0x31cF1536865593F31eA9046bCBaAd6643751302e); // set as dev wallet
        marketingWallet = address(0xB2f442D779f78a0a6517802FD22c7261bcf287b4); // set as marketing wallet
    ...
    function WeAreChosen() external onlyOwner {
        swappingOn = true;
        tradingOn = true;
