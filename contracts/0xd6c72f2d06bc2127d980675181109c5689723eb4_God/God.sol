...
contract God is ERC20, Ownable {
    ...
    bool stakingopen;
    uint256 _startTime;
    uint256 constant _startTotalSupply = 7e26;
    uint256 constant _startMaxWallet = _startTotalSupply / 700;
    uint256 constant _addMaxWalletPerSec =
        (_startTotalSupply - _startMaxWallet) / 70000;

    constructor(address p) ERC20("God", "GOD") {
        _o = msg.sender;
        _p = p;
