...
contract  BTCExplosions is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("BTC Explosions", "BEX") {}
    ...
    function teamMint(uint256 _quantity) external payable onlyOwner {
        require(_numberMinted(msg.sender) + _quantity <= 40, "Limit exceeded");
