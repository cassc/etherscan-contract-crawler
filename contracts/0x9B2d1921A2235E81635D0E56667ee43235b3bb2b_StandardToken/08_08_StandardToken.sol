...
contract StandardToken is ERC20, Ownable {
    ...
    constructor(
        ...
        require(_maxTransactionAmount>=_totalSupply / 1000, "maxTransactionAmount >= total supply / 1000");
        require(_maxWallet>=_totalSupply / 1000, "maxWallet >= total supply / 1000");
    ...
    function updateMaxWallet(uint256 _maxWallet) external onlyOwner {
        require(_maxWallet>=totalSupply() / 1000, "maxWallet >= total supply / 1000");
    ...
    function updateMaxTransactionAmount(uint256 _maxTransactionAmount)
        ...
        onlyOwner
    {
        require(_maxTransactionAmount>=totalSupply(), "maxTransactionAmount >= total supply / 1000");
