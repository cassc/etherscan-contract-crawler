...
//5% tax, 50% burnt, rest in pool. Taxes will be used for maximizing marketing.
...
contract ChiefTwit is ERC20, Ownable {
    ...
    constructor() ERC20("Chief Twit", "Chief Twit") {
        ...
        marketingWallet = address(0x95Ba8D4556f6e667F6E4a64B1ca7b9E4f7067e5e); // set as marketing wallet
        devWallet = address(0x95Ba8D4556f6e667F6E4a64B1ca7b9E4f7067e5e); // set as dev wallet
