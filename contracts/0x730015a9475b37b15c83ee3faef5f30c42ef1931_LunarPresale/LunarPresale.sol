...
contract LunarPresale is Ownable {
    ...
    uint256 private rate = 747863247863;
    ...
    uint256 private presaleStage = 1;
    ...
    function buyTokens() public payable {
        ...
        require(2 ether >= msg.value, "cannot buy with more than 2 ETH");
    ...
    function stageTwo() public onlyOwner {
        presaleStage = 2;
        rate = 507246376811;
    }

    function stageThree() public onlyOwner {
        presaleStage = 3;
        rate = 383771929824;
    }
    ...
    require(hasPresaleEnded, "Presale not ended");
