...
contract Mav is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public immutable MAX_SUPPLY = 333;
    uint16 public immutable MAX_PER_TX = 2;
    uint256 public PRICE = 0.005 ether;
    bool public IS_SALE_ACTIVE = false;
    string _URI = "https://gateway.pinata.cloud/ipfs/QmZoqgQSCtXTUXoyWtpA7UXZSaHkwUubuxUPuE8XiMkw95/";
