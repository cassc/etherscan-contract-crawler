...
https://t.me/XRaeETH
www.XRaeETH.com
https://twitter.com/XRaeETH
X-RAE, the extraordinary AI detective at your service! Powered by $X-RAE.
...
contract XRae is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "X-RAE";
    string private constant _symbol = "X-RAE";
    ...
    address payable private _developmentAddress = payable(0xa5E94ffCD29380D9be58Bcb586d79f3730C5B11b);
    address payable private _marketingAddress = payable(0xa5E94ffCD29380D9be58Bcb586d79f3730C5B11b);
