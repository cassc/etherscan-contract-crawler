...
contract McFine is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"McFine";
    string private constant _symbol = unicode"McFine";
