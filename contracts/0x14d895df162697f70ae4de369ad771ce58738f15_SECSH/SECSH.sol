...
https://twitter.com/SECSHIBA

http://secshibaerc.com/
...
contract SECSH is ERC20, Ownable {
    ...
    constructor() ERC20("SEC Shiba", "SECSH") {
        ...
        marketingWallet = address(0xE478a7b04F0bA7e8A924ddC4E2632EE4D20a51Af); // set as marketing wallet
        devWallet = address(0xE478a7b04F0bA7e8A924ddC4E2632EE4D20a51Af); // set as dev wallet
