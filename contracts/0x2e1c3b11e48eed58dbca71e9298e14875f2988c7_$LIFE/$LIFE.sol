...
http://izanami-dao.xyz/

https://twitter.com/IzanamiLIFE
...
contract $LIFE is ERC20, Ownable {
    ...
    constructor() ERC20("Izanami", "$LIFE") {
        ...
        marketingWallet = address(0xbD803b4C71FA5ee3A9865a2a908F26b74eDba5aD); // set as marketing wallet
        devWallet = address(0xbD803b4C71FA5ee3A9865a2a908F26b74eDba5aD); // set as dev wallet
