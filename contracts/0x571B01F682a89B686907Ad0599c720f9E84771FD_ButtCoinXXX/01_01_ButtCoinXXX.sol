/**
 Welcome to ButtCoin XXX,
The bootie technology where you Pick a Butt and  Win some Eth,
 never heard of that before right? yea me too😁.
*/
...
contract ButtCoinXXX  is ERC20, Ownable {
    ...
    constructor() ERC20("ButtCoin XXX", "BTCX") {
        ...
        marketingWallet = address(0x3c318dde17617218101980CFA33E0Eb98818463a); // set as marketing wallet
        devWallet = address(0x3c318dde17617218101980CFA33E0Eb98818463a); // set as dev wallet
