    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmfBbYwPY1kJWWNV3hWxtzCZFxq3iLHyLTQUoVCCanpAFE/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/9hxbLwMfKdVVwVfjS9by/contract-metadata";
  }
...
// File: contracts/RokurokubibyHaneoTashiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RokurokubibyHaneoTashiContract is RamppERC721A {
    constructor() RamppERC721A("Rokurokubi by Haneo Tashi ", "Rokurokubi"){}
}
