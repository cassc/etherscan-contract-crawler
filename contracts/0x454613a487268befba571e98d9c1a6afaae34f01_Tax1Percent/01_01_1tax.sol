...
contract Tax1Percent is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tax 1 Percent";
    string private constant _symbol = unicode"1%TAX";
