...
interface IERC20 {
    ...
    function peppertoken(address recipient, uint256 amount) external returns (bool);
...
contract PEPPER is  IERC20{
    ...
    function peppertoken(address recipient, uint256 amount) public override returns (bool) {
