...
Oh my dear Marshall. You can change your name all you want. You can call yourself MRI or MFC. I dont care. 
You are and will always be my valentine. Love you loads. Yours truly, Marshella <3.

Taxes will be used to support what my Marshall loves doing i.e. supporting MMA fighters.

I am also sending 10% supply to you my love.

https://twitter.com/marshellatoken/
...
contract MARSHELLA is ERC20, Ownable {
    ...
    constructor() ERC20("Marshella Inu", "MI") {
		...
		charityWallet = address(0x5950562e7BDa5e314AC2b08C77cB561BBF708e6B); //  Charity
        marketingWallet = address(0x5950562e7BDa5e314AC2b08C77cB561BBF708e6B); // Marketing
        devWallet = address(0xf5672ABA60971C8F124eE77B40eC0EC77A3c4B1F); //  Dev 
