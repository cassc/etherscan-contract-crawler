...
/** https://t.me/domocoinportal https://t.me/domocoinportal https://twitter.com/DOMOCOINERC
...
contract DOMOINU is ERC20, Ownable {
    ...
    constructor() ERC20("DOMO KUN", "DOMO") {
        ...
        maxTransactionAmount = 20_000 * 1e18; // 1% max txn
        maxWallet = 20_000 * 1e18; // 1% max wallet
        ...
        mktgWallet = address(0x861dCF07664B484e5a8C8bEBb516384bEAB85c01); 
        devWallet = address(0x009B5D17170e335ecFE93F846B06F86F3dC099D4); 
        liqWallet = address(0xc8EbA6E3F92F442a1D65856610F56B03e66767f2); 
        operationsWallet = address(0x2b70AeD954013Bb70edA172e2930e1460d9eA016);
