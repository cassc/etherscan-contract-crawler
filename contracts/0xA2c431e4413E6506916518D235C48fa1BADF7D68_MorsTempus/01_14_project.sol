...
contract MorsTempus is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 1111;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.06 * 10**18;
    bytes32 public whitelistMerkleRoot =
        0xb0121540471a8cd201922f3a5bfd4e62fd499939a0b9b33b56d5cacc3249414a;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmaA8XHcahmp7nrs8gkyZJjf8fwJZFETUkJWtEtY4aLesb";

    constructor() public ERC721A("Mors Tempus", "DEATH", 1111, 1111) {}
