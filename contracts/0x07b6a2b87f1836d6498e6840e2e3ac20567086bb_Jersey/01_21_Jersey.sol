    ...
    NativeMetaTransaction
{
    ...
    constructor() ERC721A("BMM Jersey", "BMMJ") {
        _initializeEIP712("BMM Jersey");
        baseTokenURI = "https://cdn.nftstar.com/neymar/bmmj/metadata/";
        collectionURI = "https://cdn.nftstar.com/neymar/bmmj/contract.json";
        ...
        onlyRole(MINER_ROLE)
    {
        require(
            ...
            "Jersey: The two arrays are not equal in length"
        );
    ...
    function pause() public virtual {
        require(
            ...
            "Jersey: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSenderERC721A()),
            "Jersey: must have pauser role to unpause"
        );
        _unpause();
    }
