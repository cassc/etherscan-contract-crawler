...
contract Moonpunkz is ERC721AQueryable, Ownable {
    ...
    address public signer = 0xC960687EbdCE7234E79069e5B90C3D84cbFC6723;
    ...
    constructor(uint8 maxPerWallet, uint16 maxSupply, uint112 price, address royaltyAddress, uint256 royaltyPercentage, string memory baseURI) ERC721A("Moonpunkz", "MP") {
