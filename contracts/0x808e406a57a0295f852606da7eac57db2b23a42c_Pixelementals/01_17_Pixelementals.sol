...
contract Pixelementals is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    constructor() ERC721A("Pixelementals", "PS") {}
    ...
    function publicMint(uint256 amount) public payable {
        ...
        if (addressMinted[msg.sender] + amount <= freeMintPerAddress) {
            ...
            require(msg.value >= price * ((addressMinted[msg.sender] + amount) - freeMintPerAddress), "Insufficient funds");
            _safeMint(msg.sender, amount);
            addressMinted[msg.sender] += amount;
        }
    }
