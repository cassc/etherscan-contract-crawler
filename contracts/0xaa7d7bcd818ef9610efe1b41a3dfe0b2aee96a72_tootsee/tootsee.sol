...
contract tootsee is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Tootsee Roll";
    string private constant _symbol = "Tootsee";
    ...
    uint256 private constant _tTotal = 700_000_000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x7BA4a7BB2423aF26f2830Fa3bFf4E15d62e92D40);
    address payable private _marketingAddress = payable(0x7BA4a7BB2423aF26f2830Fa3bFf4E15d62e92D40);
    ...
    uint256 public _maxTxAmount = 14_000_000 * 10**9;
    uint256 public _maxWalletSize = 21_000_000 * 10**9;
    uint256 public _swapTokensAtAmount = 1_400_000 * 10**9;
