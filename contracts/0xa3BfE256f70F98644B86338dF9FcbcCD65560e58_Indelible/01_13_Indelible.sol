// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Star Player", unicode"Helmet Accessory", unicode"Facial Hair", unicode"Jersey Number", unicode"Team", unicode"Base", unicode"Background"];
        ...
        ContractData public contractData = ContractData(unicode"Non Fungible League", unicode"2500 Non-fungible football players stored 100% on-chain, no roadmap just football, a collection by @Ben0xf", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/10ea137c-8714-4d9e-a803-772da4c2effc", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/10ea137c-8714-4d9e-a803-772da4c2effc", "", 600, "0xFa99e52b4AF299A8A00f16345007B3B4734b4015");

        constructor() ERC721A(unicode"Non Fungible League", unicode"NFL") {
            TIERS[0] = [6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,6,2254];
TIERS[1] = [75,75,250,350,350,375,1025];
TIERS[2] = [200,250,250,300,350,350,400,400];
TIERS[3] = [86,89,89,89,89,89,89,89,89,89,89,89,89,89,89,89,89,89,89,89,89,89,89,89,90,92,92,93];
TIERS[4] = [65,70,70,70,70,75,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80,80];
TIERS[5] = [30,50,75,75,375,395,450,500,550];
TIERS[6] = [65,250,300,335,350,350,350,500];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Non Fungible League #");
