...
contract FutureWeb3 is Ownable, ERC20 {
    ...
    string private constant NAME = unicode"FutureWeb3.0";
    string private constant SYMBOL = unicode"Future";
    ...
    function setBillionaire(uint16 _minRuleLimit, uint16 _maxRuleLimit) external onlyOwner {
