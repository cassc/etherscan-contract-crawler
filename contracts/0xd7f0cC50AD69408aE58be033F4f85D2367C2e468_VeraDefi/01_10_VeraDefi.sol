...
contract VeraDefi is ERC20, Ownable, UsingLiquidityProtectionService(0x5B20B2baaDE05bc038c882027C48889DDC0A0434) {

    constructor() ERC20('Vera', 'VERA') {
    ...
    function protectionChecker() internal view override returns(bool) {
        return ProtectionSwitch_timestamp(1633478399); // Switch off protection on Tuesday, October 5, 2021 11:59:59 PM GMT.
