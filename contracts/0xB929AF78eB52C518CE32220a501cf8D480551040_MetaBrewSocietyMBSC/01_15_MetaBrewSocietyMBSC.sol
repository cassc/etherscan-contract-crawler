...
contract MetaBrewSocietyMBSC is ERC721, Ownable, AccessControl
{
    ...
    constructor() ERC721("MetaBrewSociety Genesis Certificate", "MBSC") {  //Name of Project and Token "Ticker"
