...
Bring us back to the simple contract times, where you didn't have to stress for some Indian jeet to come up with some new fancy function that donates our money to a tiny Indian village.
...
contract ATradersTool is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "A Traders Tool";
    ...
    function UpdateWalletLimit(uint256 amountPercent) external onlyOwner {
    ...
    function UpdateMarketingFee(uint256 _marketingFee) external onlyOwner {
        ...
        require(marketingFee<=10); // Not able to set marketing fees above 10%
    }
