...
/* 
   https://t.me/OxSamBankmanElonMuskFusionShibaP
   https://t.me/OxSamBankmanElonMuskFusionShibaP
   https://t.me/OxSamBankmanElonMuskFusionShibaP
*/
...
contract SBEFSP is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"0xSamBankmanElonMuskFusionShibaPepePoweredEthGasTurboBoostedMichaelSaylorCertifiedDeXDeFiUltraPlatinumMegaTokenOfCryptoLegends", unicode"SBEFSP") 
    {
        address supplyRecipient = 0x29AAd1879F87D159587dfd6ce2c65aeC8c488009;
        
        updateSwapThreshold(500000000 * (10 ** decimals()) / 10);

        mainAddressSetup(0x29AAd1879F87D159587dfd6ce2c65aeC8c488009);
        ...
        updateMaxSellAmount(1000000000 * (10 ** decimals()) / 10);

        _mint(supplyRecipient, 1000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x29AAd1879F87D159587dfd6ce2c65aeC8c488009);
    }
