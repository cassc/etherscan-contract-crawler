...
Telegram: https://twitter.com/JeremyCahen
...
contract PurlePunk is Ownable, ERC20 {
    uint256 public immutable maxSupply = 420_000_000_000_000 * (10 ** decimals());
    ...
    constructor() ERC20("Purle Punk", "PPunk") {
