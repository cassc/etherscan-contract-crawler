...
contract PepePrinter is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Pepe Printer";
    string private constant _symbol = "PEPEPRNT";
    ...
    address payable public marketingWallet = payable(0x0BeC3516084fDCEDE606D96A128e86Fd5eF96C95);
