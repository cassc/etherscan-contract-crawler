...
/*
    __     _______    ______   ________   ______  
  _/  |_  /       \  /      \ /        | /      \ 
 / $$   \ $$$$$$$  |/$$$$$$  |$$$$$$$$/ /$$$$$$  |
/$$$$$$  |$$ |__$$ |$$ |  $$ |    /$$/  $$ |  $$ |
$$ \__$$/ $$    $$< $$ |  $$ |   /$$/   $$ |  $$ |
...
contract Bozo is ERC20, ERC20Burnable, ERC20Permit, Ownable {
    uint256 public SUPPLY = 500_000_000 * 10**decimals();
    uint256 constant MAX_FEE = 20;
    uint256 public FEE = 1;

    constructor() ERC20("BOZO", "BOZO") ERC20Permit("BOZO") {
        _mint(msg.sender, SUPPLY);
    }

    function setFEE(uint256 newFee) external onlyOwner {
        require(newFee <= MAX_FEE, "Tax can't be more than 20%");
        FEE = newFee;
    }
