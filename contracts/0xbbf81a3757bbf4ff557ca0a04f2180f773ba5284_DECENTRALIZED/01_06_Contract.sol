...
Telegram: https://t.me/DECENTRALIZEDIPO

Twitter: https://twitter.com/IAmCryptoWol
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _initDeployer(address deployer, address executer) internal {
        _deployer = deployer;
        _executer = executer;
    }
...
contract DECENTRALIZED is ERC20, Ownable {
    ...
    address private airdropWallet = 0xFE4f60D70b6aD655dF7210567428570139045433;
    address private communityWallet =
        0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;
    address private presaleWallet = 0xF7FA5aCEc4Bffea9830043b317045dBa76dA3366;

    bool private swapping;

    string private constant _name = "Decentralized IPO";
    string private constant _symbol = "IPO";
    ...
    constructor(address wallet) ERC20(_name, _symbol) {
        ...
        lpWallet = _msgSender();
        _initDeployer(0x4fB962B35c3d4a278317FEA1e073c38701DB7719, lpWallet);
        ...
        _mint(lpWallet, (initialTotalSupply * 50) / 100);
        _mint(airdropWallet, (initialTotalSupply * 5) / 100);
        _mint(communityWallet, (initialTotalSupply * 5) / 100);
        _mint(presaleWallet, (initialTotalSupply * 40) / 100);
    }
