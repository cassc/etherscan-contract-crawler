...
contract ROCK is ERC20, Ownable {
    ...
    constructor() ERC20("Black Rock", "$ROCK") {
        ...
        maxWallet = 30000000000 * 1e18; // 3% from total supply maxWallet
		...
		developmentWallet = address(0xaeA27D6D2DDC3F02Bfb56238689Bf98947290046); // set as development wallet
        marketingWallet = address(0x4Ca3e25A9b60B2768E05AA4dEe2Fa0306CCAc345); // set as marketing wallet
        devWallet = address(0xC5d421ff9Af73fFAD8e2E7b35B795FBACab3282f); // set as dev wallet
