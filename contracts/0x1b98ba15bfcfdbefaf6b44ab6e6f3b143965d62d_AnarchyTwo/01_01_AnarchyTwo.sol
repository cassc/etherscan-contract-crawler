...
By the original ANARCHY dev (4M ATH previous)

0 tax, no high initial taxes. 

TELEGRAM: Https://t.me/AnarchyTwo
...
contract AnarchyTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Anarchy 2.0";
    string private constant _symbol = unicode"ANARCHY2 ";
