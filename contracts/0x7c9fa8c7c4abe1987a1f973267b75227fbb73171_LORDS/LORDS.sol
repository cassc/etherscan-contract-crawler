...
contract LORDS is ERC20, Ownable {
    mapping(address => bool) private _isExcludedFromFee;
    mapping(address => bool) private _sniper;

    address public _marketingWallet = 0x4A504C52B2032d9ce4d074aA14180cb81BC64AA4;
    address public _devWallet = 0x4A504C52B2032d9ce4d074aA14180cb81BC64AA4;

    uint256 public feesBuy = 1000;

    uint256 public _feesM = 5500;
    ...
    constructor() ERC20("MILORD", "LORDS") {
        uint256 startSupply = 0.000000033e9 * 10 ** decimals();
