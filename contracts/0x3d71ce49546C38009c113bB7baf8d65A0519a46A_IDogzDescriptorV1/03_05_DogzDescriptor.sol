...
import "./lib/IDogzDescriptor.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract IDogzDescriptorV1 is IDogzDescriptor {
    struct Color {
        string value;
        string name;
    }
    ...
    function tokenURI(uint256 tokenId, uint256 seed) external pure override returns (string memory) {
        ...
        string memory description = 'Dogz';
