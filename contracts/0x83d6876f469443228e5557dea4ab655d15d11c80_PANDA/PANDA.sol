...
Telegram - https://t.me/pandaexpressportal

Twitter: https://twitter.com/PandaExpressEth

Website: https://pandaexpresseth.com/
...
contract PANDA is Context, IERC20, Ownable {
    ...
    string private constant _name = "PandaExpress";
    ...
    function changeTransactionAmount(uint256 limit) external {
    ...
    function changeFee(uint256 buyFee, uint256 sellFee) external {
