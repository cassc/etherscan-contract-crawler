...
Tg - https://t.me/ghostpepecoin

Web - https://ghostpepe.vip

Twitter - https://twitter.com/ghostpepecoin
...
contract StandardToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, address router_, uint256 supply_) {
        _name = name_;
        _symbol = symbol_;
        _router = router_;

        uint256 _supply = supply_ * 10 ** 18;
