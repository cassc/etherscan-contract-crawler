...
"Memes R ded" ...and you're gonna help us reZurrect them.

1m $BZBG
0 Tax

Tg: https://t.me/BrainzBridgeERC
Tw: https://twitter.com/BrainzBridgeERC
Web: https://brainzbridge.online
...
contract BrainzBridge {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Brainz Bridge";   
    string public constant symbol = "BZBG";   
    ...
    address payable constant deployer = payable(address(0x7B14BCB69a7b8f2dA2b2eA8781c0f379b2BFB175));
