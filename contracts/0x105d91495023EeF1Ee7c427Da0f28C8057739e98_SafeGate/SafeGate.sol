...
contract SafeGate {
    ...
    string public constant name = "Safe Gate";   
    string public constant symbol = "SAFEGATE";   
    ...
    address payable constant deployer = payable(address(0x423c9A907589AdAdB096F5A181d126FFF770FC58));
