...
contract DontBuyInu2 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Dont Buy Inu 2.0";
    string private constant _symbol = "DBI2.0";
    ...
    address payable private _developmentAddress = payable(0xddC23a0eCFb73ad02AD40f3BbDcde8e49Bfe22DD);
    address payable private _marketingAddress = payable(0xddC23a0eCFb73ad02AD40f3BbDcde8e49Bfe22DD);
    ...
    function highway(bool _tradingOpen) public onlyOwner {
