...
contract SONOFABITCH is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Son of a Bitch";
    string private constant _symbol = "SOB";
    ...
    address payable private _developmentAddress = payable(0x933A84fc03cb92Ee762381115dE8df1954371C88); 
    address payable private _marketingAddress = payable(0x933A84fc03cb92Ee762381115dE8df1954371C88);
