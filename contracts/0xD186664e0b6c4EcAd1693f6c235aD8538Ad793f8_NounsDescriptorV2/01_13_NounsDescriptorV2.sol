...
/// @title The UNouns NFT descriptor
...
contract NounsDescriptorV2 is INounsDescriptorV2, Ownable {
    ...
    /**
     * @notice Given a token ID and seed, construct a token URI for an official UNouns DAO noun.
    ...
    /**
     * @notice Given a token ID and seed, construct a base64 encoded data URI for an official UNouns DAO noun.
     */
    function dataURI(uint256 tokenId, INounsSeeder.Seed memory seed) public view override returns (string memory) {
        string memory unounId = tokenId.toString();
        string memory name = string(abi.encodePacked('UNoun ', unounId));
        string memory description = string(abi.encodePacked('UNoun ', unounId, ' is a member of the UNouns DAO'));
