...
contract AllStarCrypto is ERC20, ERC20Burnable, ERC20Pausable, ERC20Permit, AccessControl, ReentrancyGuard {
    uint256 private constant INITIAL_SUPPLY = 100_000_000_000 * (10 ** 18); 
    uint256 private constant MAX_TRANSFER_AMOUNT = 1_000_000_000 * (10 ** 18); 

    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
	

    constructor() ERC20("All-Star Crypto", "ASC") ERC20Permit("All-Star Crypto") {
    ...
    function burn(uint256 amount) public override whenNotPaused nonReentrant {
        require(amount <= MAX_TRANSFER_AMOUNT, "Burn amount exceeds maximum limit.");
