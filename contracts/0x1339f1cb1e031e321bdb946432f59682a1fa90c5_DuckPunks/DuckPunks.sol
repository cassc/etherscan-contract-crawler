...
contract DuckPunks is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://bafybeia72ljmz2w4jvcvn42ohqwphx43zmit6s6w62ebg546xbwtqfha6q/";
  bool public isPublicSaleActive = true;

  uint256 public  maxSupply = 879;
  uint256 public  MAX_MINTS_PER_TX = 5;
  uint256 public  PUBLIC_SALE_PRICE = 0.001 ether;
  uint256 public  NUM_FREE_MINTS = 879;
  uint256 public  MAX_FREE_PER_WALLET = 1;
  uint256 public  freeNFTAlreadyMinted = 0;

  constructor() ERC721A("DucksPunks", "DP") {}
