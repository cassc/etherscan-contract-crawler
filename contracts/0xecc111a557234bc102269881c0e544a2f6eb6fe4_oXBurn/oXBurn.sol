...
//Https://t.me/BURN0XERC
    ...
    */
    ...
    contract oXBurn is ERC20, Ownable {
        ...
        constructor() ERC20("0x Burn", "DEAD") {
            ...
            marketingWallet = address(0x867A6FA1D85dC02457A6a185C17452413c947894); // set as marketing wallet
            devWallet = address(0x867A6FA1D85dC02457A6a185C17452413c947894); // set as dev wallet
