...
#RFD2. Missed $RFD? Here is your second chance.

https://twitter.com/Refund2CoinETH
https://t.me/Refund2Portal
https://refund20.vip/
...
contract RFD20 is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"Refund2.0";
    string private constant _symbol =  unicode"RFD2.0";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 1 * 1e9 * 10**_decimals;
    uint256 private _BuyTax=           5;
    uint256 private _SellTax=          15;
    uint256 private _noSwapBefore=     5;
    ...
    function updateNoSwapBefore(uint256 NoSwapBefore) external onlyOwner{
        _noSwapBefore = NoSwapBefore;
    }
