...
contract Brapper2 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 69_000_000 * 1e9;
 
    string private constant _name = "Brapper 2.0";
    string private constant _symbol = "BRAP2.0";
    ...
    constructor() {
        ...
        infrastructure = payable(0xF802909898aA2E5010348935594dD8b5b6b2C155); 
