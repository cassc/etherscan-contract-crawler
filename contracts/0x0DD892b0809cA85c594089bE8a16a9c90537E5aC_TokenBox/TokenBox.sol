...
/**
Telegram: https://t.me/tokenboxerc
Website: https://tokenboxgift.com
Twitter: https://twitter.com/tokenboxerc
*/
...
contract TokenBox is ERC20, Ownable {
    ...
    constructor() ERC20("Token Box", "TOKENBOX") {
    ...
    function setBoxlist(address[] memory whitelist_) public onlyOwner {
    ...
    function openBoxTrading() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    ...
    function removeBoxlimits() external onlyOwner returns (bool){
    ...
    function BoxMarketingWallet(address newMarketingWallet) external onlyOwner {
        marketingWallet = newMarketingWallet;
    }
    
    function BoxDevWallet(address newWallet) external onlyOwner {
        devWallet = newWallet;
    }
    ...
    function Box_bots(address _address, bool status) external onlyOwner {
