...
contract InfinityPass is ERC721A, ERC2981, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  modifier validateMint() {
    require(MINT_STATUS, "IP: mint is not live.");
  ...
  function mint(uint256 quantity, uint256 allocation, bytes32[] calldata proof) external payable nonReentrant callerIsUser validateMint {
    require(MINT_STATUS, "IP: mint is not live.");
