...
/*
A buffalo market tends to roam over a long period of time, is herd-like and rather heavy, and can run the other way when worrisome obstacles get in the way.

Tamarau is et to tackle such sideways moving markets.
*/
...
contract Tamarau is Context, IERC20, Ownable { 
    ...
    string private constant _name = "The Crypto Buffalo";
    string private constant _symbol = "Tamarau";
