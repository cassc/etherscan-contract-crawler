...
SpaceX said that Elonmusk doesn’t have twitter account. What if Elon that we know on twitter, is actually fake…?🤔🤔 $FAKEMUSK

https://twitter.com/spacex/status/1659576083?s=21

TAX: 0/0 + Lock/Burn LP
...
contract FAKEMUSK is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Fake ElonMusk";//
    string private constant _symbol = "FAKEMUSK";//
    ...
    uint256 private constant _tTotal = 67677777777 * 10**9;
