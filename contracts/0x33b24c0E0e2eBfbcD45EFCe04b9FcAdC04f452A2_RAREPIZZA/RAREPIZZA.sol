...
contract RAREPIZZA is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Rare Sats HODL Club", "RAREPIZZA")
    {
        baseURI = _baseURI;
