...
contract Pepemigos is ERC721A {
    ...
    constructor() ERC721A("Pepemigos", "PEPEMIGOS") {
        owner = msg.sender;
        maxSupply = 3333;
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmRNo9TSLg9Pj7w3ZChVcau5WM2gGQeZ5Kx2EP4FHZfgto/", _toString(tokenId), ".json"));
    }
