...
contract PEPE2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe2.0";
    ...
    uint256 private constant _tTotal = 840180000000000 * 10**9;
    ...
    uint256 public _maxTxAmount = 16803600000000 * 10**9;
    uint256 public _maxWalletSize = 25205400000000 * 10**9;
    uint256 public _swapTokensAtAmount = 840180000000 * 10**9;
