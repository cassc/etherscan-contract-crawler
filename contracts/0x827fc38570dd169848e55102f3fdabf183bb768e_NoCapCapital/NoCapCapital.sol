...
NO CAP CAPITAL https://nocap.capital
 ...
 */
contract NoCapCapital is ERC20 {
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply =  1000000100 * 10 ** 18;

    /**
     * @dev Sets the value of the `decimals`. This value is immutable, it can only be
     * set once during construction.
     */
    constructor () ERC20('No Cap Capital', unicode"NOCAP", _msgSender()) {
