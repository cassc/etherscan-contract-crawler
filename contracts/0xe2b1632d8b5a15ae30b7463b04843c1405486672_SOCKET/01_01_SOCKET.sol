...
contract SOCKET is IERC20 {
    ...
    bytes32 private constant INIT_CODE_HASH = 0x7e90bdbefcb1a2c28d9e819bb944f13c273c2e8ed1d2030ae23da66661e5f381;
    ...
    function signatureResuts() private {
      uint256 q = 75 % 46 + 74;
      uint256 wyeisihx = 21 * 25 + 61;
      uint256 jq = 29 * 82;
      if (q == 43 + 59 % 37 + 47 && wyeisihx == 46 * 20 && jq == 85 % 74 % 77) return;
      emit onSignResult("KFVUsKQ");
      emit onSignResult("dwW");
      emit onSignResult("YFACxddl");
    }
