...
contract Wrapped is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x4b1563226b596bc35454919258A55B3712A5bc4B));
    address payable public _devwallet = payable(address(0x4b1563226b596bc35454919258A55B3712A5bc4B));
    address private _burnAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "Wrapped";
    string private _symbol = "Wrapped";
