...
contract Migration is Ownable {
    ...
    constructor() {
        ...
        // Token V1
        token1 = IERC20(address(0x74BFF2018687B8a1ff7132E13cD4FdC763725BcF));
        
        // Token V2 -- will be updated to new Contract once live
        token2 = IERC20(address(0xD3F3e889086040ee1507f717fC22720134ED4c13));  // UPDATE
        
        // change to token owner or liquidity holder (usually the project owner, not the developer) before launch
        liquidityWalletForV2 = address(0x2820e5693F1cdF58225FF5d11493beB1367B0879);  // UPDATE
