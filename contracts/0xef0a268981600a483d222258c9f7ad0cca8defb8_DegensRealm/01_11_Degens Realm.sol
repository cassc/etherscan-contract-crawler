...
Welcome to Degens Realm, a vibrant digital universe born within the ether of the blockchain. Conceived by a group of relentless adventurers united by the quest for financial freedom, this realm thrives on camaraderie and shared prosperity.

The $REALM token embodies our belief in community empowerment and the potential of collective success. It serves as a beacon against the shadows of Fear, Uncertainty, and Doubt (FUD), illuminating our path towards collective success.

In Degens Realm, every Degen is not just a token holder, but a guardian of the community, wielding their tokens to shape the future of our realm.

Launching on 06/27 - 15:00 UTC-0

Website: https://degensrealm.com/
Twitter: https://twitter.com/DegensRealm
...
contract DegensRealm is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = "Degens Realm";
    string private constant _symbol = "REALM";
