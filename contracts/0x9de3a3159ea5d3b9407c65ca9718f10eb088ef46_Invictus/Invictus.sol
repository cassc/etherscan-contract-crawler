...
// https://medium.com/@iaminvictus/i-am-invictus-ba1c531489f5
...
contract Invictus is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "The Unconquerable";
    string private constant tokenSymbol = "INVICTUS";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x3278e30389Ae9F53402cb7A138a03aFc41cC9e72);
        devAddress = payable(0x3278e30389Ae9F53402cb7A138a03aFc41cC9e72);
