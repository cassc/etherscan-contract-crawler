...
import "../domino/LibERC1155LazyMint.sol";

import "../domino/IRoyaltiesProvider.sol";

import "../domino/BpLibrary.sol";

import "../contracts/ITransferManager.sol";

abstract contract DominoTransferManager is OwnableUpgradeable, ITransferManager {
    ...
    function __DominoTransferManager_init_unchained(
        uint newProtocolFee,
