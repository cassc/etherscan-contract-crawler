...
Introducing FAKE Project - the revolutionary, decentralized, platform that takes web3 and meme projects to a whole new level! 

$1m $Fake with zero trading tax for buys/sells/transfers

Telegram: https://t.me/FakeProjectERC
Twitter: https://twitter.com/FakeProjectERC
Website: https://fakeproject.site
...
contract FakeProject {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Fake Project";   
    ...
    address payable constant deployer = payable(address(0x58c624F05f0bA07cB513349d5AE47dEcB289b6f2));
