...
contract LivesOfTamiko is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x01b2b63dff090b0b5e872fefce928d209f7b124dba313d80a3d67c5d3ef91df2;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmZFS8HTRQKP7mJYateWHmjQVeFNaEaWd26RcQ81PS6DvT";

    constructor() public ERC721A("Lives of Tamiko", "TAMIKO", 999, 999) {}
