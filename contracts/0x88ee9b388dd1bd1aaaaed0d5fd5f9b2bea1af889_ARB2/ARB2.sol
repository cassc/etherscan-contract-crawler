...
contract ARB2 is IERC20, Ownable {
    ...
    string _name = "Arbitrum 2.0";
    string _symbol = "ARB2.0";
    ...
    Fee public buyFee = Fee({reflection: 0, marketing: 22, lp: 3, buyback: 0, burn: 0, total: 25});
    Fee public sellFee = Fee({reflection: 0, marketing: 22, lp: 3, buyback: 0, burn: 0, total: 25});
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0x9Ae29ef2bEBEdfD032d5e1A8900d5EEb23F7896D;
        lpFeeReceiver = 0x9Ae29ef2bEBEdfD032d5e1A8900d5EEb23F7896D;
        buybackFeeReceiver = 0x9Ae29ef2bEBEdfD032d5e1A8900d5EEb23F7896D;
