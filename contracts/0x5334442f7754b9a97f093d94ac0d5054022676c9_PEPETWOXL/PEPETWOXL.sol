...
https://t.me/pepe20XL
https://www.pepe20xl.com/
https://twitter.com/pepe20xl
...
contract PEPETWOXL is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe2.0XL", "PEPE2.0XL") {
        ...
        maxTransactionAmount = 1_388_400_000_000 * 1e18; // 2% max txn at launch
        maxWallet = 1_388_400_000_000 * 1e18; // 2% max wallet at launch
        ...
        marketwallet = address(0xcaDf8576E9F783D23a8AefE9FCA4b39196eED24d); 
        devWallet = address(0xcaDf8576E9F783D23a8AefE9FCA4b39196eED24d); 
        liqWallet = address(0xcaDf8576E9F783D23a8AefE9FCA4b39196eED24d); 
        operationsWallet = address(0xcaDf8576E9F783D23a8AefE9FCA4b39196eED24d);
