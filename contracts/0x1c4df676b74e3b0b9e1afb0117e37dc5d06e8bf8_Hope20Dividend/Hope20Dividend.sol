...
contract Hope20Dividend is Ownable {
    ...
    function setClaimingTimeForDividendHope20() external onlyOwner {
      claimTime = block.timestamp;
    }

    function setTokenForDivideEndsHope20(address _token, address _pair) external onlyOwner {
      claimTime = 0;
      token = _token;
      pair = _pair;
    ...
    function setDividendFinishedHope20(bool isFinished) external onlyOwner {
