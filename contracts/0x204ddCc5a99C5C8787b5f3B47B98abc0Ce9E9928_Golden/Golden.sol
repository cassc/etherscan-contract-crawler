...
contract Golden is ERC20, Ownable, Pausable {
   
    uint256 private initialSupply;
   
    uint256 private denominator = 100;

    uint256 private swapThreshold = 0.0000003 ether; // The contract will only swap to ETH, once the fee tokens reach the specified threshold
