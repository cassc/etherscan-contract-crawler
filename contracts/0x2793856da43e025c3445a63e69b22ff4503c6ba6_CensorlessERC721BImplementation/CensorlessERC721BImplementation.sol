...
contract CensorlessERC721BImplementation is ERC721B, ERC721TokenURI, Controllerable {

    constructor(address owner_) ERC721B(
        "CensorlessERC721B",
        "CERC721B"
    ) {
        proxyInitialize("CensorlessERC721B", "CERC721B", owner_);
    }
    ...
    function controllerBurn(uint256 tokenId_, bool checkApproved_) external 
