...
Telegram: https://t.me/ReverseMiladyERC
Twitter: https://twitter.com/Reverse_Milady
Website: https://reversemilady.xyz/
...
contract Milady is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ʎpɐlᴉꟽ";
    string private constant _symbol = unicode"⅂Ɐᗡ⅄S";
    uint256 public _maxTxAmount = 5328005328006 * 10**_decimals;
    uint256 public _maxWalletSize = 5328005328006 * 10**_decimals;
    uint256 public _taxSwapThreshold= 5328005328006 * 10**_decimals;
    uint256 public _maxTaxSwap= 5328005328006 * 10**_decimals;
