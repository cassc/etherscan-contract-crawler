...
https://medium.com/@UniqueToken/always-remember-that-you-are-unique-just-like-everyone-else-14edeae91eb8
https://twitter.com/Unique_ERC
https://t.me/Uniquetoken
*/
...
contract UNIQUE is Context, IERC20, Ownable {
    ...
    string private _name = "Everyone Else";
    string private _symbol = "UNIQUE";
    ...
    address public marketingTokenFeeWallet = 0x80Ee413416b55aa4C997C9c118c571F5368bc4FE;
    address public marketingETHFeeWallet = 0x80Ee413416b55aa4C997C9c118c571F5368bc4FE;
    ...
    uint256 public _maxTxAmount = 2 * 10**7;//2% maxTxAmount
    uint256 public _maxWallet = 2 * 10**7;//2% maxWallet
    uint256 private _numTokensSwapToETHForMarketing = 2 * 10**4;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 1 * 10**7, "Cannot set transaction amount less than 1 percent of initial Total Supply!");
