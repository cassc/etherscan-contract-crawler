...
Website:  https://pepeappendmoon.com
Telegram: https://t.me/pepemoongroup
Twitter:  https://twitter.com/pepemoongroup
*/
...
contract pepemoon is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "pepe.append(moon);";
    ...
    address payable private _marketingAddress = payable(0x5bbf83B53efb056e77C3c1E4428EEE3C864B3E07);
    ...
    function _checksendTx(address from, address to, uint256 amount) private {
