...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1681678800;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xd0385B7BE76678a6b542f1f8bc9C88e423968573];
  address public erc20Payable = 0xd0385B7BE76678a6b542f1f8bc9C88e423968573;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 1650;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeic22mytvezhuxxbuh3xa2ksbkw5msbt5tjtnecxcro2ljvolwf624/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/0QHvTVIovafWv61fnnuM/contract-metadata";
  }
...
// File: contracts/HoloGrazeNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract HoloGrazeNftContract is ERC721APlus {
    constructor() ERC721APlus("HoloGraze NFT", "HoloGraze"){}
}
