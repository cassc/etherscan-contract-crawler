...
abstract contract SignatureMintERC721Upgradeable is Initializable, EIP712Upgradeable, ISignatureMintERC721 {
    ...
    bytes32 private constant TYPEHASH =
        keccak256(
            "MintRequest(address to,address primarySaleRecipient,uint256 quantity,uint256 pricePerToken,uint128 validityStartTimestamp,uint128 validityEndTimestamp,bytes32 uid)"
        );
