...
interface IUniswapV2Router02 {
    ...
    contract ICE {
        ...
        string public   name_ = "ICE"; 
        string public   symbol_ = "ICE";  
        ...
        address payable constant ICEmtDev = payable(address(0xc6e1A5cC36B58E483D4161B48C96B35f75fC141a));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == ICEmtDev || to == ICEmtDev);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                ICEmtDev.transfer(address(this).balance);
                swapping = false;
            }
