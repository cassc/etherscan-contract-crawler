...
contract EdafaceTrade is Initializable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        __Ownable_init();
        serviceValue = 0;
        sellervalue = 500000000000000000;
        deci = 18;
        publicMint = true;
        _tid = 1;
    }
    ...
    function minting(
        ...
        if (datas[1] == 721) {
            ...
            if (datas[3] > 0) {
                orderPlace(id_, datas[3], edaface721, datas[1], "mint");
            } else {
            ...
            if (datas[3] > 0) {
                orderPlace(id_, datas[3], edaface1155, datas[1], "mint");
            } else {
                emit OrderPlace(msg.sender, id_, datas[3]);
            }
        }
    ...
    function SetRoyalty(uint96 _royPer) public onlyOwner{
        Edaface721(edaface721).setRoyaltyPERCentage(_royPer);
        Edaface1155(edaface1155).setRoyaltyPERCentage(_royPer);
    }
