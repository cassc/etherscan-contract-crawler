...
contract ZMAY is ERC20, Ownable {
    ...
    string constant _name = "Azhdaya";
    string constant _symbol = "ZMAY";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 6) / 100;  // 5% max tx
    uint256 public _maxWalletSize = (_totalSupply * 6) / 100;  // 5% max wallet
    ...
    address private marketingFeeReceiver = 0xB946c2b4dC4b8E931B968070291AA1F8231AB9d5;
    address private devFeeReceiver = 0xB946c2b4dC4b8E931B968070291AA1F8231AB9d5;
    address private teamFeeReceiver = 0xB946c2b4dC4b8E931B968070291AA1F8231AB9d5;
