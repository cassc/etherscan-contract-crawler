...
Website:    https://www.trippytoken.vip/
Twitter:    https://twitter.com/trippyethtoken
Telegram:   https://t.me/trippyethtoken
...
contract Trippy is ERC20, Ownable {
    ...
    uint256 public constant tSupply = 1e9 * (10**18);
    uint256 public maxBuyTransactionAmount = tSupply * 35 / 1000;
    uint256 public maxWalletToken = tSupply * 35 / 1000;
    uint256 public swapTokensAtAmount = tSupply * 5 / 10000;
    uint256 public maxSellTransactionAmount = tSupply * 35 / 1000;
    ...
    address payable public _marketingAddress = payable(0x271FEa2642F10d8b920264C5E7142E507e768233);
    address payable public devWallet = payable(0x00009B2e2c2Ac4ee5C46Cdd523382b2A367BbeFa);

    constructor() ERC20(unicode"Trippy", unicode"TRIPPY") {
    ...
    function approveMax(address spender, uint256 amount) public virtual returns (bool) {
