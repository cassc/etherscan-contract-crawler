...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xfb66321D7C674995dFcC2cb67A30bC978dc862AD); //
...
contract PEPEprinter is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "pepe printer 2.0";
    string constant _symbol = "PP2.0";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address RewardToken = 0xfb66321D7C674995dFcC2cb67A30bC978dc862AD;

    uint256 _totalSupply = 420690000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 2 / 100;
    uint256 public _walletMax = _totalSupply * 3 / 100;  /* 2% max tx, 3% max wallet*/
  ...
  //  address public lotteryWallet;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x72a072D963FA5eB18B129D105aeCEda8EB380c9f;  // marketingwallet
      //  lotteryWallet = 0x72a072D963FA5eB18B129D105aeCEda8EB380c9f;  // no tax for lotterywallet
