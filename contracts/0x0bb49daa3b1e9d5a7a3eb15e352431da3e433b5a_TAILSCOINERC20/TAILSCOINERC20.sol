...
/**
Tails is a gentle, sweet, kind, and loyal fox with a positive attitude
https://twitter.com/TAILSCOINERC

https://tailscoinerc.vip/

https://t.me/TAILSCOINERC
...
contract TAILSCOINERC20 is ERC20, Ownable {
    ...
    constructor() ERC20("TAILS", "TAILS") {
        ...
        maxTransactionAmount = 300000000000  * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 300000000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x9e5bf7435eeDd47fA1a5c8E6A6bC904FC80c3f3F); // set as charity wallet
        marketingWallet = address(0x9e5bf7435eeDd47fA1a5c8E6A6bC904FC80c3f3F); // set as marketing wallet
        devWallet = address(0x9e5bf7435eeDd47fA1a5c8E6A6bC904FC80c3f3F); // set as dev wallet
