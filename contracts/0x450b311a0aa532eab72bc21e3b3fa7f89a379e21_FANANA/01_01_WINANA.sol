...
Telegram:  https://t.me/Banana_Fun_Portal
Website:   https://bananafun.net
Twitter:   https://twitter.com/BananaFunBot
...
contract FANANA is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"Banana Fun";
    string private constant _symbol = unicode"FANANA";
    uint8 private constant _decimals = 9;

    uint256 private constant _Totalvy = 1000000 * 10 **_decimals;
    ...
    uint256 private _BuyTaxinitial=2;
    uint256 private _SellTaxinitial=2;
    uint256 private _BuyTaxfinal=2;
    uint256 private _SellTaxfinal=2;
    uint256 private _BuyTaxAreduce=2;
    uint256 private _SellTaxAreduce=2;
    ...
    constructor () {
        _qfmoburq = payable(0x80b8f322b13a70b5F10b77e5bbDE065158130970);
