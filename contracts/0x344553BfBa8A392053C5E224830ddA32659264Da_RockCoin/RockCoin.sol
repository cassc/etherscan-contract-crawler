...
contract RockCoin is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = unicode"Rock Coin";
    string private _symbol = unicode"ROCK";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 46510000000 * 10**_decimals;
