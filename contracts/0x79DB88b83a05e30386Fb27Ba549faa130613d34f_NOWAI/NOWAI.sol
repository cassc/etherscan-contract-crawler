...
pragma solidity ^0.8.7;
  ...
  contract NOWAI is ERC20, Ownable, Pausable {
      ...
      constructor() ERC20("NOWAI", "$NOWAI") {
          ...
          taxWallets["liquidity"] = address(0xd97b9b4f4666072AB9084b16a798B08e27956740);
          setBuyTax(0, 2, 1, 0);
          setSellTax(0, 2, 1, 0);
          taxWallets["dev"] = msg.sender;
          taxWallets["marketing"] = address(0xd97b9b4f4666072AB9084b16a798B08e27956740);
          taxWallets["charity"] = address(0xd97b9b4f4666072AB9084b16a798B08e27956740);
          exclude(msg.sender);
      ...
      function setBuyTax(uint256 dev, uint256 marketing, uint256 liquidity, uint256 charity) public onlyOwner {
          require(dev + marketing + liquidity + charity <= 25, "tax cannot be higher than 25");
