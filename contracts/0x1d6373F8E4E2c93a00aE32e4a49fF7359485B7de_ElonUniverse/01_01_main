...
contract ElonUniverse is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Elons Universe";
    string private constant _symbol = unicode"UniV";
