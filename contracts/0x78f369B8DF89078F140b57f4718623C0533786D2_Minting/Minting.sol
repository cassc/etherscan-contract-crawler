...
contract Minting is OMS {
    ...
    uint256 private _glPrice = 80000000000000000;
    uint256 private _glUserMintLimit = 2;
    ...
    uint256 _totalMints; //Amount of NFTs minted so far
   ...
   function wlData(address user) external view returns(uint256 userMints, uint256 price, uint256 userMintLimit, bool active) {
    ...
    function totalMints() external view returns(uint256) {return _totalMints;}
    //Moderator Functions======================================================================================================================================================
    ...
    function wlMint() external payable {
        ...
        require((_totalMints += amount) <= _maxSupply, "MAX_MINT_LIMIT_EXCEEDED");
