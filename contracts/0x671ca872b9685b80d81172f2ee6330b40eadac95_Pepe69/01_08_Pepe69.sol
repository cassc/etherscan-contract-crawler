...
Website:  https://www.pepe69.gay/

Telegram: https://t.me/PEPE69_ERC20
...
contract Pepe69 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe 69";
    string private constant _symbol = "PEPE69";
    ...
    address payable private _marketingAddress = payable(0x1bc0fB7bdF41cE17600DD3a4ceBbd19caB9dc7Ee);
    ...
    function _getTValues(uint256 tAmount, uint256 redisFee, uint256 taxFee)
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwner {
        require(maxWalletSize >= ((totalSupply() * 1) / 100), "Cannot set maxWalletAmount lower than 1%");
