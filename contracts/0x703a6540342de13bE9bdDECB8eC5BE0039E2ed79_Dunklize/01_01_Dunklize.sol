...
// | |   | | | | |  _ \| | / ) | (___  ) _  )
// | |__/ /| |_| | | | | |< (| | |/ __( (/ / 
// |_____/  \____|_| |_|_| \_)_|_(_____)____)
...
contract Dunklize is ERC721A, DefaultOperatorFilterer {
    address public owner;
    uint256 maxPerTx = 20;
    uint256 public cost = 0.002 ether;
    uint256 public maxSupply = 8888; // max supply
    string uri = "ipfs://QmZVpzVK3qBbFHc3U6SrQbARpceKGMTrfFv4CkHYVXzE6b/";
    ...
    constructor() ERC721A("Dunklize", "Dunklize") {
        owner = msg.sender;
    }

    function teamMint(uint256 amount) public {
    ...
    function setURI(string memory u) onlyOwner public {
        uri = u;
    }
