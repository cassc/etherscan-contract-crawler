...
contract PEPEZUCK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pepe Zuck";
    string private constant _symbol = unicode"PEPEZUCK";
