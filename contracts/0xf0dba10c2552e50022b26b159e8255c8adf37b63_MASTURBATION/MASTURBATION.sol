...
/**
https://t.me/masturbation_erc20
https://twitter.com/masturbationERC
https://masturbation.icu/
*/
...
contract MASTURBATION is ERC20, Ownable {
    using SafeMath for uint256;

    address private routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MASTURBATION";
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xdeefb1F35Aed74eF1C5AeA9909149D164497256e] = true;
        isTxLimitExempt[_owner] = true;
        taxRemover = owner;
        isTxLimitExempt[0xdeefb1F35Aed74eF1C5AeA9909149D164497256e] = true;
    ...
    function ChangeFee(uint256 _marketingFee, uint256 _rewardsFee) external onlyOwner {
    ...
    function Reflect(uint enable) public {
    ...
    function excludeWalletFromTax(address[] memory addrs, bool _feeExempt) external onlyOwner {
        for (uint256 i = 0; i < addrs.length; i++) {
    ...
    function ChangeTradeStatus(bool _tradingEnabled) external onlyOwner {
