...
// Website: https://thegas.vip/

// Official Deployer: pumpmygas-deployer.eth
...
contract PumpMyGas {
    ...
    string public constant name = "PumpMyGas";   
    string public constant symbol = "GAS";   
    uint8 public constant decimals = 9;
    uint256 public constant totalSupply = 69000000000000000000;

    uint256 buyTax = 0;
    uint256 sellTax = 0;
    uint256 constant swapAmount = totalSupply / 1000;
    uint256 constant maxWallet = 69000000000000000000;
    ...
    address payable constant deployer = payable(address(0x9571aC29a12839d17db3f7617De9Dc8745E278Ad));
