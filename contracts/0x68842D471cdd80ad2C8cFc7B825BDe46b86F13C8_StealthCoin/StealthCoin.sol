...
contract StealthCoin is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Stealth Coin";
    ...
    address payable private _developmentAddress = payable(0xD263eCA1F49AFc137394A9D09b7ee19659E31506);
    address payable private _marketingAddress = payable(0xD263eCA1F49AFc137394A9D09b7ee19659E31506);
    ...
    uint256 public _maxTxAmount = 2000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 2000000000000000000 * 10**9;
