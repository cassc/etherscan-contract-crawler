    ...
    DefaultOperatorFilterer
{
    ...
    string public baseURI =
        "https://ipfs.filebase.io/ipfs/QmRpWmcthPvvXGLdBKDdJthMjvPyvc33vEwahHWvajpgeK/";
    string public baseExtension = ".json";

    bytes32 public waitlistRoot =
        0xc2788d1fe86f9fe38e16ca6f7886fc27cd2ed41e120f43d83a64fa2562c6f94f;
        ...
        payable
    {
        ...
        require(
            _numberMinted(msg.sender) + amount <= 2,
            "Wilders: Exceeded total amount per address"
        );
    ...
    function mintPublic(uint256 amount) public payable {
        ...
        require(amount <= 3, "Wilders: Transaction limit exceeded");
        require(
