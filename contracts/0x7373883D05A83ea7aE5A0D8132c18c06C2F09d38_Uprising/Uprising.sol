...
contract Uprising is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "INSURGENCE, The Uprising";
    string private _symbol = "THE UPRISING";
    uint8 private _decimals = 9;
    uint256 private _supply = 10000000;
    uint256 public taxForLiquidity = 50;
    uint256 public taxForMarketing = 49;
    uint256 public maxTxAmount = 100000 * 10**_decimals;
    uint256 public maxWalletAmount = 100000 * 10**_decimals;
    address public marketingWallet = 0x1593Ea5338094fd92B792786A9da9BEC0ff3C32d;
    // TOKENOMICS END ============================================================>
