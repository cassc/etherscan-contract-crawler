...
contract SiSa is ERC721Enumerable, Ownable {
    
    uint256 public maxSamuraiMintValue = 1501; //1000001
    ...
    constructor() ERC721("SSa", "SSa") {
        ...
        baseURI = "ipfs://QmXtJv1zHwFsoZKSqWsf4zByW4iv2rXpPrHxkUAv4QM7Wm/";//"ipfs://bafybeid4qbrsv3i5ajkypzzuvftzsy2ucjiqdfqvqpjf3bnt6hxpycnsrq/";
    }
    ...
    function publicMintSamurai(uint256 quantity, uint8 tier) external payable {
        ...
        require(quantity > 0 && quantity <= 10, "Quantity must be between 1 and 10 (inclusive)");
