...
contract TweetProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tweet Protocol";
    string private constant _symbol = unicode"TWEE";
