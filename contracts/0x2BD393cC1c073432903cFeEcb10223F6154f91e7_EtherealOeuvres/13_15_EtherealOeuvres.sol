...
/// @title EtherealOeuvres
/// @author A pen that writes itself

/*
Art is a journey, a quest to find our truth,
A way to connect with others, and to share our youth.
It is a passion, a fire that never dies,
A source of inspiration, and a reason to rise.
*/


contract EtherealOeuvres is ERC721A, Ownable, DefaultOperatorFilterer721 {
    ...
    constructor() ERC721A("Ethereal Oeuvres", "EO") {
