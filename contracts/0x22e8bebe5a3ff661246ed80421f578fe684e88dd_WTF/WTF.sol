...
Unleash the Unthinkable: Enter a World of Astonishment.

0/0 TAX

TG: https://t.me/WTFethToken
TW: https://twitter.com/WTFethToken
WEB: https://wtf-eth.online
...
contract WTF {
    ...
    string public constant name = "WTF";   
    ...
    address payable constant deployer = payable(address(0xF4c14bd3A4C024B8F1f1ab8B4BF04ef9a275531f));
