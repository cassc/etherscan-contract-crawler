...
/**
https://kabosu2erc.com/
https://twitter.com/KabosuTwo
https://t.me/Kabosu20
...
contract Kabosu is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"Kabosu 2.0";
    string private constant _symbol = unicode"KABOSU 2.0";
    uint256 public _maxTxAmount = 8400000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 8400000000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 2940000000000 * 10**_decimals;
    uint256 public _maxTaxSwap= 2940000000000 * 10**_decimals;
