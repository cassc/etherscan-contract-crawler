...
contract DistributionContract is Ownable {
    ...
    uint24 public  feeForETHLINK = 10000;
    uint24 public  feeForHONOUSDC = 10000;
    ...
    address payable public HONOStakingReward;

    uint256 public PoolMinterP = 1000;
    address payable public PoolMinter;
    ...
    function distributeFee() external onlyOwner {
        ...
        if(HONO.balanceOf(address(this)) > 0)
        {
    ...
    function swapAndAddLp(uint256 totalEth) internal onlyOwner
    {
        ...
        _lpEngine.increaseLiquidityCurrentRange{value:ethToAddLp}(_tokenId,amountLINK,ethToAddLp,3000,0x0000000000000000000000000000000000000000);
    }
