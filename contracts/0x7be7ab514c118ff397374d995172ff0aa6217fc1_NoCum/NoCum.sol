...
contract NoCum is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SemenRetentionTaxYourBody";
    string private constant _symbol = unicode"NOCUM.0";
