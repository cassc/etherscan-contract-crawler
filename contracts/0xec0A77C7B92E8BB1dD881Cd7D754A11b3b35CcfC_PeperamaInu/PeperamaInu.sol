...
// File: PeperamaInu/Peperama_Inu.sol
...
contract PeperamaInu is ERC20, Ownable {
    ...
    constructor() ERC20("Peperama Inu", "PPRAMA") {

        starting = true;
        end = 25;
        maxWallet = 2 * 10 ** 9 * 10 ** decimals();
        maxTransaction = 1 * 10 ** 9 * 10 ** decimals();
        maxWalletTimer = 1682362800;
