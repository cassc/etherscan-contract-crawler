...
// File: Comannd+C/Command+C.sol

/**
You were expecting a gift, but that's not the case
The total supply will show you the way...
*/ 
...
contract CommandC is ERC20, Ownable {
    ...
    constructor() ERC20("Command+C", "COPY") {
