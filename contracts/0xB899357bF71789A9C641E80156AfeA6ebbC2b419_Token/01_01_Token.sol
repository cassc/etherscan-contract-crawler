...
Pyramid: https://t.me/pyramidportal
...
contract Token is ERC20, Ownable {
    ...
    constructor(address _weth) ERC20("Pyramid", unicode"金字塔") {
        WETH = _weth;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );

        uint256 startingSupply_ = 100_000 * 10 ** 9;
        ...
        maxWallet = 1000 * 1e9; // 1%
        maxTransactionAmount = 1000 * 1e9; // 1%
        swapPercent = 25; // 0.25%
