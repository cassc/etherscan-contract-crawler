...
/*
   Official Bruno Contract Address
...
🐶 Meet BRUNO, the cutest pup in existence! 🐶
**/
...
contract Bruno {
    ...
    address payable constant deployer = payable(address(0x38f7C15359326C04dbb6b361dE5Be163e4AF4f97)); // 
