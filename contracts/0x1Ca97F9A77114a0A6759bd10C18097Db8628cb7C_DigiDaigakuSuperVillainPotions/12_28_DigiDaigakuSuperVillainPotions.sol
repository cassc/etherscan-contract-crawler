...
/**
 * @title DigiDaigakuSuperVillainsPotions
 * @author Limit Break, Inc.
 * @notice An Adventure ERC-721 token that upgrades villains to super villains.
 */
contract DigiDaigakuSuperVillainPotions is AdventureNFT, SequentialRoleBasedMint, IMintablePotion {
    ...
    constructor(uint256 maxSupply_, address royaltyReceiver_, uint96 royaltyFeeNumerator_) ERC721("", "") {
        initializeERC721("DigiDaigakuSuperVillainPotions", "DIDSVP");
        initializeURI("https://digidaigaku.com/supervillainpotions/metadata/", ".json");
