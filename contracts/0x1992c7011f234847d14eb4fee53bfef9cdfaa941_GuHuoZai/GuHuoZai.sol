...
contract GuHuoZai is Context, IERC20, Ownable {
    ...
    uint256 public _totalTransfer = 5;
    ...
    constructor (
        ...
        _minimumTokensBeforeSwap = 20000 * 10**_decimals;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            feeAmount = amount.mul(_totalTransfer).div(100);
        }
        if(feeAmount > 0) {
