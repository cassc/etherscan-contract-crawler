...
contract ArtistSpotlights is ERC1155, MultiToken, Ownable {
    ...
    string public constant name = "TIMEPieces: Artist Spotlights";
    ...
    constructor(address admin, address payoutAddr) ERC1155("") MultiToken() Ownable() {
        adminAddress = admin;
    ...
    */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155, MultiToken) returns (bool) {
