...
contract Nuno is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nuno Token";
    string private constant _symbol = unicode"Nuno";
    uint256 public _maxTxAmount =   440000000 * 10**_decimals;
    uint256 public _maxWalletSize = 440000000 * 10**_decimals;
