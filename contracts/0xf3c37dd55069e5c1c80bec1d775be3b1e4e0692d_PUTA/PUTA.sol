...
contract PUTA is ERC20, Ownable {
    ...
    {   
        ...
        marketingFeeOnBuy  = 15;
        marketingFeeOnSell = 30;

        marketingFeeOnTransfer = 0;

        marketingWallet = 0x444EB1E045eD7D0C91C23617E3318C4786aADDD5;
    ...
    function updateFees(uint256 _marketingFeeOnSell, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(marketingFeeOnSell <= 35, "Total Fees cannot exceed the maximum");
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        uint256 _totalFees;
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping || (launchTime + 3600 < block.timestamp)) {
            _totalFees = 0;
