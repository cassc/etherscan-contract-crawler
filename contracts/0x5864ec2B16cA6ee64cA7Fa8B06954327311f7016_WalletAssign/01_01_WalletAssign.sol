...
contract WalletAssign is Ownable, ReentrancyGuard {
    ...
    function allocateBalances(address[] calldata _beneficiaries, uint256[] calldata _earnings) external onlyOwner {
        ...
        for (uint256 i = 0; i < _beneficiaries.length; i++) {
            ...
            _increaseAllocation(_totalEarned);
        }
    }
