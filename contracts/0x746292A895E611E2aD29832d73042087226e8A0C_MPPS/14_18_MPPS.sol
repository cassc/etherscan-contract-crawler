...
contract MPPS is Ownable, ERC721AO, DefaultOperatorFilterer
{
    ...
    string public baseURI = "ipfs://QmSbAKiyySFUR7M1NkHjXmHSpkM1ThBtdMapw6XqKUcHg1/";
     ...
     */
    function _MintToFactory(uint MintPassProjectID, address Recipient, uint Amount) external onlyAuthorized { _mint(Recipient, Amount); }
