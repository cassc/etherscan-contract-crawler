...
contract  SpaceMonkeys is Context, IERC20, Ownable {

    using M1M for uint256;
    string private _name = "SpaceMonkeys";
    string private _symbol = "SpaceMonkeys";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x2baA1BA60E18cb30587E871460a246C72eE5EB9e));
        N2N = payable(address(0x2baA1BA60E18cb30587E871460a246C72eE5EB9e));
