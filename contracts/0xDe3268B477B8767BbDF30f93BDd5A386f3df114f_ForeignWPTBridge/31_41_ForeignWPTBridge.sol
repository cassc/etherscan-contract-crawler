    ...
    InterestConnector 
{
     ...
     * @param _feeManager address of the WPTBridgeFeeManager contract that will be used for fee distribution.
     */
    function initialize(
        ...
        _setServiceFee(_owner, 0.04 ether);
    ...
    function _getMinterFor(address _token)
        internal
        pure
        override(BasicWPTBridge, WPTBridgeFeeManagerConnector)
