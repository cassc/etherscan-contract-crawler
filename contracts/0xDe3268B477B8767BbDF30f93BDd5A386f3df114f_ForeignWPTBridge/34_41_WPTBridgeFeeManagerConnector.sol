...
import "../../Ownable.sol";
import "./WPTBridgeFeeManager.sol";

/**
 * @title WPTBridgeFeeManagerConnector
 * @dev Connectivity functionality for working with WPTBridgeFeeManager contract.
 */
abstract contract WPTBridgeFeeManagerConnector is Ownable {
     ...
     */
    function feeManager() public view returns (WPTBridgeFeeManager) {
        return WPTBridgeFeeManager(addressStorage[FEE_MANAGER_CONTRACT]);
    }
    ...
    function _distributeFee(
        ...
        WPTBridgeFeeManager manager = feeManager();
