...
You know what we did last year around this time!!! Those that know know and those that dont well watch and see!!

WE ARE ONE??????

TELEGRAM LINK ( https://t.me/zombietama_channel )

Twitter Link ( https://twitter.com/Zombie_Tama )

Website Link ( zombietama.com )

Lock/verification/calls/ and more will follow a bit after launch so sit tight and enjoy the ride!!!
...
contract ZombieTama is Context, IERC20, Ownable {
    ...
    string private _name = "ZombieTama";
    string private _symbol = "ZTama";
    ...
    uint256 public maxTxAmount = _tTotal.mul(40).div(1000); // 4%
    address payable private _devWallet = payable(0x8BC03EEB17a8774917ab3dD2E3b345B30EFa339d);
    address payable private _marketingWallet = payable(0xB90f32287e201F286e9d338DAebB3962d09E23e4);
