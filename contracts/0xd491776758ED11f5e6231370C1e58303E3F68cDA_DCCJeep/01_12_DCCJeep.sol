...
contract DCCJeep is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    constructor()
        ERC721A("Dream Cars Collection Jeep", "DCCJeep")
    {
        admins[msg.sender] = true;
    }

    modifier onlyAdmin() {
        require(admins[_msgSender()], "DCCJeep: Caller is not the admin");
        _;
    }
        ...
        onlyAdmin
    {
        ...
        require(total + totalQuantity <= MAX_ELEMENTS, "DCCJeep: Max limit");
