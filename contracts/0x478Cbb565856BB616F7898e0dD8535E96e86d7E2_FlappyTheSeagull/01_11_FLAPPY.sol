...
contract FlappyTheSeagull is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = unicode"Flappy the Seagull";
    ...
    function openTrading() external onlyOwner() {
        ...
        uint256 initialTokens = initialTotalSupply.per(73); uint256 desiredETHAmount;
