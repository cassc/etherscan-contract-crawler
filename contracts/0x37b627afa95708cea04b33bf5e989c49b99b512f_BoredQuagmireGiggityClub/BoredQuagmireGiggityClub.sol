...
// File: contracts/boredQuagmireGiggityClub.sol

pragma solidity ^0.8.4;

contract BoredQuagmireGiggityClub is ERC721A, Ownable {

    using Strings for uint256;

    string public baseURI = "https://boredquagmiregiggityclub.s3.amazonaws.com/metadata/";
    ...
    constructor() ERC721A("Bored Quagmire Giggity Club", "GIGGITY") {}
    ...
    function mintFree(uint256 _amount) external payable {
		...
		require(totalFreeMinted + _amount <= maxFreeSupply, "Cannot exceed Free BQGC supply." );
        require(totalSupply() + _amount <= maxSupply, "Sold out.");
