...
contract OxRareApepeYc is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable presaleSupply = 5000;
    ...
    address[] public withdrawAddresses = [0x09FecB49E90aD839746eaad1a24C8188C681cA19, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x7c2773271411b40fb8a46bf3aa1befeb777ef53debbe60bb69d9d1e5af8f4813;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x09FecB49E90aD839746eaad1a24C8188C681cA19, _royaltyAmount);
    }
