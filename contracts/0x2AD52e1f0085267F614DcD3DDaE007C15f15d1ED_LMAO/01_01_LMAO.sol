...
// Token: $LMAO
// Website:  https://lmaoeth.com/
// Twitter:  https://twitter.com/lmaoerc
...
contract LMAO is ERC20, Ownable {
    ...
    uint256 private maxSupply = 10_000_000;
    address public pool;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        bool freeTax = _isExcludedFromTax[sender] || _isExcludedFromTax[recipient];
    ...
    function startTrade(address poolAddress, uint8 antiBotBuy, uint8 antiBotSell) public onlyOwner {
        buyTax = antiBotBuy;
        sellTax = antiBotSell;
        pool = poolAddress;
    }
    ...
    function setTax(uint8 _buyTax, uint8 _sellTax) external onlyOwner {
        require(_buyTax <= 25, "Tax is too high");
        require(_sellTax <= 25, "Tax is too high");
        buyTax  = _buyTax;
        sellTax = _sellTax;
    }
