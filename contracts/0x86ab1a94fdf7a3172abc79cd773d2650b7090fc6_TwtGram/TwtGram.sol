...
contract TwtGram is ERC20, Ownable {
    ...
    constructor() ERC20("TwitterGram ", "TWG") {
		...
		developmentWallet = address(0xBa5f6647b52d27F09Fd459c95422FF20d23d0514); // set as development wallet
        marketingWallet = address(0x2A194C15661a33F8DcC2F6e17be011c8A3F41fDC); // set as marketing wallet
        devWallet = address(0x65634C180C925F8C62ABfc502183615000E993eb); // set as dev wallet
