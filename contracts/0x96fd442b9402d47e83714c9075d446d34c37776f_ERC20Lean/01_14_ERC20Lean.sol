...
contract ERC20Lean is AccessControl, ReentrancyGuard, VRFConsumerBase {
    ...
    function createRaffle(
        ...
        emit RaffleCreated(idRaffle, _prizeAddress, _prizeNumber);
    ...
    */
    ...
    function stake(uint256 _raffleId) external {
    ...
    function transferPrizesAndFunds(
        ...
        _asset.transfer(raffle.winner, raffle.prizeNumber); // transfer the tokens to the contract
    ...
    function transferRemainingFunds(
        ...
        || entryInfo.status == STATUS.CANCELLED, "Wrong status");
