...
tg:Portal : https://t.me/RobloxOof
...
contract OOF is Context, IERC20, Ownable {
    ...
    if (block.chainid == 56){
     ...
     uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0x0D1D80392a2afc05C261AdF8e03AD6E9193F6284);
         ShareWallet = payable (0x0D1D80392a2afc05C261AdF8e03AD6E9193F6284);
   ...
   function removeMaxTxLimitss() external onlyOwner {
    maxTxAmount = _tTotal;}
