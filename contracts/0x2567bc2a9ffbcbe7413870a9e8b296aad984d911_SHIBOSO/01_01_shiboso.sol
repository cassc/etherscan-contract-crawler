/* The SHIBA Rebirth - SHIBOSO. A Boss of all the DOGS.

Telegram: https://t.me/Shiboso
Twitter: https://twitter.com/ShibosoETH
Website: https://www.shiboso.org
*/
...
contract SHIBOSO is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerCA = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D Uniswap Router
    ...
    constructor() ERC20("SHIBOSO.ORG", "SHIBOSO") {
        ...
        marketingwallet = address(0x112eC5DF7276d3d700155c2CeC351cC8301Bfd24); // 
        devWallet = address(0x112eC5DF7276d3d700155c2CeC351cC8301Bfd24); 
        liqWallet = address(0x112eC5DF7276d3d700155c2CeC351cC8301Bfd24); 
        operationsWallet = address(0x112eC5DF7276d3d700155c2CeC351cC8301Bfd24);
