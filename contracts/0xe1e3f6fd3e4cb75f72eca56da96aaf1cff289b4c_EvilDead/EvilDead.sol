...
contract EvilDead is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Kibatar";
    string private _symbol = "KTAR";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x5077E96D770FDb6D16C803ea72487692897778f3);
    address payable public DeveloperWallet = payable(0x3fcbB83C637C51C5E0FcFadfe94AaFA969194E07);
    ...
    uint256 public _buyMarketingFee = 85;
    uint256 public _buyDeveloperFee = 1;
    
    uint256 public _sellLiquidityFee = 1;
    uint256 public _sellMarketingFee = 85;
