...
contract ERC721ACloneable is IERC721A, Initializable {
    ...
    uint256 internal _maxNumberOfTokenToMint;
     ...
     */
    function _startTokenId() private pure returns (uint256) {
        return 1;
    }
    ...
    function _mint(address to, uint256 quantity) internal virtual {
        ...
        require(startTokenId <= _maxNumberOfTokenToMint, 'Mint limit reached');
