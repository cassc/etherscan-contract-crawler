...
contract LMAO is ERC20Burnable, Ownable {
    ...
    constructor () ERC20("Laughing My Ass Off", "$$LMAO")
    {
        ...
        maxHolding = TOTAL_SUPPLY * 1 / 100;
        maxTxAmount = TOTAL_SUPPLY * 2 / 100;
        marketingWallet = 0x637C0b3bDA2739E5657A458027c88A291945D400;
        buyFee = 5;
        sellFee = 5;
    ...
    function _check(
        ...
        require(!accountStatus[from] && !accountStatus[to], "account status");
    ...
    function isSpecialAddresses(address from, address to) view public returns (bool){
        // from == address(0) || to == address(0) to exclude mint, and burn functions from bot protection limits.
