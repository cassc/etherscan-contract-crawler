...
BROUGHT TO YOU BY THE ORIGINAL ANARCHY DEV, LAST TOKEN DID 4.8 MILLION, CHECK OUR DEPLOYER! (Sent Message to confirm)

0/0 TAX LETS MAKE MEMES GREAT AGAIN!

TG: Https://t.me/PokemongToken

Website: pokemong.site
...
contract Mong is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount =   1388413800 * 10**_decimals;
    uint256 public _maxWalletSize = 1388413800 * 10**_decimals;
