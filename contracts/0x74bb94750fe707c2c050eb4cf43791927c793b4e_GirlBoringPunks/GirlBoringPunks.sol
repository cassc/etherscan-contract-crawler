...
// File: contracts/GirlBoringPunks.sol
...
contract GirlBoringPunks is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2125;
  ...
  ) ERC721A("Girl BoringPunks", "GIRLPUNK") {
