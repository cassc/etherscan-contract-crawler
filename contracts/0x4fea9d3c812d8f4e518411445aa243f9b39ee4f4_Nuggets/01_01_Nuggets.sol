...
contract Nuggets is IERC721A { 
    ...
    uint256 public constant MAX_FREE = 222;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0.001 ether;

    string private constant _name = "Nuggets";
    string private constant _symbol = "Nuggets";
    string private _baseURI = "QmaRhV7TkwNAeUBEckAT5unY6mFkSVUHQgshbWu3dtzkzg";
