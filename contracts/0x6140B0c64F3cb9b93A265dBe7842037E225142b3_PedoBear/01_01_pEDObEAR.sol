...
/* 
    JOIN OUR TELEGRAM: https://t.me/PedoBearCoin
*/
...
contract PedoBear is ERC20, Ownable {
    ...
    string private _name = unicode"Pedo Bear";
    string private _symbol = unicode"BEAR";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 329000000000 * 10**_decimals;
