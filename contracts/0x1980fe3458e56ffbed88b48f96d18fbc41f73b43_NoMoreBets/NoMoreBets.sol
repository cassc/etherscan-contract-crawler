...
contract  NoMoreBets is Context, IERC20, Ownable {
    ...
    string private constant _name =    unicode"No More Bets";
    string private constant _symbol =  unicode"孤注一掷";
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 1 * 1e6 * 10**_decimals;
    uint256 private _BuyTax=           0;
    uint256 private _SellTax=          1;
    uint256 private _buyCount=         0;
    uint256 private _taxSwapThreshold=  _tTotal * 5 / 10000;
    ...
    function changeTax(uint256 BuyTax, uint256 SellTax) external onlyOwner {
        _BuyTax = BuyTax;
        _SellTax= SellTax; 
    }
