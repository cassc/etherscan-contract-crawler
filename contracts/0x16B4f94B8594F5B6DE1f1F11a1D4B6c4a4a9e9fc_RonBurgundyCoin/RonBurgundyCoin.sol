...
// Ron Burgundy Coin
// W. https://www.ronburgundyeth.xyz/
// T. https://twitter.com/RonBurgundyETH
// T. https://t.me/RonBurgundyETH_Portal
...
contract RonBurgundyCoin is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 100_000_000 * (10**_decimals);
    string private constant _name         = "RonBurgundyCoin";
    string private constant _symbol       = "CLASSY";
    ...
    uint16 private _taxSharesLP          = 3;
    uint16 private _totalTaxShares = _taxSharesMarketing + _taxSharesDevelopment + _taxSharesLP;

    address payable private _walletMarketing = payable(0x9e1653EdB549F84934e36a8159e236b8872fbA39); 
    address payable private _walletDevelopment = payable(0x9e1653EdB549F84934e36a8159e236b8872fbA39); 
    ...
    constructor() Auth(msg.sender) {
        ...
        uint256 airdropAmount = _totalSupply * 100 / 100;
