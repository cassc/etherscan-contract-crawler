...
This Is Fine is a two-pane image of an dog trying to assure himself 
...
and published in early January 2013, the cartoon is typically used as a reaction
image to convey a sense of self-denial or 
acceptance in the face of a hopeless situation.
...
💻Website : https://thisisfine.fun/

📲Telegram : https://t.me/THISISFINEETH

🐧Twitter : https://twitter.com/THISISFINEOERC
*/
...
contract THISISFINE is ERC20, Ownable {
    ...
    constructor() ERC20("This is fine", "THISISFINE") {
		...
		charityWallet = address(0x7C377ABf2CBeB0582FBb6b28a307043833069419); // set as charity wallet
        marketingWallet = address(0x7C377ABf2CBeB0582FBb6b28a307043833069419); // set as marketing wallet
        devWallet = address(0x7C377ABf2CBeB0582FBb6b28a307043833069419); // set as dev wallet
