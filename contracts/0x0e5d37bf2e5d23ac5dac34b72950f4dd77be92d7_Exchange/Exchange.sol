...
//import "./CustomUniswapV3Pool.sol";
...
contract Exchange is Ownable, Pausable {
	...
	uint256 public maxAmount = 100000 * (10**18); //1000 tokens with 18 decimals
	uint256 public errorPercetage = 1;

	IERC20 public theToken = IERC20(0x64b78325d7495D6d4be92f234fa3f3B8d8964B8b); //the token being sold

	//CustomUniswapV3Pool public pool = CustomUniswapV3Pool(0x4D3d03fAD5c74c65c5248D53BB2d8CF5fD5ede8C);
	IUniswapV3Pool public pool = IUniswapV3Pool(0x546D4695c4fFF0e0aDF0D904CCDE3A13472f9480);
