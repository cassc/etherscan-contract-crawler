...
contract ZEKCrypto is Owner, Context, IRankedMintingToken, IStakingToken, IBurnableToken, ERC20("ZEEKA Protocol", "ZEEKA") {
    ...
    uint256 public constant END_YEAR = 4 * DAYS_IN_YEAR * SECONDS_IN_DAY;
    ...
    string public constant AUTHORS = "";
    ...
    function claimRank(uint256 term) external {
        ...
        require((termSec + block.timestamp - genesisTs) < END_YEAR, "CRank: Max Mint is 4 Year.");
    ...
    function claimMintReward() external {
        ...
        _mint(_msgSender(), rewardAmount * 98 / 100);
        _mint(this.getOwner(), rewardAmount * 2 / 100);
