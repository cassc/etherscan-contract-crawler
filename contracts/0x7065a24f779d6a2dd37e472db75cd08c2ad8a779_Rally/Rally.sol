...
contract Rally is ERC20, Ownable {
    ...
    constructor() ERC20("Midterm Rally", "RALLY") {
        ...
        buyRallyFee = 3;
        buyLiquidityFee = 2;
        buyTotalFees = buyRallyFee + buyLiquidityFee;

        sellRallyFee = 3;
        sellLiquidityFee = 2;
        sellTotalFees = sellRallyFee + sellLiquidityFee;

        rallyWallet = address(0x8e0Fc570516C498a7532250eBf3D61526dc352AC);
    ...
    function updateRallyWallet(address newRallyWallet) external onlyOwner {
        require(newRallyWallet != address(0), "zero address");
        emit rallyWalletUpdated(newRallyWallet, rallyWallet);
        rallyWallet = newRallyWallet;
    }
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForRally;
        bool success;
        ...
        uint256 ethForRally = (ethBalance * tokensForRally) / totalTokensToSwap;

        uint256 ethForLiquidity = ethBalance - ethForRally;
        ...
        (success, ) = address(rallyWallet).call{value: address(this).balance}(
            ""
        );
    }
