// https://t.me/tsukiresearch
// https://twitter.com/tsukiresearch/
// https://medium.com/@usagitsuki
...
contract TSUKI is ERC20, Ownable {
    ...
    constructor() ERC20("USAGI TSUKI", "TSUKI") {
        ...
        maxWallet = totalSupply * 15 / 1000; // 1.5% mx wal
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% swap wl
