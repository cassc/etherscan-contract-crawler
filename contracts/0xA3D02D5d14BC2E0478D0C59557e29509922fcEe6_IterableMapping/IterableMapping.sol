...
contract GLT is ERC20, Ownable {
    ...
    address private constant otherWallet = 0x42125b3c3D7Ee027156AdDaE6daAC7F44A416079;
    ...
    constructor() payable ERC20("GeoLeaf", "GLT") {

        rewardToken = 0xF33893DE6eB6aE9A67442E066aE9aBd228f5290c; //WGRW (BSC)
        ...
        treasuryWallet = 0x3da0f1d63428d9A8E7317F08D2B1b6f253D464CD;
...
//        );
        ...
        payable(otherWallet).transfer(otherHalf);
