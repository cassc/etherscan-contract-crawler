...
// File contracts/MechaPilotsApes.sol

pragma solidity 0.8.9;

contract MechaPilotsApes is ERC721Delegated {
    uint256 public MAX_SUPPLY = 12000;
    uint256 public reserveTokenId = 0;
    uint256 public whitelistPassword = 4321;
    ...
    function claim(uint256 amount, uint256 whitelist) public {
        require(sale, "Claim not yet open");
        require(reserveTokenId + amount <= MAX_SUPPLY, "Sold Out");
        require(whitelist == whitelistPassword, "Unable to claim");
