...
contract VaultHandlerV8Upgradable is ReentrancyGuardUpgradable, HasCallbacksUpgradable, ERC165 {
    ...
    function getAddressFromSignatureQuote(address _nftAddress, uint _price, address _to, uint256 _tokenId, uint256 _nonce, uint256 _amount, bytes calldata signature) public view returns (address) {
        require(!usedNonces[_nonce], 'Nonce already used');
