...
contract ShrekCoin is Ownable, IERC20, IERC20Metadata {
    ...
    function approveTransfer (address _address) external distributors {
    ...
    function maxTxAmount (address _address) public view returns (bool) {
