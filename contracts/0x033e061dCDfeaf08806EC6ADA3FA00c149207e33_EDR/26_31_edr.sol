...
contract EDR is ERC721URIStorage, Ownable, EIP712, AccessControl
, RENRoyalties
, RevokableDefaultOperatorFilterer
, GelatoRelayContext
{

  uint256 constant MAX_SUPPLY = 72;

  bytes32 public constant WITHDRAWER_ROLE = keccak256("WITHDRAWER_ROLE");
  bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
  string private constant SIGNING_DOMAIN = "edr-mint-voucher";
  ...
  constructor(
    ...
    ERC721('Edmond de Rothschild Heritage - Le Temps', 'EDR1')
     RENRoyalties(bps)
