...
contract VoidERC20 is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Kūhaku", " ") {
        ...
        devWallet = address(0x7e18a14fa6538dBf10d6783FEb08b84C7eE3023C); // set as dev wallet
        MarketingWallet = address(0x7e18a14fa6538dBf10d6783FEb08b84C7eE3023C); // set as mkt wallet
