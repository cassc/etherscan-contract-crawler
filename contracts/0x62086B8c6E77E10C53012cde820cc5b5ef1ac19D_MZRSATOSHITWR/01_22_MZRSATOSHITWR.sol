...
contract MZRSATOSHITWR is ERC721, ERC721Enumerable, DefaultOperatorFilterer, Ownable {
    ...
    uint private priceInUsdt = 1500000000;
    uint16[300] private ids;
    uint16 private index;

    constructor() ERC721("MZRSATOSHITWR", "MZRSATOSHI") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeicqg57ad2bsik4cnffl6q2zjwf65zjodonibpulvefwkxr2hmqg3m/";
    }
