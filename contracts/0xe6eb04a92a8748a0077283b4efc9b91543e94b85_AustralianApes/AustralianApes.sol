...
contract AustralianApes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVYYgrVfsvQShcKNAKBMeTS46A5oNa7C5HfY8VzJqvhEw";
    ...
    constructor(
    ) ERC721A("Australian Apes", "AUSSIEAPES", 100, maxSupply) {
    }
