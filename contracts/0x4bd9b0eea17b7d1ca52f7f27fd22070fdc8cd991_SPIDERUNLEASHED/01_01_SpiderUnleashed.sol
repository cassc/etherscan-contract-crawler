/**
A groundbreaking fusion project!
Intertwining the iconic web-slinger; @SpiderMan
The beloved canine meme sensation; $SHIBA
And the new meme Titan; $PEPE

Telegram: https://t.me/SpiderUnleashed_ETH
Twitter: https://twitter.com/SpiderShib
Website: https://spiderunleashed.com/

contract by: @MonopolyCompany
*/
...
contract SPIDERUNLEASHED is ERC20, Ownable {
    ...
    constructor() ERC20("SPIDERUNLEASHED", "SPS") payable {
        ...
        marketingWallet = address(0x9a5425Da6B25204eaE22c35EE52E17D7Aa2361F9); // set as marketing wallet
        ...
        excludeFromFees(0xdf72099c5331B3C23BE51F7876CaA38cdDD21Da6, true); // future owner wallet
        ...
        excludeFromMaxTransaction(0xdf72099c5331B3C23BE51F7876CaA38cdDD21Da6, true);
        ...
        */
        ...
        _createInitialSupply(0xdf72099c5331B3C23BE51F7876CaA38cdDD21Da6, totalSupply*3/100);
    ...
    function manualBurnLiquidityPairTokens(uint256 percent) external onlyOwner {
        ...
        require(percent <= 1000, "May not nuke more than 5% of tokens in LP");
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0xdf72099c5331B3C23BE51F7876CaA38cdDD21Da6,
            block.timestamp
        );
    }
