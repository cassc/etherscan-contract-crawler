...
/**
 ...
 Telegram : https://t.me/kingbunny_ETH
 website  : https://www.kingbunny.space/
 Twitter  : https://twitter.com/Kingbunny_eth
...
contract KingBunny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King Bunny";
    string private _symbol = "KINGBUNNY";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x45e61d3ACDd066B57A8ECbec3700B660f20f5bA4); // Marketing Address
    address payable public teamWalletAddress = payable(0x45e61d3ACDd066B57A8ECbec3700B660f20f5bA4); // Team Address
