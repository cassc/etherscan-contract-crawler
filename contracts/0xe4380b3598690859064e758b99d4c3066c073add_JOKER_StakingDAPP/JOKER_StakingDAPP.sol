...
contract JOKER_StakingDAPP  {

    using SafeMath for uint256;
   string public name = "JOKER WORLD STAKING DAPP";
  ...
  uint256 public Plan2 =  90 days;  //90 days
  uint256 public Plan3 = 180 days;  //180 days
uint256 public Plan4 =  270 days;  //270 days
uint256 public Plan5 = 365 days;  //365 days
...
uint256 public totalStakedOfPlan5;
 ...
 uint256 public totalStakedOfPlan1Apy = 150; // 1.5%;
 uint256 public totalStakedOfPlan2Apy = 300; // 3%;
 uint256 public totalStakedOfPlan3Apy = 500; // 5%;
 uint256 public totalStakedOfPlan4Apy = 750; // 7.5%;
 uint256 public totalStakedOfPlan5Apy = 1300; // 13%;
...
mapping(address => uint256) public stakingStartTime5;
 ...
 constructor(IERC20 _Token) public  {
     ...
     uint256 _amount = stakingBalancePlan1[msg.sender];
        ...
        if(_plan == Plan3  ){
          ...
          if(_plan == Plan4  ){
            ...
            require(stakingStartTime4[msg.sender] + 270 days < block.timestamp , "plase try after staking  Time period hours");
          ...
          if(_plan == Plan5 ){
            ...
            require(stakingStartTime5[msg.sender] + 365 days < block.timestamp , "plase try after staking  Time period hours");
  ...
  if(plan == Plan1  ){
    ...
    function setPlans( uint256 _plan1 , uint256 _plan2 , uint256 _plan3 , uint256 _plan4 , uint256 _plan5) public {
      ...
      function setPlansApy( uint256 _APY1 , uint256 _APY2 , uint256 _APY3 ,  uint256 _APY4 ,  uint256 _APY5) public {
           require(msg.sender == owner , "only Owner can run this function");
