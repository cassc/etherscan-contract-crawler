...
contract RICEBABY is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function premint(uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount <= maxSupply, "Ricebaby NFT is sold out!");

    if (msg.sender != owner()) {
      require(msg.value >= cost / 10 * _mintAmount, "The price of Ricebaby nft is 0.005 ether");
    }
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
      require(msg.value >= cost * _mintAmount, "The price of Ricebaby nft is 0.05 ether");
    }
