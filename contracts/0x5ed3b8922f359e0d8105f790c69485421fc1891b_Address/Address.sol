...
/**
Multi-Chain Capital: $MCC2.0
-You buy on Ethereum, we farm on multiple chains and return the profits to $MCC2.0 holders.

Tokenomics:
2% of each buy goes to existing holders.
2% of each sell goes into multi-chain farming to add to the treasury and buy back MCC2.0 tokens.
