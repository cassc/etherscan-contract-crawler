 ...
 * @notice This contract handles minting ZenAcademy Letter Remnants tokens.
 */
contract ZenAcademyLetterRemnants is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    string public baseTokenURI =
        "ipfs://bafybeiekwdxb3sdyhmepjyseuoquc3hbmtlfagak726yqltodiqychyalq/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 7855;
    uint96 public royaltyFee = 0;

    constructor() ERC721A("ZenAcademy Letter Remnants", "ZenAcademyRemnant") {
