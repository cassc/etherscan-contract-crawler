...
contract rayc is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor(string memory _baseUrl) ERC721A("Reddit Avatar Yacht Club", "RAYC") {
    ...
    function withdraw() public payable onlyOwner {
        ...
        (bool hs, ) = payable(0x2D6D4CBbE680250C1fE92ECBfFdbEF3F891ce553).call{value: address(this).balance * 25 / 100}("");
        require(hs);
