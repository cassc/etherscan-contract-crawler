...
TG: https://t.me/UnicronPortal
TW: https://twitter.com/Unicron_erc
Web: https://unicroncoin.com/
...
contract UNICRON is ERC20, Auth {
    ...
    string public constant name = "Unicron";
    string public constant symbol = "UNICRON";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x232afe0136F6329a98233B570bdF4672A00d7233;
        operationsFeeReceiver = 0x8B485f8D83A678858BE05aeB27545EBb02122B5e;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!tradingOpen && !isFeeExempt[sender]){
            require(isWL[sender] || isWL[recipient],"trading not open yet");
        }
    ...
    function setSwapBackSettings(bool _enabled, uint256 _denominator) external onlyOwner {
        require(_denominator <= 50,"Max allowed CA sells are 2%");
