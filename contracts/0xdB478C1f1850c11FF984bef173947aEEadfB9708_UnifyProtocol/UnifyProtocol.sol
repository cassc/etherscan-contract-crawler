...
https://t.me/UnifyProtocol

Unify Protocol DeFi suite allows users to simply deposit and enjoy high-yield farming strategy and staking program.
You can say goodbye to bouncing between protocols to farm for the best yield, and just sit back and watch your asset grow.  
Join Unify for the future of high-speed yield.
...
contract UnifyProtocol is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Unify Protocol";
    ...
    address payable private _developmentAddress = payable(0xbe3720019123c6CcEf191DEc7d6d5d773bec7e2E);
    address payable private _marketingAddress = payable(0xbe3720019123c6CcEf191DEc7d6d5d773bec7e2E);
