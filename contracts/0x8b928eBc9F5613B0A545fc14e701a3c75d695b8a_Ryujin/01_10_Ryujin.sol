...
contract Ryujin is ERC20, Ownable {
    ...
    uint256 public walletPercent = 3;
    ...
    constructor(address _liquidityManagerAddress) ERC20("Ryujin", "Ryujin") {
        devWallet = owner();

        uint256 totalSupply = 1 * 1e6 * 1e6; // 100,000
        supply = totalSupply;
