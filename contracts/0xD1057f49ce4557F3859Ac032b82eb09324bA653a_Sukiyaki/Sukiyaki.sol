...
🔥Sukiyaki is the first dex aggregator that uses a custom built A.I. to route for the best prices on chain and cross chain;

Sukiyaki aggregates 14 liquidity sources (and searches cross chain for routes) to return the best rates to users at no additional fees aside from the standard 0.3%. 

It also offers access to infinite liquidity by aggregating these DEXs to ensure that trades of any amount can be taken without altering slippage. 

🔥Sukiyaki is developed to return the best rates to users.

//Website: http://sukiyaki.finance/
//Twitter: http://twitter.com/sukiyaki_dex
//Telegram Channel: https://t.me/sukiyaki_dexERC
...
contract Sukiyaki is ERC20, Ownable {
