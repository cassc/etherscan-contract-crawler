...
contract TAV is IERC721A { 
    ...
    uint256 public constant MAX_FREE = 167;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0.002 ether;

    string private constant _name = "Tubes and Variations";
    string private constant _symbol = "TAV";
    string private _baseURI = "QmXiNE6qBez5ndk4pwxUBzGq1e3c7VkgiubwDq4UWzFsCA";
