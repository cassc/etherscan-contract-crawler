...
https://etherscan.io/tx/0x83d46c00efb80887ce7cdaa5667bc57098fa4272c02dd57c802ebd9f02395d60
...
contract LAC is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Muiclac", unicode"LAC") {
    ...
    function updateSwapTokensAtAmounts(uint256 newAmount) external onlyOwner returns (bool){
    ...
    function addBlacklistWallet(address _address, bool status) external onlyOwner {
