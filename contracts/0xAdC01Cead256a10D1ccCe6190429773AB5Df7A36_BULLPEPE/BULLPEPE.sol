...
contract BULLPEPE is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "Bull PEPE";
    string private constant _Symbol = "BULLPEPE";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e6 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0xdCB4EbF29CE299B50a1FA0d83f22f375107e89b3);
        treasuryAddress = payable(0xdCB4EbF29CE299B50a1FA0d83f22f375107e89b3);
        devAddress = payable(0xdCB4EbF29CE299B50a1FA0d83f22f375107e89b3);
        ...
        _MaxWallet = _Supply.mul(6).div(100);
    ...
    function GROWLIVE() external onlyOwner returns (bool){
    ...
    function GROW(address account) external onlyOwner {
