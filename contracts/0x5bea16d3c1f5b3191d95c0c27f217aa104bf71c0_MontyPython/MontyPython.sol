...
contract MontyPython is Context, IERC20, Ownable {
    ...
    string private constant _name = "Monty Inu";
    ...
    constructor () {
        _feeAddrWallet = payable(0x54568C7E7bca43B4De02cbE5146A0aBd59615403);
