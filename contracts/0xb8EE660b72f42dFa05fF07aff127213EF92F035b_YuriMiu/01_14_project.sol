...
contract YuriMiu is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 1000;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.03 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0xd06539d74df40fc4b057d9995a95d6f41595977c77b01de8c9aeffb9eb6c4b48;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmXbujrd5dz5zZsPwDKKZiekFv8p1tG9Bze9EYfHG6k7iY";

    constructor() public ERC721A("Yuri Miu", "YURI", 1000, 1000) {}
