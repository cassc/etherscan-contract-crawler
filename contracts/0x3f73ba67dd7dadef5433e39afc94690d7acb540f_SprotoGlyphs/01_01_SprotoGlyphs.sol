...
contract SprotoGlyphs is IERC721A { 
    ...
    uint256 public constant MAX_FREE = 356;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0.002 ether;

    string private constant _name = "Sproto Glyphs";
    string private constant _symbol = "SprotoGlyphs";
    string private _baseURI = "QmRa4MVTYubDtvGgK7tUjqdtfv8HfapQmDGZgyGWqCWoZE";
