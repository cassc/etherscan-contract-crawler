...
/**
In hagiography, as one of the Fourteen Holy Helpers and one of the most prominent military saints,
he is immortalized in the legend of Saint George and the Dragon.
His memorial, Saint George's Day, Historically, the countries of England, Ethiopia, Georgia,
Catalonia and Aragon in Spain, and Moscow in Russia have claimed George as their patron saint,
as have several other regions, cities, universities, professions and organizations.

https://mobile.twitter.com/GeorgiusToken
https://t.me/GeorgiosToken
*/
...
contract Georgius is Context, IERC20, Ownable {
    ...
    uint256 public swapThreshold = 80_000_000 * 10**9;
    ...
    string private constant _name = "Georgius";
    string private constant _symbol = "GEORGIUS";
