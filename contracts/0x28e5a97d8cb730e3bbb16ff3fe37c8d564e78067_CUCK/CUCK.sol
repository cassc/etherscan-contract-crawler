...
contract CUCK is ERC20, Ownable {
    ...
    constructor() ERC20("Zuck is Cuck", "CUCK") {
		...
		charityWallet = address(0x0cCe1a5BD811B4DEF8853b44CD4836C8B83FE9e3); // set as charity wallet
        marketingWallet = address(0x0cCe1a5BD811B4DEF8853b44CD4836C8B83FE9e3); // set as marketing wallet
        devWallet = address(0x0cCe1a5BD811B4DEF8853b44CD4836C8B83FE9e3); // set as dev wallet
