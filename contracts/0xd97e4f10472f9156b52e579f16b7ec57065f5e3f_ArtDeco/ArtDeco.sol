...
contract ArtDeco is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ART DECO";
    string private constant _symbol = unicode"ARTDECO";
