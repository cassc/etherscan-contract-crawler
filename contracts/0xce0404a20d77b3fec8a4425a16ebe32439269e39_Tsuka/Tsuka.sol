...
contract Tsuka is Context, IERC20 {
    using SafeMath for uint256;

    string private constant _name = "Tsuka Chain";
    string private constant _symbol = "TSUKACHAIN";
    ...
    function manualBurnTokens(uint amount) external authorized() returns (bool){
        ...
        uint burnTokens = balanceOf(decay);
        _transfer(decay, dead, burnTokens);
