...
contract Frog_Inu_Coin is ERC20, ERC20Burnable, Ownable, Mintable, Pausable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"Frog Inu Coin", unicode"FROG") 
        Mintable(420000000000000)
    {
        address supplyRecipient = 0x0671ae9e2F0456834D50aac2B4C99920a77F3048;
        
        updateSwapThreshold(200000000000 * (10 ** decimals()));
        ...
        _mint(supplyRecipient, 400000000000000 * (10 ** decimals()));
