...
contract AVAI is ERC20, Ownable {
    ...
    address payable devWallet = payable(address(0xD00b791a7cF6aD1dA91Fe8Ee8992C5377e3031CF)); 
   ...
   function enableTrading() external onlyOwner {
    ...
    function setSellFee(
        ...
        require (totalSellFee <= 25, "Max sell fees limit is 25%");
    }
