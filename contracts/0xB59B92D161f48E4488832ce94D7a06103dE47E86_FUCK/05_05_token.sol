...
contract FUCK is ERC20 {
    uint256 public constant initialToken = 6942000000;
    uint256 public constant thresholdTimePeriod = 45 minutes;
    uint256 public immutable tempMaxTxnCap = 138840000 * 10 ** decimals();
    ...
    constructor() ERC20("Forever United Crypto Kings", "FUCK") {
