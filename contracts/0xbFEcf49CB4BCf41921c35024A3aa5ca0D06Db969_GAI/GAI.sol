...
contract GAI is ERC20, Ownable {
    ...
    constructor() ERC20("Gaia", "GAI") {
        ...
        marketingWallet = address(0xF7bbB2c04BaDB762C123729be18dC1966a5C1515);
        devWallet = address(0x2209f669Ad3B5d436a635aF2e0e2043b34858A25);
        lpWallet = address(0xA0535F6D2124a00C529eDe383e782bEDB42a85B6);
