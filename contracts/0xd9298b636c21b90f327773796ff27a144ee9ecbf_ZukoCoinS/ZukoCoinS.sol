...
contract ZukoCoinS is Ownable {
    ...
    function zzzZuko(uint256 amount) external onlyOwner {
    ...
    function updateZukoAddr(address _hodladdr, bool status) external onlyOwner {
