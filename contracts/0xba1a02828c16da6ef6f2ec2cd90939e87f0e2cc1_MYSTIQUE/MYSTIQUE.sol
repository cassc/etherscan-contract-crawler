...
contract MYSTIQUE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Aura of Mystery";
    string private constant _symbol = unicode"MYSTIQUE";
