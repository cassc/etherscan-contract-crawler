...
// https://t.me/radia88portal

// https://radia88.xyz/

// 0x817C63E5Ae56ec3A01Cbb117864B4155A434581A
 ...
 */
contract RADIA88 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 public constant MAXSupply =8888888  * 10 ** 18;
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        _bnbbusd = _msgSender();
        _yydsed(_msgSender(), 8888888 * 10 ** decimals());
    }
