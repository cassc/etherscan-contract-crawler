...
contract Silex is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Silex"; 
    string private constant _symbol = unicode"SLX"; 
    ...
    address payable private _marketing = payable(0x3BDDfAC12Adbc642b721C74Ae662Fec2381a1ccF);
