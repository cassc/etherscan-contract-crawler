...
contract ShibariumDAO is IERC20, Auth {
	string _name = "ShibariumDAO";
	string _symbol = "SDAO";
	...
	address payable private _ethTaxWallet1 = payable(0xF79054D070BD796d5e0238B369DD7dC8dD83042C); 
	address payable private _ethTaxWallet2 = payable(0xF79054D070BD796d5e0238B369DD7dC8dD83042C); 
	address payable private _ethTaxWallet3 = payable(0xF79054D070BD796d5e0238B369DD7dC8dD83042C); 
	address private _tokenTaxWallet = address(0x6480C82E66b1520F156B17c2dD18ca9fBb16fE18); 
