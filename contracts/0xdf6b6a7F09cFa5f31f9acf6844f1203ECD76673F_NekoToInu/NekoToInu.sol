...
/* 
Something big come from small thing
*/
...
contract NekoToInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Neko To Inu";
    string private _symbol = "NEKOINU";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x09417dB34aA29eC1E5F22C96437C060a42e1d68D);
    address payable private taxWallet2 = payable(0x09417dB34aA29eC1E5F22C96437C060a42e1d68D);
    ...
    uint256 public _buyMarketingFees = 18;
    uint256 public _buyDevelopmentFees = 1;
    uint256 public _sellLiquidityFees = 1;
    uint256 public _sellMarketingFees = 28;
