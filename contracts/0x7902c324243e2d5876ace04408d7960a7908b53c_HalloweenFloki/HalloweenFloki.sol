...
/**
    ...
    Telegram: https://t.me/HalloweenFlokiERC
*/
...
contract HalloweenFloki is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x17a529821a8890b6eEc75a50dC7b0ACDc8E7Ff6F); // Marketing Address
    address payable public multiSigAddress = payable(0x17a529821a8890b6eEc75a50dC7b0ACDc8E7Ff6F); // Marketing Address
    address payable public devAddress = payable(0x17a529821a8890b6eEc75a50dC7b0ACDc8E7Ff6F); // Dev Address
    address payable public liquidityAddress = payable(0x17a529821a8890b6eEc75a50dC7b0ACDc8E7Ff6F); // Liquidity Address
    ...
    string private constant _name = unicode"Halloween Floki";
    string private constant _symbol = unicode"HF";
