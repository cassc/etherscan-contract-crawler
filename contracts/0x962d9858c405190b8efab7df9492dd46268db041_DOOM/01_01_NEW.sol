...
contract ERC20 is Context, IERC20, IERC20Metadata {
   ...
   constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feePayer = 0x1D2FFf11ADe50C8aFB6D84C653080e937379EAf6;
    }
...
contract DOOM is ERC20, Ownable {
    ...
    constructor() ERC20("DOOM", "MOOD") {
        ...
        buyTotalTax = buyMarketingFee + buyLiquidityFee;

        sellMarketingFee = _sellMarketingFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellTotalTax = sellMarketingFee + sellLiquidityFee;
    ...
    function swapBack() private {
        ...
        uint256 ethForLiquidity = ethBalance - ethForMkt;
