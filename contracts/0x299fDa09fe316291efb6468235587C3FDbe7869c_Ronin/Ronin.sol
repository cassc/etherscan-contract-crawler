...
contract Ronin is Context, IERC20, Ownable {
    ...
    string private _symbol = "Ronin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7C4a91f4F3f866310812BFA60b7C34ee01bE6747); // marketing wallet
    address payable lotteryWallet = payable(0x80e956703E2FC91B822D8FCDD17979886C163203);  // lotterywallet

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address internal immutable routerFactory = 0xbE09CB3E4cB6D6E4C2fAa20Ba102a816Ee6e4175;  
