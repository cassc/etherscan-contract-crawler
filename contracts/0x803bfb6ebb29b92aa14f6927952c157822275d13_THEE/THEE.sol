...
contract THEE is Context, IERC20, Ownable {
    ...
    string private constant _name = "THEE BADDEST";
    string private constant _symbol = "THEE";
    ...
    uint256 public _maxTxAmount = 20000000000 * 10**18; // 10% of max supply 
    uint256 public numTokensSellToAddToLiquidity = 5000000 *10**18;

    uint256 public maxWalletToken = 600000000 * (10**18); // 3%
    uint256 public maxSellTransactionAmount = 6000000000 * (10**18); // 3%
    uint256 public maxBuyTransactionAmount = 500000000 * (10**18); // 1%
    ...
    constructor() {
        ...
        _MarketingWalletAddress = payable(0x87b71BD0e773f974d9E98421a48297B159FC1286);
