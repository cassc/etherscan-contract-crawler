...
contract FeesManagerLogic is Ownable {
    ...
    function estimateFees(
        ...
        require(_msgSender() == hinodeAddress, "Not Hinode contract");
    ...
    function updateHinodeAddress(address _newAddr) external onlyOwner {
        hinodeContract = IHinode(_newAddr);
        hinodeAddress = _newAddr;
    }
}