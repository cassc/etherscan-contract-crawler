...
contract TheHobbit is ERC20, Ownable {
    ...
    constructor() ERC20("The Hobbit", "$hobbit") {
        ...
        _maxTransactionAmount = TOTAL_SUPPLY * 1 / 100; // 1% per total supply
        _maxWallet = TOTAL_SUPPLY * 2 / 100; // 2% per total supply
        _swapTokensAtAmount = TOTAL_SUPPLY * 1 / 1000; // 0.1% per total supply
        ...
        marketingWallet = 0xcd4Ec42a637B090D0aA56FB0D3BC6294Dac7AdBf;
        ...
        setIsExcludeFromFees(address(devWallet), true);
        ...
        setIsExcludeFromLimit(address(devWallet), true);
