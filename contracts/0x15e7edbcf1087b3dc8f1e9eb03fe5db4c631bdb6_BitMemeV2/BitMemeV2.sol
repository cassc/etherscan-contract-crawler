...
contract BitMemeV2 is IERC20 {
    using SafeMath for uint256;

    string private _name = "BitMeme V2";
    string private _symbol = "BTMV2";
    ...
    address private constant _marketingWallet = 0x612Fc6d792173f407c3227537A54Ce3a6A61cDa8;
