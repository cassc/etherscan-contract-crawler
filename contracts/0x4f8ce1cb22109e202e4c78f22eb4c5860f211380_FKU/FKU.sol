...
contract FKU is ERC20, Ownable {

    string _name = unicode"꧁𝓕𝓾𝓬𝓴 𝔂𝓸𝓾꧂";
    string _symbol = "FKU";
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        uint256 _buyTreasuryFee = 24;
        uint256 _buyLiquidityFee = 0;
 
        uint256 _sellTreasuryFee = 55;
        ...
        treasuryWallet = address(0x5D4b3C82d9d1D60e06419a21968b75627c1dc822);
    ...
    function addLP(uint ethToAdd) external onlyOwner{
         // Send the specified amount of ETH to the token contract
        (bool success,) = address(this).call{value: ethToAdd}("");
        require(success, "Failed to send ETH to the token contract");
        uint256 ethAmount = address(this).balance;
        require(ethAmount > 0, "ETH balance must be greater than 0");
        uint256 tokenAmount = balanceOf(address(this));
        require(tokenAmount > 0, "Token balance must be greater than 0");
