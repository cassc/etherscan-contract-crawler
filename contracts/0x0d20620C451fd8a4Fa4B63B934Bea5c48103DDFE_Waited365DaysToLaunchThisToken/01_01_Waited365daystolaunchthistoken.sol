...
abstract contract Ownable is Context {
    ...
    constructor() {
        _transferOwnership365(_msgSender());
    }
    ...
    function TransferOwnership(address newOwner) public virtual onlyOwner {
        ...
        _transferOwnership365(newOwner);
    }

    function _transferOwnership365(address newOwner) internal virtual {
...
contract Waited365DaysToLaunchThisToken is ERC20, Ownable {
    constructor() ERC20("Waited365DaysToLaunchThisToken", "365") {
