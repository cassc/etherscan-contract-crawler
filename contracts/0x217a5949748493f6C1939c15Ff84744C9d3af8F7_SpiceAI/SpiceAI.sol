...
/*
 ...
 SSSSS  PPPPPP  IIIII  CCCCC  EEEEEEE      AAA   IIIII 
SS      PP   PP  III  CC    C EE          AAAAA   III  
 SSSSS  PPPPPP   III  CC      EEEEE      AA   AA  III  
     SS PP       III  CC    C EE         AAAAAAA  III  
 SSSSS  PP      IIIII  CCCCC  EEEEEEE    AA   AA IIIII 

Website:       https://spice.xyz/               Total Supply:       60,000,000,000 SPICEAI
Telegram:      https://t.me/spiceai             Max Transaction:    1% 
Whitepaper:    https://docs.spice.xyz/          Max Wallet:         2% 
Gitbook:       https://github.com/spiceai       Transaction Fee:    6%   

Set slippage to 6-8% : 3% to LP, 3% tax for Marketing & GPU Hosting costs.
...
contract SpiceAI is ERC20, Ownable {
    ...
    constructor() ERC20("SpiceAI | spice.xyz", "SpiceAI") {
        ...
        uint256 totalSupply = 60_000_000_000 * 1e18;

        maxTransactionAmount = 600_000_000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 1_200_000_000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x881dAaB65C846bf5b4dfDe388909f5b6AfFAFeeE); // set as charity wallet
        marketingWallet = address(0x881dAaB65C846bf5b4dfDe388909f5b6AfFAFeeE); // set as marketing wallet
        devWallet = address(0x881dAaB65C846bf5b4dfDe388909f5b6AfFAFeeE); // set as dev wallet
