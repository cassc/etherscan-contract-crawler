...
contract Sayonara is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Sayonara さよなら";
    string private constant _symbol = "Sayonara";
    ...
    constructor () {
        dev = payable(0x16023B4d54529fe4cC3d8C6b8118B81B91f5870a);
        mktg = payable(0x1f170aDc01aB432aB2f6F995B2eB48e935788139);
