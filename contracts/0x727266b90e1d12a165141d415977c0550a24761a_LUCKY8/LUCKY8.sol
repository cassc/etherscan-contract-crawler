...
//https://t.me/LLuucckkyy88
//https://twitter.com/LUCKY84848
...
contract LUCKY8 is ERC20, Ownable {
    ...
    constructor () ERC20("Chinese Luck", "LUCKY8") 
    {   
        ...
        _mint(msg.sender, 888_888_888_888_888 * 1e18);
    ...
    function setTaxes(uint256 _buyTax, uint256 _sellTax) public onlyOwner {
        require(_buyTax <= 50 && _sellTax <= 50, "Cannot set above 50%.");
        buyTax = _buyTax;
        sellTax = _sellTax;
    }
