...
contract $HEHE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 820000000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 1250000000000 * 10**_decimals;
    
    uint256 public maxSellAmount = 6150000000000 * 10**_decimals;
    uint256 public maxBuyAmount = 6150000000000 * 10**_decimals;
    uint256 public maxWalletBalance = 61500000000000 * 10**_decimals;

    address public marketingAddress = 0xf52aB0F716C0e1ab7134B5998bD4f050EB435b5E;
    address public devAddress = 0xc583f95EcD6026bD44E1f63BA5d98502302Fa933;

    string private constant _name = "Hehe Ape Coin";
    ...
    Taxes public taxes = Taxes(0,4,1,0);
    Taxes public sellTaxes = Taxes(0,4,1,0);
    ...
    // Owner cannot transfer out $HEHE from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out $HEHE!");
