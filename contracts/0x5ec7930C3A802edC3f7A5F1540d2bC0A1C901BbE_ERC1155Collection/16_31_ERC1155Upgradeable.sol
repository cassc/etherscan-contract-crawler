 ...
 * Based on code by OpenZeppelin (v4.8.0):
    ...
    IERC1155MetadataURIUpgradeable
{
    ...
    function _beforeBurn(address /* from */, uint256 id, uint256 amount) internal virtual {
    ...
    function _uncheckedInc(uint256 x) internal pure returns (uint256) {
        unchecked {
            return x + 1;
        }
    }
