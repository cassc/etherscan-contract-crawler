...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    constructor() ERC20("Probably Nothing 2.0", "PN2.0") {
        ...
        marketingWallet = address(0x1f7B5650724eaf266254789250A55428a853f1B5); // set as marketing wallet
        devWallet = address(0x1f7B5650724eaf266254789250A55428a853f1B5); // set as dev wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x1f7B5650724eaf266254789250A55428a853f1B5),
            block.timestamp
        );
    }
