...
https://twitter.com/cz_binance/status/1585349973872644097
...
contract ThatWasThen is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'That was then';
    string private constant _symbol = 'That was then';
