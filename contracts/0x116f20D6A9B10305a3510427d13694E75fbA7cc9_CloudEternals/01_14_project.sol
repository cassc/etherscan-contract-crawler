...
contract CloudEternals is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 800;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x6585997377d8e47057b13a551ab24900b0333bc225e999358356fa4198dd40ea;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmdWZAHg3dXd2jsxyx9jqTocb9ypyUHeWQhiUJ5ci3zr3Y";

    constructor() public ERC721A("Cloud Eternals", "CLOUD", 800, 800) {}
