...
/*
^https://t.me/ShibaOldETH
^https://www.shibaold.online/
*/
...
contract ShibaOld is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x90A97522D7D9521Bfbf96F30feD09a51b8D25a47));

    string private _name = "ShibaOld";
    string private _symbol = "ShibaOld";
