...
contract HUAJIAOReligion is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("HUAJIAOReligion", "HJ", maxBatchSize_, collectionSize_) {
...
//提款钱包
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x34bD2004A8Bf2a51c3412e63C968C6C9E4d28aae);
