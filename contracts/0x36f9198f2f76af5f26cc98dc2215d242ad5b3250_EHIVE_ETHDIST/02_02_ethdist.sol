    ...
    */
    function unstake() external {
        ...
        if (eHive.totalSupply().add(reward) < eHive.maxSupply() && stakingEnabled) {
            ...
            eHive.transfer(msg.sender, stakers[msg.sender].staked.add(reward));
        } else {
            eHive.transfer(msg.sender, stakers[msg.sender].staked);
        }

        totalStaked -= stakers[msg.sender].staked;
