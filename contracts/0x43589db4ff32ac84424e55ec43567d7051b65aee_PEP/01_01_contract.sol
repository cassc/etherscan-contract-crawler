...
Telegram: https://t.me/peperonitoken
Website: https://peperoni.lol/
...
contract PEP is IERC20, Ownable {
    ...
    uint256 private constant _maxFee = 4; //Highest Tax can be set
    uint256 public _maxTxAmount = 425000000 * 10 ** 9;
    uint256 public _maxWalletSize = 425000000 * 10 ** 9;
    string private constant _name = "PEPEroni";
    string private constant _symbol = "PPRONI";
