...
// File: contracts/Transformigos.sol
...
contract Transformigos is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 3420;
  ...
  ) ERC721A("Transformigos", "TRANSFORMIGOS") {
