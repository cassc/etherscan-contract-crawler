...
contract RadiateStaking is Ownable, DSMath {
    ...
    Pool private Electro = Pool(0, 50, 0);
    //Pool Neutron
    Pool private Neutron = Pool(0, 75, 7 days);
    //Pool Beta
    Pool private Beta = Pool(0, 100, 14 days);
    //Pool Alpha
    Pool private Alpha = Pool(0, 160, 30 days);
