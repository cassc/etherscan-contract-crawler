...
/**
Telegram: http://t.me/Kirby_erc20
...
contract KIRBY is ERC20, Ownable {
    ...
    constructor() ERC20("Kirby Coin", "KIRBY") payable {
        ...
        uint256 totalSupply = 42000000000000 * 1e5 * 1e18;
    	...
    	marketingWallet = address(0xDe0B486E415F361387Bae3336eAD9FEF54b754D3); // set as Marketing wallet
        devWallet = address(0xE01881C6530A2925A6cb518DA820C4EDCf925709); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xDe0B486E415F361387Bae3336eAD9FEF54b754D3, true);
        excludeFromFees(0xE01881C6530A2925A6cb518DA820C4EDCf925709, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xDe0B486E415F361387Bae3336eAD9FEF54b754D3, true);
        excludeFromMaxTransaction(0xE01881C6530A2925A6cb518DA820C4EDCf925709, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xE01881C6530A2925A6cb518DA820C4EDCf925709,
            block.timestamp
        );
    }
