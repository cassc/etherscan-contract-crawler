...
contract Monday is ERC721A, Ownable,DefaultOperatorFilterer {
    ...
    string public baseTokenURI="https://ipfs.io/ipfs/bafybeiezqf3tiln745iokmpfcfp4m7itqmkkcywmxsw5n2zyjyw2efgzay/";
    ...
    constructor() ERC721A("Monday", "Monday") {
    ...
    function MondayLive(uint256 _quantity) external payable callerIsUser {
        require(
