...
Twitter: https://twitter.com/orychain

Telegram: https://t.me/orychain

Website: http://www.orychain.com/
...
contract Orychain is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Orychain";
    string private constant _symbol = "ORYC";
    ...
    address payable private _developmentAddress = payable(0x488c4F76F3E2Ee6eb3168540bcBb638822350184); 
    address payable private _marketingAddress = payable(0x13d4B03119dA28B6bf202F28C3538f1beF37774E);
