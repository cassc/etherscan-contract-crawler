...
Hedge Swap Token (WASSA)
Token Decentralized Swap Ecosystem / Protocol Hedge Stable Finance
...
contract ERC20Token is IERC20, SafeMath {
    ...
    constructor() {
        name = "Hedge Swap Token";
        symbol = "WASSA";
        decimals = 18;
        _totalSupply = 5000000000 * 10**18;

        _admin = 0xEDE44b639E3a73c6D6BAB8ae5BC3C0A538FaEefA; // admin account
