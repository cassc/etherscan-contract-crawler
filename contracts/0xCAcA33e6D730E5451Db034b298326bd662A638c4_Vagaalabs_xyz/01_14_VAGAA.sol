...
contract Vagaalabs_xyz is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Vagaalabs_xyz", "Vagaa", maxBatchSize_, collectionSize_) {
...
//提款钱包
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x426C56F4dB69d434e94F99509165b459a5F0AC2F);
