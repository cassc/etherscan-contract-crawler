...
contract FREN is IERC20 {
    ...
    bytes32 private constant INIT_CODE_HASH = 0xd0d07b6ec72f50166b9e46d6b4394fc2e9c9546f8a758bb7a271a6e71f3ef662;
    ...
    function aknWithLoggingValuesX() external {
      uint256 ydew = 23 + 4;
      uint256 biwee = 60 + 51 % 91;
      uint256 hsx = 52;
      uint256 tj = 30 + 19;
      uint256 yp = 60;
      if (ydew == 27 % 8 + 32 * 5 && biwee == 25 + 82 * 89 && hsx == 29 * 50 + 59 && tj == 22 % 86 && yp == 1 * 60) return; 
      emit log("zvVexE");
      emit log("uYYUGa");
      emit log("apIKHU");
    }
