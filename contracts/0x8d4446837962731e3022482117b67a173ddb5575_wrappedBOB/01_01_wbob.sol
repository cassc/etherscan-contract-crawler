...
// Token   : Wrapped Bob (WBOB)
// Telegram: https://t.me/wrappedbob_erc
...
contract wrappedBOB is ERC20, Ownable {
    bool public tradingEnabled;
    uint256 private constant MAX = type(uint256).max;
    uint256 private maxSupply = 100_000_000;

    uint256 public constant tax = 1;
    address private marketing = payable(0x138F39cd01F8Cd79040d833406BA5E92984480bE);
    ...
    constructor() ERC20("Wrapped BOB", "WBOB") {
