...
contract WTFBot is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0x99990Bf08b12C07b883e2d2C2C45919eCc524103);
    address payable public devAddress = payable(0x3f28eeF30A2913069a7a9AA7cF6fCb0aD3f7Ca30);
    address public newOwner = 0x99990Bf08b12C07b883e2d2C2C45919eCc524103;
    ...
    string private _name = "WhatTheFuck Bot";
    string private _symbol = "WTFBot";
