...
contract TwitterWallet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Twitter Wallet";
    string private _symbol = "TWALLET";
    uint8 private _decimals = 18;

    address public marketingWallet = 0x611D89456F7781731323B851B7e1Ff2b793A647d;
    address public developerWallet = 0x30F3D3C3eaf4f674915aD90980E82651fb9db741;
