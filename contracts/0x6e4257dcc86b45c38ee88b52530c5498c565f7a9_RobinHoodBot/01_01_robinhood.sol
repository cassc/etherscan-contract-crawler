/**
    RobinHoodBot
    The All-In One Telegram Trading Bot.
    
    Website: robinhoodbot.app
    Twitter: twitter.com/bot_robinhood
    Telegram: t.me/Robinhood_BotTg
    Medium: robinhoodbot.medium.com/
    Docs: robinhood-bot.gitbook.io/overview/
**/
...
contract RobinHoodBot is ERC20, Ownable {
    ...
    constructor() ERC20("Robinhood", "HOOD") {
        ...
        uint256 _buyRevShareFee = 15; //1.5%
        uint256 _buyLiquidityFee = 10; //1%
        uint256 _buyTeamFee = 25; //2.5%

        uint256 _sellRevShareFee = 15; //1.5%
        uint256 _sellLiquidityFee = 10; //1%
        uint256 _sellTeamFee = 25; //2.5%
        ...
        revShareWallet = address(0x78B2Cfc083A47b35a2a9Aca11bE90d64afEB48d7); // set as revShare wallet
        teamWallet = address(0x9aB63fC5797Cc1880ddBB58Cd7E06b76B49bDB65); // set as team wallet
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellRevShareFee + sellLiquidityFee + sellTeamFee;
        require(sellTotalFees <= 50, "Sell fees must be <= 5%");
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                fees = amount.mul(sellTotalFees).div(1000); // Fixed point arithmatic 
            ...
            // on buy
                ...
                fees = amount.mul(buyTotalFees).div(1000); // Fixed point arithmatic 
    ...
    function withdrawStuckHOOD() external onlyOwner {
    ...
    function updateBuyFeesAfterthreeMonths() external {
        require(block.timestamp >=1699660800,"Buy fees can be updated 3 months after launch");
        buyRevShareFee = 20;
        buyLiquidityFee = 10;
        buyTeamFee = 20;
        buyTotalFees = buyRevShareFee + buyLiquidityFee + buyTeamFee;
    ...
    function updateSellFeesAfterthreeMonths() external {
        require(block.timestamp >=1699660800,"Buy fees can be updated 3 months after launch");
        sellRevShareFee = 20;
        sellLiquidityFee = 10;
        sellTeamFee = 20;
