...
contract ENIGMA696 is ERC721A, Ownable {
    using Strings for uint256;

    uint16 public immutable MAX_SUPPLY = 696;
    uint16 public immutable MAX_PER_TX = 5;
    uint256 public PRICE = 0.0025 ether;
    bool public IS_SALE_ACTIVE = false;
    string _URI = "https://gateway.pinata.cloud/ipfs/QmfJfcgwWp8YrDyH8fofa9zEbmBTEUQUEEfxjQ6SFeWNz5/";
