...
contract QNTM is ERC20, Ownable {
    struct Tax {
    ...
    uint256 public maxWallet = (_totalSupply * 100) / 100;
    bool public tradingStatus = false;

    //Wallets
    address public MarketingWallet = 0x3CA1FE6CF5800F061DABD30ea9301b514D0d7F5A;
    address public stakingVault = 0xF45CdDe59cbB0FaADcba9c5e69C41A925b96ea63;
    address public stakingContract;

    constructor(address _stakingContract) ERC20("Quantum Finance", "QNTM") {
        ...
        uint256 stakingVaultportion = (_totalSupply * 20) / 100;
