...
// File: contracts/ERC721ARoyalty.sol
...
abstract contract ERC721ARoyalty is ERC2981, ERC721A {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721A, ERC2981) returns (bool) {
        if (interfaceId == type(ERC2981).interfaceId) {
            return true;
        }
...
contract Token is StartTokenIdHelper, ERC721ARoyalty, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
