...
contract OCTOCULT is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "OCTOCULT";
    string private constant tokenSymbol = "OCTOCULT";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 888e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xD66c3D2693975c50503A6FF886827627291C23CC);
        devAddress = payable(0xD66c3D2693975c50503A6FF886827627291C23CC);
