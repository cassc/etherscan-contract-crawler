...
contract X  is ERC20, Ownable {
    ...
    constructor() ERC20("X SHIBASWAP", "XSHIBA") {
        ...
        maxTransactionAmount = totalSupply * 10 / 1000; // 100%
        ...
        marketingWallet = address(0xb4decaD52CC8e637055ac598f39703209d191b14);
        devWallet = address(0xb4decaD52CC8e637055ac598f39703209d191b14);
