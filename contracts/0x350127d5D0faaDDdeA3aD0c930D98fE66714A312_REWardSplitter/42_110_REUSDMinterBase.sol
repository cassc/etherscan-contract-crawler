...
abstract contract REUSDMinterBase is IREUSDMinterBase
{
    ...
    */
    ...
    {        
        return stablecoins.getDecimals(paymentToken) == 6 ? paymentTokenAmount * 10**12 : paymentTokenAmount;
    }
    ...
    function mintREUSDCore(address from, IERC20 paymentToken, address recipient, uint256 reusdAmount)
        internal
    {
        uint256 factor = stablecoins.getDecimals(paymentToken) == 6 ? 10**12 : 1;
