...
We have never been anybody, but together we will become somebody.

$NOBODY: 100m Supply
0 TAX

TG: https://t.me/NobodysERC20
TW: https://twitter.com/NobodysERC20
WEB: https://wearenobodys.click
...
contract WeAreNobodys {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "We Are Nobodys";   
    string public constant symbol = "NOBODY";   
    ...
    address payable constant deployer = payable(address(0x36A9db15097236f06217c611D5d3D00db5F8Ec06));
