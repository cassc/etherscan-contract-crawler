...
contract PKE is ERC721A, Ownable, ReentrancyGuard, ERC2981 { 
...
uint256 public devTotal;
    ...
    constructor(string memory initBaseURI) ERC721A("Pepeki Elementals", "PKE") {
        baseURI = initBaseURI;
        setDefaultRoyalty(msg.sender, 750); // 10%
    }
