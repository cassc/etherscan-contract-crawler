...
contract LeBooToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "LeBooChain";
    string  public constant symbol = "LeBoo";
    ...
    uint256 public tokenExchangeRate = 625; // 625 LeBoo 兑换 1 ETH
