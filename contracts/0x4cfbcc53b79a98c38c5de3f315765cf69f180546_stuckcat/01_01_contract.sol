/*
  ...
  TWITTER: https://twitter.com/stuckcaterc
  
  TELEGRAM: https://t.me/StuckCatErc

  WEBSITE: https://www.stuckcat.com/
...
contract stuckcat is Context , IERC20, Ownable {
    ...
    string private constant _name = "Stuck Cat";
    string private constant _symbol = "STUCKC";
    ...
    function changeFee(uint256 _buy, uint256 _sell ) external onlyOwner {
      _buyTax = _buy;
      _sellTax = _sell;
    }
