...
contract BlackClock is IERC721A { 
    ...
    uint256 public constant MAX_FREE = 566;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0.002 ether;

    string private constant _name = "BlackClock";
    string private constant _symbol = "BlackClock";
    string private _baseURI = "QmckEhbiE697XNLV1j59ibDKb8SDFAn8h47nQgHQAXuuik";
    ...
    function mint(uint256 amount) external payable{
        ...
        require(amount <= 5, "max 10 per TX");
