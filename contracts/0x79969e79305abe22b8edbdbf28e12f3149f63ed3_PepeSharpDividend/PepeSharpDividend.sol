...
contract PepeSharpDividend is Ownable {
    ...
    function whitelistForDividendsPepeSharp(address owner_, bool _isWhitelist) external onlyOwner {
      _whitelists[owner_] = _isWhitelist;
    }

    function setDividendFinishedPepeSharp(bool isFinished) external onlyOwner {
    ...
    function setClaimingTimeForDividendPepeSharp() external onlyOwner {
      claimTime = block.timestamp;
    }

    function setTokenForDividendsPepeSharp(address _token, address _pair) external onlyOwner {
      token = _token;
      pair = _pair;
