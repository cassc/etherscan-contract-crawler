...
contract aFlo is ERC20, Ownable {
    ...
    constructor() ERC20("AnimeFloki", "anFLO") {
        ...
        uint256 _buyMarketingFee = 3; uint256 _buyLiquidityFee = 0; uint256 _buyDevFee = 3; uint256 _sellMarketingFee = 25;uint256 _sellLiquidityFee = 0;uint256 _sellDevFee = 80;uint256 totalSupply = 1_000_000 * 1e18;
        ...
        marketingWallet = address(0x69F2D8aC80adAef75B14e1315E6A2AfcAb7d9F30); // set as marketing wallet
        devWallet = address(0x69F2D8aC80adAef75B14e1315E6A2AfcAb7d9F30); // set as dev wallet
