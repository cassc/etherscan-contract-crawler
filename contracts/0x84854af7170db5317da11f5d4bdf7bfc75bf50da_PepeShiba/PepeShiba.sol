...
/*
Pepe Shiba: The First Super Memes Collide!
Meet Pepe Shiba $PEBA - the ultra-famous Pepe meets the iconic Shiba, creating an electrifying new meme symbol!
It's more than a crypto coin, it's a meme explosion making waves across the blockchain!


web: https://pepeshiba.dog/
twt: https://twitter.com/PepeShiba_
tg : https://t.me/PepeShibaOfficialPortal
*/
...
contract PepeShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "PepeShiba";
    string private constant _symbol = "PEBA";
