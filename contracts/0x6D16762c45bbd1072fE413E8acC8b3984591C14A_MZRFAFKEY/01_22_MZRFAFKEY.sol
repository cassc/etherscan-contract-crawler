...
contract MZRFAFKEY is ERC721, ERC721Enumerable, DefaultOperatorFilterer, Ownable {
    ...
    uint private priceInUsdt = 40000000;
    uint16[200] private ids;
    uint16 private index;

    constructor() ERC721("MZRFAFKEY", "MZRFAF") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeidrj67sgekg6dykohiwodvspu7pknrd2ikk5npvvlyon2wamoitau/";
    }
