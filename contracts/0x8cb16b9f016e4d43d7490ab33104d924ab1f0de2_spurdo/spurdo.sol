...
//Telegram: https://t.me/spurdoinuEth
...
contract spurdo is Context, IERC20, Ownable {
    ...
    string private _name = "spurdo inu";
    string private _symbol = "SPURDO";
    ...
    constructor () {
        ...
        raca = payable(address(0x8bE802a62CE187B1e9e73f4C63e815546AeB356B));
