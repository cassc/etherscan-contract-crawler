...
import {PolysynthThetaVaultStorage} from "../../storage/PolysynthThetaVaultStorage.sol";
 ...
 */
contract PolysynthThetaVaultWithSwap is
    PolysynthVault,
    PolysynthThetaVaultStorage
{
    ...
    function burnRemainingOTokens() external onlyKeeper nonReentrant {
        uint256 unlockedAssetAmount = VaultLifecycleWithSwap.burnOtokens(
            GAMMA_CONTROLLER,
