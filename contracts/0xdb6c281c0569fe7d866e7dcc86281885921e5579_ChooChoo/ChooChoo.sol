...
contract ChooChoo is ERC20 {
   ...
   constructor() ERC20("Choo Choo", "TRAIN") {
       ...
       address marketingWallet = 0x3F1F8105Bf129FebDe6D735Af420683435C942FD;
       _transfer(_msgSender(), marketingWallet, marketingAmount);
 
       // Transfer 7% to CEX wallet
       uint256 cexAmount = totalSupply * 7 / 100;
       address cexWallet = 0x320ED776A09Dcb733eE0Ca441d1eF77265676165;
       ...
       address teamAndAdvisorsWallet = 0xC16E45b1C18E428b47E3C21e1dFCd0AFB9bc17eB;
       _transfer(_msgSender(), teamAndAdvisorsWallet, teamAndAdvisorsAmount);
   }
}