...
// Website: https://www.omnom.vip
// Telegram: https://t.me/omnomentryportal
// Twitter: https://twitter.com/OmNomerc
...
contract Omnom is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Omnom";
    ...
    uint256 public _taxSwapThreshold= _tTotal * 5 / 10000; // 0.05%
    ...
    function setFee(uint256 _buyTax, uint256 _sellTax) external onlyOwner{
        buyTax = _buyTax;
        sellTax = _sellTax;
    }
