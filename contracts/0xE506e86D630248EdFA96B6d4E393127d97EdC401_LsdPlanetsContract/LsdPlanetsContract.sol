...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xDAA17320Eba6CAf85d8fb5678AeE28A169e0d9E2];
  address public erc20Payable = 0xDAA17320Eba6CAf85d8fb5678AeE28A169e0d9E2;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 550) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihbcwvmkh3ksywh7lh365rw53tny2w47sk7axw7fz4b23rks75hd4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Bpq72Ctgn6kZgRM2yhHL/contract-metadata";
  }
...
// File: contracts/LsdPlanetsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LsdPlanetsContract is RamppERC721A {
    constructor() RamppERC721A("Lsd Planets", "LP"){}
}
