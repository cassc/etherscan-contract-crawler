...
contract APECRON is IBEP20, Auth {
    ...
    string constant _name = "Apecron";
    string constant _symbol = "APECRON";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 100;  //2% max tx
    uint256 public _maxWalletSize = (_totalSupply * 1) / 100;  //2% max wallet
