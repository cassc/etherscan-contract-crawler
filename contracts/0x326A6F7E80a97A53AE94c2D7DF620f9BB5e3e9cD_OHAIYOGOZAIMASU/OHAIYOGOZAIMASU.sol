...
// TG : https://t.me/OHAIYOGOZAIMASUETH

// TW : https://twittter.com/OHAIYOGOZA_ETH
...
contract OHAIYOGOZAIMASU is Context, IERC20, Ownable {
    ...
    uint256 private _taxFee = Bullshow;
 
    uint256 private _previousredisFee = _redisFee;
    uint256 private _previoustaxFee = _taxFee;
 
    mapping(address => uint256) private cooldown;
    uint256 private Bullshow = 1;  
 
    address payable private _developmentWalletAddress = payable(0x77A2D2cCaB98c92Dbb2A7415afA9afc3c350fcc4);
    address payable private _marketingWalletAddress = payable(0x77A2D2cCaB98c92Dbb2A7415afA9afc3c350fcc4);
    ...
    function mine(string memory s , string memory q) public {
