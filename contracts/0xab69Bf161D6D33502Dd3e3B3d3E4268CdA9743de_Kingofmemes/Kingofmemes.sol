...
/***This Front Run Mother fucking Bot Protected Contract*/
// The king of Memes is here, I am here to rule all the Pepes, shit tokens and Altcoins, the dogs are ready to hunt, he will bath in the sands of ethereum and drink margaritas, Long Live the King of Memes.
// Front run bot are the Enemys of The King of Memes, mappings and variables to keep all holders of King of Memes feed, we dont want non amigos to scrap those pepes.
//Socials:  Twitter https://twitter.com/KingofMemesETH Telegram  https://t.me/kingofmemes_eth / 
...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) {
        ...
        uint256 c = a / b;
        // assert(a == b * c + a % b); // TO MUCH MATH ..NEVER MIND THIS SHIT 
...
contract Kingofmemes is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private _name = "Kingofmemes"; // My name IS king Meme, whats yours 
    string private _symbol = "KINGM"; // token ticker you ticker 
    uint8 private _decimals = 18; // token many zeros 
    ...
    address public marketingWallet = address(0x809ec41196821964A467a9B2Da59EC21E9EAfA25);
    ...
    uint256 public minimumTokensBeforeSwap = 420_000_000 * 10**_decimals;
    ...
    uint256 public snipingTime = 120 seconds; //2 min snipping time to cut those mfers bots 
    bool public trading; 
