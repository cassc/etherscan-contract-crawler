...
/// @custom:security-contact @GASISTOOHIGH
contract PUMPMYGAS is ERC20, ERC20Snapshot, Ownable {
    constructor() ERC20("PUMPMYGAS", "GAS") {
        _mint(msg.sender, 69696696696 * 10 ** decimals());
    }
