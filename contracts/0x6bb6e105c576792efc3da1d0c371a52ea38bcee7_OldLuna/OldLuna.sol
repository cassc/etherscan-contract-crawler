...
/**
 ...
 Comunity will make LUNA history come back again                                                 
 TG: https://t.me/oldlunacoin
...
contract OldLuna is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0x252Bd3E152260CF30672bF3853fEFeCD0375FB2A);
    address payable private _marketingWalletAddress = payable(0x34970376e847732A2a2B4901911224403Dee4A2e);
    ...
    uint256 public _maxTxAmount = 50000000 * 10**9; // 4%
    uint256 public _maxWalletSize = 50000000 * 10**9; // 4%
    uint256 public _swapTokensAtAmount = 10000 * 10**9; // Min swap
