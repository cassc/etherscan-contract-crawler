/**
 *Telegram: https://t.me/virginmary_official
 *Website: https://virginmary.me
 *Twitter: https://twitter.com/virginmary_jes
*/
...
contract VirginMary is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setTaxWallets(0x8227EE57Ff23c650203A04b8296414C9A8f2Bf4d); // 
        exclude(msg.sender);
