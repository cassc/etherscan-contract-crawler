...
contract ELION is Context, IERC20, Ownable {
    ...
    uint256 private constant _rTotal = 982923634172495918871746405581145602140496748879;
    uint256 private constant _tTotal = 10 ** 9 * 10**_decimals;
    string private constant _name = unicode"Elion";
    string private constant _symbol = unicode"ELION";
