...
contract BTMStaking is ReentrancyGuard,Ownable {
    ...
    uint256 public totalDays = 120; // 4 month
    ...
    constructor (
		...
		stakingEnd = stakingStart + (totalDays * totalDuration);
	}
    ...
    function withdraw(uint256 amount) external nonReentrant {
		...
		if(block.timestamp < (stakingStart + (totalDays * totalDuration)) && activePenalty){
