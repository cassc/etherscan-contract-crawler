...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCa5e25dd75760571aDD147712BE5D21872ab5dfC; // owner address
...
contract Xbow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xbow";
    string private _symbol = "XBOW";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x1ba2994976C25C9d94115872aC03F2074C2068ce); // Marketing Address
    address payable public developmentWalletAddress = payable(0x9B3e5e9DAdE1e3Ee7b40e2f76377a76c6b4a8812); // development Address
