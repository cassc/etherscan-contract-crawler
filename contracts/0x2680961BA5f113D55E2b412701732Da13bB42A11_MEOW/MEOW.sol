...
//https://t.me/MiKittyCommunity
//https://twitter.com/mikittytoken
//https://mikitty.xyz
...
contract MEOW is ERC20, Ownable {
    ...
    constructor() ERC20("Mi Kitty", "MEOW") {
        ...
        // launch sell fees
        uint256 _sellMarkFee = 30;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 10;
        uint256 _sellOperationsFee = 0;

        uint256 totalSupply = 880_000_000_000_000 * 1e18;

        maxTransactionAmount = 17_600_000_000_000 * 1e18; // 2% max txn at launch
        maxWallet = 17_600_000_000_000 * 1e18; // 2% max wallet at launch
        ...
        markwallet = address(0x07f15EB4901abCa42f45f9b7F94eB6e42F0183F1); 
        devWallet = address(0x54CAb404C6FBb7044ED8AB1DD696cd5C296266d3); 
        liqWallet = address(0x54CAb404C6FBb7044ED8AB1DD696cd5C296266d3); 
        operationsWallet = address(0x54CAb404C6FBb7044ED8AB1DD696cd5C296266d3);
