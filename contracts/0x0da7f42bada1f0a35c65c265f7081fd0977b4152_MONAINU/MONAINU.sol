...
/*
A personable —Mona Lisa Inu— with expressive eyes and yellow fur looks at the camera with an ambiguous expression,
of surprise, contentment, trepidation, or some mixture of all three. 

PORTAL:https://t.me/monalisainu
...
contract MONAINU is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Mona Lisa Inu";
    string private constant _symbol = "MONAINU";
