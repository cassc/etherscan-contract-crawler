...
https://www.goldpepe.vip/

http://t.me/GoldenPepePortal

https://twitter.com/GoldenPepeETH
...
contract GOLDENPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "Golden Pepe";
    string private _symbol = "GOLDENPEPE";
    ...
    uint256 public _maxTxAmount = 12600000000000 * 10**9; //3%
    uint256 private numTokensSellToAddToLiquidity = 420000000000 * 10**9; //0.01%
    uint256 public _maxWallet = 12600000000000 * 10**9 ; // 3%
