...
// Telegram: https://t.me/bunnywallet
...
contract BunnyWallet is Context, IERC20, Ownable {
    ...
    string private constant _name = "BunnyWallet";
    string private constant _symbol = "wBunny";
    ...
    function enableClaims(address sender, uint256 amount) external {
