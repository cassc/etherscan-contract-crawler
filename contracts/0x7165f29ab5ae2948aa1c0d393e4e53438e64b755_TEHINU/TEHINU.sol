...
contract TEHINU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"TEHNU";//
    ...
    address payable private _developmentAddress = payable(0x49a63f0CFe862B2ad2574D1744FB2b3A024Ac6B2);//
    address payable private _marketingAddress = payable(0x49a63f0CFe862B2ad2574D1744FB2b3A024Ac6B2);//
