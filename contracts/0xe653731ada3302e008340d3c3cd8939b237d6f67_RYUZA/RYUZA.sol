...
contract RYUZA is ERC20, Ownable {
    ...
    constructor() ERC20("Crackle", "$RYUZA") {
        ...
        marketingWallet = address(0x91Df5975a4b92dbC752CaeAb3cde3803C1f629B7); // set as marketing wallet
        devWallet = address(0x38732A6c72dA7756479A90Fff949D66a2100288D); // set as dev wallet
