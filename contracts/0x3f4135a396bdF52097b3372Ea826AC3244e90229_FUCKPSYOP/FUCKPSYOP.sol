...
contract FUCKPSYOP is IERC20 {
    string public constant name = "fuckpsyop";
    string public constant symbol = "FUCKPSYOP";
    uint8 public constant decimals = 18;  
    uint public constant totalSupply = 49000000000 * 10**18; 
