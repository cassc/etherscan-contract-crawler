...
contract OX69420 is ERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee){
            // bot/sniper penalty.
            if(sniperPenaltyInEffect() && automatedMarketMakerPairs[from] && !automatedMarketMakerPairs[to] && buyTotalFees > 0){
                fees = amount * 80 / 100;
    ...
    function sniperPenaltyInEffect() public view returns (bool){
