...
contract ArtemisInu is ERC20, Ownable {
    ...
    constructor() ERC20("Moon Mission", "Artemis Inu") {
		...
		charityWallet = address(0x1592a2655c85b0537FB921B3F3C2E22F3eE0A7b6); // set as charity wallet
        marketingWallet = address(0x1592a2655c85b0537FB921B3F3C2E22F3eE0A7b6); // set as marketing wallet
        devWallet = address(0xc3A295D43Ee2CBDDb3FcACf5786F06414E149761); // set as dev wallet
