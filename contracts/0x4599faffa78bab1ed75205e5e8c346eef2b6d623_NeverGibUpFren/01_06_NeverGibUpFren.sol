...
contract NeverGibUpFren is ERC20, Ownable {
  ...
  /// @notice These brave frens never gave up, even in the harshest of times they made sacrifices for the betterment of all frens. 
  address[] public frensThatNeverGaveUp;
  ...
  function finishDeployment(address[] memory bravestOfFrens) onlyOwner external {
    assert(deployed == 0);
    frensThatNeverGaveUp = bravestOfFrens;
  ...
  function _beforeTokenTransfer(
    ...
    require(block.timestamp >= (deployed + 5 minutes), "initial lock");
