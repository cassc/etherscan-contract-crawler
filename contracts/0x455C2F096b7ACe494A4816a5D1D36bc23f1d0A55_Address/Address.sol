...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2292cfE3C79E6D9f0393e696B66EaD7AE455718F;
...
contract MRTOK is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2292cfE3C79E6D9f0393e696B66EaD7AE455718F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MRTOK";
    string private _symbol = "MRTOK";
