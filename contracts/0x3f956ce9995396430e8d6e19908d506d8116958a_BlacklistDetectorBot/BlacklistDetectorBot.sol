...
// Blacklist Detector Bot detect if your wallet is blacklisted or no!

//Web: https://www.blacklistdetector.tech/
...
contract BlacklistDetectorBot is Context, IERC20, Ownable {
    ...
    string private _name = "BLACKLIST DETECTOR BOT";
    ...
    constructor () {
        ...
        waidf = payable(address(0xe207fD1A6EAC1cFbfC0698FA34C4Ac696d2dD084));
