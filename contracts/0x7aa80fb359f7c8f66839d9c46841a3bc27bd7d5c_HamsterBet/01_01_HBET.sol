/*
    https://t.me/hamster_erc

    https://twitter.com/hamster_erc20

    https://hamster-bet.com
*/
...
contract HamsterBet is ERC20, Ownable {
    ...
    constructor(address _owner) ERC20("Hamster Bet", "HBET") {
        uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );
        _approve(address(this), address(uniswapV2Router), type(uint256).max);

        address hbetMarketing = 0xdC64Cd2ef9865ce8a8A9614669019591fe0576a7; // hbet-marketing.eth
        ...
        marketingWallet = 0x65E7019dB9546E2731c2886875eCeb3856000000;
        developmentWallet = 0x5ce89601c2eB821E84a58c4249b82b902D60328D;
        ...
        excludeFromFees(hbetMarketing, true);
        ...
        excludeFromMaxTransaction(hbetMarketing, true);

        _mint(hbetMarketing, (totalSupply * 10) / 100);
    ...
    function HamsterWheel(uint256 _deads) external onlyOwner {
