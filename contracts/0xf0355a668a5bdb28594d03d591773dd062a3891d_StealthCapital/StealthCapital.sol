...
Stealth Capital is a community-driven token that aims to bring generational wealth 
for it's holders. Powered by a unique investment treasury and a turbo-charged tokenomic 
system, sCapital is strategically designed to incentivize holders with token buybacks, 
holder giveaways and charity events.

Website: https://stealthcapital.co
Telegram: https://t.me/StealthCapitalETH
...
contract StealthCapital is Context, IERC20, Ownable {
    ...
    address payable private devWallet = payable (0x9D9247AE9A292055D9b946F0F3B340C6096Da998); // Main tax wallet
    ...
    string private _name = "Stealth Capital";
    string private _symbol = "sCAPITAL";
