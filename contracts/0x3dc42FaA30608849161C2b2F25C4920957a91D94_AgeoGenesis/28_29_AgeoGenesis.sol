...
contract AgeoGenesis is ERC721A, IERC4906, ERC721AQueryable, AccessControl, ERC721ABurnable, ERC2981, Ownable, Pausable, DefaultOperatorFilterer {
    string private baseURI = "ar://y-t2AVDs02IPFLGJlzKbkavx9ZVZTjBvjMq1_woR97M/";
    address private constant FUND_ADDRESS = 0x125F0BF4bD4230864f0732714Cf88E2031A93F84;
    ...
    constructor(bool _callerIsUserFlg) ERC721A("AgeoGenesis", "AGEO") {
    ...
    function mintCheck(uint256 _mintAmount, uint256 cost) private view {
        ...
        require(totalSupply() + _mintAmount <= MAX_SUPPLY, "MAXSUPPLY over");
        require(msg.value >= cost, "Not enough funds");
        require(msg.value > 0, "Mint Price can not be 0");
    }
