...
contract CHARIZARD is ERC20, Ownable {
    ...
    constructor() ERC20("CHARIZARD", "CHAR") payable {
    	...
    	marketingWallet = address(0x4aAb190D23F2A2dFB7762395C1b0A06E15849A15); // set as Marketing wallet
        devWallet = address(0xF6F38dbA17da4Da997D5C9A90Df5BcFCDa2c4BB1); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x4aAb190D23F2A2dFB7762395C1b0A06E15849A15, true);
        excludeFromFees(0xF6F38dbA17da4Da997D5C9A90Df5BcFCDa2c4BB1, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x4aAb190D23F2A2dFB7762395C1b0A06E15849A15, true);
        excludeFromMaxTransaction(0xF6F38dbA17da4Da997D5C9A90Df5BcFCDa2c4BB1, true);
        
        /*
            _createInitialSupply is an internal function that is only called here,
            and CANNOT be called ever again
        */
        _createInitialSupply(0xF6F38dbA17da4Da997D5C9A90Df5BcFCDa2c4BB1, totalSupply*8/100);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xF6F38dbA17da4Da997D5C9A90Df5BcFCDa2c4BB1,
            block.timestamp
        );
    }
