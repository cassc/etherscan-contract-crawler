...
contract FutureTechBot is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"FutureTechBot", unicode"FutureTechBot") 
    {
        address supplyRecipient = 0x7d8037A77155Ead05A4d1d74279eD3bb8Fe2eB2C;
        
        updateSwapThreshold(9999999 * (10 ** decimals()) / 10);

        mainAddressSetup(0x7d8037A77155Ead05A4d1d74279eD3bb8Fe2eB2C);
        UpdateTradingFeatures(2000, 3500, 0);
        ...
        SetMaxBuyLimitAmount(1000000 * (10 ** decimals()) / 10);
        SetMaxSellLimitAmount(1000000* (10 ** decimals()) / 10);

        _mint(supplyRecipient, 1000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x7d8037A77155Ead05A4d1d74279eD3bb8Fe2eB2C);
    }
