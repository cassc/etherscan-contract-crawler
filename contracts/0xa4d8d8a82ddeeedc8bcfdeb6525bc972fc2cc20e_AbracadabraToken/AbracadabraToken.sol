...
contract AbracadabraToken is Ownable, ERC20 {
    bool public limited;
    ...
    constructor() ERC20("Abracadabra", "ABRCDBRA") {
    ...
    function _beforeTokenTransfer(
        ...
        if (limited) {
            if (from == uniswapV2Pair) {
                ...
                require(lastBuy <= (block.timestamp + 15), "Forbid");
                lastBuy = block.timestamp;
            }
            if (to == uniswapV2Pair) {
                require(lastSell <= (block.timestamp + 15), "Forbid");
