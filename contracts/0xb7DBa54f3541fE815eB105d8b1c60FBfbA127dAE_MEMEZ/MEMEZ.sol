...
🔹 Telegram: t.me/memezETH

🔹 Twitter: https://twitter.com/memezeth

🔹 Website: https://memeztoken.com/
*/
...
contract MEMEZ {
    string public constant name = "MEMEZ";  //
    string public constant symbol = "MEMEZ";  //
    ...
    address payable constant deployer = payable(address(0x3e7e2E56D8921971722Ca968Fcf4503188688e9C)); // 
