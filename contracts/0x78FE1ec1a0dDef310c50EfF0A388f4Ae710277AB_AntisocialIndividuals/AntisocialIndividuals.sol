...
We will Renunce the contract and lock liquidity shortly after launch

TG: @antisocialindividualsERC
...
contract AntisocialIndividuals is Context, IERC20, Ownable {
    ...
    string private constant _name = "antisocial individuals";
