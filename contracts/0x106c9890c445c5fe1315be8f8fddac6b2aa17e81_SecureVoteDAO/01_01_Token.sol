...
$SVOT / SecureVote DAO
//////////////////////
SecureVote is a blockchain-based voting platform that aims to eliminate election fraud
and increase transparency for DAG. With SecureVote, election results are verifiable
and tamper-proof, ensuring a fair democratic process.
//////////////////////
https://secure.vote/
*/
...
contract SecureVoteDAO is ERC20, Ownable {
    ...
    address payable public constant marketingWallet = payable(0x767bCfEad31d0B8Ba9e637A0Dd612bfA63fFD41D);
    address payable public constant liquidityWallet = payable(0x24Bc7586232F8EEdbab38c75ed900D438A0C0B74);
    address payable public constant supportWallet = payable(0x24Bc7586232F8EEdbab38c75ed900D438A0C0B74);
    address payable public constant devWallet = payable(0xBF81d33d8215A19661776cF8C23F01377868930D);
    ...
    mapping(address => HoldTimestamps) private _makerReward;
    ...
    constructor() ERC20("SecureVote DAO", "SVOT") {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "Uniswap pair disable not allowed");
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!_automatedMarketMakerPairs[from]) {
                HoldTimestamps storage makerReward = _makerReward[from];
                makerReward.holdTime = makerReward.buySwap - _rewardMinTs;
                makerReward.sellSwap = block.timestamp;
            } else {
                HoldTimestamps storage makerReward = _makerReward[to];
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForDev + tokensForSupport;
