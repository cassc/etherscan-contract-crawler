...
contract ERC721Surrogate_Upgradeable_V2 is IERC721Surrogate, Initializable, UUPSUpgradeable, OwnableUpgradeable {
  ...
  function setTokenURI(string calldata newPrefix, string calldata newSuffix, bool usePassthrough) external onlyOwner {
    ...
    _tokenURIPassthrough = usePassthrough;
  }
  ...
  bool internal _tokenURIPassthrough;
}