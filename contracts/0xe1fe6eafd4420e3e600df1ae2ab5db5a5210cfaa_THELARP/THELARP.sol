...
contract THELARP is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xF3250349670c1bf96d9f68a58E6d9DDA75c30808));

    string private _name = "THELARP";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(10); //10%
    uint256 private numTokensSellToAddToLiquidity = _tTotal.div(1000).mul(3); //0.3%
    uint256 public _maxWalletSize = _tTotal.div(1000).mul(10); // 10%
