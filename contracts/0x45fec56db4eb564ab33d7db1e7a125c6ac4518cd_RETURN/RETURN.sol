...
/**⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
Website: https://returncoin.net
TG: https://t.me/returnportal
Twitter: https://twitter.com/rtncoineth
**/
...
contract RETURN is Context, IERC20, Ownable {
    ...
    uint256 private _buyTaxAtLaunch=10;
    ...
    string private constant _name = unicode"Return";
    string private constant _symbol = unicode"RTN";
    ...
    constructor () {
		...
		_marketingWallet = payable(address(0xc583D95700CdF68fa33FCf096a5adb801Aa2A819));
    ...
    function initiateReturn() external onlyOwner() {
