...
$PYRO is distinctive buyback ecosystem running on the Ethereum Blockchain, where half of the repurchased tokens are incinerated, while the other half is reinjected into the contract. This process initiates additional tax transactions, consequently leading to more buybacks, thereby perpetuating the aforementioned actions. This results in a continuous cycle of buybacks and token burns to the advantage of the token holders.

Telegram https://t.me/PyroCoinETH 🔥 Twitter / X https://twitter.com/PyrocoinETH 🔥 Website https://www.pyro-coin.com/
...
contract PYRO is Context, IERC20, Ownable {
    ...
    uint256 private _initialSellTax2Time = 30;
