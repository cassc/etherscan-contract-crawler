...
/**
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
https://t.me/PhilosoRaptor_AI
https://twitter.com/PhilosoRaptorAI
**/
...
contract PHILOSORAPTORAI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping(address => uint256) private _holderLastTransferTimestamp;
    address payable private _taxWallet = payable(0xD922488A9486d8C7968D0572498e24B7299D08e0);
    ...
    string private constant _name = unicode"PHILOSORAPTORAI";
    string private constant _symbol = unicode"RAPTORAI";
