...
contract VENUS is Context, IERC20, Ownable {
    ...
    string private constant _name = "VENUS";
    string private constant _symbol = unicode"vεnus";
    ...
    address payable private _developmentAddress = payable(0x892410425F7ca6d0474Ed70B3acFa2e36ddBA0E4); 
    address payable private _marketingAddress = payable(0x892410425F7ca6d0474Ed70B3acFa2e36ddBA0E4);
