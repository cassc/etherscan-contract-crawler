...
myCryptoFunds FTMO Programs for Crypto Traders | Leverage Positions
up to 10x | Profit-Splits up to 75% | Revenue Sharing with Holders 
...
contract myCryptoFunds is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"myCryptoFunds";
    string private constant _symbol = unicode"FTMO";
