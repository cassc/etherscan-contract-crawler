...
https://t.me/Precisionism

Taxes: 2% / 2% -> All goes to liquidity.
...
contract Precisionism is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Precisionism", "REPENT") {
        ...
        maxTransactionAmount = totalSupply * 15 / 1000; // 0.2% maxTransactionAmountTxn
        maxWallet = totalSupply * 30 / 1000; // No Max Wallet On Launch
        ...
        marketingWallet = address(0xAAFC501d2C812Ea56689795FFE3c22e9fe76C7Ad); // set as marketing wallet
        devWallet = address(0xAAFC501d2C812Ea56689795FFE3c22e9fe76C7Ad); // set as dev wallet
