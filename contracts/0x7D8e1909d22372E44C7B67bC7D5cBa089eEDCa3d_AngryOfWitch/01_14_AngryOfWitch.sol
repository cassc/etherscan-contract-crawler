...
contract AngryOfWitch is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("AngryOfWitch", "AOW", maxBatchSize_, collectionSize_) {
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x8cD1FD3B243358a3c092C6cDCf42A30d8b95877c);
