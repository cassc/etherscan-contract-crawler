...
contract WagmiMintExample is ERC721 {
  ...
  {
    uint256 foregroundHue = uint256(keccak256(abi.encodePacked('foreground', tokenId))) %
      360;
    uint256 backgroundHue = uint256(keccak256(abi.encodePacked('background', tokenId))) %
      360;
