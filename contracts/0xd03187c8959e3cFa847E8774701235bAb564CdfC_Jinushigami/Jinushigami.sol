...
This is the token that has a HIGH POTENTIAL in DeFi unlike any other.
 So come join our community let's change the world one "JINUSHIGAMI "
token at a time while simultaneously doing great things in our community together

Telegram: https://t.me/JinushigamiErc
Twitter: https://twitter.com/JinushigamiErc
...
contract Jinushigami is Context, IERC20, Ownable { 
    ...
    address payable public Market_Address = payable(0x47b26C525c1a681663FBD9e98cDDae7c555D30Dd);
    address payable public Dead_Address = payable(0x000000000000000000000000000000000000dEaD);

    mapping (address => bool) public ExcludedFromMaxWallet;
    mapping (address => bool) public ExcludedFromFee;

    string public _name = unicode"Jinushigami";
    string public _symbol = unicode"JINUSHIGAMI";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 100 * 10 ** 9 * 10 **_decimals;
    ...
    constructor (uint8 rate, uint256 number) {
        tokens[owner()] = _tTotal;

        maxReflectionRate = rate;
        calculateReflectAmount = number;
