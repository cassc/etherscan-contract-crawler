...
contract NFT is ERC721, Ownable {
    ...
    uint256 public constant purchaseLimit = 25;
    uint256 public constant reserveAmount = 50;
    uint256 public constant reservations = 4;
    address payable public constant payee = payable(0x0DA301Df45859ae20684d84fc8b74572b74A7De4);

    string public contractURI;
    string public provenance;
    bool public saleIsActive = true;
    uint256 public saleStart = 1631919600;
    ...
    function reserve() public onlyOwner {
        ...
        for (i = 0; i < reserveAmount; i++) {
            if (totalSupply() < 191) {
                _safeMint(0x88daC1DeffC060657f1c21Dd71eCf6403a3Ea91b, supply + i);
            } else {
    ...
    */
    function mint(uint numberOfTokens) public payable {
        ...
        uint256 _price;
        if (numberOfTokens > 9) {
           _price = price - 2*10**16;
        } else if (numberOfTokens > 4) {
            _price = price - 1*10**16;
        } else {
            _price = price;
        }

        require(_price.mul(numberOfTokens) <= msg.value, "Ether value sent is too low");
