...
contract sPSI is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked PSI", "sPSI", 18) ERC20Permit() {
    ...
    /**
        @notice increases sPSI supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sPSI
