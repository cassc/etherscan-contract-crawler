...
//SOCIALS 
// https://twitter.com/OriginalWassie

// https://t.me/OriginalWassie

// https://originalwassie.com/
...
// File contracts/OriginalWassie.sol

pragma solidity ^0.8.4;


contract OriginalWassie is Ownable, ERC20 {
    ...
    constructor() ERC20("Original Wassie", "WASSIE") payable {
        _mint(msg.sender, SUPPLY * 100 / 100);
        _mint(address(this), SUPPLY * 0 / 100);
