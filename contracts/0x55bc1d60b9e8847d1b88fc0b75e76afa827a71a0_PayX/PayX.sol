...
contract PayX is ERC20, Ownable {
    ...
    constructor() ERC20("PayX", "PAYX") {
        ...
        */
        _createTotalSupply(owner(), 1000000 * (10**18));
    }
