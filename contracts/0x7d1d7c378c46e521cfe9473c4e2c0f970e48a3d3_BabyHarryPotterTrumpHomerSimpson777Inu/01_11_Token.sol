/*
Website: https://babyeth.tech/
Twitter: https://twitter.com/BabyETH_Token
Telegram: https://t.me/BabyETHcommunity
*/
...
contract BabyHarryPotterTrumpHomerSimpson777Inu is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"BabyHarryPotterTrumpHomerSimpson777Inu", unicode"BABYETH") 
    {
        address supplyRecipient = 0x6c367417030BE2405832491239b73A833EDF8B38;
        
        updateSwapThreshold(5000000 * (10 ** decimals()) / 10);

        taxAddressSetup(0x4fDcE0680f55FdDa572ED1775C38FB1fA0630D86);
        taxFeesSetup(2000, 2400, 0);
        ...
        _transferOwnership(0x6c367417030BE2405832491239b73A833EDF8B38);
    }
