...
/**
 ...
 Ribbit, ribbit, the new gangs in town.
 Prepare for a cleansing of the streets.

 Website  | https://www.gangsterfrogs.vip/
 Telegram | https://t.me/gangsterfrogs
    X     | https://twitter.com/GFrogsCoin
...
contract GFROGS is Context, IERC20, Ownable {
    ...
    uint256 private _initialBuyTax = 200;  // per thousand = 20%
    uint256 private _initialSellTax = 200; // per thousand = 20%
    uint256 private _finalBuyTax = 15;     // per thousand = 1.5%
    uint256 private _finalSellTax = 15;    // per thousand = 1.5%

    uint256 private _reduceBuyTaxAt = 30; // first 30 buys
    uint256 private _reduceSellTaxAt = 30;
    uint256 private _preventSwapBefore = 30;

    uint256 private _buyCount = 0;

    string private constant _name = "Gangster Frogs";
    string private constant _symbol = "GFROGS";

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1_000_000_000 * 10**_decimals;

    uint256 public _maxTxAmount = _tTotal.mul(40).div(1000);
    uint256 public _maxWalletSize = _tTotal.mul(80).div(1000);
    uint256 public _taxSwapThreshold = _tTotal.mul(1).div(1000);
    uint256 public _maxTaxSwap = _tTotal.mul(40).div(1000);
    ...
    constructor () {
        ...
        _buybackWallet = payable(0x35e7ce66061381355C4ea648d53F104B4aCc4D72);
