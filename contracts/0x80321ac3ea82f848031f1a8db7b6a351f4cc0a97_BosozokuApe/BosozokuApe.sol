...
contract BosozokuApe is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("BosozokuApe GangClub", "BAGC") {
        setHiddenMetadataUri("https://api.bosozokuapes.com/");
        setBaseURI("https://api.bosozokuapes.com/");
    }
    ...
    require(mintEnabled, "Mint not live yet");
      ...
      require(totalSupply() + count <= maxSupply, "No more APES");
