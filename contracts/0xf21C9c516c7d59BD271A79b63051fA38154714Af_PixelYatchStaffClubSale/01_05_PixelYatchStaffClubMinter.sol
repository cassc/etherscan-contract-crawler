...
contract PixelYatchStaffClubSale is Ownable, ReentrancyGuard {
    ...
    address public pixelYatchStaffClub;
    bytes32 public whiteListMerkleRoot;

    constructor(address _pixelYatchStaffClub) {
        pixelYatchStaffClub = _pixelYatchStaffClub;
    }
        ...
        internal
    {
        ...
        NFT(pixelYatchStaffClub).mint(msg.sender, numberOfTokens);
    }
