...
contract DontBeSilly is ERC721A, Ownable {
    uint public maxFree = 0;
    uint public supply = 10000;
    uint public price = 0.0025 ether;
    string public baseURI = "https://bafybeiexywttbktcwu5hrz7zx3za25zksyzynscixvib6tydlaaf4xdn5q.ipfs.nftstorage.link/";
    string public constant baseExtension = ".json";

    constructor() ERC721A("DontBeSilly", "DBS") {
    ...
    function Mint(uint256 _amount) external payable {
        ...
        if(_numberMinted(msg.sender) >= maxFree) {
            ...
            if(count > maxFree){
                require(msg.value >= (count - maxFree) * price == true , "Insufficient funds");
            }
        }
