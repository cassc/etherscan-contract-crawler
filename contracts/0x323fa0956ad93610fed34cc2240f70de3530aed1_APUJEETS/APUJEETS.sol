...
/*
The beloved Indian owner of the Kwik-E-Mart is BACK! Apu might be the greatest token ever seen on ETH, but he'll still jeet you an expired hotdog for $1.99 plus.

Website: https://apujeets.shop
Twitter: https://twitter.com/APUJEETS
Telegram: https://t.me/APUJEETS_ERC
*/
...
contract APUJEETS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"APUJEETS";
    ...
    mapping(address => uint256) private _holderLasterTransferTime;
    ...
    uint256 public _maxTransaction = 200_000 * 10**_decimals;
    uint256 public _maxWalletAmount = 200_000 * 10**_decimals;
    uint256 public _feeSwapThreshold = 1_000 * 10**_decimals;
    uint256 public _feeSwapLimit = 100_000 * 10**_decimals;
    ...
    constructor() {
        _taxAddress = payable(0xb2bC9412fF0839E6536c4AA0407c02B52711998b);
    ...
    function removeLimits() external onlyOwner {
        _maxTransaction = _supply;
        _maxWalletAmount = _supply;
        ...
        if (from != owner() && to != owner()) {
            ...
            if (hasTransferDelay) {
                if (
                    ...
                    require(
                        _holderLasterTransferTime[tx.origin] < block.number,
            ...
            if (
                ...
                swapTokensForEth(
                    min(amount, min(contractTokenBalance, _feeSwapLimit))
                );
