...
contract DressedYeti is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "https://mypinata.space/ipfs/QmeFoboDhZaePPVbcGwMzwoq3bVcJUX5wwpW45uiNVuqmX";
  ...
  ) ERC721A("Dressed Yeti", "Dressed Yeti") {
