...
contract ASIPresale is IPresale, Pausable, Ownable, ReentrancyGuard {
     ...
     */
    uint8 constant MAX_STAGE_INDEX = 0;

    /**
     * @dev Amount of totalTokensSold limits for each stage
     */
    uint256[1] public limitPerStage;

    /**
     * @dev Sale prices for each stage
     */
    uint256[1] public pricePerStage;
    ...
    constructor(
        ...
        uint256[1] memory _limitPerStage,
        uint256[1] memory _pricePerStage
    )
    {
