...
contract GREG is Context, IERC20, Ownable {
    ...
    string private constant _name = "FUCK GREG";
    string private constant _symbol = "FKGREG";
    ...
    address payable private _developmentAddress = payable(0xB805380362e7EDfa06d0C52896163200B1B9CF18); 
    address payable private _marketingAddress = payable(0xB805380362e7EDfa06d0C52896163200B1B9CF18);
