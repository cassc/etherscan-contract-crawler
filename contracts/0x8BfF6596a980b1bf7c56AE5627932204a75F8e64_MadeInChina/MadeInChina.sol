...
Welcome to Made In China - $CHINA!

Everything's made in China, literally everything. Find an object nearby and check the sticker or label on it, chances are, it was made in China. 

Telegram: https://t.me/MadeInChinaPortal
Twitter: https://twitter.com/madeinchinaerc
...
contract MadeInChina is IERC20, Ownable {
    ...
    string _name = "Made In China";
    string _symbol = "China";
    ...
    uint256 liquidityFeeBuy = 20; 
    uint256 liquidityFeeSell = 20;

    uint256 TeamFeeBuy = 20;  
    uint256 TeamFeeSell = 20;  

    uint256 marketingFeeBuy = 40;   
    uint256 marketingFeeSell = 40;   
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x3e0572b774033b05ccec32Cd0044d3f3D12868c0;
