...
Welcome to the Ethereum 2.0 token, a decentralized utility coin platform that establishes a peer-to-peer network that securely executes and verifies application code, called smart contracts. 
Smart contracts allow participants to transact with each other without a trusted central.

The project aimed to improve the network's scalability, accessibility, and transaction throughput. 
...
Twitter: https://twitter.com/eth2_0_0/
Tg: https://t.me/Ethereum20
