...
contract CryptoTycoon is ERC20, Ownable {
    ...
    constructor(address _address) ERC20("CryptoTycoon", "TYCOON") {
        ...
        maxTransactionAmount = 6000000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 9000000 * 1e18; // 3% from total supply maxWallet
		...
		charityWallet = address(0x000000000000000000000000000000000000dEaD); // set as charity wallet
        marketingWallet = address(0xcBE9175eb634C796972cB178A71E752663eb2a2d); // set as marketing wallet
        devWallet = address(0xACBEec6d77Dd26869B9c7C33b8061F30EC18ff5e); // set as dev wallet
