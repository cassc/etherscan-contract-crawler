...
contract YukiMiu is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x849b6494f63bc16b72c789fce481001c82187549497051275a2dfa39170e3793;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmSWfuyE77oWdVVf3zD9EE7JFVT9xd6xQdwrDtmBgBSn3q";

    constructor() public ERC721A("Yuki Miu", "YUKI", 999, 999) {}
