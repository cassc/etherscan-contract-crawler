...
contract BrokenSea is ERC721A, ERC2981, OperatorFilterer, Ownable {
    ...
    constructor() ERC721A("brokensea", "BKS"){
    ...
    function mint(uint256 amount) external payable {
        ...
        require(totalSupply() + amount <= maxSupply, "token full");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (!revealed) {
            return "https://amber-cautious-chinchilla-100.mypinata.cloud/ipfs/QmRBUzpSB9zN8CVR9hfmiHjgFcvNmw7jYwXEq4TeFmUhD5/0";
        }
