...
/* 
       The idea behind Genosama is to watch him constantly evolve into a stronger version of himself everytime he loses a fight. Genos aims to be stronger than his worshipped sensei, Saitama.
       Genos comes from One-Punch Man, the animated series. Can Genos one day defeat Saitama? Watch the story unravel.

       We are only a community token. No use-case. However, as we've seen before, we can emerge to the CEX's. 

            Tokenomics:
            Contract will not be renounced. Changes must be made in order to progress accordingly.
            1% to buy in (directly to LP)
            3% to sell (you will only be able to sell in 50% (half of your bag) increments. 
            This will enforce whales to make the decision of whether they wreck themselves until enough LP is formed.
            ** All sell taxes will be used to add back to our LP every weekend.

                        //////// Telegram: t.me/GenosamaPortal \\\\\\\\      
*/
...
contract GENOSAMA is ERC20, Ownable {
    ...
    constructor() ERC20( "GENOS", "GENOSAMA") {
        ...
        operationsAddress = address(0xa6aD038b9B6d099a28d2B66D3600Ad59eB8B8A9a); // change this address to wallet u want for operations   
        TaxAddress = address(0xa6aD038b9B6d099a28d2B66D3600Ad59eB8B8A9a);  // change this address to the one for tax 
