...
contract BabyYoda is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Yoda", "BYODA") {
        ...
        txAmountMax = (totalSupply * 20) / 1000; // 2% of total supply
        walletMax = (totalSupply * 20) / 1000; // 2% of total supply

        swapBackValueMin = (totalSupply * 1) / 1000; // 0.1% swapback trigger
        swapBackValueMax = (totalSupply * 2) / 100; // 2% max swapback
        ...
        mktFeeReceiverAddress = address(0xEf2e9FD886e3795d463Cfe0a7652207c8f0D0f41); 
    ...
    /// @dev Launches the token and enables trading. Irriversable.
    function BYODA() external onlyOwner {
        tradingOn = true;
        swapBEnabled = true;
    }
