...
/**
Telegram: https://t.me/GeishaAIERC
...
contract GeishaAI is Context, IERC20, Ownable { 
    ...
    address payable public AdvertisingWallet = payable(0x31B8D5593Ba07E96dbeBE4E131a78A4BAec9B7c1);
    address payable public DeadW = payable(0x000000000000000000000000000000000000dEaD);

    string public _name = unicode"Geisha AI";
    string public _symbol = unicode"GEISHAI";
