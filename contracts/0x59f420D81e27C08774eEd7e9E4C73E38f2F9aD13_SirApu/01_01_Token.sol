/**
 * 
 *   ERC20 Token in tribute for the legendary PHD. in Computer Science Apu Nahasapeemapetilon from Simpsons
 * 
 *   WEB:      https://sirapu.club/  
 *   TWITTER:  https://twitter.com/SirApu_eth  
 *   TG:       https://t.me/SirAPU_portal  
 */
...
contract SirApu is ERC20, Ownable {
    ...
    constructor() ERC20("SirApu", "SAPU") {
        ...
        marketingWallet = address(0x9cfAcB212656F0541d40199a8eB23761a2e08D50); // set as marketing wallet
    ...
    function SIRAPU() external onlyOwner {
        buyMarketingFee = 0;
        buyTotalFees = 0;
