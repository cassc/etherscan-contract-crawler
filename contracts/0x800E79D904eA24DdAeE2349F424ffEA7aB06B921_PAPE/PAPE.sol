...
TG: https://t.me/PEPACOIN0x

TWITTER: https://twitter.com/0xpapecoin
...
contract PAPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "PaulyPepe";
    ...
    address payable private _developmentAddress = payable(0x6c21E7243F483c6Dd52813AC406d7F62AE43281C);
    address payable private _marketingAddress = payable(0x8DFD4f307B6011D4CB21007FD5658f0686523938);
    ...
    uint256 public _maxTxAmount = 10000000000 * 10**9;//AMOUNT
