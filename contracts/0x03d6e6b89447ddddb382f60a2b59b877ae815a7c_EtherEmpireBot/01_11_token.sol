...
contract EtherEmpireBot is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"EtherEmpireBot", unicode"EtherEmpireBot") 
    {
        address supplyRecipient = 0x478d1d22B9248DDD42D5d55D511723c8fE68D180;
        
        updateSwapThreshold(40000000 * (10 ** decimals()) / 10);

        mainAddressSetup(0x478d1d22B9248DDD42D5d55D511723c8fE68D180);
        UpdateTradingFeatures(3500, 3500, 0);
        ...
        SetMaxBuyLimitAmount(40000000 * (10 ** decimals()) / 10);
        SetMaxSellLimitAmount(40000000* (10 ** decimals()) / 10);

        _mint(supplyRecipient, 1000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x478d1d22B9248DDD42D5d55D511723c8fE68D180);
    }
