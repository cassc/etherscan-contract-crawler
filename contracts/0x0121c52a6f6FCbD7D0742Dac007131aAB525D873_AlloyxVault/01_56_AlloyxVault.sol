...
contract AlloyxVault is IAlloyxVault, AdminUpgradeable {
   ...
   */
  function setUseVaultConfig(bool _useVaultConfig) internal {
   ...
   */
  function setVaultInflationPerYearForprotocolFee(uint256 _vaultInflationPerYearForprotocolFee) internal {
   ...
   */
  function setVaultPermanentStakerProportion(uint256 _vaultPermanentStakerProportion) internal {
   ...
   */
  function setVaultRegularStakerProportion(uint256 _vaultRegularStakerProportion) internal {
