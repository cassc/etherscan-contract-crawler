...
contract LBSKR_V4 is BaseBSKR_V2, DSMath, Stakable, ReentrancyGuardUpgradeable {
    enum Field {
        tTransferAmount,
        tBurnFee,
        tGrowthFee
    ...
    function __LBSKR_V4_init(
        ...
        // __LBSKR_V4_init_unchained(inflationAddressA);
    }

    function __LBSKR_V4_init_unchained(address inflationAddressA)
        internal
        onlyInitializing
    {
