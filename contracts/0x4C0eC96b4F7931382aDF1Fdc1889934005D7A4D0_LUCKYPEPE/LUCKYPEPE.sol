...
Token name: LUCKYPEPE
Telegram: https://t.me/Luckypepe
twitter: https://twitter.com/LuckypepeErc
...
contract LUCKYPEPE is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant tokenName = "LUCKYPEPE";
    string private constant tokenSymbol = "LUCKYPEPE";
    ...
    uint256 private feeBuy = 8;
    uint256 private reflectionFeeOnSell = 0;
    uint256 private feeSell = 8;
    ...
    address payable private _developmentAddress = payable(0x9D7B7a26abbdC1936CB0FDB4bcE70Db90fb959F1);
    address payable private _marketingAddress = payable(0xb05893618335365495B6d18cA48AADd0ADce7D69);
