...
Tg - https://t.me/DeathNote_ERC
Tw - https://twitter.com/DeathNote_ERC
Web - https://deathnote.quest
...
contract DeathNote {
    ...
    string public constant name = "Death Note";   
    string public constant symbol = "DHNT";   
    ...
    address payable constant deployer = payable(address(0x8f968e2A943Fec5FD0e30A159028B01C95C1A0F4));
