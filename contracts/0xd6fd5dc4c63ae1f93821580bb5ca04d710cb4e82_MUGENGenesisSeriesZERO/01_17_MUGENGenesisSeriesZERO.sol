 ...
 * @notice This contract handles minting MUGEN Genesis - Series ZERO tokens.
 */
contract MUGENGenesisSeriesZERO is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x3801a51d7B1714979e115C555373dD673cD0121A;
    ...
    address public royaltyAddress = 0xEb25A948C34f75bFb66cdafA50d7ce48DA10bE32;
    address[] public payoutAddresses = [
        0xEb25A948C34f75bFb66cdafA50d7ce48DA10bE32
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeibnwct2r45zscqeibibx4yu5ivfefxrswltvfzni46w66trvrmbwa/";
    ...
    uint256 public presaleMintsAllowedPerTransaction = 15;
    ...
    constructor(address _blocklistContractAddress)
        ERC721A("MUGEN Genesis - Series ZERO", "MG")
    {
