...
contract Overmorrow is ERC20, Ownable {
    ...
    constructor() ERC20("Overmorrow", "OVER") {
        ...
        devWallet = address(0x4901C620133DF0b2a6e41EDD718430B9D31beD6E); // set as dev wallet
