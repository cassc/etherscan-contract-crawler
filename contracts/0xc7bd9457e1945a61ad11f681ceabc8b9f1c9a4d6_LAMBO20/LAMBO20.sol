...
🏎 Telegram: t.me/LamboCoin2_0
🏎 Twitter: twitter.com/lambo2_erc
🏎 Website: lambo2.com
...
contract LAMBO20 is IERC20Metadata, Ownable {
    //Constants
    ...
    //Maxes
    uint256 public max_tx = 2_000_000 * 10 ** _decimals; //2%
    uint256 public max_wallet = 2_000_000 * 10 ** _decimals; //2%
    uint256 public swap_at_amount = 2_000_000 * 10 ** _decimals; //2%
    ...
    function StartTrade(bool _enable) public onlyOwner {
        trade_open = _enable;
        if (_enable == true) {
