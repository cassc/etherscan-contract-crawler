...
contract SOHI is ERC20, Ownable {
    ...
    {   
        address router;
        if (block.chainid == 1) {
            router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // BSC Pancake Mainnet Router
        } else if (block.chainid == 1) {
            router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // BSC Pancake Testnet Router
        ...
        developmentWallet = 0x385090af574A3e6C7A468c3B14EA32F1207b297F;
        marketingWallet =0x385090af574A3e6C7A468c3B14EA32F1207b297F;   
        ...
        swapTokensAtAmount = totalSupply() / 10_000_000_000;
    }
