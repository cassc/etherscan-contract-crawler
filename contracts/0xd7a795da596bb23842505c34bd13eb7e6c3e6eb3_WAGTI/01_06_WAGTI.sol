...
contract WAGTI is ERC721A, Ownable
{
    ...
    function mint(uint256 _quantity, bytes32[] calldata _merkleProof) external payable notPaused {
        ...
        require(totalSupply() + _quantity <= INITIAL_SUPPLY - whitelistSupply, "NO_MORE_SUPPLY");
    ...
    function startMint(uint256 _mintPrice, uint32 _whitelistSupply, bytes32 _merkleRoot, bytes32 _wlMerkleRoot) external onlyOwner {
