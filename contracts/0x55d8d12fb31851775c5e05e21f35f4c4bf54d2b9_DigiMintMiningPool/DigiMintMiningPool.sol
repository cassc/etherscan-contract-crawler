...
contract DigiMintMiningPool is Ownable, ReentrancyGuard {
    ...
    function deposit(address[] memory _nfts,uint256[] memory _tokenIds) public nonReentrant{
    ...
    function withdraw(address[] memory _nfts,uint256[] memory _tokenIds) public nonReentrant{
        require(_nfts.length <= 50,"Invalid count!");
