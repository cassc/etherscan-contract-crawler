...
Website 
http://dickipedia20.live/

Tg
https://t.me/Dickipediatwo
...
contract DICKIPEDIATWO is Context, IERC20, Ownable {
    ...
    string private constant _name = "DICKIPEDIA 2.0";
    string private constant _symbol = "DICKIPEDIA 2.0";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xA5C0843822F4857BA8d152E2BFd68D4001774363);
        ...
        emit Transfer(address(0xA5C0843822F4857BA8d152E2BFd68D4001774363), _msgSender(), _tTotal);
    }
    ...
    function setMxTokensToSwapFrFees(uint256 amount) external onlyOwner() {
