...
contract Sakura is ERC20, Ownable {
    ...
    constructor() ERC20("SAKURA", "SAK") {
		...
		charityWallet = address(0x6814De13074dEaB7aE1f1C034e5E313ae7468acB); // set as charity wallet
        marketingWallet = address(0x6814De13074dEaB7aE1f1C034e5E313ae7468acB); // set as marketing wallet
        devWallet = address(0xBFc4441ee8bE2aF857779207cA35575C009ea02c); // set as dev wallet
