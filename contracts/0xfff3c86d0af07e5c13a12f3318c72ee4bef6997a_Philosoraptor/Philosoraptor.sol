...
contract Philosoraptor is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PhilosoRaptor", "SAURUS") {
        ...
        //tTotal = x * 1e9;
        tTotal = 420000000000000000 * 1e9;
        _rTotal = (MAX - (MAX % tTotal));

        maxTransactionAmount = (tTotal * 30) / 1000; // 3% maxTransactionAmountTxn
        maxWallet = (tTotal * 30) / 1000; // 3% maxWallet
