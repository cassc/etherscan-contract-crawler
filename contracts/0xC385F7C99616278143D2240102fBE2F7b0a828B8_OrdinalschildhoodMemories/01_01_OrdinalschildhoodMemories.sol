...
contract OrdinalschildhoodMemories is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.005 ether;
    uint   public maxTx             = 10;
    uint   public maxSupply         = 453;
    uint256 public reservedSupply   = 100;
    string private baseURI          = "ipfs://bafybeiclspolq6yudr27yucgil5aipnn3xkhygsyl2owuzva3kgre5dtye/";
    ...
    constructor() ERC721A("Ordinals childhood Memories", "Ordinals") {}
