...
contract Mitch is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Seriously, it’s time for Mitch to move on";
    string private constant _symbol = unicode"Mitch";
