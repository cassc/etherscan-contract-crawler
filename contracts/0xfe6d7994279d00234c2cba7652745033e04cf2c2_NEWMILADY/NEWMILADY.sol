...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x12970E6868f88f6557B76120662c1B3E50A646bf); 
...
contract NEWMILADY is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "NEW MILADY";
    string constant _symbol = "NEW LADYS";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; 
    address RewardToken = 0x12970E6868f88f6557B76120662c1B3E50A646bf;
    ...
    uint256 private extraFeeOnSell = 60;

    uint256 public totalFee = 10;
    uint256 private totalFeeIfSelling = 30;
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x74a81a3A75CBbc310668cC8cfdD71F5E854077B8;
        anothermarketingWallet = 0x74a81a3A75CBbc310668cC8cfdD71F5E854077B8;
