...
contract WTHf is BEP20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() BEP20("WHAT THE HEX", "WTH") { // 
        marketingWallet = payable(0x4aB305926454BF0C5296A51a6b99dEbbFfE73909); //
        devWallet = payable(0xA1EDDe64306208fA47817F0592a3E846844459df); // 
