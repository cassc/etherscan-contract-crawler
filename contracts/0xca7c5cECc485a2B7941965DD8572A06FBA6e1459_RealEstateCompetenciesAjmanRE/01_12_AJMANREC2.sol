...
/// @title Real Estate Competencies by AjmanRE
...
contract RealEstateCompetenciesAjmanRE is ERC721A, ERC2981, OperatorFilterer, Ownable {
    using Strings for uint256;
    bool public operatorFilteringEnabled = true;

    uint256 public maxTokens = 15;
    string public baseUri;

    /// Contructor that will initialize the contract with the owner address
    constructor() ERC721A("Real Estate Competencies AjmanRE", "AJMANREC2") {
