...
contract RouteConfigs is Multicall {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "RouteConfigs: caller is not the owner");
        _;
    }

    modifier onlyGovernance() {
        require(governance == msg.sender, "RouteConfigs: caller is not the governance");
        _;
    }
    ...
    constructor(address _owner) {
        ...
        _updateConfig("MAX_OVERFLOW_BALANCE", 150);
    ...
    function updateDynamicConfig(
        ...
        dynamics[_target][_key].isExist = true;
        dynamics[_target][_key].value = _value;
    }
