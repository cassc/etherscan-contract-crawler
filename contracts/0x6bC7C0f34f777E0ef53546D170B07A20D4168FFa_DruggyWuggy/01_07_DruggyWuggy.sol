...
contract DruggyWuggy is ERC721A, Ownable {
    using Strings for uint256;
    using ECDSA for bytes32;

    string public constant COL_NAME = "Druggy Wuggy";
    string public constant TICKER = "DW";

    uint256 public MAX_ELEMENTS = 10001;  //must be +1
    uint256 public PRICE = 0.005 ether;
    uint256 public constant SALE_LIMIT = 11;  //must be +1

    address public whiteListSigningAddress = address(0xc429C9A7Db096B4e5795D280A203f8dBC284c9d7);


    address public constant wdAddress = address(0xD6643aBBea7d8acE3307E35a4C47b0B980A9f017);
