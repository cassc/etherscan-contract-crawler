...
//   \__ \/ //_/ _ \   / __  / __ \/ / / /_  /
//  ___/ / ,< /  __/  / /_/ / /_/ / /_/ / / /_
// /____/_/|_|\___/  /_____/\____/\__, / /___/
//                               /____/       
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xc04057e2a211C145ee0B8b806F1E21B6c33318C1];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0xc04057e2a211C145ee0B8b806F1E21B6c33318C1;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 2600) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiagaivy5v52bu4z2hlrs75gu6ghtxuxxgblsz3srrhcqdcvwmkjay/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 2600");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2600");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2600");
...
// File: contracts/SkeBoyzNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SkeBoyzNftContract is RamppERC721A {
    constructor() RamppERC721A("Ske Boyz NFT", "SKE"){}
}
