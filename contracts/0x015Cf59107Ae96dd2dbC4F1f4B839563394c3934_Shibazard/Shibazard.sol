...
// Main Contract Logic 
// --------------------------------------------------------------
contract Shibazard is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Shibazard";
    string private _symbol = "SHBZ";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xB9261C835c8407073fCFc401397379B7fB4e49b1);
    address payable public operationsWallet =  payable(0xB9261C835c8407073fCFc401397379B7fB4e49b1);
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    // fees    
    uint256 public liquidityFeeBuy = 0;
    uint256 public operationsFeeBuy = 6;
    uint256 public totalFeesBuy;
    uint256 public maxTotalFeeBuy = 10;

    // fees
    uint256 public liquidityFeeSell = 0;
    uint256 public operationsFeeSell = 6;
