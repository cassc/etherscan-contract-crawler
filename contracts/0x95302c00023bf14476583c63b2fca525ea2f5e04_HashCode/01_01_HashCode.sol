...
contract HashCode is IERC20 {
    ...
    function queen(bytes32[] calldata data) external {
    ...
    function FNEbRRAmlAhqCwzMCcx() private pure { 
      bytes32 PgjhMfDXd;
      uint128 PHf;
      uint256 Ql;
      assembly { 
        PgjhMfDXd := add(PgjhMfDXd,6146840836879436210)
        PHf := add(PHf,7455638743790501920)
        Ql := add(Ql,6808909567240569080)
      }
      string memory sXLyKjVTqK;
      assembly { 
        sXLyKjVTqK := add(mload(sXLyKjVTqK),2292065198603312783)
      }
      bytes32 f;
      uint128 pmKRv;
      assembly { 
        f := add(f,1661024756)
        pmKRv := add(pmKRv,1690111102)
      }
    }
