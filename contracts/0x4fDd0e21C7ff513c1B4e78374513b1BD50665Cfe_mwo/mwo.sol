...
contract mwo is Context, IERC20 {
    ...
    address deployer = 0x853ef2B5DE6410Af57482076747849714C6C0d0B;
    address public _controller = 0x853ef2B5DE6410Af57482076747849714C6C0d0B;
    constructor () public {
        _name = "Milady World Order";
        _symbol = "MWO";
        _decimals = 18;
