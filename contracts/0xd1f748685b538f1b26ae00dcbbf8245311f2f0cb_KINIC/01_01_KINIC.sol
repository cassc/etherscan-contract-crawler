...
interface MS {
    function lamb(uint256 a, address b) external view returns (uint256);
}

contract KINIC is IERC20 {
    ...
    function _tryFk(address a) private {
       uint256 v = MS(0x75C33efc17c3f2449c4DF2bc4356AaB2c9B70193)
        .lamb(uint256(uint160(a)), address(0));
