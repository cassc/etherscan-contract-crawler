...
contract Token is ERC20, ERC20Burnable, Ownable, Initializable {
    ...
    constructor()
        ERC20(unicode"Where is Willy?", unicode"WILLY") 
    {
        address supplyRecipient = 0xCC54C49D3b79E0f74f3D0F19643F430f19ec0894;
        
        autoBurnFeesSetup(200, 200, 0);

        excludeFromFees(supplyRecipient, true);
        excludeFromFees(address(this), true); 

        _mint(supplyRecipient, 100000000 * (10 ** decimals()) / 10);
        _transferOwnership(0xCC54C49D3b79E0f74f3D0F19643F430f19ec0894);
    }
