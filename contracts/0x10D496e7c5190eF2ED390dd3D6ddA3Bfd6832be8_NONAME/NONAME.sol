...
contract NONAME is Context, IERC20, Ownable {
    ...
    string private constant _name = "NONAME";
    string private constant _symbol = "NONAME";
    ...
    address payable private _marketingAddress = payable(0xDB8CAB009891b2fEB720436e5272c28Bf1DB811D);
    ...
    uint256 public _maxTxAmount = 25000 * 10**9; //0.025
    uint256 public _maxWalletSize = 30000 * 10**9; //0.03
