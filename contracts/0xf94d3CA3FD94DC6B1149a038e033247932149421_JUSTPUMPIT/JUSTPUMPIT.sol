...
TG:
https://t.me/Just_Pump_It_Offcial

Twitter:
https://twitter.com/just_pump_it

Just Pump It: The Meme Token Ready to Moon!

Are you ready to embark on a wild ride in the world of cryptocurrency? Buckle up, because we've got something extraordinary for you. Welcome to the incredible universe of Just Pump It, the innovative meme crypto token that's set to pump to the moon. 

But Just Pump It isn't just about the numbers—it's a community-driven movement. As the name suggests, this project embraces the power of memes, injecting fun and humor into the crypto space. We believe that by creating a lighthearted and inclusive environment, we can build a vibrant community that rallies together, supporting each other through the highs and lows of the crypto rollercoaster.

Beyond the meme factor, Just Pump It is backed by a dedicated team of experts, passionate about blockchain technology and committed to delivering a secure and reliable platform. We prioritize transparency, ensuring that every decision made is communicated openly to our valued community.

So, are you ready to ride the waves of the crypto market and  Just Pump It? Join us as we defy expectations, shatter boundaries, and pump up the excitement factor in the world of meme tokens. Together, we'll reach new heights and embrace unlimited potential.

 Let's pump it up to the moon and beyond!
...
// SPDX-License-Identifier: Unlicensed
    ...
    contract JUSTPUMPIT is ERC20 {
        ...
        constructor () ERC20("JUSTPUMPIT", "$PUMPIT"){

            numTokensSellToSendEthToDev = 20000 * 10 ** decimals();
            _devWalletAddress = 0x96076D7fb8FA76b61d823BB0C58A44561D03485F;
