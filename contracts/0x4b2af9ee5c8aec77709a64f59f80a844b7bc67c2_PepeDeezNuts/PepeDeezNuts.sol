...
contract PepeDeezNuts is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pepe Deez Nuts";
    string private constant _symbol = unicode"PENUTS";
