...
// Max Bidding - https://t.me/SAUDISETH
...
contract SAUDIS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Royal Group", "SAUDIS") {
        ...
        marketingWallet = address(0x3A7Ba911171142e7b6e8206f86Ca38cbe18b69C2); // set as marketing wallet
        devWallet = address(0x9B19FeC89A2D58857C94d46C3C1B4ac4aF637b68); // set as dev wallet
