...
contract FKAZUKIToken is ERC20, Ownable {
    ...
    address public constant DEVTEAM_ADDRESS =
        0x8baa047E673b6581E8C7C75EfA8c5B029cc209CD;
    ...
    function mint() public {
        ...
        if (isInWhitelist(msg.sender)) {
            ...
            require(
                azukiElementlsMintAddressList.length < MAX_AZUKIELEMENTLS_USER,
                "Exceeds max azukielementls user"
            );
            userType = 2;
            ...
            require(
                azukiMintAddressList.length < MAX_AZUKI_USER,
                "Exceeds max azuki user"
            );
            userType = 1;
            ...
            require(
                normalUserMintAddressList.length < MAX_NORMAL_USER,
                "Exceeds max normal user"
            );
            userType = 0;
