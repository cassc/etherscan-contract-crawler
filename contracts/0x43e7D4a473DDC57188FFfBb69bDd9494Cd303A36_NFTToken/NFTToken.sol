...
// File contracts/ERC721Permit.sol
...
contract ERC721Permit is IERC721Permit, ERC721A, EIP712 {
    ...
    function permit(
        ...
        _permit(spender, tokenId, deadline, v, r, s);
    }
        ...
        returns (bool)
    {
        ...
        require(spender == owner, "ERC721Permit: spender is not owner");
