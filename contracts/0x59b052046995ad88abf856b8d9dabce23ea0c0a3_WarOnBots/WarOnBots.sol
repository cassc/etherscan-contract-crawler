...
//WarOnBots - If you are human DO NOT buy!

//    If you are human and bought leave the eth addy in the comments section and you'll get refunded
//    I tried to launch 3 tokens on ETH and all of them got botted with -70/80% in first 5 min.
//    This is my personal war against sniper bots
...
contract WarOnBots is ERC20, Ownable {
    ...
    // Basic Contract Info
    string constant _name = "WarOnBots";
    string constant _symbol = "WOB";
    uint8 constant _decimals = 18;
    uint256 _totalSupply = 1000000000 * (10 ** _decimals); 
    
    // Max wallet
    uint256 public _maxWalletSize = (_totalSupply * 30) / 1000;
    uint256 public _maxTxSize = (_totalSupply * 30) / 1000;
    ...
    address public pair;
    address public Liq = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address public dist;
