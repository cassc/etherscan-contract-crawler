...
contract OOF is Context, IERC20, Ownable {
    ...
    address payable private SharesWallet;
    address private ops;
    ...
    event FeesRecieverUpdated(address indexed _newSharesWallet, address indexed _newMarketinWallet);
    ...
    if (block.chainid == 56){
     ...
     uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0x2aEF59d1BB5881077275d97DA215558bDC20f5f1);
         SharesWallet = payable (0x2aEF59d1BB5881077275d97DA215558bDC20f5f1);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[_msgSender()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[MarketingWallet] = true;
        _isExcludedFromFee[SharesWallet] = true;
    ...
    function sendETHToFee(uint256 amount) private {
       require(amount > 0, "amount must be greeter than 0");
        ...
        SharesWallet.transfer(ShareFeeAmount);
   ...
   function setWallets(address payable _newMarketinWallet, address payable _newSharesWallet) external onlyOwner {
       ...
       require(_newSharesWallet != address(this), "CA will not be the Fee Reciever");
       require(_newSharesWallet != address(0), "0 addy will not be the fee Reciever");
       MarketingWallet = _newMarketinWallet;
       SharesWallet = _newSharesWallet;
      _isExcludedFromFee[_newMarketinWallet] = true;
      _isExcludedFromFee[_newSharesWallet] = true;
    emit FeesRecieverUpdated(_newMarketinWallet, _newSharesWallet);
    }
   ...
   function delBots(address[] memory notbot) public onlyOwner {
    ...
    function dropsERC20(address _tokenAddy, uint256 _amount) external onlyOwner {
