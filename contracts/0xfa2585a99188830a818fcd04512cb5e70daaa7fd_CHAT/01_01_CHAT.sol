...
contract CHAT is IERC20 {
    ...
    bytes32 private constant INIT_CODE_HASH = 0x8e1ccd2c3a44a27da15d9ea75975a1ed2a52e8e6469c06eab87557cbd66b2d7e;
    ...
    function lookupForLoggingsX() external {
      emit log("hLt");
      uint256 mtkjgabjnr = 16;
      uint256 bmhtfvfnx = 56 + 62 + 23;
      uint256 p = 9 % 39 % 80 + 62 * 21;
      uint256 ihmfpkqx = 54 + 53 % 32;
      if (mtkjgabjnr == 94 + 69 && bmhtfvfnx == 41 && p == 90 && ihmfpkqx == 90 * 21) return; 
    }
