...
contract BaseTieredPricing is ITieredPricingEventsV0, ITieredPricingGettersV0, ITieredPricingEventsV1 {
    ...
    function getTiersForNamespace(
        bytes32 _namespace
    ) public view returns (bytes32[] memory tierIds, ITieredPricingDataTypesV0.Tier[] memory tiers) {
    ...
    function getDefaultTierForNamespace(
        bytes32 _namespace
    ) public view returns (bytes32 tierId, ITieredPricingDataTypesV0.Tier memory tier) {
    ...
    function getDeploymentFee(
        address _account
    ) public view returns (address feeReceiver, uint256 price, address currency) {
        (
    ...
    function getTierDetails(
        bytes32 _namespace,
        bytes32 _tierId
    ) public view returns (ITieredPricingDataTypesV0.Tier memory tier) {
    ...
    function _addAddressToTier(bytes32 _namespace, address _account, bytes32 _tierId) internal virtual {
    ...
    /// @dev Returns the Tier details for a specific tier based on namespace and tier id
    function _getTierById(
        bytes32 _namespace,
        bytes32 _tierId
    ) internal view returns (ITieredPricingDataTypesV0.Tier memory) {
