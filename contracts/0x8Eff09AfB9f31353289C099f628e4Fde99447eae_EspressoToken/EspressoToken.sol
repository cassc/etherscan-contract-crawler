...
// File @uniswap/v2-periphery/contracts/interfaces/IUnis[email protected]
...
contract EspressoToken is ERC20, Ownable {
    ...
    constructor(
        ...
        uint256 ownerReceiverSupply = (_supply * _ownerPercentageInitalSupply) / 100;
    ...
    function setFeeOwnerPercentageBuy(uint16 percentage) public onlyOwner {
        require((feeAdminPercentage + burnFeePercentage + percentage) < 100, "Percentage exceeds 100");
    ...
    function _transfer(
        ...
        || inSwap) {
            ...
            uint256 feeAmount = (amount * (feeOwnerPercentage + feeAdminPercentage)) / (100);
