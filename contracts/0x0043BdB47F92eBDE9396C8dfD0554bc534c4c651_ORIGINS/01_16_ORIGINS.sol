...
contract ORIGINS is ERC721Enumerable, Ownable {
	...
	uint256 public constant pricePerNft = 33000000000000000;

    string public baseURI = "ipfs://bafybeift7wevpytggnrhawdk33mzqjswqfdypd56nxtohxuwhs5mdg6am4";
    string public baseExtension = ".json";

	constructor() ERC721("ORIGINS", "ORIGINS") {}

    // Mint New NFT Tokens
    function mint(uint256 num) public payable {
        require(totalSupply() + num <= maxSupply, "Maximum limit of tokens exceeded");
        require(num + balanceOf(msg.sender) <= maxMintPerWallet, "Exceeded maximum mint per user");
        require(msg.value >= pricePerNft * num, "Not enough ETH sent");
