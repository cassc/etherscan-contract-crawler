...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1681743600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xcDe56468E3EaBea4A2D5F59485B291f829028fAc];
  address public erc20Payable = 0xcDe56468E3EaBea4A2D5F59485B291f829028fAc;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintTokenIdCap = 888;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigjjrnwv5cw7r57f6v3rjgchadzwrjmfwhz4cg3dftvxtiz6ubdzu/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/dIGOtB5T00hQeuo1nJJq/contract-metadata";
  }
...
// File: contracts/OnehandedSlimeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OnehandedSlimeContract is ERC721APlus {
    constructor() ERC721APlus("Onehanded Slime", "pg"){}
}
  /*******************************************************/
  /*                                                     */
