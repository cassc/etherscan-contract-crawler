...
contract PepeBase is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint public blockCooldownAmount = 5;
    // End anti bots
    ...
    constructor() {
        ...
        _name = "PepeBase";
        _symbol = "Based Pepe";
        uint e_totalSupply = 420_420_420_420 ether;
        // End editable
    ...
    function ensureMaxTxFrequency(address addr) internal virtual {
        bool isAllowed = _blockNumberByAddress[addr] == 0 ||
            ((_blockNumberByAddress[addr] + blockCooldownAmount) < (block.number + 5));
