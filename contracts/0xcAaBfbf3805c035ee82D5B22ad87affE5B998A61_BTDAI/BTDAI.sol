...
/**
TG: https://t.me/backtothedeployai

-This contract has been created with DeployAI Bot.
*/
...
contract BTDAI is Context, IERC20, Ownable {
    ...
    address payable private _daiWallet;
    ...
    string private constant _name = "BackDeployAI";
    string private constant _symbol = "BTDAI";
    ...
    constructor () {
        ...
        _daiWallet = payable(0x24e1A60faCA77fc79DD3F003cB9D9a9c3CA3b9dC);
        _balances[_msgSender()] = _tTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_marketingWallet] = true;
        _isExcludedFromFee[_daiWallet] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _daiWallet.transfer(amount.mul(40).div(100));
    }
