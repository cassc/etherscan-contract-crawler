...
contract ENS721Mapper is Ownable {
    ...
    string public domainLabel = "rektguy";
    string public nftImageBaseUri = "https://rektguy.mypinata.cloud/ipfs/QmRuj3fqWkZkuruTkPgGSvSdTdjyAMiXyBDPQ5oFer43Rq/";
    ...
    uint256 public claimFee = 0; //test claim fee, changable
    ...
    constructor(){
        ...
        nft = IERC721Enumerable(0xB852c6b5892256C264Cc2C888eA462189154D8d7);
    ...
    function text(bytes32 node, string calldata key) external view returns (string memory) {
        ...
        if(keccak256(abi.encodePacked(key)) == keccak256("avatar")){
            ...
            return useEIP155 ? string(abi.encodePacked("eip155:1/erc721:", addressToString(address(nft)), "/", token_id.toString()))
                             : string(abi.encodePacked(nftImageBaseUri, token_id.toString(),".gif"));            
        }
        else{
