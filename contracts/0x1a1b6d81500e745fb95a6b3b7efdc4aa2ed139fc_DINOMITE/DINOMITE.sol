...
This is the only real Dinomite, be careful of fakes and scams!

Telegram: https://t.me/DinomiteToken
...
contract DINOMITE is Context, IERC20, Ownable {
    ...
    uint256 public swapThreshold = 105_000 * (10**_decimals); 
    uint256 public maxTxAmount = 420_000 * (10**_decimals);
    uint256 public maxWallet =  420_000 * (10**_decimals);

    string private constant _name = "Dinomite Token"; 
    string private constant _symbol = "DINOMITE";
    ...
    address public marketingWallet = 0xeB50180B231863a14cc1cf35d22DFb4Ed239baAE;
