...
contract SnakesbyEros is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Snakes by Eros", "ETH") {}
...
/// @notice returns metadata link of tokenid
 ...
 /// @dev to pause and unpause your contract(use booleans true or false)
  ...
  function withdraw() public payable onlyOwner nonReentrant {
      ...
      payable(0x72a1EAc12359239C1212035C6fd1107148B75ADd).transfer(balance);
  }
}