...
contract TGI is ERC20, Ownable {
    ...
    constructor() ERC20("Twitter Gold Inu", "TGI") {
     ...
     uint256 totalSupply = 3 * 10 ** 6 * 10 ** decimals();
        ...
        maxTransactionAmount = 6 * 10 ** 4 * 10 ** decimals(); 
        maxWallet = 6 * 10 ** 4 * 10 ** decimals(); 
        ...
        MarketingWallet = address(0xF1F063573C6A65B416e4f01642EDc8F7F9A69298); // set as Marketing wallet
        DevWallet = address(0xF1F063573C6A65B416e4f01642EDc8F7F9A69298); // set as dev wallet
