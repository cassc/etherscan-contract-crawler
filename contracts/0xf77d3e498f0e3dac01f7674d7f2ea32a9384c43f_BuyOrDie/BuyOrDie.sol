...
contract BuyOrDie is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Buy Or Die";
    ...
    uint256 private constant _tTotal = 9876543210 * 10**9;
    ...
    address payable private _developmentAddress = payable(0x7561B3E5F8c9739ac0d4A6bD9d4faF4E6C7b7f3d); 
    address payable private _marketingAddress = payable(0x7561B3E5F8c9739ac0d4A6bD9d4faF4E6C7b7f3d);
