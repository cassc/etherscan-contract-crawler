...
contract AHunterReturns is ERC20, Ownable {
    ...
    constructor() ERC20("CAW CAW", "CAW2.0") {
        ...
        maxTransactionAmount =  6_666_666_666_666 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        maxWallet = 13_333_333_333_333 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0x117a332262cd5A010c6B8c379a13a8FDe6db9D98); // set as dev wallet
        marketingWallet = address(0x14C0e12aB694D73ce2BC22C0b6c0e98a43fd1b54); // set as marketing wallet
