...
contract PEPE3erc20 is ERC20, Ownable {
...
⠀⠀⢻⣦⡄⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣦⠀⠀⠀⠀
⠀⢀⣿⣿⣿⣶⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡧⠀⠀⠀
https://pepepepepepe.xyz
*/
    constructor() ERC20("PEPE PEPE PEPE", unicode"PEPE³") {
        ...
        maxTransactionAmount =  4_206_900_000_000 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        maxWallet = 4_206_900_000_000 * 1e18; // 1.5% from total supply maxWallet
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 38, "Must keep fees at 10% or less");
    }
