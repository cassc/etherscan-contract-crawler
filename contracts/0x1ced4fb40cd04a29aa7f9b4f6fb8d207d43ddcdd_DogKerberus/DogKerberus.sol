...
contract DogKerberus is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x2a698eC08E2cdd5d45d206fBB70350f01BAB7bAf));

    string private _name = "DogKerberus";
    string private _symbol = "DKerberus";
