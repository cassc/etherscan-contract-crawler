...
contract STOOLS is Context, IERC20, Ownable {
    ...
    string private _name = "Shibarium Tools";
    string private _symbol = "STOOLS";
    ...
    uint256 public _walletMax = 20_000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 3_000 * 10**9; 
