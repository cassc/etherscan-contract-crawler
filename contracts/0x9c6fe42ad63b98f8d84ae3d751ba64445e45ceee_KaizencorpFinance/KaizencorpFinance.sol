...
/**
 ...
 KAIZEN will be lighting the fires at the first gate. 
 Ready for you all the explore! Are you ready to brave the challenges we give to you? 
 Or will you let someone else reap the glory?
...
contract KaizencorpFinance is ERC20, Ownable {
    ...
    address public constant deadAddress = address(0x5eDd8779bCd889F5E992FBD3988e648Bc36B6966);
    ...
    constructor() ERC20("Kaizencorp Finance", "KAIZEN") {
        ...
        marketingWallet = address(0xE9473D16fa90BFD457824f1c3501BAfb5b708519); // set as marketing wallet
        buybackWallet = address(0x5eDd8779bCd889F5E992FBD3988e648Bc36B6966); // set as dev wallet
