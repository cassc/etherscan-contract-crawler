...
contract StakingPool is OwnableUpgradeable, ReentrancyGuard 
{
   ...
   // address private beneficiary;
	...
	// 	_;
	// }
    function initialize(uint256 _minAmount, uint256 _maxAmount, address _ideaToken) external initializer {   
    ...
    function register(uint256 _stakingPeriod, uint256 _weiAmount,uint256 _staking) public{
        ...
        require(_staking == 2 || _staking ==3 || _staking == 4 || _staking ==5, "percentage doesnt matches the timeperiod");
