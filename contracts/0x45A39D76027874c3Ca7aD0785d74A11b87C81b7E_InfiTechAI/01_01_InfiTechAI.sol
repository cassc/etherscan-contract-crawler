/**
 https://infitech.ai
 https://t.me/infitechaientryportal
*/
...
contract InfiTechAI is ERC20, Ownable {
    ...
    constructor()
        ERC20("InfiTechAI", "ITAI")
        Ownable()
    {
        taxWallets[0] = payable(address(0xe6D2C20E758AC5aFFdF0336897b2C97ba561DA79));
        taxWallets[1] = payable(address(0xc15E32809cbed02C1371ed738AeCD6B3eb888aEa));
