...
contract MARKETVIZ is ERC20, Ownable {
    ...
    constructor() ERC20("MARKETVIZ", "VIZ") {
        ...
        marketingWallet = address(0x9bF8dea11e2908828359EdF5A95AE99282057f7e);
        developmentWallet = address(0xa76DACBc9628c66857807fE5295eEa3d6A018569);
    ...
    function CoolDownTaxes() external onlyOwner {
        require(buyTotalFees >= 4, "Buy fees already cooled down");
        buyMarketingFee = 2;
        buyLiquidityFee = 0;
        buyDevelopmentFee = 2;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevelopmentFee;
        
        require(sellTotalFees >= 10, "Sell fees already cooled down");
        sellMarketingFee = 5;
        sellLiquidityFee = 0;
     ...
     function LowerTaxes() external onlyOwner {
        require(buyTotalFees >= 3, "Buy fees already lowered");
        buyMarketingFee = 2;
        buyLiquidityFee = 0;
        buyDevelopmentFee = 1;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevelopmentFee;
        
        require(sellTotalFees >= 3, "Sell fees already lowered");
        sellMarketingFee = 1;
        sellLiquidityFee = 0;
