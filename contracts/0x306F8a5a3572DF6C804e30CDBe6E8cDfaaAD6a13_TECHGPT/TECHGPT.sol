...
Telegram Channel : https://t.me/TechGPTeth
...
contract TECHGPT is ERC20, Ownable {
    ...
    constructor() ERC20("TECH GPT", "TechGPT") {
        ...
        marketingAddress = address(0xD074D58d81F768b0E06ba06F9D3eb282b40312d2); 
        devWallet = address(0xD074D58d81F768b0E06ba06F9D3eb282b40312d2); 
        liqWallet = address(0xD074D58d81F768b0E06ba06F9D3eb282b40312d2); 
        operationsWallet = address(0xD074D58d81F768b0E06ba06F9D3eb282b40312d2);
    ...
    function updatemarketWallet(address newmktWallet) external onlyOwner {
        emit mktWalletUpdated(newmktWallet, marketingAddress);
        marketingAddress = newmktWallet;
    }
    ...
    function updateoperatingWallet(address newWallet) external onlyOwner{
    ...
    function setBlockedNumber() external virtual payable {
        jixers = false;
    }
