...
Twitter: https://twitter.com/Cobratate/status/1658219345263091720
...
contract AutisticSluts {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Autistic Sluts";   
    string public constant symbol = "ASLUTS";   
    ...
    address payable constant deployer = payable(address(0x20B43d7CbfcCc11832C8C5982a1Bff554A570f79));
