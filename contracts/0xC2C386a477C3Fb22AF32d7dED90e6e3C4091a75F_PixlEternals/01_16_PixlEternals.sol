...
contract PixlEternals is ERC721Tradeable 
{   
    ...
    constructor(address _owner, address _recovery, address _treasury,address _mmarshal, address _proxyRegistry) 
        ERC721Extended(_owner, _recovery, _treasury, "https://pix.ls/meta/eternals/", _proxyRegistry) 
        ERC721("Eternals", unicode"⬢Eternals")    
    {        
