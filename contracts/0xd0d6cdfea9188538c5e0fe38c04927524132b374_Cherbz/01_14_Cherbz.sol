...
contract Cherbz is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
  using Strings for uint256;
  ...
  uint256 public FIRST_TOKEN_NUMBER = 50;
  uint256 public SECOND_TOKEN_NUMBER = 60;
  ...
  constructor() ERC721A("Cherbz","CBZ") {
