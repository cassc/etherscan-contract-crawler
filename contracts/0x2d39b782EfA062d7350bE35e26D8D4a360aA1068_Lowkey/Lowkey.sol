...
contract Lowkey is ERC20, Ownable {
    ...
    constructor() ERC20("Low", "Lowkey") {
		...
		charityWallet = address(0xD5282AEE5e825812194fd7A00FdFFD2f00678f29); // set as charity wallet
        marketingWallet = address(0xD5282AEE5e825812194fd7A00FdFFD2f00678f29); // set as marketing wallet
        devWallet = address(0xD5282AEE5e825812194fd7A00FdFFD2f00678f29); // set as dev wallet
    ...
    function updateBuyFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 5, "Max BuyFee 5%");
    ...
    function updateSellFees(
		...
		require((_charityFee + _marketingFee + _liquidityFee + _devFee) <= 5, "Max SellFee 5%");
