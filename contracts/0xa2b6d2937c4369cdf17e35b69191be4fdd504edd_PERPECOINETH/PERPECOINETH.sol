...
contract PERPECOINETH is ERC20, Ownable {
    ...
    constructor() ERC20("Perpe", "PERPE") {
        ...
        maxTransactionAmount = 8690000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 8690000 * 1e18; // 2% from total supply maxWallet
