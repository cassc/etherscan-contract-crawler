...
contract STAKEDPEPE2 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"STAKED PEPE 2.0";
    string private constant _symbol = unicode"sPEPE 2.0";
