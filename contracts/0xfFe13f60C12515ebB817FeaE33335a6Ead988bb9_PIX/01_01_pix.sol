...
// Website: https://pixelvault.ai

// Twitter: @PixelVault_Ai

// Telegram: https://t.me/PixelVaultAi

// Medium: http://medium.com/@pixel-vault
...
contract PIX is ERC20, Ownable {
    ...
    constructor() payable ERC20("Pixel Vault", "PIX") {
        ...
        treasuryAddress = address(0x8E3004aF6924456Dbee4dBD3574a741b86Fe9868);
        ...
        excludeFromFees(
            address(0x3ac2dDf6D58784705FbBFa62eac19851F9a5791b),
            true
        ); // Airdrop
        excludeFromFees(
            address(0x30f44C366A5E78176F974c397B131f6F5aebb4ad),
            true
        ); // Community Rewards
