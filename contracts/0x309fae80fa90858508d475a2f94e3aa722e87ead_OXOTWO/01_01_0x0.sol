...
/*
    ...
    Telegram: https://t.me/ETH0X0V2
    Twitter: https://www.twitter.com/0x0V2_0
 ...
 */
    ...
    contract OXOTWO is ERC20, Ownable {
        ...
        constructor() payable ERC20("0X0 2.0", "0X02.0") {
            ...
            uint256 totalSupply = 100 * 1e6 * 1e18; // 100000000
            ...
            marketingAddress = address(0x0d6568599FBA0B6b4ac46969F150BC35D9c1757C);
            ...
            _excludeFromMaxTransaction(
                address(0x0d6568599FBA0B6b4ac46969F150BC35D9c1757C),
                true
            ); // Deployer
        ...
        function updateBuyFees(
            ...
            buyTotalFees = buyDevelopmentFee + buyLiquidityFee + buyMarketingFee;
            require(buyTotalFees <= 1, "Fees must be 1% or less");
        }
        ...
        function updateSellFees(
            ...
            sellTotalFees = sellDevelopmentFee + sellLiquidityFee + sellMarketingFee;
            require(sellTotalFees <= 1, "Fees must be 1% or less");
        }
