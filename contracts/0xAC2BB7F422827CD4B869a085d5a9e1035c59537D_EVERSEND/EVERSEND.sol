...
contract EVERSEND is ERC20, Ownable {
    ...
    constructor() ERC20("Eversend", "EVERSEND") {
		...
		charityWallet = address(0x488EC4F875E747251DAaBaf79f517aab394fcA9a); // set as charity wallet
        marketingWallet = address(0x488EC4F875E747251DAaBaf79f517aab394fcA9a); // set as marketing wallet
        devWallet = address(0x488EC4F875E747251DAaBaf79f517aab394fcA9a); // set as dev wallet
