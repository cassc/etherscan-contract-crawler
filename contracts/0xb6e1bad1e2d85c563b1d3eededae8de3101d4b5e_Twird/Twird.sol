...
MMP""MM""YMM                db               `7MM  
P'   MM   `7                                   MM  
     MM `7M'    ,A    `MF'`7MM  `7Mb,od8  ,M""bMM  
     MM   VA   ,VAA   ,V    MM    MM' "',AP    MM  
     MM    VA ,V  VA ,V     MM    MM    8MI    MM  
     MM     VVV    VVV      MM    MM    `Mb    MM  
   .JMML.    W      W     .JMML..JMML.   `Wbmd"MML.
...
20+ percent of EVERY transaction will be donated to
the Young America's Foundation via The Giving Block

https://TwirdETH.com/
https://twitter.com/TwirdUSA
https://t.me/TwirdPortal
...
contract Twird is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Twird";
    string private _symbol = "Twird";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x7364ad203970E997C73ca549d183D7A9D1A492ad);
    address payable public DeveloperWallet = payable(0x157E7bd1AC10A31fda62597Ee888c87A7a6f7aCE);
