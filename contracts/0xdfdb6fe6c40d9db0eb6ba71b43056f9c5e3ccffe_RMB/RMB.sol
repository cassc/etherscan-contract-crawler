...
/**
The RMB, or Renminbi, is the official currency of China. It is also commonly referred to as the yuan, which is the basic unit of the currency. 
The RMB is issued by the People's Bank of China and is used in mainland China, although it is not widely accepted in other countries.
*/

// Website: https://0xrmb.com
// Telegram: https://t.me/Oxrmbeth
// Twitter: twitter.com/Oxrmbeth
...
contract RMB is Ownable, ERC20 {
    ...
    constructor(address router_, address marketing_) ERC20("0xRMB ", "0xRMB") payable 
    {
