...
contract trAId is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"trAId";
    string private constant _symbol = unicode"trAId";
