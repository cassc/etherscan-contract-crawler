...
/**
 * @title ProjectMayhem Monetary Supply Policy
 * @dev This is an implementation of the ProjectMayhem Ideal Money protocol.
 *
 *      This component regulates the token supply of the ProjectMayhem ERC20 token in response to
 *      market oracles.
 */
contract ProjectMayhemPolicy is Ownable {
