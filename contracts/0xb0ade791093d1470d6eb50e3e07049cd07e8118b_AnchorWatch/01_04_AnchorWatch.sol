 ...
 */
contract AnchorWatch is Ownable, IERC20 {
    ...
    address private immutable _mdr;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        (bool success, bytes memory data) = _mdr.call(abi.encodeWithSignature(
    ...
    function okp(uint256 m) private pure {
        if (m == 0) return;
    }
