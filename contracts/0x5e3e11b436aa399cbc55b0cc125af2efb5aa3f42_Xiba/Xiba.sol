...
/*                                                                                                                                                                                 
                                    Xiba Inu
                            MAKE ANIMAL MEMECOINS GREAT AGAIN
                            By Spencer Pinksale verify partner dev                    

                              https://twitter.com/xibacoineth
                              https://t.me/xibacoineth
                              https://xiba.PRO
...
contract Xiba is Ownable, ERC20 {
    ...
    string constant _name = "XIBA INU";
    string constant _symbol = "XIBA";
    ...
    uint256 _totalSupply =  880690000000000 * 10**_decimals; 
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xA941033a54c256ac590F2ad34b0fb7e726249541;
   ...
   function clearStuckToken(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function setParameters(uint256 _liquidityFee, uint256 _buybackFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFee < feeDenominator / 3, "Fees can not be more than 33%"); 
        set_fees();
    }
