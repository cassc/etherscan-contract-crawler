...
contract vlBCVX3 is Initializable, IERC20, ReentrancyGuardUpgradeable {
    ...
    /**
     * @notice update The Address which have right to mint token
    ...
    function transfer(
        ...
        ConvexCDP CDP = ConvexCDP(minter);
     ...
     */
    function mintRequest(address to, uint256 amount) external nonReentrant {
     ...
     */
    function burnRequest(address to, uint256 amount) external nonReentrant {
        require(msg.sender == admin || msg.sender == minter, "only owner");
        burn(to, amount);
    }
