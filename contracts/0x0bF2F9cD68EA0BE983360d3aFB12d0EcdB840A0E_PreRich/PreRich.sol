...
// @title 'An ERC20 token for all the BROKIES (PRE-RICH) out there'
...
/*  _____            _____  _      _     
   ...
   Website: prerichtoken.com
   Telegram: t.me/prerichtoken
*/                                       
...
interface IERC20 {
 ...
 // *Don't be BROKE. Be PRE RICH. Buy $PRE
...
contract PreRich is Ownable, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping(address => mapping(address => uint256)) private _allowances;

    string constant private _name = "Pre Rich";
    string constant private _symbol = "PRE";
    uint8  constant private _decimal = 10;
    uint256 private _totalSupply = 690000000 * (10 ** _decimal); // 690 million PreRich
    uint256 constant public _taxBurn = 0;
