...
// will be transferred to a governance smart contract once Muse is sufficiently
...
contract MasterChef is Ownable {
    ...
    // Safe muse transfer function, just in case if rounding error causes pool to not have enough Muse.
