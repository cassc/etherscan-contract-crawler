...
contract ShaolinTempleDAO is ERC20, Ownable {
    ...
    constructor(address _address) ERC20("Shaolin Temple DAO", "SHAOLIN") {
		...
		charityWallet = address(0xC1c8B112cceaF5853C6f3fB1FB482672f584BD6D); // set as charity wallet
        marketingWallet = address(0xC1c8B112cceaF5853C6f3fB1FB482672f584BD6D); // set as marketing wallet
        devWallet = address(0x743bF5d9F20F2A074e7aE46e7492c5B62693e0E9); // set as dev wallet
