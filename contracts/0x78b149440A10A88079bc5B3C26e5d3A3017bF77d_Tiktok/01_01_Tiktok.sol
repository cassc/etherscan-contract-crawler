...
contract Tiktok is ERC20, Ownable {
    ...
    function removeAddressFromBlacklist(address account) external onlyOwner {
        require(_blacklistedAddresses[account], "Address is not blacklisted");
    ...
    function transfer(address recipient, uint256 amount)
        ...
        returns (bool)
    {
        require(!_blacklistedAddresses[msg.sender], "Sender is blacklisted");
        require(!_blacklistedAddresses[recipient], "Recipient is blacklisted");
