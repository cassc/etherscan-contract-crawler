...
contract NFTvGenesisBox is ERC721Enumerable, AccessControl {
    ...
    // TEST SETTINGS !!!!
    uint256 public maxSupply = 499; /// !!!! FOR TESTING ONLY PLEASE COMMENT THIS LINE BEFORE MAINNET LAUNCH
    ...
    constructor() ERC721("NFTvGenesisBox", "NFTvGenBox") {
        ...
        // MAINNET SETTINGS !!!!
        // maxRoundSupply[0] = 3333;    // round 0     !!!! PLEASE UNCOMMENT THIS LINE BEFORE MAINNET LAUNCH
        // maxRoundSupply[1] = 3333;    // round 1     !!!! PLEASE UNCOMMENT THIS LINE BEFORE MAINNET LAUNCH
        // maxRoundSupply[2] = 3100;    // round 2     !!!! PLEASE UNCOMMENT THIS LINE BEFORE MAINNET LAUNCH
        // maxRoundSupply[3] = 33;      // team round  !!!! PLEASE UNCOMMENT THIS LINE BEFORE MAINNET LAUNCH    
        
        // TEST SETTINGS !!!!
        maxRoundSupply[0] = 3; // round 0     !!!! FOR TESTING ONLY PLEASE COMMENT THIS LINE BEFORE MAINNET LAUNCH
        maxRoundSupply[1] = 3; // round 1     !!!! FOR TESTING ONLY PLEASE COMMENT THIS LINE BEFORE MAINNET LAUNCH
        maxRoundSupply[2] = 3; // round 2     !!!! FOR TESTING ONLY PLEASE COMMENT THIS LINE BEFORE MAINNET LAUNCH
        maxRoundSupply[3] = 3; // team round  !!!! FOR TESTING ONLY PLEASE COMMENT THIS LINE BEFORE MAINNET LAUNCH
    }
