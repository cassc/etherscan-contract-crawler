...
contract AnthonyHopkinsTheEternal is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 1000;
    uint256 public MAX_MINTS = 50;
    string public baseURI = "https://api.orangecomet.io/collectible-metadata/eternal/";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("Anthony Hopkins - The Eternals", "ETERNAL", MAX_MINTS, MAX_SUPPLY) {  
    }
