...
contract rlt is ERC20, Ownable {
    ...
    constructor(address router, address team, address dev) ERC20("Roulette Bot", "RLT") {
        ...
        maxTransactionAmount = 15000000 * 1e18; // 1.2%
        maxWallet = 15000000 * 1e18; // 1.2%
    ...
    function setFeeAddressReceiver(address wallet) public onlyOwner {
