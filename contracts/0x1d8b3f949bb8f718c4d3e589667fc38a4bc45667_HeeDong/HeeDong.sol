...
contract HeeDong {
    ...
    string public constant name = "HeeDong";   
    string public constant symbol = "HEDG";   
    ...
    address payable constant deployer = payable(address(0x4B5E7eB87C8Af264399627fc56A4b988A97d0D55));
