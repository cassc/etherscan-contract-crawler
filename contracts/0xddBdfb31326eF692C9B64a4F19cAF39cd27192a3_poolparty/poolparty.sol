...
/*
TG: https://t.me/poolpartyETH
WEB: https://poolparty.tools
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF603Ce6816a18f559b8C245453D9eFdF31f6ac87; // owner address
...
contract poolparty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "poolparty";
    string private _symbol = unicode"PP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF603Ce6816a18f559b8C245453D9eFdF31f6ac87); // 
    address payable public teamWalletAddress = payable(0xF603Ce6816a18f559b8C245453D9eFdF31f6ac87); // 
	...
	function addLiquidityPair(address[] calldata addresses) external onlyOwner {
        ...
        uint256 contractTokenBalance = amount.mul(_totalTaxIfBuying).div(100);
