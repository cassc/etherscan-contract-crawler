...
contract BullCoin is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x98410E21AbFdCd8C3ac672eFb3a7489863137cFA);
    address payable private _marketingAddress = payable(0x98410E21AbFdCd8C3ac672eFb3a7489863137cFA);
