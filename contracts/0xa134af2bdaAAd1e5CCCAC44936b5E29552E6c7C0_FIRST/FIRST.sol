...
/**
*
* Telegram: https://t.me/LUST1stProtocol
*
* IMPORTANT PLEASE READ
*
* 1st Protocol Launch Plan.
*
* 0) Add LP
* 1) 00-05 mins 98% - Initial LP lock for 3 months
* 2) 05-10 mins 60%
* 3) then tax = 3% - Renounce Contract
*
*/
...
contract FIRST is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "1st Protocol - Lust";
    string private _symbol = "1st";
    ...
    uint256 private _numTokensSellToAddToETH = 250000 * 10**_decimals;
