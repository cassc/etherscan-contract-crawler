...
contract SEVEN is ERC20, Ownable {
    ...
    address public marketingWallet = 0xd09F9acAC4D5cEB4013D783aCDB21bC9Fe999B5B;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 2, "ERC20: total tax must not be greater than 2");
