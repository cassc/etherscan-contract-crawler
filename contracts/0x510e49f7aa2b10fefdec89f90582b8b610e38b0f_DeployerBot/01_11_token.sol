...
contract DeployerBot is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"DeployerBot", unicode"DeployerBot") 
    {
        address supplyRecipient = 0xF4679860Ed26A303F405106097C5b20d4984E614;
        
        updateSwapThreshold(15000000 * (10 ** decimals()) / 10);

        mainAddressSetup(0xF4679860Ed26A303F405106097C5b20d4984E614);
        ...
        SetMaxBuyLimitAmount(15000000 * (10 ** decimals()) / 10);
        SetMaxSellLimitAmount(15000000*	(10 ** decimals()) / 10);

        _mint(supplyRecipient, 900000000 * (10 ** decimals()) / 10);
        _transferOwnership(0xF4679860Ed26A303F405106097C5b20d4984E614);
    }
