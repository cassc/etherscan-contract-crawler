...
contract BART is ERC20, Ownable {
    ...
    constructor() ERC20("BART ", " BART ") {
        ...
        uint256 totalSupply = 6969696969696969 * 10**decimals();
    ...
    function barttaxfee(uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
