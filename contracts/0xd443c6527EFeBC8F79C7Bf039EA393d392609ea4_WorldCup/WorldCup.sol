...
// tax 2/2 welcome back world cup !
...
contract WorldCup is Context, IERC20, Ownable {
    ...
    string private constant _name = "Welcome Back World Cup";
    string private constant _symbol = "World Cup";
    ...
    function Lock_Token(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
