...
contract FeesManagerLogic is Ownable {
    ...
    function estimateFees(
        ...
        require(_msgSender() == burnballAddress, "Not Burnball contract");
    ...
    function updateBurnballAddress(address _newAddr) external onlyOwner {
        burnballContract = IBurnball(_newAddr);
        burnballAddress = _newAddr;
    }
}