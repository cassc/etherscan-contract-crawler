...
/** 
           ...
           /      \ /  |                /  |           /      \  /  |                        /  |      
          /$$$$$$  |$$ |____    ______  $$/  _______  /$$$$$$  |_$$ |_     ______    _______ $$ |   __ 
          $$ |  $$/ $$      \  /      \ /  |/       \ $$ \__$$// $$   |   /      \  /       |$$ |  /  |
          $$ |      $$$$$$$  | $$$$$$  |$$ |$$$$$$$  |$$      \$$$$$$/    $$$$$$  |/$$$$$$$/ $$ |_/$$/ 
          $$ |   __ $$ |  $$ | /    $$ |$$ |$$ |  $$ | $$$$$$  | $$ | __  /    $$ |$$ |      $$   $$<  
          $$ \__/  |$$ |  $$ |/$$$$$$$ |$$ |$$ |  $$ |/  \__$$ | $$ |/  |/$$$$$$$ |$$ \_____ $$$$$$  \ 
...
Telegram Portal: https://t.me/ChainstakeETH
Website: https://chainstack.us
Twitter: https://twitter.com/ChainstakeETH
Blog   : https://blog.chainstack.us
...
contract ChainstackNetwork is ERC20Capped {
    string public name = "Chainstack";
    string public symbol = "CNS";
    uint8 public decimals = 18;
    uint256 constant TOTAL_CAP = 390000000 ether;
    ...
    event PurchaseItemOnChainStack(address indexed _spender, uint64 appId, uint64 itemId, uint256 amount);
    ...
    function purchaseItemOnChainStack(uint64 appId, uint64 itemId) external onlyNotBlackList returns(bool) {
        uint256 itemAmount = _getItemAmount(appId, itemId, address(this));

        transfer(inAppAddress, itemAmount);
        
        emit PurchaseItemOnChainStack(msg.sender, appId, itemId, itemAmount);
        return true;
    }
