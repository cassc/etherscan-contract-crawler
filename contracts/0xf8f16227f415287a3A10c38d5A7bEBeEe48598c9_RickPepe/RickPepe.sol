 ...
 * allowances. See {IERC20-approve}.
 */
contract RickPepe is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Rick Pepe";
    ...
    address public marketingWallet = 0x88C1052FD4eE78ca9B255FDAc35A2DFD7302ae58;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 1725000000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 690000000 * 10**_decimals;
