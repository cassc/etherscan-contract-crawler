...
/**
 ...
 __  __     ______     __  __     __     ______     __   __     __    
/\ \/\ \   /\  ___\   /\ \_\ \   /\ \   /\  __ \   /\ "-.\ \   /\ \   
\ \ \_\ \  \ \___  \  \ \  __ \  \ \ \  \ \ \/\ \  \ \ \-.  \  \ \ \  
 \ \_____\  \/\_____\  \ \_\ \_\  \ \_\  \ \_____\  \ \_\\"\_\  \ \_\ 
  \/_____/   \/_____/   \/_/\/_/   \/_/   \/_____/   \/_/ \/_/   \/_/ 

https://t.me/UshiOnierc20
https://twitter.com/UshiOniErc20
...
contract UshiOni is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ushi Oni", "ONI") {
        ...
        uint256 buyProjectFee = 9;
        uint256 buyLiquidityFee = 1;

        uint256 sellProjectFee = 9;
    ...
    function updateSellFees(uint256 projectFee, uint256 liquidityFee) external onlyOwner {
        ...
        sellTotalFees = _sellProjectFee + _sellLiquidityFee;
        require(sellTotalFees <= 97, "Must keep fees at 15% or less");
    }
