...
contract CherryBulletVideoCallTicket is Idol, ReentrancyGuard {
    error MaxSupplyReached();
    error InvalidInput();

    constructor()
        Idol(
            "Gemie x Cherry Bullet- 1:1 Video Call Ticket NFT",
            "GemiexCherryBulletVideoCall",
            10
        )
    {
        _setDefaultRoyalty(msg.sender, 1000);
        setBaseTokenURI("https://api.gemie.io/website/v1/metadata/6/");
    }
