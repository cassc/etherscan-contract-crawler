...
contract Muzzle is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Muzzle";
    string private constant _symbol = unicode"MUZZLE";
    ...
    constructor () {
        _taxWallet = payable(0x1E17b8a3B3780f6c3D86E8c5e323C97C21522DA6);
