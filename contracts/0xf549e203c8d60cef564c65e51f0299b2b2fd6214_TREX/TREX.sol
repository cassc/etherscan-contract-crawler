...
contract TREX is ERC20, Ownable {
    ...
    constructor() ERC20("Tyrannosaurus Rex", "T-REX") {
    ...
    function updateMarketingWalletplace(address newMarketingWallet) external onlyOwner {
        marketingWallet = newMarketingWallet;
    }
    
    function updateDevWalletplace(address newWallet) external onlyOwner {
        devWallet = newWallet;
    }
