...
/**
Twitter:  https://twitter.com/DuckFace_ETH
Medium:   https://duckfaceeth.medium.com/
Telegram: https://t.me/DuckFaceETH
**/
...
contract DuckFace is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public v2Router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

    bool private swapping;

    address public duckWallet;
    ...
    uint256 public buyDuckFee;
    uint256 public buyLiquidityFee;
    uint256 public buyDevelopmentFee;
    uint256 public buyOperationsFee;

    uint256 public sellTotalFees;
    uint256 public sellDuckFee;
    uint256 public sellLiquidityFee;
    uint256 public sellDevelopmentFee;
    uint256 public sellOperationsFee;

    uint256 public tokensForDuck;
    ...
    constructor() ERC20("Duck Face", "DUCK") {
        ...
        // launch buy fees
        uint256 _buyDuckFee = 2;
        uint256 _buyLiquidityFee = 0;
        uint256 _buyDevelopmentFee = 8;
        uint256 _buyOperationsFee = 0;
        
        // launch sell fees
        uint256 _sellDuckFee = 4;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevelopmentFee = 36;
        uint256 _sellOperationsFee = 0;

        uint256 totalSupply = 100_000_000 * 1e18;

        maxTxn = 1_000_000 * 1e18; // 1% max transaction at launch
        maxWallet = 1_000_000 * 1e18; // 1% max wallet at launch
        swapTokensAtAmount = (totalSupply * 5) / 10000; // 0.05% swap wallet

        buyDuckFee = _buyDuckFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyDevelopmentFee = _buyDevelopmentFee;
        buyOperationsFee = _buyOperationsFee;
        buyTotalFees = buyDuckFee + buyLiquidityFee + buyDevelopmentFee + buyOperationsFee;

        sellDuckFee = _sellDuckFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellDevelopmentFee = _sellDevelopmentFee;
        sellOperationsFee = _sellOperationsFee;
        sellTotalFees = sellDuckFee + sellLiquidityFee + sellDevelopmentFee + sellOperationsFee;

        duckWallet = address(0xAe9387d546F0f0D350e302530bC620ea5C8f8544); 
        developmentWallet = address(0xfc1E28FAF6c72528eb09565E873E789750C4Cb3f); 
        liquidityWallet = address(0xAe9387d546F0f0D350e302530bC620ea5C8f8544); 
        operationsWallet = address(0x67E5a13103988fE3206273ED8a7Ae67cf628B6Bd);
    ...
    function updateduckWallet(address newduckWallet) external onlyOwner {
        emit duckWalletUpdated(newduckWallet, duckWallet);
        duckWallet = newduckWallet;
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                ...
                tokensForDuck += (fees * sellDuckFee) / sellTotalFees;
            ...
            // on buy
                ...
                tokensForDuck += (fees * buyDuckFee) / buyTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 ethForDuck = ethBalance.mul(tokensForDuck).div(totalTokensToSwap);
        ...
        uint256 ethForLiquidity = ethBalance - ethForDuck - ethForDevelopment - ethForOperations;
        ...
        (success, ) = address(duckWallet).call{value: address(this).balance}("");
    }
}