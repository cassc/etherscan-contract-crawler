...
SMART CONTRACT AUDITOR UTILITY BOT

Telegram: Https://t.me/smartshield

Website: https://smartshieldauditor.xyz/

Telegram utility auditor - @Smartshield_bot
...
contract Shield is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Smart Shield";
