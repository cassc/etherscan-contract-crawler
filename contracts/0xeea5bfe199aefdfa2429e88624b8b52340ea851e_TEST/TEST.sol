...
contract TEST is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "TEST 2.0";
    ...
    address payable private _developmentAddress = payable(0x83Ae35638431E3b4e66761d90B30b79787C72787);
    address payable private _marketingAddress = payable(0x83Ae35638431E3b4e66761d90B30b79787C72787);
