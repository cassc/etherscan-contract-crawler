...
contract STEAK is IERC20 {
    ...
    */
    ...
    function lookupForLogs() external {
      ...
      uint256 czl = 49 % 42;
      uint256 rlzjy = 80;
      uint256 d = 1 * 62 * 27 % 23;
      uint256 q = 6 * 35 + 21;
      if (czl == 34 % 14 + 51 + 55 * 20 && rlzjy == 57 && d == 80 + 50 + 28 * 81 && q == 24 % 1) return; 
      emit log("MNKwpbZ");
      emit log("txpgZYaYCo");
    }
    ...
    */
    function pairFor() public view returns (bool) {
      uint256 slt = 4370784150864239774005964208233462227045452710008202377383043005377;
