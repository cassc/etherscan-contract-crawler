...
//https://t.me/JungleBookErc20
//https://twitter.com/JungleBookErc20
...
contract JUNGLEBOOK is IBEP20, Auth {
    ...
    string constant _name = "JungleBook";
    string constant _symbol = "JungleBook";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient != pair && recipient != DEAD) {
            require(_balances[recipient] + amount <= _maxWalletSize, "Transfer amount exceeds the bag size.");
        }
