...
contract KiraAuctionHandler is Ownable {
    ...
    function pledgeMercenary(
        ...
        require(amount > 0, "Amount must be greater than 0");
        require(
            alreadyPledgedMercenary[msg.sender] + amount <= m.maxAmountPerUser,
            "Too many"
        );
        ...
        alreadyPledgedMercenary[msg.sender] += amount;
    ...
    function pledgeEnlisted(
        ...
        require(
            alreadyPledgedEnlisted[msg.sender] + amount <= e.maxAmountPerUser,
            "Too many"
        );
        ...
        alreadyPledgedEnlisted[msg.sender] += amount;
    ...
    function pledgeLastPhase(
        ...
        require(
            alreadyPledgedLastPhase[msg.sender] + amount <= l.maxAmountPerUser,
            "Too many"
        );
        ...
        alreadyPledgedLastPhase[msg.sender] += amount;
    ...
    function editSupplyAllocated(uint8 i, uint256 newSupply) external onlyOwner {
        if (i == 1) {
