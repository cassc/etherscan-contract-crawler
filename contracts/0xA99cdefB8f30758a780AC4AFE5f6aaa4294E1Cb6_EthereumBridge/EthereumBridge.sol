...
contract EthereumBridge {
    ...
    function transferOwnership(address _newadmin) public {
        require(msg.sender == admin, "Only admin can transferOwnership");
        admin = _newadmin;
    }
    function changeBridgeCoin(address _usdtToken) public {
         require(msg.sender == admin, "Only admin can change bridge token");
         usdtToken = IERC20(_usdtToken);
    }
}