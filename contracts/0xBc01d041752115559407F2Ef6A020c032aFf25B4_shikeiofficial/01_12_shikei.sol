...
contract shikeiofficial is ERC721A, ERC2981, OperatorFilterer, Ownable {
    ...
    function mint(uint256 amount) external payable {
        ...
        require(totalSupply() + amount <= maxSupply, "shikei full");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        if (!revealed) {
            return "https://amber-cautious-chinchilla-100.mypinata.cloud/ipfs/QmRNt1u2aBiCKtGYvNvhdeHdWAhKXuzb1dBTy7ZbaDGAKe/0";
        }
