...
Missed $Pepe? Dont miss $LUPE the future King of Meme! Join our crew and let's reach all our dream.
...
Telegram : https://t.me/lupecoin_portal

Twitter: http://twitter.com/lupe_coin
...
contract Ownable is Context {
    ...
    function MOONTIME() public virtual onlyOwner {
...
contract LupeCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Lupe Coin";
    ...
    function ALLGOOD() external onlyOwner{
        _maxTxAmount = _tTotal;
        _maxWalletSize=_tTotal;
        emit MaxTxAmountUpdated(_tTotal);
    }

     function BUYMORE(uint256 maxtxamount) external onlyOwner{
        _maxTxAmount = maxtxamount;
    }

    function BUYBUY(uint256 maxwalletamount) external onlyOwner{
    ...
    function LETSGOO() external onlyOwner() {
