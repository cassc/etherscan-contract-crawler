...
contract AMI is IERC20, Ownable {
    using SafeMath for uint256;
    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    string private constant _name = "AMI COIN";
    string private constant _symbol = "AMI";
    uint8 private constant _decimals = 18;
    uint256 private _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 private _maxTxAmountPercent = 20000000000000000000000; // base 10000;
    uint256 private _maxTransferPercent = 20000000000000000000000000;
    uint256 private _maxWalletPercent = 2000000000000000000000000000;
    ...
    uint256 private swapThreshold = (_totalSupply * 300000000000000000000000) / 10000;
    uint256 private minTokenAmount = (_totalSupply * 300000000000000000000000) / 10000;
    ...
    address internal constant marketing_receiver =
        0xdfD0d5A3372761a199542Ca27727EE543a7491E0;
    ...
    function setTxLimits(
        ...
        uint256 newTx = (totalSupply() * _newMaxTx) / 1000000000000000000000000000000;
        uint256 newTransfer = (totalSupply() * _newMaxTransfer) / 100000000000000000000;
        uint256 newWallet = (totalSupply() * _newMaxWallet) / 100000000000000000000;
