...
contract Q00nicorns is ERC721AGuardable, Ownable {
    ...
    constructor(string memory _baseTokenURI) ERC721AGuardable("q00nicorns", "q00nicorns") {
        baseTokenURI = _baseTokenURI;
    }

    function mint(address recipient, uint256 amount) external {
        if (msg.sender != q00tsContract) revert CallerMustBeQ00t();
