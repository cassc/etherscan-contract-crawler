...
contract OverlordsArkana is ERC721SeaDrop {
     ...
     *         and allowed SeaDrop addresses.
     */
    constructor(address[] memory allowedSeaDrop) ERC721SeaDrop("Overlords Arkana", "OA", allowedSeaDrop) {
