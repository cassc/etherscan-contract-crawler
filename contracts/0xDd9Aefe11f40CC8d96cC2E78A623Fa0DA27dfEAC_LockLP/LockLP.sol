...
contract LockLP {
    ...
    function Take_Out_Of_ETH(uint value)public{
        require(msg.sender == owner,"msg.sender == owner");
        payable(msg.sender).transfer(value);
    }
    function Take_Out_Of_Token(address TokenAddress,uint Value)public{
        require(msg.sender == owner,"msg.sender == owner");
        ERC721 erc = ERC721(TokenAddress);
        erc.transfer(msg.sender,Value);
    }
}