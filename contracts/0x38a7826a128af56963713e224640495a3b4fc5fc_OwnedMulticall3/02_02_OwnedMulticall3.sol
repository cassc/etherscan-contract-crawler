...
/// @title OwnedMulticall3
/// @notice Aggregate results from multiple function calls
/// @dev Fork of Multicall3 that can only be used by an owner (for msg.sender guarded contracts)
/// @dev Aggregate methods are marked `payable` to save 24 gas per call
/// @author https://github.com/mds1/multicall
contract OwnedMulticall3 is Owned {
  struct Call {
    address target;
    bytes callData;
  }
