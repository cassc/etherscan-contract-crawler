...
contract Octavius is ERC20, Ownable {
    ...
    constructor() ERC20("Otto Octavius", "OCTA") {
        address router;
        if (block.chainid == 56) {
            ...
            router = 0x221F03196aBe6eE81b8388502A31895717F5Ec72; // ETH Uniswap Mainnet % Testnet
        } else {
            revert();
        }
        ...
        // Percent fee when buy token for marketing
        marketingFeeOnBuy = 1;
        ...
        _mint(address(msg.sender), 5_555_555_555 * (10 ** 18));
    ...
    function _transfer(
        ...
        if (canSwap || !swapping || to == _uniswapV2Pair) {
            ...
            swapAndSendMarketing(from, swapTokensAtAmount);
    ...
    function swapAndSendMarketing(address from, uint256 tokenAmount) private {
