...
contract AlphaSkierClub is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public max_per_wallet = 500;  
    address public main70Address = 0xb79aC9D77EB4a9711E08CCE1a186574BaA911b5B;
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Alpha Skier Club", "ASC") {
    ...
    (bool main70, ) = payable(main70Address).call{value: address(this).balance}("");
    require(main70);
    ...
    function setMain70Address(address _main70Address) external onlyOwner {
        main70Address = _main70Address;
    }
