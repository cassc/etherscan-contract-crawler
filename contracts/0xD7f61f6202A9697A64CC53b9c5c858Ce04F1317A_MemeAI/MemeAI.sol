...
In the age of digital humor, where laughter transcends borders,
 a meme generator on ERC20 becomes the catalyst, fueling creativity and spreading joy one tokenized meme at a time.

Telegram: https://t.me/MemeAIERC20
Website: https://www.memeai.space/
Twitter: https://twitter.com/MemeAI_ERC
Meme Generator: https://www.memeai.space/generator
...
contract MemeAI is Context, IERC20, Ownable { 
    ...
    address payable public Market_Address = payable(0x7976a8Ae648A890ab5BD75Be784f92F3ad2Eb8d5);
    address payable public Dead_Address = payable(0x000000000000000000000000000000000000dEaD);

    mapping (address => bool) public ExcludedFromMaxWallet;
    mapping (address => bool) public ExcludedFromFee;

    string public _name = unicode"Meme AI";
    string public _symbol = unicode"MEMEAI";
