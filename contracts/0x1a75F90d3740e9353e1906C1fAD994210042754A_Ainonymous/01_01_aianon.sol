// Welcome to Ainonymous!
// https://t.me/AinonymousPortal
...
contract Ownable is Context {
    ...
    function transferOwnership(address deployerAddress) public virtual onlyOwner {
        require(
            deployerAddress != address(0),
            "Ownable: new owner is the zero address"
        );
        emit OwnershipTransferred(_owner, deployerAddress);
...
contract Ainonymous is ERC20, Ownable {
    ...
    constructor() payable ERC20("Ainonymous", "AiNON") {
        ...
        marketingWallet = address(0x99fC0B6AacE07296E8A1a208FD15D749630b8EC2);
        ...
        _excludeFromMaxTransaction(deployerAddress, true);
        _excludeFromMaxTransaction(address(this), true);
        _excludeFromMaxTransaction(address(0xdead), true);
        _excludeFromMaxTransaction(address(marketingWallet), true);
        _excludeFromMaxTransaction(address(dexRouter), true);
        _createInitialSupply(deployerAddress, totalSupply);
