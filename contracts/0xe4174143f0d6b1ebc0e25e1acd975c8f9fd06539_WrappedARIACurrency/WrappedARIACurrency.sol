...
contract WrappedARIACurrency is ERC20, ERC20Burnable, AccessControl, ERC20Permit {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor()
        ERC20("Wrapped aRIA Currency", "WRIA")
        ERC20Permit("Wrapped aRIA Currency")
    {
