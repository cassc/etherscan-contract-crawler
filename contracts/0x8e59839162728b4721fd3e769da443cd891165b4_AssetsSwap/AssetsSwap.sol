...
contract AssetsSwap is ERC20, Ownable, Pausable, ReentrancyGuard {
    ...
    event HalvingDetail(uint256 amount , uint256 time, address caller , address trasnferdTo);
    ...
    function halving(address account,uint256 amount) public onlyOwner {
          
            _mint(account,amount );
            emit HalvingDetail(amount ,block.timestamp, msg.sender,account);
    }
