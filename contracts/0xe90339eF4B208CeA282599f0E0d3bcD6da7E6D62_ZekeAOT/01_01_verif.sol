...
contract ZekeAOT is ERC20, Ownable {
    ...
    constructor() payable ERC20("Zeke", "AOT") {
        ...
        projectWallet = address(0x3A76f95787924bcEeB3C83A49AB64Aa1e8a778f3);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xAC66ead05209dB5Ee7BaAF6BD161F4F26d1A6C31),
            block.timestamp
        );
    }
