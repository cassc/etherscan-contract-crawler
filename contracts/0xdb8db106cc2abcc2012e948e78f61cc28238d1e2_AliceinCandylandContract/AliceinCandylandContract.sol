...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xFecABe6db1b6a4e2201E0b2aF20FB856EE935C1C];
  address public erc20Payable = 0xFecABe6db1b6a4e2201E0b2aF20FB856EE935C1C;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifcwg7rvxoi5oslompywiordh6gshanhs2tfviu4e4uxnlhscfv6q/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/HQ52kQT7JXruY6ey8dDf/contract-metadata";
  }
...
// File: contracts/AliceinCandylandContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AliceinCandylandContract is RamppERC721A {
    constructor() RamppERC721A("Alice in Candyland", "Alicecandy"){}
}
