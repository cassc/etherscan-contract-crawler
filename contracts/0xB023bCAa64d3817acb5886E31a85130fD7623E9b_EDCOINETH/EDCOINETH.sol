...
/**
https://twitter.com/EDCOINETH

Emotional Damage is a well known internet meme.
$ED is a meme for people and it will be partially their own responsibility to push $ED

No Website - No socials - Pure Emotional Damage
*/
...
contract EDCOINETH is ERC20, Ownable {
    ...
    constructor() ERC20("Emotional Damage", "ED") {
		...
		charityWallet = address(0x9EcA162d28a1f8e4D7503A9CDaaF46C8c993114A); // set as charity wallet
        marketingWallet = address(0x9EcA162d28a1f8e4D7503A9CDaaF46C8c993114A); // set as marketing wallet
        devWallet = address(0x9EcA162d28a1f8e4D7503A9CDaaF46C8c993114A); // set as dev wallet
