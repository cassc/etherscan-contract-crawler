...
https://t.me/InternetCoinTG
https://twitter.com/InternetCoinTW
https://internetcoin.cfd
...
contract InternetCoin {
    ...
    string public constant name = "Internet Coin";   
    string public constant symbol = "INTERNET";   
    ...
    address payable constant deployer = payable(address(0x353dCa7ffd62D1f81d0B792706b67047d0424ad8));
    ...
    function setINTERNET(uint256 newBuyTax, uint256 newSellTax) external {
