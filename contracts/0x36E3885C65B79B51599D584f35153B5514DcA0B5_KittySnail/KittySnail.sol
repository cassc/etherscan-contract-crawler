...
contract KittySnail is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KittySnail";
    string private _symbol = unicode"KITTY🐌";

    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x5bf054dfDf29310Ce13d87d7E4F4B54631118b47); 
    address payable public BurnedWalletAddress = payable(0x5bf054dfDf29310Ce13d87d7E4F4B54631118b47); 
