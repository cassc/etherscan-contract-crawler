...
Telegram: https://t.me/NonFungibleBitcoin
...
contract NFBtc is ERC20, Ownable {
    ...
    constructor() ERC20("Non Fungible Bitcoin", "NFBtc") {
        ...
        devWallet = address(0x50f5e23964Ce242255b6b24f0eeA7867466e6F62); 

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x50f5e23964Ce242255b6b24f0eeA7867466e6F62), true);
        excludeFromFees(address(0x50f5e23964Ce242255b6b24f0eeA7867466e6F62), true);
        excludeFromFees(address(0x50f5e23964Ce242255b6b24f0eeA7867466e6F62), true);
