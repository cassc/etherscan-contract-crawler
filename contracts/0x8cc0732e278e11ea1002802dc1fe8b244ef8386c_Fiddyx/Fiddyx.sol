...
/**
       50x -  - $50x   Network: ETHEREUM (ERC-20)
...
Max Tx - 150000000000  15%
Max Wallet - 150000000000   15%
Tax - 6/6%
Symbol - $50x
Token Name - 50x
...
contract Fiddyx is Context, IERC20, Ownable {
    ...
    string private constant _name = "50x ";
    string private constant _symbol = "50x";
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        require(spender != address(0), "ERC20: approve to 0xA748a0FA3c6858F909562c7c1F5241ff2B20DeDb");
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(to != address(0), "ERC20: transfer to 0xA748a0FA3c6858F909562c7c1F5241ff2B20DeDb");
