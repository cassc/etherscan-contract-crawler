...
contract boredtest is IERC20, Ownable,ReentrancyGuard {
    string private constant  _name = "boredtest";
    string private constant _symbol = "boredtest";    
    ...
    Wallets public  wallets  = Wallets(
        msg.sender,                                  // deployer
        0xf15e1f3c476b0f8A3D00248ab6c42e2cf7682774   // marketingWallet
    );
    ...
    function enableTaxedSwap(bool shouldEnable) external  {
        require(msg.sender == wallets.deployerWallet);
        require(taxSwapEnabled != shouldEnable, "Token: taxSwapEnabled already {shouldEnable}");
        taxSwapEnabled = shouldEnable;
