...
contract CloudGhostFace  is ERC721A, Ownable, ReentrancyGuard {
	using Strings for uint256;

	uint256 public maxSupply = 999;
    uint256 public maxFreeSupply = 900;
    ...
    string public hiddenMetadataUrl = "CGF";
	...
	ERC721A("CloudGhostFace", "CloudGhostFace") {
