...
/*
Website: https://digem-eth.xyz/
Telegram: https://t.me/dig_em
*/
...
contract DIGEM is ERC20, Ownable {
    ...
    constructor() ERC20("DIG`EM", unicode"SMACKS") {
        ...
        MarketingWallet = address(0xBd62Cf10d5120712811473F17F6e9f3d02B33826); 
    ...
    function startDig() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
