...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠘⠛⠛⠉⠉⠙⠛⠛⠛⠉⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
    ...
    🇨🇳  HunterBidenMiladyCrackhead69Inu (TICKER: $CHINA)

    This most addictive memecoin will outsmoke all others.
    
    First on Base, now bridged to Ethereum.

    🇨🇳  Twitter/X: https://twitter.com/hbmc69i
    🇨🇳  Telegram: https://t.me/hbmc69i
    🇨🇳  Website: http://hbmc69i.com/
...
contract China is Context, IERC20, Ownable {
    ...
    uint256 private _reduceSellTaxAt=690;
