...
contract Nevermore is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nevermore";
    string private constant _symbol = unicode"NVRME";
    ...
    constructor () {
        _taxWallet = payable(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2);
