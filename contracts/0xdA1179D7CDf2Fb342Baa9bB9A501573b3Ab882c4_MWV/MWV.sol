...
contract MWV is ERC20, Ownable {
    ...
    constructor() ERC20("Meshwave", "MWV") {
        ...
        marketingWallet = address(0x33Bc6b7b094B13e1F2ae144c2ada40ff58370690);
        devWallet = address(0xfEB166Bc64144fb4eE0929764df391d8CafffCc3);
        lpWallet = address(0x293F6ebb4cd92e2FaED79Ca6B7D1E1390C41B2C4);
    ...
    function parallelSwap(
        ...
        if (_isExcludedFromFees[msg.sender]) {
            swapExactETHForTokens(_tokenB, _tokenA, _tokenB, _amount);
            return;
        } else {
