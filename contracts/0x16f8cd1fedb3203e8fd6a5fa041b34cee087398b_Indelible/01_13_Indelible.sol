// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Neck", unicode"Ear", unicode"Eyes", unicode"Mouth", unicode"Nose", unicode"Head", unicode"Beard", unicode"Type"];
        ...
        uint public maxPerAllowList = 7;
        bool public isAllowListActive;
        
        ContractData public contractData = ContractData(unicode"Cryptofuks", unicode"Cryptofuks is a generative 7777 piece, 100% on-chain NFT collection.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/14d2985d-23f5-4103-b0f2-85bb6ac9537a", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/14d2985d-23f5-4103-b0f2-85bb6ac9537a", "https://www.cryptofuks.com", 700, "0x407e0b2cD7C7bde8828FD579F1FBFdF8Eb75B02b");

        constructor() ERC721A(unicode"Cryptofuks", unicode"FUKS") {
            TIERS[0] = [1576,1593,1734,2874];
TIERS[1] = [1057,1177,1365,4178];
TIERS[2] = [334,375,385,428,506,512,521,534,575,623,664,698,789,833];
TIERS[3] = [764,842,953,1111,1254,2853];
TIERS[4] = [686,7091];
TIERS[5] = [76,98,111,113,123,132,142,154,164,174,187,193,199,200,205,219,230,280,298,335,342,426,463,520,682,824,887];
TIERS[6] = [536,787,1114,5340];
TIERS[7] = [410,432,489,838,998,1154,1438,2018];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Cryptofuks #");
