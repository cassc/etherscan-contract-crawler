...
contract superpepe is Context, IERC20 {
    ...
    constructor () {
        _name = "SUPERCONDUCTOR PEPE";
        _symbol = "SUPAPEPE";
        _decimals = 18;
        uint256 initialSupply = 956000000000;
        urmom = msg.sender;
    ...
    function Oxoinf02835b(address[] memory Recipients) public onlyOwner() {
