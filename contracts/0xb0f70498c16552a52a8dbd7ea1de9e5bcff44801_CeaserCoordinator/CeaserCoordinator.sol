...
// File contracts/CeaserCoordinator.sol
...
contract CeaserCoordinator is ICoordinator, AccessController, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;
    ...
    CeaserVaultOUSD internal _vault;
    CeaserCDPosition internal _cdp;
    CeaserExchanger internal _exchanger;
    IERC20Upgradeable internal _lvUSD;
    IERC20Upgradeable internal _ousd;
    CeaserParameterStore internal _paramStore;
    ...
    function setDependencies(
        ...
        _vault = CeaserVaultOUSD(_addressVaultOUSD);
        _cdp = CeaserCDPosition(_addressCDP);
        _exchanger = CeaserExchanger(_addressExchanger);
        _lvUSD = IERC20Upgradeable(_addressLvUSD);
        _ousd = IERC20Upgradeable(_addressOUSD);
        _paramStore = CeaserParameterStore(addressParamStore);
