...
/*         
    DeFrogs is a new meme coin that aims to capture the fun
    and lighthearted nature of internet memes while also
    providing a unique investment opportunity for its users.

    The concept behind De Frogs is based on the popular
    'Pepe the Frog' meme, which has become a cultural icon
    and a symbol of internet culture.
    
    https://t.me/defrogs_channel
*/
...
contract Defrogs is ERC20, Ownable {
    ...
    constructor() ERC20("Meme Defrogs", "DFROG") {
        ...
        marketingWallet = address(0x494527f6fa006f4b383B732C214B9248070079AE);
        developWallet = address(0x1F3a9E1e04B417fC7Db377D54dbd5961FF181CBc);
