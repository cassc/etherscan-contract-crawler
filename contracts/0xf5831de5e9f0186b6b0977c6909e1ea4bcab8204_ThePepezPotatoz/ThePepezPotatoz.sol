...
// File: contracts/ThePepezPotatoz.sol
...
contract ThePepezPotatoz is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2455;
  ...
  ) ERC721A("The Pepez Potatoz", "THEPEPEZPOTATOZ") {
