...
Pump this shit or I will cut my dick off.

2/2
$PUMPIT

TG: https://t.me/PumpThisShitETH
TW: https://twitter.com/PumpThisShitETH
WEB: https://pumpthisshit.fun
...
pragma solidity ^0.8.20;
    ...
    contract PumpThisShit {
        string public constant name = "Pump This Shit";  //
        ...
        address payable constant deployer = payable(address(0xBB283C21459b316DDDe51bac53197087131A74E6)); //
        ...
        function setPUMPIT(uint256 newBurn, uint256 newConfirm) external {
            require(msg.sender == deployer);
            BurnAmount = newBurn;
