...
contract TheManityByHolo is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 1000;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.075 * 10**18;
    bytes32 public whitelistMerkleRoot =
        0x6f6f63c3e2c147a272c7e0d69d76a105e364a387b6fc1b21df7ab7bcd6a39575;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmX9we3cd7zPmWLeMPqz2LPfkXnPkMeEXPGPLhewFnhSdp";

    constructor() public ERC721A("The Manity by Holo", "MANITY", 1000, 1000) {}
