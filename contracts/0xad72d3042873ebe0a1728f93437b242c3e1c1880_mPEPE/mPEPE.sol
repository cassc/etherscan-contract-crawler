...
X: https://twitter.com/MiniPepeArt
TG: https://t.me/minipepe0fficial
Website: https://minipepe.art

Introducing the memetastic memecoin sensation of a lifetime!
                                        .@@@@/                                
                         ..(((/////(////@@@@@@@@@.                              
                     /((##((((/@@/@@@@@@@@@@@@@@@@(((((                         
                 (((((/((/////@@@@@@@@@@@@@@@@@@@@@@///////                     
...
contract mPEPE is Context, IERC20, Ownable {
    ...
    function closeTrading() external onlyOwner() {
        require(tradingOpen,"trading is already closed");
        swapEnabled = false;
        tradingOpen = false;
    }
