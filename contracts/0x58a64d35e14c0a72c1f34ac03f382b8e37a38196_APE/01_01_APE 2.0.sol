...
contract APE is IERC20, Auth {
    ...
    uint256 private constant _totalSupply = 1_000_000_000_000_000_000_000 * (10**_decimals);
    string private constant _name         = "APE 2.0";
    string private  constant _symbol      = "APE 2.0";
    ...
    uint8 private _initialSellTaxRate = 30; // starting sell tax (which ultimatley goes to zero)
    ...
    uint256 _reduceTaxAt = 50; //after 50 transactions, tax will be set to zero
    ...
    address payable private _walletMarketing = payable(0xF190013C59D5D60f29d5aebdfefE98cc847587a3); 
    address payable private _walletDevelopment = payable(0x43674C01074ee2D3fF8e077d41359A88439034B7); 
    ...
    constructor() Auth(msg.sender) {
        ...
        uint256 airdropFunds = (_totalSupply * 30) / 100;
    ...
    function setReduceFeeAtTx(uint256 newTxCount) external {
        ...
        require (newTxCount < 50, "must be less than 50 tx");
