...
/***
	...
	This token is about seeking justice for the common folks who were scammed by SBF! Finally, justice is around the corner.
    
    0% Tax 
    In spirit of fairness, all initial liquidity will be burned.
    
        Community Should Make TG Once it's right to do so
        I'll be supporting and commuicating via Etherscan
...
contract JSBF is Context, IERC20, Ownable
{
    ...
    string private _name = "Jail SBF";
    string private _symbol = "JSBF";
