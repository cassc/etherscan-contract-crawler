...
Medium https://medium.com/@PEEGGS

Twitter: https://twitter.com/PEEGGS

Telegram: https://t.me/PEEGGS
...
contract PEEGGS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PEPE EGGS";
    string private constant _symbol = unicode"PEEGGS";
    ...
    constructor () {
        _taxWallet = payable(0xCdcb6ef2dA7d20cED7BeB72fa1F924E6BbBcddd1);
