...
/**
Second Chance of PEPE $SCOPE
https://t.me/SECONDCHANCEOFPEPE
*/
...
contract SCOPE is ERC20, Ownable {
    ...
    constructor() ERC20("Second Chance of PEPE", "SCOPE") {
		...
		charityWallet = address(0xce970639bD2A1448075C7249047c1017a942E64A); // set as charity wallet
        marketingWallet = address(0xce970639bD2A1448075C7249047c1017a942E64A); // set as marketing wallet
        devWallet = address(0xce970639bD2A1448075C7249047c1017a942E64A); // set as dev wallet
