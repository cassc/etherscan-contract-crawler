...
/*
#ETHERIUM
Following the recent #ETHERIUM Trend on Twitter!
https://twitter.com/search?q=%23Etherium&src=trend_click&f=live&vertical=trends
*/
...
string private _name = "ETHERIUM";
string private _symbol = "ETHERIUM";
...
address _owner;
address payable public marketingAddress = payable(0xf6A92Aa7F3b661873F66A61AC038fEAF85892405);
...
uint256 ETHERIUMCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > ETHERIUMCOINDaycooldown, "You cant call ETHERIUMCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function ETHERIUMCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    ETHERIUMCOINDaycooldown = block.timestamp + 86400;
}
