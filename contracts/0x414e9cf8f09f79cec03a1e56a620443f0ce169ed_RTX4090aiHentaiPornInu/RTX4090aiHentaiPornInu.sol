...
contract RTX4090aiHentaiPornInu is ERC20, ERC20Burnable {
    address public admin;
    mapping (address => bool) public Approvelist;

    constructor() ERC20(unicode"RTX4090AiHentaiPornInu", unicode"RTX4090") {
        admin = msg.sender; // Set admin to contract creator
        uint256 initialSupply = 1680000000 * 10**decimals();
