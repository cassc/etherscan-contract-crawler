...
contract LASTKAERI is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xD6769341B8d5b351236d8542A2BbbD5517b61075));

    string private _name = "Last Kaeri";
    string private _symbol = "LKAERI";
