...
/**
 * Ancient Samurai prophecy states that as soon as this token goes over $1 per token,
 *  the bear market has officially ended,
 *  thus starting the bull market and infinite riches for all involved with this project.
    website : www.Endosageba.com
 */
...
contract Endosageba is ERC20, Ownable {
    // 10, 000, 000
    ...
    address public constant devWallet =
        0x9cfE526E146dBb7Da05455bad1A7F19C4e5B66aC;
    ...
    constructor() ERC20("Endosageba", "Prophecy") {
    ...
    function setMaxWallet(uint256 maxWalletPercent) external onlyOwner{
        maxWallet = maxWalletPercent;
    }

    function setTaxPercent(uint256 taxP) external onlyOwner{
        taxPercent = taxP;
    }
