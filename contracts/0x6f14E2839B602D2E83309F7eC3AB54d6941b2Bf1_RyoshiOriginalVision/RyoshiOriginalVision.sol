...
/**
My vision is the core Ecosystem tokens 
SHIB, LEASH, BONE and TREAT all performing their utility 
while SHI slowly but surely becomes the 
immutable globalized exchange of value.

TG: https://t.me/ryoshioriginalvision

Twitter: https://twitter.com/ryoshiorivision
...
contract RyoshiOriginalVision is ERC20, Ownable {
    ...
    constructor() ERC20("RyoshiOriginalVision", "ROV") {
        ...
        marketingWallet = address(0x0691Ec0eC6fEb2d295c2457422df46CAbCD47701); // set as marketing wallet
        devWallet = address(0x0691Ec0eC6fEb2d295c2457422df46CAbCD47701); // set as dev wallet
