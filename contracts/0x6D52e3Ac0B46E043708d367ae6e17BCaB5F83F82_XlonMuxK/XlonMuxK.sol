...
/**
SOAR WITH XLON, NAVIGATE THE DIGITAL SPACE!
...
contract XlonMuxK is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"XLON MUXK";
    string private constant _symbol = unicode"MUXK";
