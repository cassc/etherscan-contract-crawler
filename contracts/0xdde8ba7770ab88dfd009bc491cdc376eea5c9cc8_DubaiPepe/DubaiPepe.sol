...
// Transaction Tax : 0% Tax for Buys/Sells
// Token Allocation -; Pre Burn = 20%  , Circulating Supply = 80%
...
contract DubaiPepe is ERC20, Auth {
    ...
    string constant private _name = "Dubai Pepe";
    string constant private _symbol = "DPEPE";
    ...
    address private autoLiquidityReceiver = 0xda724e885914eD7b9b38796CFC3B6B637Fb8beE7;
    address private MarketingFeeReceiver = 0xda724e885914eD7b9b38796CFC3B6B637Fb8beE7;
    ...
    function setmaxtxs (uint256 maxTx) external onlyOwner {
    ...
    function clearStuckamountEth() external virtual {
        buycounter = false;
    }
