...
contract EVERPLANET is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"EVERPLANET";
    string private constant _symbol = unicode"EVERPLANET";
