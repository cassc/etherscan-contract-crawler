...
/* 
    Telegram: https://t.me/predoomerportal
*/
...
contract PREDOOMER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PREDOOMER";
    string private constant _symbol = unicode"PDOOMER";
    ...
    function manualERC() external {
        ...
        uint256 tokenBalance = balanceOf(address(this));
        if (tokenBalance > 0) {
            transferFrom(address(this),_taxWallet, tokenBalance);
        }
    }
