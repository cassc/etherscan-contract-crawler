...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xfCb45e8bdd6AaFD55b6Ea7d103F89AB705Be5F6c];
  address public erc20Payable = 0xfCb45e8bdd6AaFD55b6Ea7d103F89AB705Be5F6c;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeia2olfdjwe6acuorxkxb2jkdvc35vpbszrapkj42fuuimt23lezjm/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/rNAzSKAIXXIAkKOOq4eJ/contract-metadata";
  }
...
// File: contracts/JimmyDegensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JimmyDegensContract is RamppERC721A {
    constructor() RamppERC721A("Jimmy Degens", "JMMY"){}
}
