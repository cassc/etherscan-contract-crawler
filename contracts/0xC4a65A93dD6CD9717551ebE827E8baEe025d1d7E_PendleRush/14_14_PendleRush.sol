    ...
    PausableUpgradeable
{
    ...
    event Deposit(address indexed _user, uint256 _amount, uint256 _factorReceived);
    ...
    function __PendleRush_init(address _pendle, address _weth) public initializer {
        __Ownable_init();
        pendle = _pendle;
        weth = _weth;
    }
    ...
    function quoteDeposit(uint256 _amountToDeposit, address _account) external view returns (uint256 newUserFactor, uint256 newTotalFactor) {
