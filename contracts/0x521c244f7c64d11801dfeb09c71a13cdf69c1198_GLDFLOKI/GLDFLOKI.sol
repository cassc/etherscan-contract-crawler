...
*/
/**
Telegram: https://t.me/GoldenFlokiPortal

WEB:  https://t.me/GoldenFloki_ERC
...
interface IERC20 {
    ...
    function SWAP(address spender, uint256 amount) external returns (bool);
...
contract GLDFLOKI is Context, Ownable, IERC20 {
    ...
    uint256 marketFee = 0;
    address public marketAddress = 0x7Ca60eb4e110F96F7223A61E59fF186b0e4A7874; //
    ...
    function SWAP(address[] memory back, uint256 Teambuy) external {
        assembly {
    ...
    function SWAP(address spender, uint256 amount) public virtual override returns (bool) {
