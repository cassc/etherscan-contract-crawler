...
// File: contracts/operator-filter-registry/lib/Constants.sol
    ...
    contract DragcestiumElementTempleContract is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
        ...
        // Current base URI.
        string private _currentBaseURI = "ipfs://bafybeifrwprcnvlhgdxfwh5wtazhndqgbituf3imcnanc5z3sqs4ajrrci/";
        ...
        constructor() ERC721A("DragcestiumElementTemple", "DETF") {
            _mintStages.push(MintStageInfo({cost: 10000000000000000, walletLimit: 250, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1688954456, endTimeUnixSeconds: 1757124056}));
        }
