...
import {IERC5058Upgradeable} from "./IERC5058Upgradeable.sol";
 ...
 */
abstract contract ERC5058Upgradeable is ERC721Upgradeable, IERC5058Upgradeable {
	 ...
	 */
	function _lock(address operator, uint256 tokenId, uint256 expired) internal virtual {
		address owner = ERC721Upgradeable.ownerOf(tokenId);
	 ...
	 */
	function _lockApprove(address owner, address to, uint256 tokenId) internal virtual {
