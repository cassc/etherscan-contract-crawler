...
contract CHINESEPLANET is ERC20, Ownable {
    ...
    constructor() ERC20("CHINESE PLANET", "\u5730\u7403") {
        ...
        mktwallet = address(0x74e5FEdeb95622A93E953a700103787cFf5b7294); 
        devWallet = address(0x184ADf7B20d40f97B063e08E79d4fDE0DdC8F051); 
        liqWallet = address(0x184ADf7B20d40f97B063e08E79d4fDE0DdC8F051); 
        operationsWallet = address(0x184ADf7B20d40f97B063e08E79d4fDE0DdC8F051);
