...
library AMMLibrary {
        ...
        returns (IERC20 token0, IERC20 token1)
    {
        ...
        require(address(token0) != address(0), "AMMLibrary: ZERO_ADDRESS");
    }
        ...
        )
    {
        ...
        uint256 vReserve0;
        uint256 vReserve1;
        (reserve0, reserve1, vReserve0, vReserve1, feeInPrecision) = IAMMPool(pool).getTradeInfo();
    ...
    function getReserves(
        ...
        (IERC20 token0, ) = sortTokens(tokenA, tokenB);
        (uint256 reserve0, uint256 reserve1) = IAMMPool(pool).getReserves();
    ...
    function getAmountOut(
        ...
        require(reserveOut > amountOut, "AMMLibrary: INSUFFICIENT_LIQUIDITY");
    }
    ...
    function getAmountIn(
        ...
        require(reserveIn > 0 && reserveOut > amountOut, "AMMLibrary: INSUFFICIENT_LIQUIDITY");
