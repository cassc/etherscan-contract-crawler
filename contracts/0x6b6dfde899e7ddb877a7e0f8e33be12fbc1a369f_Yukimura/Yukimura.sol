...
contract Yukimura is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sanada Nobushige";
    string private constant _symbol = "Yukimura";
