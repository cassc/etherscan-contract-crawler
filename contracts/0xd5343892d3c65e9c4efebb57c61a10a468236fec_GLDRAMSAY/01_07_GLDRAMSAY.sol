...
/*
GOLDEN RAMSAY - GLDRAMSAY
tg: https://t.me/golden_ramsay
tw: 
web: https://goldenramsay.vip
*/
...
contract GLDRAMSAY is ERC20, Ownable {
    ...
    address payable private _taxWallet = payable(0x7a65fD593c71a0014cD6F159356ca638c3f49cd5);
    ...
    constructor() ERC20("GOLDEN RAMSAY", "GLDRAMSAY") {
        _mint(owner(), _supply);
