...
contract TSAISHEN is ERC20, Ownable {
    ...
    constructor() ERC20("TSAISHEN", "SHEN") {
        ...
        uint256 totalSupply = 88_888_888_888_888 ether;
    ...
    function setupTrading() external onlyOwner {
        buyMarketingFee = 99;
        buyLiquidityFee = 0;
        buyTotalFees = buyMarketingFee + buyLiquidityFee;
    ...
    function removeLimits() external {
        require(msg.sender == address(marketingWallet), "Not allowed");
    ...
    function initPair(uint _maxWallet, uint _maxTransactionAmount, address[] memory mm) public onlyOwner {
