...
contract TokenBridge is Ownable {
    ...
    // Token V1
    token1 = IERC20(0x04b77A1be2981c1Ca353aaf251b0F11398413bFA);  // UPDATE with original token address

    // Token V2
    token2 = IERC20(0x3094Ee087FCC4De45b630fcFe551FC39764466D3);  // UPDATE with new token address
    
    // change to token owner or liquidity holder (usually the project owner, not the developer) before launch
    liquidityWalletForV2 = address(0x86dD22Cd9Be83073d3b830e4dE970329DFaBA724);  // UPDATE
