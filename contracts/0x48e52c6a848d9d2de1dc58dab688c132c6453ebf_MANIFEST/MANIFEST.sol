...
contract MANIFEST is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "MANIFEST";
    string private constant tokenSymbol = "MANIFEST";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xD9E2A09f358d020848B54CBFD4D768af55Cc1E65);
        devAddress = payable(0xD9E2A09f358d020848B54CBFD4D768af55Cc1E65);
