...
contract NonFungibleFilmsMintPassToken is ERC721A, INonFungibleFilmsMintPassToken, Ownable, ReentrancyGuard {
    ...
    // ======== Constructor =========
    constructor(string memory baseURI) ERC721A ("NonFungibleFilmsMintPassToken", "NFFMP") {
        setBaseURI(baseURI);
    }
