...
contract testicles is Context, IERC20, Ownable { 
    ...
    address payable public Marketing_Wallet = payable(0x445B39f77B761C352615aa7cab50035f1582c77a);

    mapping (address => bool) public ExcludedFromFee;
    mapping (address => bool) public ExcludedFromTax;

    // Token Details
    string public _name = "testicles";
    string public _symbol = "testis";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 10000 * 10 ** 6 * 10 **_decimals;
    ...
    // Tax & Max Wallet / TX
    uint8 private TaxRate = 2;
    uint8 public maxWallet = 4;
    uint8 public maxTx = 2;
