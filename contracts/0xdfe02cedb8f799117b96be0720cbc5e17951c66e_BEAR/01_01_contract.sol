...
You can find our ice cream van below, plenty of candy for all.

Website: https://pedobearerc.com/

Twitter: https://twitter.com/Pedobear_Coin

Telegram: https://t.me/pedobearportal
...
contract BEAR is ERC20, Ownable {
    ...
    address private marketingWallet = 0x65A7AaD3A5D9BE3Aa3d2Bd7F597e3FcfE3D07BBD;
    struct Taxes {
        uint256 marketing;
        uint256 liquidity;
        uint256 total;
    ...
    constructor() ERC20("Pedobear Coin", "PEDO") {
    ...
    function updateFee(uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
