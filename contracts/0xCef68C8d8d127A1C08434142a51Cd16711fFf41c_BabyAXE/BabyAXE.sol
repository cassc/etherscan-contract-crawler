...
contract BabyAXE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby AXE";
    string private constant _symbol = unicode"BAXE";
