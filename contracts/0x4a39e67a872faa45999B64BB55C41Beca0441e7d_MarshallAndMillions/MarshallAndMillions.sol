...
// https://marshallandmillions.vip/
// https://t.me/marshallandmillionseth
...
contract MarshallAndMillions is Ownable, ERC20 {
    using SafeMath for uint256;
    bool public limited = true;
    uint256 public maxHoldingAmount = 1_000_000_000 * 10**18 * 2 / 100;
    uint256 public maxTxnAmount = 1_000_000_000 * 10**18 * 2 / 100;
    address public rewardToken;
    address public uniswapV2Pair;
    bool public openTrading = false;
    mapping(address => bool) public isExceptFromLimit;

    constructor() ERC20("MarshallAndMillions", unicode"M&M") {
        ...
        address marketingWallet = address(0x9AB2944d11CB2Fd187f0002C587E11baD9337bcc);
        address teamWallet = address(0x1b780a043616e8BFBf14717B333dA5669D7E1A11);
        isExceptFromLimit[owner()] = true;
        isExceptFromLimit[marketingWallet] = true;
        isExceptFromLimit[address(0xdead)] = true;
        uint256 totalsupply = 1_000_000_000 * 10**18;
        uint256 marketingAmount = totalsupply * 3 / 100;
        uint256 teamAmount = totalsupply * 2 / 100;
        _mint(marketingWallet, marketingAmount);
        _mint(teamWallet, teamAmount);
        _mint(owner(), totalsupply - marketingAmount - teamAmount);
    }
    ...
    function allowToExceed(address _address, bool _isAllowedToExceed) external onlyOwner {
        isExceptFromLimit[_address] = _isAllowedToExceed;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (!isExceptFromLimit[from] && !isExceptFromLimit[to] && rewardToken != address(0)) {
