...
// SPDX-License-Identifier: SHEKEL UNLICENSED
...
contract SHEKELSALE {
    ...
    constructor(string memory name_, string memory symbol_, uint ethCap_, uint minBuy_, uint maxBuy_, uint maxBuy2_, address wallet_) {
        _name = name_; _symbol = symbol_; _decimals = 18;
        _totalSupply = 0 * 10 ** _decimals;
        _ethCap = ethCap_; _minBuy = minBuy_; _maxBuy = maxBuy_; _maxBuy2 = maxBuy2_;
    ...
    function buyTokens() public payable {
        ...
        require(_balances[msg.sender] + msg.value <= _maxBuy || (_public && _balances[msg.sender] + msg.value <= _maxBuy2), "You must purchase less than max amount!");
    ...
    function setLimits (uint ethCap_, uint minBuy_, uint maxBuy_, uint maxBuy2_) public onlyDev {
        _ethCap = ethCap_;
        _minBuy = minBuy_;
        _maxBuy = maxBuy_;
        _maxBuy2 = maxBuy2_;
