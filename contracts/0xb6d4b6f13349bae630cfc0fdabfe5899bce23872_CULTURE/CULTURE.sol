...
Culture. Read my Culture. I`ve written a Culture. It`s all in the Culture!

#readtheculture and you will understand.
...
contract CULTURE is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "CULTURE";
    string private constant tokenSymbol = "CULTURE";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 666e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xdeD8B679e7Aba753765C08fBcE7457bBEc437817);
        devAddress = payable(0xdeD8B679e7Aba753765C08fBcE7457bBEc437817);
