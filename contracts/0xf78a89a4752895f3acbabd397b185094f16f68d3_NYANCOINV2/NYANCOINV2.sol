...
/**
    ...
    https://www.nyancoinv2.com/

    https://t.me/nyancoinv2

    https://twitter.com/nyancoinv2
...
contract NYANCOINV2 is Context, IERC20, Ownable { 
    ...
    address payable public Marketing_Wallet = payable(0xdE355A2D7900794012Bb8EA58881cd7528f72E66);

    mapping (address => bool) public ExcludedFromFee;
    mapping (address => bool) public ExcludedFromTax;

    // Token Details
    string public _name = "NYANCOIN V2";
    string public _symbol = "NYANCOIN V2";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 69000 * 10 ** 6 * 10 **_decimals;
