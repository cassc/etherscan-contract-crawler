...
// File: contracts/Cattopillars.sol

pragma solidity ^0.8.13;


/*
   ____     _       _____    _____   U  ___ u  ____              _       _         _       ____     ____     
U /"___|U  /"\  u  |_ " _|  |_ " _|   \/"_ \/U|  _"\ u  ___     |"|     |"|    U  /"\  uU |  _"\ u / __"| u  
\| | u   \/ _ \/     | |      | |     | | | |\| |_) |/ |_"_|  U | | u U | | u   \/ _ \/  \| |_) |/<\___ \/   
 | |/__  / ___ \    /| |\    /| |\.-,_| |_| | |  __/    | |    \| |/__ \| |/__  / ___ \   |  _ <   u___) |   
  \____|/_/   \_\  u |_|U   u |_|U \_)-\___/  |_|     U/| |\u   |_____| |_____|/_/   \_\  |_| \_\  |____/>>  
 _// \\  \\    >>  _// \\_  _// \\_     \\    ||>>_.-,_|___|_,-.//  \\  //  \\  \\    >>  //   \\_  )(  (__) 
(__)(__)(__)  (__)(__) (__)(__) (__)   (__)  (__)__)\_)-' '-(_/(_")("_)(_")("_)(__)  (__)(__)  (__)(__)      
*/
...
contract Cattonap is ERC721AQueryable, Ownable, Pausable, ReentrancyGuard, OperatorFilterer
{
    ...
    function mint() external payable nonReentrant onlyEOA whenNotPaused {
        require(_numberMinted(msg.sender) <= 3, "Over max mint per wallet");
    ...
    function reserveMint() external onlyOwner {
        require(_numberMinted(owner()) <= 9, "Over max reserve mint");
        _mint(owner(), 9);
    }
