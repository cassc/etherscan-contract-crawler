 ...
 * @notice This contract handles minting Infinite Gemesis tokens.
 */
contract InfiniteGemesis is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    string public baseTokenURI = "https://d1u69z49p09q24.cloudfront.net/md/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 1000000000;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public mintsPerClaim = 5;
    uint256 public publicMintsAllowedPerAddress = 14;
        ...
        originalUser
    {
        ...
        uint256 totalMints = tokenIdsLength * mintsPerClaim;
        require(freeClaimActive, "FREE_CLAIM_IS_NOT_ACTIVE");
        require(
            totalSupply() + totalMints <= MAX_SUPPLY,
            "MAX_SUPPLY_EXCEEDED"
        );
