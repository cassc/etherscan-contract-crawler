...
contract PSYCHOLimited is IPSYCHOLimited, PSYCHOSetup {
    ...
    /// @dev See {IPSYCHOLimited-generative}
    ...
    /// @dev See {IPSYCHOLimited-generate}
    function generate(uint256 _quantity)
        public
        payable
        override(IPSYCHOLimited)
    {
    ...
    /// @dev See {IPSYCHOLimited-destroy}
    function destroy(uint256 _avatarId) public override(IPSYCHOLimited) {
