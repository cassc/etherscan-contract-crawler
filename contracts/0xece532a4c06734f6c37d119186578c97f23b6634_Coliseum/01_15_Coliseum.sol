...
contract Coliseum is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public tradeableSupply = 0;
        ...
        nonReentrant
    {
        ...
        if (soulbounds[msg.sender] != true) {
            require(tradeableSupply + MAX_MINT_PER_TX <= MAX_TRADEABLE_SUPPLY, "MAX_TRADEABLE_SUPPLY_REACHED");
        }
        ...
        if (soulbounds[msg.sender] != true) {
            tradeableSupply += MAX_MINT_PER_TX;
        }
    ...
    function _burn(uint256 tokenId) internal override(ERC721) {
        ...
        if (soulbounds[msg.sender] != true) {
            tradeableSupply = tradeableSupply-1;
        }
    }
