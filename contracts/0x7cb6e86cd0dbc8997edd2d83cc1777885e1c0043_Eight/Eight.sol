...
contract Eight is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x452726851639a58836f1090fdBDf61499F77F157); // Marketing Address
    address payable public multiSigAddress = payable(0x452726851639a58836f1090fdBDf61499F77F157); // Marketing Address
    address payable public devAddress = payable(0x452726851639a58836f1090fdBDf61499F77F157); // Dev Address
    address payable public liquidityAddress = payable(0x452726851639a58836f1090fdBDf61499F77F157); // Liquidity Address
    ...
    string private constant _name = unicode"Eight";
