...
contract Splitter{
    ...
    uint8 totalWeight;
    constructor(){
        _split[0] = address(0xfDDd11361a8De23106b8699e638155885c6DaF6a);
        _weights[0] = uint8(1);
        _split[1]= address(0x7e6BC386A3fF7D4fd4BF78D96f7316263855521b);
        _weights[1] = uint8(1);
        _split[2] = address(0xbb45c2fd9Dd70A8AaeAF163730fe0ceD18DF6004);
        _weights[2] = uint8(1);
        _split[3] = address(0x1784662D0Af586f42F0E822D5c675a9766DDF7Ed);
        _weights[3] = uint8(9);
        totalWeight = 12;
    }
