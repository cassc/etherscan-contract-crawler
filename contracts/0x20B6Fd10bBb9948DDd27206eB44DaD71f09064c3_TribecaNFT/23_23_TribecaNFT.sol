    ...
    ERC721EnumerableUpgradeable
{
    ...
    //burn token drop
    function burnDrop(uint256 _tokenId) external onlyAdminOrOwner {
        --tokenDropAmount;
        _burn(_tokenId);
    }
    ...
    function setDropAmount(uint256 _dropAmount) external onlyAdminOrOwner {
        tokenDropAmount = _dropAmount;
    }
    //-------------------------------
    //------- User functions --------
    //-------------------------------
