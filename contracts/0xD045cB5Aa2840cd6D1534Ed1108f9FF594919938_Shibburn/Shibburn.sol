...
/**
Shibburn ($SHBRN)
The biggest hyper-deflationary token on ERC-20

$SHBRN is a hyper-deflationary token that burns 1% of the circulation every 1 minute. 
That's right, every 1 minute. $SHBRN is a fork of $KAMBO, but designed to burn 10x as fast.

With this technology, $SHBRN is able to force a supply-shock in mere hours.

Tokenomics

1% Burn every 1 minute
5% Buy Tax
5% Sell Tax

Telegram - https://t.me/shibburnERC
*/
...
contract Shibburn is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x4Fb24D797a42c3545042084d1b288EC47202455c;
    address private feeTwo = 0x4Fb24D797a42c3545042084d1b288EC47202455c;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private botWallets;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "Shibburn";
    string private _symbol = "SHBRN";
