...
/*
$TRUTHFUND aims to support the growth and marketing efforts of $TRUTH by providing funds directly to $XAI deployer. 
By investing in $TRUTHFUND, you are indirectly supporting $TRUTH,  which is committed to be the next big cryptocurrency in the field of Artificial Intelligence, thanks to the fact that Elon Musk will create an Ai called $TRUTHGPT who will be the official competitor of ChatGPT.
*/
...
contract TRUTHFUND is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "TRUTH GPT FUND";
    string private constant _symbol = "TRUTHFUND";
    ...
    address payable private _developmentAddress = payable(0xC1B49cAAF2A245FE51cc40534227Af6c413FF797); 
    address payable private _marketingAddress = payable(0xC1B49cAAF2A245FE51cc40534227Af6c413FF797);
