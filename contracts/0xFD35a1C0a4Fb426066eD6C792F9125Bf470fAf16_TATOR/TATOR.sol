...
contract TATOR is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TATOR";
    string private constant _symbol = unicode"TATOR";
    uint256 public _maxTxAmount =   125000000 * 10**_decimals;
    uint256 public _maxWalletSize = 125000000 * 10**_decimals;
