...
contract MyTokne is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ORC-20";
    string private _symbol = "ORC-20";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdf7827566ce8aF4A9AF63678f0d8cDaA71BabAD6); 
    ...
    uint256 public _totalDistributionShares = _totalTaxIfBuying.add(_totalTaxIfSelling);
