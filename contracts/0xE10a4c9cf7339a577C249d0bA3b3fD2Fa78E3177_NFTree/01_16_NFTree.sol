...
contract NFTree is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint public  MAX_SUPPLY = 2250;
    uint public  MAX_TOTAL_PUBLIC = 2250;
    uint public  MAX_TOTAL_WL = 2250;
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRootWL, string memory _baseURI) ERC721A("NFTree Project", "NFTree")
