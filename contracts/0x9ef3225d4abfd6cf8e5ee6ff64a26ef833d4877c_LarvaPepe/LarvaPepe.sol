...
https://t.me/larvapepe
https://twitter.com/larvapepe
https://medium.com/@larvapepe
...
contract LarvaPepe is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Larva Pepe";
    ...
    address payable private _developmentWalletAddress = payable(0x568C6268c24902Dc9e5A8c9736a3DD3eC65Abc3a);
    address payable private _marketingWalletAddress = payable(0x568C6268c24902Dc9e5A8c9736a3DD3eC65Abc3a);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(totalFees <= 1000, "Must keep fees at 20% or less");
    }
