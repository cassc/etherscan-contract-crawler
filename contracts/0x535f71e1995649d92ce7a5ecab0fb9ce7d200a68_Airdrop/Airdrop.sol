...
contract Airdrop {
    ...
    uint256 public constant AMOUNT_AIRDROP = 10344.8275862 ether; // 15M for 1450 accounts
    ...
    function claim(bytes32[] calldata merkleProof) public {
        ...
        emit Claim(msg.sender, AMOUNT_AIRDROP);

        IERC20(token).transfer(msg.sender, AMOUNT_AIRDROP);
    }
