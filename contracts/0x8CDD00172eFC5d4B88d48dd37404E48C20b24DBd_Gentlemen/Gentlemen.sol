...
Web: https://gentlementoken.com/
Tw: https://twitter.com/gentlementoken
*/
...
contract Gentlemen is ERC20, Ownable {
    ...
    /* Naming */
    string private _name = "Gentlemen";
    ...
    /* Cex listing wallet - hold 5,6 % token */
    address private cexListingWallet;

    /* marketing wallet - hold 4,4 % token */
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        uint256 totalSupply = 56000000000 * 10**decimals();
        ...
        cexListingWallet = address(0x97952Bf8B229F71aD61CC46E77f3990A7a8eCaE0);
        marketingWallet = address(0xd3F6A212c6EE72381C9FdDced81B19b1CcD9C88c);
        ...
        _mint(cexListingWallet, totalSupply.mul(56).div(1000));
        _mint(marketingWallet, totalSupply.mul(44).div(1000));
    }
