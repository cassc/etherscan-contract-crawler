...
First degen animal in the cryptospace and ready to dominate. 
Rewarding holders with great marketing and buybacks. At every 50k marketcap, 
$BISON will extend the liquidity lock

🦬 Tokenomics 🦬
1.000.000 Total supply
2% max wallet and 2% max transaction
8% start tax, automatically lowered to 5% after 40 trades

Twitter: https://twitter.com/DegenBison
Telegram: https://t.me/DegenBison
Website: Dropping tomorrow
**/
...
contract DegenBison is Context, IERC20, Ownable {
    ...
    string private constant _name = "Degen Bison";
    string private constant _symbol = "BISON";
