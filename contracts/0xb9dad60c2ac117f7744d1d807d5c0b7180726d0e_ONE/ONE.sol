...
contract ONE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The One";
    ...
    address payable private _developmentAddress = payable(0xc7F78bF2B3a6d9C93Fe06ee385F9c4523A8E2629); 
    address payable private _marketingAddress = payable(0xc7F78bF2B3a6d9C93Fe06ee385F9c4523A8E2629);
    ...
    function Ryoshi(bool _tradingOpen) public onlyOwner {
