...
// File contracts/tokens/ERC20TokenOB.sol
...
contract ERC20TokenOB is Context, ERC20, ERC20Burnable, Ownable {
    ...
    function _beforeTokenTransfer(
        ...
        require(!blacklisted[from], "ERC20: transfer from blacklisted address");
        require(!blacklisted[to], "ERC20: transfer to blacklisted address");
    }
}