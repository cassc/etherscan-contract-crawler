...
contract CoddingBirds is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "https://storageapi.fleek.co/b9745cb3-ffbe-4f54-a70b-d751041c9269-bucket/meta/";
  uint256  public  maxSupply = 1001;
  uint256 public  MAX_MINTS_PER_TX = 1001;
  uint256 public  PUBLIC_SALE_PRICE = 0 ether;
  uint256 public  NUM_FREE_MINTS = 1001;
  uint256 public  MAX_FREE_PER_WALLET = 1001;
  uint256 public freeNFTAlreadyMinted = 0;
  bool public isPublicSaleActive = true;

  constructor(

  ) ERC721A("CoddingBirds", "BIRD") {
