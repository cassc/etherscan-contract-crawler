...
contract AmphitheatrumFlavium is ERC20, Ownable {
    ...
    constructor () ERC20("Amphitheatrum Flavium", "Amphitheatrum Flavium") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xEe0013f44BAfa3a983b185BE4F9d568c49d7BF1E;
    ...
    function updateFees(uint256 _marketingFeeOnSell, uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnTransfer) external onlyOwner {
        ...
        require(marketingFeeOnBuy <= 7, "Total Fees cannot exceed the maximum");
        require(marketingFeeOnSell <= 7, "Total Fees cannot exceed the maximum");
        require(marketingFeeOnTransfer <= 7, "Total Fees cannot exceed the maximum");
