...
contract DigiDragon is ERC721A, Ownable {
    ...
    string public baseURI="ipfs://QmY6ysAsoBsdU8Qv6jwQYCEP2az8EVwhWm77F8yBpbbsTo/";

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("Digi Dragon", "DD") {
        _safeMint(msg.sender, 10);
    }

    function mint(uint256 quantity) external payable {
        uint256 cost = price;
        uint256 num = quantity;
