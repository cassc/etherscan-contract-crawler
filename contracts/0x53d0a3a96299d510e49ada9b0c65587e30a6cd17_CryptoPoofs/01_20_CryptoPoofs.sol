 ...
 * @notice This contract handles minting CryptoPoofs tokens.
 */
contract CryptoPoofs is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x5Ae722fE860d46A8Bf5af335FA9b387d4117d188;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x5Ef086335E0a5466dC7773a90a8BF565ce6061F0;
    address[] public payoutAddresses = [
        0x77Da0be065Af18947DdD23DA01D2695159368320,
        0x8C31365CF7238B706700c3655CDf5847aDE91D6e
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeihlzr2zar2flkkkf7rogqn6z6mwscba4lfmtfkchoehwpyaojwmwe/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 6626;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 626;
    // Fee paid to HeyMint per NFT minted
    uint256 public heymintFeePerToken;
    uint256 public presaleMintsAllowedPerAddress = 10;
    uint256 public presaleMintsAllowedPerTransaction = 6626;
    uint256 public presalePrice = 0.06626 ether;
    uint256 public publicMintsAllowedPerAddress = 10;
    uint256 public publicMintsAllowedPerTransaction = 6626;
    uint256 public publicPrice = 0.06626 ether;
