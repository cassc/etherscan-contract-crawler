...
Telegram: https://t.me/tengagcoin
...
contract TENGAG is Context, IERC20, Ownable {
    ...
    uint256 public _tokensBuyFee = 4;
    ...
    string private constant _name = "10GAG";
    string private constant _symbol = "10GAG";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xF25100734D1738AC07Ba88f54F72484c852f8F2B);
    ...
    function updateBuyFee(uint256 _fee) external onlyOwner {
        require(_fee <= 4, 'fee can not set more than 10%');
        _tokensBuyFee = _fee;
    }

    function updateSellFee(uint256 _fee) external onlyOwner {
        require(_fee <= 10, 'fee can not set more than 15%');
        _tokensSellFee = _fee;
    }
