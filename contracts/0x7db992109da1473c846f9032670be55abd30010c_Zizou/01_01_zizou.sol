...
contract Zizou is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Zinedine Zidane";
    string private constant _symbol = unicode"Zizou";
