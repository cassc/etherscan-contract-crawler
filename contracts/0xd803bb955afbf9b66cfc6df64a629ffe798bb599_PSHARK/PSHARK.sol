...
contract PSHARK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"PolyShark: Crypto Wallet and Gateway", "PSHARK") {

        address _owner = 0xA776aBea31a0374C01C12eaeB2AC7598950875C3;
        ...
        marketingWallet = address(0xA776aBea31a0374C01C12eaeB2AC7598950875C3); // set as marketing wallet
        devWallet = address(0xA776aBea31a0374C01C12eaeB2AC7598950875C3); // set as dev wallet
        buyBackWallet = address(0xA776aBea31a0374C01C12eaeB2AC7598950875C3); // set as buyBackWallet
    ...
    function resetTaxAmount() public onlyOwner {
        tokensForLiquidity = 1;
        tokensForMarketing = 4;
        tokensForDev = 0;
        tokensForBuyBack = 0;
    }
