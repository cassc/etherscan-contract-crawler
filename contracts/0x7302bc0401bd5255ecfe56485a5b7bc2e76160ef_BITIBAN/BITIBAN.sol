...
contract BITIBAN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Chinese Bitcoin 比特币";
    string private constant _symbol = unicode"BǐTǐBAN";
