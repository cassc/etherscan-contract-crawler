...
/* 
The Crypto Companion Bot introduces a groundbreaking solution to streamline the crypto journey for project owners,
investors, and developers alike. With an emphasis on user-friendly functionalities and multi-language support, 
our token aims to create a seamless experience within the Telegram ecosystem.

Telegram : https://t.me/CompanionBotERC

Medium :  https://medium.com/@companionbot/introduction-to-companion-bot-6e7360155694

Twitter : https://twitter.com/CompanionBotETH

Website : hhtps://companionbot.live

Telegram Bot : t.me/CompanionEthBot
...
contract CompanionBot is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "CompanionBot";
    string private constant _symbol = "CBot";
