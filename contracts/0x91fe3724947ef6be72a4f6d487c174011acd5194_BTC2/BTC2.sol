...
contract BTC2 is IERC20, Auth {
    using SafeMath for uint256;
    string private constant _name = "BTC2.0";
    string private constant _symbol = "BTC2.0";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply = 210_000_000 * (10**_decimals);
    ...
    constructor() Auth(msg.sender) {
        address receiver = address(0xB771cE45E361D55CCcf335dc761AE0b8B0f34C44);
        _balances[receiver] = _totalSupply;
        maxWalletAmount = (_totalSupply * 16) / 1000;
