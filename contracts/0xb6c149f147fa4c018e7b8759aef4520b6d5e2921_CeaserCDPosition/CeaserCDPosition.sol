...
// File contracts/interfaces/IOUSD.sol
...
// File contracts/CeaserVaultOUSD.sol
...
contract CeaserVaultOUSD is ERC4626Upgradeable, AccessController, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    CeaserParameterStore internal _paramStore;
    ...
    function setDependencies(address _addressParamStore, address _addressOUSD) external onlyAdmin {
        _paramStore = CeaserParameterStore(_addressParamStore);
...
// File contracts/CeaserCDPosition.sol
...
/// @notice This contract (will be) proxy upgradable
contract CeaserCDPosition is AccessController, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    struct CDP {
    ...
    CeaserVaultOUSD internal _vault;
    CeaserParameterStore internal _parameterStore;
    ...
    function setDependencies(address addressVaultOUSD, address addressParameterStore) external nonReentrant onlyAdmin {
        ...
        _vault = CeaserVaultOUSD(_addressVaultOUSD);
        _parameterStore = CeaserParameterStore(addressParameterStore);
    }
