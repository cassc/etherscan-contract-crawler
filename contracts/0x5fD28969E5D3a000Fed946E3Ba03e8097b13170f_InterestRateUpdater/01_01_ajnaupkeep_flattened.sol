...
contract InterestRateUpdater is AutomationCompatibleInterface {

    IPool public immutable s_poolContract ;

    constructor(address pool){
        s_poolContract = IPool(pool);
    }
    ...
    {
        (, uint256 interestRateUpdate) = s_poolContract.interestRateInfo();
