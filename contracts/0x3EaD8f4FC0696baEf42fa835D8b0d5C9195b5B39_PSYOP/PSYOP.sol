...
`7MMpdMAo. ,pP"Ybd `7M'   `MF',pW"Wq.`7MMpdMAo. 
  MM   `Wb 8I   `"   VA   ,V 6W'   `Wb MM   `Wb 
  MM    M8 `YMMMa.    VA ,V  8M     M8 MM    M8 
  MM   ,AP L.   I8     VVV   YA.   ,A9 MM   ,AP 
  MMbmmd'  M9mmmP'     ,V     `Ybmd9'  MMbmmd'  
  MM                  ,V               MM       
.JMML.             OOb"              .JMML.     
...
contract PSYOP is Context, IERC20 {
    ...
    address public _Owner = 0x095E3a9595f81FFAE19C6CE4a5C6364a2c700Cf6;
