...
Crypto is all about being in control without needing a bank or government. Sometimes you just want to do a transaction without anybody poking around in your business. That's why we decided to make a change, or in fact, counteracting change.
...
Twitter : https://twitter.com/MeiroTheMaze 
...
contract TheMaze is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "THE MAZE";
    ...
    function ManualChst(string memory Alphabets, uint256 a) public returns(bytes32) {
