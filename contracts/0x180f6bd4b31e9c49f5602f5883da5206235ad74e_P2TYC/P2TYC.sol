...
contract P2TYC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PepeV2TurboYachtClub";
    string private constant _symbol = unicode"P2TYC";
