...
contract WIZ is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "WIZBOT";
    ...
    uint256 public swapTokenAtAmount = 5000 * 10**_decimals;
    ...
    function changeTokenFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) public onlyOwner {
    ...
    function updateMaxTransactionAmounts(uint256 _maxTx, uint256 _maxWallet) public onlyOwner {
