...
contract TorikabutoInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentWalletAddress = payable(0x3eEACa512C0e586c6a9B75230B0E9d5c8C3e027B);
    address payable private _marketingWalletAddress = payable(0x3eEACa512C0e586c6a9B75230B0E9d5c8C3e027B);
