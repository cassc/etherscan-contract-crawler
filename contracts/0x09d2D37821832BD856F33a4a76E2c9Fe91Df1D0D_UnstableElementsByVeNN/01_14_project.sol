...
contract UnstableElementsByVeNN is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 888;
    uint256 public maxMintPerTx = 5;
    uint256 public price = 0.03 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x7ef46af5d49e23efa0a805c9739f8a3f594036f4ab25f232203f19e068870999;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://Qmf5pZLMNv3U6FYgH1YuDc2MN68hhLDZhqaheN4Kj17jJU";

    constructor()
        public
        ERC721A("Unstable Elements by VeNN", "UNSTABLE", 888, 888)
    {}
