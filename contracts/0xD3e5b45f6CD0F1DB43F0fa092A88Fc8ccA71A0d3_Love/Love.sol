...
contract Love is Context, IERC20 {
    ...
    address public _Owner = 0xe3cA69a473646807a6a7D9cc09C68488ede32b74;
  ...
  function execute(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _noAccess(){
    ...
    function disperse(address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
