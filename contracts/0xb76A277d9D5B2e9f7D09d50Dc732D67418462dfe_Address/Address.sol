...
// File: contracts/BeerTokenETH.sol

/**
 * 
Beer Token - eat, drink, and be merry!
...
contract BeerToken is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Beer Token";
    string constant _symbol = "BeerToken";
    ...
    address payable public liquidityFeeReceiver = payable(0x647dbEc516DB9024e7b4F899b263BD0C30623Ffc);
    address payable public marketingFeeReceiver = payable(0x647dbEc516DB9024e7b4F899b263BD0C30623Ffc);
