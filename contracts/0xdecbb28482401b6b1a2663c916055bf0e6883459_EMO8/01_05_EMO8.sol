...
//    ⨁ The artist Arseneca will produce, drunkenness, by drinking by substitution                                                                                                                                                               //
//                                                                                                                                                                                                                                               //
//                 ,-.----.    .--.--.       ,---,.       ,--.'|    ,---,.  ,----..     ,---,                                                                                                                                                    //
//            '  .' \      \    /  \  /  /    '.   ,'  .' |   ,--,:  : |  ,'  .' | /   /   \   '  .' \                                                                                                                                           //
//           /  ;    '.    ;   :    \|  :  /`. / ,---.'   |,`--.'`|  ' :,---.'   ||   :     : /  ;    '.                                                                                                                                         //
...
contract EMO8 is ERC721Creator {
    constructor() ERC721Creator("Crypto Drunkenness", "EMO8") {}
}