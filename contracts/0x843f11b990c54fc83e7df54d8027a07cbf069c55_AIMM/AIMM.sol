...
Official Telegram : https://t.me/AiMarketMaker
...
contract AIMM is ERC20, Ownable {
    ...
    bool private _valueDapping = true;
    ...
    constructor() ERC20("AI MARKET MAKER", "AIMM") {
        ...
        marketingWallet = address(0x848063D044c50E3a2171ce046D491833a886AE46);
    ...
    function updateMaxWalletAndMaxTxnAmts(uint256 newTxnNum, uint256 newMaxWalletNum) external onlyOwner {
        require(
    ...
    function excludeFromMaxTransactionAmount(address updAds, bool isEx)
        public
        onlyOwner
    {
