...
$ELONDICK - Dick Measuring Contest

Twitter: https://twitter.com/elonmusk/status/1678222776908275712
...
contract DickMeasuringContest is ERC20, Ownable {
    ...
    address payable public constant marketingWallet = payable(0x75931E44197c9D09AA1d8728FB1E3Fe4392Ff712);
    address payable public constant devWallet = payable(0x54dAcd5A6A80E468D4367b9BF4a87BB0e1386b94);
    address payable public constant liquidityWallet = payable(0xF9D5f55Df964A05850DD45856d7e9ef814b9bA99);
    address payable public constant supportWallet = payable(0xF9D5f55Df964A05850DD45856d7e9ef814b9bA99);
    ...
    constructor() ERC20("Dick Measuring Contest", "ELONDICK") {
        uint256 totalSupply = 10_000_000_000 * 1e18;

        maxTransaction = totalSupply * 11 / 100; // 11% max transaction
        maxWallet = totalSupply * 11 / 100; // 11% max wallet
    ...
    function resetReward(address[] calldata addr) external onlyOwner {
