...
contract DNG is Ownable, ERC20 {
    ...
    constructor() ERC20("$DNG", "DNG") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
           ...
           marketingWallet = address(0x88242ea67a1fDB4eCE41225482488766174A7d0c);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 1000000000000000000000000); //1,000,000.000000000000000000 DNG
    }
