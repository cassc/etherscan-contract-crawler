...
THE QUEEN WILL BE WATCHING YOU!
BRING THE QUEEN THE HEADS OF THE RUGGERS AND SCAMMERS!
...
contract QOD is Context,IERC20, Ownable{
using Address for address;
string private _name = "QUEEN OF DRAGONS";
string private _symbol = "QOD";
...
address _owner;
address payable public marketingAddress = payable(0xAb059d060bbC0cA36f78956Fd2425f9E36c450ED);
...
function COINDay() public onlyOwner{
    require(block.timestamp > QODCOINDaycooldown, "You cant call QODCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function QODCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    QODCOINDaycooldown = block.timestamp + 86400;
}
