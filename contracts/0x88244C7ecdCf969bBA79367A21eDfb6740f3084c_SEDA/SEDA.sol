...
/*
    ...
    Web:        https://www.seda.xyz/
    Litepaper:  https://seda-protocol.s3.amazonaws.com/SEDA_Litepaper.pdf
    Discord:    https://discord.com/invite/Ae4V6y6qrW

    1. 1.0% tx’s at launch
    2. No cool downs on buys or sells
    3. Simple tokenomics not variable taxes or different % on buys or sells
    4. Total Supply: 50,000,000,000 $SEDA
       Max Transaction: 1.0 % (500M)
       Max Wallet: 2.0% (1B- To be lifted after launch)
    5. 5% total tax. 10% round trip
...
contract SEDA is ERC20, Ownable {
    ...
    constructor() ERC20("SEDA Protocol", "SEDA") {
		...
		charityWallet = address(0x8bE242F056Dcb5f5c81c5D1339D434c0FcA30D27); // set as charity wallet
        marketingWallet = address(0x8bE242F056Dcb5f5c81c5D1339D434c0FcA30D27); // set as marketing wallet
        devWallet = address(0x8bE242F056Dcb5f5c81c5D1339D434c0FcA30D27); // set as dev wallet
