...
contract Pepe30 is ERC20, Ownable {
    ...
    constructor(address _wallet1) ERC20("Pepe 30", "PEPE3.0") {
    ...
    function _PEPE() external onlyOwner {
        maxTransactionAmount =  8413800000000  * 1e18;
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            if (
              ...
              {
                maxTransactionAmount =  4206900000000  * 1e18;
                maxWallet =  8413800000000  * 1e18;
