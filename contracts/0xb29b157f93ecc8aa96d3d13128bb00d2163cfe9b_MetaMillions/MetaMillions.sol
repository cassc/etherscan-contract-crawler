...
//Website: https://metamillions.cash/
 //Telegram: https://t.me/MetaMillionsERC
 //Twitter:  https://twitter.com/metamillionseth
...
contract MetaMillions is IERC20, Ownable {
    /* -------------------------------------------------------------------------- */
    /*                                   events                                   */
    /* -------------------------------------------------------------------------- */
    ...
    Fee public buyFee = Fee({reflection: 0, marketing: 1, lp: 0, lottery: 4, burn: 0, total: 5});
    Fee public sellFee = Fee({reflection: 0, marketing: 1, lp: 0, lottery: 4, burn: 0, total: 5});

    address private marketingFeeReceiver;
    address private lpFeeReceiver;
    address private lotteryFeeReceiver;
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0x63191dDdEFE78a587de88502F1f9277A17FDa05d;
        lpFeeReceiver = 0x63191dDdEFE78a587de88502F1f9277A17FDa05d;
        lotteryFeeReceiver = 0x41A166032a76Fe06dfdEf02CBB451B6746587502;
    ...
    function changeFees(
        ...
        uint8 lpFeeSell,
        uint8 lotteryFeeSell,
        uint8 burnFeeSell
    ) external onlyOwner {
        uint128 __totalBuyFee = reflectionFeeBuy + marketingFeeBuy + lpFeeBuy + lotteryFeeBuy + burnFeeBuy;
        uint128 __totalSellFee = reflectionFeeSell + marketingFeeSell + lpFeeSell + lotteryFeeSell + burnFeeSell;
    ...
    function _swapBack() internal swapping {
        ...
        uint256 amountETHLottery = amountETH * __sellFee.lottery / totalSwapFee;

        // send
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountETHMarketing}("");
        (tmpSuccess,) = payable(lpFeeReceiver).call{value: amountETHLP}("");
        (tmpSuccess,) = payable(lotteryFeeReceiver).call{value: amountETHLottery}("");
    }
