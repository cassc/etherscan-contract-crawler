...
The 1.03 code was released 03 Jan 2023
https://medium.com/@hashcash97


https://hashcash.tech/
https://twitter.com/HashCash97
https://t.me/hashcash97

000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f
Mined on
03 jan. 2009 19:15:05
...
contract HashCash is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setBuyTax(10,10); 
        setSellTax(10,10); 
        setTaxWallets(0x8705ac84fee4B6a4AB5D441C7fEA72831aCF5dbD); 
        exclude(msg.sender);
