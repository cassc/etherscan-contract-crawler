...
contract  loveherio is ERC721A, Ownable{
    using Strings for uint256;

    // Supply
    uint256 public constant MaxSupply = 5000;
    uint256 public constant SaleSupply = 4000;
    uint256 public constant TeamSupply = 1000;
    ...
    // Name and symbol
    constructor() ERC721A("loveher.io", "LH"){
    ...
    require(totalSupply() + _quantity <= TeamSupply, "Reached max Supply");
