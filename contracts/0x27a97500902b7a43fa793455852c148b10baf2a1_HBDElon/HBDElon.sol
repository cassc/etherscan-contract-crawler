...
Telegram: https://t.me/HBDElonErc

Twitter: https://twitter.com/HBDElon

Website: http://elonturns52.fyi


52 shades of success

Also join us to find out the 52 reasons why you should invest 

http://elonturns52.fyi/52-reasons-why/
...
contract HBDElon is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 5200000 * 10**18;
    ...
    string private constant _name = "Elon Turns 52";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x7539E4e030ffA88A4052976a5aea69b1E24dAc1d);
