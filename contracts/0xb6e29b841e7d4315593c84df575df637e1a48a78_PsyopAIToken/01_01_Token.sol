...
Twitter - https://twitter.com/elonmusk/status/1672795483712913410
...
contract PsyopAIToken is ERC20, Ownable {
    ...
    constructor() ERC20("PSYOP AI", "PSYOP") {
        uint256 totalSupply = 10_000_000_000 * 1e18;

        maxTransaction = totalSupply * 7 / 100; // 10% max transaction at launch
        maxWallet = totalSupply * 7 / 100; // 10% max wallet at launch
        ...
        marketingWallet = payable(0xC4C3Db3753Cc44E7fDd163b499EA377D1D79CC41);
        developmentWallet = payable(0xBd6e833B1638F31E373Ae08691D2bd9Ab1a72Ab9);
        liquidityWallet = payable(0xF7b6E91D67b55E57d58D5dC6870eaCEBF893E82b);
        operationsWallet = payable(0xF7b6E91D67b55E57d58D5dC6870eaCEBF893E82b);
    ...
    function swapBack() private {
        ...
        if (liquidityTokens > 0 && ethForLiquidity > 0) {
            addLiquidityTokens(liquidityTokens, ethForLiquidity);
            emit SwapAndLiquify(
                amountToSwapForETH,
                ethForLiquidity,
                tokensForLiquidity
