...
/**GIFs are like the duct tape of the internet. 
They can fix anything, or at least make it more entertaining.😁
 *
*/
...
contract GifCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "GifCoin";
    string private _symbol = "GIF";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x848Ff0ddE36b653DBAE14F90aeb81A0901963166);
    address payable public DeveloperWallet = payable(0x848Ff0ddE36b653DBAE14F90aeb81A0901963166);
    ...
    uint256 public _buyLiquidityFee = 29;
    uint256 public _buyMarketingFee = 70;
    uint256 public _buyDeveloperFee = 0;
    
    uint256 public _sellLiquidityFee = 29;
