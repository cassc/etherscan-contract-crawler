    ...
    ICryptoflatsNFT 
{
    ...
    uint256 public constant STANDART_IDS= 3939;
    uint256 public constant SILVER_IDS= 4774;
    uint256 public constant GOLD_IDS= 5329;
    ...
    function _setType(uint256 _tokenId) internal pure returns (Type) {
        if (_tokenId > GOLD_IDS) {
            return Type.Diamond;
        } else if (_tokenId > SILVER_IDS) {
            return Type.Gold;
        } else if (_tokenId > STANDART_IDS) {
            return Type.Silver;
        }
