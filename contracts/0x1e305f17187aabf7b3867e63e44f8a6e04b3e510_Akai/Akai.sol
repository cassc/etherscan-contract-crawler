...
// File: Tokens/AkaiToken/AkaiTokenV2.sol
...
contract Akai is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _tTotal = 1000000000000 * 10**18; // Total Supply
        _maxTxAmount = _tTotal.mul(150).div(10000); // 1.5%
        _maxWalletAmount = _tTotal.mul(150).div(10000); // 1.5%
    ...
    function swapETHForTokens(uint256 amount) private {
        ...
        path[2] = 0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE; // SHIBA Address
