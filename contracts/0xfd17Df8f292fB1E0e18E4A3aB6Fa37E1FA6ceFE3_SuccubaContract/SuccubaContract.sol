...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x521c69C0f5D1DA99f2333bc686a4b71902bEB50C];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x521c69C0f5D1DA99f2333bc686a4b71902bEB50C;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmRaUXxFyBr23dC84uejghFuk3WJWaQNUhSrMuyfqg8mXX/";
...
// File: contracts/SuccubaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SuccubaContract is RamppERC721A {
    constructor() RamppERC721A("Succuba", "Succuba"){}
}
