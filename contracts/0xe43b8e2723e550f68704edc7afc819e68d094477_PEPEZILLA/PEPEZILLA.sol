...
X : https://twitter.com/Pepezilla_ETH
Telegram : https://t.me/PepezillaERC20
...
contract PEPEZILLA is ERC20, Ownable {
    ...
    uint256 public _maxTxLimit = ( _totalSupply * 35 ) / 1000;
    uint256 public _maxSellTxLimit = ( _totalSupply * 35 ) / 1000;
    uint256 public _maxWaltAmt = ( _totalSupply * 35 ) / 1000;
    uint256 private swapThreshold = ( _totalSupply * 45 ) / 10000;
    uint256 private minTokenAmount = ( _totalSupply * 45 ) / 10000;
    ...
    address internal _feeWallet = 0x97F26847C5a3b8C5dE6703A133a60150Fb3f0926;
