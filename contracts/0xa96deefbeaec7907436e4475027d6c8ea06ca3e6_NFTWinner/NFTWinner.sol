...
// File contracts/mocks/NFTWinner.sol

// ERC721A Contracts v4.2.2

contract NFTWinner is ERC721A, ERC721ABurnable, ERC721AQueryable, Ownable {
    constructor() ERC721A('NFT_Winner', 'WIN') {}


    mapping(uint256 => uint256) public values;
    mapping(uint256 => uint256) public prices;

    event MintReward(address winnerAddress, uint256 quantity, uint256 value, uint256 price);
    ...
    function mintReward(address winnerAddress, uint256 quantity, uint256 value, uint256 price) public onlyOwner {
        require(winnerAddress != address(0), "INVALID NFT BETTING ADDRESS.");
        ...
        _mint(winnerAddress, quantity);
        emit MintReward(winnerAddress, quantity, value, price);
    }
