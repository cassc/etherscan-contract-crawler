...
/// @title Bonkler Auction Pooler
/// @notice Mints refundable DAO shares equal to ETH pooled. DAO can use this ETH to make Bonkler NFT bids.
/// The user at all times can take their ETH back. If bid succeeds, their ETH will go to DAO.
/// With their shares, users will decide together how to use their Bonkler NFTs, as well,
/// how to win future bids.
contract BonklerAuctionPooler is Multicallable {
    ...
    address internal constant DAO = 0xeef7D95b37Cd76Aa1A38a720ff2BA45DCc4D2445;
