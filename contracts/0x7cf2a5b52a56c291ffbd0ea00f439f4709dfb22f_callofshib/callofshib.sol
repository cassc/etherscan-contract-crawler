...
contract callofshib is Ownable, ERC20 {
    ...
    string constant _name = "Call Of Shib";
    ...
    function enableTradingCallofshib(bool _open, uint256 _buyMultiplier, uint256 _sellMultiplier, uint256 _transferMultiplier) public onlyOwner {
        TradingOpen = _open;
