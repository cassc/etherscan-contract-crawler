...
Are you afraid of the dark? We start as a clown club continue to clown city and then the clown world..

100,000,000 $CYCNCB
NO TAX

TG: https://t.me/CreppyClownClub
TW: https://twitter.com/CreppyClownClub
WEB: https://creepyclownclub.space
...
contract CreppyClownClub {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Creppy Clown Club";   
    string public constant symbol = "CYCNCB";   
    ...
    address payable constant deployer = payable(address(0xe5938cF5e1C7147265B5497CCE3147336Ae1a4bC));
