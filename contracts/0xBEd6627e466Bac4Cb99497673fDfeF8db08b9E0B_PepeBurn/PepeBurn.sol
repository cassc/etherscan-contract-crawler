...
contract PepeBurn is ERC20, Ownable {
    ...
    uint256 public  pepeBurnFeeOnBuy;
    uint256 public  pepeBurnFeeOnSell;
    ...
    constructor () ERC20("PepeBurn", "PEPEBURN") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        _totalFeesOnBuy    = pepeBurnFeeOnBuy  + marketingFeeOnBuy;
        _totalFeesOnSell   = pepeBurnFeeOnSell + marketingFeeOnSell;

        marketingWallet = 0xe8b6E01e9F8A7D69c6dD0a1cF040643C435f6Df3;
    ...
    function updateFees(uint256 _pepeBurnFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _pepeBurnFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        //buy fees
        pepeBurnFeeOnBuy = _pepeBurnFeeOnBuy;
        marketingFeeOnBuy = _marketingFeeOnBuy;
        _totalFeesOnBuy   = pepeBurnFeeOnBuy + marketingFeeOnBuy;
        //sell fees
        pepeBurnFeeOnSell = _pepeBurnFeeOnSell;
        marketingFeeOnSell = _marketingFeeOnSell;
        _totalFeesOnSell   = pepeBurnFeeOnSell + marketingFeeOnSell;

        require(_totalFeesOnBuy + _totalFeesOnSell <= 45, "Total Fees cannot exceed the maximum");
        require(_totalFeesOnBuy + _totalFeesOnSell <= 45, "Total Fees cannot exceed the maximum");
        emit UpdateBuyFees(pepeBurnFeeOnBuy, marketingFeeOnBuy);
        emit UpdateSellFees(pepeBurnFeeOnSell, marketingFeeOnSell);
    }
    ...
    function swapAndSendETH(uint256 tokenAmount) private {
        ...
        uint256 pepeBalance = newBalance - marketingBalance;
        ...
        if (pepeBalance > 0){
            ...
            pathTwo[1] = address(0x6982508145454Ce325dDbE47a25d4ec3d2311933);

            uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: pepeBalance}( 
                0,
                pathTwo,
                address(0xdead),
                block.timestamp + 300
