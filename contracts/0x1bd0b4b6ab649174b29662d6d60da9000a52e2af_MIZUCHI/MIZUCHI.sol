...
contract MIZUCHI is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xa3c8Ba1eb4863f830aC51FB8E2a947166e53E5Ec));

    string private _name = "MIZUCHI HIVE";
    string private _symbol = "MZI";
