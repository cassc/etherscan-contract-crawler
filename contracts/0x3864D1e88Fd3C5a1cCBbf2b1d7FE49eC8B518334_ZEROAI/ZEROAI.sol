...
/*    
    ...
    Big tech has taken control of the simulation. They own your online identity,
    surveil your every move and make trillions off of your data. 
...
contract ZEROAI is ERC20, Ownable {
    ...
    constructor() ERC20("Zero AI", "ZAI") {
        ...
        maxBuyAmount = totalSupply * 1 / 100; // 2% maxBuyAmount
        ...
        marketingWallet = address(0x413d2bF9C7b4b90bD3754F4CCa25Ca819ae2D6E2);
        developmentWallet = address(0x413d2bF9C7b4b90bD3754F4CCa25Ca819ae2D6E2);
    ...
    function beginTrans() external onlyOwner {
        isTrading = true;
        swapEnabled = true;
