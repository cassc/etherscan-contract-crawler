...
contract JEETFIGHTER is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "JEETFIGHTER";
    string private constant tokenSymbol = "JEETFIGHTER";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xE9Bc0e190db224Ce9795c07641070779618c371f);
        devAddress = payable(0xE9Bc0e190db224Ce9795c07641070779618c371f);
