...
contract RyoshiTreasury is Ownable {
    ...
    // The main community treasury (receiving and distribution of funds)
    receive() external payable {
        emit Deposited(msg.sender, msg.value);
    }

    // Withdraw ETH to an address
    ...
    // Withdraw ERC20 tokens from the treasury
    function withdrawERC20(address _token, address _to, uint256 _amount) external onlyOwner {
        require(IERC20(_token).balanceOf(address(this)) >= _amount, "Not enough token balance");
