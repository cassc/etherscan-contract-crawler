...
// File contracts/interfaces/ITheWokeToken.sol


pragma solidity 0.8.17;


interface ITheWokeToken {
    /**
...
// File contracts/BaseTheWokeToken.sol
...
abstract contract BaseTheWokeToken is
    ITheWokeToken,
    IFeeToken,
    EmergencyGuard,
    AccessControlEnumerable,
...
// File contracts/TheWokeToken.sol
...
/**
 * @title The Woke ERC20 token
 */
contract TheWokeToken is BaseTheWokeToken, ERC20Capped, ERC20Burnable {
    constructor(
        address addressTotalSupply
    )
        ERC20("The Woke", "LGBTQIA+")
    ...
    function transferFromNoFees(
        ...
        require(
            ...
            "The Woke: Can only be called by Dynamic Fee Manager"
        );
    ...
    function _preValidateTransfer(address from) private view {
        ...
        require(
            ...
            "The Woke: transactions are paused"
        );
    }
}