...
contract BionicClassic is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bionic Classic"; 
    string private constant _symbol = "BCLAS";
    ...
    Tax public sellTax = Tax(20,1);
    
    address public marketingWallet = 0xDC67B12fBfC6817ccB0D405944668B9d4177cc25;
