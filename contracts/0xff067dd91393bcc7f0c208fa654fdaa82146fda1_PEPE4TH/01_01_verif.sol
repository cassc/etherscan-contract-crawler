...
contract PEPE4TH is ERC20, Ownable {
    ...
    constructor() payable ERC20("Pepe 4th", "PP4") {
        ...
        projectWallet = address(0xE0040EfD08261A5cba521f88BAe9b54dF352DF46);
        ...
        _createInitialSupply(devWallet, totalSupply);
    ...
    function updateSwapTokensAtAmount(uint256 _swapAmt, bool _swapEnabled) external onlyOwner {
        swapTokensAtAmount = _swapAmt;
