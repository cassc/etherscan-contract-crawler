...
contract SkullWizardsTheBattleforMagic is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public immutable MAX_SUPPLY = 650;
    uint16 public immutable MAX_PER_TX = 5;
    uint256 public PRICE = 0.002 ether;
    bool public IS_SALE_ACTIVE = false;
    string _URI = "https://gateway.pinata.cloud/ipfs/QmRZNxZtU4uaGRxrxyuTvry43LQMq7Q141iLfqThSpxZps/";
