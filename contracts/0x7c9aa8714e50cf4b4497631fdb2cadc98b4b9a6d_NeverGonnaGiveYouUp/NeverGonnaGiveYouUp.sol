...
contract NeverGonnaGiveYouUp is ERC20, Ownable {
    ...
    constructor() ERC20("NeverGonnaGiveYouUpNeverGonnaLetYouDownNeverGonnaRunAroundAndDesertYouNeverGonnaMakeYouCryNeverGonnaSayGoodbyeNeverGonnaTellALieAndHurtYou", "RICKROLL") {
        ...
        maxWallet = 15_000_000_000 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0xA45f99ecbe1dc1786D88a046220EFD3D6558C579); // set as dev wallet
        MarketingWallet = address(0xA45f99ecbe1dc1786D88a046220EFD3D6558C579); // set as mkt wallet
