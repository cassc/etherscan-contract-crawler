...
/**
 * @title MemelympusStaking
 * @dev This contract implements simplified Olympus-style staking.
 */
contract Staking {
    ...
    constructor() {
        owner = msg.sender;
        stakingToken = IERC20(address(0x5278Ac4DdcB9CB9F7AD3aD677BC2A04bBc2A5271));
    }
