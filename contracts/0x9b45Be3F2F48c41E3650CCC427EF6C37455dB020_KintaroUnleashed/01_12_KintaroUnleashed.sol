...
contract KintaroUnleashed is ERC721, Pausable, Ownable, IERC721Receiver {
    ...
    constructor(IERC721 _tokenv1, string memory baseURI) ERC721("Kintaro Unleashed", "DW3-K") {
    ...
    function dark(uint256 _tokenId) external whenNotPaused {
    ...
    function light(uint256 _tokenId) external whenNotPaused {
        MintDetails storage _mintDetails = mintDetails;
        require(_mintDetails.tokenv1.balanceOf(msg.sender) > 0, "Not a holder");
