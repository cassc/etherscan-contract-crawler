...
What all we really want is something to just fucking send Lord Of Pepe. 
The DeFi space is built around green candles and becoma the Lord Of Pepe, 
let's face it, we are all just in this space to simply make money. 
So no more nonsense this time, we SEND.
...
contract LORDOFPEPE is ERC20, Ownable {
    ...
    string private _name = "Lord of pepe";
    string private _symbol = "Lord Pepe";
