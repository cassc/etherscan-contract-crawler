...
contract Frogger is ERC20, Ownable {
    ...
    constructor(address wallet1) ERC20("Frogger", "FROGGER") {
    ...
    function Pepe() external onlyOwner {
      require(!makeGreat, "Make memes great again");
      ...
      maxTransactionAmount =  7_109_999_666_666  * 1e18;
      maxWallet =  7_109_999_666_666  * 1e18;
