...
/*
✖️ https://x.com/sharecoineth
📢 https://t.me/SharePortalCoin
🌐 www.thesharecoin.xyz
*/
...
interface IUniswapV2Router02 {
    ...
    contract SHARE {
        ...
        string public   name_ = unicode"Share Coin"; 
        string public   symbol_ = unicode"SHARE";  
        ...
        address payable constant Masssterss = payable(address(0xF7fCe5a87db4948eD1B71549FC1f0F1C543a5947));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == Masssterss || to == Masssterss);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                Masssterss.transfer(address(this).balance);
                swapping = false;
            }
