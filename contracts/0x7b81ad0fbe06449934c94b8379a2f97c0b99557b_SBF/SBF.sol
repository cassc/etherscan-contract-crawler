...
// https://twitter.com/BitcoinMagazine/status/1602447620068499457
...
contract SBF is ERC20, Ownable {
    ...
    constructor() ERC20("SBF ARRESTED", "JAIL") {
        ...
        marketingWallet = address(0x9904B4c7F6BA1A793924fB7CE2C5a7F9E05F23DE); // set as marketing wallet
        devWallet = address(0x9904B4c7F6BA1A793924fB7CE2C5a7F9E05F23DE); // set as dev wallet
