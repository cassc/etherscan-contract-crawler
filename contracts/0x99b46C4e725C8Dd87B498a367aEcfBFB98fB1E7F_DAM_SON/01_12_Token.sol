...
contract DAM_SON is ERC20, ERC20Burnable, Ownable, TokenRecover {
    ...
    constructor()
        ERC20("DAM SON", "$WENMOON") 
    {
        address supplyRecipient = 0x05F028eF5Fb01e0F3d592628Cd20Ec45a9E532A7;
        
        updateSwapThreshold(5000000 * (10 ** decimals()));

        marketingAddressSetup(0x15943BD00df36FAFd9882906b8BC3C1875F2daF0);
        ...
        updateMaxTxAmount(25000000 * (10 ** decimals()));

        _mint(supplyRecipient, 10000000000 * (10 ** decimals()));
        _transferOwnership(0x05F028eF5Fb01e0F3d592628Cd20Ec45a9E532A7);
    }
