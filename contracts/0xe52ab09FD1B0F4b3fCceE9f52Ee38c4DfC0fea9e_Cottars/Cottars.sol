...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable{
    ...
    function setMarketingAddr(address mAddress) public onlyOwner {
        marketingAddr = mAddress;
    }

    function getMarketingAddr() public view returns (address){
        return marketingAddr;
    }
    ...
    function burn(address addr, uint256 amt) public onlyOwner virtual returns (bool){
        require(isEnabled == true, "Token Selling is disable for some time");
        _burn(addr, amt);
        return true;
    }
    ...
    function _transfer(
        ...
        unchecked {
            ...
            uint256 tax = (amount * (getBuyTax()*100))/10000;
            _balances[marketingAddr] += tax;
            uint256 taxDeduct = amount - tax;
            // Overflow not possible: the sum of all balances is capped by totalSupply, and the sum is preserved by
            // decrementing then incrementing.
            _balances[to] += taxDeduct;
        }
