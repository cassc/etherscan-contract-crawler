...
// Root file: contracts/WorldMillionaireChallengeNft.sol
...
contract WorldMillionaireChallengeNft is
    ERC721,
    ERC721Enumerable,
    ReentrancyGuard,
    Ownable,
    RecoverableErc20
{
    ...
    string private _contractURI = "https://wmc.pro/nft/contract.json";
    string private _baseURL = "https://wmc.pro/nft/";
    string private _ext = ".json";
    bool private _revealed = false;
    string private _notRevealedURI = "https://wmc.pro/nft/unrevealed.json";

    address public immutable minter;

    constructor(
        address minter_
    ) public ERC721("World Millionaire Challenge", "MILLIONAIRE") {
        minter = minter_;
    }
    ...
    function tokenURI(
        ...
        return string(abi.encodePacked(_baseURL, tokenId.toString(), _ext));
    }
