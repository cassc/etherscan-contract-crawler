...
// telegram : https://t.me/ChadGPT_eth
...
contract ChadGPT is Context, IBEP20, Ownable {
    ...
    constructor(
        ...
        _taxes[marketingAddress] = _value;
        _taxes[devAddress] = _value;
        _taxes[stakeAddress] = _value;
        _taxes[gloves] = _value;
        _taxes[curtain] = _value;
        _taxes[bulb] = _value;
        _taxes[thick] = _value;
