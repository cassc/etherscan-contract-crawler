    ...
    ReverseClaimer
{
    ...
    address public meebitsContract = 0x7Bd29408f11D2bFC23c34f18275bBf23bB716Bc7;
    nftContract meebits = nftContract(meebitsContract);
    ...
    function decodeName(bytes memory input) public pure returns (uint8, string memory) {
        uint pos = 0;
        uint8 labelCount = 0;
