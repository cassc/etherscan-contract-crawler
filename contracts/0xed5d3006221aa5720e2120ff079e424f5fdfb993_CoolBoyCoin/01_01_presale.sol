/*
    ...
    Website: https://www.coolboycoin.com/
...
contract CoolBoyCoin is Context , IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"CoolBoy Coin";
    string private constant _symbol = unicode"CBoy";

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address payable private _marketingWallet = payable(0xc220b913344Af080AA35690dcD5B86B6f8fbfAD2);
    ...
    function excludedFromFee(address _address, bool _bool) external onlyOwner {
