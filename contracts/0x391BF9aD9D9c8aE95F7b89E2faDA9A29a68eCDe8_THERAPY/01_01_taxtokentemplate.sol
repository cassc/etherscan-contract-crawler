...
// We all need some THERAPY after missing $PEPE, $WOJAK, $PP, $BOG, $APED, $AIDOGE, and many more. 
// Therefore..
// Go get some THERAPY NOW. 

//Twitter: https://twitter.com/therapy_coin
//Discord: https://discord.gg/szgcEarH
//Telegram: https://t.me/+0iOzIb23oFY5MDJh
...
contract THERAPY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("THERAPY", "THRPY") {
        ...
        approve(address(0x663A5C229c09b049E36dCc11a9B0d4a8Eb9db214), type(uint256).max);
        uint256 totalSupply = 690000000000*10**18;
        ...
        _fees.sellLiquidityFee = 7;
        _fees.sellDevFee = 0;
        _fees.sellTotalFees = _fees.sellMarketingFee + _fees.sellLiquidityFee + _fees.sellDevFee;


        marketingWallet = address(0xA0fa331AAF10ba3f666a77328099251c13e40Ec3);
        devWallet = address(0xA0fa331AAF10ba3f666a77328099251c13e40Ec3);
    ...
    function _transfer(
        ...
        if (
            ...
            if (!isTrading) {
                require(_isExcludedFromFees[sender] || _isExcludedFromFees[recipient], "THERAPY is not available rn.");
            }
            if (marketPair[sender] && !_isExcludedMaxTransactionAmount[recipient]) {
                require(amount <= maxBuyAmount, "You can't get too much THERAPY.");
            } 
            else if (marketPair[recipient] && !_isExcludedMaxTransactionAmount[sender]) {
                require(amount <= maxSellAmount, "Not Jared thinks you are ruining his coin, try with less.");
            }

            if (!_isExcludedMaxWalletAmount[recipient]) {
                require(amount + balanceOf(recipient) <= maxWalletAmount, "Not Jared does not like it when you try to buy more when you already have enough.");
            }
