...
What is it like to be a highborn person?
One who lives their life in luxury
And is part of the elite?

They do not have to live paycheck to paycheck
And can borrow money
To fund their extravagant lifestyle?

We in the pits of crypto, have to live with scraps
That are leftover for us
The blowup of 3AC
Whose founders are now on the run
They can take all of our money and do whatever they want
It must be nice to be highborn

Why do we continue to play this god awful game?
When all we know is misery and despair?

Is it because we have a glimmer of hope
That crypto can help pull us out of this shithole?
That one day, we may join the ranks of those above us
Be a part of the elite
The ruling class?

Or is it that we play so that we can numb out the pain
Of having to wake up another day, 
In this unfair world?

There are many things we should think about in our lives
But know this
One day, we can all make it
If we stick together, we can rise up against the establishment

This token will be renounced
Has low taxes
And can hopefully help you on your way

Good luck my friends, 
One day, I hope to see you on the moon!
...
contract lowborn is ERC20, Ownable {
    ...
    constructor() ERC20("LowBorn", "LowBorn") {
        
        IDexRouter _dexRouter = IDexRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        dexRouter = _dexRouter;

        operationsAddress = address(0x89c7E46F32438e2F8f108db2f47277939DfA1108); 
        ...
        uint256 totalSupply = 3 * 1e7 * 1e18;
        
        maxBuyAmount = totalSupply * 40 / 10000;
        maxSellAmount = totalSupply * 40 / 10000;
        maxWalletAmount = totalSupply * 30 / 1000;
        swapTokensAtAmount = totalSupply * 40 / 100000;
