...
contract Marya is ERC20, Ownable { // 
    using SafeMath for uint256;
    ...
    constructor() ERC20("Marya Sea Protector", "MARYA") { // 
        marketingWallet = payable(0x1afDca06a55a53a4ACF9940146b405f150f196A2); // 
        devWallet = payable(0x79bb646AAAf34fF3f74937EAB4B99F5Dd0CC8075); // 
