...
contract Twenty23ByRyanReyes is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;
  string  public  baseTokenURI = "ipfs://QmPFNBZ65gNYhtD2SfH1AJirBW8GWM75MZ44u9P2PwHWnP";
  ...
  constructor() ERC721A("Twenty23 By RyanReyes", "TW23") {
  ...
  function OwnerMint(uint numberOfTokens, address user)
    public
    onlyOwner
  {
    require(
