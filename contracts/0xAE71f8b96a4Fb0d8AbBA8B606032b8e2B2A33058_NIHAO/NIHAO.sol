...
/// @custom:security-contact NIHAO.BIO
contract NIHAO is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit {
    constructor() ERC20("NI HAO", "NIHAO") ERC20Permit("NI HAO") {
