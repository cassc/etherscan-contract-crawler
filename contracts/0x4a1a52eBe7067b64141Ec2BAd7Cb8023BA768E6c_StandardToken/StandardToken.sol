...
/*
    Find out Richie rich's story here: https://richierich.cash/
    Telegram: https://t.me/RichieRichERC20
    Twitter: https://twitter.com/RichieRichERC20
*/
...
contract StandardToken is Ownable, ERC20 {
    ...
    constructor(uint256 _totalSupply) ERC20("Richie Rich", "RICH") {
    ...
    function _beforeTokenTransfer(
        ...
        if(block.timestamp <= launchedTime + 6 minutes)  {
