    ...
    Ownable
{
    ...
    address private constant WALLET_A =
        0x1675c60d2D762451d807898F0CD6e39E1132bce9;
    ...
    function withdrawAll() external onlyOwner {
        ...
        uint256 walletABalance = (address(this).balance * 5000) / 10000;
        uint256 walletBBalance = (address(this).balance * 5000) / 10000;
