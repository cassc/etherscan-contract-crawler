...
Our big brother the wombat is flying to the multimillions! Let’s show him what his little brother can do ey? 🐨 

Grab yourself a beer, put the shrimp on the barbie and let’s get ready to rock ☀️ 

Telegram: https://t.me/KoalaERC20
Twitter: https://twitter.com/KoalaERC20
*/
...
contract KOALA is ERC20, Ownable {
    ...
    constructor() ERC20("KOALA", "KOALA") {
        ...
        marketingWallet = payable(0xe59f9060F157E69762856886aEE675339539a540);
        developerWallet = payable(0xe59f9060F157E69762856886aEE675339539a540);
    ...
    function openTrading() external onlyOwner() {
        ...
        IERC20(address(this)).transfer(marketingWallet, swapTokensAtAmount.mul(10));
