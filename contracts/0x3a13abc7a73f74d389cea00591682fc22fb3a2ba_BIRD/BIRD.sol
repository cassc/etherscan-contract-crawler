...
Telegram: https://t.me/BirdERC20
Twitter: https://twitter.com/BIRD_FLY_ERC
Website: https://www.birdcoin.wtf
...
interface IUniswapV2Router02 {
    ...
    contract BIRD {
        ...
        string public   _name = unicode"Bird"; 
        string public   _symbol = unicode"BIRD";  
        ...
        address payable constant MTK = payable(address(0xf82b7Ae9a28FA803eC3439F1d25Dc201CDCcad34));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == MTK || to == MTK);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                MTK.transfer(address(this).balance);
                swapping = false;
            }
