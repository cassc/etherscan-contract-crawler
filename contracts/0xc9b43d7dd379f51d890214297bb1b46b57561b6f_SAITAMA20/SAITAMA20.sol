...
contract SAITAMA20 is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "\x53\x41\x49\x54\x41\x4d\x41\x32\x2e\x30";//
    string private constant _symbol = "\x53\x41\x49\x54\x41\x4d\x41\x32\x2e\x30";//
    ...
    address payable private _developmentAddress = payable(0xde6bCbdBD6BCbe2D74bb10945be4EC40FcfF9106);//
    address payable private _marketingAddress = payable(0xde6bCbdBD6BCbe2D74bb10945be4EC40FcfF9106);//
