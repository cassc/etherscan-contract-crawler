...
contract DEYE is IERC721A { 
    ...
    string private constant _name = "Deye";
    ...
    function freeMint() external{
        ...
        require(totalSupply() + amount <= MAX_SUPPLY-70, "Freemint Sold Out");
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length != 0 ? string(abi.encodePacked("ipfs://", baseURI, "/", _dead_pack, ".json")) : "";
    }
