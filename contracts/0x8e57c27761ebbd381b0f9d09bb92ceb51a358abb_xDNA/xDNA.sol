...
contract xDNA is BurnableToken {

    string public constant name = "extraDNA";
    string public constant symbol = "xDNA";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 11000000000 * (10 ** uint256(decimals));
