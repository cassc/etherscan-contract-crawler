...
constructor() ERC20("fOrG", "fOrG") {
        ...
        swapTokensAtAmount = totalSupply * 10 / 10000; // 0.1% swapw 
        ...
        marketingWallet = address(0xAc956852104C444bA997788Aad1d4ae434C93b66); // set as marketing wallet
        devWallet = address(0xAc956852104C444bA997788Aad1d4ae434C93b66); // set as dev wallet
