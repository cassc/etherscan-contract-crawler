...
contract msn is Ownable, ERC20 {
    ...
    constructor() ERC20("MSN", "MSN") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
           ...
           marketingWallet = address(0xEc1f709fD76Bf4EB3a1333B444356639818E2bCF);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 1000000000000000000000000000); //1,000,000,000  $MSN
    }
