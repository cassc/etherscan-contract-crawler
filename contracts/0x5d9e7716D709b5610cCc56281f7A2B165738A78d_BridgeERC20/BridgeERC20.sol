...
// contracts/interfaces/IBridgeERC20.sol
...
contract MinterRole is Ownable {
    ...
    modifier onlyMinter() {
        require(isMinter[msg.sender], "BridgeERC20: FORBIDDEN");
        _;
    }
    ...
    function addMinter(address _minter) public onlyOwner {
        require(_minter != address(0), "BridgeERC20: Minter address can't be zero.");
        isMinter[_minter] = true;
    }

    function removeMinter(address _minter) public onlyOwner {
        require(isMinter[_minter], "BridgeERC20: The address is not minter.");
...
contract BridgeERC20 is ERC20, Ownable, MinterRole {
