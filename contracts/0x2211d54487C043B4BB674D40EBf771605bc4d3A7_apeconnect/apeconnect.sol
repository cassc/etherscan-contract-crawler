...
APE CONNECT is a BSC project whose main utility is a social media platform exclusively dedicated to people in the Decentralized Finance industry.  It will have massive blockchain integration and a built-in swap feature that will allow investors to trade without leaving the app.
...
TWITTER: https://twitter.com/apeconnect_bsc
-----------------------------------------------------------------------------------------------------------------
*/
...
contract apeconnect   is Context, IERC20, Ownable {
    ...
    string private _name = 'Ape Connect   ';
    string private _symbol = 'APECON ';
