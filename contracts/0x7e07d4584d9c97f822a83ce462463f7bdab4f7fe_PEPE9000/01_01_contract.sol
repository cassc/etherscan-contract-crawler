...
Website: https://pepe9000.com/
Twitter: https://twitter.com/Pepe9000Coin
Telegram: https://t.me/pepe9000
...
contract PEPE9000 is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe9000", "OVER9000") {
        ...
        maxTransactionAmount = totalSupply * 45 / 1000; // 2%
        maxWallet = totalSupply * 45 / 1000; //2%
        ...
        operationsWallet = address(0x8C2749F295ec77D7699a79F5569578F6E281d32A); //Operations Wallet = For marketing & partnerships
        devWallet = address(0x8C2749F295ec77D7699a79F5569578F6E281d32A); 
