...
contract ConversionV3 is OwnableUpgradeable,PausableUpgradeable,ReentrancyGuardUpgradeable,Percentage{
    ...
    function _wrapBezoge(uint256 amount_) private{
        ...
        if (circulatingZogi > 0 ){
            zogiAmount = receivedBezoge * circulatingZogi / (initialBezogeBalance + bezoge.balanceOf(address(this)));
        }
