...
// https://t.me/ayahuascaerc
// https://twitter.com/ayahuascaerc
...
interface IERC20 {
     ...
     * that someone may use Triph the old and the new allowance by unfortunate
...
contract aya is ERC20, Ownable {
    ...
    uint256 public buyTripFee;
    uint256 public buyBurnFee;

    uint256 public sellTotalFees;
    uint256 public sellMarketingFee;
    uint256 public sellLiquidityFee;
    uint256 public sellTripFee;
    uint256 public sellBurnFee;

    uint256 public tokensForMarketing;
    uint256 public tokensForLiquidity;
    uint256 public tokensForTrip;
    ...
    constructor() ERC20("Ayahuasca", "AYA") {
        ...
        buyTripFee = 0;
        buyBurnFee = 0;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyTripFee + buyBurnFee;

        sellMarketingFee = 28;
        sellLiquidityFee = 0;
        sellTripFee = 0;
        sellBurnFee = 0;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellTripFee + sellBurnFee;
    ...
    function updateBuyFees(uint256 _MarketingFee, uint256 _liquidityFee, uint256 _TripFee, uint256 _burnFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _MarketingFee, uint256 _liquidityFee, uint256 _TripFee, uint256 _burnFee) external onlyOwner {
        sellMarketingFee = _MarketingFee;
        sellLiquidityFee = _liquidityFee;
        sellTripFee = _TripFee;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee){
            ...
            if(earlyBuyPenaltyInEffect() && automatedMarketMakerPairs[from] && !automatedMarketMakerPairs[to] && buyTotalFees > 0){
                ...
                tokensForTrip += fees * buyTripFee / buyTotalFees;
            ...
            // on sell
                ...
                tokensForTrip += fees * sellTripFee / sellTotalFees;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForTrip;
        ...
        uint256 ethForTrip = ethBalance * tokensForTrip / (totalTokensToSwap - (tokensForLiquidity/2));

        ethForLiquidity -= ethForMarketing + ethForTrip;
        ...
        (success,) = address(TripAddress).call{value: ethForTrip}("");
    ...
    function setTripAddress(address _TripAddress) external onlyOwner {
        require(_TripAddress != address(0), "_TripAddress address cannot be 0");
        TripAddress = payable(_TripAddress);
    }
