 ...
 * @notice This contract handles minting Drakoz tokens.
 */
contract Drakoz is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x23E115d26985A0b9d8915AD1313CC3E477Fa3ECE;
    ...
    address public royaltyAddress = 0x13C16311dCb15DfFd5853dC040081BaEb484aa09;
    address[] public payoutAddresses = [
        0x13C16311dCb15DfFd5853dC040081BaEb484aa09
    ];
    ...
    constructor(address _blocklistContractAddress) ERC721A("Drakoz", "DRKZ") {
