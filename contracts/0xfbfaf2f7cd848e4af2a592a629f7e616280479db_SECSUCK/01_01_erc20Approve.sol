...
contract SECSUCK is Owner, Context, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply = 0;
    uint256 private _maxSupply = 165400000000000000000;

    string private _name = "SEC Lose from Bullrun";
    string private _symbol = "SECSUCK";
