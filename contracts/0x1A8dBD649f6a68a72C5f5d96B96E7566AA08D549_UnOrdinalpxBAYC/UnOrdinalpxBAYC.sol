...
contract UnOrdinalpxBAYC is ERC721A {
    ...
    constructor() ERC721A("UnOrdinal pxBAYC", "BAYC") {
        owner = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmTzgRehu2z9nJ4xFeZ8WWp3REUyHf2nTzAxWnsDHurKDv/", _toString(tokenId), ".json"));
    }
