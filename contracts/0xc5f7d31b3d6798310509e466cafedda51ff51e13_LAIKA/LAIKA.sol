...
// https://twitter.com/Laikacoin_erc

// https://t.me/Laikaofficialtg
...
contract LAIKA is Ownable, ERC20 {
    ...
    string constant _name = "LAIKA COIN";
    string constant _symbol = "LAIKA";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xD26a5C4df0b8CB106c60FF8364a2b6685d2CB46c;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        _maxWalletToken = (_totalSupply * maxWallPercent ) / 1;
