...
/*
LIVE COUNTDOWN TIMER FOR THE ETHEREUM POS MERGE.
...
contract WenMerge is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmV7RGe2Gt67w6vP5p9poWKxmbHjDsYtMo6UffcyoAbfK4";
    ...
    constructor(
    ) ERC721A("Wen Merge?", "WM?", 100, MaxSupply) {
    }
    ...
    function RevealALL(string memory _baseURI) external onlyOwner {
        baseURI = _baseURI;
    }
    ...
    function LIVECOUNTDOWN(uint256 _numfreemints)
        external
        onlyOwner
    {
