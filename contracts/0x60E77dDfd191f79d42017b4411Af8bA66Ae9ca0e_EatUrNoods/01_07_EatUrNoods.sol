// SPDX-License-Identifier: MIT
        ...
        contract EatUrNoods is ERC721A, Ownable, ReentrancyGuard  {
            ...
            uint256 public freeSupplyLimit = 444;
            string HiddenURL;
            bool revealed = false;
            bool paused = true;
        ...
        constructor(string memory _initBaseURI, string memory _initNotRevealedUri) ERC721A("EAT UR NOODS", "NOODS") {
