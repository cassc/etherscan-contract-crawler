 ...
 * @notice This contract handles minting Squares & Triangles tokens.
 */
contract SquaresTriangles is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x4C5BCF9A4E6bb852C16547dF67852Ba96E114B43;
    address public royaltyAddress = 0xB3dDC2A5B4EbDb7640191906Bd4195E23e17142c;
    ...
    string public baseTokenURI =
        "ipfs://bafybeic7al3f6qldzruoyzoicg3jvyz4hmn3ubojlhn2v4gdsxh2vtift4/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 333;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 90;
    ...
    constructor() ERC721A("Squares & Triangles", "S&T") {
