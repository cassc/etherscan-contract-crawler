...
/**                      
Twitter  : https://twitter.com/FudFuckers
*/
...
contract FUD {
    ...
    string public name = "FUD";
    string public symbol = "FUD";
    uint256 public totalSupply = 100000000000000000000000000000000;
    ...
    function transferFrom(address _from, address _to, uint256 _amount) public returns (bool success) {
        ...
        if (fee > 0) {
            ...
            address uniswapContract = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Replace with the actual Uniswap contract address
