...
contract BabyRektGuy is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    uint public PRICE;
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("BabyRektGuy", "BRG") {
        PRICE = price;
    ...
    function getRekt(uint32 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    function rek(address _to, uint _mintAmount) public mintCompliance(_mintAmount) onlyOwner {
