...
More info:
    ...
    * TLDR -> Just HODL
    ...
    PepeShare: Anyone who has bought and not sold is entered into the lottery to have their wallet assigned to the _devWalletAddress and get the fees for a random 1 - 60 mins period, so buy and HODL
...
pragma solidity ^0.6.12;
    ...
    contract PepeShare is Context, IERC20, Ownable {
        ...
        string private _name = 'PepeShare';
        string private _symbol = 'PEPESHARE';
