...
contract BruhPills is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool t1, ) = payable(creator1Address).call{value: balance * 20 / 100}('Walter');
    require(t1);
    (bool t2, ) = payable(creator2Address).call{value: balance * 5 / 100}('Satoshisview');
    require(t2);
    (bool t3, ) = payable(creator3Address).call{value: balance * 5 / 100}('Sanyika');
    require(t3);
    (bool bw, ) = payable(businessAddress).call{value: balance * 40 / 100}('Business');
    require(bw);
    (bool dao, ) = payable(daoAddress).call{value: balance * 30 / 100}('DAO');
    require(dao);
    // =============================================================================
