...
contract GITHUB is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "GITHUB";
    string private constant _symbol = "GITHUB";
    ...
    address payable private _developmentAddress = payable(0x3FE3abb04d208Aa223BD0D4ac1dC5516aae17C34); 
    address payable private _marketingAddress = payable(0x3FE3abb04d208Aa223BD0D4ac1dC5516aae17C34);
