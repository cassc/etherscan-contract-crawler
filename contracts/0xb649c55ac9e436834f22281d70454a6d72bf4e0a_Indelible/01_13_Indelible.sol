// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Left Eye", unicode"Right Eye", unicode"Hat", unicode"Clothes", unicode"Mouth", unicode"Ear", unicode"On Body", unicode"Body", unicode"Background"];
        ...
        uint public constant maxSupply = 6666;
        ...
        ContractData public contractData = ContractData(unicode"Pecasso", unicode"Pecasso proudly present the very first released fine art on-chain, inspired from Picasso arts and iconic meme character PePe.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/1c3240ab-e3c8-4781-85e1-0a09336eb152", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/1c3240ab-e3c8-4781-85e1-0a09336eb152", "", 700, "0xAa578D9009505CBb40668d57ed5A1ddc35f34b8d");

        constructor() ERC721A(unicode"Pecasso", unicode"PECASSO") {
            TIERS[0] = [31,64,65,86,96,296,328,440,450,499,583,605,678,701,857,887];
TIERS[1] = [22,33,52,128,131,199,220,241,245,267,350,465,529,544,576,626,630,671,737];
TIERS[2] = [29,51,63,66,68,99,117,201,201,215,242,260,275,301,320,320,355,400,451,455,527,651,999];
TIERS[3] = [40,45,69,71,89,101,123,200,245,259,261,300,319,345,381,389,396,400,420,426,489,497,801];
TIERS[4] = [29,33,51,379,380,389,390,396,397,401,434,450,470,489,489,489,499,501];
TIERS[5] = [28,33,57,60,66,88,118,221,237,348,360,368,387,388,396,405,413,428,429,438,444,472,482];
TIERS[6] = [99,1678,4889];
TIERS[7] = [25,50,51,289,299,370,370,409,496,499,500,522,532,549,549,577,579];
TIERS[8] = [255,263,274,274,278,281,289,290,290,290,291,291,294,294,299,300,300,300,300,301,301,304,307];
...
192516593828483755313857340433869706973450072701701194101197
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Pecasso #");
