...
contract CookieMonster is ERC20, Ownable {
    ...
    constructor() ERC20("Cookie Monster", "COOKIE") {
        ...
        maxTransactionAmount = 40_000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 40_000 * 1e18; // 2% from total supply maxWallet
        ...
        developmentWallet = address(0x2f94d0ba7cb67cCe3Bb7AAc597B99d7D39948E8d); // set as development wallet
        marketingWallet = address(0x067Cc326a9399141aeeE46fD23E534Cb4dc13295); // set as marketing wallet
        devWallet = address(0xdaDD91C3Ef42df2fd96dDB7dccDd1a0291b0cf84); // set as dev wallet
