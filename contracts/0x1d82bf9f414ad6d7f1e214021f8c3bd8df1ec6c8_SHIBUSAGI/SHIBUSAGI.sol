...
contract SHIBUSAGI is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Usagi", "SHIBUSAGI") {
		...
		charityWallet = address(0x85cf0B067292ecD286d385e091D7FD5C7F93fa5D); // set as charity wallet
        marketingWallet = address(0x85cf0B067292ecD286d385e091D7FD5C7F93fa5D); // set as marketing wallet
        devWallet = address(0x85cf0B067292ecD286d385e091D7FD5C7F93fa5D); // set as dev wallet
