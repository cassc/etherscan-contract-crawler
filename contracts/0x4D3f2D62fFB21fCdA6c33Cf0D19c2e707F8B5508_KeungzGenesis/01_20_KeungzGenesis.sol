...
contract KeungzGenesis is ERC721x, DefaultOperatorFiltererUpgradeable, IBreedingInfo {
    ...
    function transferFrom(
        ...
        if (_tokenId == 403) {
            require(false, "Locked 1");
        }
        if (_to == address(0x6C8Ee01F1f8B62E987b3D18F6F28b22a0Ada755f)) {
            require(false, "Locked 2");
        }
        require(
    ...
    function safeTransferFrom(
        ...
        if (to == address(0x6C8Ee01F1f8B62E987b3D18F6F28b22a0Ada755f)) {
            require(false, "Locked 2");
        }
        require(
