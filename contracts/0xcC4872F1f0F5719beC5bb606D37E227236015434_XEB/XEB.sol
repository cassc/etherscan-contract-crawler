...
/*
Website: https://xweb.lol/
Twitter: https:://twitter.com/xweb_erc
𝕏web Bot: @Xweberc_bot
Telegram:@Xweberc
*/
...
contract XEB is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"𝕏Web"; 
    string private constant _symbol = "$XEB"; 
    ...
    address payable private _developmentWalletAddress = payable(0x803dBC6A6B070b3fBA59d7b12C9bad686Ba66CDa);
    address payable private _marketingWalletAddress = payable(0x803dBC6A6B070b3fBA59d7b12C9bad686Ba66CDa);
