    ...
    ControlledAccess
{
    ...
    // Settings
    uint256 public MAX_ELEMENTS = 3000; // 225 reserved. To be updated later
    uint256 public whitelistStart = 1646348400; // March 3rd 3pm Pacific
    uint256 public publicStart = 1646694000; // March 7th 3pm Pacific
    bool public isPublicLive = false;
    bool public isWhitelistLive = false;
    uint256 public maxWhitelistMintPerTx = 3;
