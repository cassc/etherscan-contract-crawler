...
contract CHOU is Context, IERC20, Ownable {

    using SafeMath for uint256;
 
    string private _name = "Chou coin"; // token name
    string private _symbol = "$CHOU"; // token ticker
    ...
    address public marketingWallet = address(0x95b580899E0a76A3281b543ba722BF4C56089Fd0);
