...
contract GLITCHED is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "GLITCHED P2E";
    string private constant tokenSymbol = "GLITCHED";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 314e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xa63f895e06e835fcC956e1f579eF78DEc55865D1);
        devAddress = payable(0xa63f895e06e835fcC956e1f579eF78DEc55865D1);
