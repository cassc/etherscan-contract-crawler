...
contract BabyTsuka is ERC20, Ownable {
    ...
    address public marketingWallet = 0xea2f90442dDFAc21222506F3221b86422831B291;
    ...
    constructor(address routerAdd) ERC20("BabyTsuka", "BabyTsuka") {
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 1_000, "Cannot set max wallet amount lower than 0.1%");
