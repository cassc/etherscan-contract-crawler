...
contract NonFungibleHeroesComicToken is ERC721A, INonFungibleHeroesComicToken, Ownable, ReentrancyGuard {
    ...
    // ======== Constructor =========
    constructor(string memory baseURI) ERC721A ("NonFungibleHeroesComicToken", "NFHCOMICS") {
        setBaseURI(baseURI);
    }
