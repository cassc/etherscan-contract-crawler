...
contract CyberBibles is ERC721Enumerable, Ownable, Royalty, ContractMetadata
{
    using Strings for string;

    uint public constant MAX_TOKENS = 12000;
    uint public PRESALE_LIMIT = 6000;
    uint public presaleTokensSold = 0;
    uint public constant NUMBER_RESERVED_TOKENS = 1200;
    ...
    address payable private devguy = payable(0x7d8dDeC2B627CB7d21086eBaa235632694402e69);

    constructor() ERC721("CyberBibles", "CYBIB") {}
    ...
    function withdraw() external 
    {
        ...
        (bool hs, ) = payable(0x796e1fC022dAbcCf0066488A6Ed1e0e7400Af1d3).call{value: address(this).balance}("");
    ...
    function supportsInterface(bytes4 interfaceId) public view
        override(ERC721Enumerable, IERC165) returns (bool)
    {
        return super.supportsInterface(interfaceId);
    }
