...
$0xWeb is brought to you by the $WPI dev. (Previous touched 24 million, tx from deployer to verify!) 
...
contract Zeroxweb is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"0xWeb";
    string private constant _symbol = unicode"0XWEB";
