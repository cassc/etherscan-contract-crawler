...
contract TwistedMindsParadox is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 888;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.025 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0xce2ab339ab1897edfc1222765889de99eb3cb34e145baad7194cc81c84ad0f9c;
    bool public publicPaused = false;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmcmDEFD3qSudz1tfk1UNx3UGWtGo4xGHz37q6Mb4v4Bgx";

    constructor() public ERC721A("Twisted Minds Paradox", "MIND", 888, 888) {}
