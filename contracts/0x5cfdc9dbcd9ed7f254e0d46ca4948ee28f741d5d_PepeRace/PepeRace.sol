...
// Telegam : https://t.me/peperaceportal
// Twitter : https://twitter.com/PepeRaceEth
// Website : https://peperace.wtf/homepage/
...
contract PepeRace is ERC20, Ownable {
    ...
    address public marketingWallet =
        address(0x89ca29772B2bD19b26672CEA654F5Ac1597B6Cf5);

    address public devWallet =
        address(0x89ca29772B2bD19b26672CEA654F5Ac1597B6Cf5);

    uint256 _totalSupply = 100_000_000 * 1e18;
    uint256 public maxTransactionAmount = (_totalSupply * 20) / 1000; 
    ...
    constructor() ERC20("Pepe Race", "Pepe Race") {
