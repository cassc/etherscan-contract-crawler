...
/**
// the first contract written solely from ELon tweets 
// 18/18 Tax dropping to 0/0 Tax 
*/
...
contract UELON is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "UNLEASHEDELON"; 
    string private constant _symbol = "UNLEASHEDELON";
    ...
    address payable private _developmentAddress = payable(0x0C588BA2400a1cFDA7930BB9081e100682f6E605); 
    address payable private _marketingAddress = payable(0x04DC69A4cf5F5231D752b373De8c08C17b1f8853);
