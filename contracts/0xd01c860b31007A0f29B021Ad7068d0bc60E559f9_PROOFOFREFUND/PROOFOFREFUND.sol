...
Proof of refund is taking a stance on all of the different meme tokens.

The PROOF OF REFUND is community driven token built on Ethereum network, PROOF OF REFUND is a Meme with a dream. We are trying to build a helpful, useful and fun DeFi ecosystem. Join us and be a part of our community that’s all about positivity, creativity and impact.

Website: https://proofofrefund.com
Telegram: https://t.me/proofrefunderc
Twitter: https://twitter.com/proofrefunderc
...
contract PROOFOFREFUND is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PROOF OF REFUND";
    ...
    uint256 private minimumTokensBeforeSwap = 550 * 10**9; 
