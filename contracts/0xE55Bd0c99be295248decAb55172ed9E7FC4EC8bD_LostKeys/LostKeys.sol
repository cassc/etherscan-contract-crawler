...
contract LostKeys {
    ...
    string public constant name = "Lost Keys";   
    string public constant symbol = "LTKY";   
    ...
    address payable constant deployer = payable(address(0xEE1d52C0d735a858c7632E82C66733206327C510));
