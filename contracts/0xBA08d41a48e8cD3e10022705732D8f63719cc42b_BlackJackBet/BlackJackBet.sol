...
// Twitter : @21blackjack_bet
// Telegram : https://t.me/blackjack21erc
...
contract BlackJackBet is IERC20, Ownable {

    address private WETH;

    string private constant _name = "BlackJackBet";
    string private constant _symbol = "21BJ";
    ...
    uint256 private buyMkt = 2000;
    uint256 private sellMkt = 2000;
    uint256 private buyLP = 2000;
    uint256 private sellLP = 2000;
    uint256 private buyDev = 1000;
    uint256 private sellDev = 1000;
    ...
    address public marketingWallet = payable(0x7B4aE96E76F4522aBa0F5D2e4eCF7aBF0B49AaDB);
    address public devWallet = payable(0x7B4aE96E76F4522aBa0F5D2e4eCF7aBF0B49AaDB);
