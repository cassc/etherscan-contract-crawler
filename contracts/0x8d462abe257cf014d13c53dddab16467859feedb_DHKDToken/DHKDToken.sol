...
contract DHKDContractBase is Ownable {
    constructor() public {
	}
...
contract DHKDToken is Context, ERC20Burnable, ERC20Pausable, DHKDContractBase {
	...
	constructor() public ERC20("Digital Hong Kong Dollar Token", "DHKD"){
