...
contract WallsofStreets is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 666;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x7d794ef9c24d2ed06d008d1485ae9140af7a7552b216a0d5d539853e65452ab1;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmX6ZdqaUwFREiikAVyGeNikKgFWxP9XfzWmHFJrfr7tQi";

    constructor()
        public
        ERC721A("Walls of Streets by SeiKano", "WALL", 666, 666)
    {}
