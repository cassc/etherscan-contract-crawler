...
// File: contracts/Friendlycitizenjoe.sol
...
contract Friendlymonstersclub is ERC721A {
    using Strings for uint256;

    uint public maxSupply = 42000;
    address public owner;

    constructor() ERC721A("Friendly Monsters Club NFT", "FMC") {
        owner = msg.sender;
        _mint(msg.sender, 1);
    }
...
//URI_______________________________________________________________________
    string metadataPrefx = "ipfs://bafybeicktaykmq5hiqjqaaoexkeabr4tzoq7wxva6rt645srqihffozbuq/";
...
//MONEY______________________________________________________________________
    address private MonstersBoss = 0x019A128b8c233c15901f291A5Dc6AAD0124DA9Cb;
    
    
    modifier onlyGang() {
        require (
            msg.sender == MonstersBoss ||
            msg.sender ==  owner ,
            "unauthorized"
        );
        _;
    ...
    function withdraw() public onlyGang {
        ...
        payable(MonstersBoss).transfer(portion);
