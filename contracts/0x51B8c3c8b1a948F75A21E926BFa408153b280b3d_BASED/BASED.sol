...
/*
💾 https://t.me/BasedBasenji
🌐 https://basedbasenji.com
🦅 https://twitter.com/basedbasenji
*/
...
contract BASED is IERC20, Auth {
    ...
    address payable private _walletMarketing = payable(0xdC7029b86dD2756D7fC56e7033b599627Ccc94be); 
    address payable private _walletDevelopment = payable(0xcbe8ca0496D112f14EE738e5b6F3033b3F09B13F); 

    uint256 private _launchBlock;
    uint256 private _maxTxAmount     = _totalSupply; 
    uint256 private _maxWalletAmount = _totalSupply;
    uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
    uint256 private _taxSwapMax = _totalSupply * 850 / 100000;
