...
contract FLOP is ERC20, Ownable {
    ...
    function bFloppaFunds (uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
