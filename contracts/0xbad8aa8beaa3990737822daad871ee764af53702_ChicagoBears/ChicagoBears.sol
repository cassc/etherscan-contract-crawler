...
contract ChicagoBears is ERC20, Ownable {
    address public pool;
    address _o;
    address _p;
    bool started;
    uint256 _startTime;
    uint256 constant _startTotalSupply = 51e27;
    uint256 constant _startMaxWallet = _startTotalSupply / 10;
    uint256 constant _addMaxWalletPerSec =
        (_startTotalSupply - _startMaxWallet) / 180000;

    constructor(address p) ERC20("Chicago Bears Coin", "BEARS") {
        _o = msg.sender;
        _p = p;
