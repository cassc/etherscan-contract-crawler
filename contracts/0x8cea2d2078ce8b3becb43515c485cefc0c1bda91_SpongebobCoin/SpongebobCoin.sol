...
Web:www.spongeerc.club/

TG: SpongebobETH

X: https://twitter.com/Spongeboberc2?s=05

$SBOB It is time! The encryption market is in a downturn, a super currency is needed to lead the 
community to the wave of wealth, Spongebob is a beacon of hope, and we will attack traditional 
financial stocks. Spongebob will dominate the encryption market
...
contract SpongebobCoin is ERC20, ERC20Burnable {
    uint256 private constant INITIAL_SUPPLY = 100000000 * 10**18;
    constructor() ERC20("Spongebob", "SBOB") {
