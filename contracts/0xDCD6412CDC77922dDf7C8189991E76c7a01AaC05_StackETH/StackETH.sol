...
contract StackETH is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Stack ETH";
    string private constant _symbol = unicode"STACK";
