...
Kaizen dojo is A Web 3 community focused on self development through the collaborative curation of educational resources.

$KNDO: 2/2 Tax ERC20 Token

TG: https://t.me/KaizenDojoETH
TW: https://twitter.com/KaizenDojoETH
WEB: https://kaizendojo.site
...
contract KaizenDojo {
    ...
    string public constant name = "Kaizen Dojo";   
    string public constant symbol = "KNDO";   
    ...
    address payable constant deployer = payable(address(0xe089BCF6B5914787D739F538eaB0F115357f6200));
