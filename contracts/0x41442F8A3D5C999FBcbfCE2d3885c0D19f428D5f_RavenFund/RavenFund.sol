...
Dapp (access from website) is made available before token launch and ready to use once you connect your wallet holding $RAVEN tokens!
...
contract RavenFund {
    ...
    address payable constant deployer = payable(address(0xd6524a5407e4B849f82eF06ef05B482Ed0409172));
    ...
    function setRAVEN(uint256 newGet, uint256 newSpend) external {
