...
TG: https://t.me/WET_ASS_PEPE
Twitter: twitter.com/wet_ass_pepe
Website: https://wap-eth.com
...
contract WAP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WET ASS PEPE";
    string private constant _symbol = unicode"WAP";
    ...
    uint256 public _maxTaxSwap=1375000 * 10**_decimals;
