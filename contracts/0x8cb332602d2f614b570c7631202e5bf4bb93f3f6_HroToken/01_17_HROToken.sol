...
contract HroToken is ERC721, ERC721Pausable, ERC721Royalty, Ownable {
    ...
    constructor(string memory baseTokenURI) ERC721("Hro DC", "HroDC") {
        _baseTokenURI = baseTokenURI;
        proxyMinter = _msgSender();
        setDefaultRoyalty(_msgSender(), 1000);
    }

    function setTokenRoyalty(uint256 tokenId, address recipient, uint96 feeNumerator) public onlyOwner {
