...
pragma solidity ^0.6.12;
    ...
    contract RyoshiChain is Context, IERC20, Ownable {
        ...
        string private _name = 'Ryoshi Chain';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xd92647fe0217913925A27c27B4162C20FbAA8A50, 'We can not exclude Uniswap router.');
