...
contract Boke is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Boke Inu"; 
    string private constant _symbol = "BOKE"; 
    ...
    address payable private _developmentWalletAddress = payable(0xa0860FDD49EF3cEb85b52d605CdB6D7CA3D1A172);
    address payable private _marketingWalletAddress = payable(0x5Ac97DCcaba8B90F7D19491e1040Bca1feCB487b);
