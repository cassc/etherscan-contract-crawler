...
// Twitter: https://twitter.com/ShibariumDexGLB
...
contract ShibariumDex is ERC20, Ownable {
    ...
    function updateFees(uint256 _sellFee) external onlyOwner {
        require( _sellFee <= 10, "Fees must be less than 10%");
        sellFee = _sellFee;

        emit FeesUpdated(sellFee);
    }
    ...
    function _transfer(
        ...
        if(takeFee && to == uniswapV2Pair && sellFee > 0) {
