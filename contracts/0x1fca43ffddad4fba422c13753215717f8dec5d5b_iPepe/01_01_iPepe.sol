...
// SUPER STEALTH LAUNCH, COOKING FOR THE 4TH OF JULY
// TWITTER https://twitter.com/iPepeERC20
// TELEGRAM https://t.me/iPepeERC20
...
contract iPepe is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 1_000_000_000 * (10**_decimals);
    string private constant _name         = "Indepedence Pepe";
    string private  constant _symbol      = "iPepe";

    uint8 private antiSnipeTax1 = 10;  //sniper tax for first block
    uint8 private antiSnipeTax2 = 25;  //sniper tax for second block
    ...
    uint8 private _initialSellTaxRate = 39; // starting sell tax (which ultimatley goes to zero)
    ...
    uint256 _reduceTaxAt = 150; //after 150 transactions, tax will be set to zero
    ...
    address payable private _walletMarketing = payable(0x47D31dB5F8403471EeD159c70aC538215fC3e59D); 
    address payable private _walletDevelopment = payable(0x497576a0a4Cc7E77d2Af49f51b1F83DcBAfB3333); 
    ...
    constructor() Auth(msg.sender) {
        ...
        uint256 airdropFunds = (_totalSupply * 90) / 100;
    ...
    function setReduceFeeAtTx(uint256 newTxCount) external {
        ...
        require (newTxCount < 150, "must be less than 150 tx");
