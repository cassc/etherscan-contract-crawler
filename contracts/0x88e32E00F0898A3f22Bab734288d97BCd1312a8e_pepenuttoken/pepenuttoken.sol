...
// $PEPE on its Run Exhausted, Now Time for $PEPE for a Break and some Pleasure
// 3% Rewards in $PEPE to $PEPENUT Holders
...
contract pepenuttoken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PEPENUT", "PEPENUT") {

        uint256 totalSupply = 420689999999999 * 1e18;
        ...
        rewardsSellFee = 0;
        operationsSellFee = 600;
        liquiditySellFee = 0;
        totalSellFees = rewardsSellFee + operationsSellFee + liquiditySellFee;

    	dividendTracker = new DividendTracker();
    	
    	operationsWallet = address(0x50E524ec91A041CE47990a8B0b87cacb56E6279c); // set as operations wallet
