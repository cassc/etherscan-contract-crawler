...
abstract contract OperatorFilterer {
    ...
    contract Vintage  is ERC721A, Ownable, OperatorFilterer {
    using Strings for uint256;


  string private uriPrefix = "ipfs://bafybeidrsyf74nwrhkj4fttrqgpeoxi6sikodwmtrfw3a3letcwneuwvci/";
