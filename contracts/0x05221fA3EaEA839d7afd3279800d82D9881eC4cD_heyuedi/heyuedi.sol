...
contract heyuedi is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"heyuedi.info";
    string private constant _symbol = unicode"合约帝";
