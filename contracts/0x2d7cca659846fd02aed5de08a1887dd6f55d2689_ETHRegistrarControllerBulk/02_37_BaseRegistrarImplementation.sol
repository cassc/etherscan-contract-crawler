...
contract BaseRegistrarImplementation is ERC721, IBaseRegistrar, Ownable  {
    ...
    // The TDNS registry
    TDNS public tdns;
    // The namehash of the TLD this registrar owns (eg, .tomi)
    ...
    constructor(TDNS _tdns, bytes32 _baseNode) ERC721("Tomi Domain Name System","TDNS") {
        tdns = _tdns;
        baseNode = _baseNode;
    }
    ...
    /**
     * @dev Reclaim ownership of a name in TDNS, if you own it in the registrar.
     */
     ...
     */
    function tokenURI(uint256 tokenId) public view override(ERC721, IBaseRegistrar) returns (string memory) {
