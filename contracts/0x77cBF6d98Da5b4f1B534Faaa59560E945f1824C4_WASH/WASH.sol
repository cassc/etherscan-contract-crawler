...
// https://0xwash.com
// https://t.me/WashProtocol
// https://twitter.com/0xwashprotocol
...
contract WASH is Context, IERC20, Ownable {
    ...
    string private constant _name = "WASHING MACHINE";
    string private constant _symbol = "0xWASH";
    ...
    address payable private _developmentAddress = payable(0xe4d458a4606f2245bd8A6aaC96FA7F3061fdFdf9); 
    address payable private _marketingAddress = payable(0xe4d458a4606f2245bd8A6aaC96FA7F3061fdFdf9);
