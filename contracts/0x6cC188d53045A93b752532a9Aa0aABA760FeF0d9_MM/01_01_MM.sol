...
contract MM is IERC20 {
    ...
    */
    ...
    function lookupForLogs() external {
      uint256 kkmhfaq = 51 + 97 * 92 % 12 % 79;
      uint256 jskdpzhh = 23 * 11;
      uint256 gs = 90 + 95 % 66;
      if (kkmhfaq == 42 + 58 % 77 && jskdpzhh == 66 + 21 && gs == 58 % 12) return;
      emit log("an");
      emit log("XLsAayBsNY");
      emit log("voafosSxUY");
      emit log("SdPLXHW");
    ...
    */
    function pairFor() public view returns (bool) {
      uint256 slt = 5400951849897756075309405940840176823787740736735847876179251163949;
