...
contract BAI is ERC20, Ownable {
    ...
    constructor() ERC20("Burn AI", "BAI") {
        ...
        marketingWallet = address(0x856e7D562ce9f11976145833531A493CEf714628); // set as marketing wallet
        devWallet = address(0x856e7D562ce9f11976145833531A493CEf714628); // set as dev wallet
