...
contract LIQUIDITY  is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "LiquidityFTP";
    string private constant _Symbol = "LIQUIDITY";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e12 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0x253fc011118cA69CC51099B776852be4B320e4EE);
        treasuryAddress = payable(0x253fc011118cA69CC51099B776852be4B320e4EE);
        devAddress = payable(0x253fc011118cA69CC51099B776852be4B320e4EE);
