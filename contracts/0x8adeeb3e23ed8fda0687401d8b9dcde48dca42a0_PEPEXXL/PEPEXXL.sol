...
/**
https://t.me/PEPEXXL_ETH
https://pepexxl.xyz/
https://twitter.com/PepeXXL_ETH
*/
...
contract PEPEXXL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PEPE XXL";
    ...
    function NoMaxWallet() external onlyOwner{
    ...
    function decreaseTax(uint256 taxWithDecimals) external {
