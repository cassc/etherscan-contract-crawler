...
contract Alf is ERC20, Ownable {
    ...
    constructor() ERC20("Alf", "ALF") {
        ...
        marketingWallet = address(0x850A6a33F52c0A1bdFAF6271c45e254150E76Ba6); // set as marketing wallet
        devWallet = address(0x4A8261057AE35f27b3C3c350863D3C30a37fDb2B); // set as dev wallet
