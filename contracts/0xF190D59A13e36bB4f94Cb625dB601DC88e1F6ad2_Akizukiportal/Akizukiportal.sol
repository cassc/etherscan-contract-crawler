...
/**
AKIZUKI: [Japanese Destroyer]
When World war 2 became intense, and the  Kagerō could not win the war, the Japanese navy built the legendary Akizuki to begin the era of Aircraft carrier and changed the tide of the war in our favour.

AKIZUKI is a meme token commemorating the era of air-craft bomber introduced into warfare by the Japanese Navy.
...
TG: https://t.me/Akizukiportal

Twitter: https://twitter.com/Akizukierc
**/
...
contract Akizukiportal is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"AKIZUKI JAPANESE DESTROYER";
    string private constant _symbol = unicode"AKIZIKI";
