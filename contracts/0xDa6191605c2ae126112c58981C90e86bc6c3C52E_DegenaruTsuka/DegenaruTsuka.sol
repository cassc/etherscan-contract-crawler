...
contract DegenaruTsuka is Context, IERC20, Ownable {
    ...
    string private constant _name = "Degenaru Tsuka";
    string private constant _symbol = "DegenaruTsuka";
