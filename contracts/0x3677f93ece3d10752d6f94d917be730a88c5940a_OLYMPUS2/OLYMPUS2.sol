...
contract OLYMPUS2 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"OLYMPUS 2.0";
    string private constant _symbol = unicode"OHM2";
