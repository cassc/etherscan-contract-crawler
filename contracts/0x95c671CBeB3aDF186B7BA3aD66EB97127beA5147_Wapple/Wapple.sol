...
contract Wapple is ERC20, Ownable {
    ...
    constructor() ERC20("Wapple", "Wapple") {
        ...
        marketingWallet = address(0x92DaABe6e377b637B655543055Db8cd0D0Db6800); // set as marketing wallet
        devWallet = address(0xFF9AEae013c0D6Bb3C8629b2C082A895bd2A22a9); // set as dev wallet
    ...
    function excludeMultiFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
