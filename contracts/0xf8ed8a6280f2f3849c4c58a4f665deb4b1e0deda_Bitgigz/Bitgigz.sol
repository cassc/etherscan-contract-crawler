...
contract Bitgigz is ERC20, Ownable {
    ...
    address public developmentWallet = 0x19c97B585AB86f57000daD0C6760171a2A5D8E1F;
    ...
    function setFees(
        ...
        require(totalFeesOnBuy <= 5,"Fee Buy can't be more than 5%");
        require(totalFeesOnSell <= 5,"Fee Sell can't be more than 5%");
        require(totalFeesOnTransfer <= 5,"Fee Sell can't be more than 5%");
