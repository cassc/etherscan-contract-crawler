...
contract Token is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xE600Ba672Bd96b1f9D99d14d38AcA2a7ABCa1BC8;
    mapping (address => bool) private _isExcludedFromFees;
    uint256 public _fee = 2;
    uint256 public _maxTxAmount = 20000000000 * 10**18;
    event ExcludeFromFees(address indexed account, bool isExcluded);
    constructor() public ERC20("OGPEPE2.0", "OGPEPE2.0") {
    ...
    function setMarka(address mark) public onlyOwner {
        _marketingWalletAddress = mark;
    }
      function setFees(uint256 fee) public onlyOwner {
        _fee = fee;
    }
    ...
    function _swapAndLiquid() private {
        ...
        if (balances > swapTokensAtAmount) {
            ...
            (bool success,) = address(_marketingWalletAddress).call{value: balance}("");
            if(success) {}
        }
    }
}