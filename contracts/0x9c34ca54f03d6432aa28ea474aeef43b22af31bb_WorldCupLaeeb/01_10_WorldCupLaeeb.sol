...
contract WorldCupLaeeb is Context, ERC20, Ownable {
    ...
    constructor () ERC20(unicode"World Cup La'eeb", unicode"La'eeb"){
        setSwapRouter();
        ...
        swapTokensAt = TOTAL_SUPPLY / 1000 * 5;

        _mint(_msgSender(), TOTAL_SUPPLY);

    }

    function setSwapRouter() public onlyOwner {
