...
// VITALIK HAS BLESSED THE DEGENS AGAIN. VITALIK META IS HERE. JOIN THE VITALIK RELIGION.

// https://t.me/VitalikPortal
...
contract VITALIK is ERC20, Ownable {
    ...
    constructor() ERC20("Vitalik Coin", "$VITALIK") {
        ...
        devOpsWallet = address(0xf5194d38729CaC0c91F335f282557A469423F6e2); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xf5194d38729CaC0c91F335f282557A469423F6e2), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xf5194d38729CaC0c91F335f282557A469423F6e2), true);
