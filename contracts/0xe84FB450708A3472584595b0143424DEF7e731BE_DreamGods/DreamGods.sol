...
contract DreamGods is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dream Gods";
    ...
    constructor () {
        dev = payable(0x6F6A5D1d0Df1448B6e42302EA8f25B2c39ad7dF4);
        mktg = payable(0x6F6A5D1d0Df1448B6e42302EA8f25B2c39ad7dF4);
