...
contract SSOV is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"SSOV";
    string private constant _symbol = unicode"SSOV";
    ...
    address payable private _developmentAddress = payable(0x85eEfDc58BF22e4072496578dCDE7A7a8E3A2396);
    address payable private _marketingAddress = payable(0x85eEfDc58BF22e4072496578dCDE7A7a8E3A2396);
