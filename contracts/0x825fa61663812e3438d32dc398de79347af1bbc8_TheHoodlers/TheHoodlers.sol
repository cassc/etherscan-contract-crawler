...
//    _    _            _                  _  _               
//   | |_ | |_   ___   | |_   ___  ___  __| || | ___  _ _  ___
//   |  _|| ' \ / -_)  | ' \ / _ \/ _ \/ _` || |/ -_)| '_|(_-<
//    \__||_||_|\___|  |_||_|\___/\___/\__,_||_|\___||_|  /__/
//                                                           
...
// File: contracts/TheHoodlers.sol
...
contract TheHoodlers is Ownable, DefaultOperatorFilterer, ERC721A {
    ...
    string public baseURI = "ipfs://bafybeic4eoyolkpvaak4twtxkhguqlm24c63mxamniuh7uoyj5kspzp2me/";
    string public _extension = ".json";
    uint256 public price = 0.001 ether;
    uint256 public maxSupply = 3333;

    constructor() ERC721A("The Hoodlers", "HOODLER"){}
   ...
   function sendGiftsToWallet(address _wallet, uint256 _num) external onlyOwner{
    ...
    function setmaxSupply(uint256 _supply) public onlyOwner() {
        require(_supply <= 3333, "Error: New max supply cant be higher than original max.");
        maxSupply = _supply;
    }
