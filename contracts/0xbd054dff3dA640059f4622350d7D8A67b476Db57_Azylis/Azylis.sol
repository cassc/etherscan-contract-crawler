...
contract Azylis is Context, IERC20, Ownable {
    string private _name = "AZYLIS";
    string private _symbol = "AZYL";
    ...
    uint256 public marketingFeeOnBuying = 100;

    uint256 public marketingFeeOnSelling = 200;
    ...
    constructor() {
        ...
        marketingWallet = address(0xFa67ae44F8086f9bDab529750B2a51008836fF6c);
