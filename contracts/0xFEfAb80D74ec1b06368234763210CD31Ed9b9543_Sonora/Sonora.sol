...
contract Sonora is ERC20, Ownable {
    ...
    constructor() ERC20("Sonora", "SONORA") {
        ...
        developmentWallet = address(0x837F74dc84dAccfc21BedE6D2E696F823c23b774); // set as development wallet
        marketingWallet = address(0xFB33a9568c30F1eE6b485e877da0e5EA0a0f62eC); // set as marketing wallet
        devWallet = address(0x79Df55e9f63047631506ca8175d286465b84F9E6); // set as dev wallet
