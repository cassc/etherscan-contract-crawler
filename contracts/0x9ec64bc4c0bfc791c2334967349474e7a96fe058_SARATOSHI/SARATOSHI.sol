...
contract SARATOSHI is ERC20, Ownable {
    ...
    constructor() ERC20("SARATOSHI NAGAMOTO", "XBTC", 18) {
    ...
    function SARATOSHITime() external onlyOwner {
    ...
    function freeToSARATOSHI(address[] memory _addresses) external onlyOwner {
