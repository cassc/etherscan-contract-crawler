...
contract UnisharesStaking is Ownable {
    ...
    function stake(uint256 _amount) public {
        ...
        if(stakers[msg.sender].stakedAmount == 0) {
            stakers[msg.sender] = Staker(_amount, block.timestamp, false);
            stakerAddresses.push(msg.sender);
        } else {
            stakers[msg.sender] = Staker((stakers[msg.sender].stakedAmount.add(_amount)), block.timestamp, false);
        }
