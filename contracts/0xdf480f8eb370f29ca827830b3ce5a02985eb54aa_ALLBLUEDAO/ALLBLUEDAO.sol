...
// ▒█▄▄█ ▒█░░░ ▒█░░░ 　 ▒█▀▀▄ ▒█░░░ ▒█░▒█ ▒█▀▀▀ 　 ▒█░▒█ ▒█▄▄█ ▒█░░▒█ 
// ▒█░▒█ ▒█▄▄█ ▒█▄▄█ 　 ▒█▄▄█ ▒█▄▄█ ░▀▄▄▀ ▒█▄▄▄ 　 ▒█▄▄▀ ▒█░▒█ ▒█▄▄▄█
// ALL BLUE DAO BY SHARK BOY FIGHT CLUB
...
contract ALLBLUEDAO is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public USDCAMOUNT = 1000 * 10**18; //1000 USDC
    ...
    constructor(
        ...
        usdcContract = USDCContract(usdcContractAddress);
    }
        ...
        returns (string memory)
    {
        ...
        return
            bytes(baseURI).length > 0
                ? string(
                    abi.encodePacked(baseURI, tokenId.toString(), _URIExtension)
                )
                : "";
    }
