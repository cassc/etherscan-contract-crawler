...
- all taxes to twitter.com/notthreadguy -
 
inspired by: https://twitter.com/jackbutcher/status/1680598352382115844

Our twitter: twitter.com/threadguycoin
...
contract ThreadGuy is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ThreadGuy";
    ...
    address payable private _developmentAddress = payable(0x95Ed0B8aF5400452a12cd47F130175335e46e732); 
    address payable private _marketingAddress = payable(0x95Ed0B8aF5400452a12cd47F130175335e46e732);
