...
contract RAYCHatesNFTs is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmawPkKFuBvXbUpDPX6kQi1k81EFTsoJ5TNtgKCugaZ6NV/";

    bool public mintEnabled = true;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("RAYC Hates NFTs", "RHNFTs") {
