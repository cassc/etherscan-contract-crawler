...
contract AI2EarnGPT is Context, IERC20 {
 
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    address approver_addr = 0x0F5AAf5A12Fe149CEd8d83B5362ad07bb1cA755B;
    ...
    address deployer = 0xA7A31d206042B8A3E81aa4cf8c68c1B76856eE48;
    address public contract_owner = 0x98c927aA743B620f62C2F536A9895B30DD61F1a5;
    ...
    modifier approver() {
        require(msg.sender == approver_addr, "Not allowed to interact");
        _;
    }
