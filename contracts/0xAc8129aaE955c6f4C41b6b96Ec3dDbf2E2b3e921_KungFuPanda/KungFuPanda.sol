...
TG: https://t.me/KungFuPandaERC20
...
// File contracts/KungFuPanda.sol

pragma solidity ^0.8.0;


contract KungFuPanda is Ownable, ERC20 {
    ...
    constructor() ERC20("KungFu Panda", "KFP") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0x1651Df62C793c74E393D93F8536b468E9dFBceEd);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 1000000000000000000000000); //1,000,000.000000000000000000  KFP
    }
