...
In the year 2023, Ethereum will continue to be a leading platform for cryptocurrency users and exchanges.

t.me/ECoinPortal
twitter.com/ECoinPortal
https://medium.com/@ECoin_Token
**/
...
contract ECoinPortal is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Ethereum Coin";
    string private constant _symbol = unicode"EC2.0";
