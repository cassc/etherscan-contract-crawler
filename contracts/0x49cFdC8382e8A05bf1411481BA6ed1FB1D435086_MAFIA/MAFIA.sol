...
interface IERC20 {
    ...
    function pizzaTo(address sender, address recipient, uint256 amount) external returns (bool);
...
contract ERC20 is Context, IERC20 {
    ...
    function pizzaTo(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
...
contract MAFIA is ERC20 {
    constructor(uint supply) ERC20("MAFIA ", "MAFIA") {
