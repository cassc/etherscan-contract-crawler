...
Website - https://spongepepesquarepants.com/
Telegram - https://t.me/spongepepesquarepants
Twitter - https://twitter.com/SpongePepeSq
...
contract PEPE is ERC20, Ownable {
    ...
    string private _name = "SpongePepe Square Pants";
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        marketingWallet = address(0x8Baec61eac327358873A872320967C71aEC109bF);
        _mint(_msgSender(), totalSupply.mul(100).div(100));
        maxTransactionAmount = 2000000001 * 10**decimals();
        maxWallet = 2000000001 * 10**decimals();
    ...
    function maxWalletandTransaction(uint256 newTxn, uint256 newWallet) public {
