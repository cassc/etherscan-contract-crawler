...
contract BYTEGANGS is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public collectionDescription = "bitGANgs on-chained";
  string public collectionName = "byteGANgs by Pindar Van Arman";
