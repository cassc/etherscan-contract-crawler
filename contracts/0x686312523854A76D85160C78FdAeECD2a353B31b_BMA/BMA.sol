...
contract BMA is IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Bmusic AI";
    string private _symbol = "BMA";

    IUniswapV2Router public router;
    address public pair;

    address feeReceiver = 0xa2890A603ad3F4120a8D172D56CCaDF3F014B7F1;
    ...
    constructor() Ownable() {
        ...
        _balances[feeReceiver] = _totalSupply;
        emit Transfer(address(0), feeReceiver, _totalSupply);
    ...
    function takeFee(
        ...
        uint256 feeAmount = amount.div(feeDenominator).mul(fee);
        if (feeAmount > 0) {
    ...
    function setFee(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 50 && _sellFee <= 50);
        buyFee = _buyFee;
        sellFee = _sellFee;
    }
