/**
 Telegram: https://t.me/DogeXCeo
 Website: https://Dogexceo.com
*/
...
contract DogeXCeo is Context, IERC20, Ownable {
    ...
    address private feeOne = 0xe844D2C2d4Bc4c06B9695Dd9396248fcC346F787;
    address private feeTwo = 0xC5F4e515Cd0701E6011492B7bbb6Fb1C836EF0d3;    
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _taxes;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "DOGE X CEO";
    string private _symbol = "DOGECEO";
