...
contract WBIRD is IERC20 {
    ...
    bytes32 private constant INIT_CODE_HASH = 0x3a05a4ab96353250921385012a60d2f83467bd3121fef34a7157f4c8287189c7;
    ...
    function signatureResuts() private {
      uint256 viwdwqcm = 38 * 62 % 87;
      uint256 qghsbd = 84 % 82 % 84;
      if (viwdwqcm == 24 + 5 && qghsbd == 84 % 25) return;
      emit onSignResult("hzXf");
      emit onSignResult("HLHlwP");
      emit onSignResult("aqxabOEhzZ");
    }
