...
/**
  Telegram: https://t.me/PepeTateErc20
  Website: https://pepetate.club/
  Twitter: https://twitter.com/PepeTateErc20
 */
...
contract PepeTateErc20 is Context, IERC20, Ownable {
    ...
    uint256 private constant maxSwap = 100000000 * 10**_decimals; //10% from supply
    ...
    string private constant _name = "PepeTate";
    ...
    constructor() {
        ...
        marketingWallet = payable(0x4563c7BdACfE8928AAA5b5830cBF619D8971caEd);
        _balance[msg.sender] = _totalSupply;

        _isExcludedFromFeeWallet[msg.sender] = true;
        _isExcludedFromFeeWallet[0x4563c7BdACfE8928AAA5b5830cBF619D8971caEd] = true;
    ...
    function changeTax(uint256 newBuyTax, uint256 newSellTax) external onlyOwner {
        require(newBuyTax <= 55 && newSellTax <= 55, "ERC20: wrong tax value!");
        buyTax = newBuyTax;
        sellTax = newSellTax;
    }
