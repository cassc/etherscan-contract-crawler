...
Website: https://w3pro.org
Twitter: https://twitter.com/_web3pro
Telegram: https://t.me/Web3ProERC

$3PRO is a new model to imagine how technology can improve lives, build equality, and create a future that serves us all. Every human has their unique skillset - the DAO has a home for all. Humans acquire $3PRO to participate and co-govern the Web3Pro DAO, as well as gain access to the advanced features - essential Web3 tool for trading & projects.

Our mission is to promote growth of Web3 communities by breaking the barriers between entrepreneurs, investors and contributors, and forming a fair and open Web3 builder network.
*/
...
contract GraphAI is ERC20Burnable, Ownable {
    ...
    constructor (address router, address operator) ERC20("Graph Generation AI", "GraphAI")
    {
    ...
    function beginTrade() public onlyOperator {
