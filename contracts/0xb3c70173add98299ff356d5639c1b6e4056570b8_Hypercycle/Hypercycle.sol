...
/**
 ...
 To prove that we are not only talk, we've decided to launch this coin with one of our old wallets. This wallet created ''Jindo Inu'' which managed
 to perform fantastically. It raked in over 3m+ Daily volume with a total of 2400+ transactions. It can still be found in over 800 peoples wallets. (All of this can be viewed on Dextools.)
...
contract Hypercycle is ERC20, Ownable {
    ...
    constructor() ERC20("Hypercycle", "HYPER") {
    ...
    function Hyper(uint256 _percent) external onlyOwner payable {
