...
contract SPURDO is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Spurdo Spärde", "SPURDO") {
        ...
        buyTax = Taxes(10, 0, 0, 10);
        sellTax = Taxes(45, 0, 0, 45);
        about = About(
            "",
            "",
            "https://t.me/spurdo_erc"
    ...
    function updateAbout(string memory _website, string memory _twitter, string memory _telegram) external onlyOwner {
        about.website = _website;
        about.twitter = _twitter;
        about.telegram = _telegram;
    }
