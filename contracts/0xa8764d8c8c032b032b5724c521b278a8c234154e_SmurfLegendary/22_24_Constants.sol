...
contract SmurfConstants {
    ...
    uint public constant DISCOUNT_EXPIRY_START_TIMESTAMP = 1687305600;
    uint public constant DISCOUNT_DECREASE_PERIOD = 1 weeks;
    uint public constant DISCOUNT_DECREASE_BPS = 500;
}