...
contract Token is ERC20, ERC20Burnable, Ownable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"ApeCoin 2.0", unicode"APE2") 
    {
    ...
    function marketingFeesSetup(uint16 _buyFee, uint16 _sellFee, uint16 _transferFee) public onlyOwner {
        ...
        totalFees[0] = 0 + marketingFees[0] + autoBurnFees[0];
        totalFees[1] = 0 + marketingFees[1] + autoBurnFees[1];
        totalFees[2] = 0 + marketingFees[2] + autoBurnFees[2];
