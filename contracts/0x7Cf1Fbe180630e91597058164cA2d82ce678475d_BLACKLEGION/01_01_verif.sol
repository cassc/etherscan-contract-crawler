...
contract BLACKLEGION is ERC20, Ownable {
    ...
    constructor() payable ERC20("Black Legion", "BLGN") {
        ...
        projectWallet = address(0x23b61888C38594CA327AE75654811c0a6fe7f7B6);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x39225CA699D614B692D6098864E079a5e9c05aE3),
            block.timestamp
        );
    }
