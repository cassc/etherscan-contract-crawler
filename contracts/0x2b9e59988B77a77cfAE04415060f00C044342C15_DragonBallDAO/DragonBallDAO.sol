...
TELEGRAM: 
https://t.me/dragonballdao

WEBSITE: 
https://dragonballdao.com/

TWITTER:
https://twitter.com/dragonball_dao
...
contract DragonBallDAO is BEP20, Auth {
    ...
    string constant _name = "Dragonball DAO";
    string constant _symbol = "DBD";
    uint8 constant _decimals = 18;

    uint256 public _totalSupply = 1 * 10**5 * 10**_decimals;
