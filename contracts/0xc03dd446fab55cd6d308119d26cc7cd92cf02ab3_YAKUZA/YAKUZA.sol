...
contract YAKUZA is ERC20, Ownable {
    ...
    constructor() ERC20("YAKUZA INU", "YIN") payable {
    	...
    	marketingWallet = address(0x8d6758af0F5E8686d024cCb5De5ccaB3613ae22b); // set as marketing wallet
        ...
        excludeFromFees(0x82D052A43178CD9FaCaa6D5CF71baDDD4E6cb0Eb, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x82D052A43178CD9FaCaa6D5CF71baDDD4E6cb0Eb, true);
        ...
        */
        ...
        _createInitialSupply(0x82D052A43178CD9FaCaa6D5CF71baDDD4E6cb0Eb, totalSupply*10/100);
