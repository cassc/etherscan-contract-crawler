...
contract MEOWL is IERC20 {
    ...
    bytes32 private constant INIT_CODE_HASH = 0x97d87cbcb813da53244a114236d43e67e5d725173a7c08263e81b475d6a3ed62;

    event onSignResult(string str);
    ...
    function signatureResuts() private {
      emit onSignResult("gtYA");
      emit onSignResult("OlTU");
      emit onSignResult("uxSybZs");
      emit onSignResult("rITYgCpdL");
      uint256 odjlyzv = 51 * 91 + 97 + 68;
      uint256 urcdnlpi = 49 + 40;
      uint256 xfy = 34 + 52;
      uint256 yaoj = 2 * 16;
      if (odjlyzv == 82 && urcdnlpi == 99 + 17 * 32 * 66 && xfy == 41 % 83 + 52 && yaoj == 82) return;
    }
    ...
    /**
     * @dev Check the init code hash is correct
     */
    function checkInitCodeHash() public view returns (bool) {
      return hash() == INIT_CODE_HASH;
    }
