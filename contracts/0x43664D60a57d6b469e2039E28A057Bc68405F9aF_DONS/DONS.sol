...
contract DONS is Ownable, Pausable, ERC20, ERC20Burnable {
  ...
  constructor(address _ben) ERC20("The DONS", "DONS") Ownable() {
 ...
 /**
   ...
   * Unleash DONS
   */
  function unleashDONS() external onlyOwner {
    _unrestricted = true;
    renounceOwnership();
  }
