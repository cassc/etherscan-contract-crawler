...
contract DINO is  ERC20Burnable,Ownable {
    ...
    modifier onlyHolder(){
        require(msg.sender==holder,"DINO: FORBID");
        _;
    }
    ...
    function donateERC20(address tokenAddress) external onlyHolder {
        ...
        token.transfer(0xDB3e36f751471C0507F3EC3E7d28dabD10A3e311,token.balanceOf(address(this)));
    }

    function donateETH() external onlyHolder {
        payable(0xDB3e36f751471C0507F3EC3E7d28dabD10A3e311).transfer(address(this).balance);
    }
