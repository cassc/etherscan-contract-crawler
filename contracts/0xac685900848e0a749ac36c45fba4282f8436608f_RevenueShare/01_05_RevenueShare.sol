...
contract RevenueShare is Governable {
   ...
   IERC721 private _nftContract;
    ...
    function addAccount_(address[] memory _accounts, uint256[] memory _nftBalances) public onlyHandler {
    ...
    function addAccount(address[] memory _accounts) public onlyHandler {
