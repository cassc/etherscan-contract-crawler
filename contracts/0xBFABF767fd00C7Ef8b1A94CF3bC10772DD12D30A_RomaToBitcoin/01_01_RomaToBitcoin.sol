...
contract RomaToBitcoin is ERC721A {
    ...
    function mint(uint256 amount) check(amount) payable public {
    ...
    constructor() ERC721A("Roma To Bitcoin", "RTB") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmZQJnp4t4HEoVReTUXg91gEuFMuQgZ3FxChE2KCnwHoPv/", _toString(tokenId), ".json"));
    }
