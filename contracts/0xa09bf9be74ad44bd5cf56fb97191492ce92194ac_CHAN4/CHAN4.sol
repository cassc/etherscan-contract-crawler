...
contract CHAN4 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Chan4";
    string private constant _symbol = unicode"CHAN4";
