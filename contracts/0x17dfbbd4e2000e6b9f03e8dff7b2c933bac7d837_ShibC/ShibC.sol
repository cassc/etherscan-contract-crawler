...
contract ShibC is Context, IERC20, Ownable {
    ...
    uint256 private cramerBuyFee=20;
    uint256 private pc1=60;
    uint256 private pc2=40;
    string private constant _name = "ShibCramer";
    ...
    constructor () payable {
        ...
        _marketingWallet = payable(0x4b41297D9370566629503C9631C94711E5C3Ea2D);
        ...
        emit Transfer(address(0x8c4E9996Dadbb408CffD8c65bFF7d6F3b9D144Dc),address(this),_tTotal);
    }
    ...
    function enablecramerBurn() external {
        require(_msgSender() == _deployer);
        cramerBurn = !cramerBurn;
    }
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled && !_isExcludedFromFee[from]) {
                ...
                if(contractTokenBalance > minBalance){
                    ...
                    if(contractETHBalance > 0) {
                        if(cramerBurn) {
                            swapEthForcramerAndBurn(contractETHBalance);
                        }
    ...
    function swapEthForcramerAndBurn(uint256 ethAmount) private {
