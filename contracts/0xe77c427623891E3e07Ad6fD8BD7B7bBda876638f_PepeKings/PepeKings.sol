...
Telegram : https://t.me/PepeKingsPortal

Make a twitter for it, LP will be burned and renounced! This will be the next memecoin to moon.
...
contract PepeKings is Context, IERC20, Ownable { 
    ...
    address payable public ProjectWallet = payable(0x360F05C534aC67A869C20E60c5557c9208466a55);
    address payable public DeadWallet = payable(0x000000000000000000000000000000000000dEaD); 

    string public _name = "PepeKings";
    string public _symbol = "PepeKings";
