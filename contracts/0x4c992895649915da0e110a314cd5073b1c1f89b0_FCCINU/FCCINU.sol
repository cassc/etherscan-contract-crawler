...
/**
FCC INU is a ERC20 based charity coin. All tax will be donated to various charity to help make the world a better place.

TELEGRAM: T.me/Fuckclimatechangeinu
*/
...
contract FCCINU is Context, IERC20, Ownable {///////////////////////////////////////////////////////////

    using SafeMath for uint256;

    string private constant _name = "Fuck Climate Change Inu";//////////////////////////
    string private constant _symbol = "FCC INU";//////////////////////////////////////////////////////////////////////////
    ...
    address payable private _developmentAddress = payable(0xFCf7aFB95f83De40a9B99BB9B882852E7c790bA8);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0xFCf7aFB95f83De40a9B99BB9B882852E7c790bA8);///////////////////////////////////////////////////
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require (totalFees <= 10,"Must be less than 10%");
    ...
    function setMaxTxnAmount(uint256 maxTxAmount) public onlyOwner {
        ...
        require (_maxTxAmount >= _tTotal* 1 / 100,"Must be more than 1%");
    }

    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwner {
        _maxWalletSize = maxWalletSize;
        require (_maxWalletSize >= _tTotal* 1 / 100,"Must be more than 1%");
    }
