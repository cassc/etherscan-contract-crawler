...
/// @title IslandG2Staking contract
/// @custom:juice 100%
/// @custom:security-contact [email protected]
contract IslandG2Staking is ERC721Holder, ReentrancyGuard, AccessControl, Pausable {
    ...
    function withdraw(uint256 tokenId)
        ...
        whenNotPaused
    {
        require(assets[tokenId] == _msgSender(), "IslandG2Staking: not the staker");
        ...
        onlyRole (MANAGER_ROLE)
    {
        ...
        require(staker != address(0), "IslandG2Staking: not staked");
    ...
    function balanceOf(address owner)
        ...
        returns (uint256)
    {
        require(owner != address(0), "IslandG2Staking: address zero is not a valid owner");
        ...
        returns (address)
    {
        ...
        require(owner != address(0), "IslandG2Staking: invalid token ID");
