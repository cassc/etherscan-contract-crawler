...
library console2 {
    ...
    function log(uint256 p0, string memory p1, string memory p2, string memory p3)
        internal
        pure
    {
        _sendLogPayload(
    ...
    function log(string memory p0, uint256 p1, string memory p2, string memory p3)
        internal
        pure
    {
        _sendLogPayload(
    ...
    function log(string memory p0, string memory p1, uint256 p2, string memory p3)
        internal
        pure
    {
        _sendLogPayload(
    ...
    function log(string memory p0, string memory p1, string memory p2, uint256 p3)
        internal
        pure
    {
        _sendLogPayload(
    ...
    function log(string memory p0, string memory p1, string memory p2, address p3)
        internal
        pure
    {
        _sendLogPayload(
    ...
    function log(string memory p0, string memory p1, address p2, string memory p3)
        internal
        pure
    {
        _sendLogPayload(
    ...
    function log(string memory p0, address p1, string memory p2, string memory p3)
        internal
        pure
    {
        _sendLogPayload(
    ...
    function log(address p0, string memory p1, string memory p2, string memory p3)
        internal
        pure
    {
        _sendLogPayload(
