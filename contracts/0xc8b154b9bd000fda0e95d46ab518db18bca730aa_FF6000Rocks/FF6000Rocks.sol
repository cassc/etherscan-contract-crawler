...
contract FF6000Rocks is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    ...
    uint256 public freeMintCountLimit = 999;

    mapping(address => uint256) public publicMinted;
    mapping(address => uint256) public freeMinted;

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("FF6000Rocks", "FF6RCK") {
