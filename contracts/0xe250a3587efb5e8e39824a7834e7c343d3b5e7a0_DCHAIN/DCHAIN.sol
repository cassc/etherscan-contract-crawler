...
https://tsukachain.com/
TG:https://t.me/Tsuka_Chain
https://medium.com/@ryoshisrealm/dragons-are-gathering-together-3d8fa9fd192e
...
contract DCHAIN is Context, IERC20 {
    using SafeMath for uint256;

    string private constant _name = "Tsuka Chain";
    string private constant _symbol = "DCHAIN";
    ...
    constructor(address payable marketing_, address locker_, uint256 _snipeBlockAmt) {
        ...
        _locker = locker_;
        _isExcluded[dead0x] = true;
        _isExcludedFromFee[_msgSender()] = true;
        _isExcludedFromFee[dead0x] = true;
        ...
        _isMaxWalletExclude[dead0x] = true;
        ...
        _isExcludedMaxTxnAmount[dead0x] = true;
    ...
    function manualBurnTokens(uint amount) external authorized() returns (bool){
        ...
        uint burnTokens = balanceOf(dead0x);
        _transfer(dead0x, dead, burnTokens);
