...
//**
//Telegram: https://t.me/xZStudio_Portal
//Twitter: https://twitter.com/0xZStudio_Eth
//Gitbook: https://0xzombie.gitbook.io/0xz-project/
//Website: https://0xzgaming.io/
...
contract OxZ is ERC20, Ownable {
    ...
    constructor() ERC20("0xZ Project", "0xZ") {
        ...
        maxTransactionAmount = 150_000 * 1e18;
        maxWallet = 150_000 * 1e18;
        ...
        marketingWallet = address(0x9A54f66e8E206651C9C20a1c0968d9C59efFf723); 
        developmentWallet = address(0x9A54f66e8E206651C9C20a1c0968d9C59efFf723); 
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevelopmentFee;
        require(buyTotalFees <= 40, "Must keep fees at 30% or less");
    }
