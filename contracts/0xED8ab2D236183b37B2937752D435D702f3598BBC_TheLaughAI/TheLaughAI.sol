...
// Main Contract Logic 
// --------------------------------------------------------------
contract TheLaughAI is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context";
    string private _name = "The Laugh AI";
    string private _symbol = "LMFAI";
    ...
    // wallets
    address payable public liquidityWallet = payable(0xEB1593Ab7CEeCbF3AD39d25F218d23253BeD4905);
    address payable public operationsWallet =  payable(0xEB1593Ab7CEeCbF3AD39d25F218d23253BeD4905);
