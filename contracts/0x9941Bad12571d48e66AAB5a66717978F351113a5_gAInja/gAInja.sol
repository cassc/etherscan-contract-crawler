...
//Telegram: https://t.me/gAInjaERC
//Website: https://gainja.art
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x725c9348cb3E14d040b5C3bcbAE121ca5C153BE3; // owner address
...
contract gAInja is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "gAInja";
    string private _symbol = unicode"AI420";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x725c9348cb3E14d040b5C3bcbAE121ca5C153BE3); // 
    address payable public teamWalletAddress = payable(0x725c9348cb3E14d040b5C3bcbAE121ca5C153BE3); // 
