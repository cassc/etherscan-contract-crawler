...
contract _999KillTimezSecondTier is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    uint public maxVipMints = 666;

    uint public publicPrice = 0.0199 ether;
    uint public whitelistPrice = 0.0199 ether;
    ...
    uint communityPayout = payout * 4000 / 10000;
        uint developmentPayout = payout * 2000 / 10000;
        uint creatorPayout = payout * 2800 / 10000;
        uint communityManagerPayout = payout * 1200 / 10000;
    */
    uint public communityPayoutPercent = 4000;
    uint public developmentPayoutPercent = 2000;
    uint public creatorPayoutPercent = 2800;
    uint public communityManagerPayoutPercent = 1200;
    ...
    */
    ...
    ERC721A("999KillTimez", "999KT")
    {
        ...
        wlMints[0x766D5f2d38589aC4702184199c540cD97565B13B] = 1;
        vipMints[0x766D5f2d38589aC4702184199c540cD97565B13B] = 6;
        ...
        wlMints[0xb69C70A15954316920896cf11cEC942bB3CeA06f] = 11;
        vipMints[0xb69C70A15954316920896cf11cEC942bB3CeA06f] = 17;
        ...
        wlMints[0xd434B922e30193f9181284382517884c94350f9e] = 9;
        vipMints[0xd434B922e30193f9181284382517884c94350f9e] = 19;
        ...
        wlMints[0xC59297F3aCDe356f546c925FD5943a860A296603] = 2;
        vipMints[0xC59297F3aCDe356f546c925FD5943a860A296603] = 3;
        ...
        wlMints[0x73F43E66041f8804DaB52592d1c0f1C26fF6fefe] = 2;
        giftReceived[0x73F43E66041f8804DaB52592d1c0f1C26fF6fefe] = 1;
        vipMints[0x73F43E66041f8804DaB52592d1c0f1C26fF6fefe] = 3;
        vipMints[0x90c0F855979018daBC6b517f39FAddc90Acae292] = 2;
        wlMints[0x62e3E1f39025fdADD7454704C13B7b2AE8C1A8EA] = 9;
        vipMints[0x62e3E1f39025fdADD7454704C13B7b2AE8C1A8EA] = 25;
        ...
        wlMints[0x37fDf57B5bA51B777865753CD4b0F2949d8b4FfA] = 5;
        vipMints[0x37fDf57B5bA51B777865753CD4b0F2949d8b4FfA] = 16;
        ...
        wlMints[0x7c0a1f789c683B6636837C9D51c8AA2469d30ed6] = 2;
        vipMints[0x7c0a1f789c683B6636837C9D51c8AA2469d30ed6] = 3;
    ...
    */
    ...
    function spreadPayments(uint payout) private {
        uint communityPayout = payout * communityPayoutPercent / 10000;
        uint developmentPayout = payout * developmentPayoutPercent / 10000;
        uint creatorPayout = payout * creatorPayoutPercent / 10000;
        uint communityManagerPayout = payout * communityManagerPayoutPercent / 10000;
    ...
    function setCommunityPayoutPercent(uint16 _newPercent) external onlyOwner {
        communityPayoutPercent = _newPercent;
    }

    function setDevelopmentPayoutPercent(uint16 _newPercent) external onlyOwner {
        developmentPayoutPercent = _newPercent;
    }

    function setCreatorPayoutPercent(uint16 _newPercent) external onlyOwner {
        creatorPayoutPercent = _newPercent;
    }

    function setCommunityManagerPayoutPercent(uint16 _newPercent) external onlyOwner {
        communityManagerPayoutPercent = _newPercent;
    }
