...
contract MOMOYO is ERC20, Ownable {
    ...
    constructor() ERC20("MOMOYO", "MOO") {
        ...
        marketingWallet = address(0x304A61b1C1f2845018cF37998A19e31BCA083177); //
    ...
    function _Momoyo() external onlyOwner returns (bool) {
        buyTotalFees = 2;
        buyMarketingFee = 2;
        buyLiquidityFee = 0;
        sellTotalFees = 2;
