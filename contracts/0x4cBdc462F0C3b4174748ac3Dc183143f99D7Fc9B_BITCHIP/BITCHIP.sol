...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract BITCHIP is Context, IERC20, Ownable {
     ...
     address public ownerWallet = 0xc92F5547657beB4Ab7b92c049Fefa17F1bF166BC;
    ...
    function excludeFromReward(address account) public onlyOwner() {
       ...
       // require(account != 0xc92F5547657beB4Ab7b92c049Fefa17F1bF166BC,, 'We can not exclude Uniswap router.');
    ...
    function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0x3f336716767986bf29cb5Ad59728f74e8F5DE84F, 'We can not blacklist Uniswap router.');
