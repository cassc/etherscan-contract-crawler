...
/**
Welcome to Rock Paper Scissiors! From the creators of $ETHDICE (ethdice.net) we bring you the most seamless way to play this game by just using Telegram and our token.
Will you be able to outsmart your opponent?

80% of all tax will go towards buyback and burns!

https://t.me/RockPaperScissorsETH
*/
...
contract RPS is Ownable, ERC20 {
    ...
    string constant _name = "RockPaperScisscors";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x6203F9a37a072C97E5C40B4D4cbE3eA9786C608A;
