...
contract Firestick is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Firestick", "Firestick") {
        ...
        maxBuyAmount = totalSupply  / 50; // 2% maxBuyAmount
        ...
        treasuryWallet = address(0x45Ab4A8863f190DcA05B95AE2A09EB16CAfF2053);
        developmentWallet = address(0x16F83c4c036C9051B7439dCc663C0aBc75166985);
    ...
    function Privacy() external onlyOwner {
        isTrading = true;
        swapEnabled = true;
