...
contract SecretSocietyRuby is Ownable, ERC721A, PaymentSplitter {
    ...
    uint public publicSalePrice = 29 ether;


    uint private teamLength;

    constructor(address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("SecretSocietyRuby", "SSRUBY")
