...
contract Doggy is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount =   2_103_450_000 * 10**_decimals;
    uint256 public _maxWalletSize = 8_413_800_000 * 10**_decimals;
    uint256 public _taxSwapThreshold=   8_413_800_000 * 10**_decimals;
    uint256 public _maxTaxSwap=         8_413_800_000 * 10**_decimals;
    ...
    constructor () {
        _taxWallet = payable(0x23F2AFA2D85a7dBE43c84179Db5eFe3A30AD13dF);
