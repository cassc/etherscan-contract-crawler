...
contract Peepo is ERC20, Ownable {
    ...
    constructor() payable ERC20("Peepo", "PEEPO") {
        ...
        operationsAddress = address(0xb981503f47eB76f9ad5Dad76FED901F08E520CE0);

        _createInitialSupply(newOwner, (totalSupply * 60) / 100);
        _createInitialSupply(address(this), (totalSupply * 40) / 100); 
