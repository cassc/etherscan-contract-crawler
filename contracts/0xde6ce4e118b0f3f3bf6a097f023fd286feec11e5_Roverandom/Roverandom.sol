...
/**
 *
 * https://pbs.twimg.com/profile_banners/1357307595749433348/1653872284/1500x500
 * https://www.councilofelrond.com/wp-content/uploads/modules/My_eGallery/gallery/covers/books/Celeborn_rov.jpg
 * 
 */
...
contract Roverandom is ERC20, Ownable {
    ...
    constructor(address _address) ERC20("Dragon Dog", "Roverandom") {
		...
		charityWallet = address(0x595af9a3B211d0AaaDdd06AA0Dc33A172e23473a); // set as charity wallet
        marketingWallet = address(0x595af9a3B211d0AaaDdd06AA0Dc33A172e23473a); // set as marketing wallet
        devWallet = address(0x79f6e6274C4C69096Dc07073d3206b19A70cC950); // set as dev wallet
