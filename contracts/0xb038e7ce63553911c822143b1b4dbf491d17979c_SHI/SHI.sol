...
contract SHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shimazu Yoshihisa";
    ...
    address payable private _developmentAddress = payable(0x6e0D3a055E2891Fe5AB76e8AE66d609Ac77fEE48);
    address payable private _marketingAddress = payable(0x6e0D3a055E2891Fe5AB76e8AE66d609Ac77fEE48);
