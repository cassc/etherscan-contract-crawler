 ...
 * @notice This contract handles minting Shibamingos tokens.
 */
contract Shibamingos is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address public royaltyAddress = 0x68aa0b7a3F4E3897e817bD03B6240Db6BA4BF357;
    address[] public payoutAddresses = [
        0x68aa0b7a3F4E3897e817bD03B6240Db6BA4BF357
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeibgr7lmaexvkexfdawz6nyddjicbkwk4o25vtfnr6ojke67roa2h4/";
    ...
    uint96 public royaltyFee = 2;

    constructor(uint256 _heymintFeePerToken)
        ERC721A("Shibamingos", "SHIB")
        RevokableOperatorFilterer(
