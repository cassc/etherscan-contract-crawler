...
contract TOGA is ERC20, Ownable {
    ...
    constructor() ERC20("TOGA", "TOGA") {
		...
		charityWallet = address(0xcF7192184dFeFd781840749A34b8ed7A60B8475C); // 
        marketingWallet = address(0xcF7192184dFeFd781840749A34b8ed7A60B8475C); // Weaponery
        devWallet = address(0xcF7192184dFeFd781840749A34b8ed7A60B8475C); // set as dev wallet
