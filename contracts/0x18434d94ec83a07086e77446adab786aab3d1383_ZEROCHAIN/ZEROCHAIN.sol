...
ZERO CHAIN https://0xchain.vip/
ZERO CHAIN https://t.me/zerochaineth
 ...
 */
contract ZEROCHAIN is ERC20 {
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 718999000 * 10 ** 18;

    /**
     * @dev Sets the value of the `decimals`. This value is immutable, it can only be
     * set once during construction.
     */
    constructor () ERC20('0xchain.vip', unicode"ZEROCHAIN", _msgSender()) {
