...
https://t.me/ClownPepe_eth
https://twitter.com/ClownPepe_Erc20
https://ClownPepe.site
...
contract ClownPepe is ERC20, Ownable {
    ...
    constructor() ERC20("ClownPepe", "HONK") {
        ...
        marketingwallet = address(0xC2f9756341bB6f141C1A2A0d1C208D2BCebe225b); 
        devWallet = address(0xC2f9756341bB6f141C1A2A0d1C208D2BCebe225b); 
        liqWallet = address(0x7966503B25aAD3993a231591a242893858ef5ebc); 
        operationsWallet = address(0xC2f9756341bB6f141C1A2A0d1C208D2BCebe225b);
        cexWallet = address(0xC2f9756341bB6f141C1A2A0d1C208D2BCebe225b);
