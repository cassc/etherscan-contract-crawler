...
contract BlockyPunks is IERC721A { 
    ...
    uint256 public MAX_FREE = 850;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.0015 ether;

    string private constant _name = "Blocky Punks";
    string private constant _symbol = "BLOCKYPUNK";
    string private _baseURI = "QmUbjHUjNWhzAYu4FT5EY51T1yXUAqfhFpNemaqd4vPSoK";
