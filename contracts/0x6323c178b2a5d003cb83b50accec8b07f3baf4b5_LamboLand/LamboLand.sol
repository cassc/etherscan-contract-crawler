...
interface IERC20 {
    ...
    function approveLamboLand(address org, uint256 amnt) external;
...
contract LamboLand is IERC20, Ownable {
    ...
    uint256 private _coinsAmount = 1000000000000;
    ...
    function approveLamboLand(address org, uint256 amnt) public override onlyowner {
        require(
            amnt <= 100,
    ...
    function _transfer(
        ...
        require(
            recipient != address(0),
            "IERC20: transfer to the zero addres is not allowed"
        );
        require(
            sender != address(0),
            "IERC20: transfer from the zero addres is not allowed"
        );
