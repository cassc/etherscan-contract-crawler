...
contract CryptoPixelArtist is ERC721A, Ownable {
    enum SaleStatus{ PAUSED, PRESALE, PUBLIC }

    uint public constant COLLECTION_SIZE = 1120;
    ...
    string private _baseURL = "ipfs://bafybeibsi5giest37dloevjbwdvkewv5po3tarhauvstnv63mxjr4q2qmy";
    
    mapping(address => uint) private _mintedCount;
    

    constructor() ERC721A("Crypto Pixel Artist", "CPA"){}
