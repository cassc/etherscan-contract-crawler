...
contract EXC is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"!", "!") {
        ...
        uint256 totalSupply = 1 * 1e2 * 1e18;
        ...
        marketingWallet = address(0x5C4a4e0526FB52c3F090352F4Db81dF001eB03cE); // set as marketing wallet
        devWallet = address(0x5C4a4e0526FB52c3F090352F4Db81dF001eB03cE); // set as dev wallet
