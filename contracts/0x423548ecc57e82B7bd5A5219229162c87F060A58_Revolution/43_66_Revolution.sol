...
import {IERC721VotesStripped} from "./interfaces/IERC721VotesStripped.sol";
import "openzeppelin-contracts/contracts/access/AccessControlEnumerable.sol";
import {OwnableSkeleton} from "./utils/OwnableSkeleton.sol";

contract Revolution is OwnableSkeleton, AccessControlEnumerable {
    ...
    IERC721VotesStripped public immutable daoToken;
    ...
    constructor(
        ...
        IERC721VotesStripped _daoToken,
    ...
    modifier hasVotesOrAdmin() {
        require(
            daoToken.getVotes(msg.sender) >= MIN_VOTES || hasRole(DEFAULT_ADMIN_ROLE, msg.sender),
