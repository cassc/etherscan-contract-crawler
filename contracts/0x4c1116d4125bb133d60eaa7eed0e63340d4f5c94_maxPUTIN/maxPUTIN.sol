...
contract maxPUTIN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Maximum Putin";
    string private constant _symbol = unicode"maxPUTIN";
