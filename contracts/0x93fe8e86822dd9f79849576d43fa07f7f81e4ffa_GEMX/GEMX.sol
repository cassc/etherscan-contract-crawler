...
contract GEMX is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 50_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 1;
    uint256 private launchtax = 99;

    address public marketingWallet = 0xc574FcBc48e121f9F4ae189E85D59D6eE55c021f;
    ...
    constructor(address routerAdd) ERC20("GEMX", "GEMX") {
    ...
    function updateCooldown(bool state, uint256 time) external onlyOwner {
        ...
        require(time <= 1200, "cooldown timer cannot exceed 20 minutes");
    }
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 5_000, "Cannot set max wallet amount lower than 0.1%");
