...
contract PetPals2 is ERC721AQueryable, ReentrancyGuard, Ownable, Pausable {
    using Strings for uint256;

    event stageChanged(uint256 stage);
    event airDropped(uint256 count, address recipient);
    
    uint256 private constant WhiteListMintPrice = .007 ether;
    uint256 private constant WhiteListMintMax = 5;
	uint256 private constant PublicMintPrice = .007 ether;
    uint256 private constant PublicMintMax = 10;
    ...
    constructor() ERC721A("PetPals2", "PPALS2"){
    }
