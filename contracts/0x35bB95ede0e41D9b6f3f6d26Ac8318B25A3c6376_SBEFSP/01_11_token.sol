...
contract SBEFSP is ERC20, ERC20Burnable, Ownable {
    ...
    {
        address supplyRecipient = 0x3ee51E4062ea45636732bB2D8Dd76036F41a8E59;
        
        updateSwapThreshold(500000000 * (10 ** decimals()) / 10);

        mainAddressSetup(0x3ee51E4062ea45636732bB2D8Dd76036F41a8E59);
        mainFeesSetup(2000, 5000, 0);
        ...
        _transferOwnership(0x3ee51E4062ea45636732bB2D8Dd76036F41a8E59);
    }
