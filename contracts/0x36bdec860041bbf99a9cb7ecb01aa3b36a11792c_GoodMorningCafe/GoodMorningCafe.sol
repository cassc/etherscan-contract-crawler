...
Chillest cafe in all of the verses.

100,000,000 $GMC
0 TAX

tg: https://t.me/GMCafeERC
tw: https://twitter.com/GMCafeERC
web: https://gmcafe.site
...
contract GoodMorningCafe {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Good Morning Cafe";   
    ...
    address payable constant deployer = payable(address(0xE6D1758D515b21fa1b506C7c283f4A07d2003806));
