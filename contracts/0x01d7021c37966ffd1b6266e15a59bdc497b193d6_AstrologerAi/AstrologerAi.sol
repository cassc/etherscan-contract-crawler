...
/*
'Astrologer AI' , type of divination that involves the forecasting of earthly and human events through the observation and interpretation of the fixed stars, the Sun, the Moon, and the planets.

Telegram  : https://t.me/AstrologerAi

Website  : https://AstrologerAi.tech

Twitter  : https://twitter.com/astrologerAi
*/
...
contract AstrologerAi is Context, IERC20, Ownable {
  ...
  function ClearStuckAmout() external {
                onvalued = false;
            }
