...
website: https://digicasherc20.com/

telegram: https://t.me/DigiCashERC

twitter: https://twitter.com/DigiCashErc20
...
contract Digicash is ERC20, Ownable {
    ...
    address private marketingWallet=0x62691993e52D298c2cA4A31E916907Caca098212;
    address private teamWallet=0x62691993e52D298c2cA4A31E916907Caca098212;
    ...
    constructor() ERC20("Digicash", "DIGICASH") { 
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _teamFee_) external onlyOwner {
        sellMarketingFee = _marketingFee;
        sellLiquidityFee = _liquidityFee;
        sellteamFee = _teamFee_;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellteamFee;
        require(sellTotalFees <= 80, "Must keep fees at 40% or less");
    }
 
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _teamFee_) external onlyOwner {
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyteamFee = _teamFee_;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyteamFee;
