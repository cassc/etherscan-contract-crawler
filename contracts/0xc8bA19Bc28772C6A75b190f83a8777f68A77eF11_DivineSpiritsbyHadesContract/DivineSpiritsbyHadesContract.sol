...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0197C2720600B903bce72684E8355Ca0B8849ca6];
  address public erc20Payable = 0x0197C2720600B903bce72684E8355Ca0B8849ca6;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/MsbbQYtwvzAuYA15iOKN/contract-metadata";
  }
...
// File: contracts/DivineSpiritsbyHadesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DivineSpiritsbyHadesContract is RamppERC721A {
    constructor() RamppERC721A("Divine Spirits by Hades", "DivineByH"){}
}
