...
contract CoolRaptors is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Cool Raptors", "COOL"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Raptors...");
