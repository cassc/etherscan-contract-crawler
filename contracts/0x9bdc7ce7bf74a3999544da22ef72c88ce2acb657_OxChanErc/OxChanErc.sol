 ...
 * allowances. See {IERC20-approve}.
 */
 contract OxChanErc is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "0xChan";
    ...
    address public marketingWallet = 0x97323F6ce3f86c60e0EA221D8E2fC5b53a5429aB;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 10000000000 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 10000000000 * 10**_decimals;
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 100, "total tax must not be greater than 1");
