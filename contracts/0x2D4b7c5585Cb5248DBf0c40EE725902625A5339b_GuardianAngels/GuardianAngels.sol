...
contract GuardianAngels is ERC20, Ownable {
    ...
    constructor() payable ERC20("Guardian Angels", "Angels") {
        ...
        operationsAddress1 = address(0xe1c848EeC7D23AF03ee40DEc05a5Ecdd37970330); //80%
        operationsAddress2 = address(0x3c2A46Ce4781BdE023db5AB489ACa56a05d03fef); //20%
