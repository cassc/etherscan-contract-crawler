...
contract GAPED is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "GAPED";
    string private constant _symbol = "GAPED";
    ...
    address payable private _developmentAddress = payable(0x2fF32f0b5E4b11A0049c09a2be96f7EdCf85BEdb); 
    address payable private _marketingAddress = payable(0x2fF32f0b5E4b11A0049c09a2be96f7EdCf85BEdb);
