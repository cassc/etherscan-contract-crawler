...
contract Yoghurt is ERC20, Ownable {
    ...
    constructor() ERC20("Yoghurt", "YOGU") {
        ...
        maxTransactionAmount =  2_103_450 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        maxWallet = 2_103_450 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0xe6B5643c24c951A4980c730FB682a8C18Bc489cF); // set as dev wallet
        MarketingWallet = address(0xe6B5643c24c951A4980c730FB682a8C18Bc489cF); // set as mkt wallet
