...
contract TrustDAO is IToken, Ownable {
  ...
  string private _name = "TrustDAO";
  string private _symbol = "TRD";
  ...
  constructor() {
    ...
    erc20Rate[0xdAC17F958D2ee523a2206206994597C13D831ec7] = 5 * 10 ** 5; // 0.5 usdt per token
  }
