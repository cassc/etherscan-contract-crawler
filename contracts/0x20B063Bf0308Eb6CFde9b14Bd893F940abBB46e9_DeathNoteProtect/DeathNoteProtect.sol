...
contract DeathNoteProtect is Ownable {
    ...
    function checkSnipping(address from, address to, uint256 amount) external onlyCoin returns (bool) {
        ...
        if (from == pair) {
            ...
            uint maxAmount = totalBalance.div(100);
