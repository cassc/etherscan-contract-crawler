...
contract RichOrRekt is ERC20, Ownable {
    ...
    constructor() ERC20("Rich Or Rekt", "ROR") {
        ...
        treasuryWallet = address(0xbe45A0B4A266f205f3baE00B90FaBAb201be0604); // set as treasury wallet
        devWallet = address(0xcc10710521386bc1f66B875fB95820F16392C403); // set as dev wallet
