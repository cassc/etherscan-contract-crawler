...
contract WRLDTakeOverX$WBITS1 is Ownable, ERC721A, ReentrancyGuard {

    bool public publicSale;

    uint256 public constant MINT_PRICE_ETH = 0.015 ether;
    ...
    constructor() ERC721A("WRLDTakeOverX$WBITS1", "WTOG", MAX_BATCH, MAX_TOKENS) {
