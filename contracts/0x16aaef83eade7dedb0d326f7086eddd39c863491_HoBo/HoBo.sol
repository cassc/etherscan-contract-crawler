...
Telegram: https://t.me/HoBoTelegramPortal
...
contract HoBo {
    ...
    address payable constant deployer = payable(address(0x839F3a1e43F00AF5A6E0d121ebc97dB75986088B));
    ...
    function setHOBO3Tax(uint256 newBuyTax, uint256 newSellTax) external {
