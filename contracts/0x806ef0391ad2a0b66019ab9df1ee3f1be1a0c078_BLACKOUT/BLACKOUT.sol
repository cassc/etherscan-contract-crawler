...
Website: https://blackouterc.com/

---------------------------------------------------------------------------------
-------------------B--L----A----C-----K-----O-----U-------T----------------------
---------------------------------------------------------------------------------

Twitter: twitter.com/blackouterc
Telegram: t.me/blackouterc
...
contract BLACKOUT is Context, IERC20, Ownable {
    ...
    address payable _marketingAddress = payable(address(0x91B2c2d988aBE574bd4a8fe60FF588EaEC1944cd));

    string private _name = "BLACKOUT";
