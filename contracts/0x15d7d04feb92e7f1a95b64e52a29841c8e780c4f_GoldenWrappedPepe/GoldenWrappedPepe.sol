...
/* 
Web: https://goldenwrappedpepe.org
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣀⣀⣀⠀⠀⠀⠀⠀⠀⠀⣀⣀⣀⣀⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⣀⣤⠤⠤⣴⣟⡁⠀⠀⠉⠉⠓⠶⣄⣤⣖⣉⡁⠀⠀⠀⠈⠉⠳⢤⡀⠀⠀⠀⠀⠀
⠀⠀⠀⣠⠴⣚⣉⣭⣬⣉⣙⠲⢄⡈⠁⣀⣤⠤⠾⠿⠶⠶⠤⢤⣀⡈⠉⠙⠲⢦⡀⠀⠙⣶⡀⠀⠀⠀
⠀⢀⡼⢗⣋⣁⡀⠀⠀⠀⠈⠙⠲⡍⢳⡯⠔⠒⠛⠉⠉⠉⠙⠒⠪⣝⡒⢄⡀⠀⠈⠂⠀⢰⠙⣆⠀⠀
...
⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠉⠙⠓⠒⠒⠒⠒⠒⠚⠋⠉⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
*/
contract GoldenWrappedPepe is ERC20, Ownable {
    ...
    constructor() ERC20("Golden Wrapped Pepe", "GLDWPEPE") {
        ...
        maxTransactionAmount =  4_206_900_000 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        maxWallet = 4_206_900_000 * 1e18; // 1.5% from total supply maxWallet
        ...
        mktWallet = address(0x3ECef6201b4d71a340064174764ED313d7e630Eb); // set as mkt wallet
        devWallet = address(0xC9d54FFf72Df5051E268567AaFF9510049F4123b); // set as dev wallet
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 31, "Must keep fees at 10% or less");
    }
