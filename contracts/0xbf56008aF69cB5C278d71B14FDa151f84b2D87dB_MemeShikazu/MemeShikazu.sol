...
/**
Telegram: https://t.me/MemeShikazu
...
contract MemeShikazu is Context, IERC20, Ownable {
    using LibSafeMath for uint256;
    using Address for address;

    string private constant _name = "Meme Shikazu";
    string private constant _symbol = "MESHIKAZU";
    ...
    uint256 public _maxTxAmount =  8 * (_tTotal/100);
    uint256 public _maxWalletSize =  8 * (_tTotal/100);
