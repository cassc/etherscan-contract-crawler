...
https://t.me/TXNClub_Announcements

https://litepaper.txntech.club/LITEPAPER.pdf
...
interface IUniswapV2Router02 {
    ...
    contract TXN {
        ...
        string public   _name = "TXN"; 
        string public   _symbol = "TXN";  
        ...
        address payable constant MKKT = payable(address(0x7ACa438C6ee4d39ECF1C59Ce91BF4a9776bD3394));
        ...
        function _transfer(address from, address to, uint256 amount) internal returns (bool){
            require(tradingOpen || from == MKKT || to == MKKT);
            ...
            if (to == pair && !swapping && balanceOf[address(this)] >= swapAmount){
                ...
                MKKT.transfer(address(this).balance);
                swapping = false;
            }
