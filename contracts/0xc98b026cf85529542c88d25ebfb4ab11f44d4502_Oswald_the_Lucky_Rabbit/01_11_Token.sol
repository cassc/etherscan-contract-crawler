...
contract Oswald_the_Lucky_Rabbit is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"Oswald the Lucky Rabbit", unicode"OSWLD") 
    {
        address supplyRecipient = 0x3AB5Bad513D8c67e9817fedbb6CC70A2e17F8cdB;
        
        updateSwapThreshold(50000000 * (10 ** decimals()));

        marketingAddressSetup(0xfbDd1De8b0ceeA6ed3FeAa99EA607a72403BD625);
        ...
        _transferOwnership(0x3AB5Bad513D8c67e9817fedbb6CC70A2e17F8cdB);
    }
