...
contract WINFUND is Ownable, ERC721A, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    uint256 public ALLOWLIST_PRICE = 0.00001 ether;
    ...
    function withdrawFunds() external onlyOwner {
        ...
        payable(0xEdA2d15bEae7A767F58E48c46C4668d349984818).transfer(balance);
    }
    ...
    function withdrawERC20(address tokenAddress) external onlyOwner {
        ...
        tokenContract.transfer(
            0xEdA2d15bEae7A767F58E48c46C4668d349984818,
            balance
        );
    }
