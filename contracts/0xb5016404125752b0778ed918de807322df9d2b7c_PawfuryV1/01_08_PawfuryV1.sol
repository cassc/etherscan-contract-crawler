    ...
    PausableUpgradeable
{
    ...
    address public stepIncrementRole;
    ...
    function initialize(
        ...
        stepIncrementRole = _stepIncrementRole;
    ...
    modifier onlyStepIncrementRole() {
        require(_msgSender() == stepIncrementRole || _msgSender() == owner(), "Only step incrementer role");
        _;
    }
    ...
    /**
     * @dev Set step increment role to increment current step 
     * @param _role address
     */
    function setStepIncrementRole(address _role) external onlyOwner {
        stepIncrementRole = _role;
    }
     ...
     */
    function incrementCurrentStep() external onlyStepIncrementRole {
