...
contract SNOWFLAKE is IERC20 {
    ...
    string constant private _name = "Snow";
    string constant private _symbol = "FLAKE";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xdEe607aCEb5Bf1778cc48B21Aed006e1c391c367),
        development: payable(0xc2a6A661315D1AF442B45B2b9ee1d8C4Db5aC12E)
    });
    ...
    uint256 private _maxTxAmount = (_tTotal * 7) / 1000;
