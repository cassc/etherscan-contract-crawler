...
contract WTF is ERC20, Ownable {
    ...
    constructor() payable ERC20("DoubleYouTeeEff", "$WTF") {
        ...
        communityAddress = address(0x1A93aA828871f2a851D056869eDa94373DbA9a7B);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x52b505Fdd7E55D5eA950013Ce295B0eC08E5CefC),
            block.timestamp
        );
    }
    ...
    function runLaunchR() external onlyOwner {
        buyCommunityFee = 0;
        buyLiquidityFee = 0;
        buyTotalFees = buyCommunityFee + buyLiquidityFee;
