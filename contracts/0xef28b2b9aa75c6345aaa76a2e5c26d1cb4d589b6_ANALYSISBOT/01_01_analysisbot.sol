...
Webiste:   https://analysisbot.net/
Twitter:   https://twitter.com/ANALYSIS__BOT
Telegram:  https://t.me/analysisbot_portal
*/
...
contract  ANALYSISBOT is ERC20, Ownable {
    ...
    constructor() ERC20("ANALYSIS BOT", "ANA BOT") {
        ...
        maxTransactionAmount =  100_000 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        maxWallet = 400_000 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0xB11210088498bA312Da61e7081988484F734E1CC); // set as dev wallet
        MarketingWallet = address(0xB11210088498bA312Da61e7081988484F734E1CC); // set as mkt wallet
