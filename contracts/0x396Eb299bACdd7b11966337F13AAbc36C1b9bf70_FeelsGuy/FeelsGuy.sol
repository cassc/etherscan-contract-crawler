...
// Wojak (/ˈwoʊdʒæk/; WOH-jak, from Polish wojak [vɔjak], loosely 'soldier' or 'fighter'), also known as Feels Guy, is an Internet meme that is, in its original form, a simple, black-outlined cartoon drawing of a bald man with a wistful expression. The origin of the Wojak illustration is unknown.
...
contract FeelsGuy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Feels Guy";
    string private constant _symbol = "FGUY";
