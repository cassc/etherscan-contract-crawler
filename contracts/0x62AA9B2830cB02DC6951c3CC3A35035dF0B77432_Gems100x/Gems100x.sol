...
100xgems is a holder first token. 
2 percent of every buy and every sell will go to a holder bid wallet. 
When a specific criteria is met the elected team will vote on what projects 
to buy tokens from as well as how much and set targets to sell. 
The goal is to increase profits substantially and then return those profits to holders.

Links:
Http://100xgems.Biz
https://t.me/I00xgemsbiz
Twitter.com/100xgemsBiz
https://www.instagram.com/100xgemsBiz/
*/
...
contract Gems100x is ERC20, Ownable{
    ...
    bool public whaleTaxEnabled = true; // Allows you to turn whale tax off and on
    ...
    uint256 public whaleSellAmount = 5_000_000 * 10**18; //Doubles fees on sells over 1% of circulating supply
    
    address public marketingWallet = 0xC03B179dEbDf0C54AC63666fCBBCB099B2278ebF;
    address public devWallet = 0xA035Dcb09a6Fac97C6cC1df5c9A917b52f628f9B;
    ...
    struct Taxes {
        ...
        uint256 dev;
                            ...
                            // M,L,D 
    Taxes public taxes = Taxes(1,4,1);
    Taxes public sellTaxes = Taxes(1,4,1);
    ...
    constructor() ERC20("100xGems", "100xGems") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        //calculate fee
            ...
            if(recipient == pair) {
                // If sell is over 1%, then double taxes when whaleTaxEnabled is true
                if (amount > whaleSellAmount && whaleTaxEnabled) {
                    fee = amount * (totSellTax * 2) / 100;
                } else {
    ...
    function enableWhaleTax(bool state) external onlyOwner{
        require(!state, "Whale Tax is already set to this");
        whaleTaxEnabled = state;
    }

    function setTaxes(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        require(_marketing + _liquidity + _dev <= 20, "Max fee is 20%");
