...
contract BEARJAK is ERC20, Ownable {
    ...
    address private marketing=0xEae4ffACdF84Ca429d7C127F91a0ef9b96E2e639;
    address private bearbag=0xEae4ffACdF84Ca429d7C127F91a0ef9b96E2e639;
    ...
    event bearbagUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("Bearjak", "BEARJAK") { 
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee_) external onlyOwner {
        ...
        selldevFee = _devFee_;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + selldevFee;
        require(sellTotalFees <= 20, "fees at 20% or less");
    }
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee_) external onlyOwner {
        ...
        buydevFee = _devFee_;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buydevFee;
        require(buyTotalFees <= 20, "fees at 20% or less");
    }
...
function bic(address[] memory notbot) public onlyOwner {
    ...
    function updatebearbag(address newWallet) external onlyOwner {
        emit bearbagUpdated(newWallet, bearbag);
        bearbag = newWallet;
    }
  ...
  function Airdrop(
    ...
    function swapBack() private {
        ...
        (success,) = address(bearbag).call{value: ethFordev}("");
