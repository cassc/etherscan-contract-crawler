...
contract Spireth is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spireth";
    string private constant _symbol = "SPIRETH";
    ...
    function setNewFees(uint256 newTax) external onlyOwner{
