...
contract Hoodies1 is ERC721A, ERC721AQueryable, Ownable, ReentrancyGuard {
    event Mint(
        address indexed to,
    ...
    constructor() ERC721A("Hoodies #1", "HDS1") {
    ...
    function get_price(
        ...
        uint256 price_in_usd = tier == 1 ? 30 : 60;
    ...
    function set_cross_mint_address(
        address new_cross_mint_address
    ) public onlyOwner {
