...
/**
// Bob Seeks Revenge, It seems Elon has become Woke , he decides to cancel Our almighty Twitter Bot because he assumes its a scam  
// Bob has come for vengence 
// 
*/ 
...
contract RevengeOfBob is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "RevengeOfBob"; 
    string private constant _symbol = "ROB";
    ...
    address payable private _developmentAddress = payable(0x214D46Cada8680a9f33F60437145BE77F6E3a568); 
    address payable private _marketingAddress = payable(0x9422cC52741bB05AcD023786A8A2B1e675745c6D);
