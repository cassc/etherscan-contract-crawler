...
/**
  Website:  https://lowiq.online/
  Twitter:  https://twitter.com/LOWIQERC
  Telegram: https://t.me/lowiqerc
...
contract LOWIQ is ERC20, Ownable {
    ...
    string private constant NAME = unicode"LOWIQ";
    string private constant SYMBOL = unicode"LOWIQ";
    ...
    constructor() ERC20(NAME, SYMBOL) {
        ...
        maxWallet = maxTransactionAmount = (maxSupply * 5) / 100; // 5%
        swapTokensAtAmount = (maxSupply * 1) / 1000; // 0.1%

        marketingWallet = _msgSender();

        buyTax = Taxes(15, 0, 15); // Final tax 5/5
        sellTax = Taxes(20, 0, 20); // Final tax 5/5  
