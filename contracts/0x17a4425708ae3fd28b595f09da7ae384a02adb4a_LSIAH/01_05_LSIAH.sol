...
/// @title: Laurie Simmons: In and Around the House II
/// @author: manifold.xyz
...
contract LSIAH is ERC721Creator {
    constructor() ERC721Creator("Laurie Simmons: In and Around the House II", "LSIAH") {}
}