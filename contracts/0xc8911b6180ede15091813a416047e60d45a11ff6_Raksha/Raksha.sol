...
/**be part of the change by supporting $RAKSHA!**/
...
contract Raksha is Ownable, Pausable, ERC20, ERC20Burnable {
/** our official social media are: 
twitter.com/rakshacoin
telegram: t.me/rakshacoin
instagram: instagram.com/rakshacoin
website: www.rakshacoin.bond
username for all social media is @rakshacoin
**/
  /** Total amount of tokens */
  uint256 private constant  TOTAL_SUPPLY    = 44_000_000_000_000 ether;
  uint256 private constant  RESERVE         = 22_000_000_000_000 ether;
  /** Allocation for presale buyers and LP */
  uint256 private constant  PRESALE    = 22_000_000_000_000 ether;
  /** Max buy amount per tx */
  uint256 public constant   MAX_BUY         = 400_000_000_000 ether;
  ...
  constructor(address _fab) ERC20("RAKSHA THE WOLF", "RAKSHA") Ownable() {
    whitelist[msg.sender] = true;
    whitelist[_fab] = true;

    if (RESERVE + PRESALE != TOTAL_SUPPLY) { revert IncorrectSum(); }

    _mint(_fab, RESERVE + PRESALE);
 ...
 /**
   ...
   * Unleash raksha
   */
  function unleashraksha() external onlyOwner {
    _unrestricted = true;
    renounceOwnership();
  }
