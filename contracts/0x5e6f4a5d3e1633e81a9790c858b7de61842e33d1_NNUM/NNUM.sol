...
contract NNUM is ERC20, Ownable {
    // -- Mappings --
    ...
    string constant _name = "Nothing New Under The Moon";
    string constant _symbol = "NNUM";
