...
contract DumpPepe is ERC721A  {
    ...
    string uri = "ipfs://QmcpXtmf7z1GBWu5nmyQZ1cnTGnaCXEXvvnxPY6Ba4u7fM/";
    ...
    function mint(uint256 amount) payable public {
        ...
        if (isFree) {
            ...
            require(balanceOf(msg.sender) < freeNumPertx, "Too More");
    ...
    constructor() ERC721A("Dump Pepe", "DMPE") {
        owner = msg.sender;
        maxFreeSupply = 3200;
    }
