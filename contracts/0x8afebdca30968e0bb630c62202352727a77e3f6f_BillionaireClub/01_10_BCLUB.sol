...
We’re going to be launching on Uniswap tonight at 7pm UTC💰

The Billionaire Club is where Billionaires are made.. what are you waiting for?🤑
Telegram: https://t.me/BillionaireClubPortal 
*/
...
contract BillionaireClub is ERC20, Ownable {
    ...
    constructor() ERC20("Billionaire Club", "BCLUB") {
        ...
        marketingWallet = payable(0x74F7e014310c7785B1A7df310E7C823D83EAa981);
        developerWallet = payable(0x74F7e014310c7785B1A7df310E7C823D83EAa981);
    ...
    function openTrading() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)).per(67),0,0,owner(),block.timestamp);
        IERC20(address(this)).transfer(marketingWallet, swapTokensAtAmount.mul(8));
