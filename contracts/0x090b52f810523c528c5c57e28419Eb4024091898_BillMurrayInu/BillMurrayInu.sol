...
/**
Yes, we stole $BMINU (BSC) website. No, we are not the same team. Yes, we will flip them.

BSC version is currently at $1.7M MC, surely the ERC chads are able to flip them! $BMINU (ERC) offers 1/3 of the taxes compared to the BSC version.
...
Website: https://billmurrayinuERC.com
Telegram: @BillMurrayInuERC
*/
...
contract BillMurrayInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BMINU";
