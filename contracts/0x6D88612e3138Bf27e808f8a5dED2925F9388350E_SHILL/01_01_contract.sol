...
Website - https://shillraidbot.com/
Telegram - https://t.me/shillraidbot
X - https://twitter.com/shillraidbot
...
contract SHILL is Ownable, ERC20 {
    ...
    string constant _name = "ShillRaidBot";
    string constant _symbol = "RAIDBOT";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x4fF57E4aee7dad7066D7B0A5Bd50843Dfb73585a;
    ...
    function setMaxTransactionAmount(uint256 maxTXPercent) public {
        require(isliveed[msg.sender]);
