 ...
 * @notice This contract handles minting KORE - YELLOW KEYS COLLECTION tokens.
 */
contract KOREYELLOWKEYSCOLLECTION is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x98F9Bd0eb74AB34C0667313eF7021a935a54dE49;
    ...
    address public royaltyAddress = 0xb589c1fdfb240D5a5B2BA7A1C146F3C5Fb436d0A;
    address[] public payoutAddresses = [
        0xb589c1fdfb240D5a5B2BA7A1C146F3C5Fb436d0A
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeibbzvrjca2nhaguoy3anivnqaswo62tk6slsqhmuf7irohz66ut2m/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 500;
    // Total number of tokens available for minting in the presale
    uint256 public constant PRESALE_MAX_SUPPLY = 75;
    ...
    constructor(address _blocklistContractAddress)
        ERC721A("KORE - YELLOW KEYS COLLECTION", "KORE")
    {
