...
abstract contract GnosisSafeOwner is Initializable {
     ...
     */
    function __GnosisSafeOwner_init() internal onlyInitializing {
        __GnosisSafeOwner_init_unchained();
    }

    function __GnosisSafeOwner_init_unchained() internal onlyInitializing {
        // REMOVED IN V2
    }
