...
contract GLDSHIB is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GOLDEN SHIBA", unicode"GLDSHIB") {
        ...
        maxBuyAmount = totalSupply * 9 / 1000; // 0.9% maxBuyAmount
        maxSellAmount = totalSupply * 9 / 1000; // 0.9% maxSellAmount
        maxWalletAmount = totalSupply * 9 / 1000; // 0.9% maxWallet
        thresholdSwapAmount = totalSupply * 1 / 1000; 

        _fees.buyMarketingFee = 9;
