...
contract VoolaBridgeArb is Ownable{
    ...
    function deposit(uint amount,uint chainid) public payable {
        require(isValidChainID(chainid), "VoolaBridge: invalid chainid");
        require(amount>=minTransferAmount, "VoolaBridge: amount is less than minTransferAmount");
