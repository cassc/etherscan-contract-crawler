...
contract Tamacat is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Tamacat";
    string private constant _symbol = "TAMACAT";
    ...
    address payable private _developmentAddress = payable(0x83F041B3a8d380AD8e5BedD0BaEdaA781FE14964); 
    address payable private _marketingAddress = payable(0x83F041B3a8d380AD8e5BedD0BaEdaA781FE14964);
