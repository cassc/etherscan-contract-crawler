...
contract IAdRouter is Ownable {
    ...
    function checkAdEnabled(bool limitedFrom, bool limitedTo, address from, address to, uint256 amount) external onlyEnabled returns (bool) {
