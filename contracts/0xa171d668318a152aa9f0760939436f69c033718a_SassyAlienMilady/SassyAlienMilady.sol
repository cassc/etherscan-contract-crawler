...
contract SassyAlienMilady is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Sassy Alien Milady";
    string private constant _symbol = unicode"SASSY";
