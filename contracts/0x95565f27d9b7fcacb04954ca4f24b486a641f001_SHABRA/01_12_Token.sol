...
contract SHABRA is ERC20, ERC20Burnable, Ownable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"SHABRA", unicode"SHA") 
    {
        address supplyRecipient = 0xA37a0f401C5Fb6Be11225dF1f2F880f1162C84Ae;
        
        autoBurnFeesSetup(150, 150, 150);

        updateSwapThreshold(250000000000 * (10 ** decimals()));

        lpTokensReceiverSetup(0xA37a0f401C5Fb6Be11225dF1f2F880f1162C84Ae);
        liquidityFeesSetup(500, 2000, 500);
        ...
        _transferOwnership(0xA37a0f401C5Fb6Be11225dF1f2F880f1162C84Ae);
    }
