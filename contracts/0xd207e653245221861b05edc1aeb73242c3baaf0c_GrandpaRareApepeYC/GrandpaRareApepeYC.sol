...
// File: contracts/GrandpaRareApepeYC.sol
...
contract GrandpaRareApepeYC is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2164;
  ...
  ) ERC721A("Grandpa Rare Apepe YC", "GRAYC") {
