...
Token Name: UNILABS BOT
Ticker: UNILAB
Supply: 100,000,000

$UNILAB a Telegram Contract Deployer Bot powered and finance by $UNIBANK. 

UNIBANK x UNILAB

A finance firm. 
A mixer utility. 
A telegram contract deployer bot. 
...
contract UNILAB is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"UNILABS BOT";
    string private constant _symbol = unicode"UNILAB";
