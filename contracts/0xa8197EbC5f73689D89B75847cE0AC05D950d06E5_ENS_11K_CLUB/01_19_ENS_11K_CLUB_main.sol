    ...
    DefaultOperatorFilterer
{
    ...
    IBaseRegistrar private immutable _ENS;
    string private _baseURIextended;

    constructor(IBaseRegistrar contractENS, string memory ensBaseURI) ERC721("ENS 11K CLUB", "W11K") {
        _ENS = contractENS;
        _baseURIextended = ensBaseURI;
    }

    function ENS() public view virtual returns (IBaseRegistrar) {
        return _ENS;
    }
    ...
    function setController(uint256 tokenId, address controller) external {
        ...
        ENS().reclaim(digitHash[tokenId], controller);
    }
