...
contract PepeAllah  is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"Pepe Allah";
    string private constant _symbol = unicode"PEPEALLAH";
