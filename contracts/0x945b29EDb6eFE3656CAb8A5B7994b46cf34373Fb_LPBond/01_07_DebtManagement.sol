...
contract LPBond is ERC20, Ownable() {
    ...
    function purchaseBond(uint256 bondPeriod) public payable{
        ...
        uint256 ethBalBefore = address(this).balance - msg.value;
        uint256 YINUBalanceBefore = IERC20(bondToken).balanceOf(address(this));
    ...
    function zapAndStakeETHOnly(uint256 _lockOptIndex) external payable {
        ...
        uint256 _yinuBalBefore = IERC20(bondToken).balanceOf(address(this));
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        );
        ...
        uint256 _lpBalBefore = IERC20(bondToken).balanceOf(address(this));
        _addLp(IERC20(bondToken).balanceOf(address(this)) - _yinuBalBefore, msg.value / 2);
        uint256 _lpBalanceToStake = IERC20(bondToken).balanceOf(address(this)) -
        _lpBalBefore;
