...
contract FRBC is ERC20, Ownable {
    ...
    constructor() payable ERC20("First Republic Bank of Crypto", "BANK") {
        ...
        treasuryAddress = address(0xEEF8C380aBbA59b6A5341E363dAf8fa9031923b0);
        ...
        _excludeFromMaxTransaction(
            address(0xC04157d3A65d59e0175D4e9FCB53432e41d2C7aD),
            true
        ); // Listings
        _excludeFromMaxTransaction(
            address(0xC57c86DA56e1f9E63bBb0445bf53d9f4cbCeD9Aa),
            true
        ); // Team
        _excludeFromMaxTransaction(
            address(0x915498bC3776E7570322062F15E15Ecd19AC7EA2),
            true
        ); // Partners - Multisig
        _excludeFromMaxTransaction(
            address(0xEEF8C380aBbA59b6A5341E363dAf8fa9031923b0),
            true
        ); // Operator
