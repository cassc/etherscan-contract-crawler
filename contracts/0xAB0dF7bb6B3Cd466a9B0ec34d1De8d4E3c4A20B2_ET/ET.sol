...
/*
* ET - Phone Home
* Be careful - anti sniper launch tax 60%
* Reducing to 50% -> 40% -> 30% -> 20% -> 10% -> 5% -> 3%
* Lock and renounce at 3%
*/
...
contract ET is ERC20, Ownable {
    string private _name = "Phone Home";
    string private _symbol = "ET";
    uint8 private _decimals = 18;
    uint256 private _supply = 20000;
    ...
    uint256 private _numTokensSellToAddToLiquidity = 22 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 12 * 10**_decimals;
