 ...
 * @notice This contract handles minting Generative Checks tokens.
 */
contract GenerativeChecks is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0xeaad07fB8e94dabd949a1EB4F57f81B1500939BE;
    address[] public payoutAddresses = [
        0xeaad07fB8e94dabd949a1EB4F57f81B1500939BE
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeidmqoixuez5cnzih4z52kslfjupzgp7b6rrepejohomvpmo2hotci/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 1369;
    uint256 public publicMintsAllowedPerAddress = 2;
    uint256 public publicMintsAllowedPerTransaction = 1369;
    ...
    uint96 public royaltyFee = 1369;

    constructor(address _blocklistContractAddress)
        ERC721A("Generative Checks", "GCHECKS")
    {
