...
contract KENCHOI is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "KENCHOI";
    string private constant tokenSymbol = "KENCHOI";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x3EaB1A6B864ff4D30a1a426FDF246F4dA1f09862);
        devAddress = payable(0x3EaB1A6B864ff4D30a1a426FDF246F4dA1f09862);
