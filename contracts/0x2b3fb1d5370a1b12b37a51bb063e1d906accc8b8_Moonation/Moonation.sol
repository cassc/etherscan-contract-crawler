...
contract Moonation is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xcF7343cEF074d6F6dC7e5ce37983B3bD0367471f); // Marketing Wallet
    address payable private devWallet = payable (0xcF7343cEF074d6F6dC7e5ce37983B3bD0367471f); // dev Wallet
    ...
    string private _name = "Moonation";
    ...
    uint256 public _sellMarketingFee = 50;  //10%
    uint256 public _sellDevFee = 50;   //10%
    ...
    uint256 public swapThreshold = _tTotal.div(1000).mul(3); //0.2%
    ...
    function setzeroTaxmode(bool _status) external onlyOwner() {
       zeroTaxmode=_status;
    }
