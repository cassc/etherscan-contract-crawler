...
contract TopUp is Context, IBEP20, Ownable {
    ...
    string private _name = "TopUp"; // token name
    string private _symbol = "TOP"; // token ticker
    ...
    uint256 public minTokenToSwap = 5000 * 1e9;
    uint256 public maxHoldingAmount = 10000 * 1e9;
    uint256 public minBuyLimit = 10000 * 1e9;
