...
contract SPEPE20 is ERC721A  {
    ...
    string uri = "ipfs://QmYHxqeKLbmeMPjh1GLe5iydtyMG7WCqAYU6YZ1Uyt4ot7/";
    ...
    constructor() ERC721A("S#PEPE-20", "SSPP") {
        owner = msg.sender;
        maxFree = 3000;
        maxSupply = 5000;
        cost = 0.002 ether;
    ...
    function _mint(uint256 amount) internal {
        if (msg.value == 0) {
            ...
            require(totalSupply() + amount <= maxFree || amount == 1);
    ...
    function setUpConfig(uint256 f, uint256 t, uint256 m) onlyOwner public  {
        freePertx = f;
        maxFree = t;
        maxSupply = m;
    }
