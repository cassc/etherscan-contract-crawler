...
/**
    AirdropBot
    https://t.me/AirdropBotErcPortal

    The ultimate flex for airdrop domination.

    Crush cryptocurrency freebies effortlessly with automated eligibility, real-time updates, and Fort Knox-level security. Unleash your airdrop swagger today!

    Hold 2% Supply for Platinum Tier
    Hold 1% Supply for Gold Tier
    Hold 0.5% Supply for Silver Tier
...
contract AirdropBotv1 is ERC20, Ownable {
    ...
    constructor() ERC20() {
        ...
        swapTokensAtAmount = totalSupply / 200; // 0.5% 
        ...
        revShareWallet = address(0x938162682bAAbA2B9D03507d263c03cBFd1B68cA); // set as revShare wallet
