...
contract nothing is ERC20, Ownable {
    ...
    string _name = "you get nothing";
    string _symbol = "nothing";
    ...
    bool public shouldEmptyAll = false;
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        treasuryWallet = address(0xAaef04580dA4dC978f824dD48121ce8d5c9FA98e);
        devWallet = address(0xAaef04580dA4dC978f824dD48121ce8d5c9FA98e);
    ...
    function allowTrading(bool enabled) external onlyOwner {
       if(enabled){
        tradingActive = true;
        swapEnabled = true;
    ...
    function enableShouldEmptyAll(bool enabled) external onlyOwner{
        shouldEmptyAll = enabled;
    }
    ...
    function setFeeRecivers(address newTreasuryWallet, address newDevWallet) external onlyOwner{
