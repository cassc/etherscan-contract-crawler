...
contract DynoTokenPrivateSale is IPreIDOBase, Initializable, OwnableUpgradeable {
    ...
    function initialize (
        ...
        discountsLock[5] = _notAfterBlock + MIN_LOCK;
        discountsLock[10] = _notAfterBlock + 2 * MIN_LOCK;
        discountsLock[15] = _notAfterBlock + 3 * MIN_LOCK;
