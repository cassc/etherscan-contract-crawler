...
contract ShibaDoge2 is ERC20, Ownable {
    ...
    constructor() ERC20("ShibaDoge2.0", "ShibDoge2.0") {
        ...
        uint256 totalSupply = 420 * 10**21 * 1e18;

        maxTransactionAmount = 8.4 * 10**19 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 8.4 * 10**19 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x19da47c67c93a9a414Bb23B3E4b46794eaccC68a); 
        marketingWallet = address(0x19da47c67c93a9a414Bb23B3E4b46794eaccC68a); 
        devWallet = address(0x19da47c67c93a9a414Bb23B3E4b46794eaccC68a);
