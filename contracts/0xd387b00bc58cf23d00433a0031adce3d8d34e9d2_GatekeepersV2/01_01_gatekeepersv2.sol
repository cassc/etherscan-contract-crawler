...
// File contracts/gatekeepeers.sol
pragma solidity ^0.8.13;

error WithdrawFailed();

contract GatekeepersV2 is ERC721AQueryable, ReentrancyGuard, ERC2981, Ownable {

    string private _baseTokenURI;
    uint public MAX_SUPPLY = 836;

    constructor() ERC721A("GatekeepersV2", "GKV2") {}
    ...
    function airdrop(uint256 quantity, address[] memory _toAddresses) external onlyOwner {
        require(
            totalSupply() + (quantity * _toAddresses.length) <= MAX_SUPPLY,
