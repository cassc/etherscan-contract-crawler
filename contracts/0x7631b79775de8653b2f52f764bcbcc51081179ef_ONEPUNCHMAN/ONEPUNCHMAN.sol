...
_____ _   _  _____  ______ _   _ _   _ _____  _   _  ___  ___  ___   _   _ 
|  _  | \ | ||  ___| | ___ \ | | | \ | /  __ \| | | | |  \/  | / _ \ | \ | |
| | | |  \| || |__   | |_/ / | | |  \| | /  \/| |_| | | .  . |/ /_\ \|  \| |
| | | | . ` ||  __|  |  __/| | | | . ` | |    |  _  | | |\/| ||  _  || . ` |
\ \_/ / |\  || |___  | |   | |_| | |\  | \__/\| | | | | |  | || | | || |\  |
 \___/\_| \_/\____/  \_|    \___/\_| \_/\____/\_| |_/ \_|  |_/\_| |_/\_| \_/
...
contract ONEPUNCHMAN is Context,IERC20, Ownable{
    ...
    string private _name = "ONEPUNCHMAN";
    string private _symbol = "ONEPUNCHMAN";
    ...
    uint256 private _totalSupply = (69000000 * 10**4) * 10**_decimals; //
    ...
    address _owner;
    address payable public marketingAddress = payable(0x6B38AC7c8bd08d32E2B7e33c8178D4b08612e769);
    ...
    function OPMDay() public onlyOwner{
         require(block.timestamp > OPMDaycooldown, "You cant call OPMCoinDay more than once a day");
    ...
    function OPMCoinDayOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         OPMDaycooldown = block.timestamp + 86400;
    }
