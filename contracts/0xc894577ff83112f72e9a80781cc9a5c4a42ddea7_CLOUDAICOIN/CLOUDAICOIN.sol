 ...
 * Telegram:  https://t.me/CLOUDAiCoin 

 * Website: https://cloudai.finance
*/
...
contract CLOUDAICOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CLOUDAI", "CLOUD") {
        ...
        maxBuyAmount = totalSupply / 50; // 2% maxTransactionAmountTxn
        maxSellAmount = totalSupply / 50; // 2% maxTransactionAmountTxn
        ...
        marketingWallet = address(0x6E4d7ccf902A26129793eb195B3715Cc42cF5b7E);
        contestAIWallet = address(0xf58f702031EA1a2b61C94a45AE759D7FebA3FdBf);
