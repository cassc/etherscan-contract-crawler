...
import "DfxDistributorEvents.sol";
...
/// @title DfxDistributor
/// @author Forked from contracts developed by Curve, Frax and Angle and adapted by DFX
...
contract DfxDistributor is DfxDistributorEvents, ReentrancyGuardUpgradeable, AccessControlUpgradeable {
    ...
    /// @notice Address of the DFX token given as a reward
    ...
    /// @notice Changes the DFX emission rate
    /// @param _newRate New DFX emission rate
