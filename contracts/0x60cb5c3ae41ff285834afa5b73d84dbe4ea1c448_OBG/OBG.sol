...
contract OBG is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Old But Gold"; 
    string private constant _symbol = "OBG"; 
    ...
    address payable private _developmentWalletAddress = payable(0xa5133cE4400C74498caB9d59a5C4fB92cA00b7Ef);
    address payable private _marketingWalletAddress = payable(0xa5133cE4400C74498caB9d59a5C4fB92cA00b7Ef);
