...
contract PepePoo is Context, IERC20, Ownable {
    ...
    uint256 private constant _theTotalSupply = 10000000 * 10**_decimals;
    string private constant _name = unicode"Pepe Poo";
    string private constant _tickerSymbol = unicode"pepepoo";
