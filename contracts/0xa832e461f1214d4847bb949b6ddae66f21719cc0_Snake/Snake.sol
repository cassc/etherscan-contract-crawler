...
contract Snake is Context, IERC20, Ownable {
    string private _name = "Snake";
    string private _symbol = "Snake";
    ...
    uint256 public minTokenToSwap = (_totalSupply * 5) / (500000000); // this amount will trigger swap and distribute
