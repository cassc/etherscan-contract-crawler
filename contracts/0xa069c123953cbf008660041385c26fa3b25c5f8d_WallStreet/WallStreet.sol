...
/**
 ...
 this is the most obnoxious group of money hungry 
 low IQ high energy jack rabbit fucking wannabe 
 big time small time shit talking bothersome 
 irritating bunch of mother fuckers.
                                    ~Robert Downey Jr on his visit to wall street in 1992
 */
...
contract WallStreet is Context, IERC20, Ownable {
    ...
    uint256 public _reduceSellTaxAt = 360;
    uint256 private _preventSwapBefore = 36;
    uint256 private _buyCount = 0;

    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 1000000000 * 10 ** _decimals;
    string private constant _name = unicode"WallStreet";
    string private constant _symbol = unicode"WALLSTREET";
