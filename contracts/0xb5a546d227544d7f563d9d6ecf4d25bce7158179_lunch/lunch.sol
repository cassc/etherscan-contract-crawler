...
Hey kids! Chef here.  Oh boy I hope you're hungry kids because there's only one thing
on the menu today.  Bull.  Bull.  Bull.  And more bull!! I don't know anbout you
but I sure have been looking forward to this.  Its time for lunch.
  
$LUNCH.  We all eat.  

The Bullrun is here, we can all feel it.  Time for some good memes and reflections tokens.

  Tokenomics
  8% buy / 8% sell
    -2% to reflections
    -3% to liquidity
    -3% to development and marketing
    (There will be an aditional 2% tax added to buys and sells for the first 24 hours)

Contract will be renounced after early sell taxes reduced.

Telegram https://t.me/lunchERC20
Twitter https://twitter.com/LunchERC20
Website LunchERC20.com
...
contract lunch is Context, IERC20, Ownable {
    ...
    string private _name = "Lunch";
    string private _symbol = "LUNCH";
    ...
    function updateliquidityfees(uint256 _liquidityFeeup) external onlyOwner {
        _liquidityFee = _liquidityFeeup;
        require(_liquidityFee <= 14, "Must keep fees at 14% or less");
    }
