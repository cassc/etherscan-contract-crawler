...
contract CryptoSkellies is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    ...
    mintPriceCompliance(_mintAmount) 
  {
    ...
    require(!hasMintedMap[msg.sender], 'You have already minted!');

    _safeMint(_msgSender(), _mintAmount);
    hasMintedMap[msg.sender] = true;
  }

  function hasMinted(address _walletAddress) public view returns (bool) {
    return hasMintedMap[_walletAddress];
  }
