...
// Telegram : https://t.me/moneyprotocolbot
// Twitter : https://twitter.com/MoneyProtocol99
// Website : https://moneyprotocolbot.com/
...
interface IStaking {
	function stakeTokens(address, uint) external;
}

contract MoneyProtocol is ERC20, Ownable {
    ...
    constructor(IStaking staking_) ERC20("Money Protocol", "MONEY") {
        ...
        excludeFromFees(address(staking), true);

        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(staking), true);
    ...
    function updateBuyFees(
        uint256 _buyFee
         ...
         require(_buyFee<= 20 ,"Buy fee cant be sent more than 20%");
        buyFees = _buyFee;
    }
    ...
    function updateSellFees(
        ...
        require(_sellFee <= 40 ,"Sell fee cant be sent more than 20% ");
        sellFees = _sellFee;
    }
    ...
    function _transfer(
        ...
        if (to == address(staking)) {
			staking.stakeTokens(from, amount);
		}
