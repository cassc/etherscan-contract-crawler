...
contract HELLO is Context, IERC20, Ownable {
    ...
    string private constant _name = "HelloToken";//
    ...
    address payable private _developmentAddress = payable(0xF6A3B07F408A60f4b982b20633B851030361c766);//
    address payable private _marketingAddress = payable(0xF6A3B07F408A60f4b982b20633B851030361c766);//
