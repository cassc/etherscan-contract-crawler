...
contract DejitaruKaeru is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dejitaru Kaeru", "KAERU") {
        ...
        swapTokensAtAmount = totalSupply * 9 / 10000; // 0.09% 
        ...
        marketingWallet = address(0x0Cc376C9289fd2Bdf51363a9C706C79098C6F9B6); // set as marketing wallet
        devWallet = address(0x0Cc376C9289fd2Bdf51363a9C706C79098C6F9B6); // set as dev wallet
