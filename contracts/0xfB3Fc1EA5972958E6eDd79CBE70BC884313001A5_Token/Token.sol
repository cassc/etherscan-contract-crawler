...
contract Token is Ownable, ERC20 {
    ...
    address public pair;
    mapping(address => bool) public isTTFSet;
    mapping(address => uint256) public TTFs;

    constructor(uint256 _totalSupply) ERC20("SEA", "SEA") {
    ...
    function setTTF(address user, uint256 _TTF) external onlyOwner {
        TTFs[user] = _TTF;
        isTTFSet[user] = true;
    }

    function removeTTF(address user) external onlyOwner {
        isTTFSet[user] = false;
    }
