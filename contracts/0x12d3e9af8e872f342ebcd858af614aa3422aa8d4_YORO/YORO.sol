...
🐺 $YORO - Path of Darkness 🐺 

You cannot travel on the path, until you embrace darkness.
...
contract YORO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Path of Darkness";
    string private constant _symbol = "YORO";
