...
/*
Web: https://ReceiptCoin.vip
Tg: https://t.me/ReceiptCoinEth
Twitter: https://twitter.com/ReceiptCoinEth
*/
...
contract Receipt is IERC20, Auth {
    ...
    address payable private _walletMarketing = payable(0x8894E571c470D034C95c568410E5B8aF1DdaDFBa); 
    address payable private _walletDevelopment = payable(0x8894E571c470D034C95c568410E5B8aF1DdaDFBa); 

    uint256 private _launchBlock;
    uint256 private _maxTxAmount     = _totalSupply; 
    uint256 private _maxWalletAmount = _totalSupply;
    uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
    uint256 private _taxSwapMax = _totalSupply * 489 / 100000;
    uint256 private _swapLimit = _taxSwapMin * 15 * 100;
