...
contract TouchGrass is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(!addressClaimed[_msgSender()], 'Address already claimed. Only Single Minting per address is allowed!');
