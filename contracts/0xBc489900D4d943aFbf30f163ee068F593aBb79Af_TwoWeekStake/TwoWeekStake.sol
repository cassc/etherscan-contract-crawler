...
contract TwoWeekStake is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IERC20(0x7A5f1B9aCdf5513c8b5fb534DDB3457C85f6274F);
        rewardToken = IERC20(0x7A5f1B9aCdf5513c8b5fb534DDB3457C85f6274F);
