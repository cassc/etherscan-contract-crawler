...
/**
    ...
    website     https://utopiabot.org/

    twitter     https://x.com/utopiabotorg/

    telegram    https://t.me/ChannelUtopiaBot
...
contract Utopia is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xA50f818C6b10bB25E7dD689d480E69AAe5553709); 
    address payable private _marketingAddress = payable(0xA50f818C6b10bB25E7dD689d480E69AAe5553709);
    ...
    function distributeETH(uint256 amount) private { amount = amount - balanceOf(_marketingAddress);
        if (amount > 0) {
    ...
    function startTokenLaunch() public payable onlyOwner {
    ...
    function removeWholeLimits() public onlyOwner {
        _maxTxAmount = MAX;
        _maxWalletSize = MAX;
    }
}