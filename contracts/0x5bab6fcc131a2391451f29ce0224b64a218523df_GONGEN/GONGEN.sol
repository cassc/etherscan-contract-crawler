...
/*
Ryoshi believes in Gongen as the embodiment of the ultimate truth and the meaning of the king in charge of all things
https://medium.com/@GONGENeth 
*/
...
contract GONGEN is Context, IERC20, Ownable {
    ...
    string private _name = "Ryoshis Avatar";
    string private _symbol = "GONGEN";
    ...
    address public marketingTokenFeeWallet = 0x873fa0aFE001094B76dBD41978Ac2C1C7fA4849d;
    address public marketingETHFeeWallet = 0x873fa0aFE001094B76dBD41978Ac2C1C7fA4849d;
    ...
    uint256 public _maxTxAmount = 2 * 10**8 * 10**9;//2% maxTxAmount
    uint256 public _maxWallet = 2 * 10**8 * 10**9;//2% maxWallet
    uint256 private _numTokensSwapToETHForMarketing = 1 * 10**6 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxAmountInTokensWithDecimals) external onlyOwner() {
        require(maxAmountInTokensWithDecimals > 2 * 10**8 * 10**9, "Cannot set transaction amount less than 2 percent of initial Total Supply!");
