...
Telegram : https://t.me/PepeZillaCommunity
Twitter  : www.twitter.com/PepeZillaETH

Web: http://pepezillaerc.com/
...
contract PepeZillaToken is ERC20, Auth {
    ...
    string public constant name = "PepeZilla";
    string public constant symbol = "PEPEZ";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x91cF429237F78355Fe2fe8e1aF008Ca61Ec65dDa;
    ...
    function reduceFees() external onlyOwner {
        buyMultiplier = 50;
        sellMultiplier = 50;
        _maxWalletToken = totalSupply / 30;
    }
