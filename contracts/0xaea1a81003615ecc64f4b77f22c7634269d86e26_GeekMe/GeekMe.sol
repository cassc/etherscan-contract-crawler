...
contract GeekMe is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("Geek Me", "GEEKME") {
        _mint(msg.sender, 133700000000000 * 10 ** decimals());
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        require(!paused, "ERC20Pausable: token transfer is paused");
