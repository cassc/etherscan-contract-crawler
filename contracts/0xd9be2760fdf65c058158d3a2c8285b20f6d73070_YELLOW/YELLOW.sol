...
Yellow World: Vision for the Future of the Internet

The early years of the web were a whirlwind: new counter-culture collectives, 
grassroots communities and early start-up companies sprung up everywhere, 
The internet was to be completely open and free, with no control from above.

If we want to steer the direction of the internet, rather than be steered by it,
we need to better understand how these invisible forces are shaping us.

>> Manifesto
https://medium.com/@YELLOW_WORLD/yellow-world-vision-for-the-future-of-the-internet-de65a5139086

>> Web
https://yelloworld.pinkyellow.com/
...
contract YELLOW is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("YELLOW WORLD", "YELLOW") {
    ...
    ; uint256 totalSupply = 1 * 1e12 * 1e18;
        ...
        maxTransactionAmount = totalSupply * 9 / 1000; // .8% maxTransactionAmountTxn
