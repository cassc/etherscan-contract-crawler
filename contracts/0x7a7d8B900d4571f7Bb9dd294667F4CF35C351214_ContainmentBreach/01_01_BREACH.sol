...
#+#    #+# #+#    #+#     #+#     #+#        #+#        #+#        #+#    #+# #+#       #+# #+#    #+# 
 ########   ########  ########### ########## ########## ########## ###    ### ###       ###  ########  
333 WL at .022 E Max 4
667 Public at .044 E Max 10
*/
...
contract ContainmentBreach is Ownable, ERC721A, DefaultOperatorFilterer  {

    using Strings for uint256;

    string private baseTokenURI;

    uint256 public presaleCost = 0.022 ether;
    uint256 public publicSaleCost = 0.044 ether;
    ...
    constructor() ERC721A("Containment Breach by Guillermo DT", "BREACH"){}
