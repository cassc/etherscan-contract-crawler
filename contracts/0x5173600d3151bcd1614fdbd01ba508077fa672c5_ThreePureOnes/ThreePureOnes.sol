...
contract ThreePureOnes is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount = 3400000000 * (10**18);
    uint256 public maxWalletToken = 6800000000 * (10**18);
    ...
    address payable public marketingWallet = payable(0x49E9B229c4E4887CE1f3c252C9d27C3D90e9A264); 
    address payable public devWallet = payable(0x919835Ed5C40AFCf9c52E737687a164803725BB6);
    ...
    constructor() ERC20("\u4e09\u6e05 - Three Pure Ones", "\u0053\u0101\u006e\u0071\u012b\u006e\u0067\u000d") {
        ...
        */
        ...
        _createInitialTotalSupply(owner(), 333333333333 * (10**18));
    }
    ...
    function setMaxTxAmount(uint256 _maxTx) public onlyOwner {
        ...
        require(maxTransactionAmount >= totalSupply().div(333333333333), "value too low");
    }
