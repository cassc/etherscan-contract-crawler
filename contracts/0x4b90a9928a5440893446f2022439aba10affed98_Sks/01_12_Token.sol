...
contract Sks is ERC20, ERC20Burnable, Ownable, Initializable {
    ...
    constructor()
        ERC20(unicode"Sks", unicode"Hshsj") 
    {
        address supplyRecipient = 0xACC5fa6726031DA516796a5ab22ED86B758ceD27;
        
        updateSwapThreshold(345000000000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0x0e8e1E71333d3837c31ea77Bb81382eeedbB0c7D);
        ...
        _transferOwnership(0xACC5fa6726031DA516796a5ab22ED86B758ceD27);
    }
