...
/**
    Pumpkin Inu ERC Token
    Telegram: https://t.me/pumpkininuethportal
*/
...
contract PumpkinInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x080DeF26C11ea64B8C632352c94d8dc6d587e3d1); // Marketing Address
    address payable public multiSigAddress = payable(0x080DeF26C11ea64B8C632352c94d8dc6d587e3d1); // Marketing Address
    address payable public devAddress = payable(0x080DeF26C11ea64B8C632352c94d8dc6d587e3d1); // Dev Address
    address payable public liquidityAddress = payable(0x080DeF26C11ea64B8C632352c94d8dc6d587e3d1); // Liquidity Address
    ...
    string private constant _name = unicode"Pumpkin Inu";
    string private constant _symbol = unicode"PKI";
