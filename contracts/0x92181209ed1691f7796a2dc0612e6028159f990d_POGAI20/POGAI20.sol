...
contract POGAI20 is Ownable, ERC20 {
    ...
    string constant _name = "POGAI2.0";
    string constant _symbol = "POGAI2.0";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x9fd692c0485188Ecd013f29d3Ae46Ea859312207; 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != burnFeeReceiver && recipient != marketingFeeReceiver && !isexemptfrommaxTX[recipient]){
            ...
            require((holdTokens + amount) <= _maxWalletToken,"Total Holding is currently limited, you can not buy that much.");}
