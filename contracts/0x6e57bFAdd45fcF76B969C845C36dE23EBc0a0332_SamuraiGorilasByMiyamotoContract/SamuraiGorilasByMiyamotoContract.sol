...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x3f0b3B71405D21B694Bf912fbE2d2C917Ccee1dc];
  address public erc20Payable = 0x3f0b3B71405D21B694Bf912fbE2d2C917Ccee1dc;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 695) { }
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/GNeDVqS2JmcJItzimqAs/contract-metadata";
  }
...
// File: contracts/SamuraiGorilasByMiyamotoContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SamuraiGorilasByMiyamotoContract is RamppERC721A {
    constructor() RamppERC721A("Samurai Gorilas By Miyamoto", "SGorilas"){}
}
