...
contract PixelatedRenga is ERC721A, Ownable {
    ...
    address public pixelatedRengaV1;
 ...
 constructor(
    ...
    address _lead,
    address _pixelatedRengaV1
  )ERC721A("Pixelated Renga", "PXLR") {
    baseURI = _baseURI;
    lead = _lead;
    pixelatedRengaV1 = _pixelatedRengaV1;
  }
 ...
 function _startTokenId() internal view override virtual returns (uint256) {
  ...
  function setPixelatedRengaV1Address(address _pixelatedRengaV1) public onlyOwner {
    pixelatedRengaV1 =_pixelatedRengaV1;
  }
