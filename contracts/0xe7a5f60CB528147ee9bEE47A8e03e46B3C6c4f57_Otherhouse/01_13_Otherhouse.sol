...
contract Otherhouse is ERC721, ERC721Enumerable {
    ...
    uint256 public constant MINT_PRICE = 500 * (10 ** DECIMALS) / 1000;
    ...
    constructor(uint256 maxSupply, string memory baseTokenURI) ERC721("Otherhouse", "OTH") {
