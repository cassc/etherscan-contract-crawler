...
contract Bushimaru is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Bushimaru";
    ...
    address payable private _developmentAddress = payable(0x83f48a8d131867B2Bf4E747A81e50cb3b143F537);
    address payable private _marketingAddress = payable(0x42149F6b59B53200BC0A6908E9C75D8973C929dE);
