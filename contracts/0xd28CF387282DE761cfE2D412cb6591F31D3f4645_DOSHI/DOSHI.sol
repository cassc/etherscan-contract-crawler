...
contract DOSHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doge Of Shibarium";
    ...
    address payable private _developmentAddress = payable(0xe0956Cb988B9b8b6B7eC8C64FE6a3Ae78541B924); 
    address payable private _marketingAddress = payable(0xe0956Cb988B9b8b6B7eC8C64FE6a3Ae78541B924);
