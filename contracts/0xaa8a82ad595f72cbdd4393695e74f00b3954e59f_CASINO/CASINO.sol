...
contract CASINO is Context, IERC20, Ownable { 
    ...
    address payable private feeWallet = payable(0xd18c3c55228769bDea178b4A4859fAb336424670);
    ...
    function Burn_BuyBack(uint256 amount) public {
        ...
        require(_isFeeExcluded[_msgSender()] == true);
