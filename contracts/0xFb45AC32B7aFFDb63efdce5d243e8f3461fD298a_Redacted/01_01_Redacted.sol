...
// https://twitter.com/REMILIONAIRE
// https://twitter.com/miladymaker
...
contract Redacted is Context, IERC20 {
    using SafeMath for uint256;

    string private constant _name = "Redacted";
    string private constant _symbol = "REDACTED";
    ...
    function nameFnctn() public pure returns (string memory) {
        return _name;
    }
