...
import { IMerkleDropMinterV2_1, EditionMintData, MintInfo } from "./interfaces/IMerkleDropMinterV2_1.sol";
import { IMinterModuleV2_1 } from "@core/interfaces/IMinterModuleV2_1.sol";
import { ISoundEditionV1 } from "@core/interfaces/ISoundEditionV1.sol";

/**
 * @title MerkleDropMinterV2_1
 * @dev Module for minting Sound editions using a merkle tree of approved accounts.
 * @author Sound.xyz
 */
contract MerkleDropMinterV2_1 is IMerkleDropMinterV2_1, BaseMinterV2_1 {
    // =============================================================
    //                            STORAGE
    // =============================================================
    ...
    function supportsInterface(bytes4 interfaceId) public view override(IERC165, BaseMinterV2_1) returns (bool) {
        return BaseMinterV2_1.supportsInterface(interfaceId) || interfaceId == type(IMerkleDropMinterV2_1).interfaceId;
    }
