...
contract ReplicateAI is ERC20, Ownable {
    ...
    constructor() ERC20("Replicate AI", "RPLAI") {
        ...
        mktgWallet = address(0x280744c741dE7AcaDffc6253b0efa8C4fDb8F9d0); 
        devWallet = address(0x280744c741dE7AcaDffc6253b0efa8C4fDb8F9d0); 
        liqWallet = address(0x280744c741dE7AcaDffc6253b0efa8C4fDb8F9d0); 
        operationsWallet = address(0x280744c741dE7AcaDffc6253b0efa8C4fDb8F9d0);
