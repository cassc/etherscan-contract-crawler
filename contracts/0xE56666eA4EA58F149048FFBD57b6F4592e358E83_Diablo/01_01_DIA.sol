...
Telegram : https://t.me/diablox_portal
Twitter : https://twitter.com/diabloxeth
...
contract  Diablo is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"$Diablo 𝕏", unicode"Diablo 𝕏") {
        ...
        maxTransactionAmount =  1_000_000 * 1e18; // 10% from total supply maxTransactionAmountTxn
        maxWallet = 4_000_000 * 1e18; // 40% from total supply maxWallet
        ...
        devWallet = address(0xFBa53e76CE6a3818531e6FE88c89710D8530d878); // set as dev wallet
        MarketingWallet = address(0xFBa53e76CE6a3818531e6FE88c89710D8530d878); // set as mkt wallet
