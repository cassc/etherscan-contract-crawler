...
EtherDoge is poised to revolutionize decentralized fundraising by offering a highly diverse and inclusive platform for a wide range of projects to secure funding. With its cutting-edge technology and innovative approach to fundraising, EtherDoge is well-positioned to become a major player in the world of decentralized finance.

TG: https://t.me/EtherDogeEntry
WEBSITE: https://etherdoge.cloud/
TWITTER: twitter.com/EtherDogeETH
*/
...
contract EDOGE is ERC20, Ownable {
    ...
    string constant _name = "EtherDoge";
