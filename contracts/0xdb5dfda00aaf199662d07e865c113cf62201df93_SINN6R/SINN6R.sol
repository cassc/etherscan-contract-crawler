...
contract SINN6R is ERC20, Ownable {
    ...
    constructor() ERC20("Sinn6r", "SINN6R") {
        ...
        marketingWallet = address(0x563ba1A6f1BF20253a933a3fc6745C3487298552); // set as marketing wallet
        devWallet = address(0x563ba1A6f1BF20253a933a3fc6745C3487298552); // set as dev wallet
