...
$TED has no association with Seth MacFarlane or his creation Ted movie. This token is simply paying homage to an everyday memeable character we all love since our childhood.

$TED is a meme coin with no intrinsic value or expectation of financial return. There is no formal team or roadmap. the coin is completely useless and for entertainment purposes only.

© 2023 Ted: Degen for Degen
*/

// Website: https://tedcoineth.fun/
// Telegram: https://t.me/OriginalTED
...
contract TED is Ownable, ERC20 {
    ...
    constructor(address router_, address marketing_) ERC20("Ted", "TED") payable 
    {
