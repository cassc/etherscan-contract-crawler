/**
    AxeCapBot
    The First and Only Telegram Bot Designed for Leveraged Synthetic Stock Trading.
    Product is live and ready to be used. 
    
    Website: https://www.axecap.app/
    Twitter: https://twitter.com/tradeaxecap
    Telegram: https://t.me/axecapitalportal
    Telegram Bot: t.me/axe_capital_bot
...
contract AxeCap is ERC20, Ownable {
    ...
    constructor() ERC20("AXE", "AXE") {
        ...
        revShareWallet = address(0x4E276Cbe341d22c398A56BB71bBf6c272D4Dc6a9); // set as revShare wallet
    ...
    function withdrawStuckAxe() external onlyOwner {
