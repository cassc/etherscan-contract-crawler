...
https://twitter.com/ricebowlroll

https://t.me/RiceBowlRoll
...
contract RiceBowl is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Rice Bowl Roll";
    string private constant _symbol = unicode"$RICEBOWL";
