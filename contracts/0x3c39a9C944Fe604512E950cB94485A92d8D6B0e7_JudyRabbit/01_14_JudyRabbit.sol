...
contract JudyRabbit is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Judy Rabbit", "JR", maxBatchSize_, collectionSize_) {
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xba4e0b58a1f15976786a03e610E8bEF62E122018);
