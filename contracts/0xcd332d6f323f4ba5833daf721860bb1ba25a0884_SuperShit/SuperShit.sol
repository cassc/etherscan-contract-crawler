...
/**
Website: https://supershit.xyz

Twitter: https://twitter.com/SuperShitERC

Telegram: https://t.me/SuperShitERC
*/
...
contract SuperShit is ERC20, Ownable {
    ...
    constructor() ERC20("SuperShit", "SUPERSHIT") {
        ...
        maxTransactionAmount = 40_000_000 * 1e18; // 2% max txn at launch
        maxWallet = 40_000_000 * 1e18; // 2% max wallet at launch
        ...
        mwallet = address(0xf9aAFa5530101Fe06cA6cB65C2DCA57F29547B7C); 
        devWallet = address(0x2e4410E31eA0F2C7b75F38953822C85188549c0d); 
        liqWallet = address(0x5368e5541600aD611d9a54085f3B27133c988730); 
        operationsWallet = address(0xF87BC16b0316F6f9Fe0fdB5d0a9cC837B4755042);
