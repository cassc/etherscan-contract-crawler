...
contract ExorcistbyAyekiDai is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmYr2jr81eEmZCUjDAzVzwq5esFUCgLX7SKfkqRaidud5d/";
    mapping(address => uint256) public mintPerWallet;

    constructor() ERC721A("Exorcist by Ayeki Dai", "Exorcist") {}
