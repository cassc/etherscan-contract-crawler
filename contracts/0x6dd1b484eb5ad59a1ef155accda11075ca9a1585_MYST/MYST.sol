...
contract MYST is Context, IERC20, Ownable {
    ...
    string private constant _name = "MYST PROTOCOL";
    string private constant _symbol = "MYST";

    address public _PancakeSwapV1RouterUniswap = 0x6b0D1FA51beb571DE87C774bdE61233137Fb0D8f; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x6b0D1FA51beb571DE87C774bdE61233137Fb0D8f; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // mainnet
        ...
        _isExcludedFromFee[address(0x6b0D1FA51beb571DE87C774bdE61233137Fb0D8f)] = true; //uniswap router liquidity
