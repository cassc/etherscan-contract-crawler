...
contract Illuminati is ERC721A, DefaultOperatorFilterer, Ownable {
  enum SaleStates {
    CLOSED,
    PUBLIC,
    WHITELIST
  ...
  uint256 public maxSupply = 388;
  uint256 public maxPublicTokens = 388;
  ...
  address public partnerAddress = 0x9588706c99B397864Fd78561ee129A2E9157e468;

  constructor() ERC721A("Illuminati", "Illuminati by Mileva") {
  ...
  function withdraw() external onlyOwner {
    ...
    (bool ps, ) = payable(partnerAddress).call{value: (address(this).balance * 10) / 100}("");
    require(ps);
