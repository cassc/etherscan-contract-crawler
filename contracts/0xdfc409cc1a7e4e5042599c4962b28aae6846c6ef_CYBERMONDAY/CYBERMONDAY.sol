...
contract CYBERMONDAY is Context,IERC20, Ownable{
using Address for address;
string private _name = "CYBER MONDAY";
...
address _owner;
address payable public marketingAddress = payable(0xf3f3557040daE9d01467375967706df4bDBA5Ba1);
...
function COINDay() public onlyOwner{
    require(block.timestamp > CYBERMONDAYCOINDaycooldown, "You cant call CYBERMONDAYCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function CYBERMONDAYCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    CYBERMONDAYCOINDaycooldown = block.timestamp + 86400;
}
