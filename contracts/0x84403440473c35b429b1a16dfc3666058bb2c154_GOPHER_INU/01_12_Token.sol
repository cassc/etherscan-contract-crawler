...
contract GOPHER_INU is ERC20, ERC20Burnable, Ownable, Pausable {
    ...
    constructor()
        ERC20(unicode"GOPHER INU", unicode"GOPHER") 
    {
        address supplyRecipient = 0xF811F0C8b81Ef8A5Cc80568c4496A5BbB52bc10A;
        
        updateSwapThreshold(500000000 * (10 ** decimals()));

        marketingAddressSetup(0x1553E2632A235db94825E53dFDEaF633081F7517);
        marketingFeesSetup(0, 2500, 2500);
        ...
        updateMaxWalletAmount(30000000000 * (10 ** decimals()));

        updateMaxTxAmount(10000000000 * (10 ** decimals()));

        _mint(supplyRecipient, 1000000000000 * (10 ** decimals()));
        _transferOwnership(0xF811F0C8b81Ef8A5Cc80568c4496A5BbB52bc10A);
    }
