...
// Telegram: https://t.me/babygregportal

// Introducing Baby Greg, Gregs printer goes BRRRRR!
...
contract BabyGreg {
    ...
    string public constant name = "BabyGreg";   
    string public constant symbol = "BABYGREG";   
    uint8 public constant decimals = 9;
    uint256 public constant totalSupply = 69000000000000000;

    uint256 buyTax = 20;
    uint256 sellTax = 20;
    uint256 constant swapAmount = totalSupply / 1000;
    uint256 constant maxWallet = 69000000000000000;
    ...
    address payable constant deployer = payable(address(0xda8D52182f5CAD225d30a2E5a5c52d46df606759));
