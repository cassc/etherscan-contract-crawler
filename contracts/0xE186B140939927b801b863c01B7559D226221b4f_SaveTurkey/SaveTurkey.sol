...
/*
Save Turkey is Charity Token built to raise funds for current earthquake situation in Turkey. $SAVETURKEY Tax fund will be sent straight to crypto donation wallet for the victim of earthquake in Turkey. 

Save Turkey’s Token holders can rest assured that their contributions are making a real difference in the act of charity to victim who suffered trauma of recent earthquake

Tax : 5/5 (All Goes Straight To Turkey’s Donation Wallet)

Telegram - https://t.me/saveturkeyerc
...
contract SaveTurkey is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"Save Turkey";
    string private constant _symbol = "SAVETURKEY";
    ...
    address payable private _developmentAddress = payable(0xe1935271D1993434A1a59fE08f24891Dc5F398Cd); //Turkey Donation Wallet
    address payable private _marketingAddress = payable(0xe1935271D1993434A1a59fE08f24891Dc5F398Cd); //Turkey Donation Wallet
