...
Automate your DEX trading experience with 0xTOOL and our web3.0 trading tools powered by $TOOL.

2/2 Trading Tax

Telegram: https://t.me/ZeroXToolERC
Twitter: https://twitter.com/ZeroXToolERC
Website: https://0xtool.click
...
contract ZeroXTool {
    ...
    string public constant name = "0xTool";   
    string public constant symbol = "TOOL";   
    ...
    address payable constant deployer = payable(address(0xaB26276B8C12B87fa43990637DB7fF782d07AFB6));
