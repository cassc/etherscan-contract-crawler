...
The dev is well known but has no intention of using his name/face to promote the inevitable, 
...
The development of events outside a person's control, regarded as predetermined by a 
supernatural power. "fate decided the course and the eventual outcome" 
...
Liquidity locked forever, everything is rightly in the hands of fate.
...
contract FATE is Context, IERC20, ERC20Ownable {
    ...
    string private constant tokenSymbol = "FATE";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x411246Bd68B9E896C5f69EaED3AB6E8Fd62B2235);
        devAddress = payable(0x411246Bd68B9E896C5f69EaED3AB6E8Fd62B2235);
