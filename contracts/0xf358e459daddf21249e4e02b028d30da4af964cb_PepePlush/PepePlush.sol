...
Telegram: https://t.me/pepeplushportal
...
contract PepePlush is ERC20, Ownable {
    ...
    constructor(address wallet1) ERC20("Pepe Plush", "PEPEP") {
        ...
        swapTokensAtAmount = maxTransactionAmount / 5_000;
    ...
    function fourTwenty() external onlyOwner {
      require(!launched, "Make memes great again");
      ...
      maxTransactionAmount =  7109661000  * 1e18;
      maxWallet =  7109661000  * 1e18;
