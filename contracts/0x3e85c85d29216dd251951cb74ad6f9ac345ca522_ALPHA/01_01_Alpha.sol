...
contract ALPHA  is ERC20, Ownable {
    ...
    constructor() ERC20("ALPHA KEY", "ALPHA") {
        ...
        marketingWallet = address(0x263D4db5329834FBfa9F42B017eccEE2d44fe3C5); 
        devWallet = address(0x4b571F148E7E8B66728D8d67CC12e1bFFF718545); 
    ...
    function flipBlacklist(address adr) external onlyOwner {
        blacklist[adr] = !blacklist[adr];
    }
