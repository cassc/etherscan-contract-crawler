...
contract GAS is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xB7f65E3E29FB10355498f948a34c6F63B2e926cC);//
    address payable private _marketingAddress = payable(0xB7f65E3E29FB10355498f948a34c6F63B2e926cC);//
    ...
    uint256 public _maxTxAmount = 696966966 * 10**9; //
    uint256 public _maxWalletSize = 696966966 * 10**9; //
    ...
    function gasBots(address[] memory bots_) public onlyOwner {
