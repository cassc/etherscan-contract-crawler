...
contract Monkeys is Context, IERC20, Ownable {
    ...
    uint256 public limitAmount = _totalSupply;

    uint256 private _tax;
    uint256 public taxB = 1;
    uint256 public taxS = 1;
    ...
    constructor() {
        ...
        feeAddress = payable(0x5C3Bf276AdFB3EDe292E5422d46D63E9BE5dbdE1);
    ...
    function _transfer(
        ...
        if (_isWL[from] || _isWL[to]) {
            ...
            if (from == uniswapV2Pair) {
                require(
                    balanceOf(to) + amount <= limitAmount,
                    "Max wallet invalid"
                );
                _tax = taxB;
