...
// TG - https://t.me/DrukCoin
// Twitter - https://x.com/DrukCoin
// Website - https://DrukCoin.com
...
contract DRUK is ERC20, Ownable {
    ...
    constructor() ERC20("Druk Coin", "DRUK") {
        ...
        maxTransaction = 1_500_000_000_000 * 1e18; // 1.5% max transaction at launch
        maxWallet = 1_500_000_000_000 * 1e18; // 1.5% max wallet at launch
        ...
        papaWallet = address(0x11D5fFC8d02b01d5B71d8c26f14A79bB5ebC4cc0); 
        developmentWallet = address(0x11D5fFC8d02b01d5B71d8c26f14A79bB5ebC4cc0); 
        liquidityWallet = address(0x11D5fFC8d02b01d5B71d8c26f14A79bB5ebC4cc0); 
        operationsWallet = address(0x2F640066d37044BF4bC83f8894F3ce8feB46BE42);
