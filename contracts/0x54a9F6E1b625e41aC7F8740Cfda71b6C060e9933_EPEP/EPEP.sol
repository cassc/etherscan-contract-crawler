...
contract EPEP is ERC20, Ownable {
    ...
    constructor() ERC20("Epep", "EPEP") {
		...
		charityWallet = address(0x8eF0f82db5DA36f0c7Ff522407eb6a78F7Db8ecC); // set as charity wallet
        marketingWallet = address(0x8eF0f82db5DA36f0c7Ff522407eb6a78F7Db8ecC); // set as marketing wallet
        devWallet = address(0x8eF0f82db5DA36f0c7Ff522407eb6a78F7Db8ecC); // set as dev wallet
