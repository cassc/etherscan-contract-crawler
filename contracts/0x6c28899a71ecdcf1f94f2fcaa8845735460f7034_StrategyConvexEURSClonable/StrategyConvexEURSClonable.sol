...
// File: StrategyConvexEURSClonable.sol
...
contract StrategyConvexEURSClonable is StrategyConvexBase {
    /* ========== STATE VARIABLES ========== */
    ...
    function cloneConvexEURS(
        ...
        StrategyConvexEURSClonable(newStrategy).initialize(
            _vault,
            _strategist,
            _rewards,
            _keeper,
