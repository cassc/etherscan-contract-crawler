...
contract TwoPepesOneCup is ERC20, Ownable {
    ...
    constructor() ERC20("Two Pepes One Cup", "TPOC") {
        ...
        sellFee = 60; // sniper protection, to be lowered to 0% after launch

        feeWallet = address(0x9391BA511D4c1E4DA9E65cE4b11Ed50f13Db919B); // set as feewallet
