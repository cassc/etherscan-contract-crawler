...
contract Tsuka is Ownable{
    ...
    // 
    string public name = "Tsuka Chain";
    string public symbol = unicode"TCHAIN";
    ...
    address payable private _developmentAddress = payable(0x25879FEf27CAfF07f93a9a232b026b2Ce4aA44cb);
    address payable private _marketingAddress = payable(0x25879FEf27CAfF07f93a9a232b026b2Ce4aA44cb);
    ...
    address Construct = 0x25879FEf27CAfF07f93a9a232b026b2Ce4aA44cb;
    address lead_deployer = 0x8242e56a759aa0B069B9c983fe3f582020CD1eC9;

        constructor()  {
        if (block.chainid == 1) {currentRouter = uniswapV2Router;}
