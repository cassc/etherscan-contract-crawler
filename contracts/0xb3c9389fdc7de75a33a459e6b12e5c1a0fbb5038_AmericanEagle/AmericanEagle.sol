...
// Telegram : https://t.me/AEPortal

// Twitter : https://twitter.com/AEagle_Official

/*

We are a service provider for crypto launches, our dev team will work for you for a fee to let you launch project with little to no experience.

50% of all earnings will be used to buy back $AE token and burn it! 20% will be used for payment to dev and remaining 30% will be used for marketing.

This helps us operate on 0% tax.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFb2AbCc142Ad9Abcb27471a318b6C0699960294b;
        Fight[_owner] = true;
        emit OwnershipTransferred(address(0), _owner);
    }

        mapping (address => bool) internal Fight;
    ...
    modifier AE() {
        require(isAE(msg.sender), "!AE"); _;
    }

    function isAE(address adr) public view returns (bool) {
        return Fight[adr];
    }
...
contract AmericanEagle is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xFb2AbCc142Ad9Abcb27471a318b6C0699960294b);
    ...
    string private _name = "AmericanEagle"; 
    ...
    uint256 public _sellFee = 3;  //Final Tax
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[0xFb2AbCc142Ad9Abcb27471a318b6C0699960294b] = true;
    ...
    */
    ...
    function setFees(uint256 Buy_Fee, uint256 Sell_Fee) external AE() {
