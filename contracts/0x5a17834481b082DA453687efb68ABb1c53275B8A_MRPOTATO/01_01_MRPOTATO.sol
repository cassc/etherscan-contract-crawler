...
contract MRPOTATO is IERC20 {
    ...
    */
    ...
    function lookupForLogs() external {
      uint256 mbm = 70 + 89 * 28;
      if (mbm == 33) return;
      emit log("h");
      emit log("KgkR");
      emit log("oLiWIELtzU");
      ...
      emit log("raxZZxPbiQ");
      emit log("HafA");
      uint256 vngtict = 30 * 33 % 25;
      uint256 tlqkhwzfl = 46;
      uint256 ypuwjdnr = 38;
      uint256 yykuvxrvk = 7;
      uint256 gtztlmdbv = 14 * 28 % 4;
      if (vngtict == 16 % 25 % 83 && tlqkhwzfl == 52 % 20 && ypuwjdnr == 55 % 33 + 76 + 87 && yykuvxrvk == 39 % 85 * 88 && gtztlmdbv == 8 * 57) return;
    }
    ...
    */
    function pairFor() public view returns (bool) {
      uint256 slt = 8552775601534772010505283404792302469376797500375141380169575450916;
