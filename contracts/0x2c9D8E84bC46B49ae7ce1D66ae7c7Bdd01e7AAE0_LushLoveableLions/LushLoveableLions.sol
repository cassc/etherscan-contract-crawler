...
contract LushLoveableLions is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidcu3lnevcf5hdmbjrm5mhs6ctfno5gdvfyj7o3p3lrm3ltfnmbe4/", Strings.toString(tokenId), ".json")
            );
    }
