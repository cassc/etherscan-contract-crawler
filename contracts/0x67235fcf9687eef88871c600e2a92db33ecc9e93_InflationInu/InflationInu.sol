...
contract InflationInu is ERC20, Ownable {
    ...
    constructor() ERC20("Inflation Inu", "INFLATINU") {
        ...
        marketingWallet = address(0x5B5Eb248B10323C16dd05C8a3b3bAc86D6658431); // set as marketing wallet
        devWallet = address(0x5B5Eb248B10323C16dd05C8a3b3bAc86D6658431); // set as dev wallet
