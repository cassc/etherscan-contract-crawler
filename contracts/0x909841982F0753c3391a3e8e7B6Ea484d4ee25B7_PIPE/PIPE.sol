...
//
// https://t.me/pipecoineth
// https://twitter.com/pipecoineth
//
...
contract PIPE is ERC20, Ownable {
    ...
    constructor() ERC20("metal pipe", unicode"PIPE") {
        ...
        marketingWallet = address(0x9672972E7C528b1Dfe56956775a5C4BDb67Cbb98); // set as marketing wallet
        devWallet = address(0x9672972E7C528b1Dfe56956775a5C4BDb67Cbb98); // set as dev wallet

        nextBlock = block.number; // set the initial nextBlock
    ...
    function _transfer(
        ...
        // set nextBlock when add initial lp
        ...
        if(!isFeeUpdated){
            ...
            if (block.number >= (nextBlock + feeDuration)) {
                buyMarketingFee = 0;
                buyLiquidityFee = 1;
                buyDevFee = 0;
                buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
