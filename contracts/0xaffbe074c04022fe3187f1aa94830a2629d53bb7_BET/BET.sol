...
contract BET is ERC20, Ownable {
    ...
    constructor() ERC20( "Degen Inu", "BET") {
        ...
        maxBuyAmount = totalSupply * 50 / 1000; 
        maxSellAmount = totalSupply * 50 / 1000; 
        maxWalletAmount = totalSupply * 50 / 1000;
        ...
        operationsAddress = address(0x8079BE6e41f4537bb2347C7CF38F5d6EB1938ed5); // change this address to wallet u want for operations   
        TaxAddress = address(0x8079BE6e41f4537bb2347C7CF38F5d6EB1938ed5);  // change this address to the one for tax 
