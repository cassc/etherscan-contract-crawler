...
/**
https://t.me/bchinaportal
https://www.bchina.net/
*/
...
contract bCHINA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bank of China", "bCHINA") {
        ...
        marketingWallet = address(0xcf94d80208Dc401f5Fd5f49d2141327bB97d6682);
        contestAIWallet = address(0xcf94d80208Dc401f5Fd5f49d2141327bB97d6682);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(block.number < taxTill) {
                ...
                tokensForMarketing += (fees * 98) / 99;
                tokensForContestAI += (fees * 1) / 99;
