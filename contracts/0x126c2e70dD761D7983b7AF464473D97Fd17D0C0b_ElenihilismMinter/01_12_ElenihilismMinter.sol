...
contract ElenihilismMinter is Ownable, AccessControl {
    ...
    function mint() external payable {
        ...
        IERC721CreatorCore(elenihilism).mintBase(msg.sender);
        drop.mintsAvailable--;
    ...
    function gift(address addr) external onlyRole(SUPPORT_ROLE) {
        IERC721CreatorCore(elenihilism).mintBase(addr, metadataUri);
    }
