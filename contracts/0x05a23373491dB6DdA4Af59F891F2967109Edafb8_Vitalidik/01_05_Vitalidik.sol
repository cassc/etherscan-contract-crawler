...
contract Vitalidik is ERC721A, Ownable {
    string _baseUri;
    string _contractUri;
    
    uint public maxFreeMint = 2666;
    ...
    constructor() ERC721A("Vitalidik", "VTDK") {
        _contractUri = "ipfs://QmTy5p73Wk1E6qznTKjUw416nFF8EygzaEVHBLvpdgT6Bd";
    }
