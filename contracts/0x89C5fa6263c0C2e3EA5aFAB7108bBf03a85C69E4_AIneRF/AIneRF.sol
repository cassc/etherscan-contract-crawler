...
//Telegram: https://t.me/NeuralFieldAI
...
contract AIneRF is ERC20, Ownable {
    ...
    constructor() ERC20("AInerf", "NeRF") {
		...
		charityWallet = address(0xEEcd22eE3000B33361CAA638F9da5862216c7C66); // set as charity wallet
        marketingWallet = address(0xB6620878f063afbE97E68882958Dcfc6De30F1cF); // set as marketing wallet
        devWallet = address(0xe458de93C2d16E7ED3DDF7737fEae1B7d8A0ECfd); // set as dev wallet
