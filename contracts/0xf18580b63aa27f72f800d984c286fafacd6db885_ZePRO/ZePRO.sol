...
contract ZePRO is ERC20, Ownable {
    ...
    constructor() ERC20("ZePRO", "ZePRO") {
        ...
        maxTransactionAmount = 26000000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 52000000 * 1e18; // 4% from total supply maxWallet
		...
		charityWallet = address(0x731dE54d3b836115802431ef70cB7399E689B0F0); // 
        marketingWallet = address(0x731dE54d3b836115802431ef70cB7399E689B0F0); // 
        devWallet = address(0x731dE54d3b836115802431ef70cB7399E689B0F0); // 
