...
// TG - t.me/fireworxportal

// Let's start 2023 off with a BIG bang, and let us all hope and pray that the jeetery and the rugging will cease.
...
contract WorX  is ERC20, Ownable {
    ...
    constructor() ERC20("WorX", "FireWorX") {
        ...
        marketingWallet = address(0x477E7e07cb361f7c5049112313a1623A98050988); // set as marketing wallet
        devWallet = address(0x6D7D088B7a1ceB5d072FFE01E4f06236af7C25Ab); // set as dev wallet
