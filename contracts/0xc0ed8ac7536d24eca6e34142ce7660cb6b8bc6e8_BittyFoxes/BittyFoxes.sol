...
A collection of 4000 bitty foxes who are on a mission to take holders on to a adventurous journey through the dense jungles of Ethereum.
Mint pirce - 1 free and 0.001 for more foxes.
*/
...
contract BittyFoxes is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
    ...
    constructor () ERC721A("Bitty Foxes", "BF") {
    }
