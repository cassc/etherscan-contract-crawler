...
contract FatBored is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 5555;
