...
contract WPEPE is Context, Ownable, IERC20 {
    ...
    uint256 constant private buyfee = 20;
    uint256 constant private sellfee = 20;
    ...
    address payable private marketingAddress = payable(0xf6F0B81434cd7Ca88367920f4987e12d158d52aD); // build: 0xf6F0B81434cd7Ca88367920f4987e12d158d52aD


//--- v3 Allocations by David wpepe.finance ---//
    ...
    string constant private _name = "WPEPE";
    string constant private _symbol = "WPEPE";
    string constant public copyright = "wpepe.finance";
    ...
    constructor () {
        ...
        require(buyAllocation + sellAllocation + liquidityAllocation == 100,"David: Must equals to 100%");
    ...
    function changeWallets(address newBuy) external onlyOwner {
        require(newBuy != address(0),"David: Address Zero");
