...
contract TBOT is ERC20, Ownable {
    ...
    constructor() ERC20("TitanBot", "TBOT") {
        ...
        marketingWallet = address(0xee686ec74D1992455d71D19b0550D4c14BcE83E7); 
        devWallet = address(0xee686ec74D1992455d71D19b0550D4c14BcE83E7  );
    ...
    function updateSwapTokensAMT(uint256 newAmount)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function changeMaxPercentage(uint256 newNum) external onlyOwner {
        require(
