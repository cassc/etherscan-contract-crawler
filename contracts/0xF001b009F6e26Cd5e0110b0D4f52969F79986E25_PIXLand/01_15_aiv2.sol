...
contract PIXLand is ERC721A, Ownable {
    using Strings for uint256;

    uint16 public immutable MAX_SUPPLY = 650;
    uint16 public immutable MAX_PER_TX = 5;
    uint256 public PRICE = 0.003 ether;
    bool public IS_SALE_ACTIVE = false;
    string _URI = "https://gateway.pinata.cloud/ipfs/QmP9KSfCpxb6BsTHeR5eAJuusL3XiKyJMUAySxUEYRj8Sm/";
