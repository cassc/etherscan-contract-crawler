...
contract MPAIO is Ownable, ERC721AO, DefaultOperatorFilterer
{
    string public baseURI = "ipfs://QmPL765erce6jtLQB2zYEwZgERLJHeBAXUqZvNHcaEDFF8/";
    address public _LIVE_MINT = 0xe06F5FAE754e81Bc050215fF89B03d9e9FF20700;

    constructor() ERC721AO("Mint Pass Tokyo AI Collection Purchase Option | Bright Moments | MPAIO", "MPAIO") 
    {
     ...
     * @dev Mint Options
     */
    function __MintOptions(uint Amount) external onlyOwner { _mint(msg.sender, Amount); }
    ...
    /**
     * @dev Burns All Remaining Tokens
     */
    function ___BurnAllRemainingTokens() external onlyOwner
    {
        for(uint x; x < _totalMinted(); x++) { if(_exists(x)) { _burn(x, false); } }
    }
