...
contract AMERICANFLAGS is
    ...
    ERC721ABurnable
{
    uint256 public constant MAX_SUPPLY = 246;
    uint256 public constant MAX_PUBLIC_MINT = 1;
    uint256 public constant PRICE_PER_TOKEN = 0.0069420 ether;
    ...
    constructor(address payable shareholderAddress_)
        ERC721A("AMERICANFLAGS", "AMERICANFLAGS")
        WCNFTToken()
    {
