...
contract Pacman is IERC20, Ownable {
    ...
    string constant _name = "Pacman";
    string constant _symbol = "PAC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 808_080_808 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0xeD86adcDa61C5D6CF717D82F9710dE09be5F3F09;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xeD86adcDa61C5D6CF717D82F9710dE09be5F3F09] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xeD86adcDa61C5D6CF717D82F9710dE09be5F3F09] = true;
