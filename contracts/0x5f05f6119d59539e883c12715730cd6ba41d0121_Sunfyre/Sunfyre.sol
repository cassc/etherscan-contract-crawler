...
contract Sunfyre is Context, IERC20 {
...
//==========================
    ...
    {buyFee: 0, sellFee: 1000, transferFee: 500});
//==========================
    // Max Limits
...
//===============================================================================================================
    ...
    function launchToken(string memory initName, string memory initSymbol, uint256 initSupply, address devWallet) external onlyOwner payable {
        ...
        maxTxPercent = 201; // Max Transaction Amount: 100 = 1%
        maxTxDivisor = 10000;
        _maxTxAmount = (_tTotal * maxTxPercent) / maxTxDivisor;
        
        maxWalletPercent = 301; //Max Wallet 100: 3%
