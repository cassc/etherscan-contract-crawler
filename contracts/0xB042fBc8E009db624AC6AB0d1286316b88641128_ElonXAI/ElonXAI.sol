...
contract ElonXAI is ERC20, Ownable{
    ...
    uint256 tsupply = 1e10 * 10 ** decimals();
    ...
    Taxes public sellTaxes = Taxes(3,5);
    uint256 public totalTax = 8;
    uint256 public totalSellTax = 8;
    ...
    constructor(address _devWallet) ERC20("ElonXAI", "E.XAI") {
