...
contract Erc721WhiteList is ERC721URIStorage, ReentrancyGuard,Ownable{
  ...
  constructor(
    ...
    price=0.01 ether;
    whitePrice=0.001 ether;

    whiteMinted = true;
    minted = true;

    //usdt =IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    //usdt =IERC20(0xBBa535a0939705e95064749f70990C86334E2b29);
  }
  ...
  function whiteMint(bytes32[] calldata proof) public payable  onlyWhiteMinted {
  ...
  function buyMint() public payable  onlyBuyMinted {
