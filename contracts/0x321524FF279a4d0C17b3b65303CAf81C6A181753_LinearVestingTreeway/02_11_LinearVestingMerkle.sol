...
contract LinearVestingMerkle is Pausable, ReentrancyGuard, Ownable {
    ...
    function addNewTree(address safeGuard) external onlyOwner {
        require(!safeGuardUsed[safeGuard], "BidshopHammerRewards: Safe guard already used");
    ...
    function _canClaim(
        ...
        bytes32 node = keccak256(abi.encodePacked(user, vestingData.totalReward,vestingData.startEpoch,vestingData.totalDays));
