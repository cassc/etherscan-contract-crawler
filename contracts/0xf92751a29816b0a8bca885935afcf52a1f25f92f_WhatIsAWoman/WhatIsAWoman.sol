...
contract WhatIsAWoman is ERC20, Ownable {

    mapping (address => bool) public isBlackListed;
    bool public _isTradeOpen = true;
    uint256 public _maxTxAmount = 777000000000000 * 10 ** decimals();


    constructor() ERC20("What Is A Woman", "WIAW") {
    ...
    function _transfer(
        ...
        if (sender != owner() && recipient != owner()){
            ...
            require(amount <= _maxTxAmount, "Cannot be higher than max Transaction Limit");
         }
