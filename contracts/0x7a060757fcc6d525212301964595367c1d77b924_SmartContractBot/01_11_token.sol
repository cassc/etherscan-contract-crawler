...
contract SmartContractBot is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"SmartContractBot", unicode"SmartContractBot") 
    {
        address supplyRecipient = 0x738B8a3809E7D6F8242329f0264AE2B7777B1333;
        
        updateSwapThreshold(1337000 * (10 ** decimals()) / 10);

        mainAddressSetup(0x738B8a3809E7D6F8242329f0264AE2B7777B1333);
        UpdateTradingFeatures(500, 500, 0);
        ...
        SetMaxBuyLimitAmount(1337000 * (10 ** decimals()) / 10);
        SetMaxSellLimitAmount(1337000*	(10 ** decimals()) / 10);

        _mint(supplyRecipient, 800000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x738B8a3809E7D6F8242329f0264AE2B7777B1333);
    }
    ...
    function SetMaxBuyLimitAmount(uint256 _maxBuyAmount) public onlyOwner {
        maxBuyAmount = _maxBuyAmount;
        
        emit MaxBuyAmountUpdated(_maxBuyAmount);
    }

    function SetMaxSellLimitAmount(uint256 _maxSellAmount) public onlyOwner {
