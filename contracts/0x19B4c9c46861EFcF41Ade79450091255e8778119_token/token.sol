...
$Fetcher 
Is going to be your GO to Web3 DaPP Browser!
Fetcher is the only web browser that will pay you in Dog themed Meme Tokens for searching the web!

📄-White paper already Released!
🌍 - Website Launching Today!
🖼 NFT’s for premium Subscriptions (Ad Free Browsing) 
🔐- Top Level Secure Browsing!
🤲- Give Back to Charity! - percent of taxes go to No Kill Shelter
🎤 Regular Scheduled VC’s

Low Taxes! Only 5/5

TG: https://t.me/FetchertToken
*/
...
contract token is Context, IERC20, Ownable {
    ...
    string private constant _name = "FETCHER";
    string private constant _symbol = "FETCHER";
    ...
    constructor () {
        dev = payable(0x3C885EB84ba3b0811000E4f43F931f10fAa7dcdD);
    ...
    function updateFees(uint256 sellTax, uint256 reflections, uint256 buyTax) external onlyOwner {
        ...
        require(buyTax <= 15, "Must keep fees at 10% or less");
    }
