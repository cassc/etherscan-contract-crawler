...
contract LunarEclipseInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Lunar Eclipse Inu", "LEI") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0x2ECb54146dB12bC06d482221525503541F3b014E); // marketing wallet
        devWallet = address(0x2ECb54146dB12bC06d482221525503541F3b014E); // dev wallet
