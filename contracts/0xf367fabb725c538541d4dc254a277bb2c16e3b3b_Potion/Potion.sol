...
// https://medium.com/@TheAlchemistETH
//
// https://www.thealchemisterc.com/
//
// https://twitter.com/AlchemistOnETH
//
// https://t.me/AlchemistOnETH
//
// SPDX-License-Identifier: Unlicensed
/**

The 1st Neutral Based Reflex Rewards System
Since Reflex/Rebase rewards (of which I was an avid participator) every volume-based non-inflationary Yield Generator has worked with the idea of Taxing Trades.

This is a tested, and tried approach, although the trade tax deters Swing Traders and Sandwich Bots which leads to a lower trading volume.

So I asked my self if it would be possible to generate volume-based yields without taxing trades or introducing Inflationary Effects so this is what I came up with:

alchemistdeployer.eth (verify)
...
contract Potion is ERC20, Ownable {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 15, "Must keep all fees at 15% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee, uint256 _earlySellDevFee) external onlyOwner {
	    ...
	    earlySellDevFee = _earlySellDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 15, "Must keep all fees at 15% or less");
    }
