...
contract LarryPage is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Larry Page"; 
    string private constant _symbol = "PAGE"; 
    ...
    address payable private _developmentWalletAddress = payable(0xD4fc6bD8336b1e1e1da9996a8A2BC090a11ca1fc);
    address payable private _marketingWalletAddress = payable(0xD4fc6bD8336b1e1e1da9996a8A2BC090a11ca1fc);
