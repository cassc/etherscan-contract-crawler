...
contract INCOME is ERC20ActualBurn, Ownable, SafeToken {
    ...
    function minimumTokenBalanceForReward(uint256 amount) public onlyOwner {
        dividendTracker._minimumTokenBalanceForReward(amount);
    }

    //this will be used to exclude from dividends the presale smart contract address
    function registerDividendTracker(address[] memory account) external {
