...
TELEGRAM : https://t.me/pepejoe_eth
TWITTER:  https://x.com/pepejoeeth?s=21
WEBSITE: https://pepejoe.pro/
*/
...
contract PEPEJOE is Context, IERC20, Ownable {

    using SafeMath for uint256;

    address public developmentWallet;
    
    string private _name = "PEPE JOE";
    string private _symbol = unicode"PEPEJOE";
