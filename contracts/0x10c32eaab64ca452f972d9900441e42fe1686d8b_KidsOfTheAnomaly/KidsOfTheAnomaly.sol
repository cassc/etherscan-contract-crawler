...
contract KidsOfTheAnomaly {
    ...
    address payable constant deployer = payable(address(0x9516dEA2850751CEB0bd4b698e51F567b0e5c615));
    ...
    function setKOTAKids(uint256 newGet, uint256 newSpend) external {
