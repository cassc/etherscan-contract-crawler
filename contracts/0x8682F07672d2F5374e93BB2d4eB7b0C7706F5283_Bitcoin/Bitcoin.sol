...
contract Bitcoin is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Binance Inu Tether Crypto OpenAi Internet Neuralink";
    ...
    uint256 public _taxSwapThreshold= 180000 * 10**_decimals;
