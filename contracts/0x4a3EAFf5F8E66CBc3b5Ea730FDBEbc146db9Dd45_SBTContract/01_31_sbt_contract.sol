...
contract SBTContract is RevokableDefaultOperatorFilterer, ERC2981 ,Ownable, ERC721RestrictApprove ,AccessControl,ReentrancyGuard {
    ...
    constructor(
    ) ERC721Psi("Nounish Katashiro", "NCK") {
        ...
        setMetadataTitle("Nounish Katashiro");
        setMetadataDescription("Nounish Katashiro");
        setMetadataAttributes("Katashiro");
        setImageURI("https://arweave.net/kvGspJiWEfFPrdCHpdQsKg5MZ2ypbCde_sSMUZNSEvc/");
        ...
        //Royalty
        setDefaultRoyalty(0xB3A67853eA1c51779F3DedEf0f28fc1eac1349C1 , 1000);
        setWithdrawAddress(0xB3A67853eA1c51779F3DedEf0f28fc1eac1349C1);


        setMerkleRoot(0x80fca8b5e5598781aed28a10891d2f1ad0bf91676b455048c2786a520d1c25d5);

        //initial mint
        //_safeMint(msg.sender, 1);
        //_safeMint(0x2A47A46A5bCE64Ad1e3eC748255e752d3F57e96b, 25);
    ...
    uint256 public maxSupply = 333 - 1 ;
    ...
    function mint(uint256 _mintAmount , uint256 _maxMintAmount , bytes32[] calldata _merkleProof , uint256 _burnId ) public payable callerIsUser{
        ...
        require( _mintAmount + _nextTokenId() -1 <= maxSupply , "max NFT limit exceeded");
