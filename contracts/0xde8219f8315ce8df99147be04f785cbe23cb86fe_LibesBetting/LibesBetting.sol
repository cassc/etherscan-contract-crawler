...
contract NFTEntry is ERC721A, ERC721ABurnable, ERC721AQueryable, Ownable {
    constructor() ERC721A("NFT_ENTRY", "BET") {}
...
contract LibesBetting is Ownable {
    ...
    returns (uint256 _betId) {
        ...
        NFTEntry(NFTBettingAddress).lockToken(_tokenId);
    ...
    verifySignature(nonce, _betId, signature)
     {
        ...
        NFTEntry(NFTBettingAddress).unlockToken(_listToken);
    ...
    function endTournament(
        ...
        for (uint256 i = 0; i < betters[_tournamentId].length; i++) {
             NFTEntry(NFTBettingAddress).unlockToken(
