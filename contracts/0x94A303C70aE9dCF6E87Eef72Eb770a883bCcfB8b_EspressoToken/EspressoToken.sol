...
contract EspressoToken is ERC20, Ownable {
    ...
    constructor(
        ...
        require(_ownerPercentageInitalSupply < 100, "Percentage exceeds 100");
        ...
        uint256 ownerReceiverSupply = (_supply * _ownerPercentageInitalSupply) /
            100;
    ...
    function setFeeOwnerPercentageBuy(uint16 percentage) public onlyOwner {
        require(
            (feeAdminPercentage + burnFeePercentage + percentage) < 100,
