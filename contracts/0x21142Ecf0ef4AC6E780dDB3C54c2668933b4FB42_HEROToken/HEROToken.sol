...
contract HEROToken is Context, ERC20, ERC20Burnable, Ownable {
    uint256 private constant INITIAL_SUPPLY = 10_000_000_000 * 10**18;
    address private constant OWNER_ADDRESS = 0x8fBc4F575522f3310392744a21253a5D03478Df9;

    modifier onlyOwnerAddress() {
        require(_msgSender() == OWNER_ADDRESS, "Only the owner address can perform this action");
        _;
    }
