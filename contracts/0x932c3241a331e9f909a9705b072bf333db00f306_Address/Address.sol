...
contract PolygonStarSwapLP is ERC20 {
    address public immutable minter;

    constructor() ERC20("Polygon Star Swap LPs", "Swap-LP") {
        minter = msg.sender;
    }
...
contract PolygonStarSwap is Ownable, ReentrancyGuard {
    ...
    PolygonStarSwapLP public token;
    ...
    function initialize(
        ...
        // create LP token
        bytes memory bytecode = type(PolygonStarSwapLP).creationCode;
        ...
        token = PolygonStarSwapLP(lpToken);
