...
contract VoltSwap is Ownable {
    ...
    function swap(
        ...
        emit Swap(feeHalfAmount, 0, _voltPath, address(this), block.timestamp + 200);
        ...
        IERC20(VOLT).approve(address(this), (feeHalfAmount * 2));
        emit GetApproval(VOLT, address(this), (feeHalfAmount * 2));

        IERC20(VOLT).transferFrom(address(this), deadAddress, feeHalfAmount);
        emit Burned(VOLT, address(this), deadAddress, feeHalfAmount);

        IERC20(_tokenOut).approve(address(this), (feeHalfAmount * 2));
        emit GetApproval(_tokenOut, address(this), (feeHalfAmount * 2));
