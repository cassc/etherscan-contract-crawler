...
Telegram: https://t.me/BitcoinNewEth

Twitter: https://twitter.com/BitcoinNewEth
...
contract BitcoinNewEth is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bitcoin New";
    string private constant _symbol = unicode"BN";
