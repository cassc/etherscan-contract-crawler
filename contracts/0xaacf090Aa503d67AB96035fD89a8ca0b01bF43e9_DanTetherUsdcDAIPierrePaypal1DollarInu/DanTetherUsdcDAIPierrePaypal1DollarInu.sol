...
contract DanTetherUsdcDAIPierrePaypal1DollarInu is ERC20, Ownable{
    ...
    uint256 tsupply = 111111111111 * 10 ** decimals();
    ...
    constructor(address _MarketingWallet) ERC20("DanTetherUsdcDAIPierrePaypal1DollarInu", "PYUSD") {
