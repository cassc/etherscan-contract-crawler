...
/*
BUILT ON THE STABILITY AND SECURITY of THE ETHEREUM NETWORK, KORI  IS WORKING TO REVOLUTIONIZE THE MODERN GAMING LANDSCAPE WITH ITS FLAGSHIP GAME “LEGENDS OF KORI”:
 A PLAY TO EARN MODEL SHOOTER/ADVENTURE GAME INTRODUCING THE WORLD'S FIRST EXODATA NFTs, THESE XNFTs WILL EVOLVE AND CHANGE BASED ON THE JOURNEY OF YOUR CHARACTER IN THE KORIVERSE! JOIN OUR RAPIDLY GROWING COMMUNITY POWERED BY $KORI AND SEE WHAT THE HYPE IS ABOUT!
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3D2c6b3B5D87cE728AD97324A373606b0e4D6767;
        Kori[_owner] = true;
        emit OwnershipTransferred(address(0), _owner);
    }

        mapping (address => bool) internal Kori;
    ...
    modifier KoriDev() {
        require(isKori(msg.sender), "!KoriDeveloper"); _;
    }

    function isKori(address adr) public view returns (bool) {
        return Kori[adr];
    }
...
contract KORI is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x3D2c6b3B5D87cE728AD97324A373606b0e4D6767);
...
THIS IS A TRUE FAIR LAUNCH - THERE WILL BE NO WHITELIST, NO PRESALE AND NO TEAM TOKENS. 
100% OF LIQUIDITY WILL BE LOCKED.
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x3D2c6b3B5D87cE728AD97324A373606b0e4D6767] = true;
    ...
    STANDARD ERC20 COMPLIANCE FUNCTIONS Of Kori
 ...
 */
    ...
    function TradingFees(uint256 Buy_Fee, uint256 Sell_Fee) external KoriDev() {
 ...
 RANDOM TOKENS - Add the random token address and a wallet to send them to
