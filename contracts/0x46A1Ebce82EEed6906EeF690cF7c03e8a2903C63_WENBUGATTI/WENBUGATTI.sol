...
/**
WEN BUGATTI?
https://t.me/WENBUGATTI
https://twitter.com/WENBUGATTICOIN
*/
...
contract WENBUGATTI is ERC20, Ownable {
    ...
    constructor() ERC20("WEN BUGATTI", "WEN") {
        ...
        uint256 totalSupply = 4200000 * 1e18;

        maxTransactionAmount = 84000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 84000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xB6Ba7Bd36d09e3F9a85fd2A7C3C37c29Ab06e7a7); // set as charity wallet
        marketingWallet = address(0xB6Ba7Bd36d09e3F9a85fd2A7C3C37c29Ab06e7a7); // set as marketing wallet
        devWallet = address(0xB6Ba7Bd36d09e3F9a85fd2A7C3C37c29Ab06e7a7); // set as dev wallet
