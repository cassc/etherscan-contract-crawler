...
{
    // auction variables
    uint256 public allowlistMintMax     = 1;        // max number of tokens per allowlist mint
    ...
    uint256 public oasislistStartDateTime = 1678215600; //utc timestamp for 3/7/2023 20:00:00
    uint256 public allowListStartDateTime = 1678215600; //allowListStartDateTime
    uint256 public allowListEndDateTime   = 1678262400; //allowListEndDateTime  
    uint256 public auctionStartDateTime   = 1678262400; //==allowListEndDateTime; 
    uint256 public auctionEndDateTime     = 1678305600; //auctionEndDateTime
    ...
    Surreality public surreality; // The 721 contract  
    ...
    constructor(Surreality _surreality, address _payee) {
        surreality = _surreality;
    ...
    function set721ContractAddress(Surreality _surreality) public onlyOwner {
        surreality = _surreality;
    }
    ...
    function setRevealed(bool _newRevealed) public onlyOwner {
        surreality.setReveal(_newRevealed);
    }
    ...
    function promoMint(address _to, uint256 _qty) external onlyOwner {
        ...
        promoSupply -= _qty;
        auctionSupply = maxSupply - surreality.totalSupply() - raffleSupply;
    }
    ...
    function publicSaleMint() public payable nonReentrant onlyUnpaused {
        ...
        require(surreality.totalSupply() < surreality.max_supply());
