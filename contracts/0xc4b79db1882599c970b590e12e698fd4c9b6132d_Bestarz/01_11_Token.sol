...
contract Bestarz is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"Bestarz", unicode"BXZ") 
    {
        address supplyRecipient = 0xF8E3964E8E18Ec53B93ab18B8cD5291250165912;
        
        updateSwapThreshold(500000 * (10 ** decimals()));

        taxAddressSetup(0x85675c6EB3e56deFEdE6df3674aA7ee5934481Fc);
        taxFeesSetup(300, 300, 300);
        ...
        _transferOwnership(0xF8E3964E8E18Ec53B93ab18B8cD5291250165912);
    }
