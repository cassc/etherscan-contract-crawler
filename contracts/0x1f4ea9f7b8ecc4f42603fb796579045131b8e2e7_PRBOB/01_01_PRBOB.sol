...
https://t.me/PRBOB_ERC20 telegram 

https://bobgotlockedup.com website 

https://twitter.com/PrisonBobERC/status/1671303374644420611 



Despite the skepticism voiced by Elon Musk, we remain undeterred. 🟧
...
contract PRBOB is ERC20, Ownable {
    ...
    constructor() ERC20("Prisoner Bob", "PRBOB") {
        ...
        uint256 totalSupply = 13_000_000_000 * 1e18;

        maxTransactionAmount = 260_000_000 * 1e18; 
        maxWallet = 260_000_000 * 1e18; 
        ...
        marketingWallet = address(0xFfb617B3B48496e69Bd716C4dE39DC7ed0a17cC9); 
        developmentWallet = address(0xADE597DBe0cAb5799e81558082c65F2086070204); 
