...
contract Mempool is IERC20, Ownable {
    /* -------------------------------------------------------------------------- */
    /*                                   events                                   */
    /* -------------------------------------------------------------------------- */
    ...
    Fee public buyFee = Fee({reflection: 0, marketing: 5, lp: 0, buyback: 0, burn: 0, total: 5});
    Fee public sellFee = Fee({reflection: 0, marketing: 5, lp: 0, buyback: 0, burn: 0, total: 5});
