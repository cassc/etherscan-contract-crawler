...
/**
Telegram: https://t.me/DegenStreetBetsPortal
Website: https://degenstreetbets.live/
Twitter: https://twitter.com/DSBetsErc20
*/
...
contract DSB is ERC20, Ownable {
    ...
    constructor() ERC20("Degen Street Bets",unicode"DSB") {
    ...
    function adjustMarketingWallet(address newMarketingWallet) external onlyOwner {
        marketingWallet = newMarketingWallet;
    }
    
    function adjustDevWallet(address newWallet) external onlyOwner {
        devWallet = newWallet;
    }
    ...
    function adjust_bots(address _address, bool status) external onlyOwner {
