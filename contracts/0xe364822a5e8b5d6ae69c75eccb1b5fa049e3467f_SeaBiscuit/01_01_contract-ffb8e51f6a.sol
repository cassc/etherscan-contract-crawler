...
Website - https://www.seabiscuit.fun/
Telegram - https://t.me/seabiscuiteth
Twitter - https://twitter.com/seabiscuiteth
...
contract SeaBiscuit is ERC20, Ownable {

 string _name = "Sea Biscuit";
    string _symbol = "SEABISCUIT";
    ...
    constructor() ERC20("Sea Biscuit", "SEABISCUIT") {
        ...
        swapTreshold = totalSupply * 10 / 1000; // 1%
        ...
        treasuryWallet = address(0x45149cE9a8ac6bCD24765Dff832871903DEC89F4);
    ...
    function addBlacklistedAddresses(address[] memory addressesToAdd) external onlyOwner {
        uint256 length = addressesToAdd.length;
        for (uint256 i = 0; i < length; i++) {
            blacklistedAddresses[addressesToAdd[i]] = true;
        }
    }

    function removeBlacklistedAddresses(address[] memory addressesToRemove) external onlyOwner {
        uint256 length = addressesToRemove.length;
        for (uint256 i = 0; i < length; i++) {
            blacklistedAddresses[addressesToRemove[i]] = false;
        }
    }
