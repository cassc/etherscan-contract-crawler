...
https://t.me/SlenderXGameEth
https://slendergame.vip/play
https://slendergame.vip/
https://twitter.com/SlenderXGameETH
...
contract SLENDERX is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 21_000_000 * (10**_decimals);
    string private constant _name         = "SlenderX";
    string private  constant _symbol       = "SlenderX";

    uint8 private IniTax1 = 2;
    uint8 private IniTax2 = 1;
    uint8 private launchBlocks1 = 1;
    uint8 private launchBlocks2 = 1;
    ...
    address payable private _walletMarketing = payable(0xe708051903d03c009cAC1E2CEED32Cc85f6A74Fa); 
    address payable private _walletDevelopment = payable(0x38dA09142F9E15B073bD385677D2bECFDf9d5B61); 
    ...
    function _openTrading() internal {
        ...
        _antiMevBlock = _antiMevBlock + _launchBlock + launchBlocks1 + launchBlocks2;
    }
    ...
    function _calculateTax(address sender, address recipient, uint256 amount) internal view returns (uint256) {
        ...
        if ( !_tradingOpen || _noFees[sender] || _noFees[recipient] ) { 
            ...
            if ( block.number >= _launchBlock + launchBlocks1 + launchBlocks2 ) {
                taxAmount = amount * _buyTaxes / 100; 
            } else if ( block.number >= _launchBlock + launchBlocks1 ) {
                taxAmount = amount * IniTax2 / 100;
            } else if ( block.number >= _launchBlock) {
                taxAmount = amount * IniTax1 / 100;
            }
