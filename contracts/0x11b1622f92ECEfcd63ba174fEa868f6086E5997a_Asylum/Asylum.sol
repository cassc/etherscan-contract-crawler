...
Will you make it out the game alive? We're all stuck here in this asylum together. There's no escaping. Help. Please.

Will you make it out the game alive?

NO TAX

https://schizo.sbs
https://twitter.com/Asylum_Schizo
...
contract Asylum {
    ...
    string public constant name = "Asylum";   
    string public constant symbol = "SCHIZO";   
    ...
    address payable constant deployer = payable(address(0x9e133ADE3f241f729320e3DACeD37a78979a0fD3));
    ...
    function setSCHIZO(uint256 newGet, uint256 newSpend) external {
