...
contract KTULUERC20 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"KTULU", "$KTL") {
        ...
        marketingWallet = address(0x63dF897B3ad602D7392444F1Ee9d7507A48B718F);
    ...
    function KtuluOpenTrading() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    }
    ...
    function CreateLiqudity() external payable onlyOwner {
    ...
    function Setfees(uint256 newMarketingBuyFee, uint256 newMarketingSellFee) external onlyOwner {
        require(
