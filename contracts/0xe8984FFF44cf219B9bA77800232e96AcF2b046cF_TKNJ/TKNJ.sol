...
contract TKNJ is ERC20, Ownable {
    ...
    uint256 public constant MAX_SUPPLY = 1000000 ether; // token supply
    uint256 public TAX = 20; // 2%
    uint256 public MAX_TX_AMOUNT = 1000 ether; // maximum amount of tokens that can be bought or sold in a transaction
    ...
    uint256 public swapTokensAtAmount = 50 ether; // minimum amount of tokens to be swapped for ETH - if 0 won't swap
