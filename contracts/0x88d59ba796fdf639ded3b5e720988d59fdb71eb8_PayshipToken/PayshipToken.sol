...
// /////////////////////////////////////////////////////////////////////////////// //
//                                                                                 //
// This is the source code of the contract for PSHP, platform token of Payship.org //
// Deployed by Veronika Voss                                                       //
//                                                                                 //
//   //////  //////  //  //  //////                                                //
//   //  //  //      //  //  //  //                                                //
//   //////  //////  //////  //////                                                //
...
// File: contracts/PayshipToken.sol

pragma solidity ^0.6.0;

/**
 * @title PayshipToken
 * @author GitHub: @veravoss, @vittominacori
 * @dev Implementation of the PayshipToken
 */
contract PayshipToken is ERC20Capped, ERC20Burnable, Roles, TokenRecover {
    ...
    string public constant BUILT_ON = "For https://payship.org by https://github.com/veravoss";
     ...
     */
    modifier canMint() {
        require(!_mintingFinished, "PayshipToken: minting is finished");
        _;
    }
    ...
    modifier canTransfer(address from) {
        require(
            ...
            "PayshipToken: transfer is not enabled or from does not have the OPERATOR role"
        );
        _;
    }
        ...
        ERC20(name, symbol)
    {
        require(
            ...
            "PayshipToken: if finish minting, cap must be equal to initialSupply"
        );
