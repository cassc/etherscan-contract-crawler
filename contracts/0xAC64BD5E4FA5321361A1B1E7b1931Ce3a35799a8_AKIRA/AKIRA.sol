...
Telegram: https://t.me/Akira_erc20
Twitter: https://twitter.com/Akira_erc20
Website: 
...
contract AKIRA is ERC20, Ownable {
    ...
    uint256 private tokenLiquidityThreshold = 2e13 * 10**9;
    uint256 public maxWalletLimit = 2e13 * 10**9;

    address private  marketingWallet = 0x4E6D69aA04d319E10Ee2807a77B190aad5334e26;
    address private devWallet = 0xBE7b52d95D2B444E83Bcc36BAfD18cC8f4BA38f0;
	address public constant DeadAdr = 0x000000000000000000000000000000000000dEaD;
    ...
    Taxes private buytaxes = Taxes(10, 0, 10);
    Taxes private sellTaxes = Taxes(20, 0, 20);

    uint256 public BuyFees = buytaxes.marketing + buytaxes.liquidity + buytaxes.dev;
    uint256 public SellFees = sellTaxes.marketing + sellTaxes.liquidity + sellTaxes.dev;
    ...
    function DefaultSwitch() external onlyOwner {
   ...
   function OpenTrading() external onlyOwner {
    ...
    function SetMaxTxLimit(uint256 maxWallet) external onlyOwner {
        require(maxWallet >= 10000000000, "Cannot set max wallet amount lower than 0.1%");
