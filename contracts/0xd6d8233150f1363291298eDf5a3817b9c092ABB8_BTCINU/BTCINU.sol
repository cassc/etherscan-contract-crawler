...
/**
                    ...
                    Website:      https://bitcoininuerc.vip/

                    Telegram:    https://t.me/BitcoinInuEntry
...
contract BTCINU is ERC20, Ownable {
    ...
    function removeBTClimits() external onlyOwner returns (bool){
    ...
    function updateBitcoinWallet(address newWallet) external onlyOwner {
        devWallet = newWallet;
    }
    ...
    function updateBTC_bots(address _address, bool status) external onlyOwner {
