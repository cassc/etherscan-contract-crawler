...
contract NYOB is ERC20, Ownable {
    mapping(address => bool) private _isExcludedFromFee;
    mapping(address => bool) private _sniper;

    address public _marketingWallet = 0x1077cF60A26bD98e1Ca84aE5e4B8379F5266bBc1;
    address public _devWallet = 0x1077cF60A26bD98e1Ca84aE5e4B8379F5266bBc1;
    ...
    constructor() ERC20("NYAN BOB", "NYOB") {
        uint256 startSupply = 0.006969e9 * 10 ** decimals();
