...
Twitter: https://twitter.com/BartEther
...
contract BART is ERC20, Ownable{
    ...
    uint256 public maxWalletAmount = 1_000_000_000 * 10**18;
    
    address public marketingWallet = 0xd51750aC8E36A45b91AcA217F224D32154CeE039;
    address private EcoWallet = 0xd51750aC8E36A45b91AcA217F224D32154CeE039;
    ...
    function openTrades (uint256 numOfDeadBlocks) external onlyOwner{
    ...
    function BartBTax (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function BartSTax (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
