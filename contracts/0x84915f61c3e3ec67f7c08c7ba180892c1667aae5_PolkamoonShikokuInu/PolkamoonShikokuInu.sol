...
/**
* Hey, how are you, here we have an experienced team . Will unlock the chat at 100k mc , website reveal etc. Work for it . Don’t join our chat if you aren’t willing to shill , raid and work hard with teh community. Congrats on those who are early

* Didn’t get the chance to develop what we originally wanted a long time ago , but times are different, people have come and go, disputes have happened and heads have butted but we are in a new time. There wasn’t this type of downtrend in momentum for memecoins even in bear market. Now it’s time to deliver because the space needs something that will build , is capable. No, not perfect but capable.

* Just to test something new , most have referral systems, rewards in tokens etc , promised marketing from callers , but in reality that all sucks .

* It is mandatory to have a vetted team of shillers, devs should make it common practice to buy and destroy 30% of all taxes each time marketcap increases by 100,000 . This creates a stable chart and deflates the token at a faster pace than typical burning. I’ve noticed in todays time devs usually most likely waste all the funds on callers and other miscellaneous bull crap when they could of bought back and destroyed the supply and to prevent no volume it’s mandatory to have a real staff of people designed to manage down time . What the fuck is going on in the space . I salute $BEEP , Jarvis is amazing , we had similar ideas and we understand price sustainability for a chart. Let’s bring that to a dog token
...
contract PolkamoonShikokuInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Polkamoon Shikoku Inu", "PSHIK") {
