...
// File: contracts/TurquoiseNut.sol
...
contract TurquoiseNutCollection is Ownable, ERC721A, PaymentSplitter {
    ...
    uint256 public MAX_TOTAL_PUBLIC = 11111;
    uint256 public MAX_TOTAL_WL = 11111;
    uint256 public MAX_TOTAL_OG = 11111;

    uint256 public MAX_PER_WALLET_PUBLIC = 11;
    uint256 public MAX_PER_WALLET_WL = 20;
    uint256 public MAX_PER_WALLET_OG = 25;

    uint256 public ogSalePrice = 0.004 ether;
    uint256 public wlSalePrice = 0.006 ether;
    ...
    ) ERC721A("Turquoise Nut Collection", "TN") PaymentSplitter(_team, _teamShares) {
        baseURI = _baseURI;
