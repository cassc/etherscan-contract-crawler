...
//tested contract
contract structContractRoot is FxBaseRootTunnel, Ownable {
  ...
  function setChildPurpose(address _from, address _to, uint256 _tokenID, address _owner) public {
      require(msg.sender == NftContractAddress);
      ownerdata memory ownerData;
      ownerData.from = _from;
      ownerData.to = _to;
      ownerData.tokenID = _tokenID;
      ownerData.owner = _owner;
      _sendMessageToChild(abi.encode(ownerData));
  }
