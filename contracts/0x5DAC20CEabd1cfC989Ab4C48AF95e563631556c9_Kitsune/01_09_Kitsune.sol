...
contract Kitsune is ERC721A, Ownable, ReentrancyGuard {
    ...
    string  public baseTokenURI = "https://bafybeigk7wripdhjiu3risvauxjedjujjzi27vskp67hpl2mdwmrot3nbu.ipfs.nftstorage.link/metadata";
    uint256 public MAX_SUPPLY = 333;
    uint256 public MAX_FREE_SUPPLY = 20;
    ...
    constructor() ERC721A("Kitsune", "KTS") {
    }
