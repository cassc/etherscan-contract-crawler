...
constructor() ERC20("Pepeburn", "PEPEBURN") {
        ...
        marketingWallet = address(0x29249b51A5eDeF8C1858ba5958e6F741b36151F9); // set as marketing wallet
        devWallet = address(0x29249b51A5eDeF8C1858ba5958e6F741b36151F9); // set as dev wallet
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 5 / 1000)/1e4, "Cannot set maxTransactionAmount lower than 0.5%");
        maxTransactionAmount = newNum * (10**18);
    }
 
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 15 / 1000)/1e4, "Cannot set maxWallet lower than 1.5%");
