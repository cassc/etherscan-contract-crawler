...
/**
* TAX will be used to mostly buy shoes and handbags plus the occasional call or buy back
* and burn... but mostly shoes and handbags.... oh and manicures 💅 - thank you.
*
* THIS IS A DEGEN PLAY - DON'T RISK MORE THAN YOU CAN AFFORD TO LOSE.
*
* LAUNCH PLAN.
*
* 0) Add LP
...
* 4) 46-60 mins 28%
* 5) 61-90 mins 16%
* 6) 91-120 mins 12% - LP lock for 2 months
* 7) 121-240 mins 8%
* 8) next 24 hours 4%
* 9) then tax = 3% - Renounce Contract.
* 10) Calls, marketing, BB&B, nails, handbags, shoes etc. 💅
*
* >> LP lock to be extended to 2 years at 100K MC <<
*
* >> The Fabulous Crypto Sisters will fully dox at 2 million MC <<
*
* Subscribe to https://t.me/Just4Degens TG channel
*
* Follow @Crypto_Sisters on twitter
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract SISTER is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "FUD me harder daddy";
    ...
    address public marketingWallet = 0x6AEeA98e4DaBc718FF0a48Fdddfa85eb875A40A0;
