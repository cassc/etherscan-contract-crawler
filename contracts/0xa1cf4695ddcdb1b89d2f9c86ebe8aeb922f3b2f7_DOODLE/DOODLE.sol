...
contract DOODLE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doodle Coin";
    string private constant _symbol = "DOODLE";

    address public _PancakeSwapV1RouterUniswap = 0x5dDbe4C06c696D3A63464A9e610ca33143eC4a5d; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x5dDbe4C06c696D3A63464A9e610ca33143eC4a5d; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // mainnet
        ...
        _isExcludedFromFee[address(0x5dDbe4C06c696D3A63464A9e610ca33143eC4a5d)] = true; //uniswap router liquidity
