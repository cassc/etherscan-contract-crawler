...
contract Incognitoerc is Context, IERC20, Auth {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Incognitoerc";
    string private _symbol = "$NITO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x442780Ab3aC7fe0cB09f775EAbD6F4b58eB23970); // Marketing Address
    address payable public teamWalletAddress = payable(0x8BA69937eDE5a34D2732c0e32CdAd6Cfad3BF4DD); //  
