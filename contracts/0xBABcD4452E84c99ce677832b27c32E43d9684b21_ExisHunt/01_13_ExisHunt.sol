...
contract ExisHunt is Ownable, ERC721A {
    ...
    string public revealedURI = "ipfs://bafybeicuaqf5vv5lrkwwk4yi6wexbejdy22ikcdlwoq2ttp56a6yuet66i/";

    string public hiddenURI = "ipfs://QmNeKp6utBDVhsLeS2yJPoxwoANdtEctCLEkLM9x5Hctmv";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmNeKp6utBDVhsLeS2yJPoxwoANdtEctCLEkLM9x5Hctmv";

    bool public paused = true;
    bool public revealed = true;
    bool public publicSale = true;

    address constant internal CHARITY_ADDRESS = 0x01803b96cA20843a18b2eBF2338137fd25bDb697;
    address public teamWallet = 0x9775d74083eBe42772D58F325abDDd7581A03339;

    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("ExisHunt", "EXIS") {}
