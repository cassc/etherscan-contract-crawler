...
contract NEXT is Context, IERC20, Ownable {
    ...
    string private constant _name = "Next Coin";
    string private constant _symbol = "NEXT";
    ...
    address payable private _developmentAddress = payable(0xD93C90f941262218174bfafcf2FEc43D2E4B6a8F);
    address payable private _marketingAddress = payable(0xD93C90f941262218174bfafcf2FEc43D2E4B6a8F);
