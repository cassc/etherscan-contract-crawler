 ...
 * @notice This contract handles minting Gradures by1nsp1re tokens.
 */
contract GraduresBy1Nsp1Re is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0x80F6b04dbf9ab132Bc6f4A701427724409d48cf5;
    address[] public payoutAddresses = [
        0x80F6b04dbf9ab132Bc6f4A701427724409d48cf5
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeigysqhgcbqb44ydmaqykdbggixqrgz62ak4gyirjtcaco3hdceu3u/";
    ...
    constructor(address _blocklistContractAddress)
        ERC721A("Gradures by1nsp1re", "GRADU")
    {
