...
contract QuantumGambling is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Quantum Gambling", "QG") {
        ...
        marketingWallet = address(0xe6ef5aC87750480D9C12cAcBC77aD941ce742827); // marketingwallet
        devWallet = address(0xe6ef5aC87750480D9C12cAcBC77aD941ce742827); // devwallet
