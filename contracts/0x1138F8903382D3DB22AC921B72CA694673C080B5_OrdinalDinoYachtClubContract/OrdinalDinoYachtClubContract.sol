...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x35b0E2F51Ca2650F6f338c69Ebe43c9200B1c0D1];
  address public erc20Payable = 0x35b0E2F51Ca2650F6f338c69Ebe43c9200B1c0D1;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 5555) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibasmdbxgwcembteau7e2ufe6txpfzzxheydvf6k2vwgo55ufvv3i/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/D4GdrgiC87vFGcNHXF06/contract-metadata";
  }
...
// File: contracts/OrdinalDinoYachtClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OrdinalDinoYachtClubContract is ERC721APlus {
    constructor() ERC721APlus("Ordinal Dino Yacht Club", "ODYC"){}
}