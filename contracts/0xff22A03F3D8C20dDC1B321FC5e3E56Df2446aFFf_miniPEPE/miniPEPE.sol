...
/**
https://twitter.com/miniPEPEcoin
*/
...
contract miniPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("mini PEPE", "miniPEPE") {
        ...
        maxTransactionAmount = 8408408 * 1e18; // 
        maxWallet = 8408408 * 1e18; // 
		...
		charityWallet = address(0xF013457E1aa54C91305400469FE3389147306036); // Charity wallet
        marketingWallet = address(0xF013457E1aa54C91305400469FE3389147306036); // Marketing wallet
        devWallet = address(0xF013457E1aa54C91305400469FE3389147306036); // Developer wallet
