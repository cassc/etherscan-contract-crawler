...
contract Pepetuals is ERC20, Ownable {
    ...
    constructor() ERC20("Pepetuals", "PEPET") {
        ...
        buyFee = 30; // sniper protection, to be lowered to 2% after launch
        sellFee = 50; // sniper protection, to be lowered to 2% after launch

        feeWallet = address(0x9a598210f741f96F96e6d641a13D3ce18A354E90); // set as feewallet
