...
contract WPTNFT is ERC721, IWPTNFT, Ownable {
    ...
    uint256 public feeAmount = 358 * 10**4;
    uint256 public performanceFee = 89 * 10**10;
    uint256 public maxSupply = 1000;
    uint256 public maxLimit = 5;
    uint256 public preMintCount = 200;
    address public feeWallet = 0x4661c339da5d14494C2Dc80330f85D1C719eAAc9;
    address private teamWallet = 0xdA61dAb21521B59CD74bf7be2d5Ff07DA1f0C902;
    address public mintWallet = 0xdA61dAb21521B59CD74bf7be2d5Ff07DA1f0C902;
    // Star id to cid.
    ...
    string private _galaxyName = "Test Beastie";
    string private _galaxySymbol = "TST";

    /* ============ Constructor ============ */
    constructor() ERC721("", "") {
        _setBaseURI("ipfs://QmVW7NMgTPtv4Ze6tjnmr9GacbvXNwFrPGCBdwGycARNZy/");
    }
    ...
    function _transferFee(uint256 amount) internal {
        ...
        if (!whitelists[msg.sender]) {
            uint256 _feeAmount = feeAmount.mul(amount);
    ...
    function removeWhiteLists(address[] memory _users) external onlyOwner {
        for (uint256 i = 0; i < _users.length; i++) {
