...
contract Spacemix is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"Spacemix", unicode"SPCMX") 
    {
        address supplyRecipient = 0xb76EC30a9d0A633285bAD2b556777cD0A12c37F1;
        
        autoBurnFeesSetup(500, 500, 500);

        updateSwapThreshold(490000 * (10 ** decimals()));

        lpTokensReceiverSetup(0x0000000000000000000000000000000000000000);
        liquidityFeesSetup(500, 500, 500);
        ...
        _mint(supplyRecipient, 980000000 * (10 ** decimals()));
