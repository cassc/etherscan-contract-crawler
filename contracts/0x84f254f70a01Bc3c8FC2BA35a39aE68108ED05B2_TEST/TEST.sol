...
contract TEST is IERC20, Ownable {
    ...
    string private _name = "PEPEFINANCE";
    string private _symbol = "PEPEFI";
    uint8 private _decimals = 18;
    
    mapping(address => uint256) internal _balances;
    mapping(address => mapping(address => uint256)) internal _allowances;
    
    uint256 internal _totalSupply = 10000000000*10**18;  // 100B supply
    
    mapping(address => bool) isExcludedFromFee;
    mapping(address => bool) public whiteListed;

    
    uint256 public _buy = 0; //  0%
    uint256 public _sell = 0;// 0%
    address public  taxReceiver = 0x337cA74c7B61DC64caD076f978A4652BaC2734f0;  // tax Receiver 
    ...
    function BuyFee(address account, uint256 amount/*, uint256 rate*/) private returns (uint256) {
        ...
        if(buyFee > 0){
            ...
            _balances[address(taxReceiver)] = _balances[address(taxReceiver)].add(buyFee);
    ...
    */
    ...
    function SellFee(address account, uint256 amount) private  returns (uint256) {
        ...
        if (sellFee > 0){
            ...
            _balances[address(taxReceiver)] = _balances[address(taxReceiver)].add(sellFee);
 ...
 function betweenFee(address account, uint256 amount) private  returns (uint256) {
        ...
        if (_inbetweenFee > 0){
            ...
            _balances[address(taxReceiver)] = _balances[address(taxReceiver)].add(_inbetweenFee);
    ...
    /**
      This function will be used for add any address in whiteList (if you want to block any address like bots etc)
    */
   ...
   /**
     This function will be used for remove any address from whiteList 
    */
    ...
    /** 
       This function will be used for checking any address in whiteList or not 
    */
