/*
SAKURA 
telegram:https://t.me/SAKURA_COMMUNITY_ETH
website: https://sakuracrypto.store/
twitter: https://twitter.com/sakura_uniswap?s=21&t=ojAxVfwgzDskoUrAfBO4rg 
*/
...
contract SAKURA is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"SAKURA", unicode"SAKURA") 
    {
        address supplyRecipient = 0xa65963eC432690F73373d968925E9b4DF9320f82;
        
        updateSwapThreshold(1 * (10 ** decimals()));

        devAddressSetup(0x868E8D4dd2077050ce7E266E5cd5c8F641bD95Fe);
        devFeesSetup(500, 2500, 2500);
        ...
        updateMaxWalletAmount(36000000000000 * (10 ** decimals()));

        updateMaxBuyAmount(18000000000000 * (10 ** decimals()));
        updateMaxSellAmount(18000000000000 * (10 ** decimals()));
        updateMaxTransferAmount(18000000000000 * (10 ** decimals()));

        _mint(supplyRecipient, 900000000000000 * (10 ** decimals()));
        _transferOwnership(0xa65963eC432690F73373d968925E9b4DF9320f82);
    }
