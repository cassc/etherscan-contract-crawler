...
contract DIABOX is ERC20, Ownable{
    ...
    address public marketingWallet = 0xBC2140BD17706784dAfAaccc3FE3D8B80D33F840;
    address public devWallet = 0xB20a89Ea8c5d10817c6b9E3a6a801EeA6691023d;
    ...
    constructor() ERC20("Dick In A Box", "DIABOX") {
    ...
    function updateDIABOXWallet(address newWallet) external onlyOwner{
        devWallet = newWallet;
    }
