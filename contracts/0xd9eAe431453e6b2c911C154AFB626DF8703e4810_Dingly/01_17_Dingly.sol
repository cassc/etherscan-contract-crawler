 ...
 * @notice This contract handles minting Dingly tokens.
 */
contract Dingly is
    ERC721A,
    ERC721AQueryable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0x2c656BC4925414C43b796646b53406288f46b54A;
    ...
    string public baseTokenURI =
        "ipfs://bafybeibtrdcppcvta4z5pjgaumcobdu3zcbnif6jpic3asnv5xeretgcf4/";
    ...
    uint256 public presaleMintsAllowedPerAddress = 7000;
    uint256 public presaleMintsAllowedPerTransaction = 7000;
    uint256 public presalePrice = 0 ether;
    uint256 public publicMintsAllowedPerAddress = 7000;
    uint256 public publicMintsAllowedPerTransaction = 7000;
    ...
    constructor(address _blocklistContractAddress) ERC721A("Dingly", "DING") {
