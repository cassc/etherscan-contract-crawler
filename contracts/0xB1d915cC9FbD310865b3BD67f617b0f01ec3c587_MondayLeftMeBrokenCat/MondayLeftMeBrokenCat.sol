...
Mooooonday Leffffttt Me Brokennnnnnn Tuesdayyy Iiiii Was Throughhh With Hopinnn Wednesdayyy my aching armssss are open Thursday Waiting For Loveee Waiting For Loveeeee

https://t.me/mondayleftmebrokencatETH

https://twitter.com/leftmebrokencat
...
contract MondayLeftMeBrokenCat is Context, IERC20, Ownable { //69

    using SafeMath for uint256;

    string private constant _name = "Monday Left Me Broken Cat"; //69
    string private constant _symbol = "MONDAY"; //69
    ...
    address payable private _developmentAddress = payable(0x15476694330131eb30970fd0c0BbFCf29Df146e4); //69
