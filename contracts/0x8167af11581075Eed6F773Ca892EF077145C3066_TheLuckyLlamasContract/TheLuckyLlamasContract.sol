...
//
//   _               _          _     _                                
//  | |   _   _  ___| | ___   _| |   | | __ _ _ __ ___   __ _ ___      
//  | |  | | | |/ __| |/ / | | | |   | |/ _` | '_ ` _ \ / _` / __|     
//  | |__| |_| | (__|   <| |_| | |___| | (_| | | | | | | (_| \__ \     
//  |_____\__,_|\___|_|\_\\__, |_____|_|\__,_|_| |_| |_|\__,_|___/     
//   _____ _____ _____ ___|___/___ _____ _____ _____ _____ _____ _____ 
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1680369000;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1680282600;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x69956B7773bf5c48E12c9B8dE0b73C7A54e650c5];
  address public erc20Payable = 0x69956B7773bf5c48E12c9B8dE0b73C7A54e650c5;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public earlyMintOwnershipCap = 10;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmVFwE8vb9CqRF3TPCz1N3PzcQa1ooGK4ExTH7hLThY1fv/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/zBXmRqAVNpOZ1po4WwQY/contract-metadata";
  }
...
// File: contracts/TheLuckyLlamasContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheLuckyLlamasContract is ERC721APlus {
    constructor() ERC721APlus("The Lucky Llamas", "LUCK"){}
}