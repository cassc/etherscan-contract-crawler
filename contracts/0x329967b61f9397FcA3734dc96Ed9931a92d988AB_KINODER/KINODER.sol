...
contract KINODER is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Kino Der Token";
    string private constant tokenSymbol = "KINODER";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 13e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xaeA04D4006FDb82777dC89242f317341541bEfA0);
        devAddress = payable(0xaeA04D4006FDb82777dC89242f317341541bEfA0);
