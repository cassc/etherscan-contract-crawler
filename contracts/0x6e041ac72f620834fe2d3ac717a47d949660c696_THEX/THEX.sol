...
/**
        ...
        \__    ___/   |   \_   _____/\   \/  /
          |    | /    ~    \    __)_  \     / 
          |    | \    Y    /        \ /     \ 
          |____|  \___|_  /_______  //___/\  \
                        \/        \/       \_/

    TG: https://t.me/THEXerc20
...
contract THEX is Context, IERC20, Ownable {
    ...
    string private constant _name = "THE X";
    ...
    address payable private _developmentAddress = payable(0x7E064556Ed15796e178B19663d778657E5a5b0Dd);
    ...
    uint256 public _maxTxAmount = 3e4 * 10**9; //
    uint256 public _maxWalletSize = 3e4 * 10**9; //
