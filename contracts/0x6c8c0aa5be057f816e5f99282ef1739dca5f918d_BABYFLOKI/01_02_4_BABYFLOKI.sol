...
contract BABYFLOKI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"HairyPokerObamaSonicDobby10Inu";
    string private constant _symbol = unicode"BABYFLOKI";
    uint256 public _maxTxAmount = _tTotal.mul(2).div(100); // 2% of total supply intially
    uint256 public _maxWalletSize = _tTotal.mul(2).div(100); // 2% of total supply intially
    uint256 public _buyTax = 30; // intialBuyTax
    uint256 public _sellTax = 30; //IntialSell
...
function removeLimits() external onlyOwner {
        ...
        _maxWalletSize = _tTotal; // remove wallet limits
         _buyTax = 1; //change tax to final %, this was done to avoide bots and snipers
        _sellTax = 1; //change tax to final %, this was done to avoide bots and snipers
