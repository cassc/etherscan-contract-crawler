...
contract JANE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("JANE", "JANE") {
        ...
        marketingWallet = address(0xdd205F1d338e16359A93c9F005a1EAa8A832702a); // set as marketing wallet
        devWallet = address(0x2aE22CAf0DeD827Dc9cAf319e7028677a3Eb0D69); // set as dev wallet
