...
From the original team of Clifford Inu
*/
...
contract CLIFFORDINUDEV is ERC20, Ownable {
    ...
    constructor() ERC20("CLIFF2.0", "CLIFF2.0") {
        ...
        maxTransactionAmount = 3200000000000 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 3200000000000 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0xFf67F43Edc66d0118CFB2Ea7Ffa6d9ddf4b96DfB); // set as charity wallet
        marketingWallet = address(0xFf67F43Edc66d0118CFB2Ea7Ffa6d9ddf4b96DfB); // set as marketing wallet
        devWallet = address(0xFf67F43Edc66d0118CFB2Ea7Ffa6d9ddf4b96DfB); // set as dev wallet
