...
contract Setters is State {
    ...
    function _setL2MessageReceive(uint16 chainId,address l2MessageReceive) internal {
        _state.l2MessageReceives[chainId] = l2MessageReceive;
    }

    function _setL2MessageSend(address l2MessageSend) internal {
        _state.l2MessageSend = l2MessageSend;
    }

    function _setL2(bool isL2) internal {
        _state.isL2 = isL2;
    }
}