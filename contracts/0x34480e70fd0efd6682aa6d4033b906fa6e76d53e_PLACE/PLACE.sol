...
contract PLACE is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "PLACE ON BLOCKCHAIN";
    string private constant tokenSymbol = "PLACE";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xEAB2acc5a78A2617411B9E70F44B296F6a5C1448);
        devAddress = payable(0xEAB2acc5a78A2617411B9E70F44B296F6a5C1448);
