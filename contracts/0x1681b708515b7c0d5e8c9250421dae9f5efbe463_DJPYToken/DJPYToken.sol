...
contract DJPYContractBase is Ownable {
    constructor() public {
	}
...
contract DJPYToken is Context, ERC20Burnable, ERC20Pausable, DJPYContractBase {
	...
	uint256 public INITIAL_SUPPLY = 200000000000 * (10 ** uint256(decs));
	
	constructor() public ERC20("Digital Yen Token", "DJPY"){
