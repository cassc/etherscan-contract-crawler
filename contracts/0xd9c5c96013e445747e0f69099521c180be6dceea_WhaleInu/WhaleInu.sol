...
contract WhaleInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x58C2ec0dbdbA19266581d5Ae5187839Dd7933DDC); // Marketing Address
    address payable public multiSigAddress = payable(0x58C2ec0dbdbA19266581d5Ae5187839Dd7933DDC); // Marketing Address
    address payable public devAddress = payable(0x58C2ec0dbdbA19266581d5Ae5187839Dd7933DDC); // Dev Address
    address payable public liquidityAddress = payable(0x58C2ec0dbdbA19266581d5Ae5187839Dd7933DDC); // Liquidity Address
    ...
    string private constant _symbol = unicode"WHALEINU";
