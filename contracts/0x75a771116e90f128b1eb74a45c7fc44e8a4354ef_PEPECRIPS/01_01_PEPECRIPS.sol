...
PepeCripsOGTupacIceCube10🔵Inu ($PEPECRIPS)

Hood life teaches you to appreciate the value of a $PEPECRIPS Token & the power of hustling. 
$PEPECRIPS is a hood token born on the streets of LA, now taking the web3 space by storm.

$PEPECRIPS draws inspiration from the aesthetics of street culture and urban life. 
Its logo features Pepe adorned in Crips blue, sporting a bandana and exuding an air of defiance.

Socials:

OG Website: https://www.pepecrips.com/
OG Twitter: https://twitter.com/PepeCrips
OG Telegram: https://t.me/pepecrips
OG Medium: https://medium.com/@pepecrips/pepecripsogtupacicecube10-inu-28ff1c3aa5b3

No more jeets - only OG vibe.
...
contract PEPECRIPS is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"PepeCripsOGTupacIceCube10🔵Inu", "PEPECRIPS") {
        ...
        maxTransactionAmount = (totalSupply) * 10 / 1000; // 1% of total supply
        maxWallet = (totalSupply) * 10 / 1000;  // 1% of total supply
        ...
        marketingWallet = address(0x302848bC2C8b4c145eC3f6bf8a661Eb0526970e4);
        developmentWallet = address(0x2FA74fCDE70C9294A228C7778392A301a09ea6ea);
        ...
        external
    {
        ...
        require(amount <= balance, "ERC20: Exceeds balance");
