...
contract ApeFightClub is Context, ERC721Tradeable {
  ...
  constructor(address _proxyRegistryAddress) ERC721Tradeable("ApeFightClub", "AFC", _proxyRegistryAddress) {
    _baseTokenURI = "ipfs://tbd/";
    payableAddress = payable(0x1a580b013627Bb8D094B8016842870674Cc53Fe4);
  }
    ...
    function contractURI() public pure returns (string memory) {
      return "ipfs://bafkreibhf334zzpzflg6g7nm5svfjfhmiufk2invrmizn7hz3rah622xqm";
    }
