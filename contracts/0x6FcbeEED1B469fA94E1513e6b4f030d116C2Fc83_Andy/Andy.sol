...
/**
https://twitter.com/ShroomAndy

https://t.me/shrooomandy

https://www.shroom-andy.com
*/
...
contract Andy is ERC20, Ownable {
    ...
    constructor() ERC20("Andy", "SHROOM") payable {
    	...
    	marketingWallet = address(0xd1E33E217A4B6A45Be0Cc3f9d5457Ba69F1cbbFc); // set as Marketing wallet
        devWallet = address(0xEA8743D6553061fBBd8b60947D1176D9842C43F1); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xd1E33E217A4B6A45Be0Cc3f9d5457Ba69F1cbbFc, true);
        excludeFromFees(0xEA8743D6553061fBBd8b60947D1176D9842C43F1, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xd1E33E217A4B6A45Be0Cc3f9d5457Ba69F1cbbFc, true);
        excludeFromMaxTransaction(0xEA8743D6553061fBBd8b60947D1176D9842C43F1, true);
        
        /*
            _createInitialSupply is an internal function that is only called here,
            and CANNOT be called ever again
        */
        _createInitialSupply(0xEA8743D6553061fBBd8b60947D1176D9842C43F1, totalSupply*50/100);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xEA8743D6553061fBBd8b60947D1176D9842C43F1,
            block.timestamp
        );
    }
