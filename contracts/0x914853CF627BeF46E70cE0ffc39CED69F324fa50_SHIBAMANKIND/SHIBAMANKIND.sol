...
Shiba Inu is one type of cryptocurrency, or digital currency, that is available only online. Its price soared in 2021, multiplying many times over, but still trades for tiny fractions of a cent. The year 2022 has been rough for Shiba Inu, with its price plummeting, 
but it still remains one of the world’s most popular cryptocurrencies according to CoinMarketCap. But don’t get this coin confused with the Japanese dog breed that inspired its name.
...
contract SHIBAMANKIND is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBA MANKIND";
    string private _symbol = "$SHIBMK";
    ...
    address payable public marketingaddress = payable(0x1949056f66A8F29a2d1B2464e793A799485eb808);
