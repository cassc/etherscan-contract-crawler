...
contract XWolf is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("XWolf", "XWOLF", maxBatchSize_, collectionSize_) {
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x259cD20e1dB511619DF60aA52405290345f5F339);
