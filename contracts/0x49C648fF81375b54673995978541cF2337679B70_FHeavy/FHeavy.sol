...
contract FHeavy is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Falcon Heavy", "FHXXL") {
        ...
        uint256 totalSupply = 2727272272 * (10**18);
