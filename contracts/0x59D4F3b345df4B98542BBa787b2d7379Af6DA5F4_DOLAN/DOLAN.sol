...
contract DOLAN is ERC20, Ownable {
    ...
    constructor() ERC20("DOLAN DUK", "DOLAN") {
        ...
        devWallet = address(0x9dBB033F838bB3a3205d8bc0516cE53B025F4380); // set as dev wallet
    ...
    function setFees(uint256 newBuyLiquidityFee, uint256 newBuyDevFee, uint256 newSellLiquidityFee, uint256 newSellDevFee) external onlyOwner {
        ...
        require(buyLiquidityFee + buyDevFee <= 5, "fee too high");
        require(sellLiquidityFee + sellDevFee <=5, "fee too high");
    }
