...
contract Staking is Initializable, OwnableUpgradeable, ManageableUpgradeable {
    ...
    uint256 public emergencyUnstakeFees;
    ...
    function emergencyUnstake(uint256 index) public {
        ...
        if (block.timestamp >= halfwayPoint + stake_.startTimestamp) {
            uint256 fractionOfYear = (((block.timestamp -
                stake_.startTimestamp) * PRECISION) / 365) / 86400;
            uint256 apyForDuration = stake_.apy * fractionOfYear;
            ...
            fees =
                (amount * unstakeFees + amount * emergencyUnstakeFees) /
                PRECISION;
        } else {
            ...
            fees = (amount * emergencyUnstakeFees) / PRECISION;
        }
    ...
    function updateEmergencyUnstakeFees(uint256 value) public onlyOwner {
        emergencyUnstakeFees = value;
    }
