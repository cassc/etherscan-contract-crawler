...
The way you trade on ethereum is about to change, welcome to The Terminal.
...
contract TheTerminal is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "The Terminal";
    string private constant _symbol = "$TERMINAL";
    ...
    address payable private _developmentAddress = payable(0x63688229563600a223e133Ae4e196a426412C445); 
    address payable private _marketingAddress = payable(0x63688229563600a223e133Ae4e196a426412C445);
