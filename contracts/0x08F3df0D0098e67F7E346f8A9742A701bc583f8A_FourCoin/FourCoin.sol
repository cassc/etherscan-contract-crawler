...
contract FourCoin is ERC20, Ownable {
    ...
    constructor() ERC20(" FourCoin ", " FOUR ") {
        ...
        uint256 totalSupply = 4 * 10**decimals();
    ...
    function fourCoinFund (uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
