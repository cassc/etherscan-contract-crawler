...
Links:
Telegram: https://t.me/FcoinPortal
Twitter: https://twitter.com/FCoinERC20
Website: https://fcoin.cloud/
**/
...
contract FCOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"F COIN";
    string private constant _symbol = unicode"FFF";
    uint256 public _maxTxAmount = 19980000000 * 10**_decimals;
    uint256 public _maxWalletSize = 19980000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 9990000001 * 10**_decimals;
    uint256 public _maxTaxSwap= 9980000000 * 10**_decimals;
