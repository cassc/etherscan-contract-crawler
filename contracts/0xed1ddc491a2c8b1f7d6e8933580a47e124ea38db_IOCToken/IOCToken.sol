...
// File: @openzeppelin\contracts\utils\types\Time.sol
...
library Time {
     ...
     *                      [uint32]: value after (duration)
...
// File: code-sample\IOCTokenCode\IOCToken.sol
...
contract IOCToken is ERC20, ERC20Pausable, Ownable, ERC20Permit, ERC20Votes {
    constructor(address initialOwner)
        ERC20("IOC Token", "IOC")
        Ownable(initialOwner)
        ERC20Permit("IOC Token")
    {
