...
contract Grimace is ERC20, Ownable {
    ...
    constructor() ERC20("Grimace Coin", "GRIM") {
    ...
    function removeGrimLimits() external onlyOwner returns (bool){
    ...
    function manageGrim_bots(address _address, bool status) external onlyOwner {
