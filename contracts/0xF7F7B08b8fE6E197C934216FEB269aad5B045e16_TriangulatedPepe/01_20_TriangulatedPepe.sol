 ...
 * @notice This contract handles minting Triangulated Pepe tokens.
 */
contract TriangulatedPepe is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xb2d1a1c0E893545141513c2a8b9890a4AB7878E7;
    address public royaltyAddress = 0xD792957B5665225A35958a9793Affab1f1791a8E;
    ...
    constructor()
        ERC721A("Triangulated Pepe", "TriPep")
        RevokableOperatorFilterer(
