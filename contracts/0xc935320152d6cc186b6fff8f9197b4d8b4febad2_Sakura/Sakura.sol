...
/*
    ...
    The Japanese National tree is a vibe....
    Now it will be a mooner too.
    Join the Cherry Blossom movement $SAKURA

    Website: https://sakuracoin.online/
    Telegram: https://t.me/SakuraPortalERC20/
...
contract Sakura is Ownable, ERC20 {
    ...
    uint256 public maxHoldingAmount = 140000000000000000000000;
    ...
    constructor() ERC20("$SAKURA", "SAKURA") {
         address _uniswapV2Pair = IUniswapV2Factory(router.factory())
           ...
           marketingWallet = address(0x454Eb8DA6c8Fdd2B40C94e9DfD226eEC008987f3);

           excludedFromFees[address(this)] = true;
           excludedFromFees[msg.sender] = true;
           excludedFromFees[marketingWallet] = true;

            _mint(msg.sender, 7000000000000000000000000); //7,000,000.000000000000000000 SAKURA
    }
