...
contract VogueSGxBrytehallV2 is ERC1155, Ownable, ERC1155Burnable, ERC1155Supply {
    string public contractURI;

    constructor() ERC1155("https://api.brytehall.com/api/v1/contract6/token/{id}") {
        contractURI = "https://api.brytehall.com/api/v1/contract/6";
    }
