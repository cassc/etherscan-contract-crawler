...
contract pCERToken is TimeLockToken, FreezableToken, PausableToken, BurnableToken {
    string public constant name = "pCER Token";
    string public constant symbol = "pCER";
    uint public constant decimals = 18;

    uint public constant INITIAL_SUPPLY = 111100000000 * (10 ** decimals);
