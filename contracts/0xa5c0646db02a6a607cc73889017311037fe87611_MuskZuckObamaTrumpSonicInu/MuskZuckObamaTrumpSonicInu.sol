...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDCToken = IBEP20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = USDCToken.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            USDCToken.transfer(shareholder, amount);
...
contract MuskZuckObamaTrumpSonicInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "MuskZuckObamaTrumpSonicInu";                            
    ...
    uint256 _totalSupply = 100000 * 10**12 * (10 ** _decimals);
