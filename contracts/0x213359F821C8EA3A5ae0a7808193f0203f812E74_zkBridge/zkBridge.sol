...
// zkBridge. Don't be chained to one blockchain, zkBridge it all.

// https://zkbridge.in/
// https://t.me/zkbridgeportal
// https://twitter.com/zkBridgeERC20
...
contract zkBridge is IERC20, Ownable { 
    string private constant _name = "zkBridge"; 
    string private constant _symbol = "zkBridge";
    ...
    TradingFees public tradingFees = TradingFees(19,29);
    ...
    address payable private constant Treasury = payable(0x41e24c575B1c86C5c74E5FC1E2bf5e222faD1A3a);
