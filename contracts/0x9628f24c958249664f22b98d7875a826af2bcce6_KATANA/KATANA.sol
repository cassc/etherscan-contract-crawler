...
KATANA is a community driven anime-japenese meme coin focused on
connecting fans all over the world. There are many anime based NFT
collaborations in the works, providing promising opportunities for
early and new investors. What are you waiting for? Sheath your KATANA
and join us!

https://t.me/katana_portal
...
contract KATANA is ERC20, Ownable {
    ...
    string private _name = "KATANA";
    string private _symbol = "KTN";

    TransferHelper private transferHelper;
    
    constructor() {
        _totalSupply = 101_000_000_000 * (10 ** decimals());
