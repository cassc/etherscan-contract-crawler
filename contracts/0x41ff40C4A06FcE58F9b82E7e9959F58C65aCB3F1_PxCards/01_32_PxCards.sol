...
contract PxCards is OperatorFilterRegistry, DefaultOperatorFilterer, Context, ERC721Tradeable {
  ...
  constructor(address _proxyAddress) ERC721Tradeable("PxCards", "PXCARD", _proxyAddress) {
    _baseTokenURI = "ipfs://tbd/";
    payableAddress = payable(0x1E51903e98FE8f418e6F27ecE11EEbbA531878f4);
  }
