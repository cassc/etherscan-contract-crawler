...
$SILENCE 0% TAX - https://t.me/silencerc
 ...
 */
contract SILENCE is ERC20 {
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 555888999 * 10 ** 18;

    /**
     * @dev Sets the value of the `decimals`. This value is immutable, it can only be
     * set once during construction.
     */
    constructor () ERC20('SILENCE', unicode"SILENCE", _msgSender()) {
