...
contract ThePilots is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenId;

    uint256 public MAX_SUPPlY = 5000;
    uint256 public MAX_ALLOWED = 25;
    ...
    constructor(string memory baseURI) ERC721("The Pilots", "Pilot") {
        setBaseURI(baseURI);
    }
    ...
    function mintNFT(uint256 _count) public payable 
    {
        ...
        if (msg.sender != owner()) {
            require(totalSupply() + _count <= (MAX_SUPPlY - OWNER_RESERVED), "All NFTs sold");
        }else
        {
            require(totalSupply() + _count <= (MAX_SUPPlY),  "All NFTs sold");
        }
    ...
    function getNetTokenId() public view returns (uint256)
    {
    ...
    {
        require(_exists(tokenId), "RoyaltyNFT: Token does not exist");
        address creator = 0x95E91df6976A5F68092f2E6b578bba3D1eA126c3;
        return (creator, (value * ROYALTY_FEE_PERCENTAGE) / 100);
    }
