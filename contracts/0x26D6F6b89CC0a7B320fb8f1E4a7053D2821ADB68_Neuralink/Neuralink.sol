...
contract Neuralink is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xaa79f44528167dAfe65Dca55B8C4930AfaFF36dc);
    address payable private _marketingAddress = payable(0xaa79f44528167dAfe65Dca55B8C4930AfaFF36dc);
