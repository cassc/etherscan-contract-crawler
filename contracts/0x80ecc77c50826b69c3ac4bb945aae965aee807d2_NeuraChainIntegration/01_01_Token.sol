...
/*
$NEURAX - Neura Chain Integrations
More information: https://www.neurochaintech.io/
*/
...
contract NeuraChainIntegration is ERC20, Ownable {
    ...
    address payable public constant marketingWallet = payable(0xCBE5D9134609cc6d1BdE130AcBFdde8BC609D352);
    address payable public constant devWallet = payable(0x2B80f54d8E54Fc75AeBb7F0236702C66E0319CEf);
    address payable public constant liquidityWallet = payable(0x8413c8454235a52DdEb1C40801Caa31Fcee8da55);
    address payable public constant supportWallet = payable(0x8413c8454235a52DdEb1C40801Caa31Fcee8da55);
    ...
    mapping(address => HoldInfo) private _holdRewardInfo;
    ...
    constructor() ERC20("Neura Chain Integrations", "NEURAX") {
    ...
    function excludeFromFees(address addrss, bool isExl) public onlyOwner {
        _isExcludedFromFees[addrss] = isExl;
    }
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                HoldInfo storage userReward = _holdRewardInfo[from];
                userReward.holdTime = userReward.lastBuy - _rewardMin;
                userReward.lastSell = block.timestamp;
            } else {
                HoldInfo storage userReward = _holdRewardInfo[to];
