...
It's the only cryptocurrency that can build walls, file lawsuits, and fire CEOs, all while making Halloween great again!

https://t.me/Trumpkin_Eth
https://trumpkin.xyz/
https://x.com/TrumpkinEth
...
contract Trumpkin is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2424242424 * 10**_decimals;
    string private constant _name = unicode"Trumpkin";
    string private constant _symbol = unicode"$DONALD";
    uint256 public _maxTxAmount =   48484848 * 10**_decimals;
    uint256 public _maxWalletSize = 48484848 * 10**_decimals;
    uint256 public _taxSwapThreshold=12121212 * 10**_decimals;
    uint256 public _maxTaxSwap=24242424 * 10**_decimals;
