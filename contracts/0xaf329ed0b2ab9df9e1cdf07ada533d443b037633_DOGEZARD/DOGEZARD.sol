...
/**
Who's That Pokemon? DOGEZARD!

Biggest Pokemon themed token ever to be launched on ERC20, fully Pokemon x Crypto focused, collect custom cards as NFTs.
Pull your Pokemon and become the wealthiest chad in Dogezard's space.

Telegram: https://t.me/dogezard
Twitter: https://twitter.com/DOGEZARDETH
Website: https://pokemonpacksimulator.com/
...
contract DOGEZARD is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "DOGEZARD";
    string private constant _symbol = "DOGEZARD";
