...
// File: contracts/SkullElementals.sol
...
contract SkullElementals is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 2655;
  ...
  ) ERC721A("Skull Elementals", "SKULLELEMENTALS") {
