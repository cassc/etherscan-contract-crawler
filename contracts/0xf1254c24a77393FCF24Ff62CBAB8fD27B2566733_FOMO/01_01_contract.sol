...
FomoBot - $FOMO
YOUR TRUSTED DEGEN TOOL

// Website - https://fomobot.tools/
// Twitter - https://twitter.com/FOMO_Bot_ERC
// Portal - https://t.me/fomobotportal
...
contract FOMO is Context, IERC20, Ownable {
    ...
    string private constant _name = "FomoBot";
    ...
    function changeMaxTransactionAmount(uint256 _maxTx, uint256 _maxWallet) public onlyOwner {
