...
// Who doesnt love a german shehperd? 
...
contract BabyGermanShepherd is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby German Shepherd ", "BSHEP") {
        ...
        devOpsWallet = address(0x19dbb122a613f58bf53014f96430dA12DE347698); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x19dbb122a613f58bf53014f96430dA12DE347698), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x19dbb122a613f58bf53014f96430dA12DE347698), true);
