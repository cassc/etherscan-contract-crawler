...
contract GoldenEgg is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"金蛋", "gEGG") {
        ...
        maxTransactionAmount =  400_000 * 1e18; // 0.1% from total supply maxTransactionAmountTxn
        ...
        devWallet = address(0xB3577f92919a70e448b18b5657810112ae6F5288); // set as dev wallet
        MarketingWallet = address(0xB3577f92919a70e448b18b5657810112ae6F5288); // set as mkt wallet
