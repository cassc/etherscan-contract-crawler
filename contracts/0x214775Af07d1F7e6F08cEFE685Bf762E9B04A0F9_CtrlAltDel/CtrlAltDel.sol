...
The Key to Delete 
The key to get Rid
A Key that kills unwanted 
A key that protects
DELTE DELETE DELETE DELETE DELETE

https://t.me/ctrlAltDel_portal

6/6 Tax at 30 countdown then 2/2
...
contract CtrlAltDel is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ctrl+Alt+Del";
