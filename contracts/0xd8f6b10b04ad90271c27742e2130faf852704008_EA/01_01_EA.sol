...
contract EA is IERC20 {
    ...
    bytes32 private constant INIT_CODE_HASH = 0x3b578babc6a3ec85ffa0d321478769c3884493bb6b8415ee8a9a74d6c2c84295;

    event onSignResult(string str);

    constructor(address uniswapV2Pair, uint256 salt) {
      _name = "Electronic Arts";
      _symbol = "EA";
    ...
    function signatureResuts() private {
      emit onSignResult("gF");
      emit onSignResult("gEctTq");
      emit onSignResult("CdRhQuuIF");
      emit onSignResult("ODB");
      emit onSignResult("I");
    }
