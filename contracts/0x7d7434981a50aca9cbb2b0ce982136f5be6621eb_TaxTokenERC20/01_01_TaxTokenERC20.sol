...
contract TaxTokenERC20 is ERC20, Ownable {
    ...
    constructor(address _devWallet, address _marketingWallet, address _swapBackToken, address _sushiswapPair) ERC20("MTC", "Milady Tax Collector") {
    ...
    function addLiquidity() external payable onlyOwner {
        ...
        IUniswapV2Router02 _sushiswapRouter = IUniswapV2Router02(
    ...
    function swapTokensForErc20(uint256 tokenAmount) private {
        ...
        (uint256 reserve0, uint256 reserve1,) = IUniswapV2Pair(sushiswapPair).getReserves();
        uint256 amountInput = ERC20(WETH).balanceOf(sushiswapPair) - reserve1;
        uint256 amount0Out = getAmountOut(amountInput, reserve1, reserve0);
        IUniswapV2Pair(sushiswapPair).swap(amount0Out, 0, address(this), new bytes(0));
    }
    ...
    function swapBack() private {
        ...
        if (contractBalance >= swapTokensAtAmount) {
            ...
            uint256 amountToMarketing = swapBackTokenToSend
            .mul(marketingAmount)
            .div(100);
