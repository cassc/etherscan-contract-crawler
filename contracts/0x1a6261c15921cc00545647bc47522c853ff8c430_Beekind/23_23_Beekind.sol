...
contract Beekind is ERC721A, ERC2981, Ownable, DefaultOperatorFilterer  {
    ...
    function beelistbZzZz(bytes calldata _signature) external noContract isMintable validSignature(_signature, publicSigner) {
    ...
    function bZzZz(uint256 _num) external payable noContract isMintable {
