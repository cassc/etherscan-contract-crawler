...
contract HAPIPIZ is Context, Ownable, IERC20  {
    using SafeMath for uint256;

    address private uniswapV2Pair;
    address payable private _taxWallet;

    string private constant _name = unicode"HAPIPIZ";
    string private constant _symbol = unicode"HAPIPIZ";

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 10 ** 9 * 10 ** _decimals;
    uint256 public _maxTransaction = 5 * _tTotal / 100;   
    uint256 public _maxWallet = 65* _tTotal / 100;
    ...
    address private _devAddr = 0x2cd518E96e060Fc8fA06Ebd36dD6c96D5e61a447;
