...
contract BTC2 is ERC20, Ownable {
    ...
    constructor() ERC20("Bitcoin2", "BTC2") {
        ...
        maxTransactionAmount = 210_000_000 * 1e18; // 1%
        maxWallet = 210_000_000 * 1e18; // 1% 
        ...
        revShareWallet = address(0x7C88320eED580b2561139d0ce404e5C8339e5649); // set as revShare wallet
