...
contract Chillennials is ERC721A, Ownable, ERC2981 {
    ...
    uint256 public immutable supply = 20000;
    ...
    address[] public withdrawAddresses = [0x985AFcA097414E5510c2C4faEbDb287E4F237A1B, 0x1D9016C9131eF6C56310A7246E5efcEcBC79c786];
    uint256[] public withdrawPercentages = [5, 95];

    bytes32 public merkleRoot = 0xa129fce27214ad314d4d96e10ecc534cb2eb1481204069941432ba42406510ef;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x1D9016C9131eF6C56310A7246E5efcEcBC79c786, _royaltyAmount);
    }
