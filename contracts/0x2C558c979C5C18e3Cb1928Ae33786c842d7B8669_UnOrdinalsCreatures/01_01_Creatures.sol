...
contract UnOrdinalsCreatures is ERC721A, TheOperatorFilterer {
    uint256 freePerTx;
    ...
    constructor() ERC721A("UnOrdinals Creatures", "UnOrdinals Creatures") {
        owner = msg.sender;
        freePerTx = 1;
        uri = "ipfs://QmaRZJZA2i1cT9wsrq9xgMmLnVYFAWPnAF61H422QQdqdt/";
    }
    ...
    function _mint(uint256 amount) internal {
        ...
        require(msg.value >= amount * 0.002 ether);
