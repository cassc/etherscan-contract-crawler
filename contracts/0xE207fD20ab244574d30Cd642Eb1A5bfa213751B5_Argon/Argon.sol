...
(which averages about 4000 ppmv, but varies greatly), 23 times as abundant as carbon dioxide (400 ppmv), 
and more than 500 times as abundant as neon (18 ppmv). 
Argon is the most abundant noble gas in Earth's crust, comprising 0.00015% of the crust.    

Argon is here to be the most abundant crpyto project on earth! 
https://t.me/ArgonETH
...
contract Argon is ERC20, Ownable {
    ...
    constructor() ERC20("Argon", "ARGON") {
        ...
        revShareWallet = address(0x1465467d24604815eDc2B26acD4145E9B8dc1Dee); // Set as revShare wallet - Helper Contract
