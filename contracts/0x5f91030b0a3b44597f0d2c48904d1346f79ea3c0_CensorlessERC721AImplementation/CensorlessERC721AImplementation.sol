...
contract CensorlessERC721AImplementation is ERC721A, Controllerable {

    constructor(address owner_) ERC721A(
        "CensorlessERC721A",
        "CERC721A"
    ) {
        proxyInitialize("CensorlessERC721A", "CERC721A", owner_);
    }
    ...
    address owner_) public {
        ...
        // To use Controllerable BURNER functions, set it yourself after.
    ...
    function controllerBurn(uint256 tokenId_, bool approvalCheck_) external
    onlyController("BURNER") {
        _burn(tokenId_, approvalCheck_);
    }
