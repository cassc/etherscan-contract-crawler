// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"nose", unicode"Eyes", unicode"Cheeks", unicode"Mouth", unicode"Smiley", unicode"chromatic aberration", unicode"Background animation", unicode"background"];
        bool private shouldWrapSVG = true;
        string private backgroundColor = "transparent";

        bool public isContractSealed;
        uint public constant maxSupply = 600;
        ...
        ContractData public contractData = ContractData(unicode"MERGE SMILEY BY WONC", unicode"Merge Smileys by WONC celebrate the historic transition to Ethereum proof of stake at 2:20 a.m. EST Sept. 15. They are fully onchain and CC0. They are a free mint for WONC holders.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/41ba3415-8cb6-4968-99ae-426988c7ec39", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/41ba3415-8cb6-4968-99ae-426988c7ec39", "https://womenonchain.xyz/", 600, "0x7CE5C931BEeA68A6Bba6551fF5d993C86fA121C5");

        constructor() ERC721A(unicode"MERGE SMILEY BY WONC", unicode"SMILE") {
            TIERS[0] = [15,32,175,188,190];
TIERS[1] = [15,20,20,20,25,30,30,30,30,30,30,30,30,30,30,30,35,40,45,50];
TIERS[2] = [20,30,80,100,110,129,131];
TIERS[3] = [25,30,50,145,150,200];
TIERS[4] = [20,32,57,75,130,136,150];
TIERS[5] = [50,50,500];
TIERS[6] = [50,50,50,50,50,350];
TIERS[7] = [150,150,150,150];
        }
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"MERGE SMILEY BY WONC #");
