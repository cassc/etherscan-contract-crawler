...
contract DogBird is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20("DogBird", "DogBird") 
    {
        address supplyRecipient = 0x53CFc6c2aCaBf873D21E550c89547Ba261D88094;
        
        updateSwapThreshold(500000 * (10 ** decimals()));

        walletAddressSetup(0x559b38A6755B4589eB6abF3c2c9a19E266201324);
        walletFeesSetup(400, 400, 0);
        ...
        _transferOwnership(0x53CFc6c2aCaBf873D21E550c89547Ba261D88094);
    }
    ...
    function walletFeesSetup(uint16 _buyFee, uint16 _sellFee, uint16 _transferFee) public onlyOwner {
        ...
        totalFees[0] = 0 + walletFees[0];
        totalFees[1] = 0 + walletFees[1];
        totalFees[2] = 0 + walletFees[2];
    ...
    function _transfer(
        ...
        bool canSwap = 0 + _walletPending >= swapThreshold;
        ...
        if (!_swapping && !AMMPairs[from] && canSwap) {
            ...
            if (false || _walletPending > 0) {
                ...
                (success,) = payable(address(walletAddress)).call{value: walletPortion}("");
