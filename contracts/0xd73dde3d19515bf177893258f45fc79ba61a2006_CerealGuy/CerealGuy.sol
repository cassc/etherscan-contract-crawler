...
contract CerealGuy is ERC20, Ownable {
    ...
    constructor() ERC20("Cereal Guy", "CEREAL") {
        ...
        devWallet = address(0x9632CcCF2829C681ED5D122c696869e9d194796a); // set as dev wallet
        MarketingWallet = address(0x9632CcCF2829C681ED5D122c696869e9d194796a); // set as mkt wallet
