...
contract FeesManagerLogic is Ownable {
    ...
    function estimateFees(
        ...
        require(_msgSender() == gochugaruAddress, "Not Gochugaru contract");
    ...
    function updateGochugaruAddress(address _newAddr) external onlyOwner {
        gochugaruContract = IGochugaru(_newAddr);
        gochugaruAddress = _newAddr;
    }
}