...
/**
          ...
          Yield Acquisition Protocol token (YAP)

          https://t.me/yap_token
*/
...
contract yap is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    string private  _name = "Yield Acquisition Protocol";
    string private  _symbol = "YAP";
    uint8 private  _decimals = 18;
    uint256 private _totalSupply = 1e7 * 10 ** _decimals;
