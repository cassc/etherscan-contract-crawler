// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        ContractData public contractData = ContractData(unicode"CryptoBabyTeddies", unicode"The CryptoBabyTeddies are the first larger collection besides the main/genesis Collection CryptoTeddies. They are first and foremost handdrawn pieces of pixel art by the renowned artist numo. It has always been about art first with his collections and this is also true for the CBT. It is hugely inspired by the project CryptoBabyPunks and of course CryptoPunks. The CryptoBabyTeddies are sweet little teddies with different well-known traits. It is on-chain and it is CC0. The CryptoBabyTeddies are part of the whole CryptoTeddies ecosystem and will play a role in future iterations of it.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/7141b334-e4c0-4918-955d-66206dd96061", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/7141b334-e4c0-4918-955d-66206dd96061", "", 700, "0x4b074B99b7454dC183FE363FAca21B2D7B120781");

        constructor() ERC721A(unicode"CryptoBabyTeddies", unicode"CBT") {
            TIERS[0] = [3,3,22,22,35,45,57,65,71,75,85,105,107,116,300];
            TIERS[1] = [3,3,5,5,6,6,6,7,7,8,8,8,9,9,10,11,11,14,14,14,20,20,25,30,30,35,35,40,40,45,45,50,55,55,61,63,63,65,170];
            TIERS[2] = [3,45,55,70,80,85,90,106,110,120,127,220];
            TIERS[3] = [3,3,90,131,178,206,500];
            TIERS[4] = [86,95,130,800];
            TIERS[5] = [7,30,50,111,111,111,111,111,111,358];
            TIERS[6] = [3,3,7,30,50,509,509];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"CryptoBabyTeddies #");
