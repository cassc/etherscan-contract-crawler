...
// File: contracts/tokenrun/battlepass.sol
...
contract TokenRunBattlePass is ERC721x {
    ...
    mapping(address => uint256) mintAddr;
    mapping(uint256 => uint256) tokensLastStakedAt;
    ...
    function initialize(
        ...
        __ERC721x_init("Token Run Battle Pass", "PASS");
