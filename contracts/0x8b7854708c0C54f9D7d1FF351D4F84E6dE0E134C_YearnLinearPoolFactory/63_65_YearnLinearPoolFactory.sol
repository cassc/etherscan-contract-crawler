    ...
    ReentrancyGuard
{
    ...
    event YearnLinearPoolCreated(address indexed pool, uint256 indexed protocolId);
    ...
    /**
     * @dev Deploys a new `YearnLinearPool`.
     */
    function create(
        string memory name,
        ...
        // We are going to deploy both an YearnLinearPool and an YearnLinearPoolRebalancer set as its Asset Manager, but
        ...
        YearnLinearPool.ConstructorArgs memory args;
        args.vault = getVault();
        args.name = name;
        args.symbol = symbol;
        ...
        emit YearnLinearPoolCreated(address(pool), protocolId);
