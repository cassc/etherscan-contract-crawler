...
/**
 ...
 Wax on and wax off LFG

 Mission: charity - fund under privileged kids out of school activities

 Breakdown:
    1% treasury (charity)
    1% LP
    4% buy backs, marketing and competitions
...
abstract contract Project {
    ...
    string constant _name = "MiyagiInu";
    string constant _symbol = "Miyagi";
 ...
 * MainContract
 */
contract MiyagiInu is Project, IERC20, Ownable {
