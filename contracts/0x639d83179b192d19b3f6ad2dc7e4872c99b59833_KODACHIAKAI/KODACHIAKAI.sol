...
contract KODACHIAKAI is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x07dAE00B1A205b2Ac7cf520B105B730fc9804dAA));

    string private _name = "KODACHI AKAI";
    string private _symbol = "KOCHIKAI";
