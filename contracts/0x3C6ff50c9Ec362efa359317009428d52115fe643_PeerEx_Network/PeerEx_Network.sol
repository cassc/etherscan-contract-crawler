...
contract Owned {
    ...
    constructor() public {
        owner = 0xBCBD9D0EaA6dc720B9581C788836ea4ca65Cb04d;
    }
...
// ----------------------------------------------------------------------------
contract PeerEx_Network is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "PeerEx Network";
        decimals = 18;
        _totalSupply = 365000000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
         RATE = 3000000000; // 1 ETH = 300000 PERX 
        DENOMINATOR = 10000;
