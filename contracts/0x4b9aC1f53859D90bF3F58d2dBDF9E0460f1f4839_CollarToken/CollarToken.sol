...
contract CollarToken is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xa8e874c200cAD2762A27284B90743d15B1b5D1cD);
    ...
    constructor() ERC20("Collar", "COLLAR") {
        ...
        devWallet = address(0xa8e874c200cAD2762A27284B90743d15B1b5D1cD); 
