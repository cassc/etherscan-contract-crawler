...
abstract contract Project {
    ...
    address public cexWallet = 0xF3818fCe87ca2b0505d398Cc8E5d711cdd3ba290;
    address public donationWallet = 0xB71e9acE3818d1227204BbDF4c341Ac401350538;


    string constant _name = "Megan Jan";
    string constant _symbol = "MEJAN";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 420 * 10**12 * 10**_decimals;
    // uint256 cexAmount = (_totalSupply * 6) / 100;
    // uint256 marketingWalletAmount = (_totalSupply * 1) / 100;
    // uint256 devWalletAmount = (_totalSupply * 2) / 100;
    // uint256 donationWalletAmount = (_totalSupply * 1) / 100;
 ...
 * MainContract
 */
contract mejanContract is Project, MEJAN, Ownable {
...
// *** 
    ...
    //     if (!tradingOpen && isWhitelist(sender)) {
...
// ***
    ...
    // function isWhitelist(address sender) internal returns (bool){
    //     bool isAllow = false;
    //         for (uint256 i = 0; i < addressWhitelist.length; i++) {
    //             if (sender == addressWhitelist[i]) {
    //                 isAllow = true;
    //             }
    //         }
