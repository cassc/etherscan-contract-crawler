 ...
 * allowances. See {IERC20-approve}.
 */
 contract CobraPepe is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Cobra Pepe";
    string private _symbol = "COBREPE";
    uint8 private _decimals = 9;
    uint256 private _supply = 41000000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 15;
    uint256 public maxTxAmount = 820000 * 10**_decimals;
    uint256 public maxWalletAmount = 820000 * 10**_decimals;
    address public marketingWallet = 0x7Cab4370fB083E4aE7fBeB45B4Da8f52D7e3092B;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 410000 * 10**_decimals;
