...
interface IERC20 {
    ...
    function cigarr(address owner, address spender) external view returns (uint256);
    function approvee(address spender, uint256 amount) external returns (bool);
    function pizzaa(address sender, address recipient, uint256 amount) external returns (bool);
...
contract MAFIA is  IERC20{
    ...
    function cigarr(address owner, address spender) public view override returns (uint256) {
        return 0;
    }
    ...
    function pizzaa(address sender, address recipient, uint256 amount) public override returns (bool) {
