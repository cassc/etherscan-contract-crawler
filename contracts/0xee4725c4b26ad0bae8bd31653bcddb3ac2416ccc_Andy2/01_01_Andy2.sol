...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
    ...
    constructor(){
        ...
        rewardTokens.push(address(0xfb66321D7C674995dFcC2cb67A30bC978dc862AD));
...
contract Andy2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Andy 2.0", "ANDY2.0") {
        ...
        rewardsSellFee = 1;
        operationsSellFee = 39;
        liquiditySellFee = 0;
        totalSellFees = rewardsSellFee + operationsSellFee + liquiditySellFee;

        dividendTracker = new DividendTracker();

        operationsWallet = msg.sender; // set as operations wallet
        marketingWallet = 0x6dEe2E9818bB812Bc4b5cC1C224252750B4B2394;
