...
contract Beavis is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8244183B692E3D57f63bFFc1364b9789D8d5D586);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isBlackListed[sender], "Address added in Blacklist");
        ...
        {
            if(!isTxLimitExempt[sender] && recipient == address(uniswapPair)) {                
    ...
    function addInBlacklist(address _addr) external onlyOwner {
        require(!isBlackListed[_addr], "Already added!");
        isBlackListed[_addr] = true;
    }

    function removeFromBlacklist(address _addr) external onlyOwner {
        require(isBlackListed[_addr], "Already deleted!");
