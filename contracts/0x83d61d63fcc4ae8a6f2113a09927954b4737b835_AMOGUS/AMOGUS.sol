...
contract AMOGUS is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "If you shit in the sink at exactly 4:20 am and yell amogu 69 times,a shadowy figured called mom will come to beat you up and you will wake up in a place called the orphanage";
    string constant _symbol = "AMOGUS";
    ...
    address payable public liquidityFeeReceiver = payable(0x84948395dD3de2927DCeCDd8B332Ca049695fB49);
    address payable public marketingFeeReceiver = payable(0x84948395dD3de2927DCeCDd8B332Ca049695fB49);
