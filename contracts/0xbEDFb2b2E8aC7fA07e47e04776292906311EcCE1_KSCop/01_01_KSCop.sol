...
contract KSCop is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("ClownWorld", "CLOWN") payable
    {
        ...
        setBuyTax(0, 4);
        setSellTax(0, 30);
        setTaxWallets(0x47e9fE7E81eAd51E02ad7058aaFC46dB27956Bfd);
        exclude(msg.sender);
        // owner wallet excluded from tax and cap
        exclude(address(this));
        exclude(0x47e9fE7E81eAd51E02ad7058aaFC46dB27956Bfd);
        // dex tax wallet excluded from tax and cap

        _mint(0x47e9fE7E81eAd51E02ad7058aaFC46dB27956Bfd, initialTeamSupply);
