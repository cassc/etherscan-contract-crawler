...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address internal router = 0xE6605A8FB9c381F1E0120d5b9BB8fA78bD634365;
    string private _symbol;
    string private _name;
    uint8 private _decimals = 9;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private swapEnableds;
    address private _uniswapFactory = 0x53Fd6cd3221fbE699aB244df65822CA0C8AC9E17;
...
contract THECHEF is ERC20, Ownable
{
    constructor()
    ERC20(unicode"THECHEF", unicode"THECHEF")
    {
