...
contract Big is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 420_000_000 * (10**_decimals);
    string private constant _name         = "The Notorious";
    string private constant _symbol       = "B.I.G";
    ...
    address payable private _walletMarketing = payable(0xf96a060c33dD8f07E33056A1fD30b081bD4afD93); 
    address payable private _walletDevelopment = payable(0xf96a060c33dD8f07E33056A1fD30b081bD4afD93); 

    uint256 private _launchBlock;
    uint256 private _maxTxAmount     = _totalSupply; 
    uint256 private _maxWalletAmount = _totalSupply;
    uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
    uint256 private _taxSwapMax = _totalSupply * 50 / 100000;
    ...
    function setFees(uint8 buy, uint8 sell) external onlyOwner {
        require(buy + sell <= 0, "Roundtrip too high");
        _buyTaxRate = buy;
        _sellTaxRate = sell;
    }  
