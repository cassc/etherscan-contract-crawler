...
Ctrl + F5
The refresh key is probably the most used key in a computer from some people using it as an antivirus myth to some pressing it as a daily routine.
Ctrl + F5 
Initial Tax - 5/5
Final Tax - 1/1
...
contract CtrlF5 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ctrl+F5";
