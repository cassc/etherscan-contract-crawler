...
🍌 $BANANA Launch Simulation 🍌

This will be a experiment launch to know how will the official banana launch go.

Since $BANANA is very popular and trending lately.

There's a lot of speculation how the launch will go.

That's why we've created this coin. 

You have to feed your fomo/hype hunger with this coin.
...
contract BANANA is IERC20, Auth {
    ...
    address payable public marketingWallet = payable(0x8057cD7860Dc37974f6752722E0999ea73f8FD5E);
