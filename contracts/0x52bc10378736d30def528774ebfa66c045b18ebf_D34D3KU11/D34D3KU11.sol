...
contract D34D3KU11 is ERC721A  {
    ...
    constructor(){
        super.initial("D34D 3KU11", "3KU11");
        owner = msg.sender;
        freeNum = 3000;
        maxSupply = 4444;
        mintPrice = 0.001 ether;
        freePertx = 3;
        uri = "ipfs://QmYiFQSRyBkcScgSmhuDdqL8y7FBWJ1JcNjQaWpUprKdWi/";
    }
    ...
    function royaltyInfo(uint256 _tokenId, uint256 _salePrice) public override view virtual returns (address, uint256) {
        uint256 royaltyAmount = (_salePrice * 44) / 1000;
