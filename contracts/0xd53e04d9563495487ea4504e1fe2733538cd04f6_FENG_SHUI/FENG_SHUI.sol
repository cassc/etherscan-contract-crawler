...
/**
Telegram: https://t.me/Fengshui_lucky
Twitter: https://twitter.com/FENGSHUI_Erc20
Website: https://www.fengshuicoin.info
*/
...
contract FENG_SHUI is ERC20, Ownable {
    ...
    uint256 public maxWalletLimit = 4e10 * 10**9;

    address private  marketingWallet = 0x9529F115F2FF8b922976d9524EF71bc53f4ffc60;
    address private devWallet = 0xe937D74aF6E0dBcD1Eb1971D5149B38ee819B97b;
    ...
    Taxes private buytaxes = Taxes(0, 0, 2);
    Taxes private sellTaxes = Taxes(0, 0, 2);

    uint256 public BuyTaxes = buytaxes.marketing + buytaxes.liquidity + buytaxes.dev;
    uint256 public SellTaxes = sellTaxes.marketing + sellTaxes.liquidity + sellTaxes.dev;
    ...
    constructor() ERC20("FENG SHUI", "LUCKY") {
   ...
   function UnShake() external onlyOwner {
    ...
    function DefaultTaxes() external onlyOwner {
        buytaxes = Taxes(0, 0, 2);
        sellTaxes = Taxes(0, 0, 2);
    }

   function TaxesSwitch() external onlyOwner {
        buytaxes = Taxes(20, 0, 20);
       ...
       function UpdateBuyFee( uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner {
        ...
        buytaxes.dev = _dev;
     require((_marketing + _dev + _liquidity) <= 50, "Must keep fees at 50% or less");
    }
