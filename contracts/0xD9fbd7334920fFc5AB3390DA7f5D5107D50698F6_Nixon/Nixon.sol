...
/*
Telegram: https://t.me/nixon_erc20
Twitter: https://twitter.com/nixon_erc20
*/
...
contract Nixon is ERC20, Ownable {
    ...
    uint256 public maxTxAmount = (supply * 2) / 100;
    uint256 public maxWalletAmount = (supply * 2) / 100;

    address private marketingWallet =
        0x10887f0163eB008D5B66b55E66B382b248F2c80B;

    uint256 private  liquidityBuyTax = 10;
    uint256 private devBuyTax = 5;

    uint256 private liquiditySellTax = 50;
    uint256 private devSellTax = 10;
    ...
    constructor() ERC20("Richard Milhous Nixon", "Nixon") {
    ...
    function _transfer(
        ...
        if (swapping || excludedFromFees[sender] || excludedFromFees[recipient])
            ...
            if (recipient == pair)
                ...
                fee = (amount *(liquidityBuyTax + devBuyTax)) / 100;
        }
