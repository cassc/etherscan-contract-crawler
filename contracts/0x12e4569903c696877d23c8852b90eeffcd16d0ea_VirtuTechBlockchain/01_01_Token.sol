...
$VTBC - VirtuTech Blockchain

https://www.virtutechsolutions.com/
...
contract VirtuTechBlockchain is ERC20, Ownable {
    ...
    address payable public constant liquidityWallet = payable(0xA97EAffEC37583cf4A3A343d672a71c08d556Edc);
    address payable public constant marketingWallet = payable(0x9f4fBc25ADFD47cB4dc9B6993eaeb2A7bF688341);
    address payable public constant devWallet = payable(0x8e605D61899cAb6CCFf62CeF4DE63246cD759a5F);
    ...
    constructor() ERC20("VirtuTech Blockchain", "VTBC") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapV2Router = _uniswapV2Router;

        uint256 totalSupply = 10_000_000_000 * 1e18;

        swapTokensAtAmount = (totalSupply * 14) / 10000; // 0.14% swap amount
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "Uniswap pair update not allowed");
    ...
    function swapBack() private {
        ...
        if (contractBalance > swapTokensAtAmount * 24) {
            contractBalance = swapTokensAtAmount * 24;
        }
