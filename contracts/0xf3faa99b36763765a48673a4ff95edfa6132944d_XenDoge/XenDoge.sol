...
contract XenDoge is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0x31D1E1D44A0f6537509E2b6Cc70FE92e1eaffC0f; 
    address internal constant marketing_receiver = 0x31D1E1D44A0f6537509E2b6Cc70FE92e1eaffC0f;
    address internal constant liquidity_receiver = 0x31D1E1D44A0f6537509E2b6Cc70FE92e1eaffC0f;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        if(marketingAmt > 50000000000000000){payable(marketing_receiver).transfer(address(this).balance);}
    ...
    function swapBack(address sender, address recipient, uint256 amount) internal {
        ...
        if (swapBackamount >= swapThreshold * 4 ){
            swapBackamount = swapThreshold * 4;
        }
