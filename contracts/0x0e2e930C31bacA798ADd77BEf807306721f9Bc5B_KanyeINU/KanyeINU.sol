...
contract KanyeINU is ERC20, ERC20Permit {
    constructor() ERC20("Kanye INU", "KNYE") ERC20Permit("Kanye INU") {
        _mint(msg.sender, 1000000000 * 10 ** decimals()); // 50% burned on deploy
    }
}