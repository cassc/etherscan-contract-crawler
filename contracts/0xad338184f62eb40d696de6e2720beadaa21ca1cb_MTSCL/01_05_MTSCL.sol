...
//                                                                                        //
//    @@@@@@@@@@@@@[email protected]@@@@@@@@@@@@@@@@@@$$$M|    '[email protected]@L   gg[email protected]@@@@@@@@@@@@@@@@    //
//                                                                                        //
...
contract MTSCL is ERC721Creator {
    constructor() ERC721Creator("Mike Shupp Claims", "MTSCL") {}
}