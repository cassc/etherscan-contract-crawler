...
contract NounsDescriptorV2 is INounsDescriptorV2, Ownable {
    ...
    function dataURI(uint256 tokenId, INounsSeeder.Seed memory seed) public view override returns (string memory) {
        ...
        string memory name = string(abi.encodePacked('YOLO Noun ', nounId));
        string memory description = string(abi.encodePacked('YOLO Noun ', nounId, ' is a member of the YOLO Nouns DAO'));
