...
contract SHITAPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SHIT APE";
    string private constant _symbol = unicode"SHITAPE";
