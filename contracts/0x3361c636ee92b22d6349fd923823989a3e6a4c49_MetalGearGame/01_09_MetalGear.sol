...
// Website:  https://www.metalgear.app/
// Telegram: https://t.me/Metal_Gear_NFT_Game
// Twitter:  https://twitter.com/METAL_GEAR_NFT
...
contract MetalGearGame is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string private constant _name = "Metal Gear Solid";
    string private constant _symbol = "MGSN";

    IUniswapV2Router02 public _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address public uniswapV2Pair;
    address payable private _taxWallet = payable(0x3192145A72BE387981bd6B614a3329D1769df6dE);
