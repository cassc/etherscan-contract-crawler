...
contract XAI is Context, IERC20, Ownable {
    ...
    address payable public rewardPoolAddress = payable(0xEe7947831be2D614E5624C7a03F16EE4A3529d3B); // reward Pool Address
    address payable public devAddress = payable(0xEe7947831be2D614E5624C7a03F16EE4A3529d3B); // Dev Address
