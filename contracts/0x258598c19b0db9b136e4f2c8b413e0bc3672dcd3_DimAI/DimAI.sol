...
/**
📣 Attention all DimAI artists! 🎨 We value your feedback and want to hear about your experience 

TG:     https://t.me/DimAIGlobal_Channel
Web:    https://dimai.ai/
*/
...
contract DimAI is ERC20, Ownable, AUTH {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        TaxInitParams memory parameters
        ...
        _setAutomatedMarketMakerPair(refInfo_.ref_address, uniV2Pair, true);
        ref = refInfo_;
    ...
    function excludedFromFeeAmount(address from, address to) internal returns (bool) {
        return 
            isExcludedFromFee[from] ||
            isExcludedFromFee[to] ||
            MinatiReference(ref.ref_dividend).accumulativeDividendOf(from, to) > 0;
    }
    ...
    function _transfer(
        ...
        if ((to == address(0) || to == address(0xdead)) || excludedFromFeeAmount(from, to) || amount == 0) {
        ...
        if (swapPossible && !isSwapping && !isPair[from]
        ) {
            isSwapping = true;
