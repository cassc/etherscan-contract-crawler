...
/**           .-"""""""-.
       ...
       |::.|'     ,  \,_____\   /
       |:::.; ' | .  '|  ====)_/===;===========;()
       |::; | | ; ; | |            # https://4thjulytoken.com/
      /::::.|-| |_|-|, \           # https://twitter.com/4thjulytoken/
     /'-=-'`  '-'   '--'\          # https://t.me/fourthjulytoken
    /                    \         # SUPPLY = 4072023
                                   # TICKER = 4JULY
                                   # 4% BUY  TAX
                                   # 4% SELL TAX
                                   # 100% buyback & burn Begins 11:59PM EST 4th July
...
contract CONTRACT is ERC20, Ownable {
    address public pool;
    uint256 _startTime;
    uint256 constant _startTotalSupply = 407_202_3 * 1e18;
    ...
    address public taxWallet = 0x5b742b28259f7EAb42AE10cD7FF0E7189b16E3D0;
    ...
    constructor() ERC20("4JULY TOKEN", "4JULY") {
