 ...
 * 
 ...
 |_____/   \____/  |_|             
 * 
 * https://twitter.com/SuPrintooor
 * https://t.me/suprintooor
 * https://famus.su-printooor.com
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            IERC20(SU).transfer(shareholder, amount);
        }
    }
...
contract SuPrintooor is IERC20Metadata, Ownable {
    using SafeMath for uint256;
    ...
    string private constant _name = "Su Printooor";
    ...
    uint256 private constant PRINTOOOR_FEE = 9;
    ...
    constructor(address _marketingAddr) {
        uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // mainnet: 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    ...
    function takeFee(
        ...
        uint256 feeAmount;
        feeAmount = amount.mul(PRINTOOOR_FEE).div(feeDenominator);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForSU(amountToSwap.div(2));

        uint256 dividends = IERC20(SU).balanceOf(address(this));

        bool success = IERC20(SU).transfer(address(distributor), dividends);
