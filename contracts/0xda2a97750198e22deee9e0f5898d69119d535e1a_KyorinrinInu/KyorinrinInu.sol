...
Kyōrinrin are often extravagant; they decorates themselves with the most ornate volumes and scrolls, wearing them like a kimono. 
Compelled by the wisdom of the ages, the volumes that make up a kyōrinrin rise up as a dragon-like spirit.

locked and renounced

Twitter:https://twitter.com/Kyorinrin_Inu
Telegram:https://t.me/Kyorinrin_Inu
*/
...
contract KyorinrinInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Kyōrinrin Inu";
    string private constant _symbol = "KYORINRINI";
