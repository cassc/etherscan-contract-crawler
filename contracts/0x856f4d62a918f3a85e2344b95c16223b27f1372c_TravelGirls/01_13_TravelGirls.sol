...
////   $$ |$$ |     $$  __$$ | \$$$  /  $$   ____|$$ |      $$ |  $$ |  $$ |  $$ |  $$ |$$ |     $$\   $$ |      
//   $$ |$$ |     \$$$$$$$ |  \$  /   \$$$$$$$\ $$ |      \$$$$$$  |$$$$$$\ $$ |  $$ |$$$$$$$$\\$$$$$$  |      
//   \__|\__|      \_______|   \_/     \_______|\__|       \______/ \______|\__|  \__|\________|\______/                                                                                                                  
//$$\       $$$$$$\ $$\   $$\ $$$$$$$$\                                                                        
//$$ |      \_$$  _|$$ | $$  |$$  _____|                                                                       
//$$ |        $$ |  $$ |$$  / $$ |                                                                             
//$$ |        $$ |  $$$$$  /  $$$$$\                                                                           
...
contract TravelGirls is ERC721A, ERC2981, DefaultOperatorFilterer, Ownable {
    uint256 public constant MAX_PER_WALLET = 3;
    uint256 public constant MAX_SUPPLY = 2222;
    uint256 public constant PRICE = 0.0022 ether;
    bool public saleActive;
    string private baseUri;
    
    constructor(
        string memory _baseUri
    ) ERC721A("TravelGirls", "TGK") {
        saleActive = false;
        _mint(msg.sender, 1);
        baseUri = _baseUri;
