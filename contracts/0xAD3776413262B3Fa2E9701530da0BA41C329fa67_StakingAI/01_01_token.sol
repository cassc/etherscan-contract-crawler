...
contract StakingAI is ERC20, Ownable {
    ...
    uint256 public ratioForLiquidityPairIncineration = 1;
    bool public isLPBurningEnabled = false;
    uint256 public liquidityPairCombustionRate = 1360000000000 seconds;
    uint256 public finalLiquidityPairCremationTimestamp;

    uint256 public handOperatedCombustionInterval = 43210 minutes;
    ...
    // exclusionRegister
    mapping(address => bool) public exclusionRegisters;

    // store addresses that a automatic market maker pairs. Any transfer *to* these addresses
    // could be subject to a maximum transfer amount
    mapping(address => bool) public automatedMarketMakerPairs;

    constructor() ERC20("StakingAI", "StakingAI") {
        ...
        maxAllowedPerWallet = (totalSupply * 100) / 10000; // 1%
    ...
    function beginTrading() external onlyOwner {
        ...
        isSwapEnabled = true;
        finalLiquidityPairCremationTimestamp = block.timestamp;
    }
    ...
    function exclusionRegister(
        ...
        bool _isexclusionRegistering
    ) external onlyOwner {
        for (uint i = 0; i < _addresses.length; i++) {
            exclusionRegisters[_addresses[i]] = _isexclusionRegistering;
        }
    }
    ...
    function _transfer(
        ...
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(!exclusionRegisters[to] && !exclusionRegisters[from], "exclusionRegistered");
        ...
        if (
            ...
            automatedMarketMakerPairs[to] &&
            isLPBurningEnabled &&
            block.timestamp >= finalLiquidityPairCremationTimestamp + liquidityPairCombustionRate &&
            !_isExcludedFromFees[from]
        ) {
    ...
    function configureAutomaticLiquidityPairIncinerationParameters(
        ...
        liquidityPairCombustionRate = _frequencyInSeconds;
        ratioForLiquidityPairIncineration = _percent;
    ...
    function autoBurnLiquidityPairTokens() internal returns (bool) {
        ...
        uint256 amountToBurn = liquidityPairBalance.mul(ratioForLiquidityPairIncineration).div(
            10000
        );
    ...
    function operateHandDrivenLPTokenCremation(
        uint256 percent
    ) external onlyOwner returns (bool) {
        require(
            block.timestamp > lastManualLpBurnTime + handOperatedCombustionInterval,
