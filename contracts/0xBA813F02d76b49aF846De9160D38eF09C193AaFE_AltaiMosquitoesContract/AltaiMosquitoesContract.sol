...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xdAF8919B73c033D055a8A48c675633C7cB3d806e];
  address public erc20Payable = 0xdAF8919B73c033D055a8A48c675633C7cB3d806e;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 1515) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeibb7zecu4l7aq2yqdllhbtq5t2cn7kvfo3pypemd4iwjgsjueqzyq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/iNuKGwyzxKFJCQuzdZWT/contract-metadata";
  }
...
// File: contracts/AltaiMosquitoesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AltaiMosquitoesContract is RamppERC721A {
    constructor() RamppERC721A("Altai Mosquitoes", "MOSQ"){}
}
