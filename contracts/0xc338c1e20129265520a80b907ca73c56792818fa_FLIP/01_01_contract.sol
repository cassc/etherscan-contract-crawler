...
Try our bot soon the degens will reap the rewards! Catch you in the tg.

WEBSITE - https://coinfliperc.com/
TELEGRAM - https://t.me/coinfliperc
TWITTER - https://twitter.com/CoinFlipErc

FLIPBOT - https://t.me/coinfliperc_bot
...
contract FLIP is ERC20, Ownable {
    ...
    constructor() ERC20("CoinFlip","FLIP") {
    ...
    function updateBuyFeesAmount(uint256 _operationsFee, uint256 _liquidityFee) external onlyOwner {
