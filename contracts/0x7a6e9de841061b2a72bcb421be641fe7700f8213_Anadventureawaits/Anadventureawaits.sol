...
contract Anadventureawaits is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 777;
    uint256 public price  = 0 ;
    uint256 private maxTransactionAmount =2;
    string baseURI = "ipfs://QmWhkXtozgozBcdzMwaGsCpE6F5oV9sPye6GMNHaRnt4QC/";
    bool paused;



    constructor () ERC721A("An Adventure Awaits","AAA"){
