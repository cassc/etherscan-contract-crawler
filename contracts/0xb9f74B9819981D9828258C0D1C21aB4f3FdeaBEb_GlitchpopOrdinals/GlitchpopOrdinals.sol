...
// File: contracts/GlitchpopOrdinal.sol
...
// File: contracts/GlitchpopOrdinals.sol

pragma solidity >=0.8.9 <0.9.0;

contract GlitchpopOrdinals is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    string baseURI;
    ...
    constructor( string memory _initBaseURI) ERC721A("GlitchpopOrdinals", "GO") { 
