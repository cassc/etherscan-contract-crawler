...
contract BoredBlackJack is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "https://ipfs.io/ipfs/QmZRFAmsLwWbiFYPY33Kys7r6GHpeGzVwESuWkYdHZKyZ6/";
  uint256  public  maxSupply = 7000;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  PUBLIC_SALE_PRICE = 0.002 ether;
  uint256 public  NUM_FREE_MINTS = 5500;
