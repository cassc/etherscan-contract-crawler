...
contract SacrificedShibaCrypt is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Sacrificed ShibaCrypt", "xSCX") {
        uint256 totalSupply = 100000 * 1e6 * 1e9;
        ...
        operationsWallet = address(0x397593E2B21e84B036d84E981c2407411B7100A4); // set as operations wallet
        buybackWallet = address(0x397593E2B21e84B036d84E981c2407411B7100A4); // set as buyback wallet
    ...
    //only the governance contract can mint xSCX
    //using _transfer() to update divivdend shares too
    ...
    function distributeDividends() public payable {
        dividendTracker.distributeDividends{value: msg.value}();
    }
...
contract SCXGovernance is Ownable {
  ...
  address public burnAddress = address(0xdEAD000000000000000042069420694206942069);

  // SCX token
  address public scxAddress = address(0xD15bC1F6408d11c2513444B9d0253efd838AF781);
  ...
  // xToken Address
  //   => address of xToken
   address payable public xTokenAddress;
  ...
  */
  function setXToken(address payable newXTokenAddress) public onlyOwner {
  ...
  */
  function _increaseOwnership(uint256 amount) internal {
    SacrificedShibaCrypt xtoken = SacrificedShibaCrypt(xTokenAddress);
