...
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
//Twitter https://twitter.com/cashapp20eth
//Website https://www.cashapp20eth.com
//Telegram https://t.me/cashapp20eth
//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
contract CASHAPP is ERC20, Ownable {
  
    uint256 public buyFee = 5; // 5% buy marketing fee
    uint256 public sellFee = 15; // 15% sell marketing fee
    ...
    constructor () ERC20("CASHAPP 2.0", "$CASH"){
        address _uniswapV2Pair = IUniswapV2Factory(router.factory())
            .createPair(address(this), router.WETH());
           uniswapV2Pair   = _uniswapV2Pair;
           marketingWallet = address(0x14dBa1dba1B55a53dcEfFeF785C78eA56911CD38);
           devWallet = address(0xD5CBa80b337122EaD7226c3865D9242D6bc09687); 
