...
/* 
website : https://saturneth.xyz
telegram : https://t.me/saturneth
twitter : https://twitter.com/saturnerc20
*/
...
contract SATURN is ERC20, Ownable {
    ...
    constructor() ERC20("Saturn", "SATURN") {
        ...
        marketingWallet = address(0xD1a7a9F6391F5a7CdCbEdd4d020432563A691eFd); 
    ...
    function setTax (uint256 _buyMarketingFee, uint256 _buyBurnFee, uint256 _sellMarketingFee, uint256 _sellBurnFee) external onlyOwner {
        require(_buyMarketingFee + _buyBurnFee <= 30, "Total buy fee cannot be set higher than 30%.");
        require(_sellMarketingFee + _sellBurnFee <= 40, "Total sell fee cannot be set higher than 40%.");
        ...
        sellMarketingFee = _sellMarketingFee;
        sellBurnFee = _sellBurnFee;
        sellTotalFees = sellMarketingFee + buyBurnFee;
    }
