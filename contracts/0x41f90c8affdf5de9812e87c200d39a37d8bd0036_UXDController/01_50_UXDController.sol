    ...
    UXDControllerStorage
{
    ...
    /// @notice Mints redeemable tokens by depositing assets
        ...
        returns (uint256)
    {
        ...
        IERC20Upgradeable(redeemParams.assetToken).safeTransferFrom(depository, redeemParams.intermediary, amountOut);
