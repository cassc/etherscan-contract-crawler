...
contract MementoMeMory is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 1666;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.033 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0xfb79e33cd6fba3607ae6b38aa9e585788f6d5c9d92492bc945894d400df75483;
    bool public publicPaused = false;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmbzGHwveo1q6pz2QEActwA3roiE7NUQYhfcNLumzBKybt";

    constructor() public ERC721A("Memento MeMory", "MEMMO", 1666, 1666) {}
