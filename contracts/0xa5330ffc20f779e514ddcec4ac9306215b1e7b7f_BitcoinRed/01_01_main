...
TELEGRAM: https://t.me/bitcoinred_eth
...
contract BitcoinRed is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Bitcoin Red";
    string private constant _symbol = unicode"BTCRED";
