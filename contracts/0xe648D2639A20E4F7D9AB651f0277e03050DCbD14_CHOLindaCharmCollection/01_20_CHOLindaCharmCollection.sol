 ...
 * @notice This contract handles minting CHO: Linda Charm Collection tokens.
 */
contract CHOLindaCharmCollection is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x27bcC7b14074334154aC352E67771F747924204f;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x67849fAFE88291E6e63fC55eF844AEe3C1cC155B;
    address[] public payoutAddresses = [
        0x95472B621bAdBaBc5D8DE9bf4196A3d6C7aaad00
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeif762ah4f2unmsiexct2j3zrizq7a3vgp2m74j7n2z6a3n2exgakq/";
    ...
    uint256 public presaleMintsAllowedPerTransaction = 9000;
    uint256 public presalePrice = 0.0001 ether;
    uint256 public publicMintsAllowedPerAddress = 1;
    uint256 public publicMintsAllowedPerTransaction = 9000;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("CHO: Linda Charm Collection", "LINDA")
        RevokableOperatorFilterer(
