...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe308c6b9E13Eb829CF6E0F780F43be7c4E1e95fa;
...
contract zenchain is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x0EF9FB848FCe75bDd3fa2434EE90E972cB39cA4c);
    ...
    uint256 private _TotalFee = 8; // Total fee is 4% (buyFee) + 4% (sellFee)
    uint256 public _buyFee = 4;    // 4% buy fee
    uint256 public _sellFee = 4;   // 4% sell fee
