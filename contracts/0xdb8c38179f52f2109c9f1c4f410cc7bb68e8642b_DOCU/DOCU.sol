...
DOCU - The meme token to combine the best of DOGE and CULT. 
...
contract DOCU is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOCU";
    string private constant _symbol = "DOCU";
