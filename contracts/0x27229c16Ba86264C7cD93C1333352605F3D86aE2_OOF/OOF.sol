...
contract OOF is ERC20, Ownable {
    ...
    uint256 private immutable maxSupply = 420_000_000_000_000 * 10 ** decimals();
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    string private constant NAME = unicode"OOF";
    string private constant SYMBOL = unicode"OOF";
    ...
    constructor() ERC20(NAME, SYMBOL) {
        ...
        maxWallet = maxTransactionAmount = (maxSupply * 10) / 100;
