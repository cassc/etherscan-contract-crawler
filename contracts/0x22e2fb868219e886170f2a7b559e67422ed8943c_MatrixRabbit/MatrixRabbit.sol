...
contract MatrixRabbit is ERC20, AccessControl {
    using SafeMath for uint256;
      mapping(address => bool) public VCheck;
    ...
    uint public txFee = 0;
    uint public _maxwallet=30000e18; 
    bool public inSwapAndLiquify = false;

    address public uniswapV2Pair;

    address private marketting_address=0xbdB8B9C116233eA8b90A3909e364b80107D1DE6d;
    ...
    constructor() ERC20("Matrix Rabbit", "MXR") {
        ...
        VCheck[marketting_address]=true;
        VCheck[address(this)]=true;
        VCheck[_msgSender()]=true;
    }
    ...
    function _transfer(
        ...
        if(!VCheck[to]) {
            require(_maxwallet >=  balanceOf(to).add(amount), "ERC20: _maxwallet >= amount");
        }
    ...
    function _createPair(address _router) private {
        ...
        _setupRole(PAIR_HASH,uniswapV2Pair);
         VCheck[uniswapV2Pair]=true;
         VCheck[address(uniswapV2Router)]=true;
    }   
