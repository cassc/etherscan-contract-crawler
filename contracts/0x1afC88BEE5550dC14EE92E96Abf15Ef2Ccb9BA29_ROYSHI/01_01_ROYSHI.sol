...
contract ROYSHI is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 210210420000 * 10**_decimals;
    string private constant _name = unicode"ROYSHI";
    string private constant _symbol = unicode"ROYSHI";
    uint256 public _maxTxAmount =   4204208400 * 10**_decimals;
    uint256 public _maxWalletSize = 4204208400 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=4204208400 * 10**_decimals;
