...
contract Pepatel is Context, IERC20, Ownable, IMultisend, IERC20Permit {
    event Bought(address indexed buyer, uint256 amount);
    event Sold(address indexed seller, uint256 amount);
    using SafeMath for uint256;
    // Constants
    string private constant _name = "Pepatel";
    string private constant _symbol = "PATEL";
    // Standard decimals
    uint8 private constant _decimals = 18;
    uint256 private constant totalTokens = 6942000000000000000000000000;
    // Mappings
