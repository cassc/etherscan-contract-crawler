...
contract TheCryptoOverlords is Ownable, ERC721, ERC721URIStorage, PaymentSplitter {
    ...
    uint256 public constant MAX_TOKENS = 550;
    ...
    uint256 public maxWhitelistPassMints = 550;
