...
contract THUNDERCATS is ERC20, Ownable {
    ...
    constructor() ERC20("THUNDER CATS", unicode"⚡CATS") payable {
    	...
    	marketingWallet = address(0xC23D178626DF7C0930Ff03f08c58f4a5f76EaD19); // set as Marketing wallet
        devWallet = address(0x0A490cCBa3440D295D55c3A76437Df0eCc0e1d32); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xC23D178626DF7C0930Ff03f08c58f4a5f76EaD19, true);
        excludeFromFees(0x0A490cCBa3440D295D55c3A76437Df0eCc0e1d32, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xC23D178626DF7C0930Ff03f08c58f4a5f76EaD19, true);
        excludeFromMaxTransaction(0x0A490cCBa3440D295D55c3A76437Df0eCc0e1d32, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x0A490cCBa3440D295D55c3A76437Df0eCc0e1d32,
            block.timestamp
        );
    }
