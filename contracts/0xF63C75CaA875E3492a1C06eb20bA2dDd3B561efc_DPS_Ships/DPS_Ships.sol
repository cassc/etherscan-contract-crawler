    ...
    UUPSUpgradeable
{
    ...
    function initialize(address _admin) public initializer {
        __ERC721_init("DEEPSPACE Ships", "DPS-Ships");
        ...
        baseURI = "https://assets.deepspace.game/ships/";
        contractURI = "https://assets.deepspace.game/ships";
    }
    ...
    function burn(uint256[] memory tokenIds) external onlyRole(BRIDGE_ROLE) {
        for (uint i = 0; i < tokenIds.length; i++) {
            _burn(tokenIds[i]);
            totalSupply--;
        }
    ...
    function setRoyalty(
        ...
        _setDefaultRoyalty(treasury, _royaltyFeeNumerator);
    }
    ...
    function setBaseURI(string calldata __baseURI) public onlyRole(ADMIN_ROLE) {
        baseURI = __baseURI;
    }
    ...
    function renounceOwnership() public override onlyRole(ADMIN_ROLE) {
        _transferOwnership(address(0));
    }
    ...
    function supportsInterface(
        ...
        public
        view
        override(AccessControlUpgradeable, ERC721RoyaltyUpgradeable)
        returns (bool)
    {
        return
