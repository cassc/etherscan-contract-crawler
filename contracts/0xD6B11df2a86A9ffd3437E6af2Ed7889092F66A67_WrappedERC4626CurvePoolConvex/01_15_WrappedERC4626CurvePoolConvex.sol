...
contract WrappedERC4626CurvePoolConvex is ERC4626, PricePerTokenMixin {
    ...
    {
        return
            _convertLpAmountToShares(curvePool.calcTokenAmount(assets, true));
    }
    ...
    {
        return
            _convertLpAmountToShares(curvePool.calcTokenAmount(assets, false));
    }
    ...
    {
        uint256 lpAmount = _convertSharesToLpAmount(shares);
        return curvePool.calcWithdrawOneCoin(lpAmount);
    }
