...
contract MIU is IERC20 {
    using SafeMath for uint256;

    string private _name = "MIU MIU";
    string private _symbol = "MIU";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1000000000000 * (1**uint256(_decimals));
    ...
    address private constant _marketingWallet = 0x6Ae42aefD9B63415297a4ecbc7c7d7f2867f4FEc;
