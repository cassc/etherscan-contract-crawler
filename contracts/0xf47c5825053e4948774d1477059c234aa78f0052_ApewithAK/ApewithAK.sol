...
contract ApewithAK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ape with AK";
    ...
    constructor () {
        _feeAddrWallet = payable (0x31Ea1BdF1976707eF06C247E04585a8d2747664B);
