...
contract GirlGuard is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 3000;
    uint256 public MAX_MINTS = 275;
    string public baseURI = "https://bafybeic5ng726mvoguqa7tke2crh7b5eo3gnionpkvwvqggjwqx5u3fvdy.ipfs.nftstorage.link/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("GirlGuard", "gg", MAX_MINTS, MAX_SUPPLY) {  
