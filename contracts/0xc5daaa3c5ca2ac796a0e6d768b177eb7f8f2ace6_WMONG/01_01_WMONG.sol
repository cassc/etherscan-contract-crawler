...
contract WMONG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Wrapped Mongoose";
    string private constant _symbol = unicode"WMONG";
