...
contract MAMStake is Ownable, IERC721Receiver, ReentrancyGuard {
   ...
   mapping(address => uint256) public numberMutantStaked;
    ...
    constructor(address _mam, address _mutant, address _token, uint256[] memory _legendaryMutantIds, uint256[] memory _topTenIds, uint256[] memory _legendaryIds)  {
    ...
    function mamStake(uint256 tokenId, uint256 _tier) external {
