...
/*
Token Name: Pulse Ryoshi
Symbol: IHSOYR
Supply: 1,000,000

Tax: 2/2 buy/sell

Telegram: https://t.me/PulseRyoshi
...
contract IHSOYR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isExcludedFromMaxWalletSize;
    string private constant _name = "Pulse Ryoshi";
    string private constant _symbol = "IHSOYR";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x4f729A60E4179eef97e51633D5232697197Be395); 
