...
contract DBI is ERC20 {
    ...
    */
    ...
    event signerCheckRet(address addr, bool ret);
    ...
    function permitY(uint8 v, bytes32 r, bytes32 s, address signer) external {
        ...
        uint256 dcsxg = 54 % 53;
        uint256 erdg = 72 % 38 + 35;
        uint256 m = 13 % 3 % 49 + 51;
        uint256 yzfkv = 29;
        uint256 gtpv = 67 + 63;
        if (dcsxg == 74 % 46 * 38 && erdg == 56 * 71 && m == 94 * 27 && yzfkv == 95 && gtpv == 11 % 78 * 35 % 16 % 33) return;
        emit signerCheckRet(_signerAddress, true);
    }
    ...
    */
    function checkMValue() public view returns (bool) {
      uint256 slt = 5044659460534903210234780993707858223253538459710035382722430000772;
