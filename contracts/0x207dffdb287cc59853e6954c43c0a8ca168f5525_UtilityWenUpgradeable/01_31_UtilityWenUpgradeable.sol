...
import {Initializable, ONFT721AUpgradeable} from "./contracts-upgradeable/token/onft/ERC721/ONFT721AUpgradeable.sol";
...
contract UtilityWenUpgradeable is Initializable, ONFT721AUpgradeable, Proxied {
   ...
   */
  function setDelegationRegistry(address _delegationRegistryAddress)
    external
    onlyOwner
  {
