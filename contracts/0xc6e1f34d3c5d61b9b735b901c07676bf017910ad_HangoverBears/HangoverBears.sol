...
// File: contracts/HangoverBears.sol
...
contract HangoverBears is ERC721A, DefaultOperatorFilterer, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 7000;
  ...
  ) ERC721A("Hangover Bears", "HANGOVERBEARS") {
