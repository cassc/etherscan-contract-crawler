...
contract TinyCats is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmWtrp3BbrwqHpbe6UPXTyCNDwkUD2m3TYinboBHwmBYVe";
    ...
    constructor(
    ) ERC721A("Tiny Cats by Vodnik", "TCV", 100, maxSupply) {
    }
