...
contract PUNK is ERC20, Ownable {
    ...
    address public _marketingWallet = 0x694317C36EE90b0Eb92548e2b08Ad1Ba4FFA906C;
    address public _devWallet = 0x694317C36EE90b0Eb92548e2b08Ad1Ba4FFA906C;

    uint256 public feesBuy = 1500;

    uint256 public _feesM = 3500;
    ...
    constructor() ERC20("Crypto Punk 9998", "Punk9998") {
        uint256 startSupply = 0.0009998e9 * 10 ** decimals();
