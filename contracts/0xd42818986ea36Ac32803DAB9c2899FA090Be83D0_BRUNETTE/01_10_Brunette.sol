...
$BRUNETH is an Ethereum Token emphasizing on the extraordinary beauty and magnificence of Brunettes.

With her long curly black hair, a beautiful face and sexy body, she radiates beauty that puts men in a trance to Grant all her wishes

Telegram: https://t.me/Brun_ethe

Twitter: https://twitter.com/BRUN_ETHE

Website: https://brunette.bio/
*/
...
contract BRUNETTE is ERC20, Ownable {
    ...
    constructor() ERC20("BRUNETTE", "BRUNETH") {
        ...
        marketingWallet = payable(0xB186C077FA8167577Cc4a0cC760a65dA268f8C47);
        developerWallet = payable(0xB186C077FA8167577Cc4a0cC760a65dA268f8C47);
    ...
    function openTrading() external onlyOwner() {
        ...
        _uniswapV2Router.addLiquidityETH{value: address(this).balance}(address(this),balanceOf(address(this)).per(73),0,0,owner(),block.timestamp);
