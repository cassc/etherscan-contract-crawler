...
contract VoxelCrazyHead is Initializable, ERC721AQueryableUpgradeable, DefaultOperatorFiltererUpgradeable,  OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
  ...
  function setApprovalForAll(address operator, bool approved) public override(ERC721AUpgradeable,IERC721AUpgradeable) onlyAllowedOperatorApproval(operator) {
    ...
    function bulkAirdrop(address[] calldata _to, uint256[] calldata _amounts) public onlyOwner {
  ...
  function setMaxAmountPublicSalePerWallet(uint256 _value) public onlyOwner {
    maxAmountPublicSalePerWallet = _value;
  }

    function setMaxAmountWhitelistPerWallet(uint256 _value) public onlyOwner {
