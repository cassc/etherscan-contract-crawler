...
SecuriBlaze
Empowering You, Securing Your Future
     
 ⍣ Website:
   https://securiblaze.com/
       
 ⍣ Telegram:   
   https://t.me/securiblaze
...
contract SecuriBlaze is ERC20, Ownable { 
    ...
    constructor() ERC20("SecuriBlaze", "SBZ") { 
        ...
        maxTransactionAmt = 17_000 * 1e18;  
        maxWallet = 17_000 * 1e18;  

        swapTokensAtAmt = (totalSupply * 5) / 10000;   // 0.05%

        devWallet = msg.sender;   
        marketingWallet = address(0x88117529DC5Aa619aEce47771c4b0123B99e6FB6);   
