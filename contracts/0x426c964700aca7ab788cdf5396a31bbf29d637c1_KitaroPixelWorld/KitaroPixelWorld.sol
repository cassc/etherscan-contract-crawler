...
// File: contracts/KitaroPixelWorld.sol
...
contract KitaroPixelWorld is ERC721A, Ownable, ReentrancyGuard {
  uint256 public MAX_SUPPLY = 4000;
  uint256 public MINT_PRICE = 0.01 * 10 ** 18; // 0.01 ETH
  string public baseURI = "https://shark-app-d4r9v.ondigitalocean.app/api/v1/nft/eu17tig48ufccqdpydk1yb79/";
  bool public pausedMint = false;

  constructor() ERC721A("Kitaro Pixel World", "KITARO") {}
