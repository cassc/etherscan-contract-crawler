    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 370) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmWUbRcDYY9eHb5Qi47QL4mf276gUdQK61Ko2mM2bKfSdt/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 370");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 370");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 370");
...
// File: contracts/MilleniumNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MilleniumNftContract is RamppERC721A {
    constructor() RamppERC721A("Millenium NFT", "MILLENIUM"){}
}
