...
contract HeartPetz is ERC721A, DefaultOperatorFilterer, Pausable, Ownable, ReentrancyGuard {
    using Strings for uint256;

    uint256 public constant WL_LIMIT_PER_WALLET = 5;
    uint256 public constant PUBLIC_LIMIT_PER_WALLET = 5;
    uint256 public constant MAX_SUPPLY = 2222;
    uint256 public constant RESERVED_FOR_TEAM_SUPPLY = 7;

    bool public isMintedReserved = false;
    bool public isWlActive = false;
    bool public isPublicActive = false;

    uint256 public wlPrice = 0.0068 ether;
