...
/*
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |   ______     | || |   _____      | || |     ____     | || |     ______   | || |  ___  ____   | || |     ____     | |
| |  |_   _ \    | || |  |_   _|     | || |   .'    `.   | || |   .' ___  |  | || | |_  ||_  _|  | || |   .'    `.   | |
| |    | |_) |   | || |    | |       | || |  /  .--.  \  | || |  / .'   \_|  | || |   | |_/ /    | || |  /  .--.  \  | |
| |    |  __'.   | || |    | |   _   | || |  | |    | |  | || |  | |         | || |   |  __'.    | || |  | |    | |  | |
| |   _| |__) |  | || |   _| |__/ |  | || |  \  `--'  /  | || |  \ `.___.'\  | || |  _| |  \ \_  | || |  \  `--'  /  | |
| |  |_______/   | || |  |________|  | || |   `.____.'   | || |   `._____.'  | || | |____||____| | || |   `.____.'   | |
| |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
| |  | |/  \| |  | || |   / ____ \   | || |   |  __ /    | || |   '.___`-.   | |
| |  |   /\   |  | || | _/ /    \ \_ | || |  _| |  \ \_  | || |  |`\____) |  | |
| |  |__/  \__|  | || ||____|  |____|| || | |____| |___| | || |  |_______.'  | |
| |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------' 

Adding a new layer to the on-chain PvP:
Play for weekly prize pools in our Web3 Game suite.

- - - - - - - - - 

Telegram: https://t.me/blockowars
Twitter: https://twitter.com/BlockoWars
Web: https://blockowars.com
Warroom: https://warroom.blockowars.com
...
contract BlockoWars is ERC20, Ownable {
    ...
    constructor() ERC20("BLOCKO", "BLOCKO") {
        ...
        marketingWallet = address(0xb78cc9909979ddfAeAc75979A720AeBCF6d1788E); 
        developmentWallet = address(0x4dCEdbe791516b05f8Df6a39Dc5Edc3D0bCAEf85); 
        liquidityWallet = address(0xfEBCa736d7F7Dd2a13196Ac6903C7D8DC82543a7); 
        operationsWallet = address(0x8d88573daaC4e15c35E340E56D6Ce549a8f83E6C);
