...
contract RacerClub is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x627Bda1B40b243f0B265302155d72cE64f028beD));

    string private _name = "RacerClub";
    string private _symbol = "RACERCLUB";
