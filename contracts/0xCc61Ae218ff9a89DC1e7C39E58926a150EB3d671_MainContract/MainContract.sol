...
Token Name: Lightning Chain
Symbol: Voltz
Supply: 1,000,000,000
initial buy 1% 10,000,000
max wallet 3% 30,000,000

Tax: 3/3 (3/8 initial tax will be reverted after bots are kicked)

1% LP
2% Market

socials:
    telegram: https://t.me/LightningChainETH
    twitter: updates at telegram...
    website: updates at telegram...
*/
...
contract MainContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Lightning Chain";
    string private constant _symbol = "Voltz";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0xd4592d21D479eC5320ddf1ec1796639B47709420); 
        ...
        maxTxAmount = 10000001 * 10**9;
        maxWalletAmount = 10000001 * 10**9;          
