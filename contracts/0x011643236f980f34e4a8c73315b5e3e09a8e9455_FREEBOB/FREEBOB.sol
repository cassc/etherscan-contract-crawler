...
contract FREEBOB is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"#FREEBOB";
    ...
    address payable private _developmentAddress = payable(0x119c9146c58f991322AFD5b674A978C9536cdc5c); 
    address payable private _marketingAddress = payable(0x119c9146c58f991322AFD5b674A978C9536cdc5c);
