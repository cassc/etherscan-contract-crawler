...
// Telegram : t.me/Casper_erc20
// Twitter: https://twitter.com/jerry_erc20?s=11&t=jk__GHy0IAOI-U12rrwdvg
...
contract CasperToken is ERC20Capped {
    address payable public owner;

    // There can never be more than 1Billion Tokens
    uint256 maxSupply = 1000000000 * (10 ** decimals());

    constructor() ERC20("Jerry", "JERRY") ERC20Capped(maxSupply) {
