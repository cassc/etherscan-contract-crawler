...
contract BtcBonk is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BtcBonk";
    string private constant _symbol = "BtcBonk";
    ...
    address payable private _developmentAddress = payable(0xb740dEEDc0Ef760F353A28dB239cAE7b1D4b016E); 
    address payable private _marketingAddress = payable(0xb740dEEDc0Ef760F353A28dB239cAE7b1D4b016E);
    ...
    uint256 public _maxTxAmount = 840001 * 10**9; 
    uint256 public _maxWalletSize = 840001 * 10**9; 
