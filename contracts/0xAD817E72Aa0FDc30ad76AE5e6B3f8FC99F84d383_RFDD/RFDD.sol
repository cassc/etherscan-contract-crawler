...
contract RFDD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"REFUNDED";
    string private constant _symbol = unicode"RFDD";
