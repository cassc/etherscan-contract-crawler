...
contract PixelBirdy is ERC721A, Ownable{
    using Strings for uint256;

    constructor() ERC721A("PixelBirdy", "PBIRDY") {}

    uint256 public cost = 3330000000000000;
    uint256 public maxMintAmountPerTx = 100;
    bool public paused = false;
    uint16 public maxSupply = 3333;
    string private URI = "ipfs://bafybeignacm5xxrwlxarikypxe4rwo6zgbhqodwdk6gum73pln2vxciw6i/"; 
    string private uriPrefix;
    string private uriSuffix = "";
    mapping (address => bool) public NFTPerPublicAddress;

    function freeMint() public {
        require(!NFTPerPublicAddress[msg.sender], "Sorry only one Free Mint per Wallet");
         _safeMint(msg.sender , 1);
         NFTPerPublicAddress[msg.sender] = true;
    }
