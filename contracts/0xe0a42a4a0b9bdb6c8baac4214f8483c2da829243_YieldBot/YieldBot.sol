...
Telegram: https://t.me/YieldBotETH
...
contract YieldBot {
    ...
    address payable constant deployer = payable(address(0x6027480bD1386bb698030328287027f565185a37));
    ...
    function setYBOT(uint256 newBuyTax, uint256 newSellTax) external {
