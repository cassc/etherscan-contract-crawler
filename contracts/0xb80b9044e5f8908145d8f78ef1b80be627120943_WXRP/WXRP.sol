...
contract WXRP is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"WXRP";
    string private constant _symbol = unicode"WXRP";
    ...
    address payable private _developmentAddress = payable(0x8FEa6A390c4A1717772cc0F9b639532ceAF4f323);
    address payable private _marketingAddress = payable(0x8FEa6A390c4A1717772cc0F9b639532ceAF4f323);
