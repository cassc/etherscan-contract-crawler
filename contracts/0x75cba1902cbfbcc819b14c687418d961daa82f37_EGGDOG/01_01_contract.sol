...
Twitter: https://twitter.com/eggdog2eth

Telegram: https://t.me/eggdog2

Website: https://eggdog2.vip/
...
contract EGGDOG is ERC20, Ownable {
    ...
    constructor(
        ...
        maxTransactionAmount = 45000000 * 1e18;
        maxWallet = 45000000 * 1e18;
        swapTokensAtAmount = 3500000 * 1e18;

        AWallet = address(0x2810a883b5228d34Ab634B4e5f7A1ce33E645C68); 
    ...
    function updateMarketingWallet(address newAWallet) external onlyOwner {
        emit AWalletUpdated(newAWallet, AWallet);
        AWallet = newAWallet;
    }

    function excludeFromFees(address account) public view returns (bool) {
