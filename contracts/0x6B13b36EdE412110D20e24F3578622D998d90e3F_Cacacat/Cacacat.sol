...
contract Cacacat is ERC2981, ERC721A, Ownable {
    using Strings for uint256;

    uint32 public constant MAX_SUPPLY = 777;

    uint32 public _MintPerWallet = 5;

    bool public _publicMintActive = true;
    
    uint256 public _price = 0.0099 ether;

    string public _prerevealURI = "ipfs://bafybeifno5632y76i5bglarsdczgimjvoavsgbgwpfac2epi4twkymt7tu/cat.json";
    string public _matadataURI;

    constructor() ERC721A("Cacacat", "CC") {
