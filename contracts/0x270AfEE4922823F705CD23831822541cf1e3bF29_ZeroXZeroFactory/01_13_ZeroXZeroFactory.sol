...
contract ZeroXZeroFactory is ERC721, ERC721URIStorage, Ownable { 
    ...
    uint public price = 0.096 ether;
    uint public totalSupply = 10000;
    uint public mintSupply = 8500;
    uint public claimSupply = 1500;
    uint public nonce = 0;
    uint public maxTx = 2;
...
///////////
    constructor() ERC721("0x0WEIRDOS", "0x0WEIRDOS") {}
...
/////////////// Public Sale        
    ...
    function withdrawTeam() external onlyOwner {
        payable(0x9182A76e84d82355453b9d805d3eB55bFC04f64d).transfer(address(this).balance);
    }
