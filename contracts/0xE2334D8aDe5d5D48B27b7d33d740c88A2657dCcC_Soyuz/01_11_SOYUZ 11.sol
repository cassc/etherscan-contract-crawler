...
/*
Taking one small step for crypto and one GIANT LEAP for bag holders - We are setting off for the moon!

Soyuz 11: Soyuz 11 was a Soviet spacecraft that achieved the first manned mission to an orbiting space station, Salyut 1, in 1971. However, during re-entry, a cabin vent valve opened prematurely, causing the crew to be exposed to the vacuum of space. All three cosmonauts on board, Georgi Dobrovolski, Viktor Patsayev, and Vladislav Volkov, lost their lives.

Telegram:  https://t.me/Soyuz11Portal
Twitter: https://twitter.com/soyuz_11
Website: https://soyuz.live/
*/ 
...
contract Soyuz  is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = "SOYUZ 11 ";
    string private constant _symbol = "SOYUZ";
