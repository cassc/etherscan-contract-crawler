...
contract WallWonders is ERC721A, Ownable {
    using Strings for uint256;

    uint16 public immutable MAX_SUPPLY = 250;
    uint16 public immutable MAX_PER_TX = 5;
    uint256 public PRICE = 0.005 ether;
    bool public IS_SALE_ACTIVE = false;
    string _URI = "https://gateway.pinata.cloud/ipfs/QmPPWNgQwZPrtF9GtpbHNJm4GUMd5CkL23vHX3xBSP2gyc/";
