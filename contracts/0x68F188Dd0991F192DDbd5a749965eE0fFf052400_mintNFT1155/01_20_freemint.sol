    ...
    ERC2981
{
    ...
    constructor() ERC1155("") {
        name = "KOJIPRO Music Video NFTs";
        symbol = "KMVN";
        dataByTokenId[1].paused = true;
        dataByTokenId[1].maxSupply = 6000;
        dataByTokenId[1].cost = 0;
        dataByTokenId[1]
            .merkleRoot = 0x69e06ea7bb1c9324cce486ed497d01584cc3548e9442174d535c07eb3b163d8a;
        setDefaultRoyalty(0x67582F38b7FE150D8530491Ee96945691f7793eC, 1000);
    }
    ...
    function ownerMint(uint256 _tokenId,uint256 _mintAmount, address _receiver) public onlyOwner {
        //check
        require(
            (dataByTokenId[_tokenId].totalSupply + _mintAmount) <=
                dataByTokenId[_tokenId].maxSupply,
