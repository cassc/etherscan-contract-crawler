...
contract MemoryBoxEditions is TLCreator {
    ...
    /// @dev override to lock in blocklist in constructor
    function updateBlockListRegistry(address) public {
        revert("No updates to BlockList allowed");
    }
}