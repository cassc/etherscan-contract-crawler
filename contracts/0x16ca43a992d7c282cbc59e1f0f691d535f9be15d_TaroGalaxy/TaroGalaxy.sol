...
// https://tgalaxy.finance
// https://twitter.com/TaroGalaxyToken
...
contract TaroGalaxy is ERC20, Ownable {
    ...
    constructor() ERC20("Taro Galaxy", "TAGA") {
        ...
        marketingWallet = address(0xACAB324019282BB7624535e8A5640dFF51A29Ee2); // set as marketing wallet
        devWallet = address(0x98E7a289D6240b50ec981cC1c7B8Db90C9D6b3F1); // set as dev wallet
