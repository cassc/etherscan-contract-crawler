...
contract WIREFRAUD is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("WIREFRAUD", "WIREFRAUD") {
     ...
     uint256 totalSupply = 10 * 10 ** 6 * 10 ** decimals();
        ...
        MarketingWallet = address(0x37c245aD34856E2269a911B882b0eFd77d28C590); // set as Marketing wallet
        DevWallet = address(0x37c245aD34856E2269a911B882b0eFd77d28C590); // set as dev wallet
