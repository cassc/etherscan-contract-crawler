...
contract NotAptomingos is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.001 ether;
  uint public          maxPerTx          = 10;
  uint public          maxFreePerWallet  = 2;
  uint public          totalFree         = 1212;
  uint public          maxSupply         = 1212;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("NotAptomingos", "NotAptomingo"){}
