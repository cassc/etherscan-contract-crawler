...
// Telegram : https://t.me/ShiwaERC

// Twitter : https://twitter.com/ShiwaERC

// Medium : https://medium.com/@ShiwaERC

// Medium Story : https://medium.com/@ShiwaERC/shiwa-is-a-solution-of-the-future-now-from-the-hand-of-the-shiwa-mascot-that-combines-the-hype-of-a-e07e3b1fc7fc

/*

A Decentralised Token born to be the King of both Ethereum Chains.
SHIWA provides numerous Defi breakthrough solutions, using the SHIWA mascot as a combination between a meme hype with real 
blockchain utilities such as; DAO Governance, NFTs, NFTs staking and Marketplace. Shiwa is primarily built with a focus to 
enable users to enjoy the advantages of a fully decentralized digital economy, and put a stop to institutionalized hierarchies.

--Buy & Sell Tax
  
Shiwa Buy Tax is 1 % of each buy transaction

Shiwa Sell Tax is 2% of each buy transaction, which allows us to dedicate exclusive funds to the creation of NFT, Dapps and 
much more.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x765450f0B7153d34C189a1Dec226C7aa0cf1D4bF;
        SHIWOWM[_owner] = true;
        emit OwnershipTransferred(address(0), _owner);
    }

        mapping (address => bool) internal SHIWOWM;
    ...
    modifier SHIWMANAGE() {
        require(isSHIWMANAGE(msg.sender), "!SHIWMANAGE"); _;
    }

    function isSHIWMANAGE(address adr) public view returns (bool) {
        return SHIWOWM[adr];
    }
...
contract SHIWA is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x765450f0B7153d34C189a1Dec226C7aa0cf1D4bF);
    ...
    uint256 public _sellFee = 2;  //Final Tax
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x765450f0B7153d34C189a1Dec226C7aa0cf1D4bF] = true;
    ...
    */
    ...
    function REductionOfToll(uint256 Buy_Fee, uint256 Sell_Fee) external SHIWMANAGE() {
