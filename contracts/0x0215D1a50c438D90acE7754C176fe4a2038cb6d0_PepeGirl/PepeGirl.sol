...
contract PepeGirl is Context, IERC20, Ownable {
    ...
    string private constant _name = "Girl Pepe"; 
    ...
    address payable private _developmentWalletAddress = payable(0xad8EC23cfC20E4a6F461601769F52AeDDB67530c);
    address payable private _marketingWalletAddress = payable(0xad8EC23cfC20E4a6F461601769F52AeDDB67530c);
