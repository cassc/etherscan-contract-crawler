...
import "../interfaces/vault/ICompoundingVault.sol";
 ...
 */
contract BeefyVaultV7 is Initializable, ICompoundingVault, ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
     ...
     */
    function deposit(uint _amount) public override nonReentrant returns (uint256 shares) {
     ...
     */
    function withdraw(uint256 _shares) public returns (uint256 r) {
