 ...
 * @notice This contract handles minting REKT NEWS tokens.
 */
contract REKTNEWS is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address public freeClaimContractAddress =
        0x2137555183ddAE424624c099cBA676afBc67A158;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xff3BAbABf10233a7Aa904879D9D5de6dcBecDeD2;
    address[] public payoutAddresses = [
        0x48199e5541CFFb0426E8aFDA3C7B457C106377c7,
        0x7988aC6119669EfdaD611E69Cc4d04E2af9b8C64,
        0xA3496F61B544E374FDD801E6f1c6044615dd103B,
    ...
    uint256[] public payoutBasisPoints = [3000, 1000, 3000, 3000];
    uint96 public royaltyFee = 500;

    constructor(uint256 _heymintFeePerToken)
        ERC721A("REKT NEWS", "REKT")
        RevokableOperatorFilterer(
