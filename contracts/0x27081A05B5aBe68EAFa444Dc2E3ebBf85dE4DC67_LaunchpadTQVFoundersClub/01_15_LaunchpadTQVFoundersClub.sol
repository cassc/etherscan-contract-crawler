 ...
 * @notice This contract handles minting TQV Founders Club tokens.
 */
contract LaunchpadTQVFoundersClub is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    address public royaltyAddress = 0x9b66584D2AB738DDf030a07831877792C7C15b1a;
    address[] public payoutAddresses = [
        0x4E9dDdF23257B1Fe39d42c5C659627868800A78D,
        0x9b66584D2AB738DDf030a07831877792C7C15b1a,
        0xD163C348760D0A146C42b407fa1e593B00E693b8
    ];
    bool public isPublicSaleActive = false;
    // Permanently freezes metadata so it can never be changed
    bool public metadataFrozen = false;
    string public baseTokenURI =
        "ipfs://bafybeidybixbjdvxzcvtapnlghwy4436fy3bmlyf35cx4sfpy6qfytuqoe/";
    // Maximum supply of tokens that can be minted
    uint256 public constant MAX_SUPPLY = 55;
    uint256 public publicMintsAllowedPerAddress = 55;
    uint256 public publicMintsAllowedPerTransaction = 55;
    uint256 public publicPrice = 1.5 ether;
    // The respective share of funds to be sent to each address in payoutAddresses in basis points
    uint256[] public payoutBasisPoints = [250, 9500, 250];
    uint96 public royaltyFee = 200;

    constructor() ERC721A("TQV Founders Club", "TQVKey") {
