...
/**
    Cybertruck
    https://twitter.com/elonmusk/status/1587583673901121538
...
contract Cybertruck is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6f695b949a9fd3c57C2EF06dC7FB047cEf490003); // Marketing Address
    address payable public multiSigAddress = payable(0x6f695b949a9fd3c57C2EF06dC7FB047cEf490003); // Marketing Address
    address payable public devAddress = payable(0x6f695b949a9fd3c57C2EF06dC7FB047cEf490003); // Dev Address
    address payable public liquidityAddress = payable(0x6f695b949a9fd3c57C2EF06dC7FB047cEf490003); // Liquidity Address
