...
contract POSHIK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Proof of Shikoku", "POSHIK") {
     ...
     uint256 totalSupply = 1 * 10 ** 9 * 10 ** decimals();
        ...
        MarketingWallet = address(0xD0F1c774cFa04aaa173cd01f3A3199E2f0D13e06); // set as Marketing wallet
        DevWallet = address(0xD0F1c774cFa04aaa173cd01f3A3199E2f0D13e06); // set as dev wallet
