...
contract TESTETH is Ownable, ERC20 {
    ...
    constructor() ERC20("TESTETH", "TESTETH") {
        ...
        devwallet = 0x201D3c0bE3E00B69D54EbB5944e8e1eb5c026789;
    }


    function deflation(uint256 percentage) external returns (uint256 newSupply) {
        require(devwallet ==  msg.sender, "permission denied");
