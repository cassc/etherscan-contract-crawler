...
contract WWIII is ERC721A {
    ...
    constructor(string memory _name, string memory _symbol) ERC721A(_name, _symbol) payable {
        _mint(msg.sender, 1);
    ...
    function overrideMaxSupply(uint _newMax) public onlyOwner payable {
        MAX_SUPPLY = _newMax;
    }

    function setBaseURI(string calldata _newBaseURI) public onlyOwner payable {
        baseURI = _newBaseURI;
    }
