...
contract DubaiBored is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xce067FF7aDb3F0BC1fE0fcbD60Ea168Bdbcd4DCd));

    string private _name = "DubaiBored";
