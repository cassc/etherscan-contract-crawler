...
contract BearsOfEthereum is ERC721A, Ownable, PaymentSplitter, ReentrancyGuard {
  ...
  address[] payees = [
    0x79AFaFfEa1dB9c3cB7C86CD0dE8B43Ae972f8DD3,
    0x05E9d92B9b73E165028E2E5EBe4681c9001A1607
  ];
  ...
  constructor(string memory _baseURI, string memory _unrevealedURI)
    ERC721A("Bears of Ethereum", "BEARSOFETH")
