...
/**
TurboBot Is An Interactive Ecosystem For Communicating With Developers, Marketers And Moderators.

Interact, With
Time and Network in Hand

TurboBot is perfect for you if you are looking to launch your own token on any chain.

TurboBot will be the first ETH token to bring this type of utility to its holders.

Website: https://turbobot.pro
TG: https://t.me/TurboBotPortal
Twitter: https://twitter.com/TurboBotPortal
**/
...
contract TURBOBOT is Context, IERC20, Ownable {
    ...
    string private constant _name="TURBOBOT";
