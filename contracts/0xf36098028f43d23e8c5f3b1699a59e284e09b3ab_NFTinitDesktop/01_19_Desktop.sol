...
contract NFTinitDesktop is ERC721, DefaultOperatorFilterer, Ownable, ERC2981 {
  ...
  uint256 public constant TEAM_SUPPLY = 40;

  uint256 public constant PHASE1_PRICE = 0.005 ether;
  uint256 public constant PHASE2_PRICE = 0.005 ether;
  uint256 public constant PHASE3_PRICE = 0.005 ether;
  uint256 public constant PHASE4_PRICE = 0.005 ether;
  ...
  function teamMint(address to, uint256 amount) external onlyOwner {
    require(teamMinted <= TEAM_SUPPLY, "Max supply reached.");
    require(teamMinted + amount <= TEAM_SUPPLY, "Max supply reached.");
