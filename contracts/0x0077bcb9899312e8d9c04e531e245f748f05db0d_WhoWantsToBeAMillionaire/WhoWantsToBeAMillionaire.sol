...
The FIRST and ONLY LIVE hosted Gameshow hosted on Telegram.
...
Buy/Sell tax will be lowered after first game of "Who Wants To Be A Millionaire" is played.

Contract will not be renounced so we can reduce taxes over the course of the game sessions and enable USDC rewards at higher marketcaps.

Will be lowered 1% after each round is completed until tax settles at the below; 
...
Telegram Portal: https://t.me/Who_Wants_To_Be_A_Millionaire
...
contract WhoWantsToBeAMillionaire is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Who Wants To Be A Millionaire';
