...
contract Ramen is ERC20, Ownable {
    ...
    constructor() payable ERC20("Ramen", "$RAMEN") {
        ...
        marketingAddress = address(0xa7849E88B1c360d496F1c010C1a3bA9eE0e246Ac);
        ...
        _createInitialSupply(0xa7849E88B1c360d496F1c010C1a3bA9eE0e246Ac, totalSupply);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xa7849E88B1c360d496F1c010C1a3bA9eE0e246Ac),
            block.timestamp
        );
    }
