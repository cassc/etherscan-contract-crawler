...
contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
    ...
    string[] private layerNames = [unicode"1/1", unicode"Accessory 1", unicode"Head", unicode"Eyes", unicode"Accessory 2", unicode"Mouth", unicode"Style"];
    ...
    uint public maxSupply = 512;
    uint public maxPerAddress = 2;
    uint public publicMintPrice = 0.005 ether;
    string public baseURI;
    bool public isPublicMintActive;
    uint public allowListPrice = 0.002 ether;
    uint public maxPerAllowList = 1;
    bool public isAllowListActive;

    ContractData public contractData = ContractData(unicode"ANAGLYPH 3D SKULLS", unicode"The Anaglyph 3D Skulls are the first series of the 24x24 pfp trilogy. The skulls symbolize death. They are a reminder that our life on earth is not endless. Since the collection is entirely minted on-chain, the skulls become immortal as long as the blockchain exists. The artwork features a stereoscopic 3D effect achieved by encoding the image with filters in red and cyan. I recommend 3D red cyan glasses to see the full effect of the artwork.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/a250380b-a71b-4b2c-ad88-af92c32e9fe9", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/a250380b-a71b-4b2c-ad88-af92c32e9fe9", "https://www.filter8.xyz", 800, "0x019B0EE245fb09aaf92aC93Ca3309832B7974681");
    WithdrawRecipient[] public withdrawRecipients;

    constructor() ERC721A(unicode"ANAGLYPH 3D SKULLS", unicode"A3DS") {
        tiers[0] = [1,1,1,1,1,1,506];
        tiers[1] = [0,36,36,440];
        tiers[2] = [0,3,4,5,5,5,5,7,10,11,12,21,21,24,24,29,32,32,32,33,33,35,36,37,56];
        tiers[3] = [0,14,17,21,22,23,27,28,30,32,33,38,42,43,43,43,56];
        tiers[4] = [0,4,30,30,448];
        tiers[5] = [0,3,3,3,3,4,8,14,17,36,44,44,49,54,56,58,58,58];
        tiers[6] = [0,0,107,112,293];
