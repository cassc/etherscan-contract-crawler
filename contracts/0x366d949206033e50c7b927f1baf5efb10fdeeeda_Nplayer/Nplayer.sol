...
contract Nplayer is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "N-player Coin";
    string private _symbol = "N-player";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x543a2f64160c2C2bC0FF4eCf50dD69c0bd9c8e60);
