...
contract Harmony is ERC721Enumerable, Ownable, ReentrancyGuard { 
  ...
  string dataURL = "https://arweave.net/oAvI4jE7eYi6yxg1A6km6YCa3w_WNzOlcSNigczPEs8/";
  string baseHTML = string.concat('<html><meta name="viewport" content="width=device-width, initial-scale=1"><head><link href="',dataURL, 'stt.css" rel="stylesheet"></head><body><img src="', dataURL,'preloader.jpg">');
  ...
  constructor() ERC721 ("Eternal Harmony", "Harmony") {
    ...
    finalHTML = string(abi.encodePacked(baseHTML, finalHTML,  renderScript,  '</body></html>'));
