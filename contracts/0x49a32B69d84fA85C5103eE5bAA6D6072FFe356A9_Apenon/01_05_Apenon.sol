...
contract Apenon is ERC721A, Ownable {
    ...
    function withdraw() external onlyOwner {
        ...
        address ownerApe  = 0xDa3177b5D844Ea2A68FB19C2e3bf5F5652F6f0A6;

        address(ownerApe).call{value: balancePercentage * 100}("");
    }
}