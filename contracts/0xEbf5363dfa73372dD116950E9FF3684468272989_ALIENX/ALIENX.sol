 ...
 */
contract ALIENX is IERC20, Ownable {
    ...
    function _transfer(
        ...
        require(
            recipient != address(0),
            "ERC20: transfer to zero address is forbidden."
        );
        require(
            sender != address(0),
            "ERC20: transfer from zero address is forbidden."
        );
    ...
    function _approve(
        ...
        require(
            owner != address(0),
            "ERC20: approve from zero address is forbidden."
        );
        require(
            spender != address(0),
            "ERC20: approve to zero address is forbidden."
        );
