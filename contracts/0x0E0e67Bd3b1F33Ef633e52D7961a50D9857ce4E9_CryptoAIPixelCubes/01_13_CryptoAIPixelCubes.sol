...
contract CryptoAIPixelCubes is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Crypto AI Pixel Cubes", "CAPC")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 2300;
  ...
  uint256 public constant MAX_MULTIMINT = 2300;
  ...
  function mint(uint256 count) public nonReentrant onlyOwner {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 2300 at a time");
