...
/*
Deploying ethereum smart contracts made easy with Deploy X. Our vision is to let everybody create their own
token contract with ease and operate it through our Telegram Bot.
Deploy X will be available when shibarium launches.
*/
