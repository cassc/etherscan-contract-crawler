...
contract bankOfEngland is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x10975795C4395C12B79C13c55b362f225Fc37b67); // Marketing Address

    address payable public teamAddress =
        payable(0x10975795C4395C12B79C13c55b362f225Fc37b67); //  Development Address

    address payable public liquidityAddress =
        payable(0x10975795C4395C12B79C13c55b362f225Fc37b67); // Liquidity Address
    ...
    uint256 private constant _tTotal = 100 * 1e7 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;

    string private constant _name = "Bank of England";
    string private constant _symbol = "BOE";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 15 / 10000; // 0.15%
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal * 25 / 1000; // 2.5% maxWalletToken
    ...
    // Clear stucked Balance and send to _OwnerWalletAddress
