...
contract OpenPoolV2 is ERC20, Ownable {
    ...
    OpenPoolDividendTrackerV2 public dividendTracker;
    ...
    constructor(address _developerwallet) ERC20("OpenPoolV2", "POOL") {
        dividendTracker = new OpenPoolDividendTrackerV2();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        OpenPoolDividendTrackerV2 newDividendTracker = OpenPoolDividendTrackerV2(
            payable(newAddress)
        );
...
contract OpenPoolDividendTrackerV2 is Ownable, DividendPayingToken {
    struct AccountInfo {
        address account;
    ...
    constructor()
        DividendPayingToken("OpenPool_Dividend_Tracker_V2", "OpenPool_Dividend_Tracker_V2")
    {}
