...
contract ET is Ownable, ReentrancyGuard, ERC20 {
    ...
    constructor() ERC20("ET", "ET") {
        _transferOwnership(0x55C162672E6638C20B0d6631255BeC29c753567A);
        ...
        marketingWallet = 0x4284711C4deA227ab0a8095d37F4eba5F4b18f58;
    ...
    function setSellTax(uint256 _marketingTaxSell) external onlyOwner {
        ...
        require(_marketingTaxSell <= 200, "Sell Tax cannot be more than 2%");
