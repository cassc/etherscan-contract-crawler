...
// File contracts/DestinationToken.sol


pragma solidity ^0.8.4;
// Import ERC20
contract DigitalFiles is ERC20, ERC20Burnable {
    address bridge;

    constructor(address _bridge) ERC20("Digital Files", "DIFI") {
        bridge = _bridge;
    }
    ...
    modifier onlyBridge() {
        require(
            bridge == msg.sender,
            "Digital Files: only the bridge can trigger this method!"
        );
        _;
    }
