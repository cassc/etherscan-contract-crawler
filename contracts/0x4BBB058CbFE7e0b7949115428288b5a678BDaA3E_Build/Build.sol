...
contract Build is ERC20, Ownable {
    ...
    constructor() ERC20("Build Token", "BUILD") {
        ...
        maxTransactionAmount = totalSupply / 1; // 1% from total supply maxTransactionAmountTxn
        maxWallet = totalSupply / 1; // 1% from total supply maxWallet
