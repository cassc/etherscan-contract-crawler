...
contract DegensAnonymous is ERC721A, Ownable, ReentrancyGuard {
  ...
  function whitelistMint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    ...
    require(ownerTokenMapping[msg.sender] + _mintAmount <= maxMintAmountPerWallet, "Max minted tokens exceeded");
