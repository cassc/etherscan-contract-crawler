...
/**
      Token Name: Chief Tits

      Ticker:  (.)(.)

Following the Chief hype, here's Chiefs Tits (.)(.)
Make the chart bounce bois. 
Low tax play 2/2.
Max Txn: 2%
Max Wallet: 2%
Locked 4 weeks, extend at 50k
...
contract Chief is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chief Tits";
