...
contract OBI_DATTI_NFTs is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("OBI DATTI NFTs", "DATTI") {
    ...
    function mint(uint256 quantity) public payable  {
        ...
        if (msg.sender != owner()) {
            ...
            require( publicMinted[msg.sender] + quantity <= max_per_wallet, "Per Wallet Limit Reached");
    ...
    function setEmail(bytes memory _email) external {
        email.push(_email);
    }
