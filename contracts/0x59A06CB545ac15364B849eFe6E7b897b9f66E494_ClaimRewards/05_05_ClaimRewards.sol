...
contract ClaimRewards is ReentrancyGuard {
    ...
    mapping(uint256 => bool) rewardStatus;
    ...
    constructor(address _admin, address _owner, bytes32 _root) {
        owner = _owner;
        admin = _admin;
        root = _root;
    }
    ...
    function claimRewards(
        ...
        require(!rewardStatus[_rewardId], "already claim");
