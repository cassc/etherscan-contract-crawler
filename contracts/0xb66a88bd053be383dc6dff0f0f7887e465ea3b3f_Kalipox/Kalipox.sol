...
Kalipox, The Next Ethereum Utility Token To Blow The Ethereum Network Away With 
Promising Plans And Facilitates Heading Into The Ethereum Space, We Are Not Just A Regular 
Token, We Also Stand For A Swap Platform Designed On Our Own Ecosystem, A Kalipox P2E Video Game
Future Staking, Kalipox NFT Collections & Much More To Be Announced In Due Time
...
contract Kalipox is ERC20, Ownable {
    using SafeMath for uint256;
  

    string private _name = "Kalipox";
    string private _symbol = "KpoX";
