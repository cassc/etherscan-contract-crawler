...
/**
*This Staking was created by and for InuTube ETH Staking. Stake and Enjoy
...
contract InuTubeStaking15 is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        stakingToken = IERC20(0xB74795625537D6aE29350F7B6BEC152E5FF34a0b);
        rewardToken = IERC20(0x4Fabb145d64652a948d72533023f6E7A623C7C53);
    ...
    function updateApy(uint256 newApy) external onlyOwner {
        require(newApy <= 10000000000, "APY must be below 10000000000%");
        updatePool(0);
        apy = newApy;
    }

    function updatelockduration(uint256 newlockDuration) external onlyOwner {
        require(newlockDuration <= 20736000, "Duration must be below 4 months");
