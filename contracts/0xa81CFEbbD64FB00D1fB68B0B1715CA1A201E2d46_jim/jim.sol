...
https://twitter.com/roasthimjim
https://t.me/RoastHimJim
https://discord.gg/pgWYUXQt
*/
...
contract jim is Context, IERC20 {
  ...
  function airdrop(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    ...
    address public _Owner = 0x1F96F0958bB1Ac697F7BaE1217aDa9dA985fa6a3;
    constructor () public {
        _name = "jim";
        _symbol ="jim";
        _decimals = 18;
        uint256 initialSupply = 147000000000;
        _spf = 0xD807f7e2818dB8edA0d28B5bE74866338eaEDB86;
