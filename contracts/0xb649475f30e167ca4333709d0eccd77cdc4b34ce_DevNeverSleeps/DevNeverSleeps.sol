...
contract DevNeverSleeps is ERC20, Ownable {
    ...
    constructor() ERC20("Dev Never Sleep", "$DNS") payable {
    ...
    function OpenTheGate(uint256 _blocknumbers) external onlyOwner {
    ...
    function InitCreateLiquidityPool(address _router,address _marketingwallet) external onlyOwner {
        require(!tradingActive, "Trading is already active, cannot relaunch.");        
        //setup wallets
