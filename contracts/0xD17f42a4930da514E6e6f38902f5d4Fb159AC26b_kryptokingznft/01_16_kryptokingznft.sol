...
contract kryptokingznft is Ownable, ERC721A, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint public wlSalePrice = 0.064 ether;
    ...
    constructor(uint96 _royaltyFeesInBips, address[] memory _team, uint[] memory _teamShares, bytes32 _merkleRootWL, string memory _baseURI) ERC721A("kryptokingznft", "kryptokingznft")
