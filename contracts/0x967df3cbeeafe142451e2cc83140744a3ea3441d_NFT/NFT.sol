...
// File: contracts/FreeTateNFT.sol
...
contract NFT is ERC721, Ownable {
    ...
    uint private constant TOKENS_RESERVED = 110;
    uint public price = 9900000000000000;
    uint256 public constant MAX_MINT_PER_TX = 150;
    ...
    constructor() ERC721("Free Tate NFTs", "TATE") {
        baseUri = "ipfs://QmQssXphuv1n5BErcWLZhmznUF1GQW6RGxkpGJYH65thGK/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0x1541EDD3294250A9361a7af48746913D09E85C43).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0x1541EDD3294250A9361a7af48746913D09E85C43).call{value: balanceTwo}("");
