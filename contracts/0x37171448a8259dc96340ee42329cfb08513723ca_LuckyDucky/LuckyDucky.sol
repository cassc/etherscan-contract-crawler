...
contract LuckyDucky is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Lucky Ducky";
    string private constant _symbol = "LUCKYDUCKY";
