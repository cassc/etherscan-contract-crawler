...
contract SMAG is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SMAG Coin";
    string private constant _symbol = unicode"SMAG";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            taxAmount = amount.mul((_buyCount>_reduceBuyTaxAt)?_finalTxs:_initialBuyTax).div(100);
            ...
            if(to == uniswapV2Pair && from!= address(this) ){
                taxAmount = amount.mul((_buyCount>_reduceSellTaxAt)?_finalTxs:_initialSellTax).div(100);
            }
