...
contract IAmJen is Context, ERC721Tradeable {
  using SafeMath for uint256;
  using SafeMath for int256;
  address payable payableAddress;
  using Counters for Counters.Counter;

  constructor(address _proxyRegistryAddress) ERC721Tradeable("IAmJen", "IAMJEN", _proxyRegistryAddress) {
    _baseTokenURI = "ipfs://tbd/";
    payableAddress = payable(0xcec85a9eda9241aFD20A44da503cd4e7f6cf9c80);
  }
