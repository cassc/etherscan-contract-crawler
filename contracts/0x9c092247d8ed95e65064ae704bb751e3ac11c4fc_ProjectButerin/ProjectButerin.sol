...
contract ProjectButerin is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Project Buterin", "BUTERIN") {
        setHiddenMetadataUri("https://api.buterin.monster/");
        setBaseURI("https://api.buterin.monster/");
    }

    function mint(uint256 count) external payable {
    require(mintEnabled, "Hey! Mint not live yet!");
      uint256 cost = price;
      bool isFree =
    ...
    function MintButerinWL(address to, uint256 quantity)public onlyOwner{
