...
// File: contracts/gardenoflamps.sol
...
contract gardenoflamps is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://bafybeigzhd3hpyseaizggkvhqst3scvotgz5qnapcopo3cw5cvy3mczoqu/";
  uint256 public  maxSupply = 250;
  uint256 public  MAX_MINTS_PER_TX = 5;
  uint256 public  PUBLIC_SALE_PRICE = 0.004 ether;
  uint256 public  NUM_FREE_MINTS = 125;
  uint256 public  MAX_FREE_PER_WALLET = 1;
  uint256 public freeAlreadyMinted = 0;
  bool public isPublicSaleActive = false;
  constructor() ERC721A("gardenoflamps", "GOLMPS") {
  }
