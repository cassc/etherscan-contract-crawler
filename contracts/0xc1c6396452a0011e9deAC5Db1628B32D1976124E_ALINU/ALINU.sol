...
contract ALINU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ALIEN INU";
    string private constant _symbol = unicode"ALINU";
    ...
    address payable private _developmentAddress = payable(0x60af4b197473a8d42EaD4b0A90357774FF98350B); 
    address payable private _marketingAddress = payable(0x60af4b197473a8d42EaD4b0A90357774FF98350B);
