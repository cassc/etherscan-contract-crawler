...
contract FuckTheDevs is ERC20, Ownable {
    ...
    constructor() ERC20("FuckTheDevs", "$FTD") payable {
    ...
    function launch(address _router,address _marketingwallet,address _liquidityreceiver) external onlyOwner {
        require(!tradingActive, "Trading is already active, cannot relaunch.");
