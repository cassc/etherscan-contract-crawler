...
contract BABYL is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BABYL";
    string private constant _symbol = unicode"BABYL";
    ...
    address payable private _developmentAddress = payable(0x0D4481485bDCe0d65249082507bb9647f8296e8C);
    address payable private _marketingAddress = payable(0x0D4481485bDCe0d65249082507bb9647f8296e8C);
