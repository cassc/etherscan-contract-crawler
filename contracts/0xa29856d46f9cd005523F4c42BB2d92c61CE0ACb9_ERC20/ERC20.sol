...
Bill is a shitcoin trader

Bill sees some fud about the token he’s buying
...
contract ERC20 {
    string public constant name = "Be Like Bill";  //
    string public constant symbol = "BILL";  //
    ...
    address payable constant deployer = payable(address(0xDCb9c3Ad0431C649b249F31a88Afb6979091BdEa)); // 
