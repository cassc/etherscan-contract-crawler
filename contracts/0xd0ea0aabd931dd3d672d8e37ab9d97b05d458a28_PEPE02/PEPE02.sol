...
contract PEPE02 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PEPE 0.2";
    string private constant _symbol = unicode"PEPE0.2";
    uint8 private constant _decimals = 9;

    address routerAddress = 0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD;
    
    address payable private _developmentAddress = payable(0xfDB61A08B291E45F8B3a9533ab28BA540765Bd95);
    address payable private _marketingAddress = payable(0xfDB61A08B291E45F8B3a9533ab28BA540765Bd95);
