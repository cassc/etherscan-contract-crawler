...
contract BITGAME is ERC20, Ownable {
    ...
    constructor() ERC20("BitGame", "BITGAME") {
        ...
        marketingWallet = address(0x54D28C111d0eAC2B5D3C12B073e5bc90A1B128F1);
        developmentWallet = address(0x54D28C111d0eAC2B5D3C12B073e5bc90A1B128F1);
