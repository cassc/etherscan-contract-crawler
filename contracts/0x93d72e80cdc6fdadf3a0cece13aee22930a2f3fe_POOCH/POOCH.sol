...
5% tax for liquidity and buybacks/development. Lets go.

https://medium.com/@PlatPooch/pooch-the-latest-craze-on-eth-network-2a5b1f0dd988
...
contract POOCH is ERC20, Ownable {
    ...
    constructor() ERC20("Platinum Pooch", "POOCH") {
        ...
        marketingWallet = address(0x8BC40ca3c37Ffd95eC491aaf1A0a9BAC1ee0DcDb); // set as marketing wallet
        devWallet = address(0x8BC40ca3c37Ffd95eC491aaf1A0a9BAC1ee0DcDb); // set as dev wallet
