...
contract RippleInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf0D298c38E86671021f44E3f15b9c6377A095FA7;
    address public developmentWallet = 0xEA5f064c70f3107C62cd83BF7eC86752F151BA8f;
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        uint256 amountETHDevelopment = amountReceived.sub(amountETHLiquidity).sub(amountETHMarketing);
    ...
    function setBuyFee(uint _newLP , uint _newMarket , uint _newCharity) public onlyOwner {     
        ...
        _buyDevelopmentFee = _newCharity;
        totalBuy = _buyLiquidityFee.add(_buyMarketingFee).add(_buyDevelopmentFee);
    }
    ...
    function setSellFee(uint _newLP , uint _newMarket, uint _newCharity) public onlyOwner {        
        ...
        _sellDevelopmentFee = _newCharity;
        totalSell = _sellLiquidityFee.add(_sellMarketingFee).add(_sellDevelopmentFee);
    }

    function setWallets(address _newMarket ,address _newLiquidity,address _newDevelopment) public onlyOwner {
        marketingWallet = _newMarket;
        liquidityReciever = _newLiquidity;
