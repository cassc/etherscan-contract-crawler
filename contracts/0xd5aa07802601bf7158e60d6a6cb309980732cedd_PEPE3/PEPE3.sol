...
// https://twitter.com/pepe3coineth

// https://t.me/Pepe3Channel
...
contract PEPE3 is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PEPE3.0";
    ...
    address payable private _developmentAddress = payable(0xbf40Bd59EdD0D2a222f4aB3d234c818C479Fd874);
    address payable private _marketingAddress = payable(0xf58C286b4B8bd3A9382317591583BD4cdd334522);
