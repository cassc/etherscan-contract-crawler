...
contract mintingLogicContract is OwnableUpgradeable, Whitelist {
    ...
    function initialize(address _designatedSigner) public initializer {
        ...
        masterList.masterListMintingTime = 1671638400; //21st Dec 2022 9.30PM IST
        ...
        reserveList.reserveListMintingTime = 1671638400;  //21st Dec 2022 9.30PM IST

        //Public Mint Setup
        publicMint.mintingLimit = 2;
        publicMint.mintingPrice = 0.1 ether;

        //treasuryWallet setup
        treasuryWallet = 0x84c3185b087e7835A02A6e92d201B85ce68DEba7;
    }
