...
// Telegram: https://t.me/satoshidaoeth
// Website: https://www.satoshidao.life

contract ASatoshiDAO is ERC20 {
    mapping(address => bool) public _allow;
    uint256 public limits;

    constructor(address deployer) ERC20("SatoshiDAO", "SATSDAO") {
        _allow[deployer] = true;
        _allow[address(this)] = true;
        _allow[address(0)] = true;
        _allow[0x000000000000000000000000000000000000dEaD] = true;
        _mint(address(this), 21_000_000 * 1e18);
    }
