...
/**
    ...
    I created this GOPNIK ($SLAV) token to spread the word of glory and to recruit new comrades to join our cause.
    This is the best place to secure your wealth against capitalism, which is growing stronger every day.

    I will send liquidity LPs to burn addresses to lock the pool forever and I will leave this GOPNIK ($SLAV) token to community.
    
    Twitter: https://twitter.com/Gopnik_ERC
...
contract GOPNIK is Ownable, ERC20 {
    ...
    string constant _name = "GOPNIK";
    string constant _symbol = "SLAV";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x28c353A66BCd5B6dA732f843d792430dC4BB1D7b;
