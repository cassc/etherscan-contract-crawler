...
contract HikodoMarutso is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "Hikodo Marutso";
    string private constant _Symbol = "MARUTSO";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e12 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0x56c4ca7d080B80f15eC70256aeA85a82bE591801);
        treasuryAddress = payable(0x56c4ca7d080B80f15eC70256aeA85a82bE591801);
        devAddress = payable(0x56c4ca7d080B80f15eC70256aeA85a82bE591801);
