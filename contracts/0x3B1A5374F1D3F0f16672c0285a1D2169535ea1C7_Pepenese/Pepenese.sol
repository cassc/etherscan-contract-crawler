...
Twitter: https://Twitter.com/PepeneseERC20
*/
...
contract Pepenese is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 10_000_000_000 * (10**_decimals);
    string private constant _name         = "Pepenese";
    string private constant _symbol       = "PEPENESE";
    ...
    address payable private _walletMarketing = payable(0x8eF0db7E07BDe85B30B01E02F7AE492207c32f4e); 
    address payable private _walletDevelopment = payable(0xAF6814C9889A53a10a51Da6acddA26652f85BeDD); 
    ...
    constructor() Auth(msg.sender) {
        ...
        uint256 airdropAmount = _totalSupply * 18 / 100;
