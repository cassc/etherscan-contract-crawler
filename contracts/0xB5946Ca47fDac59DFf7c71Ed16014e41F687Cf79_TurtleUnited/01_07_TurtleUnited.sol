...
contract TurtleUnited is ERC721A, Ownable {
    using Strings for uint256;
        
    uint256 public PRESALE_PRICE = 0.2 ether;
    ...
    string private _baseTokenURI = 'https://bafybeicjuoduavsosh2heys7gjgjucqfvlivlhtwan2lnrw5o5kat673am.ipfs.nftstorage.link/';
 
    bytes32 public merkleRoot;

    mapping(address => uint256) public _owners;

    constructor() ERC721A("TURTLE UNITED NFT", "TUNFT") {}
