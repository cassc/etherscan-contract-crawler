...
contract QuantumCollective is ERC721A, ReentrancyGuard, Ownable, PaymentSplitter, DefaultOperatorFilterer {
    ...
    uint256 public maxPublicMints = 50;
    uint256 public publicMints = 0;

    address[] public _payees = [
        0xCe7a3a51E2170Ecd47BdF45422420614D20672Bc,  // gas pay back
        0x13Ede5b6f7d3da059Ae4b6c7ad0A8c254C70F6Ca  // contract wallet
    ...
    // Metadata
    string _baseTokenURI = "ipfs://bafybeif5zbzl6blykoyjpg5wabyxxjsyiwtkp6p7v6cmxolxvpncbaqvui/";


    // Events
    event SaleActivation(bool isActive);

    constructor() ERC721A("Project Vendetta", "QSPY") PaymentSplitter(_payees, _shares) {
          freelist[0x4e4CC29ab82cf8aa4EcD3578A26409E57793de4b].exists = true;
          freelist[0xCe7a3a51E2170Ecd47BdF45422420614D20672Bc].exists = true;
          freelist[0x13Ede5b6f7d3da059Ae4b6c7ad0A8c254C70F6Ca].exists = true;
