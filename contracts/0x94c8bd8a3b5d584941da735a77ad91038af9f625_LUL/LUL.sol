...
contract LUL is Context, IERC20, Ownable {
    ...
    string private constant _name = "LUL";
    string private constant _symbol = "$LUL";
  ...
  function IncludeInFrom_maxTxAmount(address _account) external onlyOwner {
    ...
    function burnERC20(address tokenAdd, uint256 amount) external onlyOwner {
        IERC20(tokenAdd).transfer(deadWallet, amount);
    }
