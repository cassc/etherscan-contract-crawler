...
contract NakaDogemigos is ERC721A, Ownable, ReentrancyGuard {

    using Strings for uint256;

    mapping(address => uint) public mintedPerAddress;
    uint256 public mintCost = 0.0035 ether;
    uint256 public maxSupply = 4000;
    uint256 public maxPerTXN = 10;
    string internal baseUri = "ipfs://bafybeihvbdp4irgwoxuhwgkxg75b64sv2xy2ianjsc7tgbdcnr62avycdy/";
    bool private saleStarted = false;



    constructor() ERC721A("NakaDogemigos", "NDOGEM") {}
    ...
    function mintModifier(uint256 _amount) internal {
        ...
        require(msg.value >= mintCost * (_amount - free), "One Free, rest 0.0035 ETH.");
