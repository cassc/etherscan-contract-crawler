...
contract PepeFemaleDividend is Ownable {
    ...
    function setTokenForDividendsPepeFemale(address _token, address _pair) external onlyOwner {
    ...
    function whitelistForDividends(address owner_, bool _isWhitelist) external onlyOwner {
