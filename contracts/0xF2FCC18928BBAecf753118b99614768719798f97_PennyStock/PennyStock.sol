...
contract PennyStock is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Penny Stock", "PSC") {
        ...
        marketingWallet = address(0x422999Ec233CAD051c6729A0C42EC394709b6d05); // set as marketing wallet
        devWallet = address(0x422999Ec233CAD051c6729A0C42EC394709b6d05); // set as dev wallet
