...
contract AlphaTraders is ERC721A, Ownable {
     using Strings for uint256;

    uint256 public constant COST = 0.002 ether;
    uint32 public constant MAX_SUPPLY = 444;
    uint32 public constant MAX_PER_TX = 1;

    string private uriPrefix = "ipfs://bafybeiaopwft2xflfctecqsxekhtk2dzzy5xunezvc7xayp2vfj3aqh72u/";
    ...
    constructor() ERC721A ("Alpha Traders Pass", "ALPHA") {}
