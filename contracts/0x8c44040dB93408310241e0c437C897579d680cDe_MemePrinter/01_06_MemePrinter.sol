...
/*
   ...
   MemePrinter is the first meme-oriented artificial intelligence, designed to generate new memes using a database of existing memes. 

    MemePrinter | $MMPRT

    Telegram: t.me/MemePrinter
    Website: MemePrinter.fun
    Medium: medium.com/@MemePrinter
    Twitter: twitter.com/MemePrinterErc
...
contract MemePrinter is ERC20, Ownable{
    ...
    address public marketingWallet = 0x9eF63aa03387F78314407b66912893d71B42da6E;
    address public devWallet = 0x9eF63aa03387F78314407b66912893d71B42da6E;
    ...
    constructor() ERC20("Meme Printer", "MMPRT") {
