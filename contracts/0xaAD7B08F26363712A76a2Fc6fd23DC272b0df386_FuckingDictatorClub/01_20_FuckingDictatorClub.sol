 ...
 * @notice This contract handles minting Fucking Dictator Club tokens.
 */
contract FuckingDictatorClub is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x30fA3DAeF9cd6Cb1dc050b96af03C40ecb4a9468;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x3De8EbDa74FA42B06D8be9eD983bD4df7A9951Ef;
    address[] public payoutAddresses = [
        0x3De8EbDa74FA42B06D8be9eD983bD4df7A9951Ef
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeicazau6w3cf4s67mkmcj26d22ouixg6veelpjsms4zt7mdcrsy3du/";
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("Fucking Dictator Club", "FCD")
        RevokableOperatorFilterer(
