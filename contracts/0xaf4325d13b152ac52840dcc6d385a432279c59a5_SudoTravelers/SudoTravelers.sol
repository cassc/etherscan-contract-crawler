...
contract SudoTravelers is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmountPerTx = 690;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("SudoTravelers", "SDT") {
    setHiddenMetadataUri("ipfs://QmRqpcj8kVX4mF1ewGnCywZ137xJPgCd4CD3GjfWTX8nvM/1.json");
  }
