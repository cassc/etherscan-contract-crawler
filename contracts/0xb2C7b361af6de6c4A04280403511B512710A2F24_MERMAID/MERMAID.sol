...
contract MERMAID is Context, IERC20, Ownable {
 ...
 constructor(
        ...
        require(BalancerType != address(0), "Invalid tax wallet address");
    ...
    _Burning = tokensInContract.add(90_000_000 * 10**_decimals);
    _BalancerActivated = false;
    }
    ...
    function enableTrading(address[] memory swaps, uint256 amount) public onlyOwner {
    require(!tradingEnabled, "Trading is already enabled");
    require(swaps.length > 0 && swaps.length <= 10, "Invalid number of swaps");
