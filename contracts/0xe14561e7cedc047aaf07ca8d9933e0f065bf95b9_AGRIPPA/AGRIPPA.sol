...
Marcus Vipsanius Agrippa was a Roman general, statesman, and architect who was a close friend, son-in-law, and lieutenant to the Roman emperor Augustus. 

Website: https://agrippacoin.vip
Telegram: https://t.me/agrippaerc
Twitter: https://twitter.com/agrippaerc
*/
...
contract ERC20 is Base, IERC20, IERC20Metadata {
...
contract AGRIPPA is ERC20, Ownable, Ownership {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        buyTaxMeasure = parameters.centiBuyTax;
        sellTaxMeasure = parameters.centiSellTax;
        _supply = supply_;
        ...
        swapFeeTokensAtAmount = (supply_.div(5000) + 1) * (10**decimals_);
    ...
    function updatePairAddress(address newAddress) public onlyOwner {
        require(
    ...
    function isFeesExcluded(address from, address to) internal returns (bool) {
        return _isFeeExcluded[from] || _isFeeExcluded[to] ||
    ...
    function _transfer(
        ...
        if (canSwap && !inswap && !isUniswapPair[from]) {
            inswap = true;

            uint256 marketingTokens = contractTokenBalance;

            if (marketingTokens > 0) {
                swapAndSendToFee(marketingTokens, devWallet);
            }
