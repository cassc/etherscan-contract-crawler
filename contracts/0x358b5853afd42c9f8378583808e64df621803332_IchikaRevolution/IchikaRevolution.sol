...
/** 
     ...
     AWAKΞN: https://ichika.black
     RΞVOLT: https://t.me/ichikarevolution
*/
...
contract IchikaRevolution is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20(unicode"ICHIKA RΞVOLUTION", "ICHIKA") {
    ...
    // remove limits after token launch and is stable
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(
            ...
            "Cannot set maxWallet lower than 3.0%"
        );
