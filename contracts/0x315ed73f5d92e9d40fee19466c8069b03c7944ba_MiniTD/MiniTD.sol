...
/**
* Dear holders, I will contact with you through the contract owner address.
*/
...
contract MiniTD is ERC20, Ownable {

    using SafeMath for uint256;

    mapping(address => bool) private pair;
    bool public tradingOpen = false;
    uint256 public _maxWalletSize = 30000000 * 10 ** decimals(); // 3%
    uint256 private _totalSupply = 1000000000 * 10 ** decimals();
    address _deployer;

    constructor() ERC20("Mini TamaDoge", "MTD") {
