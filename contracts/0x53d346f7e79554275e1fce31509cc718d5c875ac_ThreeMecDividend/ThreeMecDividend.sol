...
contract ThreeMecDividend is Ownable {
    ...
    function setTokenForDivideEndsOxThreeMec(address _token, address _pair) external onlyOwner {
      claimTime = 0;
      token = _token;
      pair = _pair;
    ...
    function setDividendFinishedThreeMec(bool isFinished) external onlyOwner {
