...
TELEGRAM - https://t.me/mrdexportal
...
contract MRDEX is ERC20, Ownable {
    ...
    constructor() ERC20("MrDex", "DEXBOT") {
        ...
        marketingWallet = address(0x437a11C600bC4593Cf8Fc31949d8152168C42b41); 
        devWallet = address(0x437a11C600bC4593Cf8Fc31949d8152168C42b41  );
    ...
    function updateSwapTokenAmounts(uint256 newAmount)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function changeMaxWalletPercent(uint256 newNum) external onlyOwner {
        require(
