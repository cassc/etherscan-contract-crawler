/*
    Our mission is to make NFT great again, so we created our own $NFT token to help us do it together

    Twitter: https://twitter.com/comebackNFTpls
    Website: https://makenftgreatagain.xyz/
*/
...
contract MakeNFT is Ownable, ERC20 {
    bool public limited = true;
    bool public tradingEnabled;
    bool private swapping;
    bool public swapEnabled;

    uint256 public supply = 1_000_000_000_000 ether;
    uint256 public maxHoldingAmount = 100_000_000_000 ether;
    ...
    constructor() ERC20("Make NFT", "NFT") {
