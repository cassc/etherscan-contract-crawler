...
contract MBYC is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  using Counters for Counters.Counter;

  string private uriPrefix = "https://ipfs.io/ipfs/QmNvQqWz5x2vm6HTXN5rH2k5GTMNV7sFTUFC9CNUeMv3ZP/";
  string public uriSuffix = ".json";
  string private hiddenMetadataUri;

    constructor() ERC721A("Mr. Bean Yacht Club", "MBYC") {
