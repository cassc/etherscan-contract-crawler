...
contract DogeAI4 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DogeAI 4.0";
    string private constant _symbol = unicode"DogeAI4.0";
    uint8 private constant _decimals = 9;

    address routerAddress = 0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD;
    
    address payable private _developmentAddress = payable(0x61C27640FCF8b25d2D56647a0f44f77f72AcB944);
    address payable private _marketingAddress = payable(0x61C27640FCF8b25d2D56647a0f44f77f72AcB944);
