...
Welcome to the world of memeonics, burning $MPRO and giving out $ETH, 
what more could a degen want? (🐸,💰)

Twitter: twitter.com/MemeproERC
Website: memeproerc.com
TG: t.me/MemeproERC
*/
...
contract MemePro is ERC20, Ownable {
    ...
    // Constants
    uint256 internal constant MARKETING_RATE = 2; //both marketing and treasury, 5% each
    uint256 internal constant REFLECT_RATE = 2;
    uint256 internal constant COOLDOWN = 20 seconds;
    uint256 internal constant SWAP_FEES_AT = 400 ether;
    address internal constant LP_HOLDER = 0x0a9eD865F622e002FB7F94625652270E49633Cd7;

    uint256 internal _maxTransfer = 50; 
    ...
    ) ERC20("Memepro", "MPRO") Ownable(msg.sender) {
    ...
    function openTrading(uint256 tokens) public payable onlyOwner() liquidityAdd {
        _mint(address(this), tokens);
        _mint(address(deadAddress), tokens);
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        uint256 maxTxAmount = totalSupply() / _maxTransfer;
