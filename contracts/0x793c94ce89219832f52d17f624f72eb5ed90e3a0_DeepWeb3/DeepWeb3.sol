...
Ẇ̸e̴̾b̵̓ ͍̭s̸͛i̷̚t̶̄é̷ (https://deepweb3dot0.xyz/) ͛
T̶̽ ̛̄ẁ̴i̸̅ṫ̴t̵͂è̷r̷̛ (https://twitter.com/DeepWeb3dot0)
...
contract DeepWeb3 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10101010101010 * 10**8;
    ...
    string private constant _name = "DeepWeb3.0";
    string private constant _symbol = "DWeb3.0";
    ...
    uint256 public _maxTxAmount = 202020202020 * 10**8;
    uint256 public _maxWalletSize = 303030303030 * 10**8;
