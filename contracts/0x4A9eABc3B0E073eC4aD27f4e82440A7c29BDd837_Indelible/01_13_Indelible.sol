// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Index 7", unicode"Index 6", unicode"Index 5", unicode"Index 4", unicode"Index 3", unicode"Index 2", unicode"Index 1", unicode"Index 0"];
        ...
        uint public constant maxSupply = 100000;
        uint public maxPerAddress = 100000;
        uint public publicMintPrice = 0.001 ether;
        string public baseURI = "";
        bool public isPublicMintActive;
        bytes32 private merkleRoot = 0;
        uint public allowListPrice = 0.0 ether;
        uint public maxPerAllowList = 100;
        bool public isAllowListActive;

        ContractData public contractData = ContractData(unicode"Bytes", unicode"Random binary. Do what you want with it - use it as RNG, use it to assign traits and attributes for a game character, use it to decide whether you will have pizza or thai for dinner.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/70c82318-045a-4a3d-9c5a-90601e85d178", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/70c82318-045a-4a3d-9c5a-90601e85d178", "", 0, "0x77b75FbF5A53D1831204fE431B954f383B18b538");

        constructor() ERC721A(unicode"Bytes", unicode"BYTE") {
            TIERS[0] = [50000,50000];
TIERS[1] = [50000,50000];
TIERS[2] = [50000,50000];
TIERS[3] = [50000,50000];
...
TIERS[7] = [50000,50000];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"Bytes #");
