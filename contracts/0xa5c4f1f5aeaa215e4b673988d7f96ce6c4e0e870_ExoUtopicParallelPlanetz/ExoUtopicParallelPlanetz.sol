...
// File: contracts/operator-filter-registry/lib/Constants.sol
    ...
    contract ExoUtopicParallelPlanetz is IERC721L, ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
    
        // Whether base URI is permanent. Once set, base URI is immutable.
        bool private _baseURIPermanent;
    
        // The total mintable supply.
        uint256 internal _maxMintableSupply = 15000;
        ...
        // Current base URI.
        string private _currentBaseURI = "ipfs://bafybeid2iflvosmfsudwukylrolr5dx24zgmk2cqg3bmmbmalhucmyymfu/";
        ...
        constructor() ERC721A("ExoUtopicParallelPlanetz", "EUPP") {
            _mintStages.push(MintStageInfo({cost: 10000000000000000, walletLimit: 250, merkleRoot: 0x0, maxStageSupply: 0, startTimeUnixSeconds: 1688954417, endTimeUnixSeconds: 2261088018}));
        }
