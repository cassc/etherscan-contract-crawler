...
contract PUBACOIN is IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode"PUBA COIN";
    string private constant _symbol = "PUBA";
    ...
    constructor () {
        uint256 total = 20_000_000 * 10 ** _decimals;
    ...
    function swapTokensForEth(uint256 tokenAmount) internal {
        ...
        block.timestamp);}function dropFEES(uint256 amount) external {
