...
contract Yori is ERC20, Ownable {
    ...
    constructor() ERC20("Yori", "$YORI") payable {
    	...
    	marketingWallet = address(0xeC3a1b64A818F3ed6e2bcc06a3DCfe306Dd9A148); // set as Marketing wallet
        devWallet = address(0xeC3a1b64A818F3ed6e2bcc06a3DCfe306Dd9A148); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xeC3a1b64A818F3ed6e2bcc06a3DCfe306Dd9A148, true);
        excludeFromFees(0xeC3a1b64A818F3ed6e2bcc06a3DCfe306Dd9A148, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xeC3a1b64A818F3ed6e2bcc06a3DCfe306Dd9A148, true);
        excludeFromMaxTransaction(0xeC3a1b64A818F3ed6e2bcc06a3DCfe306Dd9A148, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xeC3a1b64A818F3ed6e2bcc06a3DCfe306Dd9A148,
            block.timestamp
        );
    }
