...
contract ALLTimeHIGH is Context, IERC20, Ownable {
    ...
    string private constant _name = "ALLTime HIGH"; 
    ...
    address payable private _developmentAddress = payable(0xfe8C894a45192B49E30e623eB9d3551a42Aa78A1);
    address payable private _marketingAddress = payable(0xfe8C894a45192B49E30e623eB9d3551a42Aa78A1);
