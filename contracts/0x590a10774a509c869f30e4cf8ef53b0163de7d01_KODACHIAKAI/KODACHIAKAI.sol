...
contract KODACHIAKAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "KODACHI AKAI";
    string private constant _symbol = "$KODACHI";
    ...
    address payable private _developmentAddress = payable(0xcca51A6589DfDC285f1deCff3e4A316263ef5974); 
    address payable private _marketingAddress = payable(0xcca51A6589DfDC285f1deCff3e4A316263ef5974);
