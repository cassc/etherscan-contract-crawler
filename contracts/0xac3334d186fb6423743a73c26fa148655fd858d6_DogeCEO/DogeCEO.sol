...
contract DogeCEO is ERC20, Ownable {
    ...
    constructor(
        ...
        maxTransactionAmount = 21000000000000000 * 1e18;
        maxWallet = 21000000000000000 * 1e18;
        swapTokensAtAmount = 200000 * 1e18;

        AWallet = address(0x2415A966236EA080489EFdf529874025DCa5d668); 
        BWallet = address(0x2415A966236EA080489EFdf529874025DCa5d668);
        CWallet = address(0x2415A966236EA080489EFdf529874025DCa5d668);
