...
contract DONTBUY is ERC20, Ownable {
    ...
    constructor() ERC20("DONT", "BUY") {
        ...
        marketingWallet = address(0xBc64bc0f33F1186e5e7Aa4F854B81C846c61EcEd); // marketing wallet
    ...
    function enableTrading(bool isActive) external onlyOwner {
