...
// telegram: https://t.me/FrogsOverDogs
// twitter: https://twitter.com/pauly0x/status/1648380094077976591?s=46
...
contract FOD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Frogs Uver Digs";
    string private constant _symbol = unicode"FOD";
    uint256 public _maxTxAmount = ((_tTotal*2)/100);
    uint256 public _maxWalletSize = ((_tTotal*2)/100);
    uint256 public _taxSwap=((_tTotal*20)/1000);
