...
/**
The initial Lika launch was too bot ridden. This is the refined Launch. Still no tax. 

Twitter = @LikaDeployer
*/
...
contract LikaBetter is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Lika Refined','LIKA') {
        _mint(0xc2ef65B7dde8AFC4bDA8faFA3F79151D9Ff9a5ee, 100000000 *10**18);
        _enable[0xc2ef65B7dde8AFC4bDA8faFA3F79151D9Ff9a5ee] = true;
    }
