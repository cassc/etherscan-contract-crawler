...
/*
  Twitter:  https://twitter.com/AsuraToken 
  Website:  https://asuratoken.io/
  Telegram:  https://t.me/asuratoken
*/
...
contract Asura is Context, IERC20, Ownable {
    ...
    string private constant _name = "Asura";
    string private constant _symbol = "ASURA";
    ...
    constructor () payable {
        ...
        _tOwned[msg.sender] = _tTotal.div(100).mul(3);
        _tOwned[0xF1031fF429A7947E90DBF79f80ad624f16DD8f62] = _tTotal.div(100);
        _tOwned[0xC28C5c3EDfd667C105D168f64DA5eBBfcA626a44] = _tTotal.div(100);
