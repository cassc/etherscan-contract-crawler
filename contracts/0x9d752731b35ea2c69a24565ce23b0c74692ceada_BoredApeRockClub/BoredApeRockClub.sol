...
// File: contracts/BoredApeRockClub.sol
...
contract BoredApeRockClub is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  using Counters for Counters.Counter;

  string private uriPrefix = "ipfs://QmQHSdzhVLgomtHY1EXBLpJ6HWvMJZyk7yLHh83ZpydFw7/";
  string public uriSuffix = ".json";
  string private hiddenMetadataUri;

    constructor() ERC721A("BoredApeRockClub", "BARC") {
