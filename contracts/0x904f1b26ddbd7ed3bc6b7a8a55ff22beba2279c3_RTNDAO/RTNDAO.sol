...
/*
    ...
    Medium: https://medium.com/@thereturndao
    Telegram: https://t.me/TheReturnDAO
    Twitter: https://twitter.com/RTNDAO
...
contract RTNDAO is ERC20, Ownable {
    ...
    constructor() payable ERC20("The Return DAO", "DAO") {
        ...
        launchSellDevelopmentFee = 0;
        launchSellLiquidityFee = 0;
        launchSellMarketingFee = 90;
        ...
        marketingAddress = address(0x66dd2ac7bAdE291E3D4975385E745F694D00F7B4);
        ...
        _excludeFromMaxTransaction(
            address(0x66dd2ac7bAdE291E3D4975385E745F694D00F7B4),
            true
        ); // Team
    ...
    function enableLoyalty(uint256 blocksForPenalty) external onlyOwner {
    ...
    function UpdateLoyaltyBuy(
        ...
        buyTotalFees = buyDevelopmentFee + buyLiquidityFee + buyMarketingFee;
        require(buyTotalFees <= 7, "Fees must be 7% or less");
    }

    function UpdateLoyaltySell(
        uint256 _developmentFee,
        uint256 _liquidityFee,
        uint256 _marketingFee
    ) external onlyOwner {
    ...
    function setBuyAndSellTax(uint256 buy, uint256 sell) external onlyOwner {
        require(launchTaxModeEnabled, "Launch tax disabled");
    ...
    function TaxLoyal() external onlyOwner {
    ...
    function SetLoyaltyModeTax() external onlyOwner {
        require(launchTaxModeEnabled, "Disabled.");
