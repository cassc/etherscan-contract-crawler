...
contract SBT is Ownable, ERC721 {
    ...
    constructor(string memory _uriString) ERC721("3xcalibur Discounted Round", "XCAL-SBT") {
    ...
    /**
     * @dev Set the URI string
     * @param _uriString - new URI string 
     */
    function setUriString(string memory _uriString) external onlyOwner {
        uriString = _uriString;
    }
