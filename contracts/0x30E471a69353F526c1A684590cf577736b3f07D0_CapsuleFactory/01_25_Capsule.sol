...
contract Capsule is ERC721URIStorage, ERC721Enumerable, Ownable, ICapsule {
    ...
    string public license = "www.capsulenft.com/license";
    ...
    /**
     * @notice An address is collectionMinter
     * - if collection is private and address is owner of collection
     * - else collection is public and any address is minter.
     */
    ...
    /// @notice onlyOwner:: Update link to collection license.
    function setLicense(string calldata _newLicense) public onlyOwner {
        license = _newLicense;
    }
