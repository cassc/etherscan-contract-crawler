...
contract Neutron is ERC20, Ownable {
    ...
    constructor() ERC20("Neutron", "n") {
		...
		charityWallet = address(0x9a17e0A08beC903C1c705044D00f87D503CD1BCe); // set as charity wallet
        marketingWallet = address(0x9a17e0A08beC903C1c705044D00f87D503CD1BCe); // set as marketing wallet
        devWallet = address(0x9a17e0A08beC903C1c705044D00f87D503CD1BCe); // set as dev wallet
