...
contract LandReservePool is Ownable {
    ...
    // Reward parameters
    uint256 public constant REWARD_INTERVAL = 1800;
    ...
    function claimReward() public {
        ...
        require(!rewardsCollected[msg.sender][currentRewardIndex].claimed, "REWARD_ALREADY_CLAIMED");

        // Get reward amount
        uint256 totalLandWeightOfUser = getTotalLandWeightByUser(msg.sender);
        ...
        rewardsCollected[msg.sender][currentRewardIndex] = Reward(true, block.timestamp, rewardAmount);
    }
