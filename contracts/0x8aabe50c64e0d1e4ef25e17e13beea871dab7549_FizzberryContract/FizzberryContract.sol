...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1687100400;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1687075800;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0x80b2a90E28d199c9c8860E3AA0F0e8808E071245];
  address public erc20Payable = 0x80b2a90E28d199c9c8860E3AA0F0e8808E071245;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeighahp5ksvquigmxi65uyfggundpkzyxvvx5huednvb4lnlkj3zam/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/FKoyYMglUs3JHx9JmviE/contract-metadata";
  }
...
// File: contracts/FizzberryContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FizzberryContract is ERC721APlus {
    constructor() ERC721APlus("Fizzberry", "FZB"){}
}
  /*******************************************************/
  /*                                                     */
