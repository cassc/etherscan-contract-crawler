...
TG: https://t.me/TWINK_TRUMP_ETH
Twitter: twitter.com/twink_trump_eth
Website: twinkfortrump.cc
...
contract TWINK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Trump Wins in November Karens ";
    string private constant _symbol = unicode"TWINK";
