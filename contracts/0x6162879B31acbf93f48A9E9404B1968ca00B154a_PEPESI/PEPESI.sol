...
//Simple tokenomics, High Tax (antibot) on launch reducing to 0/0 and renounce and burn ;).

//TG: https://t.me/pepesiETH
...
contract PEPESI {
    string public name = "PEPESI";
    string public symbol = "$PEPESI";
    ...
    constructor() {
     ...
     function renounceOwnership() public {
        require(msg.sender == devWallet, "Only the owner can renounce ownership");
        devWallet = address(0);
     }
