...
contract HomelessPepe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Homeless Pepe";
    ...
    address payable private _developmentAddress = payable(0xc91B1e065b45eB97232b23b8605080350C73a539);
    address payable private _marketingAddress = payable(0xc91B1e065b45eB97232b23b8605080350C73a539);
