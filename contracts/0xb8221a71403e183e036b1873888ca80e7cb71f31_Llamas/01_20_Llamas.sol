...
contract Llamas is ILlamas, ERC721AQueryable, PaymentSplitter, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  ) ERC721A("Llama Circle", "LC") PaymentSplitter(_payees, _shares) {}
