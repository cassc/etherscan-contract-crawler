...
interface IONFT721Core is IERC165 {
     ...
     */
    function estimateSendFee(uint16 _dstChainId, bytes calldata _toAddress, uint _tokenId, string memory _tokenURI, bool _useZro, bytes calldata _adapterParams) external view returns (uint nativeFee, uint zroFee);
