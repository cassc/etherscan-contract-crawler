...
contract TEST is Context, IERC20, Ownable {
    ...
    uint256 private _maxBuyTax=50;
    uint256 private _maxSellTax=50;
    ...
    constructor () {
        ...
        _taxWallet = payable(0x21F7043cF1019042c94556e9E52ebc5e4350177a);
    ...
    function setTaxes(uint256 buyTax, uint256 sellTax) external onlyOwner {
        ...
        require(
            ...
            "buyTax and sellTax cannot be more than 20%"
        );
    }
