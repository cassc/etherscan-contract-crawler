// SPDX-License-Identifier: MIT
        ...
        contract TheSkullNation is ERC721A, Ownable, ReentrancyGuard  {
            ...
            uint256 public costOfNFT = 0.3 ether;
            uint256 public numberOfFreeNFTs = 1;
            
            uint256 currentFreeSupply = 0;
            uint256 freeSupplyLimit = 888;
            string HiddenURL;
            bool revealed = false;
            bool paused = true;
        ...
        constructor(string memory _initBaseURI) ERC721A("The Skulls Nation", "SKUL") {
