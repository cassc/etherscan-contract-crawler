...
contract SALTPEPE is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("SALT PEPE", "SALTPEPE") ERC20Permit("SALT PEPE") {
        _mint(msg.sender, 420420420696969 * 10 ** decimals());
    }
