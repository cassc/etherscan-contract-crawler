...
/*      THE BOAT
 * 'The Boat' an interactive graphic meme based on the acclaimed short story by Nam Le of of 16-year-old Mai, sent alone by her parents on a boat after the Fall of Saigon. The project was launched 
 * in recognition of the 40th anniversary of the fall of Saigon and 40 years of Vietnamese resettlement in Australia. It is usually used to against the war and appreciate ppl try to relief in the difficult 
 * situation. Peace & Love. Finally the Land.
*/

// website: https://theboat.land
// twiiter: https://twitter.com/theboat_erc20
...
contract BOAT is ERC20, Ownable {
    ...
    constructor() ERC20("The Boat", "BOAT") {
        ...
        uint256 totalSupply = 626_262_626_000 ether;
