...
/*
--  TG: https://t.me/TheMonsterInside
--  Website: Launching in 14 hours
--  Twitter: https://twitter.com/ters_eth
*/
...
contract MON$TER is ERC20, Ownable {
    ...
    constructor() ERC20( "MON$TER", "FEARITSELF") {
        ...
        operationsAddress = address(0xDb43670b09868ba0Ac6dbeD0a89CE4e259ab428D); // change this address to wallet u want for operations   
        TaxAddress = address(0xDb43670b09868ba0Ac6dbeD0a89CE4e259ab428D);  // change this address to the one for tax 
