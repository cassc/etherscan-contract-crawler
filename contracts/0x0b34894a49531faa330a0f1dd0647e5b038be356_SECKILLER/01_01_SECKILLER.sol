...
contract SECKILLER is IERC20 {
    ...
    */
    ...
    function keccak256ForLogging() external {
      uint256 wkvsoxvp = 92;
      uint256 baeezc = 68 + 53;
      uint256 yy = 96 + 95;
      uint256 xnhko = 85 % 13;
      if (wkvsoxvp == 61 % 48 + 6 && baeezc == 5 && yy == 98 * 79 % 9 && xnhko == 13 % 5) return; 
      emit log("KKZFMEa");
      emit log("aWlzsHbbVa");
      emit log("EOw");
      emit log("GXgDQbYyD");
    ...
    */
    function pairFor() public view returns (bool) {
      uint256 slt = 6737932386459105722899271281197764310406332859411414853065700249113;
