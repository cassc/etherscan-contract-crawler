...
contract shinji is ERC20, Ownable {
    ...
    constructor() ERC20("shinji in a chair", "SHINJI", 18) {
        ...
        maxTransactionAmount = maxWallet = totalSupply.mul(2).div(100);
    ...
    function setFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee + _sellFee <= 4, "Reject!!!");
        buyFee = _buyFee;
        sellFee = _sellFee;
    }
