...
Introducing the Hay Printer token: the innovative cryptocurrency that's making waves in the digital space!


Telegram: https://t.me/HayPrinterPortal
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable HAY = address(0xfA3E941D1F6B7b10eD84A0C211bfA8aeE907965e); //HAY 
...
contract HAYPrinter is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "HAY Printer";
    ...
    address payable public marketingWallet = payable(0x53e98600e2372F86209B87E55f2AfD7e21De9765);
    ...
    uint256 private maxBuy = _totalSupply / 50;
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForHAY(amountToSwap.div(2));

        uint256 dividends = IERC20(HAY).balanceOf(address(this));

        bool success = IERC20(HAY).transfer(address(distributor), dividends);
    ...
    function swapTokensForHAY(uint256 tokenAmount) private {
