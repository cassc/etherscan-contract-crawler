...
contract WorldCupWinner is ERC721A, Ownable {
    ...
    string  public defaultTokenURI = "ipfs://bafkreihpjrt3pckhfx4yrx6g4uuvbubebhs5ptvpzx2c7vxllwzr2yslri";
    ...
    constructor() ERC721A ("WorldCup Winner", "WCP") {
    ...
    function mint(uint256 _quantity) external payable  {
        ...
        if (totalSupply()+_quantity<1011) {
            if (5 > usermint[msg.sender] ) {
