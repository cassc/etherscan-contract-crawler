...
contract Starship is Context, IERC20, Ownable {
    ...
    address payable public rewardPoolAddress = payable(0x2391538223796ad1F85B7244359Dc3Cb83A84e72); // reward Pool Address
    address payable public devAddress = payable(0x2391538223796ad1F85B7244359Dc3Cb83A84e72); // Dev Address

    mapping(address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isBlacklisted;

    uint256 private _totalSupply = 10 * 10**9 * 10**9;  // 10 Bn tokens


    mapping (address => bool) private _isExcludedFromFee;

    string private _name = "Elons Starship";
