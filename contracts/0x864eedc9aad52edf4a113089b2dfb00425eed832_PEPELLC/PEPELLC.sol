...
/*
Website: https://pepellc.com
TG: https://t.me/pepellcerc
Twitter: https://twitter.com/pepellcerc
*/
...
contract PEPELLC is ERC20 {
    ...
    uint256 _totalSupply = 10 ** 9 * 1e18;
    uint256 public maxTransactionAmount = (_totalSupply * 30) / 1000; // 1% from total supply maxTransactionAmountTxn;
    ...
    uint256 public maxWallet = (_totalSupply * 30) / 1000; // 1% from total supply maxWallet
    ...
    constructor() ERC20("PEPE LLC", "PEPELLC") {
