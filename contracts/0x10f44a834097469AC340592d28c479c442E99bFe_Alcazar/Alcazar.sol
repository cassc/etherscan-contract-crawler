...
// Main Contract Logic 
// --------------------------------------------------------------
contract Alcazar is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Alcazar";
    string private _symbol = "ALCAZAR";
    ...
    uint256 public _walletMax = (_totalSupply * 8) / 1000; 
    bool public checkWalletLimit = true;
    
    // wallets
    address payable public liquidityWallet = payable(0x2FF9d7be466f674c8640466A55fFdd02b3a00864);
    address payable public operationsWallet =  payable(0x2FF9d7be466f674c8640466A55fFdd02b3a00864);
