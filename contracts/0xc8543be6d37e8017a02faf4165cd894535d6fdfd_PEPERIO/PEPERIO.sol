...
/**
Telegram: https://t.me/Peperio_erc20
Twitter: ttps://twitter.com/peperio_erc20
Website: 
*/
...
contract PEPERIO is ERC20, Ownable {
    ...
    uint256 private tokenLiquidityThreshold = 16400000 * 10**9;
    uint256 public maxWalletLimit = 16400000 * 10**9;

    address private  marketingWallet = 0xb360185bA0BA22343e12f71bb0082f7a0e8b8AFf;
    ...
    uint256 public TotalBuyTaxes = buytaxes.marketing + buytaxes.liquidity + buytaxes.dev;
    uint256 public TotalSellTaxes = sellTaxes.marketing + sellTaxes.liquidity + sellTaxes.dev;
    ...
    constructor() ERC20("Peperio", "PEPERIO") {
        _tokengeneration(msg.sender, 820000000 * 10**decimals());
