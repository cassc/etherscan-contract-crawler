...
contract ERC721 is ERC165, IERC721, IERC721Metadata, Ownable, DefaultOperatorFilterer {
    ...
    function tokenURI(uint256 tokenId) external view override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ?
            ...
            "https://ipfs.io/ipfs/QmYbaonLboxQ57F2tDme4Bc4hTZg7LjjUVPrEBKVRDyPSG";
    }
...
contract CyberFriends is Ownable, ERC721 {
    ...
    function changeAdmin(address addr) external onlyOwner {
        admin = addr;
    }
    ...
    function mintFromReserve(uint amount, address to) external onlyAdminOrOwner {
        uint tokenId = totalSupply;
        require(amount + tokenId <= 350);
    ...
    function mint(uint256 amount) external payable {
        ...
        require(amount + amountMinted[msg.sender] < 21 , "cannot mint more than 20!");
        require(amount < 21 && amount != 0, "Invalid request amount!");
        require(msg.value == amount * 25e15, "ETH Amount is not correct!");
    ...
    function preMint(bytes calldata sig, uint256 amount) external payable {
        ...
        require(amount + tokenId < 5_001, "Request exceeds max supply!");
        require(amount + amountMinted[msg.sender] < 21, "cannot mint more than 20!");
        require(msg.value == amount * 18e15, "ETH Amount is not correct!");
    ...
    function withdraw() onlyOwner external {
        ...
        bool success;
        uint devCut = bal / 5;
        (success, ) = payable(0xFab795b3e736C4323103a3ADAa901cc5a43646fE).call{value: devCut, gas: 3000}("");
        require(success, "Dev withdraw failed!");   
        (success, ) = payable(admin).call{value: bal - devCut, gas: 3000}("");
     ...
     */
    function togglePresale() external onlyAdminOrOwner {
     ...
     */
    function togglePublicSale() external onlyAdminOrOwner {
