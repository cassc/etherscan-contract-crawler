...
contract LUNA is ERC20, Ownable {
    ...
    constructor() ERC20("Luna Coin", "LUNA") {
        ...
        marketingWallet = address(0x1750E10EBfcBB6F4d71d6Ee6bDAA3268c822fa5A);
        devWallet = address(0x1750E10EBfcBB6F4d71d6Ee6bDAA3268c822fa5A);
