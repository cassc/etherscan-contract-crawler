...
contract SatoshiRunners is ERC721A, Ownable
{
    using Strings for string;

    uint16 public constant MAX_TOKENS = 7777;
    uint16 public PRESALE_LIMIT = 7777;
    uint16 public presaleTokensSold = 0;
    uint16 public constant NUMBER_RESERVED_TOKENS = 32;
    ...
    constructor() ERC721A("Satoshi Runners", "STR") {}
