 ...
 * @notice This contract handles minting ABSTRASCII: AAA ESCAPES tokens.
 */
contract ABSTRASCIIAAAESCAPES is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xB8f34eEE7d1a1f957A742aFA6335dD8c78Ec592E;
    ...
    constructor(uint256 _heymintFeePerToken)
        ERC721A("ABSTRASCII: AAA ESCAPES", "AAAESCAPES")
        RevokableOperatorFilterer(
