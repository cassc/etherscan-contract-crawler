...
contract pi is ERC20, Ownable {
    string private _name = 'Pidavinci';
    ...
    address public marketingWallet = 0x7da02Af2c80F032ef14254507A370A22e7D294c3;
    ...
    function setTaxForLiquidityAndMarketing(
        ...
        require((_taxForLiquidity + _taxForMarketing) <= 4, 'ERC20: total tax must not be greater than 10%');
