...
contract OLEEE is IERC20, Auth {
    ...
    string private constant  _name = "Olee Ole Ole Oleee";
    string private constant _symbol = "OLEEE";
    ...
    address payable public marketingWallet = payable(0x0Baf1F4B9Ca4Fd8b8B986e12AB265B70F343c638);
