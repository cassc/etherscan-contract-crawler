...
contract LogiDex is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"LogiDex"; 
    string private constant _symbol = unicode"LDEX"; 
    ...
    address payable private _marketingWalletAddress = payable(0xdA1Ff3CA28e8980196a5c54F174526aF4373C855);
    ...
    function setLDEXFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
