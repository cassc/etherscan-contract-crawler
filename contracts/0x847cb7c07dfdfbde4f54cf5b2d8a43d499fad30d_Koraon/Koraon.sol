...
Inquiry and live in those years
...
contract Koraon is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 15000000 * 10**11;
    ...
    string private constant _name = "Koraon Token";
    string private constant _symbol = "KORAON";
    ...
    function openTradingFlash() external onlyOwner() {
        require(!tradingOpen,"trading is already open");
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapV2Router = _uniswapV2Router;
        _approve(address(this), address(uniswapV2Router), _tTotal);
