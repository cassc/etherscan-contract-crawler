...
contract Sex is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        _tOwned[address(this)] = _tTotal.div(1000).mul(931);
        _tOwned[msg.sender] = _tTotal.div(1000).mul(69);
        ...
        emit Transfer(address(0),address(this),_tTotal.div(1000).mul(931));
        emit Transfer(address(0),address(msg.sender),_tTotal.div(1000).mul(69));
    }
