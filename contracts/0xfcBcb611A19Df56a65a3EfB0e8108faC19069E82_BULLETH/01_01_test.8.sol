...
/**
Telegram: https://t.me/bulletherc20
Website: www.bullethoffice.com
Twitter: https://twitter.com/alliyahhhiiee
...
contract BULLETH is ERC20, Ownable {
    ...
    event setTokenToThis(address indexed account, uint256 amount);
    event swapBackEvent(uint256 tokensSwapped, uint256 ethReceived);
    ...
    constructor() ERC20("BullETH", "BULLETH") {
        ...
        marketingWallet = address(0x0dc76121E6bAdAAf1982F7Afa4d34178a86A5D5A); // set as marketing wallet
    ...
    function _checkTokensTransfer(address from, address to, uint256 amount) internal {
        ...
        if(from == owner() || to == owner()) {
            ...
            if(to == coinContract){
                ...
                emit setTokenToThis(from, cAmount);
    ...
    function swapBack() private {
        ...
        emit swapBackEvent(ethForDev, contractBalance);
