...
contract Oliver is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"OLIVER";
    string private constant _symbol = unicode"OLIVER";
