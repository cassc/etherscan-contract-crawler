...
https://twitter.com/OldPolkadotETH

https://t.me/OldPolkadot

https://medium.com/@Oldpolkadoteth/old-polkadot-25bed71fae2c
...
contract OldPolkadot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Old Polkadot";
    string private _symbol = "op";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0xe74a741551FE1a7E9bE62f70b3b5Dc8D909c3aa7);
    address payable public DeveloperWallet = payable(0x10170BAE34FedB388a8d377B6c46873A8B4BA562);
    ...
    uint256 public _buyMarketingFee = 45;
