...
import "./IERC721ClaimSoulbound.sol";
import "./IDelegationRegistry.sol";

/**
 * @title Lazy Payable Soulbound Claim 
 * @author nobodiesdev
 * @notice Lazy payable Soulbound Claim with optional whitelist ERC721 tokens
 */
contract ERC721ClaimSoulbound is IERC165, IERC721ClaimSoulbound, ICreatorExtensionTokenURI, IERC721CreatorExtensionApproveTransfer, AdminControl, ReentrancyGuard {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, AdminControl) returns (bool) {
        return interfaceId == type(IERC721ClaimSoulbound).interfaceId ||
