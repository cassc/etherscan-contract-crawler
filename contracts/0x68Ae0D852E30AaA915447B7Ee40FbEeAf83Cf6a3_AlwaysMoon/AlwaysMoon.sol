...
contract AlwaysMoon is Context , IERC20, Ownable {
    ...
    string private constant _name = unicode"Always Moon";
    string private constant _symbol = unicode"ALMOON";
