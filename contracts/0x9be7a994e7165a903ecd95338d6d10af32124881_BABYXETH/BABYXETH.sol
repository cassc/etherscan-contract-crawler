...
contract BABYXETH is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x5f70B0F0d99d6B5cC50fDc7B31C77EcAe0471BfE));

    string private _name = "BABYXETH";
    string private _symbol = "BABYXETH";
