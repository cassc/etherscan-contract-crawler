 ...
 */
contract TWDDegenerativeStage2B is ERC721Airdroppable, Terms {
    /**
     * @notice TWDDegenerativeStage2B constructor.
     *
        ...
        ERC721Airdroppable(name, symbol)
    {
        ...
        _baseTokenURI = "https://api.orangecomet.io/collectible-metadata/twd-degenerative-stage-2b/";

        // Initial contract URI
        _contractURI = "https://api.orangecomet.io/collectible-contracts/twd-degenerative-stage-2b/opensea";
