/*
Crystal The Monkey - Going to be meme coin of the year 2023-2024!
Telegram: https://t.me/CrystalTheMonkey
Website: https://crystalthemonkey.com
*/
...
contract Crystal_the_Monkey is ERC20, ERC20Burnable, Ownable, TokenRecover, Initializable {
    ...
    constructor()
        ERC20(unicode"Crystal the Monkey", unicode"CRYSTAL") 
    {
        address supplyRecipient = 0x55702D92B794bf27da2c45cd15f952c09431bDbf;
        
        updateSwapThreshold(12500000 * (10 ** decimals()) / 10);

        marketingAddressSetup(0xB04659155DF87Ac2316b19B4209F4A484E4Ee00f);
        marketingFeesSetup(500, 1000, 0);

        excludeFromFees(supplyRecipient, true);
        excludeFromFees(address(this), true); 

        _mint(supplyRecipient, 25000000000 * (10 ** decimals()) / 10);
        _transferOwnership(0x55702D92B794bf27da2c45cd15f952c09431bDbf);
    }
