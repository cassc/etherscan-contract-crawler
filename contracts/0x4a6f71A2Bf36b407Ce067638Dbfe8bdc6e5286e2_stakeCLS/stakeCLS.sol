...
contract stakeCLS is Auth, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() Auth(msg.sender) {
        stakingClassic = IERC20(0x2F1DC8b1783da12Db055767624C49Ca4C48C5DBA);
        rewardPerBlock = 100000000;
        startBlock = block.number;
        bonusEndBlock = 1000000000;

        poolInfo.push(PoolInfo({
            stakedToken: stakingClassic,
            allocPoint: 100000000,
            lastRewardBlock: 1000000000,
            accTokensPerShare: 150
        }));

        totalAllocPoint = 100000000;
