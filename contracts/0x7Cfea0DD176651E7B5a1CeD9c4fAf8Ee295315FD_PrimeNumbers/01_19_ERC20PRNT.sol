...
import "@openzeppelin/contr[email protected]/access/Ownable.sol";
...
contract PrimeNumbers is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes {
    constructor() ERC20("PrimeNumbers", "PRNT") ERC20Permit("PrimeNumbers") {}
