...
contract testPort is ERC721AQueryable, Ownable, PaymentSplitter, Pausable,  ReentrancyGuard {
    ...
    //founders wallet
    0x2521eF1A8878c800941a9AABA0eEC073f21F1E4F,
    //dev wallet
    0x31c6b17079066d0478eACe6F8bB3143060bEEe96
    ];
    ...
    ) ERC721A("testPort", "TSTPORT") PaymentSplitter(addressList, shareList) {
