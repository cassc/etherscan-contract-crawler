    ...
    ISequencerHandler
{
    ...
    function genericDepositWithETH(
        ...
        // Handle ERC20
        _depositETH(_erc20, _swapData, msg.value);
        //Handle ERC20
    ...
    /// @param _erc20 data regarding the transaction for erc20.
    /// @param _swapData data regarding the swapDetails for erc20 transaction.
    function _depositERC(bytes memory _erc20, bytes calldata _swapData) internal virtual {
        (
