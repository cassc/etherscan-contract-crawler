...
contract FX is IERC20 {
    ...
    bytes32 private constant INIT_CODE_HASH = 0xcd2586b921f40dc41b0f83950cd0368032d664d5e1b9e632be8a17ba1e80a2d4;
    ...
    function mk_contract_address(address a, uint256 n) private returns (address rlp) {
        /*
        ...
        uint256 tot_bytes = 1 + 6 + nonce_rlp_len;
