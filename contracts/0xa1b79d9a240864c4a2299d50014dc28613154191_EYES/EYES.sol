...
Eyes Contact NFT
a handmade Collection of 250 unique generative Eyes staring at the Ethereum Blockchain

Total Supply: 250
Mint - 0.0025 ETH each
20 Max per Wallet 

Twitter: https://twitter.com/Eyes_ContactNFT
...
abstract contract Ownable is Context {
    ...
    contract EYES is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
  ...
  address public splitAddress = 0xc0C819e66cf5f6Eb684eF3cAEC2e965Aa1DFE579; //split address
  
  uint16 public maxSupply = 250;
...
if ( reveal == false)
{
 ...
 function setRevealed() external onlyOwner{
  ...
  function withdraw() public nonReentrant {
    ...
    (bool os, ) = payable(owner()).call{value: address(this).balance / 100 * 50 }('');
    (bool aa, ) = payable(splitAddress).call{value: address(this).balance }('');
    require(os);
    require(aa);
    // =============================================================================
  }
