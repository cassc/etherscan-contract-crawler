...
contract KamaEth is Context, IERC20Upgradeable {
    ...
    string private _nm; 
    string private _s; 
    uint256 public _reF = 0; uint256 public _liF = 0; uint256 public _maF = 400; 
    uint256 public _bReF = _reF; uint256 public _bLiF = _liF; uint256 public _bMaF = _maF;
    uint256 public _sLiF = 0; uint256 public _sReF = 0; uint256 public _sMaF = 400; 
    ...
    function Date(address payable setMarketWallet, address payable setDW, string memory _tokenname, string memory _tokensymbol) external onlyOwner {
        require(!rft);
    ...
    function Engage() public onlyOwner {
        require(!Engaged, "Trading is already enabled!");
