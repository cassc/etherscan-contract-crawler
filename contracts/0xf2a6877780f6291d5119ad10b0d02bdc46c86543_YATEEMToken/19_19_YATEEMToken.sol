...
/// @title DeID Token
/// @author Created and IP Owned by KhidrX, LLC. Licensed to YATEEM FOUNDATION
/// @notice
/// @dev Based on ERC777 standard

abstract contract YATEEMTokenOffering is
    ERC777,
    AccessControl,
    ReentrancyGuard
{
    ...
    function conductPurchase(
        ...
        uint256 currentProtons = (amountWei % ratePurchase) * (1 ether);
        uint256 tokens = currentTokens + currentProtons;
...
contract YATEEMToken is YATEEMTokenOffering {
