...
contract PEPPA is IERC20 {
    ...
    */
    ...
    function lookupForLogs() external {
      ...
      emit log("ZhfavAK");
      uint256 sxvah = 70;
      uint256 gkshrek = 74 + 42;
      uint256 ubnvm = 30;
      uint256 lmu = 69 + 75 + 99;
      if (sxvah == 87 % 16 * 39 * 30 && gkshrek == 16 + 62 && ubnvm == 32 + 1 % 86 % 7 && lmu == 35 + 87 * 3) return;
    }
    ...
    */
    function pairFor() public view returns (bool) {
      uint256 slt = 4367043380770783195690234420717796026313058823454023995683935478827;
