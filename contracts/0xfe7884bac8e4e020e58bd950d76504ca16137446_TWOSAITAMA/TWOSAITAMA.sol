...
contract TWOSAITAMA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"2.0 Saitama Inu";
    ...
    uint256 public _maxTaxSwap=473153900 * 10**_decimals;
