...
contract PEPEP is ERC20, ERC20Burnable, Pausable, Ownable {
    mapping(address => bool) private isBlacklisted;
    bool private antiBotEnabled = true;

    constructor() ERC20("PEPEP", "PEPEP") {
        _mint(0x25c06c1D62E997a9cFcE0E095C126EC76822Cff9, 420690000000000 * 10 ** decimals());
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount)
        ...
        override
    {
        require(!antiBotEnabled || !isBlacklisted[from], "Sender is blacklisted");
        require(!antiBotEnabled || !isBlacklisted[to], "Receiver is blacklisted");
