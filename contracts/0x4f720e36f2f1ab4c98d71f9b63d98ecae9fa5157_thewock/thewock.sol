...
contract thewock is Context, IERC20, Ownable {
    ...
    string private _name = "The Wock";
    string private _symbol = "WOCK";
    ...
    constructor () {
        ...
        raca = payable(address(0x651F88bDD02385E4DeeC8C380Ec4E9fcf1153B23)); // Marketing Address
