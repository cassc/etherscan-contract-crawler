...
contract TsukaHaru is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0x1348AC6e56393Ca9eE758e79b342C12dA1251520));

    string private _name = "Ikari (TsukaHaru)";
    string private _symbol = "TsukaHaru";
