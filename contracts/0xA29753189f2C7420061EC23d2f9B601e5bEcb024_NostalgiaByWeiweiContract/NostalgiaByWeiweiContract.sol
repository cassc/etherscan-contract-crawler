...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xcA99967fC42b6424b00E7ef4D3e47F5B7A3efF11];
  address public erc20Payable = 0xcA99967fC42b6424b00E7ef4D3e47F5B7A3efF11;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 245) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeid4pkewad3cbel34ql33rwrugxkycmmc5rxklq2lfsydcmptk3eqq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/LjWZzp439YBJUh5vIQuS/contract-metadata";
  }
...
// File: contracts/NostalgiaByWeiweiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NostalgiaByWeiweiContract is RamppERC721A {
    constructor() RamppERC721A("Nostalgia By Weiwei", "NBW"){}
}
