...
contract Metheors is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public preSaleMintAmount = 1;
  ...
  constructor(address _payments) ERC721("Metheors", "MNFT") {
    setHiddenMetadataUri("ipfs://QmTcid9zd3KTo1LiUx8zJkor9o7VkLpDXdaPyjBy5Xtpi2/hidden.json");
