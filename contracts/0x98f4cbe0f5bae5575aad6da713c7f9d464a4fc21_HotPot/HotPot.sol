...
Telegram: https://t.me/HotpotTokenPortal

Web: https://www.hotpotcoinerc.com/
*/ 
...
contract HotPot  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "HotPot Coin";
    string private constant _symbol = "HotPot";
    ...
    address payable private _developmentAddress = payable(0xC466fE1b03096BE402bC8e9622B1DFaB38a0B5f5); 
    address payable private _marketingAddress = payable(0x73827aC610dEfE93d6875C3C9910023f2Ed34aEE);
