...
contract Sockx is IERC721A { 
    ...
    uint256 public MAX_FREE = 150;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST_STEPS = 0.0001 ether;
    uint256 public CURRENT_PRICE = 0.0001 ether;

    string private constant _name = "Sockx";
    string private constant _symbol = "SOCKX";
    string private _baseURI = "QmWZNVZbnBrHXc2Z36UbfAWamWFiA4SebAxGsQX49S9sqp";
    ...
    function mint(uint256 amount) external payable{
        ...
        require(amount*CURRENT_PRICE <= msg.value, "Value to Low");
        require(amount <= 5, "max 5 per TX");

        if(totalSupply()>MAX_FREE){
            CURRENT_PRICE += COST_STEPS*amount;
        }
