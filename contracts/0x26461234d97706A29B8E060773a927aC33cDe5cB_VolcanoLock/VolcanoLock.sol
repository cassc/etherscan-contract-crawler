...
Website:  https://VolcanoLock.com

Twitter:  https://twitter.com/VolcanoLock

Discord:  https://discord.gg/RKhuCQHyzx
...
contract VolcanoLock is ERC20, Ownable {
    ...
    constructor() ERC20("Volcano Lock", "VLock") {
        ...
        marketingWallet = address(0xc6d92721632F8b106a150e8C0Bd6fc8D48f7Ccd3); 
        devWallet = address(0x5Fb25E51b87b8A770Cf8D708ea39c14A9E2C7117); 
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevelopmentFee;
        require(buyTotalFees <= 8, "Must keep fees at 10% or less");
    }
