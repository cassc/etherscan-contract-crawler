...
A tool for the degens to find the next x1000 meme token without getting scammed!

Tg : https://t.me/pepealphascannereth 
Tw : https://twitter.com/Pepeas_token
Web : https://pepealphascanner.com/
*/
...
contract PEPEAS is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Pepe Alpha Scanner";
    string private constant _symbol = unicode"PEPEAS";
    ...
    constructor() {
        ...
        _marketingAddress = payable(0x40cA81F9da1cB6D9B7C88d920506532d65553b4B);
