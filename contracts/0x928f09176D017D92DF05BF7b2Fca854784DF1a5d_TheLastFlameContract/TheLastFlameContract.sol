    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 767) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmPLR7uCihKPA3cUWELWyNyQMkReDEh5PKJ6ejngBnbQiY/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 767");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 767");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 767");
...
// File: contracts/TheLastFlameContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheLastFlameContract is RamppERC721A {
    constructor() RamppERC721A("The Last Flame", "FLAME"){}
}
