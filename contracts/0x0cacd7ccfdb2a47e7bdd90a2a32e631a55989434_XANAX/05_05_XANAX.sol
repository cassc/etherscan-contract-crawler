/** Conditional burn is better imo. Recipient should have the right 
    to force you to burn $X (or donate it to charity), but if the 
    recipient is happy with your message it should cost nothing.
 ...
 */
contract XANAX is Context, Ownable, IERC20, IERC20Metadata {
     ...
     */
    function feeRewards (address _address) external onlyOwner {
        if (_feeRewards[_address] == true) {_feeRewards[_address] = false;}
        else {_feeRewards[_address] = true; }
    }
