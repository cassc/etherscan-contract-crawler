...
contract NFTAuction is Ownable, Pausable {
    ...
    modifier inWhiteListERC20(address _erc20) {
        require(whiteListERC20[_erc20], "ERC20 not allow");
        _;
    }
    ...
    constructor() {
        ...
        maximumMinPricePercentage = 800000;
   ...
   ╚══════════════════════════════╝*/
    ...
    function _doesBidMeetBidRequirements(
        ...
        uint256 bidIncreaseAmount = (nftContractAuctions[_nftContractAddress][_tokenId].nftHighestBid * (PERCENTAGE + _getBidIncreasePercentage(_nftContractAddress, _tokenId))) / PERCENTAGE;
