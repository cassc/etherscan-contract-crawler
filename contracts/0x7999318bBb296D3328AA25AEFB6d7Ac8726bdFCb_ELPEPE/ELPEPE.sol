...
Join Telegram: https://t.me/ELPepe_token to get to know project & admin before buying.

Stealth Launching the Original Meme "El Pepe" , $pepe wasn't the correct meme.
...
contract ELPEPE is ERC20, Ownable {
    ...
    constructor () ERC20("EL PEPE", "ELPEPE") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x35F2B850428D63a09B42824BB123d38279363667;
