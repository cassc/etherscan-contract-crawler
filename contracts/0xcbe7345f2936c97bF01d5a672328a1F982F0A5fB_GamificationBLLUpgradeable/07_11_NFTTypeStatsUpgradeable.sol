...
abstract contract NFTTypeStatsUpgradeable is Initializable, OwnableUpgradeable {
    ...
    function __NFTTypeStatsUpgradeable_init() internal onlyInitializing {
        __NFTTypeStatsUpgradeable_init_unchained();
    }

    function __NFTTypeStatsUpgradeable_init_unchained()
        internal
        onlyInitializing
    {
