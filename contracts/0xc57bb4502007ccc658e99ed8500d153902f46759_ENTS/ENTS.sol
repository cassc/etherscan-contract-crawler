 ...
 * allowances. See {IERC20-approve}.
 */
contract ENTS is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "ENTS";
    string private _symbol = "ENTS";
    uint8 private _decimals = 9;
    uint256 private _supply = 1000000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 9000 * 10**_decimals;
    uint256 public maxWalletAmount = 10000 * 10**_decimals;
    address public marketingWallet = 0xE30a4652D1cA8A8421C0EEB4A3b58762151bF638;
    // TOKENOMICS END ============================================================>
