...
contract QuantumChainProtocol is ERC20, Ownable {
    ...
    address payable public constant liquidityWallet = payable(0xAE3c44d73b046FD2Fd7bf8A2cabB4beF09228e69);
    address payable public constant marketingWallet = payable(0x6F8007D5B5631eFbb6961BA7d277158ba28A486d);
    address payable public constant devWallet = payable(0x2AAa23FfF91ec8193F3fF902a9Bb3E115740E19D);
    address payable public constant supportWallet = payable(0xAE3c44d73b046FD2Fd7bf8A2cabB4beF09228e69);
    ...
    mapping(address => HoldInfo) private _holdReward;
    ...
    constructor() ERC20("Quantum Chain Protocol", "QCP") {
    ...
    function excludeFromFees(address addrs, bool excluded) public onlyOwner {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "Uniswap pair shouldn't be removed");
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
            if (!automatedMarketMakerPairs[from]) {
                HoldInfo storage userReward = _holdReward[from];
                userReward.holdTime = userReward.lastBuy - _rewardMinTimestamp;
                userReward.lastSell = block.timestamp;
            } else {
                HoldInfo storage userReward = _holdReward[to];
                if (userReward.lastBuy == 0) {
                    userReward.lastBuy = block.timestamp;
                }
            }
        }
