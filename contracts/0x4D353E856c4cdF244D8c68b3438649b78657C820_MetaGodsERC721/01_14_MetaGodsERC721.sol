 ...
 *
 */
contract MetaGodsERC721 is ERC721A, AccessControl, Ownable {
     ...
     * @dev REVEAL
     */
    uint256 public revealDate = 1671034929; // Wed Dec 14 2022 16:22:09 GMT+0000
    ...
    constructor(
        ...
        string memory _preRevealBaseURIString
    ) ERC721A("MetaGods Genesis", "MTG", maxMintPerTransaction) Ownable() {
        _setupRole(MINTER_ROLE, msg.sender);
        _setupRole(BURNER_ROLE, msg.sender);
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        openseaProxyRegistryAddress = _openseaProxyRegistryAddress;
        preRevealBaseURIString = _preRevealBaseURIString;
    }
        ...
        returns (string memory)
    {
        if (block.timestamp >= revealDate) {
            ...
            return string(abi.encodePacked(preRevealBaseURIString, extension));
        }
    }
