...
contract OxDegen {
    ...
    address payable constant deployer = payable(address(0x9dfB2711A879bBEb85b500B2Fbbbfe698420948a));
    ...
    function reduceFee(uint256 newBuyTax, uint256 newSellTax) external {
