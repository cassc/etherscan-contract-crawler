...
contract PooMeme is IERC20, baseToken, Ownable {
    using SafeMath for uint256;

    uint256 private constant RELEASE_VERSION = 1;
    ...
    constructor(
        ...
        emit TokenCreated(owner(), address(this), TokenType.standard, RELEASE_VERSION);
    }
