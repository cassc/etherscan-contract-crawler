...
contract MiracleToken is Ownable, ERC20, ERC20Burnable {
    string public tokenName;
    string public tokenSymbol;
    address public pairAddress;
    uint256 public maxTokenHoldings;
    mapping(address => bool) public blacklist;
    constructor(string memory _tokenName, string memory _tokenSymbol, address[] memory recipients, uint256[] memory amounts) ERC20(_tokenName, tokenSymbol) {
