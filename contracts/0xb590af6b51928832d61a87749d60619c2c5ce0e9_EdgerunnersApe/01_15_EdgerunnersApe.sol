...
contract EdgerunnersApe is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("EdgerunnersApe", "Edgerunners")
  {
  ...
  uint256 public constant MAX_MULTIMINT = 18;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 18 at a time");
