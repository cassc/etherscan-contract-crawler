...
TG: https://t.me/CoronaInuToken

Corona is here to take over the World. The #1 Disease.
...
contract Corona is ERC20, Ownable {
    ...
    constructor() ERC20("Corona Inu", "Corona") {
        ...
        marketingWallet = address(0x9D840274374132fd983866e79e5b2A2B6955804a); // set as marketing wallet
        devWallet = address(0x9D840274374132fd983866e79e5b2A2B6955804a); // set as dev wallet
