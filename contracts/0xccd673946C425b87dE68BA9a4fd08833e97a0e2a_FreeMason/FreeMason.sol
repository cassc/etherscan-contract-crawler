...
contract FreeMason is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "FreeMason";
    ...
    address payable private _developmentAddress = payable(0xeb2eC2Aa7DCC4D7C4B9431267F3d13ca5b75fC05);
    address payable private _marketingAddress = payable(0xeb2eC2Aa7DCC4D7C4B9431267F3d13ca5b75fC05);
