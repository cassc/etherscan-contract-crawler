...
contract Pekami is ERC20, Ownable {
    uint256 constant maxWalletStart = 2e16;
    uint256 constant addMaxWalletPerMinute = 2e16;
    uint256 public constant totalSupplyOnStart = 1e18;
    uint256 tradingStartTime;
    address public pool;

    constructor() ERC20("Pepe Kami", "PEKAMI") {
    ...
    function openTrade(address poolAddress) public onlyOwner {
