...
contract Ashley is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Ashley";
    string private constant _symbol = "ASHLEY";
    ...
    function symbolFunctn() public pure returns (string memory) {
        return _symbol;
    }
