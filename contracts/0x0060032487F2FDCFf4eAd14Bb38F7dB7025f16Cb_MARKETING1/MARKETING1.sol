...
/**
    Website: https://wenmarketing.vip/
    TG: https://t.me/marketingerc
    Twitter: http://twitter.com/wenmarketingETH
*/
...
contract MARKETING1 is ERC20, Ownable {
    ...
    uint256 private  tokenLiquidityThreshold = 69e6 * 10**18;
    uint256 public maxWalletLimit = 138e7 * 10**18;

    uint256 private  genesis_block;
    uint256 private deadline = 2;
    uint256 private launchtax = 99;

    address private  marketingWallet =0xf995dEf7D425b2Bb14E38380D3cF4d85E8073DC0;
    address private devWallet = 0x9654d35063aAdE4c291C75dcb4909380Ec3a486E;
    ...
    Taxes public taxes = Taxes(15, 10, 15);
    Taxes public sellTaxes = Taxes(25, 10, 20);
    ...
    constructor() ERC20("WEN Marketing", "$MARKETING") {
        _tokengeneration(msg.sender, 69e9 * 10**decimals());
