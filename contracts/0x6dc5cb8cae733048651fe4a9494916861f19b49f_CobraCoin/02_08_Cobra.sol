...
Website: https://cobracoin.co/
Telegram: https://t.me/Cobra_Token

Cobra Coin - $COCO

Cobra Coin is the bold-faced meme inspired by the success, 
power and brute masculinity of the Tate brothers. 

Cobras by nature are venomous predators that are known to devour frogs, 
lame MONGoose losers and other brokie peasants in the wild.

The Cobra Coin way is a hardened path to wealth and dominance in the eco-system, 
the era of dogs, frogs and rodents has come to an end. 

It is time for the new apex meme to take over the crypto space.

Cobra Coin - Fuck The Brokies!
...
contract CobraCoin is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal/10; 
    uint256 public maxTxAmountSell = _tTotal/10; 
    uint256 public maxWalletAmount = _tTotal/10; 
