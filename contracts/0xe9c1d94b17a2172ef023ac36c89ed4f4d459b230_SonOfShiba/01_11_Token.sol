...
As strong as his father, stealth launched on 2nd July 2023
*/
...
contract SonOfShiba is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"SonOfShiba", unicode"SOS") 
    {
        address supplyRecipient = 0x3A9C09Ce6b2e2aebb76DB11Ab99d0f943eE04f25;
        
        updateSwapThreshold(210345000000 * (10 ** decimals()));

        marketingAddressSetup(0x3A9C09Ce6b2e2aebb76DB11Ab99d0f943eE04f25);
        ...
        _transferOwnership(0x3A9C09Ce6b2e2aebb76DB11Ab99d0f943eE04f25);
    }
