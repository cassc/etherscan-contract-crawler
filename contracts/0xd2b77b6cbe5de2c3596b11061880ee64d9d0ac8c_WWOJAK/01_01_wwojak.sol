...
contract WWOJAK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Wrapped Wojak", "WWOJAK") {
        ...
        marketingWallet = address(0xF6cd0a04e62697034F1c60C5ce12f20bC2d9903d); // mwallet
        devWallet = address(0xF6cd0a04e62697034F1c60C5ce12f20bC2d9903d); // dwallet
