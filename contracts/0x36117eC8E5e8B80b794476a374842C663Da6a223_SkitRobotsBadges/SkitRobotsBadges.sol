...
contract SkitRobotsBadges is ERC721A, Ownable, ERC2981, OperatorFilterer {
    ...
    uint256 public immutable presaleSupply = 294;
    uint256 public immutable supply = 294;
    ...
    address[] public withdrawAddresses = [0xC77A6A629b3Cd50FA478973a5BdFaB415bfe314a, 0x985AFcA097414E5510c2C4faEbDb287E4F237A1B];
    uint256[] public withdrawPercentages = [95, 5];

    bytes32 public merkleRoot = 0x243530076dc8bd4477c8118622e2727f9a56e1928b96fa55567742703cf3eebd;
    ...
    constructor(
        ...
        _setDefaultRoyalty(0xD71ADDB8168298179faEE23ABb4592C76e57021d, _royaltyAmount);
    }
