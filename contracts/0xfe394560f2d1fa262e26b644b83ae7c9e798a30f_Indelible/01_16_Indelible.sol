// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        string[] private LAYER_NAMES = [unicode"Orion Carrier", unicode"2", unicode"3", unicode"Ship Invader", unicode"5", unicode"6", unicode"7", unicode"8", unicode"Beam", unicode"Game", unicode"10", unicode"Button", unicode"12", unicode"Location"];
        ...
        uint public constant maxSupply = 96;
        uint public maxPerAddress = 96;
        ...
        ContractData public contractData = ContractData(unicode"M.O.A.N. : The Harvest", unicode"Extraterrestrials from the Orion Nebula have been disturbed by Earth's radiowave broadcasts.  Now, they harvest and analyse... The 1st chapter of a generative GIF story collection by TorpedoSplash.", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/profile/4148b81b-1d7d-4d81-aa4d-43160edb23dc", "https://indeliblelabs-prod.s3.us-east-2.amazonaws.com/banner/4148b81b-1d7d-4d81-aa4d-43160edb23dc", "", 200, "0xf376A6a24B0c36A86024AeA15841893B43cF35f8");

        constructor() ERC721A(unicode"M.O.A.N. : The Harvest", unicode"MOAN") {
            TIERS[0] = [11,15,17,23,30];
            TIERS[1] = [19,32,45];
            TIERS[2] = [29,32,35];
            TIERS[3] = [7,14,16,19,40];
            TIERS[4] = [7,89];
            TIERS[5] = [16,19,20,41];
            TIERS[6] = [22,74];
            TIERS[7] = [11,21,29,35];
            TIERS[8] = [11,30,55];
            TIERS[9] = [1,19,19,19,19,19];
            TIERS[10] = [20,28,48];
            TIERS[11] = [11,12,19,54];
            TIERS[12] = [13,15,30,38];
            TIERS[13] = [1,12,19,22,42];
            ...
            returns (string memory)
        {
            ...
            jsonBytes.appendSafe(unicode"{\"name\":\"M.O.A.N. : The Harvest #");
