...
In an era of digital deceit, SleuthBot emerges as your reliable telegram bot,
dedicated to sniffing out counterfeit tokens lurking in the shadows of the crypto space.

Website: https://sleuthbot.app/
TG: https://t.me/sleuthboteth
X: https://twitter.com/Sleuth_Bot
...
contract SLEUTH is ERC20, Ownable {
    ...
    constructor () ERC20("SleuthBot", "SLEUTH") 
   {   
        address newOwner = 0x566ECd0a79a8D796919438d8793436eEA95bb19b;
        transferOwnership(newOwner);
        marketingWallet = 0x566ECd0a79a8D796919438d8793436eEA95bb19b;
    ...
    function updateTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
    ...
    function updateTotalFeeAmount(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
    ...
    function updateMinSwapAmount(uint256 newAmount) external onlyOwner{
