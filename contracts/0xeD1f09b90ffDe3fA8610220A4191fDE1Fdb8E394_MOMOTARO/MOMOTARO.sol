...
Tg : https://t.me/HiloliPopsETH
Web : https://www.momotaro.site/

Momotaro's Journey, a unique NFT project inspired by the legendary Japanese folklore tale of Momotaro. 
Our collection features stunning digital art and animations that bring to life the heroic adventures of the brave Peach Boy 
and his animal companions as they battle against the demons threatening their world
...
contract MOMOTARO is Context, IERC20, Ownable {
    ...
    string private _name = "MOMOTARO";
    string private _symbol = "BOM";
    ...
    uint256 public _maxTxAmount = _tTotal.div(1000).mul(20); //2.0%
