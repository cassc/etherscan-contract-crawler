    ...
    OwnableUpgradeable
{
    ...
    function __AccessControlModule_init(
        address admin
     ...
     *
     */
    function __AccessControlModule_init_unchained(
        address admin
    ) internal onlyInitializing {
    ...
    If you only want to transfer the adminship or the ownership, please use the
    functions provided by OpenZeppelin
