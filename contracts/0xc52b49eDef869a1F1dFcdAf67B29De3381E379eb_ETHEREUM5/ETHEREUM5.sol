...
Telegram: https://t.me/Ethereum5ERC
Web: http://www.ethereum5.online/
X: https://twitter.com/5ethereum
...
contract ETHEREUM5 is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"ETHEREUM.5";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to   == uniswapV2Pair && swapEnabled && contractTokenBalance>_taxSwapThreshold && _buyCount>_preventSwapBefore) {
                ...
                if(contractETHBalance > 5000000000000) {
