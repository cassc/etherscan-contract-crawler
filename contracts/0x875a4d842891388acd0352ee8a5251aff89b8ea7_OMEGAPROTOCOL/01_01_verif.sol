// https://t.me/OmegaProtocolPortal

// Omega Protocol with OmegaX - Need a dApp that combines a rich algorithmic
// token tracking experience & insanely accurate sniping utility?
// We've got you covered with the OmegaX platform.
// Learn more today at https://omegaprotocol.app/
...
contract OMEGAPROTOCOL is ERC20, Ownable {
    ...
    constructor() payable ERC20("OMEGA PROTOCOL", "OP") {
        ...
        projectWallet = address(0xA83d429CF89f3b8112C847D249b643D711Fd70D4);
        ...
        onlyOwner
    {
        ...
        // Maxes must always be above 1% for CA to be SAFU
        require(maxWallet >= onePercent, "Max wallet must be at least 1%");
        require(maxSellAmount >= onePercent, "Max sell must be at least 1%");
        require(maxBuyAmount >= onePercent, "Max buy must be at least 1%");
    }
