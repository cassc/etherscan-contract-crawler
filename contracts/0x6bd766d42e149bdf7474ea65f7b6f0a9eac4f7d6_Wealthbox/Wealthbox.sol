...
Endless wealth and diamonds, hold it and you will get great wealth too
TG:https://t.me/wealthbox_eth
*/
...
contract Wealthbox is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Wealth Box", "WBOX") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xE837cB18b2C02B44Ec241FAb4e5e4839bc62bd01); // marketing wallet
        devWallet = address(0xE837cB18b2C02B44Ec241FAb4e5e4839bc62bd01); // dev wallet
