 ...
 */
contract ETH is ERC20, ServicePayer, GeneratorCopyright {
    constructor(
        string memory name_,
        string memory symbol_,
        bytes memory signature_,
        address payable feeReceiver_
    ) payable ERC20(name_, symbol_) ServicePayer(feeReceiver_, "HarryPotterObamaPoliticos666Inu", signature_, _msgSender()) {
        _mint(_msgSender(), 666000000e18);
    }
}