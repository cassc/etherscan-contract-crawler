...
contract TZRKT is ERC721Enumerable, Ownable {
	...
	constructor() ERC721("BOOOST TZRKT DEV", "TZRKTDEV") {}
	...
	function mint(address to, uint256 amount) public onlyMinter {
		require(_tokenIdCounter.current() <= MAX_SUPPLY, "mint: exceeded maximum supply.");
		require(_tokenIdCounter.current() + amount <= MAX_SUPPLY, "mint: exceeded maximum supply.");
