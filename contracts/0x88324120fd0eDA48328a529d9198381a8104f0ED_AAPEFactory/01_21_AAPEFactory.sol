...
contract AAPEFactory is Ownable {
    ...
    function getDeployedNFTs() public view returns (AAPEHotSauce[] memory) {
        return nfts;
    }
    ...
    function deploy(
        ...
        AAPEHotSauce nft = new AAPEHotSauce(_name, _symbol, _uri, payees, shares, msg.sender, paperAddress);
