...
contract FeesManagerLogic is Ownable {
    ...
    function estimateFees(
        ...
        require(_msgSender() == dragoonAddress, "Not Dragoon contract");
    ...
    function updateDragoonAddress(address _newAddr) external onlyOwner {
        dragoonContract = IDragoon(_newAddr);
        dragoonAddress = _newAddr;
    }
}