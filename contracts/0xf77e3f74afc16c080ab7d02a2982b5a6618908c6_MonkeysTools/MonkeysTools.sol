...
Website: https://monkeys.tools/
Telegram: https://t.me/monkeystools
 ...
 */
contract MonkeysTools is ERC20 {
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 444000444000 * 10 ** 18;

    /**
     * @dev Sets the value of the `decimals`. This value is immutable, it can only be
     * set once during construction.
     */
    constructor () ERC20('Monkeys Tools', unicode"MONKEYS", _msgSender()) {
