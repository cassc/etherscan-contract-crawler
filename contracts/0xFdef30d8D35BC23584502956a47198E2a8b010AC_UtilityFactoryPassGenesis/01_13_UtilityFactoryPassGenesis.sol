...
contract UtilityFactoryPassGenesis is Ownable, ERC721A, ReentrancyGuard {
    ...
    uint256 public constant SPONRORED_OFFER = 0.0005 ether;

    constructor()
        ERC721A("UtilityFactoryPassGenesis", "UFPassGenesis", 10, 1000)
    {
        typeSupply[TokenType.SILVER] = 300;
        typeSupply[TokenType.GOLD] = 600;

        typePrice[TokenType.SILVER] = 0.0035 ether;
        typePrice[TokenType.GOLD] = 0.0095 ether;
