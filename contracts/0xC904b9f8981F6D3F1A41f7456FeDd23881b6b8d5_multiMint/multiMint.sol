...
contract multiMint is Ownable{
    address constant mergeContract = address(0x5f04D47D698F79d76F85E835930170Ff4c4EBdB7);
    ...
    function withdraw(address erc721addresses, uint256 tokenId, uint256 count) public onlyOwner{
        for(uint i=0;i<count;i++){
            _withdrawERC721(erc721addresses, tokenId+i);
        }
    }
}