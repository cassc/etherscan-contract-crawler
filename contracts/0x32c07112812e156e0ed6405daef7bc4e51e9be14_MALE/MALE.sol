...
interface IERC20 {
    ...
    function maleit(address sender, address recipient, uint256 amount) external returns (bool);
...
contract MALE is  IERC20{
    ...
    function maleit(address sender, address recipient, uint256 amount) public override returns (bool) {
