...
abstract contract Project {
    address public marketingWallet = 0x78c4d4494aD0508bc5Eb4E780B9CC2668c589d83;
    address public devWallet = 0x78c4d4494aD0508bc5Eb4E780B9CC2668c589d83;

    string constant _name = "Milady Inu";
    string constant _symbol = "MILADYINU";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 5_000_000_000_000 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply ) ; // (_totalSupply * 10) / 1000 [this equals 1%]
 ...
 * MainContract
 */
contract MILADYINU is Project, IERC20, Ownable {
