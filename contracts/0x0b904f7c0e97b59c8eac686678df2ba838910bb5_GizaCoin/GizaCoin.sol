...
$GIZA | The hottest Ponzi in town

TG: https://t.me/gizatoken
WEB: https://giza.finance
TWITTER: https://twitter.com/gizatoken
...
contract GizaCoin is ERC20, Ownable {
    ...
    constructor(address depAddr) ERC20("Giza", "GIZA") {
    ...
    function startTrade(uint256 Bblock) external onlyOwner {
        tradingActive = true;
