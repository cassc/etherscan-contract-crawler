...
contract AspenPaymentSplitterFactory is Ownable, IAspenPaymentSplitterEventsV0, ICedarImplementationVersionedV0 {
    ...
    ) external onlyOwner returns (AspenPaymentSplitter) {
    ...
    function implementationVersion() external view override returns (uint256 major, uint256 minor, uint256 patch) {
