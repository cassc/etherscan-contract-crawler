...
contract DAOWhale is ERC20, Ownable {
    ...
    constructor() payable ERC20("DAOWhale", "WAO") {
        ...
        operationsAddress = address(0xaECeAd12509D2c966dDdeD53fBB198DedB4124A5);
        treasuryAddress = address(0x639C4Fe68Cc9DD9dA3990b78d5BAa0F5E4e00E14);
        teamAddress = address(0x012683b865ED2c8dB3F4569a11BF962C40B926B0);
        ...
        _excludeFromMaxTransaction(
            address(0xd0012d64Fc164d014d973e855152DB75Cb8f5Fb2),
            true
        ); // Reserves
        ...
        _createInitialSupply(newOwner, (totalSupply * 62) / 100); // LP, presale
        _createInitialSupply(teamAddress, (totalSupply * 3) / 100); // Team
    ...
    function swapBack() private {
        ...
        ethForLiquidity -= ethForOperations + ethForTreasury + ethForTeam;
    ...
    // 24-48 hours
    function sellTaxToTwelvePercent() external onlyOwner {
        sellOperationsFee = 5;
        sellLiquidityFee = 3;
        sellTreasuryFee = 3;
        sellTeamFee = 1;
    ...
    // Reset to normal sell tax - after 48 hours
    function sellTaxToNormal() external onlyOwner {
        sellOperationsFee = 3;
        sellLiquidityFee = 0;
        sellTreasuryFee = 3;
        sellTeamFee = 1;
