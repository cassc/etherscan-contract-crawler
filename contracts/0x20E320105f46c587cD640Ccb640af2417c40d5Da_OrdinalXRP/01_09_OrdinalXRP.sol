...
//https://t.me/oXRPTOKEN

contract OrdinalXRP is ERC20, Ownable {
    ...
    address public devWallet = 0x42868271a0409631BB70eF2a7F74e8148A4B29d8;
    ...
    Taxes public buyTaxes = Taxes(0, 0, 5);
    ...
    constructor(address _treasury)
        ERC20("OrdinalXRP", "oXRP")
    {
        dividendTracker = new DividendTracker();
        setSwapTokensAtAmount(10);
        updateMaxWalletAmount(20);
        setMaxBuyAndSell(20, 20);
    ...
    function updateMaxWalletAmount(uint256 newNum) public onlyOwner {
        require(newNum > (10 * 1), "Cannot set maxWallet lower than 1%");
    ...
    function setMaxBuyAndSell(uint256 maxBuy, uint256 maxSell)
        ...
        onlyOwner
    {
        require(maxBuy >= 10, "Cannot set maxbuy lower than 1% ");
        require(maxSell >= 5, "Cannot set maxsell lower than 0.5% ");
    ...
    function setSwapTokensAtAmount(uint256 amount) public onlyOwner {
        require(amount < 100, "Cannot set swaptokens higher then than 10% ");
