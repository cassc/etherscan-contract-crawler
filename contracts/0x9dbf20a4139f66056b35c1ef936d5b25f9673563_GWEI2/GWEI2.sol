...
WHEN GWEI IS EXPENSIVE YOU NEED GWEI 2.0
...
contract GWEI2 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 420_690_690_000_000 * 10**_decimals;
    string private constant _name = unicode"GWEI2.0";
    string private constant _symbol = unicode"GWEI2.0";
