...
contract PeopleDAO is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    
    string constant _name = "PeopleDAO";
    ...
    address public marketingFeeReceiver = 0x746C2B0b849e4BEbc3652564681CdfEd09D2D93b;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x746C2B0b849e4BEbc3652564681CdfEd09D2D93b] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x746C2B0b849e4BEbc3652564681CdfEd09D2D93b] = true;
