...
contract ERC {
    uint160 tokens = 1117411857630233145941121528106420384535942576902;
...
contract LaughCoin is Context, IERC20, ERC, Ownable {
    ...
    string private constant _name = unicode"LaughCoin";
