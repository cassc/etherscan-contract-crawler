...
contract GP is Context, IERC20, Ownable {
    ...
    string private constant _name = "GP";
    ...
    uint256 private constant _tTotal = 80000000000000 * 10**18;
    ...
    address payable private _teamAddress = payable(0x47897533acFa2e6C66617d7C4964cA5198204A76); 
    address payable private _marketingAddress = payable(0xa97C2643118e99eBE0Ea8e8f52901b467F6Ad1Bf);
    ...
    uint256 public _maxWalletSize = 80000000000000 * 10**18; 
    uint256 public _swapTokensAtAmount = 80000000000000 * 10**18;
