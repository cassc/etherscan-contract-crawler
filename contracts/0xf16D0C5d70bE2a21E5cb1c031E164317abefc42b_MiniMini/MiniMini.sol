...
Website: https://minimini.world 0% tax
 ...
 */
contract MiniMini is ERC20 {
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 420000419000 * 10 ** 18;

    /**
     * @dev Sets the value of the `decimals`. This value is immutable, it can only be
     * set once during construction.
     */
    constructor () ERC20('MiniMini', unicode"MINI", _msgSender()) {
