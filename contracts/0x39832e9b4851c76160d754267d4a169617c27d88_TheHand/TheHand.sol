...
contract TheHand is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xc701d4aBA3D9dc20CB1184dA2BD1512821916671); // Marketing Address

    address payable public teamAddress =
        payable(0xc701d4aBA3D9dc20CB1184dA2BD1512821916671); //  Development Address

    address payable public liquidityAddress =
        payable(0xd50352864767A152270D0e951Dfd51CFA590b3A6); // Liquidity Address
    ...
    string private constant _name = "The Hand";
    string private constant _symbol = "THAND";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 40 / 1000; // maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 40 / 1000; // maxWalletToken
