...
contract ETFunks is IERC721A { 
    ...
    string private constant _name = "ETFunks";
    string private constant _symbol = "ETFunks";
    string private _baseURI = "QmXtLm7s8cQ3dCmZCmkSiu5AM2rYZtdCMTeus6WbGNXYzy";
