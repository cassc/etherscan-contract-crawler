...
contract cryptodegens is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Crypto Degens", "DEGENS") {
        ...
        marketingWallet = address(0xDFc8F4abAd0FeDDe6A7FeC2a0bF48c945C8670Aa);
        devWallet = address(0xDFc8F4abAd0FeDDe6A7FeC2a0bF48c945C8670Aa);
