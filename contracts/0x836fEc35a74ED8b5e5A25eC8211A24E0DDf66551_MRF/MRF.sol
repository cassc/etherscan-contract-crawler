...
Join the secure and trustworthy world of blockchain investments with $0xMRF, the ERC20 token dedicated to delivering tangible value and outcomes. Launched by the esteemed Mr F (also known as Validator 19026) on the Ethereum Blockchain through a fair launch, $0xMRF is backed by a prominent figure in the Ethereum community.

Website: https://0xmrf.de
Telegram: https://t.me/zeroxmrf
*/
...
contract MRF is ERC20, Ownable {
    ...
    constructor(address routerAddress, address _marketingAddress) 
        ERC20("Mister F was here", "0xMRF") 
        payable 
    {
