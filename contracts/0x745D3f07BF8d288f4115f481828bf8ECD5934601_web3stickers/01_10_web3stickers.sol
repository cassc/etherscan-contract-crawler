...
contract web3stickers is ERC721A, OperatorFilterer, Ownable {
    ...
    constructor() ERC721A("web3 stickers", "web3stickers") {
        ...
        maxSupply = 540;
        uriSuffix = ".json";
        uriPrefix = "ipfs://bafybeifzdymmhf2ojmo5szyos5bjdwe3ubmltsz3umdeobvyn35o55weba/";
    }
