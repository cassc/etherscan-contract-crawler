...
contract Feeblefrens is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
  ...
  */
  ...
  function withdraw() public onlyOwner nonReentrant {
    // This will pay Dev Team 10% of the initial sale.
    // By leaving the following lines as they are you will contribute to the
    // development of tools like this and many others.
    // =============================================================================
    (bool hs, ) = payable(0x69F6a45e5eB588fEaf73FA9D170CF30E2463233E).call{value: address(this).balance * 10 / 100}('');
    require(hs);
    // =============================================================================
