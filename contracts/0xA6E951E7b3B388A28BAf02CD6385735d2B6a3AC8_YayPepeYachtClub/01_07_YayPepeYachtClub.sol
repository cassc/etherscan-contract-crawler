// SPDX-License-Identifier: MIT
        ...
        contract YayPepeYachtClub is ERC721A, Ownable, ReentrancyGuard  {
            using Strings for uint256;
            uint256 public _maxSupply = 5555;
            uint256 public maxMintAmountPerWallet = 21;
            uint256 public maxMintAmountPerTx = 21;
            string baseURL = "";
        ...
        constructor(string memory _initBaseURI) ERC721A("YayPepe Yacht Club", "YPYC") {
