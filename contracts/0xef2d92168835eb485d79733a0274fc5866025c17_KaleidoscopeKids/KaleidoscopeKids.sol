...
contract KaleidoscopeKids is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://bafybeiakeihycpdcgcnoldyexlthbzoonohh5ujzx3fn7fvku3bbqf5emq/";
    ...
    uint256 public constant MAX_SUPPLY = 1013;
    uint256 public constant FREE_MINT_SUPPLY = 1013;
    uint256 public INSTANT_FREE_MINTED = 0;

    event Minted(address minter, uint256 amount);

    constructor(string memory initBaseURI) ERC721A("KaleidoscopeKids", "KaleidoKid") {
        baseURI = initBaseURI;
