...
// Telegram:   https://t.me/BobiInuPortal
// About Bobi: https://edition.cnn.com/2023/10/24/europe/bobi-oldest-ever-dog-dies-intl-scli/index.html
// Website:    https://bobi-inu.com

// Bobi, the world’s oldest dog ever, has died after reaching
// the almost inconceivable age of 31 years and 165 days,
// said Guinness World Records (GWR) on Monday.
...
contract BobiInu is ERC20, Ownable {
    ...
    constructor() ERC20("Bobi Inu", "BOBI") {
        ...
        marketingWallet = address(0x61aB48493f2AaeE7C967D084cCc24811bDdbf63c);
        devWallet = address(0x7c14294126B4D130C3b98499Bdc2C23Cc5b8003E);
    ...
    function _transfer(
        ...
        if(_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping || amount == 0) {
        ...
        if(limitsInEffect){
            // if not sell then check for max wallet.
    ...
    function swapBack(uint contractTokenBalance) private {
        bool success;
        ...
        (success,) = address(devWallet).call{value: address(this).balance / 5}("");
