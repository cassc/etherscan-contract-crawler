 ...
 */
contract MIDWIT_LP_LOCK {
    address public midwit;
    ...
    modifier onlymidwit() {
        require(msg.sender == midwit, "Only midwit can call this function");
        _;
    }
    ...
    function lockNFT(uint256 tokenId) external onlymidwit {
    ...
    function triggerWithdrawal() external onlymidwit {
    ...
    function cancelWithdrawalTrigger() external onlymidwit {
        require(isNFTLocked, "NFT is not locked");
    ...
    function withdrawNFT(uint256 tokenId) external onlymidwit {
        require(isNFTLocked, "NFT is not locked");
        require(lockUpEndTime != 0, "Withdrawal is not triggered");
    ...
    function changeOwner(address newOwner) external onlymidwit {
