...
//--- Contract v2 ---//
contract wFloki is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x097051dEe4e6E3e0aD3B7CE356227b34C95cE321);


    IRouter02 public swapRouter;
    string constant private _name = "wFloki";
    string constant private _symbol = "wFloki";
