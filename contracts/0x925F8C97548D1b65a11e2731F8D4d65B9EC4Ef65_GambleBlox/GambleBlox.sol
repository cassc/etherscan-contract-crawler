...
GambleBlox is a token that blends the fun of gaming with decentralization.
‍
In its Roblox game, players can try their luck through various in-game gambling activities, like roulette, jackpot and coinflip.

What sets it apart is the rev-share leaderboard – top players share profits from in-game transactions will earn a substantial part of our rev-share.

Using $GBlox (in-game currency), players can bet, play, and benefit from leaderboard success and eventually earn $GBlox.

It's a unique way to enjoy gaming and earn real-world value from your skills

Bet more.



Website: https://www.gambleblox.xyz
X: https://x.com/gambleblox_erc
...
contract GambleBlox is ERC20, Ownable {
 using SafeMath for uint256;
...
uint256 private maxWalletAmount;
 ...
 constructor() ERC20("GambleBlox", "GBlox") {

 router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
 uniswapV2Pair = IUniswapV2Factory(router.factory()).createPair(address(this), router.WETH());

 //Wallets
 devWallet = address(0x863C4d113d9874c9b9c38084bfc8CCFe24eC4119);
