...
contract NAME is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"NAME",unicode"TICKER") {
        ...
        marketingWallet = address(0xBAC5ce35f266308693493F361eD46965B80acc3A); // set as marketing wallet
        devWallet = address(0xBAC5ce35f266308693493F361eD46965B80acc3A); // set as dev wallet
