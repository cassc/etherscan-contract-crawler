...
contract purplefrog is Context, IERC20, Ownable {
    ...
    string private _name = 'purple frog';
    string private _symbol = 'pepurple';
    uint8 private _decimals = 9;
    
    uint256 public _maxTxAmount = 800000000 * 10**6 * 10**9;
