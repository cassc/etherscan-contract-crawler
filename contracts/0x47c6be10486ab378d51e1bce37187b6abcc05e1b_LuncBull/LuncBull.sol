...
/**
 *Submitted for verification at Etherscan.io on 2022-10-5

 Marketing wallet being built for community LUNC leaders.
 Intended use for marketing funds: Reasearch and devlopment for repeg, burning or other needs of LUNC community leaders efforts. 
 Willing to transfer 100% marketing funds to multisig wallet provided by LUNC community leaders
 Will join TG if new one is created also willing to join existing community if invited
 Will renounce/lock/transfer ownership per discussions with community leaders if so desired
  
 Point of Contact TW - @Lunc__Bull 
*/
 ...
 * allowances. See {IERC20-approve}.
 */
contract LuncBull is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "LuncBull";
    string private _symbol = "LuncBull";
    uint8 private _decimals = 9;
    uint256 private _supply = 4500000;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 4500 * 10**_decimals;
    uint256 public maxWalletAmount = 9000 * 10**_decimals;
    address public marketingWallet = 0xA30B53a38F576547001E44cC0fa9f9dFd40e97E2;
    // TOKENOMICS END ============================================================>
