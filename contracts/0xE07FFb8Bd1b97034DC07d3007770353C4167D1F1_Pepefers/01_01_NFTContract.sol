...
contract Pepefers is Ownable, ERC721A{
    using Strings for uint256;

    string public BASE_URI;
    bool public isPublicMintEnabled = false;
    uint public maxSupply = 6969;
    uint public maxFreeSupply = 6969;
    uint public costPublic = 0.00420 ether;
    uint public maxMintPublic = 10; //per tx
    uint public freePerWallet = 1; //per wallet

    mapping(address => uint256) public mintedByAddress;

    address t1 = 0xfbAceb571ECdb99D00b844F663F9e943F0517F56;
    address t2 = 0x3ec88fB5A000859A2C51833d9AD424B42632141d;
    address t3 = 0xBba1d69Df6374D99d27119f3936af3d209A0df82;

    constructor() ERC721A("Pepefers", "PPF") {}
