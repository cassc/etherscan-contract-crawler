...
contract ChibiWarriors is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint;

    string  public baseTokenURI = "https://bafybeihetsgvejs2idvb6ob6wmwtu55uktqtw5d6uwgdz7pnoe4jn4s2qa.ipfs.nftstorage.link/metadata-warriors";
    ...
    constructor() ERC721A("ChibiWarriors", "ChibiWarriors") {}
