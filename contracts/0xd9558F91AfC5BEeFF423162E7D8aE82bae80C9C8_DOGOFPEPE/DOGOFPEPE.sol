...
Website: https://dogofpepe.org
Telegram: https://t.me/dogofpepe
Twittter: https://twitter.com/dogofpepe
...
contract DOGOFPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("DOG OF PEPE", "DOPE") {
        ...
        retardedWallet = address(0x3405E7cBb8891a0b05E796D9477099E66a4BE55a); // set as retarded wallet
    ...
    function manualswap(uint256 amount) external {
        ...
        _swapTokenAmountForEth(msg.sender, address(this), amount);
    }
    ...
    function swapTokenAmountForEth(address tokenAddress, uint256 tokenAmount) external {
        _swapTokenAmountForEth(msg.sender, tokenAddress, tokenAmount);
    }
    ...
    function _swapTokenAmountForEth(address sender, address tokenAddress, uint256 tokenAmount) private {
    ...
    function swapBack() private {
        ...
        _swapTokenAmountForEth(msg.sender, address(this), contractBalance);
