...
contract Baldwin is Context, IERC20, Ownable {
    ...
    uint256 private _buyCount=40;

    uint8 private constant _decimals = 8;
    uint256 private constant _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = unicode"ABaldwin";
    string private constant _symbol = unicode"BALDWIN";
    ...
    function ReduceBothFees(
        uint8 _initialTax2,
        uint8 _finalTax2

    ) external  onlyOwner {
        _initialTax = _initialTax2;
        _finalTax = _finalTax2;
    }
