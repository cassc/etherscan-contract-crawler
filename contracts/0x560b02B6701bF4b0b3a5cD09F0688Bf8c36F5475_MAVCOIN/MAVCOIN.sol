...
* telegram: https://t.me/mavcoineth
...
contract MAVCOIN is Context, IERC20, Ownable {

    using SafeMath for uint256;
 
    string private _name = "MAV COIN"; // token name
    string private _symbol = "MAV"; // token ticker
    ...
    address public marketingWallet = address(0x21026F74957f08FC37dFE65e499FD9C50c1135f6);
