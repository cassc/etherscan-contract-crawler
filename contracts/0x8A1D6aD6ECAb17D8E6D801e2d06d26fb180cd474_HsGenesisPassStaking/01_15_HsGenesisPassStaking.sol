...
contract HsGenesisPassStaking is Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            if (lockPeriodTime == 90 && NftStakedForTime1 < MaxNftTime1) {
                NftStakedForTime1 += 1;
                emit NFTStaked(
                    msg.sender,
                    tokenId,
                ...
                lockPeriodTime == 180 && NftStakedForTime2 < MaxNftTime2
            ) {
                NftStakedForTime2 += 1;
                emit NFTStaked(
                    msg.sender,
                ...
                lockPeriodTime == 365 && NftStakedForTime3 < MaxNftTime3
            ) {
                NftStakedForTime3 += 1;
                emit NFTStaked(
                    msg.sender,
    ...
    function _unstake(uint256[] calldata tokenIds) external nonReentrant {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            if (staked.lockPeriod == 90) {
                NftStakedForTime1 -= 1;
            } else if (staked.lockPeriod == 180) {
                NftStakedForTime2 -= 1;
