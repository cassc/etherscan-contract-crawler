...
contract PrimeGuins is ERC721, Ownable, ERC721Enumerable, ReentrancyGuard {
	...
	uint256[4] public SaleNFT = [10,90,900,4555]; // Giveaway 10, Genesis PrimeGuins (90), Genesis PrimeGuins (900), PrimeGuins (4500)
    uint256[4] public BatchStarted = [1,11,101,1001];
