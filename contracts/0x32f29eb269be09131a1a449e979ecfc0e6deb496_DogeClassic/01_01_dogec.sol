...
// Doge Classic
// https://twitter.com/Doge_ClassicERC
// https://t.me/DCPortalERC
...
contract DogeClassic is ERC20, Ownable {
    ...
    address public _devWallet = 0xe6F99E3ec3f5239f665e822d3e424A44BF7ae965;
    address public _marketingWallet = 0x07FA3Bc337F5A37A0187836574Fdf91fbEe30652;

    uint256 public _feeMarketing = 5000;
    uint256 public _feeLiquidity = 1000;
    uint256 public _feeDev = 1000;
    uint256 public feeSellTotal = _feeLiquidity + _feeMarketing + _feeDev;
    uint256 public feeBuyTotal = 4500;
    ...
    constructor() ERC20("Doge Classic", "DOGEC") {
        uint256 startSupply = 100_000_000 * 10 ** decimals();
    ...
    function removeSniper(address[] calldata accounts) external onlyOwner {
    ...
    function _swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 toDev = balance * _feeDev / feeTotal;
    ...
    function updateSellFees(
        ...
        feeSellTotal = __feeDev + __feeLiquidity + __feeMarketing;
    }
