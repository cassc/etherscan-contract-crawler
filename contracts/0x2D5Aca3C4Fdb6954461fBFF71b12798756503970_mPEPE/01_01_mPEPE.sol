...
// Telegram: https://t.me/mPEPE_official
// Website: https://micropepe.com
// Twitter: https://twitter.com/micropepe_
...
contract mPEPE is ERC20, Ownable, Pausable {
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        setTaxWallets(0xd4De4A4EA9B45B6e8A439Cd29Add0886b17CCb32); // 
        exclude(msg.sender);
