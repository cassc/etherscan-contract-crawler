...
$NPC TOKEN
Non Person Character token, a unique digital asset on the Ethereum blockchain, crafted for the true individualists, freethinkers, and self-made men of our generation.

Drawing inspiration from the NPC Wojak meme, this token stands as a testament to those who dare to think differently, challenge the status quo, and carve their own path in life.

Web : http://npc.supply
Twitter : https://twitter.com/npc_coinerc
Tg : https://t.me/npc_coinerc
...
contract NPC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Non Player Character";
