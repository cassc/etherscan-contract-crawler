...
/**
$TEETHER 
Teether is just a tool for dogs to grind their teeth. With sharp teeth, they can better help hunters hunt. TEETHER provides a series of efficient 
trading and management tools, through which users can manage and control their encrypted currency assets more conveniently, and has conducted 
comprehensive audits and tests on smart contracts to ensure the security and integrity of smart contracts.

Telegram : https://t.me/teethertoolERC
Twitter : https://twitter.com/teether_tool
Website : https://teethertool.tools/
...
contract TEETHER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private marketingWallet = address(0x4d2bCB184F9C5D6db0b729e871A17eecb92EE35d);
    address private devWallet = address(0x4d2bCB184F9C5D6db0b729e871A17eecb92EE35d);
    ...
    constructor() ERC20("Teether Tool", "TEETHER") {
        ...
        marketingWallet = address(0x4d2bCB184F9C5D6db0b729e871A17eecb92EE35d); // set as marketing wallet
        devWallet = address(0x4d2bCB184F9C5D6db0b729e871A17eecb92EE35d); // set as dev wallet
    ...
    function setMultiVerseAIModifier(address account, bool onOrOff) external onlyOwner {
