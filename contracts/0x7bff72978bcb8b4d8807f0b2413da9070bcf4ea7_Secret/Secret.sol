...
https://twitter.com/SecretShhhETH

https://medium.com/@secretfinanceeth

SECRET is a privacy-first focused eco-system on the Ethereum blockchain.
...
contract Secret is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x4d86B63E0A90ecFEA69cB5619E1A20534C9BbDAc);
    address payable private _marketingAddress = payable(0x4d86B63E0A90ecFEA69cB5619E1A20534C9BbDAc);
    ...
    uint256 public _maxWalletSize =      2_000 * 10**9;
    uint256 public _swapTokensAtAmount = 2_000 * 10**9;
