...
// CAWCEO Contract
contract CAW_CEO is ERC20, Ownable {
    ...
    constructor(uint256 _sell_MarketingFee, uint256 _sell_Liquidity_Fee) ERC20("CAW CEO", "CAWCEO") {
        ...
        marketingWallet = address(0x4cD7fEA56A9A12134EF3445E119462a264b5b9d2); // set as marketing wallet
        devWallet = address(0xb84ac938aB6339E2587dB216255cA5e1e81C67E2); // set as dev wallet
