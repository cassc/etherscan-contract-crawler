...
/**
 * @title   Calculates Curve token amounts including fees for Curve.fi Factory Metapools that are based on 3Pool (3Crv).
 * @notice  This has been configured to work for factory metapools with only two coins, 18 decimal places
 ...
 * @dev The main different between Curve metapools like mUSD and factory metapools like BUSD is
 * the factory metapools do not cache the base pool's virtual price.
 * @author  mStable
 * @dev     VERSION: 1.0
 *          DATE:    2022-08-26
...
library Curve3CrvFactoryMetapoolCalculatorLibrary {
     ...
     * @param _metapool Curve metapool to deposit tokens. eg BUSD+3Crv
     * @param _metapoolToken Curve metapool liquidity provider token. eg BUSD3CRV-f/USD
     ...
     * @param _metapool Curve metapool to withdraw tokens. eg BUSD+3Crv
     * @param _metapoolToken Curve metapool liquidity provider token. eg BUSD3CRV-f/USD
     ...
     * @param _metapool Curve metapool to mint lp tokens. eg BUSD+3Crv
     * @param _metapoolToken Curve metapool liquidity provider token. eg BUSD3CRV-f/USD
     ...
     * @param _metapool Curve metapool to redeem lp tokens. eg BUSD+3Crv
     * @param _metapoolToken Curve metapool liquidity provider token. eg BUSD3CRV-f/USD
        ...
        )
    {
        ...
        uint256 baseVirtualPrice = _baseVirtualPrice();
     ...
     * @param metapoolToken Curve metapool liquidity provider token. eg BUSD3CRV-f/USD
     ...
     * @param metapool Curve metapool to get the virtual price from.
     * @param usdAmount Amount of USD scaled to 18 decimal places to value.
     * @return metaLp_ Value in metapool liquidity provider tokens. eg BUSD3CRV-f
     */
     ...
     * @param xp  The scaled balances of the coins in the pool.
     * @param Ann The amplitude coefficient multiplied by the number of coins in the pool (A * N_COINS).
     * @param coinIndex The index of the coin in the metapool. 0 = eg BUSD, 1 = base coin, eg 3Crv.
