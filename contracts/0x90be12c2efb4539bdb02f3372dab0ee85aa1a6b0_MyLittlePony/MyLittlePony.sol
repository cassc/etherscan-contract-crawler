...
Website: http://mylittlepony.vip $PONY
 ...
 */
contract MyLittlePony is ERC20 {
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 20202020202 * 10 ** 18;

    /**
     * @dev Sets the value of the `decimals`. This value is immutable, it can only be
     * set once during construction.
     */
    constructor () ERC20('My Little Pony', unicode"PONY", _msgSender()) {
