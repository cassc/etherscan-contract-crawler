...
contract burnthair is ERC20, Ownable {
    ...
    constructor() ERC20("BURNT HAIR", "BURNT") {
        ...
        sellTotalFees = sellDevFee + sellBurnFee;
    ...
    function updateBuyFees(uint256 _devFee, uint256 _burnFee) external onlyOwner {
        buyDevFee = _devFee;
        buyBurnFee = _burnFee;
        buyTotalFees = buyDevFee + buyBurnFee;
    ...
    function updateSellFees(uint256 _devFee, uint256 _burnFee) external onlyOwner {
        sellDevFee = _devFee;
