...
ETHAMPHETAMINE ($METH), the freshest crypto project on the Ethereum blockchain, inspired by the groundbreaking series, Breaking Bad!

1m $METH
0 TAX

Telegram: https://t.me/METH_ERC
Twitter: https://twitter.com/METH_ERC
Website: https://methcoin.site
...
contract ETHamphetamine {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "ETHamphetamine";   
    ...
    address payable constant deployer = payable(address(0x8b78D05a5a1fA38e1fD8bFCFAaBECB6a4A021Ad1));
