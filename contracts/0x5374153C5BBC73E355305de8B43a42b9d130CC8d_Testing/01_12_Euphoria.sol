...
contract Testing is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    uint256 public ogSalePrice = 0.00013 ether;
    ...
    constructor(bytes32 _ogMerkle, bytes32 _wlMerkle) ERC721A("TESTING", "TTT") {
    ...
    function _verifyOG(
        ...
        address addr
    ) internal view returns (bool) { // @TODO: make it internal
    ...
    returns (string memory) {
        ...
        // @TODO: if unreveal, return same url
