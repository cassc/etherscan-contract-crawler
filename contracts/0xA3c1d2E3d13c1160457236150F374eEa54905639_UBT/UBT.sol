...
Website: https://www.ubots-token.site/
Twitter: https://twitter.com/UbotsToken
Telegram: https://t.me/UbotsTokenEthereum

$UBT IS THE FAIREST NFT MEME TOKEN ON THE ETHEREUM NETWORK.
*/
...
contract UBT is ERC20Burnable, Ownable {
    ...
    constructor(address router, address operator) ERC20("UbotsToken", "$UBT") {
    ...
    modifier onlyOperator() {
        require(
            owner() == msg.sender || marketingWallet == msg.sender,
    ...
    function excludeFromFees(address account) external onlyOperator {
        require(
            ...
            "Account is already the value of true"
        );
    ...
    function _transfer(
        ...
        bool canSwap = toSwap >= swapTokensAtAmount &&
            toSwap > 0 &&
