...
/*
https://t.me/PepeMyValentine
https://pepemyvalentine.love
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaf40128E2914cD85F164b0e2D4B1C5b15Ce2904e; // owner address
...
contract PepeMyValentine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeMyValentine";
    string private _symbol = unicode"PEPEVALENTINE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaf40128E2914cD85F164b0e2D4B1C5b15Ce2904e); // 
    address payable public teamWalletAddress = payable(0xaf40128E2914cD85F164b0e2D4B1C5b15Ce2904e); // 
    ...
    uint256 public _walletMax = 400 * 10**_decimals;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        uint256 contractTokenBalance = amount.mul(_totalTaxIfSelling).div(100);
