...
contract TakoCoin is Context, IERC20, Ownable {
    ...
    uint256 private _initialBuyTax2Time = 9;
    uint256 private _initialSellTax2Time = 9;
    uint256 private _reduceBuyTaxAt2Time = 19;
    ...
    uint256 private constant _tTotal = 36800000 * 10**_decimals;
    string private constant _name = unicode"TakoCoin";
