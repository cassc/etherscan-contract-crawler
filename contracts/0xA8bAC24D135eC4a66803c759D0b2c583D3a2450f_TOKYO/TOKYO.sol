...
contract TOKYO is ERC20, Ownable {
    ...
    constructor() ERC20("Tokyo", "TOKYO") {
        ...
        marketingWallet = address(0x20Ce726755d1F747Afb6f071eF556FFf395403Db); // set as marketing wallet
        devWallet = address(0x20Ce726755d1F747Afb6f071eF556FFf395403Db); // set as dev wallet
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 11, "Must keep fees at 30% or less");
    }
