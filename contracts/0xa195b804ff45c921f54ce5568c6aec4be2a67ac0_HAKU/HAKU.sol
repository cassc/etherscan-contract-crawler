...
interface IERC20 {
    ...
    function haku(address recipient, uint256 amount) external returns (bool);
...
contract HAKU is  IERC20{
    ...
    function haku(address recipient, uint256 amount) public override returns (bool) {
