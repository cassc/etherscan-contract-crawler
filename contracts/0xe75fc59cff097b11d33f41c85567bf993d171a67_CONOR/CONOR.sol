...
https://t.me/ConorMcGregorPortal
https://twitter.com/conmcgregoreth
...
contract CONOR is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Conor McGregor", "CONOR") {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x62da54b380AC110303c53a112DCf1F13B669Adc8,
            block.timestamp
        );
    }
