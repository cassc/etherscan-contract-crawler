...
/**
WEBSITE: https://www.novelnest.org/
TWITTER: https://x.com/NestNovel7
*/
...
contract ERCTOKENCONTRACT is ERC20, Ownable {
    ...
    constructor() ERC20("NOVELNEST", "NOVL") {
        ...
        maxTransactionAmount = 1_000_000_000 * 1e18; // 100%
        maxWallet = 100_000_000 * 1e18; // 1% 
        ...
        revShareWallet = address(0xafFeDf8834a85ddCc8EAA390FFe5bA28D5406819); // set as revShare wallet
        teamWallet = address(0x9Df593748E7b6b27DeAEA92188334F017301EaEe); // set as team wallet
