...
import "./KatanaDividendToken.sol";

/*
The Katana is made from many into one... 
it is a tool that must be forged from the 
struggle of the many. Strike the flame, 
stand together, and rise as legends!

https://t.me/KatanaToken
...
contract Katana is ERC20, Ownable {
    ...
    modifier onlyManager() {
        require(
            ...
            "Message sender must be the contract's Manager."
        );
        _;
    }
    ...
    address public treasuryWallet = 0xAd989683483c6D72B3eb815f01ee0Ca14542C01e;
    address public devWallet = 0xAd989683483c6D72B3eb815f01ee0Ca14542C01e;

    uint256 public swapTokensAtAmount;
    uint256 public maxBuyAmount;
    uint256 public maxSellAmount;
    uint256 public maxWallet;
    address public managerAddress= 0xAd989683483c6D72B3eb815f01ee0Ca14542C01e;
        ...
        ERC20("Katana", "KAT")
    {
        ...
        setSwapTokensAtAmount(5000);
        updateMaxWalletAmount(20000);
    ...
    function UpdateTreasuryAddress(address newtreasury) public onlyManager {
    ...
    function updateMaxWalletAmount(uint256 newNum) public onlyOwner {
        require(newNum > (10000 * 1), "Cannot set maxWallet lower than 1%");
    ...
    function setMaxBuyAndSell(uint256 maxBuy, uint256 maxSell)
        ...
        onlyOwner
    {
        require(maxBuy >= 10000, "Cannot set maxbuy lower than 1% ");
        require(maxSell >= 5000, "Cannot set maxsell lower than 0.5% ");
    ...
    function setSwapTokensAtAmount(uint256 amount) public onlyManager {
        require(amount < 250000, "Cannot set swaptokens higher then than 25% ");
    ...
    function rescueETH20Tokens(address tokenAddress) external onlyManager {
    ...
    function forceSend() external onlyManager {
    ...
    function setClaimEnabled(bool state) external onlyManager {
        claimEnabled = state;
    }
