...
// File: contracts/InfernoEntities.sol
...
contract InfernoEntities is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmSyj5MzYWd5Z5FRe5RfiFwirXvXZBms3957MxvUxdrjCK";
  ...
  uint256 public  TOTAL_FREE_MINTS = 100;
  bool public isPublicSaleActive = false;

  constructor() ERC721A("Inferno Entities", "INFEN") {
