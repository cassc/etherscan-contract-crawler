...
contract StakedApe is ERC4626, Owned {
    ...
    uint256 public constant FEE = 200; // 2% fee
    ...
    /// @notice the total balance of ApeCoin staked in the contract
    ...
    function beforeWithdraw(uint256 assets, uint256) internal override {
        // lets stake what we can
        harvest();
        // lets withdraw what we need
        staking.withdrawSelfApeCoin(assets);
    }

    /// @notice claim any pending rewards and stake them
