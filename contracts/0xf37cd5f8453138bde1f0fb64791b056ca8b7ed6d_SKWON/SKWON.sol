...
contract SKWON is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Do Kwon";
    string private constant _symbol = "SKWON";
    ...
    constructor () {
        ...
        _standardTax = 8; // only active during launch
