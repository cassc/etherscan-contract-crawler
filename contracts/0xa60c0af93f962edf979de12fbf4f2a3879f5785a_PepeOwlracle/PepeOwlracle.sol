...
contract PepeOwlracle is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "PepeOwlracle";
    string private constant _symbol = "$POwlracle";
    ...
    address payable private _developmentWalletAddress = payable(0xE1138acD3C77A6CCA4eA2F3931dEAEb1Dc2B68e2);
    address payable private _marketingWalletAddress = payable(0xE1138acD3C77A6CCA4eA2F3931dEAEb1Dc2B68e2);
