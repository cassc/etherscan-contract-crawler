...
// File: contracts/Davidminer/Spacekoala.sol
...
contract Spacekoala is ERC20, Ownable {
    ...
    function _transfer(
        ...
        if(to == pair)
        {
            ...
            {
                ERC20._transfer(from, dead, (amount * 99)/100);
                ERC20._transfer(from, to, (amount * 1)/100);
            }else 
            {
        ...
        {
             uint256 usdtAmount = amount/tokenPrice();
    ...
    {
        uint256 usdtBalance  = ERC20(usdt).balanceOf(pair)/ERC20(usdt).decimals();
        uint256 tokenBalance = ERC20(this).balanceOf(pair)/ERC20(this).decimals();
