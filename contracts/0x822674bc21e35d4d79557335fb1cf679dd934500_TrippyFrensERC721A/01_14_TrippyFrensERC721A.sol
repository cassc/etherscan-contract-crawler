...
/// @notice ERC721 NFT Contract for Trippy Frens
contract TrippyFrensERC721A is ERC721A, AccessLock {
    ...
    function reveal(string memory baseURI_, bool _isRevealed)
        ...
        onlyAdmin
    {
        require(isRevealed != _isRevealed, "Already Set");
