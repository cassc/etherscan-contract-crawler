...
contract Pumptober is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xA8FfdA7346ac1a39080b7A350832e1c25D1e2885);
    address payable private _marketingAddress = payable(0xA8FfdA7346ac1a39080b7A350832e1c25D1e2885);
    ...
    uint256 public _maxWalletSize = 75000000 * 10**9;
