...
Tax is 4% for buy & sell, 2% for burning the supply & 2% marketing.

Max Wallet : 1.5%

Max wallet will be lifted to 3% .
*/
...
contract NEKO51 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NEKO 51", "NEKO51") {
        ...
        uint256 totalSupply = 21000000  * 1e6;
        supply += totalSupply;
        ...
        maxTransactionAmount = supply * transDigit / 50;
        swapTokensAtAmount = supply * 5 / 10000; // 0.05% swap wallet;
        maxWallet = supply * walletDigit / 50;
        ...
        devWallet = 0x843A8Db9294426D73433036E2d2d2673957236A5;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellBurnFee + sellDevFee;
        require(sellBurnFee <= 10, "Must keep fees at 10% or less");
    }
