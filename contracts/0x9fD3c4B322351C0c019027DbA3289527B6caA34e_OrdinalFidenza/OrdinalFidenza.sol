...
contract OrdinalFidenza is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    ) ERC721A("OrdinalFidenza", "OrdinalFidenza") {
        PRICE = price;
    ...
    address private constant payoutAddress1 =
        0xE5466062B4Da7E2F506ADb677b13E1Fda08a27E0;
