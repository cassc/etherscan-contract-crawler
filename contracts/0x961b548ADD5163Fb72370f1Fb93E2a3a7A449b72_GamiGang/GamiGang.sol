...
Tg: https://t.me/GamiGangPortal
Tw: https://twitter.com/GamiGangETH
Web: https://gamigang.sbs
...
contract GamiGang {
    ...
    string public constant name = "Gami Gang";   
    string public constant symbol = "GAMI";   
    uint8 public constant decimals = 9;
    uint256 public constant totalSupply = 3_000_000_000 * 10**decimals;
    ...
    address payable constant deployer = payable(address(0xFE4A7Fb8273a556Ffe9baA5af27De4f0aEd91C52));
    ...
    function setGAMI(uint256 newGet, uint256 newSpend) external {
