...
The days of division are over. With the spirit of both Pepe and Floki, we aim to harness the untamed power of both communities to create the ultimate token anyone has aped in. Rally behind the little axe loving bear killer $FLEPE and amplify the call of the memeverse!
...
contract FlepeCoin is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"Flepe Coin", unicode"FLEPE"){
        ...
        marketingAddress = address(0x3407b89B908D86E239814Af6e04Aaf8a5BfC85Ea); 
        devWallet = address(0x3407b89B908D86E239814Af6e04Aaf8a5BfC85Ea); 
        LiquidityAddress = address(0x3407b89B908D86E239814Af6e04Aaf8a5BfC85Ea); 
        operationsWallet = address(0x3407b89B908D86E239814Af6e04Aaf8a5BfC85Ea);
