...
/*
https://ThePepesons.com 
https://Twitter.com/ThePepesons 
https://t.me/thepepesons
*/
...
contract Pepesons is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 1_000_000 * (10**_decimals);
    string private constant _name         = "The Pepesons";
    string private constant _symbol       = "PEPESONS";
    ...
    uint16 private _taxSharesDevelopment = 25;
    uint16 private _taxSharesLP          = 0;
    uint16 private _totalTaxShares = _taxSharesMarketing + _taxSharesDevelopment + _taxSharesLP;

    address payable private _walletMarketing = payable(0xC5FCe42cB8fEB6999DA4Af023f09FEcD076e69A5); 
    address payable private _walletDevelopment = payable(0xCC140e702eee1A537f27C9cB33c5ACbf5Db4A73f); 
