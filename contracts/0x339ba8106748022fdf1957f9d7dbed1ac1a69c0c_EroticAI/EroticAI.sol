...
// Discord will be open post lock and renounce there is no tg for now, all initial updates will be on twitter.
// twitter: https://twitter.com/AIEroticaLLC
...
contract EroticAI is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "EroticAI";//
    ...
    address payable private _developmentAddress = payable(0xf3403AA1270338a895f7c4BbDF0F6fd5793541EA);//
    address payable private _marketingAddress = payable(0xf3403AA1270338a895f7c4BbDF0F6fd5793541EA);//
