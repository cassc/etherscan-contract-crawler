...
contract BUGATTIINU is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0xA2fED6a644B4D56411D2A0672b51FCf7bd7Ae3b4); // Marketing Wallet
    address payable private crowdfundWallet = payable(0xA2fED6a644B4D56411D2A0672b51FCf7bd7Ae3b4); // Crowd Fund Wallet
    address payable private devWallet = payable (0xA2fED6a644B4D56411D2A0672b51FCf7bd7Ae3b4); // Dev Wallet
    ...
    uint256 private crowdfundfee = 25;   //0% same for buys and sells
