...
contract TheDollhouse is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 999;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x0c29d745ee9c6f251292b24dcad57b3ca8d1b480f4e4ddb0f75be5fcf5e7caad;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://Qmeh9xxTegaiQQu9cKSmiXjDWS76vT4JERWnXXodXtyLTo";

    constructor() public ERC721A("The Dollhouse", "DOLL", 999, 999) {}
