...
contract FOTB is ERC721AQueryable, ERC2981, Ownable, ReentrancyGuard {
  ...
  ) ERC721A("Freedom Of The Bulls", "FOTB") {
    require(_royaltyFee <= 1000 && _royaltyFee >= 0, "can't be more than 10 or less then 0");
  ...
  function mintFromCrossmint(address _to, uint256 _mintAmount) public payable  mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount){
