...
contract MemeStaking {
    ...
    constructor() {
        memeToken = IERC20(0x44edbC9C306CFdA02d4561122206c56850064047);
        rewardPool = 6900000000 * 10**18; 
    }
    ...
    function calculateReward(address user) public view returns (uint256) {
        ...
        uint256 duration = block.timestamp.sub(lastClaimed[user]);
        uint256 rewardRate = 172800; // Emission rate changed to 48 hours (172800 seconds)

        return staked.mul(duration).div(rewardRate);
    }
}