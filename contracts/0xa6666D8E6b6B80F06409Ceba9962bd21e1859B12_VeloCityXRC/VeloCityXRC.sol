...
https://t.me/VeloCityXRC 
https://twitter.com/VeloCityXRC
...
contract VeloCityXRC is ERC20, Ownable {
    address public pool;
    uint256 _startTime;
    uint256 constant _startTotalSupply = 1000000000e18;
    uint256 constant _startMaxWallet = _startTotalSupply / 100;
    uint256 constant _addMaxWalletPerSec =
        (_startTotalSupply - _startMaxWallet) / 60000;

    constructor() ERC20("VeloCityXRC", "XRC") {
