//Redployment from Shiba Revival Team. Last Contract had error. 

//Ryo is coming back................. Watch this in silence
...
contract ShibaRevivalTeam is ERC20, Ownable {
    ...
    //Taxes
    Tax public buyTaxes = Tax(1, 0, 2);
    Tax public sellTaxes = Tax(1, 0, 2);
    ...
    //Swapping
    uint256 public swapTokensAtAmount = _totalSupply / 10; 
    bool public swapAndLiquifyEnabled = true;
    bool public isSwapping = false;

    //Wallets
    address public marketingWallet = 0x15fBCCA6bE12A5ed00173ACDaC5684B9a0e43D90;
    address public developmentWallet = 0x15fBCCA6bE12A5ed00173ACDaC5684B9a0e43D90;
    ...
    constructor() ERC20("Shiba Revival Team", "SRT") {
