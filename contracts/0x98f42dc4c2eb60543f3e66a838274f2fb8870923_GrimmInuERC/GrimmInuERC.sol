...
TG Portal : https://t.me/GrimmInuErc
Twitter : https://twitter.com/Grimm_inu
...
contract GrimmInuERC is Context, IERC20, Ownable {
    ...
    string private constant _name = "Grimm Inu";
    string private constant _symbol = "GRIMM";
    ...
    constructor () {
        _TreasuryWallet = payable(0xcd9d561C6Ec5f9b8c4DE8A8CabCfA5e1769C404b);
    ...
    function setBuyFee(uint256 buyTreasuryFee, uint256 buyLiquidityFee) external onlyOwner {
        require(buyTreasuryFee + buyLiquidityFee <= 8, "Must keep buy taxes below 8%");
        _buyTreasuryFee = buyTreasuryFee;
        _buyLiquidityFee = buyLiquidityFee;
    }

    function setSellFee(uint256 sellTreasuryFee, uint256 sellLiquidityFee) external onlyOwner {
        require(sellTreasuryFee + sellLiquidityFee <= 8, "Must keep sell taxes below 8%");
    ...
    function removeAllFee() private {
        if(_buyTreasuryFee == 0 && _buyLiquidityFee == 0 && _sellTreasuryFee == 0 && _sellLiquidityFee == 0) return;
    ...
    function _getTotalFees(bool isSell) private view returns(uint256) {
        if (isSell) {
            return _sellTreasuryFee + _sellLiquidityFee;
        }
        return _buyTreasuryFee + _buyLiquidityFee;
    }
}