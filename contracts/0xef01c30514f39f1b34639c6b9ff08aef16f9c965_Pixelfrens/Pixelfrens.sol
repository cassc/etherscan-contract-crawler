...
contract Pixelfrens is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Pixelfrens", "PF"){}
    ...
    function priceCheck() public view returns (uint256) {
        return price;
    }
    ...
    function devMint(uint quantity, address user)
    public
    onlyOwner
  {
    require(
