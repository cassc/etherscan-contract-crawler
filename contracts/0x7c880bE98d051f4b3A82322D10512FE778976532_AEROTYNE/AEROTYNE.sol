...
https://twitter.com/Aerotyneerc20
https://t.me/aerotyne_eth
https://aerotyne.vip/
...
contract AEROTYNE is Ownable, ERC20 {
    ...
    string constant _name = "AEROTYNE";
    string constant _symbol = "ATYNE";
    uint8 constant _decimals = 9; 

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);

    uint256 public _maxTxAmount = 20_000_001 * (10 ** _decimals);
    uint256 public _maxWalletToken = 20_000_001 * (10 ** _decimals);
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xeb2078876A8238D3568b63232d04980857f06147;//marketing
    ...
    function updateIsPennyStock(address account, bool state) external onlyOwner{
        _isBot[account] = state;
    }
    
    function bulkIsPennyStock(address[] memory accounts, bool state) external onlyOwner{
