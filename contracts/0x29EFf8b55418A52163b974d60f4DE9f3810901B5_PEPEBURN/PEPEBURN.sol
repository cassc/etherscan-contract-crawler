...
/*
The First EVER PEPE BURN Utility Token
Alerts you on every burn a token developer has done making it easier to get into tokens
and trading with ease Join and BUY NOW to be the first ever on every alpha  

Entry: https://t.me/pepeburnportal
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣴⣿⠽⠭⣥⣤⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⡴⠞⠉⠁⠀⠀⠀⠀⠉⠉⠛⠶⣤⣀⠀⠀⢀⣤⠴⠞⠛⠉⠉⠉⠛⠶⣦⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡾⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠳⣏⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⢻⣆⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⣰⠏⠀⠀⠀⠀⠀⠀⢀⣠⠤⠤⠤⠤⢤⣄⡀⠀⠀⠹⡆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢹⡄⠀⠀⠀⠀⠀⠀⠀
...
contract PEPEBURN is ERC20, Ownable {
    ...
    constructor() ERC20("PEPE BURN", "BURN") {
        ...
        uint256 totalSupply = 10_000_000 * 1e18; //10,000,000 supply
        ...
        buyFee = 20; // 5% buy fee
        sellFee = 20; // 10% sell fee

        feeWallet = address(0x5fe6Dd75b0d8B88B280d137790bB6B83BbffD846); // set as feeWallet
    ...
    function updateTreasury(address _feeWallet)
        external
        onlyOwner
    {
        emit TreasuryUpdated(_feeWallet, feeWallet);
