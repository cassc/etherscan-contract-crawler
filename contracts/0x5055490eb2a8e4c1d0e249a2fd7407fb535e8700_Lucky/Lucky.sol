...
/*
 ...
 https://t.me/TheLuckyCatToken
 https://LuckyCatToken.com
 https://twitter.com/LuckyCatERC
...
contract Lucky is IERC20, Auth {
    ...
    string private constant _name         = "Lucky Cat";
    ...
    address payable private _walletMarketing = payable(0x08a70ba48629D11AcB389C4786C178B29Fee147e); 
    address payable private _walletDevelopment = payable(0x8d07745bC2f74d051e491324665e80AB52A77A78);

    uint256 private _launchBlock;
    uint256 private _maxTxAmount     = _totalSupply; 
    uint256 private _maxWalletAmount = _totalSupply;
    uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
    uint256 private _taxSwapMax = _totalSupply * 875 / 100000;
