...
contract GameNFT is ERC1155, Ownable {
    ...
    function mintOrTransfer(
        ...
        _mintOrTransferFrom(msg.sender, to, id, amount);
    }

    function mintOrTransferFrom(
        address from,
        address to,
        uint256 id,
        uint256 amount
    ) public onlyOwner {
        _mintOrTransferFrom(from, to, id, amount);
    }

    function _mintOrTransferFrom(
        address from,
        address to,
        uint256 id,
        uint256 amount
