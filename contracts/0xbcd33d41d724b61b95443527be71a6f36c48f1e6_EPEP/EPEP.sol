...
contract EPEP is Context, IERC20, Ownable {
    ...
    string private constant _name = "0.2 EPEP";
    string private constant _symbol = "02EPEP";
    ...
    address payable private _developmentAddress = payable(0x0307C2C67f11114dF878271bf42EC53a9bC5AA11);
    address payable private _marketingAddress = payable(0x636E7D1302a2df5bb7Cc4bcB1ff26bAC12E4c635);
