...
import "contracts/compound/tokens/cToken.sol";
...
/**
 * @title Ondo's Comptroller Contract
 * @author Compound
 */
  ...
  ExponentialNoError
{
  ...
  uint internal constant collateralFactorMaxMantissa = 0.999e18; // 0.999
  ...
  /**
   * @notice Return the address of the ONDO token
   * @return The address of Ondo
   * @dev ONDO is referred to as COMP in this repo
   */
