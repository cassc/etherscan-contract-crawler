...
// File: contracts/tokenrun/ERC721x/IERC721x.sol
...
// File: contracts/tokenrun/ERC721x/LockRegistry.sol
...
// File: contracts/tokenrun/ERC721x/ERC721x.sol

pragma solidity ^0.8.14;

contract ERC721x is Initializable, ERC721AUpgradeable, LockRegistry {
    /*
...
// File: contracts/tokenrun/tokenrun.sol

// pragma solidity ^0.8.18;

pragma solidity ^0.8.18;

contract TokenRun is ERC721x {
    ...
    mapping(address => uint256) public mintAddr;
    mapping(uint256 => address) public soulBonding;
    ...
    function initialize(string memory _prefixURI)
        public
        initializerERC721A
        initializer
    {
        __ERC721x_init("Tata Avatar by Julian's Editor", "TATA");
    ...
    function adminMint(address receiver, uint256 quantity) public onlyOwner {
    ...
    function mint() public payable {
        ...
        require(mintAddr[msg.sender] < maxPerWallet, "reached the maximum");

        mintAddr[msg.sender] += 1;
        safeMint(msg.sender, 1);
        soulBonding[totalSupply()] = msg.sender;
    }
    ...
    function setMintStatus(bool _enableMint) external onlyOwner {
        enableMint = _enableMint;
    }

    function setTransferStatus(bool _enableTransfer) external onlyOwner {
    ...
    function unStake(uint256 tokenID) external {
        ...
        uint256 stakeTimestamp = tokensLastStakedAt[tokenID];
        tokensLastStakedAt[tokenID] = 0;
        emit Unstake(tokenID, msg.sender, stakeTimestamp, block.timestamp);
    }
    ...
    function transferFrom(
        ...
        require(enableTransfer, "transfer not enabled");
        require(
            tokensLastStakedAt[tokenId] == 0,
            "Cannot burn staked token"
        );
