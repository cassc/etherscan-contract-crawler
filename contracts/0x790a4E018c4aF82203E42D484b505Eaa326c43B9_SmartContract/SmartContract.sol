...
Token Name: Dev 4 Hire
Symbol: CodeMaster
Supply: 1,000,000,000 i dump 15% (150,000,000) to deadwallet
initial max buy 30,000,000

initial tax 2/20 i like to f*ck up the bots
all tax to liquidity pool
i'll revert the tax to 2/2 when we reach 10k mcap
i'll renounce the ownership for your assurance
i'll lock the LP after the fake LP remove to jeets out bots

Telegram: you create i join
website: none don't expect
Twitter: none - i live in solidity
...
contract SmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dev 4 Hire";
    string private constant _symbol = "CodeMaster";
    ...
    uint256 private maxWalletAmount = 30000001 * 10**9;  // 3% initial max buy
    uint256 private maxTxAmount = 30000001 * 10**9;      // 3% initial max wallet
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0x63D0ca38f0C852629e89b8471F48559353c1834d); 
        ...
        swapEnabled = true;
        tradingOpen = true;
        maxTxAmount = 30000001 * 10**9;
        maxWalletAmount = 30000001 * 10**9;          
    ...
    function setwallet(uint256 _sellMarketingFee) external onlyOwner{/*
