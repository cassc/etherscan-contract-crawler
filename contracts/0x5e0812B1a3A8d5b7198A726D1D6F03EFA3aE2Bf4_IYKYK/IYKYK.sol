...
contract IYKYK is ERC20, Ownable {
    ...
    constructor() ERC20("IYKYK", "IYKYK") {
        ...
        marketingWallet = address(0xa4FD63de67Dbc07C9cbaBCD5DC3B2e4e12A02Aaf); // set as marketing wallet
        devWallet = address(0x90787660C09120F330e51622cCbD1a25758549d7); // set as dev wallet
