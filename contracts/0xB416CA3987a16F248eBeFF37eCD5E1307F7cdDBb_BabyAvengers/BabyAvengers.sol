...
contract BabyAvengers is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    AvengersDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BabyAvengers", "Avengers") {
        marketingWallet = payable(0x124847658733587ce7e744c9F5b8749d2aB91A94);
        devWallet = payable(0x1217B21CEBC1226435821Da5E08AFce058a1e858);
        ...
        dividendTracker = new AvengersDividendTracker(
            payable(this),
            router,
...
contract AvengersDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BabyAvengers public BabyAvengersContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BabyAvengersContract = BabyAvengers(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Avengers_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Avengers_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabyAvengers contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BabyAvengersContract);

            uint256 prevBalance = BabyAvengersContract.balanceOf(address(this));
            ...
            {
                uint256 received = BabyAvengersContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BabyAvengersContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
