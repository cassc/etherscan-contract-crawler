...
contract STEALTHINU is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "Stealth Inu";
    string private constant _Symbol = "STEALTHINU";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e12 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0x16B1867949ddd1aAf3b4b724970710F326708E24);
        treasuryAddress = payable(0x16B1867949ddd1aAf3b4b724970710F326708E24);
        devAddress = payable(0x16B1867949ddd1aAf3b4b724970710F326708E24);
