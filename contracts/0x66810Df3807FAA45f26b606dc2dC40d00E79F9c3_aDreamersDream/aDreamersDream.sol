...
contract aDreamersDream is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "A dreamer's dream";
    string private constant _symbol = "INCEPTION";
