...
$HAmster is a meme coin with no intrinsic value or expectation of financial return. There is no formal team or roadmap. the coin is completely useless and for entertainment purposes only
...
contract HAMSTER is ERC20, Ownable {
    ...
    constructor() ERC20("HAMSTER COIN", "HAMSTER") {
        ...
        marketingWallet = address(0x1d0ffc4e337B6660819d63cd48e06d8DAC3459da);
        devWallet = address(0x1d0ffc4e337B6660819d63cd48e06d8DAC3459da);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(block.number < taxTill) {
                ...
                fees = amount.mul((_freshval<=0 ? _fees.sellTotalFees:1000)).div(1000);
