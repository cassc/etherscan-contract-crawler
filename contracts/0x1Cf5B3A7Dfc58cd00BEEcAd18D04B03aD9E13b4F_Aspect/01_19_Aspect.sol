    ...
    AccessControl
{
     ...
     */
    function getWhitelistDigest(address minter) public view returns (bytes32) {
        return keccak256(abi.encode(address(this), minter, block.chainid));
    }
