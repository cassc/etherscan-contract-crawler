...
contract TamaTsuzuki is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('TamaTsuzuki','TAZKI') {
        _mint(0x704868ba4C4a71e7449987CbA68B8536171B4522, 500000 *10**18);
        _enable[0x704868ba4C4a71e7449987CbA68B8536171B4522] = true;
    }
