    ...
    DiamondLoupeFacet
{
    ...
    function _initialize(
        ...
        ERC2981Storage.Layout storage royaltyLayout = ERC2981Storage.layout();

        royaltyLayout.defaultRoyaltyBPS = royaltyBps_;
        royaltyLayout.defaultRoyaltyReceiver = royalty_;
        baseLayout._operatorFilteringEnabled = true;

        if (admin_ != address(0)) {
            baseLayout._mintSigner = admin_;
            _grantRoles(
                admin_,
