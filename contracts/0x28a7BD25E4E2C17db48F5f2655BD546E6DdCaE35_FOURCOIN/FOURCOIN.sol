...
contract FOURCOIN is ERC20, Ownable {
    ...
    constructor() ERC20(" FOUR", " Four Coin ") {
        ...
        uint256 totalSupply = 4444444444444 * 10**decimals();
    ...
    function fourcoinnFees (uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
