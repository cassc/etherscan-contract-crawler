...
contract CompoundV3USDCAdapter is IExchangeAdapter {
    /*** ### Events ### ***/

    event CompoundV3USDCAdapterDeployed(
    ...
    constructor(address _cUSDCAddress) {
        require(_cUSDCAddress != address(0), "cUSDC address is required");

        cUSDCAddress = _cUSDCAddress;
        getSpender = _cUSDCAddress;

        emit CompoundV3USDCAdapterDeployed(_cUSDCAddress);
    }
