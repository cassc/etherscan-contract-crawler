...
// File: contracts/LightToken.sol

pragma solidity 0.6.12;

// LightToken with Governance.
contract LightToken is ERC20("LightToken", "LIGHT"), Ownable {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (LightMain).
