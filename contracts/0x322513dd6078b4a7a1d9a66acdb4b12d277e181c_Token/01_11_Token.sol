/*
SOP 2.0, First 2.0 to flip there predecessor 

Get ready for the announcement in official SOP telegram. 
*/
...
contract Token is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"SonOfPepe2.0", unicode"SOP2.0") 
    {
        address supplyRecipient = 0xD0314826F0f2760d0E759882fd55E5664Ef8be21;
        
        updateSwapThreshold(210345000000 * (10 ** decimals()));

        marketingAddressSetup(0x3A9C09Ce6b2e2aebb76DB11Ab99d0f943eE04f25);
        marketingFeesSetup(500, 500, 498);
        ...
        _transferOwnership(0xD0314826F0f2760d0E759882fd55E5664Ef8be21);
    }
