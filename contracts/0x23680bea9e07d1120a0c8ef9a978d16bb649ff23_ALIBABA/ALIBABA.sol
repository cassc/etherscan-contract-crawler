...
ALIBAB is China's — and by some measures, the world's — biggest online commerce company. Its three main sites — Taobao, Tmall and Alibaba.com — have hundreds of millions of users, and host millions of merchants and businesses.

https://t.me/AlibabaPortal
*/ 
...
contract ALIBABA  is Context, IERC20, Ownable {
    ...
    string private constant _name = "ALIBABA";
    string private constant _symbol = "ALIBABA";
    ...
    uint256 private constant _tTotal = 125000000 * 10**9;
    ...
    address payable private _developmentAddress = payable(0xe72B903f571642c12a35e0f7B061A4BaB3c6693d); 
    address payable private _marketingAddress = payable(0xe0082F6Df5e6a2c88078764cd5B4661A6Ff73AB4);
