...
// File: contracts/arrestedTateJailClub.sol

pragma solidity ^0.8.4;

contract ArrestedTateJailClub is ERC721A, Ownable {

    using Strings for uint256;

    string public baseURI = "https://arrestedtatejailclub.s3.amazonaws.com/metadata/";
    ...
    constructor() ERC721A("Arrested Tate Jail Club", "TATEJAIL") {
        _mint(msg.sender, 1);
    }
    ...
    function mintPublic(uint256 _amount) external payable {
        ...
        require(_amount <= maxPerTx, "You can only mint a max of 20 per transaction.");
