...
contract ConvexStrategyMainnet_OUSD is ConvexStrategyUL_V2 {
  ...
  function initializeStrategy(
    ...
    address underlying = address(0x87650D7bbfC3A9F10587d7778206671719d9910D); // Info -> LP Token address
    address rewardPool = address(0x7D536a737C13561e0D2Decf1152a653B4e615158); // Info -> Rewards contract address
    ...
    ConvexStrategyUL_V2.initializeBaseStrategy(
      ...
      56,  // Pool id: Info -> Rewards contract address -> read -> pid
      dai, // depositToken
