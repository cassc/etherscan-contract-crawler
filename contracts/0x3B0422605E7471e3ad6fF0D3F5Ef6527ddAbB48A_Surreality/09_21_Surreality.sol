...
contract Surreality is IQF, Ownable, RevokableDefaultOperatorFilterer, ERC721 {
    ...
    // URI
    string public baseURI = "https://static.wild.xyz/tokens/1116/metadata/";
    ...
    constructor(address _minter) ERC721("Surreality", "SURREALITY") {
        minter = _minter;
    }
