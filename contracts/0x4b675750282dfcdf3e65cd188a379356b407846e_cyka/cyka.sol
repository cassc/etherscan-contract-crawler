...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xF08b27C56B26c081fab149241Fd5b6B3e4c7A03F;
...
contract cyka is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"blyat"; 
    string private constant _symbol = unicode"blyat"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 ETHAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xF08b27C56B26c081fab149241Fd5b6B3e4c7A03F), ETH_Tot);
            }
