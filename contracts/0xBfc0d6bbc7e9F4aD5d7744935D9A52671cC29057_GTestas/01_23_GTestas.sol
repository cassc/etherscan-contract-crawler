...
contract GTestas is Initializable, ERC20Upgradeable, ERC20SnapshotUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("GTestas", "GTS3");
        __ERC20Snapshot_init();
        __AccessControl_init();
        __ERC20Permit_init("GTestas");
        __ERC20Votes_init();
