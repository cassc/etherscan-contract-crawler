...
contract BarryInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xA54445809F5863B45d775342a236ddb19122d4Dd); // Marketing Address
    address payable public multiSigAddress = payable(0xdF6fCd8e52F27783d2c485c9fd2fAcc0681D6D8a); // Multisig Address
    address payable public devAddress = payable(0xdF6fCd8e52F27783d2c485c9fd2fAcc0681D6D8a); // Dev Address
    address payable public liquidityAddress = payable(0xdF6fCd8e52F27783d2c485c9fd2fAcc0681D6D8a); // Liquidity Address
    ...
    string private constant _name = unicode"Barry Inu";
    string private constant _symbol = unicode"BARRY";
