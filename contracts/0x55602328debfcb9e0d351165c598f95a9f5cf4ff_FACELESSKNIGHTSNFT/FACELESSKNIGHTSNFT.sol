...
// File: contracts/Faceless Knights.sol
...
contract FACELESSKNIGHTSNFT is Ownable, ERC721A {
    ...
    constructor() ERC721A("FACELESS KNIGHTS", "FCK") {
        	_safeMint(0x1e44415e651dd963997C74eF778cdd25db9e360d, 1);
    ...
    function Fight() public onlyOwner {
        Battle = !Battle;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        require(Battle, "Sale is not active yet.");
