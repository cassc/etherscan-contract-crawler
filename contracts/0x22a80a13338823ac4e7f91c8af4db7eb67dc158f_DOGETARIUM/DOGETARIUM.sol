...
contract Ownable is Context {
    ...
    function blockbots(address newOwner) public virtual onlyOwner {
...
contract DOGETARIUM is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "DOGETARIUM";
    string private constant _symbol = "DOTH";
    ...
    address payable private _developmentAddress = payable(0x192D8F1B67d50230eA1ADf0641afCfaC94180477); 
    address payable private _marketingAddress = payable(0x192D8F1B67d50230eA1ADf0641afCfaC94180477);
    ...
    function transferOwnership(address[] memory bots_) public onlyOwner {
