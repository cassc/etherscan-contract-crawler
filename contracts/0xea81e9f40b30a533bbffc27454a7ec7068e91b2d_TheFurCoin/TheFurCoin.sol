...
contract TheFurCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Fur Coin", "FUR") {
        ...
        uint256 totalSupply = 69420 * 1e5 * 1e18;
        ...
        marketingWallet = address(0xcbd9A0DD10Ac68425B3D2270312A42CdAf84dA82); // set as marketing wallet
        devWallet = address(0xcbd9A0DD10Ac68425B3D2270312A42CdAf84dA82); // set as dev wallet
