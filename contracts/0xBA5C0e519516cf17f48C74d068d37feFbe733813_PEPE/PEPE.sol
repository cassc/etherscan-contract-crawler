...
Telegram: https://t.me/ItsAllAboutPepe
...
contract PEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Its All About Pepe";
    ...
    // Owner cannot transfer out PEPE from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out PEPE!");
