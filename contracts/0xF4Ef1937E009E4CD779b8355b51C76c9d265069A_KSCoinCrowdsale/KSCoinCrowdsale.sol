...
contract KSCoinCrowdsale is Ownable, Pausable {
    ...
    uint256 public individualCap = 1000000000;
    ...
    receive() external payable whenNotPaused {
        ...
        _preValidatePurchase(weiAmount, msg.sender);
    ...
    function _preValidatePurchase(uint256 weiAmount, address beneficiary) internal view {
        require(weiAmount != 0, "Wei amount is 0");
        require(weiAmount >= 1e15, "Wei amount is less than 0.001 Ether"); // Modification here
        ...
        require(contributions[beneficiary] + _getTokenAmount(weiAmount) <= individualCap, "Individual cap exceeded");
    }
    ...
    function adjustIndividualCap(uint256 newCap) external onlyOwner {
