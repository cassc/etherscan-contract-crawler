...
// It's '23. Jordan Year. The GOAT. Start It Right.
// Telegram: @jordanyear23
...
contract jordan is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jordan Year";
    string private constant _symbol = "23";
    ...
    address payable private _developmentAddress = payable(0xf2Fb92D099F2CdCe0d1778B5625eEcD5E508Cc9e); 
    address payable private _marketingAddress = payable(0xf2Fb92D099F2CdCe0d1778B5625eEcD5E508Cc9e);
    ...
    uint256 public _maxTxAmount = 230001 * 10**9; 
    uint256 public _maxWalletSize = 230001 * 10**9; 
