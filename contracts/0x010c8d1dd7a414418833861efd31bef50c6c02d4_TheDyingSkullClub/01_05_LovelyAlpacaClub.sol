...
contract TheDyingSkullClub is ERC721A, Ownable {
    uint256 public MaxPerTxn = 15;
    uint256 public MaxFreePerWallet = 5;
    bool public mintEnabled = false;
    uint256 public maxSupply = 5555;
    uint256 public price = 0.002 ether;
    string public baseURI = "ipfs://TheDyingSkullClub/";
    mapping(address => bool) public wlAddress;

    constructor(address[] memory _address) ERC721A("TheDyingSkullClub", "TDSC") {
