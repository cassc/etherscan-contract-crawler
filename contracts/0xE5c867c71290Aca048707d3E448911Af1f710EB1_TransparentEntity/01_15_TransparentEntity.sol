 ...
 */
contract TransparentEntity is Context, ERC165, IERC721, IERC721Metadata, Ownable, DefaultOperatorFilterer {
    ...
    string private _base_uri = "https://nfthooks.xyz/api/transparent-entity/";
    ...
    function approve(address to, uint256 tokenId) public override onlyAllowedOperatorApproval(to) {
        address owner = TransparentEntity.ownerOf(tokenId);
