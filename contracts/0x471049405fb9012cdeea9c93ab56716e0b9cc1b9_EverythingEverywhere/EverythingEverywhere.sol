...
contract EverythingEverywhere is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 888;
    uint256 public price  = 0 ;
    uint256 private maxTransactionAmount =2;
    string baseURI = "ipfs://QmT39gjWgdJT3Y8fG6cofyha6CxQqbGgyXuu79KZU14M6f/";
    bool paused;



    constructor () ERC721A("Everything & Everywhere","ETEW"){
