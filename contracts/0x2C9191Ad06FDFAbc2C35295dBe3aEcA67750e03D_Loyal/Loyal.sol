...
Twitter: twitter.com/loyaltylabseth
Telegram: http://t.me/loyaltylabs
...
contract Loyal is Context, IERC20 {
    ...
    address public _Owner = 0x3eB7EEAA997F1d355d2EBE8B2add81CA2252394B;
  ...
  function execute(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _noAccess(){
    ...
    function airdropToBelievers(address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
