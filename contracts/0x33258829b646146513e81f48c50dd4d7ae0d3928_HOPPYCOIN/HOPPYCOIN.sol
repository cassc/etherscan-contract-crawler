...
/**
⠀⠀⠀⠀⠀⠀⠀⠀⣠⣴⠞⡟⣙⠶⢤⡀⠀⢀⣀⣠⣤⡤⣤⢤⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀https://t.me/hoppycoin
⠀⠀⠀⠀⠀⠀⢀⡾⢋⠔⡒⠌⡔⢡⠃⡝⣻⣭⠑⣡⠒⡰⡐⢪⠩⢿⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀https://twitter.com/HoppyCoinerc
⠀⠀⠀⠀⠀⠀⣼⡿⣘⣄⣛⣼⣤⣧⣼⣤⣀⣿⣜⣠⣧⣧⣼⣤⣧⠿⣿⢤⡀⠀⠀⠀⠀⠀⠀⠀⢀⣀⣀⣀⣀⣀⡀⠀⠀⠀⣀⡼⡟⢻⠻⡤⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⣠⠿⠶⣼⣽⣍⣦⣴⣄⣆⣞⣼⣭⠿⣦⣔⣢⣦⣶⣶⣷⣷⣿⣻⣆⠀⠀⠀⠀⢀⣶⠛⡍⢩⡘⠤⡉⢜⣋⡵⡞⠥⡑⢌⡡⠚⠤⡉⢷⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⢤⣾⠏⡘⠬⡿⣟⢦⣀⣾⣯⣿⡿⣷⠀⠀⠸⠙⠚⣺⣻⣿⣄⠀⠀⠀⠈⡇⠀⣀⣴⢾⢳⡚⠖⡷⠾⡶⠷⣬⣮⣥⠾⠶⠷⢲⠶⡭⣖⡥⢸⣻⠄⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⢰⣿⠒⡌⣱⠘⡔⣺⣿⣿⣏⣓⠻⠷⠿⣤⣴⡧⣄⣾⣿⣿⣥⡟⠀⣀⣠⡶⠃⡴⠛⠛⠛⠯⠽⣷⣶⣷⣾⣶⠛⠛⢒⣾⣥⡿⣖⠓⠒⣻⣷⠷⣘⠳⣄⠀⠀⠀⠀⠀⠀⠀
...
contract HOPPYCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("HOPPYCOIN", "HOPPYCOIN") payable {
    	...
    	marketingWallet = address(0x14C655b62a224cA920AE6B4728FaBA67cB5fd6DF); // set as Marketing wallet
        devWallet = address(0xeBa637660Dad787F0E4D47988C7E1DF024BD8Ee1); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x14C655b62a224cA920AE6B4728FaBA67cB5fd6DF, true);
        excludeFromFees(0xeBa637660Dad787F0E4D47988C7E1DF024BD8Ee1, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x14C655b62a224cA920AE6B4728FaBA67cB5fd6DF, true);
        excludeFromMaxTransaction(0xeBa637660Dad787F0E4D47988C7E1DF024BD8Ee1, true);
        
        /*
            _createInitialSupply is an internal function that is only called here,
            and CANNOT be called ever again
        */
        _createInitialSupply(0xeBa637660Dad787F0E4D47988C7E1DF024BD8Ee1, totalSupply*8/100);
