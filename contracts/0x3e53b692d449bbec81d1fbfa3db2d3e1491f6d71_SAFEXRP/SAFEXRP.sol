...
//https://safexrp.net/
//https://twitter.com/SafeXrpETH
//https://t.me/SafeXrpETH
...
contract SAFEXRP is IERC20, Ownable {
    using SafeMath for uint256;

    using Address for address payable;
    string private constant _name = "SAFE XRP";
    string private constant _symbol = "SAFEXRP";
    uint8 private constant _decimals = 9;
    uint256 private _totalSupply = 1_000_000_000 * 10**_decimals;
    uint256 private  _maxWallet = 30_000_000 * 10**_decimals;
    uint256 private  _maxBuyAmount = 30_000_000 * 10**_decimals;
    uint256 private  _maxSellAmount = 30_000_000 * 10**_decimals;
    ...
    address private projectE = 0x4B90a0649805b9C2f55E32bd9BB3EaB04131cd45;
    address private teamW = 0xb699EB541A31F3A51A574544be0A8d21E9fd1f9c;
    ...
    constructor(address hold_1,address hold_2) {
        ...
        uint256 Lteam = _totalSupply.mul(5).div(100);
    
        _balances[msg.sender] = tsupply - Rteam - Lteam;
