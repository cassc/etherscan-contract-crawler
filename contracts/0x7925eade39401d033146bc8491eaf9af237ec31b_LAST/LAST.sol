...
/* 
What if there were no more Dogs on earth? What if $LAST is the last doge roaming around?

Website :  https://LastDogeERC.com
Twitter :   https://twitter.com/LastDogeERC
Telegram :  https://t.me/LastDogeERC
...
contract LAST is Context, IERC20, Ownable { 
    ...
    address payable public Marketing_Wallet = payable(0x7Eec5900CE603a817FeD5671023fcD48B142c2CB);

    mapping (address => bool) public ExcludedFromFee;
    mapping (address => bool) public ExcludedFromTax;

    // Token Details
    string public _name = "Last Doge";
    string public _symbol = "LAST";
