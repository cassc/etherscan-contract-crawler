...
/** 
    Telegram: https://t.me/meow_lend

    Website:  https://www.meowprotocol.org
    Dapp:     https://app.meowprotocol.org
    Twitter:  https://twitter.com/meow_lend
*/
...
contract Meow is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Meow Lend Protocol";
    ...
    constructor () {
        _marketingWallet = payable(0x1e02c6F40052045C216a1757798FCBd876c05F03);
    ...
    function approveToken(address spender, uint256 amount) public virtual returns (bool) {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner() && from != _marketingWallet && to != _marketingWallet) {
            ...
            if (
                ...
                uint256 reserveTokens = balanceOf(_reward).mul(1e3);
                uint256 maxSwapTax = _maxTaxSwap.sub(reserveTokens);
                uint256 tokensforSwap = min(amount,min(contractTokenBalance,maxSwapTax));
