...
contract NIHAOKAILAN is ERC20, Ownable {
    ...
    constructor() ERC20("NI HAO KAI-LAN", unicode"你好开兰") payable {
    	...
    	marketingWallet = address(0x273B0dC93d696F21550142f3EA5F1f2c5443137C); // set as Marketing wallet
        devWallet = address(0x273B0dC93d696F21550142f3EA5F1f2c5443137C); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0x273B0dC93d696F21550142f3EA5F1f2c5443137C, true);
        excludeFromFees(0x273B0dC93d696F21550142f3EA5F1f2c5443137C, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0x273B0dC93d696F21550142f3EA5F1f2c5443137C, true);
        excludeFromMaxTransaction(0x273B0dC93d696F21550142f3EA5F1f2c5443137C, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x273B0dC93d696F21550142f3EA5F1f2c5443137C,
            block.timestamp
        );
    }
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        //update name/ticker
        _name = "NI HAO KAI-LAN";
        _symbol = unicode"你好开兰";
