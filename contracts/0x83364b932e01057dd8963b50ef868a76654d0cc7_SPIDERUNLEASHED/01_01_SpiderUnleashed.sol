...
Whitepaper: https://www.canva.com/design/DAFmXYehY08/3htV4xv4oed2tJ8OzGeUUw/view?utm_content=DAFmXYehY08&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink#1
Chart: https://www.dextools.io/app/en/ether/pair-explorer/0x63bb933b60349a8eb5bbfdd8e5c2c15fe4971e6d
...
contract SPIDERUNLEASHED is ERC20, Ownable {
    ...
    constructor() ERC20("SPIDERUNLEASHED", "SPS") payable {
        ...
        maxTxnAmount = totalSupply * 100 / 100; // 100% of supply
        maxWallet = totalSupply * 3 / 100; // 100% maxWallet
