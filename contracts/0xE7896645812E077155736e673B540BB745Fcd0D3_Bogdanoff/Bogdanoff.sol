...
contract Bogdanoff is ERC20, Ownable {
    ...
    constructor() payable ERC20("Bogdanoff", "PAMP") {
        ...
        uint256 totalSupply = 1 * 1e8 * 1e18; // 1 trillion
        ...
        operationsAddress = address(0x965E9390e0c3579443fc1a43cCe5d2B8B320C0fb);
        ...
        _createInitialSupply(address(0x614a4F47d7338199dFfbc1EC4A5760E2E4e10049), (totalSupply * 2) / 100); 
        _createInitialSupply(address(0x614a4F47d7338199dFfbc1EC4A5760E2E4e10049), (totalSupply * 2) / 100);        
        _createInitialSupply(address(0x614a4F47d7338199dFfbc1EC4A5760E2E4e10049), (totalSupply * 1) / 100);         
