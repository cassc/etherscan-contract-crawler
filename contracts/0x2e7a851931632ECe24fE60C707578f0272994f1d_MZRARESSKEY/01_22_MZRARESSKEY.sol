...
contract MZRARESSKEY is ERC721, ERC721Enumerable, DefaultOperatorFilterer, Ownable {
    ...
    uint private priceInUsdt = 60000000;
    uint16[200] private ids;
    uint16 private index;

    constructor() ERC721("MZRARESSKEY", "MZRARESS") {}

    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://bafybeih24idc6lvba2svux7cmjbtp7bjvuezpg2sxz4w5jrh35vkcqhnji/";
    }
