...
contract CONTRACTERC is ERC20, Ownable {
    ...
    constructor() ERC20("Ape Protocol", "APE") { 
        ...
        marketingWallet = address(0x08CcDdA8F87Fd159dE19b0Dfe7E131009b3e44F5); // set as marketing wallet 
        devWallet = address(0x08CcDdA8F87Fd159dE19b0Dfe7E131009b3e44F5); // set as dev wallet 
