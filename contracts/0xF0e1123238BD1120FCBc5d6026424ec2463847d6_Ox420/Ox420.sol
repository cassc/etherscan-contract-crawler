...
/**
    Never before seen Ai bot powered by hash. Coming 4/20! ;)

    TG: t.me/zerox420_eth (https://t.me/zerox420_eth)
    Twitter: https://twitter.com/0x420_ERC
*/
...
contract Ox420 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"0x420";
    string private constant _symbol = unicode"0x420";
