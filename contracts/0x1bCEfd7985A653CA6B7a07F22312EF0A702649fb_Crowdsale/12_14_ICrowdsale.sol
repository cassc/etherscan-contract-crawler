...
interface ICrowdsale {
    ...
    /**
     * @notice Updates start block for a tranche
     * @param trancheNumber number of a tranche to be updated
     * @param newStartBlock new start block
     */
    function updateTrancheStartBlock(uint256 trancheNumber, uint256 newStartBlock) external;
}