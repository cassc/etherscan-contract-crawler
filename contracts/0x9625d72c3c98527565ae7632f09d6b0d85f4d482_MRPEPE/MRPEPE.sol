...
contract MRPEPE is Context, IERC20, Ownable {
    ...
    bool public isMrPepeTradingOpen = false;
...
//============== Owner Functions ===========//
    ...
    function setMrPepeTradingOpen(bool _isTradingOpen) external onlyOwner {
        isMrPepeTradingOpen = _isTradingOpen;
...
// ========================================//. 
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        require(isMrPepeTradingOpen || from == owner() || to == owner(), "MrPepe Trading is not enabled yet");
