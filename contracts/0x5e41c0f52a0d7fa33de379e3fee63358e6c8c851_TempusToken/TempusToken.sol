...
// Root file: contracts/TempusToken.sol
...
contract TempusToken is ERC20, Ownable {
    ...
    modifier onlyPauser() {
        require(pauser == _msgSender(), "TempusToken: caller is not the pauser.");
        _;
    }

    modifier onlyStakingContract() {
        require(stakingContract == _msgSender(), "TempusToken: caller is not the staking contract.");
        _;
    }
    ...
    ) public Ownable() ERC20("Tempus Token", "TEMP") {
    ...
    function _beforeTokenTransfer(
        ...
        require(!paused || msg.sender == pauser, "TempusToken: token transfer while paused and not pauser role.");
    }
    ...
    function _internalBurn(uint256 amount) internal onlyStakingContract {
    ...
    function _transferReward(address to, uint256 amount) internal onlyStakingContract {
