...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0x502b65CBc776B0AdEF15EdB74A800d18870D91dF];
  address[] public surchargePayableAddresses = [RAMPPADDRESS];
  address public erc20Payable = 0x502b65CBc776B0AdEF15EdB74A800d18870D91dF;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://api.wehatedegens.com/";
...
// File: contracts/WeHateDegensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WeHateDegensContract is RamppERC721A {
    constructor() RamppERC721A("We Hate Degens", "WHD"){}
}