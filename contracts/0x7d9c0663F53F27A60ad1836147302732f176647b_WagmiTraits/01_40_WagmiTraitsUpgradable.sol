...
contract WagmiTraits is Initializable, UUPSUpgradeable, ERC1155Upgradeable, ERC2981Upgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, DefaultOperatorFiltererUpgradeable {
    ...
    nonReentrant
    {
        ...
        for (uint256 i = 0; i < _traits.length; ++i) { 
            _mint(msg.sender, _traits[i].traitId, _traits[i].amount, "");
        }
