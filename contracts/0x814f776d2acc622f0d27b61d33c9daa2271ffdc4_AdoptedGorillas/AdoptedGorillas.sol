...
contract AdoptedGorillas is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 888;
    uint256 public price  = 0 ;
    uint256 private maxTransactionAmount =2;
    string baseURI = "ipfs://QmQMCb9JY9tJJ2wwwxZL8cjh3y6RBPcgt4AewpZVKNMvop/";
    bool paused;



    constructor () ERC721A("Adopted Gorillas Club","AGC"){
