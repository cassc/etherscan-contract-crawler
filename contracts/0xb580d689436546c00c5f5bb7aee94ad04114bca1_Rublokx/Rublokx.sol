...
/**
https://twitter.com/WatcherGuru/status/1577643927213334528

Russia blocks access to OKX?
No problem, new one coming - RUBLOKX

2% max tx
8% initial tax (1% after 60 buys)
...
contract Rublokx is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rublokx";
    string private constant _symbol = "RUBLOKX";
