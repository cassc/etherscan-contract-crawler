...
contract Gem is Ownable, ERC721A {

    // constants
    uint256 constant MAX_ELEMENTS = 8888;
    uint256 constant MAX_ELEMENTS_TX = 100;
    uint256 constant MAX_FREE_PER_TX = 10;
    uint256 constant PUBLIC_PRICE = 0.005 ether;

    string public baseTokenURI = "ipfs://QmNSW5szaaFc4TjNXB9a8CLpjV2iboptrccuPDYwuoyLyN/";
    bool public paused = false;

    constructor(uint256 maxBatchSize_) ERC721A("100x Gem", "GEM", maxBatchSize_) {}
