...
// File: default_workspace/close mint.sol
...
contract LipsofCrypto is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public maxSupply = 999;
    uint256 public price  = 0 ;
    uint256 private maxTransactionAmount =1;
    string baseURI = "ipfs://QmaFQmEkPiZKmQuDMZp8LQ9vX4MqSwNhdtRPYVCjnEzVwa/";
    bool paused;



    constructor () ERC721A("Lips of Crypto","LOC"){
