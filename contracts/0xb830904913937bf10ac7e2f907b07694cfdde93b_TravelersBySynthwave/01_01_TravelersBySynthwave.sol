...
contract TravelersBySynthwave is Ownable, ERC721A, DefaultOperatorFilterer  {
    ...
    uint256 public publicSaleCost = 0.009 ether;

    uint64 public maxSupply = 500;

    uint64 public publicMaxSupply = 500;
    uint64 public publicTotalSupply = 0;
    uint64 public presaleMaxSupply = 100;
    ...
    constructor() ERC721A("Travelers by Synthwave", "TVLR"){}
