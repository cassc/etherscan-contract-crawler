...
30 August 1974.
The government starts a hidden experiment on 15.000 humans. They are injecting a secret serum into homeless people's blood. 99% of the "LAB RATS" die or are killed by the guardians. However, that 1% is made out of 14 Mutants that are kept in an underground lab, 236km away from NYC.
Miles, a well-known journalist hears about this information and goes to check it out by himself.
NOW, THEY ARE 15 MUTANTS AND THEY DESTROY THE SECRET LAB.
They will go out on the streets and kill everybody they see
ITS YOUR TIME TO KILL THEM.
Much Love,
X.

Chapter 2.
The mutants got Miles and they are heading for DC, they might stop on the way there to get some rest. Ur new mission is to kill them all.
...
-2% Max Buy
-4% Max Wallet
-Mutant NFT collection
-Big Mc for Chapter 1
-1 year lock

Telegram: https://t.me/ProjectX2Erc
Twitter: https://twitter.com/ProjectXErc?s=09
Medium: https://bit.ly/3TpQRk8
Wesite: On the way
NFT Collection: https://opensea.io/collection/projectxerc
...
contract ca  is ERC20, Ownable{
    ...
    address public marketingWallet = 0x10Bff9157363630dcE45beeA3233d99Ad242a008;
    address public devWallet = 0x10Bff9157363630dcE45beeA3233d99Ad242a008;
