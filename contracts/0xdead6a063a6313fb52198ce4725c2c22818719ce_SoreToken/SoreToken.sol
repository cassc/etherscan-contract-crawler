...
/**
When development happens, it is inconvenient for you to post it. 
It is because you don’t post it. 
Your parents say release. It is because you don’t bother.
$Sore 
*/
...
pragma solidity 0.8.8;
contract SoreToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sore Token";
    string private constant _symbol = "Sore";
