...
// Are you ready for the game of fear in the world of Hashima?
// Here, you need to figure everything out on your own, everything
// is in your hands. You can find our Telegram and Discord group links on the MAP. Good luck!
// 試合開始
...
contract HashimaIsland is Context, IERC20, Ownable {
    using SafeMath for uint256;
    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 666_000_000 * 10**_decimals;
    ...
    string private constant _name = unicode"HASHIMA ISLAND";
    string private constant _symbol = unicode"試合開始";

    uint256 public _initialBuyTax=20;
    uint256 public _initialSellTax=25;
