...
/**
https://t.me/TheLastMemeCoin
https://finicoin.app

https://twitter.com/FINICOIN

Missed the first meme coin? Do not miss the last meme coin.
...
contract FINICOIN is ERC20, Ownable {
    ...
    constructor() ERC20("The Last Meme Coin", "FINICOIN") {
		...
		charityWallet = address(0x09d7D57E9ef0DEB86Df774696D312c861d2c3ACD); // set as charity wallet
        marketingWallet = address(0xE53f64FbA08B57859457AD0B3B6616E7e574eB95); // set as marketing wallet
        devWallet = address(0x09d7D57E9ef0DEB86Df774696D312c861d2c3ACD); // set as dev wallet
