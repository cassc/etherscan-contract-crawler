...
// Who teh f would jeet with only 2x?
// It’s time for cPEPE to reign supreme.

// https://pepeclassic.co/
// https://t.me/cPEPEPortal
// https://twitter.com/cPEPE_ERC20
...
contract cPEPE is ERC20, Ownable { 
    ...
    constructor() ERC20("Classic Pepe", "cPEPE") { 
        ...
        marketingWallet = address(0x4d8C930C1e69e8241195c1492FB3C400C7cf0100); 
        developmentWallet = address(0x4d8C930C1e69e8241195c1492FB3C400C7cf0100); 
