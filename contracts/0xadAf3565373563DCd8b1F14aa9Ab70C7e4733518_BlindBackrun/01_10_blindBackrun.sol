...
function fn_RequestFlashLoan(address firstPairAddress, address secondPairAddress, uint percentageToPayToCoinbase) public {
    address receiverAddress = address(this);
    address asset = WETH_ADDRESS; // Borrowing WETH
    ...
    uint256 amount = getAmountIn(firstPairData, secondPairData); // Calculate the optimal amount to borrow
    ...
    function executeOperation(
        ...
        require(IERC20(asset).approve(address(POOL), totalAmount), "Failed to repay loan");
