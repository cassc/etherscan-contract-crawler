...
About #GMEDEFI
No social, do you know the stock "GME" and how it doing lately? 
If you do know, you will understand. I make this token and give it to the free world, to the "GME" community. 
You can make GameStopToken a "GME" in the DEFI crypto world!
...
-0.1 Ether add to the pool
-10% team reserve tokens
-4% tx fee distribute to all token holders

-10000000 total supply
-100000 max tokens per transaction

-Lock the liquidity at 14:00 27 Jan 2021 UTC
-Renounce the ownership to burn address at 16:00 27 Jan 2021 UTC
...
contract GameStopToken is Context, IERC20, Ownable {
    ...
    string private _name = 'GameStop Defi Token';
    string private _symbol = 'GMEDEFI';
