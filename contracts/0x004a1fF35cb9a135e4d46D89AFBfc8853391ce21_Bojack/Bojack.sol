...
/**
Telegram: https://t.me/BojackOnEth
Website:  https://bojackoneth.com/#
Twitter:  https://twitter.com/BojackOnEth
**/
...
contract Bojack is ERC20, Ownable {
    ...
    constructor() ERC20("Bojack Coin", "Bojack") {
        ...
        uint256 _buyOpsFee = 2;
        
        // launch sell fees
        uint256 _sellMarketingFee = 5;
        uint256 _sellLiquidityFee = 0;
        uint256 _sellDevFee = 45;
        uint256 _sellOpsFee = 45;

        uint256 totalSupply = 69_420_000_000 * 1e18;

        maxTxn = 1_388_400_000 * 1e18; // 2% max transaction at launch
        maxWallet = 1_388_400_000 * 1e18; // 2% max wallet at launch
        ...
        marketingWallet = address(0x7cf672c4Ae278820fe0a193c3Dea1081dC34185D); 
        devWallet = address(0x06aA6E9b1FE007797403a70CACDd96F2a0491e7b); 
        liquidityWallet = address(0x7cf672c4Ae278820fe0a193c3Dea1081dC34185D); 
        opsWallet = address(0xE4526006910be92E5138d20D4f7701337ACB788C);
