...
contract shiktosa is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIKTOSA INU";
    string private constant _symbol = "SHIKTOSA";
