...
Telegram: https://t.me/SuperMemeParty
Twitter: https://twitter.com/SuperMemeParty
...
contract SuperMemeParty is IERC20, Ownable {
    using Address for address;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Super Meme Party";
    string constant _symbol = "PARTY";
    ...
    function update() external onlyTeam {
        launchedAt = block.number;
        launchedTime = block.timestamp;
        swapEnabled = true;
        ...
        _maxBuyTxAmount =  2500000 * 1e18;
        _maxWalletSize =  2500000 * 1e18;
    }
