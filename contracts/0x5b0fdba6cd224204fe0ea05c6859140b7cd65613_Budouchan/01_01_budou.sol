...
contract Budouchan is ERC1155, ERC2981, Ownable, ReentrancyGuard {
    ...
    constructor() ERC1155("") {
        setOptions(
            0,
            "https://arweave.net/vLyD90TOigF9TCYQGen7Ab1C-y01gi0YuRhf09mGdvc/budou.json",
            300,
            3,
            true,
            3000000000000000,
    ...
    function _beforeTokenTransfer(
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            ...
            require(from == address(0) || to == address(0) || from == owner() || lock[tokenId] == false, "Token is soulbound");
        }
    }

    function setApprovalForAll(address operator, bool approved) public override {
        require(sbt == false, "Not Allowed to set approval");
    ...
    function withdraw() external onlyOwner {
        ...
        address founder = payable(0xeE355f5A154Fe3D3727999520963A3276Bf9A2b3);
        bool success;
