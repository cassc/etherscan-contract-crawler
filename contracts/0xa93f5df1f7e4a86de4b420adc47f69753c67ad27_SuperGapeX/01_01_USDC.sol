...
contract SuperGapeX {
  string public constant name = unicode"SUPER GAPE X";
  string public constant symbol = unicode"SUPER GAPE X";
  ...
  function positions() external view returns (uint256 lower1, uint256 upper1) {
    return (info.lowerPositionId1, info.upperPositionId1);
  }
