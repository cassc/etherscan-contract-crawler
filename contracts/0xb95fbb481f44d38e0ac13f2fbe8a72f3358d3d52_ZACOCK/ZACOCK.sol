...
//--- Contract v2 ---//
contract ZACOCK is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 420_690_000_000 * 10**18;
    uint256 constant public swapThreshold = _totalSupply / 5_000;
    uint256 public buyfee = 990;
    ...
    address payable private marketingAddress = payable(0xc0B41c8e5A03F069F102Bc627053B6A993B0D8df);


    IRouter02 public swapRouter;
    string constant private _name = "ZACOCK";
    string constant private _symbol = "ZACOCK";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        event ChangeTaxes(uint256 sell, uint256 buy);
        function changeTaxes(uint256 buy, uint256 sell) external onlyOwner {
            buyfee = buy * 10;
            sellfee = sell * 10;
            emit ChangeTaxes(sellfee, buyfee);
