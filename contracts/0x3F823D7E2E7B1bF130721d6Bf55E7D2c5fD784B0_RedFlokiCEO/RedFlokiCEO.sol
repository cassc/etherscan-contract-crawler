...
contract RedFlokiCEO is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_00_000_000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 200_0 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xF403536c5f5965905FDea54e85aB3D71f68bd82C;

    string private constant _name = "Red Floki CEO";
    string private constant _symbol = "RedFlokiCEO";
