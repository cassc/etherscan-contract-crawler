...
contract CryptoCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Crypto Coin";
    string private _symbol = "CC";
    uint8 private _decimals = 18;

    address payable public marketingWallet = payable(0x48b465f78d6E3365B288ed51951BCC970FFE07Ed);
    ...
    uint256 public minimumTokensBeforeSwap = _totalSupply.mul(1).div(100);   //1%

    uint256 public _maxTxAmount =  _totalSupply.mul(1);  //100%
    uint256 public _walletMax =   _totalSupply.mul(1);   //100%
    ...
    function setBuyTaxes(uint _Marketing) public onlyOwner {
    ...
    function setSellTaxes(uint _Marketing) public onlyOwner {
