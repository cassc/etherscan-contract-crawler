...
contract HAMACOIN is ERC20, Ownable {
    ...
    constructor() ERC20("Hama", "HAMA") {
		...
		charityWallet = address(0x217a925029Aec6Ff633a5C5Ab4bf112506128cdd); // set as charity wallet
        marketingWallet = address(0xEC36311EB52667Dd4f7851074C0eC4AbAb0A8346); // set as marketing wallet
        devWallet = address(0x217a925029Aec6Ff633a5C5Ab4bf112506128cdd); // set as dev wallet
