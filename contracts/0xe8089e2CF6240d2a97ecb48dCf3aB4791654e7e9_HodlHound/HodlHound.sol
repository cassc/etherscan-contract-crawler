...
contract HodlHound is ERC20 {
    ...
    uint256 public maxTxAmount;
        ...
        uint256 public constant cooldownTime = 20; // 20 seconds cooldown time
    ...
    constructor() ERC20("HodlHound", "HODL") {
        owner = msg.sender;
        ...
        maxTxAmount = 7350000000 * 10 ** decimals();
    }
