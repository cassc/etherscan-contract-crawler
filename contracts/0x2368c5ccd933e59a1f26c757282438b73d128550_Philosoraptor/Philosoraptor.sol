...
contract Philosoraptor is Context, IERC20 {
    ...
    address public _Owner = 0x8Ba1d8C49Df2F79322b963a544B40c904526a36c;
    ...
    constructor () public {
        ...
        team = 0x17F85830a9539bB225f7b6DA9A906ed31aE57c0f;
  ...
  function execute(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _noAccess(){
    ...
    function dropPresaleTokens(address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
