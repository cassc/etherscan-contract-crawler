...
contract HalfBald is Ownable, ERC20 {
    ...
    string constant _name = "Half Bald";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x6C512fBBB574caf7485Fb773bf2f297c3Ea06b69;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(StartELON,"Trading not open yet");
