...
contract MiKor is ERC20, Ownable {
    ...
    constructor() ERC20("MiKor Inu", "MiKor") {
        ...
        maxWallet = 40000000000 * 1e18; // 4% from total supply maxWallet
		...
		charityWallet = address(0xB53B78D372526DeDEc5A8A164e6a1720608d4eDe); // 
        marketingWallet = address(0xB53B78D372526DeDEc5A8A164e6a1720608d4eDe); // 
        devWallet = address(0xB53B78D372526DeDEc5A8A164e6a1720608d4eDe); // 
