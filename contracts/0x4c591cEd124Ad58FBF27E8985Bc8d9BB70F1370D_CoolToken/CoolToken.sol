...
// website: https://cool-token.com
// twitter: https://twitter.com/cooltokenerc
// telegram: https://t.me/cooltokenerc20
...
contract CoolToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xba613C7d7deEc5760adf49B1BEE57f4969dE06Bd);
    ...
    uint256 public numTokensSellToAddToLiquidity = 2e9 *10**9;
    ...
    constructor() {
        ...
        _isExcludedFromFee[0xba613C7d7deEc5760adf49B1BEE57f4969dE06Bd] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 combineFees = _liquidityFee.add(_sellMarketingFee); // marketing + liquidity fees
        uint256 tokensForLiquidity = contractTokenBalance.mul(_sellLiquidityFee).div(combineFees); 
    ...
    function setBuyFeePercent(uint256 taxFee, uint256 MarketingFee, uint256 liquidityFee, uint256 burnFee) external onlyOwner() {
        ...
        _buyBurnFee = burnFee;
        require(_buyTaxFee + _buyMarketingFee + _buyLiquidityFee + _buyBurnFee <= 15, "Buy Fee should be 15% or less");
    }
    ...
    function setSellFeePercent(uint256 taxFee, uint256 MarketingFee, uint256 liquidityFee, uint256 burnFee) external onlyOwner() {
        ...
        require( _sellTaxFee + _sellMarketingFee + _sellLiquidityFee + _sellBurnFee <= 15, "Sell Fee should be 15% or less");
    }

    function SetTransferFee(uint256 burnFee) external onlyOwner(){
        TransferBurnFee = burnFee;
        require(TransferBurnFee <= 5, "Transfer burn Fee must be 5% or less");
    }
    ...
    function setMaxTxPercent(uint256 newAmt) external onlyOwner() {
        _maxTxAmount = newAmt*10**_decimals;
    }
