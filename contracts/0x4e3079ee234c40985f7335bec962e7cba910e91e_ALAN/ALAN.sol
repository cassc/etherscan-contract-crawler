...
contract ALAN is ERC20, Ownable {
    ...
    constructor() ERC20("Alan", "ALAN") {
        ...
        marketingWallet = address(0xA6422b2ee81E9E10447A1DE4F7b8EdE6AFEA3679); // set as marketing wallet
        devWallet = address(0x824a137b581940072411ef2597F090D276287595); // set as dev wallet
