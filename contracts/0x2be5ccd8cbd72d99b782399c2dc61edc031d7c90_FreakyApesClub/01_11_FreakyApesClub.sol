...
contract FreakyApesClub is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

// ================== Variables Start =======================
    
  string public uri = "ipfs://bafybeifcr7jtrcjf5s55k7aa5a52rv2salbupqytzsch5kvou4ql66tkde/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri = "ipfs://QmfGtMM6wQtxwPsDMcNd6TGSuEyo8cyQwm6M1BPKd65obb";
  uint256 public cost1 = 0 ether;
  uint256 public cost2 = 0.001 ether;
  uint256 public supplyLimit = 1200;
