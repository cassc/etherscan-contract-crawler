...
contract SHILLD is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "SHILLD";
    string private _symbol = "SHILLD";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xa3746Ce755C9896A627F975AAE602836A8B7b5Ee); // Marketing Address
