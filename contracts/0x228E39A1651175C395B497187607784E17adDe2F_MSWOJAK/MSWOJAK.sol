...
contract MSWOJAK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Miss Wojak";
    string private constant _symbol = unicode"MSWOJAK";
