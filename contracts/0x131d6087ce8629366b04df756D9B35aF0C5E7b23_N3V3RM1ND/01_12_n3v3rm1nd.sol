...
contract N3V3RM1ND is ERC721A, Ownable, VRFv2DirectFundingConsumer {
    constructor() ERC721A("N3V3RM1ND", "N3V3RM1ND") {
        c0nf16 = C0nf16(3, 3310, 0, 0, false);
    }
    ...
    /**
     * @dev Limit to 1 for each wallet.
     */
    function m1n7() external payable {
        require(c0nf16.ph453 > 0, "n07 1n m1n7 ph453.");
        require(m1n73l161bl3(msg.sender), "n0 3l161bl3");
        require(numb3rm1n73d(msg.sender) == 0, "3xc33d m4xm1um m1n7.");
        require(1 * c0nf16.pr1c3 <= msg.value, "n0 3n0u6h 37h.");
        require(
            totalSupply() < m4xm1n70fph453(),
    ...
    /**
     * @dev Check a address is eligible to mint at phase.
     */
     ...
     */
    function n3x7ph453(uint256 pr1c3) external onlyOwner {
