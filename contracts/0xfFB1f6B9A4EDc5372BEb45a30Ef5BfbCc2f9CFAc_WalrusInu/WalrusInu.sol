...
Token Name: Walrus Inu  ==  Ticker: Tusk


Supply : 1,000,000
Max buy at launch is 0.005 = 5000  


TAX: 5%
3% auto liquidity / 2% marketing wallet 


TeleGram Account: https://t.me/TuskERC20
...
contract WalrusInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "WalrusInu"; //
    string private constant _symbol = "Tusk"; //
    ...
    uint256 private maxWalletAmount = 5001 * 10 ** _decimals;
    uint256 private maxTxAmount = 5001 * 10 ** _decimals; 
    ...
    constructor () {
        ...
        feeAddrWallet = payable(0x2fD55099d66b03EaB611fa69a0772dAb59e344EB); //wallet
