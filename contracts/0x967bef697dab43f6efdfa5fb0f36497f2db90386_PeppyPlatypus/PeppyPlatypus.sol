...
Website: https://peppy-platypus.com/
 ...
 */
contract PeppyPlatypus is ERC20 {
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 6999999996 * 10 ** 18;

    /**
     * @dev Sets the value of the `decimals`. This value is immutable, it can only be
     * set once during construction.
     */
    constructor () ERC20('Peppy Platypus', unicode"PEPPY", _msgSender()) {
