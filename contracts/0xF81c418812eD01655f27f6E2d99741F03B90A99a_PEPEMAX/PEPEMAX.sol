...
https://twitter.com/BlondieSOLIDITY

$PEPEMAX is community owned and run project with the team leader working in the background.

As the original Dev of $KEANU (Keanu Inu)

I can guarantee I have the access to everything you can imagine,however the initial 
push from the community and strong base holders are crucial for the growth of every token.
*/
...
contract PEPEMAX is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Max", "PEPEMAX") {
        ...
        maxTransactionAmount = 1380 * 1e18; // 
        maxWallet = 1380 * 1e18; // 
		...
		charityWallet = address(0xC9161E353057E67447a04B1F0595a3F4C08cAa45); // Charity wallet
        marketingWallet = address(0xC9161E353057E67447a04B1F0595a3F4C08cAa45); // Marketing wallet
        devWallet = address(0xC9161E353057E67447a04B1F0595a3F4C08cAa45); // Developer wallet
