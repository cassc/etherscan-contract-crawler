...
contract DejitaruTsuke is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dejitaru Tsuke", "TSUKE") {
    ...
    function tsukAccount (address account, bool isBlacklisted) public onlyOwner {
