...
contract FatPunks is IERC721A { 
    ...
    string private constant _name = "Fat Punks";
    string private constant _symbol = "FATPUNKS";
    string private _baseURI = "QmNgZajWurtg9kE1BUyAWpewUvgiswsXPFuNvzb4UqCJjs";
    ...
    function freeMint() external noReentrant{
        address _caller = _msgSenderERC721A();
    ...
    function setConfig(uint _MAX_FREE_PER_WALLET, uint _COST) external onlyOwner{
