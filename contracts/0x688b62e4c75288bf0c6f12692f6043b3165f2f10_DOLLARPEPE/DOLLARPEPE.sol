...
Pepe that made it - He was so popular that they decided to put his picture on a dollar.

Initial Liquidity 0.01 ETH

Super cheap start.

2/2 Tax 1% to dev 1% top Auto Liquidity.


Max bag 1%

https://dollarpepevip.com/

https://twitter.com/DollarPepe

https://t.me/DOPEentry
*/
...
contract DOLLARPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("Dollar Pepe", "DOPE") {
        ...
        maxTransactionAmount = 694204 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 694204 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x564071AD5bA7C12DEE26e9cabD062377Fe82c3b0); // set as charity wallet
        marketingWallet = address(0x564071AD5bA7C12DEE26e9cabD062377Fe82c3b0); // set as marketing wallet
        devWallet = address(0x564071AD5bA7C12DEE26e9cabD062377Fe82c3b0); // set as dev wallet
