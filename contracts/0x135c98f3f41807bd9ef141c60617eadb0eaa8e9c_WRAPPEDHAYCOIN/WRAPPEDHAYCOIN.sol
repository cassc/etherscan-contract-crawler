...
WRAPPED HAY - first token to be pegged to $HAYCOIN 
* This token is only tradeable by buying and selling with HAYCOIN at this address 0xfa3e941d1f6b7b10ed84a0c211bfa8aee907965e
...
contract WRAPPEDHAYCOIN is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public HAY = 0xfA3E941D1F6B7b10eD84A0C211bfA8aeE907965e;
    ...
    constructor() ERC20("WRAPPED HAYCOIN", "WHAY") {
        ...
        devWallet = address(0xd821a0EfDa7C6CE52837b566bc0dF13d83C15A6E); 
