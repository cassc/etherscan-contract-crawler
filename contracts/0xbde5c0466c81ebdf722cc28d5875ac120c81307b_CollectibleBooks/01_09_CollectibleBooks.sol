...
contract CollectibleBooks is ERC721A, Ownable, ReentrancyGuard{
...
// ================== Variables Start =======================
  ...
  string public hiddenMetadataUri = "ipfs://bafybeifqn7uztgyscqczy2e53wzdh4wqqmq3xxyvh2m55gotf7btnw7oka/hidden.json";
...
// ================== Constructor Start =======================
  ...
  constructor(
    string memory _uri
  ) ERC721A("Collectible Books", "CBOOK")  {
    seturi(_uri);
  }
