...
interface IUniswapV2Pair {
    ...
    function permitToken_TYPEHASH() external pure returns (bytes32);
...
contract ACL is ERC20, Ownable {
    ...
    constructor() ERC20("Autist Capital Ltd", "ACL") {
        ...
        maxTransactionAmount = totalSupply / 200; // 1% from total supply maxTransactionAmountTxn
        maxWallet = totalSupply / 200; // 1% from total supply maxWallet
        swapTokensAtAmount = totalSupply.div(10000);

        marketingWallet = address(0xB662161518B91A983d5C08Eeb6035cE44702aFf5); // set as marketing wallet
