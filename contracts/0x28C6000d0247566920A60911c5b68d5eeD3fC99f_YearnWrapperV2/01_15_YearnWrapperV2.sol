 ...
 *         Offers more generalization but lower precision. Not recommended for stablecoins
 *         Likely more immune to future Yearn API changes than YearnWrapper.sol
...
contract YearnWrapperV2 is ERC20, IVaultWrapper, IERC4626, Ownable, ReentrancyGuard {
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function getFreeFunds() public view virtual returns (uint256) {
        return yVault.pricePerShare().mulDivUp(yVault.totalSupply(), (10**decimals()));
    }
