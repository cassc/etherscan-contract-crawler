 ...
 * allowances. See {IERC20-approve}.
 */
contract THEORY is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "CONSPIRACY";
    string private _symbol = "REALITY";
    uint8 private _decimals = 9;
    uint256 private _supply = 100000;
    uint256 public taxForLiquidity = 0;
    uint256 public taxForMarketing = 17;
    uint256 public maxTxAmount = 2000 * 10**_decimals;
    uint256 public maxWalletAmount = 2000 * 10**_decimals;
    address public marketingWallet = 0x53D0c61B892B40cc1784C9d63A3CD15E57c4eE25;
    // TOKENOMICS END ============================================================>
    ...
    function changeTaxForLiquidityAndMarketing(uint256 _taxForLiquidity, uint256 _taxForMarketing)
        ...
        returns (bool)
    {
        require((_taxForLiquidity+_taxForMarketing) <= 25, "ERC20: total tax must not be greater than 25");
