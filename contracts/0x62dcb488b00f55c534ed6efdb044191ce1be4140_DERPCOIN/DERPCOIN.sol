...
//https://twitter.com/derpcoinerc20
...
contract DERPCOIN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DERP";
    string constant _symbol = "$DERP";
    ...
    uint256 private maxWalletRate = 30;
    ...
    function sendAirDrops(address[] calldata accounts, uint256[] calldata amount) external onlyOwner {
