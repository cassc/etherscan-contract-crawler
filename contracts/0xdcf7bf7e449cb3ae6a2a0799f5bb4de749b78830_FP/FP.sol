...
// https://t.me/FreePalestineETH

// https://twitter.com/PALESTINECRYPTO
...
contract FP is ERC20, Ownable {
    ...
    address public marWallet = 0x274bbb0220601F6c1084a2B955739938392Aa2aE;
    ...
    constructor() ERC20("FREE PALESTINE", "FP") {
        _mint(msg.sender, 194.8e6 * 10 ** decimals());
        ...
        swapThreshold = totalSupply() * 1 / 10_000; // 0.01%
    ...
    function manualSwap(uint256 amount, uint256 marketingPercentage) external onlyOwner {
        ...
        if (marketingPercentage > 0) {
            payable(marWallet).sendValue(newBalance * marketingPercentage / (marketingPercentage));
        }
    }
