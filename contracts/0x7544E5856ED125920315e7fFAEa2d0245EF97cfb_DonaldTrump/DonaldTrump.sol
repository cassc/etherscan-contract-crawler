...
contract DonaldTrump is Context, IERC20, Ownable {
    ...
    string private constant _name = "Trumps Wish";
    string private constant _symbol = "White House";
    ...
    address payable private _developmentAddress = payable(0x6Ff48f0D78f3c77739D208596C3edbDeA1166EFd); 
    address payable private _marketingAddress = payable(0x6Ff48f0D78f3c77739D208596C3edbDeA1166EFd);
