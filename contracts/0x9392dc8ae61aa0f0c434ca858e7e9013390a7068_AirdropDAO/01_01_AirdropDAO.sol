...
Airdrop DAO token $ADAO


Twitter: @airdropdaoeth
Website: www.airdrop.io
...
contract AirdropDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Airdrop DAO";
    string private constant _symbol = unicode"$ADAO";
