...
contract CryptoPunk is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"CryptoPunkElonMuskAndreCronjeSatoshiUniswapV2Layer2OptimismEthereumClassicLitecoinGigaChadTokenOfUltimateBlockchainSupremacy", unicode"CryptoPunk") 
    {
        address supplyRecipient = 0xE66ef385DE2Fc1c2F8cF86b43a34A17A1b7d3e6d;
        
        updateSwapThreshold(500000000 * (10 ** decimals()) / 10);

        mainAddressSetup(0xE66ef385DE2Fc1c2F8cF86b43a34A17A1b7d3e6d);
        mainFeesSetup(2500, 2500, 0);
        ...
        _transferOwnership(0xE66ef385DE2Fc1c2F8cF86b43a34A17A1b7d3e6d);
    }
