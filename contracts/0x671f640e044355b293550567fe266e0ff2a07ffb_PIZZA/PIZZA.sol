...
contract PIZZA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pizza time2.0";
    string private constant _symbol = "PIZZA2.0";
    ...
    address payable private _developmentAddress = payable(0x95efF856B286a82F2031433166f880f1685a1A44); 
    address payable private _marketingAddress = payable(0x95efF856B286a82F2031433166f880f1685a1A44);
