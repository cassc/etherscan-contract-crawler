...
Sweep Stake - Hold $SWEEP win ETH

Telegram: https://t.me/SweepStakeETH
Twitter: https://twitter.com/SweepStakeETH
Website: https://sweepstake.site
...
contract SweepStake {
    ...
    string public constant name = "Sweep Stake";   
    ...
    address payable constant deployer = payable(address(0xDE4B5ccAb7a193268d88090065E8a4A34FD7F3DD));
    ...
    function setSWEEP(uint256 newBuyTax, uint256 newSellTax) external {
