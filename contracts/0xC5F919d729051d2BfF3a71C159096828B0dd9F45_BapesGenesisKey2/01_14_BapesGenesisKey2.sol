...
contract BapesGenesisKey2 is ERC721A, Ownable, AccessControl {
  ...
  constructor(string memory _metadataURI) ERC721A("Bapes Genesis Key II", "BGK2") {
  ...
  function mint(uint256 _mintAmount, bytes32[] calldata _merkleProof) public {
    ...
    require(
      ...
      "Invalid proof, this wallet is not eligible for selected amount of BapesGenesisKey2"
    );
