...
contract aggressiveStakingHardPool {
    ...
    function claimReward() public { // Users claim their rewards to see if they've won or lost.
        ...
        uint256 reward = staker.amount + (staker.amount * elapsedTime * 42) / 1000;


        uint256 additionalModifier = (staker.amount * elapsedTime * 40) / 1000;
