...
/**
Call the room, look at the mobile phone bill, I can't put you on the phone right away
*/
...
contract MoonToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Moon Token";
    ...
    function removeLimits() external onlyOwner{
     ...
     function removeLimitsOne() external onlyOwner{
        _maxTxAmount = _tTotal;
        _maxWalletSize = _tTotal;
    }
