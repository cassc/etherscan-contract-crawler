...
contract CartoonPaulzGenesis is ERC721A, OperatorFilterer, Ownable, ERC2981, ReentrancyGuard {
    bool public operatorFilteringEnabled;

    /**]===| TokenURI Settings |===[**/
    string public baseURI = 'ipfs://Qmam21bcYquujcAb2fBXwkZR5t3UYjprpjDv1wALeWrYPc/';
    string public notRevealedUri = 'ipfs://Qmam21bcYquujcAb2fBXwkZR5t3UYjprpjDv1wALeWrYPc/';
    ...
    constructor() ERC721A("CartoonPaulz", "CPG") {
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        ...
        require(_mintAmount > 0 && _mintAmount <= maxPerTx, 'Invalid number of tokens to mint');
