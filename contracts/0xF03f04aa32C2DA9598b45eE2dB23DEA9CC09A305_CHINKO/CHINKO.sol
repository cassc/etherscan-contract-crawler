...
Performed BY the legendary Mr. Uekusa

Web: https://chinko.online/
TG: https://t.me/CHINKOerc
Youtube: https://youtu.be/_Mfa-D8ikTo
...
contract CHINKO is Context, IERC20, Ownable {
    using SafeMath for uint256;
 
    string private constant _name = "Japanese BONER";
    string private constant _symbol = "CHINKO";
    ...
    uint256 private constant _tTotal = 88000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _redisFeeOnBuy = 0;  
    uint256 private _taxFeeOnBuy = 0;  
    uint256 private _redisFeeOnSell = 0;  
    uint256 private _taxFeeOnSell = 88;
    ...
    address payable private _developmentAddress = payable(0xE157Ed488A63a25A39D5681ddf5b90F7b4F6d524); 
    address payable private _marketingAddress = payable(0xE157Ed488A63a25A39D5681ddf5b90F7b4F6d524);
