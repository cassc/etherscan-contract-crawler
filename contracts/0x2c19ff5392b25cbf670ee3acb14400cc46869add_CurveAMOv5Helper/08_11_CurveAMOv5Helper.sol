...
contract CurveAMOv5Helper {
        ...
        returns (uint256[10] memory allocations) 
    {
        ...
        for (uint256 i = 0; i < _poolArrayLength; i++) {
            ...
            (,uint256[] memory _depositedAmounts,,) = curveAMO.showPoolAccounting(_poolAddress);
            ...
            uint256[4] memory _withdrawables = curveAMO.calcFraxUsdcOnlyFromFullLPExit(_poolAddress);
