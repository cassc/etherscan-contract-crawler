...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xDb28367EC7fdB1AA83c1eDE2CF15B78c1b87E6C4];
  address public erc20Payable = 0xDb28367EC7fdB1AA83c1eDE2CF15B78c1b87E6C4;
    ...
    
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/lddtH81MTyrqwiBwnX3s/contract-metadata";
  }
...
// File: contracts/OlympiabyAjWalkerContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OlympiabyAjWalkerContract is RamppERC721A {
    constructor() RamppERC721A("Olympia by AJ Walker", "Olympia"){}
}
