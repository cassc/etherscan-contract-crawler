...
Telegram: https://t.me/shibarangersether
Website: https://shibarangers.tech/
Twitter: https://twitter.com/shibarangers
Ranger Tools: http://t.me/RangerTools_bot
*/
...
contract SRANGERS is ERC20, Ownable {
    ...
    constructor() ERC20("ShibaRangers", "SRANGERS") {
        ...
        devWallet = address(0xD9E5853B30aD83ba0060CA7711D56791D251347e); 

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xD9E5853B30aD83ba0060CA7711D56791D251347e), true);
        excludeFromFees(address(0xD9E5853B30aD83ba0060CA7711D56791D251347e), true);
        excludeFromFees(address(0xD9E5853B30aD83ba0060CA7711D56791D251347e), true);
