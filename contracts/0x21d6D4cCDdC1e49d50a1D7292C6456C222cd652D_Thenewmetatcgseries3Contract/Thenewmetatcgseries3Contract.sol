    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 25) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeib6e2t5hkajhlqenja4ekiculryksnj6fwfnc7zpvcj5yx6wjhep4/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/cwPR5WtqpvuGbDwo2E3F/contract-metadata";
  }
...
// File: contracts/Thenewmetatcgseries3Contract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract Thenewmetatcgseries3Contract is RamppERC721A {
    constructor() RamppERC721A("THE NEW META TCG  SERIES 3", "TNM3"){}
}
