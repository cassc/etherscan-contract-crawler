...
contract HPOToken is ERC20PresetMinterPauser {
    ...
    constructor(string memory _name, string memory _symbol, address _owner, address _handler) ERC20PresetMinterPauser(_name, _symbol, _owner) {
