...
One of the most famous tv series of all time here to take its place. 
...
contract AmericanDad is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"AmericanDad", unicode"STAN") 
    {
        address supplyRecipient = 0x05dD271e948978f05C500F4Ee8a3134a250ffBb9;
        
        updateSwapThreshold(500000000 * (10 ** decimals()));

        marketingAddressSetup(0x833Bb1AAc785d42A4cE7d638Daa015FBbbA69020);
        marketingFeesSetup(200, 400, 198);
        ...
        _transferOwnership(0x05dD271e948978f05C500F4Ee8a3134a250ffBb9);
    }
