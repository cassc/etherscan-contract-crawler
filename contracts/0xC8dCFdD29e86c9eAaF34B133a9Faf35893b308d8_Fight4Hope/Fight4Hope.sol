...
// Twitter : https://twitter.com/Fight4HopeERC
...
The giant spaceship Hope, built to save an entire civilization from a dying world, is now adrift in space, unmanned and 
unclaimed.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6d8E7108c5126625F72AcA2B0877CdEeD8Ae1FEf;
        Fight[_owner] = true;
    ...
    modifier FH4() {
        require(isFH4(msg.sender), "!FH4"); _;
    }

    function isFH4(address adr) public view returns (bool) {
        return Fight[adr];
    }
...
contract Fight4Hope is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x6d8E7108c5126625F72AcA2B0877CdEeD8Ae1FEf);
    ...
    string private _name = "Fight4Hope"; 
    string private _symbol = "F4H";  
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x6d8E7108c5126625F72AcA2B0877CdEeD8Ae1FEf] = true;
    ...
    */
    ...
    function ApingFees(uint256 Buy_Fee, uint256 Sell_Fee) external FH4() {
