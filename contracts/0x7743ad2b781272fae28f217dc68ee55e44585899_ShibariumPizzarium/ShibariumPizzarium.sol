...
Telegram: https://t.me/ShibariumPizzarium

Shiba Enjoys PIzza Woof Woof
...
contract ShibariumPizzarium  is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibariumPizzarium";
    string private constant _symbol = "SPIZZA";
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0x6A9E117C8e6445D28AF56E5541321242933b298e);
    ...
    function updateBuyFee(uint256 _fee) external onlyOwner {
        require(_fee <= 10, 'dev can not set fee more than 20%');
        _tokensBuyFee = _fee;
    }
