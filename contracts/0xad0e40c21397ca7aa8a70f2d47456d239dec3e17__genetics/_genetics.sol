...
contract _genetics is Delegated, ERC721EnumerableLite, PaymentSplitterMod {
  using Strings for uint;

  uint public MAX_ORDER      = 1000;
  uint public MAX_SUPPLY     = 1000;
  uint public MAINSALE_PRICE = 0.172 ether;
  uint public PRESALE_PRICE  = 0.172 ether;
  ...
  address[] private addressList = [
    0xe533f82d2aB3625267031bD6DD3487E4abd914EC,
    0x286777D6ad08EbE395C377078a17a32c21564a8a, 
    0x39583d414c8fEf71C006710bE319ec9042DA018a
  ];
  ...
  constructor()
    Delegated()
    ERC721B("Genetics{NFT} | Grow-Op Drop", "G{N}", 0)
