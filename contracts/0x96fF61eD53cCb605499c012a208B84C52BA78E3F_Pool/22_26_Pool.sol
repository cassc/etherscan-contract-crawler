    ...
    Liquidity
{
    ...
    /*
        core functions
    */
    function deposit(uint256 value, uint256 poolID) external notPaused(poolID) onlyFrozen(msg.sender, poolID){
    ...
    */
    ...
    // function unstake(uint256 value, uint256 poolID) external onlyFrozen(msg.sender, poolID){
    //     unbond(value, poolID);
