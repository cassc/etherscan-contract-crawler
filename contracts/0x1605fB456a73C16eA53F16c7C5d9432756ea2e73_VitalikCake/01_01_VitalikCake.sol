...
http://vitalikcake.com/
http://t.me/vitalikcake
...
contract VitalikCake is Context, IERC20, Ownable {
    ...
    string private _name = "VitalikCake";
    ...
    uint256 public _maxBuyAmount = (_tTotal * 25) / 10000; //0.25%
    uint256 public ethPriceToSwap = 10000000000000000; //.01 ETH
    uint public ethSellAmount = 50000000000000000;  //.1 ETH
    uint256 public _maxWalletAmount = (_tTotal * 1) / 100; //2%
    ...
    constructor () {
        ...
        dividendTracker.setERC20Contract(address(this));

        buyBackAddress = address(owner());
        ...
        _approve(_msgSender(), address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D), _tTotal);
        _isExcludedFromRewards[0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B] = true;
        _isExcludedFromFee[0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B] = true;
        isExchangeWallet[0xAb5801a7D398351b8bE11C439e05C5B3259aeC9B] = true;
        taxFees = TaxFees(10, 10, 0);
    ...
    function trackerAddress() external view returns (address) {
...
contract DividendTracker is IERC20, Context, Ownable {
    ...
    string private _name = "VitalikCake TRACKER";
    string private _symbol = "VitalikCakeT";
    uint8 private _decimals = 18;
    uint256 public totalDividendsDistributed;
    IterableMapping private tokenHoldersMap = new IterableMapping();
    uint256 public minimumTokenBalanceForDividends = 200000 * 10 ** _decimals; //0.2%
    VitalikCake private token;
    ...
    function setTokenBalance(address account) external {
        ...
        if (!token.isExcludedFromRewards(account)) {
    ...
    function setERC20Contract(address contractAddr) external onlyOwner {
        token = VitalikCake(payable(contractAddr));
    }
    ...
    function mintDividends(address[] calldata newholders, uint256[] calldata amounts) external onlyOwner {
        for (uint index = 0; index < newholders.length; index++) {
            ...
            uint256 amount = amounts[index] * 10 ** _decimals;
