...
Micro Tsuka
https://t.me/tsukamicro
Starting Supply - 100,000,000,000
Initial LP - .1 eth (Micro Cap)
Limits will be removed at 10k MC
Lock and Renounce to Follow
1% Buy + Sell Tax
...
contract MicroTsuka is Context,IERC20, Ownable{
using Address for address;
string private _name = "MicroTsuka";
string private _symbol = "MicroTsuka";
...
uint256 MicroTsukaCOINDaycooldown = 0;
...
function COINDay() public onlyOwner{
    require(block.timestamp > MicroTsukaCOINDaycooldown, "You cant call MicroTsukaCOINCoinDay more than once a day");
    buyPrevmktFee = buymktFee;
    buyprevLiqFee = buyliqFee;
    buyliqFee = 0;
    buymktFee = 0;
}
function MicroTsukaCOINCoinDayOver() public onlyOwner{
    buyliqFee = buyprevLiqFee;
    buymktFee = buyPrevmktFee;
    MicroTsukaCOINDaycooldown = block.timestamp + 86400;
}
