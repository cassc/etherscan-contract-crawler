...
Twitter: https://twitter.com/DetectiveElon
Telegram: https://t.me/DetectiveElon
Website: https://detectiveelon.com/
...
contract DELON  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Detective Elon";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && _taxAmount>_taxSwapThreshold) {
