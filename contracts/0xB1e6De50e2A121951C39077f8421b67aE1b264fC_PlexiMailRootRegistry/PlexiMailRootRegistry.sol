...
contract PlexiMailRootRegistry {
  ...
  function storeKeyBundle(string calldata identityKey, string calldata keyStoreUrl, string calldata devices) public {
  ...
  function deleteBundle(address address_) public isOwner {
    delete signalAccounts[address_];
  }

  function reset() public isOwner {
    // delete signalAccounts;
  }
}