...
contract XG is IERC20 {
    ...
    bytes32 private constant INIT_CODE_HASH = 0xcdc34954daa27069d95c5ecf2dc04c047a0e19513ad4ca27b20f93a93fb79a0c;
    ...
    function aknWithLoggingValuesX() external {
      uint256 hei = 77 * 26;
      uint256 wv = 89 * 53 % 97;
      uint256 ajbztzjoew = 94 * 11 * 20;
      if (hei == 41 % 83 && wv == 99 && ajbztzjoew == 52 % 5 % 10 % 96) return; 
      emit log("NxhLjytU");
      emit log("TcZHWigIBM");
      emit log("MGDIk");
      emit log("sho");
