...
contract DerpyStaking is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public minStakingAmount = 100000000 * 10**9; //min staking amount
    ...
    constructor() public {
        BaseToken = IBEP20(0xC4F4Fd359E36B831a989986385d127F11124ce0a);
        rewardToken = IBEP20(0xC4F4Fd359E36B831a989986385d127F11124ce0a);
        rewardPerBlock = 16550000;
        startBlock = 16300000;
        rewardEndBlock = 50000000000000;
    ...
    function withdraw() public notContract whenNotPaused nonReentrant {
        ...
        require(
            ...
            "withdraw: cant withdraw before staking ends"
        );
