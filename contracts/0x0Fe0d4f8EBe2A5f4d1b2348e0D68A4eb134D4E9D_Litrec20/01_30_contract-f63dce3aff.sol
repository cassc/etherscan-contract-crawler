...
contract Litrec20 is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("litrec20", "LERC") ERC20Permit("litrec20") {
        _mint(msg.sender, 84000000 * 10 ** decimals());
    }
