...
contract TUGOU is ERC20, Ownable {
    ...
    constructor() ERC20("Tugou Inu", "TUGOU") {
        ...
        maxTransactionAmount = 100_000_000 * 1e18; // 3% from total supply maxTransactionAmountTxn
        ...
        marketingWallet = address(0xE0f05bD04F5874f0bA39E1187a13730936053fbb); // set as marketing wallet
    ...
    function updateBuyFees(
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 100, "Must keep fees at 25% or less");
    }
