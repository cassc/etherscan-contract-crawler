...
contract GenerativeBoats is ERC721A, Ownable {
    ...
    string private baseUri = "ipfs://QmfR32FQt8FFnpgu4xZjNnYEDuHQZouRmgbPrkMtc5TbPW";

    mapping(address => uint256) private _freeMintedCount;

    constructor() ERC721A("Generative Boats", "GenerativeBoats") {}
