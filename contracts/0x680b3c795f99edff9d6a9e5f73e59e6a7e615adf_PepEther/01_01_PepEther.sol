...
contract PepEther is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "ipfs://bafybeigtun7exvx5dpzybrtwsznkxscnu4qh3guatux7sfave36p4a6764/";
    uint   public price             = 0.002 ether;
    uint   public maxPerTx          = 10;
    uint   public maxPerFree        = 2;
    uint   public maxPerWallet      = 12;
    ...
    constructor() ERC721A("PepEther", "PepEther"){}
