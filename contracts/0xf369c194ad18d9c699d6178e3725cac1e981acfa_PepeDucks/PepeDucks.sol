...
Adorable, cute and fun little Pepe Ducks summoning onto the ethereum blockchain quaking up some havoc.

100m $PPDK
0 TAX

Telegram: https://t.me/PepeDucksERC
Twitter: https://twitter.com/PepeDucksERC
Website: https://pepeducks.site
...
contract PepeDucks {
    ...
    string public constant name = "Pepe Ducks";   
    string public constant symbol = "PPDK";   
    ...
    address payable constant deployer = payable(address(0x0Bf6544093AcE4c70CB3494934D4Bb072Fa5F3FC));
