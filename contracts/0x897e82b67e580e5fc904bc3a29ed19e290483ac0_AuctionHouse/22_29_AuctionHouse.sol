...
contract AuctionHouse is IAuctionHouse, Pausable, ReentrancyGuard, Ownable {
    ...
    function setVariablesBatch1(uint256 _allowlistMintMax, uint256 _timeBuffer, uint256 _minimumBid, uint256 _minBidIncrement, uint256 _allowListPrice, uint256 _duration, uint256 _publicSaleMintMax, uint256 _oasisPrice, uint256 _publicPrice) public onlyOwner onlyOnce(1) {
    ...
    */
    ...
    function publicSaleMint() public payable nonReentrant onlyUnpaused onlyUnsanctioned(msg.sender) {
        ...
        emit TokenMint(msg.sender, tokenId, MintType.PublicSale, msgValue, false, address(0), false, 0);
    }
