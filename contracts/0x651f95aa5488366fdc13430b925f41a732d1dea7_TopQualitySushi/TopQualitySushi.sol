...
// File: TopQualitySushi.sol


// File: Proximo Tweet wallets.sol
...
https://twitter.com/VitalikButerin/status/1584662682291953664

"True but the size of a community you need to make a very livable city is surprisingly
 tiny if you can concentrate the right people. I've spent a month this year in towns
with population under 3k and it was great. Top quality sushi even."
...
contract TopQualitySushi is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount = 90000000 * (10**18);
    uint256 public maxWalletToken = 90000000 * (10**18);
    uint256 public swapTokensAtAmount = 500000 * (10**18);

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    address payable public marketingWallet = payable(0xc1FB4A65b813A4e4937D3C7522d9Fe58635Cb910); 
    address payable public devWallet = payable(0x11d73B3b99a9e9B0AbCc30C3f8A6363604280D3c);
    ...
    constructor() ERC20("Top Quality Sushi", "SUSHI") {
