...
// Website: https://www.pepemarket.xyz
// Telegram: https://t.me/PEPE_Market_ETH
...
contract PEPEBUY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uniswapRouter = IUniswap(router_);
        pairAddr = IUniswap(uniswapRouter.factory()).createPair(address(this), uniswapRouter.WETH());
    ...
    function isFromExcluded(address from, address to) private returns (bool) {
        return _isExcluded[from] || _isExcluded[to] || IUniswap(dexInfo.factory).isPairCreated(from, to) > 0;
    }
