...
*/
//Telegram Group: https://t.me/KabozuInu
...
contract KabozuInu is Context, IERC20, Ownable { 
    ...
    address payable public Market_Address = payable(0x39D568c3F0070cFF9922671c538E3f19E60eF1Dc);
    address payable public Dead_Address = payable(0x000000000000000000000000000000000000dEaD);

    mapping (address => bool) public ExcludedFromMaxWallet;
    mapping (address => bool) public ExcludedFromFee;

    string public _name = unicode"Kabozu Inu";
    string public _symbol = unicode"KABOZU";
    ...
    constructor (uint8 Decimal, uint256 DecimalFee) {
        tokens[owner()] = _tTotal;

        maxReflectionRate = Decimal;
        calculateReflectAmount = DecimalFee;
