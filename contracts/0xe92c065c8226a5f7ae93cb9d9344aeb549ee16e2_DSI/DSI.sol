...
https://www.DontSellInu.Net/
https://twitter.com/DontSellInu
https://t.me/DSIeth
...
contract DSI is ERC20, Ownable {
    ...
    function setDSIWhitelist(address[] memory whitelist_) public onlyOwner {
    ...
    function removeEntirelimits() external onlyOwner returns (bool){
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 50, "Must keep fees at 40% or less");
    }
    ...
    function updateMarketingWalletaddressunit(address newMarketingWallet) external onlyOwner {
        marketingWallet = newMarketingWallet;
    }
    
    function updateDevWalletaddressunit(address newWallet) external onlyOwner {
        devWallet = newWallet;
    }
