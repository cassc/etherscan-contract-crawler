...
FOMO Bot has been created to help the everyday degen make better decisions trading.

Find us below

SITE: https://fomobot.tools/
TG PORTAL: https://t.me/fomobotportal
TWITTER: https://twitter.com/FOMO_Bot_ERC

FOMO Bot: http://t.me/fomobot_bot
...
contract FOMO is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"FomoBot", unicode"FOMO") {

        address newOwner = msg.sender; 

        UniswapRouter _dexRouter = UniswapRouter(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        dexRouter = _dexRouter;

        // create pair
        lpPair = UniswapFactory(_dexRouter.factory()).createPair(address(this), _dexRouter.WETH());
