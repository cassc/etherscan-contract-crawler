...
// SSLX is the native token of the Sl8 Social Crypto Platform, combining altogheter the power of content monetization and SocialFi.
...
contract StarSlax is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"sl8.social";
    string private constant _symbol = unicode"SSLX";
