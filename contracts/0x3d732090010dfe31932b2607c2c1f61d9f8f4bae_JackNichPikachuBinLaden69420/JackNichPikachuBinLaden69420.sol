...
contract JackNichPikachuBinLaden69420 is ERC20, Ownable {
    ...
    constructor(
    ...
    ) ERC20("JackNichPikachuBinLaden69420", "$BITCONNECT") {
        ...
        maxTransactionAmount = 2_500 * 1e18; // 0.25%
        maxWallet = 2_500 * 1e18; // 0.25%
        ...
        */
        ...
        _mint(
            0x561F33fBCB2999112f7406414e6d292097DBd8E7,
            (totalSupply * 20) / 100
        ); //marketing wallet
    }
