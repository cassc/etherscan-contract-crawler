...
contract Snibs is ERC20, Ownable {
    ...
    constructor() ERC20("Snibs", "SNIBS") {
        ...
        marketingWallet = address(0x8ef58eA79A5fe75413Be981edc422ADecDB2a99f); // set as marketing wallet
        devWallet = address(0x8ef58eA79A5fe75413Be981edc422ADecDB2a99f); // set as dev wallet
