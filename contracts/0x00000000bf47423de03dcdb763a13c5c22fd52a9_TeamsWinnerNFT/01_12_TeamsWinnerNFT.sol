...
contract TeamsWinnerNFT is ERC721A, IERC4906, Ownable {
    ...
    constructor() ERC721A("!teams winner", "TWNR") {
    ...
    function setWinnerInfo(bytes32 _root, uint256 _reward) public onlyOwner {
        if (_root == bytes32(0)) {
