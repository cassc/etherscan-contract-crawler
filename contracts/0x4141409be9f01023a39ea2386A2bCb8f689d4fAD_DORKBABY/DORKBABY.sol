...
contract DORKBABY is Context, IERC20, Ownable {
    ...
    string private constant _name = "DORKBABY";
    string private constant _symbol = "DORKBABY";
    ...
    uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0xdb8ab6d727e915377308B0a202dDDAf52aaeb9a5);
