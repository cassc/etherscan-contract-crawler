...
contract KENNY is ERC20, Ownable {
    ...
    constructor() ERC20("KENNY", "KENNY") {
        ...
        marketingWallet = address(0xDd2861f1161A89019B3b2F21f75E5474bB878178); // set as marketing wallet
        devWallet = address(0xDd2861f1161A89019B3b2F21f75E5474bB878178); // set as dev wallet
    ...
    function KennyLimitsOff() external onlyOwner returns (bool) {
