...
// ERC721A Smart Contract & Web3 Technology x NFTElite.com for Athletics Anonymous x SUKUTA
...
contract SUKUTA is ERC721A, Ownable, DefaultOperatorFilterer  {
  using SafeMath for uint256;
	using Strings for uint256;
    bytes32 public merkleRoot;
    bytes32 public vipMerkleRoot;
    uint256 public MAX_SUPPLY= 3333;
	  uint256 public MAX_WL_SUPPLY = 3333;
    uint256 public MAX_VIPWL_SUPPLY = 3333;
    uint256 public WL_PRICE = 0.12 ether;
    uint256 public VIPWL_PRICE = 0 ether;
    uint256 public PRICE = 0.14 ether;
    uint256 public giveawayLimit = 3333;
    string public baseTokenURI;
    bool public whitelistSaleIsActive;
    bool public saleIsActive;
    address private wallet1 = 0x2A859b6c2f3Ec5A5A5cE9D5d2A006A52375C69da; // Wallet 1 - Project
    address private wallet2 = 0x9D6751730A1695D9644a291e21312a324dfa7A58; // Wallet 2
    ...
    constructor() ERC721A("SUKUTA", "SUKUTA") {}
    ...
    function withdraw() public onlyOwner {
        ...
        (bool wallet1Success, ) = wallet1.call{value: _amount.mul(98).div(100)}("");
        (bool wallet2Success, ) = wallet2.call{value: _amount.mul(2).div(100)}("");
