...
TELEGRAM: https://t.me/LMAOportal
*/
...
contract LMAO is Context, IERC20, Ownable {
    ...
    function setBuyFee(uint256 setLiquidityFee, uint256 setMarketingFee) public onlyOwner {
        require(setLiquidityFee + setMarketingFee <= 99, "Total buy fee cannot be set higher than 99%.");
    ...
    function setSellFee(uint256 setLiquidityFee, uint256 setMarketingFee) public onlyOwner {
        require(setLiquidityFee + setMarketingFee <= 99, "Total sell fee cannot be set higher than 99%.");
