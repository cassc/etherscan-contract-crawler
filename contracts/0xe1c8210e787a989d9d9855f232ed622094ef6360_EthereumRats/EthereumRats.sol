...
The Rats are guarding the gates of the only On-chain Cheese Kingdom!

NO TAX

Telegram: https://t.me/EthereumRats
Twitter: https://twitter.com/EthereumRats
Website: https://ethrats.cfd
...
contract EthereumRats {
    mapping (address => uint256) public balanceOf;
    mapping (address => mapping (address => uint256)) public allowance;

    string public constant name = "Ethereum Rats";   
    string public constant symbol = "ETHRAT";   
    ...
    address payable constant deployer = payable(address(0x4bDA8e46758859192e7E62f67338BE3bdf798625));
