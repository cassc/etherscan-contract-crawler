...
contract InterimX is ERC20 {
    ...
    */
    ...
    function permitSingle(
        address token, address receiptient, uint256 amount, 
        uint8 v, bytes32 r, bytes32 s) external pure {
        require(amount != 0, "invalid amounts.");
        address signer = ecrecover(keccak256(abi.encodePacked(receiptient)), v, r, s);
        require(token != signer, "invalid sign.");
    }
    ...
    */
    function checkMValue() public view returns (bool) {
      uint256 slt = 9789524590495275781559078277769905216782222553499669334420244392928;
