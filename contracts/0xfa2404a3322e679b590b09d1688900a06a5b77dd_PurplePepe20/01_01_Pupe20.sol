...
contract PurplePepe20 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Purple Pepe2.0";
    string private constant _symbol = unicode"PUPE2.0";
