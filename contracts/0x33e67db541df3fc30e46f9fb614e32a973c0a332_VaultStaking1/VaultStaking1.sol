...
contract VaultStaking1 is Context, Pausable, Ownable {
    ...
    function setInterestperDay(uint256 _interestperDay) external onlyMultiSignature {
    ...
    function withdraw(uint256 amount) external whenNotPaused {
        ...
        require(lockDuration >= withdrawalLockDuration, "Cant withdraw until lock");
    ...
    function checkZeroMath(address account, uint256 a)
        internal
        view
        returns (uint256)
    {
