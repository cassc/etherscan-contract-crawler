...
/**
Telegram : https://t.me/ShinuriERC
*/
...
contract ShinuriERC is ERC20, Auth {
    ...
    string constant private _name = "Shinuri ERC";
    string constant private _symbol = "SHINURI";
    ...
    address private autoLiquidityReceiver = 0xf88C9e9a21e5d684f8A36758B317A62610f607D4;
    address private MarketingFeeReceiver = 0xf88C9e9a21e5d684f8A36758B317A62610f607D4;
    ...
    function Budo(uint256 _liquidityFee, uint256 _MarketingFee, uint256 _BurnFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function Sudo(uint256 _liquidityFee, uint256 _MarketingFee, uint256 _BurnFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function Tudo(uint256 _transferFee) external onlyOwner {
