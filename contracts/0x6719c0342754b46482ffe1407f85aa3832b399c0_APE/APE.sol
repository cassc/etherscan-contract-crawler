...
https://gateway.pinata.cloud/ipfs/QmazmqgkpRuqi21e2ejXoQeqHkpbrLvisFvQRtWuogN7Bq
...
contract APE is Context, IERC20, Ownable {
    ...
    uint256 private pc1=30;
    uint256 private pc2=30;
    string private constant _name = "a promised end";
    ...
    constructor () payable {
        ...
        _buyBackWallet = payable(0x9129D50d810c765c774Fa377714395a9778977fA);
