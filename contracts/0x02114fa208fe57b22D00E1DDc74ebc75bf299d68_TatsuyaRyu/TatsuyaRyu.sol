...
Tatsuya Ryu is an ethereum-powered marketing and advertising platform based on the principles of DeFi. 
Our project aims to tokenize advertising and marketing engagements with a proprietary ERC20 Token, 
the Tatsuya Ryu Token (SUYA).

https://t.me/TatsuyaRyu
...
contract TatsuyaRyu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tatsuya Ryu", "SUYA") {
