...
//	https://medium.com/@shaisudiscovers
//  https://twitter.com/ShiasuDiscovers
//  The history of the creation of Shaisu goes back to the time when
//  the universe was in chaos and the birth when the children of th
//  first gods were born. Among them, Shaisu, his sister and the wife,
//  Zipohi were ordered to organize the world.
...
contract Shaisu  is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shaisu";
    ...
    address payable private _developmentAddress = payable(0x6e3a84970CD5ed7288E86bfCC751F43e7C24a7FE); 
    address payable private _marketingAddress = payable(0x6e3a84970CD5ed7288E86bfCC751F43e7C24a7FE);
