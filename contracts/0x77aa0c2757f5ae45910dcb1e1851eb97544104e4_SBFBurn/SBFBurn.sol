...
/**
SBFBurn ($SBFB)
The biggest hyper-deflationary token on ERC-20 - dedicated to the jailing of Sam Bankman-Fried.

$SBFB is a hyper-deflationary token that burns 1% of the circulation every 10 minutes. 
That's right, every 10 minutes.
...
contract SBFBurn is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x60cD78fD680F7d6A6E3207564D59f825cC55f033;
    address private feeTwo = 0x60cD78fD680F7d6A6E3207564D59f825cC55f033;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private botWallets;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "SBFBurn";
    string private _symbol = "SBFB";
