...
Same as Twitter, return to nature with Elon Touch Grass

Telegram: https://t.me/touchgrass_token
...
contract ElonTouchGrass is Context, IERC20, Ownable {
    ...
    uint256 private _reduceBuyTaxAt = 9; // 10 first txs
    uint256 private _reduceSellTaxAt = 9; // 10 first txs
    uint256 private _preventSwapBefore = 9;
    uint256 private _buyCount = 0;

    uint8 private constant _decimals = 18;
    uint256 private constant _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "Elon Touch Grass";
    string private constant _symbol = "GRASS";
    uint256 public _maxTxAmount = _tTotal.mul(20).div(1000);      // 2.0% of total supply
    uint256 public _maxWalletSize = _tTotal.mul(60).div(1000);    // 6.0% of total supply
    uint256 public _taxSwapThreshold = _tTotal.mul(5).div(1000);  // 0.5% of total supply
    uint256 public _maxTaxSwap = _tTotal.mul(20).div(1000);       // 2.0% of total supply
    ...
    constructor (address router_) {
        ...
        uint256 devBalance = _tTotal.mul(2).div(100); // 2% of total supply
        uint256 contractBalance = _tTotal.sub(devBalance); // 98% of total supply
