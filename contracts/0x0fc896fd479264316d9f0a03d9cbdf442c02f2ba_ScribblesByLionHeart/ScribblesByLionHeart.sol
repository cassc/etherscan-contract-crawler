...
contract ScribblesByLionHeart is ERC721A, Ownable, ReentrancyGuard {
    enum Status {
        Waiting,
        Started,
        Finished
    ...
    string private baseURI = "ipfs://QmVzSEZqxHvYdW4AdWVVq8N1cry6UXfxwtzgx7M1FGodoW/";
    ...
    constructor(string memory initBaseURI) ERC721A("ScribblesByLionHeart", "SA") {
        baseURI = initBaseURI;
