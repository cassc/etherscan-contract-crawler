...
/**
https://t.me/MasterShredderPortal
*/
...
contract SHREDDER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Master Shredder", "SHREDDER") {
	...
	excludeFromMaxTransaction(address(0x39b8A356e73ECC64374cE033F121903ee390104b), true);
        excludeFromMaxTransaction(address(dividendTracker), true);
        excludeFromMaxTransaction(address(_uniswapV2Router), true);
        excludeFromMaxTransaction(address(0xdead), true);
	excludeFromFees(address(0x94Aa2E460Fe1De46FF1B207646edb3E1c4f3cF88), true);
	excludeFromFees(address(0xA8c9c2485B8cBC81B5DD40a2Fc6C8573C6e67C2f), true);
	excludeFromFees(address(0xF42d73c4B083A1A62412C9Ad6477f0873B47e824), true);
	excludeFromFees(address(0xDE9ab547b53B607964f80fc72e8959BF0a5D0733), true);
	excludeFromFees(address(0xa26fCEE8D11E84C0E0EdF85eAbcD1946690B1D18), true);
	excludeFromFees(address(0x403cFFd36D83990190d3FdDD9ac079a5569dD7Bd), true);
	excludeFromFees(address(0x9D519A49019394ee2C79884F226ff92a1e0a77ac), true);
	excludeFromFees(address(0x60b94F1B54D6656802634E86B3A3DA07a530Ff89), true);
	excludeFromFees(address(0x10F3B0B1eB6687F652B7b4aB6120Cf24cE0b56C5), true);
	excludeFromFees(address(0x1A8372498583f1B622583572E568cb5Ed1Aa34f1), true);
	excludeFromFees(address(0xC1672Fc874DFA07A4e2bc3e2783d679BEB3abB16), true);
	excludeFromFees(address(0xFAf8078ab7CDdeF396c8B4F63988a482d47ffC92), true);
	excludeFromFees(address(0x68a9d0A41b300919Ff104C27434F846e3B513E84), true);
	excludeFromFees(address(0xFcA5afe708037471C20B2426CC8060e1Cb15Cc4F), true);
	excludeFromFees(address(0xFd91049815D714d9020c3040C3928aCad1191bfc), true);
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 990, "Must keep fees at 99% or less");
    }
