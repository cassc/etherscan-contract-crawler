...
Get ready, folks. $MALE is back, but we're now dressed in $FEMALE.

Our successful stint as $MALE showed us the power of community and memes.
We chuckled, we HODLed, we changed the game. 
And now, the team that brought you the powerhouse $MALE is back - 
but this time, we're switching gears. 
$FEMALE is born.

We're thrilled to announce the birth of $FEMALE, a new meme token that channels the strength, wisdom, and irresistible charm of femininity into the world of crypto.
The $FEMALE token isn't just an investment - it's a statement, a celebration, a wink and a nod to the women who inspire us every day.


https://t.me/femaletokenerc
...
contract Female is ERC20, Ownable {
    ...
    constructor(uint256 _initialBuyFee, uint256 _initialSellFee, uint256 _preventSwapBefore) ERC20("Female", "$Female") {
