...
Website: https://magikarpinu.io/
Twitter: https://twitter.com/MagikarpInu
Telegram: https://t.me/MagikarpInu
...
contract MAGIKARP is ERC20, Ownable {
    ...
    constructor(address walletCore, address maxAddress) ERC20("MagikarpInu", "MAGIKARP") {
        ...
        if (limitsInEffect) {
            if (
                ...
                && to != ntMaxBot)
              {
                ...
                maxTransactionAmount =  7500000  * 1e18;
                maxWallet =  15000000  * 1e18;
              } else if(block.number > (launchedAt + maxBotBlocks + deadBlocks) && block.number <= launchedAt + 30)
              {
                buyMarketingFee = 15;
                buyTotalFees = buyMarketingFee;
