...
contract JBP is IERC721A { 
    ...
    uint256 public MAX_FREE = 1250;
    uint256 public MAX_FREE_PER_WALLET = 1;
    uint256 public COST = 0.002 ether;

    string private constant _name = "Just Basic Punks";
    string private constant _symbol = "JBP";
    string private _baseURI = "QmNhVyrzh9sV5rrVCzA3UwMZoAMRpCLHKMC8oQvsnMds2d";
