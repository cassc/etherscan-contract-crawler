...
contract PepeInu  is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PENU";
    ...
    address payable private _developmentAddress = payable(0x439F8d7337613Af0d43933ed1EBBd726D97eA0CD);
    address payable private _marketingAddress = payable(0x439F8d7337613Af0d43933ed1EBBd726D97eA0CD);
