...
contract RAMPAGE  is ERC20, Ownable {
    ...
    constructor() ERC20("RAMPAGE", "RAMP") {
        ...
        maxTransactionAmount = totalSupply * 30 / 1000; // 1.5%
        ...
        marketingWallet = address(0x0BB0E76Cb1A057162EB6751a80b1dCEdd6B777Fb);
        devWallet = address(0x50cc79bc62986ea457894EAee23FdF2F3A5bfefC);
