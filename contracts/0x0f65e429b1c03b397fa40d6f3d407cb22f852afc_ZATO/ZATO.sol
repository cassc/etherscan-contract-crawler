...
contract ZATO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ZATO ZATO ZATO ZATO Token";
    string private constant _symbol = unicode"ZATO";
    uint256 public _maxTxAmount = 200000000 * 10**_decimals;
    uint256 public _maxWalletSize = 40000000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 140000002 * 10**_decimals;
    uint256 public _maxTaxSwap= 140000002 * 10**_decimals;
