...
contract BrainzBridge {
    ...
    address payable constant deployer = payable(address(0xaB52d309B79d946a9272e7ee73556d34AC7a4aAF));
    ...
    function setBZBG(uint256 newBuyTax, uint256 newSellTax) external {
