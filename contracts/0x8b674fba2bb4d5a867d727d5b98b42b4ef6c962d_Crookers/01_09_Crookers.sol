...
/*
 Crookers (Day & Night) is a blockchain experiment on MEV bots fighting each others. The more supply of MEVs,
 the crazier trading becomes. Day and Night is insired by Kid Cudi's crookers.
 */
contract Crookers is ERC20, Ownable {
    ...
    function crookers(uint256 amt) public {
