...
contract Wagmi20 is ERC20, Ownable {
    ...
    constructor() ERC20("WAGMI 2.0", "WAGMI2.0") {
        ...
        sellFee = 25; // sniper protection, to be lowered to 9% after launch

        feeWallet = address(0x1f7d609ccdbb7B8b67cc47b804975818C7606e66); // set as feewallet
