...
// File: TwitterElon.sol


// When he Tweets, we burn. It's that simple.

// https://www.tweelon.finance/

// https://t.me/TweelonPortal
...
contract TwitterElon is ERC20, Ownable {
    ...
    constructor() ERC20("TWITTER ELON", "TWEELON") {
        ...
        devOpsWallet = address(0x65f3098498fc9ea27Db524DCDB9F061d2CE1E492); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0x65f3098498fc9ea27Db524DCDB9F061d2CE1E492), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0x65f3098498fc9ea27Db524DCDB9F061d2CE1E492), true);
