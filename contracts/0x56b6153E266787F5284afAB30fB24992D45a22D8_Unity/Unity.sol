...
contract Unity is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    uint256 public WL_PRICE_PER_TOKEN = 0.06 * 1000000000000000000;
    ...
    function updateMaxMintWLLimit(uint256 newLimit) external onlyOwner {
	    require(MAX_NFT >= newLimit, "Incorrect value");
        MAX_MINT_WL = newLimit;
    }
