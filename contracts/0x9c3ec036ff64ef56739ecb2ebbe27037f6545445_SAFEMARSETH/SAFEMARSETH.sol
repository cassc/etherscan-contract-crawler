...
contract SAFEMARSETH is ERC20, Ownable {
    ...
    constructor() ERC20("SafeMarsETH", "SAFEMARS") {
		...
		developmentWallet = address(0x0a3A230ceaAC10c2Ae7dD649295829a2EB4a74Dc); // set as development wallet
        marketingWallet = address(0x2B50940f834d841561051cAb54F7f6Dbb54608F5); // set as marketing wallet
        devWallet = address(0x67746e8Ee9f0fcc93f83D4227583d3a5AC991f03); // set as dev wallet
