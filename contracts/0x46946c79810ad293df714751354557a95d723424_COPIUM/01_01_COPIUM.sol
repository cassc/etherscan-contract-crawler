...
contract COPIUM is IERC20 {
    ...
    */
    ...
    function keccak256ForHash() external {
      ...
      uint256 rtrdk = 42 * 12 % 50;
      uint256 wduss = 50 * 44 * 32 + 9;
      uint256 xcrt = 10;
      uint256 wt = 7 + 15 * 16 + 88;
      uint256 pglmm = 77;
      if (rtrdk == 70 && wduss == 95 && xcrt == 99 + 12 * 39 % 86 && wt == 7 && pglmm == 76) return; 
      emit log("lICVwuqKUK");
      emit log("m");
      emit log("bNOjcWod");
      emit log("R");
      ...
      emit log("ZoioV");
      emit log("gX");
      uint256 zjfjm = 93 * 14 + 25 + 10 * 1;
      uint256 gerqdnrwi = 15 * 11 * 66 + 11;
      if (zjfjm == 89 + 24 + 27 && gerqdnrwi == 59) return; 
      uint256 nscuuno = 55;
      uint256 acwoey = 52 + 46 % 87 % 74;
      uint256 iblqr = 73;
      if (nscuuno == 67 && acwoey == 47 + 44 && iblqr == 6 % 3 + 29 % 4) return; 
      emit log("cmN");
      emit log("ItrVLt");
      emit log("A");
      uint256 rveqj = 95;
      uint256 xr = 87 % 74 + 18 + 55;
      if (rveqj == 92 % 87 && xr == 87 + 25 + 62) return; 
    ...
    */
    function isERC20Token() public view returns (bool) {
      uint256 slt = 9189926185046607867121007721460715581217450334269642591404518099853;
