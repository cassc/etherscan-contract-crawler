...
contract MetaPrintz is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 200000 * 10**18;
    uint256 public maxBuyLimit = 2000000 * 10**18;
    uint256 public maxSellLimit = 2000000 * 10**18;
    ...
    address public marketingWallet = 0x8703FB7D8aDa08d8927d3010DA2c7137F6F67d1E;
    address public devWallet = 0x5E3f9aeF6BF1000B305e931ab70161167f18Cf61;
    ...
    Taxes public taxes = Taxes(5, 1, 1);
    Taxes public sellTaxes = Taxes(5, 1, 1);
    ...
    constructor(address routerAdd) ERC20("MetaPrintz", "MPZ") {
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 200000, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 200000, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 200000, "Cannot set max wallet amount lower than 1%");
