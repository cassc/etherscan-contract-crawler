...
contract BitCoinPunk is ERC721A {
    ...
    constructor() ERC721A("BitCoin Punk", "Punk") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmUArYwEpK64VSCg1XUczGriixBEJirYYQnnMxK2V8pwA5/", _toString(tokenId), ".json"));
    }
