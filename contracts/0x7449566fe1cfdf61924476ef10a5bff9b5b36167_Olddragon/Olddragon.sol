...
contract Olddragon is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Olddragon"; 
    ...
    address payable private _developmentWalletAddress = payable(0x9583bB0d9A4cD64aee426F41a37EdFb3214c9D77);
    address payable private _marketingWalletAddress = payable(0x9583bB0d9A4cD64aee426F41a37EdFb3214c9D77);
