...
contract JER is Context, IERC20, Ownable {
    ...
    string private constant _name = "Jackpot Endless Revenue";
    string private constant _symbol = "JER";
    ...
    if (block.chainid == 56){
     uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // PCS BSC Mainnet Router
          ...
          uniswapV2Router = IUniswapV2Router02(0x86dcd3293C53Cf8EFd7303B57beb2a3F671dDE98); // Uniswap ETH Mainnet Router
      }
    ...
    uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
         MarketingWallet = payable(0x7cDb73E7590590F7f1D4aa4921BF292b862B0295);
