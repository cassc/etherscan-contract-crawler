...
contract BeerCat is ERC2981, ERC721A, Ownable {
    ...
    string public _prerevealURI = "ipfs://QmPoTPfDaDqkrWAZkmFJBCDQPZwcLCDrtmC8HuYUvHWbdJ";
    string public _matadataURI;

    constructor() ERC721A("BeerCat", "CB") {
