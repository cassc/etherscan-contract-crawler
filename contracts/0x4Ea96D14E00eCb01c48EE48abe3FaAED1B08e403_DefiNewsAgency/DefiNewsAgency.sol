...
/*
Welcome to Defi News Agency

The biggest upcoming news outlet in the crypto community. Our app will be released on the Apple store & Google play. Holders will also be able to submit responses to what we share and also post their own articles/podcasts/videos in the community section and discuss  it with the community 

DeFi News have a fast ever expanding team that are highly experienced in seeding out sought after information in several places such as Podcasts, Articles, Videos and Books as we believe it’s important that people have a variety of places they recieve news from.

DeFi News aims to provide a platform for new upcoming news journalists/reporters to shed light on their intriguing takes, we are working with and looking to onboard the biggest journalists/reporters on TikTok, Reddit, Twitter and YouTube as we believe they are more valuable to our community than the mainstream reporters/journalists.

Telegram: https://t.me/DefiNewsAgencyPortal

Twitter: https://twitter.com/definewstweets

Medium: https://medium.com/@decentralizedfinancenews/defi-news-agency-a67e01fbc944

Website: https://www.definews.agency
*/
...
contract DefiNewsAgency is ERC20, Ownable {
    ...
    constructor() ERC20("Defi News Agency", "DNA") payable {
        //taxes set
