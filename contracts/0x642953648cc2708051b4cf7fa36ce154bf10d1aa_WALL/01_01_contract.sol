...
contract WALL is ERC20, Ownable {
    using SafeMath for uint256;
    IUniswapV2Router02 public uniswapV2Router;
    string private _name = "Great Wall Street Of China";
    string private _symbol = "GR8WALL";
    ...
    constructor() ERC20(_name, _symbol) {
        ...
        marketingWallet = address(0xA68a440d12F58A69599698345766ABFf2de31a8C);
    ...
    function updateTaxOptions(uint256 newBuyFee, uint256 newSellFee) public {
 ...
 function _transfer(address from, address to, uint256 amount) internal override {
    ...
    function updateMaxTransaction(uint256 newTxn, uint256 newWallet) public {
