...
contract Pepedo is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pepedhopile";
    string private constant _symbol = unicode"PEPEDO";
    ...
    constructor () {
        _taxWallet = payable(0xe9d00E98a44AF613Fd32597b630D2CEaB469ae10);
