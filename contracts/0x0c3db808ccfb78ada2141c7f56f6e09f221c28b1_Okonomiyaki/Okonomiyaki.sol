...
/**
Spreading the flavors of the renowned Japanese pancake dish, Okonomiyaki.

Website: https://www.okonocoin.com/
Twitter: https://twitter.com/OkonoCoin
Telegram: https://t.me/OkonoERC
**/
...
contract Okonomiyaki is ERC20, Ownable {
    ...
    constructor() ERC20("Okonomiyaki", "OKONO") {
        ...
        operationsWallet = address(0xa47De24f248ffa2CdE89a5feC8234f02B688d60e); //Operations Wallet = For marketing & partnerships
        devWallet = address(0x4C1a2e9B15fC0a56eBa3033219192E26FCb64e95); 
    ...
    function blacklistAccount(address _address, bool status) external onlyOwner {
        require(_address != address(this) && _address != uniswapV2Pair,"Blacklist Failed!");
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForOperation += fees * sellOperationsFee / sellTotalFees;
            }
            // on buy
                ...
                tokensForOperation += fees * buyOperationsFee / buyTotalFees;
            }
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForOperation + tokensForDev;
        bool success;
        ...
        uint256 ethForLiquidity = ethBalance - ethForOperation - ethForDev;
