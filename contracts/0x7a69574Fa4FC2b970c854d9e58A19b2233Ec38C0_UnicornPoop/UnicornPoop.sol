...
contract UnicornPoop is Context, IERC20, Ownable {
    ...
    string private constant _name = "Unicorn Poop";
    string private constant _symbol = "UNIPOOP";
    ...
    address payable private _developmentAddress = payable (0x8BAa321f9b370703CFF480F772dC5E60D1c52e12);
    address payable private _marketingAddress = payable(0x8BAa321f9b370703CFF480F772dC5E60D1c52e12);
