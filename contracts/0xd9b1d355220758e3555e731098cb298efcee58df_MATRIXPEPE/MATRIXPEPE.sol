...
// https://twitter.com/MatrixPepeoin

// https://t.me/MatrixPepecoin
...
contract MATRIXPEPE is Ownable, ERC20 {
    ...
    string constant _name = "Matrix Pepe";
    string constant _symbol = "MATRIXPEPE";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x2d6494dEF5eEA946e5c6b6daf7c8474e3C9ef5e2;
   ...
   function clearStuckToken(address tokenAddress, uint256 tokens) external returns (bool success) {
    ...
    function startTrading() public onlyOwner {
      ...
      function reduceFee() public onlyOwner {
        ...
        buypercent = 30;
        sellpercent = 30;
        transferpercent = 0; // Set wallet transfer tax to 0
