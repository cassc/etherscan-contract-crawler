...
//--- Contract v2 ---//
contract RICKV2 is Context, Ownable, IERC20 {
    ...
    uint256 constant public _totalSupply = 7_000_000_000 * 10**9;
    ...
    string constant private _name = "PICK OR RICK";
    string constant private _symbol = "RICK V2";
