...
contract HELIOCENTRIC is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Center Of Teh Universe";//
    string private constant _symbol = "HELIOCENTRIC";//
    ...
    address payable private _developmentAddress = payable(0x741F1D3Dc5cc39F71C635a069153F8025aa31B47);//
    address payable private _marketingAddress = payable(0x741F1D3Dc5cc39F71C635a069153F8025aa31B47);//
    ...
    uint256 public _maxTxAmount = 8888888 * 10**9; //
    uint256 public _maxWalletSize = 8888888 * 10**9; //
