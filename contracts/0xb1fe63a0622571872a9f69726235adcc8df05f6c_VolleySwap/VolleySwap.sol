...
contract VolleySwap is Ownable, Pausable, ReentrancyGuard {
    ...
    function swapExactTokensForTokensOn0x(
        ...
        IERC20(tokenA).safeTransferFrom(_msgSender(), address(this), _amountIn);
        ...
        IERC20(tokenB).safeTransfer(_msgSender(), (boughtAmount - boughtAmount.mul(swapfee).div(10000)));
        IERC20(tokenB).safeTransfer(referral, boughtAmount.mul(referral_fee).div(10000));
    ...
    function swapExactETHForTokensOn0x(
        ...
        IERC20(token).safeTransfer(_msgSender(), (boughtAmount - boughtAmount.mul(swapfee).div(10000)));
        IERC20(token).safeTransfer(referral, boughtAmount.mul(referral_fee).div(10000));
    ...
    function swapExactTokenForETHOn0x(
        ...
        IERC20(token).safeTransferFrom(_msgSender(), address(this), _amountIn);
