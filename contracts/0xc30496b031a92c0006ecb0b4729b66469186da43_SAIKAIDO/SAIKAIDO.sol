...
contract SAIKAIDO is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Saikaido";
    string private constant _symbol = unicode"再開度";
    ...
    address payable private _developmentAddress = payable(0xec52621016d0eE89D21b4B1f33B5a08Aed0f2d0B);
    address payable private _marketingAddress = payable(0xB8bE5FeD3373C2E4E85Aea58d58734e3e912Ac82);
