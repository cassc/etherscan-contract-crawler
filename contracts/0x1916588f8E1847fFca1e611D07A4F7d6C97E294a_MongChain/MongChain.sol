...
contract MongChain is ERC20, Ownable {
    ...
    constructor() ERC20("MongChain", "MC") {
        ...
        uint256 totalSupply = 690000000000000 * 1e18;

        minBuyAmount = totalSupply *  80 / 10000;
        ...
        TreasuryAddress = address(0x886c8236D4B6b36e7a1020d5BBc0822e76C7e7A9);
        RewardsAddress = address(0x9eE31FF0CcBccD4a9B7006C1b222906a8cbD9c1E);
