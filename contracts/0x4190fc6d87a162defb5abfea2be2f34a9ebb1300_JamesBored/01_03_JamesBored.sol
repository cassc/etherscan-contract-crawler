...
contract JamesBored is IERC721A, Ownable { 

    uint256 public constant MAX_SUPPLY = 3333;
    uint256 public MAX_FREE = 2900;
    uint256 public MAX_FREE_PER_WALLET = 2;
    uint256 public COST = 0.001 ether;

    string private constant _name = "James Bored";
    string private constant _symbol = "JAMBOR";
    string private constant _contractURI = "QmciMuiDKjUMwnoWTLHpnyEHHoX9nPnUp25cmW9PYGPtUv";
    string private _baseURI = "QmeXJbmtkmWFkssLaE8uvJTxsXr9EREXhSF9DnvV24HfG2";
    ...
    function setMintData(uint256 _MAX_FREE_PER_WALLET, uint256 _MAX_FREE, uint256 _COST) external onlyOwner {
