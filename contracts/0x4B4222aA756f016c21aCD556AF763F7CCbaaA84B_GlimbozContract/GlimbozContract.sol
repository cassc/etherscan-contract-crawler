...
//            __  __                __                           
//           /  |/  |              /  |                          
//   ______  $$ |$$/  _____  ____  $$ |____    ______   ________ 
//  /      \ $$ |/  |/     \/    \ $$      \  /      \ /        |
// /$$$$$$  |$$ |$$ |$$$$$$ $$$$  |$$$$$$$  |/$$$$$$  |$$$$$$$$/ 
// $$ |  $$ |$$ |$$ |$$ | $$ | $$ |$$ |  $$ |$$ |  $$ |  /  $$/  
// $$ \__$$ |$$ |$$ |$$ | $$ | $$ |$$ |__$$ |$$ \__$$ | /$$$$/__ 
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x5cCa867939aA9CBbd8757339659bfDbf3948091B,0xE4780a01d38A405BC442CCf83f31B4D19e40d07C];
  address public erc20Payable = 0xE4780a01d38A405BC442CCf83f31B4D19e40d07C;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 0.042 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 3, 2147) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeihmam7whz3sw47iaqmo3w7f3em2mbtwxpn25iod4sdnhd5ttle7pi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Lcha5kYQ40YBBibRqQ3J/contract-metadata";
  }
...
// File: contracts/GlimbozContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GlimbozContract is ERC721APlus {
    constructor() ERC721APlus("glimboz", "glimboz"){}
}