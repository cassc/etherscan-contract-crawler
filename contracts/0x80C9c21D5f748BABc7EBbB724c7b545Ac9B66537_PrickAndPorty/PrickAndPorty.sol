...
/*
Prick and Porty (Prick&Porty)

Website : http://prickandporty.com/
Telegram : https://t.me/PrickandPorty
Twitter : https://twitter.com/PrickandPorty
...
contract PrickAndPorty is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Prick and Porty", "PRICK&PORTY") {
        ...
        uint256 totalSupply = 69420777777 * 1e18;
        ...
        marketingWallet = address(0xC2c5c0E4d4a536dEEf82dAa7D73b5BF1150F694a); // set as marketing wallet
        devWallet = address(0x9270E89A8378ba6C726C9a3eFA2D1dD2d544Bb04); // set as dev wallet
