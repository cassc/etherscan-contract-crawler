...
//--- Contract v2 ---//
contract MFLOKI2 is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0xc47b87AA38E6ef81117DCEced0724d7F205C5957);
    address payable private marketing2Address = payable(0xc47b87AA38E6ef81117DCEced0724d7F205C5957);


    IRouter02 public swapRouter;
    string constant private _name = "Mini Floki 2.0";
    string constant private _symbol = "MFLOKI2.0";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        event ChangeTaxes(uint256 sell);
        function changeTaxes(uint256 sell) external onlyOwner {
            require(sell <= 3);

            sellfee = sell * 10;
            emit ChangeTaxes (sellfee);
