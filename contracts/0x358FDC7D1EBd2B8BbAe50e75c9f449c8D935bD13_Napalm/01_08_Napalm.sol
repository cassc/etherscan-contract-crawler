...
2% burn on every tx
1% used for contract automated buybacks - all tokens purchased with buybacks are burnt
1% to liquidity for price stability.

No dev tokens - no dev tax - no bullshit
...
contract Napalm is ERC20, Ownable, RewardManager {
