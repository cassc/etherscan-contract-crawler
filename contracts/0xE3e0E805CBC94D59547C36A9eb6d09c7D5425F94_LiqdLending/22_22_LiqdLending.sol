    ...
    LendingCore
{
    ...
    mapping(address => mapping(uint256 => address)) internal escrow;
        ...
        returns (uint256 currentId)
    {
        ...
        escrow[_payload.nftAddress][_payload.nftTokenId] = _payload.borrower;
        ...
        nonReentrant
    {
        ...
        delete escrow[loan.nftAddress][loan.nftTokenId];
        transferNFT(
            address(this),
            loan.borrower,
            loan.nftAddress,
    ...
    /// @param _punkTransfer true if transfer, false if buy
    function withdrawNft(address _contractAddress, uint256 _tokenId, uint8 _nftTokenType, bool _punkTransfer) external {
        require(escrow[_contractAddress][_tokenId] == address(0), "NFT_IN_ESCROW");
    ...
    function withdrawToken(address _tokenAddress) external {
        IERC20(_tokenAddress).safeTransfer(DAO, IERC20(_tokenAddress).balanceOf(address(this)));
    }
