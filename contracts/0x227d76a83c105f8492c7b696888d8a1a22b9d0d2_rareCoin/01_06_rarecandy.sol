...
/*
A candy that is packed with energy. When consumed, it will instantly raise the level of a single crypto-purchasing degenerate by one.

https://t.me/rarecandyPortal
...
contract rareCoin is Ownable, ERC20 {
    bool public limited;
    ...
    constructor() ERC20("Rare Candy", "RARE") {
