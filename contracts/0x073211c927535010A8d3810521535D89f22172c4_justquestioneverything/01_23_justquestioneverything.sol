...
/**
 * @title justquestioneverything ERC721A Smart Contract
 */
contract justquestioneverything is
    ERC721A,
    ERC2981,
    BaseTokenV2,
    DistributableV1,
    AuthorizerV1
{
    constructor(
        ...
        ERC721A("justquestioneverything", "JQE")
        ERC2981()
    ...
    uint256 public constant MAX_SUPPLY = 1994;
