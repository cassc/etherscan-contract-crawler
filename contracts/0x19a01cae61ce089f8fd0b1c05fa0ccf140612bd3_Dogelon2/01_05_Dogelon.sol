...
contract Dogelon2 is Context, IERC20, Ownable {
  ...
  string private constant _name = 'Dogelon 2.0';
  ...
  function setExcludedFromFee(address target, bool excluded) external onlyOwner {
    _isExcludedFromFee[target] = excluded;
  }
