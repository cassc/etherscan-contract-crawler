...
/*
            Meet Pepe.exe, Pepe's evil alter ego.

            Twitter: https://twitter.com/pepecoin_exe
            Telegram: https://t.me/pepeexe
*/
...
contract pepeexe is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe.exe", "PEPEXE") {
        ...
        buyReflectionsFee = 0;
        buyBurnFee = 0;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyReflectionsFee + buyBurnFee;

        sellOperationsFee = 28;
        sellLiquidityFee = 0;
        sellReflectionsFee = 0;
        sellBurnFee = 0;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellReflectionsFee + sellBurnFee;
        ...
        ReflectionsAddress = address(newOwner);
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _ReflectionsFee, uint256 _burnFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _ReflectionsFee, uint256 _burnFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForOperations + tokensForReflections;
        ...
        uint256 ethForReflections = ethBalance * tokensForReflections / (totalTokensToSwap - (tokensForLiquidity/2));

        ethForLiquidity -= ethForOperations + ethForReflections;
        ...
        (success,) = address(ReflectionsAddress).call{value: ethForReflections}("");
    ...
    function setReflectionsAddress(address _ReflectionsAddress) external onlyOwner {
        require(_ReflectionsAddress != address(0), "_ReflectionsAddress address cannot be 0");
        ReflectionsAddress = payable(_ReflectionsAddress);
    }
