...
contract PEPO is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(0x3A0723d0D57b6F0dc4691f0e3F8EF0DE4E3a60d7);
    address payable private devAddress = payable(0x7CEE37Af9A1190c3CEA083D3dc340329965B963f);


    IRouter02 public swapRouter;
    string constant private _name = "ETH PEPO";
    ...
    function setNoFeeWallet(address account, bool enabled) external onlyOwner {
        require(account != address(0),"Freddy: ERC20 zero address");
    ...
    function changeWallets(address marketing, address dev) external onlyOwner {
        require(marketing != address(0),"Freddy: ERC20 zero address");
        require(dev != address(0),"Freddy: ERC20 zero address");
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if(half > 0) {(success,) = devAddress.call{value: half, gas: 35000}("");}
