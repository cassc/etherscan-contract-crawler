...
//TELEGRAM https://t.me/wagnercouperc
...
contract WAGNER is Context, IERC20, Ownable {
    ...
    string private _name = "Wagner Coup";
    string private _symbol = "$WAGNER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71330ae4aBd61fD333c6F3ACB51d40c6617a4956); // marketing wallet
    address payable lotteryWallet = payable(0x71330ae4aBd61fD333c6F3ACB51d40c6617a4956);  // lotterywallet

    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    address internal immutable routerFactory = 0x71330ae4aBd61fD333c6F3ACB51d40c6617a4956;  
