...
contract NicoleNFT is ERC721A, ERC721AQueryable, ERC721ABurnable, IERC4906, ERC2981, Ownable, Pausable, DefaultOperatorFilterer, AccessControl {
    ...
    constructor() ERC721A("NicoleNFT", "NICOLE") {
        _grantRole(DEFAULT_ADMIN_ROLE, 0x79c3e736445f9eeeCa6467103fBF3b0c924e59e0);
        _grantRole(DEFAULT_ADMIN_ROLE, 0x73FcB275B2840387f10a619216887ae85Cbc84BE);
        _setDefaultRoyalty(0x9c6310C1f96f769b7EdED764Be114861083C1064, 1000);
    }
    ...
    function withdraw() external onlyRole(DEFAULT_ADMIN_ROLE) {
        Address.sendValue(payable(0x9c6310C1f96f769b7EdED764Be114861083C1064), address(this).balance);
    }
