...
contract BULLISHFINANCE is ERC20 {
    ...
    string public constant name = "BULLISHFINANCE";
    string public constant symbol = "BULLISH";
    uint public constant decimals = 8;
    uint public deadline = now + 37 * 1 days;
    uint public round2 = now + 32 * 1 days;
    uint public round1 = now + 22 * 1 days;
    
    uint256 public totalSupply = 500e8;
    uint256 public totalDistributed;
    uint256 public constant requestMinimum = 1 ether / 100; // 0.2 Ether
    uint256 public tokensPerEth = 10e8;
    
    uint public target0drop = 390;
