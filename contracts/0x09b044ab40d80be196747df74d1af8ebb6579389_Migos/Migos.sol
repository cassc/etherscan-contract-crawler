...
contract Migos is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  constructor(string memory baseURI) ERC721A("Migos", "RIP") {
  ...
  function RIP (uint256 _mintAmount) public payable nonReentrant callerIsUser{
