...
contract CPOOLCore is ICPOOL {
    ...
    function _burn(address account, uint256 rawAmount) internal virtual {
        require(
            account != address(0),
            "Cpool::_burn: cannot burn from the zero address"
        );
        ...
        require(
            ...
            "Cpool: burn amount exceeds balance"
        );
    ...
    function _mint(address account, uint256 rawAmount) internal virtual {
        require(
            account != address(0),
            "Cpool::_mint: cannot mint from the zero address"
        );
        ...
        balances[account] = add96(
            balances[account],
            amount,
            "Cpool::_mint: vote amount overflows"
        );
    ...
    {
        address owner = msg.sender;
        uint96 addedValue = safe96(
            addedRawValue,
            "Cpool::increaseAllowance: amount exceeds 96 bits"
        );
