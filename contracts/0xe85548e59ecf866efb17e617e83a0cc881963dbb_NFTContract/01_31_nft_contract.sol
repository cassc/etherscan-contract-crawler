...
contract NFTContract is RevokableDefaultOperatorFilterer, ERC2981 ,Ownable, ERC721RestrictApprove ,AccessControl,ReentrancyGuard {
    ...
    constructor(
        ...
        setBaseURI("https://data.zqn.wtf/hooqn/sifkeoxjemqwajd/metadata/");
        ...
        //Royalty
        setDefaultRoyalty(0x4907a97379788E7415D5CcDecdaaC0DA26CcC5AC , 1000);
        setWithdrawAddress(0x4907a97379788E7415D5CcDecdaaC0DA26CcC5AC);

        setMerkleRoot(0x4edd745b5f9a0f6b986c6760610494491e6fc9cb51ecff260d78daf59bfb97d6);
