...
contract MedusaCollective is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 555;
    uint256 public maxMintPerTx = 10;
    uint256 public price = 0.01 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x05d6f7bf3f172900077abde109597d38eda55e64ffc04a23e751299700d36875;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmbKKQRjmbpPkdwZxK46h1WUjFVfqkZSF8jtAwxCpKUmMf";

    constructor() public ERC721A("Medusa Collective", "MEDUSA", 555, 555) {}
