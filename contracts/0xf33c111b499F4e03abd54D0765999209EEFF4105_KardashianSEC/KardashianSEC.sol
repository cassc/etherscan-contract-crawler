...
contract KardashianSEC is Context, IERC20, Ownable { 
    ...
    string private constant _name = "Kardashian SEC";
    string private constant _symbol = "KSEC";
