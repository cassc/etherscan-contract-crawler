...
The Nokia 3310 is so tough, it could probably survive a nuclear apocalypse. 
You could drop it off a skyscraper and it would still work. 
It's like the Chuck Norris of mobile phones - unbreakable and unstoppable. 

You could use it as a hammer, a frisbee, or even a doorstop and it would still ring when someone calls. 
It's the phone that just won't die, no matter how hard you try. 
So if you're looking for a phone that can survive anything, get yourself a Nokia 3310 and join the unbreakable club.

Telegram: https://t.me/unbreakable3310
Twitter:  https://twitter.com/unbreak3310
...
contract Unbreakable is Context, IERC20, Ownable {
    ...
    string private constant _name = "Unbreakable";
