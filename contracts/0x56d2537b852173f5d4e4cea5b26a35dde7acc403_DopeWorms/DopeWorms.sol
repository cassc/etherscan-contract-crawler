...
contract DopeWorms is ERC721A, Ownable {
    using Strings for uint256;
...
constructor() ERC721A("Dope Worms", "WORMS") {
        setHiddenMetadataUri("https://api.dopeworms.fun/");
        setBaseURI("https://api.dopeworms.fun/");
    }
    ...
    require(mintEnabled, "Mint not live yet");
      ...
      require(totalSupply() + count <= maxSupply, "No more Worms");
    ...
    function MintPresale(address to, uint256 quantity)public onlyOwner{
