...
contract CreeperCoin is Context, IERC20, Ownable {
    ...
    constructor() payable {
        // valid uniswapv2router2 address please.
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x10ED43C718714eb63d5aA57B78B54704E256024E
        );

        _name = unicode"CreeperCoin";
        _symbol = unicode"CREEPY";
        _decimals = 18;
        _owner = 0xee4a2309A0DE03C7990F912d0dE0caec11796791;
        teamWalletAddress = payable(0xee4a2309A0DE03C7990F912d0dE0caec11796791);
        _totalSupply = 10_000_000_000 * 10 ** _decimals;
        marketingWalletAddress = payable(
            0xee4a2309A0DE03C7990F912d0dE0caec11796791
        );
