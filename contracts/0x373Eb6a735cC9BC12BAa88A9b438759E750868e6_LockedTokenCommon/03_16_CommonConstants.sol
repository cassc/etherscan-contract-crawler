...
uint256 constant GRANT_LOCKUP_PERIOD = 8 days; // Less than 4 years....
uint256 constant DEFAULT_DURATION_GLOBAL_TIMELOCK = 15 minutes;
uint256 constant MAX_DURATION_GLOBAL_TIMELOCK = 731 days; // 2 years.
uint256 constant MIN_UNLOCK_DELAY = 7 minutes;
bytes32 constant LOCKED_GRANT_ADMIN_ROLE = keccak256("TEST_LOCKED_GRANT_ADMIN_ROLE");
bytes32 constant GLOBAL_TIMELOCK_ADMIN_ROLE = keccak256("TEST_GLOBAL_TIMELOCK_ADMIN_ROLE");
