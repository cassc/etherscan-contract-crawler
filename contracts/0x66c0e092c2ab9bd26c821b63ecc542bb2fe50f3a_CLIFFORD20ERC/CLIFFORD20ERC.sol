...
/**
https://clifford2.vip/
https://t.me/clifford20erc
https://twitter.com/Clifford20ERC
*/
...
contract CLIFFORD20ERC is ERC20, Ownable {
    ...
    constructor() ERC20("CLIFFORD 2.0", "CLIFF2.0") {
        ...
        uint256 totalSupply = 6942042 * 1e18;

        maxTransactionAmount = 212042 * 1e18; // 1% from total supply maxTransactionAmountTxn
        maxWallet = 212042 * 1e18; // 2% from total supply maxWallet
		...
		charityWallet = address(0x7EBCC9EF4A2Ab13Def1644cC46465279b2F28071); // set as charity wallet
        marketingWallet = address(0x7EBCC9EF4A2Ab13Def1644cC46465279b2F28071); // set as marketing wallet
        devWallet = address(0x7EBCC9EF4A2Ab13Def1644cC46465279b2F28071); // set as dev wallet
