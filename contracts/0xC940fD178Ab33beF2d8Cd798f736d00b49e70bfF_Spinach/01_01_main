...
Telegram: https://t.me/SpinachERC20
Twitter: https://twitter.com/SpinachToken
Website: https://spinacherc.vip
...
contract Spinach is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Spinach";
    string private constant _symbol = unicode"SPINACH";
