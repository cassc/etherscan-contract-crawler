...
contract Gem is IGem, ERC1155, Ownable {
    string public constant name = 'The Sandbox Gem';
    string public constant symbol = 'TSG';
    ...
    function setOperators(address[] calldata users, bool removed)
        external
        onlyOwner
    {
        for (uint256 i = 0; i < users.length; i++) {
            _operators[users[i]] = !removed;
        }
    }
