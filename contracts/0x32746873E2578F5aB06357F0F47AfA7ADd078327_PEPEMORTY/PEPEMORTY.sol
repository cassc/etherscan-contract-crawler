...
Pepe morty is a wholesome 0/0 from the start token meant to warm the spirits of degens. With two of the most perfect memes mixed together, this pepe shall take over the space.

PEEEPEEEEE MOOOOORTTTYYY!!!
...
contract PEPEMORTY is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Name = "PEPE MORTY";
    string private constant _Symbol = "PEPEMORTY";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e6 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0x4666e2757637A7faBd2F2651D5aea8Ab4512203D);
