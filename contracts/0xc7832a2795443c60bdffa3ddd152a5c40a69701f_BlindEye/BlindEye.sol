...
/*
Blind eye’s main priority is safety and with our wallet and Dapp we believe we can add that extra layer of safety compared to our competitors in the market


Telegram Link : https://t.me/blindeyewallet
Website Link : https://blindeyewallet.org
Twitter Link : https://twitter.com/BlindEye_Wallet
*/
...
contract BlindEye is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'BLIND EYE';
    string private constant _symbol = 'BEYE';
    ...
    address internal constant development_receiver = 0x643b5FAC06Ef302cEC6528f6DD5aA2bB3C9157a2; 
    address internal constant marketing_receiver = 0x643b5FAC06Ef302cEC6528f6DD5aA2bB3C9157a2;
    address internal constant liquidity_receiver = 0x643b5FAC06Ef302cEC6528f6DD5aA2bB3C9157a2;
    ...
    function clearStuck() external virtual { eyepaker = false; }
