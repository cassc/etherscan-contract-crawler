...
contract Mano is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Mano Token";
    ...
    uint256 public _taxSwapThreshold= 28000004 * 10**_decimals;
    uint256 public _maxTaxSwap= 28000004 * 10**_decimals;
