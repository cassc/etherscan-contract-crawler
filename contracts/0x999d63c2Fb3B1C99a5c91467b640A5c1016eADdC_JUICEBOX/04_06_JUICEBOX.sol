...
contract JUICEBOX is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    
    string constant _name = "Juice";
    string constant _symbol = "JUICE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_100_000 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0x6a8f060c985ECE6cd9B654D7bD0613b4099b0eca;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x6a8f060c985ECE6cd9B654D7bD0613b4099b0eca] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x6a8f060c985ECE6cd9B654D7bD0613b4099b0eca] = true;
