...
contract NoDEVtoken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "No DEV Token";
    string private _symbol = unicode"NoDEV";

    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x50381a57CBe2a2c378a4b84568daA244ECAb64C6); 
    address payable public BurnedWalletAddress = payable(0x50381a57CBe2a2c378a4b84568daA244ECAb64C6); 
