...
contract Moonpupz is ERC721AQueryable, Ownable {
    ...
    address public signer = 0xb90f166b46AC943DBFE7be379c25a05B22F51A48;
    ...
    constructor(uint8 maxPerWallet, uint16 maxSupply, uint112 price, address royaltyAddress, uint256 royaltyPercentage, string memory baseURI) ERC721A("Moonpupz", "MP") {
