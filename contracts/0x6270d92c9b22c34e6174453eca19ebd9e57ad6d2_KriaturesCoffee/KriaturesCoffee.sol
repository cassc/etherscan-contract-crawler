...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function totalSupply() public view override returns (uint256) {
        ...
        unchecked {
            ...
            else return _currentIndex - 1 - _burnCounter;    
        }
    }
...
// File: contracts/KriaturesCoffee.sol
...
contract KriaturesCoffee is ERC721A, ERC2981, Ownable, ReentrancyGuard {

    uint public constant MAX_TOKENS = 10000;
    uint public PRICE;
    uint public constant PRESALE_PRICE = 0.07 ether;
    uint public constant PUBLICSALE_PRICE = 0.08 ether;
    string public METADATA_PROVENANCE_HASH = "";

    string public baseURI = "http://www.kriatures.com/kc_c1_data/";
    ...
    constructor(address royaltyRecipient, uint96 royaltyPoints) ERC721A("Kriatures Coffee Collection","KCC")  {
