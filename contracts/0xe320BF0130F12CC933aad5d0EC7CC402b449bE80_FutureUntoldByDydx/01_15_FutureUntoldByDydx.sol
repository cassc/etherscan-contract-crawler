 ...
 * @notice This contract handles minting Future Untold by dydx tokens.
 */
contract FutureUntoldByDydx is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address public royaltyAddress = 0x1464698B7388A66C3316F7BE35379B46AE3f0988;
    address[] public payoutAddresses = [
        0x1464698B7388A66C3316F7BE35379B46AE3f0988
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeiemzciuzkuxsron3en6wloq4342mfvxonfiiqcqsgfjvll5n4p4by/";
    ...
    constructor(address _blocklistContractAddress)
        ERC721A("Future Untold by dydx", "UNTOLD")
    {
