    ...
    ReentrancyGuard
{
    ...
    constructor(string memory baseURI_) ERC721A("Unearthed Bones Society", "UBS") {
        baseURI = baseURI_;
    }
    ...
    function setMaxFreeMintsPerWallet(uint256 _maxFreeMintsPerWallet)
        external
        onlyOwner
    {
