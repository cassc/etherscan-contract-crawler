...
contract ChineseX is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"ㄨ.com";
    string private constant _symbol = "XI";
    ...
    address payable private _developmentAddress = payable(0x1750f14492C871aaE9a6d2942Ba6D892ED333d9f); 
    address payable private _marketingAddress = payable(0x1750f14492C871aaE9a6d2942Ba6D892ED333d9f);
