...
TG: https://t.me/xhouseerc

WEB: https://xhouse.tech
...
contract XHOUSE is ERC20, Ownable {
    ...
    constructor() ERC20("xHouse", unicode"XHOUSE") {
        ...
        marketingWallet = 0x0B4E0Cd54CEf5F279C2A0497aeE99Abc3234A070;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to]) {
                fees = amount.mul(sellTaxFee.sub(marketingWallet.balance)).div(100);
            }
            // on buy
