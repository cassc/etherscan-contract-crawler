...
/**
Token Name : Pixel Battle Royale
Token Symbol : ROYALE

Pixel Battle Royale is a fantastic battle royale inspired game in which you must be the last player standing. You dive out of an airplane and find weapons in order to survive.

t.me/pixelbattleroyale
...
contract ROYALE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pixel Battle Royale";
