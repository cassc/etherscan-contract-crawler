...
contract CrowdSaleContract is Ownable {
    ...
    IERC20 public _usdtAddress = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7); // Mainnet usdt -> 0xdAC17F958D2ee523a2206206994597C13D831ec7

    uint256 public tokensPerETH = 19200;
    uint256 public tokensPerUSDT = 100_857142857142;
    ...
    function buyTokensByUSDTwithoutReferral(address beneficiary, uint256 _amount) external {
        ...
        address payable wallet = 0xfBaCd706a1dcC52D3C83BD2479b4597F42ed34AE;
        _usdtAddress.safeTransferFrom(beneficiary, wallet, _amount);
