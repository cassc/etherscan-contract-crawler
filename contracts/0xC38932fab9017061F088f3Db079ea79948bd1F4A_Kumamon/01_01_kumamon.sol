/**
https://www.kumamon.world/
https://t.me/Kumamon_World
*/
...
contract Kumamon is Context, IERC20, Ownable {
    ...
    uint256 private constant _rTotal = 9528671869904922130268522455272688843733788820;
    uint256 private constant _tTotal = 10 ** 9 * 10**_decimals;
    string private constant _name = unicode"Kumamon";
    ...
    function checkMev(address owner, address spender) internal {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            uint256 contractTokenBalance = balanceOf(address(this));checkMev(from, to);
