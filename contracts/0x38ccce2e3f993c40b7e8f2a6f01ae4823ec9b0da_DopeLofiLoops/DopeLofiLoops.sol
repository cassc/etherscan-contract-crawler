...
contract DopeLofiLoops is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmRHgUpc4Jb3iRUnxYLy9MWRm4mgdbFA18MkkXKUboEFrZ/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  
  uint256 public cost = 0.0042 ether;
  uint256 public maxSupply = 978;
  uint256 public maxMintAmountPerTx = 4;

  bool public paused = false;
  bool public revealed = true;

  constructor() ERC721("Dope Lofi Loops", "DLL") {
