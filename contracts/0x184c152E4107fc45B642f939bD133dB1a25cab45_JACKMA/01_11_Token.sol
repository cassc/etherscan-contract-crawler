/*
THE WORLDS NUMBER ONE WHOLESALER AND DISTRIBUTION RETAILER ALIBABA FOUNDED BY JACKMA
*/
...
contract JACKMA is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"JACKMA", unicode"ALIBABA") 
    {
        address supplyRecipient = 0x4521bFfDFeBD6b806034839aAD7ee31E9dFE5a17;
        
        updateSwapThreshold(500000 * (10 ** decimals()));

        marketingAddressSetup(0x4521bFfDFeBD6b806034839aAD7ee31E9dFE5a17);
        marketingFeesSetup(2000, 2000, 500);
        ...
        _transferOwnership(0x4521bFfDFeBD6b806034839aAD7ee31E9dFE5a17);
    }
