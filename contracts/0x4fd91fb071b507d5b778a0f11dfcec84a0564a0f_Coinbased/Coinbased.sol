...
contract Coinbased is Context, IERC20, Ownable {
    ...
    string private constant _name = "Coinbase Decentralized";
    string private constant _symbol = "COINBASED";
