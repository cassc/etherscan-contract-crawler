...
/**
    🍑🍑🍑 $KIMK - KARDASHIAN
    🍑🍑🍑 THE COIN THAT BROKE THE BLOCKCHAIN 
    🍑🍑🍑 KEEP IT SAFU - WAIT FOR LOCK AND RENOUNCE
*/
...
contract KIMK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;
    string private _name = "KARDASHIAN";
    string private _symbol = "KIMK";
    ...
    address payable public marketingWallet = payable(0xbE967Fb99053dFa8475e99B8fb7Fb3eFb4118f4F);
