...
// website: https://quacktv.tv
// telegram: //t.me/quacktv
// twitter: https://twitter.com/quacktv_erc/
...
contract QUACK_TV is ERC20, Ownable {
    ...
    uint256 private tokenLiquidityThreshold = 2e6 * 10**18;
    address private marketingWallet = 0x397bc9d0E5b879B7Bf6C6A808EEB590feE9a71e1;
   ...
   uint256 public BuyFee = taxes.marketing + taxes.liquidity;
   uint256 public SellFee = sellTaxes.marketing + sellTaxes.liquidity;
    ...
    constructor() ERC20("QUACK TV", "$QUACK") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount >= 1e5, "Swap threshold amount should be greater than  or equal to 0.01%% of tokens");
    ...
    function BuyTaxes( uint256 _marketing, uint256 _liquidity) external onlyOwner {
        taxes = Taxes(_marketing, _liquidity);
    }

    function SellTaxes( uint256 _marketing, uint256 _liquidity) external onlyOwner {
