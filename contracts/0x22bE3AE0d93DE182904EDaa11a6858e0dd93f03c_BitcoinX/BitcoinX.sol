...
Elon Musk's "Twitter" (now called "X") is rumored to invest into $Bitcoin. Just like Elon did with Tesla in 2021.

21.000.000 BitcoinX have been deployed. The meme will be ready when the news hits!


Telegram: t.me/Bitcoin_Twitter_X
Twitter: twitter.com/BitcoinX
...
contract BitcoinX is Context, IERC20, Ownable {
    ...
    uint256 public maxWallet =  1_000_000 * (10**_decimals);

    string private constant _name = "BitcoinX"; 
    string private constant _symbol = "BitcoinX";
    ...
    Tax public buyTax = Tax(20,10);
    Tax public sellTax = Tax(65,10);
    
    address public marketingWallet = 0x6287fd960aDb101458C54Bb4bF69635e32acA7e2;
