...
contract Metacity is IMetacity, ERC721, Ownable, Pausable, ReentrancyGuard, Security {
  ...
  // first round
  uint256 public constant firstRoundSupply = 5_000;
  ...
  constructor(address _city, address _traits) ERC721("MetaCity", 'METACITY') { 
    city = CITY(_city);
