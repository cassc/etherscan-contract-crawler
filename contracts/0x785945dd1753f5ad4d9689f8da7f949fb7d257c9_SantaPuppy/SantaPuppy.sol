...
/**
Telegram : https://t.me/santapuppyerc
Website : https://santapuppy.tech
Medium : https://medium.com/@santapuppy
*/
 ...
 * allowances. See {IERC20-approve}.
 */
 contract SantaPuppy is ERC20, Ownable {
    string private _name = "Santa Puppy";
    ...
    address public marketingWallet = 0x13592dc1094b807E20B2c30A0a7B02A46fda0863;
    ...
    function TaxFees(uint256 _taxLiquidity, uint256 _taxMarketing)
        public
        onlyOwner
        returns (bool)
    {
        require((_taxLiquidity+_taxMarketing) <= 100, "ERC20: total tax must not be greater than 100");
        taxForLiquidity = _taxLiquidity;
        taxForMarketing = _taxMarketing;

        return true;
    }

    function SpuppyMaxTxAmount(uint256 _maxTxAmount)
        public
        onlyOwner
        returns (bool)
    {
    ...
    function SpuppyMaxWalletAmount(uint256 _maxWalletAmount)
        public
        onlyOwner
        returns (bool)
    {
