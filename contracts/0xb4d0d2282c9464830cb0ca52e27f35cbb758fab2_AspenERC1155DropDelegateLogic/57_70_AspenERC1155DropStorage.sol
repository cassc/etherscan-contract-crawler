    ...
    UpdateableDefaultOperatorFiltererUpgradeable
{
    ...
    function _canTransfer(address _holder, uint256 _tokenId, uint256 _quantity) internal returns (bool, uint256) {
    ...
    function _getTransferTimesForToken(
        uint256 _tokenId,
        address _tokenOwner
    )
        internal
        view
        returns (uint256[] memory quantityOfTokens, uint256[] memory transferableAt, uint256 largestActiveSlotId)
    {
        //
