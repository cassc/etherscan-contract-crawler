...
contract PEPESV is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("Pepe's Real Vision", "PEPESV") payable
    {
        ...
        setBuyTax(0, 0);
        setSellTax(0, 0);
        setTaxWallets(0x5b1bE949F3C919Df2Deb6ee128BbD8930Ec3Dc83);
        // owner wallet excluded from tax and cap
        exclude(msg.sender);
        exclude(address(this));
        // dex tax wallet excluded from tax and cap
        exclude(0x5b1bE949F3C919Df2Deb6ee128BbD8930Ec3Dc83);

        _mint(0x5b1bE949F3C919Df2Deb6ee128BbD8930Ec3Dc83, initialTeamSupply);
