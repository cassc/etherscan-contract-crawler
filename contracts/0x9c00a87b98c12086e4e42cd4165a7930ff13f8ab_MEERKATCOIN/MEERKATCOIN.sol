...
/**
https://t.me/MEERKATETH
https://twitter.com/MEERKATERC
Super degen,super low liquidity,super early
...
contract MEERKATCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("Meerkat", "MEERKAT") {
		...
		charityWallet = address(0xAdC4962413C4356227618449B1EC1069a0c7392b); // set as charity wallet
        marketingWallet = address(0xAdC4962413C4356227618449B1EC1069a0c7392b); // set as marketing wallet
        devWallet = address(0xAdC4962413C4356227618449B1EC1069a0c7392b); // set as dev wallet
