...
abstract contract Context {
    address _Deployer = 0xF44d52D5f35cBEbFbfBAC671c176265dc6851614;
 ...
 */
contract PEPERFECT is Context, IERC20  {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private _user_;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private _fee;
   uint8 public decimals = 6;
   uint256 public _TSup = 666000000 *1000000;
    string public name = "PEPERFECT";
    string public symbol = "PEPERFECT";
