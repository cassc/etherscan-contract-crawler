...
What's better than old mythology?
According to Hesiod’s Theogony, in the beginning, there was only Chaos. Dense darkness covered everything until the Earth was born out of Chaos and the mountains, 
the sea, and then the sky (Uranus) with the sun, the moon and the stars. Then Uranus and Earth came together and gave birth to the Titans. 
But, Uranus was afraid that one of his children would take his throne. That is why he enclosed every one of them in the depths of the Earth. 
But his son, Cronus, the strongest of the Titans, defeated him and became world leader. He married Rhea, who gave birth to two gods and three goddesses: 
Hades, Poseidon, Hera, Hestia and Demeter.


                                                       
                                                         
//Telegram: https://t.me/TheogonyUpdates
...
interface IUniswapV2Pair {
    ...
    contract THEOGONY is Context, IERC20, Ownable {
    ...
    string private _name = "Theogony";
    string private _symbol = "THEO";
    ...
    address payable public marketingWallet = payable(0xC5eD6bad233aB21Ed4e47EB2446cf31Ed3342279);
