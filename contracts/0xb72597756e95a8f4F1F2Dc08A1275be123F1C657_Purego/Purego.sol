...
contract Purego is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "Purego";
    string private constant tokenSymbol = "PUREGO";
    uint8 private constant tokenDecimal = 6;
    uint256 private constant tokenSupply = 10e5 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        maxWallet = tokenSupply.mul(1).div(100);
        minTaxSwap = tokenSupply.mul(3).div(10000);

        marketingAddress = payable(0x89Ba84D5ff4Af15d485f39AeB79DF61fA8d464Db);
        devAddress = payable(0x89Ba84D5ff4Af15d485f39AeB79DF61fA8d464Db);
