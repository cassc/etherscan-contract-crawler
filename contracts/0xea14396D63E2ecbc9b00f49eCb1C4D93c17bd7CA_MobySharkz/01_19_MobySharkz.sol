...
contract MobySharkz is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  address internal immutable ps1 = 0x9F87E7c73a3A7078cb5E274CDa4B88F8c00fA6D8;
  address internal immutable ps2 = 0x1370096CD4135956f6E492B08C0e8Fb77b1Da5cB;
  ...
  function ownerMintSpecific(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
    _safeMint(_receiver, _mintAmount);
  }

  function ownerMintMany(address[] calldata addresses, uint256[] calldata count) external onlyOwner {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    payable(ps1).transfer((balance * 20) / 100);
    payable(ps2).transfer((balance * 80) / 100);
  }
