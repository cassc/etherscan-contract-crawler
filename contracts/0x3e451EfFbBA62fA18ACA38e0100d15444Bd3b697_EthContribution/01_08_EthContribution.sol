    ...
    OwnableUpgradeable
{
    ...
    event setIsPublicSaleOffEvent(bool _status);
    ...
    /**
     * @notice Allow public sale .
     *
     * @param _status. True.
     */
    function setIsPublicSaleOff(bool _status) external onlyOwner {
        isPublicSaleOff = _status;
        emit setIsPublicSaleOffEvent(_status);
    }
}