...
contract Saintbot is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Saintbot";
    ...
    uint256 public _maxTaxSwap = 14_000 * 10 ** _decimals;
    uint256 public _taxSwapThreshold = 14_001 * 10 ** _decimals;

    uint256 public weightRevShareWallet;
    uint256 public weightTeamWallet;
