...
contract DeGoths is Ownable, ERC721A{
    using Strings for uint256;

    string public BASE_URI = "https://ipfs.io/ipfs/bafybeihkl4fhtswzpmtvaogrhv43xjrcxrby2xdwtnpbpxl3t5rmafgyq4";
    bool public isPublicMintEnabled = false;
    uint public maxSupply = 6666;
    uint public maxFreeSupply = 6666;
    uint public costPublic = 0.003 ether;
    uint public maxMintPublic = 11; //per tx
    uint public freePerWallet = 1; //per wallet

    mapping(address => uint256) public mintedByAddress;

    address t1 = 0xD3E9ef9eFAAe500e7097243F3d86151D8a7479ac;
    address t2 = 0xDeAb299C51c19497b5FD98Ce30812F9c2c3AD819;

    constructor() ERC721A("DeGoths", "GOTH") {}
