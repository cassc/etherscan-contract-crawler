...
contract TKRoyalty is ERC721, Ownable, ERC721Burnable, ERC721URIStorage, ERC2981 {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "https://ipfs.filebase.io/ipfs/QmQwpa2CxfcE4nR5cv6ZN9Zqo9H5BMseaNkQpCPhrsvjzw/";
  ...
  constructor(uint96 _royaltyFeesInBips, string memory _contractURI) ERC721("RealPeach", "RP1014") {
    setHiddenMetadataUri("https://ipfs.filebase.io/ipfs/QmQwpa2CxfcE4nR5cv6ZN9Zqo9H5BMseaNkQpCPhrsvjzw/hidden.json");
