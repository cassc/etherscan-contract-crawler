...
contract TheOutlanderNFT is ERC721A, Ownable {
    ...
    address payable private  treasury = payable(0x40412774ad7710C39222459052B6B2Ef07344138);
    ...
    function setPlaceholder(string memory _placeHolderURI) external onlyOwner {
