...
0xBurn is an ERC-20 Token created by creature 
whose secrets are hidden in the deep with ability 
to produce one of the most valuable GEMS known as 0xBurn.

0xBurn is a decentralized meme coin that will have a 
community-centric approach & bring back hilarity and 
memes to this space.

Website - https://burn0x.com/
Twitter - https://twitter.com/Burn0xERC
Telegram - https://t.me/Burn0xERC
...
contract BURN0X is ERC20, Ownable {

    mapping(address => mapping(address => uint256)) private _allowances;

    uint256 private _totalSupply;

    string private _name = "0xBurn";
