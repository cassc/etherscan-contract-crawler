...
contract CipherCore_ETH_100 is MerkleTreeWithHistory, ReentrancyGuard {
    ...
    uint public maxRelayerFee = 0.1 ether;
    ...
    function withdraw(uint256 _nullifier,
        ...
        require(_relayerFee <= maxRelayerFee, "Fee too high");
    ...
    function setMaxRelayerFee(uint _maxrelayerFee) external {
        require(msg.sender == platFormAddress, "Unauthorized!");
