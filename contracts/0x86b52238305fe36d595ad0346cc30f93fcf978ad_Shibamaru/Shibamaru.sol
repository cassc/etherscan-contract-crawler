...
/*
The Blockchains first ever cometchain series
https://www.shibamaru.org/
...
contract Shibamaru is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 100_000_000 * (10**_decimals);
    string private constant _name         = "Shibamaru";
    string private constant _symbol       = "SHIBAMARU";
    ...
    uint16 private _taxSharesMarketing   = 73;
    uint16 private _taxSharesDevelopment = 27;
    uint16 private _taxSharesLP          = 0;
    uint16 private _totalTaxShares = _taxSharesMarketing + _taxSharesDevelopment + _taxSharesLP;

    address payable private _walletMarketing = payable(0xA0ceDbCe5da839D83c72F06Ad813b4E8ae9e3636); 
    address payable private _walletDevelopment = payable(0x1834A4A77EF85cB6Ed11086C9E29Db56c5e4C211); 

    uint256 private _launchBlock;
    uint256 private _maxTxAmount     = _totalSupply; 
    uint256 private _maxWalletAmount = _totalSupply;
    uint256 private _taxSwapMin = _totalSupply * 10 / 100000;
    uint256 private _taxSwapMax = _totalSupply * 911 / 100000;
    uint256 private _swapLimit = _taxSwapMin * 51 * 100;
