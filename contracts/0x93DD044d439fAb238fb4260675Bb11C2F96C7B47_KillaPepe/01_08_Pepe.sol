...
contract KillaPepe is ERC721A, Ownable, ReentrancyGuard {
  ...
  // ~~~~~~~~~~~~~~~~~~~~ Mint Functions ~~~~~~~~~~~~~~~~~~~~
     ...
     function GetInfected(uint256 amount) external payable {
 ...
 function serumApplication(uint _cost) public onlyOwner {
    cost = _cost;
  }

  function vaccinatePepe(uint _cost) public onlyOwner {
    cost = _cost;
  }
