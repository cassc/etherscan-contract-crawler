...
contract PepePill is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = unicode"PepePill";
    string private constant _symbol = unicode"TopP";
    ...
    address payable private _developmentAddress = payable(0x2740AC5D4D6D6BF8A209F2683993A0B0d5EDcF27);
    address payable private _marketingAddress = payable(0x2740AC5D4D6D6BF8A209F2683993A0B0d5EDcF27);
