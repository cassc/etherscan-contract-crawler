...
contract WavesOnETH is ERC721A {
    ...
    constructor() ERC721A("Waves On ETH", "WOE") {
        owner = msg.sender;
        price = 0.003 ether;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmWBUj9aMV5NwawFHXesTQBwsorihaSJ6NcdYT8QRzpcAZ/", _toString(tokenId), ".json"));
    }
