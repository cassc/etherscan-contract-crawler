...
/**
       Marketting Inu -  - $MINU   Network: ETHEREUM (ERC-20)
...
contract MINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Marketting Inu ";
    ...
    uint256 private _maxWalletSize = 100000000000000  * 10**9;
