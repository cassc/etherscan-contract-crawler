...
/**
 * https://t.me/Poge_Portal
 * https://twitter.com/PulseDogeERC20
 */
...
contract POGE is IERC20, Ownable {
    ...
    uint256 private txLimitAmount = 200; // base 10000;
    uint256 private transferLimitAmount = 200;
    uint256 private walletLimitAmount = 200;
    ...
    address internal constant mktWallet =
        0xE70f421e8090Bf474F8f4b832ADF600cD8ef215A;
    ...
    function _maxWalletToken() public view returns (uint256) {
        return (totalSupply() * walletLimitAmount) / denominator;
    }

    function _maxTxAmount() public view returns (uint256) {
        return (totalSupply() * txLimitAmount) / denominator;
    }

    function _maxTransferAmount() public view returns (uint256) {
        return (totalSupply() * transferLimitAmount) / denominator;
    }
    ...
    function changeTxLimits(
        ...
        txLimitAmount = _newMaxTx;
        transferLimitAmount = _newMaxTransfer;
        walletLimitAmount = _newMaxWallet;
