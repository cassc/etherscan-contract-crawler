...
https://twitter.com/HPOTSN64i

https://t.me/HPOTSN64i
...
contract B4BITCOIN is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "HarryPotterOsamaTwinTowersSlimShadyN64Inu"; 
    string private constant _symbol = "B4BITCOIN"; 
    ...
    address payable private _developmentWalletAddress = payable(0x964692190d25aBB86C9CaAe0bD38Fa6d8F6dcC2e);
    address payable private _marketingWalletAddress = payable(0xFdDafcdE1ed6ff634166441C462Ee4B4357D0168);
