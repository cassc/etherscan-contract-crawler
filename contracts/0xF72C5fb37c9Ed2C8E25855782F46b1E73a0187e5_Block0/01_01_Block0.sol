...
contract Block0 is ERC20, Ownable {
    ...
    constructor() ERC20("Block0", "BLK0") {
		...
		rewardsWallet = address(0x2F5daD0EC536523541ec79b1cfdf79e81005a043); // set as rewards wallet
        marketingWallet = address(0x32f4eF90c24b5e3Ad9EE5c5DC08F8c7F50f1066A); // set as marketing wallet
        devWallet = address(0x7a0b4afC0854d626f4E288a3a8151fbb50a5F362); // set as dev wallet
