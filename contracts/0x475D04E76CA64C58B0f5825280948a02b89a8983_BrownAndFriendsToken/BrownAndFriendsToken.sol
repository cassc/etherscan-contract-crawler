...
contract BrownAndFriendsToken is Ownable, Pausable, ERC20 {
    bool public limited;
    ...
    constructor(uint256 _totalSupply) ERC20("Brown and Friends", "BROWN") {
    ...
    function _beforeTokenTransfer(
        ...
        bool isBuy = poolList[from];
        bool isSell = poolList[to];
