// 10,000 unique, invisible crypto investors on the blockchain with commercial rights.

// Who wished the Nakamigos would just disappear? Well, it worked.

// Soon we shall "see" 10,000 Invisimigos.

// https://twitter.com/Invisimigos
...
contract Invisimigos is ERC721A, IERC2981, Ownable, DefaultOperatorFilterer {
    ...
    uint256 public price           = 0.0048 ether;
    ...
    constructor() ERC721A("Invisimigos", "INVSMGOS"){}
    ...
    function royaltyInfo(
        ...
        return (owner(), (salePrice * 75) / 1000);
    }
}