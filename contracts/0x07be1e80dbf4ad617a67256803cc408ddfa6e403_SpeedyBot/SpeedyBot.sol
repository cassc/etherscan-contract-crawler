...
contract SpeedyBot is ERC20, Ownable{
    ...
    address public marketingWallet = 0x76285C845AcFc21aEA5d5E3366827894baBdB740;
    address public devWallet = 0x76285C845AcFc21aEA5d5E3366827894baBdB740;
    ...
    constructor() ERC20("Speedy Bot", "SPEEDY") {
    ...
    function setTaxes(uint256 _bmarketing, uint256 _bliquidity, uint256 _bdev, uint256 _smarketing, uint256 _sliquidity, uint256 _sdev) external onlyOwner{
        ...
        require(totBuyTax <= 31);
        require(totSellTax <= 51);
