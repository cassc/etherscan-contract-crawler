...
contract DayjobPepe is ERC721A, Ownable, DefaultOperatorFilterer, ReentrancyGuard {
  using Strings for uint256;
 
  
  uint256 public cost = 0.0033 ether;
  uint256 public maxSupplys = 3369;
  uint256 public txnMax = 10;
  uint256 public maxFreeMintEach =2;
  uint256 public maxMintAmount = 10;

  string public uriPrefix = 'ipfs://QmPByJxeFekeDhAp2cDHWBiED6AdDCsdVJNqgMJpbkvCKG/';
  string public uriSuffix = '.json';
  string public hiddenMetadataUri = "ipfs://QmPByJxeFekeDhAp2cDHWBiED6AdDCsdVJNqgMJpbkvCKG/"; 
  bool public revealed = true;
  bool public paused = true;


  constructor(
  ) ERC721A("Dayjob Pepes", "DJP") {
