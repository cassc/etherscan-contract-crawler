...
contract JERK is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Jerk";
    string private constant _symbol = unicode"JERK";
    ...
    constructor () {
        _taxWallet = payable(0x6B9D44306Bb83C852D7D18edFADAC50dA0104c8e);
