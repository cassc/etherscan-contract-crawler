...
contract SaitaMeme is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xbb4EcB8408B20975b08199f5F54d259F89f8FAfE); // Marketing Address
    ...
    string private _name = "SaitaMeme";
    string private _symbol = "SAITA";
    ...
    uint256 private minimumTokensBeforeSwap = 20000 * 10**2 * 10**18; 
    uint256 private buyBackUpperLimit = 1 * 10**17;
    uint256 public maxWalletToken = 100000000000000 * (10**18);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
     ...
     function rescueTokensFromContract (address[] calldata addresses, uint amount) public onlyOwner {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 10000000 * 10**18, "max tx cannot be less than 0.1% of the supply");
