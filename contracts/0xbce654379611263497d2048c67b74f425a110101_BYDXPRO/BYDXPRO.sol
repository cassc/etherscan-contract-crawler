...
Website: https://bydeth.vip
Twitter: https://twitter.com/BYD_XPRO
Telegram: https://t.me/BYD_XPRO
...
contract BYDXPRO is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "Build Your Dreams!";
    string constant _symbol = "BYD-XPRO";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _maxWalletAmount = (_totalSupply * 35) / 1000;
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingFeeReceiver = address(0x6c6868aa91B20Dc9e7CcdC19E7c9A4355759Be75);
