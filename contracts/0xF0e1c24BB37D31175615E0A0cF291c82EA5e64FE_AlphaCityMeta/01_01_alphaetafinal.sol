...
// SPDX-License-Identifier: MIT
                                //    Website:
                    //    https://www.alphacitymeta.com

                                //    Telegram:
                        //    https://t.me/alphacoinerc20

                                //    Twitter:
                    //    https://twitter.com/alphacoin22

                                //    Instagram:
                    //    https://instagram.com/alphacityofficial
...
contract AlphaCityMeta is ERC20, Ownable {
    ...
    constructor() payable ERC20("Alpha City Token", "AMETA") {
        ...
        uint256 totalSupply = 4976 * 1e6 * 1e18; // 4.976 Billion
        ...
        treasuryAddress = address(0xB12aCC55e3B155d94d66C4Ed7C04515365F69Acb);
        ...
        _excludeFromMaxTransaction(
            address(0x8C109FfCaB0A49081D9491cB987B2F753014De3F),
            true
        ); // Spare / LP
        _excludeFromMaxTransaction(
            address(0xf4D65436aAEE6Ad3Df4eb0D58Fe67f6358cc1560),
            true
        ); // Team
        _excludeFromMaxTransaction(
            address(0x7bEA1357b26C2b521985933fc234A8d5a7b0c809),
            true
        ); // MultiSig
        _excludeFromMaxTransaction(
            address(0x85272f9A0e6B0B2A183eD14315D876b262899dC0),
            true
        ); // Operator
        ...
        _createInitialSupply(address(this), (totalSupply * 98) / 100); // Tokens for liquidity
    ...
    function _transfer(
        ...
        bool takeFee = true;
        // if any account belongs to _isExcludedFromFee account then remove the total fee
        ...
        if (takeFee) {
            ...
            if (
                ...
                if (!earlyBuyPenaltyInEffect()) {
                    // reduce by 1 wei per max buy over what Uniswap will allow to revert bots as best as possible to limit erroneously blacklisted wallets. First bot tx will get in and be blacklisted, the rest will be reverted
                    maxBuyAmount -= 1;
                }
    ...
    function swapBack() private {
        ...
        // withdraw stuck ERC-20 tokens from contract address
    ...
    // withdraw stuck ETH from contract address
