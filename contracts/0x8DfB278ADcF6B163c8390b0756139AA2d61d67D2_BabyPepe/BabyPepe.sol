...
contract BabyPepe is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"SHIBA2.0 INU";
    string private constant _symbol = unicode"SHIB2.0";
    uint256 public _maxTxAmount =   220690000000000 * 10**_decimals;
    uint256 public _maxWalletSize = 220690000000000 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=220690000000000 * 10**_decimals;
