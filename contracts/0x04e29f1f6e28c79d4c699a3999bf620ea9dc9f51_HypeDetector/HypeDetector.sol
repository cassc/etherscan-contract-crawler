...
https://t.me/hypedetectorofficial
...
contract HypeDetector is ERC20, Ownable {
    ...
    constructor() ERC20("Hype Detector", "HYPE") {
        ...
        developmentWallet = address(0x6D647932fF6131FE3F02856ecF615F92A1eE4160); // set as development wallet
        marketingWallet = address(0x70889078c8c7EbDdA9B47E03F8b8b16D4F87FB31); // set as marketing wallet
        devWallet = address(0xBE47154f510c8172fA629212dD03a353cd9303EA); // set as dev wallet
