...
import "./interfaces/IKatabami.sol";
...
contract FeesManagerLogic is Ownable {
    ...
    IKatabami public katabamiContract;
    address public katabamiAddress;
    ...
    function estimateFees(
        ...
        require(_msgSender() == katabamiAddress, "Not Katabami contract");
    ...
    function updateKatabamiAddress(address _newAddr) external onlyOwner {
        katabamiContract = IKatabami(_newAddr);
        katabamiAddress = _newAddr;
    }
}