...
/**
    Proof of Halloween - ERC 
   
    Telegram: https://t.me/ProofofHalloweenERC
*/
...
contract ProofOfHalloween is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xec9B0E5FdCfE73B11dD9fD12ad90bad03BDAACEf); // Marketing Address
    address payable public multiSigAddress = payable(0xec9B0E5FdCfE73B11dD9fD12ad90bad03BDAACEf); // Marketing Address
    address payable public devAddress = payable(0xec9B0E5FdCfE73B11dD9fD12ad90bad03BDAACEf); // Dev Address
    address payable public liquidityAddress = payable(0xec9B0E5FdCfE73B11dD9fD12ad90bad03BDAACEf); // Liquidity Address
    ...
    string private constant _name = unicode"Proof Of Halloween";
