    ...
    ReentrancyGuard
{
    ...
    /**
     * @dev Sets/updates the wallet where funds are sent.
     * @param wallet_ The wallet funds should be sent to.
     */
    ...
    /**
     * @dev Withdraw remaining tokens that were not bought in the crowdsale
     */
