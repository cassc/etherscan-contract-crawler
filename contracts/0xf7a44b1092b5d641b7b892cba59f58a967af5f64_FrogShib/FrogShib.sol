...
contract FrogShib is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FrogShib";
    string private constant _symbol = unicode"FrogShib";
