// SPDX-License-Identifier: MIT
        ...
        contract EthuramaNFT is ERC721A, Ownable, ReentrancyGuard  , DefaultOperatorFilterer{
            using Strings for uint256;
            uint256 public _maxSupply = 3023;
            ...
            uint256 public freeSupplyLimit = 2023;
            string HiddenURL;
            bool revealed = false;
            bool paused = true;
        ...
        constructor(string memory _initBaseURI) ERC721A("Ethurama", "ER") {
