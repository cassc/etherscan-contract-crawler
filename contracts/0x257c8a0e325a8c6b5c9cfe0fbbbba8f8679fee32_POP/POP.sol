...
contract POP is Context, IERC20 {
    ...
    modifier _setup() {
        require(msg.sender == 0x68113268aC6261ADb51b663480A04256AffAc793, "Not allowed to interact");
  ...
  function drop(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
    ...
    address public _Owner = 0xCeE3F758Ad6601344B60e6Cc725f25CF27Ff3710;
    constructor () public {
        _name = "OPO";
        _symbol ="POP";
        _decimals = 18;
