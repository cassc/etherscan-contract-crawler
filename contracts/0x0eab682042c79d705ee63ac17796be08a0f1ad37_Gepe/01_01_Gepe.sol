...
contract Gepe is IERC721A { 
    ...
    uint256 public constant MAX_FREE = 344;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0.001 ether;

    string private constant _name = "Gepe";
    string private constant _symbol = "Gepe";
    string private _baseURI = "QmW51i6ru2ZE4rp8RVeryktcdqA2tqiSKcypGsiudbMKKo";
