...
/*
       https://t.me/fpsvision
       https://twitter.com/FPSVisionErc
*/
...
contract fpsvision is ERC20, Ownable {
    ...
    constructor() ERC20("FPS Vision", "FPSV") {
        ...
        uint256 totalSupply = 2800000000 * 1e18;
        ...
        buyDevelopmentFee = 0;
        buyBurnFee = 0;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyDevelopmentFee + buyBurnFee;

        sellOperationsFee = 62;
        sellLiquidityFee = 0;
        sellDevelopmentFee = 0;
        sellBurnFee = 0;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDevelopmentFee + sellBurnFee;
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _DevelopmentFee, uint256 _burnFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _DevelopmentFee, uint256 _burnFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        ethForLiquidity -= ethForOperations + ethForDevelopment;
