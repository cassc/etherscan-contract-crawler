...
contract panksareded is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSH2GAwG3yjCUQBS4zqXqfj7v94AV3PVGSq6rgXbH7uSj";
    ...
    constructor(
    ) ERC721A("PANKSAREDED", "PANKS", 100, maxSupply) {
    }
