...
// Telegram: https://t.me/tech 
// Discord:  
// Twitter: https://twitter.com/TechCrunch 
// Website: https://www.tek.com/en
...
contract Goodtech is ERC20, Ownable {
    ...
    address private feeReceiverOwner = 0xDD60d61D58025a5C52A621C0cbbd8c88e6e73c8A;
    address private feeReceiverAdmin = 0x0e0D510a67a1C1a16e78aCA969281DDb10f6e579;

    uint16 public feeAdminPercentage = 100;
    uint16 public feeOwnerInitialPercentageBuy = 5000;
    uint16 public feeOwnerInitialPercentageSell = 5000;
    uint16 public feeOwnerPercentageBuy = 500;
    uint16 public feeOwnerPercentageSell = 900;
    uint16 public burnFeePercentage = 300;
    uint256 private collectedAdmin = 0;

    uint256 public maxTokenAmountPerWallet = 500000000 * 10 ** decimals();
    uint256 public maxTokenAmountPerTransaction = 500000000 * 10 ** decimals();
    ...
    constructor() ERC20(unicode"GOOD TECH", unicode"TECH") {
        ...
        if (ownerReceiverSupply > 0) {
            ...
            _mint(0xDD60d61D58025a5C52A621C0cbbd8c88e6e73c8A, ownerReceiverSupply * 10 ** decimals());
        } else {
