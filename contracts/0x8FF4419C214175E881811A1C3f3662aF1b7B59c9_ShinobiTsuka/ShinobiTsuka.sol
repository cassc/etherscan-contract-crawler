...
contract ShinobiTsuka is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shinobi Tsuka";
    string private constant _symbol = "ShinobiTsuka";
