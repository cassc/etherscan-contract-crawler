 ...
 */
contract TheAssetsClubAtNFTParis is ERC721A, Ownable {
  /**
  ...
  constructor(string memory _baseURI, string memory _contractURI) ERC721A("TheAssetsClub at NFT Paris", "TACP") {
    baseURI = _baseURI;
