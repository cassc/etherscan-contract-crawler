...
Website : https://pepegirlfriend.pro/
X : https://twitter.com/PEPE__GF
Telegram : https://t.me/PepeGFPortal
...
contract PEPEGIRLFRIEND is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPEGIRLFRIEND";
    string private constant _symbol = "PEPEGF";
    address payable private _taxWallet = payable(0xfCED55263D6455Bc2541D807798E10a5AA1e1506);
    ...
    function OpenLaunch() external payable onlyOwner {
        ...
        uniswapV2Pair = V2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
