...
WE LOVE YUMMY MUMMYS - $MILF
"YOUR MOM'S A TOTAL MILF"
A Memecoin for all the milflovers out there!
https://www.facebook.com/karlsruheMilfs/
Come say hi: https://twitter.com/AmateurMilfs3
...
abstract contract Project {
    address public marketingWallet = 0xbBe24D71A4Eac7aB7Bb5D8cd86fFA324558fc941;
    address public devWallet = 0xf592F3583C6C0Ab19ca1Ee2Ce96CA00Ee2013140;

    string constant _name = "WE LOVE YUMMY MUMMYS";
    string constant _symbol = "MILF";
    uint8 constant _decimals = 10;

    uint256 _totalSupply = 69696 * 10**6 * 10**_decimals;
 ...
 * MainContract
 */
contract MILFContract is Project, IERC20, Ownable {
