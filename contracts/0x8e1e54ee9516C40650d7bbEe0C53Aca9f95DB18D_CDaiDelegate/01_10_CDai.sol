...
/**
 * @title Ondo's OErc20 Contract
 * @notice CTokens which wrap an EIP-20 underlying
 * @dev Compatible with CTokenSanction contract
 * @author Compound + Ondo
 */
contract CDai is CToken, CErc20Interface {
  /**
  ...
  function sweepToken(EIP20NonStandardInterface token) external override {
    require(
      msg.sender == admin,
      "OErc20::sweepToken: only admin can sweep tokens"
    );
    require(
