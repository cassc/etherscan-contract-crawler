...
After 30 minutes will drop to

5% buy
10% sell

then 5/5 after 1 hour
...
contract KURA  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Bonk Inu";
    ...
    address payable private _developmentAddress = payable(0xf6bd87b3681fe8de1730eb1c804f6a4C56FAAC0D); 
    address payable private _marketingAddress = payable(0xf6bd87b3681fe8de1730eb1c804f6a4C56FAAC0D);
