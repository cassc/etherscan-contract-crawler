...
/**
The 5% was born out of the idea of making a coin with sustainable tax structure that benefits the long term holders.
One of the mainproblems when coins starts to get traction and volume picks up is the lack of liquidity.

Tokenomics: 5% auto liquidity and 5% for buybacks, burn, marketing or adding to liquidity.

The 5% will be left to the community to run. When its time the marketing wallet will be made a multisig where the proven community leaders will decide what to spend on.
*/
...
contract The5 is ERC20, Ownable{
    ...
    address public marketingWallet = 0x4C08dCa2876C420d44247B91fDFa5Cb7D163ff18;
    address public devWallet = 0x4C08dCa2876C420d44247B91fDFa5Cb7D163ff18;
