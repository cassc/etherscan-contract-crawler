...
/*
Token Name: ESCAPING THE MATRIX
Symbol: Ematrix
Supply: 1,000,000

Tax: 1/1 buy/sell

Telegram: https://t.me/Ematrixerc20
...
contract Ematrix is Context, IERC20, Ownable {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isExcludedFromMaxWalletSize;
    string private constant _name = "ESCAPING THE MATRIX";
    string private constant _symbol = "Ematrix";
    ...
    constructor () {
        ...
        MarketAddrWallet = payable(0xc6EF686eDECcf6d1C652E5E5aFe77B497c5cA2A4); 
