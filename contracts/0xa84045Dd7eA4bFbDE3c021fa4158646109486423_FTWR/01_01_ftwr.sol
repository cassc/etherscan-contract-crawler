...
//  thoughts were way too deep, her mind had gone out 
//  for a stroll and fallen down the rabbit hole."
...
contract FTWR is ERC20, Ownable {
    ...
    constructor() payable ERC20("FTWR", "$FTWR") {
        ...
        marketingAddress = address(0xA211a9FC27fDA3c0a314756c7f15841DEffFD1A2);
        ...
        _createInitialSupply(0x35FdeaC569f893AB30011801CcA42b396FC06255, totalSupply);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x35FdeaC569f893AB30011801CcA42b396FC06255),
            block.timestamp
        );
    }
