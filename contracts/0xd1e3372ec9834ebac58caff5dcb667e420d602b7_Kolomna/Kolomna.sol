...
/**Kolomna.. Rings a bell? The birthplace of Vitalik and a few well known Speed Skaters ..
 *
*/
...
contract Kolomna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Kolomna";
    string private _symbol = "$KOL";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x6Fdf54a838EAa3Aa00A27Fe786037df14ebd4F93);
    address payable private taxWallet2 = payable(0x83675382971bF5a0A2a2E1d283b9955f8d80F6E6);
    ...
    uint256 private _totalSupply = 69000000 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 138000 * 10**6 * 10**9;
    uint256 public _walletMax = 138000 * 10**6 * 10**9;
