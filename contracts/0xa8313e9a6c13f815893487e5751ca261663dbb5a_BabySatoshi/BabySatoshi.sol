...
contract BabySatoshi is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Satoshi", "BSATOSHI") payable {
    	...
    	marketingWallet = address(0xDd791C1c4342873b1A174B279441b0e7104b1dF9); // set as Marketing wallet
        devWallet = address(0xDd791C1c4342873b1A174B279441b0e7104b1dF9); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xDd791C1c4342873b1A174B279441b0e7104b1dF9, true);
        excludeFromFees(0xDd791C1c4342873b1A174B279441b0e7104b1dF9, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xDd791C1c4342873b1A174B279441b0e7104b1dF9, true);
        excludeFromMaxTransaction(0xDd791C1c4342873b1A174B279441b0e7104b1dF9, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xDd791C1c4342873b1A174B279441b0e7104b1dF9,
            block.timestamp
        );
    }
