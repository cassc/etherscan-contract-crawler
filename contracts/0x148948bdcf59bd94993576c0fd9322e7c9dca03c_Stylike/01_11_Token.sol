...
contract Stylike is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"Stylike", unicode"STYL") 
    {
        address supplyRecipient = 0xeDd0c1c863EBEa876CF5825Bb60F49b925569C37;
        
        updateSwapThreshold(100000 * (10 ** decimals()));

        taxAddressSetup(0x85675c6EB3e56deFEdE6df3674aA7ee5934481Fc);
        taxFeesSetup(350, 500, 350);
        ...
        excludeFromLimits(taxAddress, true);

        updateTradeCooldownTime(3);

        _mint(supplyRecipient, 1000000000 * (10 ** decimals()));
        _transferOwnership(0xeDd0c1c863EBEa876CF5825Bb60F49b925569C37);
    }
