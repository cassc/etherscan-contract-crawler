...
import "./types/LovelyDAOAccessControlled.sol";

contract LovelyDAOAuthority is ILovelyDAOAuthority, LovelyDAOAccessControlled {
    /* ========== STATE VARIABLES ========== */
    ...
    constructor(
        ...
        address _policy,
        address _vault
    ) LovelyDAOAccessControlled(ILovelyDAOAuthority(address(this))) {
        governor = _governor;
