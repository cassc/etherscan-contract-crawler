...
contract tendies is ERC20, Ownable{
    ...
    address public marketingWallet = 0x1fbaf9C440597BA76Aa04633F55B56cbA8B539C6;
    address private EcoWallet = 0x802C1B29d728e437D84985aB5D546a3C68e02933;
    ...
    Taxes public sellTaxes = Taxes(20,0,30);
    ...
    constructor() ERC20("T TENDIES", "TTENDIES") {
    ...
    function setBuyFees(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function setSellFees(uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
    ...
    function updateRouterAndPair(IRouter _router, address _pair) external onlyOwner{
        ...
        function rekBots(address[] memory isBot_) public onlyOwner {
