...
contract DarkKirby is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dark Kirby";
    string private constant _symbol = unicode"DARKKIRBY";
