 ...
 * @notice This contract handles minting VAL GOBBLERS OFFICIAL tokens.
 */
contract VALGOBBLERSOFFICIAL is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    ERC2981
{
    ...
    address private presaleSignerAddress =
        0xE66B4cAacFD9Bf44B3449022EDC4A1C4d66Bec82;
    ...
    address public royaltyAddress = 0x8aA69B8162A86dE87B8908D871a09cE19C30C2f6;
    address[] public payoutAddresses = [
        0x33EbC58a9fe1224302c52BBeb1bff992Af65D58a
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeid662g24anx3krcwbuhv62rouf3ykgz3e2npxk2wvtkqeruiylep4/";
    // Maximum supply of tokens that can be minted
    uint256 public MAX_SUPPLY = 5555;
    // Total number of tokens available for minting in the presale
    uint256 public PRESALE_MAX_SUPPLY = 5500;
    ...
    uint256 public publicMintsAllowedPerAddress = 0;
    ...
    constructor(address _blocklistContractAddress)
        ERC721A("VAL GOBBLERS OFFICIAL", "VGB")
    {
