...
contract Cockatoos is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Cockatoos"; 
    ...
    address payable private _developmentWalletAddress = payable(0xE8C2930d8607aB5eB556102b746ebAd9e2d5AE62);
    address payable private _marketingWalletAddress = payable(0xE8C2930d8607aB5eB556102b746ebAd9e2d5AE62);
