 ...
 */
contract WDTC is Context, AccessControl, ERC20Burnable, ERC20Pausable {
    ...
    function transferToAvalon(uint256 amount, string calldata avalon_recipient) public virtual {
        _burn(_msgSender(), amount);
    }
}