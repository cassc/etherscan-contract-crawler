...
contract DCCTesla is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    constructor()
        ERC721A("Dream Cars Collection Tesla", "DCCTesla")
    {
        admins[msg.sender] = true;
    }

    modifier onlyAdmin() {
        require(admins[_msgSender()], "DCCTesla: Caller is not the admin");
        _;
    }
        ...
        onlyAdmin
    {
        ...
        require(total + totalQuantity <= MAX_ELEMENTS, "DCCTesla: Max limit");
