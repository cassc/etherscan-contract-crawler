...
contract BabyApt is ERC20, Ownable {
    ...
    constructor() ERC20("Baby Apt", "BAPT") {
        setupSwapRouter();
        ...
        _maxTransactionAmount = TOTAL_SUPPLY / 1000 * 10; // 1%
        _maxWallet = TOTAL_SUPPLY / 1000 * 20; // 2%
        ...
        marketingWallet = address(0xD4aC69B5FA4c22262aAFC719FE14d422f00C3787);
