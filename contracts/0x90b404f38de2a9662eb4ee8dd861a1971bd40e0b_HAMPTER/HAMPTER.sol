...
/*
Hampter | 1/1 Taxes | $HAMPTER 🐹

Telegram: Https://t.me/HampterETH

Website: Hampter.site
*/
...
contract HAMPTER is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Hampter";
    string private constant _symbol = unicode"HAMPTER";
    ...
    constructor () {
        _taxWallet = payable(0x52F1e9E466D261A0CE43B4cCb2C302e82c667F34);
