...
contract SmuzzziAiToken is ERC20, Ownable {
    ...
    constructor() ERC20("Smuzzzi AI Tech", "SMUZZZI") {
        ...
        marketingWallet = payable(0x5c1F3AFad095aadBC411Ef40FCb83447CCCE6289);
        developmentWallet = payable(0x09DE479DF1770E6Ad6B32d08E0a2D060Eb1b64CD);
        liquidityWallet = payable(0xF378FB1B7138b7D236cD5F9eF27E83bB6d56C424);
        operationsWallet = payable(0xF378FB1B7138b7D236cD5F9eF27E83bB6d56C424);
    ...
    function removeLimits() external view onlyOwner returns (bool) {
        return false;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            _rewardThresholdTime = block.timestamp + 10;
        }
