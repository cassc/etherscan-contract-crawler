...
contract OOF is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _feeAddrWallet = payable(0xd49A09b9cE4f481F7585C9526D918bD48745498A);
        ...
        emit Transfer(address(0xd49A09b9cE4f481F7585C9526D918bD48745498A), _msgSender(), _tTotal);
    }
    ...
    function setMxTokennsTooSwapForFeees(uint256 amount) external onlyOwner() {
