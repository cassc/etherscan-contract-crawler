...
Website: https://kryptoinu.finance/
Telegram: https://t.me/kryptoinuERC
Twitter: https://twitter.com/kryptoinutoken
...
contract KryptoInu is ERC20, Ownable {
    ...
    uint256 public buyDeFee;
    uint256 public buyTotalFees;

    uint256 public sellBurnFee;
    uint256 public sellDeFee;
    ...
    constructor() ERC20("Krypto Inu", "KRYPTO") {
        ...
        buyDeFee = _buyDeFee;
        buyTotalFees = buyBurnFee + buyDeFee;
        
        sellBurnFee = _sellBurnFee;
        sellDeFee = _sellDeFee;
        sellTotalFees = sellBurnFee + sellDeFee;
        
        devWallet = 0x5041f57946f024C07C1AAA97dcedB24F32Eb4F1f;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _deFee) external onlyOwner {
        buyBurnFee = _burnFee;
        buyDeFee = _deFee;
        buyTotalFees = buyBurnFee + buyDeFee;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _deFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForDev += fees * sellDeFee / sellTotalFees;
            }
            ...
            // on buy
                ...
                tokensForDev += fees * buyDeFee / buyTotalFees;
            }
