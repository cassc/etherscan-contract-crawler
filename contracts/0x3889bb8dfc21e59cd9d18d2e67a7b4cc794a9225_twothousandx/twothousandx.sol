...
contract twothousandx is BEP20, Ownable { //
    using SafeMath for uint256;
    ...
    constructor() BEP20("2000X", "2X") { // 
        marketingWallet = payable(0xAFfdF4c47b7223C661170df413661874657bAa43); // 
        devWallet = payable(0xAFfdF4c47b7223C661170df413661874657bAa43); // 
        ...
        uint256 totalSupply = (2_000) * (10**18); // 
