...
contract EGMI is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"EGMI COIN";
    string private constant _symbol = unicode"EGMI";
