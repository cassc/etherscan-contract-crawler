...
contract UDC is Context, IERC20, Ownable {
    ...
    address public _bettingContract;
    ...
    string private constant _name = unicode"Ultimate Degen Championship";
    string private constant _symbol = unicode"UDC";
    ...
    uint256 public _taxSwapThreshold = 100_000 * 10 ** _decimals; // 1% of total supply
    uint256 public _maxTaxSwap = 100_000 * 10 ** _decimals; // 1% of total supply
    ...
    constructor() {
        ...
        _isExcludedFromFee[_bettingContract] = true;
    ...
    function setBettingContract(address bettingContract) external onlyOwner {
        _bettingContract = bettingContract;
    }
