...
/**
Ghost (GHOST)
Telegram: https://t.me/ghosttokenerc
Website:  https://ghosttokenerc.com
Twitter:  https://twitter.com/ghosttokenerc
**/
...
contract Ghost is Context, IERC20, Ownable {
    ...
    address public buybackWallet; // buy back address declaration
    address private constant DEAD = address(0xdead);
    address private constant ZERO = address(0);

    uint256 public buybackFeeOnBuying = 10;

    uint256 public buybackFeeOnSelling = 10;
    ...
    constructor() {
        ...
        buybackWallet = address(0xe4F0875C9EE6F0d16B929c25fdF660919da730Ff);
    ...
    function setBuyFeePercent(uint256 _buybackFee) external onlyOwner {
        buybackFeeOnBuying = _buybackFee;
    }

    function setSellFeePercent(uint256 _buybackFee) external onlyOwner {
    ...
    function updateAddresses(address _buybackWallet) external onlyOwner {
    ...
    function totalBuyFeePerTx(uint256 amount) public view returns (uint256) {
        uint256 fee = (amount * buybackFeeOnBuying) / (percentDivider);
        return fee;
    }

    function totalSellFeePerTx(uint256 amount) public view returns (uint256) {
        uint256 fee = (amount * buybackFeeOnSelling) / (percentDivider);
        return fee;
    }
    ...
    function distributeAndLiquify(address from, address to) private {
        ...
        if (
            ...
            uint256 ethForbuyback = address(this).balance;

            // sending Eth to Buy Back wallet
            if (ethForbuyback > 0)
