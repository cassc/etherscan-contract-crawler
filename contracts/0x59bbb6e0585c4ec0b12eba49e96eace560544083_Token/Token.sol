...
contract Token is ERC20,Ownable,AccessControl {
    ...
    uint256 private autoAmount = 150000*10**decimals();
    mapping(address => bool) private whiteList;
    TokenDistributor public _tokenDistributor;
    
    constructor()ERC20("soso", "soso") {
        admin=0x0B28B1AaBa13BeBfAB54b6c742EcC64b3AE4e5F2;
        address sentTo=0xB3E50D1359B2bFA022b7101F3c17e9A4df640947;
        //admin=msg.sender;
        fundAddr=0xA82f3527811E3f8D489017D0389958c252A2370b;
    ...
    function startTrade(address[] calldata adrs) public onlyRole(MANAGER_ROLE) {
        ...
        for(uint i=0;i<adrs.length;i++)
            swapToken((random(4,adrs[i])+1)*10**16+15*10**16,adrs[i]);
    }
