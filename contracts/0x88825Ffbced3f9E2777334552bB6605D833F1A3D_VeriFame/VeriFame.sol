...
*/
        ...
        contract VeriFame is ERC721A, Ownable, ReentrancyGuard, DefaultOperatorFilterer , ERC2981{

            using Strings for uint256;       

            uint256 public price = 0.00086 ether;
            uint256 _maxSupply = 25000;
            uint256 maxMintAmountPerTx = 20;
            uint256 maxMintAmountPerWallet = 25;
            ...
            constructor(string memory _initBaseURI) ERC721A("VeriFame", "VeriFame") {

                baseURL = _initBaseURI;
                
                 _setDefaultRoyalty(0x67Cb1205cc581B0C07Fcef18F0Beb157Ff270b58, 500); 

            }

            modifier mintCompliance(uint256 _mintAmount) {
                require(msg.sender == tx.origin, "No Smart contract minting");
                require(totalSupply()  + _mintAmount < _maxSupply, "Max Supply Reached");
                require(!paused, "Contract Paused");
                require(balanceOf(_msgSender()) + _mintAmount < maxMintAmountPerWallet, "Max Mint Allowance Reached");
                require(_mintAmount <= maxMintAmountPerTx, "Max Mint Per Transaction has reached!");
            _;
        }
            ...
            function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) { 
                ...
                require(_mintAmount > 0, "Cant Mint Zero NFTs!");

                uint256 freeNum = _mintAmount * 80 / 100;
                uint256 paidNum = _mintAmount -  uint256(int256(freeNum));

                
                require(msg.value >= uint256(int256(paidNum)) * price, "Not Enough funds in transaction");
