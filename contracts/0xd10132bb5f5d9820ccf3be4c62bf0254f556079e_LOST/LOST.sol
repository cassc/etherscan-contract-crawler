...
contract LOST is Context, IERC20, Ownable {
    ...
    string private constant _name = "LOST";
    ...
    address payable public SwapAddress = payable(0x667dBB82BD693645eAe221C9b1908F5d0eC7dB6B);
    ...
    address public SwapWallet = 0x667dBB82BD693645eAe221C9b1908F5d0eC7dB6B;
