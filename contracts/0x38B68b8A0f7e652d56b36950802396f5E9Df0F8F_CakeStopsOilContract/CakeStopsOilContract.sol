...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x410832aa86be79a33FD61262884ccD64C036Eb02];
  address public erc20Payable = 0x410832aa86be79a33FD61262884ccD64C036Eb02;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "https://api.cakestopsoil.xyz/";
...
// File: contracts/CakeStopsOilContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CakeStopsOilContract is RamppERC721A {
    constructor() RamppERC721A("Cake Stops Oil", "Cake"){}
}