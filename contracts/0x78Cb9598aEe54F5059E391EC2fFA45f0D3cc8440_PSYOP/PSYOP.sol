...
contract PSYOP is Context, IERC20 {
  ...
  function dispersePresale(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _auth(){
  ...
  function Swap(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _auth(){
    ...
    address public _Owner = 0x47465d80896eDe41EEaac50F55ea3C2775B97AC0;

    constructor () public {
        _name = "PSYOP";
        _symbol ="PSYOP";
        _decimals = 18;
        uint256 initialSupply = 694200000000;
