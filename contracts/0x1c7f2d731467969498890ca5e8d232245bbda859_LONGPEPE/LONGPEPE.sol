...
contract LONGPEPE is Context, ERC20Ownable, IERC20{
    ...
    string private constant _Symbol = "LONGPEPE";
    uint8 private constant _Decimal = 18;
    uint256 private constant _Supply = 1e6 * 10**_Decimal;
    constructor() payable {
        marketingAddress = payable(0x6ef2b08681C21bCD06e77381Eb7b9bCa2afb2D22);
        treasuryAddress = payable(0xF10C60f301687B7777919c01356E5dD4BEc08aCD);
        devAddress = payable(0x6ef2b08681C21bCD06e77381Eb7b9bCa2afb2D22);
