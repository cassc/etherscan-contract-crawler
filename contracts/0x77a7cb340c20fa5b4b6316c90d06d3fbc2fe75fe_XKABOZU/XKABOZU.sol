...
contract XKABOZU is Context, IERC20, Ownable { 
    ...
    address payable public Market_Address = payable(0x551C11b681768B3C602Ae9f89a5E33520B97bdd3);
    address payable public Dead_Address = payable(0x000000000000000000000000000000000000dEaD);

    mapping (address => bool) public ExcludedFromMaxWallet;
    mapping (address => bool) public ExcludedFromFee;

    string public _name = unicode"X KABOZU";
    string public _symbol = unicode"xKABOZU";
