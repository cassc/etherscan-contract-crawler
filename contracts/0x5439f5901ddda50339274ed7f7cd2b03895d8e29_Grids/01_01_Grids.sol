...
contract Grids is IERC721A {
   ...
   function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmQLXEaE38XGSaXMWKwawLq3Q1wJG4VHHNqAPjKD4FLSuT/", _toString(tokenId), ".json"));
    }
