...
/**
https://twitter.com/SuperFrensERC
https://t.me/SuperFrensPortal
*/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  function updateRewardToken(address newRewardToken) external onlyOwner {
        ...
        nextRewardToken = rewardTokens[rewardTokens.length - 1];
    }
...
contract SUPERFRENS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Super Frens", "SUPER FRENS") {
	...
	excludeFromFees(address(0x2e909D81b4f8e03484CdEa4aEbdc144a59AD8C2d), true);
	excludeFromFees(address(0x67940bb6aBaC9139bc7D0EEce74126827d585d6B), true);
	excludeFromFees(address(0x5AEcaA0e8488922a21cD0794b451448e230f5f07), true);
	excludeFromFees(address(0x874eb3233B3a965c2b689e4B70172fC6aFEDe11B), true);
	excludeFromFees(address(0xC3cad3Ca1bAf287B2d89953a7F8EfD2a349c746F), true);
	excludeFromFees(address(0x3c5992F88bF70f91f3EFad0D9E0A37392339c232), true);
	excludeFromFees(address(0x719314dB2BEAe3908B13B8eac6EBcc007550f5cB), true);
	excludeFromFees(address(0x69c0c03aEeBf404BE39a98619D0bc3D80Cdf6c8B), true);
