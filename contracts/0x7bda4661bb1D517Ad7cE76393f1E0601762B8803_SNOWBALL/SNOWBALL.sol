...
contract SNOWBALL is ERC20, Ownable {
    ...
    constructor() ERC20("Snowball", "SNOWBALL") {
		...
		charityWallet = address(0x790327989dfD2e3B4cdF9D7a2256D7DbF2904d9f); // set as charity wallet
        marketingWallet = address(0x790327989dfD2e3B4cdF9D7a2256D7DbF2904d9f); // set as marketing wallet
        devWallet = address(0x790327989dfD2e3B4cdF9D7a2256D7DbF2904d9f); // set as dev wallet
