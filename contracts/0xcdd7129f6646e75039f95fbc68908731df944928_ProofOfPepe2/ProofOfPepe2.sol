...
contract ProofOfPepe2 {
    ...
    string public constant name = "Proof Of Pepe 2.0";   
    string public constant symbol = "POP2.0";   
    ...
    uint256 constant maxWallet = 25 * totalSupply / 100;
    ...
    address payable constant deployer = payable(address(0x7e4E170d167F07D0C4eC8b90a8AD27517Ac53842));
