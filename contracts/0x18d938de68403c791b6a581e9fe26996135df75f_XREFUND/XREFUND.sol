...
contract XREFUND is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"0xRefund";
    string private constant _symbol = unicode"0xR";
