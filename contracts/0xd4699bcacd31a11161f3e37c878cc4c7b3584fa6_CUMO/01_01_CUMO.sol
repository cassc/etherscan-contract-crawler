...
contract CUMO is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Pornstar Milady Cumo";
    string private constant _symbol = unicode"CUMO";
