...
// Welcome to Platinum! You escaped elo hell.
...
contract PLATINUM is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    address payable public marketingAddress = payable(0xA95B36Ad5135F9ac5877c6fd8b61b6EF8AB8E2Ed);
    address payable public devAddress = payable(0x2904C3bF4E1E273E2DdEed9F80bd1C92067268fB);
    address public newOwner = 0x2904C3bF4E1E273E2DdEed9F80bd1C92067268fB;
    ...
    uint256 public _buyMarketingFee = 189;
    ...
    uint256 public _sellMarketingFee = 189;
    ...
    uint256 private minimumTokensBeforeSwap = 105000 * 10**18;
