 ...
 * @notice This contract handles minting BLUR BLOCKS tokens.
 */
contract BLURBLOCKS is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0xedbfEf29890a1a83dCE80C8962E10C3C01cf4eE9;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0xC16b2865EcBCe4672eDd0C7D6359B12D01554EC6;
    address[] public payoutAddresses = [
        0xC16b2865EcBCe4672eDd0C7D6359B12D01554EC6
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeibghpbllmcqlx4u5bpe7d2qs7hngi2n67iegngvu2lcabdufsbpdm/";
    ...
    uint256 public presaleMintsAllowedPerTransaction = 2048;
    uint256 public presalePrice = 0 ether;
    uint256 public publicMintsAllowedPerAddress = 2;
    uint256 public publicMintsAllowedPerTransaction = 2048;
