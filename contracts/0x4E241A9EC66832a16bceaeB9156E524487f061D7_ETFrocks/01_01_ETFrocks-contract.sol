...
contract ETFrocks is IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "ETF Rocks";
    string private constant _symbol = "ETF";

    uint8 private constant _decimals = 18;

    uint256 private _totalSupply = 1618000000 * (10 ** _decimals);
    ...
    address public devWallet = 0xb1d446DC6b9Fe7FfDb9983b0e91Fc253e75a9B4F; 
