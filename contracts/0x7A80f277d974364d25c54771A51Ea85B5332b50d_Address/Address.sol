...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDBC7E5390c2226ac633041b27441EeDf0d8da7a2; // DEPLOYER
...
contract EllipticalGalaxy  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "MUSK WILL WIN";
    string public _symbol = "MUSK_WIN";
    uint8 public _decimals = 9;

    address payable private marketingWalletAddress = payable(0x888888888a2698C37c2B8F53C856665F9408d3b4); 
    address payable private developmentWalletAddress = payable(0x222222229EFca881Ab8f2f541c24A9bC6539ce7D);
    ...
    uint256 public _marketingShare = 94;
