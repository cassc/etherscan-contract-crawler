...
contract Good_Gensler is ERC20, ERC20Burnable, Ownable, TokenRecover {
    ...
    constructor()
        ERC20("Good Gensler", "GENSLR") 
    {
        address supplyRecipient = 0x032DF95ba6E7F31c464D3571B378879925D4D962;
        ...
        updateMaxWalletAmount(12600000000000 * (10 ** decimals()));

        updateTradeCooldownTime(30);

        _mint(supplyRecipient, 420000000000000 * (10 ** decimals()));
        _transferOwnership(0xc9691184351f29Af7412C7BE7E931FfD06BDEC4C);
    }
