...
contract Decentralzone is ERC20, Ownable {
    ...
    uint256 public marketingFeeOnTransfer = 2;
    uint256 public liquidityFeeOnTransfer = 1;
    ...
    uint256 public totalFeesOnTransfer = marketingFeeOnTransfer + liquidityFeeOnTransfer;
    uint256 private totalFees;

    address public marketingWallet = 0x39CE0F71Db9D2D0d7EdCb373895cd5bB10A192a0;
    ...
    event UpdateTransferFee(uint256 indexed newFee);
    ...
    constructor() ERC20("Decentralzone", "DZ") {
    ...
    function _transfer(
        ...
        if (canSwap && !swapping && swapEnabled && to == uniswapV2Pair) {
            ...
            uint256 totalShare = liquidityShare + marketingShare;
            if (liquidityShare > 0) {
        ...
        if (takeFee) {
            ...
            if (from == uniswapV2Pair) {
                ...
                fees = (amount * totalFeesOnTransfer) / 100;
            }
            amount -= fees;
            if (fees > 0) {
