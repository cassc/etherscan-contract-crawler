...
contract Greed is Ownable, ERC20 {
    ...
    constructor() ERC20("Greed", "Greed"){
        ...
        super._transfer(msg.sender, 0x27E4FF8fb3378B5364F74081d30D3130956E73cd, totalSupply * 1 / 100);
        super._transfer(msg.sender, 0x4c05B95d31Af469d7C92A04F6228eaCCb8E24Cdf, totalSupply * 2 / 100);
        super._transfer(msg.sender, 0x75e89d5979E4f6Fba9F97c104c2F0AFB3F1dcB88, totalSupply * 10 / 100);
        super._transfer(msg.sender, 0xdbFbF135daD8CD83BE0d7474C7F5682abb495bE1, totalSupply * 1 / 100);
        super._transfer(msg.sender, 0x4B2D5008F49dE428a48D172C7082ad63e2C64E92, totalSupply * 2 / 100);
        super._transfer(msg.sender, 0x4bcb94A2A8dd0c3f35197B140B571810062A0Cb0, totalSupply * 2 / 100);
        super._transfer(msg.sender, 0xf623edC7B1C75151a9AD100D365DA12dd23F7cBe, totalSupply * 2 / 100);
        super._transfer(msg.sender, 0x7725706bD3857E481E09de352Fde6AE644D14c92, totalSupply * 2 / 100);
