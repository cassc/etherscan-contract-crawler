...
/**
    ...
    Buy, Sell, Leverage trade your favourite Stocks with Crypto - KYC COMPLETED! ✅
...
contract Stonks {
    ...
    string public constant symbol = "STONKS ( KYCD )";  //
    ...
    address payable constant deployer = payable(address(0x9f92a9CfAA8928Ec204a449a14c7bc2801e18B54)); // 
