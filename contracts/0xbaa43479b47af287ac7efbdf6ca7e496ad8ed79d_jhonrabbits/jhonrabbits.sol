...
// File: contracts/jhonrabbits.sol
...
contract jhonrabbits is ERC721A, Ownable {
    enum SaleStatus{ PAUSED, PRESALE, PUBLIC }

    uint public constant maxSupply = 5999;
    ...
    string private _baseURL = "ipfs://bafybeiel4gwi57b46h7wwrl6ct5t3xast4inxkweragphjlhmtd2vkgy5m";
    
    mapping(address => uint) private _mintedCount;
    

    constructor() ERC721A("Jhon Rabbits CRAC", "JR"){}
    ...
    function mint(uint count) external payable {
        require(saleStatus != SaleStatus.PAUSED, "AvR: Sales are off");
        require(_totalMinted() + count <= maxSupply, "AvR: Number of requested tokens will exceed collection supply");
