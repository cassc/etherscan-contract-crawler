...
contract Moontopia is IERC20, Ownable {
    ...
    uint256 public buyTax = 150; // 15% - For First 5 Blocks
    uint256 public sellTax = 200; // 20%
    uint256 public dynamicTax = 20; // 2%
    uint256 public maxSellTax = 200; // 20%
 
    string private constant _name = "Moontopia";
    ...
    TaxesPercentage public taxesPercentage = TaxesPercentage(35,30,35);
