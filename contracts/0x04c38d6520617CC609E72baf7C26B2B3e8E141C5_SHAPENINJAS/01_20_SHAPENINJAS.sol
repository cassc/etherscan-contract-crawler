 ...
 * @notice This contract handles minting SHAPE NINJAS tokens.
 */
contract SHAPENINJAS is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x8b462020ef534ED9b23b71b6E8Ac66830Ebe8dEC;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x7Bc4fa0Afe2349AB117eecc5b933508C78290385;
    address[] public payoutAddresses = [
        0x7Bc4fa0Afe2349AB117eecc5b933508C78290385
    ];
    ...
    string public baseTokenURI =
        "ipfs://bafybeiaqsejnszipqwgdsx5s6nlmqbu3agrwcq6zfom2kxjilynwzd7xyi/";
    ...
    uint256 public presaleMintsAllowedPerTransaction = 1500;
    uint256 public presalePrice = 0 ether;
    uint256 public publicMintsAllowedPerAddress = 1;
    uint256 public publicMintsAllowedPerTransaction = 1500;
