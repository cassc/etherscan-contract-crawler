/*
                           l)L                                        
                            l)                                        
w)      WW  o)OOO   o)OOO   l)      m)MM MMM   o)OOO   o)OOO  n)NNNN  
w)  WW  WW o)   OO o)   OO  l)     m)  MM  MM o)   OO o)   OO n)   NN 
w)  WW  WW o)   OO o)   OO  l)     m)  MM  MM o)   OO o)   OO n)   NN 
 w)WW WWW   o)OOO   o)OOO  l)LL    m)      MM  o)OOO   o)OOO  n)   NN 
*/
...
contract WoolMoon is Ownable, ERC721A, DefaultOperatorFilterer  {

    using Strings for uint256;

    string private baseTokenURI;

    uint64 public maxSupply = 333;

    uint64 public publicMaxSupply = 333;
    ...
    constructor() ERC721A("Wool Moon by Kool Knitter", "WOOLMOON"){}
