...
/* Welcome to FOrtifiBot, your dedicated Telegram assistant 
designed to streamline your DeFi experience. FOrtifiBot enables swift
 and secure locking of Uniswap LP liquidity on UNCX, 
 all within the comfortable interface of your Telegram app.*/

//  Telegram: https://t.me/FortifiBotERC
//  Twitter:  https://twitter.com/FortifiBot
//  Medium:   https://medium.com/@FortifiBot
//  Website:  https://fortifibot.io/
//  Bot:      https://t.me/FortifiBot
...
abstract contract Ownable is Context {
    ...
    /**
     * @dev Initializes the contract setting the dev as the initial owner.
     */
    constructor() {
...
contract Fortifi is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address private immutable uniswapV2Pair;
    address private constant deadAddress = address(0x0000000000000000000000000000000000000000);
    ...
    constructor() ERC20("Fortifi Bot", "FORTIFI") {
        ...
        excludeFromFees(devAddress, true); // dev Address
        excludeFromFees(lpLocker, true); // LP Locker

        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(devAddress, true); // dev Address
