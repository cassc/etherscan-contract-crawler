...
contract APE2_0 is ERC20, Ownable {
    ...
    constructor () ERC20("Ape 2.0", "Ape 2.0") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x70B41fF68cb78ACd3C8e923EB87E4A23d62a541F;
        ...
        _mint(owner(), 420690000000000 * (10 ** decimals()));
