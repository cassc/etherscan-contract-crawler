...
/**
Telegram : https://t.me/somethingportal
Website : https://somethingcoin.xyz
Twitter: https://twitter.com/Something_ERC
**/
...
contract Something is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x9ccc53a84fdD5cb8B12B304247487f8c32B0A42E); 
    address payable private _marketingAddress = payable(0x9ccc53a84fdD5cb8B12B304247487f8c32B0A42E);
    ...
    uint256 public _swapTokensAtAmount = _tTotal.mul(60).div(1000);
