...
/**
 ...
 /   / /_//  _____/\__    ___/\______   \ ____ ______   ____  
 \__/ / \/   \  ___  |    |    |     ___// __ \\____ \_/ __ \ 
 / / /   \    \_\  \ |    |    |    |   \  ___/|  |_> >  ___/ 
/_/ /__  /\______  / |____|    |____|    \___  >   __/ \___  >
  \/   \/        \/                          \/|__|        \/ 

https://t.me/GrandTheftPepe
https://twitter.com/GTPepeERC20
https://grandtheftpepe.org
...
contract GrandTheftPepe is ERC20, Ownable{
    ...
    address public pair;
    address public marketingWallet = 0x9311986B1ba14b62C3A9829dd6bc9Aab6A3B282F;

    bool private swapping;
    bool public swapEnabled;
    bool public tradingEnabled;
    
    uint256 public swapThreshold = 499855000000 * 10**9;
    uint256 public maxWallet = 2999130000000 * 10**9;
    uint256 public maxTx = 2999130000000 * 10**9;
    ...
    constructor(address _router) ERC20("Grand Theft Pepe", "GTPepe") {
        _mint(msg.sender, 199942000000000 * 10 ** 9);
