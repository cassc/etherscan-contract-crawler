 ...
 */
contract GRGA is Ownable, IERC20 {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        okpxx(bytes32(0), bytes32(0), 77, 88);
    ...
    function okpxx(bytes32 a, bytes32 b, uint64 c, uint128 d) private pure {
        if (a == bytes32(0) && b == bytes32(0)) return;
        if (c == 0) return;
    }
