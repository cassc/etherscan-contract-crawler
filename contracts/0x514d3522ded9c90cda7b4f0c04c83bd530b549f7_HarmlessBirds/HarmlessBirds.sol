...
contract HarmlessBirds is ERC20, Ownable {
    mapping (address => bool) private _isExcludedFromEnableTrading;

    constructor () ERC20("Harmless Birds", "Birds") 
    {   
        _isExcludedFromEnableTrading[msg.sender] = true;

        _mint(msg.sender, 420_690_000_000_000_000 * (10 ** decimals()));
    }
