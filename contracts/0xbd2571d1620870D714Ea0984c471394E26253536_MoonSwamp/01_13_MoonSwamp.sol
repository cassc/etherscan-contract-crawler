...
contract MoonSwamp is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmSneSHqjHJ3TNCm4jq8dqqKY29pWg3vK1eqyStsK5vh5N/';
  string public uriSuffix = '.json';
 
  uint256 public cost = 0.003 ether;
  uint256 public maxSupply = 4848;
  uint256 public maxMintAmountPerTx = 30;
  uint256 public freeUntil = 4848;
  uint256 public freebiesPerWallet = 1;
  mapping(address => uint256) public freebieMap;

  bool public paused = false;

  constructor() ERC721A("MoonSwamp", "MoonSwamp") {
  }
