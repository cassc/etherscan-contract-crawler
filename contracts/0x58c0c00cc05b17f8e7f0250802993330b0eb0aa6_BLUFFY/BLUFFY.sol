...
contract BLUFFY is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BASIC LUFFY";
    string private constant _symbol = unicode"BLUFFY";
