...
// File: contracts/BoredRengaYC.sol
...
contract BoredRengaYC is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("BoredRengaYC", "BRYC"){}
    ...
    function mintBoredRengas(uint256 count) external payable {
        uint256 cost = price;
