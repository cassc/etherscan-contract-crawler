...
Twiiter: https://twitter.com/BigEyesCoin
...
contract BigEyes is Ownable, ERC20 {
    uint256 public immutable maxSupply = 200_000_000_000 * (10 ** decimals());
    ...
    constructor() ERC20("Big Eyes", "$BIG") {
