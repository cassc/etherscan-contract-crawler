...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x1C4853Ec0d55e420002c5eFaBc7Ed8e0bA7A4121); //DOGE
...
contract NamiArmy is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Nami Army";
    string constant _symbol = "NAMIARMY";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address RewardToken = 0x1C4853Ec0d55e420002c5eFaBc7Ed8e0bA7A4121;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x93629a98Cb116B96E8fe9b782C5f95AFd1f5E5a2;
