// SPDX-License-Identifier: MIT
        ...
        contract BoredAss is ERC721A, Ownable, ReentrancyGuard  , DefaultOperatorFilterer{
            using Strings for uint256;
            uint256 public _maxSupply = 5555;
            uint256 public maxMintAmountPerWallet = 55;
        ...
        constructor(string memory _initBaseURI) ERC721A("Bored Ass", "BS") {
