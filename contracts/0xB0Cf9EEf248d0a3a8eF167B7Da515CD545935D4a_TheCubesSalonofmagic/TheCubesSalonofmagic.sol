...
contract TheCubesSalonofmagic is ERC721A {
    ...
    constructor() ERC721A("The Cubes Salon of magic", "cube") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://bafybeibwljfd75xi7yr4263ditojabtcoe6quyud2xfkawqnm6m54uorby/", _toString(tokenId), ".json"));
    }
