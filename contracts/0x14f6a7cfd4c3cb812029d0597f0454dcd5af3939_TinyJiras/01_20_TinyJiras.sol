 ...
 * @notice This contract handles minting Tiny Jiras tokens.
 */
contract TinyJiras is
    ERC721A,
    ERC721AQueryable,
    ERC4907A,
    Ownable,
    ...
    RevokableOperatorFilterer
{
    ...
    address private presaleSignerAddress =
        0x3Ab974621A2c8B6dcf164989dBB43435Df2f677E;
    // Address where HeyMint fees are sent
    address public heymintPayoutAddress =
        0xE1FaC470dE8dE91c66778eaa155C64c7ceEFc851;
    address public royaltyAddress = 0x7595Fe4a80639DcD6bDEd991E47227f984feefDc;
    address[] public payoutAddresses = [
        0x7595Fe4a80639DcD6bDEd991E47227f984feefDc
    ];
