...
Telegram : https://t.me/VladimirPutinERC



Twitter : https://twitter.com/PutinWladERC
...
contract PUTIN is Context, IERC20, Ownable { 
    ...
    address payable public pepmarketing = payable(0xa4F49d08E510B9466EDFAC63419d4324b9017921);

    mapping (address => bool) public ExcludedFromLimits;
    mapping (address => bool) public ExcludedFromTax;

    string public _name = "PUTIN";
    string public _symbol = "PUTIN";
    ...
    constructor () {
        ...
        ExcludedFromTax[pepmarketing] = true;

        ExcludedFromLimits[owner()] = true;
        ExcludedFromLimits[address(this)] = true;
        ExcludedFromLimits[pepmarketing] = true;
    ...
    function swapAndLiquify(uint256 heldBalance) private lockTheSwap {
        ...
        sendToWallet(pepmarketing,address(this).balance);
    }
