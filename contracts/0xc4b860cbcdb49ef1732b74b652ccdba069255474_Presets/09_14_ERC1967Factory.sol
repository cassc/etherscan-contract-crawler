...
contract ERC1967Factory {
    ...
    function upgradeAndCall(address proxy, address implementation, bytes calldata data) internal {
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function deploy(address implementation, address admin, bytes32 salt, bool useSalt, bytes calldata data)
        internal
