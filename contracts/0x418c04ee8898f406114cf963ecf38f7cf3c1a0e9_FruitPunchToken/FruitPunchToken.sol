...
/**
    Fruit Punch Mixer Bot
    Experience seamless and efficient crypto mixer with our free-to-use Telegram bot.
    
    Twitter: twitter.com/fpmixerbot
**/
...
contract FruitPunchToken is ERC20, Ownable {
    ...
    constructor() ERC20("Fruit Punch Mixer Bot", "FPMBOT") {
        ...
        maxTransactionAmount = 10_000_000 * 1e18; // 0.1%
        maxWallet = 10_000_000 * 1e18; // 0.1% 
        ...
        revShareWallet = address(0x82FE419EC51a0FBa1E7C9b1d18391DC184ccDBc9); // set as revShare wallet
