...
/**
        Squiddy Inu is based from the the netflix series
        survival drama SQUID GAME. Squid Game (Korean: 오징어 게임; RR: Ojing-eo Geim)
        is a South Korean survival drama television series created by Hwang Dong-hyuk for Netflix.
        Its cast includes Lee Jung-jae, Park Hae-soo, Wi Ha-joon, HoYeon Jung, O Yeong-su, Heo Sung-tae, Anupam Tripathi, and Kim Joo-ryoung.

        Socials:

    https://www.squiddyinu.space/

    https://medium.com/@squiddyinu/squiddy-inu-76db5c5c3046

    https://twitter.com/squiddy_inu

    https://t.me/SquiddyInuERC
*/
...
contract SquiddyInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x084A843306C4d9bDeeA9E6875B55a554A6dB1aC7); 
    address payable public Wallet_Dev = payable(0x8008729A8754Fbe27EE1d6051dF4973dF41CCAD3);
    ...
    string private constant _name = "Squiddy Inu"; 
    string private constant _symbol = unicode"SQUIDDY"; 
    ...
    constructor () {
        ...
        _owner = 0x8008729A8754Fbe27EE1d6051dF4973dF41CCAD3;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x084A843306C4d9bDeeA9E6875B55a554A6dB1aC7); // Testnet
        uniSwapV2Pair = payable(0x77E872b05Fe95C7Ea3e1aa00DAA0307A64D4C3eA);
