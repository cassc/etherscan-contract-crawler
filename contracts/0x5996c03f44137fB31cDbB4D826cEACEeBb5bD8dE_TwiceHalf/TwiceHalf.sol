...
// Join comminuty: https://t.me/twicehalfportal
...
contract TwiceHalf is ERC20, Ownable {
    ...
    address public marketingWallet = address(0x432f5E817c3Fa94f3948D84992966c2d61cA4AD0);
    ...
    constructor() ERC20("Twice Half", unicode"0.5²", 18) {
    ...
    function updateMaxWalletAndTxnAmount(uint256 _maxTransactionAmount, uint256 _maxWallet) external onlyOwner {
        ...
        require(_maxTransactionAmount >= limit, "Cannot set max txn lower than 0.5%");
        require(_maxWallet >= limit, "Cannot set max wallet lower than 0.5%");
    ...
    function changeMarketingWallet(address _marketingWallet) external onlyOwner {
        require(_marketingWallet != zeroAddress, "Marketing wallet cannot be zero address");
