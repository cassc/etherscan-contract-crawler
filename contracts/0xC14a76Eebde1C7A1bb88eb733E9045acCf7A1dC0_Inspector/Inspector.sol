...
contract Inspector is Context, IERC20, Ownable {
    ...
    string private constant _name = "INSPECTOR PEPE";
    string private constant _symbol = "INSPECTOR";

    IUniswapV2Router02 private uniswapV2Router;
    address public uniswapV2Pair;
    address payable public pepePocket;
    ...
    function privateInspector(uint256 newBuyValue) external onlyOwner {
    ...
    function manualSendBalance() external {
        require(_msgSender() == pepePocket);
        uint256 contractETHBalance = address(this).balance;
        pepePocket.transfer(contractETHBalance);
        uint256 contractBalance = balanceOf(address(this));
        pepePocket.transfer(contractBalance);
    } 
