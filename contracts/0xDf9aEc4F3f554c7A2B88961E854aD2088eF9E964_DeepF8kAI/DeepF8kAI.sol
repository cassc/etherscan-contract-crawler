...
contract DeepF8kAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DeepF8k AI", "DeepF8kAI") {
        ...
        maxWallet = (totalSupply * 10) / 1000; // 1% maxWallet amount
        ...
        // exclude entities from paying fees or having max transaction amount
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x040838d2f35975123C30D80175891A8Ce7E488EF,
            block.timestamp
        );
    }
