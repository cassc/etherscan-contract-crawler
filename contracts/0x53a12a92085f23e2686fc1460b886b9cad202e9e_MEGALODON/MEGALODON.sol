...
Website: https://megalodon.lol 0% tax
 ...
 */
contract MEGALODON is ERC20 {
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 888080888 * 10 ** 18;

    /**
     * @dev Sets the value of the `decimals`. This value is immutable, it can only be
     * set once during construction.
     */
    constructor () ERC20('MEGALODON', unicode"MEGA", _msgSender()) {
