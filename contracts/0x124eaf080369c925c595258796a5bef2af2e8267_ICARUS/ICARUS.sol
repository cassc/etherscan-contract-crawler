...
/**
   ...
   "There's a premise in Western culture that to gain something you must lose. 
   If you're Icarus and you try to fly, you'll fly too high and melt your wings. 
   But guess what, we fly every day, commercial air flight"
*/
...
contract ICARUS is Context, IERC20, Ownable {
    ...
    string private _name = "ICARUS INU";
    string private _symbol = "ICARUS";
    ...
    address payable public marketingWallet = payable(0x49f25b65e6845420EFB74F66Efcb89cdfe7b64d6);
