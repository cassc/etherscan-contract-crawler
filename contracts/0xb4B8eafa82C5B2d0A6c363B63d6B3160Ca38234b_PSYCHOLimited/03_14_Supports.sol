...
contract Supports is
    ...
    /**
     * @dev Constructs Metadata and Master contracts
     */
    constructor(
    ) Metadata(
        "PSYCHO Limited",
    ...
    /**
     * @dev Relinquishes master role
     * and sets fee to zero
     */
    function relinquish(
        bool _bool
    ) public master {
    ...
    /**
     * @dev Use `true` to activate genesis
     * `false` to deactivate genesis
     */
    function activate(
        bool _bool
    ) public master {
