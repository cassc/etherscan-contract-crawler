...
contract HeyDEV is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"When Marketing?";
    string private constant _symbol = unicode"HeyDEV";
