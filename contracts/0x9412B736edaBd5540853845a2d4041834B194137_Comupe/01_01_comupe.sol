...
Twitter:  https://twitter.com/ComupeCoin
Telegram: https://t.me/ComupeCoin
Website:  https://comupecoin.com/
...
contract Comupe is ERC20, Ownable {
    ...
    constructor() ERC20("Comupe", "COMUPE") {
    ...
    function updateBothFees(uint256 _buy, uint256 _sell) external onlyOwner {
        buyTotalFees = _buy;
        sellTotalFees = _sell;
    }
