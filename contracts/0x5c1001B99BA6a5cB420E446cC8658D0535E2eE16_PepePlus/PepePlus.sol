...
contract PepePlus is Context , IERC20, Ownable {
    ...
    string private constant _name = "Pepe Plus";
    string private constant _symbol = "PEPE+";
    uint256 public _maxTxAmount = 1725000 * 10**_decimals;
    uint256 public _maxWalletSize = 1725000 * 10**_decimals;
    uint256 public _taxSwapThreshold= 690000 * 10**_decimals;
    uint256 public _maxTaxSwap= 1725000 * 10**_decimals;
    ...
    function setTax(uint256 buyTax, uint256 sellTax) external onlyOwner{
        require(sellTax < _SellTax && buyTax < _BuyTax, "Cannot set higher tax");
        _BuyTax = buyTax;
        _SellTax = sellTax;
    }
