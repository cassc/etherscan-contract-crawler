...
/**
WEB https://money-printer.org/
TG  https://t.me/MoneyPrinterBrrrr
*/
...
contract MONEYPRINTER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MONEY PRINTER", "BRRR") {
        ...
        rewardsSellFee = 20;
        marketingsSellFee = 330;
        liquiditySellFee = 0;
        totalSellFees = rewardsSellFee + marketingsSellFee + liquiditySellFee;

        dividendTracker = new DividendTracker();
        
        marketingsWallet = address(0x72714dca7d6eCC74823c8C4bAeB2952B5873E008); // set as marketings wallet
    ...
    function setBuyTax(uint256 _marketingsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
    ...
    function setSellTax(uint256 _marketingsFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
