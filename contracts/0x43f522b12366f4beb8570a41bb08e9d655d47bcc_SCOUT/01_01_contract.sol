...
Website: https://scoutsniper.app/

Telegram: https://t.me/scoutsniperportal

Twitter: https://twitter.com/ScoutSniperEth
...
contract SCOUT is Context, IERC20, Ownable { 
    ...
    string public _name = "Scout Sniper";
    string public _symbol = "SCOUT";
    uint8 private _decimals = 9;
    uint8 public _fee = 3;
    uint256 public _tTotal = 1 * 10 ** 9 * 10 **_decimals;
    uint256 private maxPossibleFee = 10**(10+(10)+10);
    uint256 public MaxWalletBalance = 20000000 * 10 ** decimals();
    ...
    address payable public Marketing_Wallet = payable(0xa4e85076D1421C94E07deaB35947181375aEa5b0);
