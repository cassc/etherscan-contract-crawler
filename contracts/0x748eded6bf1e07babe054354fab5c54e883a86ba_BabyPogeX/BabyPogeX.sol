...
/**
  Telegram: https://t.me/Babypogex
  Twitter: https://twitter.com/BabyPogeX

  Buy Baby PogeX and get rewarded in PogeX!
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 RWRD = IERC20(0xAEd8077B25c88AF2e711aBdcc24ef9389B028876);
...
contract BabyPogeX is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby PogeX";
    string constant _symbol = "BogeX";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7D561254BE147795Bfd37471e3bd3Fe615Fe55b6;
        teamFeeReceiver = 0xE161C7cf07589093Ed3ED8A8082C30276d8FcC39;
