...
contract ShiroInu is Context, IERC20, Ownable { 
    ...
    address payable public AdvertisingWallet = payable(0x8C84cD35bE96D57E9Ac3312425cDe2164E47c57B);
    address payable public DeadW = payable(0x000000000000000000000000000000000000dEaD);

    string public _name = unicode"Shiro Inu";
    string public _symbol = unicode"$SHIRO";
