...
contract Unihorns is ERC721AQueryable, ERC721ABurnable, EIP712, Ownable {
    ...
    uint public maxWhitelistSupply = 300;
    uint public normalMintPrice = 0.005 ether;
    uint public whitelistMintPrice = 0 ether;
    uint public maxNormalMintPerAccount = 10;
    uint public maxWhitelistMintPerAccount = 3;
    uint public publicSalesTimestamp = 1550496400;
    uint public whitelistSalesTimestamp = 1560489200;
    ...
    constructor() ERC721A("Unihorns", "UNI") EIP712("Unihorns", "1.0.0") {
    }
