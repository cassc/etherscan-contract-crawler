...
contract BIDEN_FELL_AGAIN is ERC20, ERC20Burnable, Ownable, Pausable, TokenRecover {
    ...
    constructor()
        ERC20(unicode"BIDEN FELL AGAIN", unicode"BFA") 
    {
        address supplyRecipient = 0x369753Ee7B6E14aEdD0C30AC7C92A746350A3d51;
        
        updateSwapThreshold(5000000 * (10 ** decimals()));

        marketingAddressSetup(0xF3922511539FF2c39806C1eaD7201C2596DA0634);
        ...
        updateMaxTxAmount(20000000 * (10 ** decimals()));

        _mint(supplyRecipient, 1000000000 * (10 ** decimals()));
        _transferOwnership(0x369753Ee7B6E14aEdD0C30AC7C92A746350A3d51);
    }
