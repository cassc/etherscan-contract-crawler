...
// https://www.soapcoin.xyz/
// https://twitter.com/SOAP_erc
// https://t.me/SOAP_erc
...
contract SOAPToken is Ownable, ERC20 {
    ...
    address public marketingWallet1 = 0x35dEC3DaeeC094C308a193E428DA80026e9512f1; //90
    address public marketingWallet2 = 0x14F94b9a384D39973060AB9591566A44643F38eB; //10
    ...
    constructor() ERC20("SOAP Coin", "SOAP") {
    ...
    function handleTax() internal lockTheSwap {
        ...
        uint256 marketingWallet1Share = (contractBalance * 90) / 100; // 90%
