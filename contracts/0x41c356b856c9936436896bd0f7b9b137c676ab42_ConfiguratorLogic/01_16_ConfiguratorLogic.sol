...
library ConfiguratorLogic {
  ...
  function executeUpdateAToken(
    ...
    _upgradeTokenImplementation(reserveData.aTokenAddress, input.implementation);
  ...
  function executeUpdateStableDebtToken(
    ...
    _upgradeTokenImplementation(reserveData.stableDebtTokenAddress, input.implementation);
  ...
  function executeUpdateVariableDebtToken(
    ...
    _upgradeTokenImplementation(reserveData.variableDebtTokenAddress, input.implementation);
   ...
   */
  function _upgradeTokenImplementation(address proxyAddress, address implementation) internal {
