...
contract SEIBA is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "SEIBA";
    string private constant _symbol = unicode"せいば";
    ...
    address payable private _developmentAddress = payable(0x501B5B2b95cf471762c6A6629a815dFaDc10fcBD);
    address payable private _marketingAddress = payable(0x501B5B2b95cf471762c6A6629a815dFaDc10fcBD);
