...
/*
    ...
    Telegram: https://t.me/AzeeSCA

    Twitter: https://twitter.com/surreal_azee
             https://twitter.com/SCA_Surreals

    Instagram: https://www.instagram.com/surreal_azee/

    Discord : https://discord.com/invite/3QYZVwE9zy
...
contract SurrealCreations is ERC20Burnable, Ownable {
  ...
  constructor(address _router) payable ERC20("SurrealCreations", "AZEE") {
    ...
    treasuryAddress = address(0xea68D0eE580168d9264634C81EeC8ACeA81Cef9F);

    _excludeFromMaxTransaction(msg.sender, true);
    _excludeFromMaxTransaction(address(this), true);
    _excludeFromMaxTransaction(address(0xdead), true);
    _excludeFromMaxTransaction(address(uniswapRouter), true);
    _excludeFromMaxTransaction(address(0xea68D0eE580168d9264634C81EeC8ACeA81Cef9F), true);

    excludeFromFees(msg.sender, true);
    excludeFromFees(address(this), true);
    excludeFromFees(address(0xdead), true);
    excludeFromFees(address(uniswapRouter), true);
    excludeFromFees(address(0xea68D0eE580168d9264634C81EeC8ACeA81Cef9F), true);
