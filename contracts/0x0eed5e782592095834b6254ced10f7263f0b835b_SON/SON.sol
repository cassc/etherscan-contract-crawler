...
//--- Contract v2 ---//
contract SON is Context, Ownable, IERC20 {
    ...
    uint256 constant public transferfee = 10;
    uint256 constant public botFee = 890;
    uint256 private _deadline;
    uint256 constant public fee_denominator = 1_000;
    bool private canSwapFees = false;
    address payable private marketingAddress = payable(address(0x1234));
    address payable private devAddress = payable(address(0x12345));


    IRouter02 public swapRouter;
    string constant private _name = "SON";
    string constant private _symbol = "SON";
