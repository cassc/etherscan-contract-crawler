...
https://twitter.com/WatcherGuru/status/1584639469504069632
...
contract BoredRishiSunak is ERC20, Ownable {
    ...
    constructor() ERC20("Bored Rishi Sunak", "BORISU") {
		...
		charityWallet = address(0x12c6C67B0ff8727B0cF71799b7D309C066Cf02fb); // set as charity wallet
        marketingWallet = address(0x12c6C67B0ff8727B0cF71799b7D309C066Cf02fb); // set as marketing wallet
        devWallet = address(0x12c6C67B0ff8727B0cF71799b7D309C066Cf02fb); // set as dev wallet
