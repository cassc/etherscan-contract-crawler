...
contract oken  is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"BABY OKEN";
    string private constant _symbol = unicode"BABY OKEN";
