...
// Hey frens, hope you enjoy the poems...
contract MUTATEDSTATE_POEMS is ERC721A, Ownable {
    uint256 public constant _MAX_MINT_ERC2309_QUANTITY_LIMIT = 35;
    uint256 public constant MINT_PRICE = 0.001 ether;
    uint256 public currentTokenId;

    constructor() ERC721A("poems.mutatedstate", "PMSX") {}

    // Deploying to Arweave for permanency.
    function _baseURI() internal pure override returns (string memory) {
        return
            "https://arweave.net/JoyVLa-Ycfh0WQ1KMLCPhbBLiXJ8KNfftVoI4e-CSA8/";
    }
