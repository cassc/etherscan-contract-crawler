...
contract UpEthereum is ERC20, Ownable {
    ...
    UpEthereumDividendTracker public dividendTracker;
    ...
    constructor() ERC20("UpEthereum", "UPETH") {
        marketingWallet = payable(0x3f1F84c01FCd4104E561c6F12E2ba9B901AD8338);
        devWallet = payable(0xeEC0CeBE2914a161B837AF7Ca7e96ac624c38cd6);
        ...
        dividendTracker = new UpEthereumDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 30; // 3%
...
contract UpEthereumDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    UpEthereum public UpEthereumContract;
    ...
    constructor(
        ...
        defaultToken = token;
        UpEthereumContract = UpEthereum(mainContract);
    ...
    function _transfer(
        ...
        require(false, "UpEthereum_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "UpEthereum_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main UpEthereum contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(UpEthereumContract);

            uint256 prevBalance = UpEthereumContract.balanceOf(address(this));
            ...
            {
                uint256 received = UpEthereumContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    UpEthereumContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
