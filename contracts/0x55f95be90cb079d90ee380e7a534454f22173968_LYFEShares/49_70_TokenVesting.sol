...
contract TokenVesting {
    ...
    address public _BLOC_contract_address;
    ERC20 BLOC;
    ...
    function setBLOCAddress(address BLOC_address) public {
        require(msg.sender == _owner, "must be set by the owner");
        _BLOC_contract_address = BLOC_address;
        BLOC = ERC20(BLOC_address);
    }
    ...
    function release() public {
        ...
        BLOC.transfer(_beneficiary, unreleased);
    ...
    function revoke() public {
        ...
        uint256 balance = BLOC.balanceOf(address(this));
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external {
        ...
        require(tokenAddress != _BLOC_contract_address, "Cannot withdraw the BLOC through this function");
    ...
    function _vestedAmount() private view returns (uint256) {
        uint256 currentBalance = BLOC.balanceOf(address(this));
