 ...
 * Version 0x11
 * Add PMSet, PMAssign, pm for granting PositionManagers powers
 * Added PMTransfer for contracts set to be PM the ability to move tokens with certain restrictions
 * Added softLiq parameter as point to be considered for soft liquidation
 * @author RoeLabs
 **/
...
contract LendingPool is VersionedInitializable, ILendingPool, LendingPoolStorage {
  ...
  uint256 public constant LENDINGPOOL_REVISION = 0x13;
