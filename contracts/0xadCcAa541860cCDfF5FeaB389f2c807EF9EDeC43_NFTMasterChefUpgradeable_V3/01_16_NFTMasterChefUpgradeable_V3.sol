...
contract NFTMasterChefUpgradeable_V3 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC721EnumerableUpgradeable {
...
/*
    ...
    */
    ...
    function setImageUri(string memory _image) public onlyOwner {
        imageUri = _image;
    }
