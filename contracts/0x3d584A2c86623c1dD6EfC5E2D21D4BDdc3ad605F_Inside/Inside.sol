...
Telegram: https://t.me/insideerc20
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x654212157f75CEf8B78f76AeC48A236Fbd6922C7; // owner address
...
contract Inside is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Inside Coin";
    string private _symbol = "INSIDE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x654212157f75CEf8B78f76AeC48A236Fbd6922C7); // Marketing Address
    address payable public teamWalletAddress = payable(0x654212157f75CEf8B78f76AeC48A236Fbd6922C7); // Team Address
