...
contract FLOKI30 is Ownable, ERC20 {
    ...
    string constant _name = "Floki 3.0";
    string constant _symbol = "FLOKI3";
    ...
    uint256 _totalSupply =  420690000000030 * 10**_decimals; 
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x82cEBffA73d8e0Aa429c25AA2d7889fF231b377a;
