...
Let's burn the supply 🔥TOGETHER🔥 along with any jeets that stand in our way 🔥🔥🔥🔥!
...
contract Dracarys is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dracarys";
    string private constant _symbol = "DRACARYS";
