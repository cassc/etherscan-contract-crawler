...
// https://twitter.com/FUFU_COIN
// https://fufucoin.xyz
// https://t.me/FUFUPORTAL
...
contract FUFU is ERC20, Ownable {
    ...
    constructor() ERC20("FUFU", "FUFU") {
        ...
        uint256 totalSupply = 888e9 * 1e18;
        ...
        marketingWallet = address(0x7BbbAFFC043f45a51CE65fE364EecA0840464f07);
        devWallet = address(0x7BbbAFFC043f45a51CE65fE364EecA0840464f07);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (block.number < taxTill) {
                ...
                tokensForMarketing += (fees * 94) / 50;
                tokensForDev += (fees * 5) / 50;
