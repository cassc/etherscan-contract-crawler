...
contract SuperPortalBush is Context, IERC20, Ownable {
    ...
    string private _name = "SuperPortalBush";
    string private _symbol = "SuperPortalBush";
    ...
    address payable public marketingWallet = payable(0x36B9AAfaD9D9224EEA5d529ec3AAc97db2D8e622);
