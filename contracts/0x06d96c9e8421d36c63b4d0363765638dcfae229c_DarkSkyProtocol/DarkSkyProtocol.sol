...
Token Name: DarkSky Protocol

Ticker: DSP

TG : https://t.me/DarkSkyProtocolPortal


Medium : https://darkskyprotocol.medium.com/the-dark-sky-protocol-87e5b1256e2d
...
contract DarkSkyProtocol is Context, IERC20, Ownable {
    ...
    uint256 private _reduceTaxAt=200;
    uint256 private _preventSwapBefore=10;
    uint256 private _buyCount=0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1000000 * 10**_decimals;
    string private constant _name = unicode"DarkSky Protocol";
    string private constant _symbol = unicode"DSP";
