...
/**
With the rapid advancement going on in the tech ecosystem and a whole lotta things can’t actually happen in tech without a connection.
So we have decided to bring in something very unique into the system with a strong utility capable of ensuring the users benefit from what’s coming their way .
We bring to you the WI-FI Token✅

🔵Telegram : https://t.me/wifiofficial

🌐Website : https://wifiofficial.com/

🕊Twitter : https://twitter.com/wifitoken
*/ 
...
contract WIFITOKEN is ERC20, Ownable, BaseMath {
    ...
    string private constant _name = "WIFI TOKEN";
    string private constant _symbol = unicode"$信任";
