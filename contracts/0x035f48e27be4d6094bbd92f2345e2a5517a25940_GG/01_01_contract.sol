...
As the Binance story unfolds, expect turbulence in the crypto space.

TG - https://t.me/byenancegg
X - https://twitter.com/ByenanceGG
Web - https://byenance.gg/
...
contract GG is Context, Ownable, IERC20 {
    ...
    uint256 public _maxTransaction = 100000000000000000;
    uint256 public _maxWallet = 100000000000000000;
    uint256 public _swapTokensAtAmount = 500000000000000;
    ...
    function openTrade() public onlyOwner{
        require(!startTrading, "Trading is already enabled");
        startTrading = true;
    }  
    ...
    function _transfer(
        ...
        require(startTrading || _isExcludedFromFee[from] || _isExcludedFromFee[to], "Trading is not enabled yet");
    ...
    function setMinSwapAmount(uint256 swapTokensAtAmount) public onlyOwner {
