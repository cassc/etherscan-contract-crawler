...
He is an antagonist in both the Jujutsu Kaisen series 
His experiences as a jujutsu sorcerer bred a deep hatred for non-sorcerers, leading to an incident where Suguru massacred over a hundred civilians in a single night
He was expelled from Jujutsu High and came to be known as the worst of all curse users

Social :
Telegram : https://t.me/SuguruGetoERC
Twitter : https://twitter.com/SuguruGetoERC
...
contract SuguruGeto is Context, IERC20, Ownable {
    ...
    string private constant _name = "Suguru Geto";
    string private constant _symbol = "SUG";
