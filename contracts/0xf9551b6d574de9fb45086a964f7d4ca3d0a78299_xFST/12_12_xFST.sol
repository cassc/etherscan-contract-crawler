...
contract xFST is ReentrancyGuard, Ownable, Pausable {
    ...
    ///@notice claims fees, swaps them for FST, and stakes that FST
    ///@param amountOutMin the minimum FST back you want to get for your rewards.
