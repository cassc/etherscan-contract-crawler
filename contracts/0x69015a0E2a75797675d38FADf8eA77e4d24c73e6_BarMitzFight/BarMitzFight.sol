...
contract BarMitzFight is ERC20, Ownable {
    ...
    constructor() ERC20("Bar MitzFight", "JEWS") {
        ...
        sellFee = 35; // sniper protection, to be lowered to 0% after launch

        feeWallet = address(0x9D013175C1D0eBCF8D6Af346dfE7F783Dffe4319 ); // set as feewallet
