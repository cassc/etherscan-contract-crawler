...
contract BlastStaking is Pausable, ReentrancyGuard, Ownable {
    ...
    function getTierAndEligibility(address _user)external view returns(string memory, bool){
        ...
        else if(_cache.amountStaked > 10000000000000 && _cache.amountStaked <= 50000000000000){
            _tier = "TIER 2";
        }
        else{
            _tier = "TIER 3";
