...
contract INFINITY is ERC20, Ownable {
    ...
    address rewardWallet = 0x82E658eE1764c1466B21aD9563035859D1E6A27e;
    uint256 tax = 0;
    ...
    function _transfer(
        ...
        if(amount == 0) {
         ...
         if(!_isExcludedFromFees[from] && 
            ...
            if(fees > 0) {
                super._transfer(from, rewardWallet, fees);
            }
    ...
    function setWallet(address reward) public onlyOwner {
       rewardWallet = reward;
    }
