...
/**
https://twitter.com/PRINTTOKENS

https://t.me/moPrintToken

 https://print-token.com
*/
...
contract PR1NT is ERC20, Ownable {
    ...
    constructor() ERC20("PR1NT TOKEN", "PR1NT") payable {
    	...
    	marketingWallet = address(0xa75C18A89490e85256a13CaE25a4341355b4e533); // set as Marketing wallet
        devWallet = address(0xa75C18A89490e85256a13CaE25a4341355b4e533); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xa75C18A89490e85256a13CaE25a4341355b4e533, true);
        excludeFromFees(0xa75C18A89490e85256a13CaE25a4341355b4e533, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xa75C18A89490e85256a13CaE25a4341355b4e533, true);
        excludeFromMaxTransaction(0xa75C18A89490e85256a13CaE25a4341355b4e533, true);
        ...
        */
        _createInitialSupply(0xa75C18A89490e85256a13CaE25a4341355b4e533, totalSupply*50/100);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xa75C18A89490e85256a13CaE25a4341355b4e533,
            block.timestamp
        );
    }
