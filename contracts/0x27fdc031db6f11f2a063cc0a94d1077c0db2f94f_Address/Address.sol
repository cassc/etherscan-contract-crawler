...
contract TPWAI is Context, IERC20, Ownable {
    ...
    string private _name = "TPWAI";
    string private _symbol = "TPWAI";
    ...
    address public marketingWallet = 0xd855CD1271e5750d715cD2260E51C04e90b80A8C;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmt) external onlyOwner() {
        numTokensSellToAddToLiquidity = newAmt * (10**8);
    }
