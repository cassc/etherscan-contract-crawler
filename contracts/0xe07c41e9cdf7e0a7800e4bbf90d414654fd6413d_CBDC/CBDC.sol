...
contract CBDC is Context, IERC20, Ownable {
    ...
    string private constant _name = "CBDC";
    ...
    address payable private _developmentAddress = payable(0x727f394D85dfF49bE343E80b61ebFF1b90dbc808); 
    address payable private _marketingAddress = payable(0x727f394D85dfF49bE343E80b61ebFF1b90dbc808);
