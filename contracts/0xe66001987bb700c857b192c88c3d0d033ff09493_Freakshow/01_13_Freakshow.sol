    ...
    DefaultOperatorFilterer
{
    ...
    ExchangedCustomToken[] customFreakshowTokens;
    ...
    function getCustomFreakshowTokens()
        external
        view
        returns (ExchangedCustomToken[] memory)
    {
        ...
        whenNotPaused
    {
        ...
        customFreakshowTokens.push(
            ExchangedCustomToken({
                clownzId: _tokens[0],
                freakshowId: _nextTokenId().sub(1)
            })
        );
    }
