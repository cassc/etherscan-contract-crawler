...
contract RamenDAO is ERC721
 {
    ...
    uint256 public immutable price = 0.05875 ether;

    constructor() ERC721("RamenDAO @ ETHBerlin by Crypto Nomads Club", "RAMEN") {
        owner = msg.sender;
    }

    function tokenURI(uint256) public pure override returns (string memory) {
        return "ipfs://QmWBRWWqT51uFiPCQQx1iR7RPecuAQwM7apuJfBVF4krYy/";
    }
