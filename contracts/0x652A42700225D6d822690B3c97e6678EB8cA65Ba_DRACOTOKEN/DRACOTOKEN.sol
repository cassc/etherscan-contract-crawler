...
contract DRACOTOKEN is ERC20, Ownable {
    ...
    // Owner can't disalbe trade.
    bool public tradingEnabled = false;
    bool private swapping;

    // Marketing wallet
    address private marketingWallet = address(0xB271A5aE1317C62d2a85E1251eCc7867182052B6);
    ...
    constructor() ERC20("DRACO TOKEN", "DAR", 18) {
    ...
    function enableTrading() external onlyOwner {
        require(tradingEnabled == false, "Tranding has been enabled.");
        tradingEnabled = true;
    }
    ...
    function updateFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee;
        require(buyTotalFees <= 6, "Must keep buy total fees at 6% or less.");
        require(buyTotalFees <= 6, "Must keep sell total fees at 6% or less.");
    }
