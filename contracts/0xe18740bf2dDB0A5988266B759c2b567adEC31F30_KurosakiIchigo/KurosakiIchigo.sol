...
https://t.me/KurosakiIchigoERC


https://kurosakieth.net/


https://twitter.com/kurosakiichigoe
...
abstract contract baseToken is IERC20, Ownable {
    ...
    constructor (
        ...
        allot=Allot(0,0,0,0,0);
        fees=Fee(2,2,2,100);
        marketingAddress = msg.sender;
        swapThreshold = total.div(1000000);
        maxSwapThreshold = total.div(1000000);
...
contract KurosakiIchigo is baseToken {
