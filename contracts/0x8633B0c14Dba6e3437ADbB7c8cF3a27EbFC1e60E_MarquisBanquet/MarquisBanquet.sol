...
contract MarquisBanquet is Ownable, VRFConsumerBaseV2 {
    ...
    function cleanPayments() public {
        ...
        while(paymentIndex < allPaymentIds.length) {
            Payment memory _payment = payments[allPaymentIds[paymentIndex]];
            ...
            allPaymentIds[paymentIndex] = allPaymentIds[allPaymentIds.length - 1];
            allPaymentIds.pop();
