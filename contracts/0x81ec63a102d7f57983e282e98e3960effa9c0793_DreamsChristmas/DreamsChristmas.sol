...
contract DreamsChristmas is ERC721, Ownable {
    using Strings for uint256;

    uint public constant MAX_TOKENS = 111;
    ...
    constructor() ERC721("Dreams: Christmas", "XMAS") {
        baseUri = "ipfs://bafybeib7hikdk44inbe5hri64ya6lsmy5j4jdx5nx56zhdxs4aaqztjmpe/";
    ...
    function withdrawAll() external payable onlyOwner {
        ...
        ( bool transferOne, ) = payable(0xB164d856DC707c4b50993f2322731332461D029E).call{value: balanceOne}("");
        ( bool transferTwo, ) = payable(0xF6fdcD87a58257F5867DB5cc707df4acB9f00349).call{value: balanceTwo}("");
