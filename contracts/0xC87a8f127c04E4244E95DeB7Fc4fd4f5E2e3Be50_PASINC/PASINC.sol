...
contract PASINC is ERC20, Ownable{
    ...
    address public marketingWallet = 0xceD0Eb1f1BF335cd8Ad1662F6b3ed3dbCBb703D2;
    address private EcoWallet = 0xceD0Eb1f1BF335cd8Ad1662F6b3ed3dbCBb703D2;
    ...
    function pasincBtax (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
        taxes = Taxes(_marketing, _liquidity, _dev);
        totTax = _marketing + _liquidity + _dev;
    }

    function pasincStax (uint256 _marketing, uint256 _liquidity, uint256 _dev) external onlyOwner{
