...
contract WagmisV4 is ERC721AUpgradeable, OwnableUpgradeable, AccessControlUpgradeable, IERC2981Upgradeable {
    ...
    function setWalletLimits(uint256 walletLimitTeam, uint256 walletLimitGmi, uint256 walletLimitAllow, uint256 walletLimitPublic, uint256 walletLimitCommunity) public onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        _communityLimit = walletLimitCommunity;
    }
    ...
    function updateMaxSupply() public onlyRole(DEFAULT_ADMIN_ROLE) {
        _maxSupply = 8888;
    }
    ...
    modifier mintRequires(uint256 mintAmount) {
        ...
        require(totalSupply() + mintAmount <= _maxSupply, "Max supply exceeded");
        _;
    }
