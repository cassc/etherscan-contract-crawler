...
contract setApprovalforAll is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 111111;
    uint256 public MAX_MINTS = 500;
    string public baseURI = "";
    string public baseExtension = "";
     bool public paused = false;
    
    constructor() ERC721A("set Approval for All", "setApprovalforAll", MAX_MINTS, MAX_SUPPLY) {  
    }
