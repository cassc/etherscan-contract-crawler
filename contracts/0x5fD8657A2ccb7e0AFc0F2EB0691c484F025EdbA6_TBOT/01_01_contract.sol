...
contract TBOT is Context, IERC20, Ownable {
    ...
    string private constant _name = "TeleBetting";
    string private constant _symbol = "TBET";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  10000000000  * 10**_decimals;
    uint256 public _maxWalletAmount = 249000001 * 10**_decimals;
    uint256 public _maxTxAmount =  249000001 * 10**_decimals;
    ...
    function updateMaxTransaction(uint256 _maxTx, uint256 _maxWallet) public onlyOwner {
