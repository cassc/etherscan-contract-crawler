...
contract TeamCAT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Team CAT";
    string private constant _symbol = unicode"TEAMCAT";
