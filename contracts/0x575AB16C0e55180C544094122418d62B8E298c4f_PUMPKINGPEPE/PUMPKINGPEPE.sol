...
Web: https://pumpkingpepe.com

TG: https://t.me/PumpKingPepe

X: https://x.com/pumpkingpepe
...
contract PUMPKINGPEPE is ERC20, Ownable {
    ...
    constructor () ERC20("PumpKing Pepe", "PUMPKING") 
    {   
        address newOwner = 0x423c9A907589AdAdB096F5A181d126FFF770FC58;
        ...
        marketingWallet = 0xB3C17aE0a30b054CCd5Dc16E664400c2942ec986;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping) {
            ...
            if(block.timestamp - timeInTrade <= 5 minutes) _totalFees = 5;
            else _totalFees = buyFee;
        } else if (to == uniswapV2Pair) {
            if(block.timestamp - timeInTrade <= 5 minutes) _totalFees = 10;
