...
contract PresaleAVAX {
    ...
    constructor (
        ...
        uniswapV2Router02 = IJoeRouter02(_uniswapV2Router02);
    ...
    function unlockLPTokens() public onlyPresaleOwner isPresaleEnded {
        ...
        address WBNBAddr = uniswapV2Router02.WAVAX();

        address pairAddress = IJoeFactory(factory).getPair(tokenInfo.tokenAddress, WBNBAddr);
