...
contract OrdinalLogic is ERC721A {
    ...
    constructor() ERC721A("Ordinal Logic", "OL") {
        owner = msg.sender;
    }

    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmZ5GXEwbgVV2cRbj3GazBpkpH7dGwfyDwhEQkgoCMURjU/", _toString(tokenId), ".json"));
    }
