...
https://t.me/EeahsapaEntry

This man with hard features, with an expression filled with piercing wisdom, as he appears on the photographs of the time, carried the destiny of his people at arm's length, for whom he desired only one thing, a free life. He was a warrior to the core of his being. And yet, there was no more ardent defender of peace than him.
...
contract Eeahsapa is ERC20, Ownable {
    ...
    constructor(address _liquidityManagerAddress) ERC20("Eeahsapa", "Eeahsapa") {
        devWallet = owner();

        uint256 totalSupply = 1 * 1e6 * 1e5; // 100,000
        supply = totalSupply;
