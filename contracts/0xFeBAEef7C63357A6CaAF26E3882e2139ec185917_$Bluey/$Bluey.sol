...
contract $Bluey is ERC20, ERC20Burnable, Ownable, Pausable {
    bool private _tradingEnabled;
    uint256 private _cap;

    constructor() ERC20("$Bluey", "BLU") {
        _cap = 1000000000000000 * 10 ** decimals();
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal whenNotPaused override {
        require(_tradingEnabled || from == owner() || to == owner(), "Trading is not enabled yet");
