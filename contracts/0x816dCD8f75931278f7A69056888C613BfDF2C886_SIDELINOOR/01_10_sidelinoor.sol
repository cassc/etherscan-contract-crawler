...
Telegram : https://t.me/Sidelinoor 
Twitter : https://twitter.com/sidelinoor
Website : https://sidelinoor.xyz/
...
contract SIDELINOOR is ERC20, Ownable {
    modifier lockSwap() {
        _inSwap = true;
        _;
        _inSwap = false;
    ...
    uint256 public maxBuy = 4_000_000 ether;
    ...
    /// @notice Contract TBC balance threshold before `_swap` is invoked
    ...
    /// @notice Change the minimum contract TBC balance before `_swap` gets invoked
    ...
    /// @notice Rescue TBC from the taxes
    /// @dev Should only be used in an emergency
    /// @param _index The tax allocation to rescue from
    /// @param _amount The amount of TBC to rescue
    /// @param _recipient The recipient of the rescued TBC
    ...
    /// @notice Perform a Uniswap v2 swap from TBC to ETH and handle tax distribution
    ...
    /// @notice Transfers TBC from an account to this contract for taxes
    /// @param _account The account to transfer TBC from
