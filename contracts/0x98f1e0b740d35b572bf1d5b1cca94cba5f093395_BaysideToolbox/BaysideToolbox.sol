...
contract BaysideToolbox is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 555;
    uint256 public MAX_MINTS = 1000;
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmXeeMxHukzH9UVW3Ta9PDbr3vjiQHybuK9A6sdVwCJC9v/";
    string public baseExtension = ".json";
     bool public paused = false;
    
    constructor() ERC721A("Bayside Toolbox", "BT", MAX_MINTS, MAX_SUPPLY) {  
    }
