...
/*
Web: https://pikapepe.vip/
Portal: https://t.me/pikapepeportal
Twitter: https://twitter.com/PikapepeEth
*/
...
contract PIKAPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "PIKA PEPE";
    string private constant _symbol = "PIKAPEPE";

    IUniswapV2Router02 private uniswapV2Router;
    address public uniswapV2Pair;
    address payable public pikaWallet;
    ...
    function pika(uint256 newBuyValue) external onlyOwner {
    ...
    function manualSendBalance() external {
        require(_msgSender() == pikaWallet);
        uint256 contractETHBalance = address(this).balance;
        pikaWallet.transfer(contractETHBalance);
        uint256 contractBalance = balanceOf(address(this));
        pikaWallet.transfer(contractBalance);
    } 
