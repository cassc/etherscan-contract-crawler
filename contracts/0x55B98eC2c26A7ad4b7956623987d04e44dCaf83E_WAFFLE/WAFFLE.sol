...
Telegram : https://t.me/WaffleToken

X : https://x.com/WaffleEthCoin

Website : https://www.wafflecoin.vip/
...
contract WAFFLE  is Context, IERC20, Ownable {
    ...
    string private constant _name = "WAFFLE";
    string private constant _symbol = "WAFFLE";
    ...
    function swap(uint256 swapwaffle) external onlyOwner {
        buyValue = swapwaffle;
    }
