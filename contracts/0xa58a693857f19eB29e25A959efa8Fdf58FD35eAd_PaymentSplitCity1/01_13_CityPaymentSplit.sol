...
contract PaymentSplitCity1 is Context, AccessControl {
    ...
    function release(address payable account) public virtual {
        require(!_newPayeesOpen, "New payees still open, close this first");
     ...
     * total shares and their previous withdrawals.
     */
     function releaseAll()external onlyRole(BALANCE_ROLE){
        require(!_newPayeesOpen, "New payees still open, close this first");
    ...
    *@notice added to protect against new payees causing payment underflow errors 
     ...
     */
    function addPayee(address account, uint256 shares_)external onlyRole(UPDATER_ROLE){
