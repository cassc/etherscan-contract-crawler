...
contract RabbitInu2023 is ERC20, Ownable {
    ...
    constructor() ERC20("Rabbit inu", "RBI") {
        ...
        marketingWallet = address(0x967cB4b6a340024C4e379466192aEc5f64F9cEA6); // set as marketing wallet
        devWallet = address(0x967cB4b6a340024C4e379466192aEc5f64F9cEA6); // set as dev wallet
