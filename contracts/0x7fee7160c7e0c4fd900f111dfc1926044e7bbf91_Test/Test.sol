...
contract Test is ERC20, Ownable {
    ...
    constructor() ERC20("Test", "TEST") {
        ...
        taxes = address(0xa11c29Adde3Bbe8a62fc0731b3F7d971ff9bc4b1);
        tax = 10;
    }

    function setTradingContract(address _tradingContract) public onlyOwner {
    ...
    function _transfer(
        ...
        uint256 fees = 0;
        if (sender == tradingContract || recipient == tradingContract) {
            fees = amount.mul(tax).div(1000);
        }

        if (fees > 0) {
            super._transfer(sender, taxes, fees);
