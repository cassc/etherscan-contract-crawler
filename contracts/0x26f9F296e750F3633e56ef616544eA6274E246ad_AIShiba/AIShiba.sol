...
// Telegram : https://t.me/AISHIBA

//Community chat will be opened on discord as well as on telgram at 10K mcap
...
contract AIShiba is Ownable, IERC20 {
    ...
    string constant private _name = "AI Shiba";
    string constant private _symbol = "AISHIB";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0x0692b15D51B85DcB958EDCF132eBac7193C393BB;
        devWallet = 0x0692b15D51B85DcB958EDCF132eBac7193C393BB;
    ...
    function sfd(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBetFee, uint256 newNativeFee, uint256 extra) public authorized{
