...
contract TheLastOfApes is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmUPivBcJx45AvfcWqxRRuBokMz2vFx2H6szWMrdE7wZbV/';
  string public uriSuffix = '.json';
 
  uint256 public cost = 0.002 ether;
  uint256 public maxSupply = 8888;
  uint256 public maxMintAmountPerTx = 30;
  uint256 public freeUntil = 8888;
  uint256 public freebiesPerWallet = 1;
  mapping(address => uint256) public freebieMap;

  bool public paused = true;

  constructor() ERC721A("TheLastOfApes", "TheLastOfApes") {
  }
