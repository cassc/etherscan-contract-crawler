...
contract SCFCollection is ERC721Enumerable, Ownable, IRamperInterface721 {
    ...
    uint256 constant public TOKEN_PRICE = 0.0066 ether;

    string public baseTokenURI = "ipfs://bafybeifbuxvnpaheuz6d2zum3vujrjcbp5wopj3okf5jmar5zb7664ywvy/";

    constructor() ERC721("SOCCER FRIEND Collection", "SOCFNFT") {
