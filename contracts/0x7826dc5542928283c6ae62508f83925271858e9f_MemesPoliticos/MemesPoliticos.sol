 ...
 */
contract MemesPoliticos is ERC20, ServicePayer, GeneratorCopyright {
    constructor(
        string memory name_,
        string memory symbol_,
        bytes memory signature_,
        address payable feeReceiver_
    ) payable ERC20(name_, symbol_) ServicePayer(feeReceiver_, "Memes Politicos", signature_, _msgSender()) {
