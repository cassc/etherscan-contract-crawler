 ...
 * allowances. See {IERC20-approve}.
 */
 contract BlobToken is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    ...
    uint256 public maxTxAmount = 1388 * 10**_decimals;
    uint256 public maxWalletAmount = 1388 * 10**_decimals;
    address public marketingWallet = 0x4F83C72aCC4178bAb0Ea814F72841A1EF07d220e;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 694 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 347 * 10**_decimals;
