// SPDX-License-Identifier: MIT
    ...
    contract Indelible is ERC721A, DefaultOperatorFilterer, ReentrancyGuard, Ownable {
        ...
        constructor() ERC721A(unicode"LarvaDickbutts", unicode"LDB") {
            TIERS[0] = [44,247,380,777,802,1083];
            TIERS[1] = [7,10,13,20,35,36,42,44,66,80,90,102,115,120,123,129,153,200,280,451,465,752];
            TIERS[2] = [158,334,2841];
            TIERS[3] = [20,743,789,1781];
            TIERS[4] = [44,46,73,106,114,158,263,265,266,388,480,525,605];
            TIERS[5] = [7,9,9,10,11,14,18,20,23,31,31,32,35,39,45,59,60,62,75,78,78,87,90,98,117,125,137,137,139,152,153,157,200,279,352,364];
            TIERS[6] = [76,166,783,856,1452];
            TIERS[7] = [9,69,188,696,961,1410];
            TIERS[8] = [356,388,442,636,665,846];
