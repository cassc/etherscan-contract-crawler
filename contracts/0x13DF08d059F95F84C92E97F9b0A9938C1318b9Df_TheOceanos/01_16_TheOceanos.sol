...
contract TheOceanos is ERC721AQueryable, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool os, ) = payable(0xd723D5407340f73D348Cfe2de830A9B70a91659d).call{value: address(this).balance}('');
    require(os);
    // =============================================================================
  }
