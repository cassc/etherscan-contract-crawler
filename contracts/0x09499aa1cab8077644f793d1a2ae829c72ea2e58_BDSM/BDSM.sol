...
/**
Welcome to the hottest token there could ever be!

Come lock in with us!

https://bdsmcoin.com/
https://t.me/BitcoinDogeShibaMeta
https://twitter.com/BDSMCoinETH
...
contract BDSM is Context, IERC20, Ownable {
    ...
    string private constant _name = "BitcoinDogeShibaMeta";//
    string private constant _symbol = "BDSM";//
    ...
    address payable private _developmentAddress = payable(0xA7455cE9493329523222Fc100B445b506918177c);//
    address payable private _marketingAddress = payable(0xA7455cE9493329523222Fc100B445b506918177c);//
