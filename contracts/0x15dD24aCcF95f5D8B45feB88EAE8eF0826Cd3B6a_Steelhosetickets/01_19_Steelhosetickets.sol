...
contract Steelhosetickets is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  string public BASE_URI = 'ipfs://QmPdR2A9tbZwhGSJndLiEvx4kYaRhDGuNwsT6gXjFK8YPN/';
  ...
  uint256 public cellMateAllotedSize;

  bool public paused = true;
  bool public whitelistMintEnabled = false;
  bool public revealed = false;
  bool public celMatesLinked = false;
  ...
  function Claim(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
