...
/*
😈 https://SatanPepe.Vip
👿 https://t.me/SatanPepeCoin
👿 https://Twitter.com/SatanPepeCoin 
*/
...
contract Spepe is IERC20, Auth {
    uint8 private constant _decimals      = 9;
    uint256 private constant _totalSupply = 666_666_666_666 * (10**_decimals);
    string private constant _name         = "Satan Pepe";
    ...
    uint16 private _taxSharesDevelopment = 18;
    uint16 private _taxSharesLP          = 0;
    uint16 private _totalTaxShares = _taxSharesMarketing + _taxSharesDevelopment + _taxSharesLP;

    address payable private _walletMarketing = payable(0x838dbA483169C4346be15B601427A6B7f681863A); 
    address payable private _walletDevelopment = payable(0xB4e9D59bc61E29B55b136419f9B3B4672fDdb47D); 
