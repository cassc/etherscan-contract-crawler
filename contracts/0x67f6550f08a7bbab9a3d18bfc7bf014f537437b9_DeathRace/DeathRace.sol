...
contract DeathRace is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(address(0xf60BDE9380f2d63F382Fc9c620c64CAE8eB32E2A));

    string private _name = "DeathRace";
    string private _symbol = "RaceETH";
