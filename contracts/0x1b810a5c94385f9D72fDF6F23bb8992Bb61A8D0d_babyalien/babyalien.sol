...
contract babyalien is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Baby Alien";
    string private constant _symbol = unicode"BALIEN";
    uint256 public _maxTxAmount =   22222222 * 10**_decimals;
    uint256 public _maxWalletSize = 22222222 * 10**_decimals;
    uint256 public _taxSwapThreshold=0 * 10**_decimals;
    uint256 public _maxTaxSwap=5555556 * 10**_decimals;
