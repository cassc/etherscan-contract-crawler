...
contract ZuckInu2 is ERC20, Ownable {
    // Info? are you sure?
    ...
    // Important addresses
    address payable private DevAddress = payable(0x78D1053915Ba56D6c095B90262D1d38Ec77C5f84);
    address payable private MarketingAddress = payable(0x78D1053915Ba56D6c095B90262D1d38Ec77C5f84);
    ...
    function _tokenTransfer(
        ...
        (feesReales) = CalcularTasasRealesYRefracionarias(
            cantidadBruta,
            takeFee
        );
        ...
        BalancesReales[sender] -= cantidadBruta;
        BalancesReales[recipient] += cantidadNeta;

        if (takeFee) {
            TotalFee += feesReales.TransactionFee;
            AccumulateFee(feesReales);
    ...
    function CalcularTasasRealesYRefracionarias(
        ...
        private view returns (TransactionFees memory realFees)
    {
        if (takeFee) {        
    ...
    function AccumulateFee(
        ...
        BalancesReales[address(this)] += realFees.TransferrableFee;
