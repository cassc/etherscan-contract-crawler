...
//SHIBAPRINT is a Frictionless Yield Redistribution Token on the ETHEREUM Chain. Simply hold the token to Gain Automatic Restribution Rewards


//TELEGRAM : https://t.me/SHIBAPRINTETH
// TWITTER : https://mobile.twitter.com/SHIBAPRINTeth
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE);
...
contract SHIBAPRINT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SHIBA PRINT";
    string constant _symbol = "SHIBAP";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address RewardToken = 0x95aD61b0a150d79219dCF64E1E6Cc01f0B64C4cE;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x90C673F7886C4B9c944df4A514698807F00373e5;
        marketingWallet = 0x90C673F7886C4B9c944df4A514698807F00373e5;
        devWallet = 0x3Cd978479A9137Abc2dF464d6a7aa807f9B8E15A;
