...
contract PawSushiLPStake is Ownable, ReentrancyGuard, DividendStakingToken {
    ...
    constructor()  DividendStakingToken("Paw Stake Tracker", "stPAWsslp") {
        lpToken = IERC20Metadata(0x0dBa3dfeE43d9B6450C716c58fdAE8D3BE37FdC9); //SushiSwap PAW-ETH
        PAWToken = IERC20Metadata(0xDc63269eA166b70d4780b3A11F5C825C2b761B01); //PAW
        wPAWToken = IERC20Metadata(0x083Af0FB9A8982E09e43AC718aeA9773E28c7f06); //wPAW
