...
contract RUGGED is ERC20Permit, Ownable {
    ...
    constructor() ERC20("SHIT", "sHIT", 9) ERC20Permit() {
    ...
    /**
        @notice increases RUGGED supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess RUGGED
