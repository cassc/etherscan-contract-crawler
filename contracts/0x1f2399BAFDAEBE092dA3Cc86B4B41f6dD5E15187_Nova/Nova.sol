...
/** https://twitter.com/Token_Nova?s=20&t=pyqG377vrjTdUTEbkBv48w */
...
contract Nova is ERC20, Ownable {
    ...
    constructor() ERC20("Nova", "Nova") {
        ...
        swapTokensAtAmount = totalSupply * 20 / 10000; // 2.0% swap tokens amount
        ...
        liquidityBuyFee = 0;
        buybackBuyFee = 10;
        totalBuyFees = rewardsBuyFee + operationsBuyFee + liquidityBuyFee + buybackBuyFee;
 
        rewardsSellFee = 30;
        operationsSellFee = 30;
        liquiditySellFee = 0;
        buybackSellFee = 10;
        totalSellFees = rewardsSellFee + operationsSellFee + liquiditySellFee + buybackSellFee;
 
    	dividendTracker = new DividendTracker();
 
    	operationsWallet = address(0x54896D2d0a9737530391542B87573eaF3B11EF1C); // set as operations wallet 
        buybackWallet = address(0x52a03D3b80dEE43aF459E92B7562f53072afA9Bd); // set as operations wallet
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _buybackFee) external onlyOwner {
        operationsBuyFee = _operationsFee;
        rewardsBuyFee = _rewardsFee;
        liquidityBuyFee = _liquidityFee;
        buybackBuyFee = _buybackFee;
        totalBuyFees = operationsBuyFee + rewardsBuyFee + liquidityBuyFee + buybackBuyFee;
        require(totalBuyFees <= 100, "Must keep fees at 10% or less");
    }
 
    function updateSellFees(uint256 _operationsFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _buybackFee) external onlyOwner {
        operationsSellFee = _operationsFee;
        rewardsSellFee = _rewardsFee;
        liquiditySellFee = _liquidityFee;
        buybackSellFee = _buybackFee;
        totalSellFees = operationsSellFee + rewardsSellFee + liquiditySellFee + buybackSellFee;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForOperations + tokensForRewards + tokensForBuyback;
        ...
        uint256 ethForLiquidity = ethBalance - ethForOperations - ethForRewards -ethForBuyback;
