...
// https://twitter.com/Pauly0x/status/1678257943677140992
...
contract PAULYSOL {
    ...
    string public constant name = "PAULY.SOL";   
    string public constant symbol = "PAULY.SOL";   
    ...
    address payable constant deployer = payable(address(0x672c7a4AeBF25aa0DBdEF183327d8dFe08f0EEa0));
