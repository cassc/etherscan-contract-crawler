 ...
 *Submitted for verification at Etherscan.io on 2022-10-05
 ...
 Medium -- https://medium.com/@SecretyDev/the-secret-society-fea061938dc8
...
contract TheSecretSociety is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private constant tokenName = "The Secret Society";
    string private constant tokenSymbol = "TSS";
    uint8 private constant tokenDecimal = 18;
    uint256 private constant tokenSupply = 50e12 * 10**tokenDecimal;
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x2ab414479a8D8f05B5B4B0939Cb9b56B0c66Df69);
        devAddress = payable(0x2ab414479a8D8f05B5B4B0939Cb9b56B0c66Df69);
