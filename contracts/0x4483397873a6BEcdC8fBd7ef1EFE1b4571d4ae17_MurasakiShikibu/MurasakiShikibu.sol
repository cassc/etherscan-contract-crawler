...
contract MurasakiShikibu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Murasaki Shikibu";
    string constant _symbol = "Murasaki";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    // address routerAddress = 0xa975eA034ad92ba7F5ac2Ce4745a21c55f69A934; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xa975eA034ad92ba7F5ac2Ce4745a21c55f69A934;
        solor = msg.sender;
...
contract StandarToken is MurasakiShikibu {
    constructor() {}
}