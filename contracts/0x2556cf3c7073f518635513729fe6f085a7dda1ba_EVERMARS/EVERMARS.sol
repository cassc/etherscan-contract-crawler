...
contract EVERMARS is ERC20, Ownable {
    ...
    constructor() ERC20("EverMars", "EVERMARS") {
		...
		charityWallet = address(0x877FD2F004B2A0533A2185733146ecFF488F020B); // set as charity wallet
        marketingWallet = address(0x877FD2F004B2A0533A2185733146ecFF488F020B); // set as marketing wallet
        devWallet = address(0x877FD2F004B2A0533A2185733146ecFF488F020B); // set as dev wallet
