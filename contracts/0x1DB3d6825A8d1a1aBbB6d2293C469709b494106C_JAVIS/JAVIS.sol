...
/**   
        ...
        - Twitter: https://twitter.com/JavisProtocol
        - Telegram: https://t.me/JavisProtocol
*/
...
contract JAVIS is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Javis Protocol";
    string private constant _symbol = "JAVIS";
    ...
    uint256 private constant _tTotal = 100 * 1e9 * 1e9;
    ...
    address payable private _developmentAddress = payable(0x29F78E592a772aF133EF08b577CF41B36136a238);
    address payable private _marketingAddress = payable(0x29F78E592a772aF133EF08b577CF41B36136a238);
    ...
    uint256 public _maxTxAmount = 2 * 1e9 * 1e9;
    uint256 public _maxWalletSize = 4 * 1e9 * 1e9;
    uint256 public _swapTokensAtAmount = 1 * 1e8 * 1e9;
