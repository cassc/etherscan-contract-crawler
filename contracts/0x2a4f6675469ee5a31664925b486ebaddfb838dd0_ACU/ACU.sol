...
contract ACU is ERC20Pausable, Ownable {
  string public constant name = "Agricultural Unions";
  string public constant symbol = "ACU";
  uint public constant decimals = 18;
  uint public constant INITIAL_SUPPLY = 8000000000 * (10 ** decimals);
