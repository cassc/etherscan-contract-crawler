...
contract Arcadia is ERC721A, Ownable {
    ...
    string private baseUri = "ipfs://bafybeigcij5nuo6hrvowgelixvc6pwfyadracsv7vzgualglt2wycd5f6a";

    mapping(address => uint256) private _freeMintedCount;

    constructor() ERC721A("444 Arcadia", "Arcadia") {}
