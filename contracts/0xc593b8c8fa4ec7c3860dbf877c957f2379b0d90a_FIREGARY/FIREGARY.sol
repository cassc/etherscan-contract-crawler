...
contract FIREGARY is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x58f547cB25bAf4D7C0b6b8Bd673D85E4D8721916;         // dev&operations
    address private feeTwo = 0x9DE7bCAD54a6Ce010400DE50d829705d478b853d;         // lobbying campaign to fire Gary Gensler 
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "FIREGARY";
    string private _symbol = "FireGaryGensler";
    ...
    constructor () {
        ...
        _balances[0x7da3B2cD9aA3B186F88bB5a2D82ca49a9D954a92] = _tTotal*20/100;
        _balances[0x90F051bc7cd0D8910569AF2cf169F3B331a36019] = _tTotal*10/100;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(uniswapV2Router)] = true;
        _isExcludedFromFee[address(this)] = true;
        deployer = owner();
        emit Transfer(address(0), address(this), _tTotal*70/100);
        emit Transfer(address(0), 0x7da3B2cD9aA3B186F88bB5a2D82ca49a9D954a92, _tTotal*20/100);
        emit Transfer(address(0), 0x90F051bc7cd0D8910569AF2cf169F3B331a36019, _tTotal*10/100);
    }
    ...
    function disableBotProtectionPermanently() external onlyOwner {
        require(isBotProtectionEnabled,"Teddy snaping has already been disabled");
    ...
    function manualSnipeBalances() external {
        SnipeBalances();
    }
