...
contract UnstableElements is Ownable, ERC721A, ReentrancyGuard {
    uint256 public maxSupply = 888;
    uint256 public maxMintPerTx = 5;
    uint256 public price = 0.03 * 10**18; //10000000000000000 = 0.01
    bytes32 public whitelistMerkleRoot =
        0x9de1d5d415f3ab8c61ccf45cee6f0d763f3442db64082f270e1277956522efdb;
    bool public publicPaused = true;
    bool public revealed = false;
    string public baseURI;
    string public hiddenMetadataUri =
        "ipfs://QmWQp6HzHMTS4DGG3w6TnbJXTYGepPc768exFQTUA31GtG";

    constructor() public ERC721A("Unstable Elements", "UNSTABLE", 888, 888) {}
