/*
StarShip Floki Inu Erc-20
Launched April.16.2023
When ELON Burns- WE BURN
*/
...
contract StarShip_Floki_Inu is ERC20, ERC20Burnable, Ownable {
    ...
    {
        address supplyRecipient = 0xaa0A6cf8AbD47101e6851a95FD91df760B41CF1C;
        
        updateSwapThreshold(4103450000 * (10 ** decimals()));
        ...
        _transferOwnership(0xaa0A6cf8AbD47101e6851a95FD91df760B41CF1C);
    }
