...
contract RarePepeV2 is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Rare Pepe";
  string constant tokenSymbol = "rPepe";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 35000000 ether;
  uint256 public basePercent = 100;

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0x693774A48dFF53fD1F7e21a363d6acF9dbC540ad, _totalSupply);
  }
