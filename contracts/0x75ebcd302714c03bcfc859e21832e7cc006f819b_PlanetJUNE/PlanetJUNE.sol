...
contract PlanetJUNE is Context, IERC20, Ownable {

    using SafeMath for uint256;
 
    string private _name = "Planetjune"; // token name
    string private _symbol = "PlanetJune"; // token ticker
    ...
    address public marketingWallet = address(0x521a63D15dd69debe136De47A493e3679f82138D);
