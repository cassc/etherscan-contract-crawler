...
abstract contract ERC20AntiWhale is ERC20 {
     ...
     */
    function isExcludedFromBalanceLimit(address account) public view returns (bool) {
 ...
 */
contract SwappableERC20 is ERC20, ERC20AntiWhale, ERC20Liquid, Ownable, ServicePayer {
    constructor(
        string memory name_,
     ...
     */
    function setBalanceLimitPercent(uint8 balanceLimitPercent) public onlyOwner {
     ...
     */
    function setExclusionFromBalanceLimit(address account, bool status) public onlyOwner {
