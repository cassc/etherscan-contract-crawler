...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1663279200;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1660665600;
...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [RAMPPADDRESS,0xd2fe99b235c3487654DE81f0987473A19cec803C];
    ...
    , TimedDrop
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 6, 15) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdNDBMu2oJ56poRakBZMpHRa1uTXpxKRGxexkTrBEZ7tN/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 15");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 15");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 15");
...
// File: contracts/TheDoOverSocietyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheDoOverSocietyContract is RamppERC721A {
    constructor() RamppERC721A("The Do Over Society", "TDOS"){}
}
