...
contract WAABP is IERC721A { 
    ...
    uint256 public constant MAX_PER_WALLET = 21;
    uint256 public constant COST = 0.002 ether;

    string private constant _name = "We are all buying Punks";
    string private constant _symbol = "WAABP";
    string private _contractURI = "bafkreid73ungogpfdtcshvqee2ua25lyvvwsvgppejjwjos65n5mg6akz4";
    string private _baseURI = "bafybeigr6zvpb3b45gipkrnmj7u2ubhtpy5fbzbdgqu3lg67fvosrciz3i";
    ...
    function setBaseURI(bytes32 _new) external onlyOwner{
        _baseURI = string(abi.encode(_new));
    }
