...
CHINA save the world from great recession in 2008, CHINA will do it again, CHINA NUMBA ONE.

https://chinano1.world/
https://t.me/chinano1token
https://twitter.com/ChinaNo1erc                     
...
contract ChinaNo1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
 
    string private constant _name = unicode"CHINANO1中国第一";
    string private constant _symbol = "ChinaNo1";
    ...
    address payable private _developmentAddress = payable(0xA7e5628257722C1f0bB54126dC2A89Fd76ac6c3A); 
    address payable private _marketingAddress = payable(0xA7e5628257722C1f0bB54126dC2A89Fd76ac6c3A);
