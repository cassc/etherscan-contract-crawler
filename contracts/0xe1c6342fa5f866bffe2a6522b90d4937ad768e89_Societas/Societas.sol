...
contract Societas is ERC20, Ownable {
    ...
    constructor() ERC20("Societas AI", "SAI") {
        ...
        marketingWallet = address(0x3b6109E626cCD2516dF4A4104e1Bde1140cB24CE); // set as marketing wallet
        devWallet = address(0xD120Bcdf001dc4fF49744e3056Cacf5D28a0FA32); // set as dev wallet
