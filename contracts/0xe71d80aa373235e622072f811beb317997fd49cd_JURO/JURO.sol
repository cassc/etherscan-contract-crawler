 ...
 * allowances. See {IERC20-approve}.
 */
contract JURO is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Jurojin";
    string private _symbol = "JURO";
    uint8 private _decimals = 9;
    uint256 private _supply = 777777777;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 1;
    uint256 public maxTxAmount = 777777777 * 10**_decimals;
    uint256 public maxWalletAmount = 777777777 * 10**_decimals;
    address public marketingWallet = 0x189291AaD66eF03b463b39f71fee196bd4D8480D;
    // TOKENOMICS END ============================================================>
