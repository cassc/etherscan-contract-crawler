...
contract Sukuta is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Sukuta";
    string private constant _symbol = unicode"SUKUTA";
