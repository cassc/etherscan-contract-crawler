...
Unleashing the full Inu power to combine all recent stock tokens $AMC (AMC Inu), $TESLA (Tesla Inu) and $GME (GameStop Inu) into ONE FULL SEND MOON. SEND THEM ALL!

Tokenomics
Total supply: 10.000.000 $NASINU
Max buy: 2% (200.000)
Max transaction: 2% (200.000)
Final tax: 4%

Socials
https://twitter.com/nasdaqinu
https://t.me/nasdaqinu
...
contract NASDAQINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "NASDAQ Inu";
    string private constant _symbol = "NASINU";
