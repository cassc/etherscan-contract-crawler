...
contract ALLAH {
    ...
    string public constant name = "ALLAH";   
    string public constant symbol = "ALLAH";   
    ...
    address payable constant deployer = payable(address(0xcD5Ee44629bbad099B41E797f674f79Fdc0a8fca));
