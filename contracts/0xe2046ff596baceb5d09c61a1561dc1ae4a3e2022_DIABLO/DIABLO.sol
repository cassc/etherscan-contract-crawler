...
Website: https://www.theexorcisterc20.com/
Twitter: https://twitter.com/TheExorcistETH
TG: https://t.me/TheExorcistERC20
...
contract DIABLO is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 8000000 * (10**18); // 0.8%
    ...
    uint256 public marketingBuyFee = 13;
    uint256 public teamBuyFee = 6;
    ...
    address payable public marketingWallet = payable(0x3910380b8f400CB02BcD4b27edabAe232Bc79D3b);
    address payable public teamWallet = payable(0x59682cCd574F240352E1AAE90C821b698473babe);
    ...
    constructor() ERC20("The Exorcist", "DIABLO") {
