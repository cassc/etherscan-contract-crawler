...
contract nation4 is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nation4";
    string private constant _symbol = unicode"Nation4";
