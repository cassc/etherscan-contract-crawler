...
contract VVDealersChoice is ERC721, ERC721Enumerable, ERC2981, AdminControl, Ownable, ReentrancyGuard, Pausable {
    using Strings for uint256;

    uint256 public MAX_SUPPLY = 54;
    string baseURI = "";
    ...
    ) ERC721("Vegas Vickie Dealers Choice", "VVDEALERS") {

        allowlistSaleStartTime = _allowlistSaleStartTime;
        allowlistMinimumTier = 2;
