...
Telegram:  https://t.me/EroticCoinETH
...
contract EROTIC is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"EROTIC COIN";
    string private constant _symbol = unicode"EROTIC";
    uint8 private constant _decimals = 9;

    uint256 private constant _TotalSupply = 69690000000000000000 * 10 **_decimals;
    ...
    uint256 private _swapBeforeExpansion=1;
    ...
    constructor () {
        _marketingWallet = payable(0x69397526dFd1aF1f162a365D6504c5d286caccd5);
