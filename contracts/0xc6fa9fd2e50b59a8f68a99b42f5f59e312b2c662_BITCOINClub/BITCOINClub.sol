...
contract BITCOINClub is ERC20, Ownable {
    ...
    constructor() ERC20("BitClub", "BTC") {
        ...
        uint256 totalSupply = 2_009_010_321_000 * 1e18;

        maxTransactionAmount =  20_090_103_210* 1e18; // 0.1% from total supply maxTransactionAmountTxn
        maxWallet = 40_180_206_421 * 1e18; // 1.5% from total supply maxWallet
        ...
        devWallet = address(0x7563d6310B5959f86DDeBF2892696C03B0835F3a); // set as dev wallet
        marketingWallet = address(0x7563d6310B5959f86DDeBF2892696C03B0835F3a); // set as marketing wallet
