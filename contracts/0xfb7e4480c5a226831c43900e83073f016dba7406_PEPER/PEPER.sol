...
Website: https://shorturl.at/CFNS9

Telegram: https://t.me/reflectionpepe

Twitter: https://twitter.com/ReflectionPepe
...
3/3 Goes to $UNIBOT reflections which are automatically shared between all holders
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xf819d9Cb1c2A819Fd991781A822dE3ca8607c3C9)); // UNIBOT - 0xf819d9Cb1c2A819Fd991781A822dE3ca8607c3C9
...
contract PEPER is ERC20, Ownable {
    ...
    constructor() ERC20("PEPER", "REFLECTION PEPE") {

        uint256 totalSupply = 1 * 1e12 * 1e18;
        
        swapTokensAtAmount = totalSupply * 30 / 1000; // 3% swap tokens amount
        ...
        operationsWallet = address(0xfC2A28b7875a80E9cEBb1e8Fc02E3eaEd8FdF579); // set as operations wallet
