    ...
    IMemberships
{
    ...
    /// @notice Emitted when transferring soulbound token
    error Soulbound();
    ...
    /// @notice Flag for soul bound token
    /// @dev Any value other than 1 means the token is transferable
    uint256 public soulbound;
    ...
    /// @param _soulbound flag for soul bound token
    function initialize(
        address _owner,
