...
// File: BankingCollapseInu.sol


// First it was The Bank of England, then Credit Suisse and Deutsche Bank. Who's next?

// https://t.me/BankingCollapseInu

// https://twitter.com/BankCollapseInu
...
contract BankingCollapseInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Banking Collapse Inu", "BCI") {
        ...
        devOpsWallet = address(0xF188906D3b519b91Af8F1b5F40985AEaBf2fD768); // set as devOps wallet
 
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(0xF188906D3b519b91Af8F1b5F40985AEaBf2fD768), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xF188906D3b519b91Af8F1b5F40985AEaBf2fD768), true);
