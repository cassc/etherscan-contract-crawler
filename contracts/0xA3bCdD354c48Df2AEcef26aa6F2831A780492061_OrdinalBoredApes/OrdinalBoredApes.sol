...
// File: contracts/OrdinalBoredApes.sol
...
contract OrdinalBoredApes is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public freeSupply = 1450;
  ...
  ) ERC721A("Ordinal Bored Apes", "ORDINALBYAC") {
