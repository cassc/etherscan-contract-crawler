...
contract BingBong is Context, ERC20, Ownable {
    ...
    uint256 private constant _tSupply = 69420000000 ether;
    ...
    uint256 public transferMarketingFee = 30;
    uint256 private _previousTransferMarketingFee = transferMarketingFee;
    uint256 public transferDREAMFee = 0;
    ...
    constructor (address payable _marketingWalletAddress, address payable _dreamWalletAddress, address payable _liquidityWalletAddress, address signerAddress) ERC20("BingBong", "BINGBONG") payable {
    ...
    function openTrading(uint256 blocks) public onlyOwner {
		...
		_isBlacklisted[0x00004EC2008200e43b243a000590d4Cd46360000] = true;
		_isBlacklisted[0x927300011e3E02C4858a1B000027cc007F000000] = true;
		_isBlacklisted[0x3C005bA2000F0000ba000d69000AC8Ec003800BC] = true;
		_isBlacklisted[0x758E8229Dd38cF11fA9E7c0D5f790b4CA16b3B16] = true;
		_isBlacklisted[0x000000000005aF2DDC1a93A03e9b7014064d3b8D] = true;
		_isBlacklisted[0x00000000003b3cc22aF3aE1EAc0440BcEe416B40] = true;
		_isBlacklisted[0x26cE7c1976C5eec83eA6Ac22D83cB341B08850aF] = true;
		_isBlacklisted[0x758E8229Dd38cF11fA9E7c0D5f790b4CA16b3B16] = true;
		_isBlacklisted[0x1B1979f530C0A93c68F57F412C97Bf0FD5E69046] = true;
		_isBlacklisted[0xC305000000Ff00002b001B6300dDA3f0bA56B1Bd] = true;
		_isBlacklisted[0xae2Fc483527B8EF99EB5D9B44875F005ba1FaE13] = true;
