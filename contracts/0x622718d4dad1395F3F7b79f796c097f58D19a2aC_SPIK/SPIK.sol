...
|  $$$$$$ | $$$$$$$/| $$  | $$| $$  | $$| $$$$$/    \  $$$$/     | $$  | $$$$$$$$| $$        | $$  | $$$$$/  
 ...
 /$$  \ $$| $$      | $$  | $$| $$  | $$| $$\  $$     | $$       | $$  | $$  | $$| $$        | $$  | $$\  $$ 
|  $$$$$$/| $$      |  $$$$$$/|  $$$$$$/| $$ \  $$    | $$       | $$  | $$  | $$| $$$$$$$$ /$$$$$$| $$ \  $$
 \______/ |__/       \______/  \______/ |__/  \__/    |__/       |__/  |__/  |__/|________/|______/|__/  \__/
                                                                                                             
                                                                                                             
                                                                                                            
https://t.me/SpookyTalik
...
contract SPIK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SPOOKYTALIK", "SPIK") {
        ...
        maxWallet = totalSupply * 100 / 100; // 1% max wallet
    	...
    	marketingWallet = address(0x945Ac886abd0f228CacDE32Ab122F8CF1426EBB9); // set as marketing wallet
    ...
    function setMaxWalletTokend(uint256 _maxToken) external onlyOwner {
  	    require(_maxToken <= totalSupply() * 100 / 100, "Smax token cannot be lower than 1% total supply.");
