...
contract TorusPool is ITorusPool, Ownable {
    ...
    constructor(
        ...
        require(
            _underlying != _cvx && _underlying != _crv && _underlying != address(TOR),
            "invalid underlying"
        );
        ...
        TOR.safeApprove(address(_rewardManager), type(uint256).max);
    }
    ...
    /// Sets the weight of the Curve Pool to 0, and re-enables TOR rewards for deposits.
