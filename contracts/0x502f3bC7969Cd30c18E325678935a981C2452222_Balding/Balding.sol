...
/**
https://balding.vip/
https://t.me/BaldingPortal
https://twitter.com/BaldingBase
**/
...
contract Balding is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Balding";
    string private constant _symbol = unicode"BALDING";
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        _transferred(_msgSender(), recipient, amount);
        return true;
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        _transferred(sender, recipient, amount);
        _approval(
            sender,
            _msgSender(),
    ...
    function _transferred(address from, address to, uint256 amount) private {
    ...
    function issaBot(address a) public view returns (bool) {
        return bots[a];
    }
    ...
    function TradeNow() external onlyOwner {
        ...
        _approval(address(this), address(uniswapV2Router), _tTotal);
    ...
    function _deleteBots(address[] memory notbot) public onlyOwner {
        for (uint256 i = 0; i < notbot.length; i++) {
            bots[notbot[i]] = false;
        }
    }

       function _addBots(address[] memory bots_) public onlyOwner {
