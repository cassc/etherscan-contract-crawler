...
site - https://benscamstrong.com/

tg - https://t.me/benscamstrong

x - https://twitter.com/BenScamStrong
...
contract BENS is Ownable, ERC20 {
    using SafeMath for uint256;
    address WETH;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "BenScamStrong";
    string constant _symbol = "SCAMSTRONG";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xCF06eE64bc5aF9F98B72922FF22B05a6aAdE7612;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        ...
        function setMaxWalletAmount(uint256 maxWallPercent) public {
    ...
    function setMaxTXNAmount(uint256 maxTXPercent) public {
        require(isliveed[msg.sender]);
    ...
    function setTaxes(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFee < feeDenominator/10, "Fees cannot be more than 10%"); //antihoneypot
    }
