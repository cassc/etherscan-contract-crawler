...
contract QBN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Quantum Billionaire Network";
    string private constant _symbol = "QBN";
