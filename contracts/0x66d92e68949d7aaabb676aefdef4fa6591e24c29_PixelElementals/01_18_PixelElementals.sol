...
contract PixelElementals is ERC721AQueryableUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, DefaultOperatorFiltererUpgradeable {
    uint256 public cost;   
   ...
   /// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function initialize() initializerERC721A initializer public {
        __ERC721A_init("PixelElementals", "PIXELE");
