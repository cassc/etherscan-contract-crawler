...
//It didn't have to be this way, but the powers that be have forced our hands, let's take the fight to them together. Frens joining Frens is the only way.
 ...
 * allowances. See {IERC20-approve}.
 */
 contract MIPEP is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Pepe the Milady";
    string private _symbol = "MIPEP";
    uint8 private _decimals = 9;
    uint256 private _supply = 420690133780085101;
    uint256 public taxForLiquidity = 12;
    uint256 public taxForMarketing = 12;
    uint256 public maxTxAmount = 21034506689004256 * 10**_decimals;
    uint256 public maxWalletAmount = 21034506689004256 * 10**_decimals;
