...
contract GempeDividend is Ownable {
    ...
    function whitelistForDividendsGempe(address owner_, bool _isWhitelist) external onlyOwner {
    ...
    function setTokenForDividendsGempe(address _token, address _pair) external onlyOwner {
