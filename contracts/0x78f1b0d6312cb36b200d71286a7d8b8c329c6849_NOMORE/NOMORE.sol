...
contract NOMORE is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nomore"; 
    string private constant _symbol = unicode"NOMORE"; 
