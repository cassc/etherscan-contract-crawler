...
contract PepeRich is Context, IERC20, Ownable {
    ...
    string public constant contractVersion = "5.0";
    string public constant contractDev = "PPP";
    string public constant contractEdition = "Factory";
    //Definition of Wallets for Marketing or team.
    address payable public marketingWallet =
        payable(0x6c3109E5dA447B90584DAD9212C3e1EbD940d1f6);
    ...
    //Supply Definition.
    uint256 private _tTotal = 1_000_000_000_000_000 ether;
    uint256 private _tFeeTotal;
    //Token Definition.
    string public constant name = "PepeRich";
    string public constant symbol = "PEPERICH";
