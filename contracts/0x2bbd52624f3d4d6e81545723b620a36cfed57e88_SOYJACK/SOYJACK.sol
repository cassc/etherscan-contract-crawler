...
contract SOYJACK is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SOYJACK";
    string private constant _symbol = "SOYJACK";
    ...
    address payable private _developmentAddress = payable(0x753aB664A1A733d2C26A9cBB18CAb1fc049024dE); 
    address payable private _marketingAddress = payable(0x753aB664A1A733d2C26A9cBB18CAb1fc049024dE);
