...
// https://www.ethernalerc.com/
//https://twitter.com/EthernalERC
//https://t.me/ethernalportal
...
contract ETHERNAL is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'ETHERNAL';
    string private constant _symbol = 'ETHERNAL';
    ...
    address internal constant development_receiver = 0x08d94f9D18A965bFe8f3F93D0B62E85D742B8E0c; 
    address internal constant marketing_receiver = 0x811D3fD92a8DDcC8538C8178e4Ac3371F5662423;
    address internal constant liquidity_receiver = 0x48CA39895860270D01cf98785C6924F5AAef6770;
    ...
    function setisBot(address[] calldata accounts, bool _enabled) external onlyOwner {for (uint256 i = 0; i < accounts.length; i++) {isBot[accounts[i]] = _enabled;}}   
