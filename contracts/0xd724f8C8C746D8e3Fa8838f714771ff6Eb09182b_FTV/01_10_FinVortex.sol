...
abstract contract Tokenomics {
    ...
    address public developerFEEAddress =
        0xB4B6A4Fd0bacb8F542FED5b5bfCFAe5A8cBb701C;

    uint256 public _devFee = 10; // 1%
    uint256 public _liqFee = 20; // 2%

    string internal constant NAME = "FinVortex";
    string internal constant SYMBOL = "FTV";
    ...
    uint256 public constant maxTransactionAmount = 200000 * ZEROES; 

    uint256 public constant maxWalletBalance = 200000 * ZEROES; 
    ...
    function _addFees() private {
        _addFee(FeeType.Liquidity, _liqFee, address(this));
        _addFee(FeeType.ExternalToETH, _devFee, developerFEEAddress);
    }
...
abstract contract FinVortex is Base, Liquifier {
    using SafeMath for uint256;
...
contract FTV is FinVortex {
    constructor() FinVortex(Env.MainnetV2) {
