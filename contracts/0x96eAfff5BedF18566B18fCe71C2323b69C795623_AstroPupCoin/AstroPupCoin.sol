...
contract AstroPupCoin is ERC20, ERC20Burnable, Pausable, Ownable {
    uint256 public burnPercentage = 1; // 1% burn rate

    constructor() ERC20("AstroPup Coin", "ASPC") {
    ...
    function setBurnPercentage(uint256 newBurnPercentage) public onlyOwner {
        require(
            newBurnPercentage <= 10,
            "Burn percentage must be between 0 and 10."
        );
