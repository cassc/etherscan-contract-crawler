...
contract Ordibone is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name ="Ordibone";
    string private _symbol = "Obone";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x2904770C05da1E53CF21497FF6621B4312689F92);
    address payable private taxWallet2 = payable(0x2904770C05da1E53CF21497FF6621B4312689F92);
