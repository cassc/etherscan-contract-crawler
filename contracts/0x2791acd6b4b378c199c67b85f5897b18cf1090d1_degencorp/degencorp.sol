...
Telegram: https://t.me/degencorp
Twitter: https://twitter.com/Join_Degencorp
...
contract degencorp is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = unicode"DEGENCORP";
    string private constant _symbol = unicode"$DCORP";
    ...
    address payable private _developmentAddress = payable(0x527C19D09294a2937c2A40970f1D12961DC4D434);
    address payable private _marketingAddress = payable(0x527C19D09294a2937c2A40970f1D12961DC4D434);
