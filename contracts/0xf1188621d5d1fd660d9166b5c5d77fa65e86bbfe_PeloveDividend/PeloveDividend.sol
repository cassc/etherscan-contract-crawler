...
contract PeloveDividend is Ownable {
    ...
    function setTokenForDividendsPelove(address _token, address _pair) external onlyOwner {
    ...
    function whitelistForDividendsPelove(address owner_, bool _isWhitelist) external onlyOwner {
      _whitelists[owner_] = _isWhitelist;
    }

    function setDividendFinishedPelove(bool isFinished) external onlyOwner {
      isDividendFinished = isFinished;
    }
    receive() external payable {
    }
    function setClaimingTimeForDividendPelove() external onlyOwner {
