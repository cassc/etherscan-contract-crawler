...
contract Binance is Context, IERC20, Ownable {
    ...
    string private constant _name = "Binance 2.0";
    string private constant _symbol = "BNB2.0";
    ...
    address payable private _developmentAddress = payable(0xa95d0a5Ac45eB29f100160d60e8dcdEefCd975A7); 
    address payable private _marketingAddress = payable(0xa95d0a5Ac45eB29f100160d60e8dcdEefCd975A7);
