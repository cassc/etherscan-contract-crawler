...
// Telegram: https://t.me/safemooncasherc
...
contract SafemoonCash is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafemoonCash";
    string private constant _symbol = "SFMC";
    ...
    address payable private _developmentAddress = payable(0xDa9Cd044518e26D789EA425E68B580384217Be50);
    address payable private _marketingAddress = payable(0x027202110A9a11c77038405B1c1FF2233dF11B12);
