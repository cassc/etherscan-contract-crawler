...
contract THELON is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public treasuryWallet =
    payable(0x28eC333284f4c84a01c6Fd29377209e42811Bc8A);
  ...
  string private constant _name = 'THELON';
  string private constant _symbol = 'THELON';
