/**
telegram：https://twitter.com/pkpk_eth
Twitter：https://t.me/PKPK_eth
CEO:f h
*/
...
contract Token is ERC20Detailed, ERC20 {
  ...
  constructor() ERC20Detailed("PKPK", "PKPK", 18) {
    uint256 totalTokens = 100000000 * 10**uint256(decimals());
    _mint(msg.sender, totalTokens);
    sellTax = 2;
    buyTax = 2;
    transferTax = 0;
    marketingPool = 0x9475E061303B89f52e0b8b53128473a16ce16Ea2;
  }
