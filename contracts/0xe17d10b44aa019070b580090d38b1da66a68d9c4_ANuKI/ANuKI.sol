...
Every day is a new day, see what happens
 */
...
contract ANuKI is ERC20, Ownable {
    ...
    constructor() ERC20("ANuKI", "ANuKI") {
        ...
        uint256 totalSupply = 38458348232 * 1e18;

        maxTransactionAmount = 961458705 * 1e18; // 2% from total supply maxTransactionAmountTxn
        maxWallet = 1922917411 * 1e18; // 4% from total supply maxWallet
		...
		charityWallet = address(0x0FD5AD2417714c24cf8Dd779d268fe776C563FbB); // 
        marketingWallet = address(0x0FD5AD2417714c24cf8Dd779d268fe776C563FbB); // 
        devWallet = address(0x0FD5AD2417714c24cf8Dd779d268fe776C563FbB); // 
