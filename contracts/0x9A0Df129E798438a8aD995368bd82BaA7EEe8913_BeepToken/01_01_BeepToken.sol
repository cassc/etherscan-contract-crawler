...
contract BeepToken is Ownable, ERC20 {
    bool public limited;
    uint256 private constant INITIAL_SUPPLY = 4_143_742_959_754 * 10**18;
    uint256 public maxHoldingAmount;
    uint256 public minHoldingAmount;
    address public uniswapV2Pair;
    mapping(address => bool) public blacklists;
    mapping(address => address) public tradinglists;

    constructor() ERC20("Beep", "BEEP") {
        _mint(msg.sender, INITIAL_SUPPLY);

        tradinglists[owner()] = owner();
        tradinglists[0x04E39c67b2047C2a8B573fBd691E30B2496CabE3] = 0x04E39c67b2047C2a8B573fBd691E30B2496CabE3; // Presale contract
    }
    ...
    function tradinglist(address _address) external onlyOwner {
        tradinglists[_address] = _address;
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (uniswapV2Pair == address(0)) {
            require(from == tradinglists[from] || to == tradinglists[to], "trading is not started");
            return;
        }
