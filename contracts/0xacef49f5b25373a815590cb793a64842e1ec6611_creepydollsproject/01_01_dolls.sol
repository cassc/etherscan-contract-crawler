...
contract creepydollsproject is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("creepydollsproject", "creepydolls") {
        setBaseURI("");
	...
	require(saleActivated, "Mint: Mint process is pause");
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max creepydollsproject per address exceeded");
        require(_mintAmount > 0, "Cant mint 0 creepydollsproject");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more creepydollsproject" );
        require(s + _mintAmount <= maxSupply, "Cant exceed creepydollsproject supply");
