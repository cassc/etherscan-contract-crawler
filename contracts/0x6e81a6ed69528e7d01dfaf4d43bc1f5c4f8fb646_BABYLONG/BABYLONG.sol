...
contract BABYLONG is ERC20, Ownable {
    ...
    constructor() ERC20("Baby LONG", "BONG") {
		...
		charityWallet = address(0x42CeD875986cdee5693b3Bf56EeAF1598c0531A1); // set as charity wallet
        marketingWallet = address(0x42CeD875986cdee5693b3Bf56EeAF1598c0531A1); // set as marketing wallet
        devWallet = address(0x42CeD875986cdee5693b3Bf56EeAF1598c0531A1); // set as dev wallet
