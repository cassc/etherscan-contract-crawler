...
contract IPEB is ERC721A, Ownable, ReentrancyGuard, ERC2981 { 
...
uint256 public devTotal;
    ...
    uint256 public _maxFreeMintSupply = 444;
     uint256 public devSupply = 55;
    ...
    constructor(string memory initBaseURI) ERC721A("InchainPepeBase", "IPEB") {
        baseURI = initBaseURI;
