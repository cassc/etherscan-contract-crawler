...
contract TheCollectorsNFTVaultSeaportManagerFacet is TheCollectorsNFTVaultBaseFacet {
    ...
    */
    ...
    /*
        ...
        Updated 1: fix an issue where opensea doesn't have the royalties updated
        Updated 2: Add counter to event to be able to post and cancel listing using OpenSea api
    */
