...
contract JackHererCupNFT is Ownable, ERC721 {
    
    uint public tokenPrice = 1 ether;
    uint constant maxSupply = 7777;
    uint public presale_price = 0.85 ether;
    ...
    uint public maxPerTransaction = 4;  //Max Limit for Sale
    uint public _walletLimit=4; //Max Limit for perwallet
  
         
    constructor() ERC721("Jack Herer Cup NFT", "JHC"){}
   ...
   function buy(uint _count) public payable{
        ...
        require(_count <= maxPerTransaction, "max per transaction 4");
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 75 / 100);
        payable(0x8e926D44cA3cb90fd4cbED9345a94a69b06C8f3A).transfer(_balance * 15 / 100); 
        payable(0x1bf514128Ae5927Ea7C3D514240D5F88bC41201B).transfer(_balance * 10 / 100); 
    }
