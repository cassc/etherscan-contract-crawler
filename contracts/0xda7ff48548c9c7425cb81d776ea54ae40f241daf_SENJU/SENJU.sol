...
At $SENJU, we have all been wrecked before, 
so we know first hand how to ensure this does 
not happen to our community.
...
contract SENJU is ERC20, Ownable {
    ...
    string private _name = "Senju";
    string private _symbol = "SENJU";

    TransferHelper private transferHelper;
    
    constructor() {
        _totalSupply = 10_100_000_000 * (10 ** decimals());
