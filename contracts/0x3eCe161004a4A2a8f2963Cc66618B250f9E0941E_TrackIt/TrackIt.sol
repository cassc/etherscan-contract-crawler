...
The best in the space where users can check contracts and it helps them being saved from potential scams. 

This bot allows you to view the following:

Insights

🛠️ Marketing wallet check & Spend 
🔫 helps users protect from scams & potential honeypots 
⚙️ Check clogged CA
...
contract TrackIt is ERC20, Ownable {
    ...
    string private constant _name = "TrackIt Bot";
    string private constant _symbol = "TRACKIT";
