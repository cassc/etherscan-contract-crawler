...
library DynamicBuffer {
	function allocate(uint256 capacity) internal pure returns (bytes memory container, bytes memory buffer) {
		assembly {
	...
	function appendBytes(bytes memory buffer_, bytes memory data_) internal pure {
		assembly {
