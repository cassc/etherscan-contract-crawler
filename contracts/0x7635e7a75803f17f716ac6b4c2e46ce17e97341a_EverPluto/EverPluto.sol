...
// Website: https://everpluto.xyz/
// Twitter: https://twitter.com/everplutoeth
// Telegram: https://t.me/EverPlutoETH
...
contract EverPluto is IERC20, Ownable {
    /* -------------------------------------------------------------------------- */
    /*                                   events                                   */
    /* -------------------------------------------------------------------------- */
    ...
    string _name = "EverPluto";
    string _symbol = "PLUTO";
    ...
    Fee public buyFee = Fee({reflection: 2, marketing: 1, lp: 1, buyback: 1, burn: 0, total: 5});
    Fee public sellFee = Fee({reflection: 2, marketing: 3, lp: 3, buyback: 2, burn: 0, total: 10});
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0x5e7F57cD4dE91D3F273a546e021fB9ACc98f7c8D;
        lpFeeReceiver = 0x5bc3F37d65C23e62E5cd341Ff6585E8ebA82358b;
        buybackFeeReceiver = 0xeB41B28C903075D7A7700664d7AA8875F0d3e469;
