...
contract Crunkz is IERC721A { 
    ...
    uint256 public constant MAX_FREE = 543;
    uint256 public constant MAX_FREE_PER_WALLET = 1;
    uint256 public constant COST = 0.001 ether;

    string private constant _name = "Crunkz";
    string private constant _symbol = "CRUNKZ";
    string private _baseURI = "Qmevtgi3ipnzbycJRDoausNnJ4DapBUUrY8YcB45MHpuDd";
