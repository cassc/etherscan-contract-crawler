...
contract Ltc_Inu is ERC20, Ownable {
    ...
    constructor(address[] memory addresses) ERC20("Ltc Inu", "LTCINU") {
        ...
        uint256 totalSupply = 84 * 1e6 * 1e18;

        maxTransactionAmount = 168 * 1e4 * 1e18;
        maxWallet = 168 * 1e4 * 1e18; 
        ...
        marketingWallet = address(0xAA45181d8588A1E9Ee6ACC09A4E5A8fc3B7D700b); 
