...
https://t.me/MilkBonePassage
Shibarium here we come
...
contract milkbone is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MilkBone", "MilkBone") {
        ...
        maxTransactionAmount = totalSupply * 8 / 1000; // 1.5% maxTransactionAmountTxn
        maxWallet = totalSupply * 8 / 1000; // 1.5% maxWallet
