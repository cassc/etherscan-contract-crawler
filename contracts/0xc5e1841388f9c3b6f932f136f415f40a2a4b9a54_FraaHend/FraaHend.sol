...
contract FraaHend is ERC721A, Ownable {
    using Strings for uint256;
    ...
    string public baseURI = "https://FRAAHEND.COM/";

    constructor() ERC721A("Fraa Hend", "FH") {}
    ...
    function withdrawsplitter() external payable onlyOwner {
        ...
        address ad1 = 0x0F4d70F8a296330760D22Ef196514536F16F6cc2;
