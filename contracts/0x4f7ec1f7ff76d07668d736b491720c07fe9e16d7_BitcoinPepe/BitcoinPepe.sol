...
contract BitcoinPepe is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Bitcoin Pepe";
    ...
    address payable private _developmentAddress = payable(0xb67f4AB685Ca778eB66A8B7Aed55A0b96A465A4c); 
    address payable private _marketingAddress = payable(0xb67f4AB685Ca778eB66A8B7Aed55A0b96A465A4c);
