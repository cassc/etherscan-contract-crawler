...
/*
 Community Chat - https://t.me/Froginami
 NFT Collection - https://opensea.io/collection/froginami
 Website - http://www.froginami.live/
 Discord - Check Telegram to confirm link.
*/
...
contract Froginami is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Froginami";
    string private constant _symbol = "$DEGFROG";
    ...
    address payable private _developmentAddress = payable(0x719aa89BDe5b4668443F81542E34f7EDf6100aeE); 
    address payable private _marketingAddress = payable(0x719aa89BDe5b4668443F81542E34f7EDf6100aeE);
