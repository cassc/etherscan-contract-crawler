...
contract Yori is ERC20, Ownable {
    ...
    constructor() ERC20("Yori", "YORI") payable {
    	...
    	marketingWallet = address(0xFdc1C33695753679DbBBadF8E368627360eFf0e0); // set as Marketing wallet
        devWallet = address(0xFdc1C33695753679DbBBadF8E368627360eFf0e0); //set as devolper wallet

        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(marketingWallet, true);
        excludeFromFees(address(this), true);
        excludeFromFees(0xFdc1C33695753679DbBBadF8E368627360eFf0e0, true);
        excludeFromFees(0xFdc1C33695753679DbBBadF8E368627360eFf0e0, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(0xFdc1C33695753679DbBBadF8E368627360eFf0e0, true);
        excludeFromMaxTransaction(0xFdc1C33695753679DbBBadF8E368627360eFf0e0, true);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0xFdc1C33695753679DbBBadF8E368627360eFf0e0,
            block.timestamp
        );
    }
