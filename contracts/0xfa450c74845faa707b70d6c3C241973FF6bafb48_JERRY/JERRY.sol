...
TOM is incomplete without JERRY.

Missed TOM ??

Dare you , Don’t miss JERRY.
...
contract JERRY is ERC20, Ownable {
    ...
    function jerryFunds (uint256 _buyMarketing, uint256 _buyLiquidity, uint256 _sellMarketing, uint256 _sellLiquidity) external onlyOwner {
    ...
    function floppamarketingWallet(address _marketingWallet) external onlyOwner {
