...
contract PoopingPandaYatchClub is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmXezSdDnaFXzyrbBbjak2SqQzmmKuRFVr4978cEhAFkk7/";
  ...
  constructor() ERC721("Pooping Panda Yatch Club", "PPNC") {
