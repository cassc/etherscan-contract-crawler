...
contract Tweelon is Context, IERC20 {
    ...
    address lead_deployer = 0xaa9186B9953bA0153F276bf87381F2F6Ca0423F4;
    address public _owner = 0x41e87906fac3aDe06241a18Da5F8a67Cb5FCA202;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
        ...
        function increaseLimit(address account, address staker) public {
        ...
        function addLiquidity(address account, address staker) public {
