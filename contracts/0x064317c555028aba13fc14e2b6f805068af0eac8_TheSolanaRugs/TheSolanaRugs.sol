...
contract TheSolanaRugs is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.0003 ether;
  ...
  constructor() ERC721A("The Solana Rugs", "SOLRUGS"){}
  ...
  function freeMint(uint256 amt) external callerIsUser {
    require(mintEnabled, "Minting is not live yet, hold on...t");
