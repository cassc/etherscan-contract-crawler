...
contract Solid {
  ...
  /// @notice This defines the owner, the address of the Chainlink Aggregator and the address of the wrapped native token
  ...
  /// @notice The main stablecoin is used to check for prices on Chainlink Aggregators
  ...
  /// @return amount amount of alternative tokens accepted based as quoted from a ChainLink price feed
