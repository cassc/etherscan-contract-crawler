...
contract OrdinalsETHBridge is ERC721A, Ownable, DefaultOperatorFilterer {
    ...
    constructor(string memory _baseURI, bytes32 _merkleRoot) ERC721A("Ordinals ETH Bridge", "ORDI")
    {
        baseURI = _baseURI;
