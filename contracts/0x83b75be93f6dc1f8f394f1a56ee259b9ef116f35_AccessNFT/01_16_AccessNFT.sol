...
contract AccessNFT is ERC1155, IAccessNFT, Ownable, Initializable {
    ...
    constructor(address _addressesRegistry, bool _deadlinesOn) Ownable() ERC1155("https://www.souq.finance/accessNFT/metadata/{id}.json") {
