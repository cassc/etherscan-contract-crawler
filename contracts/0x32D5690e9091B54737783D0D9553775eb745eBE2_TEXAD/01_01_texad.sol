...
💀 THE EXAMPLE X ALL DIE - $TEXAD 💀

We will airdrop Vitalik 50% of supply. However, his address will be blacklisted. Let's fucking put an end to Vitalik's games and meta.

https://t.me/texadtoken
...
contract TEXAD is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"THE EXAMPLE X ALL DIE";
    string private constant _symbol = unicode"TEXAD";
