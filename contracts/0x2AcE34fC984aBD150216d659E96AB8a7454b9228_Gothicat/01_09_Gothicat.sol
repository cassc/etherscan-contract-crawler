...
contract Gothicat is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint;

    string  public baseTokenURI = "https://bafybeihw6whpurqaw32qswntxxie3di5s4jshzzflztskvjms2ntfc62v4.ipfs.nftstorage.link/metadata";
    ...
    constructor() ERC721A("Gothicat", "GCAT") {}
