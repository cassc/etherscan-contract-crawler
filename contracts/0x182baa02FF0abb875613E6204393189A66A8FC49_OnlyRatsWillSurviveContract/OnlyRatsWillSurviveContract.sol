...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0x012D9FeddF3E484eD263008f1533b86dA2231148];
  address public erc20Payable = 0x012D9FeddF3E484eD263008f1533b86dA2231148;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 30, 6666) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://api.onlyrats.live/";
...
// File: contracts/OnlyRatsWillSurviveContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OnlyRatsWillSurviveContract is RamppERC721A {
    constructor() RamppERC721A("Only Rats Will Survive", "ORWS"){}
}