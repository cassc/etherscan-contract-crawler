...
contract IndePunks23 is ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    uint256 public public_price_2 = 0.003 ether;
    uint256 public public_price_3 = 0.0069 ether;
    uint256 public public_price_4 = 0.01 ether;
    uint256 public whitelist_price = 0 ether;

    uint256 public free_supply = 700;
    uint256 public supply2 = 2200;
    uint256 public supply3 = 3200;
   ...
   uint256 public maxLimitPerWallet = 4444;
