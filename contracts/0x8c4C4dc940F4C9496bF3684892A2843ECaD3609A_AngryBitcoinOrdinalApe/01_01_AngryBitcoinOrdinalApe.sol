...
contract AngryBitcoinOrdinalApe is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    
    uint   public price             = 0.001 ether;
    uint   public maxTx             = 14;
    uint   public maxSupply         = 1486;
    uint256 public reservedSupply   = 100;
    string private baseURI          = "ipfs://bafybeiacwazzfrhjxnai6dbxsksmxrccmftweonzsdwqi7dru2l4hvgbza/";
    ...
    constructor() ERC721A("Angry Bitcoin Ordinal Ape", "ABOA") {}
