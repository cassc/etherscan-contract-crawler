...
contract AlcazarNftStaking is Ownable, IERC721Receiver, ReentrancyGuard {
    ...
    function deposit(uint256[] memory _tokenIds) external payable nonReentrant {
        ...
        if (user.amount > 0) {
            ...
            if (pending > 0) {
                ...
                uint256 fee = pending * rewardFee / PERCENT_PRECISION;
                earnedToken.safeTransfer(feeAddress, fee);
