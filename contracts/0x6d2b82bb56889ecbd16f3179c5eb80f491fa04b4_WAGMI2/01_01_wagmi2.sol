...
contract WAGMI2 is ERC20, Ownable {
    using SafeMath for uint256;
    address public uniswapV2Pair;
    mapping(address => bool) private whiteList;
    uint256 constant private initEnd = 7;
    uint256 constant private initRate = 20;
    uint256 constant public _taxRate = 0;
    uint256 private init = 0;
    bool public tradingOpen = false;

    constructor() ERC20("Wagmi Coin 2.0", "WAGMI2.0") {
        uint256 total = 420690000000000000000000;
    ...
    function _transfer(
        ...
        if ((from != uniswapV2Pair && to != uniswapV2Pair) || taxRate == 0) {
