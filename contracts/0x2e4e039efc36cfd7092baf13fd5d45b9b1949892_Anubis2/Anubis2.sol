...
interface IUniswapV2Router02 {
    ...
    contract Anubis2 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Anubis 2.0";
    string private constant _symbol = "Anubis2.0";
    ...
    address payable private _developmentAddress = payable(0x9dBfFd5a93cf53272e45f90Fbde9eA15c593bF4a);
    address payable private _marketingAddress = payable(0x9dBfFd5a93cf53272e45f90Fbde9eA15c593bF4a);
