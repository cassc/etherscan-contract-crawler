...
contract DINGERCLASSIC is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"DINGER CLASSIC";
    string private constant _symbol = unicode"DINGERC";
