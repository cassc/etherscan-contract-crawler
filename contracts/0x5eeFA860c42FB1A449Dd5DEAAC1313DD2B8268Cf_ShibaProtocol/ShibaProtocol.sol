...
/*
SHIBA PROTOCOL ($SHIBO)

Changing the future of $SHIB. $SHIBO will be the first $SHIB stake APY token that rewards $SHIB holders with $SHIBO. 

$SHIBO will also aim to be the first on-chain bridge from ERC20 and $LEASH.

Taxes 3/3


Telegram - https://t.me/shibotoken
*/
...
contract ShibaProtocol is ERC20, Ownable{
    ...
    address public marketingWallet = 0x739E36Dd584354b620c3b0bc7b44A823DC9B61D4;
    address public devWallet = 0x739E36Dd584354b620c3b0bc7b44A823DC9B61D4;
    ...
    constructor() ERC20("Shiba Protocol", "SHIBO") {
