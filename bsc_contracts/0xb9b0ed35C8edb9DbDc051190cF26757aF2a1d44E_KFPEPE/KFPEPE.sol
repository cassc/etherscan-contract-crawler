...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CAKE = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD address REWARDS
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //pancakeswap router
        _token = msg.sender;
    }
...
contract KFPEPE is IBEP20, Auth {
    using SafeMath for uint256;

    address CAKE = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD address REWARDS
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // BNB FOR LIQ
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "KENTUCKY FRIED PEPE";
    string constant _symbol = "KFP";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 4201337069 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 15)  / 1000; //1.5%

    uint256 public _maxWalletToken = ( _totalSupply * 45 ) / 1000; //4.5%
    ...
    uint256 targetLiquidityDenominator = 100000;
    ...
    uint256 public swapThreshold = _totalSupply * 10000 / 10000;
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
            ...
            require((heldTokens + amount) <= _maxWalletToken,"Limit reached, you can not buy that much anymore.");}
