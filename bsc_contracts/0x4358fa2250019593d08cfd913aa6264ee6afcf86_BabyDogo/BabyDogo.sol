...
BabyDogo Coin aims to offer a blockchain-based farm, betting, mining and gaming platform on the BEP20 network, which is completely decentralized and operates on smart contracts.


https://babydogo.pro
https://t.me/babydogocoin
https://twitter.com/BabyDogoCoin
...
contract BabyDogo is ERC20, Ownable {
    uint256 public buyFee = 6;
    uint256 public sellFee = 8;

    address public marketingWallet = 0x8F828CeD83024186106B5DfD954d8fc49AD0E4Ee;
    ...
    constructor () ERC20("Baby Dogo Coin", "BabyDogo") 
    {   
