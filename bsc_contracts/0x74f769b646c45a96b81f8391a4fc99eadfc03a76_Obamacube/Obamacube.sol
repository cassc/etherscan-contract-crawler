...
/**
 *Submitted for verification at BscScan.com on 2023-0-20
*/
...
contract Obamacube is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ObamacubeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Obamacube", "Obamacube") {
        marketingWallet = payable(0xCCBF02eA0f6d5BB091ffd0aC67a1b3aB977bE4Cd);
        devWallet = payable(0xc1AD3633887AB7bfC9681C1498f106F8A4c6A4Ac);
        ...
        dividendTracker = new ObamacubeDividendTracker(
            payable(this),
            router,
            0x33E05e27C4f4eec0971FE6d1CFb347c3517884b9,
            "ObamacubeTRACKER",
            "ObamacubeTRACKER"
        );
...
contract ObamacubeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Obamacube public ObamacubeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ObamacubeContract = Obamacube(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Obamacube_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Obamacube_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Obamacube contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ObamacubeContract);

            uint256 prevBalance = ObamacubeContract.balanceOf(address(this));
            ...
            {
                uint256 received = ObamacubeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ObamacubeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
