...
contract Bert is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0x77590EF427349A0C6A6296452c40627cF2c89C1d;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xdead)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true; //pinklock
        _isExcludedFromFees[0xe1A073B33587345B1547dA4cb5a250729db48Cb7] = true; //pinklock

        _mint(address(0xe1A073B33587345B1547dA4cb5a250729db48Cb7), 1e11 * (10 ** decimals()));
