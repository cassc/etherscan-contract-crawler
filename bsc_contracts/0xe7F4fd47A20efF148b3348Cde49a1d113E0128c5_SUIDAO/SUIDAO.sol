            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (0 == startTradeBlock) {
                    ...
                    if (!isAddLP && !isRemoveLP && block.number < startTradeBlock + _killBlock) {
                        _funTransfer(from, to, amount, 80);
                        return;
                    }
                }
            }
            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0x8DeE7ad5Db4Cb9EC72FAf49108f6a6CB65e4Cca3), destroyAmount);
                    }
                }
...
contract SUIDAO is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000,
        address(0x8DeE7ad5Db4Cb9EC72FAf49108f6a6CB65e4Cca3),
        address(0x8DeE7ad5Db4Cb9EC72FAf49108f6a6CB65e4Cca3),
        address(0x8DeE7ad5Db4Cb9EC72FAf49108f6a6CB65e4Cca3),
        address(0xa9b67ECeeB9f7c83f91eaB69Cb2a6879E06Aab38),
        10000,
        0,
        10000
    ){
