...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x20402B664C9C76614485f2EE46a6A48B94f401A7; // Owner
...
contract Moonbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Moonbit";
    string private _symbol = "MOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20402B664C9C76614485f2EE46a6A48B94f401A7); // 营销地址
    address payable public teamWalletAddress = payable(0xc6069163a23AD49d0c0A29EEAA0BDABe01582c10); // 团队地址
