...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x37C6603Bf6891F84D522129cb98527896A86fc4C;
...
contract lordbeerus is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lord Beerus";
    string private _symbol = "BEERUS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe097EE32fA146b2D25B026599fF52Aeecb28442b);
    address payable public teamWalletAddress = payable(0xe097EE32fA146b2D25B026599fF52Aeecb28442b);
