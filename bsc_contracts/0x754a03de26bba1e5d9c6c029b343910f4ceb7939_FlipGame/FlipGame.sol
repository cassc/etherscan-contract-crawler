...
/*
 Flip Game Token - $FLIPS
 Developer - 4%
 Liquidity - 66%
 Game Pool - 30%
 Telegram - https://t.me/ProjectFlipGame
 Twitter - @ProjectFlipGame
 Website - www.projectflipgame.xyz
*/
...
contract FlipGame is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Flip Game";
    string private constant _symbol   = "FLIPS";
    ...
    uint256 public _marketingFee = 300; // 3% of every transaction is sent to marketing wallet
