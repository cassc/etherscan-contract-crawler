...
// File: contracts/Evergrow contract.sol
...
contract BROKENDICK is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BROKENDICK";
    string constant _symbol = "B$DCK";
    ...
    uint256 public swapThreshold = _totalSupply / 20; // 0.5%
    bool inSwap;
