...
// ENTERFLOKIWORLD (ENTERFLOKI) is an exclusive tokenized community of the most prolific NFT Investors, Builders, and Creators in the Web3 space. 
// Our primary focus is to stay at the forefront of technology and innovation by cultivating the best talent, products, and education through our community.
// Submitted for Telegram: https://t.me/ENTERFLOKIWORLD
...
contract  ENTERFLOKIWORLD  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "ENTERFLOKIWORLD";
    string private _symbol = "ENTERFLOKI";
