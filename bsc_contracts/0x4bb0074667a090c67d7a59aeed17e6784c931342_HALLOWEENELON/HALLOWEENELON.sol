...
/* Token contract */
contract HALLOWEENELON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x4E610C9b5c4d7A419ee2b0473479C75082d3e630;
    ...
    // Name and symbol
    string constant _name = "Halloween Elon";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 5.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 2% or 2M tokens
