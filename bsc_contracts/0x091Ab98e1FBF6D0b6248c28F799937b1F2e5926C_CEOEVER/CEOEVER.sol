...
$$    $$/ $$       |$$    $$/ $$       |$$$/  $$       |$$ |      
 ...
 Twitter's CEO will be the only CEO who will remain immortal forever.
 Earn Dogecoin forever with CEOEver. 
 As long as you hold onto CEOEver, you will earn a 5% Doge reward.
 All you have to do is hold it in your wallet and earn automatically.

 Telegram : https://t.me/ceoever
...
contract CEOEVER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CEOEVER";
    string constant _symbol = "CEOEVER";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 100 * 10**19 * 10**_decimals;
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeAmount = amount.mul(totalFee).mul(100).div(feeDenominator * 100);
