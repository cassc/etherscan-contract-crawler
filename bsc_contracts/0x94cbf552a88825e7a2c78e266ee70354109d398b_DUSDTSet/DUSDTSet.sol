...
function Score(address account) external view returns(uint256 _Satisfied_Received,uint256 _Satisfied_Sented,uint256 _Resentful_Received, uint256 _Resentful_Sented, bool _On_BlackList){
