...
/**
 *Submitted for verification at BscScan.com on 2023-10-045
*/
// Telegram : https://t.me/DEEDEEGOLD
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x071B18E8d052c4396046377538f4ce7926cF011D; // owner address
...
contract DEEDEEGOLD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DEDE DEDE GOLD";
    string private _symbol = "DDG";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xC18c566b328885137C732138d11cCE9C3f50Fb3C); // Marketing Address
    address payable public teamWalletAddress = payable(0x071B18E8d052c4396046377538f4ce7926cF011D); // Team Address
