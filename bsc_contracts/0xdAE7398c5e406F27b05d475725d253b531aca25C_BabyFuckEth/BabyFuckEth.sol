...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1aD089dCc76E3595461d56a7ed70Ca344d458840; // owner address
...
contract BabyFuckEth is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby FuckEth";
    string private _symbol = "$bMBGA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1aD089dCc76E3595461d56a7ed70Ca344d458840); // Marketing Address
    address payable private teamWalletAddress = payable(0x1aD089dCc76E3595461d56a7ed70Ca344d458840); // Team Address
