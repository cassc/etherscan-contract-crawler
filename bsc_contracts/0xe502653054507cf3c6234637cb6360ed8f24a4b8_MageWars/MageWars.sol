 ...
 *
 *
 * Mage Wars is an economic investment game built on a decentralized smart contract by Binance Smart Chain.
 *
 * You build your Guilds and summon mages to your tower.
 *
 * Magicians for you with the help of spells will Collect Mana every hour, which you can exchange for Runes or BNB.
 *
 * Join an exciting Journey and participate in the Arena, where you can fight in a difficult battle with your opponents.
 *
 * Build a tower, hire mages, fight in the Arena and get infinite Wealth for yourself and your mages.
 *
 *
 * JOIN US ON TWITTER: https://twitter.com/magewars_io/
 *
 *
 * Web: https://magewars.io/
 *
 *
 *
 */
