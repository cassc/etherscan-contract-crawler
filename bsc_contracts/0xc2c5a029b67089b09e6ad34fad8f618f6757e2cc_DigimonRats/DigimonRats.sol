...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x799b855774C5C7e176C814076dbCe76423e901B4; // owner address
...
contract DigimonRats is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Digimon Rats";
    string private _symbol = "$DGR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x799b855774C5C7e176C814076dbCe76423e901B4); // Marketing Address
    address payable public teamWalletAddress = payable(0x799b855774C5C7e176C814076dbCe76423e901B4); // Team Address
