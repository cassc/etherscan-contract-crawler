...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("CDOGE", "CDOGE") {
        address newOwner = address(0xeF66f492480e8995847e2f78926C1fef25e35669);
    
        uint256 totalSupply = 35000000 * 1e18;
        
        maxTransactionAmount = 35000000 * 1e18; // 0.5% maxTransactionAmountTxn
    	...
    	marketingWallet = address(0x4E0035f3f5c1dcCa793F51D598d06631277CBFBC); // set as marketing wallet
        buyBackWallet = address(0x4E0035f3f5c1dcCa793F51D598d06631277CBFBC); // set as marketing wallet
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 22000 * (10**18); //must hold 10,000+ tokens
    }
