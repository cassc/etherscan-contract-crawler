...
contract Pepe182 is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xd1D8B9BE5De3C09F28D1186fce2255DDa58CdD40);

    string public _name = "Pepe182";
    string public _symbol = "Pepe-182";
