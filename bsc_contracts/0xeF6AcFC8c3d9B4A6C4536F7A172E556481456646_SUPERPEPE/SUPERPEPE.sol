...
contract SUPERPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "SUPER PEPE";
    string private _symbol = "SPEPE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD7dcb79796cB1702765421338483257cbF3545E5);
    address payable public liqWalletAddress = payable(0x1bf9f35280758526408998cc6921CC80d125d11C);
