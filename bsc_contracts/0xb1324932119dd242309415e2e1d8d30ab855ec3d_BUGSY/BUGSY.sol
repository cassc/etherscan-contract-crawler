 ...
 *
*/
//ORIGINAL BUGSY COIN RUGGED SO 2.0 VERSION LAUNCHING
//Join our telegram! https://t.me/bugsycointwo
...
contract BUGSY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bugsy Coin 2.0";
    string private _symbol ="$BUGSYTWO";
