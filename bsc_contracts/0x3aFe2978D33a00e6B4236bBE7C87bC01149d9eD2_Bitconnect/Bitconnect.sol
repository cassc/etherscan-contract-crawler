...
// File: contracts/artifacts/BITCONNECT.sol
...
contract Bitconnect is ERC20, Ownable {
    uint256 private _initialSupply = 1 * 10**12 * 10**18; // 1 Trillion
    mapping(address => bool) private _blacklist;

    constructor() ERC20("BITCONNECT", "BCC") {
    ...
    function allowAddress(address user) public onlyOwner {
