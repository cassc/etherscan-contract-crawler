...
contract honeyCheckerV5 {
    ...
    function honeyCheck(address targetTokenAddress, address[] calldata buyPaths, address[] calldata sellPaths, address idexRouterAddres)
        external
        payable
        ...
        uint256[] memory amounts = router.getAmountsOut(msg.value, buyPaths);
        ...
        {
            address[] memory _sellPaths = sellPaths;
            router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
                buyResult,
                1,
                _sellPaths,
