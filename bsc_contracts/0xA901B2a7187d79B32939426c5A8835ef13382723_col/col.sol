...
contract col is ERC20, Ownable {
    ...
    function setBuyTaxes(uint256 _marketingTax) external onlyOwner {
        ...
        require(_marketingTax <= 25, "Can not set buy fees higher than 2%");
    ...
    function setTransferFees(uint256 _transferTaxes) external onlyOwner {
        ...
        require(_transferTaxes <= 25, "Can not set transfer tax higher than 2%");
