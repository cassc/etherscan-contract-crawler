...
contract YFICEO is ERC20, Ownable {
    ...
    address public marketingWallet = 0xFcaA9362b07f4d623F4AEDDAD5877908C065Fc18;
    address public ownerWallet = 0x214Fd627AC0cDF003C0290c8C51Cf8024cc8180C;

    uint256 public numTokensSellToSwap = 1e18;
    ...
    constructor() ERC20("YFICEO", "YFICEO") {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        if(takeFee) {
            ...
            if(sender == uniswapV2Pair) { //buy
                totalFee = buyLpFee + buyMarketingFee;
            } else {
                totalFee = sellLpFee + sellMarketingFee;
            } 
            if(totalFee > 0) {
    ...
    function swapAndDividend(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 totalBuyShare = buyMarketingFee + buyLpFee;
        uint256 totalSellShare = sellMarketingFee + sellLpFee;
        ...
        IERC20(USDT).transferFrom(address(_tokenReceiver), address(this), newBalance - balanceToMarketing);
    }
