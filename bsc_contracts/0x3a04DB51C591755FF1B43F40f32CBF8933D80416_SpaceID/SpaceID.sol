...
contract SpaceID is ERC20, Ownable {
    ...
    uint256 public charityBuyFee = 0;
    uint256 public devBuyFee = 0;
    uint256 public totalBuyFees = 0;

    uint256 public buyBackSellFee = 0;
    uint256 public marketingSellFee = 0;
    uint256 public charitySellFee = 0;
    uint256 public devSellFee = 0;
    uint256 public totalSellFees = 0;
 
    address payable public marketingWallet = payable(0xf61043503c39e9217CCcBB5145610d4fDACa1b46);
    address payable public devWallet = payable(0x4DaB540b86BC30Bed934E56236277043166fb8c4);
    address payable public charityWallet = payable(0xbB6d2286E25603B00539c80AD7a8858673E9b386);
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Space ID: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Space ID: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Space ID: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Space ID: Automated market maker pair is already set to that value");
    ...
    function swapAndSendToWallets(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingShare = newBalance.mul(marketingSellFee).div(totalSellFees);
        uint256 charityShare = newBalance.mul(charitySellFee).div(totalSellFees);
        uint256 devShare = newBalance.mul(devSellFee).div(totalSellFees);
