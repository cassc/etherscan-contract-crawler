...
contract babydogeCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "babydogeCeo";
    string private _symbol = "babydogeCeo";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2FFcb629D0D0AaDC3265043FfB8c992c8855fa02); 
    address payable public BurnedWalletAddress = payable(0x2FFcb629D0D0AaDC3265043FfB8c992c8855fa02); 
