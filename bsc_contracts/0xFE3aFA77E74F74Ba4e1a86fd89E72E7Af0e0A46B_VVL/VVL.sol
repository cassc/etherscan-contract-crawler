...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 5000;
    uint256 public _buyLPDividendFee = 0;
    uint256 public _sellLPDividendFee = 0;
    uint256 public _sellFundFee = 700;
    uint256 public _sellLPFee = 0;
    address secFundAddress = 0xE96C88D2c52D774F39446d6c44057Ccf1A657267;
    ...
    constructor (
        ...
        maxTXAmount =  airDropNumbs * 100 * 10 ** Decimals;
        _tTotal = total;
        ...
        holderRewardCondition = 10 ** IERC20(FISTAddress).decimals();
         _limitAmount = airDropNumbs * 100 * 10 ** Decimals;
...
contract VVL is AbsToken {
    constructor() AbsToken( 
        ...
        6,   
        142017000,   
        address(0x2552975f79174FB2af5e8aD2422C29dc314F7282),   
        address(0xE30187d4068Fa805159F5337f184866f92761Cf1)
    ){
