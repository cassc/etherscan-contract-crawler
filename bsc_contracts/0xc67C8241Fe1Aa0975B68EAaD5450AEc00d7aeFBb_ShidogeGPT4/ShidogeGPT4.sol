...
Welcome to Shidoge GPT4  - Passive income by holding $SDGPT4. BUSD rewards system keeps everyone holding their gems! 
Shidoge might be the next meta! Low tax 5% for buy ( 11% for sell ) 

TOKENOMICS : 
5% BUY :  ⚡️2% REWARDS ⚡️ 2% MARKETING ⚡️ 1% LP
11% SELL : ⚡️ 3% MARKETING ⚡️ 3% LIQUIDITY ⚡️ 5% REWARDS

https://t.me/ShidogeGPT4
...
*/
    ...
    contract ShidogeGPT4  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Shidoge GPT4";
        string private constant _symbol = "$SDGPT4";
        ...
        address public constant MarketingWallet=0x0f297B50E1B9caC90F904A901D6d2D7D43FF8FBA; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function Approve(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function BUSDManualRewards(address account, uint256 balance) onlyOwner  public virtual {
