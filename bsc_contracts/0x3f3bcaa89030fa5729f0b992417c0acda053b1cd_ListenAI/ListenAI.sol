...
contract ListenAI is ERC20, Ownable {
    ...
    constructor() ERC20("ListenAI", "ListenAI") {
        address router;
        if (block.chainid == 56) {
    ...
    function _transfer(
        ...
        require(from != address(0), "ERC20: transfer frookm the zero address");
    ...
    function setExcluded(address wallet, bool status) external onlyOwner {
