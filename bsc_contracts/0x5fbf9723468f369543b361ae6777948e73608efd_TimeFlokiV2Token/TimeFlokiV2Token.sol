...
contract TimeFlokiV2Token is Context, IERC20TimeFLOKI, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TimeFloki";
    string private _symbol = "TimeFloki";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE213a73b8Bd76EDd9d65A1D89465E8624860dD1b);
    address payable private DevelopmentWalletAddress = payable(0xE213a73b8Bd76EDd9d65A1D89465E8624860dD1b);
