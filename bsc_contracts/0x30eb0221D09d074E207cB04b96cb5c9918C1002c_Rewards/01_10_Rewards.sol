...
contract Rewards is Initializable, OwnableUpgradeable {
    ...
    uint256[] public staticRewards;

    // 5 public decimals

    uint256[] public buybackRewards;
    ...
    function setRewardsAmount() external onlyOwner {
        staticRewards = [
            205 * 10**9 * 10**9,
            120 * 10**9 * 10**9,
            14 * 10**9 * 10**9,
        ...
        buybackRewards = [300000, 120000, 9850, 4000, 2000, 800];
    }
    ...
    function releasePartialStaticRewards(
        address[][] calldata holders,
