    ...
    function harvestFromMasterApe() public {
        ...
        if (banana.totalSupply() >= hardCap && masterApe.BONUS_MULTIPLIER() > 0) {
            ...
            if (availableBananaRewards >= surplus)
                _safeBananaTransfer(address(0x000000000000000000000000000000000000dEaD), surplus);
            else {
                ...
                unallocatedBanana = 0;
                _safeBananaTransfer(address(0x000000000000000000000000000000000000dEaD), availableBananaRewards);
                return;
            }
        }
    }
