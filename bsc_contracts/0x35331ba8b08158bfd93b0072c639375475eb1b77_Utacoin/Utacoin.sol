...
contract Utacoin is BEP20, Auth {
    ...
    string public constant name = "Uta Coin";
    string public constant symbol = "$UTA";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x5Fd4d697E7003B331ed5fe864C9233792137b596;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(antibot && (firstbuy[sender] > 0)){
            require( firstbuy[sender] > (block.number - 1), "Bought before contract was launched");
        }
