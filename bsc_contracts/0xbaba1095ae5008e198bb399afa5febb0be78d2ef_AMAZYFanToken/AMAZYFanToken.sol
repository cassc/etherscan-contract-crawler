...
/* 
⚡️AMAZY⚡️#DaoGem 📜RO 📜Fee 5%
⚡️DAOGEM CLUB FANS
📢We are pleased to welcome you in our the community !  

⚡️💲Official Airdop get up to $100 worth of USDC tokens💲
⚡️$AMAZY  IS LIVE PancakeSwap #DaoGem  NOW⚡️
...
Telegram https://t.me/AmazyToken
⚡️DAOGEM CLUB FANS
$100 worth of USDC tokens
...
abstract contract ContextBEPSPORTS {
...
contract OwnableBEPSPORTS is ContextBEPSPORTS {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBEPSPORTS: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBEPSPORTS: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract AMAZYFanToken is ContextBEPSPORTS, BEPSPORTS, OwnableBEPSPORTS {
    ...
    string private _name = 'AMAZY';
    string private _symbol = '$AMAZY';
