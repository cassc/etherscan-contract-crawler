...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3F80cc662215d7c42a5f0d27071126150282cA20;
...
contract Chonkosaurus is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =  0x0531a502628a24b0E337b53a839050912dE8DC86;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Chonckosauras";
    string private _symbol = "Chonk";
