...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public partnerAddress = address(0x21DDE6e9d5fcf5185F7b099451610cbE2Ae40B37);
    ...
    function setPartnerFee(uint256 partnerFee) external onlyOwner {
...
contract Token is AbsToken {
    ...
    //USDT
        ...
        1000,
    //Fund
        address(0xa29c654bc84f6D41685cF59B0C82312622055CFA),
    //Receive
        address(0x1b02106D725037C866Aa7FaDd858BA279CBeeBA2)
    ){
