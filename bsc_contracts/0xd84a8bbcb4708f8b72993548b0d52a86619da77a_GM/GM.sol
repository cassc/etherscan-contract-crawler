...
/**
Website: goodmorningbsc.com
Twitter: https://twitter.com/goodmorningbsc
Telegram: https://t.me/GoodMorningPortal
*/
...
contract GM is Context, IERC20, Ownable {
    ...
    string private _name = unicode"GM  ☕️";
    string private _symbol = unicode"GM";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x6A519a88d7C2CD856304C7272C758Ae8F1341b1e); 
    address payable public teamWalletAddress = payable(0x6A519a88d7C2CD856304C7272C758Ae8F1341b1e); 
