...
contract QATARFIFA2022 is IERC20 {
    ...
    string constant private _name = "QATAR FIFA 2022";
    string constant private _symbol = "QTFF";
    ...
    uint256 constant public maxBuyTaxes = 500000;
    uint256 constant public maxSellTaxes = 1500000;
    uint256 constant public maxTransferTaxes = 500000;
    uint256 constant masterTaxDivisor = 10000000;
    ...
    constructor () payable {
        ...
        if (block.chainid == 56) {
            ...
            dexRouter = IRouter02(0xC0f5cE8a54f21383377E6523BBcE661F8aDFF397);
        } else if (block.chainid == 1 || block.chainid == 4 || block.chainid == 3) {
            dexRouter = IRouter02(0xC0f5cE8a54f21383377E6523BBcE661F8aDFF397);
            //Ropstein DAI 0xA67A0f86C4cdb1e80a9E4592d414798ef8973D20
        } else if (block.chainid == 43114) {
            dexRouter = IRouter02(0x628972691F2107a4828E805de534321E73E94C53);
