...
The Dogetti family set out to create a revolutionary new meme coin that would become the top dog in the meme coin space. They envisioned a coin that would be owned and controlled by the community, with the express goal of shifting wealth into the defi ecosystem and creating a sense of belonging and shared purpose among its holders.

Stay tuned for the launch and be part of Dogetti - The family of Mafias

https://t.me/DogettiBSC
*/
...
contract Dogetti is IBEP20, Auth {
    ...
    address constant DEV = 0xd474607c85cC5E7805895cC899707eC4F85a2735;


    string constant _name = "Dogetti";
    string constant _symbol = "$DOGETTI";
