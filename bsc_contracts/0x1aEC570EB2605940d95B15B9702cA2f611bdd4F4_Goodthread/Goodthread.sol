...
contract Ownable is Context {
    address private _owner =  0xffB287B7Fc275Daab5dcC8Be42962b03ffD13311; 
...
contract Goodthread is Context, IBEP20, Ownable { 
    ...
    address payable public _marketingAddress = payable(0xffB287B7Fc275Daab5dcC8Be42962b03ffD13311); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Good thread"; 
    string private _symbol = "Good thread";
    uint8 private _decimals = 9; 

    uint256 private _tTotal = 6000 * 10**12 * 10**_decimals;
    ...
    uint256 public _marketingBNBFee =30; 
    ...
    uint256 public _minTokensSwapToAndTransferTo = 30 * 10**12 * 10**_decimals; 
