...
interface IDEXRouter {
 ...
 contract  BNB_2_3 is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "BNB 2.3";
    string constant _symbol = "BNB 2.3";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 90) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 90) / 100; 
    ...
    address public devFeeReceiver = 0x75d2732567Ce6143C0f0f373fA5655E943FC07B6;
    address public buybackFeeReceiver = 0x75d2732567Ce6143C0f0f373fA5655E943FC07B6;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 5; // 0.3%
    bool inSwap;
