...
contract PEPEV is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0x8aeB884284e284d7C598523E991ca9CcD3B0f66A);
  
    bool inSwapAndLiquify;
    bool private swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToFee = 10000000 * 10**18;
    ...
    constructor () BEP20Detailed("PepeVault", "PEPEV", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 1000000 * 10**18 && _numTokensSellToFee <= 1000000000 * 10**18, "Threshold must be set within 1,000,000 to 1,000,000,000 tokens");
    ...
    function clearBEP20(address _tokenAddr,address _to, uint256 _amount) external onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
     ...
     function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(contractTokenBalance); // <- this breaks the ETH -> PEPEV swap when swap+liquify is triggered
