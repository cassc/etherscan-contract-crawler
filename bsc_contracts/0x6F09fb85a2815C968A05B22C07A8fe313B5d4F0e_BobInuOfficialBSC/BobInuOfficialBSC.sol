...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6eab906465CD1352C54E9E74Be0c99C3b7abD735; // owner address
...
contract BobInuOfficialBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOB INU";
    string private _symbol = "BOB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x57d2001f495694d45633b065E31fe459f691afDc); // Marketing Address
    address payable private teamWalletAddress = payable(0x6eab906465CD1352C54E9E74Be0c99C3b7abD735); // Team Address
