...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x28bDA186D8892177323f27EA9F48A280F2e76231; // owner address
...
contract FatPepe is Context, IERC20, Ownable {
    ...
    string private _name = "FatPepe";
    string private _symbol = "FATPEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x16fba88617bEE9608C3980EEa1007ebAEcF56911); // Marketing Address
    address payable private teamWalletAddress = payable(0x16fba88617bEE9608C3980EEa1007ebAEcF56911); // Team Address
