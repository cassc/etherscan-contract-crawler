...
/**
TELEGRAM : https://t.me/qatardoge2022
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
/* Token contract */
contract qatardoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x6BDCE77377e8Db5025e25b616589622f1Dc61DFe;
    ...
    // Name and symbol
    string constant _name = "QATARdoge";
    string constant _symbol = "Qdoge";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 1% or 1m tokens
    ...
    uint256 public reflectionFeeSell = 3;
    ...
    uint256 GREEDDuration = 600;
    
    // Dead blocks
    uint256 deadBlocks = 3;

    // Sell amount of tokens when a sell takes place
    uint256 public swapThreshold = _totalSupply * 25 / 100; // 0.25%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x21E5310d872c86D533cE413Fb0f10472bAB4be0d;
