...
contract CIBADUYUTHUNTER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CIBADUYUT HUNTER";
    string private _symbol = "CIBA";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x728b247e9d6Ccd36e9F39e758eCfa17933Fb91EB); // Marketing Address SM
    address payable public BuyBackWallet = payable(0x4FB5F19b7281A53150C36d942770f7D86Feb61fb); // Team Address
