...
contract WHEN is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 250000000 * 10**_decimals;
    
    uint256 public maxSellAmount = 10000000000 * 10**_decimals;
    uint256 public maxBuyAmount = 10000000000 * 10**_decimals;
    uint256 public maxWalletBalance = 10000000000 * 10**_decimals;

    address public marketingAddress = 0xb3D8D58fC988538C094dE6720e71d38Fb8D18798;
    address public devAddress = 0xf39030F55Dc6dFdeD4Ce8DBB98FE4D5a79c8ECa4;

    string private constant _name = "Mr When Inu";
    ...
    Taxes public taxes = Taxes(2,0,5,1);
    Taxes public sellTaxes = Taxes(2,0,5,1);
