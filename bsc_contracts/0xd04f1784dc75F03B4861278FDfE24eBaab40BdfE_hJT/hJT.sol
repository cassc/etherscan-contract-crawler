...
contract hJT is IERC20, Ownable {
    ...
    address private fundAddress = address(0x43d3A4cc72647e340CBFe598773f2d122f8996FB);
    address private fundAddress2 = address(0x87f92D3953C45FA763DCAd23f4446E2d648e3bbB);
        ...
        if (takeFee) {
            ...
            if (sender==uniswapV2Pair && isRoute[recipient]){
                ...
                _takeTransfer(
                    sender,
                    fundAddress2,
                    tAmount.div(100).mul(_taxFee.mul(multiple)),
                    currentRate
                );
