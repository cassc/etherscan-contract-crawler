...
contract FlOKIDS is ERC20, Ownable {
    ...
    constructor() ERC20("FLOKIDS", "$FLOKIDS") {
        ...
        maxTransactionAmount = 2 * 1e9 * 1e18; 
        maxWallet = 2 * 1e9 * 1e18; 
        ...
        devWallet = address(0xF8223B7E43b307d7CcA35FC59e1702Fa7223Ab03); 
