...
contract GodsTime is Context, IERC20, Ownable {
    ...
    string private _name = "GodsTime";
    string private _symbol = "GodsTime";
  ...
  function getBurnWallet() public view returns (address) {
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xb5aEecAD6eFb6a3BB75037Ffab22715C7A1E550C, 'We can not exclude Uniswap router.');
