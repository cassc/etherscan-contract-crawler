...
contract SUPERPEPE is Context, IERC20, Ownable {
    ...
    string private _symbol = "SUPERPEPE";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xD0f5C5D2372b387d608bA00408A6Ef1fFDC03EF1); // Marketing Address
    address payable public teamWalletAddress = payable(0x5d5A7E39A7c0777d3724378Dd12b0458EcA334Ec); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xb64471eF881963f73F660956acf6373f20210fF1),
            block.timestamp
        );
    }
