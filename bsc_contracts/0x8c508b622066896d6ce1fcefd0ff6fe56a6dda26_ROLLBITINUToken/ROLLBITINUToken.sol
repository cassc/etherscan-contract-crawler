...
ROLLBIT INU (RLB)
Rollbit Inu.
https://twitter.com/CryptoWithNick/status/1629213798388338688
*/
...
contract ROLLBITINUToken is ROLLBITINUDeployer, Context, Ownable {
    // common addresses
   address private _owner;
   address private ROLLBITINUTeam;
   address private CharityROLLBITINU;
   ...
   string public override name = "ROLLBIT INU";
   string public override symbol = "RLB";
   ...
   constructor(uint totalSupplyValue, address ROLLBITINUTeamAddress, address CharityROLLBITINUAddress) {
       // set total supply
       totalSupply = totalSupplyValue;
      
       // designate addresses
       _owner = msg.sender;
       ROLLBITINUTeam = ROLLBITINUTeamAddress;
       CharityROLLBITINU = CharityROLLBITINUAddress;
      
       // split the tokens according to agreed upon percentages
       balances[ROLLBITINUTeam] =  totalSupply * 4 / 100;
       balances[CharityROLLBITINU] = totalSupply * 4 / 100;
