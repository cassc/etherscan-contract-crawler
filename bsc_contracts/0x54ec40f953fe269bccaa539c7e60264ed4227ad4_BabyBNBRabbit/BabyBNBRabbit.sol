...
contract BabyBNBRabbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyBNBRabbit";
    string private _symbol = "BabyBNBRabbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc111Ba72b1C392aF35575d5C445ce602cf8D8853); // Marketing Address
    address payable public teamWalletAddress = payable(0xc111Ba72b1C392aF35575d5C445ce602cf8D8853); // Team Address
