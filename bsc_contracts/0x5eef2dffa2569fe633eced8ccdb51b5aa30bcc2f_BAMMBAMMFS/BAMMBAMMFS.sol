...
contract BAMMBAMMFS is Context, IERC20, Ownable {
    ...
    string private constant _name = "BAMMBAMM"; //
    string private constant _symbol = "STONE"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0xAC87Ee978a6DD26C7ca53AD0f6999022A2b1A8f6 ;
