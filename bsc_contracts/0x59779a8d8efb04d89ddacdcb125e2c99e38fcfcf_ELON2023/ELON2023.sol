...
// Telegram: https://t.me/elon2023bsc

// Previous projects:  10k - 15k - 30k

// More info: https://t.me/whitetygercalls
...
contract ELON2023 is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Elon2023";
    string private constant _symbol = unicode"ELON2023";
    ...
    uint256 public _maxTxAmount = _tTotal * 5 / 1000; // 0.5%
    uint256 public _maxWalletToken = _tTotal * 2 / 100 ; // 2%

    address payable public DevWallet = payable(0x8AA6797fb246109357480480BFD70338f4A55e79);
    address payable public MarketingWallet = payable(0x8AA6797fb246109357480480BFD70338f4A55e79);
    ...
    function Blacklist() external onlyOwner {
    ...
    function setMax (uint256 maxtx, uint256 maxwal) external onlyOwner {
