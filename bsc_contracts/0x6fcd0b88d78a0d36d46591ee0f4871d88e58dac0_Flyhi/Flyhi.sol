...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x8793abA76DD77A5F9B1ca3a5096FF5caBB20FeF7);
...
contract Flyhi is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xFF12Fe41b05168F717A8B7FC401ec2dA25d022c1;

    string constant _name = "Flyhi";
    string constant _symbol = "Flyhi";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**10 * 100**_decimals;
