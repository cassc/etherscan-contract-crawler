...
import "contracts/interfaces/ICronosPadAntiBot.sol";
...
contract AntiBotStandardToken is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        cronosPadAntiBot = ICronosPadAntiBot(cronosPadAntiBot_);
        cronosPadAntiBot.setTokenOwner(owner());
        enableAntiBot = true;
