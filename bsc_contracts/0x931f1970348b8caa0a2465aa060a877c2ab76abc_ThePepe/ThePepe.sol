...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // Rewards Token
...
contract ThePepe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "THEPE";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = .1 * 10**10 * 10**_decimals; // 1 Billion Total Supply
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xA9283F8fb01abcAf16e2494C8387c4E0A8225FB5;
        marketingFeeReceiver = 0x9fB21865Df608B973C72fD34bBb5aa8aa1215AB9;
        teamFeeReceiver = 0x21527952260Af5956da9E1Cc9b0b6169829bCc2d;
        charityFeeReceiver = 0x7299ebcEC846D6011B238af91039FADb75Ef69EA;
    ...
    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base1000) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base1000 ) / 200;
    }
