...
contract MomFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MomFloki";
    string private _symbol = "MFloki";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xACE15615aEDe35C99FF085298Ca1d39E81ABF975); // Marketing Address
    address payable public teamWalletAddress = payable(0xACE15615aEDe35C99FF085298Ca1d39E81ABF975); // Team Address
