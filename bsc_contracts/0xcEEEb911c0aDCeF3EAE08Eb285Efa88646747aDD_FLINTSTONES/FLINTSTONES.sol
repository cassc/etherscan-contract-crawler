...
"Yabba Dabba Doo - living in the stone age never looked so fun!" Bringing a new moonshot to the BSC space using stones 🪨 🦕💥
...
contract FLINTSTONES is IBEP20, Auth {
    ...
    string constant _name = "Yabba Dabba Doo";
    string constant _symbol = "$FLINTSTONES";
    ...
    address public marketingFeeReceiver = 0x37d7C5A8473ef7541117A151FFd933C97C05246d;
    address public devFeeReceiver = 0x37d7C5A8473ef7541117A151FFd933C97C05246d;
