...
contract Token_Tech_Coin is Context, Ownable, IERC20 {
    ...
    uint256 private _tTotal = 8717800 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "Token Tech Coin";
    ...
    address payable public burnWallet = payable(0xe4723073c17430a8fFB280Be8aD27165CBe30D08);
    address payable public marketingWallet = payable(0xe4723073c17430a8fFB280Be8aD27165CBe30D08);
    address payable public liquidityWallet = payable(0xe4723073c17430a8fFB280Be8aD27165CBe30D08);
    address payable public airdropWallet = payable(0xe4723073c17430a8fFB280Be8aD27165CBe30D08);
