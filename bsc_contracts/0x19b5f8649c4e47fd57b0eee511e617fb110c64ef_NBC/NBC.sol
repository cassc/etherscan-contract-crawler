...
contract NBC is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 23e3 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public marketingWallet = 0xb055ebFf8b642b589d3abD224E2499bf36eD6a09;
    ...
    constructor() ERC20("New Beginning Chain", "NBC") {
        _tokengeneration(msg.sender, 23e6 * 10**decimals());
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 23e4, "Swap threshold amount should be lower or equal to 1% of tokens");
