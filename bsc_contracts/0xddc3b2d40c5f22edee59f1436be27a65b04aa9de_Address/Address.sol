...
library Address{
 ...
 contract  SamuraiPepe is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xd3Ec1ae7F19D3f92dfc9A6900c2653ac951fbf22;
    address public donationWallet =0xd3Ec1ae7F19D3f92dfc9A6900c2653ac951fbf22 ;
    string private constant _name = "Samurai Pepe ";
    string private constant _symbol = "SamuraiPepe";
    ...
    Taxes public taxes = Taxes(2, 7, 2, 0);
    Taxes public sellTaxes = Taxes(2, 8, 3, 0);
