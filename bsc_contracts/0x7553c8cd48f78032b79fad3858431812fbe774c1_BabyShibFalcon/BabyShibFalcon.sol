...
// Telegram: https://t.me/BabyShibFalconGlobal
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 ShibCat = IBEP20(0x5A8261214a6C5FE68a6a4c81aeC4f68bCD73ebc1); //reward ca can be changed any
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = ShibCat.balanceOf(address(this));
 
       address[] memory path = new address[](2);
       path[0] = WBNB;
       path[1] = address(ShibCat);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = ShibCat.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           ShibCat.transfer(shareholder, amount);
...
contract BabyShibFalcon is IBEP20, Auth {
   using SafeMath for uint256;
 
   address ShibFalcon = 0x5A8261214a6C5FE68a6a4c81aeC4f68bCD73ebc1; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Baby ShibFalcon";
   string constant _symbol = "Baby SF";
...
uint256 reflectionFee = 5;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xd2889d13CDB2e76c3d01AEac8eff002cDE1D2F84; //should be wallet of owner
       ...
       autoLiquidityReceiver =0xd2889d13CDB2e76c3d01AEac8eff002cDE1D2F84; //Can be change to any wallet you want
       marketingFeeReceiver = 0xd2889d13CDB2e76c3d01AEac8eff002cDE1D2F84; //Can be change to any wallet you want
