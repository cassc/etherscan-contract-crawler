...
/**
TG https://t.me/flokihero
Twitter https://twitter.com/flokiherocoin
*/
...
contract FlokiHero is ERC20, Ownable {
    ...
    constructor() ERC20("FlokiHero", "FlokiHero") {
        marketingWallet = payable(0x2e9a86B320042a2F3D1133879fC4423F4aC5cAD5);
        devWallet = payable(0x2e9a86B320042a2F3D1133879fC4423F4aC5cAD5);
        ...
        maxWallet = totalTokenSupply / 20000000; //
        swapTokensAtAmount = totalTokenSupply / 20000000; //
    ...
    function updateFees(
        ...
        require(totalSellFees <= 30 && totalBuyFees <= 6, "total fees cannot exceed 30% sell or buy");
...
contract FlokiHeroDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    FlokiHero public FlokiHeroContract;
    ...
    constructor(
        ...
        defaultToken = token;
        FlokiHeroContract = FlokiHero(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "FlokiHero_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FlokiHero contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(FlokiHeroContract);

            uint256 prevBalance = FlokiHeroContract.balanceOf(address(this));
            ...
            {
                uint256 received = FlokiHeroContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    FlokiHeroContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
