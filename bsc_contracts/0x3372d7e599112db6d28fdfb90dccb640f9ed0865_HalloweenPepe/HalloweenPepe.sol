...
https://twitter.com/HPepeBSC

Nano Market Capitalization (100$)
...
contract HalloweenPepe is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xe452E0db0326B0aA1865A5b6dF45FDDb6F294675);
    ...
    string private constant _name = "HalloweenPepe";
    string private constant _symbol = unicode"HalloweenPepe";
    ...
    constructor() {
        _owner = 0xe452E0db0326B0aA1865A5b6dF45FDDb6F294675;
