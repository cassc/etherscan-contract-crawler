...
contract QJZX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 888 * 10**9;
    uint256 public _maxTxAmount = 888 * 10**9; // 
    uint256 public _maxWalletAmount = 888 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**9; //
    string private constant _name = unicode"QJZX"; // 
    string private constant _symbol = unicode"QJZX"; //    
    ...
    address public  _marketingWallet = 0x6ABe3dfdEE2527554d4DCb4040E3f753d5d1F31C;
