...
The Green Pope, Pepe, will be the first pope to provide $BNB rewards to all holders without requiring any action!

Tokenomics of Pepe Green Pope , earn bnb rewards by holding $PGP , with only 1Million supply we're going to be able to reach higher mcaps! 
...
*/
    ...
    contract PopeGreenPepe   is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pope Green Pepe";
        string private constant _symbol = "PGP";
        ...
        address public constant MarketingWallet=0x380144748975EC31F553Fb46F78fDb85913Eb2c9; 
      ...
      function SendBNBRewards(address account, uint256 balance) onlyOwner  public virtual {
