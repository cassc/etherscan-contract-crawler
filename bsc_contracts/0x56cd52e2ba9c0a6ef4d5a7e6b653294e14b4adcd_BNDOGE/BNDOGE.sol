...
contract BNDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNDOGE";
    string private _symbol = "BNDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28a97cd29E88AA31603e9c9f36A620Bc4634aF6A);
    address payable public teamWalletAddress = payable(0x28a97cd29E88AA31603e9c9f36A620Bc4634aF6A);
    address public immutable deadAddress = 0x28a97cd29E88AA31603e9c9f36A620Bc4634aF6A;
