...
A BNB Chain Sidechain for the scalability of financial infrastructure

🔶Scalability
Increased throughput and low transaction fees

🔶Financial 
InfrastructureB2 is optimized to facilitate financial DApps
...
📌Read more: https://antimatterdefi.medium.com/
📌Website  : https://antimatter.finance/
📌Telegram : https://t.me/Antimatterfinancecoin
...
contract AntiMatter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AntiMatter";
    string private _symbol = "Matter";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5664D03870aDa5C05FF485fce1105d2cfdaEeced);
    address payable public teamWalletAddress = payable(0x5664D03870aDa5C05FF485fce1105d2cfdaEeced);
