...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD Rewards on Toggle
...
contract SquidShikokuInu is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Squid Shikoku Inu";
    string constant _symbol = "SQUIDSHIK";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 ; //BUSD Rewards on Toggle
    ...
    uint256 public rewardsFee = 0; //Rewards might be turned on at higher marketcap to reduce gas fees
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x4233b16CD2A4a30907c61f062041EE6AEa86Ca65;  
        anothermarketingWallet = 0x4233b16CD2A4a30907c61f062041EE6AEa86Ca65;
