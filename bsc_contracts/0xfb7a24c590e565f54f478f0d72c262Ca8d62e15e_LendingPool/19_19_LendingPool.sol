...
contract LendingPool is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        priceOracle = 0x048f11915114b561E49c86BAcEB457a9D7c3A9Ec;
    }
    ...
    function borrow(
        ...
        uint256 interestAmount = (loanAmount * poolInfo[pid].interestRate) / 1000;
    ...
    function getPenaltyAmount(
        ...
        if (timestamp > dueTime) {
            penaltyAmount = (loanAmount * penaltyRate * (timestamp - dueTime)) / (ONE_DAY * 1000);
        }
    }
