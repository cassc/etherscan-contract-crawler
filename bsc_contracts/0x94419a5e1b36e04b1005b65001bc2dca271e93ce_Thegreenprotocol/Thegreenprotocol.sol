...
contract Thegreenprotocol is IBEP20, Auth {
    ...
    string constant _name = "The Green";
    string constant _symbol = "Protocol";
    ...
    address private marketingFeeReceiver =0x54977741aC6FabF21c468A3EEF0aA95BC809eA19;
    address private devFeeReceiver =0x54977741aC6FabF21c468A3EEF0aA95BC809eA19;
 ...
 //Snipers
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x54977741aC6FabF21c468A3EEF0aA95BC809eA19;
 ...
 // switch Trading
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBdevelopment = amountBNB.mul(devFee).div(totalBNBFee).div(2);
  ...
  //      require(Success1, "receiver rejected ETH transfer");
        (Success1, /* bytes memory data */) = payable(devFeeReceiver).call{value: amountBNBdevelopment, gas: 30000}("");
