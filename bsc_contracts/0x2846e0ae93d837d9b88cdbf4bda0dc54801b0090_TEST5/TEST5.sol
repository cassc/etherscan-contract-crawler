...
contract TEST5 is ERC20, Ownable {
    mapping(address => bool) private _blacklist;
    address public marketingWallet = 0x4ae8d5c1c82985b1D14b23B2a6B4ECdCe64ea212;
    uint256 public marketingFee = 0;
    uint256 public liquidityFee = 0;
    IPancakeRouter02 private pancakeRouter;
    address private busd = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;

    constructor() ERC20("TEST5", "TEST5") {
    ...
    function _swapTokensForBUSD(uint256 tokenAmount) private {
        ...
        pancakeRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(tokenAmount, 0, path, marketingWallet, block.timestamp);
    }
}