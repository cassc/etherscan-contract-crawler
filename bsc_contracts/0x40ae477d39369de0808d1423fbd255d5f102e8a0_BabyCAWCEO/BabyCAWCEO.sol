...
contract BabyCAWCEO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8b38836c148B844B0226415CA37B1981a77e367c); 
    address payable public Wallet_Dev = payable(0x8b38836c148B844B0226415CA37B1981a77e367c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Baby CAW CEO"; 
    string private constant _symbol = unicode"Baby CAWCEO"; 
