...
contract OptimusCEO is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xE1be342cc3Fc8B04dc3dd739AEE4492f333CDa66); // Marketing Address

    address payable public teamAddress =
        payable(0x5405ecf1D0b0e947b4C7d742a8210AA6DAB4c59B); // Team Address

    address payable public liquidityAddress =
        payable(0x7eEa81b3640CF9f054D3A7570a380F54F583fcE7); // Liquidity Address
    ...
    uint256 private constant _tTotal = 100 * 1e4 * 1e18;
    ...
    string private constant _symbol = "$OPTIMUSCEO";
