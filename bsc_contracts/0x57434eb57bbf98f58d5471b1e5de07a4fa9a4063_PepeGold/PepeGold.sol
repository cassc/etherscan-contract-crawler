...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x82953082d7E0fFF4A833b30B9Dccc39DD12111Fd; // owner address
...
contract PepeGold is Context, IERC20, Ownable {
    ...
    string private _name = "Pepe Gold";
    string private _symbol = "PEPEGOLD";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD5f66BBe787a1D4ddF72CA67b040B3a501147435); // Marketing Address
    address payable private teamWalletAddress = payable(0x82953082d7E0fFF4A833b30B9Dccc39DD12111Fd); // Team Address
