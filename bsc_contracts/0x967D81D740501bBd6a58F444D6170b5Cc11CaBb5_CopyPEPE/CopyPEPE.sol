...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public RewardToken =
        IERC20Extended(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D);
    ...
    function setRewardToken(address _token) external override onlyToken {
        RewardToken = IERC20Extended(_token);
    }
    ...
    function swapAndTransfer(address _reciever, uint256 _amount) private {
        ...
        router.swapExactETHForTokensSupportingFeeOnTransferTokens{
            value: _amount
        }(0, path, _reciever, block.timestamp);
    }
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if (amount > 0) {
            ...
            if (amount > 0) swapAndTransfer(shareholder, amount);
...
// main contract
contract CopyPEPE is IERC20Extended, Ownable {
    using SafeMath for uint256;

    string private constant _name = "COPYPEPE";
    string private constant _symbol = "$COPYPEPE";
    ...
    uint256 _reflectionBuyFee = 2_00;
    uint256 _liquidityBuyFee = 1_00;
    uint256 _marketingBuyFee = 5_00;

    uint256 _reflectionSellFee = 2_00;
    ...
    constructor() Ownable() {
        ...
        marketingFeeReceiver = 0xfe7B55E3e50F071cB28cCdc3F664db4c123429e3;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = address(this)
            .balance
    ...
    function setRewardToken(address _token) external onlyOwner {
        distributor.setRewardToken(_token);
    }
