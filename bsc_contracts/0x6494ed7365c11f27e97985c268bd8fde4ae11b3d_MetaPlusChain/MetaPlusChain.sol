...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7dDB1415705F1dC299632244D9c6Dd93340fC91A; // owner address
...
contract MetaPlusChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Meta Plus Chain";
    string private _symbol = "MPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3Ab61464C2A7be4CF8AEFb54676337cD4d04EAd9); // Marketing Address
    address payable public teamWalletAddress = payable(0x7dDB1415705F1dC299632244D9c6Dd93340fC91A); // Team Address
