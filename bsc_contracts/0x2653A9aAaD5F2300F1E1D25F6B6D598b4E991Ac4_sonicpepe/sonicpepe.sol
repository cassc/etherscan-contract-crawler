...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC5CE02d1f9fe528D7CC71CFeb522Ca1028B90B76; // owner address
...
contract sonicpepe is Context, IERC20, Ownable {
    ...
    string private _name = "SONIC PEPE";
    string private _symbol = "SPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC5CE02d1f9fe528D7CC71CFeb522Ca1028B90B76); // Marketing Address
    address payable public teamWalletAddress = payable(0xC5CE02d1f9fe528D7CC71CFeb522Ca1028B90B76); // Team Address
