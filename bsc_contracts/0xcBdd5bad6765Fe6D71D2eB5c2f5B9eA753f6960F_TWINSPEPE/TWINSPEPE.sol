...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1893Fd35C5a8dcCb5Bc0d1f761Df0932e956C05B; // owner address
...
contract TWINSPEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TWINS PEPE";
    string private _symbol = "TWINS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1893Fd35C5a8dcCb5Bc0d1f761Df0932e956C05B); // Marketing Address
    address payable public teamWalletAddress = payable(0x1893Fd35C5a8dcCb5Bc0d1f761Df0932e956C05B); // Team Address
