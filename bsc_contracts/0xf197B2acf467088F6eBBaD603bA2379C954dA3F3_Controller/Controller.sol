...
contract View is IView, OwnableV2
{
    ...
    /// OLD
    IUserStorage private userStorage = IUserStorage(0xc0BD4AacbCc1a6c8a02Aeec0447787E75d01F177);
    IWalletStorage private walletStorage = IWalletStorage(0x0984eDe01503659A25d53A77F5A3Cf41E0126c1a);
    IUnfrozen private unfrozen  = IUnfrozen(0xC696EefF5DE10FA3d07b7252c3f884c8aF314804);
    IDepositeStorage private depositeStorage = IDepositeStorage(0xDdE0308BF5B4BEbF1305E6ffE9607F53c4657aA6);
...
{
    /// OLD
    IWalletStorage walletStorage =IWalletStorage(0x0984eDe01503659A25d53A77F5A3Cf41E0126c1a);
    IUserStorage userStorage= IUserStorage(0xc0BD4AacbCc1a6c8a02Aeec0447787E75d01F177);
    View V = View(0x85dDcd099a5A865CD29597A6d0a95F283C27514F);
    IDepositeStorage depositeStorage = IDepositeStorage(0xDdE0308BF5B4BEbF1305E6ffE9607F53c4657aA6);
    IUnfrozen unfrozen = IUnfrozen(0xC696EefF5DE10FA3d07b7252c3f884c8aF314804);
