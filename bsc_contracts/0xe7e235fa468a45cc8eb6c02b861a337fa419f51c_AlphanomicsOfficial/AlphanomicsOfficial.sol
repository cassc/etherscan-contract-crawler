...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0eBcc06448876cB98B1462C5BA63E3899D498E5D; // owner address
...
contract AlphanomicsOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlphanomicsOfficial";
    string private _symbol = "Alphanomics"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7f1342c55aEE1547A69c8183aC8FfA7b004Dd1A5); // Marketing Address
    address payable public teamWalletAddress = payable(0x7f1342c55aEE1547A69c8183aC8FfA7b004Dd1A5); // Team Address
