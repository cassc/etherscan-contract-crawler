...
contract PERRY is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("PERRY", "PERRY") ERC20Permit("PERRY") {
        _mint(0x65a77cB0f99E86e7e6b93bCC0f59D4CaCe40F6f1, 420420420 * 10 ** decimals());
    }
