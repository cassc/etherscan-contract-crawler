...
contract FourTest is ERC20, Ownable {
    ...
    uint256 public USDTRewardsFee = 3;
    uint256 public liquidityFee = 2;
    uint256 public burnFee = 2;
    uint256 public ecoSystemFee = 1;
    uint256 public totalFees = USDTRewardsFee.add(liquidityFee).add(burnFee).add(ecoSystemFee);
...
constructor(address payable _fundWallet) public ERC20("4TEST Token", "4TEST") {
      ...
      fundWallet = _fundWallet;
        ...
        swapTokensAtAmount = 1 * 10**4 * (10**18);
    ...
    function setUSDTRewardsFee(uint256 value) external onlyOwner{
        ...
        totalFees = USDTRewardsFee.add(liquidityFee).add(burnFee).add(ecoSystemFee);
    }
