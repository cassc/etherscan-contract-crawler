...
Telegram: https://t.me/hallowratbsc
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43c123C9ce7FacddB4d8dB9267023d4F861B37B2;
...
contract HALLOWRAT is Context, IERC20, Ownable {
    ...
    string private constant _name = "HALLOW RAT"; // 
    string private constant _symbol = "HRat"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x43c123C9ce7FacddB4d8dB9267023d4F861B37B2);
