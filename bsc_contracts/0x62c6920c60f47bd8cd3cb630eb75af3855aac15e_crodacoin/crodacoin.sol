...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf7BB127C7873F23eB20be65Cbf90A5f527861B40;
...
contract crodacoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xcC67B8FBD845797C2D034Faf1980C65aF3C553e0;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "crodacoin";
    string private _symbol = "Croda";
