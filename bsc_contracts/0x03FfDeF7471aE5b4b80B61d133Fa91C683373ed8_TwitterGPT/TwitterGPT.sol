...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xab89d7b248eC009cBaAefD185F4b67ed68181319; // owner address
...
contract TwitterGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TwitterGPT";
    string private _symbol = "T-GPT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xab89d7b248eC009cBaAefD185F4b67ed68181319); // Marketing Address
    address payable public teamWalletAddress = payable(0xab89d7b248eC009cBaAefD185F4b67ed68181319); // Team Address
