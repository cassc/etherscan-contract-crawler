...
contract KangUniverse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KangUniverse";
    string private _symbol = "KU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2F37208F7f290DD8bea63157C94061C84de4CdE5); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2F37208F7f290DD8bea63157C94061C84de4CdE5); // BuyBack Address
