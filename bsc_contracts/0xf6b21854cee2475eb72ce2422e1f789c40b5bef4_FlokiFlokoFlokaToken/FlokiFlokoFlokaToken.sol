...
contract FlokiFlokoFlokaToken is BEP20Official {
    ...
    string public override name = unicode"FlokiFlokoFloka";
    string public override symbol = unicode"FlokiFlokoFloka";
