...
contract Justindogezilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Justindogezilla";
    string private _symbol = "JDZ";
    uint8 private _decimals = 18;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x8a1D099671964B07F285b2a277568Cf9EA2f5B64); 
    address payable public ttWal = payable(0x8a1D099671964B07F285b2a277568Cf9EA2f5B64); 
