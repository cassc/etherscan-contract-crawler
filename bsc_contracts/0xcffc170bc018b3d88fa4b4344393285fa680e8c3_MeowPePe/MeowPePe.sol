...
contract MeowPePe is ERC20, Ownable {
    uint256 public marketingFeeOnBuy  = 5;
    uint256 public marketingFeeOnSell = 5;

    address public marketingWallet = 0xa9c45643De2e28F635892dA474BA35004817A8da;
    ...
    constructor () ERC20("MeowPePe Token", "$MPP") 
    {   
    ...
    function setFees(uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnBuy <= 5, "Marketing fee on buy cannot be more than 10%");
        require(_marketingFeeOnSell <= 5, "Marketing fee on sell cannot be more than 10%");
