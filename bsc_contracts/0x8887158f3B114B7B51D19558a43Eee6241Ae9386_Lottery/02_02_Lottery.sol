...
contract Lottery {
    uint256 public constant ticketPrice = 0.02 ether;
    uint256 public constant maxTickets = 100; // maximum tickets per lottery
    uint256 public constant ticketCommission = 0.004 ether; // commition per ticket
    uint256 public constant duration = 10080 minutes; // The duration set for the lottery
