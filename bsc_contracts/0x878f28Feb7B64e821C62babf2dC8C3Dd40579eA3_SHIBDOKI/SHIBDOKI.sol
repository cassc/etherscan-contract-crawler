...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf46083411c47C195E75B175636DA9fBe3ccB3edf; // owner address
...
contract SHIBDOKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBDOKI";
    string private _symbol = "$SHIBDOKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf46083411c47C195E75B175636DA9fBe3ccB3edf); // Marketing Address
    address payable public teamWalletAddress = payable(0xf46083411c47C195E75B175636DA9fBe3ccB3edf); // Team Address
