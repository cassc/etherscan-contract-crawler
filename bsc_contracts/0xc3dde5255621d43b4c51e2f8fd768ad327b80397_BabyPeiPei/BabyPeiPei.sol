...
contract BabyPeiPei is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Pei Pei";
    string constant _symbol = "BPEI";
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 4000;
    }
