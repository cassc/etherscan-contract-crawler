...
contract TESTE is ERC20, Ownable {
    ...
    constructor() payable ERC20("Teste", "TESTE") {
        ...
        marketingWallet = 0xA03598F9c4F40aD82AD001360e8442daC60EE4c3;
        ...
        transferOwnership(address(0xE7e0F00F3B86e17AeA13d78E71583a95F466D5dB));
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        uniswapV2Router.addLiquidityETH{value: newBalance}(
            ...
            0, // slippage is unavoidable
            address(0xA03598F9c4F40aD82AD001360e8442daC60EE4c3),
            block.timestamp
        );
