...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x80aF76EBA3a493d85C19157D86fB545ef6E15492; // owner address
...
contract FC is Context, IERC20, Ownable {
    ...
    string private _name = "FloCat";
    string private _symbol = "FC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCae8Ef504368C5cd4c5f901FE0eB7f90329b6c32); // Marketing Address
    address payable public teamWalletAddress = payable(0xCae8Ef504368C5cd4c5f901FE0eB7f90329b6c32); // Team Address
