...
contract BabyHasbulla is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    
    string private constant _name = "Baby Hasbulla";

    string private constant _symbol = "Baby Hasbulla";

    address payable public marketingAddress =
        payable(0x3a01aC925a82536037971573715d5e4946463d52); // Marketing Address
        
    address payable public teamAddress =
        payable(0x3a01aC925a82536037971573715d5e4946463d52); // Team Address
        
    address payable public liquidityAddress =
        payable(0x3a01aC925a82536037971573715d5e4946463d52); // Liquidity Address
