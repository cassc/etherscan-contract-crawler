...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x0a6ff991a21323a2228127FcBA3A804f6D4A3e56;
...
contract BMWinu2023 is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"BMW Inu 2023"; 
    string private constant _symbol = unicode"2023BMWI"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x0a6ff991a21323a2228127FcBA3A804f6D4A3e56), BNB_Tot);
            }
