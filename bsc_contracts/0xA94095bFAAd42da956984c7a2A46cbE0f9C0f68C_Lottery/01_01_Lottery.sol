...
contract Lottery is ReentrancyGuard {
    ...
    uint256 public maxTickets; // maximum tickets per lottery
    uint256 public ticketCommission; // commition per ticket
    uint256 public duration; // The duration set for the lottery
    ...
    function setTicketPrice(uint256 _ticketPrice, uint256 _ticketCommission) public  {
