...
contract Companion is Context, IERC20, Ownable {
    ...
    string private _name = "Companion";
    string private _symbol = "CMPN";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x16E10d7ef8638eEb1890C5502409A6d9D89Cda7B, 'We can not exclude Uniswap router.');
    ...
    function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0x16E10d7ef8638eEb1890C5502409A6d9D89Cda7B, 'We can not blacklist Uniswap router.');
