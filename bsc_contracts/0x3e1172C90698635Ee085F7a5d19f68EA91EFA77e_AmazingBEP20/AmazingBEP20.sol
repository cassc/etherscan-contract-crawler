 ...
 */
contract AmazingBEP20 is BEP20, ERC20Decimals, ERC20Mintable, ERC20Burnable, ERC1363, TokenRecover, ServicePayer {
    constructor(
        string memory name_,
        ...
        ServicePayer(feeReceiver_, "AmazingBEP20", signature_, _msgSender())
    {
