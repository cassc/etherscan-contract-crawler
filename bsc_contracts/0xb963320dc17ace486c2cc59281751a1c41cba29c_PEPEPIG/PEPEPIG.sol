...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24331bDC3FFf3Ec2C4363F5F12f8661d101C36C4;
...
contract PEPEPIG is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x56D388792d24e009CA9F2Ccc541A58d9F7cad7BC;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PEPEPIG";
    string private _symbol = "PEPEPIG";
