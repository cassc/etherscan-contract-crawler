...
contract BurnRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = "Burn Rabbit"; // 
    string private constant _symbol = "$BR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x9d2564E8f579525DA76a2AD963d4197c3814b9dA;
