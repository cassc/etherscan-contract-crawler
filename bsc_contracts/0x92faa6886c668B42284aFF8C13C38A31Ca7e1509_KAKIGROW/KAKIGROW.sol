...
contract KAKIGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KAKIGROW";
    string private _symbol = "KAKIGROW";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x3196A30d1AcDA6Cb9eD0b2148e03FA3223BcC353); 
    address payable private teamWalletAddress = payable(0x3196A30d1AcDA6Cb9eD0b2148e03FA3223BcC353); 
