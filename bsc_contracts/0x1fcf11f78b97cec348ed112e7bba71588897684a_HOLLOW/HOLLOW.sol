...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x64ea8618DA50dF26562eBeE8337dAbDb6F522D45;
...
/* Token contract */
contract HOLLOW is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x64ea8618DA50dF26562eBeE8337dAbDb6F522D45;
    ...
    // Name and symbol
    string constant _name = "HOLLOW";
    string constant _symbol = "HOLE";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 5% on launch or 50k tokens
    uint256 public _maxSellTxAmount = _totalSupply * 300 / 10000; // 5% or 50k tokens
    uint256 public _maxWalletToken = ( _totalSupply * 300 ) / 10000; // 5% or 50k tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x64ea8618DA50dF26562eBeE8337dAbDb6F522D45;
