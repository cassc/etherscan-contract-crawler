...
contract UnclePepe is ERC20, Ownable {
    ...
    constructor () ERC20("Uncle Pepe", unicode"Uncle🐸") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xba6D5c42DB51B964D1342d4bF74267D72C0472BD;
        ...
        maxTransactionAmountBuy     = totalSupply() * 200 / 1000;
        maxTransactionAmountSell    = totalSupply() * 200 / 1000;
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_totalFeesOnBuy <= 100, "Total Fees cannot exceed the maximum");
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        require(_totalFeesOnSell <= 100, "Total Fees cannot exceed the maximum");
