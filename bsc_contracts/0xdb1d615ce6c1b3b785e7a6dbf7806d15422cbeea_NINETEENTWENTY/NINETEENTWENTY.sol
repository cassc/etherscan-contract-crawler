...
contract NINETEENTWENTY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "1920";
    string private _symbol = "1920";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x840d29585b5a310905c29ceac1cDE2778dB290ff); 
    address payable public buyBackWalletAddress = payable(0xefB27d0744e1eb1D0c9421b0E52923F536A00dDc); 
    ...
    uint256 public _walletMax = 300000000 * 10**9; 
