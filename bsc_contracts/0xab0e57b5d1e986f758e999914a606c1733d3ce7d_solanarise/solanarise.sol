...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9DcC4B9712c13EA717d284036dFdeed3405bB51c; // owner address
...
contract solanarise is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "solanarise";
    string private _symbol = "solanarise";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9DcC4B9712c13EA717d284036dFdeed3405bB51c); // 
    address payable public teamWalletAddress = payable(0x9DcC4B9712c13EA717d284036dFdeed3405bB51c); // 
