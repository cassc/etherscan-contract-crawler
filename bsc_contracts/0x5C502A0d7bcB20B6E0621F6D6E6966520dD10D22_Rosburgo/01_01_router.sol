...
contract Rosburgo is IERC20, Ownable {
    ...
    string private constant _name =  "Rosburgo2";
    string private constant _symbol = "RSB2";
    ...
    address public marketingWallet = 0x77fE120ed9edd9221823c4b239A4c8a1d301e943;
    ...
    constructor() {
        ...
        whitelist[0x10ED43C718714eb63d5aA57B78B54704E256024E] = true;   // Uniswap router       
    ...
    function activateTrading() external onlyOwner {
       ...
       _approve(address(this), address(uniswapV2Router), _totalSupply);
        ...
        maxTxAmount = 100 * 10**6 * 10**_decimals;
        maxWalletAmount = 100 * 10**6 * 10**_decimals;
    }
