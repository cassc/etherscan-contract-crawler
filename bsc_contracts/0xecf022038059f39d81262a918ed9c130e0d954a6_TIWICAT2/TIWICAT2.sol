...
/*
    ...
    website:
    telegram: https://t.me/tiwicat2_community
    twitter:
...
contract TIWICAT2 is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletBalance = 40000000000 * 10**_decimals;

    address public marketingAddress = 0x23c48E4B480591F81A128b698ebB029687415871;
    address public devAddress = 0x23c48E4B480591F81A128b698ebB029687415871;

    string private constant _name = "TIWICAT2";
    string private constant _symbol = "TIWICAT";
    ...
    Taxes public taxes = Taxes(1,0,2,1);
    Taxes public sellTaxes = Taxes(1,0,2,1);
