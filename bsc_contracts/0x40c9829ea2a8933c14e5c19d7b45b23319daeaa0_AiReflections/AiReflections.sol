...
//OFFICIAL WEBSITE - HTTPS://BSCREFLECTORS.COM
//OFFICIAL TELEGRAM - HTTPS://T.ME/BSCREFLECTORS

//10% Ai REFLECTIONS in partnership and native tokens
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public RWRD = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c);
    ...
    function updateRewardToken(address _rewardToken) public {
        require(isContract(_rewardToken), "");
...
contract AiReflections is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ai Reflections";
    string constant _symbol = "AiR";
    ...
    function updateRewardToken(address _rewardToken) external onlyOwner {
        distributor.updateRewardToken(_rewardToken);
    }
