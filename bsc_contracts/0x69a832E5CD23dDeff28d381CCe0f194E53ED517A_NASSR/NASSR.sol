...
/*  #RonaldoEffect #AlNassrFC

        Telegram : https://t.me/AlnassrToken
        Webiste : https://alnassrtoken.com/
...
contract NASSR is IBEP20, Ownable {
    string private constant _name = "Al-Nassr FC Fan Token"; // Name
    string private constant _symbol = "NASSR"; // Symbol
    uint8 private constant _decimals = 18;
    uint256 private constant _totalSupply = 1e12 * 10**_decimals; //Token Decimals
    ...
    uint256 public totalSellFee = 6; //Total Sell Fee
    ...
    constructor() {
        ...
        liquedityReceiver = address(0x317A9749CdcD008E8ADAa2D102B0861593E6EE89);
        marketFeeReceiver = address(0x317A9749CdcD008E8ADAa2D102B0861593E6EE89);
        devFeeReceiver = address(0x317A9749CdcD008E8ADAa2D102B0861593E6EE89);
