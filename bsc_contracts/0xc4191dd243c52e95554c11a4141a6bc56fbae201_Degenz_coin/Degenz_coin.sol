...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF1d6502a3bbECd5e52559F5E53Ec599F552ADe1a;
...
contract Degenz_coin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x95e4f91a66491625ec32cC6addd1E92b9B008eaD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Degenz_coin";
    string private _symbol = "DGNZ";
