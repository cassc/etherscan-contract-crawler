...
contract PPUSDT is ERC20, Ownable {
    ...
    constructor() payable ERC20("PepeUSDT", "PPUSDT") {
        ...
        treasuryWallet = 0xDe6ACAc53937Ecb81a8986fe470243516d593EEE;

        dividendTracker = new DividendTracker(99e6, rewardToken);
        ...
        _mint(treasuryWallet, 99e12 * (10 ** 9));
