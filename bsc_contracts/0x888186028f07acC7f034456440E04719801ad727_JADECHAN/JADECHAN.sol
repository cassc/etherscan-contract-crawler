...
contract JADECHAN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JADE";
    string private _symbol = "JADE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08Fb39CE4a75E86f793028a3d5c7066Af772dA81); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x0862CBb7b6B36857BBa4A1d019295873def93b3C); // Development Address
