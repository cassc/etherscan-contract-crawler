...
contract CEOGPT4 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "CEO GPT4";
    string private _symbol = "CGET4";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x038eBA3d1f49bD02132C4B8C01603BA5682F4271);
    address payable public liqWalletAddress = payable(0x038eBA3d1f49bD02132C4B8C01603BA5682F4271);
