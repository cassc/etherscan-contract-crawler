...
contract BabyFlokiClassic is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x755bE21F77f15C85bf683b54844C86007CFa3199); 
    address payable public Wallet_Dev = payable(0x755bE21F77f15C85bf683b54844C86007CFa3199);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x755bE21F77f15C85bf683b54844C86007CFa3199); 
    ...
    string private constant _name = "BabyFlokiClassic"; 
