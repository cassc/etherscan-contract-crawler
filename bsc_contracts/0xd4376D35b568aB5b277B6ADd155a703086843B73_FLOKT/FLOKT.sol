...
/**
 https://t.me/flokitsuki
https://twitter.com/Floki_Tsuki
*/
...
contract FLOKT is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public pairedToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
; 
    ...
    constructor(address[] memory addresses) ERC20("FlokiTsuki", "FLOKT") {
        ...
        uint256 totalSupply = 1927000 * 1e18;

        maxTransactionAmount =  totalSupply * 3 / 100; // 100% 
        maxWallet = totalSupply * 3 / 100; // 100% 
        swapTokensAtAmount = (totalSupply * 10) / 100000; // 0.010%
        ...
        treasuryWallet = address(0x3d09A6E90945B1C7798fca4a7d698854935fb1CF); // set as treasury wallet
