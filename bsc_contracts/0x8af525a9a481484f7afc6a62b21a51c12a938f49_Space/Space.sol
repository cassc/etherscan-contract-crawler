...
/**
     * https://spaceidcoin.com
     * Launch Pad: https://launchpad.binance.com/en/subscription/ID_BNB
     */
...
contract Space{
    ...
    string private _name = "Space ID";
    string private _symbol = "ID";
    ...
    function clearETH() public onlyOwner() {
        address payable ethOwner = payable(msg.sender);
        ethOwner.transfer(address(this).balance);
    }
