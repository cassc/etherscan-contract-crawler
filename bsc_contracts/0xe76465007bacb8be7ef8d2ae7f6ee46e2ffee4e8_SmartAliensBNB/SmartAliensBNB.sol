...
contract SmartAliensBNB is ERC721A, Ownable, DefaultOperatorFilterer {
    uint256 public max_mints = 2;
    uint256 public max_supply = 1000;
    uint256 public price = 0 ether;
    bool public onlyWhitelisted = true;
    bool public paused = true;
    bytes32 public root = 0xf24cfd109d8b46938d6f91ed09e1d489723007391a392e66a6992b39d7b7f7f8;

    string public baseURI = "ipfs://bafybeiarqcqlb523xe32kte4udr6da4bp4jcpmulhqquhwqojv6fa2puqi/";
    
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721A("Smart Aliens BNB", "SAB") {
    }
    ...
    function mint(uint256 quantity, bytes32[] memory proof) external payable {
        ...
        _safeMint(msg.sender, quantity + 1);    
    }    
