...
Website  https://testnet.cubescan.network/en-us/
Main-net Explorer - https://www.cubescan.network/en-us/
Documentation - https://docs.cube.network/#/bridge/
*/
...
contract CubeRise is Context, IERC20, Ownable {
    ...
    string private constant _name = "CubeRise";
    string private constant _symbol = "CubeRise";
