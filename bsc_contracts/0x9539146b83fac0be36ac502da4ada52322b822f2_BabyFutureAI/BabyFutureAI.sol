...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1e2Fca43f56B990e919990Ddb3FC2F5De2d95F4d;
...
contract BabyFutureAI  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x5511dADaC22F074f9fa749b8F25Ed798a879d268;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Baby Future AI";
    string private _symbol = "BabyFutur-AI";
    ...
    uint256 public numTokensSellToAddToLiquidity = 7000000 * 10**6 * 10**9;
