...
contract Luk is ERC20{
    ...
    constructor(address synthesize,address orePool,address _router,address usdt) ERC20("Luk","Luk"){
        possessor = msg.sender;
        _mint(synthesize, 20 * 10000 ether);
        _mint(orePool, 80 * 10000 ether);
        officeReceiveAddress = address(0xFd8aa1158e8FC115b5048EFef02eb81be62F33FB); 
    ...
    function burn(uint amount) public isPossessor {
