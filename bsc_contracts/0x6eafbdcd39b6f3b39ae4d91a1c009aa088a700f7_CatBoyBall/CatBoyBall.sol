...
contract CatBoyBall is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Boy Ball"; // 
    string private constant _symbol = " $CATBOYBALL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xE494c47d95Ff79a6C30a0FbF01e0ae63faf37dF9;
