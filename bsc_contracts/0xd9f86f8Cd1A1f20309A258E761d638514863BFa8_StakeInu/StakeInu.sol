...
/*
Welcome Everyone to Stake Inu. We will be Fair Launching Monday at 4:30pm UTC (you can check the VC timer). Launch will be fair for everyone, no pre pump nor any of that stuff, we always keep it clean over here and transparent, we have anti bot measures so everyone has equal chances of entering. We will be going live as soon as VC Timer starts, we will be keeping you guys posted, this is when the contract will be deployed and trading will start, NO CA HAS BEEN DEPLOYED YET, DO NOT BUY ANT OTHER CA OTHER THEN THE PINNED ONE (at launch). 

Chat will be closed to avoid any fake ca’s and spam, it will be opened 10 mins after launch.
We are changing the space over here, we don’t play around, we will be reaching milestones that has never been seen before.

Join us on our Journey… Some very exciting stuff is planned for this. 

- Max bag at launch 0.5% ( 50k tokens)
- Total supply 10 million 
- Starting mcap 2 BNB
- Tax will be 9/9 (sell tax slighlty higher for first few minutes) 

GOOD LUCK EVERYONE!


“Number #1 Crypto Casino Casino coin, #STAKEINU “
*/
...
contract StakeInu is IERC20 {
    ...
    string constant private _name = "Stake Inu";
    string constant private _symbol = "SINU";
    ...
    address payable public marketingWallet = payable(0x712Dcb1cE8820A1feBD82b8048bECa498061740d);
    ...
    constructor () payable {
        ...
        IRouter02 _newRouter = IRouter02(dexRouter);
        address get_pair = IFactoryV2(dexRouter.factory()).getPair(address(this), _newRouter.WETH());
...
//================================================ BLACKLIST
    ...
    function finalizeTransfer(address from, address to, uint256 amount, bool buy, bool sell, bool other) internal returns (bool) {
        ...
        if (_hasLimits(from, to) && !_hasLiqBeenAdded) {
