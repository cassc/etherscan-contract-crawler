...
//Max Tx and Wallet: 4% (40,000,000)

// SPDX-License-Identifier: MIT

//Telegram:https://t.me/KateCatBsc
//Website:http://KateCat.website/
//Twitter:https://twitter.com/KateCat
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor() {
        _owner = 0x75F852CA0985406A25a2af0778D82e1F60348525;
...
contract KateCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "KATE CAT"; //
    string private constant _symbol = "KATECAT"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address payable public _marketingWallet =
        payable(0x75F852CA0985406A25a2af0778D82e1F60348525);
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = (balanceOf(address(this)) * _liquidityFee) /
            (_marketingFee + _liquidityFee);
