...
contract  MikeTyson is Context, IERC20, Ownable {
    ...
    string private _name = "MikeTyson";
    string private _symbol = "MikeTyson";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xA572A38292cC24C09Bb654E83754E60bFBc6e000));
        ruinWalletAddress = payable(address(0xA572A38292cC24C09Bb654E83754E60bFBc6e000));
