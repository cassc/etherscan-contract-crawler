...
abstract contract AToken is IERC20, Ownable {
    ...
    uint256 public _Mfeione = 200;
    uint256 public _Mfeito = 0;//N
    uint256 public _Wfeiin = 0;//N
    uint256 public _Wfeiok = 100;
        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x3EFCF208A13BfF854f37d5F0BC48a9B71a4a1127), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0x3EFCF208A13BfF854f37d5F0BC48a9B71a4a1127),//
        address(0x3EFCF208A13BfF854f37d5F0BC48a9B71a4a1127)//
    ){
    }
}