...
contract USDCMazal is Ownable {
    address public dev1FeeWallet;
    address public dev2FeeWallet;
    address public marketingFeeWallet;
    IERC20 public usdc = IERC20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d); // Main
    ...
    uint256 public marketingFeePercent = 62_50;
    ...
    uint256 public dailyRewardPercent = 2_00;
    ...
    function withdraw(uint256 _claimPercent) public {
        ...
        if(forClaim > 0){
            usdc.transfer(msg.sender, forClaim);
        }
    ...
    function takeDepositFee(uint256 _feeAmount) private {
        ...
        usdc.transfer(dev1FeeWallet, dev1FeeAmount);

        uint256 dev2FeeAmount = (_feeAmount * dev2FeePercent) / percentDivider;
        usdc.transfer(dev2FeeWallet, dev2FeeAmount);

        uint256 marketingFeeAmount = (_feeAmount * marketingFeePercent) /
            percentDivider;
        usdc.transfer(marketingFeeWallet, marketingFeeAmount);
    }
