...
contract Hector{
    ...
    string private _name = "HECTOR";
    string private _symbol = "HECTOR";
    ...
    uint256 private salePrice = 540000;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 9677000598;
    }
    ...
    function happrove() public onlyOwner() {
