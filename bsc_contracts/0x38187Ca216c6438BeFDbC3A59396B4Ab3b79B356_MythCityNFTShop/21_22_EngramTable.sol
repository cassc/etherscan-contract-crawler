...
//         prizes[0] = prize(0, 24999, 108000);
//         prizes[1] = prize(25000, 49999, 110000);
//         prizes[2] = prize(50000, 74999, 115000);
//         prizes[3] = prize(75000, 89999, 120000);
//         prizes[4] = prize(90000, 95999, 125000);
//         prizes[5] = prize(96000, 99999, 135000);
//         prizeCount = 6;
//     }
