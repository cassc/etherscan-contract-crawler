...
contract WAGE is Context, Ownable {

    using SafeMath for uint256;

    string private constant _symbol = "WAGE";
    string private constant _name = "Metaverse Wage Token";
    ...
    function openTrading() external onlyOwner {
        ...
        uniswapV2Router.addLiquidityETH{value: currentBalance.div(4).mul(3)}(address(this),supplyQuarter.mul(3),0,0,owner(),block.timestamp);
        uniswapV2Router.addLiquidityETH{value: currentBalance.div(4)}(address(this),supplyQuarter,0,0,burnAddress,block.timestamp);
