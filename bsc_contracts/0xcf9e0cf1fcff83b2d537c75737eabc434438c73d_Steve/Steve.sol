...
contract Steve is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420_690_000_000_000 * _decimalFactor; // 420,690,000,000,000 tokens total
    ...
    uint256 public _maxTxAmount = 8_413_800_000_000 * _decimalFactor; // 2% of total supply
    uint256 public _minTxAmount = 420_690_000 * _decimalFactor; // 0.0001% of total supply
