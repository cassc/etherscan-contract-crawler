...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb04308f9453f8910Cb6fbbbE813272bDA90aBa08; // owner address
...
contract WHITEPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "WHITE PEPE";
    string private _symbol = "WHITEPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb04308f9453f8910Cb6fbbbE813272bDA90aBa08); // Marketing Address
    address payable public teamWalletAddress = payable(0x1de203e4E9004bE82D52cc3fb57AcC540547592c); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 10000000000000000000000 * 10**_decimals; 
