...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x39cc9FF1AE457031950ee51697D72de292bfcD60;
...
contract SUCC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6e086Ee89b114833B40E5d72932CAA09F15A948B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MR.SUCC";
    string private _symbol = "SUCC";
