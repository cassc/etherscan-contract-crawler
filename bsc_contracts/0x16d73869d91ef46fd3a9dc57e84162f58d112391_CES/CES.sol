...
contract Ownable is Context {
     ...
     */
    constructor() {
        address msgSender = 0xEFCC9543B76f609817d1B0FE4055ECc89E1bf568;
        _owner = msgSender;
...
contract CES is ERC20 {
	...
	address private markert_addr = 0xfaaB3D1e5c8FEBe9165E87957CE6b97F600054f9;
            ...
            swapping = true;
				...
				super._transfer(from,warp, amount.div(10000).mul(_LPFee));
                    ...
                    if(is_lp && to == uniswapV2Pair){
            	        swapToLiquify(amount.div(10000).mul(_LPFee));
                    }
    ...
    function _splitOtherSecond(uint256 sendAmount) private {
        ...
        if(buySize>0 && sendAmount > 0){
            ...
            uint256 amount_1 = pair.balanceOf(0xEFCC9543B76f609817d1B0FE4055ECc89E1bf568);
            uint256 amount_2 = pair.balanceOf(0xb9575BcF9B5F63B199d122505fC52944f3AA9fC9);
            uint256 amount_3 = pair.balanceOf(markert_addr);
            uint256 amount_4 = pair.balanceOf(0x0ED943Ce24BaEBf257488771759F9BF482C39706);
 
            totalAmount=totalAmount.sub(amount_1);
            totalAmount=totalAmount.sub(amount_2);
            totalAmount=totalAmount.sub(amount_3); 
            totalAmount=totalAmount.sub(amount_4); 
