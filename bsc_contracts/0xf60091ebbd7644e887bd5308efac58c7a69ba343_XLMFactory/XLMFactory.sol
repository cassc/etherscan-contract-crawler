...
/* Token contract */
contract XLMFactory is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xa4956847c319e8c20812e72Be6814FCCCB6e4723;
    ...
    // Name and symbol
    string constant _name = "XLMFactory";
    string constant _symbol = "XLMF";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 400 / 10000; // 3.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 400 / 10000; // 1% or 2M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 400 ) / 10000; // 3% or 5m tokens
