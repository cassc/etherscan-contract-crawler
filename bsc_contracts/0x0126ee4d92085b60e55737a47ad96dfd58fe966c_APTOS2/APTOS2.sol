...
contract APTOS2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0xb579fbB624030ccF7ba5E6Ed24AEa72a84236e75;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "APTOS 2.0";
    string constant _symbol = "$APS";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x19979651394860583bf4831079B8fA3CaEC5B43F;
