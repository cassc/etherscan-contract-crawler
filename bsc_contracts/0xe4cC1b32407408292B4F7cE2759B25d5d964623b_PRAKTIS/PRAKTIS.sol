...
Insert contract details here if needed or remove the  / ** and * / 
...
contract PRAKTIS is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "PRAKTIS";
    string constant _symbol = "PRAKTIS";
