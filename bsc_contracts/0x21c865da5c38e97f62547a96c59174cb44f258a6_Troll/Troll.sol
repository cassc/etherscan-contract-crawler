...
//TELEGRAM: https://t.me/trollfaceportalbsc
interface IERC20 {
...
contract Troll is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x80A320778ccAd3b5174F7b317C7b24e1EbeB1347;
    address public devAddress = 0x80A320778ccAd3b5174F7b317C7b24e1EbeB1347;
    ...
    Taxes public taxes = Taxes(0,0,13,2);
    Taxes public sellTaxes = Taxes(0,0,13,2);
