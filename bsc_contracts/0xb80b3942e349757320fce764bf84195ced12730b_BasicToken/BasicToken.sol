...
contract BasicToken is ERC20, Ownable {
    ...
    {   
        require(buyFee_ <= 25 && sellFee_ <= 25, "Fees must be less than 25%");
    ...
    function updateEnableTrang(bool _enable) external onlyOwner {
    ...
    function _transfer(
        ...
        require(enableTrading, "ERC20: Token not listed yet");
