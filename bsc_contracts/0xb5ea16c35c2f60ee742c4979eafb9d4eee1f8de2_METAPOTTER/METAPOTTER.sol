...
/**
    ...
    Name =  HOGWARTS META LEGACY
    Symbol = POTTER
    Total Supply = 1,000,000,000,000,000
    Decimal = 9
    1% of each transaction to the liquidity pool
    2% of each transaction to the dev wallet
...
contract METAPOTTER is Context, IBEP20, Ownable {
    ...
    string private _name     = "HOGWARTS META LEGACY";
    string private _symbol   = "POTTER";
    uint8 private  _decimals = 9;
    
    uint256 public _taxFee =2; 
    uint256 public _liquidityFee = 5; 
    uint256 public _percentageOfLiquidityForMarketing = 60; 
    uint256 public maxWalletToken = 20000000000000 * (10**9);

    
    uint256 public  _maxTxAmount     = 1000000000000000 * 10**9;
    uint256 private _minTokenBalance = 10000000000 * 10**9;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner {
        require(taxFee <= 2, "Holder Reflection cannot exceed 2%");
        _taxFee = taxFee;
    }
