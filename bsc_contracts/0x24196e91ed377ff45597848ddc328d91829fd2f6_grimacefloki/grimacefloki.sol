...
MAX WALLET/TX : 2%
BUY/SELL TAX: 8/8
BREAKDOWN: 1% LP, 5% MARKETING, 2% REWARDS IN GRIMACE (CA : 0xc6759a4fc56b3ce9734035a56b36e8637c45b77e)
TELEGRAM: https://t.me/grimacefloki
TWITTER: https://twitter.com/grimacefloki

DESCRIPTION:
BSC is back and Floki, the resident mascot of the network, is leading the charge!  
What better way to celebrate this momentous ocassion than to join a project that will 
also generate one of 2022's biggest hits: GRIMACE COIN!  A hybrid of two legends, 
led by a based, committed and well-connected team!  Enjoy Grimace rewards just by holding!  
This is Grimace Floki!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 GRIMACE = IERC20(0xC6759a4Fc56B3ce9734035a56B36e8637c45b77E);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GRIMACE.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(GRIMACE);
        ...
        uint256 amount = GRIMACE.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GRIMACE.transfer(shareholder, amount);
...
contract grimacefloki is IERC20, Ownable {
    using SafeMath for uint256;

    
    address GRIMACE = 0xC6759a4Fc56B3ce9734035a56B36e8637c45b77E;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Grimace Floki";
    string constant _symbol = "GRMFLOKI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000 * (10 ** _decimals); // 
    uint256 public _maxTxAmount = (_totalSupply * 10) / 500; // 2% of Total Supply.
    ...
    constructor () {
        ...
        autoLiquidityReceiver = address(0xED4FadB483FC0489E6b2Da811d9f15Db3FF9A7D1);
        marketingFeeReceiver = address(0xED4FadB483FC0489E6b2Da811d9f15Db3FF9A7D1);
