...
/* 
🦹🏼‍♀️ Welcome to TekeTeke FINANCE ⛩
🦹🏼‍♀️ $TekeTeke is a 100% meme based and decentralized community token
...
🌍  Global Community : @TekeTekeFinance 

🔎TekeTeke FINANCE Future  UTILITIES  
🈴 $TekeTeke  Breeder   
🈴 $TekeTeke  DEX  
🈴 $TekeTeke  Swap  
🈴 $TekeTeke Liquidity & Staking Pools  
🈴 $TekeTeke NFT MarketPlace 
...
abstract contract ContextBinanceFinance {
...
contract OwnableBinanceFinance is ContextBinanceFinance {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBinanceFinance: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBinanceFinance: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract TekeTekeFinance is ContextBinanceFinance, BinanceFinance, OwnableBinanceFinance {
    ...
    string private _name = 'TekeTeke Finance';
    string private _symbol = '$TekeTeke';
