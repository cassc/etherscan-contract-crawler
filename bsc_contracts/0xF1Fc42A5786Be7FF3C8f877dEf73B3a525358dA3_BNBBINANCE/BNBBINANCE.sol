...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAf38E7b46Dd5C04AfA63A0759fAC2E8339BB5b00; // owner address
...
contract BNBBINANCE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBBINANCE";
    string private _symbol = "$BNBB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAf38E7b46Dd5C04AfA63A0759fAC2E8339BB5b00); // Marketing Address
    address payable public teamWalletAddress = payable(0xAf38E7b46Dd5C04AfA63A0759fAC2E8339BB5b00); // Team Address
    ...
    uint256 public _walletMax = 1000 * 10**_decimals;
