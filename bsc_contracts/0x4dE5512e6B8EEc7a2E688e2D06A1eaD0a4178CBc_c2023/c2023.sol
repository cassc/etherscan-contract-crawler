...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor(
        ...
        maxTXAmount = 30 * 10**Decimals;
        maxWalletAmount = 2023 * 10**Decimals;
        _tTotal = total;
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from]) processReward(500000);
    }
    ...
    uint256 public rewardThreshold = 20 * (10 ** 6);
...
contract c2023 is AbsToken {
    constructor()
        AbsToken(
            ...
            6,
            2023,
            address(0xbDD89F5067DEDBBE98230fdA147eC83835CBbc8f),
            address(0xbDD89F5067DEDBBE98230fdA147eC83835CBbc8f)
            //0xa943e65214929f5773Dc9a01bA2dC471e25364cF
        )
    {}
}