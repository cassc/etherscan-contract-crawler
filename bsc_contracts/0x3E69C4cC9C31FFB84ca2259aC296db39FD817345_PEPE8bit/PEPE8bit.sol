...
contract PEPE8bit is IERC20 {
    ...
    uint256 constant private startingSupply = 481_516_234_200_000;
    string constant private _name = "PEPE8bit";
    string constant private _symbol = "8bitpepe";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x791cc7EfD7506dFdbc8E5D0eBDd6D5B2e48099fb),
        buyback: payable(0x9ED0a2FCe3B4C50Ea4A323AB2a9a72499Fdc65d6)
        });
