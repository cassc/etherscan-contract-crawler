        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x712f923Bf2d555Ffc43C8eCD679bE266420cA654), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        1000000000,//Su
        address(0x712f923Bf2d555Ffc43C8eCD679bE266420cA654),//
        address(0x712f923Bf2d555Ffc43C8eCD679bE266420cA654)//
    ){
    }
}