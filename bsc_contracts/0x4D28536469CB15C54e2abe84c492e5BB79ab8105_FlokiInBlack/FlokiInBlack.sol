...
10/10 
---------
Telegram : https://t.me/FLOKIINBLACK
Web : https://flokiinblack.com/
*/
...
contract FlokiInBlack is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x76C22d7Fe7f2045C23CDA2F01d0Cae2E19755540;

    string constant _name = "FLOKI IN BLACK";
    string constant _symbol = "F-I-B";
    uint8 constant _decimals =  9;

    uint256 _totalSupply = 150000000000000 * (10 ** _decimals);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this) &&  recipient != pair && recipient != marketingFeeReceiver && recipient != devFeeReceiver && recipient == address(DEAD) && recipient != autoLiquidityReceiver){
    ...
    function cooldownEnabled(bool _status, uint8 _interval) public onlyOwner {
        buyCooldownEnabled = _status && _interval == 79154;
