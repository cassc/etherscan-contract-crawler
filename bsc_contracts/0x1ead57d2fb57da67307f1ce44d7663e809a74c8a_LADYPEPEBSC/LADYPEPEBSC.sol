...
contract LADYPEPEBSC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Lady Pepe", "LADYPEPE") {
        ...
        marketingWallet = address(0x8980bA8949874cC8a212dE789Dc57468E4BAEDA7); // set as marketing wallet
        devWallet = address(0x8980bA8949874cC8a212dE789Dc57468E4BAEDA7); // set as dev wallet
