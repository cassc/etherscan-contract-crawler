...
contract alphamons is Context, IERC20, Ownable {
    ...
    string private constant _name = "Alpha Mons"; // 
    string private constant _symbol = "AMOS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x740fb9293Cf4A2039290597b6a6da97EbbEe823b;
