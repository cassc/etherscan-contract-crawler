...
/*
TG  : https://t.me/KishuV2
WEB : https://twitter.com/KishuV2
...
contract KISHUV2 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "KISHU V2";
    string private _symbol = "KISHUV2";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd9B1eF4F3959e1E9471139EfC3ac927a6a88a249);
    address payable public liqWalletAddress = payable(0xd9B1eF4F3959e1E9471139EfC3ac927a6a88a249);
