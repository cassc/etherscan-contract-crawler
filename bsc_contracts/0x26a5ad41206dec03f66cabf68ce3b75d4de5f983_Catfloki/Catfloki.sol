...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x66D7351945AF166979272eA2E1363eF207e807F1 ; // owner address
...
contract Catfloki is Context, IERC20, Ownable {
    ...
    string private _name = "CATFLOKI";
    string private _symbol = "cloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x66D7351945AF166979272eA2E1363eF207e807F1); // Marketing Address
    address payable public teamWalletAddress = payable(0x66D7351945AF166979272eA2E1363eF207e807F1); // Team Address
