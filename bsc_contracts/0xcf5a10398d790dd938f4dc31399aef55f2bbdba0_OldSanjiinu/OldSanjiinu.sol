...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x19aD388eD5f1236985DD8b07e5E375f411393446; 
...
contract OldSanjiinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Old Sanji Inu";
    string private _symbol = "$OSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x19aD388eD5f1236985DD8b07e5E375f411393446); // 
    address payable public teamWalletAddress = payable(0x19aD388eD5f1236985DD8b07e5E375f411393446); // 
