...
contract ELONTOOLS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ETDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ELON TOOLS", "ET") {
        marketingWallet = payable(0xa81EfA2314dCA845eCBAab8A62160f857CadCc5e);
        devWallet = payable(0xE7972C5fDaBc4AcC7dbD21E71E8F4Ff7431239b2);
        ...
        dividendTracker = new ETDividendTracker(
            payable(this),
            router,
...
contract ETDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        ETContract = ELONTOOLS(mainContract);
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ETContract);

            uint256 prevBalance = ETContract.balanceOf(address(this));
            ...
            {
                uint256 received = ETContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ETContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
