...
contract NewCommunityAlphazilla is Context, IERC20, Ownable {
    ...
    string private _name = "New Community Alphazilla";
    string private _symbol = "nAlphazilla";
    ...
    address public ownerAddres = address(0xD41D94598B38beDce29BA324d7Ebe0cCAC695077);
    address public devAddress = address(0x8253F48b9572d39333839fF66fD31c1250500335);
    ...
    uint256 private numTokensSellToAddToLiquidity = 2000000000000000 * 10 **18;
