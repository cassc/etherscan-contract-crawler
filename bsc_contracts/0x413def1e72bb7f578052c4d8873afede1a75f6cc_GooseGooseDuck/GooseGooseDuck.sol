...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 8888000000000 * 10 ** Decimals;
        _tTotal = total;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xb71f2D75DbCA9dE2C8AE30Ce1C811a67dCe2a630;    
...
contract GooseGooseDuck   is AbsToken {
    constructor() AbsToken(
        ...
        address(0xb71f2D75DbCA9dE2C8AE30Ce1C811a67dCe2a630),  //
