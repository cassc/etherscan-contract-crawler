...
abstract contract Ownable is Context {
    ...
    constructor() {
        _owner = address(0xC82C5DFccF70eb50D7c786FDe663e601Ab6e53A3);
...
contract HaroldAi is Ownable, IBEP20 {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;

    uint256 public _decimals = 18;
    uint256 public _totalSupply = 420 * 10**9 * 10**_decimals;
    string private _name = "HaroldAi";
    string private _symbol = "$HRLD";

    address public immutable DeadWalletAddress =
        0x000000000000000000000000000000000000dEaD;
    address payable public MarketingWalletAddress =
        payable(0x9Bdf35a3e2903344e01d47A4F51f9840d1694fa3);
    address payable public DevelopmentWalletAddress =
        payable(0xa7F7d6280669e2D84DAdcB53a97d94ad1f00e931);

    uint256 internal _liquidityFee = 2;
    uint256 internal _DevelopmentFee = 1;
    uint256 internal _MarketingFee = 1;
    ...
    uint256 public numTokensSellToAddToLiquidity = 50 * 10**6 * 10**_decimals;
