...
// $ID Rewards!  Increase your $ID portfolio by simply holding.
// Based team!  LP locked!  CA verified!  Ownership renounced!
// Floki + Space ID = moontime, baby!
...
contract kryptofayv is Context, IERC20, Ownable {
    ...
    uint8 public maxWalletFee = 9;             // Transaction fee % that would be sent to a marketing or charity wallet (0-10)
    //change that
