...
contract WSBaby is Context, IERC20, Ownable {
 ...
 uint256 private constant _tTotal = 70 * (10**16) * (10**9);
 ...
 string private constant _name = "WSBaby";
 string private constant _symbol = "WSBaby";
 uint8 private constant _decimals = 9;

 address payable private _marketingAddress = payable(0xF4C27bd3d537cdEec1B6d358644F5791138de808);
 address payable private _marketing2Address = payable(0xF4C27bd3d537cdEec1B6d358644F5791138de808);
