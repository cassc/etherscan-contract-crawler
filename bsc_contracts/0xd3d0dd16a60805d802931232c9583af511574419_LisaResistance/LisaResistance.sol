...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1EADb60d98638FC72CdF20D5403c13FE12122Bc1; // owner address
...
contract LisaResistance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lisa Resistance";
    string private _symbol = "LISARES";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1EADb60d98638FC72CdF20D5403c13FE12122Bc1); // Marketing Address
    address payable private teamWalletAddress = payable(0x1EADb60d98638FC72CdF20D5403c13FE12122Bc1); // Team Address
