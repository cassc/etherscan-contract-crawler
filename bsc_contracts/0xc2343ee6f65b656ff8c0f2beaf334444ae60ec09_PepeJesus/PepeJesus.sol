...
contract PepeJesus is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Jesus", "PESUS")  {
        rewardToken = 0x55d398326f99059fF775485246999027B3197955;
        _marketingWalletAddress = 0xda3aF86B86Df8fF0804D68961489987A82c76aaC;
        ...
        uint256 totalSupply = 420000000000000* (10**18);
        swapTokensAtAmount = totalSupply.mul(2).div(10**6); // 0.002%

        // use by default 300,000 gas to process auto-claiming dividends
        gasForProcessing = 300000;

        _node = 0xda3aF86B86Df8fF0804D68961489987A82c76aaC;
        dividendTracker = new TokenDividendTracker(rewardToken, 50000000 * (10 ** 18));
