...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x114d9E201766A0B893D4b6eb3b689163b3a4aA3C; // owner address
...
contract one is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x114d9E201766A0B893D4b6eb3b689163b3a4aA3C); // Marketing Address
    address payable public teamWalletAddress = payable(0x114d9E201766A0B893D4b6eb3b689163b3a4aA3C); // Team Address
    ...
    uint256 public _maxTxAmount = _totalSupply * 4 / 100 * 10**_decimals; 
    uint256 public _walletMax = _totalSupply * 4 / 100 * 10**_decimals;
