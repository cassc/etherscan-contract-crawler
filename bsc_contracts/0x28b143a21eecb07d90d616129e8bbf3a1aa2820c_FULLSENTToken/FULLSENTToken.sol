...
contract FULLSENTToken is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xc930A9cc8F065b877D84013edd1b97a9585cceb4);

    string public _name = "FULLSENT";
    string public _symbol = "FULLSENT";
