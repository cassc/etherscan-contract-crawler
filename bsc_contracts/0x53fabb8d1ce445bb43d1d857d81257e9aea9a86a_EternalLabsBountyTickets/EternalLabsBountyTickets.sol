...
/**
 * @title EternalLabsBountyTickets
 * @author : saad sarwar
 */
...
contract EternalLabsBountyTickets is Ownable , ERC721 {
    ...
    constructor() ERC721("BountyTickets", "BT") {}
    ...
    function mint(address to) public payable {
        uint price = ticketPrice();
        require(msg.value >= price, "EL: Not enough balance");
        require((TOKEN_ID + 1) <= MAX_SUPPLY, "EL: Purchase would exceed max supply");
    ...
    function safeTransfer(address _recipient, uint _amount) private {
        ...
        require(_success, "EL: BNB Transfer failed.");
    }
