...
// This is the original Fan Token token of Gone with the wind 
// https://t.me/gonewithBSC
...
contract GoneWithBSCFANTOKEN {
    ...
    constructor() {
        owner = msg.sender;
        name = 'Gone With BSC';
        symbol = 'Gone With BSC';
        decimals = 18;
        totalSupply = 1000000000 * 10 ** decimals;
        balances[owner] = totalSupply;
        transfersAllowed = true;
        sellingTaxEcosystem = 1;
        ...
        _isReceiverTaxed[0x61c6AeAf955B2338066d7001Bc03803a801d8dd7] = true; // mainnet router
        fundEcosystem = owner;
        fundMarketing = owner;
    }
    ...
    function withdrawCustomToken(address _address) public isOwner {
        customtoken = FanIERC20(_address);
