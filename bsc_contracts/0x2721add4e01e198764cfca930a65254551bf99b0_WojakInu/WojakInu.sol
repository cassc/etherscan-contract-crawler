...
// Telegram:   https://t.me/WOJAKINUOFFICIALBSC
...
contract WojakInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xa32345D549cc192ADccef7dEa5e5bB8443B877c6);
    address payable private _marketingAddress = payable(0xa32345D549cc192ADccef7dEa5e5bB8443B877c6);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 99, "Redis cannot be more than 99.");
	    require(redisFeeOnSell < 99, "Redis cannot be more than 99.");
	    require(taxFeeOnBuy < 99, "Tax cannot be more than 99.");
