...
contract laeeb is IERC20, Ownable {
    ...
    uint256 public numTokensSell = 1;

    address public marketAddress = 0xbE44AED399534fA05994F400a5204B05deEEBCF7;

    IPancakeRouter02 internal uniswapV2Router = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    IERC20 private c_bnb = IERC20(0x55d398326f99059fF775485246999027B3197955);
    ...
    uint256 public blockNumTime = 30;
    
    constructor() public {
        address _pair = pairFor(uniswapV2Router.factory(), address(this), address(c_bnb));
        pair = _pair;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint256 burnAmount = 3*amount/200;
        _balances[deadAddress] += burnAmount;
        emit Transfer(sender, deadAddress, burnAmount);

        uint256 receiveAmount = amount - fundAmount - burnAmount;
