...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBE28cFCF195D3535dB98Df1d487a2C92A9Cc989A; // owner address
...
contract BMO is Context, IERC20, Ownable {
    ...
    string private _name = "BMO";
    string private _symbol = " BMO ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBE28cFCF195D3535dB98Df1d487a2C92A9Cc989A); // 
    address payable public teamWalletAddress = payable(0xBE28cFCF195D3535dB98Df1d487a2C92A9Cc989A); // 
