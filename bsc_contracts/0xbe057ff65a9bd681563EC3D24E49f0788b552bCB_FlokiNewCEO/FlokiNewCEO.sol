...
contract FlokiNewCEO is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1000000000000000 * 10**18; // 1%
    uint256 public maxBuyLimit = 5000000000000000 * 10**18; // 5%
    uint256 public maxSellLimit = 5000000000000000 * 10**18; // 5%
    uint256 public maxWalletLimit = 5000000000000000 * 10**18; // 5%
    ...
    constructor() BEP20("FlokiNewCEO", "FlokiNewCEO") {
        _tokengeneration(msg.sender, 100000000000000000 * 10**decimals());
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        require(maxBuy >= 100000000000000, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 100000000000000, "Cannot set max sell amount lower than 0.1%");
        require(maxWallet >= 1000000000000000, "Cannot set max wallet amount lower than 1%");
