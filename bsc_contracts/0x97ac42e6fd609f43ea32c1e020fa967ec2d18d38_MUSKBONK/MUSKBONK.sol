...
contract MUSKBONK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MUSK-BONK";
    string private _symbol = "MUSKBONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x92577CB6c429BB36909e7c22d1E293F3B7Ea6A7A); // 
    address payable public teamWalletAddress = payable(0x92577CB6c429BB36909e7c22d1E293F3B7Ea6A7A); // 
