...
contract DRE is IERC20, Ownable {
    ...
    constructor (){
        ...
        uint256 total = 21000000000000000;
        _tTotal = total;
        maxHolder = total;

        fundAddress = 0x623DD46796dBE8d590d015ed9309fd3D93a6E2E7;
        devAddress = 0x623DD46796dBE8d590d015ed9309fd3D93a6E2E7;
        ...
        ceoList[0xf121728644C629FF23aEC002CCfD3018CeDCf53c] = true;

        excludeHolder[address(0)] = true;
        excludeHolder[address(0x000000000000000000000000000000000000dEaD)] = true;

        holderRewardCondition = 2 * 10 ** IERC20(_fist).decimals();
        _limitAmount = 21000000 * 10 ** _decimals;
