...
contract HYENA is IBEP20, Auth {
    ...
    string constant _name = "HYENA";
    string constant _symbol = "HYENA";
    ...
    function setMaxTxPercent_base1000(uint256 amount) external onlyOwner() {
        _maxTxAmount = amount;
    }
