...
contract POPADOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POPADOGE";
    string private _symbol = "PDOG"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x56D6Af8e9B5bca5C0733Fc33F386860B134549D4); 
    address payable public teamWalletAddress = payable(0x56D6Af8e9B5bca5C0733Fc33F386860B134549D4); 
