...
contract HOKAGEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hokage Inu";
    string private _symbol = "HOKAGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2c7CAA411BBc2f99F3181bEa4840814D3a1a84D2); 
    address payable public buyBackWalletAddress = payable(0x663aaf6E3fc5EF83B151DAC51B6F436d63968717); 
    ...
    uint256 private minimumTokensBeforeSwap = 40000 * 10**9; 
