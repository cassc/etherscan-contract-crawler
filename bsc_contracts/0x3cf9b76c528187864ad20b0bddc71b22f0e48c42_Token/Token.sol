...
contract Token is ERC20 {				
    ...
    uint256 public destroyFee = 7;				
	address private _destroyAddress = address(0xd64804540607098f67Fab2ce16A25741A707d6b1);			
    mapping(address => bool) private _isExcludedFromFees;				
    mapping(address => bool) private _isExcludedFromVipFees;				
    mapping(address => bool) public automatedMarketMakerPairs;				
    bool public swapAndLiquifyEnabled = true;				
    uint256 public start;				
    uint256 public time = 7200;				
    uint256 public maxbuy = 1000000000000 * 10**18;				
				
				
    constructor(address tokenOwner) ERC20("DOGEKO", "DOGEKO") {				
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);				
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())				
        .createPair(address(this), address(_baseToken));				
		uint256 total = 1000000000000000 * 10**18;		
    ...
    function _transfer(				
        ...
        if(start != 0 && block.timestamp >= start && block.timestamp <= start + time){				
        ...
        if (takeFee) {				
			super._transfer(from, address(this), amount.div(100).mul(destroyFee));	
			amount = amount.div(100).mul(100-destroyFee);	
        }				
        super._transfer(from, to, amount);				
    }				
