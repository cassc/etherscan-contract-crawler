...
/**
    TG: https://t.me/PepiSimpson
    Twitter: https://twitter.com/PepiSimpson
*/
...
contract PEPI is ERC20, Ownable {
    ...
    constructor() ERC20("Pepi The Simpson", unicode"PEPI") {
        ...
        uint256 totalSupply = 420690 * 1e11 * 1e9;

        maxTransactionAmount = 420690 * 1e9 * 1e9;
        maxWallet = 420690 * 1e9 * 1e9 * 3;
        swapTokensAtAmount = 420690 * 1e8 * 1e9 * 3;
        ...
        devWallet = address(0xD9F3c233B5843D88498B183C1Ed6839449D904b1); 
        teamWallet = address(0x109948F33C0CC7fFe40E4a66d29cC194777431F8);
