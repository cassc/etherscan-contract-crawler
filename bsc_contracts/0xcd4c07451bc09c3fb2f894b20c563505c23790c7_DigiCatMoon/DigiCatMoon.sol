...
contract DigiCatMoon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 4200000000 * 10**9;
    uint256 public _maxTxAmount = 4200000000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = " Digi CatMoon "; // 
    string private constant _symbol = " $DCM "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xB0850B696c0945501C0f6156DDF378dab9ee8D73;
