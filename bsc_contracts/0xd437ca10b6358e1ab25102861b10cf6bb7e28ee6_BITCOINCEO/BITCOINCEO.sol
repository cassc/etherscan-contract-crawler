...
contract BITCOINCEO is IBEP20, Auth {
    
    using SafeMath for uint256;

    string public constant _name = "BITCOIN CEO";
    string public constant _symbol = "$CEO";
    uint8 public constant _decimals = 18;

    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    address private routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public RewardToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c;
    ...
    uint256 public swapThreshold = _totalSupply * 30 / 2000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x599C781246ACE25045b5Cc16aE2472E6E682EcC6; 
        devWallet = 0x599C781246ACE25045b5Cc16aE2472E6E682EcC6; 
