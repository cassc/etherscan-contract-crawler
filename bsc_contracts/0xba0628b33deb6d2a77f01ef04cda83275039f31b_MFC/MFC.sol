...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Dividend = IBEP20(0x2859e4544C4bB03966803b044A93563Bd2D0DD4D); 
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            Distributor = 0x5E73C4553C0030a9B32ceaF063196342Ff58E74A;
        _token = msg.sender;
    }
...
contract MFC is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xaDf993B1de701BBdF4b7e60CBA7aE666EDF8df44;
    address DevWallet       = 0xaDf993B1de701BBdF4b7e60CBA7aE666EDF8df44;

    string constant _name = "MINI FLOKI CEO";
    string constant _symbol = "MFC";
    ...
    address PAIR = 0xaDf993B1de701BBdF4b7e60CBA7aE666EDF8df44;
