...
contract KaKing is Context, IERC20, Ownable {
    ...
    address public  DividendToken = 0x42414624C55A9CBa80789f47c8F9828A7974e40f;
    ...
    uint256 internal _awardShare = 6;
    uint256 internal _reflectionShare = 3;

    uint256 public _total = 10;
    uint256 internal _totalDistributionShares = 10;

    uint256 public buyTokenRewardsFee = 6;
    uint256 public sellTokenRewardsFee = 6;
    uint256 public buyLiquidityFees = 1;
    uint256 public sellLiquidityFees = 1;
    uint256 public buyDeadFee = 0;
    uint256 public sellDeadFee = 0;
    uint256 public getNumberOfDividendTokenHolders = 50000000000;
    ...
    function setDividendByNum(bool newValue) public PancakeRouter {
