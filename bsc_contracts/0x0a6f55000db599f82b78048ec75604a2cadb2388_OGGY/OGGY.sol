...
contract OGGY is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x7dc4015294AD53c74103699c4e84cAF196CD7216); 
    address payable public Wallet_Dev = payable(0xfa79FD53f6a3680f040cC1F026b62a24a7Df42df);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000000 * 10**1* 10**1 * 10**_decimals;
    string private constant _name = "OGGY COIN"; 
    string private constant _symbol = unicode"OGGY"; 
    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 
    uint256 public _Tax_On_Buy = 9;
    uint256 public _Tax_On_Sell = 9;
    uint256 public Percent_Marketing = 94;
    ...
    constructor () {
        _owner =0xfa79FD53f6a3680f040cC1F026b62a24a7Df42df;
