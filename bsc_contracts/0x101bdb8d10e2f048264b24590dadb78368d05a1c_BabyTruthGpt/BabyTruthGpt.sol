...
/**
 *Telegram:https://t.me/babytruthgptofficial
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2abDB5903171071ac29cC0779d7EFDF0FaF14228);
    IDEXRouter router;
...
contract BabyTruthGpt is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby TruthGPT";
    string constant _symbol = "$BABYTRUTH";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 10 * 10**10 * 1**_decimals;
    ...
    uint256 private DevelopmentFee  = 17;
    uint256 private buybackFee      = 0;
    uint256 private burnFee         = 0;
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + DevelopmentFee + burnFee + buybackFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xDbf8240F6913b4A538b4461D2d53390503605e50;
        DevelopmentFeeReceiver = 0xDbf8240F6913b4A538b4461D2d53390503605e50;
        buybackFeeReceiver = 0xDbf8240F6913b4A538b4461D2d53390503605e50;
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(DevelopmentFeeReceiver).call{value: amountBNBTeam, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _DevelopmentFee, uint256 _buybackFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        burnFee = _burnFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _DevelopmentFee + _burnFee + _buybackFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _DevelopmentFeeReceiver, address _burnFeeReceiver, address _buybackFeeReceiver ) external authorized {
