...
contract newalveychain is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "new alvey chain";
    string constant _symbol = "WALV";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =0x0a8d4dAdd84ddcb26FA0A5Ca7b8e816A790D16eC;
