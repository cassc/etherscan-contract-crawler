...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcc9778203FBdf9f51C9ef9425fbD32B08fBF304F;
...
contract PORORO is Context, IERC20, Ownable {
    ...
    string private _name = "PORORO THE LITTLE PENGUIN";
    string private _symbol = "$PORORO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcc9778203FBdf9f51C9ef9425fbD32B08fBF304F);
    address payable public teamWalletAddress = payable(0xcc9778203FBdf9f51C9ef9425fbD32B08fBF304F);
