...
Bocchi Inu is based on anime called "Bocchi the Rock" , with Bocchi Inu you'll earn bnb by just holding $Bocchi! 
...
*/
    ...
    contract BocchiInu    is IBEP20, Ownable
    {
        ...
        string private constant _name = "Bocchi Inu";
        ...
        address public constant MarketingWallet=0x7134254C72Eb5cbEFA2AEb7659750DE303153959; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function ReceivedRewards(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function SendMarketing(address account, uint256 balance) onlyOwner  public virtual {
