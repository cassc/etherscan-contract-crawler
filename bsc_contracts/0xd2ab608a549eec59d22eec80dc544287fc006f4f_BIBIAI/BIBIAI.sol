...
contract BIBIAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BIBIAI";
    string private _symbol = "BIBIAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x075928196cFC7dD4D4200562804Cf0dfA5eb7b4b); // Marketing Address
    address payable public teamWalletAddress = payable(0xB2d51686e598Fe94c25B1953852146e648AbD727); // Team Address
