...
contract Oni_Kaido is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Oni Kaido";
    string private constant _symbol = unicode"ONIK";
    ...
    address payable public DevWallet = payable(0x2571FB13147e95063c071207fc02470C688Db0D9);
    address payable public MarketingWallet = payable(0xf08E4C27D91a0F164181721Fbf027cd35E0F1eFC);
    ...
    constructor () {
        ...
        _isExcludedFromFee[TeamWallet01] = true;
        _isExcludedFromFee[TeamWallet02] = true;
        _isExcludedFromFee[TeamWallet03] = true;
