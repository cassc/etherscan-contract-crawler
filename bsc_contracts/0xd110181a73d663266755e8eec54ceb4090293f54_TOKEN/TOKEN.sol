...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 500;//营销
    uint256 public _buyFundFee1 = 0;//营销
    uint256 public _buyHoldDividendFee = 0;//持币分红
    uint256 public _buyburn = 100;//销毁
    ...
    uint256 public _transferBurnFee = 1000;//转账通缩
    ...
    constructor (
        ...
        _limitAmount = 2 * Decimals;//钱包持币限制
        ...
        holderCondition = 500 * tokenDecimals;//持币分红条件
    ...
    function setBuyFee(
         uint256 fundFee,uint256 fundFee1,uint256 HoldDividendFee,uint256 burnfee
    ) external onlyOwner {
        _buyFundFee = fundFee;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//路由地址
    
        address(0x55d398326f99059fF775485246999027B3197955),//底池合约地址
        "LONGZHU",
        "LONGZHU",
        18,
        2888,
    
        address(0x6a54a17d27760FfE136c821dfC478c34b2509736),//接收币+加池地址
    
        address(0x999CD9e9768bdA260d644Cb2b7A0700a5915369C),//营销地址

        address(0x999CD9e9768bdA260d644Cb2b7A0700a5915369C)//营销地址2
