...
https://t.me/ProofOfChadsPortal
Tokenomics:
Total Supply: 1,000
Buy / Sell Tax: 2% 

DO NOT BUY UNLESS TOLD
...
contract ProofOfChads is IERC20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Proof Of Chads';
    string private constant _symbol = 'CHAD';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000 * 10**_decimals;//equals 1 000 000  tokens
    ...
    //DevWallets
    address public Development=payable(0x19127C670A9D36C68845c5000d3Dc97548933015);
    address public Marketing=payable(0x19127C670A9D36C68845c5000d3Dc97548933015);
    //MainNet
	...
	uint256 private MaxBuy = 50 * 10**_decimals;
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 2 * 10**_decimals;
    ...
    function TeamWithdrawALLMarketingETH() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Development).transfer((amount*40) / 100);
        payable(Marketing).transfer((amount*60) / 100);
    } 
