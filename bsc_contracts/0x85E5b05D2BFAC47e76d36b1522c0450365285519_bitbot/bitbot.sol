...
contract bitbot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bit Bot";
    string private _symbol = "BIT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf7452B29C1cF892496894C7069549d2c0a646AB3);
    address payable public teamWalletAddress = payable(0xf7452B29C1cF892496894C7069549d2c0a646AB3);
