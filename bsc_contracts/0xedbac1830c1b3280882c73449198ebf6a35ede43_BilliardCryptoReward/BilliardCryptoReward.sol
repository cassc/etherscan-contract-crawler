...
contract BilliardCryptoReward is ERC20, Ownable {
    ...
    address public marketingWallet = 0xf8eE4C93CafCA95b39572965b24573D55C8011b8;
    ...
    constructor() ERC20("Billiard Crypto Reward", "BICR") {
        _tokengeneration(msg.sender, 0);
        ...
        exemptFee[0xA7618C49B0C419969F012B3e44a6DA9281744cc3] = true;
        exemptFee[0x6E545E05C71a76d43614E25260a2e062363587E6] = true;
