...
contract CHASA  is Context, IERC20 { 
    ...
    function removeMaxLimit() public virtual {
    ...
    address payable public Wallet_Marketing = payable(0xFF08f6835323E618F9081628008Da218ae50EBeD); 
    address payable public Wallet_Dev = payable(0xFF08f6835323E618F9081628008Da218ae50EBeD);
    ...
    string private constant _name = "CHASA INU"; 
    string private constant _symbol = "CHASA"; 
    ...
    constructor () {
        ...
        _owner = 0xFF08f6835323E618F9081628008Da218ae50EBeD;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*_buyFee/100;
            ...
            uint256 sellFEE = tAmount*_sellFee/100;
