...
/**
    DAOchain 是世界上最快的加密区块系统

    DAOchain Token 是一个去中心化的 BEP20 社区驱动的代币。
    我们首次将独特的推力系统代码部署在币安智能链上，将硬编码到我们合约中的被动功能收入提升到最高水平，直到达到阈值。
*/
...
contract DAOchain is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x30035c8771AcEE7F55072a90e38442d60b196dfa);
    address payable public teamWalletAddress = payable(0xf9C5Ba72A11A004325b4c90fBb70d7e9018b3718);
    ...
    string private _name = "DAOchain";
    string private _symbol = "DAOchain";
