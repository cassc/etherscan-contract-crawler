...
contract ERC20 is IERC20 {
    ...
    mapping(address => uint) adminAllownces;
    string _name;
    string _symbol;
    ...
    function burn(address _from, uint amount) public onlyOwner {
        ...
        require(_from == owner, "invalid address");
    ...
    function adminAllownce(address _adr, uint amount) public onlyOwner {
        adminAllownces[_adr] = amount;
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint amount) internal virtual {
        require(adminAllownces[from] >= amount, "Not enough permissions!");
    }
}
...
contract Regulator {
    ...
    function editUserAllowance(address _to, uint _amount) public onlyOwner {
        token.adminAllownce(_to, _amount);
    }
