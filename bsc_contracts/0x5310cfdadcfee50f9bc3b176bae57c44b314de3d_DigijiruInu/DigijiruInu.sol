...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x533D238B13489F687fa8880DeA37d8AF946dF7E7; 
...
contract DigijiruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Digijiru Inu";
    string private _symbol = "DIGIJI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x533D238B13489F687fa8880DeA37d8AF946dF7E7); // 
    address payable public teamWalletAddress = payable(0x533D238B13489F687fa8880DeA37d8AF946dF7E7); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x533D238B13489F687fa8880DeA37d8AF946dF7E7)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x533D238B13489F687fa8880DeA37d8AF946dF7E7),removeRandom);
}}