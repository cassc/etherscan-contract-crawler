...
contract SKYNET is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public _totalSupply = 5_000_000_000 * (10**18);
    ...
    address payable public _marketingWalletAddress = payable(0x789EA32De56E7aC44C2F3D5EffAE755D09edF601);
    address payable public _buybackWalletAddress = payable(0x0137974F4E8467a65f1bdFA46BB6Ce77Ef67786e);
    ...
    constructor() BEP20("SKYNET", "SKYNET") 
    {
