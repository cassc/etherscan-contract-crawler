...
contract FlokiFireToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiFire Token";
    string private constant _symbol = "FFT";
