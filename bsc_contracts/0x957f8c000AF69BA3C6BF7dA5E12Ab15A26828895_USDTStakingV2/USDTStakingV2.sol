...
contract USDTStakingV2 is Ownable, ReentrancyGuard {
    //test
    address public usdtAddress =
        address(0x55d398326f99059fF775485246999027B3197955); //busd 0xD6055D2543BB3A5e60ca7b40c7c369B55e337098
    ...
    constructor() {
        plans[1] = plan(true, 30, 1000, 100, rewardAddress);
        plans[2] = plan(true, 70, 1000, 200, rewardAddress);
        plans[3] = plan(true, 120, 1000, 300, rewardAddress);
    }
    ...
    function withdrawlUSDT(uint256 amount) public onlyOwner {
        require(
            IERC20(usdtAddress).transfer(msg.sender, amount * 1e18),
