...
contract LendBorrowLendStrategy is LogicUpgradeable {
    ...
    mapping(address => uint8) private avoidLiquidationFactorTokens;
     ...
     */
    function setCirclesCount(uint8 _circlesCount, address _token) external onlyOwner {
     ...
     * @param _token token address
     */
    function setAvoidLiquidationFactor(uint8 _factor, address _token) external onlyOwner {
     ...
     * @param token token address
     * @param minimumBLIDPerRewardToken min BLID amount per rewardsToken
     */
