...
/**
LUNANAS
🍌$LUNANAS🍌 Ultimate backed by influencers Token ! 10 Youtubers 🖥 ,
10+ Twitter, 10+TG Partners Onboarded 📝! 
Hyper-Deflationary Limited Supply 1 Million burning 2% on Trades. 
Expect powerful 🌙MOONSHOT🌙! Luna Classic to Explode with Binance Burn in Time for Launch 
- Accumulate 5% LUNC Rewards! Casino with Daily Lottery and Scratchcards Huge Jackpots!
🎁Staking! All at Launch! 🦍 Lunape Ecosystem🦍SAFU✅️CMC✅️ BNB Bonus 
- (SAFU 1 Month Cliff)🟢0-400: 17.5% 🟢401-800:15% 🟢801- 1200:12.5% 🟢 1201+ 10%
*/
...
contract LUNANAS is LUNANASDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private LUNANASTeam;
    address private CharityLUNANAS;
    ...
    string public override name = "LUNANAS";
    string public override symbol = "$LUNANAS";
    ...
    constructor(uint totalSupplyValue, address LUNANASTeamAddress, address CharityLUNANASAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        LUNANASTeam = LUNANASTeamAddress;
        CharityLUNANAS = CharityLUNANASAddress;
        
        // split the tokens according to agreed upon percentages
        balances[LUNANASTeam] =  totalSupply * 5 / 100;
        balances[CharityLUNANAS] = totalSupply * 15 / 100;
        
        balances[_owner] = totalSupply * 82 / 100;
    }
    ...
    // Get the address of the token's LUNANASTeam pot
