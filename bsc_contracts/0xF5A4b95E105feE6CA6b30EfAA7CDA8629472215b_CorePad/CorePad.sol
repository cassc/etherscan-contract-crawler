...
/**
 * Website https://corepad.finance/
 * Telegram https://t.me/corepadglobal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C7849B97c6341879535afB7cFbEdC2CcB7BedF2; // owner address
...
contract CorePad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CorePad";
    string private _symbol = "COREPAD";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x01096043143d0b5DBab77b5ffc950ca93baD95Af); // Marketing Address
    address payable public teamWalletAddress = payable(0xd09C064B25cA8F70411e6b4603034F991cb8fD70); // Team Address
    ...
    constructor () {
        ...
        _allowances[address(uniswapPair)][address(msg.sender)] = _totalSupply;
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        ...
        require(_buyLiquidityFee.add(_buyMarketingFee).add(_buyTeamFee) <= 8 , "MAX FEE");
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyTeamFee);
    }
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        ...
        require(_sellLiquidityFee.add(_sellMarketingFee).add(_sellTeamFee) <= 8 , "MAX FEE");
