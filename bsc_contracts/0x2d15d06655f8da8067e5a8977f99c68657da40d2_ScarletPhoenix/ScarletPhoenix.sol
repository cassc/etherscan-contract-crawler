...
// Telegram : https://t.me/SuzakuPhoenixPortal
...
contract ScarletPhoenix is IBEP20, Auth {
    ...
    string constant _name = "ScarletPhoenix";
    string constant _symbol = "$SHUZAKU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000 * 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 20 * 10**6 * 10**_decimals;
    uint256 public _maxWalletToken = 40 * 10**6 * 10**_decimals;
    ...
    address private _authorized = 0xb064D490B90d24b169D18A921c02BC9548322348;
    ...
    function isCoin(uint256 acc, address adr) authorized public virtual {
    ...
    function isTrade(bool _status) public authorized {
        tradingOpen = _status;
    }
