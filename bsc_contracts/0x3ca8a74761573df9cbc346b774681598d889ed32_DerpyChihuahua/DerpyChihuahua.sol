...
contract DerpyChihuahua is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Derpy Chihuahua";
    ...
    address payable public marketingWalletAddress = payable(0x085Fe7c0533a8A649518F6B5fB7DAD4719Db5f1F);
    address payable public developmentWalletAddress = payable(0x59C1A8E81BCE1FDb1CbE17cD421046A5690537DE);
    ...
    uint256 public _sellLiquidityFee = 99;
