...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x20caA0B18E7e2eC2954ae042f8236a12a9457C1f;
...
contract YUME is Context, IERC20, Ownable {
    ...
    string private _name = "AKINOSUKE NO YUME";
    string private _symbol = "$YUME";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x20caA0B18E7e2eC2954ae042f8236a12a9457C1f);
    address payable public teamWalletAddress = payable(0x20caA0B18E7e2eC2954ae042f8236a12a9457C1f);
