...
contract TreasuryManager is Initializable, OwnableUpgradeable {
    ...
    function updateTreasuryFees(uint256 _treasuryFees) external onlyOwner {
        require(
            _treasuryFees > 0 && _treasuryFees <= 6,
            "Must keep fees between 0 and 6"
        );
    ...
    function mintTokens() public {
        moleculeContract = IMolecule(
            0xF7493Ea1fa2789509Dde39f90aDfAC85fe453240
        );

        moleculeContract.treasuryRewardHolder(
            0x1C61f197514bDe4f59b6Eb64e0aF62B3C4F9Df68,
