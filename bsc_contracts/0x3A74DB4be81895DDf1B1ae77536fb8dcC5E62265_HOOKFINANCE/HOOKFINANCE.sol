...
Telegram: https://t.me/Hook_Finance
...
pragma solidity ^0.6.12;
    ...
    contract HOOKFINANCE is Context, IERC20, Ownable {
        ...
        mapping (address => bool) public Bot_Blacklisted;
        ...
        string private _name = 'HOOK FINANCE';
        string private _symbol = 'HOOK';

        address payable public Hook_Wallet_Stake;
        ...
        constructor (address payable MarketingWalletAddress) public {
            Hook_Wallet_Stake = MarketingWalletAddress;
            ...
            _isExcludedFromFee[Hook_Wallet_Stake] = true;
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0xb954c77d88F49b4ad4299C379c8A902031979a35, 'We can not exclude Uniswap router.');
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            require(!Bot_Blacklisted[sender] && !Bot_Blacklisted[recipient], "This address is blacklisted");
        ...
        function sendETHToMarketing(uint256 amount) private {
            Hook_Wallet_Stake.transfer(amount.mul(3).div(8));
        ...
        function _getETHBalance() private view returns(uint256 balance) {
