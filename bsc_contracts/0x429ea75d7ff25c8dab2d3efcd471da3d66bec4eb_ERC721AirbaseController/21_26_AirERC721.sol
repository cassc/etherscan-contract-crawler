...
interface IAirERC721 is IERC721, IERC721Metadata {
...
contract AirERC721 is Ownable, ERC165, IAirERC721 {
  ...
  modifier onlyTransferable() {
    require(_transferable, "ERC721: must transferable");
    _;
  }
  ...
  function burn(address account, uint256 tokenId) external override onlyMinter {
    ...
    require(account == owner, "ERC721: invalid owner");
  ...
  function _transfer(
    ...
    require(
      AirERC721.ownerOf(tokenId) == from,
