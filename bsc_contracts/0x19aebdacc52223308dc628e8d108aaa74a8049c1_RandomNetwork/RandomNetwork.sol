...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5A94A54353d382EA1E0BE7Fbf88DE29AfEf4f864; // owner address
...
contract RandomNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RandomNetwork";
    string private _symbol = "$RW";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5A94A54353d382EA1E0BE7Fbf88DE29AfEf4f864); // Marketing Address
    address payable private teamWalletAddress = payable(0x5A94A54353d382EA1E0BE7Fbf88DE29AfEf4f864); // Team Address
