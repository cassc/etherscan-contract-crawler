...
contract $AABB is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 142017000 * 10**0 * 10**9;
    ...
    uint256 private _maxHavAmount = 200 * 10**9;

    uint256 private _redisFeeOnBuy = 40;
    ...
    string private constant _name = "AABB";

    string private constant _symbol = "AABB";

    uint8 private constant _decimals = 9;

    address payable private _developmentAddress = payable(0x64f002f004D762E831656275D413a55F8bE667d7);

    address payable private _marketingAddress = payable(0xD3d29de98916c0Ab8A0bE995971729002a66eD82);
