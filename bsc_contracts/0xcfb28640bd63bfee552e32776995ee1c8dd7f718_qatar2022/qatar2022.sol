...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25884fF8EFCCc0B7be1A75058188d284046F34bD; // owner address
...
contract qatar2022 is Context, IERC20, Ownable {
    ...
    string private _symbol = "OGQ2022";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x25884fF8EFCCc0B7be1A75058188d284046F34bD); // Marketing Address
    address payable public teamWalletAddress = payable(0x25884fF8EFCCc0B7be1A75058188d284046F34bD); // Team Address
