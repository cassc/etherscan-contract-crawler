...
contract BILLY is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xfD92C50259AB7d862c5c1b884736c354e2be2DEF;
    address public devAddress = 0xfD92C50259AB7d862c5c1b884736c354e2be2DEF;
    string private constant _name = "Billy";
    ...
    Taxes public taxes = Taxes(5,4,5,5);
    Taxes public sellTaxes = Taxes(5,2,7,8);
