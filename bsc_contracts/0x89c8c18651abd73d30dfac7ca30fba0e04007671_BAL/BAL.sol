...
contract BAL is Context, IERC20, Ownable {
    ...
    string private constant _name = "A.I";
    string private constant _symbol = "BALENCIAGA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xB1a3BefBF671016e8713BB2eB8b79955CB2915d4);
    address payable private _marketingAddress = payable(0xB1a3BefBF671016e8713BB2eB8b79955CB2915d4);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 100, "Tax");
	    require(redisFeeOnSell < 100, "Tax");
	    require(taxFeeOnBuy < 100, "Tax");
	    require(taxFeeOnSell < 100, "Tax");
