...
contract BABYOKX is Context, IERC20, Ownable {
    ...
    string private _name = "queai";
    string private _symbol = "queai";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0xfDdC074d1A7437140B6f14388415088B4E56DA86));
    address _tokenOwner;
