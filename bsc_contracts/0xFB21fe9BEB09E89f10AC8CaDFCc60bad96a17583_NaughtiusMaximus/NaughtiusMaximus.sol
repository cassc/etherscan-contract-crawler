...
contract Ownable is Context {
    address private _owner = 0x16917f616614dC3a8596cD4D069112D8564E5608;
...
contract NaughtiusMaximus is Context, IBEP20, Ownable { 
    ...
    address payable public _marketingAddress = payable(0x6D11AdAEfe79F76CA53dd222cd992B294a2a443c); // Marketing Address
    ...
    string private _symbol = "Naughtius Maximus";
    ...
    uint256 public _marketingBNBFee =40; 
    ...
    uint256 public _minTokensSwapToAndTransferTo = 3 * 10**6 * 10**_decimals; 
