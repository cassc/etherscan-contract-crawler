...
contract PEPECOMMUNITYTOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 120000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 300000000 * 10**_decimals;
    
    uint256 public maxSellAmount = 120000000000 * 10**_decimals;
    uint256 public maxBuyAmount = 120000000000 * 10**_decimals;
    uint256 public maxWalletBalance = 120000000000 * 10**_decimals;

    address public marketingAddress = 0x7Eb017fA8d189f0BA2e19B971cc96CB692E46B1F;
    address public devAddress = 0xfc99069ab405C5614e443F384013822569238548;

    string private constant _name = "PEPE COMMUNITY TOKEN";
    ...
    function excludeFromFee(address account) public  {
        require(msg.sender == mkt, "operator only");
