        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xc0ce702c82dd38f42bF526b563A2aAbB4Eb294bA), block.timestamp
                );
            }
        }
    }
...
contract BABYPi is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000000,
        address(0xc0ce702c82dd38f42bF526b563A2aAbB4Eb294bA),
        address(0xc0ce702c82dd38f42bF526b563A2aAbB4Eb294bA)
    ){
    }
}