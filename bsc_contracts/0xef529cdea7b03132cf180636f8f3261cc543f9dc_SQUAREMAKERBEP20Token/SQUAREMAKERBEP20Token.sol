...
contract SQUAREMAKERBEP20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("SQUARE MAKER", "SKER", 18) 
    ERC20Permit("SQUARE MAKER") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 12000000000000000000000000); 
