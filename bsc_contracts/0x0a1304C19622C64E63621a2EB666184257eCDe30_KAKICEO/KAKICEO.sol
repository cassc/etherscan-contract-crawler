...
contract KAKICEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KAKICEO";
    string private _symbol = "KAKICEO";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x2e8a244A71507FC4B47dDE3198AC9b2fA8F4Ad7E); 
    address payable private teamWalletAddress = payable(0x2e8a244A71507FC4B47dDE3198AC9b2fA8F4Ad7E); 
