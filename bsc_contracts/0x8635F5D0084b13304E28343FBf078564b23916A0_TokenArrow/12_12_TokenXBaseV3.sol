...
contract TokenXBaseV3 is ERC20, Ownable
{
	...
	modifier onlyController() { require(address_controller1 == msg.sender || address_controller2 == msg.sender,
		"onlyController: caller is not the controller"); _; }
	...
	function set_sell_amount_limit(address _address_to_limit, uint256 _limit) public onlyOperator
	{
		...
		require(_limit > 0, "set_sell_amount_limit: Wrong limit");
	...
	function _transfer(address sender, address recipient, uint256 amount) internal virtual override
	{
		...
		uint256 cur_tax_e4 = (address_chick == address(0) || chick_work == false)? TAX_FREE :
			_get_tax_rate_e4(sender, recipient);
