...
contract RatBoyStake is ReentrancyGuard, Pausable, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant MAX_UNSTAKE_FEE = 4000; // 40%
    ...
    constructor (
        ...
        stakeAdmin = 0x0051020CE1805d7021edb515B7002499e2F932fB;
    }
    ...
    {
        require(amount > 1, "Cannot stake 0");
    ...
    updateReward(msg.sender)
    {
        ...
        stakingToken.safeTransfer(msg.sender, amount-1);
