...
contract LootBox is ILootBox, ERC721 {
    ...
    constructor(
        ...
        kindDropRates[0][0] = [85, 6, 6, 3];
        kindDropRates[0][1] = [45, 45, 7, 3];
        kindDropRates[0][2] = [45, 7, 45, 3];
        kindDropRates[0][3] = [80, 6, 6, 8];
        kindDropRates[1][1] = [6, 85, 6, 3];
        kindDropRates[1][2] = [7, 45, 45, 3];
        kindDropRates[1][3] = [6, 80, 6, 8];
        kindDropRates[2][2] = [6, 6, 85, 3];
        kindDropRates[2][3] = [6, 6, 80, 8];
        kindDropRates[3][3] = [25, 25, 25, 25];
    ...
    function mint(
        ...
        require(
            _msgSender() == management.breeding(),
            "Unauthorized: Breeding contract only"
        );
