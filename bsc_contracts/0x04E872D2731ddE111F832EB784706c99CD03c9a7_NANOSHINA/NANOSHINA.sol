...
contract NANOSHINA is ERC20, Ownable {
    ...
    constructor() ERC20("NANO SHINA", unicode"NNSHINA") {
        ...
        maxTransactionAmount = 0.5 * 1e7 * 1e18; 
        maxWallet = 0.5 * 1e7 * 1e18; 
        ...
        devWallet = address(0x5d5b340150213cD0846b4F347574e3FC3388AfdB); 
