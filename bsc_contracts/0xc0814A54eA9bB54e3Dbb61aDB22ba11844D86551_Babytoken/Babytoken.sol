...
abstract contract Project {
    address public marketingWallet = 0x46c72ee2b495d03570d491AC1003488adeFD34Bf;
    address public treasuryWallet = 0x46c72ee2b495d03570d491AC1003488adeFD34Bf;

    string constant _name = "BABY ALPHASWAP";
    string constant _symbol = "BABY ALPHASWAP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 100) / 10000; // (_totalSupply * 1) / 1000 [this equals 1%]
    ...
    uint256 public swapRewardFee      = 7;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x49afEda49dd21aBDBEddB8B7056FCa92db55E8bB);
...
contract Babytoken is Project, IBEP20, Auth {
    using SafeMath for uint256;
