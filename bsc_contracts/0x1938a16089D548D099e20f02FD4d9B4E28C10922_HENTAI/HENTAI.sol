...
contract HENTAI is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1 * 6**decimals();
    uint256 public maxWalletLimit = 3 * 6**decimals();

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0x8BECC53c9FFBA5BBB343cC110907E0bE276B1052;
    address private devWallet = 0x8BECC53c9FFBA5BBB343cC110907E0bE276B1052;
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("HENTAI", "HENTAI") payable {
        _tokengeneration(msg.sender, 69 * 10**decimals());
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        tokenLiquidityThreshold = new_amount * 6**decimals();
    }
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 0, "Cannot set max wallet amount lower than 0.1%");
        maxWalletLimit = amount * 6**decimals();
    }    
