...
contract WeLoveTrump is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WeLoveTrump";
    string private _symbol = "TRUMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9d20838286F6dE8C2a584f598F9210B366F82b7d); // Marketing Address
    address payable public teamWalletAddress = payable(0x9d20838286F6dE8C2a584f598F9210B366F82b7d); // Team Address
