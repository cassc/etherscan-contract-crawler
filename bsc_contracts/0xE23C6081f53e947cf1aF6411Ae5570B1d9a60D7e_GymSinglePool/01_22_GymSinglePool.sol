...
contract GymSinglePool is ReentrancyGuardUpgradeable, OwnableUpgradeable, RewardRateConfigurable {
    ...
    function _activatePendingCommissions() private {
        //TODO: change before deployment
        ICommissionActivation(0x3E1240E879b4613C7Ae6eE1772292FC80B9c259e).activateCommissions(
            3,
            msg.sender
        );
        for (uint256 _depositId = 0; _depositId < userInfo[msg.sender].depositId; ++_depositId) {
            UserDeposits memory depositDetails = user_deposits[msg.sender][_depositId];
