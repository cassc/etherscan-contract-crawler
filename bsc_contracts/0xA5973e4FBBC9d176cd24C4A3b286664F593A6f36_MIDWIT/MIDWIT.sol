...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0323E1AA0CDEd4f86da0Ee42E7f29C42b81FF579; // owner address
...
contract MIDWIT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MIDWIT";
    string private _symbol = "$MIDWIT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0323E1AA0CDEd4f86da0Ee42E7f29C42b81FF579); // Marketing Address
    address payable private teamWalletAddress = payable(0x0323E1AA0CDEd4f86da0Ee42E7f29C42b81FF579); // Team Address
