...
contract BABYCRAZYTIGER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYCRAZYTIGER";
    string private _symbol = "BABYCRAZYTIGER";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xFA9607924Dd0D668b74Aed310F8B2fF5D5E95bA7); 
    address payable private teamWalletAddress = payable(0xFA9607924Dd0D668b74Aed310F8B2fF5D5E95bA7); 
