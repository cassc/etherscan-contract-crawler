...
contract BOXCDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOXCASINODoge";
    string private _symbol = "BOXCDoge";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x2aa70E314627F5424642B89384201bEDd3BA418c); 
    address payable private teamWalletAddress = payable(0x7FB2F6AefAC766F329210a8457B93Adf6710A75e); 
