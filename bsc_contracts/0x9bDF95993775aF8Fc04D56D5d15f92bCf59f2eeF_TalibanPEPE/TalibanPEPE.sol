...
/**
 TELEGRAM : https://t.me/talibanpepe - MEMECOIN
*/
...
contract TalibanPEPE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Taliban Pepe";
    string private _symbol = "TPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x33E4C59dC79b6c163C32aD29253542216C76644E); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x33E4C59dC79b6c163C32aD29253542216C76644E); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 420000000000 * 10**_decimals;
