...
Launch date: Tuesday, MAY 23th .
Launch time: 5.30PM UTC.

PEPE TOXIC is an anime from the Black Clover series and PEPE TOXIC will issue 100 NFT collections and have utilities such as PepeToxicSwap, NFT marketplace, and P2E Games and will distribute 50 NFT to 50 Top Holders.

-Tax: buy sell: 1/3%.

Telegram Portal 
https://t.me/pepetoxic.
*/
...
contract PepeToxic is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;    
    string public name = "PEPE TOXIC";
    string public symbol = "PTOXIC";
