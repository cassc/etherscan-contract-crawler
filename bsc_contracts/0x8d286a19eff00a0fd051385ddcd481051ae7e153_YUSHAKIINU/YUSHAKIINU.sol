...
contract YUSHAKIINU is Context, IERC20 { 
    ...
    string private constant _symbol = unicode"YUSHAKIINU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable public DevWallet = payable(0x9918e6a5c6F65D47E324275c9DD1EAD0A8C922c1);
    address payable public MarketingWallet = payable(0xFde1881BD6E876786e3F99cDDa696352d580F2c9);
