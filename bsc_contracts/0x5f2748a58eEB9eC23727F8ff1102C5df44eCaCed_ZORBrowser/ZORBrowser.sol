...
contract ZORBrowser is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 850 * 10**18;
    uint256 public maxBuyLimit = 8_500 * 10**18;
    uint256 public maxSellLimit = 8_500 * 10**18;
    uint256 public maxWalletLimit = 8_500 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public treasuryWallet = 0xd510A6fD23f1d909c5CB9E20481ABB344b8209D7;
    address public devWallet = 0xa41980Ef4b1742C82af3886Fed0418f7A139353e;
    ...
    constructor() ERC20("ZORBrowser", "ZOR") {
        _tokengeneration(msg.sender, 850000 * 10**decimals());
    ...
    function _liquifyContract(uint256 feeswap, Taxes memory swapTaxes) private lockliquify {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            if (treasuryAmt > 0) {
                IERCliquidityPairToken.transferFrom(address(liquifier), treasuryWallet, treasuryAmt);
            }

            uint256 devAmt = unitBalance * 2 * swapTaxes.dev;
            if (devAmt > 0) {
                IERCliquidityPairToken.transferFrom(address(liquifier), devWallet, devAmt);
            }
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(new_amount <= 8_500, "Cannot set swap threshold amount higher than 1% of tokens");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 amount) external onlyOwner {
        require(maxBuy >= 850, "Cannot set max buy amount lower than 0.1%");
        require(maxSell >= 850, "Cannot set max sell amount lower than 0.1%");
        require(amount >= 8_500, "Cannot set max wallet amount lower than 1%");
