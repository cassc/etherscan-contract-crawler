...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb4fc9D0276dE82a9a84abc021429090b0FcB75f4;
...
contract BBOY is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xC7Fc6d35F479626a1B9Ec8bA2a91Cde2960415ba;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BITBOY";
    string private _symbol = "BBOY";
