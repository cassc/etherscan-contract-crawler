...
/**
 * TG: https://t.me/autismbsc
    WEB: https://www.autismbsc.online/
*/

/**
Artificial Ultra Technological Intelligent Strong Monkey| Official BSC  
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x337C4930B612FA27072abB7b8fDE693e9D129405);
...
contract ArtificialUltraTechnologicalIntelligentStrongMonkey is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ArtificialUltraTechnologicalIntelligentStrongMonkey";
    ...
    uint256 public sellMultiplier  = 700;
    ...
    function fuck_bots(address[] calldata addresses, bool status) public onlyOwner {
    ...
    function setFeeWallets(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        devFeeReceiver = _devFeeReceiver;
    }

    function setContractSells(bool _enabled, uint256 _amount) external authorized {
