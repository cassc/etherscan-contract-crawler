...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xed93CA92329a00AcdcE2583D8A0312A4e6D6aE63; // owner address
...
contract NestNetwork is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xed93CA92329a00AcdcE2583D8A0312A4e6D6aE63); // Marketing Address
    address payable public teamWalletAddress = payable(0xed93CA92329a00AcdcE2583D8A0312A4e6D6aE63); // Team Address
