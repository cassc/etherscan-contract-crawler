...
contract EGoldAuctionAirdrop is AccessControl {
    ...
    function setup( uint256 _sb , uint256 _eb , address _token , address _auction ) external onlyRole(DEFAULT_ADMIN_ROLE) isInActive {
        StartBlock = _sb;
        EndBlock = _eb;
    ...
    function Claim ( ) external isActive {
        ...
        Token.transfer( msg.sender , dispatch );
