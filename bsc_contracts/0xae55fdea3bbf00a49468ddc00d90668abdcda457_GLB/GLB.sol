...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x76cE794c3aB734dE0a831B2B85e4DBa758c3326f; // owner address
...
contract GLB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Globe Network ";
    string private _symbol = " GLB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x76cE794c3aB734dE0a831B2B85e4DBa758c3326f); // Marketing Address
    address payable public teamWalletAddress = payable(0x76cE794c3aB734dE0a831B2B85e4DBa758c3326f); // Team Address
    ...
    uint256 public _marketingShare = 78;
    uint256 public _teamShare = 3; 

    uint256 public _totalTaxIfBuying = 0;
    uint256 public _totalTaxIfSelling = 83;  
    uint256 public _totalDistributionShares = 83;  
