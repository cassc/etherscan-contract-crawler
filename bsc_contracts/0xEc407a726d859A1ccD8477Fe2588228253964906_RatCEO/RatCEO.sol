...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE9855c08AB2B210849f6b02546d955f165F4972c; 
...
contract RatCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rat CEO";
    string private _symbol = "RatCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x688D93CCc99B8Ee4db5fBF8b23d62cEe1F74B4D3); // 
    address payable public teamWalletAddress = payable(0x688D93CCc99B8Ee4db5fBF8b23d62cEe1F74B4D3); // 
