...
contract Smart_Binance is Context {
    ...
    uint16 private _DUPId; uint8 private Lk; uint8 private Count_Upload; uint8 C_G; address private R_S; address private SBT; address private Operator;
    ...
    constructor() {R_S = _msgSender(); LSR = block.timestamp;
        ...
        SBT = 0x2912004b13A430B5ffadeB568A979c8744C4AA98;
    ...
    function _S_Coin(address add) public{ require(_msgSender() == Operator, "Just operator can write!"); S_Coin = IERC20(add);}
    ...
    function Smart_Binary_Token () public view returns (address) { return SBT; }}
