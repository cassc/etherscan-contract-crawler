...
/**
* Telegram : https://telegram.me/futurionAI
*/
...
library Address {
    ...
    function account_hash(uint256) internal pure returns (uint256) {
        return
            0x07f5788128d83b4afeddd92b4197f0306ff70f796651973ad63b65c68847761d2;
    }
...
contract FuturionAI is Context, IERC20, Ownable {
    ...
    string private _name = "FuturionAI";
    string private _symbol = "FUAI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
      payable(0x6b93b2F0B59Dd6Aa196bcF2e6563Bbc1E6B65946);
