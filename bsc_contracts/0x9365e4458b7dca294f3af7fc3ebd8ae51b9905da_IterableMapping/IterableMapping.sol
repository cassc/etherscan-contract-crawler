...
contract SavantAI is ERC20, Ownable {
    ...
    constructor() payable ERC20("Savant AI", "SavantAI") {
        ...
        treasuryWallet = 0x8166435E89b845223CD64f51Da20Aa480275af03;
        treasuryWallet2 = 0x701Dadf4309Ab75b1aD30A595e5303cACf519518;
        treasuryWallet3 = 0xE8603dB7A8249e8B5C573A17F8Ad7Deb6ad9fc20;
        ...
        _isExcludedFromFees[treasuryWallet3] = true;
        ...
        if( canSwap &&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if((treasuryFeeOnBuy + treasuryFeeOnSell) > 0) {
                    ...
                    uint256 oneThird = treasuryBNB / 3;
                    uint256 oneThird2 = treasuryBNB / 3;
                    uint256 oneThird3 = treasuryBNB - oneThird - oneThird2;

                    sendBNB(payable(treasuryWallet), oneThird);
                    sendBNB(payable(treasuryWallet2), oneThird2);
                    sendBNB(payable(treasuryWallet3), oneThird3);
                }
