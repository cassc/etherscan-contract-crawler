...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC510e008a369855F8c260BffcedF731a8b6B2C00;
...
contract Pepee is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x99eff967F803ADd434525B66197e4e8C566D4D2b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Pepee";
    string private _symbol = "Pepee";
