...
contract LTABD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public InvestmentTreasuryAddress = payable(0xa4ea711a98c4Aa17126dfF7e49C32b7Fbf18cfaa); 
    ...
    uint256 private _tTotal = 13310000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "LTABD";
    string private _symbol = "LTA";
    ...
    uint256 public _maxTxAmount = 13310000 * 10**9;
