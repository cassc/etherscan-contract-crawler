...
// Incinerator smart contract
// 1000 DeMOON tokens initial supply
// 4% from each transaction is burned
// https://t.me/incinerator
...
contract INCINERATOR is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Incinerator";
