    ...
    AccessControlUpgradeable
{
    ...
    function deposit() external payable override whenNotPaused {
        ...
        totalInWombatLP += amountInLP;
        totalShares += amountInVault;
        userShares[msg.sender] += amountInVault;
        ...
        )
    {
        ...
        amountInVault = convertBnbToVault(amountInBnb);
    }
    ...
    // Deposit to StakeManager and get back bnbX
