...
contract ERC20 is DadyMilk, IERC20, IERC20Metadata {
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Dady Mlik", "DLK") {

        address _owner = 0x41E07eCFE511238dA48FE3f6df53600b9840dbFd;
        ...
        marketingWallet = address(0x6578d14248126015a45B0fDC04292dDeE7Db1630); // set as marketing wallet
    	devWallet = address(0x40047cB01FBE6078D3E3951C4C9b53A815909530); // set as dev wallet
    	charityWallet = address(0x17b8ded434146534C70E49082F6810Ce8CA2745a); // set as charityWallet
    ...
    function airdropToWallets(address[] memory airdropWallets, uint256[] memory amounts) external onlyOwner returns (bool){
        require(!tradingActive, "Trading is active, cannot airdrop after launch.");
