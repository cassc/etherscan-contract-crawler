...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintNftWithTokenUser(address to) public onlyMinter returns (bool) {
        require(tokenId < 128,"max");
		tokenId = tokenId + 1;
		_mint(to, tokenId);
        _setTokenURI(tokenId, "https://ipfs.io/ipfs/QmQVJhmgtzN6gUDfjfhbCt82ACycHEEimRxeomncJ7K4Mp");
        return true;
    }
}
...
contract LunarProbeNFT is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("Lunar Probe NFT", "LunarProbeNFT") {
