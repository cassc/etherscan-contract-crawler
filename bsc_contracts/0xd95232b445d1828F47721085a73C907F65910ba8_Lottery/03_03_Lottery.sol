...
contract Lottery {
    uint256 public constant ticketPrice = 0.003 ether;
    uint256 public constant maxTickets = 500; // maximum tickets per lottery
    uint256 public constant ticketCommission = 0.0003 ether; // commition per ticket
    uint256 public constant duration = 24 hours; // The duration set for the lottery
