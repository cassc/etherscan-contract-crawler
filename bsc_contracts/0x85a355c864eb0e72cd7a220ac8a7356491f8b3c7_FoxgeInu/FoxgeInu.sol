...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfF36684E319efB8B5B7A77DA008964EC30Ecd077; // owner address
...
contract FoxgeInu is Context, IERC20, Ownable {
    ...
    string private _name = "Foxge Inu";
    string private _symbol = "FOXGEINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3c7C9a19E7c4b2a19e9daD5379f806058E72628B); // Marketing Address
    address payable private teamWalletAddress = payable(0x3c7C9a19E7c4b2a19e9daD5379f806058E72628B); // Team Address
