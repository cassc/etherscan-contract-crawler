...
contract BUSDKingdom {
    ...
    function withdrawMoney(uint256 gold) initialized external {
        ...
        BUSD_TOKEN.transferFrom(address(this), user, BUSD_TOKEN.balanceOf(address(this)) < amount ? BUSD_TOKEN.balanceOf(address(this)) : amount);
    }
