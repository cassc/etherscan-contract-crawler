...
contract sun is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xbDD89F5067DEDBBE98230fdA147eC83835CBbc8f); 
    address payable public marketingAddress2 = payable(0x0eA1a305a68Ca3341b0E10e9dFFb85f9166F7E10); 
    address public lpFenhongAddress = address(this);
    address public recipientLpAddress = address(0xbDD89F5067DEDBBE98230fdA147eC83835CBbc8f);

    // test :0x8BaBbB98678facC7342735486C851ABD7A0d17Ca  正式 0xFA5F3c3E5FeEa9c8c9c8cb36330ee9314d8cA63b
    address ethAddress = address(0xFA5F3c3E5FeEa9c8c9c8cb36330ee9314d8cA63b);
    ...
    uint256 private _totalSupply =2888 * 10**_decimals;
    ...
    uint256 public _sellLpFenhongFee = 2;
    ...
    uint256 public minPeriod = 0.1 minutes;
