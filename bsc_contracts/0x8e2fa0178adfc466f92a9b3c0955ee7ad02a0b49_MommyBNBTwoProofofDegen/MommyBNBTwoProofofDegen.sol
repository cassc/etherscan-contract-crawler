...
/**
Telegram : https://t.me/MommyBNB20ProofofDegen
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1a4A9A70398AafF40a5a0F50613064559D76F9fB; // owner address
...
contract MommyBNBTwoProofofDegen is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mommy BNB Two Proof of Degen";
    string private _symbol = "MBNB2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1a4A9A70398AafF40a5a0F50613064559D76F9fB); // Marketing Address
    address payable public teamWalletAddress = payable(0x1a4A9A70398AafF40a5a0F50613064559D76F9fB); // Team Address
