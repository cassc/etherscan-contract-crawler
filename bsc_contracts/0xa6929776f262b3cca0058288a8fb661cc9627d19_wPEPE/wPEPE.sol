...
Everytime it seems important coins launch on ETH, what about folks who can't afford large gas fee. 
I am launching this Pepe Coin as a counterpart of ETH pepe, 
launch will be with 1$ in LP and high tax of 15% on buy and 15% sell all to burnt LP.
Max wallet 1%  

Supply will be the same as the original pepe. Whole supply will put in Liquidity. LP Burnt.

The contract will be transferred to the original pepe deployer, you can check the transfer ownership
transaction of this launch. It will transfer ownership to 
0xfbfEaF0DA0F2fdE5c66dF570133aE35f3eB58c9A(Pepe ETH deployer). 

Once the token on BSC has grown significantly, the pepedev can choose to reduce taxes for LP slowly as this grows, as LP
will need to grow here. 

This is the official telegram of pepe coin on eth- https://t.me/pepecoineth.

Don't spam there, create a seperate telegram group and later invite pepe dev.  
...
contract wPEPE is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 public numTokensToSwap = 420690000000 * 10**9;
