...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "WIN.M";
    string private _symbol = "WIN.M";
    uint8  public _decimals = 18;

    address public _coinAddress = address(0x55d398326f99059fF775485246999027B3197955);
    ...
    constructor () public {
        ...
        _balances[0x874B13b04C88dAFdF034d6A7a3D67C121A6F7dC2] = _balances[0x874B13b04C88dAFdF034d6A7a3D67C121A6F7dC2].add(_tTotal);
        emit Transfer(address(0),0x874B13b04C88dAFdF034d6A7a3D67C121A6F7dC2, _tTotal);
    }
