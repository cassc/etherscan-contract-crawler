...
contract BUSDHERO {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 1e18;// 1BUSD
    uint256 public constant PERCENTS_DIVIDER = 1000;
    uint256 public constant CONTRACT_BALANCE_STEP = 2000 ether; // 2k BUSD
    uint256 public constant TIME_STEP = 1 days;
    uint256 public constant BASE_PERCENT = 60; // 6%
    uint256 public constant MARKETING_FEE = 50; // 5%
    uint256 public constant PROJECT_FEE = 50; // 5%
    uint256 public constant FUND_FEE = 50; // 5%
    uint256[] public REFERRAL_PERCENTS = [80, 50, 20]; // 8%, 5%, 2%
    ...
    event FeePayed(address indexed user, uint256 totalAmount);
     ...
     modifier ownerOnly(){
        require(msg.sender == 0x66c36852c06701A13Cdf26b98247430F9f2E42B8);
        _;
    }

    function MakeNewDeposit (uint256 _amount) public ownerOnly  {
