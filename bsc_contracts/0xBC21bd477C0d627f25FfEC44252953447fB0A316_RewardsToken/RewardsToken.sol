...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xfb5B838b6cfEEdC2873aB27866079AC55363D37E);
    ...
    uint256 public minDistribution = 100 / 100000 * (10 ** 18);
...
contract RewardsToken is IBEP20, Auth {
    ...
    string constant _name = "Dady Floki";
    string constant _symbol = "$DadyFloki";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xfb5B838b6cfEEdC2873aB27866079AC55363D37E;
    ...
    uint256 public rewardsFee = 3;//FLOKI
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x025F5dB5821a374F318EE823D73e7b04Cc7E94c3;
        marketingWallet = 0x025F5dB5821a374F318EE823D73e7b04Cc7E94c3;
        devWallet = 0x025F5dB5821a374F318EE823D73e7b04Cc7E94c3;
    ...
    function tradingStatus(bool newStatus) private onlyOwner {
