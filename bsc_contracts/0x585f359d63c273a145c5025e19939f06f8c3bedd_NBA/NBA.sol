...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x31D03DD3f6234fa58a6B28955bf45f3fd870e3A5; // owner address
...
contract NBA is Context, IERC20, Ownable {
    ...
    string private _name = "National Basketball Association";
    string private _symbol = "NBA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x31D03DD3f6234fa58a6B28955bf45f3fd870e3A5); // Marketing Address
    address payable private teamWalletAddress = payable(0x31D03DD3f6234fa58a6B28955bf45f3fd870e3A5); // Team Address
