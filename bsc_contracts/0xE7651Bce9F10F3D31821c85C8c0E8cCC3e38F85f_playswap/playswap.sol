...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x51832B4d7657FA0A2aB653eaCA7e1d6F0713B3eB);
...
contract playswap is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xED3a958d9a863DE22879bD71C03fc13314AF935f;

    string constant _name = "PlaySwap";
    string constant _symbol = "PLAY";
...
function clearStuckBalance_token(uint256 amountPercentage) external authorized {
        uint256 amount = address(this).balance;
        payable(marketingFeeReceiver).transfer(amount * amountPercentage / 100);
    }
