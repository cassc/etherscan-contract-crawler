...
/**
STEALTH LAUNCH AT 100 MEMBERS 
TG: https://t.me/BabySowlTokenBSC
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA8F032175952A1e07bE57D5A46E8AA2949C37AE7; // owner address
...
contract BabySowlTokenBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Sowl";
    string private _symbol = "BS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA8F032175952A1e07bE57D5A46E8AA2949C37AE7); // Marketing Address
    address payable public teamWalletAddress = payable(0xA8F032175952A1e07bE57D5A46E8AA2949C37AE7); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 14;  // original 12
