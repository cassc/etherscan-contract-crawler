...
/**
follow the hype 0% tax
Telegram https://t.me/Ben20bsc_official
*/
...
contract BEN20 is ERC20, Ownable {
    ...
    constructor() ERC20("BEN 2.0", "BEN20") {
        ...
        // tax is higher at launch to prevent from bot attack, final tax will be 0/1
        ...
        marketingWallet = address(0xf0e352095A257c09b4238dFd9DC9D10a1042743E); // set as marketing wallet
        devWallet = address(0xf0e352095A257c09b4238dFd9DC9D10a1042743E); // set as dev wallet
