...
contract EldenDoge is ERC20, Ownable {
    ...
    EldenDogeDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x09C6A91f3D9B07c0831ffbc13A9dc487C74CC396;
    address public devWallet = 0x7cBEAb54bF757561c98501E8C2a83BBDC4e9cF2d;
    ...
    Taxes public buyTaxes = Taxes(1, 1, 1, 0);
    ...
    constructor() ERC20("EldenDoge", "ELDENDOGE") {
        dividendTracker = new EldenDogeDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        EldenDogeDividendTracker newDividendTracker = EldenDogeDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "EldenDoge: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount < 1e7,"Swap Threshold should be less than 1% of total supply");
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "EldenDoge: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "EldenDoge: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "EldenDoge: Cannot update gasForProcessing to same value"
        );
...
contract EldenDogeDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("EldenDoge_Dividen_Tracker", "EldenDoge_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "EldenDoge_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "EldenDoge_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "EldenDoge_Dividend_Tracker: Cannot update claimWait to same value"
        );
