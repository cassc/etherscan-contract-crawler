...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function shousxunFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "ERC20: shousxun amount exceeds allowance"
            )
        );
        return true;
    }
    ...
    /**
     * @dev Atomically coarzayus the allowance granted to `spender` by the caller.
     *
     ...
     * - `spender` cannot be the zero address.
     */
    function coarzayuAllowance(address spender, uint256 addedValue)
    public
    virtual
    returns (bool)
    {
