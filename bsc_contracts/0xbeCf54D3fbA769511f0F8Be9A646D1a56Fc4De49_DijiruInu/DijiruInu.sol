...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x94E210868457Acb10c6231B05f74711093DA83fa; // owner address
...
contract DijiruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dijiru Inu";
    string private _symbol = "DIJIRU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x94E210868457Acb10c6231B05f74711093DA83fa); // Marketing Address
    address payable public teamWalletAddress = payable(0x94E210868457Acb10c6231B05f74711093DA83fa); // Team Address
