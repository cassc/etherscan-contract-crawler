...
/*
PEPE CEO INU $PCI is developing technology that reduces the gaps between traditional and decentralized finance.
...
contract PEPECEOINU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PCI";
