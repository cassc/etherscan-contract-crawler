...
contract FalconGpt is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xb6d0A44fF5b0a2833b0862273b820ACA60E6354e;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "Falcon GPT";
    string constant _symbol = "$FGPT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xeC451956d0032dD2bC5666aD9681200f7102F2eF;
