...
contract TITANPROTOCOL is ERC20, Ownable {
    ...
    constructor() ERC20("Titan Protocol", "$TP") {
        ...
        marketingWallet = address(0xB4d6d0A5E4a8c4CC7ED208c3f2AF5F5A35c577Cb); 
        devWallet = address(0x5941EBDC203c6Ca1bcf7aBAa917a5fD5EA03F463);
        lpWallet = msg.sender;
