...
library Address{
 ...
 contract Pepe is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 42e13 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 100_000 * 10**18;
    uint256 public maxBuyLimit = 8_400_000_000_000 * 10**18;
    uint256 public maxSellLimit = 8_400_000_000_000 * 10**18;
    uint256 public maxWalletLimit = 8_400_000_000_000 * 10**18;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xAE5a1C8d84B37e34f3f68d73c0f99907E59b7C9c;
    address public developmentWallet = 0xE06326891354C371F6Efd2BfA8DEa94F6F28fB10;

    string private constant _name = "PepeChain";
    string private constant _symbol = "PCHAIN";
    ...
    Taxes public taxes = Taxes(0, 3, 2, 0);
    Taxes public sellTaxes = Taxes(0, 3, 2, 0);
