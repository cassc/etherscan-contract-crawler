...
contract Stackoin_v3 {
   ...
   // IERC20 public token = IERC20(0x1D89E635c136E7429069b6551D995C7f764688FB); Testnet Kovan
	...
	uint256[] public REFERRAL_PERCENTS 	= [700, 300, 100, 100, 50, 50, 100, 150]; // 7%, 3%, 1%..
	uint256[] public SEED_PERCENTS 		= [700, 300, 100, 100, 50, 50, 100, 150]; // 7%, 3%, 1%..
	uint256 constant public PROJECT_FEE = 0; // 0%
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(3000, 5)); // 3000j avec du 0.05/j        
	}
	...
	function getUserDownlineCount(address userAddress) public view returns(uint256[8] memory referrals) {
		return (users[userAddress].levels);
	}

	function getUserTotalReferrals(address userAddress) public view returns(uint256) {
		return users[userAddress].levels[0]+users[userAddress].levels[1]+users[userAddress].levels[2]+users[userAddress].levels[3]+users[userAddress].levels[4]+users[userAddress].levels[5]+users[userAddress].levels[6]+users[userAddress].levels[7];
	}
