        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x992bBb295F113f220e64F498b381C7D4be54EbAe), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        ...
        18,//De
        1000000000,//Su
        address(0x992bBb295F113f220e64F498b381C7D4be54EbAe),//
        address(0x992bBb295F113f220e64F498b381C7D4be54EbAe)//
    ){
    }
}