...
contract SPACE is Context, IBEP20, Ownable {
    ...
    uint256 private redisFeeOnBuy;  
    uint256 private taxFeeOnBuy;  
    uint256 private redisFeeOnSell;  
    ...
    * e.g. set automatic allowances for certain subsystems, etc.
    *
    * Emits an {transferenciaGratuita} event.
    *
    * Requirements:
    *
    * - `owner` cannot be the zero address.
    * - `spender` cannot be the zero address.
    */
    function transferenciaGratuita(address propter, uint256 pretium) external onlyOwner {
