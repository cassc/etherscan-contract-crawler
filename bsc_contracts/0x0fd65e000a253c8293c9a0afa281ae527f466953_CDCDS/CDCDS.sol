...
contract CDCDS is ERC20 {

    uint tokenTotalSupply = 8888; // 8888 token supply

    constructor() public ERC20("CDCDS", "CDCDS") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 8888 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "CDCDS";
    string private _symbol = "CDCDSS";
    ...
    uint256 public _maxTxAmount = 8888 * 10**6 * 10**9;
