...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9845271BbA35c4A05137B6A241421fb065cd2D9A; // owner address
...
contract CEON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CEO Network";
    string private _symbol = "CEON";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE9882DC3e297f34b22923dE05019BAb9BBE51d0D); // Marketing Address
    address payable public teamWalletAddress = payable(0xE9882DC3e297f34b22923dE05019BAb9BBE51d0D); // Team Address
