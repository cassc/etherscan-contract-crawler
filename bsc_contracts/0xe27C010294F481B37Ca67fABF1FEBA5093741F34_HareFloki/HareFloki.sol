...
contract HareFloki  is Context, IERC20, Ownable {
    ...
    string private constant _name = "HareFloki"; 
    string private constant _symbol = "HAREFLOKI";
    ...
    Tax public buyTax = Tax(4,0,4);
    Tax public sellTax = Tax(4,0,4);
    
    address public treasuryWallet = 0x4D4e9a95615D08Ca1C3528F83cf8A1d3b3ca1E9E;
    address public devWallet = 0x4D4e9a95615D08Ca1C3528F83cf8A1d3b3ca1E9E;
