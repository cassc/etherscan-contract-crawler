...
contract OldCroge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OldCroge";
    ...
    address payable private TeamWallet = payable(0x94944F50A20572f52522A56721C9bC518E662CFB); // Buy Back Address
