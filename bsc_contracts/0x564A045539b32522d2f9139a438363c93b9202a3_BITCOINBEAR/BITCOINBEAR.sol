...
library SafeMath {
    function tryAdd(uint256 a, uint256 b) internal pure returns (bool, uint256) {
        unchecked {
            ...
            return (true, c);// SPDX-License-Identifier: Unlicensed
      }
 }
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6b25807F90b215770b060D95Ff22A5d391a2E592;
...
contract BITCOINBEAR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb2969d4D1f42e285aD860AD3a54d89C6d37E3d67;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BITCION BEAR";
    string private _symbol = "BITBEAR";
