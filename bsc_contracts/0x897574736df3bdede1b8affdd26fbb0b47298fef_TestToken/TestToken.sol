...
library SafeMath {
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMath: subteraction overflow");
    }
...
contract TestToken is IBEP20, Auth {
    ...
    address DEV = 0x502b75D044da32A6C73FAB17fD9b0fa171E330BE;

    string constant _name = "STOIC";
    string constant _symbol = "STOIC";
