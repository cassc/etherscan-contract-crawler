...
/** 
PPR is now trending on Twitter. 
Contract renounced - zero tax - Liquidity locked.
Huge community around PepeRocket - soon the new Pepe Coin. 

Telegram: https://t.me/PepeRocket
Website: https://www.PepeRocket.com
**/
...
contract PepeRocket {
    ...
    function symbolPPR() public view virtual returns (string memory) {
        return 'tokensymbol is PPR';
    }
