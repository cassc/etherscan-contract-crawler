...
Website: https://floki-tech.tech/
Telegram: https://t.me/flokitechportal
...
uint256 amount;
    ...
    IBEP20 RewardToken = IBEP20(0xb815335e402982C7Bcd143c0eAE219B1C5645DE3) ; //BUSD
...
contract FlokiTech is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Floki Tech";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xb815335e402982C7Bcd143c0eAE219B1C5645DE3; //BUSD
 
    uint256 _totalSupply = 1000000 * 10**6 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 10000; //  10000 tokens per trx ;
    uint256 public _walletMax = _totalSupply * 1 / 500;    // 200000 mx wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xb815335e402982C7Bcd143c0eAE219B1C5645DE3; // liquidity
        marketingWallet = 0xb815335e402982C7Bcd143c0eAE219B1C5645DE3;  // marketing
