...
contract BnbCZInu {
    string constant _name = "Bnb CZ Inu";
    string constant _symbol = "BNBCZ";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 10000000000000000000 * (10**_decimals);
    ...
    uint256 public ecoFee_BUY = 300; 
    uint256 public burnFee_BUY = 500; 
    
    uint256 public ecoFee_SELL = 900; 
    uint256 public burnFee_SELL = 100; 
