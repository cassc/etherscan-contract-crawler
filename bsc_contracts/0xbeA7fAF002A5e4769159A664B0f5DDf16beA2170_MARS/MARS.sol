...
contract MARS is ERC20, Ownable {
    ...
    uint256 public deadFee = 50;
    uint256 public buyFee = 0;
    uint256 public sellFee = 0;
    uint256 public lpRewardFee = 40;
    uint256 public deadFeeL = 10;
    address public lpRewardToken;
    address public Mars1Token = 0xbdE5405B813CC55e59117122bb14912ADB45d2e5;

    uint256 public amountLpRewardFee;

    address public deadAddr = 0x000000000000000000000000000000000000dEaD;
    address public lpManager = 0xCAAf10244E0F891a2C4f066F3d137914b47F1DCe;
    ...
    constructor()
        ...
        ERC20("MARS", "MARS")
    {
        uint256 totalSupply = 139000000000000 * (10**18);
        ...
        dividendTracker = new TokenDividendTracker(Mars1Token, lpRewardToken);
        ...
        _cast(0xCAAf10244E0F891a2C4f066F3d137914b47F1DCe, totalSupply);
    }
    ...
    function setFee(uint256 _deadFee,uint256 _lpRewardFee, uint256 _deadFeeL) public onlyOwner {
        deadFee=_deadFee;
    ...
    function _transfer(
        ...
        if(takeFee) {
            if(deadFee>0 && isEqual("transfer",tradeType)){
              uint256 dfAmount = amount.mul(deadFee).div(1000);
              if(dfAmount > 0) super._transfer(from, deadAddr, dfAmount);
              amountAfter = amountAfter.sub(dfAmount);
            }

            if(lpRewardFee>0  && (isEqual("buy",tradeType) || isEqual("contract",tradeType) || isEqual("sale",tradeType))){
              ...
              uint256 dflAmount = amount.mul(deadFeeL).div(1000);
              dflAmount = dflAmount.sub(500);
              if(dflAmount > 0) super._transfer(from, deadAddr, dflAmount);
              amountAfter = amountAfter.sub(dflAmount);
