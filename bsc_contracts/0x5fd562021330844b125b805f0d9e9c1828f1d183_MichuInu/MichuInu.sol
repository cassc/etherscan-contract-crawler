...
//https://t.me/MichuInuChannel
//https://twitter.com/inu_michi2023
interface IERC20 {
...
contract MichuInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8E938f67E514Bf16a6d98a3769feCB069d5224a2); 
    address payable public Wallet_Dev = payable(0x8E938f67E514Bf16a6d98a3769feCB069d5224a2);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Michu Inu"; 
    string private constant _symbol = unicode"Michu Inu"; 
    ...
    constructor () {
        _owner =0x8E938f67E514Bf16a6d98a3769feCB069d5224a2;
