...
contract BNBSHIBCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBSHIB CEO";
    string private _symbol = "BNBSHIBCEO";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x2975D0dF52ad6ec3d0392563c6cd3D723210f9d5); 
    address payable private teamWalletAddress = payable(0x2975D0dF52ad6ec3d0392563c6cd3D723210f9d5); 
    ...
    uint256 private minimumTokensBeforeSwap = 5* 10**5 * 10**_decimals;
