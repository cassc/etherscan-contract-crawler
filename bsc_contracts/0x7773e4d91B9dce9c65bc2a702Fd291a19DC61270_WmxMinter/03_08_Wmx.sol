 ...
 * @dev     The minting schedule is based on the amount of WOM earned through staking and is
 *          distirbuted along a supply curve (cliffs etc). Fork of ConvexToken.
 */
contract Wmx is ERC20 {
    using WmxMath for uint256;

    address public operator;
    address public immutable vProxy;
    ...
    function updateOperator() public {
        ...
        address newOperator = IStaker(vProxy).operator();
    ...
    /**
     * @dev Mints WMX to a given user based on the WOM supply schedule.
     */
