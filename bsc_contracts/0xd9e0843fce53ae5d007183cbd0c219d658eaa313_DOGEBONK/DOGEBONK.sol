...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x13CDF19858046d8f688B5760cc8b033855ef098B; // owner address
...
contract DOGEBONK is Context, IERC20, Ownable {
    ...
    string private _name = "DOGE-BONK";
    string private _symbol = "DOGEBONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x13CDF19858046d8f688B5760cc8b033855ef098B); // 
    address payable public teamWalletAddress = payable(0x13CDF19858046d8f688B5760cc8b033855ef098B); // 
