...
contract FrogeInu is Context, IERC20, Ownable {
    ...
    string private _name = "FrogeInu";
    string private _symbol = "FrogeInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe11509EFcb97944e93D0636690070b69CA136845); 
    address payable public DevelopmentWalletAddress = payable(0x1Cc96d4e78520D9038b30B2989dB6C9D4899C3f4); 
