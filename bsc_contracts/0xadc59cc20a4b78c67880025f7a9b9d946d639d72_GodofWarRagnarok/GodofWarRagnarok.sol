...
/**
    | God of War Ragnarok | 
    Max wallet: 15.000 tokens (1.5%)
    Max transaction 15.000 tokens (1.5%)
        Telegram :  https://t.me/gowrbsc      
*/
...
contract GodofWarRagnarok  is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0x4EF34550C22dd9bD013B6C1439514330c7D45470;
    address public devFeeReceiver = 0x4EF34550C22dd9bD013B6C1439514330c7D45470;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function _setIsFeeExempt(address holder, bool exempt) external authorized {
    ...
    function _setFeeReceivers(address _marketingFeeReceiver, address _devFeeReceiver) external authorized {
    ...
    function manage_blacklist(address _address, bool _value) public authorized {
