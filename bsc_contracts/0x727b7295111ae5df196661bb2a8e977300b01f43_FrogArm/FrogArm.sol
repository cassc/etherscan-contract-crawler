...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF99a450Fafc7610b5Ccb04B912c502210Bd16fA3;
...
contract FrogArm is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FrogArm";
    string private _symbol = "FRGARM";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5322F49908DFc47A14e663Bc3a2e184561726C89);
