...
contract CCDZ is ERC20 {

    uint tokenTotalSupply = 100; // 100 token supply

    constructor() public ERC20("CCDZ", "CCDZ") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CCDZ ";
    string private _symbol = "CCDZ";
