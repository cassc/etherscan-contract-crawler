...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7C7184cd61F1C9d70D5eE12C3359C985773d40Fb;
...
contract Susi is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x66febbE306b5f95Dec7BFD62889d9dC354A8c169;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 3000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Susi Inu";
    ...
    uint256 private numTokensSellToAddToLiquidity = 3000000000 * 10**18;
