...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53A3442f2339C9d20F86022b2635394EB2982E61; // owner address
...
contract PulsePaw is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " PulsePaw ";
    string private _symbol = "PulsePaw";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53A3442f2339C9d20F86022b2635394EB2982E61); // Marketing Address
    address payable public teamWalletAddress = payable(0x53A3442f2339C9d20F86022b2635394EB2982E61); // Team Address
