...
contract  $MONKA is IBEP20, Auth {
    ...
    address DEV = 0xBf58aaa683D8C3D1b17F151bfD4e51c98c0cA8ea;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = " $MONKA";
    string constant _symbol = "$MOK";
