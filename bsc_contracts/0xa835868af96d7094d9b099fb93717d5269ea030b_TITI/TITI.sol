 ...
 * 
 */
contract TITI is IERC20 {
    
    using SafeMath for uint256;
    
    //TITI DAO token, creator will take 3% fee
    address public feeTo = 0x000000000000000000000000000000000000dEaD;

    string public name = "TITI DAO";
    string public symbol = "TITI DAO";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //TITI DAO Token supply max length
    uint256 private totalLength = 7;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 TITI DAO
