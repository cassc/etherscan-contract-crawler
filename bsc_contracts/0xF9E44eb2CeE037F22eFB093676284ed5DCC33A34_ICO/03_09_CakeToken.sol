...
contract CakeToken is BEP20 {
    ...
    function setPayer(address _payer) onlyAdmin public {
        require(_payer != address(0), "Payer Address Invalid");
        payer[_payer] = true;
    }

    function setUnLockTime(uint256 _unlockTime) onlyAdmin public {
        require(_unlockTime > block.timestamp, "Unlock Time Invalid");
        unlockTime = _unlockTime;
    }

    function setUnlockPercent(uint256 _unlockPercent) onlyAdmin public {
