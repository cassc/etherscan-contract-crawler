...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x84416dF8DD4C96bd2eD435473CdAC0A8A091CEBa;
...
contract ReflectionCoin is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x761dF3930b63F308AB91f7157D428c121f9F3979;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ReflectionCoin";
    string private _symbol = "RC";
