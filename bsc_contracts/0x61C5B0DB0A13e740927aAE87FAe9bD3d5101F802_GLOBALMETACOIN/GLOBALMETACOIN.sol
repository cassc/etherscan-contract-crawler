...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEF9d4c1ce606164ba279947430f0Dec37cCa0771;
...
contract GLOBALMETACOIN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x649005d62293Ed078Cfbbb735EB70d026cdBb7c3;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 26000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Global Meta Coin";
    string private _symbol = "GMC";
    ...
    uint256 public _maxTxAmount = 26000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 26000000 * 10**18;
