...
// https://t.me/POOHannouncement
// https://pooh-money.com/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7D56aB08Ca253Fc35358037A0A6F0e6Ca8ab4d42; // owner address
...
contract PoohMoney is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POOH Money";
    string private _symbol = "$POOH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7D56aB08Ca253Fc35358037A0A6F0e6Ca8ab4d42); // Marketing Address
    address payable public teamWalletAddress = payable(0x7D56aB08Ca253Fc35358037A0A6F0e6Ca8ab4d42); // Team Address
