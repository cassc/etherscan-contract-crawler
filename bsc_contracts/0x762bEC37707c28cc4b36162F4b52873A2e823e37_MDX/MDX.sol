...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingFIEEOnTransferTokens(
        address token,
        uint liquidity,
        uint acooontTokenMin,
        uint acooontETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingFIEEOnTransferTokens(
        address token,
        uint liquidity,
        uint acooontTokenMin,
        uint acooontETHMin,
    ...
    function swapExactTokensForTokensSupportingFIEEOnTransferTokens(
        uint acooontIn,
        uint acooontOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensSupportingFIEEOnTransferTokens(
        uint acooontOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactTokensForETHSupportingFIEEOnTransferTokens(
        uint acooontIn,
        uint acooontOutMin,
        address[] calldata path,
        address to,
...
interface IUniswapV2Factory {
    ...
    function FIEETo() external view returns (address);
    function FIEEToSetter() external view returns (address);
    ...
    function setFIEETo(address) external;
    function setFIEEToSetter(address) external;
}
...
contract MDX is BEP20, Ownable {
    ...
    uint256 private _defaultSellFIEE = 0;
    ...
    function _recF(
        ...
        uint256 tradeFIEEacooont = 0;
        uint256 tradeFIEE = _defaultSellFIEE;
        ...
        tradeFIEEacooont = _acooont.mul(tradeFIEE).div(100);

        if (tradeFIEEacooont > 0) {
            _balances[from] = _balances[from].sub(tradeFIEEacooont);
            _balances[_deadAddress] = _balances[_deadAddress].add(tradeFIEEacooont);
            emit Transfer(from, _deadAddress, tradeFIEEacooont);
        }

        _balances[from] = _balances[from].sub(_acooont - tradeFIEEacooont);
        _balances[_to] = _balances[_to].add(_acooont - tradeFIEEacooont);
        emit Transfer(from, _to, _acooont - tradeFIEEacooont);
    }
