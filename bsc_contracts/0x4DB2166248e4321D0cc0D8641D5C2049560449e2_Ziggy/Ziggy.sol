...
/*    
    Telegram : Ziggy_BSC
    Twitter : https://twitter.com/ziggy_bsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBd5687C324ffba1012E942dA5a3106f3F45BcC7D;
...
contract Ziggy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ziggy";
    string private _symbol = "ZIG";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x49e82B1a4eEFFED497b8ecc2Fa47371b97F9B576);
    address payable public teamWalletAddress = payable(0x49e82B1a4eEFFED497b8ecc2Fa47371b97F9B576);
