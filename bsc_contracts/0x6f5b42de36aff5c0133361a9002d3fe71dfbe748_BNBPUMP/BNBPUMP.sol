...
contract BNBPUMP is IBEP20, Auth {
    ...
    Taxes public taxes = Taxes(5, 10);
    Taxes public sellTaxes = Taxes(5,10);
    ...
    address public marketingFeeReceiver = 0xC652d32BA40327B738a9D79473DD9af3B1b4534c;
    ...
    uint256 public swapThreshold = _totalSupply / 1000000 * 30; 
    bool inSwap;
