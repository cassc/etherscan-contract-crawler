...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0f0C1a9E099Bc03ce6036F5B51E87F3a87134E29;                   //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
contract ALEX is Context, IERC20, Ownable {                                                //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
    ...
    address private _developmentWalletAddress = 0xC08CdB476CE690F75A95069cc96Aa21Dd38B749f; //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!111
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ALEX";                                                      //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    string private _symbol = "ALX";                                                      //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    uint8 private _decimals = 18;
    uint256 public _taxFee = 30;                                                         //!!!!!!!!!!!!!!1
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 30;                                                 //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _liquidityFee = 30;                                                    //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!11
