...
contract MASYAGROW is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Masya Grow";
    string private _symbol = "$MASYAGROW";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x5Fb32743D39A1b30B0a54Fa6f0b8c1265C877E19); // Marketing Address
    address payable private TeamWallet = payable(0xb4f66193178D7C321adbc3e3Fa2798484a19b583); // Buy Back Address
