...
contract FreedyFi is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x12e468097A611603b472DA9d2Bc41765Be781681;

    address public teamWalletOne = 0x183CefB559A8fE68cA2eEe5E28003b0E889a3887;
    address public teamWalletTwo = 0x4feeA6864b7C89830910FaEDEC59245c8C1021d2;
    address public teamWalletThree = 0x2f08aC001E43d42CcA5F0415C0cd30c2E8DCFb16;
    address public teamWalletFour = 0x7668A54EB44485df1ae1019FBc6708a02578860c;
    ...
    { 
        ...
        _isExcludedFromFees[teamWalletThree] = true;
        _isExcludedFromFees[teamWalletFour] = true;
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        sendBNB(payable(marketingWallet), (newBalance * 780 / 1000));

        sendBNB(payable(teamWalletOne), (newBalance * 150 / 1000));
        sendBNB(payable(teamWalletTwo), (newBalance * 25 / 1000));
        sendBNB(payable(teamWalletThree), (newBalance * 25 / 1000));
        sendBNB(payable(teamWalletFour), (newBalance * 20 / 1000));
