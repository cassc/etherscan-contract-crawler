...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAe93e1e3e61A37b72EcBD85b0A4f7541b2f1A735; // owner address
...
contract squidpepe is Context, IERC20, Ownable {
    ...
    string private _name = "Squid Pepe";
    string private _symbol = "twidoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAe93e1e3e61A37b72EcBD85b0A4f7541b2f1A735); // Marketing Address
    address payable public teamWalletAddress = payable(0xAe93e1e3e61A37b72EcBD85b0A4f7541b2f1A735); // Team Address
