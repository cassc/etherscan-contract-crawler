...
contract crazy9s is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "crazy9s";
    string private _symbol = "crazy9s";
    ...
    address payable public ttWal = payable(0x495b360B123a29DEe373f0Dd9F11c08DB1eCFe71); 
