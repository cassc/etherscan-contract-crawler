...
/**
---------------------------------------------------------------------------------------------------
 Contract Developed by SAFU Dev [Developed over 300+ contracts]: 
...
contract KabosuCEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x4F437c5175def12b4c47C4bde93DCdeEee034D60;
    
    string private constant _name = "KabosuCEO";
    string private constant _symbol = "KCEO";
    ...
    Taxes public taxes = Taxes(3, 3, 0);
    Taxes public sellTaxes = Taxes(3, 3, 0);
    Taxes private launchtax = Taxes(0, 99, 0);
