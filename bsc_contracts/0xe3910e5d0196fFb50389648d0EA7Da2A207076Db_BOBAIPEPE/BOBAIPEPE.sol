...
contract BOBAIPEPE is Context, IERC20 {
    ...
    string private _name = unicode"BOB Ai Pepe";
    string private _symbol = "$BOBAIPEPE";
    ...
    uint256 public _maxWalletToken = _tTotal * 13 / 100;
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x432acF1904DDA6eE91749544ca820a44212e8E3c);
