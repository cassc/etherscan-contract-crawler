...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc013081075fB95B73C275a2323A013af864D74A4; // owner address
...
contract Akita is Context, IERC20, Ownable {
    ...
    string private _name = "Akita";
    string private _symbol = "AKT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa55e99CbcF250634056c21Bba6e2e3C14dd6f89B); // Marketing Address
    address payable private teamWalletAddress = payable(0xa55e99CbcF250634056c21Bba6e2e3C14dd6f89B); // Team Address
