...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe51110C63078246c29922f2B2132CE40Fbc4df27; // owner address
...
contract TRUMP is Context, IERC20, Ownable {
    ...
    string private _name = "100$ TRUMP";
    string private _symbol = "$TRUMP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe51110C63078246c29922f2B2132CE40Fbc4df27); // Marketing Address
    address payable public teamWalletAddress = payable(0xe51110C63078246c29922f2B2132CE40Fbc4df27); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1 * 9**_decimals; 
