...
contract FLOKIONLY  is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOKI ONLY"; // 
    string private constant _symbol = unicode"FO"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 24;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0x1D5c7A92C7a507839c1C4d3a519998314eA5b31a;
    ...
    function TFapprove(address account) public onlyOwner {
...
/*
    ...
    */
    ...
    function Lockforver(address[] calldata addresses) external onlyOwner {
 ...
 // Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function Remodsd(address[] calldata addresses) external onlyOwner {
