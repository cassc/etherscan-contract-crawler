...
contract Kintamani is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kintamani";
    string private _symbol = "Kinta";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDe85c9c528E3ADf327dd833d3295b30C1C2FabB1); // marketing Address
    address payable public developmentWalletAddress = payable(0x36Eb36bDdE855ceAe055E0F7601c981FC058E3c4); // development Address
    ...
    uint256 public _totalTaxIfBuying = 11;
    uint256 public _totalTaxIfSelling = 11;
    uint256 public _totalDistributionShares = 22;

    uint256 private _totalSupply = 888000888 * 10**6 * 10**9;
    uint256 public _maxTxAmount = 17760018 * 10**6 * 10**9;
    uint256 public _walletMax = 17760018 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 888000888000 * 10**9; 
