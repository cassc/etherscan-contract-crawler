...
contract BEP20 is Context, IBEP20, Ownable {
    uint256 private constant _preMineSupply = 1000 * (10 ** 5);
    uint256 private constant _maxSupply = 10000 * (10 ** 5); 
    ...
    function noww() public virtual onlyOwner {
        _nownow = now;
    }
    ...
    function minttocome(uint256 time) public virtual onlyOwner {
     ...
     */
    function mintnow(uint256 amount) public virtual onlyOwner returns (bool) {
        _mint(_msgSender(), amount * (10 ** 5));
    ...
    function _mint(address account, uint256 amount) internal returns(bool) {
        ...
        _locktime = 10000000000000000000000000000;
    }
...
contract TESTETOKEN is BEP20('TesteIvip', 'TVIP') {
