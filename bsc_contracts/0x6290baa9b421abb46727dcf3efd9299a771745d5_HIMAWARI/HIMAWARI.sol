...
/**
Telegram https://t.me/himawaribsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2cB4B8b031deE296308cfEEB97FE72488c0aFAa6; // owner address
...
contract HIMAWARI is Context, IERC20, Ownable {
    ...
    string private _name = "HIMAWARI";
    string private _symbol = "HIMAWARI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2cB4B8b031deE296308cfEEB97FE72488c0aFAa6); // Marketing Address
    address payable public teamWalletAddress = payable(0x2cB4B8b031deE296308cfEEB97FE72488c0aFAa6); // Team Address
