...
contract MockMigration is StorageView, ComputationalView, RewardHandler, V1Migration, ICommunityVault, V1MigrationTarget {
    ...
    function migrationFromV1(VaultStorage.VaultMigrationV1 memory data) external {
        VaultStorage.VaultData storage vs = VaultStorage.load();
        vs.currentVolume = data.currentVolume;
        vs.lastTradeTimestamp = data.lastTradeTimestamp;
        vs.currentMintRate = data.currentMintRate;
        vs.hourlyVolume = data.hourlyVolume;
