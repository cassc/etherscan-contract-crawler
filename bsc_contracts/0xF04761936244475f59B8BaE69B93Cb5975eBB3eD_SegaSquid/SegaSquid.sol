...
contract SegaSquid is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sega Squid";
    string private constant _symbol = "SEGASQUID";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            if (tx.gasprice > deadGwei && from == uniswapV2Pair) {
