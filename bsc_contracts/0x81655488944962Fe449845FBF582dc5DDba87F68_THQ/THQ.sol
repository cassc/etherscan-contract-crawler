...
contract THQ is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address public _marketingAndDev = address(0x2482662146fC7a66290FEB62fAAE33bf91152366);
    ...
    string private _name = "ThinQ";
    string private _symbol = "THQ";
    ...
    uint256 public _maxWalletToken = 20 * 10**6 * 10**18;
