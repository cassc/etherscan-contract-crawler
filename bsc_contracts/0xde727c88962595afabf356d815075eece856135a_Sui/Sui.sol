...
contract Sui is Context, IERC20, Ownable {
    ...
    string private _name = "Sui";
    string private _symbol = "Sui";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC99001eF9B43Ae28Be35a6D162A7e29CF1799DbE); // Marketing Address
    address payable public teamWalletAddress = payable(0xC6d30F6a5F92A510Bc10e7A626679Bc066Ed9D34); // Team Address
    ...
    uint256 private _totalSupply = 2000000 * 10**6* 10**_decimals;
