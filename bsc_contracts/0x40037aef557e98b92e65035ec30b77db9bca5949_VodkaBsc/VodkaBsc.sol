...
contract VodkaBsc is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address DEAD                                = 0x000000000000000000000000000000000000dEaD;
    address ZERO                                = 0x0000000000000000000000000000000000000000;
    address public marketingFeeReceiver         = 0x2Dd468C34a7C0d1811A40DDE38Cd838785f98224;

    string  _name                               = "Vodka Bsc";
    string  _symbol                             = "$VODKA";
