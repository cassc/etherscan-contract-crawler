...
contract WagmiPepe   is Context, IERC20, Ownable {
    ...
    string private _name = " Wagmi Pepe ";
    string private _symbol = " WAGMIPEPE "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x906F15c9bbE39a74a296314aF81CDb1B8D7a95FD); 
    address payable public teamWalletAddress = payable(0x906F15c9bbE39a74a296314aF81CDb1B8D7a95FD); 
