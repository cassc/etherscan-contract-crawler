...
contract PEPEQuestToken is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    PEPEQuestTokenDividendTracker public dividendTracker;
    ...
    address payable public _marketingWalletAddress = payable(0x0BC4b45aB28d8c10407D0Bd70e92B7d17749f8F7);
    address payable public _buybackWalletAddress = payable(0xc654C9c3dC1a71f42D091C7B4CbE0C8A19e7F0E7);
    ...
    constructor() BEP20("PEPE Quest Token", "PEPEQ") 
    {
        dividendTracker = new PEPEQuestTokenDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "PEPEQuestToken: The dividend tracker already has that address");
        PEPEQuestTokenDividendTracker newDividendTracker = PEPEQuestTokenDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "PEPEQuestToken: The new dividend tracker must be owned by the PEPEQuestToken token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "PEPEQuestToken: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "PEPEQuestToken: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PEPEQuestToken: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "PEPEQuestToken: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "PEPEQuestToken: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "PEPEQuestToken: Cannot update gasForProcessing to same value");
...
contract PEPEQuestTokenDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("PEPEQuestToken_Dividend_Tracker", "PEPEQuestToken_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "PEPEQuestToken_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "PEPEQuestToken_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PEPEQuestToken contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "PEPEQuestToken_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "PEPEQuestToken_Dividend_Tracker: Cannot update claimWait to same value");
