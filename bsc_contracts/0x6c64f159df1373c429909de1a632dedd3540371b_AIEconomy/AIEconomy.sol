...
contract AIEconomy is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 200 * 10**8 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "AI Economy";
    string private _symbol = "AEC";
    uint8 private _decimals = 18;
    
    address mainAddress = 0x81f3c23f3B7C5C7C25C79591D00373c989a3B4F1;
    
    uint256 public _taxFee = 2;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _poolFeeA = 2;
    uint256 private _previousPoolFeeA = _poolFeeA;
    address public _poolAddressA = 0xc9Fb0d36537d0e4f413cE81444c2c7897b1bc493;

    uint256 public _poolFeeB = 1;
    ...
    uint256 public _maxTxAmount = 200 * 10**8 * 10**18;
    uint256 public numTokensSellToAddToLiquidity = 500 * 10**4 * 10**18;
    ...
    function _transfer(
		...
		require(!isBlacklist[from],"ERC20: sender is blacklisted");
