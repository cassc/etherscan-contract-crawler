...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DATBOI = IBEP20(0x5F2eEcEEC35353420F6A8c89E366e741cc1a52d6);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DATBOI.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(DATBOI);
        ...
        uint256 amount = DATBOI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            DATBOI.transfer(shareholder, amount);
...
contract BabyDatBoi is IBEP20, Auth {
    using SafeMath for uint256;

    address DATBOI = 0x5F2eEcEEC35353420F6A8c89E366e741cc1a52d6;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby DatBoi";
    string constant _symbol = "BDatBoi";
    ...
    constructor (
        ...
        autoLiquidityReceiver = 0x40D6842DD02869577bCFd7A729F0F35F01Ac272f;
        marketingFeeReceiver = 0x40D6842DD02869577bCFd7A729F0F35F01Ac272f;
