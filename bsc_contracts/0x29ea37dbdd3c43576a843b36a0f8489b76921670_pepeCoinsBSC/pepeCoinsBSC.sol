 ...
 * https://t.me/pepecoinsBSC
 * https://pepecoinsBSC.com
 * https://twitter.com/pepecoinsBSC
 *
 * Pepecoin is a cryptocurrency founded in 2016 as a parody of the popular meme Pepe the Frog. 
 * It is based on the Scrypt mining algorithm and has a maximum supply of 100 billion coins.
 *
 * The BSC version has been created to buyback the supply from the ETH OG version and redistribute
 * rewards to its holders in the ETH token $pepecoin.
 *
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡤⠚⠛⠛⠲⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⡠⠔⠚⠉⠙⠒⢶⠋⠀⠀⠀⣠⠴⠚⠉⠒⠲⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⡜⠁⠀⠀⢀⡤⠔⠚⠛⠒⠲⣏⠀⠀⡠⢖⣿⣯⣭⣷⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
contract pepeCoinsBSC is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "pepeCoinsBSC";
    string private _symbol = "pepecoins";
    ...
    constructor () {
        ...
        marketing = payable(address(0x1556B4827748B0E5CD02718e0da5606a50357Bc1));
    }
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        uint256 swapFee = amount.mul(12).div(100);
