...
contract Health is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address diviAddr;
        superA = msg.sender;
        uint256 totalSupply_ = 100000000e18;
      
        _marketingWalletAddress = 0x60A32609d5e0dFF62fCA3F9C3DA5e611deFC8dDD;
          if( block.chainid == 56){
                _token = 0x55d398326f99059fF775485246999027B3197955 ;
                router = 0x10ED43C718714eb63d5aA57B78B54704E256024E ;
                adminAddress = 0xDEC9Ce8b5281a3a4AfEf1eA9e3db21D5de8AD38A ;
                diviAddr = 0x8e268141DaF54aA1fcdB5574A72feB0eC2fC3970 ;
                risc = 0x932D73Dccdb2a6B4F06FD8436f29e42CaE33d26a ;
        }else{
    ...
    function _transfer(
        ...
        if (
            ...
            swapping = true;
                ...
                swapRISCTokensForTokens( usdtBalance/2 );
                IERC20(_token).transfer(_marketingWalletAddress,usdtBalance*1/20);
   ...
   function swapRISCTokensForTokens(uint256 tokenAmount) public {
        if(tokenAmount == 0) {
            return;
        }
