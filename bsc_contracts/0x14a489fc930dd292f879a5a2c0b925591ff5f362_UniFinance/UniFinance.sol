...
contract UniFinance is ERC20, Ownable {
    ...
    address public marketingWallet = 0x08f58ba2333DB8c4347b1dee99edcCBa770D0BfA;
    ...
    constructor() ERC20("Uni Finance", "UNI") {
        _tokengeneration(msg.sender, 560000000 * 10**decimals());
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity) <= 10, "Must keep fees at 5% or less");
    }
