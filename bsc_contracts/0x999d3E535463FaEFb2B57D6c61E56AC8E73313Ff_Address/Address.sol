...
contract spark is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = 0x2F26364C5AB40EA08Cbf8e593d8FA722af8A46DB; // Marketing Address
	address payable public burningAddress = 0x0000000000000000000000000000000000000000; // burn Address
	address payable public devAddress = 0x2F26364C5AB40EA08Cbf8e593d8FA722af8A46DB; // Dev Address
    ...
    uint256 private minimumTokensBeforeSwap = 6900000000 * 10**9; 
