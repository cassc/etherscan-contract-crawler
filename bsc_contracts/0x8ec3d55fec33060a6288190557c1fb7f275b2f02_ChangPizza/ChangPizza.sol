...
contract ChangPizza is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x48Be99f1aeA827130b90AAc16b71395D3A3f8aCb);

    string public _name = "ChangPizza";
    string public _symbol = "ChangPizza";
    ...
    uint256 private fee_totals = 18;
    uint256 public buying_fee = 9;
