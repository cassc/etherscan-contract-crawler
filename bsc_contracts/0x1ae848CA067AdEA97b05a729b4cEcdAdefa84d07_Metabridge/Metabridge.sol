...
Meta Bridge Coin is a DAO (Decentralized Autonomous Organization) platform built on top of Binance 
...
MBC token is designed to be used in the payment of Metaverse gaming tools like dresses, equipment, weapons, 
...
contract Metabridge is Context, IBEP20, Initializable {
    ...
    constructor() public {
      ...
      IPancakeswapV2Router02 _pancakeRouter = IPancakeswapV2Router02(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
   ...
   */
    ...
    /**
    * @dev called by the owner to update reflection percentage
    */

    function update_reflectionsPer(uint256 reflectionsPer) onlyOwner public {
    ...
    */
    ...
    function update_marketingWalletAddress(address marketingWalletAddress) onlyOwner public {
        ...
        reflectionHolders.push(marketingWalletAddress);
    ...
    */
    ...
    /**
    * @dev called by the owner to update liquidity wallet address
    */

    function update_liquidityWalletAddress(address liquidityWalletAddress) onlyOwner public {
        _liquidityWalletAddress = liquidityWalletAddress;
        emit UpdateLiquidityWalletAddress();
    }

    /**
    * @dev called by the owner to update liquidity percentage
    */

    function update_liquidityPer(uint256 liquidityPer) onlyOwner public {
        _liquidityPer = liquidityPer;
        emit UpdateLiquidityPer();
    }

    /**
    * @dev called by the owner to update burn percentage
    */

    function update_burnPer(uint256 burnPer) onlyOwner public {
        _burnPer = burnPer;
        emit UpdateBurnPer();
    }
    ...
    */
    ...
    /**
    * @dev called for check account is excluded for fee or not
    */ 
    ...
    /**
    * @dev called by the owner to update reflection status
    */
    ...
    */
    ...
    /**
    * @dev called by the owner to include address in reflection
    */
   ...
   */
    ...
    */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
      ...
      _totalBurnet=_totalBurnet.add(_burnValue);
