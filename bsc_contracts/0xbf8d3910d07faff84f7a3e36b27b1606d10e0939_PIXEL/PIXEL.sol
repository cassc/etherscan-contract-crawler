...
contract PIXEL is IERC20, Context, Ownable {
    ...
    address private Marketing_Wallet = 0x16a279f244A712b5f02a2678c7E7430FFB915683;
    address private Team_Wallet = 0x16a279f244A712b5f02a2678c7E7430FFB915683;
    
    string private constant _symbol = "PX";
    string private constant _name = "PIXEL";

    uint256 private max_BuyLimit = 10000000000 * 10**9;
    uint256 private max_SellLimit = 20000000000 * 10**9;

    uint256 private max_WalletLimit = 20000000000  * 10**9;
    ...
    Taxes public sellTaxes = Taxes(0, 45, 1, 0);
    Taxes public taxes = Taxes(0, 20, 1, 0);
