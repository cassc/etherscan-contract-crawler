...
contract DaddyBNBTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DaddyBNBTiger";
    string private _symbol = "DaddyBNBTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2e62824ea38aa6e91C80988CA6EcE0AfCE44C8E8); // Marketing Address
    address payable public teamWalletAddress = payable(0x2e62824ea38aa6e91C80988CA6EcE0AfCE44C8E8); // Team Address
