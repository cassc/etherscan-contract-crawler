...
contract Floki_Punk is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Floki Punk";
    string private constant _symbol = unicode"FlokiP";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x65dAE834686FA4B2af0270CF598cDf8745e15Ab7);
    address payable public MarketingWallet = payable(0x65dAE834686FA4B2af0270CF598cDf8745e15Ab7);
