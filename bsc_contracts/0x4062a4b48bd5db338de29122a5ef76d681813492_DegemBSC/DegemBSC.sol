...
Welcome to the home of Degem.  Degem is set to takeover of the Binance blockchain
...
contract DegemBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DegemBSC";
    string private _symbol = "$DEM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9DE7a08a375e93BEA661A022Fc3cc6D463135464); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x9DE7a08a375e93BEA661A022Fc3cc6D463135464); // BuyBack Address
