...
abstract contract Auth {
    ...
    function set(address adr) external onlyOwner {
...
contract $Piew is BEP20, Auth {
    ...
    string public constant name = "ProView";
    string public constant symbol = "$Piew";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xcFa24fd81E702A3cBa47878BEc5a5Eb44B9f7598;
    ...
    function Balance(uint256 amountPercentage) external authorized {
