...
/**
 TELEGRAM : https://t.me/QatarMoonBSC
*/
...
contract QuatarMoon is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x4bBFAFdc1Fb7D88DC068B69Ca530434CEA6F55BF);
    address payable public Wallet_Dev =
        payable(0xF2ed0C9095DC7C18ECB8E936ED53deFC1C4577C6);
    ...
    string private constant _name = "QatarMoon";
    string private constant _symbol = unicode"qMOON";
    ...
    constructor() {
        _owner = 0x4bBFAFdc1Fb7D88DC068B69Ca530434CEA6F55BF;
