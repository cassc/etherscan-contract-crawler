 ...
 *
*/
// MARTIN SHREKLI DEV Yamamoto Akihiro, Last project 70M
//Join our telegram! https://t.me/DogeBmwPortal
...
contract DOGEBMW is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Bmw";
    string private _symbol ="$DOGEBMW";
    ...
    uint256 public _TreasuryFeeBuy = 2;
    uint256 public _LiquidityFeeSell = 0;
    uint256 public _TreasuryFeeSell = 2;
