...
Telegram :   https://t.me/scryptNetwork
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =  0x2310a96D11f0bAc28f96f573374F1d303A08a4F5; 
...
contract CTN is Context, IERC20, Ownable {
    ...
    string private _name = "SCRYPT NETWORK";
    string private _symbol = "CTN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x9c93C3A1c9D9DafcBfdFBcEdcF00cE20B5892B61); // 
    address payable public teamWalletAddress = payable(0x9c93C3A1c9D9DafcBfdFBcEdcF00cE20B5892B61); // 
