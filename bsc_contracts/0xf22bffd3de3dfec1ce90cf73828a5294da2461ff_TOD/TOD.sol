...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x4f833cc89Ad9f2C300288B3C7a26927a473458a2);
...
contract TOD is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x0582335b5259b3469e02e0e900bD765B812A7aeA;

    string constant _name = "$TOD";
    string constant _symbol = "$TOD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 420000 * 10**6 * 10**_decimals;
