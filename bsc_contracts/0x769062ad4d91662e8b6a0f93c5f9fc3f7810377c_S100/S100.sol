...
// Наш сайт https://skills100.net/

// Контакт телеграм @S100_Token

// Обучение криптовалютам, блокчейну, арбитражу и тд...
...
contract S100 is Context, IERC20, Ownable {
    ...
    string private _name = "SKILLS 100";
    ...
    address payable public marketingWallet = payable(0x0549d9Eef97c200300a3432B52F20853D577E145);
    ...
    uint256 public numTokensSellToAddToLiquidity = 333 * 10**18;
