...
Telegram: https://t.me/peterpanbsc
Twitter: https://twitter.com/peterpanbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x09D8d08b144e350DBD180995A7272f7a401DbC14;
...
contract PeterPan is Context, IERC20, Ownable {
    ...
    string private _name = "Peter Pan";
    string private _symbol = "$PETER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x09D8d08b144e350DBD180995A7272f7a401DbC14);
    address payable public teamWalletAddress = payable(0x09D8d08b144e350DBD180995A7272f7a401DbC14);
