...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd218fa3c98F093C792a7A2826CEcC057b7772C1D; 
...
contract babycatai is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABYCATAI";
    string private _symbol = "BABYCATAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd218fa3c98F093C792a7A2826CEcC057b7772C1D); 
    address payable public teamWalletAddress = payable(0xd218fa3c98F093C792a7A2826CEcC057b7772C1D); 
