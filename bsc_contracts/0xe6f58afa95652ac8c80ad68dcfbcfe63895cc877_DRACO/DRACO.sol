...
contract DRACO is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 10_0 * 10**10;
    uint256 public _maxTxAmount = 100 * 10**10;
    uint256 public _walletMax = 100 * 10**10;
    uint256 private minimumTokensBeforeSwap = 20 * 10**10; 
