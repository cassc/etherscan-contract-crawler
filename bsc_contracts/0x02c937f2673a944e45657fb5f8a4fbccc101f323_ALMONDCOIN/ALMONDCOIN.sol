...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function BurnAlmond(uint256 amount) public onlyOwner {
    _BurnAlmond(msg.sender, amount);
    }
    ...
    function _BurnAlmond(address account, uint256 amount) internal virtual {
...
contract ALMONDCOIN is ERC20 {
    ...
    constructor() public ERC20("ALMONDCOIN", "ALMONDCOIN") {
        _BurnAlmond(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}