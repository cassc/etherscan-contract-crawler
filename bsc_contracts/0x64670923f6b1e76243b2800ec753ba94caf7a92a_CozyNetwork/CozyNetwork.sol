...
/**
Stealth Launch - Cozy Network


🌐 Website   : https://cozynetwork.app/
📰 Medium    : https://medium.com/@cozynetworktoken
🐱 Github    : https://github.com/cozynetwork
🕊Twitter     : https://twitter.com/cozynetworkbsc
✉️ Group     : https://t.me/cozyNetwork
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE0d8Ff1633f072Dd74e3565595283707ba980860;
...
contract CozyNetwork is Context, IERC20, Ownable { 
    ...
    string private _name = "Cozy Network"; 
    ...
    uint256 private _previousBuyFee = _taxFee; 
    ...
    */
    ...
    address payable public Wallet_Marketing = payable(0xE0d8Ff1633f072Dd74e3565595283707ba980860);
    ...
    uint256 private maxPossibleFee = 10 * 10**6; 
    uint256 private _TotalFee = 10 * 10**6;
    ...
    function _set_Fees(uint256 tax_Fee, uint256 Sell_Fee) external onlyOwner() {

        require((tax_Fee + Sell_Fee) <= maxPossibleFee, "");
        _sellFee = Sell_Fee;
        _taxFee = tax_Fee;
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/20000;
    }    
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/20000;
    }

    function removeAllFee() private {
        if(_TotalFee == 0 && _taxFee == 0 && _sellFee == 0) return;

        _previousBuyFee = _taxFee; 
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
        } else if (from == uniswapV2Pair){_TotalFee = _taxFee;} else if (to == uniswapV2Pair){_TotalFee = _sellFee;}
    ...
    function remove_Random_Tokens(address random_Token_Address, address send_to_wallet, uint256 number_of_tokens) public onlyOwner returns(bool _sent){
        require(random_Token_Address != address(this), "");
