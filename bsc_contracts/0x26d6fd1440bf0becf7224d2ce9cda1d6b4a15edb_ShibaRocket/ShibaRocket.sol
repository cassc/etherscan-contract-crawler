...
/*
TG : http://t.me/ShibaRocketbsc
Twitter : https://twitter.com/ShibaRocketBNB
Website: www.shibarocket.live & Having fun on the way to the moon
CARLOS/DEV make 1 more MoonyShot :)
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); //BTCB
...
contract ShibaRocket is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Shiba Rocket";
    string constant _symbol = "$SBR";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //BTCB
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xA0Ef5F1B1416Ee9b0B37E9CfF59bC2fc6D5B86f8;
        devWallet = 0xA0Ef5F1B1416Ee9b0B37E9CfF59bC2fc6D5B86f8;
