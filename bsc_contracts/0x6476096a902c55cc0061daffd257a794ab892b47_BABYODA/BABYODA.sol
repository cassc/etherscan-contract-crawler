...
// website: http://babyoda-bsc.trade/
// tg: https://t.me/babyodaportal
...
/* Token contract */
contract BABYODA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x817Fbc867333e2aD460bD13bE4A4eB867F8A3FDB;
    ...
    // Name and symbol
    string constant _name = "Baby Yoda";
    string constant _symbol = "BABYODA";
    ...
    uint256 public swapThreshold = _totalSupply * 65 / 10000; // 0.25%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xA2D567Bf01c9Efb2964604a08FCc47A8d6174b6b;
