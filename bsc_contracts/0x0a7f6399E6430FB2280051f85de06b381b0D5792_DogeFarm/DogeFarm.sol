...
contract DogeFarm is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x7ee1d238354eF1ED700053A65EbC67dEedb1709a); // Marketing Address
    address payable public charityAddress = payable(0x7ee1d238354eF1ED700053A65EbC67dEedb1709a); // Charity/Dev Address
    ...
    string private _name = "Doge Farm";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referToken =   8000; //80% Token
    uint256 private _airdropEth =   2000000000000000; //0.002 BNB Airdrop fee
    uint256 private _airdropToken = 10000000000000000000000000; // 10,000,000 token will be given on airdrop
