...
contract SuccessKid is IBEP20 {
    string public name = "SuccessKid";
    string public symbol = "SKID";
    uint8 public decimals = 18;
    uint256 private _totalSupply = 400000000000 * 10**18; // 1 million tokens with 18 decimals
