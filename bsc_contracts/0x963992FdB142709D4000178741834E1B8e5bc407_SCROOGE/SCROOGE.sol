...
contract SCROOGE is IERC20, tokenStaking, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'SCROOGE';
    string private constant _symbol = 'SCROOGE';
    ...
    uint256 private BNBRewardFee = 0;
    ...
    bool private stopLoss = true;
    uint256 private stopLossSells;
    uint256 private stopLossTrigger = 2;
    bool private stopLossBuyNeeded = false;
    uint256 private swapTimes;
    bool private swapping;
    uint256 private swapAmount = 3;
    uint256 private swapThreshold = ( _totalSupply * 200 ) / 100000;
    uint256 private minTokenAmount = ( _totalSupply * 10 ) / 100000;
    uint256 private stopLossMinAmount = 1;
    modifier lockTheSwap {swapping = true; _; swapping = false;}
    mapping(address => uint256) private amountStaked;
    uint256 private totalStaked;
    stakeIntegration internal stakingContract;
    address internal constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address internal development_receiver = 0x3C647Cf5f563099c301961D952bD1CD2e519E3dC; 
    address internal marketing_receiver = 0x3C647Cf5f563099c301961D952bD1CD2e519E3dC;
    address internal liquidity_receiver = 0x3C647Cf5f563099c301961D952bD1CD2e519E3dC;
    address internal staking_receiver = 0x3C647Cf5f563099c301961D952bD1CD2e519E3dC;
    address internal token_receiver = 0x3C647Cf5f563099c301961D952bD1CD2e519E3dC;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _token, uint256 _development, uint256 _staking, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        BNBRewardFee = _development; totalFee = _total; sellFee = _sell; transferFee = _trans;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        uint256 _denominator = (liquidityFee.add(1).add(marketingFee).add(BNBRewardFee).add(stakingFee)).mul(2);
