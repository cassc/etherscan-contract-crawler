...
/**
TG https://t.me/+UJYjWQ4iAdwwODJl
*/
...
contract PepeGrow is IBEP20, Auth {
    ...
    uint256 _totalSupply = 100000000000 * (10 ** _decimals); //100 million total supply 
    ...
    Taxes public sellTaxes = Taxes(1,8);
    ...
    address public marketingFeeReceiver = 0x734C9Fa64E0650EDA3B7C05c7ad2B426A6e698Ac;
    ...
    uint256 public swapThreshold = _totalSupply / 1000000 * 60; 
    bool inSwap;
