...
contract BullBNB is ERC20, Ownable {
    ...
    constructor () ERC20("BULLBNB", "BBNB") 
    ...
    {   
        ...
        marketingWallet = 0x956Ca8e1E90F3ABA4f13f77d7d2B317E34111f3a;
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_totalFeesOnBuy + _totalFeesOnSell <= 15, "Total Fees cannot be more than 15%");
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner {
        require(_walletToWalletTransferFee <= 15, "Wallet to Wallet Transfer Fee cannot be more than 15%");
