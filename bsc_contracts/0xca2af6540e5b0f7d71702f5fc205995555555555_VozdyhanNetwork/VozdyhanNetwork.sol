...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF9eCB248d9d7e51Ab151c56ed7b0C61fe111Cb2f; // owner address
...
contract VozdyhanNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vozdyhan Network";
    string private _symbol = "VN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF9eCB248d9d7e51Ab151c56ed7b0C61fe111Cb2f); // Marketing Address
    address payable public teamWalletAddress = payable(0xF9eCB248d9d7e51Ab151c56ed7b0C61fe111Cb2f); // Team Address
