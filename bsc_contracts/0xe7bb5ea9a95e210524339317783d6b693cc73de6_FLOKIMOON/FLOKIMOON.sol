...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEA0Da8eE8EB33bE30c91FdFdf6E615C2F5187aa1; // owner address
...
contract FLOKIMOON is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKI MOON";
    string private _symbol = "FLM";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xEA0Da8eE8EB33bE30c91FdFdf6E615C2F5187aa1); 
    address payable public teamWalletAddress = payable(0xEA0Da8eE8EB33bE30c91FdFdf6E615C2F5187aa1);
