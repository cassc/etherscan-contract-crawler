...
contract CK_Stake is OwnableUpgradeable {
    ...
    function setClaimStatus(bool b) external onlyOwner {
        claimStatus = b;
    }
    ...
    function setBlack(address[] memory addr, bool b) external onlyOwner {
    ...
    function claimReward() external onlyEOA rateChange {
        ...
        require(claimStatus, 'market port is repairing');
