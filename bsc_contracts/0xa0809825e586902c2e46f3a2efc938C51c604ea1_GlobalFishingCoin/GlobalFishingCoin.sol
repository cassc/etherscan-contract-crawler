...
contract GlobalFishingCoin is Context, IERC20, Ownable {
    using Address for address;
    using SafeMath for uint256;

    string private _name = "Global Fishing Coin";
    string private _symbol = "GFC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd15b2143CAeb049173D7B584aA800345460869Be); // Marketing Address
    address payable public teamWalletAddress = payable(0xd15b2143CAeb049173D7B584aA800345460869Be); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1* 10**19;
