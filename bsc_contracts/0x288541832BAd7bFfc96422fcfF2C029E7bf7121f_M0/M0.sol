...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _dividendThreshold = 1000 ether;
    uint256 public _sellFundFee = 190;
    uint256 public _sellLPFee = 60;
    ...
    constructor (
        ...
        maxBuyAmount = 10000000000000000000000000000 * 10** Decimals;
        walletLimit =  10000000000000000000000000000 * 10** Decimals;
...
contract M0 is AbsToken {
    constructor() AbsToken(
        ...
        "M0",//Symbol
        18,//Decimals
        10000000000000000000000000000,//Supply
        address(0xCc2B76989585a8F474075EDB6Ac426b7b38CD7a7),//FundAddress
        address(0xA710A2A09fb10e26Ba343Af763F8BAae31aC68CD)//ReceiveAddress
