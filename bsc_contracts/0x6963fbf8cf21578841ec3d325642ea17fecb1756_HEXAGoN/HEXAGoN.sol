...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9619e7aE230A7f7e0738F7aE0515658D0C6f323b; // owner address
...
contract HEXAGoN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HEXAGON CHAIN";
    string private _symbol = "HEXAGON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9619e7aE230A7f7e0738F7aE0515658D0C6f323b); // Marketing Address
    address payable public teamWalletAddress = payable(0x9619e7aE230A7f7e0738F7aE0515658D0C6f323b); // Team Address
