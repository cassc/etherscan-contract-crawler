...
contract optimus is Context, IERC20, Ownable {
    ...
    string private _name = "Optimus AI";
    string private _symbol = "optimus";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4b495927ca477cd0c253D022aE30Be3f0ae77018);
    address payable public liqWalletAddress = payable(0xa177e10c7fE11cA1643023007b3bA3eFcaeac209);
