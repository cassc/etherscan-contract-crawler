...
/**
⚽️  🏆 LOW TAX WORLD CUP 🏆  ⚽️
Telegram: https://t.me/LowTaxWorldCup                                                       
*/
/*
...
contract LowTaxWorldCup is Context, IERC20, Ownable {
    ...
    string private constant _name = "LowTaxWorldCup";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if(takeFee) {
            if(sender == pancakeswapV2Pair) {
                ...
                if(sender != owner() && recipient != owner() && recipient != address(1)){
                    bool blockedSellTime = collectTheStatistics(getFromLastPurchaseBuy(sender), deadline, sender);
