...
/**
PepeRetro  | x1000 Moonshot 🚀 | PepeRetro |  Golden Age🐈 | Low MC 💠 |🧯 LPs Locked
💠PepeRetro TOKEN is born. The tastiest Pepe of them all. Don't miss this moon💠
💎 PepeRetro is a decentralized, community-focused meme token with continued marketing and development ✅

🗣 Telegram: https://t.me/PepeRetro
...
/*
 * @dev Provides information about the current execution PEPEHEXContext, including the
 ...
 */
abstract contract PEPEHEXContext {
 ...
 * the owner.
 */
abstract contract OwnablePEPEHEX is PEPEHEXContext {
...
contract PEPERETRO is PEPEHEXContext, BEP20PEPEHEX, OwnablePEPEHEX {
