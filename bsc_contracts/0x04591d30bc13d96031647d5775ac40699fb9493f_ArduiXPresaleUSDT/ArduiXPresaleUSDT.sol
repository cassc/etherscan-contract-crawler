...
contract ArduiXPresaleUSDT is Context, ReentrancyGuard {
   ...
   modifier onlyOwner() {
    ...
    constructor (uint256 __rate, address payable _wallet90, address payable _wallet10, IERC20 __token, address usdt) {
        _owner = msg.sender;
