...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address FundAddress, address secFundAddress,address ReceiveAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        isMaxEatExempt[secfundAddress] = true;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (goMoonBlock == 0 && _mainPair == to && _feeWhiteList[from] && IERC20(to).totalSupply() == 0) {
    ...
    function setsecFundAddress(address addr) external onlyOwner {
        secfundAddress = addr;
        _feeWhiteList[addr] = true;
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        9,
        7999,
        address(0xEa90eb1e14E27600f64Aa7B16e6213F0327c2777),
        address(0xEa90eb1e14E27600f64Aa7B16e6213F0327c2777),
        address(0x1949d2Ec39236312609114c5b97EF0f36b468Df9)
    ){
    }
}