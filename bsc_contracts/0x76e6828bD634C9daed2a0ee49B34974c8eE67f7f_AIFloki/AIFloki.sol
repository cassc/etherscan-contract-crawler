...
contract AIFloki is IERC20 {
    ...
    string constant private _name = "AI Floki";
    string constant private _symbol = "AIFLOKI";
    ...
    address payable public marketingWallet = payable(0x753350289a7264a25b2C799a77b6D5213f2EAcC0);
