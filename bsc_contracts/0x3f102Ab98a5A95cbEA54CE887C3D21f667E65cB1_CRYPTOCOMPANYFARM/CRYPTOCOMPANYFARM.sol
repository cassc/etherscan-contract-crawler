...
contract CRYPTOCOMPANYFARM is Context, IERC20, Ownable {
    ...
    uint256 public _maxRxAmount = 5000 * 10**_decimals;
    uint256 public numTokensToSwap = 4000 * 10**_decimals;
    ...
    string private constant _name = "Crypto Company Farm";
    string private constant _symbol = "CCF";
