...
contract CHIPS is ERC20, Ownable {
    ...
    CHIPSDividendTracker public dividendTracker;

    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD

    address public marketingWallet = 0xEb4AfDC86C9F6Af6604f3B9d5CB8B07C72b35bd6;
    address public devWallet = 0xB7D96232507e7090b3aBDc03406655892738AAd1;
    ...
    constructor() ERC20("777OnChain", "CHIPS") {

    	dividendTracker = new CHIPSDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        CHIPSDividendTracker newDividendTracker = CHIPSDividendTracker(payable(newAddress));
   ...
   /////////////////////////////////
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "CHIPS: Account is already the value of 'excluded'");
   ...
   ///////////////////////
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value, "CHIPS: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "CHIPS: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "CHIPS: Cannot update gasForProcessing to same value");
...
contract CHIPSDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()  DividendPayingToken("CHIPS_Dividen_Tracker", "CHIPS_Dividend_Tracker") {
    	claimWait = 3600;
    	minimumTokenBalanceForDividends = 10_000_000_000 * (10**decimals());
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "CHIPS_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "CHIPS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "CHIPS_Dividend_Tracker: Cannot update claimWait to same value");
