...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x77e48Ada17E48f3a5FA6b6A4dECB6ab00d7E4e27;
...
contract HunVenture is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x7b51425D04255C1FDD28137B5e7C56eF7342aCDd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HunVenture";
    string private _symbol = "HUN";
