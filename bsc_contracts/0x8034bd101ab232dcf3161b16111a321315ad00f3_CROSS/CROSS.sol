...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBf3eF52579199d0fd8307B5529C6eE8435D8Bba7; // CROSS
...
contract CROSS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CROSS";
    string private _symbol = "CROSS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBf3eF52579199d0fd8307B5529C6eE8435D8Bba7); // AIGRIMACE
    address payable public teamWalletAddress = payable(0xBf3eF52579199d0fd8307B5529C6eE8435D8Bba7); // AIGRIMACE
    ...
    uint256 public _buyMarketingFee = 21;
    uint256 public _buyTeamFee = 1;
    
    uint256 public _sellLiquidityFee = 19;
