...
contract Vendor is Ownable, ReentrancyGuard {
     ...
     */
    function buyTokenswtet(uint256 amountToBuy) public payable nonReentrant {
    ...
    function buyTokenswbusd(uint256 amountToBuy) public payable nonReentrant {
    ...
    function withdraw(address _tokenContract) public onlyOwner {
        ...
        require(
            tokenContract.transferFrom(address(this), msg.sender, ownerBalance)
        );
    }
}