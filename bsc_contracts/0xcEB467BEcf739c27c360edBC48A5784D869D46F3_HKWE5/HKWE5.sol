...
contract HKWE5 is Context, IBEP20, Ownable {
    ...
    string private _name = "HKWE5";
    string private _symbol = "HKWE5";
    ...
    uint256 public numTokensSellToAddToLiquidity = 3000000 * 10 ** _decimals;

    address public _market = 0x1023bf1993A4e0B616727F7a1Bc4E72eb3CB93F7;
