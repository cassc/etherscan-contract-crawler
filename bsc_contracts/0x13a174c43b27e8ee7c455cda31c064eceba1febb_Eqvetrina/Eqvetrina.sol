...
Telegram https://t.me/EQVETRINA
Website Https://eqvetrina.com
...
contract Eqvetrina is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EQVETRINA";
    string private _symbol = "$EVTR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFFC9eF7e4e90c23EBe9f64A60eCA7f24e06e57ED); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xbdc97DF2CDfcd1C3c9beb21252741F6D7B78578C); // BuyBack Address
