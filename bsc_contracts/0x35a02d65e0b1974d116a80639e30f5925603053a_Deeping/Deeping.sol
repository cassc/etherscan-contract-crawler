...
contract Deeping is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string private _name = "Deeping";
    string private _symbol = "DEEP";
    uint8 private _decimals = 9;

    uint8 public autorateBuy;
    uint8 public autorateSell;
    uint8 public autorateBurn;
    ...
    function changeTxSetting(address holder, bool exempt)
        external
        onlyOwner
    {
