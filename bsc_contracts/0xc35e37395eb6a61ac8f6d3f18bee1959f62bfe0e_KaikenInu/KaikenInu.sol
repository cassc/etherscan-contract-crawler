...
contract KaikenInu is Context, IERC20, Ownable {
    ...
    string private constant _name = " Kaiken Inu "; // 
    string private constant _symbol = " $KAINU "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xc8d7561C46703d2018Cec451a1a2a16fF81B6910;
