...
abstract contract Token is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 210000000 * 10 ** Decimals;
        _tTotal = total;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xBb82459A6721187Ef32e8f32e3c1d68256008a89;//fund address
...
contract UID is Token {
    constructor() Token(
        ...
        address(0xBb82459A6721187Ef32e8f32e3c1d68256008a89),//fund address
    
        address(0xBb82459A6721187Ef32e8f32e3c1d68256008a89)//dev address
    ){
