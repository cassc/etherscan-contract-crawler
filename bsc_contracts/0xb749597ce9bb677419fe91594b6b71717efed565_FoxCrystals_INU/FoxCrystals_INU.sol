...
/**
Telegram : https://t.me/FoxCrystals
*/
...
contract FoxCrystals_INU  is Context, IERC20, Ownable {
    ...
    string private constant _name = "FOX Crystal INU"; // 
    string private constant _symbol = unicode"FCINU"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 14;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0xF4FA58EAB337959E79856155D0A6C516CbaD120d;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function _Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
    ...
    function EXapproved(address account) public onlyOwner {
