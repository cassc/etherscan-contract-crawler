...
contract SafeMoonFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "SafeMoon Floki";
    string private constant _symbol = "$SMF";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 1000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 30000000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 30000000000 * 10**_decimals;
