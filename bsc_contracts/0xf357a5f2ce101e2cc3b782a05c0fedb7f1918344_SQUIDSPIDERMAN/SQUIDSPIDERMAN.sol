...
/**
https://t.me/squidspidermanportal
...
contract SQUIDSPIDERMAN is Ownable, IBEP20 {
    ...
    uint256 private gas = 4 * 1 gwei;

    string constant _name = "SQUID SPIDER MAN";
    string constant _symbol = "SSM";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xcc14B6893F2B8485af116E6E159f407d47ee787c;
        marketingWallet = 0x0974D0d72710866fB931fE4685b5131E77E2948d;
        devWallet = 0xcc14B6893F2B8485af116E6E159f407d47ee787c;
    ...
    function setWalletLimit(uint256 newLimit) external onlyOwner {
        require(newLimit >= _totalSupply * 10 / 1000,"Cannot set max wallet less than 1%");
        _walletMax = newLimit;
    }

		function changeTxLimit(uint256 newLimit) external onlyOwner {
        require(newLimit >= _totalSupply * 10 / 1000,"Cannot set max transaction less than 1%");
			_maxTxAmount = newLimit;
		}
  
    function setGas (uint256 newGas) external onlyOwner {
        require (newGas >= 99, "Max gas should be higher than 99 gwei");
        gas = newGas * 1 gwei;
    }

    function tradingStatus(bool newStatus) public onlyOwner {
	require (newStatus != false, "Cannot stop trading after launch is done");
