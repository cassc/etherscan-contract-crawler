...
contract ChinaZilla is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = "ChinaZilla";
    string private _symbol = "ChinaZilla";
    ...
    uint256 maxgasprice = 100 * 10**8;
    uint256 maxamount = (_totalSupply * 1) / 10000;
