...
https://t.me/Dollarflokiofficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x514f202320B4d19E78E635a2a334991A1C40a583; // owner address
...
contract Dollarflokiofficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dollar Floki";
    string private _symbol = "DF";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xDd6AB819673CAfe8629e108b15B37BbC6869cAB1); // Marketing Address
    address payable private teamWalletAddress = payable(0x514f202320B4d19E78E635a2a334991A1C40a583); // Team Address
