...
contract BESTDOUBLE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BEST DOUBLE", "BEST DOUBLE") {
        ...
        //maxTransactionAmount = totalSupply * 10 / 1000; // 0.2% maxTransactionAmountTxn
        maxTransactionAmount = 500000 * 1e18;
        maxWallet = totalSupply * 10 / 1000; // 0.4% maxWallet
