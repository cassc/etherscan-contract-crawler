...
WE HAVE LAUNCHED ON PANCAKESWAP! You can now trade our token freely on the market. 
🐾CA :0x4384485A03947E2d7194cfD0F189828D80f5264F

🐾CHART https://poocoin.app/tokens/0x4384485a03947e2d7194cfd0f189828d80f5264f
🐾Chart      https://www.dexview.com/bsc/0x4384485A03947E2d7194cfD0F189828D80f5264F
...
contract BabyCEO  is Contextbep20, bep20, Ownablebep20 {
    ...
    uint256 private constant _allTotalSupply = 10000 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Baby CEO';
