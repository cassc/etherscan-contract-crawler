...
contract ULTRON is Context, IERC20, Ownable {
    ...
    string private _name     = "Ultron Vault";
    string private _symbol   = "ULTRON";
    ...
    {        
        ...
        marketingWallet = 0x7dF92cB069a87d325811e045e2477D0608a6F627;
    ...
    function _takeMarketing(uint256 tMarketing) private {
        if (tMarketing > 0) {
            uint256 currentRate =  _getRate();
            uint256 rMarketing = tMarketing * currentRate;
            _rOwned[address(marketingWallet)] = _rOwned[address(marketingWallet)] + rMarketing;
            if(_isExcluded[address(marketingWallet)])
                _tOwned[address(marketingWallet)] = _tOwned[address(marketingWallet)] + tMarketing;
        }
    }
