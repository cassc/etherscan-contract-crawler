...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public numTokensSellToFund = 200000000*10**9;
...
//                }
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (block.number < startTradeBlock + bb) {
    ...
    function startTrade(uint16 _bb) external onlyOwner {
    ...
    function setbb(uint16 _bb) external onlyOwner {
        bb = _bb;
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0x184013FD1120f7Ee8734644934bcbd687c7409D1),
    
        address(0xD09475d30a56E6B843f6548A7E935661b104C799)
    ){
