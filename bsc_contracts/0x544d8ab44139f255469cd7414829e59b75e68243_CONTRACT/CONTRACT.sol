...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB25c76B134880B3474b3858bd2bC17de53c8540C; // owner address
...
contract CONTRACT is Context, IERC20, Ownable {
    ...
    string private _name = "HOBBES NETWORK";
    string private _symbol = "HONET";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB25c76B134880B3474b3858bd2bC17de53c8540C);
    address payable private teamWalletAddress = payable(0xB25c76B134880B3474b3858bd2bC17de53c8540C);
