...
contract TRUTH is Context, IERC20, Ownable {
    ...
    string private _name = "ThetruthGPT";
    ...
    uint256 public _AutoLPFee = 1;
    uint256 private _previousAutoLPFee = _AutoLPFee;

    uint256 public _MarketingFee = 4;
    address public marketingWallet = 0x4ba114FB7Bb6b0d0c6b08FC0fd061f763BF0E0f1;
    uint256 private _previousMarketingFee = _MarketingFee;
    
    uint256 public _DevelopmentFee = 4;
    address public DevelopmentWallet = 0x5158B2701757b0f35E5eA3191198163D95baAf14;
    ...
    function calculateAutoLPFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_AutoLPFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_ReflectionFee == 0 && _AutoLPFee == 0 && _MarketingFee==0 && _DevelopmentFee==0) return;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Calculate marketing and Dev amount
