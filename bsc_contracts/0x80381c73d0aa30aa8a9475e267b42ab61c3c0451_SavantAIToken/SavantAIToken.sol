...
SavantAI
Savant AI (SavantAI)
The world’s first AI meme token with USDT rewards. 
Savant AI aims to be the most marketing - centric meme token on the Binance smart chain. 
4% Low buy tax ✅ No private sale ✅ No team token ✅ CG & CMC FAST TRACK 🚀. 
AVEDEX + DEXVIEW TRENDING @ LAUNCH �
*/
...
contract SavantAIToken is SavantAIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private SavantAITeam;
    address private CharitySavantAI;
    ...
    string public override name = "SavantAI";
    string public override symbol = "SavantAI";
    ...
    constructor(uint totalSupplyValue, address SavantAITeamAddress, address CharitySavantAIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        SavantAITeam = SavantAITeamAddress;
        CharitySavantAI = CharitySavantAIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[SavantAITeam] =  totalSupply * 4 / 100;
        balances[CharitySavantAI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's SavantAITeam pot
