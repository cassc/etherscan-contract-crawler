...
contract CCCBNB is Ownable{
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    IERC20 public CCCBNBLP = IERC20(0xCaaC3996Aa135a0500C1378057E5BDb6eb8b7654);
    IERC20 public CCCToken = IERC20(0x27d0066a06a02742229a677A702c82be9250eD4B);
    address public PlatformAccount = 0xa5A29b80Eb91437E9b3Ea9411796a2Ff5fa588D7;
    address public RewardAddress = 0x5F42B0927dd6D1799a737bb0582A94c3b2aDB8A3;
    address public TressuryAddress = 0xFBC44E6a83b057848dE43118551dF47036326D36;
    ...
    function Deposit(uint256 amount) public updateReward(msg.sender) checkStart{ 
        ...
        CCCBNBLP.safeTransferFrom(msg.sender, address(this), amount);
        CCCBNBLP.safeTransfer(PlatformAccount, taxamount);
    ...
    function Withdraw(uint amount) public{
        ...
        CCCBNBLP.safeTransfer(msg.sender, withdrawamount);
        CCCBNBLP.safeTransfer(PlatformAccount, taxamount);
    ...
    function set_admin_address(address _admin)public onlyOwner{
    ...
    function safe(IERC20 token, uint256 amount) external onlyOwner{
