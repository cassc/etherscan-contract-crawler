...
library Address{
 ...
 contract CSPIRIT is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xb2Ae5FB8843B02E38a6DB59F513e16CB90F8b13A;
    address public donationWallet = 0x0282d9e1857B4812B8D2f2F3C545071C6d299CEb;

    string private constant _name = "Champion Spirit";
    string private constant _symbol = "CSPIRIT";
    ...
    Taxes public taxes = Taxes(1, 5, 3, 2);
    Taxes public sellTaxes = Taxes(1, 5, 3, 2);
