...
/*
   ___ __ __ __    ______      ___    ____     ____ __      ___   __ __ __
  //   || || ||    | || |     // \\  ||       ||    ||     // \\  || // ||
 ((    || || ||      ||      ((   )) ||==     ||==  ||    ((   )) ||<<  ||
  \\__ \\_// ||__|   ||       \\_//  ||       ||    ||__|  \\_//  || \\ ||

https://t.me/Cultoffloki
*/
...
contract CultofFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cult of Floki";
