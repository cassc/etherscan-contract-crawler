...
contract HEISAI is Context, IERC20, Ownable {
    ...
    string private _name = unicode"HE IS AI";
    string private _symbol = "$HIA";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x30670ce23FB6ea0B14529F5DE5dD1C708f34a9f8); 
    address payable public teamWalletAddress = payable(0x30670ce23FB6ea0B14529F5DE5dD1C708f34a9f8); 
