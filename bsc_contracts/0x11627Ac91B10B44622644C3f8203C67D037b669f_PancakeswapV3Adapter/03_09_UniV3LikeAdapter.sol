...
abstract contract UniV3LikeAdapter is AdapterModel {
    ...
    ) AdapterModel(_name, _swapGasEstimate) {
    ...
    function _underlyingSwap(
        ...
        //SupportingFeeOnTrasferToken
        uint256 balanceBefore = IERC20(params.tokenOut).balanceOf(pool);
        ...
        uint256 amountOut = IERC20(params.tokenOut).balanceOf(pool).sub(balanceBefore);
        return amountOut;
    }
