...
//*********************************************************************//
//
//    ______                 __                      _   ______________    
//   / ____/______  ______  / /_____  ____  _____   / | / / ____/_  __/____
//  / /   / ___/ / / / __ \/ //_/ _ \/ __ \/ ___/  /  |/ / /_    / / / ___/
// / /___/ /  / /_/ / /_/ / ,< /  __/ / / (__  )  / /|  / __/   / / (__  ) 
// \____/_/   \__, / .___/_/|_|\___/_/ /_/____/  /_/ |_/_/     /_/ /____/  
//           /____/_/                                                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1684152000;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x0E97D863cc69f10DADf4b76eBDc498a55f18eD79,0xF6755BfeD7aBE643Cd33e375ae77209460a00264];
  address public erc20Payable = 0x0E97D863cc69f10DADf4b76eBDc498a55f18eD79;
  uint256[] public payableFees = [80,20];
    ...
    , TimedDrop
{
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/4mDHYJqj7LXe1tJY8VE6/contract-metadata";
  }
...
// File: contracts/CrypkensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CrypkensContract is ERC721APlus {
    constructor() ERC721APlus("Crypkens", "CRYPK"){}
}
