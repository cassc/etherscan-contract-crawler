...
interface IERC20 {
     ...
     * allowed to spend on behalf of `owneolr` through {transferFrom}. This is
     * zero by default.
     *
     ...
     * transaction ordering. One possible sution to mitigate this race
...
contract BlackCeo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Black Ceo"; // 
    string private constant _symbol = "BLCKCEO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xF02453091Fc9fBaC7772559602F95CE1F921C178; 
