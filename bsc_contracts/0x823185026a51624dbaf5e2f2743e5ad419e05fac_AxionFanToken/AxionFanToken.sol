...
/* 
🏧 $Axion 🏧🌠Meme token 🌠
🌠https://t.me/AxionToken
🃏 Inspired by This is $AXN🃏
⤵️ Axion - Earn bitcoin dividends and a minimum 8% APY⤵️
Celebration to The world's best staking ecosystem! Up to 47% APR. #Crypto launchpad. 
#NFT Galaxy stakes. Unique Token Accelerator. 
...
🏧TG Group🏧 https://t.me/AxionToken
🏧Website    🏧 https://axion.network/
🌠Accelerator🌠 https://axion.network/accelerator
🌠 Network 🌠 https://axion.network/how-to-buy-axion
🌠 Whitepaper🌠 https://axion.network/pdf/axion-whitepaper.pdf
🌠 Stake-Nfts🌠 https://axion.network/galaxy-stake-nfts
🌠 Launchpad 🌠 https://axion.network/axion-launch
🌠 Discord🌠 https://discord.com/invite/G8YJanCnvw
...
abstract contract ContextBEPSTAKING {
...
contract OwnableBEPSTAKING is ContextBEPSTAKING {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Ownable BEPSTAKING: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "Ownable BEPSTAKING: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract AxionFanToken is ContextBEPSTAKING,  BEPSTAKING, OwnableBEPSTAKING {
    ...
    string private _name = 'Axion';
    string private _symbol = '$Axion';
