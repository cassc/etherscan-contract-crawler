    ...
    IERC721Receiver
{
    ...
    /**
     * @notice Wraps a non .bnb domain, of any kind. Could be a DNSSEC name hello.xyz or a subdomain
    ...
    /**
     * @notice Unwraps a .bnb domain. e.g. hello.bnb
     * @dev Can be called by the owner in the wrapper or an authorised caller in the wrapper
     * @param label label as a string of the .bnb domain to wrap e.g. hello.xyz would be 'hello'
    ...
    /**
     * @notice Unwraps a non .bnb domain, of any kind. Could be a DNSSEC name hello.xyz or a subdomain
     * @dev Can be called by the owner in the wrapper or an authorised caller in the wrapper
     * @param parentNode parent namehash of the name to wrap e.g. hello.xyz would be namehash('xyz')
     * @param label label as a string of the .bnb domain to wrap e.g. hello.xyz would be 'hello'
     * @param newController sets the owner in the registry to this address
     */
     ...
     * @param node namehash of the name. e.g. hello.xyz would be namehash('hello.xyz')
    ...
    /**
     * @notice Sets records for the subdomain in the BNS Registry
    ...
    /**
     * @notice Sets records for the name in the BNS Registry
