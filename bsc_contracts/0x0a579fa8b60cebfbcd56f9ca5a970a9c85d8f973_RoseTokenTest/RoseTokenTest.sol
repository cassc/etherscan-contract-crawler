...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcBB621070645116FF4a6d506ed050DAb9E9610F7; 
...
contract RoseTokenTest is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rose Test02";
    string private _symbol = "Rose02";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcBB621070645116FF4a6d506ed050DAb9E9610F7); // 
    address payable public teamWalletAddress = payable(0xcBB621070645116FF4a6d506ed050DAb9E9610F7); // 
