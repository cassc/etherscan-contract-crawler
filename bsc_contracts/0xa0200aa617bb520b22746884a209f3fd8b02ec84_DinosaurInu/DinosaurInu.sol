...
Telegram: https://t.me/dinosaurinuBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9497e2B0F87d3C254e98246195954714b8e88eAd; // owner address
...
contract DinosaurInu is Context, IERC20, Ownable {
    ...
    string private _name = "Dinosaur Inu";
    string private _symbol = "DINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9497e2B0F87d3C254e98246195954714b8e88eAd); // Marketing Address
    address payable public teamWalletAddress = payable(0x9497e2B0F87d3C254e98246195954714b8e88eAd); // Team Address
