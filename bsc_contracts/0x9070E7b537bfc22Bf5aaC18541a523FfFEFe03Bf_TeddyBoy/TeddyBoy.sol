...
contract TeddyBoy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TeddyBoy";
    string private _symbol = "$TeddyBoy";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x9adF751f74153f25c908284ddaEcaCE676781600); // Marketing Address
    address payable public teamWalletAddress = payable(0x0Dd7abA6e09EfB5AD7c0c3a59d5b28D715764Ffe); // Team Address
