...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA19479882FF0951FCd1c8428a10cc19989020FF7; // owner address
...
contract SafemoonEaster is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Safemoon Easter";
    string private _symbol = unicode"SFMNEASTER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA19479882FF0951FCd1c8428a10cc19989020FF7); // Marketing Address
    address payable public teamWalletAddress = payable(0xA19479882FF0951FCd1c8428a10cc19989020FF7); // Team Address
