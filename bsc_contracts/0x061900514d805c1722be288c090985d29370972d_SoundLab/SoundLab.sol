...
/* 
SLAB
Unique, quality sound, at your fingertips.
SoundLab is a cutting-edge AI platform for generating music and sound effects through Telegram. With a simple text input, 
users can easily create unique pieces of music and sound effects. 
Our team of experts is dedicated to delivering the best possible experience and constantly improving our technology. 
Join us in revolutionizing the music creation process.
...
contract SoundLab  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Sound Lab';
