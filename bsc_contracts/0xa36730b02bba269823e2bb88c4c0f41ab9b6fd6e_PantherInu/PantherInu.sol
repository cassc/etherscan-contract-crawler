...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x25a2A9e83BA30567347a478c291c69C646b21B85; // owner address
...
contract PantherInu is Context, IERC20, Ownable {
    ...
    string private _name = "Panther Inu";
    string private _symbol = "PINU"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x25a2A9e83BA30567347a478c291c69C646b21B85); // Marketing Address
    address payable public teamWalletAddress = payable(0x25a2A9e83BA30567347a478c291c69C646b21B85); // Team Address
