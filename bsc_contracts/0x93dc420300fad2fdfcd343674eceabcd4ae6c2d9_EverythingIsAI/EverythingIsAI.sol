...
contract EverythingIsAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Everything Is AI";
    ...
    constructor (address marketingAddress, address liquidityAddress) {
        ...
        _isExcludedFromFee[liquidityProtecter] = true;
    ...
    function _beforetakeFee(uint256 _amount, address _address) private {
