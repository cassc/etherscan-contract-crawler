...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7460eD115738797aceAf221d9747FcC48cD30B36; // owner address
...
contract PiggieInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PiggieInu";
    string private _symbol = "PIGI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3E543F62f393Ebc604772C524D94c264e77837a4); // Marketing Address
    address payable private teamWalletAddress = payable(0x7460eD115738797aceAf221d9747FcC48cD30B36); // Team Address
