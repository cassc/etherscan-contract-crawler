...
/*
There are people asking for the name, I am also a Muslim, the word inu is now a crypto term, we all know it, this is not disrespect, I have endless respect for the month of Ramadan and Muslims.
...
contract RamadanInu is IBEP20, Auth {
    ...
    address constant DEV = 0xf8cf801A8f4EbF6D93d4370B27B5F87BcCEDB03d;


    string constant _name = "Ramadan Inu";
    string constant _symbol = "$RAMADAN";
