...
import "./SigmaToken.sol";

contract TokenStaking {
    string public name = "Yield Farming / Token dApp";
    SigmaToken public sigmaToken;
    ...
    constructor(SigmaToken _sigmaToken)  payable {
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        sigmaToken.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        sigmaToken.transfer(msg.sender, balance);
    ...
    function redistributeRewards() public {
        ...
        for (uint256 i = 0; i < stakers.length; i++) {
            ...
            if (balance > 0) {
                sigmaToken.transfer(recipient, balance);
            }
        }
    }
