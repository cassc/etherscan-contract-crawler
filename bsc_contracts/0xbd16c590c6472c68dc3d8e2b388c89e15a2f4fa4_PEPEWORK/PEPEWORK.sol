...
// Pepe Pepework is a fair launch project, with no presale or pre-mine. 
// Our goal is to create a community-driven token that everyone can participate in.
// https://t.me/PepePepework
...
contract PEPEWORK is ERC20, Ownable {
 ...
 constructor() ERC20("PEPEPEWORK", "PEPEWORK") {
        ...
        maxTransactionAmount = 20 * 1e7 * 1e18; 
        maxWallet = 20 * 1e7 * 1e18; 
        ...
        devWallet = address(0xfb3671DD50F63df03DFa2083Fa1fe2FA270eEE43); 
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "Swap amount cannot be higher than 0.001% total supply."
        );
