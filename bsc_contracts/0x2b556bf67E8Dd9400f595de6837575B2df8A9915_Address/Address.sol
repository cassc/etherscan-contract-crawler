...
contract ShibAInu is IBEP20, Ownable {
    ...
    string private constant _name = 'ShibAInu Token';
    string private constant _symbol = 'SHIB-AI';
    uint8 private constant _decimals = 18;
    uint256 public constant InitialSupply= 30000000000000000000000000000;

    uint256 public sellLockTime;

    uint256 private constant DefaultLiquidityLockTime= 0;

    address public constant TeamWallet=0x2EeC5B8d1D849D26485a2De7D0f330438bbc1A1a;
    address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;
    bool antibot;

    uint256 private _circulatingSupply =InitialSupply;
    uint256 public  balanceLimit = 3000000000 * 10**_decimals;
    uint256 public  sellLimit = 3000000000 * 10**_decimals;
   ...
   function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
    ...
    function switchBot(bool disabled) public authorized{
        antibot=disabled;
    }
