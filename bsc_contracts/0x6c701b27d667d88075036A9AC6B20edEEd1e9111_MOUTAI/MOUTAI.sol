...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 private _marketShare = 20;
        ...
        if (takeFee) {
            ...
            if (isRemove) {
                ...
                if (_swapPairList[sender]){
                    ...
                    uint256 swapFee = _buyLPDividendFee + _buyLPFee;
                ...
                uint256 swapFee = _sellLPDividendFee + _sellLPFee;   
                uint256 swapAmount = (tAmount * swapFee) / 10000;
                ...
                if (!inSwap) {
                        ...
                        if (contractTokenBalance > 0) {
                            swapFee = _buyLPDividendFee + _buyLPFee + _sellLPDividendFee + _sellLPFee;
...
contract MOUTAI is AbsToken {
    constructor() AbsToken(
        ...
        address(0xc9f4f8FB75F1960685936129F386C8f3FA712222)
    ){
