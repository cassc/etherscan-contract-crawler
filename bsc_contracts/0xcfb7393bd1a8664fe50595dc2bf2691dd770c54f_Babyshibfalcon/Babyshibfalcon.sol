...
// https://t.me/babyshibfalconportal
...
contract Babyshibfalcon  is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyShibFalcon"; 
    string private constant _symbol = "BSHFLCN";
    ...
    Tax public buyTax = Tax(5,0,3);
    Tax public sellTax = Tax(7,0,3);
    
    address public treasuryWallet = 0xaD55b3F5eBfDa4a4C56f14169eE77180886A3CFe;
    address public devWallet = 0xaD55b3F5eBfDa4a4C56f14169eE77180886A3CFe;
