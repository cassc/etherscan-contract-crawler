...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x7Dbab56967D48983314F0e8b2D58815Ee47ECc4B);
        _token = msg.sender;
    }
...
contract UniPay is IBEP20, Auth {
    ...
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0xb45Ddc349Ffa0083Eb8a36ddeE64683a4f6F8a56;
    address ZERO = 0x7Dbab56967D48983314F0e8b2D58815Ee47ECc4B;
    address DEV = 0x7Dbab56967D48983314F0e8b2D58815Ee47ECc4B;

    string constant _name = "UniPay";
    string constant _symbol = "UPay";
