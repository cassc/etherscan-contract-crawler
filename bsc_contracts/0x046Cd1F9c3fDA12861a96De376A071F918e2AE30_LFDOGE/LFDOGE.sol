...
contract LFDOGE is Context, IERC20, Ownable { 
    using SafeMath for uint256;
    using Address for address;

    uint256 private _TOTAL_TAX = 18;
    uint256 public _BUYING_TAX = 9;
    uint256 public _SELLING_TAX = 9;
    ...
    string public _name = "Lo-Fi DOGE 2.0"; 
    string public _symbol = "LFDOGE";  
    uint8 private _decimals = 9;
    uint256 public _tTotal = 1 * 10**6 * 10**_decimals;

    uint256 public _maxWalletToken = _tTotal.mul(30).div(100);
    uint256 private _previousMaxWalletToken = _maxWalletToken;
    uint256 public _maxTxAmount = _tTotal.mul(15).div(100); 
    uint256 private _previousMaxTxAmount = _maxTxAmount;

    address payable private _MARKETING_ = payable(0x9A8a4Bf7c3516d6AaA6DF8775e78c6D2fC1D3244);
