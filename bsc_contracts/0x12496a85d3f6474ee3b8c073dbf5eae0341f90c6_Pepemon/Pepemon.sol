...
/** https://t.me/pepemonproject from https://t.me/pepcalls
 * 
*/ 
...
contract Pepemon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Pepemon";
    string constant _symbol = "Pepemon";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * 10**6 * 10**9;

    uint256 public _maxTxAmount = _totalSupply.mul(4).div(100);
    uint256 public _maxWalletToken = _totalSupply.mul(12).div(100);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xf5C4E64f0453A3999b470E985bF6262F92786350;
        ecosystemfeeReceiver = 0xf5C4E64f0453A3999b470E985bF6262F92786350;
