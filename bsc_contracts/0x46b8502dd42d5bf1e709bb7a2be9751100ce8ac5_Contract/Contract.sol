...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Samurai X Inu"; //
    string private constant _symbol = "Samurai X"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xFb78754edFbd245f60E8Ba0675775c78351F51cd;
