...
contract BABYJACKIE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Jackie";
    string private _symbol = "BJACKIE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x68D451ea7F241181A1420aa05386f89C310994AF); 
    address payable public teamWalletAddress = payable(0xF44ab4F292046Aee3B4a98D910EF849b015b48fc); 
