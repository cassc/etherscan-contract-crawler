...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1B369817967473B9cd2D7904A3A3A49e73493A65; // owner address
...
contract EasterSafemoon is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Easter Safemoon";
    string private _symbol = unicode"ESFMN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B369817967473B9cd2D7904A3A3A49e73493A65); // Marketing Address
    address payable public teamWalletAddress = payable(0x1B369817967473B9cd2D7904A3A3A49e73493A65); // Team Address
