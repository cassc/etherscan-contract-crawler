...
contract BUNNYGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BUNNY GPT";
    string private _symbol = "BGPT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x557ceec1c335035c8cADCE7D5e9946C4d91B6aa4); 
    address payable public teamWalletAddress = payable(0xc8b00452d4CD7D8Aa4126CE42b690C31dC7A164B); 
    ...
    uint256 public _extraFeeOnSell = 30; 
