...
contract OneFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "ONE FLOKI";
    string private constant _symbol = "1-FLOKI";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 1111 * 10**_decimals;
    uint256 public _maxTxAmount = 34 * 10**_decimals;
    uint256 public _maxWalletAmount = 34 * 10**_decimals;
