...
/**
 TELEGRAM : https://t.me/ThirdSisterBSC
*/

/**
    The union of two immutable Trends. 

    BNB and ZHAO. Our favorite hero and the most succesfull ecosystem togheter, supported by an incredible community, low taxation and a professional team. 
...
contract BNBZHAO is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xa2a5E0A902Dc66101a249aF90B980F219bf1c28d);
    address payable public Wallet_Dev =
        payable(0xd4345cE0Ac940497820604D2d7DCDAd7D57fBf42);
    ...
    string private constant _name = "BNBZHAO";
    ...
    constructor() {
        _owner = 0xa2a5E0A902Dc66101a249aF90B980F219bf1c28d;
