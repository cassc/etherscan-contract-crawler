...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x750ec2Df245879EB8CE552a0450ac8900a555c4c;
...
contract LOZA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x750ec2Df245879EB8CE552a0450ac8900a555c4c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Loza test";
    string private _symbol = "LOZAT";
