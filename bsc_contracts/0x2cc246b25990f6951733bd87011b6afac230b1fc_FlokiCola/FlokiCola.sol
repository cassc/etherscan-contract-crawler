...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x47b3b1EFE1A1edd0dAe87a9f4203427EA9F31D97; // owner address
...
contract FlokiCola is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Cola";
    string private _symbol = "$FCOLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x47b3b1EFE1A1edd0dAe87a9f4203427EA9F31D97); // 
    address payable public teamWalletAddress = payable(0x95df900a8fA21B7D54081bE8dE2FEeF5af856f8e); // 
