...
// File: contracts/InvestPrêmio.sol
...
contract InvestPremio is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MKT              = 0xdff94929B07bdBFA4Bf7E4515a7882bE9f2009E3;
    address PROJECT          = 0xE6FE78B006f337d3a1b7908293E1B8504DC2C9e1;
    address CONTRACT         = 0xd40b6B56703a5587358D6667b123F606B4457DDC;

    string constant _name    = "InvestPremio Coin";
    string constant _symbol  = "IPC";
    uint8 constant _decimals = 9;
    uint256 _totalSupply     = 500000000000000000;

    //max transaction of 20%
    ...
    uint256 public totalFee               = liquidityFee.add(reflectionFee).add(marketingFee).add(projectFee).add(burnFee);
    ...
    function setFeeDistribution(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _projectFee,  uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_burnFee).add(projectFee);
