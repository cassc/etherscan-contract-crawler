...
contract BNBSnake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBSnake";
    string private _symbol = "BNBSnake";
    ...
    uint256 public _buyTeamFee = 95;
    
    uint256 public _sellLiquidityFee = 2;
    uint256 public _sellMarketingFee = 2;
    uint256 public _sellTeamFee = 95 ;
