...
contract ALPHAGROW is IBEP20, Auth {
    ...
    string constant _name = "Alpha Grow";
    string constant _symbol = "AGROW";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100;  // 4% 最大购买
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 4% 最大钱包 
    ...
    address private marketingFeeReceiver = 0x539BD8210801EAd93EEe7Fb738cc91eB9aF9b605;
    address private teamFeeReceiver = 0xb49aa07FD343AF12A532Af400991E4c4B3A2455a;
