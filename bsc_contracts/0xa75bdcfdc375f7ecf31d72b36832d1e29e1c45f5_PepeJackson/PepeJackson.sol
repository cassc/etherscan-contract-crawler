...
contract PepeJackson is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x62C98937cCc3F1eDD872e63990409f4C722a9bb7); 
    address payable public Wallet_Dev = payable(0x62C98937cCc3F1eDD872e63990409f4C722a9bb7);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "PepeJackson"; 
    string private constant _symbol = unicode"PepeJack"; 
    ...
    constructor () {
        _owner =0x62C98937cCc3F1eDD872e63990409f4C722a9bb7;
