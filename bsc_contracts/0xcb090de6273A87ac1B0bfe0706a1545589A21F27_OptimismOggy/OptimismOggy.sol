...
contract OptimismOggy is IBEP20, Auth {
    using SafeMath for uint256;

    address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO = 0x0000000000000000000000000000000000000000;
    address constant DEV = 0x7b46e3F0758da61B1846674120378D125d4FaEF1;

    string constant _name = "OptimiSm Oggy";
    string constant _symbol = "OPO";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 1000000000000 * (10 ** _decimals);
