...
//
// SHIBAFINANCE proposes an innovative feature in its contract.
//
// 📱 Telegram:https::https://t.me/SHIBAFINANCE
//
...
contract SHIBAFINANCE is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("SHIBAFINANCE", "SHIBAFINANCE") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBAFINANCE";
    string private _symbol = "SHIBAFINANCE";
