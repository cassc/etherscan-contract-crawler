...
Telegram    : https://t.me/OneDollarToady
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA1116c6D137EDE7Ce05be3FE2e7D52e7d9a5899a;
...
contract onedollartoady is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_Dev = payable(0xA1116c6D137EDE7Ce05be3FE2e7D52e7d9a5899a);
    ...
    */
    ...
    string private _name = "One Dollar Toady"; 
    string private _symbol = unicode"$1toady";  
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require(maxPossibleFee <= maxPossibleFee, "Fee is too high!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
