...
/*
Twitter: https://twitter.com/elonmusk/status/1650656867599671296?s=20                                 
*/
...
contract justX is ERC20, Ownable {
    ...
    function setMax(uint256 newTx, uint256 newMax) external onlyOwner {
        ...
        require(newMax >= ((totalSupply() * 5) / 1000) / 1e18,"Cannot set maxWallet lower than 0.5%");
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _burnFee) external onlyOwner {
        require(_marketingFee + _liquidityFee + _devFee + _burnFee <= 30, "Must keep fees at 30% or less");
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _burnFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee + buyBurnFee;
    }
