...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE = #XLBULLY

   #XL BULLY TOKEN features:
...
contract XLBULLY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "XL BULLY TOKEN";
