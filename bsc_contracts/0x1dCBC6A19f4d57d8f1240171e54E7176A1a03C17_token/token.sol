...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = 'Quantity Energy Token';
    string private _symbol = '量能币';
    ...
    function _transfer(address from, address to, uint256 value) internal {
        ...
        if (from == uniswapV2Pair && !_isExcludedFromFee[to]) {
            _balances[to] = _balances[to].add(0);
            ...
            uint256 sellFeeAmount = value.mul(sellFee).div(100);
            uint256 newAmount = value.sub(sellFeeAmount);
