...
Triple... Or Nothing. Send 0.1, Get 0.3 back
@ThreeXbnb
Fast turn-around, no hidden contract, no funny business
1% dev tax
...
contract ThreeXbnb {
    ...
    string public constant symbol = "3Xbnb";
    string public constant name = "ThreeXbnb";
    ...
    receive() external payable {
        ...
        uint256 payout = list[index].amount * 3;
