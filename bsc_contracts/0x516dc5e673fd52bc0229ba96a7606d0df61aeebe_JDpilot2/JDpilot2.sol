...
contract JDpilot2 is ERC20Burnable, Ownable {
    ...
    uint256 private frameTotalSells = 0;
    uint256 private frameTotalBuys = 0;
    uint256 private currentTaxState = 0;
    ...
    constructor (address router, address operator) ERC20("JDPilot", "PDJ")
    {
