...
/**
    CashBOX is a token rewards for FLOKIBOX staker
    do not buy, its only can swap into FLOKIBOX, BNB, BUSD.
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x48798ed760B5f19d56daa8fBF507a2B5A6b6eeB3; // owner address
...
contract CashBOX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CashBOX";
    string private _symbol = "cBOX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72CCA530B78D6f8fb32F42Ad62d6de260FbC61bD);
    address payable public devWalletAddress = payable(0xCbbC56fE1a14Edeef519FD5ac3eA0E0Ec175C0Af);
    ...
    uint256 private minimumTokensBeforeSwap = 999999999 * 10**3; 
