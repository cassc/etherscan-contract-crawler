...
contract DigimonAlpha is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DigimonAlpha";
    string private _symbol = "DA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x60b06A27fe11031aAd28D8fB87cb6caA5E182291); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x60b06A27fe11031aAd28D8fB87cb6caA5E182291); // BuyBack Address
