...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint secfundamount = fundAmount / 3;
        uint firstfundamount = fundAmount - secfundamount;
        address secFundAddress = 0xDC792aB6F52BB581d7F88f5e4C6f6d6372b673Ec;
...
contract moonfallrabbitcoin is AbsToken {
    constructor() AbsToken(
        ...
        address(0x382a8a946842eB7a09Cdf0AfDF69e14a7aAbb027),  //营销
        
        
        address(0x122a29e65E46e6D2475aD475eCF60E0C768ef1A4) //代币接受钱包
    ){
