...
/*
加密货币是一个以费用为中心的区块链平台，旨在为用户提供安全、匿名和去中心化的金融交易。 
我们以先进的加密技术为基础，为用户提供私下交易的能力，而不会牺牲传统区块链平台的安全性或分散性。
本白皮书概述了核心功能和优势，以及它的潜在用例和未来的发展计划。

https://t.me/loopereum
https://loopereum.net
https://twitter.com/loopereum_
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc5071b3554696452178980258fa951D543E614bf; // owner address
...
contract Loopereum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Loopereum";
    string private _symbol = "Loopereum";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc5071b3554696452178980258fa951D543E614bf); 
    address payable public teamWalletAddress = payable(0xc5071b3554696452178980258fa951D543E614bf); 
