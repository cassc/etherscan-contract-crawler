...
contract queenpepe is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xDAdFDBdE9670128Db8097efB93582B7966C4dE1E);

    string public _name = "QUEEN PEPE";
    string public _symbol = "PEQUEN";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 4200000000000000000 * 10 **_decimals;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;
     
    uint256 private fee_totals = 6;
