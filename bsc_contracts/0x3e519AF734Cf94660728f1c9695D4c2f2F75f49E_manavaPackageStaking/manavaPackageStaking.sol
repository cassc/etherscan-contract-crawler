...
abstract contract PackagesManagement is Ownable {
    ...
    function changeRoundAmountManava(uint256 limit,uint256 roundNumber) public onlyOwner {
        roundIdToRound[roundNumber].amountManav = limit;
    }
...
contract manavaPackageStaking is
    PackagesManagement,
    NFTPackageStaking,
    PackagesVesting
{
