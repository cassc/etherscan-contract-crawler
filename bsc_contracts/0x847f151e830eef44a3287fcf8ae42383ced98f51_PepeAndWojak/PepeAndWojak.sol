...
contract PepeAndWojak    is IBEP20, Ownable {
    ...
    string constant _name = "Pepe+Wojak";
    string constant _symbol = "PepeWojak";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100;  //100% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 2) / 100;  //100% max wallet
    ...
    address public marketingFeeReceiver = 0x38942C1b429B6C3f6eba2ED5275626127A873C81;
