...
/**               
  🔹  Porsche Inu  🔹
💠 A Long Term Project 💠
🔹Porsche Metaverse and Car Racing game with Web3.0 infrastructure.
🔹Built on , BSC Solana, UE4, AI/ML.

🔹Our Official LINKS🔹                                     
Telegram : First Porsche Inu Find us
Website : TBA
Twitter : https://twitter.com/Porscheinu
...
| $$     | $$  | $$| $$       \____  $$| $$      | $$  | $$| $$_____/        | $$  | $$  | $$| $$  | $$
| $$     |  $$$$$$/| $$       /$$$$$$$/|  $$$$$$$| $$  | $$|  $$$$$$$       /$$$$$$| $$  | $$|  $$$$$$/
|__/      \______/ |__/      |_______/  \_______/|__/  |__/ \_______/      |______/|__/  |__/ \______/ 
*/
...
contract PorscheInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PorscheInuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Porsche Inu", "Porsche") {
        marketingWallet = payable(0x3F44891e2c5636F62261E600b197A0aABb2248BE);
        devWallet = payable(0x2583D5145955dd8E89d7194F4A156B882AB51030);
        ...
        dividendTracker = new PorscheInuDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 30; // 2%
        _maxTxAmount = totalTokenSupply / 30;
...
contract PorscheInuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PorscheInu public PorscheInuContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PorscheInuContract = PorscheInu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PorscheInu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PorscheInu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PorscheInu contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PorscheInuContract);

            uint256 prevBalance = PorscheInuContract.balanceOf(address(this));
            ...
            {
                uint256 received = PorscheInuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PorscheInuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
