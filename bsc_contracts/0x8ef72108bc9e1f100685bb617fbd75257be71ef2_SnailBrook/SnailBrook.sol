...
// t.me/SnailBrook_BSC 
// SnailBrook on Eth is Mooning! Let's full send on BSC Too! 
...
contract SnailBrook is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SnailBrook";
    string constant _symbol = "$SnailBrook";
