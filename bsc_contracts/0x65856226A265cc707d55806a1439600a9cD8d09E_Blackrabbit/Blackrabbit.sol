...
contract Blackrabbit is Context, IERC20, Ownable {
    ...
    string private _symbol = "Blackrabbit";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 1;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8D0C68bb626Fb571fD83b08Ec7d3B000A00Fc025); // Marketing Address
    address payable private teamWalletAddress = payable(0x8D0C68bb626Fb571fD83b08Ec7d3B000A00Fc025); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 10000000000 * 3 **_decimals; 
