...
contract TIFIB  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TIFIB ";
    string private _symbol = "TIFIB ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x988b8b25df46e3eAe0e7c8ee6898758B647dE424);
    address payable public teamWalletAddress = payable(0x988b8b25df46e3eAe0e7c8ee6898758B647dE424);
    address public immutable deadAddress = 0x988b8b25df46e3eAe0e7c8ee6898758B647dE424;
