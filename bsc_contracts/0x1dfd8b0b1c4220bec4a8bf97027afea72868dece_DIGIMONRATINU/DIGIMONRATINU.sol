...
TELEGRAM: https://t.me/digimonratinu
        數碼寶貝鼠飲 Chinese Community 
*/
...
contract DIGIMONRATINU   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " digimon rat inu ";
    string private _symbol = " $DGRI "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71051471E36b3dC52435a8350c03A5580a089eB3); 
    address payable public teamWalletAddress = payable(0x71051471E36b3dC52435a8350c03A5580a089eB3); 
