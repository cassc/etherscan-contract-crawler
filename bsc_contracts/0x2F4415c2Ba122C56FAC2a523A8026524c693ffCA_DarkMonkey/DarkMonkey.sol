...
contract DarkMonkey is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dark Monkey"; 
    string private _symbol = "DarkM"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8Cb25B87E9508F4A6418Eb70A38aD42a3DeAd4cA); 
    address payable public teamWalletAddress = payable(0x8Cb25B87E9508F4A6418Eb70A38aD42a3DeAd4cA); 
