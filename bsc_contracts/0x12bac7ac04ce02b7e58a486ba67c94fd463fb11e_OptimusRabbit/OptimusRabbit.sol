...
//
//
//   📱Telegram::https://t.me/+HORqXTi7i7BhMWVl
//   📱Website ::https://Optimusrabbit.com/
/*
...
contract OptimusRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("OptimusRabbit", "OptimusRabbit") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "OptimusRabbit";
    string private _symbol = "OptimusRabbit";
