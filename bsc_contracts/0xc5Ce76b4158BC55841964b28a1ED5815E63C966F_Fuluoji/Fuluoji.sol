...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4C4D6aDa14a230a96922ccc606FFcdb3994f846a;
...
contract Fuluoji is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fuluoji";
    string private _symbol = "FULUOJI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4C4D6aDa14a230a96922ccc606FFcdb3994f846a);
    address payable public teamWalletAddress = payable(0x4C4D6aDa14a230a96922ccc606FFcdb3994f846a);
