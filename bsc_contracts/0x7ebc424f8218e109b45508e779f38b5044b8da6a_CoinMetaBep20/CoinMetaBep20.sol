...
library SafeMath {
    ...
    function div(uint256 a, uint256 b, string memory errorMessage) internal pure returns (uint256) { // [email protected] 2023
        unchecked {
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAC178Dc5a9a11c4F6e6770fD8a8aa310C3b3b8a1;
...
contract CoinMetaBep20 is Context, BEP20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xAC178Dc5a9a11c4F6e6770fD8a8aa310C3b3b8a1);
    ...
    string private _name = "Coin Meta BEP20"; 
  ...
  function process_Tokens_Now (uint256 percent_Of_Tokens_To_Process) public onlyOwner {
    ...
    function remove_Random_Tokens(address random_Token_Address, address send_to_wallet, uint256 number_of_tokens) public onlyOwner returns(bool _sent){
        ...
        uint256 randomBalance = BEP20(random_Token_Address).balanceOf(address(this));
        if (number_of_tokens > randomBalance){number_of_tokens = randomBalance;}
        _sent = BEP20(random_Token_Address).transfer(send_to_wallet, number_of_tokens);
    }
