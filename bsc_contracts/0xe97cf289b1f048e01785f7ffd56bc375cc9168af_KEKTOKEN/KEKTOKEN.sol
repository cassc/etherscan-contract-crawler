...
/**
   ...
   TG GROUP：https://t.me/KEKTOKENBSC
   */
...
contract KEKTOKEN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "KEK TOKEN";
    string private _symbol = "KEK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x1a9ED0bbe71140F1bD3c815Bbaf7e928de34b689);
