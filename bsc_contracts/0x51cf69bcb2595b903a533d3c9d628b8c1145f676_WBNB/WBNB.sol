...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x07198f2Ce1b9F90237566d8D22d9129895aB3DAD;
...
contract WBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WOW BNB";
    string private _symbol = "WBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07198f2Ce1b9F90237566d8D22d9129895aB3DAD);
    address payable public teamWalletAddress = payable(0x07198f2Ce1b9F90237566d8D22d9129895aB3DAD);
