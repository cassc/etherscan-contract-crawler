...
contract JGR {
    string public constant name = "JUGAR TOKEN";
    string public constant symbol = "JGR";
    ...
    constructor() {
        ...
        stAddress = 0xa9d5f0a624e11AB7dbA2e4FD08475A7e0556B21A;
    }

    // ERC20 Functions
    function balanceOf(address account) public view returns (uint256) {
        return DB(stAddress).balanceOf(account);
    }
    ...
    function transfer(address receiver, uint256 amount) public returns (bool) {
        ...
        return DB(stAddress).transferFrom(msg.sender, receiver, amount);
    }
    function transferFrom(address tokenOwner, address receiver, uint256 amount) public returns (bool) {
        ...
        return DB(stAddress).transferFrom(tokenOwner, receiver, amount);
    }
}