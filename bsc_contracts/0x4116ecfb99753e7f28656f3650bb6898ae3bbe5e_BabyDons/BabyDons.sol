...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd9030Ab766971c830f98d6Ca3565EADabA1F9FA2;
...
contract BabyDons is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd7D2900E217eab13fE5d620F97B25c36168fe881;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabyTheDons";
    string private _symbol = "BabyDons";
