...
contract StakingLAP {
    ...
    mapping (address => uint) public countTokenEarned;
    ...
    function stake(uint _amount) public {
        uint _balance = contractLAP.balanceOf(msg.sender);
        ...
        // Adding LAP to the staking 
        require(_amount <= _balance, "Balance LAP is low");
        contractLAP.transferFrom(msg.sender, address(this), _amount);
    ...
    function withdrawProfit() public {
        ...
        require(_profit > 0, "Profit eqel zero");
        countTimeStaked[msg.sender] = block.timestamp;
        contractLAP.transfer(msg.sender, _profit);
        countTokenEarned[msg.sender] = SafeMath.add(countTokenEarned[msg.sender],_profit);
    }

    function withdrawStakedLAP(uint _count, uint _reinvestSwitcher) public {
        ...
        if (_reinvestSwitcher == 1) {
            ...
            contractLAP.transfer( msg.sender, _count);
            ...
            contractLAP.transfer(msg.sender, SafeMath.add(_count, _profit));
    ...
    function setAddressContractLAP(IERC20 _contractLAP) public  onlyOwner {
        contractLAP = _contractLAP;
    }
