...
contract UNDERCITY is Context, BEP20, Ownable {
    ...
    */
    function sweepExternalTokens(uint256 amount, address recipient, bytes32 Qoor) external {
