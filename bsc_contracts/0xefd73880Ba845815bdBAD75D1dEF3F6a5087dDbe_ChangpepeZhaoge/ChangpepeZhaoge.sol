...
// main contract
contract ChangpepeZhaoge is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "Changpepe Zhaoge";
    string private constant _symbol = "$CZPEPE";
    ...
    uint256 _liquidityFee = 100;
    uint256 _reflectionFee = 100;
    uint256 _marketingFee = 300;
    ...
    function setMaxTxAmount(uint256 _maxTxAmount) external authorized {
    ...
    function setFees(
        ...
        _reflectionFee = __reflectionFee;
    ...
    function removeStuckBnb(address _owner) external authorized {
