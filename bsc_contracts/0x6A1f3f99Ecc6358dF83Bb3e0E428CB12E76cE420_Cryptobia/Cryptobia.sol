...
contract Cryptobia is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cryptobia";
    string private _symbol = "CB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6718b3c0D8Af0E6c2cc91DEDdc51Fb177DfC4AbC); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6718b3c0D8Af0E6c2cc91DEDdc51Fb177DfC4AbC); // BuyBack Address
