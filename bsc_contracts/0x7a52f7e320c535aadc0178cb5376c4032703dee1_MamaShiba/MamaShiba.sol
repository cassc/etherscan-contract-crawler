...
contract MamaShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mama Shiba"; // 
    string private constant _symbol = " $MAMASHIBA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xad5620928c53050B33dd0BE0b3Aad36c9Cd29349;
