...
contract ScoobyInu is ERC20, Ownable {
    ...
    address public marketingWallet = 0x814F611a74C0cF9b0Aca51CD1193E7850CfaFc1E;
    ...
    constructor() ERC20("Scooby Inu", "SCOOBY") 
    {
        address newOwner = 0x507355207B243847746Fb7a283de4dEDBf190552;
        transferOwnership(newOwner);

        _mint(owner(), 100_000_000_000_000_000 * (10 ** 9));
        swapTokensAtAmount = totalSupply() / 5000;

    	dividendTracker = new DividendTracker(100_000_000_000_000_000 / 50000, rewardToken);
