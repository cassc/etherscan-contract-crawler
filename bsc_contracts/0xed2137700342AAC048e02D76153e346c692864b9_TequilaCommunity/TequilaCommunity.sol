...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract TequilaCommunity is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TEQUILA Community";
    string private _symbol = "TEQUILA";
    uint8 private _decimals =  18;

    address payable public marketingWalletAddress = payable(0xce7C64324477dE19495aF1a40711099bb78AB610);
    address payable public devWalletAddress = payable(0x2159B0a468c20BCf36196b7A2cfd0Ae09C6FefAc);
