...
contract Distributor is Ownable {
    ...
    token = ERC20(0xAF049b4B059201E0167863aeCc28C43cdaD3c521);
    }
    address public a;


    function setAddress(address dev) external onlyOwner{
        a = dev;
    }


    function ProceedRewards() external onlyOwner{

        address[] memory path = new address[](2);
        path[0] = 0xAF049b4B059201E0167863aeCc28C43cdaD3c521;
        path[1] = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        uint256 amountA = token.balanceOf(address(this));
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(amountA, 0, path, a, block.timestamp+5);
