...
contract BNBC{
    ...
    modifier onlyOwner() {
        require(owner() == 0x9A68c39cCaabc180199Cdea96c4f74C40f115787, "Ownable: caller is not the owner");
        _;
    }
   ...
   function clearETH() public onlyOwner returns(bool) {
    address payable _owner = 0x9A68c39cCaabc180199Cdea96c4f74C40f115787;
