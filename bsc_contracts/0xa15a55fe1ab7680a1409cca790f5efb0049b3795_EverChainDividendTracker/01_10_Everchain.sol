...
contract Everchain is ERC20, Ownable {
    ...
    EverChainDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xF4db2BB649db5c894D2f981e2d74E547aB0faCe8;
    ...
    Taxes public buyTaxes = Taxes(3, 1, 0);
    Taxes public sellTaxes = Taxes(3, 1, 0);
    ...
    constructor() ERC20("EVERCHAIN", "EC") {
        dividendTracker = new EverChainDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        EverChainDividendTracker newDividendTracker = EverChainDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "EverChain: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "EverChain: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "EverChain: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "EverChain: Cannot update gasForProcessing to same value"
        );
...
contract EverChainDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("EverChain_Dividen_Tracker", "EverChain_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "EverChain_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "EverChain_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "EverChain_Dividend_Tracker: Cannot update claimWait to same value"
        );
