...
abstract contract Project {
    address public marketingWallet = 0x6A4A87bc9e649Ab107291559F86670C11fF82552;
    address public treasuryWallet = 0x6A4A87bc9e649Ab107291559F86670C11fF82552;

    string constant _name = "DUTCH RABBIT";
    string constant _symbol = "DURT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 3) / 1000; // (_totalSupply * 3) / 1000 [this equals 1%]
    ...
    uint256 public swapRewardFee      = 1;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x485D37CA1c8d4e0b5b11b87604816A4843C079eD);
...
contract DUTCHRABBIT is Project, IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == pair &&
            ...
            require(cooldownTimer[recipient] < block.timestamp,"Please wait for 0min between two buys");
    ...
    function setSwapFees(uint256 _newSwapLpFee, uint256 _newSwapRewardFee, uint256 _newSwapMarketingFee, uint256 _newSwapTreasuryFee, uint256 _feeDenominator) external authorized {
        ...
        require(swapTotalFee < feeDenominator/3, "Fees cannot be more than 10%");
    }
