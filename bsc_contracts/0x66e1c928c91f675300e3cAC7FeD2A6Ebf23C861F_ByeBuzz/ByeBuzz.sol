...
Join for the truth: https://t.me/woodyOnBsc
*/         
...
contract ByeBuzz is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Woody","$WOODY")  {
        ...
        address newOwner = address(0xE76eDa771B35842f9A66864Ffa7093D52dF2513C);
    	...
    	marketingWallet = address(0xE76eDa771B35842f9A66864Ffa7093D52dF2513C); // set as mw
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xE76eDa771B35842f9A66864Ffa7093D52dF2513C),
            block.timestamp
        );
