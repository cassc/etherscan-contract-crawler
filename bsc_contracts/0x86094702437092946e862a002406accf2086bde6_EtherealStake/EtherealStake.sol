...
contract EtherealStake {
	using SafeMath for uint256;
    IERC20 public token = IERC20(0x22714c3532b4D52256f3c683e34170266b888D55); 
	uint256 constant public INVEST_MIN_AMOUNT = 5e18; // 5 USDT
	uint256[] public REFERRAL_PERCENTS 	= [600, 210, 90, 90, 60, 30, 30, 30, 30, 30];
	uint256[] public SEED_PERCENTS 		= [1000, 500, 500, 50, 50, 0, 0, 0, 0, 0];
	uint256 constant public PROJECT_FEE = 1800;
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(365, 57));
		plans.push(Plan(30, 57));
		plans.push(Plan(60, 57));
        plans.push(Plan(90, 57));
        plans.push(Plan(120, 57));
        plans.push(Plan(150, 57));
        plans.push(Plan(180, 57));
        plans.push(Plan(210, 57));
        plans.push(Plan(240, 57));
        plans.push(Plan(270, 57));
        plans.push(Plan(300, 57));
        plans.push(Plan(330, 57));
	}
