...
contract JACKALOPE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string public constant _name = "JACKALOPE COIN";
    string public constant _symbol = "LOPE";
    ...
    uint256 public marketingFee = 24;
    uint256 public rewardsFee = 21;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x076b1aaB788d016046392E5A3B08B54b43BE0d98; 
        devWallet = 0x076b1aaB788d016046392E5A3B08B54b43BE0d98; 
    ...
    function changeFeesBase1000(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newDevFee, uint256 extraSellFee) external authorized {
        ...
        require(totalFee + totalFeeIfSelling <= 250);
