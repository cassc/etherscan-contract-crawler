...
contract QuantumaniaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Quantumania Inu";
    string private constant _symbol = "QUANTUMANIA";
