...
contract DimensionalHead is Context, DimensionalHeadECO, Ownable {
    ...
    string private _name = 'Dimensional Head';
    string private _symbol = 'DHEAD';
