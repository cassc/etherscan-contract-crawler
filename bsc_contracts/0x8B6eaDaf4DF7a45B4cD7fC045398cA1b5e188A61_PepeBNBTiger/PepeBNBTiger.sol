...
contract PepeBNBTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeBNBTiger";
    string private _symbol = "PepeBNBTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF0597a09D1d70819bBec086406D1f0B88f73D05F); // Marketing Address
    address payable public teamWalletAddress = payable(0xF0597a09D1d70819bBec086406D1f0B88f73D05F); // Team Address
