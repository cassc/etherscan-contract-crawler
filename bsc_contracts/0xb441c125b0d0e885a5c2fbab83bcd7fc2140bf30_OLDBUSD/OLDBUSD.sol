...
BUSD rewards for holding 
Lets make this next 1000x token 
https://t.me/OldBUSDOff
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // BUSD BEP-20 Rewards
...
contract OLDBUSD is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "OLD BUSD";
    string constant _symbol = "OBUSD";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; 
    address RewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 ; //BUSD EEP-20 Rewards
    ...
    constructor () Ownable(msg.sender) {
        ...
        marketingWallet = 0x0dc0F9C2115E380EA9Da699304e15Cb7eCB3c3E1;  
        anothermarketingWallet = 0x0dc0F9C2115E380EA9Da699304e15Cb7eCB3c3E1;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(3).div(6);
