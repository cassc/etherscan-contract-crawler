...
/**
https://t.me/PepeTigerOfficialBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15134060D442c4ec390A40aC156089345Fa8d3fE; // owner address
...
contract PepeTigerOfficialBsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE TIGER";
    string private _symbol = "PT";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x83549fcb8e7340c68BA1a00342F578b65589AD33); // Marketing Address
    address payable private teamWalletAddress = payable(0x15134060D442c4ec390A40aC156089345Fa8d3fE); // Team Address
