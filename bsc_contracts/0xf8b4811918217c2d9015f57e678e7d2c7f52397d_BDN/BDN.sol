...
TELEGRAM : https://t.me/bulldragonBSC
WEBSITE  : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCef738C55C7Cd4B211f36485bceD0Db140ADa853; // owner address
...
contract BDN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BULL DRAGON ";
    string private _symbol = " BDN ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCef738C55C7Cd4B211f36485bceD0Db140ADa853); // Marketing Address
    address payable public teamWalletAddress = payable(0xCef738C55C7Cd4B211f36485bceD0Db140ADa853); // Team Address
