...
contract HerePepe is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2100000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Hero Pepe";
    string private _symbol = "HEROPEPE";
    ...
    uint256 public _maxTxAmount = 1900000 * 10**6 * 10**18;
