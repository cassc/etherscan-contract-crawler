...
contract TwitterCoins is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "TwitterCoins";
    string private _symbol = "TwitterCoins";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x3678516bbc1983ab1eD26318f7cc8EbB89c7983c);
