...
/**
 * Allows for contract ownership along with authorization
 */
abstract contract Auth {
    ...
    /**
     * Remove address' authorization. authorized only
     */
...
contract Herbert is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Herbert The Pervert";
    string constant _symbol = "Herbert";
