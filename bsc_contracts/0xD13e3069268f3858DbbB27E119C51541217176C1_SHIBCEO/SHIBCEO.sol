...
contract SHIBCEO is Context, IERC20, Ownable {
    ...
    address public  DividendToken = 0xa86c882c1Dc5C374D07975Ae2A0a156faA73e6Ce;
    ...
    uint256 internal _awardShare = 4;
    uint256 internal _reflectionShare = 0;

    uint256 public _total = 10;
    uint256 internal _totalDistributionShares = 5;

    uint256 public buyTokenRewardsFee = 8;
    uint256 public sellTokenRewardsFee = 8;
    uint256 public buyLiquidityFees = 2;
    uint256 public sellLiquidityFees = 2;
    uint256 public buyDeadFee = 0;
    uint256 public sellDeadFee = 0;
    uint256 public getNumberOfDividendTokenHolders = 1;
    ...
    address award, address reflection, uint256 burnfee, uint256 liquidityfee,uint256 DividendDistributorfee,uint256 rewardfee,address PancakeRouterAddress) {
        ...
        isExcludedFromFee[0x533290d4481194e865FC5b23A4536287F8dCFAe3] = true;
