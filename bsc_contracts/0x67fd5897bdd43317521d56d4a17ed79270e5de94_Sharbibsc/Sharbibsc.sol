...
Sharbi is a cryptocurrency token created on the Binance Smart Chain (BSC) after the success of Sharbi on other networks. Sharbi aims to be a decentralized and community-driven project that provides innovative solutions to the problems faced by the DeFi (Decentralized Finance) industry.

Low tax 5/5 

Join the Sharbi BSC community!



Will you follow Sharbi to moon?

Deployer: @Joris93 

Telegram: https://t.me/SharbiBSC
Website: http://sharbi-bsc.com/
Twitter: https://twitter.com/SharbiBsc
...
contract Sharbibsc is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x72407bCa568C74D40B06cBB1Cfa99f7fE59dE8FE); // Marketing Address
        
    address payable public teamAddress =
        payable(0xE2B5Def47ce7b1fa883213d41aa3Fc5505D793DC); // Team Address

    address payable public liquidityAddress =
        payable(0xEe62d2CDCB2D26bd82C2BA1263AD2C7D1082c121); // Liquidity Address
    ...
    string private constant _name = "Sharbi BSC";
    string private constant _symbol = "SHAR";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xEe62d2CDCB2D26bd82C2BA1263AD2C7D1082c121).call{value: bnbForDev}("");
