...
contract NFT is ERC721Enumerable, Ownable {
    ...
    IERC20 private _NBA;
    constructor() ERC721("NFT Of NBA", "NON") {
        _USDT = IERC20(0x55d398326f99059fF775485246999027B3197955);
        _market = 0xe980330bBEcd17e9bF16872C8D5654A92C62E5d0;
        nftMax = 2000;
    }
    ...
    function withdraw() public {
        ...
        if (user.balance > 0) {
            _NBA.transfer(msg.sender, user.balance);
            _lastBalanceToken = _NBA.balanceOf(address(this));
            user.balance = 0;
        }
        ...
        returns (uint256, uint256)
    {
        ...
        if (_NBA.balanceOf(address(this)) > _lastBalanceToken) {
            uint256 balance = _NBA.balanceOf(address(this)) - _lastBalanceToken;
