...
contract ELONDOGECEOTestGreen is ERC20, Ownable {
    ...
    address public marketingAddress = address(0x1);
    ...
    constructor() payable ERC20("Elon Doge CEO Test Green Do not buy", "ELONDOGECEOTestGreen") {
    ...
    function _transfer(
        ...
        if(canSwap && canSwapFees && !swapping && is_sell(from, to) && buyfee + sellfee > 0
        ) {
            swapping = true;
