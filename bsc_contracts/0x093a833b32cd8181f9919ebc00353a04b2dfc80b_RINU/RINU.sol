...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x14644b7cf9D201e797835f722fbf2482F3E4d3F5;
...
contract RINU is Context, IERC20, Ownable {
    ...
    string private _name = "Ramadan Inu";
    string private _symbol = "RINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdebBAfe2B5fe271530cC22785132332CC3930Cb2);
    address payable public teamWalletAddress = payable(0x14644b7cf9D201e797835f722fbf2482F3E4d3F5);
    ...
    uint256 private minimumTokensBeforeSwap = 3500000 * 10**_decimals; 
