...
contract EncryptoCoin  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'EncryptoCoin';
    string private constant _symbol = 'ENC';
    ...
    function rescuetokenBEP20(address _tadd, address _rec, uint256 _amt) external authorized {
