...
/**
Ezo flying squirrel broke 100k mcap and will break 1 mio soon ! You missed it?
No problem, the baby version is here !
...
TELEGRAM : https://t.me/BabyEzoBSC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x191516D43F1d5BBa2C4826767fa5b850B50CEE0A);
...
contract BabyEzo is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Ezo Flying Squirrel";
    string constant _symbol = "BabyEZO";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x191516D43F1d5BBa2C4826767fa5b850B50CEE0A; 
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x3Df0ccF6999dB146EdEf8f422a3E76E25B49d637;
        marketingWallet = 0xf444AE69d6A54bBFb85c518677f8022f3bF90407;
        devWallet = 0x3Df0ccF6999dB146EdEf8f422a3E76E25B49d637;
