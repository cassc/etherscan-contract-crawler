...
/**
    I would liek  to welcum you to a game of winners nd losers. First the pot runs and once there are no new buyers we will allow sellers to sell. First one to sell wins. 
    @john1null1 for updates
*/
...
contract PepePot is IBEP20, Ownable
{
    ...
    string private constant _name = "PepePot ";
    string private constant _symbol = "PPP";
    uint8 private constant _decimals = 8;
    uint256 public constant InitialSupply=  42000690000 * 10**_decimals;


    uint256 private constant DefaultLiquidityLockTime= 0;
    
    address public constant TeamWallet=0x0E365A45ae6d097df04042ee73236aC8CAe994F6;
