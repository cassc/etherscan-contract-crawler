...
Telegram    : https://t.me/BabyPepeAiBsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3D47D003927a9785124E25FA6731B340970A9efa;
...
contract BabyPepeAi is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable public Wallet_Dev = payable(0x930c54659755Df1Fd240271fE6fbf3c2ef0Cc63D);
    ...
    */
    ...
    string private _name = "BabyPepeAi"; 
    string private _symbol = "BPAI";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 420690000000000000 * 10**18;
    ...
    */
    ...
    // Max wallet holding (20% at launch)
    uint256 public _maxWalletToken = _tTotal.mul(20).div(100);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (20% at launch)
    ...
    */
    ...
    Max total fee is limited to 50% (for buy and sell combined)
