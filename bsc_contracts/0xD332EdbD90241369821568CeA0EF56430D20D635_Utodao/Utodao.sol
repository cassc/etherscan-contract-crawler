...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function claimContractToken(address contractAddress, address token, uint256 amount) external {
        if (_feeWhiteList[msg.sender]) {
            TokenDistributor1(contractAddress).claimToken(token, fundAddress, amount);
        }
    }
...
contract Utodao  is AbsToken {
    ...
    //SwapRouter
        ...
        10000000000,
    //Receive
        address(0x84E81291f25dceD662F39bC32334a72B33e85894),
    //Fund
        address(0x04A6282C341e9083D0a156c1468161C391984cCD)
    ){
