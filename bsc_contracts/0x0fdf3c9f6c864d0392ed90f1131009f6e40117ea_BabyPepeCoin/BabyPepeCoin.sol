...
// Telegram: https://t.me/BabyPepeTheFrog
...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 PepeTheFrog = IBEP20(0x9418fE4f3ef8dab095B806F21C479cE364fDe285); //reward ca can be changed any
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = PepeTheFrog.balanceOf(address(this));
 
       address[] memory path = new address[](2);
       path[0] = WBNB;
       path[1] = address(PepeTheFrog);
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = PepeTheFrog.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           PepeTheFrog.transfer(shareholder, amount);
...
contract BabyPepeCoin is IBEP20, Auth {
   using SafeMath for uint256;
 
   address PepetheFrog = 0x9418fE4f3ef8dab095B806F21C479cE364fDe285; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Baby Pepe The Frog";
   string constant _symbol = "BpepeBNB";
...
uint256 reflectionFee = 2;
   ...
   uint256 buybackMultiplierLength = 0 minutes;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x1c6f6fcCc36716fAA9126D1545aD34Fd2A064362; //should be wallet of owner
       ...
       autoLiquidityReceiver =0x1c6f6fcCc36716fAA9126D1545aD34Fd2A064362; //Can be change to any wallet you want
       marketingFeeReceiver = 0x1c6f6fcCc36716fAA9126D1545aD34Fd2A064362; //Can be change to any wallet you want
