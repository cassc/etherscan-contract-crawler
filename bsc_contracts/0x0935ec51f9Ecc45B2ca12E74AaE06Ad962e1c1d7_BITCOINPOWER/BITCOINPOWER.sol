...
contract BITCOINPOWER is IBEP20, Auth {
    ...
    string constant _name = "BITCOIN POWER";
    string constant _symbol = "$BTCP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 21000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1000;  // .1% max tx
    uint256 public _maxWalletSize = (_totalSupply * 1) / 1000;  // .1% max wallet
    ...
    address private marketingFeeReceiver = 0x263538fA3cA87b8e62b997324E2D091c7bB2ef82;
    address private teamFeeReceiver = 0x263538fA3cA87b8e62b997324E2D091c7bB2ef82;
