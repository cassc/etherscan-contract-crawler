...
/**
 * @title OnAvaxNFTTradable
 * OnAvaxNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract OnAvaxNFTTradable is ERC721, Ownable {
    ...
    */
    ...
    /**
     * Override isApprovedForAll to whitelist OnAvax contracts to enable gas-less listings.
     */
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist OnAvax auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist OnAvax contracts to enable gas-less listings.
     */
