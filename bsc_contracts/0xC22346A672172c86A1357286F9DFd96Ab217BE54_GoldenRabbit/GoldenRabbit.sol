...
contract GoldenRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = "GoldenRabbit"; // 
    string private constant _symbol = "GORA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 4;
    address public  _marketingWallet = 0x48E9A5744EBC0e13D534532a576bc256d61E519F;
    ...
    function setFees(uint256 buytax, uint256 selltax) external onlyOwner {
        _marketingFee = buytax;
        _liquidityFee = selltax;
    }
