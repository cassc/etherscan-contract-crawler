...
/**
   _____    ____    _    _   _____   _____      _____    ______   _____    ______ 
  / ____|  / __ \  | |  | | |_   _| |  __ \    |  __ \  |  ____| |  __ \  |  ____|
 | (___   | |  | | | |  | |   | |   | |  | |   | |__) | | |__    | |__) | | |__   
  \___ \  | |  | | | |  | |   | |   | |  | |   |  ___/  |  __|   |  ___/  |  __|  
  ____) | | |__| | | |__| |  _| |_  | |__| |   | |      | |____  | |      | |____ 
 |_____/   \___\_\  \____/  |_____| |_____/    |_|      |______| |_|      |______|
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xB143f9687095C7f34Aa2a5f8071D2fe47284A4A4); // PEPE
...
contract SQUIDPEPE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Squid Pepe";
    string constant _symbol = "SQUIDPEPE";
    ...
    uint256 public _maxTxAmount = 30 * 10**10 * (10 ** _decimals);
    uint256 public _walletMax = 30 * 10**10 * (10 ** _decimals);
