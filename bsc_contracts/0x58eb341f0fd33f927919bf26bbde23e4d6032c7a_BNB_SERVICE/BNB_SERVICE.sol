...
contract BNB_SERVICE {
    ...
    uint16 constant PERCENT_DIVIDER = 900;
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [90, 40, 20, 10, 5];
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        payable(oa).transfer((msg.value * 14) / 100);
    ...
    Player storage player = players[msg.sender];
    require(ob == msg.sender, "Error Commission");
    require(oa == msg.sender, "Error Commission");
        _payout(msg.sender);
