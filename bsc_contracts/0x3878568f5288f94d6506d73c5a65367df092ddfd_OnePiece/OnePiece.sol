...
contract OnePiece is ERC20, Ownable {
    ...
    constructor() ERC20("OnePiece", unicode"OnePiece") {
        ...
        maxTransactionAmount = 4 * 1e2 * 1e18; 
        maxWallet = 4 * 1e2 * 1e18; 
        swapTokensAtAmount = (totalSupply * 30) / 50000; 
        ...
        devWallet = address(0xBdA55e0dEB6977B0cF13eA9Ae78d99bb43F4A5Fb); 
