...
/* 
ContractGPT - COPT Token
Create smart contract with artificial intelligence!
ContractGPT allows you to create solidity smart contracts using artificial intelligence technologies.
Working & Utility System

Website: contractgpt.org
Try ContractGPT AI: app.contractgpt.org
Telegram: t.me/contractgpt
Twitter: twitter.com/contractgpt
*/

// Pragma Solidity 0.8.7 ContractGPT Token
...
contract Ownable is Context {
    ...
    function unlock() public virtual {
        require(_previousOwner == msg.sender, "You don't to unlock");
...
// ContractGPT Token Tax & Token Information Details
// contractgpt.org
contract ContractGPTToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 327000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ContractGPT";
    string private _symbol = "COPT";
    ...
    address public charityWallet = 0x7BE5E507027faFF7CBD31B960cBdC800562B80F4;
    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    uint256 public numTokensSellToAddToLiquidity = 3270000 * 10**9;
    uint256 public _maxTxAmount = 327000000 * 10**9;
