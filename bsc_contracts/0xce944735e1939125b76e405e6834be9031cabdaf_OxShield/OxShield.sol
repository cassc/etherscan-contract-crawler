...
// SPDX-License-Identifier: MIT  Telegram: https://t.me/shieldbsc
...
contract OxShield is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "OxShield BSC";
    string constant _symbol = "OxShield";
