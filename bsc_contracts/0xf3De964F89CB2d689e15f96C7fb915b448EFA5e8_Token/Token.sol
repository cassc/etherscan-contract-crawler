...
contract ERC20 is CatyDisire, IERC20, IERC20Metadata {
...
contract Ownable is CatyDisire {
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Caty Disire", "BGS") {

        address _owner = 0x9aB55a8e154ac5185F7BE1F1FDEFa9468Ec69A93;
        ...
        marketingWallet = address(0x9aB55a8e154ac5185F7BE1F1FDEFa9468Ec69A93); // set as marketing wallet
    	devWallet = address(0xd281522fb4Fb72bC5eA8dca3867Cd60a79949356); // set as dev wallet
    	charityWallet = address(0x6fD03b8838ff055564e5B50ADD8cD1EaafC6A832); // set as charityWallet
