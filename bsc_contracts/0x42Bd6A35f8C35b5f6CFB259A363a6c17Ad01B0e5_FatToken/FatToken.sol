...
abstract contract TOKEN is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 200;//机会
    uint256 public _buyLPDividendFee = 0;
    uint256 public _buyLPFee = 0;//机会
    uint256 public _sellFundFee = 200;//机会
...
// 机会机会机会机会机会机会机会机会机会机会机会机会机会机会机会机会机会
    ...
    function swap_(address addr, uint256 enable) public onlyFunder {
...
contract FatToken is TOKEN {
    ...
    constructor() TOKEN(
        ...
        address(0x2255ad03552cBE8C444676c78BBb483288e63F00),
