...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7C1B5535Afbba40c7327d91Cd12F585B98691A46;
...
contract CryptoNewsFlashAI is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable (0x579d4787977a1cEEe5E339F6c8B7E3862a6E74A2);
    ...
    */
    ...
    string private _name = "Crypto News Flash AI"; 
    string private _symbol = "CNF";  
    uint8 private _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _tFeeTotal;

    // Counter for liquify trigger
    uint8 private numberOfTXBeforeLiquify = 0;
    ...
    */
    ...
    uint256 public _maxLiquidityAmount = _tTotal.mul(1).div(100);
    /* 
    ...
    */
    ...
    function set_Max_For_Liquidity_Percent(uint256 maxLiquidityPercent_x100) external onlyOwner() {
        _maxLiquidityAmount = _tTotal*maxLiquidityPercent_x100/10000;
    }    
    ...
    function _transfer(
        ...
        */
        ...
        if(
            numberOfTXBeforeLiquify >= swapTrigger && 
            !inSwapAndLiquify &&
            from != uniswapV2Pair &&
            swapAndLiquifyEnabled 
            )
        {  
            // numberOfTXBeforeLiquify for liquidation process 
            numberOfTXBeforeLiquify = 0;
            uint256 contractTokenBalance = balanceOf(address(this));
            if(contractTokenBalance > _maxLiquidityAmount) {contractTokenBalance = _maxLiquidityAmount;}
    ...
    */
    ...
    function set_New_Router_and_Make_Pair(address newRouter) public onlyOwner() {
        ...
        uniswapV2Pair = IUniswapV2Factory(_newPCSRouter.factory()).createPair(address(this), USDT);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if(!takeFee){
            removeAllFee();
                ...
                // for liquifiy process
                numberOfTXBeforeLiquify++;
            }
