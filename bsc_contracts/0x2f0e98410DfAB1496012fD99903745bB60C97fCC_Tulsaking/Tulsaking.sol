...
// https://t.me/tulsakingportal

// https://tulsaking.site/BSC/
...
contract Tulsaking is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TulsakingDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Tulsa king", "Tulsa") {
        marketingWallet = payable(0x86d5b7787982302800e4d545e80A6A19a9bE93e9);
        devWallet = payable(0x973D439c4a0C052a7261bf9491a2aEB8A4115CB0);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 1;
        sellDeadFees = 1;
        buyMarketingFees = 20;
        sellMarketingFees = 60;
        buyLiquidityFee = 3;
        sellLiquidityFee = 3;
        buyRewardsFee = 3;
        sellRewardsFee = 3;
        ...
        dividendTracker = new TulsakingDividendTracker(
            payable(this),
            router,
...
contract TulsakingDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Tulsaking public TulsakingContract;
    ...
    constructor(
        ...
        defaultToken = token;
        TulsakingContract = Tulsaking(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Tulsaking_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Tulsaking_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Tulsaking contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TulsakingContract);

            uint256 prevBalance = TulsakingContract.balanceOf(address(this));
            ...
            {
                uint256 received = TulsakingContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TulsakingContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
