...
library SafeERC20 {
    ...
    * @return bool whbnber the transfer was successful or not
    */
...
contract Sellix {
    ...
    function multiPayoutBnb(address[] addresses, uint256[] amounts) public onlyOwner returns(bool success) {
        uint total = 0;
        ...
        uint requiredAmount = total.add(bnbSendFee * 1 wei);
