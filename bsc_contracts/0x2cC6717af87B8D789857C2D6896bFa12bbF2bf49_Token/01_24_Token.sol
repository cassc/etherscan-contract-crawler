...
contract Token is ERC20PresetMinterRebaser, Ownable {
    ...
    constructor(address _marketing) ERC20PresetMinterRebaser("TEST", "TEST")  {
    ...
    function _mint(address to, uint256 amount) internal override {
        ...
        // increase initSupply
        initSupply = initSupply.add(tokenValue);
    ...
    function _mintUnderlying(address to, uint256 amount) internal {
        ...
        // get external value
        uint256 scaledAmount = _tokenToFragment(amount);
    ...
    function _transfer(
        ...
        if (inSwap) {
            ...
            if (
                ...
                swapTokensForUSDT(amount.div(2), marketingAddress);
            }
