...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7f5A3B4df52110b4B4A266Ba9dEB37248bb8f859; // owner address
...
contract BattleOfCoin is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x7f5A3B4df52110b4B4A266Ba9dEB37248bb8f859); // Marketing Address
    address payable public teamWalletAddress = payable(0x7f5A3B4df52110b4B4A266Ba9dEB37248bb8f859); // Team Address
