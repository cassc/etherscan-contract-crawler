...
contract DogeZillaCEO is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeZilla CEO";
    string private constant _symbol = "DZCEO";
