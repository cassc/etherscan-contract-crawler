...
contract DonnateloInu is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "DONNATELOINU";
    string private constant _symbol = unicode"$DONI";
    ...
    address payable public DevWallet = payable(0x7249779Ccf860a3e3C9314B7616b8C3772762176);
    address payable public MarketingWallet = payable(0xed1c6BB4b4D0f6468750b126274A142b4a1E86E9);
