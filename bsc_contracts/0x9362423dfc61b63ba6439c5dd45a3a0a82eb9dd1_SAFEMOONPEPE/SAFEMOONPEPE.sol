...
Telegram: https://t.me/SafemoonPepePortal
*/
...
contract SAFEMOONPEPE is IERC20, Ownable {
    ...
    string _name = "SAFEMOON PEPE";
    string _symbol = "SAFEPEPE";
  ...
  /* rOwned = ratio of tokens owned relative to [[circulating]] supply */
    ...
    uint256 smallSwapThreshold = 2000000 * 10**_decimals;
    uint256 largeSwapThreshold = 3000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamFeeReceiver = 0x075cf8aED6FBa0DA815600e38173C1Fbfc2a1662;
        devFeeReceiver = 0x075cf8aED6FBa0DA815600e38173C1Fbfc2a1662;
        marketingFeeReceiver = 0x075cf8aED6FBa0DA815600e38173C1Fbfc2a1662;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <= 200,"Cannot set buy fees above 20%"); // Max Buy Fee possible to set
        require(totalFeeSell <= 200,"Cannot set sell fees above 20%"); // Max Fee Sell possible to set
