...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15F7d10EF1E45EB6A063a12918D2E1f96363B4d9; // owner address
...
contract BULLPEPE is Context, IERC20, Ownable {
    ...
    string private _name = "BULLPEPE";
    string private _symbol = "$BULLPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x15F7d10EF1E45EB6A063a12918D2E1f96363B4d9); // Marketing Address
    address payable public teamWalletAddress = payable(0x15F7d10EF1E45EB6A063a12918D2E1f96363B4d9); // Team Address
