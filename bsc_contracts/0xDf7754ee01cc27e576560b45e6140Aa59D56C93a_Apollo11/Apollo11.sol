...
/**
http://t.me/apollo11entry

APOLLO 11 (LAUNCHING APRIL 20 16 UTC) is a bsc token ready to launch and land on the moon with it holders
...
contract Apollo11 is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Apollo11"; // 
    ...
    uint256 public BuyliquidityFee    = 7;
    ...
    uint256 public _maxWalletToken = _totalSupply / (100) * (6); // 6%

    // Fees receivers
    address private autoLiquidityReceiver = 0x56224a6f89CAb0aF0Eb4D2eF40adC54319aF11Db; //LP receiver
    address private marketingFeeReceiver = 0x56224a6f89CAb0aF0Eb4D2eF40adC54319aF11Db; //mkt
    address private devFeeReceiver = 0x56224a6f89CAb0aF0Eb4D2eF40adC54319aF11Db; //31 BuyBack
    address private teamFeeReceiver = 0x56224a6f89CAb0aF0Eb4D2eF40adC54319aF11Db; //32 
