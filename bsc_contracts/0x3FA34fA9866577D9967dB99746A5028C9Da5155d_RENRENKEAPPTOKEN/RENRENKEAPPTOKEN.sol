...
contract RENRENKEAPPTOKEN is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 10 * (10**1) * (10**18);
    ...
    string private constant _name = "RENRENKE APP TOKEN";
    string private constant _symbol = "RRK";
    uint8 private constant _decimals = 18;

    address payable private _marketingAddress = payable(0x99384d181Ab74EeB7ab9245f2a65aF3116De0403);
    address payable private _burnAddress = payable(0xbCFF7DE7044af65764ac024eA036087EBEe72fed);
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 mktAmount = amount.mul(3).div(5);
