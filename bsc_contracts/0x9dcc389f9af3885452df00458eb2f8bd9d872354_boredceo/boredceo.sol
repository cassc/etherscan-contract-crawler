...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8d4D6d2b5CdB2F7f38Ec899cCdebf0255EE949eD;
...
contract boredceo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BORED CEO";
    string private _symbol = "BODERCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72DDF241D3D6B8f4B3BE31E3183E7a59008a14F7);
    address payable public teamWalletAddress = payable(0x8d4D6d2b5CdB2F7f38Ec899cCdebf0255EE949eD);
