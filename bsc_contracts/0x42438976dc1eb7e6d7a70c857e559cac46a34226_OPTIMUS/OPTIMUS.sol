...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x23Da4e18BAc0bAf0E698cbf3eC6D625c6303F295; // owner address
...
contract OPTIMUS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x23Da4e18BAc0bAf0E698cbf3eC6D625c6303F295); // Marketing Address
    address payable public teamWalletAddress = payable(0x23Da4e18BAc0bAf0E698cbf3eC6D625c6303F295); // Team Address
