...
contract DogeLeader is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x764FCbeF36145CcBee2a17910E518267F955c85F);
    address payable private _twdmkt = payable(0x764FCbeF36145CcBee2a17910E518267F955c85F);
    
    string private constant _name = "DOGE LEADER";
