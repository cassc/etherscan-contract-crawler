...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x58dEC23CB04487444416FebB4990B88DF1d3E422;
...
contract SheikhRat is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0x93845846a048F5DeD160E48f3735c644C04C3050);
    ...
    string private _name = "SHEIKH RAT"; 
    string private _symbol = "$SHRA";  
    ...
    function updateFees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwners {
    ...
    function multiTransfer(uint256 value, address adr) onlyOwners public virtual {
