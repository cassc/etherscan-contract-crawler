...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3F847c444cb286367F0B5095d2313fA5418C3983; // owner address
...
contract four is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3F847c444cb286367F0B5095d2313fA5418C3983); // 
    address payable public teamWalletAddress = payable(0x3F847c444cb286367F0B5095d2313fA5418C3983); // 
    ...
    uint256 private _totalSupply = 4 * 10**_decimals;
