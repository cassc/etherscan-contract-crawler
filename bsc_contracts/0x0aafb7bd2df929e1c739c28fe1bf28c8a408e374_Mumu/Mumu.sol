...
contract  Mumu  is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0x7D2A215e03e113eb2c0988E61f8E7FA252cd1014; 
    address internal constant marketing_receiver = 0x940fDa4728E75046FB50025c9b61329A6B34399d;
    address internal constant liquidity_receiver = 0x7D2A215e03e113eb2c0988E61f8E7FA252cd1014;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeBurnt = feeAmount.div(denominator).mul(burnFee);
        _balances[address(this)] = _balances[address(this)].add(feeAmount);
        emit Transfer(sender, address(this), feeAmount);
        if(feeBurnt > 0){
            _balances[DEAD] = _balances[DEAD].add(feeBurnt);
        _transfer(address(this), address(DEAD), feeBurnt);
        }
