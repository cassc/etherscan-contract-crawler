...
/**               
Telegram : https://t.me/ClassicBakedBean
Website : TBA
...
contract ClassicBakedBean is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ClassicBakedBeanDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Classic Baked Bean", "ClassicBean") {
        marketingWallet = payable(0xFcc29D9f4Be3E566Ffe22e2159f95e1209d34Dba);
        devWallet = payable(0xFcc29D9f4Be3E566Ffe22e2159f95e1209d34Dba);
        ...
        dividendTracker = new ClassicBakedBeanDividendTracker(
            payable(this),
            router,
            0x2859e4544C4bB03966803b044A93563Bd2D0DD4D,
            "ClassicBakedBeanTRACKER",
            "ClassicBakedBeanTRACKER"
        );
        ...
        maxWallet = totalTokenSupply / 80; // 2%
...
contract ClassicBakedBeanDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    ClassicBakedBean public ClassicBakedBeanContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ClassicBakedBeanContract = ClassicBakedBean(mainContract);
    ...
    function _transfer(
        ...
        require(false, "ClassicBakedBean_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ClassicBakedBean_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ClassicBakedBean contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ClassicBakedBeanContract);

            uint256 prevBalance = ClassicBakedBeanContract.balanceOf(address(this));
            ...
            {
                uint256 received = ClassicBakedBeanContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ClassicBakedBeanContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
