...
contract PAAX is Context, IERC20, Ownable {
    ...
    string private _name = "Paax Coin";
    string private _symbol = "PAAX";
    ...
    address public _marketingWallet =
        payable(address(0xe5221AEAAaE99385dEeadab9FfF2292e9F922Cf0));
    address public _exchangeWallet =
        payable(address(0x4a6Fc915cfD6475C4FA110819c064Fee49d077Eb));
        ...
        private
    {
        ...
        _rOwned[_exchangeWallet] = _rOwned[_exchangeWallet].add(rReward);
        _rOwned[_marketingWallet] = _rOwned[_marketingWallet].add(rMarketing);

        _tOwned[_exchangeWallet] = _tOwned[_exchangeWallet].add(tReward);
