...
contract AntManInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ant-Man Inu";
    string private _symbol = "AMINU";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xdAcC55b960eB828d78c48f42e7b201E42623225A); // Marketing Address SM
    address payable public BuyBackWallet = payable(0xeB3E9756AD90469d2ffCeFA3de270E9c9dd30F40); // Team Address
    ...
    function blacklistAddress(address _address, bool _value) private onlyOwner {
