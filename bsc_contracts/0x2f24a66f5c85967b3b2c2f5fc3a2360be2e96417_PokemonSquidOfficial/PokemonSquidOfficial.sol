...
/**
https://t.me/PokemonSquidOfficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1D90f2Ef0E42a594ab17ADB91bcfa791080847ec; // owner address
...
contract PokemonSquidOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PokemonSquid";
    string private _symbol = "PS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1D90f2Ef0E42a594ab17ADB91bcfa791080847ec); // Marketing Address
    address payable public teamWalletAddress = payable(0x1D90f2Ef0E42a594ab17ADB91bcfa791080847ec); // Team Address
    ...
    uint256 public _walletMax = 22000000 * 10**_decimals;
