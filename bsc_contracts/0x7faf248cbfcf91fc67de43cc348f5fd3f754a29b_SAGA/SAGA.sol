...
contract SAGA is ERC20, Ownable {
    ...
    constructor () ERC20("SANTA GATE", "SAGA") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x31773438F3F5223547B425641F3B3Da6eD89BfDA;
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(_totalFeesOnBuy + _totalFeesOnSell <= 10, "Total Fees cannot exceed the maximum");
