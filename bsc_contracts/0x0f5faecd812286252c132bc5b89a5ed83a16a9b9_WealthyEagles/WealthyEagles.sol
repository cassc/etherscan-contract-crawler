...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf359Fba430dbb20b2c3A58D74cAbd38f45223c7e;
...
contract WealthyEagles is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x83bA4Af8a8E8d23Ed1D8fdad2F5E312921A89D92;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Wealthy Eagles Token";
    string private _symbol = "WET";
