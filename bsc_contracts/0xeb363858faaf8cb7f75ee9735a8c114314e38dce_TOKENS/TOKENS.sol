...
contract TOKENS is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xCAB776F301a5b44657e98ECD7b1d8F59fB2C47C7);
    address payable private teamWalletAddress = payable(0xCAB776F301a5b44657e98ECD7b1d8F59fB2C47C7);
    ...
    mapping (address => bool) private _isAntiwhaleed;
    ...
    uint256 private minimumTokensBeforeSwap = 1000000 * 10**2 * 10**_decimals; 
    ...
    function isAntiwhale(address account) public view returns(bool) {
        return _isAntiwhaleed[account];
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!_isAntiwhaleed[recipient] && !_isAntiwhaleed[sender], "Antiwhaleed address");
