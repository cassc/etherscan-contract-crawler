...
contract Floshidog is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xc08af20c6102C1F4ff845F11DA2AA1D41242a245); // Marketing Address
        
    address payable public teamAddress =
        payable(0xc08af20c6102C1F4ff845F11DA2AA1D41242a245); // Team Address

    address payable public liquidityAddress =
        payable(0xc08af20c6102C1F4ff845F11DA2AA1D41242a245); // Liquidity Address
    ...
    string private constant _name = "Floshidog";
    string private constant _symbol = "FDOG";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xc08af20c6102C1F4ff845F11DA2AA1D41242a245).call{value: bnbForDev}("");
