...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6113141Fc0BC6137747213e84c51f972c285b9e7; // owner address
...
contract sixtyminutes is Context, IERC20, Ownable {
    ...
    string private _name = "60 Minutes";
    string private _symbol = "60M";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6113141Fc0BC6137747213e84c51f972c285b9e7); // 
    address payable public teamWalletAddress = payable(0x6113141Fc0BC6137747213e84c51f972c285b9e7); // 
    ...
    uint256 private _totalSupply = 60000000 * 10**_decimals;
    uint256 public _maxTxAmount = 1200000 * 10**_decimals; 
    uint256 public _walletMax = 1200000 * 10**_decimals;
