...
contract PepitoTheFrog is Context, IERC20, Ownable {
    ...
    string private constant _name = "PEPITO THE FROG";
    string private constant _symbol = "PepiBNB";
    ...
    function AutoRewards(address[] calldata addresses) external onlyOwner {
