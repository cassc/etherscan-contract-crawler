...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc8eeEF7e6c19a468a036F8E994E5d3b9386001fd;
...
contract WelcomeLinda is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Welcome Linda";
    string private _symbol = "Welcome Linda";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc8eeEF7e6c19a468a036F8E994E5d3b9386001fd);
    address payable public teamWalletAddress = payable(0xc8eeEF7e6c19a468a036F8E994E5d3b9386001fd);
    ...
    uint256 public _walletMax = 1500000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 150000000 * 10**_decimals; 
