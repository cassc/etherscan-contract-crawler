...
contract QATARK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Qatar King "; // 
    string private constant _symbol = " QATARK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address private  _marketingWallet = 0x1a0eC680DBdCFcf6434B30945Eb0CD7dE3E9e029;
