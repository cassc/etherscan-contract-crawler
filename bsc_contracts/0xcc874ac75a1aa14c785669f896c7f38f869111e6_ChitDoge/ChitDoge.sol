...
contract ChitDoge  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " ChitDoge ";
    string private _symbol = " CHITDOGE "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x130e9895A1d5EC8F3c6562166c636b879BEFB1f0); 
    address payable public teamWalletAddress = payable(0x3A1623A508E89C96d5Af952bce2C9322D2d42255); 
