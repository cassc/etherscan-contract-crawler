...
https://rugpush.io
https://t.me/rugpush
https://twitter.com/RugPushIO

 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |  _______     | || | _____  _____ | || |    ______    | || |   ______     | || | _____  _____ | || |    _______   | || |  ____  ____  | |
| | |_   __ \    | || ||_   _||_   _|| || |  .' ___  |   | || |  |_   __ \   | || ||_   _||_   _|| || |   /  ___  |  | || | |_   ||   _| | |
| |   | |__) |   | || |  | |    | |  | || | / .'   \_|   | || |    | |__) |  | || |  | |    | |  | || |  |  (__ \_|  | || |   | |__| |   | |
| |   |  __ /    | || |  | '    ' |  | || | | |    ____  | || |    |  ___/   | || |  | '    ' |  | || |   '.___`-.   | || |   |  __  |   | |
| |  _| |  \ \_  | || |   \ `--' /   | || | \ `.___]  _| | || |   _| |_      | || |   \ `--' /   | || |  |`\____) |  | || |  _| |  | |_  | |
| | |____| |___| | || |    `.__.'    | || |  `._____.'   | || |  |_____|     | || |    `.__.'    | || |  |_______.'  | || | |____||____| | |
| |              | || |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'    
...
contract RUGPUSH is ERC20, Ownable {
    ...
    constructor() payable ERC20("RUG PUSH", "RGP") {

        rewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // BUSD

        developmentFeeOnBuy    = 6;
        rewardsFeeOnBuy     = 2;

        totalBuyFee         = developmentFeeOnBuy + rewardsFeeOnBuy;

        developmentFeeOnSell   = 6;
        rewardsFeeOnSell    = 2;
        totalSellFee        = developmentFeeOnSell + rewardsFeeOnSell;
        totalSellFee        = developmentFeeOnSell + rewardsFeeOnSell;

        developmentWallet = 0xfF9b2d46b96a6f3b5081dB971778040CcFd6dbd5;

        dividendTracker = new DividendTracker(1 * 10**8, rewardToken);
