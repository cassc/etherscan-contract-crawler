...
/ (_ / _ `/  ' \/  ' \/ _ `/ /    / /_/ / |/ / __ |
\___/\_,_/_/_/_/_/_/_/\_,_/ /_/|_/\____/|___/_/ |_|
                                                   


telegram: https://t.me/gammanova
...
/* Token contract */
contract GammaNOVA is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address CALLS = 0x8D3d63C6E6d6544a81ed9e6C994fe707D2DfeB1a;
    ...
    // Name and symbol
    string constant _name = "GammaNOVA";
    string constant _symbol = "GAMMANOVA";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 100k 
    ...
    uint256 public swapThreshold = _totalSupply * 150 / 10000; // 1.5% of supply
    ...
    function checkMaxWallet(address sender, address recipient, uint256 amount) internal view {
        if (!authorizations[sender] && recipient != owner && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver && recipient != CALLS){
    ...
    function swapBack() internal swapping {
        ...
        (bool successDev, /* bytes memory data */) = payable(CALLS).call{value: amountBNBDev, gas: 30000}(""); 
