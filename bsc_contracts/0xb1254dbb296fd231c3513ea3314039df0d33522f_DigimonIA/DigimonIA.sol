...
contract DigimonIA   is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Digimon IA ";
    string private _symbol = " $DIGIIA "; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58453b671c8B652c983b77E4C4e19402bff8Ca67); 
    address payable public teamWalletAddress = payable(0x58453b671c8B652c983b77E4C4e19402bff8Ca67); 
