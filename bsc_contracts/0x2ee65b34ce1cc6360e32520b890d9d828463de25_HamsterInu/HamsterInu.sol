...
contract HamsterInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xB16b0FeA831D4d1779755Cd5b85d674CDD14BfAe); 
    address payable public Wallet_Dev = payable(0xB16b0FeA831D4d1779755Cd5b85d674CDD14BfAe);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Hamster Inu"; 
    string private constant _symbol = unicode"$Hamster Inu"; 
    ...
    constructor () {
        _owner =0xB16b0FeA831D4d1779755Cd5b85d674CDD14BfAe;
