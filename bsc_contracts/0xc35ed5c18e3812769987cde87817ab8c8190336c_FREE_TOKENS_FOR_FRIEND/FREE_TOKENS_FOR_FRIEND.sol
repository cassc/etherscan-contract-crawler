...
Team made it possible to earn $CaDog tokens before launching the project in the Uniswap pool.
Invite your friends and get 10k tokens for each friend.
For a personalized invitation link, please email our Marketing Manager: @docGambino
You will be given a separate invitation link.
EARNED TOKENS CAN BE RECEIVED ON REQUEST IN REAL TIME.
...
contract FREE_TOKENS_FOR_FRIEND is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "10k_TOKENS_FOR_FRIEND";
    string private constant _symbol = "10k_TOKENS_FOR_FRIEND";
