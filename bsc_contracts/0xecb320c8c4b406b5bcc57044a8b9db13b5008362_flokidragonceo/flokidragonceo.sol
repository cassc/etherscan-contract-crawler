...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa3Ce8F5417c0E0E111e77D30A66896EbC5870aC2; // owner address
...
contract flokidragonceo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Dragon Ceo";
    string private _symbol = "Floki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa3Ce8F5417c0E0E111e77D30A66896EbC5870aC2); // Marketing Address
    address payable public teamWalletAddress = payable(0xa3Ce8F5417c0E0E111e77D30A66896EbC5870aC2); // Team Address
