...
contract Pepeye is Context, IERC20, Ownable {
    ...
    string private _name = "Pepeye";
    string private _symbol = "PEPEYE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x492D9E8F8edcD5543fC11150d60d6e49145eC244);
    address payable public developmentWalletAddress = payable(0x91d3AeF92aF23eBA59Ce2670cd832c796cfc7E23);
