...
/**
Telegram : https://t.me/spookysegabsc
Website  : TBA
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9FDF25A880700B48f3Ca9666a7FD09B602ebB990; // owner address
...
contract SSEGA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPOOKY SEGA";
    string private _symbol = "$SSEGA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEC9D6E1b07Ce3827Cb5Fd118Bf285aE3125ef1F9); // Marketing Address
    address payable public teamWalletAddress = payable(0x9FDF25A880700B48f3Ca9666a7FD09B602ebB990); // Team Address
