...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb84FBa5c554b0B44B7D22Ce4fB0Cff74985e2362;
...
contract pascal is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0xb84FBa5c554b0B44B7D22Ce4fB0Cff74985e2362);
    ...
    string private _name = "Daddy Pascal"; 
    string private _symbol = "PASCAL";  
    uint8 private _decimals = 10;
    uint256 private _tTotal = 100000000 * 10 ** _decimals;
    uint256 private _tFeeTotal;

    // Counter for liquify trigger
    uint8 private txCount = 3;
