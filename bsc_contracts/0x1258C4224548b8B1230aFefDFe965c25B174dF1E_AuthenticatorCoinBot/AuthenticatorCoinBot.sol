...
TG: https://t.me/AuthenticatorCoinBot
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x970fd3c573824d3c3128f8245a2fDA4230114dEF; // owner address
...
contract AuthenticatorCoinBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Authenticator Coin Bot";
    string private _symbol = unicode"ACB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x970fd3c573824d3c3128f8245a2fDA4230114dEF); // Marketing Address
    address payable public teamWalletAddress = payable(0x970fd3c573824d3c3128f8245a2fDA4230114dEF); // Team Address
