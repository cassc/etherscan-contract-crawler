...
contract  ARBDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ArbitrumDoge";
    string private _symbol = "ARBDoge";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x222C54d148a4b7Ec71c3ccB0a6462481e0612b96); 
    address payable private teamWalletAddress = payable(0x222C54d148a4b7Ec71c3ccB0a6462481e0612b96); 
