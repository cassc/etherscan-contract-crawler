...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d); //USDC
...
contract AlphaChads is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AlphaChads";
    string constant _symbol = "AC";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xb0FBe0494c7896dba6aef3f472626e9c16B2F500;  // marketingwallet
        devWallet = 0x4b03C6cab4164B0DF284A520fC1c63B46490AFF8;  // devwallet
