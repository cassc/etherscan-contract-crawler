...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20pEPEu RWRD = IBEP20pEPEu(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
...
contract PepeUSDTToken is IBEP20pEPEu, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xb57e9b9E2df373Fa7BF6342bd4efC9C4f840EeA0;

    string constant _name = "PepeUSDT";
    string constant _symbol = "PepeU";
