...
contract NFTLabs is Ownable, ERC721, ERC721Enumerable, ERC721URIStorage {
    ...
    uint256 public unlockPeriod = 10 * 60;
    ...
    function unlock(uint256 tokenId) public {
        ...
        _purchase(tokenId, tokenLockInfo, lockInfo);
    ...
    function _purchase(uint256 tokenId, TokenLockInfo memory tokenLockInfo, LockInfo memory lockInfo) private {
