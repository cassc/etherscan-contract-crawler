...
contract McCarthy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name ="zuguotongyi";
    string private _symbol = "zuguotongyi";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x198e8d734c087a38Cb80E88ef02A5Ff6C7acb3bA);
