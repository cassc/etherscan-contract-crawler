...
contract Beceive is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x60908de295ab2C9f0B8b10b223235894Acf51681;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "BECEIVE FINANCE";
    string constant _symbol = "$BECEIVE";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x122188CFab75e0D35B8aCa3f06a6bBC6BBcC1e35;
