...
/**
Medium: https://medium.com/@PokemonFloki/the-rise-of-pokemon-floki-a-tale-of-community-and-adventure-c5d8a11a7252
*/

/**
As legend has it, Pokemon Floki was born from a rare and powerful crystal that was discovered in the depths of the Binance Smart Chain.
This crystal was said to hold the essence of community and low taxes, two qualities that were highly coveted in the world of cryptocurrency. 
The crystal was shattered, and from its fragments, Pokemon Floki was born.
...
contract PokemonFloki is IBEP20, Ownable {
    ...
    string constant _name = "PokemonFloki";
    string constant _symbol = "$PFK";
    ...
    uint256 public _sellMultiplier = 0;
    
    address public marketingFeeReceiver = 0xFcfb7698DF8A7E5986e9B9DcCFba9C790Fd6fED2;
