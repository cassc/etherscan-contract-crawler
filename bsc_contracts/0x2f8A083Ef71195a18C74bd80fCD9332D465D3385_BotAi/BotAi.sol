...
Welcome Smart Tech AI

Bot AI Generation is a program that has a way of working to scan smart contracts that have just been deployed and AI will check whether there is fraud in the contract to anticipate scams.
Bot generation has an artificial intelligence way of working therefore bot generation will continue to evolve over time and will have a perfect success rate

🌐 Channel: https://t.me/BotAIGeneration
🐤 Twitter: https://twitter.com/BotAIGeneration
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x99B91C2bE99272E3A2868b0D195c00c26d0f095B; 
...
contract BotAi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bot AI";
    string private _symbol = unicode"AIG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x02B3c47FBD5526c1f24FFeD86D1651B0bE1D78b3); // 
    address payable public teamWalletAddress = payable(0x99B91C2bE99272E3A2868b0D195c00c26d0f095B); // 
    ...
    uint256 public _totalDistributionShares = 53;  
