...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x15b8cB17F5eC523895721cca853b13b833a932a3;
...
contract $Skermit is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd11b89c503E9c5e3EBf8eD1C579b7D75c181E592;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 210000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "$Skermit";
    string private _symbol = "$Skerm";
    ...
    uint256 private numTokensSellToAddToLiquidity = 105000000000 * 10**18;
