...
/*
https://t.me/BabyOptimismDogeBSCPortal
https://baby-odoge.cryptoo.bid
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x9528b1166381fe60f24A952315A3e528A56407a0); // Reward ODOGE
...
contract BabyOptimismDoge is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "Baby Optimism Doge";
    string constant _symbol = "BABYODOGE";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x9528b1166381fe60f24A952315A3e528A56407a0; // Reward ODOGE
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingWallet = 0x5D0171f87409F2eFCA30b8A6a427815415261E7C; // Marketing Wallet
        teamWallet = 0x47E617235Ba11FFf622dEb5efD5ef1ea4bc7F01A; // Team Wallet
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountBNB.sub(amountBNBLiquidity).sub(
            amountBNBReflection
        );
