...
Onitsuka 鬼束 Inu is a japanese is a japanese based name 
derived from "Oni" which is a "demonic creature" while "tsuka" means "I see".


**/
// TELEGRAM : https://t.me/Onitsuka_Inu
// TWITTER: https://twitter.com/onitsuka_inu
...
contract Onitsuka is Context, IERC20, Ownable {
    ...
    string private _name = "Onitsuka Inu";
    string private _symbol = "ONITSUKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x071229Be3CE13E7ADD92f224d2899ccFc31F419a); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x9247508c5eCfA19F81bEC60B769F2FA073fF4BeF); // Development Address
