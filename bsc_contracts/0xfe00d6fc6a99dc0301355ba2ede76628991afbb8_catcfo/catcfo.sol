...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5187929D9d6531160BaA45bC6607Af1ad01d3bb8;
...
contract catcfo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CAT CFO";
    string private _symbol = "CAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA2c1B094D688BA7513977FEb9881393210209590);
    address payable public teamWalletAddress = payable(0x5187929D9d6531160BaA45bC6607Af1ad01d3bb8);
