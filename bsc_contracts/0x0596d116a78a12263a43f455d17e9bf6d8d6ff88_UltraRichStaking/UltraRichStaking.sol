...
contract UltraRichStaking is Ownable {
    ...
    uint256 public stakingTime = 180 days;
    uint256 public withdrawLimitTime = 30 days;
    uint256 public aprPercent = 30_00;
    uint256 public totalWithdraw;
    uint256 public totalStaked;
    uint256 public totalUsers;
    uint256 public referrerLevelCounter = 50;
    ...
    constructor() {
        ...
        devWallet = address(0x1a600A8b982229a2c1aEFB004BF4225293def2F6);
        projectWallet = address(0x2490982505d255ef50697Fd912De7Db10f49802b);
    }
    ...
    function changeAprPercent(uint256 _aprPercent) external onlyOwner {
        require(_aprPercent > 1_00,"Must be greater than 1%");
    ...
    function changeFeeWallets(address _projectWallet, address _devWallet) external onlyOwner {
        projectWallet = _projectWallet;
        devWallet = _devWallet;
    }

    function changeFees(uint256 _pFee, uint256 _dFee) external onlyOwner {
        projectWalletFee = _pFee;
        devWalletFee = _dFee;
        require(projectWalletFee + devWalletFee <= 10_00,"Must be less than 10%");
    }
