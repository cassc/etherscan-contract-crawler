...
/**
Website https://flokichain.co
Telegram https://t.me/Flokichainportal
twitter https://twitter.com/Flokichain
*/
...
contract FLOKICHAIN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xBb79FC53c06c770305c1a9DA7f59BBaCa4364D37); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x82B3057Dc8D45e39Aec6501f3d769c842F56A275); // BuyBack Address
    ...
    uint256 private _totalSupply = 10**7 * 10**9;
    uint256 public _maxTxAmount = 2 * 10**14;
    uint256 public _walletMax = 2 * 10**14;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (20 * 10**6 * 10**9), "Max wallet should be less or euqal to 2% totalSupply");
