...
/*
 _______  ___      _______  __    _  _______  _______  _______ 
|       ||   |    |   _   ||  |  | ||       ||       ||       |
|    ___||   |    |  |_|  ||   |_| ||    ___||_     _||____   |
|   |___ |   |    |       ||       ||   |___   |   |   ____|  |
|    ___||   |___ |       ||  _    ||    ___|  |   |  | ______|
|   |    |       ||   _   || | |   ||   |___   |   |  | |_____ 
|___|    |_______||__| |__||_|  |__||_______|  |___|  |_______|
...
contract FLANETZSTAKING is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public FlanetzTotalStaked;
    uint256 public Flanetz_APY;
    uint256 public lockDuration;
    uint256 private exitPenaltyPerc;
    ...
    constructor(
        ...
        stakingToken = IBEP20(0x27044cfe4D9E4d799c5aE3778d2215110465Df00);
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        uint256 lpSupply = FlanetzTotalStaked;
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        if(_amount > 0) {
            ...
            FlanetzTotalStaked += amountTransferred;
        }
    ...
    function emergencyRewardWithdraw(uint256 _amount) external onlyOwner {
        require(_amount <= rewardToken.balanceOf(address(this)) - FlanetzTotalStaked, 'not enough tokens to take out');
    ...
    function calculateNewRewards() public view returns (uint256) {
        ...
        return (((block.timestamp - pool.lastRewardTimestamp) * FlanetzTotalStaked) * Flanetz_APY / 100 / 365 days);
    }

    function rewardsRemaining() public view returns (uint256){
        return rewardToken.balanceOf(address(this)) - FlanetzTotalStaked;
    }

    function updateFlanetz_APY(uint256 newFlanetz_APY) external onlyOwner {
        require(newFlanetz_APY <= 10000, "Flanetz_APY must be below 10000%");
        updatePool(0);
        Flanetz_APY = newFlanetz_APY;
    }
