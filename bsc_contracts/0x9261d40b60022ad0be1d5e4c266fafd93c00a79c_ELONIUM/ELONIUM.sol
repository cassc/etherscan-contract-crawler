...
contract ELONIUM is ERC20, Ownable {
    ...
    constructor() payable ERC20("ELONIUM", "ELON") {

        _setOwner(0x812e82356B2d4532dfA91d6677aA9Fc6C929a174);
        ...
        marketingWallet = 0x812e82356B2d4532dfA91d6677aA9Fc6C929a174;

        dividendTracker = new DividendTracker(420 * 10**4, rewardToken);
        ...
        _mint(owner(), 420_690_000_000 * (10 ** 9));
