...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8fBe15404CbE4367B8ae9B72ed40145c43BD809A; 
...
contract PawINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Paw Inu";
    string private _symbol = "PAW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8fBe15404CbE4367B8ae9B72ed40145c43BD809A); 
    address payable public teamWalletAddress = payable(0x8fBe15404CbE4367B8ae9B72ed40145c43BD809A); 
