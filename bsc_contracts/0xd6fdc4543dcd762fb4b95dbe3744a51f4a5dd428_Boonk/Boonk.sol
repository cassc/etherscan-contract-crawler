...
contract Boonk is IBEP20, Ownable {
    string private constant _name = "Boonk"; // Name
    string private constant _symbol = "boonk"; // Symbol
    uint8 private constant _decimals = 18;
    uint256 private constant _totalSupply = 1e9 * 10**_decimals; //Token Decimals
    uint256 public maxHoldAmount = _totalSupply/5 ;
    ...
    constructor() {
        ...
        liquedityReceiver = address(0xD40564c7f0ffce82A0948620D7ad9De81a5C2608);
        marketFeeReceiver = address(0xD40564c7f0ffce82A0948620D7ad9De81a5C2608);
        devFeeReceiver = address(0xD40564c7f0ffce82A0948620D7ad9De81a5C2608);
