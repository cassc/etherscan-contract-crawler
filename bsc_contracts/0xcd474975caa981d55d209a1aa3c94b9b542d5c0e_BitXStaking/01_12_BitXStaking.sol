...
contract BitXStaking is ReentrancyGuardUpgradeable, OwnableUpgradeable {
  ...
  // Constructor function to set the ERC20 address
  ...
  //need to dicuss about it
  function addReferral(address[] memory _referrals, address staker) external onlyOwner {
