...
contract ReflectionsToken is IBEP20, Auth {
    
    using SafeMath for uint256;

    string public constant _name = "MR.FLOKI"; 
    string public constant _symbol = "MR.FLOKI"; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xf3F08315c05D41a2735073D029276B7AFA742E2f; 
        devWallet = 0xf3F08315c05D41a2735073D029276B7AFA742E2f; 
		prizewallet = 0xf3F08315c05D41a2735073D029276B7AFA742E2f; 
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newDevFee, uint256 newprizewalletfee, uint256 extraSellFee) external authorized {
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newprizewalletWallet, address newDevWallet) external authorized {
