...
import {SafeCast} from 'mongswap/v3-core/contracts/libraries/SafeCast.sol';
import {IMongSwapV3Pool} from 'mongswap/v3-core/contracts/interfaces/IMongSwapV3Pool.sol';
import {IMongSwapV3SwapCallback} from 'mongswap/v3-core/contracts/interfaces/callback/IMongSwapV3SwapCallback.sol';
...
/// @title Router for MongSwap v3 Trades
abstract contract V3SwapRouter is RouterImmutables, Permit2Payments, IMongSwapV3SwapCallback {
    ...
    function mongswapV3SwapCallback(int256 amount0Delta, int256 amount1Delta, bytes calldata data) external {
    ...
    function _swap(
        ...
        (amount0Delta, amount1Delta) = IMongSwapV3Pool(computePoolAddress(tokenIn, tokenOut, fee)).swap(
            recipient,
            zeroForOne,
            amount,
