...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 maxSellAmount = balance * 999 / 100;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                if(cutcount > 0)
                {
                    _balances[address(this)] =  _balances[address(this)].add(cutcount.mul(3).div(4));
    ...
    function getRewardNFT(address user) public view returns(bool) {
        uint256 hold = ERC721(NftAddress).balanceOf(user);
    ...
    function processNFTReward(uint256 gas) private {
        ...
        ERC721 holdToken = ERC721(NftAddress);
...
contract MTXQ is AbsToken {
    constructor(address _f) AbsToken(
        ...
        address(0x55d398326f99059fF775485246999027B3197955),_f, //0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684
        "MTTEST",
        "MTTEST",
        6,
        1000000,
        ...
        address(0x0083e635F9448A26EBc84b92393164edA81106AE)
    ){}
}