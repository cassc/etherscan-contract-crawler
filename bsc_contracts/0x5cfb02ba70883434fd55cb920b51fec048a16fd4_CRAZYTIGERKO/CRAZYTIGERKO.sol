...
contract CRAZYTIGERKO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xea72175bf1b1142C125f341812F736c74Bc42d8d); 
    address payable public Wallet_Dev = payable(0xFf00dB6e3De1c1c7B36f815e3537a65aCa3505e7);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "CRAZY TIGER KO"; 
    string private constant _symbol = unicode"CRAZYTIGERKO"; 
    ...
    constructor () {
        _owner =0xFf00dB6e3De1c1c7B36f815e3537a65aCa3505e7;
