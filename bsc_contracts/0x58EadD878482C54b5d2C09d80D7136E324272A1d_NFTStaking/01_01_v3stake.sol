...
contract NFTStaking is IERC721Receiver, Ownable{
    ...
    IERC20 public CCCToken = IERC20(0x82458aFf9eBa1f4e196fDADf25331Afa2C9575ca);
    ...
    function stake(uint256 _tokenId) external checkStart{
    ...
    function addStakeLP(uint _tokenId) public{
        //Check lp in token
    ...
    function removeStakeLP(uint _tokenId) public{
        //Check lp in token
        uint amount = getLiquidity(_tokenId);
        require(amount > 0, "Amount 0");
        _balances[msg.sender] = _balances[msg.sender] - amount;
    ...
    function Claim() public updateReward(msg.sender) checkStart{
        ...
        if (reward > 0) {
            ...
            uint tressuryamount = taxamount.mul(harvesttax).div(taxdenominator);
