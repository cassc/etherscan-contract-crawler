...
/**
PENGUIN SmartContract

https://t.me/PENGUINBNB
...
contract PENGUIN is ERC20, Ownable {
    ...
    PENGUINDividendTracker public dividendTracker;
    ...
    constructor() ERC20("PENGUIN", "PENGUIN") {
        marketingWallet = payable(0x9C57542c21eC79A05F94D429ccEbA0601B0B88F7);
        devWallet = payable(0x9C57542c21eC79A05F94D429ccEbA0601B0B88F7);
        ...
        dividendTracker = new PENGUINDividendTracker(
            payable(this),
            router,
...
contract PENGUINDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    PENGUIN public PENGUINContract;
    ...
    constructor(
        ...
        defaultToken = token;
        PENGUINContract = PENGUIN(mainContract);
    ...
    function _transfer(
        ...
        require(false, "PENGUIN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "PENGUIN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main PENGUIN contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(PENGUINContract);

            uint256 prevBalance = PENGUINContract.balanceOf(address(this));
            ...
            {
                uint256 received = PENGUINContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    PENGUINContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
