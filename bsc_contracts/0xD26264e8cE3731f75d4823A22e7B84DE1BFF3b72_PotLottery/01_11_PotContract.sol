...
contract PotLottery is ReentrancyGuard {
    ...
    constructor(address _owner) {
        ...
        addToken('BNB', 'BNB', 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c, 0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16, false, false, 18);
        addToken('Wrapped BNB', 'WBNB', 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c, 0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16, true, false, 18);
        addToken(
            'BNBP',
            'BNBP',
 ...
 */
    ...
    */
    function UpdatePrice(string memory _tokenName) public nonReentrant {
    ...
    */
     ...
     *
     */
    function _reBalanceTokenomicsPools() internal {
        uint256 totalPool = adminFeeTokenValues['BNBP'];
        airdropPool = (totalPool * airdropPercentage) / 100;
        lotteryPool = (totalPool * lotteryPercentage) / 100;
        burnPool = totalPool - airdropPool - lotteryPool;
    }
