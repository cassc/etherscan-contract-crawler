...
contract Chihuahua is Context, IERC20, Ownable {
    ...
    address payable public devWalletAddress = payable(0x17F093be4190c26288e69afb9E2b78C9Da5B8E0F); // dev Wallet Address
    ...
    function setReserveFee (uint256 reserveFee ) external onlyOwner() {
