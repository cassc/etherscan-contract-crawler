...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5541eD5666299f3544453dE20Db58fBC1D116DCd;
...
contract JojoCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "JojoCoin"; // 
    string private constant _symbol = "JOJO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x5541eD5666299f3544453dE20Db58fBC1D116DCd);
