...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x07936f766004040045084439047C668D4CBb0FEA; // owner address
...
contract pepewise is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe Wise";
    string private _symbol = "$PEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x07936f766004040045084439047C668D4CBb0FEA); // Marketing Address
    address payable public teamWalletAddress = payable(0x07936f766004040045084439047C668D4CBb0FEA); // Team Address
