...
CyberTrust was created for the purpose of developing a sophisticated blockchain development and growth service provider, our main service goal is to create a cheap and secure network. CyberTrust is a EVM-compatible privacy protocol. It is built as a native privacy layer that can provide end-to-end anonymity for the entire DeFi and Web3.0 stack.

http://t.me/cybertrustofc
https://cybertrust.space
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD431A5320c83B5D8160FcaA12fcfd74522d62fF8; 
...
contract CyberTrust is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CyberTrust";
    string private _symbol = "CYBER";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xb8D966d53637d291Ce35c3F26910301da81355B4); // 
    address payable public teamWalletAddress = payable(0xA635E1597F525fcCD1F2f4a334C2A6Ef2d55058a); // 
    ...
    uint256 private minimumTokensBeforeSwap = 70000 * 10**_decimals; 
