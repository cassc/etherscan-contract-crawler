...
contract z2023
 is Context, IERC20, Ownable {
    ...
    string private _name = "2023ZILLA";
    string private _symbol = "2023ZILLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF4FB555F6F3d5CCe6431dDBe6DfEdB7aC1C6A8de);
    address payable public teamWalletAddress = payable(0xF4FB555F6F3d5CCe6431dDBe6DfEdB7aC1C6A8de);
    address public immutable deadAddress =0xF4FB555F6F3d5CCe6431dDBe6DfEdB7aC1C6A8de;
