...
/** 
BVE is now trending on Twitter. 
Contract renounced - zero tax - Liquidity locked.
Huge community around BoboVSElmo - soon the new Pepe Coin. 

Telegram: https://t.me/BoboVSElmo
Website: https://www.BoboVSElmo.com
**/
...
contract BoboVSElmo {
    ...
    string public name = "BoboVSElmo";
    string public symbol = "BVE";
    ...
    function symbolBVE() public view virtual returns (string memory) {
        return 'memesymbol is BVE';
    }

    function symbolBVE2() public view virtual returns (string memory) {
        return 'mysymbol is BVE';
    }
