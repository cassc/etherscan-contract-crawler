...
contract NeverFallToken is ERC20,Ownable{
    ...
    uint256 public initSupply = 9900000000e18;
    ...
    constructor()ERC20("Never Fall","NF"){
       
        //router address
        uniswapV2Router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        usdtAddress = 0x55d398326f99059fF775485246999027B3197955;
        marketingAddress = 0x3a610c4A96448235D2Fb978b6d1a46C487a8bd89;
        ...
        _mint(0x1306715e31079Fd406C4816dDa734CCFB8572a4d, initSupply);
        whitelist[0x1306715e31079Fd406C4816dDa734CCFB8572a4d] = true;
        whitelist[marketingAddress] = true;
    }
    

    modifier notContract(){
        require(!msg.sender.isContract() || whiteContract[msg.sender],"0");
        _;
    }
    ...
    function setWhiteContract(address _account,bool value) public onlyOwner{
         whiteContract[_account] = value;
    }
    ...
    function buy(uint256 amountU) public notContract returns(uint256){
        //收usdt
        ...
        addLiquidity(initSupply, amountU * 93 / 100);
        uint256 afterLiquidityAmount = balanceOf(address(this));
        //5%的usdt购买
        buySwap(amountU * 5 / 100);
        ...
        //营销
        IERC20(usdtAddress).safeTransfer(marketingAddress,amountU * 2 / 100);
    ...
    function sell(uint256 amount) public notContract returns(uint256){
        ...
        IERC20(usdtAddress).safeTransfer(msg.sender, outU * 85 / 100);
         //营销
        IERC20(usdtAddress).safeTransfer(marketingAddress,outU * 15 / 100);
