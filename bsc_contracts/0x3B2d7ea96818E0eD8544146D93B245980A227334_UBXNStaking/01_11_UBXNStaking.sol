...
contract UBXNStaking is ERC20, ReentrancyGuard, Pausable, Ownable {
    ...
    function updateBotAddress(address _botAddress) public onlyOwner {
        require(_botAddress != address(0), "invalid address");
    ...
    function distributePerfPoolRewards() external updateReward(address(0)) {
        require(msg.sender == botAddress, "not a bot");
