...
contract Optimusfloki is Context, IERC20, Ownable {
    ...
    string private _name = "Optimusfloki";
    ...
    address payable public marketingWalletAddress = payable(0x5B632c94ABD17f3b461912c4382bccC9C5723a52); // Marketing Address
    address payable public teamWalletAddress = payable(0x5B632c94ABD17f3b461912c4382bccC9C5723a52); // Team Address
