...
contract PaperHands is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0xad19A3a4Cce73a60080080Ee36bB1E0965e7bdEA);
    ...
    //Token Definition.
    string public constant name = "Paper Hands";
    string public constant symbol = "PHANDS";
