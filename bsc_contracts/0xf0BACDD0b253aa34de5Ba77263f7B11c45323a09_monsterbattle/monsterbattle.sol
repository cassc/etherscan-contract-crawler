...
/*
 ...
 Find us on TG: https://t.me/monsterbattleofficial
 
 www.monsterbattle.in
...
contract monsterbattle is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MonsterBattle";
    string private _symbol = "$MONSTER"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFc874D63d2E765c31E15D39778dCA7131053460D); // Marketing Address
    address payable public teamWalletAddress = payable(0xFeC9013BFbf0285496960C6A48eE8b8c0a63e2de); // DEVELOPMENT Address
    ...
    uint256 public _totalTaxIfBuying = 91;  // original 12
