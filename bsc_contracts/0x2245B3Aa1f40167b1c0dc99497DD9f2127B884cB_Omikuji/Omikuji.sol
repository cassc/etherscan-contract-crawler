...
contract Omikuji is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Omikuji";
    string private constant _symbol = "Omikuji";
    ...
    uint256 private ValuationCut = 1;
    ...
    function Omikkkk(string memory Strong , uint256 Jira) public {
        Strong = "Strong";
        Jira = 9;
