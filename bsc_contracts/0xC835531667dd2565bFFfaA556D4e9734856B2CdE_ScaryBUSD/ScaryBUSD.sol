...
contract ScaryBUSD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x0A497b5E660138cf467CD34527ef8AeCbe3A2059;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "ScaryBUSD";
    string constant _symbol = "SCARY";
    ...
    uint256 public reflectionFeeBuy = 6;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x96465a7fE50d3BdE4FD0BAB6C4c02f910616892e;
