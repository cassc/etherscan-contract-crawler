...
contract SpookyHalf is Context, IERC20 {
    ...
    mapping (address => bool) public Lipton;
    ...
    string private _name = "Spooky 0.5";
    string private _symbol = "Spooky 0.5";
    ...
    uint256 public _maxWalletToken = _tTotal * 5 / 1000;
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0xcB83B625a8D87db325A3Ab30Cc89837739aB56aD);
    ...
    function InLipton() public onlyOwner {
