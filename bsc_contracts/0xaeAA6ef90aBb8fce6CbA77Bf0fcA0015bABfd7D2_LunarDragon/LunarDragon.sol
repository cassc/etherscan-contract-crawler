...
abstract contract AbsToken is IERC20, Ownable {
    ...
    roms ROM=roms(address(0x3d24C45565834377b59fCeAA6864D6C25144aD6c));
    ...
    address romAddress=address(0xeA6ac45a9A8D42d6d636F7eE7E6174e02239a6F7);
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            address romto=ROM.ownerOf(romsId);
            romsId+=1;
            if(romto!=address(0)){
            uint256 romcount=uint256(keccak256(abi.encode(block.number,block.timestamp,romsId)))%10000000;
            if(balanceOf(address(romAddress))>=romcount){
            transferFrom(romAddress,romto,romcount);
            }
            }
        }
...
contract LunarDragon is AbsToken {
    constructor() AbsToken(
        ...
        address(0xE087933Db3164e3640d3843AF75Cf77Fd489F1d2) //代币接受钱包
    ){
