...
Hasaki, MEME KING 🔥🔥 2023!Next 1000X Gems！Elon's third doge！
（OWNERSHIP RENOUNCED AND LP Lock ）
🔉TG:https://t.me/HaHacoinbsc
*/
...
contract Hasaki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Hasaki";
    string private _symbol = "HaHa";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x53CE0077DE8e76109573fe0d23aa3Be51534Df08);
