    ...
    WhitelistManager
{
    ...
    */
    ...
    function initializeBBB(address _busdToken, uint256 startingAmount, uint256 callerRate) public onlyOwner {
    ...
    function buyBackAndBurn() public {
        ...
        (uint256 _buyAmount, uint256 _rewardAmount) = getAmountAvailableToBurn();
    ...
    function getAmountAvailableToBurn() public view returns (uint256 burnAmount, uint256 rewardCaller) {
