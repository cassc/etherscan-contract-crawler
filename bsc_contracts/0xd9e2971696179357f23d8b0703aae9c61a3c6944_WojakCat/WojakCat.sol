...
Welcome to WojakCat. The new meme coin on BSC that merges the legend Wojak and Cat

Same tokenomics like old Wojak. 

5/5 tax - All into lp to make it rise as we grow
...
contract WojakCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "WojakCat"; // 
    string private constant _symbol = "WOJAT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0x8A45C53D1054fAC58931B5Ed3693EFB473cF9Da9;
