...
Telegram : https://t.me/pupu_token
Twitter  : https://twitter.com/pupu_token
Website  : TBA

                PUPU 🐸🌸 || Stealth Launch 

The Pepe Frog's Girlfriend 
PUPU is a frog girl who comes from Japanese and was born as PePe's fiancé to complete Pepe's role.
Become a First Mover taken from Anime Style (Japan Concept), 
This token is community driven and will build a solid community on the first launch.

ETA : 18.00 - 20.00 p.m UTC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x640134F241a1fc4D4BAB47954B8BBe5A56A063fE;
...
contract PUPU is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x640134F241a1fc4D4BAB47954B8BBe5A56A063fE);
    ...
    string private _name = "PUPU"; 
    string private _symbol = "PUPU";  
    uint8 private _decimals = 15;
    uint256 private _tTotal = 100000000000000 * 10**15;
