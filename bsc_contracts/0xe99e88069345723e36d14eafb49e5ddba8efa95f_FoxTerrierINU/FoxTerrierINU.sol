...
contract FoxTerrierINU is ERC20, Ownable {

    uint256 public transactionFeeRate = 15; // 15% transaction fee on buy and sell
    uint256 public _maxTxAmount = 100000000000 * 10 ** 18;
    address public marketingWallet = 0xc7A9bD264f7Ff1Da671F5193f08399EA0111035D; 

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("FoxTerrierINU", "FOXT") {
