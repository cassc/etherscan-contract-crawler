...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a373E0b068B3112477D5Cba2868cF92dfb037cE; // owner address
...
contract HeIsAi is Context, IERC20, Ownable {
    ...
    string private _name = "He Is Ai";
    string private _symbol = "HEISAI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4c205e5713aA41Cd86f9E39926255B4cb4E56ed6); // Marketing Address
    address payable private teamWalletAddress = payable(0x4c205e5713aA41Cd86f9E39926255B4cb4E56ed6); // Team Address
