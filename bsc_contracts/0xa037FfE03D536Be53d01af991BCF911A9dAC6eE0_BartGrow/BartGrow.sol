...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbC7F9f356fA1D787F3334BFD41E3cDC6DEf945Bf; // owner address
...
contract BartGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bart Grow";
    string private _symbol = "$BGROW";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xec1d1BAA10EE667b53f3a84903Ab4ed633c63508); // Marketing Address
    address payable private teamWalletAddress = payable(0xbC7F9f356fA1D787F3334BFD41E3cDC6DEf945Bf); // Team Address
