...
contract SPACEX is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8ebe24DC8eCFd8B0A00Be92Dc6F71F1B44F35573); // Marketing Address
    address payable public teamWalletAddress = payable(0x8ebe24DC8eCFd8B0A00Be92Dc6F71F1B44F35573); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000 * 5 **_decimals; 
