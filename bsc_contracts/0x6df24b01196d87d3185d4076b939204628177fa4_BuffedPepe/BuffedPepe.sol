...
contract BuffedPepe is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BuffedPepe";
    string constant _symbol = "Buffed Pepe";
    ...
    uint256 public _maxTxAmount = 100 * 10**10 * (10 ** _decimals);
    uint256 public _walletMax = 100 * 10**10 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        //
        autoLiquidityReceiver = 0x2a96Cb99E822dA0dC14dde0d33e7ac51A67c1dfD;
        marketingWallet = 0x2a96Cb99E822dA0dC14dde0d33e7ac51A67c1dfD;
        devWallet = 0x2a96Cb99E822dA0dC14dde0d33e7ac51A67c1dfD;
