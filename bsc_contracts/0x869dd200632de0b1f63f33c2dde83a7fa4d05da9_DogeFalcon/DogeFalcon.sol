...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8139B99A9bd8B528edBbCF69A72E2CEB2086E2F5; 
...
contract DogeFalcon is Context, IERC20, Ownable {
    ...
    string private _name = "DogeFalcon";
    string private _symbol = "DGFLCN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8139B99A9bd8B528edBbCF69A72E2CEB2086E2F5); // 
    address payable public teamWalletAddress = payable(0x8139B99A9bd8B528edBbCF69A72E2CEB2086E2F5); // 
