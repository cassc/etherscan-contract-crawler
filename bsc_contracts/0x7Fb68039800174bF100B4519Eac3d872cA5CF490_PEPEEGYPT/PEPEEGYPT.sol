...
contract PEPEEGYPT is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 100000000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline ;
    uint256 private launchtax ;

    address public marketingWallet = 0x541131923fc85759935686B83b87E4aC8E362aE6;
    address public devWallet = 0xcb586BD86470e8a366E8bA3A9419d94c8752d40b;
    ...
    constructor() ERC20("EGYPTIAN PEPE", "$EGYPTIANPEPE") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        require(new_amount >= 42069000000,"Swap threshold amount should be lower or equal to 0.01% of tokens");
