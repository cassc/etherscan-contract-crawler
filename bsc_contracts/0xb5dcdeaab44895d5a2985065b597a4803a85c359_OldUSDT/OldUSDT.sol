...
Welcome to OLDTETHER_USDT♻️

♻️OLDTETHER_USDT is 100% based on USDT's journey from ancient to modern times and a decentralized community token based on exchange. 📈 $OLDUSDT - The Most Secure and Fastest Growing Decentralized Coin. In 2023, it's time for oldusdt to head to the Crypto World. We launched a Crypto marketing campaign across social media

🌍Global Community :
https://t.me/OldTetherUsdt
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa0d55eB2a69CF8BE6e71Ce71Ac68080DD77B58cE;
...
contract OldUSDT is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 20000000 * 10**9; //
    string private constant _name = "Old USDT"; // 
    string private constant _symbol = "OldUSDT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xCcC7AE8cA5C7e351194Dd2e6ecB1c8c061778546);
