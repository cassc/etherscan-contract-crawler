...
contract STRATOCOINERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("STRATOCOIN", "STC", 10) 
    ERC20Permit("STRATOCOIN") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 320000000000000000); 
