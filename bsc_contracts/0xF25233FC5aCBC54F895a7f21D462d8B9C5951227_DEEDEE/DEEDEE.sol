...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x92eD61FB8955Cc4e392781cB8b7cD04AADc43D0c); //OGGY
...
contract DEEDEE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Dee Dee Inu";
    string constant _symbol = "DEEDEE";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address TEAM = 0x91c143cB8Af27A4bC322289Fbf6A65691b8B2Dbd;   
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x92eD61FB8955Cc4e392781cB8b7cD04AADc43D0c;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x002BDE1F4217400E4aF6e28014cf6dAF0c7Cc000; //=
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(9).div(10);
