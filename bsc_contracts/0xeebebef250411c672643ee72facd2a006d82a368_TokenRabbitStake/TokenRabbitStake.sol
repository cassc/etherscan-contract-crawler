...
// Submitted for Telegram: https://t.me/rabbitstake_bsc
// Submitted for Website: rabbitstake.site
...
contract  TokenRabbitStake  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Rabbit Stake Token";
    string private _symbol = "RBTS";
