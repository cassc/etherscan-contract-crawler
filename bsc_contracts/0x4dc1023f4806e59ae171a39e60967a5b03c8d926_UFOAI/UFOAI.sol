...
contract UFOAI is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "UFO AI";
    string private _symbol = "UAI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xD0AE8c700D0709d170386cef3E99a8c98caAe885);
    address payable public liqWalletAddress = payable(0xD0AE8c700D0709d170386cef3E99a8c98caAe885);
    ...
    uint256 private minimumTokensBeforeSwap = 30 * 10**_decimals;
