...
contract DRAGONSHIB is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 10 / 1000; // 1%
    ...
    uint256 public gas = 7 * 1 gwei;

    string constant _name = "Dragon Shiba";
    string constant _symbol = "DSH";
    ...
    uint256 public totalFee = 27;
    uint256 public totalFeeIfSelling = 27;

    address public autoLiquidityReceiver = 0x6b1F9eB73876F80B61974f7359a581278864401A;
    address public marketingWallet = 0x6b1F9eB73876F80B61974f7359a581278864401A;
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x6b1F9eB73876F80B61974f7359a581278864401A;
        marketingWallet = 0x6b1F9eB73876F80B61974f7359a581278864401A;
