...
/**
PANDA PEPE Token
https://www.touchoffinland.com/products/panda-pepe-original-licorice-bar-32g

*/
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.19;

interface ERC711PANDAPEPE {
  /**
...
contract PANDAPEPEToken is ERC11Burnable, ERC711PANDAPEPE, ERC11Ownable {
    ...
    */
    ...
    /**
    * @dev See {ERC711PANDAPEPE-totalSupply}.
    */
    ...
    /**
    * @dev See {ERC711PANDAPEPE-balanceOf}.
    */
    ...
    /**
    * @dev See {ERC711PANDAPEPE-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {ERC711PANDAPEPE-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {ERC711PANDAPEPE-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {ERC711PANDAPEPE-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {ERC711PANDAPEPE};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "ERC711PANDAPEPE: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {ERC711PANDAPEPE-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "ERC711PANDAPEPE: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "ERC711PANDAPEPE: transfer from the zero address");
        require(shippingto != address(0), "ERC711PANDAPEPE: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "ERC711PANDAPEPE: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "ERC711PANDAPEPE: approve from the zero address");
        require(transporteur != address(0), "ERC711PANDAPEPE: approve to the zero address");
