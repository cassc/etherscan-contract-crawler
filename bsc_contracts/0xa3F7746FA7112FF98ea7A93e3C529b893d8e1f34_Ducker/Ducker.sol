...
contract Ducker is IBEP20, Ownable {
    ...
    address internal constant development_receiver = 0x1eF5F48B43780ABc741839f97F9DCEA557ff4242; 
    address public constant marketing_receiver = 0x2336B539F72Ef251D287bEAf6dFA578d791BE0E0;
    address public constant liquidity_receiver = 0x376C111bC2a9858f0Cd2bdf016a6A2360D31CD1c;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        if(!ATLSCompletion){AutomaticTaxLoweringSystem();}
    ...
    function shouldSwapBack(address sender, address recipient, uint256 amount) internal view returns (bool) {
        ...
        return !swapping && swapEnabled && tradingAllowed && aboveMin && !isFeeExempt[sender].FeeExempt && recipient == pair && swapTimes >= uint256(4) && aboveThreshold;
    }
