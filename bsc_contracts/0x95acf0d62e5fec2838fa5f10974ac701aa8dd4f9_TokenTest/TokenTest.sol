...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1D35D4f6FFAc8aC559c8fB501096C9E23ac7B2f1;
...
contract TokenTest is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xC6469035B21E7A651ED5e97edBe4454d9de2B76E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 350000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Token Test";
    ...
    uint256 public _maxTxAmount = 350000000 * 10**18;
