...
contract DeltaChain is ERC20, Ownable, ReentrancyGuard {
    ...
    address public marketingWallet = 0xb7e5E6539f4253F8850a9e49794551488db8afd9;
    ...
    constructor() ERC20("DeltaChain", "DELTA") {
    ...
    function _transfer(
        ...
        if (
            ...
            _autoswapBack(contractTokenBalance);
        }
    ...
    function _autoswapBack(uint256 tokenAmount) internal {
        swapping = true;
        ...
        if (marketingShare > 0) {
            outBNB(marketingWallet, marketingShare);
        }
    ...
    function outBNB(address _to, uint256 amount) internal nonReentrant {
        require(
            address(this).balance >= amount,
