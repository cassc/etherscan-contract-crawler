...
contract KolStrategyThenaFrxEth is Initializable, UUPSUpgradeable, FeeManager {
    ...
    function initialize() public initializer {
        ...
        address mainToken = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; //ETH
        address pairToken = 0x64048A7eEcF3a2F1BA9e144aAc3D7dB6e58F555e; //frxETH

        address _want = 0x8A420aACA0c92e3f97CDcFdd852e01Ac5b609452; //ETH-frxETH LP
        address _gauge = 0x33a357faD7DD41692f2403b919225f0624eA50ff;//ETH-frxETH Thena Gauge
        ...
        _outputToLp0Route[1].stable = false;
        ...
        if (pairToken == chainNative) {
            ...
            _outputToLp1Route[1].to = mainToken; //ETH
            _outputToLp1Route[1].stable = false;

            _outputToLp1Route[2].from = mainToken; //ETH
            _outputToLp1Route[2].to = pairToken; //frxETH
            _outputToLp1Route[2].stable = stable;
