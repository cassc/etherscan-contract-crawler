...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa3C947fCef8b038d170dfC434D0219C4484495BE; // owner address
...
contract Shibosu is Context, IERC20, Ownable {
    ...
    string private _name = "Shibosu";
    string private _symbol = "$SHIBO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa3C947fCef8b038d170dfC434D0219C4484495BE); // 
    address payable public teamWalletAddress = payable(0xa3C947fCef8b038d170dfC434D0219C4484495BE); // 
