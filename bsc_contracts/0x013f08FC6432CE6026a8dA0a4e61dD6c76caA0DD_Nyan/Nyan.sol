...
contract Nyan is Context, IBEP20, Ownable {
    ...
    string  private constant _SYMBOL = "~=[,,_,,]:3";
    ...
    uint256 private constant     _TAX_FEE = 3;
    uint256 private constant    _BURN_FEE = 0;
    uint256 private _MAX_TX_SIZE = 5000000000 * _DECIMALFACTOR;
