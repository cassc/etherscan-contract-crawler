...
Telegram  : https://t.me/pepesmokebsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7fdCd1cC29B84dFf65C83C89e0E69d1F5DF182C2;
...
contract PEPESMOKE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE SMOKE";
    string private _symbol = "$SMOKE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7fdCd1cC29B84dFf65C83C89e0E69d1F5DF182C2);
    address payable public teamWalletAddress = payable(0x7fdCd1cC29B84dFf65C83C89e0E69d1F5DF182C2);
