...
TG: https://t.me/RabbitEastergpt4
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6c433857e3a3Ee9EFFcB4d9957DE0756c2988D5F; // owner address
...
contract Rabbiteastergpt4 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Rabbit easter Gpt-4";
    string private _symbol = unicode"REGPT-4";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6c433857e3a3Ee9EFFcB4d9957DE0756c2988D5F); // Marketing Address
    address payable public teamWalletAddress = payable(0x6c433857e3a3Ee9EFFcB4d9957DE0756c2988D5F); // Team Address
