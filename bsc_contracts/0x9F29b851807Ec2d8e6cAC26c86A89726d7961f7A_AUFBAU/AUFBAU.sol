...
contract  AUFBAU is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = unicode'Aufbau';
    string private constant _symbol = 'AUFBAU';
    ...
    address internal constant development_receiver = 0x787EF35807c4d949a6B80F8e0d7997282726275B; 
    address internal constant marketing_receiver = 0x787EF35807c4d949a6B80F8e0d7997282726275B;
    address internal constant liquidity_receiver = 0x787EF35807c4d949a6B80F8e0d7997282726275B;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator && sellFee <= denominator, "totalFee and sellFee cannot be more than 16%");
    }
