...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5b4514b8C8d1A032b49cB73ca983f87E6bF26922; // owner address
...
contract SeijiruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SeijiruInu";
    string private _symbol = "SEIJI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5b4514b8C8d1A032b49cB73ca983f87E6bF26922); // 
    address payable public teamWalletAddress = payable(0x5b4514b8C8d1A032b49cB73ca983f87E6bF26922); // 
