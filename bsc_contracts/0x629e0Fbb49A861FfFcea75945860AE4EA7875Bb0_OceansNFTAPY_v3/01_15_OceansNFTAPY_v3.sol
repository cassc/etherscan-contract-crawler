...
contract OceansNFTAPY_v3 is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function quickSetting() public onlyOwner {
        uint factor = 10 ** 20;
        _NftData[1] = database(1, 100, 1*factor);
        _NftData[2] = database(2, 200, 3*factor);
        _NftData[3] = database(3, 300, 9*factor);
        _NftData[4] = database(4, 400, 15*factor);
        _NftData[5] = database(5, 500, 21*factor);
        _NftData[6] = database(6, 600, 28*factor);
        _NftData[7] = database(7, 700, 30*factor);
        _NftData[8] = database(8, 800, 37*factor);
        _NftData[9] = database(9, 900, 42*factor);
        _NftData[10] = database(10, 1000, 50*factor);
    }
