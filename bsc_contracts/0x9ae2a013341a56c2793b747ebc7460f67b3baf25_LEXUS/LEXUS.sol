...
/*
   Official Community: https://t.me/LEXUSCHAIN
*/
...
contract LEXUS is IERC20, Context, Ownable {
    ...
    string private constant _symbol = "LXS";
    string private constant _name = "LEXUS CHAIN";

    uint256 public Max_Buy_Limit = 10000000 * 10**9;
    uint256 public Max_Sell_Limit = 10000000 * 10**9;

    address private Marketing_Wallet = 0x322E7D7750A6CA7894e2Efc97D5797bBe7543Cb2;
    address private Team_Wallet = 0x322E7D7750A6CA7894e2Efc97D5797bBe7543Cb2;

    uint256 public Max_Wallet_Holding = 20000000  * 10**9;
    ...
    Taxes public sellTaxes = Taxes(1, 13, 1, 0);
    Taxes public taxes = Taxes(1, 13, 1, 0);
