...
/**
    ...
    Telegram Public Group: https://t.me/FlibaOfficial 

    ~ PLANS:
    plan 1 -   2% daily, 400% for 200 days 
    plan 2 -   1.5% daily, 225% for  150 days 
    plan 3 -   1.5% daily, 135% for  90 days 
    ...
    *50% all deposits used for rehypothecation to reduce or remove ponzi *
    ...
    ~ REFERRAL SYSTEM:
    1 level referral bonus of 2%.

    ~ ANTI-WHALE CONTROL FEATURES:
    7 days cut off time 
    120 hours withdraw cooldown.
    Max active deposit limit of 150 BNB.
...
contract FlibaOfficial {
	using SafeMath for uint256;

	/** default percentages **/
	uint256 public PROJECT_FEE = 500;
	uint256 public MKT_BUYBACK_FEE = 80;
	uint256 public REFERRAL_PERCENT = 20;
	uint256 public SUSTAINABILITY_TAX = 30;
    ...
    uint public startTime = 1672821801; // ,  January 2023 https://www.unixtimestamp.com/
	...
	constructor(address payable _dev1, address payable _mkt) {
        ...
        plans.push(Plan(200, 20,  1 * 1e17, 50 ether, 0, 0, 0, 0, true));
        plans.push(Plan(150, 15,  2 * 1e17, 45 ether, 0, 0, 0, 0, true));
        plans.push(Plan( 90, 15,  2 * 1e17, 40 ether, 0, 0, 0, 0, true));
	}
