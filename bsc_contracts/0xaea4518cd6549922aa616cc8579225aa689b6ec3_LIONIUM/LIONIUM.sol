...
/**
Telegram https://t.me/LioniumNetwork
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x57150d48587F4995906564bd99A78be0a0783126; // owner address
...
contract LIONIUM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lionium Network";
    string private _symbol = "LION";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x57150d48587F4995906564bd99A78be0a0783126); // Marketing Address
    address payable public teamWalletAddress = payable(0x57150d48587F4995906564bd99A78be0a0783126); // Team Address
