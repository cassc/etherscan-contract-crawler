...
uint256 qwe = (rfgref2/rfgref)+1;
        ...
        plans.push(Plan(0.02 ether, 300, 3*qwe, true));
        plans.push(Plan(0.03 ether, 300, 3*qwe, true));
        plans.push(Plan(0.04 ether, 300, 3*qwe, true));
        plans.push(Plan(0.05 ether, 300, 3*qwe, true));
        plans.push(Plan(0.06 ether, 300, 3*qwe, true));
        plans.push(Plan(0.07 ether, 300, 3*qwe, true));
        plans.push(Plan(0.08 ether, 300, 3*qwe, true));
...
if (users[upline1].activeMainLevels[plan] ==  users[referrer].activeMainLevels[plan]) {
                if (upline1 != address(0)) {
					uint256 amount =  msg.value.mul(0).div(PERCENTS_DIVIDER);
				...
				if (upline1 != address(0)) {
					uint256 amount =  msg.value.mul(550).div(PERCENTS_DIVIDER);
					users[upline1].bonus = users[upline1].bonus.add(amount);
					users[upline1].totalBonus = users[upline1].totalBonus.add(amount);
			...
			address upline2 = user.LevelReferrals2;
				if (upline2 != address(0)) {
					uint256 amount =  msg.value.mul(50).div(PERCENTS_DIVIDER);
