...
contract stableAGI is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("stableAGI", "stableAGI") payable
    {
        uint256 initialSupply = 1000000000000000 * (1**18);
        address owner = 0x45b2b69e2eD4EC9eD8C9789676Ca3956c85b5B8D; // owner wallet
