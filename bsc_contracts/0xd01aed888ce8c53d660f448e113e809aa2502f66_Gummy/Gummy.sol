...
contract Gummy is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gummy Bear Soldiers";
    string private constant _symbol = "GUMMY";
    ...
    constructor() {
        ...
        marketingAddress = payable(0x959850002f06B970727f009BbDc34308CE774a30); // Marketing Address
        liquidityAddress = payable(address(owner())); // Liquidity Address
        teamAddress = payable(0x959850002f06B970727f009BbDc34308CE774a30); // Team Address
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForMarketing = ethBalance.mul(_marketingTokensToSwap).div(
            totalTokensToSwap
        );
        uint256 ethForTeam = ethBalance.mul(_teamTokensToSwap).div(
            totalTokensToSwap
        );
    ...
    function setBuyFee(
        ...
        require(
            _buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <=
                1500,
            "Must keep buy taxes below 15%"
        );
