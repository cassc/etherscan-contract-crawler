...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x7DE821be16c4ad46A03cf52Ca109c49B85C0d286;
...
contract KERBEROSINU is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Kerberos Inu"; 
    string private constant _symbol = unicode"$KERBEROS"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x7DE821be16c4ad46A03cf52Ca109c49B85C0d286), BNB_Tot);
            }
