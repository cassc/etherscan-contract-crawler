...
/**
    ...
    Telegram: https://t.me/TrumpGrowBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x347242e8b23B69017456fD2Dc1e059a98126686D; // owner address
...
contract TrumpGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Trump Grow ";
    string private _symbol = "TRUMPGROW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x347242e8b23B69017456fD2Dc1e059a98126686D); // Marketing Address
    address payable public teamWalletAddress = payable(0x347242e8b23B69017456fD2Dc1e059a98126686D); // Team Address
