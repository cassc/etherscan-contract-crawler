...
/*
telegram : https://t.me/barneschain
web :      https://barnes-chain.live
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE48A6B4ADfaD5fC0583B184B645baA60Cb85C91B; // 
...
contract BarnesChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Barnes Chain";
    string private _symbol = "Bchain";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE48A6B4ADfaD5fC0583B184B645baA60Cb85C91B); // Marketing Address
    address payable public teamWalletAddress = payable(0xE48A6B4ADfaD5fC0583B184B645baA60Cb85C91B); // Team Address
