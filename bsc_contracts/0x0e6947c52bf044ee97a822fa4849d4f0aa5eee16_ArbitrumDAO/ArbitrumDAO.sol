...
contract ArbitrumDAO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x030374206F51ef684d45fD6C08a335f0BaeafCd9;

    string private constant _name = "ArbitrumDAO";
    string private constant _symbol = "ArbitrumDAO";
    
    struct Taxes {
        uint256 rfi;
        uint256 marketing;
    }
    // tax 2% reflection, 6% mkt
