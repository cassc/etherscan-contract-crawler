...
contract KillerPEPE is Context, IERC20, Ownable {
    ...
    string public constant contractVersion = "1.1";
    string public constant contractDev = "Samurai";
    string public constant contractEdition = "MarketingWallet";
    //Definition of Wallets for Marketing or team.
    address payable public marketingWallet =
        payable(0x47c8bAb69BEd0F1A2e3578714dd2e7BDb9ECC44C);
    //adding customer wallet to send supply and exclude from fees.
    address payable public Buyback=
        payable(0xeCEd2FA09A696D1f63aB1b3073c627ceaED24d15);
    ...
    //Token Definition.
    string public constant name = "Killer PEPE";
    string public constant symbol = "KillPepe";
    ...
    uint256 public swapOutput = 0;
        //Trading Controls added for MarketingWallet Requirements
...
//What is my router and exclude pinksale locker.
        ...
        if (block.chainid == 56) {
            ...
            marketingWallet = payable(0x4c4DAFf8A144213896db1dD85730163d17EB6afe);
        } else if (block.chainid == 137) {
            currentRouter = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506; //Polygon Quick
            _isExcludedFromFee[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true;
        ...
        //Owner of balance
        _tOwned[marketingWallet] = _tTotal;
    ...
    function recoverTokensFromContract(
        ...
        //Trading Controls for Marketing Contract
