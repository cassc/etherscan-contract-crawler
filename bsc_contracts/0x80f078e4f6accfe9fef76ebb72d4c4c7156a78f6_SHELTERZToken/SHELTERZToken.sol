...
// https://t.me/shelterz_token_eng
// SPDX-License-Identifier: Unlicensed
pragma solidity ^0.8.18;

abstract contract ContextBep20NFT {
...
contract OwnableBep20NFT is ContextBep20NFT {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBep20NFT: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBep20NFT: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract SHELTERZToken  is ContextBep20NFT, Bep20NFT, OwnableBep20NFT {
    ...
    string private _name = 'SHELTERZ';
    string private _symbol = 'SHELTERZ';
