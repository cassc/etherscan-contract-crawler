...
contract HakuAIToken is HakuAIDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HakuAITeam;
    address private CharityHakuAI;
    ...
    string public override name = "Haku AI";
    string public override symbol = "HAI";
    ...
    constructor(uint totalSupplyValue, address HakuAITeamAddress, address CharityHakuAIAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HakuAITeam = HakuAITeamAddress;
        CharityHakuAI = CharityHakuAIAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HakuAITeam] =  totalSupply * 4 / 100;
        balances[CharityHakuAI] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's HakuAITeam pot
