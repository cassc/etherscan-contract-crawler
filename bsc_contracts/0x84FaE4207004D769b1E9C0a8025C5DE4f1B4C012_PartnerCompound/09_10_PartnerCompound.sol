...
contract PartnerCompound is Initializable, Ownable, ReentrancyGuard
{
	...
	{
		address ESHARE_V1 = 0xDB20F6A8665432CE895D724b417f77EcAC956550;
		address ESHARE_V2 = 0x29C55f1b02A95F0B30e61976835a3eee2359ad92;
		require(reserveToken == ESHARE_V1, "invalid state");
		uint256 _balance = IERC20(ESHARE_V1).balanceOf(address(this));
		IERC20(ESHARE_V1).approve(ESHARE_V2, _balance);
		IEShareV2(ESHARE_V2).swap();
		require(IERC20(ESHARE_V2).balanceOf(address(this)) == _balance, "invalid balance");
		reserveToken = ESHARE_V2;
		rewardToken = ESHARE_V2;
	}
