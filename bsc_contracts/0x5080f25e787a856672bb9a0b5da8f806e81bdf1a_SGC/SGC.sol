...
contract SGC is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Shiba Green Classic";
    string private constant _symbol = unicode"SGC";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x0B34742D44cc8f631714F4EB03840695Cb61adaa);
    address payable public MarketingWallet = payable(0xa3Ab3FE6D0eC98E543622989EE76f44E1cC9f7F5);
