...
contract PandaYAYA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private supply = 420690000000000 * 1e9;
    ...
    uint256 public rewardCharity = 1;
    ...
    constructor() ERC20("Panda YAYA", "PYY") {
        router = IRouter(address(0x10ED43C718714eb63d5aA57B78B54704E256024E));
        swapPair = IFactory(router.factory()).createPair(
            address(this),
            router.WETH()
        );
        marketing = address(0xE118732717D9ed746441bae366e4C6BD2a08fD01);
        dev = address(0xb42144ec499ecea291b8899d322C3692286972EC);
        charity = address(0xD8A70629C530430A24e9fD71A972A015C3748Ba6);
    ...
    function setReward(uint256 total_,uint256 rewardMtk_,uint256 rewardDev_,uint256 rewardCharity_) external onlyOwner {
        fee = total_;
        reward = rewardMtk_;
