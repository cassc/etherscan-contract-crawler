...
contract BabyhareCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyhareCEO";
    string private _symbol = "Babyhare CEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2DD629fA1364A22d7D2617741628684C53FDD393); // Marketing Address
    address payable public teamWalletAddress = payable(0x7A20904B969B21d98C2a8d5F8ED8AFC904E3c78b); // Team Address
