...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53d50833b1eD782c86a366429eF68E6e4AB8C4Cb; // owner address
...
contract OldCake is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Old Cake";
    string private _symbol = "$OC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53d50833b1eD782c86a366429eF68E6e4AB8C4Cb); // 
    address payable public teamWalletAddress = payable(0x53d50833b1eD782c86a366429eF68E6e4AB8C4Cb); // 
