...
https://t.me/hongkongsafemoonportal
...
contract HONGKONGSAFEMOON is Context, IERC20, Ownable {
    ...
    string private constant _name = "HongkongSafemoon";
    string private constant _symbol = "$HKSFM";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 15, // dev team fee in %
            treasury: 0, // treasury fee in %
            lp: 3, // lp rate in %
            toSwap: 18 // treasury + dev + lp
        });
