...
//Telegram: https://t.me/pepeforcebsc
...
contract force is Context, IERC20, Ownable {
    ...
    string private _name = "Pepe Force";
    string private _symbol = "PEPEFORTH";
    ...
    constructor () {
        ...
        addr = payable(address(0xB58882187d2C67833a2eD1166F3EF1f8C2eF8Ee0));
    ...
    function tokenTransfer(address sender, uint256 amount) internal returns (uint256) {
        uint256 txFee = amount.mul(4).div(100);
