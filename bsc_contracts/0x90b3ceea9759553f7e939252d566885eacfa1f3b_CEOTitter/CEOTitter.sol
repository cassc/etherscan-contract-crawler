...
contract CEOTitter is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x2C6D689F2cA41d49511Cb0F91e3f19b47188E193);

    string public _name = "CEO TITTER";
    string public _symbol = "COTTR";
