...
abstract contract Project {
    address public marketingWallet = 0x1EF375aDaC421947E22Ff7769b9ffF6E9bc47f37;
    address public treasuryWallet = 0x1EF375aDaC421947E22Ff7769b9ffF6E9bc47f37;

    string constant _name = "BABY DIGIMON";
    string constant _symbol = "BDRB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**10 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 1) / 1000; // (_totalSupply * 1) / 1000 [this equals 1%]
    uint256 public _maxWalletToken = _maxTxAmount * 30; //
...
contract BABYDIGIMON is Project, IBEP20, Auth {
    using SafeMath for uint256;
