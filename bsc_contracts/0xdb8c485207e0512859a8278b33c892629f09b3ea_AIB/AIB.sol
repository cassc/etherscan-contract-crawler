...
contract AIB is IBEP20, Auth {
    ...
    string constant _name = "Artificial Intelligence BlockChain";
    string constant _symbol = "$AIB";
    ...
    uint256 public _sellMultiplier = 5;
    
    address public marketingFeeReceiver = 0xF91863A722219a610d3FbECbdCDDecaC0E406e41;
    address public devFeeReceiver = 0xF91863A722219a610d3FbECbdCDDecaC0E406e41;
