...
// don`t jeets my project i will give you x100 to x1000
// i need strong community holders
// check my contract 1st before you invest
// PATIENT IS THE KEY
// HOLD UNTIL 1$
/ TELEGRAM: https://t.me/Holduntil1dollar
*/
...
contract DONTJEETS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " HOLD UNTIL 1$ ";
    string private _symbol = " JEETSNOTALLOWED "; 
