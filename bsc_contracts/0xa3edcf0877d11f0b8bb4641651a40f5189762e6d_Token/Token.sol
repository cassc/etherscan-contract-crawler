...
contract Token is Context, IERC20, Ownable {
    ...
    constructor (address payable _feeWallet)  {
        uint256 amountOfTokenWei = 20000000000000000000000000000;         
        ...
        numTokensSellToAddToLiquidity = 250000000000000000000000;        
    ...
    function setNumTokensSellToAddToLiquidity (uint _amountInWei) external onlyOwner(){
        numTokensSellToAddToLiquidity = _amountInWei;
    }
    ...
    function _burn(address account, uint96 amount) internal {
        require(account != address(0), "NEXTToken: burn from the zero address");
        require(_rOwned[account] >= amount, "NEXTToken: amount exceeds");
    ...
    function burn(uint256 rawAmount) public nonReentrant(){
        uint96 amount = safe96(rawAmount, "NEXTToken::approve: amount exceeds 96 bits");
