...
contract ArabianRabbitInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arabian Rabbit Inu";
    string private constant _symbol = "ARRI";
