...
//TELEGRAM:https://t.me/thesimpsoncoins
interface IERC20 {
...
contract THESIMPSONCOIN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 240000000000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = 480000000000000 * 10**_decimals;
    
    uint256 public maxSellAmount = 240000000000000000 * 10**_decimals;
    uint256 public maxBuyAmount = 240000000000000000 * 10**_decimals;
    uint256 public maxWalletBalance = 240000000000000000 * 10**_decimals;

    address public marketingAddress = 0x22C07a0cF7c5cFF69CA1D4Cbfaf09fC90629fD74;
    address public devAddress = 0x22C07a0cF7c5cFF69CA1D4Cbfaf09fC90629fD74;

    string private constant _name = "THE SIMPSON COIN";
