...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x110519555566ADA278b726282675B381f3C99958; // owner address
...
contract SAMURAI is Context, IERC20, Ownable {
    ...
    string private _name = "SamurAI";
    string private _symbol = "$SHINAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x110519555566ADA278b726282675B381f3C99958); // Marketing Address
    address payable public teamWalletAddress = payable(0x110519555566ADA278b726282675B381f3C99958); // Team Address
