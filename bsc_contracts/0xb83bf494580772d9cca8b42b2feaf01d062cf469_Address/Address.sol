...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x773D4b905a355b82BfeaE44B7d7c091d92403365;
...
contract pytest is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x773D4b905a355b82BfeaE44B7d7c091d92403365);
    ...
    string private _name = "Pytest"; 
    string private _symbol = "test";  
    uint8 private _decimals = 18;
    uint256 private _tTotal = 290000000 * 10**18;
