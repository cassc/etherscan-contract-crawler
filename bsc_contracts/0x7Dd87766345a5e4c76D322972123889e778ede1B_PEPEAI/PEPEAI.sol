...
contract PEPEAI is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe AI", "PepeAI") {
        _mint(msg.sender, 69000000000000 * 10**uint8(_decimals));
    }
    ...
    function _checkTimeout(address sender, address recipient) internal {
      ...
      if (!_timeoutWhitelist[sender]) {
       require(block.timestamp >= lastTransfer[sender] + timeout, "lock for prevent bots.");
      }
