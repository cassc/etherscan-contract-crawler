...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9965a810d2F812184b9dAe6968Eb787BC9BD4D3D;
...
contract GAMAKICHI is Context, IERC20, Ownable {
    ...
    string private _name = "GAMAKICHI TOKEN";
    string private _symbol = "$GAMAKICHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9965a810d2F812184b9dAe6968Eb787BC9BD4D3D);
    address payable public teamWalletAddress = payable(0x9965a810d2F812184b9dAe6968Eb787BC9BD4D3D);
