...
contract deneme is ERC20, Ownable {
    uint256 public marketingFeeOnBuy  = 0;
    uint256 public marketingFeeOnSell = 0;

    address public marketingWallet = 0x45666E3546606Cae2F0FACf4eC7c9a0537F25C6D;
    ...
    function setFees(uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnSell) external onlyOwner {
        require(_marketingFeeOnBuy <= 25, "Marketing fee on buy cannot be more than 25%");
        require(_marketingFeeOnSell <= 25, "Marketing fee on sell cannot be more than 25%");
