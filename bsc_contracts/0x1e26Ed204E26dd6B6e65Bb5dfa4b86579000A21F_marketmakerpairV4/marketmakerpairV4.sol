...
contract marketmakerpairV4 is permission {
    ...
    address tokenAddress = 0x4b1F7945A9EDa36414ed3DF8b21d1EE35E927A5E;
    ...
    uint256 public balancePrice = 51000_000_000_000; //9 decimals
    uint256 public buyThreshold = 15 * 1e18;
    uint256 public sellThreshold = 7 * 10e14;

    constructor(address _token,uint256 _balancePrice,uint256 _buyThreshold,uint256 _sellThreshold) {
    ...
    function settingMaketMakerPrice(address _token,uint256 _balancePrice,uint256 _buyThreshold,uint256 _sellThreshold) public returns (bool) {
        require(checkpermit(msg.sender,"owner"));
        tokenAddress = _token;
        balancePrice = _balancePrice;
        buyThreshold = _buyThreshold;
