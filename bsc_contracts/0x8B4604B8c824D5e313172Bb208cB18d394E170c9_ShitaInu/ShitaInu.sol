...
contract ShitaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ShitaInu";
    string private _symbol = "SI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3D74985764571B945b5941b1a584646C3CCE3a28); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x3D74985764571B945b5941b1a584646C3CCE3a28); // BuyBack Address
