...
Telegram: https://t.me/FreezeProtocolChat
*/
...
contract FreezeProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "FreezeProtocol";
    string private constant _symbol = "FREEZE";
    ...
    Taxes public taxes = Taxes(0,3,4,0);
    Taxes public sellTaxes = Taxes(0,5,4,0);
