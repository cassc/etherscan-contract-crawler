...
// File: https://github.com/Fredohu/HYBRIDX/blob/main/HYBRIDX.sol
...
contract HYBRIDX is ERC20, ERC20Burnable, Ownable {
  ...
  constructor() ERC20("HYBRIDX", "HBDX") { 
...
// File: contracts/ApeHybridSocietySakingV2.sol
...
contract ApeHybridsSocietyStakingV2 is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, HYBRIDX _token) { 
    nft = _nft;
    token = _token;
  }
