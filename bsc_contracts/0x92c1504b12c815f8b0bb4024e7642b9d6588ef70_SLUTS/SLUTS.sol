...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6B0482052Fd91Bbc423cfCb61Ac2531cAdDc07F0;
...
contract SLUTS is Context, IERC20, Ownable {
    ...
    string private _name = "CryptHOEs";
    string private _symbol = "$SLUTS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6B0482052Fd91Bbc423cfCb61Ac2531cAdDc07F0);
    address payable public teamWalletAddress = payable(0x6B0482052Fd91Bbc423cfCb61Ac2531cAdDc07F0);
