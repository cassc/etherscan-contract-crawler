...
/**
Telegram : https://t.me/ProofofLowTax
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC8e9ba3Be394E7128b52739176C6b102ece1D773; // owner address
...
contract ProofofLowTax is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Proof of LowTax";
    string private _symbol = "POL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC8e9ba3Be394E7128b52739176C6b102ece1D773); // Marketing Address
    address payable public teamWalletAddress = payable(0xC8e9ba3Be394E7128b52739176C6b102ece1D773); // Team Address
