...
contract BitcoinBingo is Ownable {
  ...
  constructor(address _priceFeed, address _prizeToken) {
    ...
    accumulator = msg.sender;
    prizeDepositer = msg.sender;
  ...
  function setAccumulator(address _accumulator) public onlyOwner {
    accumulator = _accumulator;
  }
  function setPrizeDepositer(address _prizeDepositer) public onlyOwner {
