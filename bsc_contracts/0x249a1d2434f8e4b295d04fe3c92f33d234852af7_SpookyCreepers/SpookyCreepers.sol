...
Telegram : https://t.me/spookycreepers
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1823A36d0049B03ac0f1290B437F86557909Eb58; // owner address
...
contract SpookyCreepers is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SpookyCreepers";
    string private _symbol = "$SCREEPERS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1823A36d0049B03ac0f1290B437F86557909Eb58); // Marketing Address
    address payable public teamWalletAddress = payable(0x1823A36d0049B03ac0f1290B437F86557909Eb58); // Team Address
