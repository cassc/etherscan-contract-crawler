...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]){
                ...
                uint256 swapFee = _buyFundFee + _buyHoldDividendFee + _buyLPFee;
                ...
                uint256 swapFee = _sellFundFee + _sellHoldDividendFee + _sellLPFee;   
                uint256 swapAmount = (tAmount * swapFee) / 10000;
                ...
                if (!inSwap) {
                    ...
                    if (contractTokenBalance > 0) {
                        swapFee = _buyFundFee + _buyHoldDividendFee + _buyLPFee + _sellFundFee + _sellHoldDividendFee + _sellLPFee;
    ...
    function setBuyHoldDividendFee(uint256 newvalue) external onlyOwner {
        _buyHoldDividendFee = newvalue;
    }
    ...
    function setSellHoldDividendFee(uint256 newvalue) external onlyOwner {
        _sellHoldDividendFee = newvalue;
    }
...
contract LW is AbsToken {
    constructor() AbsToken(
        ...
        18,
        9000000,
        address(0x379091bBb82f5625EE4E287314493e39bA8A4271),
        address(0xF577E596c784a633002C8f4eAEdC7b51f98f1586)
    ){
