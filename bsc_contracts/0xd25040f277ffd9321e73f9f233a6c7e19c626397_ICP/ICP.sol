...
contract ICP is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public buyFee = 3; // Taxa de Compra
    uint256 private previousBuyFee; // Armazena Taxa de Compra
    uint256 public sellFee = 3; // Taxa de Venda
    ...
    /*=== Strings ===*/
    string private _name = "ICP 2.0";
    string private _symbol =  "LOWTAX";
    /*=== Modifiers ===*/
