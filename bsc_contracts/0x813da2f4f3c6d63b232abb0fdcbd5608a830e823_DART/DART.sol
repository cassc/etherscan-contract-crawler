...
/**
 ...
 DART Token.
 Official Website: www.dartcoin.io
*/
...
contract DART is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    _symbol = 'DRT';
    _decimals = 18;
    _totalSupply = 1*10**8 * 10**18; //100 Million
    locked = true;
  ...
  function whiteListAddress(address newAddress) public onlyOwner{
      unlocked[newAddress] = true;
  }

  function removeWhiteListAddress(address newAddress) public onlyOwner{
      unlocked[newAddress] = false;
  }
