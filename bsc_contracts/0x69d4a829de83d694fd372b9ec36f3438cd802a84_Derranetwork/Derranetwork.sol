...
contract Derranetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = "Derra Network";
    string private constant _symbol = "DRNET";
