...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8C7A3A9A3f79a94289a93B9c4a1A0CE8b27eCC0d; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Bnb_Pump";
    string private _symbol = "bnb_pump";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8C7A3A9A3f79a94289a93B9c4a1A0CE8b27eCC0d); // Marketing Address
    address payable public teamWalletAddress = payable(0x8C7A3A9A3f79a94289a93B9c4a1A0CE8b27eCC0d); // Team Address
