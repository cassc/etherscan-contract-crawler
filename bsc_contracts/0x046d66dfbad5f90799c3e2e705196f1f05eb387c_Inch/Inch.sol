...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x222Db175217eDA21A8E34284a009c2c5cc1FC57d; // owner address
...
contract Inch is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x222Db175217eDA21A8E34284a009c2c5cc1FC57d); // Marketing Address
    address payable public teamWalletAddress = payable(0x222Db175217eDA21A8E34284a009c2c5cc1FC57d); // Team Address
