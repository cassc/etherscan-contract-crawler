...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5100463d0FcDB8B32543b21209Eed1f0AEe77352; // owner address
...
contract SCOOBYDOGEOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SCOOBY DOGE";
    string private _symbol = unicode"看漲";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x146EF2A60702C1D838E2499486FE0D77A662Cd97); // Marketing Address
    address payable private teamWalletAddress = payable(0x5100463d0FcDB8B32543b21209Eed1f0AEe77352); // Team Address
