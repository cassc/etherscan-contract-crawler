...
contract TrueCityNFT is IERC20 {
    ...
    uint256 constant private startingSupply = 66_000_000;
    string constant private _name = "True City NFT";
    string constant private _symbol = "TRU";
    ...
    uint256 private _maxTxAmount = (_tTotal * 1614) / 1000000;
