...
contract TheFirstPepe is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 50_000 * 10**9;
    uint256 public maxWallet = 4_206_900_000_000 * 10**9;
    ...
    constructor(address _router, address _marketingWallet, string memory _name, string memory _symbol) ERC20(_name, _symbol) {
        _mint(msg.sender, 420_690_000_000_000 * 10 ** 9);
