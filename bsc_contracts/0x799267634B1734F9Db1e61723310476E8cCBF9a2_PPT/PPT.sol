...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _numToSell = 3 * tokenDecimals;

        _feeConfigs.push(FeeConfig(4 days, 300));
        _feeConfigs.push(FeeConfig(3 days, 300));
        _feeConfigs.push(FeeConfig(2 days, 300));
        _feeConfigs.push(FeeConfig(1 days, 300));
        _feeConfigs.push(FeeConfig(0, 300));
    }
...
contract PPT is AbsToken {
    ...
    //USDT
        ...
        3344,
    //Receive
        address(0x8087d7c71F0a02BfaE696535FE0d71B6Dc87991c),
    //Fund
        address(0x18594E5f789ba9414a0774af0b738B22943B9D68),
    //topestaddress
        address(0x5ffb47Cc5bFA700449Ed04E6c0c07d5aD9E9ff8C)
    ){
