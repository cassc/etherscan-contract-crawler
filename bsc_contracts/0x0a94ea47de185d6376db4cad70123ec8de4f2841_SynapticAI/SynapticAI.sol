...
contract SynapticAI is BEP20, Ownable {
    ...
    address public marketingWallet = 0x774b256ee4ad4C0e5bb41af2D2A8986Af916aa0f;
    address public ecosystemWallet = 0x774b256ee4ad4C0e5bb41af2D2A8986Af916aa0f;
    ...
    constructor() BEP20("Synaptic AI", "SynapticAI") {
    ...
    function _transfer(
       ...
       if (!exemptFee[sender] && !exemptFee[recipient]) {
        ...
        if (_interlock || exemptFee[sender] || exemptFee[recipient])
            ...
            feeswap = sellTaxes.liquidity + sellTaxes.marketing + sellTaxes.ecosystem;
            feesum = feeswap;
            currentTaxes = sellTaxes;
        } else if (!useLaunchFee) {
            feeswap = taxes.liquidity + taxes.marketing + taxes.ecosystem;
            feesum = feeswap;
            currentTaxes = taxes;
        } else if (useLaunchFee) {
            feeswap = launchtax;
    ...
    function DefaultBuyTax() external onlyOwner {
        taxes = Taxes(2, 1, 0);
    }

    function DefaultSellTax() external onlyOwner {
        sellTaxes= Taxes(2, 1, 0);
    }
