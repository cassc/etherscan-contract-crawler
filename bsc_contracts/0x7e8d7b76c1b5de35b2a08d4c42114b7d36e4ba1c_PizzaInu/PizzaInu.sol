...
// Telegram : https://t.me/pizzainubnb
...
contract PizzaInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x34a5D73726589be47C26B049Af35dFdFB3ac4456); 
    address payable public Wallet_Dev = payable(0x9CfC91742e185393358001F3d31aB8dfD5b7c80F);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Pizza Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x9CfC91742e185393358001F3d31aB8dfD5b7c80F;
