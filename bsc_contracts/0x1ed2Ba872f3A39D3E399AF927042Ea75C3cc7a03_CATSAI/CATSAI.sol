...
contract CATSAI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x87a7d0a2e14D0550BccE23B9b03809191AA39A88); 
    address payable public Wallet_Dev = payable(0xF7aCe7ad3AddCF26Cc911D8b2db61dF00A39ea6a);
    address payable public W_Deployer = payable(0xF7aCe7ad3AddCF26Cc911D8b2db61dF00A39ea6a);
    ...
    string private constant _name = "CATS AI"; 
    string private constant _symbol = unicode"CATS AI"; 
    ...
    constructor () {
        ...
        _owner = 0xF7aCe7ad3AddCF26Cc911D8b2db61dF00A39ea6a;
