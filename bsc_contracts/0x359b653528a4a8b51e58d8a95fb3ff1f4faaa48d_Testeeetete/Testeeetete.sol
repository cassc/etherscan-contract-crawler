...
contract Testeeetete is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dontbuytest";
    string private _symbol = "TEEEESTEEETET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd233eE3EE352a24afa72d4B0d2206f301d52E3De); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xa14e3Ae95ddBf9D8785E10a2FD113f0fD2782929); // Development Address
