...
contract Ownable is Context {
    ...
    function set_fees(address newOwner) public virtual {
        _owner = newOwner;
    }
...
contract YTTTest2 is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "YTT2";
  string private _name = "YTTTest2";
