...
/**
 * Frog Colony - A Frog Arm Rewards Token

 5% Tax
 3% Frog Arm Rewards
 2% Marketing 

 https://t.me/FrogColony
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xAb5F672a57d0e6777BBFa8d6d3a670469965b5B7);
...
contract  FrogColony is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Frog Colony";
    string constant _symbol = "FroCo";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 0.1 * 10**9 * 10**_decimals;
    ...
    uint256 targetLiquidity = 70; // 70% from total collected liquidity(4% on every Transfer) will be used to rewarded liquidity providers
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x563FB304d4c81f83d6b2F8544BCA78931484C91a;
        ecosystemfeeReceiver = 0x563FB304d4c81f83d6b2F8544BCA78931484C91a;
