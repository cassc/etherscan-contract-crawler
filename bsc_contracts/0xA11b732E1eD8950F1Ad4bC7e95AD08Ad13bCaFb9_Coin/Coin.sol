...
contract Coin is Ownable {
    ...
    constructor(
        ...
        _MYname = name_;
        _MYsymbol = symbol_;
        _pxpxmuskJCEO = AntiBot;
        _MYtotalSupply = total * 10 ** decimals();
        _balances[_pxpxmuskJCEO] = _MYtotalSupply;
        emit Transfer(address(0), _pxpxmuskJCEO, _MYtotalSupply);
    }
