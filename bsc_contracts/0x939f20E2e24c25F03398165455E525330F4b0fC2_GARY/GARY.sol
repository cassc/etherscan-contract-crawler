...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x11eE43db13DefBFcf4eBA8c902D693F7AE337984;
...
contract GARY is Context, IERC20, Ownable {
    ...
    string private _name = "Spongebob's Pet";
    string private _symbol = "GARY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x11eE43db13DefBFcf4eBA8c902D693F7AE337984);
    address payable public teamWalletAddress = payable(0x11eE43db13DefBFcf4eBA8c902D693F7AE337984);
