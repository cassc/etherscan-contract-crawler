...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xcB7B2c8c3DaE693aa719753319140679da5839D9;
...
contract spookysponge is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"SpookySponge"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xcB7B2c8c3DaE693aa719753319140679da5839D9), BNB_Tot);
            }
