...
contract BUNNYGPT is ERC20, Ownable {
    ...
    constructor(address _router) ERC20("BUNNY GPT", "BunnyGPT") payable
    {
        ...
        // Buy Taxes
        buyTaxes["marketing"] = 400;
        buyTaxes["dev"] = 0;
        buyTaxes["liquidity"] = 200;

        // Sell Taxes
        sellTaxes["marketing"] = 400;
        sellTaxes["dev"] = 0;
        sellTaxes["liquidity"] = 200;

        // External wallets 
        taxWallets["marketing"] = 0xe7A26966aFcCfDff1Adc2bB04dA27c3e420f8BB4;
        taxWallets["dev"] = 0xEbe9E7F6f827401BDa74D2c0631d6A79A8Abb82A;

        maxTxAmount = initialSupply * 300 / 10000;
        maxOwnedAmount = initialSupply * 300 / 10000;
