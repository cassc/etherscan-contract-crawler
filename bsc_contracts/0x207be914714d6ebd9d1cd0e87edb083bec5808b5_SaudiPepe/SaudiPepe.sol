...
// Telegram :https://t.me/saudiPepeEntry

// Twitter :https://twitter.com/SaudiPepeBsc
...
contract  SaudiPepe is Context, IERC20, Ownable {
    ...
    string private _name = "Saudi Pepe";
    string private _symbol = "SPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBfC8274e8a06d24a1f6D757e0DB49d4D5B449a5f); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xBfC8274e8a06d24a1f6D757e0DB49d4D5B449a5f); // BuyBack Address
