...
contract WealthSea {
    ...
    uint256 constant launch = 1666022400; //17th Oct 2022 16:00 UTC
    
  	uint256 constant hardDays = 86400;
    uint256 constant percentdiv = 1000;
    uint256 constant minDeposit = 5 ether; // Min deposit 5 BUSD
    ...
    address public dev = 0x3ebc941495A6E3E4271dCFf3413A6C7536664569;
    ...
    function stakeStablecoins(uint256 amtx, address ref) payable public {
        ...
        require(amtx >= minDeposit,"Minimum deposit is 5 BUSD");
        ...
        if(amtx > todayBigDeposit.depositAmount){
            todayBigDeposit.depositAmount = amtx;
