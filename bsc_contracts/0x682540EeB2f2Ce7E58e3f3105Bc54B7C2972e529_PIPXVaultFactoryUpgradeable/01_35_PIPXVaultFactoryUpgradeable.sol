...
import "./PIPXVaultUpgradeable.sol";

// Authors: @0xKiwi_ and @alexgausman.

contract PIPXVaultFactoryUpgradeable is
    PausableUpgradeable,
    UpgradeableBeacon,
    IPIPXVaultFactory
{
    ...
    function __PIPXVaultFactory_init(address _vaultImpl, address _feeDistributor) public override initializer {
        __Pausable_init();
    ...
    function createVault(
        ...
        onlyOwnerIfPaused(0);
        require(feeDistributor != address(0), "PIPX: Fee receiver unset");
        require(childImplementation() != address(0), "PIPX: Vault implementation unset");
        ...
        IPIPXFeeDistributor(feeDistributor).initializeVaultReceivers(_vaultId);
    ...
    function deployVault(
        ...
        PIPXVaultUpgradeable(newBeaconProxy).__PIPXVault_init(name, symbol, _assetAddress, is1155, allowAllItems);
        // Manager for configuration.
        PIPXVaultUpgradeable(newBeaconProxy).setManager(msg.sender);
        // Owner for administrative functions.
        PIPXVaultUpgradeable(newBeaconProxy).transferOwnership(owner());
