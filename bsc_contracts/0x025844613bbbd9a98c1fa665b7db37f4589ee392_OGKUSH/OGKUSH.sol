...
/**
* IMPORTANT: You may lose your full investment if you invest in this smart contract. 
* By buying this token you agree that there is no one responsible for the possible loss.
*/ 
...
contract OGKUSH is Context, IERC20, Ownable {
    ...
    string private constant _name = "OG Kush";
    string private constant _symbol = "OGKUSH";
