...
contract ElonDragon is Ownable, IBEP20 {
    ...
    string constant _name = "ElonDragon";
    string constant _symbol = "EDRAGON";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xF8F154e5ad0776D268218B0EAa868Fc8BE7954e2;
    ...
    function antiBotMode(bool _status) external onlyOwner {
        antibotMode = _status;
    ...
    function updateAntibot(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver, address _stakingFeeReceiver, address _teamFeeReceiver) external onlyOwner {
