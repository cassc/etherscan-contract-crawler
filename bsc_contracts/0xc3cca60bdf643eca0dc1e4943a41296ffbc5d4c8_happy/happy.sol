...
O))     O))O))         O))O))       O))           O))    
 ...
 TELEGRAM : https://t.me/HappyEntry          // main channel
            https://t.me/HappyAnnouncement   // announcement 
 WEBSITE  : https://www.happytoken.site    
 TWITTER  : https://twitter.com/happytokeneco
 Contact  : [email protected]                



we are proud to present our token !
In partnership with different teams we want to introduce
a new concept of token that can do something of different 
from other token already in the scene.
First of this great part are REWARDS in $HAPPY.
Also a big Roadmap is on the way with big partnerships and Dapps release
Do you have something different that can make you happier?
...
contract happy is Context, IERC20, Ownable {
    ...
    string private _name = "HAPPYeco";
    string private _symbol = "HAPPY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0394B367580CdCC756d920f23F2dF0509D5E0a71); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x20C3D734fA55cf1f87c7897C72DF3e7ecF6c90F8); // Charity Address
