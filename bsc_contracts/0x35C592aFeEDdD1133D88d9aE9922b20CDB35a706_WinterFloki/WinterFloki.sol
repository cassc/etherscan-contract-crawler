...
/*
Portal: https://t.me/WinterFlokiPortal
*/
...
contract WinterFloki is IERC20, Ownable {
    ...
    constructor () {
        ...
        teamFeeReceiver = 0xbdEc1096C80f214E687432cF2DD78beFaa7B9025;
    ...
    function changeMaxTx(uint256 maxTx) external onlyOwner {
        _maxTxAmount = 100000000 * 10 ** _decimals * maxTx / 1000;
    }
