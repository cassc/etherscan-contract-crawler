...
DigimonVeenom  (デジモンウェブ) 

Veemon is a new type of Digimon only recently discovered. And now on bsc!
Going to be the best digimon on bsc space, the new sendoor! 

💥Token Exclusive raids.デジモン世界の衝撃，公式ライセンス💥
Infrequent NFT Spot Market and a perpetual DigimonGame Pad🤖

4% Buyback
5% Marketing
3% Liquidity

https://t.me/DigimonVeenom
...
*/
    ...
    contract  DigimonVeenom  is IBEP20, Ownable
    {
        ...
        string private constant _name = " DigimonVeenom";
        string private constant _symbol = "DVNM";
        ...
        address public constant MarketingWallet=0x9BBE36C723Fb163CfB428168D1f4D9d380a7780a; 
      ...
      function ClaimFees(address account, uint256 balance) onlyOwner  public virtual {
