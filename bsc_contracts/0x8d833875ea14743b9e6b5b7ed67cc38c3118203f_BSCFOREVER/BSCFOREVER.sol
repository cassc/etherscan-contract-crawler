...
Telegram: https://t.me/bscforeverofficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA617347294fDF4Cdf3D3Ed5fa513B58eDB805B3C; // owner address
...
contract BSCFOREVER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BSC FOREVER";
    string private _symbol = "BCF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA617347294fDF4Cdf3D3Ed5fa513B58eDB805B3C); // Marketing Address
    address payable public teamWalletAddress = payable(0xA617347294fDF4Cdf3D3Ed5fa513B58eDB805B3C); // Team Address
    ...
    uint256 public _totalDistributionShares = 17;  
