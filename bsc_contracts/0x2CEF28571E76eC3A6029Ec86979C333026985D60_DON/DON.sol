...
contract DON is VRFV2WrapperConsumerBase {
    ...
    function checkCosts() public view returns (uint256,uint256,uint256,uint256,uint256,uint256,uint256) {
        return (maximumStakePercentage,gameFee,minimumBNBstake,minimumUSDstake,minimumSRGstake,bnbVRFcost,usdVRFcost);
    }
