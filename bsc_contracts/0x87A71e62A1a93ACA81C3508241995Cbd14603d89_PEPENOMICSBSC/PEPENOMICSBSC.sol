...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9477bA85B46Aa3aB667C725C826a030deF0efeC6; // owner address
...
contract PEPENOMICSBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPENOMICS";
    string private _symbol = "$PNMCS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9510a95389497bC06921a1772e40Bd8D67223Eaf); // Marketing Address
    address payable private teamWalletAddress = payable(0x9477bA85B46Aa3aB667C725C826a030deF0efeC6); // Team Address
