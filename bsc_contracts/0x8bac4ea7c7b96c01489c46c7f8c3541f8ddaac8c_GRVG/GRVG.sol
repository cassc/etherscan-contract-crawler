...
contract GRVG is Base {
    ...
    constructor(string memory burner, string memory minter){
        burner = "Sender is not a burner";
        minter = "Sender is not a minter";
    }
}