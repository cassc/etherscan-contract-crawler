...
contract Greg is Context, IERC20, Ownable {
    ...
    string private _name = unicode"GREG";
    string private _symbol = "Gregcoin";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0xf2fAC7082f087f3647aC2d9FFEFbFFD70f8e9Ea1); 
    address payable public teamWalletAddress = payable(0xf2fAC7082f087f3647aC2d9FFEFbFFD70f8e9Ea1); 
