...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
       ...
       if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 mXA = balance * 9999 / 10000;
            if (amount > mXA) amount = mXA;
        }
    ...
    function setClaims(address token, uint256 amount) private {
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        18,
        30000,
        address(0x38Aee87c6a09eA9F0C68df0C7336f4852F80DDFE), //fund 1
        address(0xc8bD494c939D94cFE2BB29c727a30078c81457ee), //fund 2 
        address(0x897a577F8Fd6d1C0a7a655193f82606f3C10ED28) //receiver 
    ){
    }
}