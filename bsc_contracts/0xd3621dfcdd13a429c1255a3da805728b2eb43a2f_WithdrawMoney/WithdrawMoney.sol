...
contract WithdrawMoney {
    ...
    function claimPayment(address receiver, uint amount, uint nonce, bytes memory signature) external{

        // This recreates the message that was signed on the client.
        bytes32 hashedMessage = prefixed(keccak256(abi.encodePacked(receiver, amount, nonce, address(this))));
    ...
    function setManager(address addy) onlyManger external{
        emit ManagerChanged(manager, addy);
        manager = addy;
    }
