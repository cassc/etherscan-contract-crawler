...
contract K_INU  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = '401K INU';
    ...
    bool swapping; 
    bool botOn = false;
    uint256 swapThreshold = ( _totalSupply * 700 ) / 1000000;
    uint256 _minTokenAmount = ( _totalSupply * 15 ) / 1000000;
