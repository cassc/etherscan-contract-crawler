...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc7043852AEb71327f2704452Ac8Aff4909e6111a; // owner address
...
contract McDInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "McDonald's Inu";
    string private _symbol = "McD Inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc7043852AEb71327f2704452Ac8Aff4909e6111a); // Marketing Address
    address payable public teamWalletAddress = payable(0xc7043852AEb71327f2704452Ac8Aff4909e6111a); // Team Address
