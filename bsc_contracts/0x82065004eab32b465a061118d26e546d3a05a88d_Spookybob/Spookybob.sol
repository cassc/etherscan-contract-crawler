...
contract Spookybob is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spookybob";
    string private _symbol = "SPOOKYBOB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF871Fe3922D7577477ABC094C39aF7ACAC0ce7Ff); // Marketing Address
    address payable private developmentWalletAddress = payable(0x4b4a26B11D6Ec4BD9F9F3Ff4d40F715c1d65dCA1); // Development Address
    ...
    uint256 public _buyLiquidityFees = 3;
    ...
    uint256 public _marketingShares = 11;
    ...
    uint256 public _walletMax = 100 * 10**12 * 10**9;
    ...
    constructor () {
        ...
        isWalletLimitExcept[address(uniswapPair)] = true;
    ...
    function setIsTxLimitExcept(address holder, bool exempt) external onlyOwner {
        isTxLimitExcept[holder] = exempt;
    }
    
    function setIsExcludedFromFees(address account, bool newValue) public onlyOwner {
    ...
    function adjustMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (100 * 10**6 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
    ...
    function setIsWalletLimitExcept(address holder, bool exempt) external onlyOwner {
        isWalletLimitExcept[holder] = exempt;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        {
            if(!isTxLimitExcept[sender] && !isTxLimitExcept[recipient]) {
            ...
            if(checkWalletLimit && !isWalletLimitExcept[recipient])
