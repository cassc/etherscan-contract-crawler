...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x642040049d7b15DC17483f5F9B632fA2341c3f11;
...
contract Hamasiuntoken is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x61586423dee185d9f2567BC1b7288b90e86531B8);
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "hummus";
    string private _symbol = "hus";
    ...
    function _takeDevelopment(uint256 tDevelopment) private {
        uint256 currentRate =  _getRate();
        uint256 rDevelopment = tDevelopment.mul(currentRate);
        _rOwned[_marketingAddress] = _rOwned[_marketingAddress].add(rDevelopment);
        if(_isExcluded[_marketingAddress])
            _tOwned[_marketingAddress] = _tOwned[_marketingAddress].add(tDevelopment);
    }
