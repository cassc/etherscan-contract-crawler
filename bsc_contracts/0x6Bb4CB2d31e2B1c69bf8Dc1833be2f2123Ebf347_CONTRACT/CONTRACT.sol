...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardtoken = IBEP20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);  //USDC - Update in two places if changing
    ...
    uint256 public minPeriod = 45 * 60;  //Auto distribute every 45 mins
    uint256 public minDistribution = 1 * (10 ** 18); //holders must accumulate atleast 1 token before auto distribution occurs
...
contract CONTRACT is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d; // USDC - update in two places if changing
    ...
    uint256 _totalSupply = 777 * 10**_decimals;
    ...
    uint256 private ecosystemFee   = 5;
    ...
    uint256 public swapThreshold = _totalSupply * 50 / 100000;
    bool inSwap;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        autoLiquidityReceiver = msg.sender;  //set fee receivers here
        marketingFeeReceiver = 0x52974beF278A71C14F612dA101ad1bA2Ce634241;
        ecosystemFeeReceiver = 0x18BA76A1e8bD204c56242b5209F723c3bc318172;
        devFeeReceiver = 0xc868e5F599f39AF9D2b53425dEe994553582a96e;
    ...
    function setTxLimitAbsolute(uint256 amount) external onlyOwner {
        require(amount >= _totalSupply / 1000,"cannot set max TX below .1%" );
        _maxTxAmount = amount;
    }
    ...
    function exemptFromRewards(address holder, bool exempt) public onlyOwner {
