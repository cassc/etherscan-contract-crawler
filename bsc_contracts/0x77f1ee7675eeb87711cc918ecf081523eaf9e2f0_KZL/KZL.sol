...
contract KZL is ERC20, Ownable {
    ...
    KZLDividendTracker public dividendTracker;
    ...
    constructor() ERC20("KZL", "kzl") {
        marketingWallet = payable(0xb77F5063fe20b879468EFf7550c60727ef4640cf);
        devWallet = payable(0xb77F5063fe20b879468EFf7550c60727ef4640cf);
        ...
        dividendTracker = new KZLDividendTracker(
            payable(this),
            router,
            0xb77F5063fe20b879468EFf7550c60727ef4640cf,
            "KZLTRACKER",
            "kzlTRACKER"
        );
        ...
        maxWallet = totalTokenSupply / 6000000000; // 0.005%
        swapTokensAtAmount = totalTokenSupply / 6000000000; // 0.05%;
...
contract KZLDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "KZL_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "KZL_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main KZL contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(KZLContract);

            uint256 prevBalance = KZLContract.balanceOf(address(this));
            ...
            {
                uint256 received = KZLContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    KZLContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
