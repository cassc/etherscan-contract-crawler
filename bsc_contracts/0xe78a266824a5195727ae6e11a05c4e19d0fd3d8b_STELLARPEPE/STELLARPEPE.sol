...
// https://t.me/StellarPepe
// https://twitter.com/stellarpepe
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0x43C934A845205F0b514417d757d7235B8f53f1B9);
...
/* Token contract */
contract STELLARPEPE is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x43C934A845205F0b514417d757d7235B8f53f1B9; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0xcbC149d806703538053bBbBa506d9693f1E0cd81;
    ...
    // Name and symbol
    string constant _name = "STELLAR PEPE";
    string constant _symbol = "$XLMPepe";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 3.0% on launch or 5M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; // 1% or 2M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 10000; // 3% or 5m tokens
