...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string constant private _name = "MetaX Ecological Points";
    string constant private _symbol = "META";
    ...
    function _burn(uint256 amount) internal virtual{
        ...
        require(balanceOf(owner) >= amount, "No sufficient amount from wallet");
