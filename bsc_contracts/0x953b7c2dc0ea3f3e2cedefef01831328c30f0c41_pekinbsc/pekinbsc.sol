...
/**
/*  
https://t.me/mysterylaunchpredator
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36464662bC18dec6a2AD6813840aF2D1Ee83929C; 
...
contract pekinbsc is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pekin Bsc";
    string private _symbol = "$Pekin";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCEBf9a29997158310B977ae17B54F2A553527037); // 
    address payable public teamWalletAddress = payable(0xCEBf9a29997158310B977ae17B54F2A553527037); // 
    ...
    uint256 private minimumTokensBeforeSwap = 10000000000 * 10**_decimals; 
