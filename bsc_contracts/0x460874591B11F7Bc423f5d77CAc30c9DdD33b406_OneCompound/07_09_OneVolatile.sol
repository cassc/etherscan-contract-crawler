...
/*
 ...
 1% Bankroll
 1% Payout
 Does not receive incentives daily but does receive 1% of all ONE deposited into Compound VDC
 */
contract OneVolatile is Initializable, Ownable, ReentrancyGuard
{
	...
	struct AccountInfo {
		...
		uint256 reward; // ONE reward from Compound VDC accumulated but not claimed
