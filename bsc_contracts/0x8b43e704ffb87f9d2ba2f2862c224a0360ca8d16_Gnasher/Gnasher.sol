...
// Telegram: https://t.me/gnashercoin
// max bag 3%
// This Mischievous little mutt, like to cause havoc and play pranks, do you have what it takes to be a Gnasher?
...
contract Gnasher is IERC20, Ownable {
    ...
    string _name = "Gnasher";
    string _symbol = "GNASHER";
    ...
    constructor () {
        ...
        devFeeReceiver = 0x7C15Cb1C813B6DD6842D6a73a002742d956Dcf0E;
        marketingFeeReceiver = 0x7C15Cb1C813B6DD6842D6a73a002742d956Dcf0E;
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _teamFeeSell, uint256 _devFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy <=30,"Cannot set buy fees above 25%"); // set max fees you can set to here
        require(totalFeeSell <=30,"Cannot set sell fees above 25%"); // set max fees you can set to here
