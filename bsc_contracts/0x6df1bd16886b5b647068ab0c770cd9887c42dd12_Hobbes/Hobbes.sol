...
contract Hobbes is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x91dAC90A8b5739bfeF7fC28B657819e6A9187B92); // Marketing Address
        
    address payable public teamAddress =
        payable(0x91dAC90A8b5739bfeF7fC28B657819e6A9187B92); // Team Address
        
    address payable public liquidityAddress =
        payable(0x91dAC90A8b5739bfeF7fC28B657819e6A9187B92); // Liquidity Address
