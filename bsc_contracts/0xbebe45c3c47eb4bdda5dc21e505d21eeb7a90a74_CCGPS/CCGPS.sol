...
/**
 *  CCGPS泵 | Discord华人社区 | 1% Max Wallet
 *  Created By: Fatsale
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3696b3d178628d1B1060eC3266C7B73D51eFA070; // owner address
...
contract CCGPS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CCGPS";
    string private _symbol = "CCGPS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3696b3d178628d1B1060eC3266C7B73D51eFA070); // 
    address payable public teamWalletAddress = payable(0x3696b3d178628d1B1060eC3266C7B73D51eFA070); // 
