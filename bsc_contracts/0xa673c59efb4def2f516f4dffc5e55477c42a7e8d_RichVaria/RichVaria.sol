...
=== 'Rich Varia' Token contract with following features ===
    => BEP20 Compliance
...
contract RichVaria is owned {
    
    using SafeMath for uint256;

    string constant private _name = "Rich Varia";
    string constant private _symbol = "RVAR";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 50000000 * (10**_decimals);
