...
Daddy token just hit 1 million MC, we are the first baby token.

  TELEGRAM : https://t.me/BabyFlokiCEO
  TWITTER: https://twitter.com/BabyFlokiCEO

  brought to you by https://t.me/MakkksCalls
*/
...
contract BabyFlokiCEO is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x927c0b7FFA69779DE585C34D2C297AAEb1a8f0DD);
    ...
    string private constant _name = "BabyFlokiCEO";
    string private constant _symbol = unicode"BFLOKICEO";
    ...
    constructor() {
        _owner = 0x927c0b7FFA69779DE585C34D2C297AAEb1a8f0DD;
