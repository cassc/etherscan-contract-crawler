...
// File: contracts\Lib8\EnumerableSet.sol
...
contract BitDriverToken is ERC20, ERC20Burnable, Ownable {
    ...
    /// @dev overrides transfer function to meet tokenomics of ODC
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        require(sender != address(0), "BDR::sender is not valid");
    ...
    function addBlockAddr(address _addBlockAddr) public onlyOwner returns (bool) {
        require(_addBlockAddr != address(0), "BDR: _addBlockAddr is the zero address");
    ...
    function delBlockAddr(address _delblockAddr) public onlyOwner returns (bool) {
        require(_delblockAddr != address(0), "BDR: _delblockAddr is the zero address");
    ...
    function getBlockAddr(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getBlockAddrLength() - 1, "BDR: index out of bounds");
