...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6CF2489E91c8bD494D7cc114B7De866faefca9B5;
...
contract SCHOCK is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xe30043B370DC3c684e43463E0D86ac52D911A2A6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SCHOCK";
    string private _symbol = "SCHOCK";
