...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x84adE480A4a90Ff13030D9f28B2619e8Eb66c136; // owner address
...
contract ChickenZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChickenZilla";
    string private _symbol = "CZ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xeB09595eC68847E6218a284E5e90B7D49ebbE8FD); // Marketing Address
    address payable private teamWalletAddress = payable(0xeB09595eC68847E6218a284E5e90B7D49ebbE8FD); // Team Address
