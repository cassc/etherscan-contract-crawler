...
// TG: https://t.me/AIRobocatOfficial
...
contract AI_RoboCat is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AI RoboCat";
    string private _symbol = "AIRC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0b30c6aaafd1F9e0F0d3cd75209Da64b362F7d2F);
    address payable public TeamWAddress = payable(0x0E42682f8202C4fD30479C48daB3627198F1070F);
    ...
    constructor (address addr) {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(addr); 
    ...
    function clearStuckBNB() public {
        require(_msgSender() == marketingWalletAddress || _msgSender() == TeamWAddress);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= (4 * 10**5 * 10**9));
    ...
    function setTeamWAddress(address newAddress) external onlyOwner() {
        TeamWAddress = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(TeamWAddress, amountBNBTeam);
