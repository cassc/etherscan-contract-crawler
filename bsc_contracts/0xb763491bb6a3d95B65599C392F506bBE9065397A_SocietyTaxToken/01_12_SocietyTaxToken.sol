...
contract SocietyTaxToken is Context, IERC20, Ownable, Blacklistable {
    ...
    uint256 public maxAllowedTax = 100;
    uint256 public partnerTax = 20;
    uint256 private platformSellingTax = 10;
    ...
    constructor (
        ...
        _totalTax = _totalTax.add(partnerTax);
        for(uint i = 0; i < _partners.length; i++){
            _totalTax = _totalTax.add(partnerTax);
            isExcludedFromFee[_partners[i]];
