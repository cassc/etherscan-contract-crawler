...
contract GoGreenGenerators is Initializable, ERC721Upgradeable, PausableUpgradeable, OwnableUpgradeable {

    using CountersUpgradeable for CountersUpgradeable.Counter;

    CountersUpgradeable.Counter private _tokenIdCounter;

    uint256 public constant FINAL_TOTAL_SUPPLY = 100000;
    ...
    function initialize() initializer public {
        __ERC721_init("GoGreen-Generators", "GGR");
        __Pausable_init();
        __Ownable_init();
    }
    ...
    function safeMint(address to) public onlyOwner {
        ...
        require(tokenId <= FINAL_TOTAL_SUPPLY,"Final supply reached!");
    ...
    override
    {
        require(from == address(0), "ERC721: transfer not allowed in the Go Green project");
