...
contract PepeDiamondHands is Context, IERC20, Ownable {
    ...
    /* Naming */
    string private _name = "Pepe Diamond Hands";
    ...
    uint256 private _tTotal = 420_690 * 10**6 * _decimalFactor; // 420 billion 690 million tokens total
