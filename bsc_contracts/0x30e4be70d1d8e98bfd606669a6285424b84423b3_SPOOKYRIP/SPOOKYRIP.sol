...
contract SPOOKYRIP is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Spooky Rip";
    string private constant _symbol = unicode"SPOOKYRIP";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable public DevWallet = payable(0x3aEB9714c14C820220CD1afe5D85E57754D7FF21);
    address payable public MarketingWallet = payable(0xA55773b8eA235370971fFC09b54AfFD94925d0b0);
