...
contract Marsmellow is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "MARSMELLOW COIN";
    string private _symbol = "MARSMELLOW";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4b16585b498899f7109db22b54672D0DC2cf47Ac);
    address payable public liqWalletAddress = payable(0x4b16585b498899f7109db22b54672D0DC2cf47Ac);
