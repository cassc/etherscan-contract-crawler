...
telegram : https://t.me/NewYearBSC2023
*/
...
contract NEWYEARBSC2023  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4A5aDDf09c40B858D31E0A532544e91eFd19D6cf); 
    address payable public Wallet_Dev = payable(0xc3f1778401ea67f4cAD231b9ACf2D556bfaecA60);
    address payable public constant Wallet_Burn = payable(0x4A5aDDf09c40B858D31E0A532544e91eFd19D6cf); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "New Year BSC 2023"; 
    string private constant _symbol = unicode"NYBSC23"; 
    ...
    constructor () {
        ...
        _owner = 0xc3f1778401ea67f4cAD231b9ACf2D556bfaecA60;
