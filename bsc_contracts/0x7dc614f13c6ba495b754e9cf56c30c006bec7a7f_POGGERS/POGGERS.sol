...
/**
    Pepe is mooning. Poggers is PEPE's brother. WE SEND IT.

    Telegram https://t.me/PoggersBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xedb6d8f1160997A70aAdeF3e0104f8B07b51cd8e; // owner address
...
contract POGGERS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xedb6d8f1160997A70aAdeF3e0104f8B07b51cd8e); // Marketing Address
    address payable public teamWalletAddress = payable(0xedb6d8f1160997A70aAdeF3e0104f8B07b51cd8e); // Team Address
