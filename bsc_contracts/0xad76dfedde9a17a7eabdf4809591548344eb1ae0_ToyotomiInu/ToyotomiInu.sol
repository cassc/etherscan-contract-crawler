...
Toyotomi Inu
Toyotomi Hideyoshi (豊臣 秀吉), [02/02/1537 – 09/18/1598) was a Japanese samurai and daimyō (feudal lord) of the late Sengoku period regarded as the second "Great Unifier" of Japan.
He rose from a peasant background as a retainer of the prominent lord Oda Nobunaga to become one of the most powerful men in Japan.                                                                               
...
contract ToyotomiInu is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Toyotomi Inu";
    string private _symbol = unicode"Toyo";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x9F4BD6bf528f4DC46e0099ad1dfFB3692B8903C4);
    address payable private taxWallet2 = payable(0x9F4BD6bf528f4DC46e0099ad1dfFB3692B8903C4);
    ...
    uint256 public _buyMarketingFees = 11;
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply*2/2000; 
