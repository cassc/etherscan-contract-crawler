...
contract QJRtoken is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("QJR", "QJR") {
    ...
    function _transfer(
        ...
        if (takeFee) {
			splitOtherToken();
			super._transfer(from, _destroyAddress, amount.div(100).mul(1)); //destroyAddress
			super._transfer(from, address(this), amount.div(100).mul(4)); // lp
