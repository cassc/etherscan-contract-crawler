 ...
 * OLDFEG TOKEN
 * JOIN THE FEG ARMY 
 * https://medium.com/@OldFeg/old-feg-348d9f8d3ed7 
 * https://t.me/OLDFEGBSC
*/
...
contract Oldfeg is ERC20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "OLDFEG";
    string constant _symbol = unicode"OFEG";
    ...
    uint256 public extraFeeOnSell = 13;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0x898A8251b67C0A80bE88AFb72Ef42c5a21b3A0E7;
        marketingWallet = 0x898A8251b67C0A80bE88AFb72Ef42c5a21b3A0E7;
        devWallet = 0x898A8251b67C0A80bE88AFb72Ef42c5a21b3A0E7;
