...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xDd77429c6645EE79dB33936d0773a2F23932e7a7; // owner address
...
contract CrazyPepeInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CrazyPepeInu";
    string private _symbol = "CrazyPepeInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDd77429c6645EE79dB33936d0773a2F23932e7a7);
    address payable public teamWalletAddress = payable(0xDd77429c6645EE79dB33936d0773a2F23932e7a7); 
