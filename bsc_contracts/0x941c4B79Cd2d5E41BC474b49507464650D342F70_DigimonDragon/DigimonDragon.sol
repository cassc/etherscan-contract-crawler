...
// 今年是中国新年的龙年,那么，让我们一起来到月球，并形成团结一致的社区！
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x17Fe9fB756801DB975862335fEE2C47bFDf4522E; 
...
contract DigimonDragon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Digimon Dragon";
    string private _symbol = "DGN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x17Fe9fB756801DB975862335fEE2C47bFDf4522E); // 
    address payable public teamWalletAddress = payable(0x17Fe9fB756801DB975862335fEE2C47bFDf4522E); // 
