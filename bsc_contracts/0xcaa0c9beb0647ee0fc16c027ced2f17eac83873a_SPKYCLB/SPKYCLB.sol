...
contract SPKYCLB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spooky Club";
    string private _symbol = "SPKYCLB";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0x985bD995231E9b96e5B6bc24eB1bEeC85d1eAB3b); // Buy Back Address
