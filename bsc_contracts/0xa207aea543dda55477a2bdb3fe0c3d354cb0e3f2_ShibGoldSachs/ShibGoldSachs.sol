...
contract ShibGoldSachs is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ShibGoldSachsDividendTracker public dividendTracker;
    ...
    uint256 public cooldowntimer = 5;
    ...
    constructor() ERC20("Shib Gold Sachs", "SGS") {
        marketingWallet = payable(0x45fec173d1b426743cede310D8755246D856c334);
        devWallet = payable(0xc494d6830BAB93Ee10c93e6419B7C2Fa2a6327CD);
        ...
        dividendTracker = new ShibGoldSachsDividendTracker(
            payable(this),
            router,
            0x2859e4544C4bB03966803b044A93563Bd2D0DD4D,
            "SHIBGOLDSACHSTRACKER",
            "SGSTRACKER"
        );
...
contract ShibGoldSachsDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    ShibGoldSachs public ShibGoldSachsContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ShibGoldSachsContract = ShibGoldSachs(mainContract);
    ...
    function _transfer(
        ...
        require(false, "ShibGoldSachs_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ShibGoldSachs_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ShibGoldSachs contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ShibGoldSachsContract);

            uint256 prevBalance = ShibGoldSachsContract.balanceOf(address(this));
            ...
            {
                uint256 received = ShibGoldSachsContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ShibGoldSachsContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
