...
Telegram: https://t.me/OptimusCEOChat
Twitter : https://t.me/OptimusCEOChat
*/
...
contract OptimusCEO is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 800000 * 10**_decimals;

    uint256 public maxSellAmount = 3000000 * 10**_decimals;
    uint256 public maxBuyAmount = 3000000 * 10**_decimals;
    uint256 public maxWalletBalance = 3000000 * 10**_decimals;

    address public marketingAddress = 0xceff5cD9f62b532ef7427B93762620b1a9fB6FAE;
    address public devAddress = 0xceff5cD9f62b532ef7427B93762620b1a9fB6FAE;

    string private constant _name = "OPTIMUS CEO";
    string private constant _symbol = "OPTCEO";
    ...
    Taxes public taxes = Taxes(0,4,3,0);
    Taxes public sellTaxes = Taxes(0,4,5,0);
