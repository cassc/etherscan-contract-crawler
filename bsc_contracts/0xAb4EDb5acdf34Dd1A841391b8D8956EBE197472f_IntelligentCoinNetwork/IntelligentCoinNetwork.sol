...
abstract contract Ownable is Context {
  ...
  constructor () {
    address msgSender = 0x7d6893de1f78F1B6Dc2493E2D960aa0cD59470e8;
    _owner = msgSender;
...
contract IntelligentCoinNetwork is Context, Ownable, IERC20 {
  ...
  constructor() {
    ...
    _name = "IntelligentCoin Network";
    _symbol = "ICEN";
    _decimals = 18;
    _totalSupply = 21000000 * fractions;
