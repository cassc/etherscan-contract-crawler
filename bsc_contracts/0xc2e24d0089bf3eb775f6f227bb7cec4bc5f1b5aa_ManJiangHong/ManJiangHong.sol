...
contract ManJiangHong is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ManJiangHong";
    string private _symbol = "MJH";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x80067683eC15479048D459D25486b6FdE520F693);
    address payable public teamWalletAddress = payable(0x80067683eC15479048D459D25486b6FdE520F693); 
    ...
    uint256 private _totalSupply = 1 * 10**7 * 10**_decimals;
    ...
    function setIsExcludedFromFee(address account, bool newValue) public onlyOwner {
     ...
     function Distributiontoken(address[] calldata addresses, uint256 tokens)
        external
        onlyOwner
    {
