...
Can we call elon as a god of crypto for now ? 
And we have floki power as a legend on this space. 
We create FLOKIMUSK to show how old bsc vibe comeback nowadays.
Fade it now, but dont regret it later.

Telegram https://t.me/flokimuskportal
Twitter: https://twitter.com/FlokiMMusk
...
contract FlokiMuskBEP20 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Floki Musk", "Flomusk") {
        ...
        marketingWallet = address(0x86350Acaa716382057d5eF5Ea8F86bbea6B70929); // set as marketing wallet
        devWallet = address(0x86350Acaa716382057d5eF5Ea8F86bbea6B70929); // set as dev wallet
