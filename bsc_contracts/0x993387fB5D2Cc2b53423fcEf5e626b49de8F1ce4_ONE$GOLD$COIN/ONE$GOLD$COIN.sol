...
contract ONE$GOLD$COIN  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ONE GOLD COIN";
    string private _symbol = unicode"OGC💰";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x535f25FAa23658068D0D39301dF9798dA55297D7); // Marketing Address
    address payable public teamWalletAddress = payable(0x535f25FAa23658068D0D39301dF9798dA55297D7); // Team Address
