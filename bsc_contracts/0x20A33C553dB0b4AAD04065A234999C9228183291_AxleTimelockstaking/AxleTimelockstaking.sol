...
// File: AxleTimelockstaking.sol

contract AxleTimelockstaking is Ownable, Initializable, ReentrancyGuard {
    using SafeERC20 for IERC20; 
    using SafeMath for uint256;
    uint256 public totalstakedamount ;
    uint256 public preUnlockPenalty = 1500;
    uint256 public maxStake = 20000000 * 10**9;
    uint256 public minStakeamt = 100000 * 10**9;
    ...
    */
    function initialize(IERC20 _token, address owner_) public initializer {
        ...
        rewardPercent[30 days] = 6000;
        rewardPercent[90 days] = 9000;
        rewardPercent[180 days] = 10000;
        rewardPercent[360 days] = 10000;
    }
    ...
    */
    function stake(uint256 _time, uint256 _amount) external nonReentrant {
        ...
        require(_amount != 0, "AxleStake: Null amount!");
        require(_time != 0, "AxleStake: Null time!");
        ...
        require(rewardPercent[_time] != 0, "AxleStake: Time not specified.");
    ...
    */
    function claim(uint256 _txNo) external nonReentrant {
        ...
        require(
            ...
            "AxleStake: Rewards already claimed."
        );
        require(
            block.timestamp > stakes.stakingPerTx[_txNo].lockedUntil,
            "AxleStake: Stake period is not over."
        );
