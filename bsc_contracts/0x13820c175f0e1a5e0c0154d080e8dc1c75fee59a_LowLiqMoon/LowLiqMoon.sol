...
contract LowLiqMoon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LowLiqMoon", "LLM") {
        ...
        deployerAddress = address(0x0BB59FCdAEc08055ce84e912092bd49606A8cc90); // Deployer Address
    	marketingWallet = address(0x30630301b6baAa6562d3e9f690983462f9b253ae); // Marketing Wallet
