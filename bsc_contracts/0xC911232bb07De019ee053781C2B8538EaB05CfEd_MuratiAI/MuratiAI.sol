...
/**
MuratiAI - 开发一个平台 Web 和 Bot，利用 MuratiAI 的强大功能在几秒钟内创建动漫图像
*/
...
contract MuratiAI is ERC20, Ownable {
    uint256 public marketingFeeOnBuy = 2;
    uint256 public marketingFeeOnSell = 2;

    address public marketingWallet = 0x34a47574214C694c8e9482bC921161E0670Ad663;
    ...
    uint256 public walletLimit = 10_000;
    uint256 public txLimit = 10_000;
    ...
    constructor() ERC20("MuratiAI", "MAI") {
