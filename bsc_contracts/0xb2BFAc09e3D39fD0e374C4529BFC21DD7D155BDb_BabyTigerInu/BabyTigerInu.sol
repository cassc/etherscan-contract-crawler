...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFDe17beB158D5edFb99a3Fb5160420120bd8Ae8d; // owner address
...
contract BabyTigerInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Tiger Inu";
    string private _symbol = "$BTI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE74254137148d3bD8f3cb67e7B3f4A6143710E43); // Marketing Address
    address payable public teamWalletAddress = payable(0xE74254137148d3bD8f3cb67e7B3f4A6143710E43); // Team Address
