...
contract VenusAi is Context, IERC20, Ownable {
    ...
    uint256 public marketFeeOnBuying = 50; // 2% will be added to the market address
    ...
    uint256 public marketFeeOnSelling = 50; // 2% will be added to the market address
    ...
    constructor() {
        marketWallet = payable(0xA6913A840A3163C3DB990d9773DCe853F0e5D0d7);
        devWallet = payable(0x8d874e13b7A483a3b8B82CF8D6C75674e2fF5CdD);
