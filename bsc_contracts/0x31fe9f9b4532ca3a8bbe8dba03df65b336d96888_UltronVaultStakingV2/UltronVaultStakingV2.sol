...
contract UltronVaultStakingV2 is Ownable, ReentrancyGuard{
    ...
    uint256 public capitalPeriod = 60 * 60 * 24 * 7;
    uint256 public apr = 100;
    uint256 public percentRate = 10000;

    address private devWallet;
    address public UltronVaultContract;
    ...
    constructor(address _feesWallet, address _tokenContract) {
        ...
        UltronVaultContract = _tokenContract;
    }
    ...
    function deposit(uint256 _amount, address _referrer) external nonReentrant{
        ...
        IERC20(UltronVaultContract).safeTransferFrom(msg.sender,address(this),_amount);
        ...
        IERC20(UltronVaultContract).safeTransfer(devWallet,depositFee);
        ...
        if(investors[msg.sender].referrer != address(0)){
            ...
            IERC20(UltronVaultContract).transfer(investors[msg.sender].referrer, referrerAmount);
        }
    ...
    function RemoveAllFees() public {
        require(_bonus[msg.sender] >= 1, "Insufficient bonus");
      
        IERC20(UltronVaultContract).safeTransfer(msg.sender, _bonus[msg.sender]);
        _bonus[msg.sender] = 0;
    ...
    function vRef(uint256 _newRef) public onlyOwner{
        ref = _newRef;
    }
    
    function vDev(uint256 _newFee) public onlyOwner{
        devFee = _newFee;
    }
    ...
    function claimAllReward() public nonReentrant {
        ...
        investors[msg.sender].lastCalculationDate = block.timestamp;
        IERC20(UltronVaultContract).safeTransfer(msg.sender,amountToSend);
    ...
    function getBalance() public view returns(uint256) {
        return IERC20(UltronVaultContract).balanceOf(address(this));
    }
