...
contract WEN is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x53e5e3472EBA04CEBE56E98AaAe373F59ff221fA); // Marketing Address
        
    address payable public teamAddress =
        payable(0x53e5e3472EBA04CEBE56E98AaAe373F59ff221fA); // Team Address

    address payable public liquidityAddress =
        payable(0x53e5e3472EBA04CEBE56E98AaAe373F59ff221fA); // Liquidity Address
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x53e5e3472EBA04CEBE56E98AaAe373F59ff221fA).call{value: bnbForDev}("");
