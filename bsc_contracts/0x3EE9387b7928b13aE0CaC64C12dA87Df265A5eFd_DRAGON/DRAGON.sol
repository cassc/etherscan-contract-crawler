...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x008f000C49b881dc84A633B310C5A9CA652B1172;
...
contract DRAGON is Context, IERC20, Ownable {
    ...
    string private _name = "DRAGON BALL";
    string private _symbol = "DRAGON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x008f000C49b881dc84A633B310C5A9CA652B1172);
    address payable public teamWalletAddress = payable(0x008f000C49b881dc84A633B310C5A9CA652B1172);
