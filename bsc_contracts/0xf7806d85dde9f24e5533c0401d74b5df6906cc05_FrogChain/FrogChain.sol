...
contract FrogChain is Context, IERC20, Ownable {
    ...
    string private _name = unicode"FrogChain";
    string private _symbol = unicode"FGC";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0xa1F8A2707D56D3B74Ef5836BeC8E54407399c114); 
    address payable public BurnedWalletAddress = payable(0x10a0743D64ad76e0ED0ad871cf8d1249caaaE87c); 
