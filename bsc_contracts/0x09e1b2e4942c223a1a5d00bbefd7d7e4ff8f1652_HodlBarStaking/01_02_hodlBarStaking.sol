...
contract HodlBarStaking is Ownable, Pausable, ReentrancyGuard {
  using SafeMath for uint256;
  ...
  uint256 public lockupPeriod = 2419200; // in seconds
  uint256 public minStakingAmount = 1000000 * 10**18; //min staking amount
  ...
  constructor() public {
    BaseToken = IBEP20(0xe0f7c8682F865B417AEB80BF237025b4cB5EbaEF);
    rewardToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    rewardPerBlock = 31 * 10**15;
    startBlock = 21421200;
    rewardEndBlock = 22227600;
  ...
  function changeMinStakingAmount(uint256 amount) external onlyOwner {
    require(amount > 0, "changeMinStakingAmount: amount should greator than 0");
    ...
    nonReentrant
  {
    ...
    time[msg.sender] = block.timestamp + lockupPeriod;
    totalStaked += _amount;
