...
contract FGDZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FGDZilla";
    string private _symbol = "FGDZilla";
    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0xE2dB70D73Ad34B1f94ecE088B6a19532c9aDf591); 
    address payable public ttWal = payable(0xE2dB70D73Ad34B1f94ecE088B6a19532c9aDf591); 
