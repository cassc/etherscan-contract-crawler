...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardsToken = IBEP20(0x893535ED1b5C6969E62a10bABfED4F5fF8373278);
...
contract KINGOFMEME is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = " KING OF MEME ";
    string constant _symbol = " KOM ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 90/100;
    uint256 public _walletMax = _totalSupply * 90 / 100;
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 10000000000);
        _maxTxAmount = amount;
    }
