...
contract MiniNaughtiusMaximus
 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MiniNaughtiusMaximus";
    string private _symbol = "MiniNaughtiusMaximus";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6cd05693a3f82574773787d01666c14C76F82a0A);
    address payable public teamWalletAddress = payable(0x6cd05693a3f82574773787d01666c14C76F82a0A);
    address public immutable deadAddress = 0x6cd05693a3f82574773787d01666c14C76F82a0A;
