...
contract CES is Ownable  {
	...
	function swapToLiquify() public {
		...
		if(allAmount > usdtAmount){
			...
			IERC20(token_address).transfer(uniswapV2Pair,tokenAmount); 
			USDT.transfer(uniswapV2Pair,newAmount); 
		}
