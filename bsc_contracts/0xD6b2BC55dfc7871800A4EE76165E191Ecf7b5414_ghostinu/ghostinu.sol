...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0891813274bd3D7fe750b0Fc68687A22C4635E9B;
...
contract ghostinu is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x0891813274bd3D7fe750b0Fc68687A22C4635E9B);
    ...
    */
    ...
    string private _name = "Ghost Inu"; 
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((Buy_Fee + Sell_Fee) <= 100, "Fee is too high!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
