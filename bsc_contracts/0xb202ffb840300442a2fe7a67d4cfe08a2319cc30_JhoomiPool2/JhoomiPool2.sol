...
contract JhoomiPool2  is Ownable, ReentrancyGuard{
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    
    uint256 public developerFee = 1000; // 300 : 3 %. 10000 : 100 %
    uint256 public withdrawFee = 100; // 300 : 3 %. 10000 : 100 %
    uint256 public rewardPeriod = 365 days;
    uint256 public withdrawPeriod = 30 days;
    uint256 public apr = 6000; // 150 : 1.5 %. 10000 : 100 %
    ...
    function setWithdrawFee(uint256 _wfee) external onlyOwner {
        withdrawFee = _wfee;
    }

    function setDeveloperFee(uint256 _dfee) external onlyOwner {
        developerFee = _dfee;
    }
