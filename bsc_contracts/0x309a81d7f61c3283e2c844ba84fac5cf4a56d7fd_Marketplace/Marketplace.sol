...
contract Marketplace is Ownable {
    ...
    address constant ACOIN = 0x7A41C1228e802DaF15B42dF3Be25070e979252a2;
    address constant SOD = 0x9352fbE4609DF2cAA766509EF7DC975cD12DdAa8;
    address constant USDT = 0x55d398326f99059fF775485246999027B3197955; 
    uint256 public FEE_PERCENTAGE_ACOIN = 3;
    uint256 public FEE_PERCENTAGE_SOD = 3;
    ...
    function changeFeePercentageACOIN(uint256 newPercentage) public onlyOwner {
        FEE_PERCENTAGE_ACOIN = newPercentage;
        emit FeePercentageChanged(newPercentage);
    }

    function changeFeePercentageSOD(uint256 newPercentage) public onlyOwner {
    ...
    function buyItem(uint256 itemId, uint256 tokenAmount) public {
        ...
        uint256 feeAmount = 0;
        if(item.tokenAddress == ACOIN){
            feeAmount = (totalPrice * FEE_PERCENTAGE_ACOIN) / 100;
        }else{
            feeAmount = (totalPrice * FEE_PERCENTAGE_SOD) / 100;
        }   
