...
contract Starshib is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "STARSHIB INU";
    string constant _symbol = "STARSHIB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(2).div(100); // 2% of total supply
