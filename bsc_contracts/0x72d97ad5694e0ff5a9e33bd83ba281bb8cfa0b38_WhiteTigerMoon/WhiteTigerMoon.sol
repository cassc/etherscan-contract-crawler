...
contract WhiteTigerMoon is Context, IERC20, Ownable {   //
    ...
    string private constant _name = "White Tiger Moon"; // 
    string private constant _symbol = "$WHTETGRMOON"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0x9829ac43C11489c38a75979fDf6ba954ff7c2Af3); //
