...
contract token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20232022 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3 * 10**9; 
    string private constant _name = "2023>2022"; 
    string private constant _symbol = "2023>2022"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 1;
    uint256 public _liquidityFee = 0;
    address private _promoWallet = 0xb2EcB100B74Db107AF7C62a3e08B4675c2eE85eC;

    uint256 public _maxTxAmount = (_tTotal * 1) ; 
    uint256 public _walletMax = (_tTotal * 1) ;
    uint256 private minimumTokensBeforeSwap = (_tTotal * 2) / 100;
