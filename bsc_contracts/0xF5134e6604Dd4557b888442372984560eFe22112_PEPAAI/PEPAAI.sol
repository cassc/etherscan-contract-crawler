...
contract PEPAAI is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 42 * (10**16) * (10**9);
    ...
    string private constant _name = "PEPA AI Inu";
    string private constant _symbol = "PEPAAI";
    uint8 private constant _decimals = 9;

    address payable private _marketingAddress = payable(0x449E1b693e3BFE0B93eCc3dc4B1D0961E8ffCc57);
    address payable private _marketing2Address = payable(0x533500Eb8d5B0D40eb30a8EB9A4ADe18a3141Db4);
