...
*telegram : https://t.me/spookymoonportal
...
interface IDEXRouter {
 ...
 contract spookymoon  is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Spooky MOON";
    string constant _symbol = "SMOON";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 10; 
    uint256 public _maxWalletSize = (_totalSupply * 3) / 10; 
    ...
    address public devFeeReceiver = 0x945A075d6676EeC02aC14583A65D7FB2dBa7c11a;
    address public buybackFeeReceiver = 0x945A075d6676EeC02aC14583A65D7FB2dBa7c11a;
    ...
    uint256 public swapThreshold = _totalSupply / 100 * 3; // 0.3%
    bool inSwap;
