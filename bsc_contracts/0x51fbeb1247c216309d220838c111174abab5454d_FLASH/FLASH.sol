...
abstract contract Ownable {
    ...
    contract FLASH is Ownable, IBEP20{
    ...
    uint constant  InitialSupply=10**7*10**_decimals;
    ...
    function symbol() external pure override returns (string memory){return "FLASH";}
    function name() external pure override returns (string memory){return "Flash Inu";}
    ...
    event OnSetTaxes(uint Buy, uint Sell, uint Transfer, uint Reflection, uint Liquidity, uint Marketing);
    ...
    constructor(){
       ...
       addTokens(msg.sender,InitialSupply*999999/1000000);
       addTokens(address(0xdead),InitialSupply/1000000);
        emit Transfer(address(0),address(0xdead),InitialSupply/1000000);      
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function setTaxes(uint Buy, uint Sell, uint Transfer, uint Reflection, uint Liquidity, uint Marketing) public onlyOwner{
...

function getTaxes() public view returns (uint Buy, uint Sell, uint Transfer, uint Reflection, uint LP, uint Marketing){
    Buy=_buyTax;
    Sell=_sellTax;
