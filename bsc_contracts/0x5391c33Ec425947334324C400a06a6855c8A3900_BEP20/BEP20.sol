...
contract BEP20 is Context, IERC20, Ownable {
    ...
    uint256 public marketingFee2 ;//营销
    ...
    address public marketingWalletAddress2;//营销钱包
    ...
    constructor() {
        ...
        address _main=0x59fa43e3A0279315f930b329A0Ed99EfFAd82b06;//钱包持有
        marketingWalletAddress=0x4a36eEB5b7557EEa517e5870A4dFFdcb5ce48DdE;//营销钱包
        marketingWalletAddress2=0xBBCc72365c3A59AF0F95A8547fe259f01a2bce7d;//营销钱包
        foundationWalletAddress=0xC75D9434E9a5F167f71D34B53A0206A16d21154E;//滑点接收钱包
        liquidityReceiveAddress=0x1F66ED9B8393C9bf5A16760580887c35cA35693c;//回流钱包
    ...
    function setMarketingFee2(uint256 val) public onlyOwner {
        marketingFee2 = val;
    }
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= swapTokensAtAmount && AmountLiquidityFee.add(AmountLpRewardFee).add(AmountMarketingRewardFee).add(AmountMarketingRewardFee2)>=swapTokensAtAmount;
        if( canSwap &&
            !swapping &&
            from != uniswapV2Pair &&
            from != owner() &&
        ...
        if(takeFee) {
            require((from != uniswapV2Pair && to != uniswapV2Pair)||amount<=swapAmountMax,"ERC20: transfer amount over max");
    ...
    function takeAllFee(address from,uint256 amount) private returns(uint256 amountAfter) {
        ...
        if(MFee2 > 0) AmountMarketingRewardFee2 += MFee;
