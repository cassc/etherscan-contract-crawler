...
contract PepeCash is IERC20, Ownable {
    ...
    address internal constant development_receiver = 0x3F0Dc246637344a9d9d155DF9c84F9f735bb995b; 
    address internal constant marketing_receiver = 0x3F0Dc246637344a9d9d155DF9c84F9f735bb995b;
    address internal constant liquidity_receiver = 0x3F0Dc246637344a9d9d155DF9c84F9f735bb995b;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _burn, uint256 _development, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        sellFee = _sell;
        transferFee = _trans;
        require(totalFee <= denominator.div(5) && sellFee <= denominator.div(5), "totalFee and sellFee cannot be more than 50%");
    }
