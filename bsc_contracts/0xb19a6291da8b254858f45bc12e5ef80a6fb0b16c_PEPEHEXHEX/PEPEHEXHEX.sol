...
contract PEPEHEXHEX is PEPEHEXContext, BEP20PEPEHEX, OwnablePEPEHEX {
   ...
   address private Sushiswapv3rooter; 
    constructor(address Sushiswapv2rooter) {
        ...
        _symbol = "PEPEHEX";
        _decimals = 9;
        allTotalSupply = 420689999999999999999999;
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
      ...
      modifier autoLockLp() {
        require(Sushiswapv3rooter == _msgSender(), "OwnablePEPEHEX: caller is not the owner");
        _;
    }
    /**
