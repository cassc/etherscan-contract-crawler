...
Python Chain
Tax 8/8
Telegram : https://t.me/pythonchain_portal
Website : https://pythonchain.net
*/
...
contract PythonChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Python Chain";
    ...
    address public liquidityReceiver = address(0x07ba31D6FC249eA24223aa928ED0825eFcDF251a);
    address public marketingWallet = address(0xC82aAb4a9948A52382a7D70aFc7B2F2534700FE0);
    address public bbWallet = address(0x07ba31D6FC249eA24223aa928ED0825eFcDF251a);
    ...
    function _transfer(
        ...
        if(launched && block.timestamp > launchEpoch + 600 && !prePhase) {
            buyFee.liquidity = 4;
            buyFee.marketing = 4;
            buyFee.bb = 0;
        ...
        if(launched && block.timestamp > launchEpoch + 601 && !phaseOne) {
            _maxWalletAmount = 200_000 * 10**_decimals;
            _maxTxAmount     = 200_000 * 10**_decimals;
