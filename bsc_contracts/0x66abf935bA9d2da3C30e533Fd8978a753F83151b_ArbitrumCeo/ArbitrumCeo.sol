...
contract ArbitrumCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arbitrum Ceo";
    string private _symbol = "ARBCeo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x90f4fa24431e7D51ea26Beacfa997A0fFDFA30da); // Marketing Address
    address payable public teamWalletAddress = payable(0x90f4fa24431e7D51ea26Beacfa997A0fFDFA30da); // Team Address
