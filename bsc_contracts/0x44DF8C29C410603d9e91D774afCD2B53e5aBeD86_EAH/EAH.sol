...
contract EAH is ERC20 {
    ...
    uint256 public inviterFee = 0;
    uint256 public totalFee = lpFee+marketFee+inviterFee;
    ...
    constructor() ERC20("EAH", "EAH") {
        ...
        _tokenOwner = address(0x31c7B74d2CCDDB5EFE3e8e4E77F4907b6e340F4f);
        marketAddress = address(0x0000000000000000000000000000000000000000);
    ...
    function setFees(uint256 _lpFee,uint256 _marketFee,uint256 _inviterFee) external onlyOwner{
        lpFee = _lpFee;
        marketFee = _marketFee;
        inviterFee = _inviterFee;
        totalFee = lpFee+marketFee+inviterFee;
    }
    ...
    function _transfer(
        ...
        require(!_isBlack[from],"the black address");
    ...
    function _takeInviterFee(
        ...
        for (uint256 i = 0; i < 4; i++) {
            ...
            uint256 amount = iAmount.mul(rate).div(40);
