...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x31a5d6EC14f5d030c9BFC757CEb0353CC964fCc9;
...
contract SpookyAptos is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Spooky Aptos"; 
    string private constant _symbol = unicode"SpookyAptos"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x31a5d6EC14f5d030c9BFC757CEb0353CC964fCc9), BNB_Tot);
            }
