...
contract Fav is Context, IERC20, Ownable {
    ...
    string private constant _name = "my favorite childhood memory is my back not hurting"; // 
    string private constant _symbol = "MFCMIMBNH"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xC47dBBae676E2829e0BC19028701C01150aD832c;
