...
contract AlmondCoin is BEP20, Ownable {
    ...
    uint256 public maxBuyLimit = 3e10 * 10**18;
    uint256 public maxSellLimit = 3e10 * 10**18;
    ...
    address public marketingWallet = 0xBe1056983Ee436Cab70680cE50AAce75B1b2c7Fe; 
    address public devWallet = 0xae9DBAF25bd7340926E5Eb7F53BB2d4926935088;
    ...
    // Taxes(Marketing, Liquidity, Develoment)
    Taxes public taxes = Taxes(2, 1, 2);
    Taxes public sellTaxes = Taxes(2, 2, 4);
    ...
    constructor() BEP20("Almond Coin", "AMC") {
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _dev) <= 14, "Must keep fees at 14% or less");
    }
    ...
    maxBuyLimit = (2**256) - 1;
    maxSellLimit = (2**256) - 1;
    maxWalletLimit = (2**256) - 1;
    }
