...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        address ReceiveAddress, address FundAddress , address _TopestAddress
    ){
        _name = Name;
        _symbol = Symbol;
        _decimals = Decimals;
        ...
        lpRewardCondition = 30 * 10 ** IERC20(USDTAddress).decimals();
        _numToSell = 21 * tokenDecimals;

        _feeConfigs.push(FeeConfig(4 days, 350));
        _feeConfigs.push(FeeConfig(3 days, 350));
        _feeConfigs.push(FeeConfig(2 days, 350));
        _feeConfigs.push(FeeConfig(1 days, 350));
        _feeConfigs.push(FeeConfig(0, 350));
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (_swapPairList[sender]) {
                ...
                // uint256 LPAmount = tAmount*_lpDividendFee/10000;
        ...
        _takeTransfer(sender, recipient, tAmount - feeAmount - inviterAmount);
    }
    ...
    function _takeInviterFee(
            ...
            for (uint256 i = 0; i < 8; i++) {
                ...
                cur = inviter[cur];
                if (cur == address(0)) {
                    uint256 _leftAmount = tAmount * tak / 10;
                    _balances[TopestAddress] = _balances[TopestAddress] + _leftAmount;
                    emit Transfer(sender, TopestAddress, _leftAmount);
                    break;
                }
                tak = tak - rate;
                uint256 curTAmount = tAmount * rate / 10;
...
contract PPT is AbsToken {
    ...
    //USDT
        ...
        21000,
    //Receive
        address(0x7Eef6Bd714588Be08c9568E4e90E8fD71c8778B9),
    //Fund
        address(0x0C6B12727aB5cf3112ad411F103fd12Ca666719f),
    //topestaddress
        address(0x97f5841F3bAee2A0F640356877FC876650910A50)
    ){
