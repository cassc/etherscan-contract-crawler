...
contract DarkFloki  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dark Floki";
    string private _symbol = "DFLOKI";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x30F89D1e50bC8F02771d416A5F2d0910000257c0);
