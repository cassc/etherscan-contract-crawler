...
contract NEWCOMMUNITYOFFSHOREPLAN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Offshore Plan";
    string private _symbol = "cOPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE593319ab8BDA1ECcaDA1cf8d4FCA51Ed7c77B58); 
    address payable public teamWalletAddress = payable(0xE593319ab8BDA1ECcaDA1cf8d4FCA51Ed7c77B58); 
    ...
    uint256 private _totalSupply = 2000000000000 * 10**9;
    uint256 public _maxTxAmount = 20000000000 * 10**9; 
    uint256 public _walletMax = 60000000000 * 10**9; 
