...
contract BSC is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x075e756aACbbB89C75aD7094aFe0DD8f99B87A62);
        teamWallet= payable(0xb503A983CfB74fca28D99EBEe99BfDCC5F68c4Bb);
        ...
        _maxOnceEat = 100000000000 * 10**_decimals;
        _maxTotalEat = 100000000000 * 10**_decimals;
