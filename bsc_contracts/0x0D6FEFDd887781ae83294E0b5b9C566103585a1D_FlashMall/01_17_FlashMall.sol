...
contract FlashMall is AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() external initializer {
        ...
        point = 0x8F9E8D7657c5D8eA543e78C4D59e1986F75702b2;
    ...
    function setMerchantDiscount(uint8 discount) external {
        require(discount >= 100 && discount <= 3200, "Invail discount");
    ...
    function setPointRate(uint16 rate) external onlyRole(OPERATOR_ROLE) {
        pointRate = rate;
    }
