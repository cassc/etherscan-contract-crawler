...
/**
https://t.me/PEPE2023OFFICIALBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xec4e1AbCCFc8fcf9E3620b9BDdbCd3E59e0E62D3; // owner address
...
contract PEPE2023OFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE 2023";
    string private _symbol = "$P23";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x778d438a07d57e89050147cfEd306cf3573BbE03); // Marketing Address
    address payable private teamWalletAddress = payable(0xec4e1AbCCFc8fcf9E3620b9BDdbCd3E59e0E62D3); // Team Address
