...
contract EMPi is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2023 * 10**9;
    uint256 public _maxTxAmount = 2023 * 10**9; // 
    uint256 public _maxWalletAmount = 2023 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 6 * 10**9; //
    string private constant _name = unicode"EMPi"; // 
    string private constant _symbol = unicode"EMPi"; //    
    ...
    address public  _marketingWallet = 0xCF03C9E4c490eb3843c8B5F8F63a990F662e433b;
