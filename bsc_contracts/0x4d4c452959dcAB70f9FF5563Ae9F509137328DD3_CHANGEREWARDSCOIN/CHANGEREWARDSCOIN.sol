...
/**
 *CHANGE REWARDS COIN $CRC

 TG: t.me/changerewardstoken

 Change Rewards Coin $CRC is the token that allows the community to choose which tokens to get in rewards ,
  every day you can choose a token of verse , 
  but for how long and which token you will decide through polls we will put in the group.
...
contract CHANGEREWARDSCOIN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "CHANGEREWARDSCOIN";
    string constant _symbol = "CRC";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0xECCF35F941Ab67FfcAA9A1265C2fF88865caA005;
    ...
    uint256 public swapThreshold = _totalSupply * 100 / 2000;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =  0x3Bb035F33269E887cF50aCC4Ab754238CC4906Eb;
