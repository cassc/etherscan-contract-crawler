...
contract  ShibaInu is ERC20, Ownable {
    ...
    constructor() ERC20("Shiba Inu", "SHIBA") {
        ...
        _mint(address(this), 495000000000000*10**decimals());
        startSale(block.number, 999999999, 0,10000000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,10000000*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
