...
contract BARTCN is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xc13a17F25cE70261716cb0ec3a27455eEF188Fff);
    address payable public Wallet_Dev =
        payable(0xa9c956Ff1AC8889Ba269666603C2282725a56828);
    ...
    string private constant _name = "Bart Chinese Version";
    string private constant _symbol = unicode"$BARTCN";
    ...
    constructor() {
        _owner = 0xa815bb0D761239546F243Ad31195226018FFa280;
