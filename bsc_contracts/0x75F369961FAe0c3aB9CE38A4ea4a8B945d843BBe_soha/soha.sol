        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xA47B9141Ec22B817D9e352aCc8570dE40901949F), block.timestamp
                );
            }
        }
    }
...
contract soha is AbsToken {
    constructor() AbsToken(
        ...
        9,
        2100000000000000,
        address(0x3bC694a5823F154744763bb661254Efc989add47),
        address(0x460944876b4744a16dFAc3A3c1C84bB7820B9901)
    ){
    }
}