...
contract LMJ is ERC20, Ownable {
    ...
    LMJDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Last Man Joshing", "$LMJ") {
        marketingWallet = payable(0x150189876933AF18593F311AF35F275261aaD555);
        devWallet = payable(0x150189876933AF18593F311AF35F275261aaD555);
        ...
        dividendTracker = new LMJDividendTracker(
            payable(this),
            router,
        ...
        uint256 totalTokenSupply = (250_000) * (10**18);
    ...
    function updateFees(
        ...
        require(totalSellFees <= 40 && totalBuyFees <= 40, "total fees cannot exceed 40% sell or buy");
...
contract LMJDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "LMJ_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "LMJ_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LMJ contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(LMJContract);

            uint256 prevBalance = LMJContract.balanceOf(address(this));
            ...
            {
                uint256 received = LMJContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    LMJContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
