...
/*
    ...
    CZ BINANCE🔶 
Mindset is everything. Don't say: I wish I got in early. 
Say: I wish I bought when there was FUD. Not financial advice. Keep building.
    https://t.me/BilIionaireMindset
...
contract BillionaireMindset is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Billionaire Mindset";
    string private _symbol = "BOMB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xE5f4cdCE210f69d9133A6a51eb576c61234fab63);
    ...
    uint256 private _totalSupply = 10000 * 10**8 * 10**_decimals;
