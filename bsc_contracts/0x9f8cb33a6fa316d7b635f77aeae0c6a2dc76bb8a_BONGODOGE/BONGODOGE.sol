...
contract BONGODOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Bongo Doge";
    string private _symbol = "BDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD822D6b0D28f52B6d5d24231781cbc63ef403123); 
    address payable public buyBackWalletAddress = payable(0xD822D6b0D28f52B6d5d24231781cbc63ef403123); 
