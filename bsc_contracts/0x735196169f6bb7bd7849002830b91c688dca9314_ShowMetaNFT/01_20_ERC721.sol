...
contract ERC721 is Context, ERC165, IERC721 {
    ...
    function _setup(string memory _name) internal {
        ...
        returns (bool)
    {
        return
            ...
            interfaceId == type(IERCPermit).interfaceId ||
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "ShowMeta: EXPIRED");
        require(
            ERC721.ownerOf(tokenId) == owner,
            "ShowMeta: transfer of token that is not own"
        );
