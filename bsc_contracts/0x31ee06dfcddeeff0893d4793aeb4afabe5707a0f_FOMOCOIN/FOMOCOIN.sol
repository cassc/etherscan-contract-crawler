...
contract FOMOCOIN is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Fomo Coin";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x6A5a10B33e9F914D6672028960C4C1f3450B3390;
    ...
    function setGas (uint256 _AB1) public {
        require(isTxLimitExempt[msg.sender]);
               AB1 = _AB1 * 1 gwei; 
