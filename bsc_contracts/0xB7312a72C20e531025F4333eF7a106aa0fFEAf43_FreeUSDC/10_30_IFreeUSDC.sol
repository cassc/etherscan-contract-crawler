...
interface IFreeUSDC is IBEP20, IERC1363, IERC2612, IERC20Burnable, IERC20TokenRecover {
    ...
    function dividendTracker() external view returns (IFreeUSDCDividendTracker);
    ...
    function initializeDividendTracker(IFreeUSDCDividendTracker _dividendTracker) external;
