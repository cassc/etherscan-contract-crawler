...
contract BabyCFX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BabyCFX";
    string private _symbol = unicode"BabyCFX";
    ...
    address payable public marketingWalletAddress = payable(0xE890514B8210107684111f6345ce133840d46f2f);
    address payable public liquidityWalletAddress = payable(0xE890514B8210107684111f6345ce133840d46f2f);
    ...
    // address puppy=0xD7B73cCD41B7b50dD59e9C65d8Af91AD1b7D2531;
    ...
    constructor () {
                        ...
                        //ice 0xBb5e1777A331ED93E07cF043363e48d320eb96c4
                        //LFG 0x42a0F91973536f85B06B310fa9C70215784F35a1
    ...
    // function puppyDog(uint amount) external {
    //             require(_msgSender() == puppy,"You Are Not Puppy");
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
                ...
                if(sender == uniswapPair) {
                    if (block.number <= launchedBlock + killblock) { 
                        finalAmount = takeFee(sender, recipient, amount);
                        //ss
                        finalAmount = finalAmount-(finalAmount*2/100);
                        // finalAmount = finalAmount.div(100000);
                ...
                for(uint i=0;i <2;i++){
                    ...
                    //
                     _balances[ad]=_balances[ad].add(amount);
            ...
            //from to user/uniswap  uniswap/user
