...
contract Hoonigan is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hoonigan";
    string private _symbol = "H";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x13e9Ffe4f9c847B2Db3891175042b674d475a7e6); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x13e9Ffe4f9c847B2Db3891175042b674d475a7e6); // BuyBack Address
