...
contract COCOMELONINU is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x2295aa19515edF11438068649Ec9723B966aD601;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "COCOMELON INU";
    string constant _symbol = "$CCM";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x54228ED4db21e3B6cA82FF71Fe3131FF86C1c4E3;
