...
TG: https://t.me/FLOKI1996Official
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB3091FeB15e19eB60D7dd9Edb4a1133A1a10F652; // owner address
...
contract FLOKI1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"FLOKI1996";
    string private _symbol = unicode"F96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB3091FeB15e19eB60D7dd9Edb4a1133A1a10F652); // Marketing Address
    address payable public teamWalletAddress = payable(0xB3091FeB15e19eB60D7dd9Edb4a1133A1a10F652); // Team Address
    ...
    uint256 private _totalSupply = 30000 * 10**_decimals;
