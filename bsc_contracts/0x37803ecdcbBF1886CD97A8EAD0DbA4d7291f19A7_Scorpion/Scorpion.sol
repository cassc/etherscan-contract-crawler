...
contract Scorpion is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xA8B894e8ab851840bF2A713D23212390AC470004);
    ...
    string private _name = "SCORPION";
    string private _symbol = "SCORP";
    ...
    uint256 public _maxTxAmount = 1000000 * 10**3 * 10**18;
    uint256 private minimumTokensBeforeSwap = 3000 * 10**3 * 10**18;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 10000000000000 * 10**3 * 10**18;
    }
    ...
    function afterPreSale() external onlyOwner {
        ...
        _taxFee = 2;
        _liquidityFee = 8;
        _maxTxAmount = 1000000 * 10**3 * 10**18;
    }
