...
* This contract has an audit on https://contractwolf.io/projects/token-generator
* This Smart Contract was made from contractwolf.io token generator (contractwolf.io/createtoken) 
...
contract ContractWolfTokenGen is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 81000000 * 18**decimals();
    uint256 public maxWalletLimit = 405000000 * 18**decimals();

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0xceC3AF281011436eb3E9Cd004746eC666E22B3bF;
    address private devWallet = 0xceC3AF281011436eb3E9Cd004746eC666E22B3bF;
    ...
    Taxes public sellTaxes = Taxes(0, 4, 0);
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("GRANDPA TOKEN", "GRANDPA") payable {
        _tokengeneration(msg.sender, 8100000000 * 10**decimals());
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 8100000, "Cannot set max wallet amount lower than 0.1%");
