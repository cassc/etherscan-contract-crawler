...
/*
Telegram : https://t.me/SuperCatBoyToken
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xB2680909B925A843b2b9765b331510999EfDDf5c;
...
contract SuperCatBoy is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xB2680909B925A843b2b9765b331510999EfDDf5c);
    address payable private Wallet_Burn = payable(0xB2680909B925A843b2b9765b331510999EfDDf5c); 
    ...
    */
    ...
    string private _name = " Super Cat Boy "; 
    string private _symbol = " SCatBoy ";  
    ...
    */
    ...
    function set_Max_Transaction_Percent(uint256 maxTxPercent_x200) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x200/10000;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x200) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x200/10000;
    }
