...
contract BabyCtrl2XY is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Control2XY";
    string constant _symbol = "BabyCtrl2XY";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xF8B250547f318314a70D411839851a7DeD00Aa6C;
        marketingWallet = 0xF8B250547f318314a70D411839851a7DeD00Aa6C;
        devWallet = 0xF8B250547f318314a70D411839851a7DeD00Aa6C;
