...
// Telegram : https://t.me/pepemomsBSC
...
contract PepeMoms is ERC20, Ownable {
    ...
    constructor() ERC20("Pepe Mom's", unicode"MOPE") {
        ...
        devWallet = address(0x86597c0f8F7a84CF76bfcD6FE8DE95A9F3101D53);
...
{
    require(
        newAmount == 100000000 * 1e18,
        "Swap amount must be equal to total supply."
    );
