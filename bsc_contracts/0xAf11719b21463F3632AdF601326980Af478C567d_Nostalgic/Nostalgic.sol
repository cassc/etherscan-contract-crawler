...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x5b41028f250204fAE2d96A8B1Ffe33E2944dc9a6);
...
contract Nostalgic is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Nostalgic";
    string constant _symbol = "NSTL";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x5b41028f250204fAE2d96A8B1Ffe33E2944dc9a6;

    uint256 _totalSupply = 10000000000 * 10**13;
    uint256 public _maxTxAmount =  _totalSupply * 8 / 200;
    uint256 public _walletMax = _totalSupply * 8 / 200;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xEC92ffDAf73e0Df345fDb4096515BDe70A4Ca91f;
        buybackWallet = 0xEC92ffDAf73e0Df345fDb4096515BDe70A4Ca91f;
