...
contract BABYPepeBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY PepeBNB";
    string private _symbol = "BABYPepeBNB";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x8496bA3648272f1d0e2db4Ea1E22c7F8396291F5); 
    address payable private teamWalletAddress = payable(0x8496bA3648272f1d0e2db4Ea1E22c7F8396291F5); 
    ...
    uint256 private minimumTokensBeforeSwap = 5* 10**9 * 10**_decimals;
