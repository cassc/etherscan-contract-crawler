...
contract ASFM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Alpha Safemoon";
    string private _symbol = "$ASFM";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xd29591a82e01cb7551a092174ED37C279103819c); // Buy Back Address
