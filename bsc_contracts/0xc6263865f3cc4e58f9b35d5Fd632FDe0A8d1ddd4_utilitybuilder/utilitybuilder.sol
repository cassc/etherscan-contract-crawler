...
/*
    telegram: t.me/utilitybuilderchannel
    website: utilitybuilder.tech
*/
...
contract utilitybuilder is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Utility Builder";
    string private _symbol = "UBuild";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xf446Eac1915a7D703fDeAbEdb37D47baaAD09C72);
    address payable public DevelopmentFee = payable(0xf446Eac1915a7D703fDeAbEdb37D47baaAD09C72);
    ...
    uint256 public _walletMax = 2000000 * 10**18;
    ...
    function setDevelopmentFeeAddress(address newAddress) external onlyOwner() {
        DevelopmentFee = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBBuyBack = amountReceived.mul(_DevelopmentShare).div(totalBNBFee);
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(DevelopmentFee, amountBNBBuyBack);
