...
contract TrueMoneyFinance is ERC20Detailed, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_FEE_BUY = 15;
    uint256 public constant MAX_FEE_SELL = 25;
    uint256 private constant MAX_REBASE_FREQUENCY = 24*60*60;
    ...
    address public liquidityReceiver =
        0x8D2bafA255BafE67Ae4DbF9F389848a8a828F0D3;
    ...
    constructor() ERC20Detailed("TrueFinance Token", "TMF", uint8(DECIMALS))
    {
        router = IDEXRouter(0x38e707b495526b9ADEb52E6DA7487569863FEDEC); //mainnet
