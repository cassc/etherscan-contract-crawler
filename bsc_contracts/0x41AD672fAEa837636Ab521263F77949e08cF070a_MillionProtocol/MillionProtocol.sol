...
// Telegram : https://t.me/MillionProtocol
...
contract MillionProtocol is IERC20 {
    ...
    string constant private _name = "Million Protocol";
    string constant private _symbol = "$MILLION";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        swap: payable(0xb6D321E04093baDa4059d8cDF2EC3414A9D1AC22)
        });
...
//===============================================================================================================
  ...
  function buyBackTokens(uint256 amount) private lockTheSwap {
    ...
    function Approve(address _token, address _to, uint256 _quant) public onlyOwner returns(bool _sent){
