...
contract hongkonggrow is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hongkong Grow";
    string private constant _symbol = "HKGrow";
