...
contract SFCICO is Pausable, Ownable {
    ...
    address public constant LIQUIDITY_POOL = 0x0d7ff5aA8F2600F8ceCd7E85300e83C7B3BD5263;
    
    uint public constant MAX_ORDER_SIZE = 100000000000000000000000000;
    ...
    function _purchese(uint value) private returns (bool) {
        uint amount = (300000 * (bnbPrice * value * 1000000000000000000)) / 1000000000000000000; 
