...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD7a53F35097d17A208c50D25a5489650a076af35; 
...
contract ShikokuC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shikoku Classic";
    string private _symbol = "$SHIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50CA660b0013582B9804C0b5D8C6E2d85Ab9c518); // 
    address payable public teamWalletAddress = payable(0x50CA660b0013582B9804C0b5D8C6E2d85Ab9c518); // 
    ...
    uint256 public _totalDistributionShares = 32;  
    uint256 private _totalSupply = 49444999 * 10**_decimals;
    uint256 public _maxTxAmount = 49444999 * 10**_decimals; 
    uint256 public _walletMax = 49444999 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 494949 * 10**_decimals; 
