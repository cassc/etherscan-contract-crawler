...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6d9F8C361d9eFB8e2163B06760953310Abf973e8; // owner address
...
contract Pepemoon is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x317e401B23D8467163Da4E70a9e5B675e7bC7dd2); // Marketing Address
    address payable public teamWalletAddress = payable(0x6d9F8C361d9eFB8e2163B06760953310Abf973e8); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 3000000000 * 10**3; 
    ...
    constructor () {
        ...
        isWalletLimitExempt[address(0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE)] = true; //Pinksale Pinklock
        isWalletLimitExempt[marketingWalletAddress] = true;
        isWalletLimitExempt[teamWalletAddress] = true;
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE)] = true; //Pinksale Pinklock
