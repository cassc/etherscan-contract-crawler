...
// File: contracts/BabyLunaNftStaking.sol
...
contract BabyLunaNFTstaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0xF6F2B7850a63bE9f1A15251C4De636fa3BC2aBe3); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [1, 2, 4, 6, 12, 24, 36];
    }

        function initialize() public onlyOwner {
        RTOKEN.approve(address(this), 10000000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
