...
contract  QQQ is Context, IERC20, Ownable {

    using M1M for uint256;
    string private _name = "QQQ";
    string private _symbol = "QQQ";
    ...
    constructor () {
        ...
        N2N = payable(address(0xf41665565d799596a9453302061a5BC4E7Ac56Fb));
