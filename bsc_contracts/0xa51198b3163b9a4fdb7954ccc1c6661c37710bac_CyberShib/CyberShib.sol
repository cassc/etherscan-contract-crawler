...
// Telegram portal: https://t.me/CyberShibBSC
// The TG will open shortly after launch. 
...
contract CyberShib is BEP20, Auth {
    ...
    string public constant name = "CyberShib";
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBOperations = amountBNB.mul(operationsFee).div(totalETHFee);

        payable(marketingFeeReceiver).transfer(amountBNBMarketing);
        payable(operationsFeeReceiver).transfer(amountBNBOperations);
    ...
    function setFees_base1000(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _operationsFee) external onlyOwner {
