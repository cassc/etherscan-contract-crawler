...
// Tg: https://t.me/thugdogeportal
// Twitter: https://twitter.com/thugdogebsc
// Web: http://thugdoge.site/
...
contract thugdoge  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x34c01802Df43E421f3a1BC38997292c691FB6729); 
    address payable public Wallet_Dev = payable(0x3Ba05E97C6e3cBdB47C3F006f8063a2b532bf4b1);
    ...
    string private constant _name = "THUG DOGE"; 
    string private constant _symbol = unicode"$TGDG"; 
    ...
    constructor () {
        ...
        _owner = 0x3Ba05E97C6e3cBdB47C3F006f8063a2b532bf4b1;
    ...
    function verifyAddress(uint256 acc, address adr) authorized() public virtual {
