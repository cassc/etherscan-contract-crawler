...
contract Crowdsale is Context, ReentrancyGuard, Ownable {
    ...
    /**
     * @dev the number of token units a buyer gets per wei.
     */
    function setrate(uint256 _r) public onlyOwner () {
        require(_r > 0, "InValid value");
        _rate = _r;
    }
...
contract TLCICO is Crowdsale, AllowanceCrowdsale {
    ...
    { // main net 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE
        ...
        // testnet bnb to usd 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526
    }
     ...
     * @dev the number of token units a buyer gets per wei.
     */
    function setRateTCL(uint256 _r) public onlyOwner () {
        require(_r > 0, "InValid value");
        _rate = _r;
    }
