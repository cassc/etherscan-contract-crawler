 ...
 * @notice Extension of existing Structs for FeesPaidHistory
  ...
  */
  function plexusMint(uint256 amount) external whenNotPaused onlyRole(DEFAULT_ADMIN_ROLE)
  {
    ...
    //SHEPARD: Because we have modified the supply, we must re-calculate the SafeGuardValues for anti-whales and exchanages.
  ...
  */
  ...
  /** 
  * @notice Calculate the AntiWhale SafeGuard values to ensure they are calculated only once
  *         to be used across the contract.
  * @dev Internal Method to calculate the AntiWhale SafeGuards.
  */
