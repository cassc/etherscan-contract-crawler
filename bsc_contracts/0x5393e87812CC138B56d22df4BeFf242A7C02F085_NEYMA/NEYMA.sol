...
contract NEYMA is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "NEYMA";
    string constant _symbol = "NEYMA";
    ...
    address public devFeeReceiver = 0x3F8B673496d351AD06C35db0a69d23A6A1B3dF9a;
    address public buybackFeeReceiver = 0x3F8B673496d351AD06C35db0a69d23A6A1B3dF9a;
