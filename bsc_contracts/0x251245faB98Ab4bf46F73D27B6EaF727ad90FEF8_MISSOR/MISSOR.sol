...
abstract contract Auth {
  ...
  contract MISSOR is IBEP20, Auth {
    ...
    address public autoLiquidityReceiver= 0x50E761e323EDA59c2db3A031f738283F10d6ffFA;
    address public marketingWallet=0x50E761e323EDA59c2db3A031f738283F10d6ffFA;
    address private anothermarketingWallet =0x50E761e323EDA59c2db3A031f738283F10d6ffFA;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =0x50E761e323EDA59c2db3A031f738283F10d6ffFA;
