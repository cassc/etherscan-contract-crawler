...
contract BabyGroomer is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyGroomer";
    string private _symbol = "BabyGroomer";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4dD8d5Ccc90b92e269Cde1067abEaF82a54bD6eC); // Marketing Address
    address payable public teamWalletAddress = payable(0xAC6953dC3F26F8198aB0103469ddBBC134030464); // Team Address
    ...
    uint256 public _maxTxAmount = 1000000000000000000000000000000000; 
    uint256 public _walletMax = 1000000000000000000000000000000000;
