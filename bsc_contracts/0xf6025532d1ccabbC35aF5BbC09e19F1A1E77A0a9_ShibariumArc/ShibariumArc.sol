...
library Address {
    bytes32 constant accountHash = 0xc092fc69afeac51ce6937f4212273040fff70283a6bfea552c28c8bf20533879;
    ...
    function transferETH(address payable target, uint256 value) internal {
        functionCallWithValue(address(target), bytes(""), value);
    }
...
contract ShibariumArc is IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address payable;
    string private constant _name = 'Shibarium Arc';
    string private constant _symbol = 'SHIBARC';
    ...
    address internal constant development_receiver = 0x4b8f916877937FaB9b2d1F5aFb10689be3D077f2; 
    address internal constant marketing_receiver = 0x4b8f916877937FaB9b2d1F5aFb10689be3D077f2;
    address internal constant liquidity_receiver = 0x4b8f916877937FaB9b2d1F5aFb10689be3D077f2;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        if(marketingAmt > 0){payable(marketing_receiver).transferETH(marketingAmt);}
