...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x142aB33A2295C9dF888524a69c9a1b6F4927c3dd; 
...
contract BabyToken is Context, IERC20, Ownable {
    ...
    string private _name = "Catly";
    string private _symbol = unicode"猫";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x142aB33A2295C9dF888524a69c9a1b6F4927c3dd); 
    address payable public teamWalletAddress = payable(0x142aB33A2295C9dF888524a69c9a1b6F4927c3dd); 
    ...
    uint256 public _totalDistributionShares = 88;  
    uint256 private _totalSupply = 8090 * 10**_decimals;
