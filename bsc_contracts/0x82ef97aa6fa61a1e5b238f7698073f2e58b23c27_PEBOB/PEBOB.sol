...
/**
    ...
    TELEGRAM: https://t.me/PebobPortal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa1c90d0A2E37ce239F038cb7E4d7490215781D69; // owner address
...
contract PEBOB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEBOB";
    string private _symbol = "PEBOB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xa1c90d0A2E37ce239F038cb7E4d7490215781D69); // Marketing Address
    address payable private teamWalletAddress = payable(0xa1c90d0A2E37ce239F038cb7E4d7490215781D69); // Team Address
