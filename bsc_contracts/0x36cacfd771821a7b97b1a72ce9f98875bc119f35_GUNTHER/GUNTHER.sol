...
Gunther Inu - based on TV Show Series Kick Buttowski.Also a community hyped project launched in Binance Smart Chain with the goal and aim to build a strong and solid community.
We also aim to launch a utility that will benefit all investors and believers. 

Tokenomics: 9/9
Marketing - 5%
Auto Liquditiy - 3%
Dextool and Listing update - 1%

https://t.me/guntherbscofficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x27E1DD5cc373ef71dCDd82F43b1be34F312A77b2; // owner address
...
contract GUNTHER is Context, IERC20, Ownable {
    ...
    string private _name = "GUNTHER INU";
    string private _symbol = "$GUNTHER";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x27E1DD5cc373ef71dCDd82F43b1be34F312A77b2); // Marketing Address
    address payable private teamWalletAddress = payable(0x27E1DD5cc373ef71dCDd82F43b1be34F312A77b2); // Team Address
