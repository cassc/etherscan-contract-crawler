...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4d0b8b8abEE6111A482712b4EA0ccAc52239d386;
...
contract FidoAI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8632D37be78847aDBAfb021DB41DE59B7CED392b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 777777777 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FidoAI";
    ...
    uint256 public _maxTxAmount = 77777777 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 77777777 * 10**18;
