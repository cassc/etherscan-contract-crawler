...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEa18e1A89724243380313ac5D12294CD3639AC84; // owner address
...
contract ShinamaruInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"ShinamaruInu";
    string private _symbol = unicode"SHINA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEa18e1A89724243380313ac5D12294CD3639AC84); // Marketing Address
    address payable public teamWalletAddress = payable(0xEa18e1A89724243380313ac5D12294CD3639AC84); // Team Address
