...
contract Satoshi is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "SATOSHI14";
    ...
    address payable public DevWallet = payable(0x772045d4dB02C7E586799586317369B319405f8a);
    address payable public MarketingWallet = payable(0x8962B98938F18d12629d489749C5A5e003d91375);
