...
contract CUBINU  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cub Inu"; 
    ...
    Tax public buyTax = Tax(6,0,1);
    Tax public sellTax = Tax(9,0,6);
    
    address public treasuryWallet = 0x6a55EBf342834F52c0456eA8D521E6DfaafeC176;
    address public devWallet = 0x6a55EBf342834F52c0456eA8D521E6DfaafeC176;
