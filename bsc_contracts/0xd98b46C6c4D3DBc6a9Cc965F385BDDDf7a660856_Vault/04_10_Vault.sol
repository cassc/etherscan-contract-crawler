...
contract Vault is ReentrancyGuard, IVault {
    ...
    uint256 public constant MAX_FUNDING_RATE_FACTOR = 10000000; // 1%
    ...
    function setFundingRate(
        ...
        _onlyGov();
        // remove MIN_FUNDING_RATE_INTERVAL check to enable us to charge very accurate fuding rate.
