...
// game developer deploys contract
contract sheraclaim {
    // game developer's account
    address public owner = 0xd645d3902a446B73Fb705Aff4D177a89B9c6A309;

    // address of the token contract
    address public tokenContract = 0xe2C5fCF777A2B860921116B275951A50e8135EEb;
    ...
    function claimPrize(
        ...
        if (signer == owner) {
            ...
            IERC20(tokenContract).transfer(msg.sender, _amount * 10**9);
            return true;
        }
