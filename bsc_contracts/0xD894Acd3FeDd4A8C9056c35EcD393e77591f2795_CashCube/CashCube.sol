...
contract CashCube is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CashCube", "CC") {
        ...
        maxBuyAmount = totalSupply / 1; // 1% maxTransactionAmountTxn
        maxSellAmount = totalSupply / 1; // 1% maxTransactionAmountTxn
        ...
        marketingWallet = address(0xab2187118A684aeF133229867A24B801D2dfbe2f); // set as marketing wallet
