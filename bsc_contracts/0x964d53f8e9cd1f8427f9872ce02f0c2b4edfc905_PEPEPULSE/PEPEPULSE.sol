...
//Telegram : https://t.me/PepePulseAnn
//Twitter : https://twitter.com/PepePulseBNB
...
contract PEPEPULSE is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 25000000 * 10**_decimals;
    uint256 public maxBuyAmount = 25000000 * 10**_decimals;
    uint256 public maxWalletBalance = 25000000 * 10**_decimals;

    address private marketingAddress = 0xc21b74E4432f419CbbB6D03d183A2119CB5E89D4;
    address private devAddress = 0xc21b74E4432f419CbbB6D03d183A2119CB5E89D4;

    string private constant _name = "PEPE PULSE";
    string private constant _symbol = "PEPEPULSE";
    ...
    Taxes public taxes = Taxes(0,10,10,0);
    Taxes public sellTaxes = Taxes(0,10,10,0);
