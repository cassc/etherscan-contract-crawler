...
contract bsc is Context, IERC20, Ownable {
    ...
    string private _name = "Free2.0";
    string private _symbol = "Free2.0";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint private killblock = 1;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xcA3db42618489Ca3Ef152821f93f253f73E8a25b); // Marketing Address
    address payable private teamWalletAddress = payable(0xcA3db42618489Ca3Ef152821f93f253f73E8a25b); // Team Address
