...
contract Dodoinu is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x0555F4d1a1a5892460875Ed6C99bFf14aDE3cADD);
    address payable private _twdmkt = payable(0x0555F4d1a1a5892460875Ed6C99bFf14aDE3cADD);
    
    string private constant _name = "DoDo Inu";
