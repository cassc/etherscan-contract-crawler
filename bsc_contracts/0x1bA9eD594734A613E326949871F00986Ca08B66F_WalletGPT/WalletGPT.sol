...
/**
 * Website https://walletgpt.space/
 * Telegram https://t.me/walletgptofficial
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7D57f29d440d4CC47083cf9120BE0Ffb4B888888; // owner address
...
contract WalletGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WalletGPT";
    string private _symbol = "WGPT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8b8FF321e5D8282209FC76280EeB1dc4B0084157); // Marketing Address
    address payable public teamWalletAddress = payable(0x23B9ae6c3Ae74B5AB57D92e913940808bD278B49); // Team Address
    ...
    uint256 public _marketingShare = 41;
