...
contract AstroFloki is Context, IERC20, Ownable {
    ...
    string private _name = "Astro Floki";
    string private _symbol = "$Astro";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x10900bC2C4B56b5ca5304F97566b113D5A3Ecb11); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x10900bC2C4B56b5ca5304F97566b113D5A3Ecb11); // BuyBack Address
