...
/**
---------------------------------------------------------------------------------------------------
 Contract Developed by Renowned SAFU Dev in the space [Developed over 300+ contracts]: 
...
contract BSCBULL is ERC20, Ownable {
    ...
    BSCBULL_DividendTracker public dividendTracker;
    
    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x396E8510dC6CB6D852F341cc543Ea09842AA2CE7;
    ...
    Taxes public buyTaxes = Taxes(1, 3, 0);
    ...
    constructor() ERC20("BSCBULL", "BSCBULL") {
        dividendTracker = new BSCBULL_DividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        BSCBULL_DividendTracker newDividendTracker = BSCBULL_DividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BSCBULL: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value,"BSCBULL: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "BSCBULL: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "BSCBULL: Cannot update gasForProcessing to same value"
        );
...
contract BSCBULL_DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("BSCBULL_Dividen_Tracker", "BSCBULL_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "BSCBULL_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "BSCBULL_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "BSCBULL_Dividend_Tracker: Cannot update claimWait to same value"
        );
