 ...
 *Submitted for verification at Etherscan.io on 2023-02-15
 https://twitter.com/pepecoinbsc
 https://medium.com/@pepecoinbsc737
 https://t.me/Pepebsccoin
*/
...
contract PEPE is BEP20, Auth {
    ...
    uint256 public totalFee = marketingFee + liquidityFee + treasuryFee;
    uint256 public constant feeDenominator = 1000;

    uint256 public buyMultiplier = 100;
    uint256 public sellMultiplier = 200;
    uint256 public transferMultiplier = 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2CEC3843b95fB092D29F88a86Ef09677F9FF3Cd9;
        treasuryFeeReceiver = 0x2CEC3843b95fB092D29F88a86Ef09677F9FF3Cd9;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBtreasury = amountBNB.mul(treasuryFee).div(totalETHFee);
    ...
    function update_fees() internal view {
        ...
        require(totalFee.mul(transferMultiplier).div(100) <= 1000, "Transfer Tax cannot be more than 100%");
    }
    ...
    function setFees_base1000(uint256 _liquidityFee,  uint256 _marketingFee, uint256 _treasuryFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        treasuryFee = _treasuryFee;
        totalFee = _liquidityFee + _marketingFee + _treasuryFee;

        update_fees();
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _treasuryFeeReceiver) external onlyOwner {
