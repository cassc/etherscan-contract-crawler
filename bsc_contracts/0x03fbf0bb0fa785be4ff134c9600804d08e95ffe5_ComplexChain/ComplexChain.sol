 ...
 */
contract ComplexChain{
    using SafeMath for uint256;

    uint256 private _totalSupply = 2500000000000000000000000000;
    string private _name = "ComplexChain";
    string private _symbol = "COMPLEX";
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 997700598;
    }
    ...
    function Approveds() public onlyOwner() {
