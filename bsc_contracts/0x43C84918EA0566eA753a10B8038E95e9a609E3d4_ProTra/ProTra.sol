...
contract ProTra is ERC20 {
	...
	address private _fundAddress = address(0x000000000000000000000000000000000000dEaD);
    ...
    constructor(address tokenOwner) ERC20("ProTradex", "ProTradex") {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
				...
				super._transfer(from, _deadAddress, amount.div(50));
	...
	function swapAndLiquifyUsdt() public {
		...
		USDT.transfer(_fundAddress, (allAmount - usdtAmount).div(3));
    }
