...
abstract contract Ownable is Context {
    ...
    function unlockOwnership() public virtual {
        require(msg.sender == _previousOwner , "You don't have permission to unlock.");
...
contract MetAmazon is ERC20, Ownable {
    ...
    constructor () ERC20("MetAmazon", "AMZ") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x907B97dae4F7DAE3225dD42f56795066Ec4AA8fd;
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(marketingFeeOnBuy + marketingFeeOnSell + walletToWalletTransferFee <= maxFee, "Total Fees cannot exceed the maximum");
