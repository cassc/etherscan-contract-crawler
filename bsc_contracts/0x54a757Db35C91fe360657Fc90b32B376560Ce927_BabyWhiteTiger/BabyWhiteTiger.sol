...
// 🐯Baby White Tiger(BWT) 🐯 is a new cryptocurrency project based on the new BSC Trending Meme Token "Tiger King Token". 
// Baby White Tiger  aims to capture the excitement and interest generated by the series and use it to create a decentralized community around wildlife

// Tokenonomics:

// - $BWT is an Meme Token Built on the BSC blockchain.
// - Total supply: 100,000,000,000 $BWT .
// - Token distribution: Tax will be used for ecosystem development + marketing.

// https://t.me/Baby_WhiteTigerBSC
...
contract BabyWhiteTiger is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x909EA66c963aD64e760e6c0375A236A5cef18bDb);

    string public _name = "BABY WHITE TIGER";
    string public _symbol = "BWT";
