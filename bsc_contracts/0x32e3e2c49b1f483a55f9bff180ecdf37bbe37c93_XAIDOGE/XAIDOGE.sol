...
contract XAIDOGE is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xd395D4465Ba26621691f1F1C9e35eDb396edC291);

    string public _name = "XAI DOGE";
    string public _symbol = "XDOGE";
