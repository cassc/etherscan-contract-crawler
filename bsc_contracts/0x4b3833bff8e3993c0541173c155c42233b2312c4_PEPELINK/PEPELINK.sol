...
Twitter: https://twitter.com/pepelink_token
Website: https://pepelink.net/
...
contract PEPELINK is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet =
        payable(0x1482de907665dB39a0c094735F271587CcB69e4d);
    address payable public safuWallet =
        payable(0x87742167573BDBeCB6E02A9dF2125c0d11BB9298);
    ...
    //Supply Definition.
    uint256 private _tTotal = 420_000_000_000_000_000 ether;
    uint256 private _tFeeTotal;
    //Token Definition.
    string public constant name = "PEPELINK TOKEN";
    string public constant symbol = "PLINK";
    ...
    constructor() {
        ...
        if (block.chainid == 56) {
            ...
            _isExcludedFromFee[0x7d60f101a485D97AFBa960d2B4CaA146F3f858B1] = true;//PinkSale Lock
