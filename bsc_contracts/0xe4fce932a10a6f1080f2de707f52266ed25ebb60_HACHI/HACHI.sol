...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBb0bb157F9d1b180dfe0cD067dc8202359899949; 
...
contract HACHI is Context, IERC20, Ownable {
    ...
    string private _name = "Hachi";
    string private _symbol = "HACHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBb0bb157F9d1b180dfe0cD067dc8202359899949); 
    address payable public teamWalletAddress = payable(0xBb0bb157F9d1b180dfe0cD067dc8202359899949); 
