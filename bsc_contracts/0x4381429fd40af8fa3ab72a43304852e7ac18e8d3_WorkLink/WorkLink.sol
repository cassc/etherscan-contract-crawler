...
// Work Link is the future of WEB3 with DeFi infrastructure

   //https://t.me/Worklink
   //https://worklink-docs.gitbook.io/work-link-documentations/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc3152675648d13E33385A6f70C0073Ac18c8779C;
...
contract WorkLink is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Rnd = payable(0xc3152675648d13E33385A6f70C0073Ac18c8779C);
    ...
    */
    ...
    string private _name = "Work Link"; 
    string private _symbol = "WLINK";  
    ...
    // This contract cant set fee untill 25%
    ...
    */
    ...
    constructor () {
        ...
        _isExcludedFromFee[Wallet_Rnd] = true;
    ...
    */
    ...
    // Update Rnd wallet
    function Wallet_Update_Rnd(address payable wallet) public onlyOwner() {
        Wallet_Rnd = wallet;
        _isExcludedFromFee[Wallet_Rnd] = true;
    }
    ...
    */
    ...
    One wallet is used for ALL fees. This includes liquidity, marketing, Rnd costs etc.
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        sendToWallet(Wallet_Rnd,contractBNB);
    }
    ...
    */
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        (uint256 tTransferAmount, uint256 tRnd) = _getValues(tAmount);
        _tOwned[sender] = _tOwned[sender].sub(tAmount);
        _tOwned[recipient] = _tOwned[recipient].add(tTransferAmount);
        _tOwned[address(this)] = _tOwned[address(this)].add(tRnd);   
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 tRnd = tAmount*_TotalFee/100;
        uint256 tTransferAmount = tAmount.sub(tRnd);
        return (tTransferAmount, tRnd);
    }
