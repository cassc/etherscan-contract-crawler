...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 10 ** IERC20(DOGEAddress).decimals() / 10**10;
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0xcc780503E290274CFa8Da085528067E259DF58f0), // glc 
        "LuckCoin",
        "LUCK",
        9,
        88888,
        address(0x9cAc31E856BF1aE29817E1b6d231170B9F862bEE),
        address(0x9cAc31E856BF1aE29817E1b6d231170B9F862bEE)
    ){
    }
}