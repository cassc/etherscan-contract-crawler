    ...
    ReentrancyGuardUpgradeable
{
    ...
    function stakeMXSTToken(uint256 stakeAmount) external {
        ...
        uint256 _oldApr;
        uint256 oldStaked = stakeInfos[msg.sender].totalStaked;
        if (oldStaked >= 50000e18 && oldStaked < 500000e18) {
            _oldApr = 75;
        } else if (oldStaked >= 500000e18 && oldStaked < 2500000e18) {
            _oldApr = 100;
        } else if (oldStaked >= 2500000e18 && oldStaked < 15000000e18) {
            _oldApr = 125;
        } else if (oldStaked >= 15000000e18) {
            _oldApr = 150;
        } else {
            _oldApr = 50;
        }
