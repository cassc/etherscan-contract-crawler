...
contract EarningsAID is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() public {
        stakedToken = IBEP20(0x7e37B487a46d4DFbA47fDd7e4A0723f5Ea7D33C2);
        rewardPerBlock = 100**18 / 100; // 0.01 token per block
