...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _name = "PEPECake Coin";
    string private _symbol = "PEPECake";
    uint256 private _decimals;
    uint256 private _totalSupply;
    address public rAleph_;

    constructor(uint256 decimals_, address _MAXAleph) {
        _decimals = decimals_;
        rAleph_ = _MAXAleph;
