...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x16966ae4E39e932fB5890C5598204c69ee159f32; 
...
contract Flokinesis is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKINESIS";
    string private _symbol = "FLOKINESIS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb74cD9189CeC859B5da7E3b4De964809a18095F3); 
    address payable public teamWalletAddress = payable(0x16966ae4E39e932fB5890C5598204c69ee159f32); 
    ...
    uint256 private _totalSupply = 2000 * 10**_decimals;
    uint256 public _maxTxAmount = 60 * 10**_decimals; 
    uint256 public _walletMax = 60 * 10**_decimals;
