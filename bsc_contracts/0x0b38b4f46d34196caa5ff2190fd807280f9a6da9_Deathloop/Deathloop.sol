...
contract Deathloop is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Deathloop";
    string constant _symbol = "$LOOP";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x327d3661cf19988AbB55BeCeD235C17af4848969;
