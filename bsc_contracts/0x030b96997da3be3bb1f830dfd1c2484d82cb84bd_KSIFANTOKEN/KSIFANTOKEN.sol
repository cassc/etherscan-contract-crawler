...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDd7A011C93e2AB22a8c96910F3771e3fD40f50b0; // owner address
...
contract KSIFANTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KSI FAN TOKEN";
    string private _symbol = "KFT"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2CDbbf044122034cC024ac0aEb599d1E02C28970); // Marketing Address
    address payable public teamWalletAddress = payable(0x5643cD6C9c84B39969005A3516ee864307354E7C); // Team Address
