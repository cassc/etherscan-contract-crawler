...
contract DDSCADOGS is Ownable {
    ...
    IERC20 public token = IERC20(0x198271b868daE875bFea6e6E4045cDdA5d6B9829);

    uint256 public tokenPerBlock = 70000000000000000;
    uint256 public maxEmissionRate = 280000000000000000;
    uint256 public emissionStartBlock = 22686700;
    uint256 public emissionEndBlock = type(uint256).max;
    address public masterchef = 0x78205CE1a7e714CAE95a32e65B6dA7b2dA8D8A10;
    bool public isUnderATL = false;
    bool public underATLemissions = false;
    // Dynamic emissions
    uint256 public topPriceInCents    = 12500;  // 8$
    uint256 public bottomPriceInCents = 800;  // 1$
