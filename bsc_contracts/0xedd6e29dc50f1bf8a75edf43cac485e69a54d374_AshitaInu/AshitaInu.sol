...
/* Token contract */
contract AshitaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xdDB2F36C9057D519423E14a0393731861a3ea4A5;
    ...
    // Name and symbol
    string constant _name = "Ashita Inu";
    string constant _symbol = "ASHITA";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x73c68EaB4E357B14C37728e4f6e0824B9154d8A5;
