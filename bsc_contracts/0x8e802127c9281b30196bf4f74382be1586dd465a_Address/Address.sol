...
contract RECOVERY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB RECOVERY FUND";
    string private _symbol = "RECOVERY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc25B8E362552c1d1cFA7cd6D3F2779055D1e77Fe); // Marketing Address
    address payable public teamWalletAddress = payable(0xc25B8E362552c1d1cFA7cd6D3F2779055D1e77Fe); // Team Address
