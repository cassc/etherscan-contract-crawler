...
contract FlokiDragon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlokiDragon";
    ...
    uint256 private _totalSupply = 3000 * 10**6 * 10**9;
    ...
    function changeWhitelistFlag(bool _value) external onlyOwner{
        whiteListFlag = _value;
    }
