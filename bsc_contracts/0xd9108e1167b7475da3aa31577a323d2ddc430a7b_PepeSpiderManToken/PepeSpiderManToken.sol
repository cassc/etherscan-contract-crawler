...
// Pepe Snow - BSC Reward Token 

// Telegram Group: https://t.me/PepeSpiderManBSC     * 10/10 | Rewards
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); // Binance-Peg Ethereum Token
...
contract PepeSpiderManToken is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x8f771eb08122ef7A4265445b9810C152649248Ac;

    string constant _name = "Spider Pepe Token";
    string constant _symbol = "SPIDERPEPE";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Blacklist
        if(blacklistMode){
            require(!isBlacklisted[sender] && !isBlacklisted[recipient],"You're Blacklisted");    
        }
        ...
        if (sender == pair &&
            ...
            require(cooldownTimer[recipient] < block.timestamp,"Please wait for 1 min between two buys");
