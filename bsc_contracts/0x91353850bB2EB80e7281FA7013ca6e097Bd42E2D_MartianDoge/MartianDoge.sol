...
/**
https://t.me/MartianDogePortal
https://www.martiandog.net/
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81D60c2de0f405Cb9FAa8B207181c26bf8658384; //
...
contract MartianDoge is Context, IERC20, Ownable {   //
    ...
    uint256 public _maxTxAmount = _tTotal * 30 / 100; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5000000000000000 * 10**9; //
    string private constant _name = "Martian Doge"; // 
    string private constant _symbol = "$MAD"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3; //
    uint256 public _liquidityFee = 2; //
    address payable public  _marketingWallet = payable(0x81D60c2de0f405Cb9FAa8B207181c26bf8658384); //
