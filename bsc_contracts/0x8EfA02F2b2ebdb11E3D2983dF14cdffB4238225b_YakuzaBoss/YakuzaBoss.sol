...
什么是邪惡黨老大？
Yakuza Boss一种独特的税收公用代币，它可以使代币持有人分享销售税的奖励。

谁支付特赋就成为新的Yakuza Boss，并收取60％的销售税。 特赋很简单……只要购买100,000 $BOSS代币就可以成为下一位Yakuza Boss。
...
contract YakuzaBoss is IERC20, Ownable {
