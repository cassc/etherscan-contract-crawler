...
Welcome to Trump Forever!
Donald Trump has been indicted and is scheduled to be arrested.  This is the height of injustice!  Let us support the best president the USA has ever had by celebrating everything that he is with his own cryptocurrency.  Based and experienced team!  Locked LP. Ownership renounced!  100% SAFU!

Website: https://trumpforeverBSC.com
Twitter: https://twitter.com/trumpforeverBSC
TG: https://t.me/trumpforeverBSC
...
contract BabyCryptoGPT is Context, IERC20, Ownable {
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            treasury: 1, // treasury fee in %
            lp: 1, // lp rate in %
            toSwap: 2 // treasury + dev + lp
        });
