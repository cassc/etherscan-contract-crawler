...
contract BuildCardStaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [100, 0, 0, 0, 0];
    }
