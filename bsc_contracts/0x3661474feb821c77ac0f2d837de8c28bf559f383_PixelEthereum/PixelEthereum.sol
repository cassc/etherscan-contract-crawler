...
13% $ETH REWARDS 300,000 $PIXETH Total Supply
...
contract PixelEthereum is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Pixel Ethereum";
    string constant _symbol = "PIXETH";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 300000 * 10**_decimals;
    ...
    uint256 public swapThreshold = _totalSupply * 120 / 10000;
    bool inSwap;
