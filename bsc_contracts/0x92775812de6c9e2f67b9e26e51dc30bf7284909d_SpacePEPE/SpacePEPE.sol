...
contract SpacePEPE is Context, IERC20, Ownable {
    ...
    string private _name = "SpacePEPE";
    string private _symbol = "SpacePEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC99001eF9B43Ae28Be35a6D162A7e29CF1799DbE); // Marketing Address
    address payable public teamWalletAddress = payable(0x6e7D87DD8eEeF60C39B91cfA36fe1b1E62CBEa87); // Team Address
    ...
    uint256 public _maxTxAmount = 800000 * 10**6 * 10**_decimals; 
    uint256 public _walletMax = 800000 * 10**6 * 10**_decimals;
