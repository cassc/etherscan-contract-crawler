...
// https://t.me/ContractInuPortal
// https://contractinu.xyz
// https://twitter.com/ContractInu
...
contract ContractInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x643704AF82D082692a40f51D92f51F84a4514152); 
    address payable public Wallet_Development = payable(0xE656aFC286a581be96c5C40C484f4B8bFAe513af);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Wallet_Liquidity = payable(0x0518312ab6b775ad911486131F798AFf099bCE1C); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "Contract Inu"; 
    ...
    uint256 public Percent_Development = 30;
    ...
    constructor () {
        ...
        _owner = 0x0518312ab6b775ad911486131F798AFf099bCE1C;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_Development / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_Liquidity + Percent_Marketing + Percent_Development);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Development * 100 / (Percent_Liquidity + Percent_Marketing + Percent_Development);
            ...
            sendToWallet(Wallet_Development, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_Development, removeRandom);
