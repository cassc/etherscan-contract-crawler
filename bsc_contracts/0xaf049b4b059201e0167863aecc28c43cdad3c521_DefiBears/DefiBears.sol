...
/*                                                                                                                                                                          
welcome to DefiBears
https://linktr.ee/DefiBears
*/
...
abstract contract ReentrancyGuard {
    ...
    contract DefiBears is BEP20, Auth, ReentrancyGuard {

    constructor () Auth(msg.sender) {
    _balances[msg.sender] = _totalSupply;
    isNoFee[msg.sender] = true;
    }
    ...
    string constant _name = "DefiBears";
    string constant _symbol = "$DFB";
    ...
    address public FeeReceiver = 0x941b773872F333c494717731DE50BdE84f41Df79;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(MaxWallet){
            if(!isPair[recipient]&&!authorizations[recipient]&&!isNoFee[recipient]&&!isWhitelist[recipient])
        ...
        _basicTransfer(sender,FeeReceiver,amount);
            ...
            if (isNoFee[recipient]||isNoFee[sender])
            {
    ...
    function setNoFeeContracts(address _NoFee, bool yes) external authorized {
        isNoFee[_NoFee] = yes;
        isWhitelist[_NoFee] = yes;
    }

    function setWhitelistContracts(address _router, bool yes) external authorized {
        isWhitelist[_router] = yes;
    }
	...
	function recoverBEP20(BEP20 BEP20Token) public onlyOwner {
