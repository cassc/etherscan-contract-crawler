...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7B9b25583E46a3e1c218834399382b64f6F7905C;
...
contract SHIBRINA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibrina Inu";
    string private _symbol = "$SHIBRINA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7B9b25583E46a3e1c218834399382b64f6F7905C);
    address payable public teamWalletAddress = payable(0x7B9b25583E46a3e1c218834399382b64f6F7905C);
