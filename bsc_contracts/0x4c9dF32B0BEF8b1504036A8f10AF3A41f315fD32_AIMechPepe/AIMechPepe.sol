...
contract AIMechPepe is ERC20, Ownable {
    ...
    constructor(
        ...
        address owner,
        address mintToAddr
    ) ERC20('AI MechPepe', 'AIMP') {
        require(
            feeAccount != address(0),
            'AI MechPepe: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'AI MechPepe: incorrect fee percent');
        require(owner != address(0), 'AI MechPepe: incorrect owner address');
        require(mintToAddr != address(0), 'AI MechPepe: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'AI MechPepe: transfer from the zero address');
        require(recipient != address(0), 'AI MechPepe: transfer to the zero address');
