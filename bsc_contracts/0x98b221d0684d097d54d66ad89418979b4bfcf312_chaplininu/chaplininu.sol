...
Twitter: https://twitter.com/chaplin_inuvip
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x10Bf70D9d9A0664971f74B05957F007D0BCeD926;
...
contract chaplininu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x40005EAFe9936Fc907Fb233300c99fae52690556);
    address payable public teamWalletAddress = payable(0x10Bf70D9d9A0664971f74B05957F007D0BCeD926);
