...
//Website:https://huskyprotocol.online/
//Telegram:https://t.me/HuskyProtocolBsc

// SPDX-License-Identifier: MIT

//Twitter:https://twitter.com/HuskyProtocol
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x88a83FbcA9FE83Bb4b73E2E39516d7dF08C75a63;
...
contract HuskyProtocol is Context, IERC20, Ownable {
    ...
    string private constant _name = "HUSKY PROTOCOL"; // 
    string private constant _symbol = "HUSKY"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x88a83FbcA9FE83Bb4b73E2E39516d7dF08C75a63);
