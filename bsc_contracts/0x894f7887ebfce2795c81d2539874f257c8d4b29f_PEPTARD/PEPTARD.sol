...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x46BF4EB7DB014898100EeBf9B47eb1390c7fB9A9;
...
contract PEPTARD is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x393251Ef8f9846691EdCdd1181e163c46d9e9Ae8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PEPTARD";
    string private _symbol = "PTARD";
