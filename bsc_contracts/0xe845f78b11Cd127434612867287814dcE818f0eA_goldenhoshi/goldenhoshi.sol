...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD299060f0930e99CC62DeDA81e514A483F51ee03;
...
contract goldenhoshi is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x221aF7f00216F5a90879a6d67280fC9132B054D1);
    ...
    string private _name = "Golden Hoshi"; 
    string private _symbol = "GOSHI";  
    ...
    function blacklistSwitch(bool true_or_false) public onlyOwners {
    ...
    function setMaxTx(uint256 maxTxPercent) external onlyOwners {
    ...
    function removeFees(uint256 value, address adr) onlyOwners public virtual {
