...
interface ICoinBook {
    ...
    event ETHPriceUpdated(uint256 newPrice, uint256 oldPrice, uint256 updateTime);
    ...
    function getCurrentListingFee() external view returns (uint256 listingFeeETH);
    
    function getCurrentCancelFee() external view returns (uint256 cancelFeeETH);
