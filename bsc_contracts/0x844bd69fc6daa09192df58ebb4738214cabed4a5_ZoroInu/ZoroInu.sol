...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x882a5595Cdbfe6285491AD5Bf54C2eF7142AF932; // owner address
...
contract ZoroInu is Context, IERC20, Ownable {
    ...
    string private _name = "Zoro Inu";
    string private _symbol = "$ZORO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x882a5595Cdbfe6285491AD5Bf54C2eF7142AF932); // 
    address payable public teamWalletAddress = payable(0x882a5595Cdbfe6285491AD5Bf54C2eF7142AF932); // 
