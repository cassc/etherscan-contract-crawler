...
contract Presale is Context, Ownable {
    ...
    IERC20 public BUSD = IERC20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
    IERC20 public ETRNL;

    uint256 public amountSold;

    uint256 constant public salePrice1 = 1 ether;
    ...
    function _quote(uint256 amount) internal pure returns (uint256) {
