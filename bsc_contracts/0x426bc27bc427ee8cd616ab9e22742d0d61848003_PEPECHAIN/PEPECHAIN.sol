...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf5A01077981D92128c3F90eaF045336FCD325942; //
...
contract PEPECHAIN is Context, IERC20, Ownable {   //
    ...
    string private constant _symbol = "PEPE CHAIN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9; //
    uint256 public _liquidityFee = 0; //
    address payable public  _marketingWallet = payable(0xf5A01077981D92128c3F90eaF045336FCD325942); //
