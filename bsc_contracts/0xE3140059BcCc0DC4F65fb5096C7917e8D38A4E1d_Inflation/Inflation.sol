...
/**
Telegram: https://t.me/InflationChain
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x781b6351ba9D2E6572303831417144b9e3BcEB4E; // owner address
...
contract Inflation is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Inflation Network";
    string private _symbol = "INFLATION";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x781b6351ba9D2E6572303831417144b9e3BcEB4E); // Marketing Address
    address payable public teamWalletAddress = payable(0x781b6351ba9D2E6572303831417144b9e3BcEB4E); // Team Address
    ...
    uint256 public _teamShare = 5; // original 7

    uint256 public _totalTaxIfBuying = 7;  // original 7
    uint256 public _totalTaxIfSelling = 7;  // original 7
