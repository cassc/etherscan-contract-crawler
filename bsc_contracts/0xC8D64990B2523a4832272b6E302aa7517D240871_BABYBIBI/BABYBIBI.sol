...
abstract contract Project {
    address public marketingWallet = 0x0CA6EA51640dd7bdfE5eaadAEe5100D17DD81cbF;
    address public treasuryWallet = 0x0CA6EA51640dd7bdfE5eaadAEe5100D17DD81cbF;

    string constant _name = "Baby BIBI";
    string constant _symbol = "BABYBIBI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 75) / 10000; // (_totalSupply * 1) / 1000 [this equals 1%]
    ...
    uint256 public swapTreasuryFee    = 4;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xFE8bF5B8F5e4eb5f9BC2be16303f7dAB8CF56aA8);
...
contract BABYBIBI is Project, IBEP20, Auth {
    using SafeMath for uint256;
