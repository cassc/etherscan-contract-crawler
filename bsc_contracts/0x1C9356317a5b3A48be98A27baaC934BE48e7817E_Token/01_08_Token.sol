...
contract Token is ERC20, Ownable {
    ...
    function setFees(uint256 _sellFee, uint256 _excludedFee) public onlyOwner {
        require(_sellFee <= feeLimit, "ERC20: fee value higher than fee limit");
        sellFee = _sellFee;
        excludedFee = _excludedFee;
    }
