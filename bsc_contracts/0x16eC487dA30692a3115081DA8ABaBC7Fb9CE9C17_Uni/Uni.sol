...
contract Uni is Context, IERC20, Ownable {
    ...
    string private constant _name = "UNITED NATION INU"; // 
    string private constant _symbol = "UNI"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xe52FE05BE1eE0B5e95E692A0C44280b6Efb1C53B;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && to != uniswapV2Pair && !_isExcludedFromFee[from])
