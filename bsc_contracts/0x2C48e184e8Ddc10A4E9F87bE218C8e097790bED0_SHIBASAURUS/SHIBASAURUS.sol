...
// NAME: Shibasaurus Inu
// TICKER: SHIBASAURUS

// Bringing BSC back to the glorious age.

// TG: https://t.me/shibasaurusinu
...
contract SHIBASAURUS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 public maxWalletFee = 7;             // Transaction fee % that would be sent to a marketing or charity wallet (0-10)
    //change that
