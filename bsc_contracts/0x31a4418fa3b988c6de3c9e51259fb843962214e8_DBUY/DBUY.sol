...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3A0fBB11Fd335A68a1aef0f8dc87FBA12e858514;
...
contract DBUY is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0021E013d79883E053D643050d2A81647F519967;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Dont Buy";
    string private _symbol = "DBUY";
