...
contract MOONARCHNETWORK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Moonarch Network";
    string private constant _symbol = "MOONNET";
