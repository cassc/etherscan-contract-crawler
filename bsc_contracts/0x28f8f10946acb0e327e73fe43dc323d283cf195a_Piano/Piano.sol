...
contract Piano is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Piano";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x0E28F48a56207D08ef264e0111b524A94F2c12A6;  
        lotteryWallet = 0x8744Ca4D01101D45823AeCFC14E984A8B2D4BFfb;  
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newLotteryFee) external authorized {
        ...
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee).add(lotteryFee);
        require(totalFee <= 15);
        totalFeeIfSelling = totalFee.mul(sellMultiplier).div(15);
    }
