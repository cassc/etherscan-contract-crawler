...
/**
*/
// SAFEMOONHONGKONG - is the purrfect fusion of a Hongkong and Safemoon, now on the BSC! 
// this meme project is sure to bring a smile to your face while delivering utility to your portofolio. 
// Join the pack and be part of the $SFMHK revolution today!
// Submitted for Telegram: https://t.me/SafemoonHongkongPortal
...
contract  SFMHK  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Safemoon Hongkong";
    string private _symbol = "SFMHK";
