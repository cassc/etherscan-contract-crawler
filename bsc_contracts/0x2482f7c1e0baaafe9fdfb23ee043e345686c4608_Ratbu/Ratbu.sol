...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEd38930a102D0a05ba8E5C321195918E2f5aFb6D;
...
contract Ratbu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xBcBc3c1f5cdfB5542A8958B6bA275C1E9F430821;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "RatbuToken";
    string private _symbol = "Ratbu";
