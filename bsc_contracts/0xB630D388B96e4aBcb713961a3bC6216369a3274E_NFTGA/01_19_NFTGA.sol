    ...
    ERC721Burnable
{
    ...
    function createToken(string memory tokenURI1) public returns (uint256) {
        _tokenIds.increment();
     ...
     function createTokenBulk(string memory tokenURI1, address Tokown, uint  mintxtimes) public returns (uint[] memory) {       
        uint[] memory Tokens;
