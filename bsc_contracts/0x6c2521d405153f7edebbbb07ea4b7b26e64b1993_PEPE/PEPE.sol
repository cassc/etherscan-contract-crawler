...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private teamAddress = address(0xba191EaA6bA7231CC9AAFccc931b350A7F7E294F);
    ...
    uint256 public _invitorLength = 2;
    ...
    uint256 private _marketShare = 55;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount.mul(41).div(50));
        USDT.transferFrom(address(_tokenDistributor), teamAddress, fundAmount.mul(9).div(50));
    ...
    function setExcludedAddress(address addr) external onlyOwner {
        teamAddress= addr;
        _isExcludedFromFees[addr] = true;
    }
...
contract PEPE is AbsToken {
    constructor() AbsToken(
        ...
        address(0xa4c13f67D3b7D7B0FeEFcC0C625592f86F330afD),
        address(0xba191EaA6bA7231CC9AAFccc931b350A7F7E294F)
    ){
