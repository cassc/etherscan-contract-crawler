...
contract PN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3786477931503743abde716F67DBA041613Cb55b); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x3786477931503743abde716F67DBA041613Cb55b); // Development Address
    ...
    uint256 public _walletMax = 400000 * 10**6 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 0, "Max wallet should be less or euqal to 2% totalSupply");
