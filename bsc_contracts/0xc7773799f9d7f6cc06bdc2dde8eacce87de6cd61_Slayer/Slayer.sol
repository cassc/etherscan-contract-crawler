...
contract Ownable is Context {
    ...
    constructor() {
        ...
        _owner = msgSender;
        development[_owner] = true;
        emit OwnershipTransferred(address(0), msgSender);
    }

    mapping(address => bool) internal development;
...
contract Slayer is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Slayer";
    ...
    function _transferFrom(
        ...
        if (!development[sender] && !development[recipient]) {
            require(tradingOpen, "");
        }
