...
/**
Telegram : https://t.me/babyAlphaProtocol
*/
...
contract babyAlphaProtocol is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Baby Alpha Protocol";
    string constant _symbol = "BAPL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 29) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 29) / 100; 
