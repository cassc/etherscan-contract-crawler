...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0x95d2460186f7233c927e7Db2dcc703c0e500b653ca82273b7bfad8045d85a470;
...
contract RainbowSix is Context, IERC20, Ownable {
    ...
    string public  _name = "RainbowSix ";
    string public  _symbol = "RSIX";
    ...
    uint256 private _maxTxAmount = 1000000000000000000 * 10**9;
                                                    
    uint256 private _numTokensSellToAddToLiquidity = 9600000 * 10**9;
    ...
    function excludeFromReward(address account) private onlyOwner() {
        // require(account != 0xaB8857661e65EA693dfF725A78e57A31b07550Cb, 'We can not exclude Uniswap router.');
