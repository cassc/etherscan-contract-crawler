...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x00316940adfA30c3C2F312B14C713b59159e6712;
...
contract GhostCat is Context, IERC20, Ownable { 
    ...
    uint256 public _tTotal = 100**9 * 10**_decimals;
    string private constant _name = unicode"Ghost Cat"; 
    string private constant _symbol = unicode"$GHOSTCAT"; 
