...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 10000 * (10 ** 13);
...
contract SpaceMoonToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Space Moon Token";
    string constant _symbol = "SMT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 9000 * 10**6 * 10**_decimals;
