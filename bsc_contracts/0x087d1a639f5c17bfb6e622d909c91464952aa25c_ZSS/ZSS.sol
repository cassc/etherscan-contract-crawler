...
abstract contract AbcToken is ERC20, Ownable {
    ...
    uint256 private _buyRepoFee = 200;
    uint256 private _buyLPDividendFee = 150;
    uint256 private _sellBurnFee = 50;
    uint256 private _sellFundFee = 200;
    uint256 private _sellRepoFee = 200;
...
contract ZSS is AbcToken {
    constructor()
        AbcToken(
            ...
            "ZSS", //Symbol
            100000 * 10**18, //Supply
            address(0x5a8c4eAf500607165CB82b4A96f0A6769c858121), //FundAddress
            address(0x23308cc0F6569988e00c5EA77187F0D33D98d8Ae), //RepoAddress
            address(0xDB9eFc86ef77A614a61Ac361D55A0E744a8cA405) //LPAddress
        )
    {}
}