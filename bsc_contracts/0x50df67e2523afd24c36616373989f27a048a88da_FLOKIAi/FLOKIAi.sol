...
/**
Telegram: https://t.me/flokiaiofficiall
Twitter: https://twitter.com/flokiaimate
Website: http://flokiaimate.com/
-------------
Taxes: 10/10 %
*/
...
contract FLOKIAi is IBEP20, Auth {
    ...
    string constant private _name = "FLOKI Ai";
    string constant private _symbol = "FLKAI";
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setMaxTx(uint256 amountBuy) external authorized {
