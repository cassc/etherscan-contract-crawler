...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x64A779D326ca60c8d5CcFd19155202783E4a4C5D ; // owner address
...
contract Catinutoken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATINUTOKEN";
    string private _symbol = "CATINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64A779D326ca60c8d5CcFd19155202783E4a4C5D); // Marketing Address
    address payable public teamWalletAddress = payable(0x64A779D326ca60c8d5CcFd19155202783E4a4C5D); // Team Address
