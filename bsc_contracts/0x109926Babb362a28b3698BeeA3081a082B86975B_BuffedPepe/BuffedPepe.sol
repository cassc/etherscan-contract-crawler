...
contract BuffedPepe is IBEP20, Auth {
    ...
    address constant DEV = 0x967B2bfe899cf0F020ebDc302f60680CA4DF6f9E;

    string constant _name = "Buffed Pepe";
    string constant _symbol = "$BUFFEDPEPE";
    uint8 constant _decimals = 12;

    uint256 constant _totalSupply = 420000000000 * (10 ** _decimals);
