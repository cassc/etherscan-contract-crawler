...
contract DEXFACTORY_PRE_SALE is ERC20 {
    uint256 public tokenPrice = 0.00005 ether;
    uint256 public minPrice = 0.1 ether;
    uint256 public total_sale = 0;
    uint256 public hardcap = 50 ether;
    address public project_address = 0xf08Da222A1617d6665D4e117c3E6A726e9794C92;

    constructor() ERC20("DexFactory", "DEXF") {}

    function PreSale() public payable {
        require(total_sale <= hardcap && msg.value >= minPrice);
