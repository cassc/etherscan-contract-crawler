...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAD7Ca4B516284e06BA4697DFcC657BE4c9de49dD; // owner address
...
contract Braille is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Braille Day";
    string private _symbol = "$BSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAD7Ca4B516284e06BA4697DFcC657BE4c9de49dD); // Marketing Address
    address payable public TeamWalletAddress = payable(0xAD7Ca4B516284e06BA4697DFcC657BE4c9de49dD); // Team Address
    address payable public BurnWalletAddress = payable (0xAD7Ca4B516284e06BA4697DFcC657BE4c9de49dD) ; // Burn Address
    ...
    constructor () {
        ...
        isExcludedFromFee[BurnWalletAddress] = true;
        ...
        _totalDistributionShares = _liquidityShare.add(_marketingShare).add(_TeamShare).add(_sellBurnFee);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBBurn = amountReceived.sub(amountBNBMarketing);
        ...
        if(amountBNBMarketing > 0)
            transferToAddressETH(BurnWalletAddress, amountBNBBurn);     
    }
