...
contract BITDOG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xfBaabF98DA6b6fa67897EB572616e0DeE2567cb1); 
    address payable public Wallet_Dev = payable(0xfBaabF98DA6b6fa67897EB572616e0DeE2567cb1);
    ...
    string private constant _name = "BITDOG"; 
    ...
    constructor () {
        ...
        _owner = 0xfBaabF98DA6b6fa67897EB572616e0DeE2567cb1;
