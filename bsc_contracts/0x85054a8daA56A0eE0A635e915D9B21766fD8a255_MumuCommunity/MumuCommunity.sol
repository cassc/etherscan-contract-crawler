...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract MumuCommunity is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Mumu Community";
    string private _symbol = "MUMU";
    uint8 private _decimals =  9;

    address payable public marketingWalletAddress = payable(0x799F5158e28bC47fa721A6721356E7285cA2F159);
    address payable public devWalletAddress = payable(0x504639C0c94A7159B0455656C6e6ACAe83000e2c);
