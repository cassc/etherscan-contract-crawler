...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2b09E0a5172bBD73DB0F8E90F48f0Ab14929400e; // owner address
...
contract babyCAWCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby CAW CEO";
    string private _symbol = "$BCC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2b09E0a5172bBD73DB0F8E90F48f0Ab14929400e); // Marketing Address
    address payable public teamWalletAddress = payable(0x2b09E0a5172bBD73DB0F8E90F48f0Ab14929400e); // Team Address
