...
contract BassetHound is ERC20, Ownable {
    ...
    constructor() payable ERC20("Basset Hound", "BASH") {
        ...
        totalBuyFee         = liquidityFeeOnBuy + treasuryFeeOnBuy + rewardsFeeOnBuy + buybackFeeOnBuy + marketingFeeOnBuy;
        ...
        totalSellFee        = liquidityFeeOnSell + treasuryFeeOnSell + rewardsFeeOnSell + buybackFeeOnSell + marketingFeeOnSell;

        treasuryWallet = 0xC3c5A04C5D835212A77B3d2Cee2c0b0cF3A735a1;
        marketingWallet = 0x168Dd0e2742A4558E38AD2E48C0A364B00BF0390;
        ...
        _mint(owner(), 100_000_000_000_000_000 * (10 ** 9));
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _treasuryFeeOnBuy, uint256 _rewardsFeeOnBuy, uint256 _buybackFeeOnBuy, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        totalBuyFee = _liquidityFeeOnBuy + _treasuryFeeOnBuy + _rewardsFeeOnBuy + _buybackFeeOnBuy + _marketingFeeOnBuy;
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _treasuryFeeOnSell, uint256 _rewardsFeeOnSell, uint256 _buybackFeeOnSell, uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        totalSellFee = _liquidityFeeOnSell + _treasuryFeeOnSell + _rewardsFeeOnSell + _buybackFeeOnSell + _marketingFeeOnSell;
