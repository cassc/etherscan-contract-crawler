...
contract Idle_Treasure_Party is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Idle Treasure Party";
    string private constant _symbol = unicode"ITP";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**9 * 10**_decimals;

    address payable private DevWallet = payable(0xC3CBE3F4329F811E85920b9EdC064D965F17Cbb7);
    address payable private MarketingWallet = payable(0xA1260FdF72888c7A775dbc9412d4413F72F72Ec4);
