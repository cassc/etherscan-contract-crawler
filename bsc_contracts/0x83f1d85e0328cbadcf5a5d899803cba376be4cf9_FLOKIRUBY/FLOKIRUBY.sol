...
//   📱Website ::https://twitter.com/realflokiinu/status/1433022904095096838/
/*
...
contract FLOKIRUBY is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("FLOKI RUBY", "FLOKIRUBY") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKIRUBY";
    string private _symbol = "FLOKIRUBY";
