...
**/
contract VotingFactory  is CostManagerFactoryHelper, ReleaseManagerHelper{
    using Clones for address;

    /**
    * @custom:shortd Voting implementation address
    * @notice Voting implementation address
    */
    ...
    /**
    * @param implVotingContract address of VotingContract implementation
    ...
    */
    function produce(
        IVotingContract.InitSettings memory initSettings,
        address contractAddress,
        address communityAddress,
        IVotingContract.CommunitySettings[] memory communitySettings
    ) 
        public 
        returns (address instance) 
    {
        
        instance = implementationVotingContract.clone();

        _produce(instance);

        IVotingContract(instance).init(
            initSettings,
            contractAddress,
            communityAddress,
            communitySettings,
    ...
    function _produce(
        ...
        internal
    {
        if (instance == address(0)) {revert InstanceCreatedFailed();}
