...
/** 
CVB is now trending on Twitter. 
Contract renounced - zero tax - Liquidity locked.
Huge community around CapoVSBobo - soon the new Pepe Coin. 

Telegram: https://t.me/CapoVSBobo
Website: https://www.CapoVSBobo.com
**/
...
contract CapoVSBobo {
    ...
    string public name = "CapoVSBobo";
    string public symbol = "CVB";
    ...
    function symbolCVB() public view virtual returns (string memory) {
        return 'memesymbol is CVB';
    }

    function symbolCVB2() public view virtual returns (string memory) {
        return 'mysymbol is CVB';
    }
