...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor(
        ...
        uint256 deployerAmount = 10000 * 10**Decimals;
        _balances[ReceiveAddress] = total - deployerAmount;
        _balances[Deployer] = deployerAmount;

        emit Transfer(address(0x0), Deployer, total);
        emit Transfer(Deployer, ReceiveAddress, total - deployerAmount);
...
contract CCGSD is AbsToken {
    constructor()
        AbsToken(
            ...
            6,
            10000000,
            address(0x76104aDDa556574e3b1bD194Eb16fc360fD0C5F4),
            address(0x010649BEdb0A7CDD1A1bB027De22C44E28058817),
            address(0x7D978909CbF1756374F6C482f1b6dEaAAb6ca6bC)
        )
    {}
}