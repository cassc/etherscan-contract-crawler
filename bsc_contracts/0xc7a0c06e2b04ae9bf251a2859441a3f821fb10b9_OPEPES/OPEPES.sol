...
contract OPEPES is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OPEPES";
    string private _symbol = "OPEPES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB2c2b7c855102db4c5aC88fE76dA3bE2A326fEdd);
    address payable public teamWalletAddress = payable(0xB2c2b7c855102db4c5aC88fE76dA3bE2A326fEdd);
    address public immutable deadAddress = 0xB2c2b7c855102db4c5aC88fE76dA3bE2A326fEdd;
