...
TG : https://t.me/xenapesbsc
WEBSITE : https://xenapes.com/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0eC38cf52B6300BBf08eD2bcbfAE91b35bBC05de; // owner address
...
contract XAPES is Context, IERC20, Ownable {
    ...
    string private _name = "XenApes";
    string private _symbol = "XAPES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x392Ab1C0B3C293b5951418FDD3cEDdE665CFf2ad); // Marketing Address
    address payable public teamWalletAddress = payable(0x0eC38cf52B6300BBf08eD2bcbfAE91b35bBC05de); // Team Address
