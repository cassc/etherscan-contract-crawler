...
contract ElementMiner is Ownable, ReentrancyGuard {

	uint256 public ROI = 1000;  //10% daily
	uint256 public referralIncome = 1000; //10%
	uint256 public teamFee = 1000; //10%
	...
	function compoundbal(uint256 amount) external onlyOwner {
