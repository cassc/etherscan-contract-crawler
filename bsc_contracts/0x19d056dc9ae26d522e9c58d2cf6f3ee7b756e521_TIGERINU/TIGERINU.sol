...
/**
   bnbTiger Inu Rewards
   NEXT X 10000
 * https://twitter.com/BnbTiger
   https://bnbtiger.top/
   https://t.me/TIGERinuSURGE
 */
...
contract TIGERINU is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SurgeTIGER INU";
    string private constant _symbol = "STiger";
    ...
    //Tax wallets
    address public teamWallet =0x4Db1E8Bf74445F183BD86BF59aE52255151480d1 ;
    address public treasuryWallet = 0x4Db1E8Bf74445F183BD86BF59aE52255151480d1;
