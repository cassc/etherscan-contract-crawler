...
//SPDX-License-Identifier: MIT
        /**
            TG: https://t.me/InsurgentOfficial
            Website:
            Twitter:
        */
...
contract Ownable is Context {
    ...
    constructor() {
        _owner = 0x6695A8e0D1cE9878884F884B01103deF77821761;
...
contract insurgent is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    string private constant _symbol = "ISRG";
    ...
    // Total Supply
    uint256 public constant _totalSupply =1000000 * _DECMULTIPLIER;
    // balances
    mapping(address => uint256) public _balances;
    mapping(address => mapping(address => uint256)) internal _allowances;
    //Fees
    mapping(address => bool) public isFeeExempt;
    uint256 public sellMul = 84;
    uint256 public buyMul = 84;
    ...
    //Tax wallets
    address public teamWallet = 0x6695A8e0D1cE9878884F884B01103deF77821761;
    address public treasuryWallet = 0x6695A8e0D1cE9878884F884B01103deF77821761;
    // Tax Split
    uint256 public teamShare = 437;
    uint256 public treasuryShare = 437;
    uint256 public rewardShare = 125;
