...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 60 && newClaimWait <= 86_400, "claimWait must be updated to between 1 minute and 24 hours");
...
contract TrumpCoin is ERC20, Ownable {
    ...
    constructor() payable ERC20("TrumpCoin", "DTC") {

        rewardToken = 0x55d398326f99059fF775485246999027B3197955; // USDT main
        //rewardToken = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; // BUSD test
        burnFeeOnBuy        = 1;
        marketingFeeOnBuy    = 4;
        rewardsFeeOnBuy     = 5;
        ...
        marketingWallet = 0x22D636ea87b16d877162F96761b2234de4D90504;

        dividendTracker = new DividendTracker(47000000, rewardToken);
        ...
        _transferOwnership(0x1B2Dd43A2720779db7c91d80357AB388855f6c5c);

        _mint(owner(), 47000000000000 * (10**9));
    ...
    function setMinimumTokenBalanceForDividends(uint256 _newMinimumBalance) external onlyOwner {
