...
TG link: https://t.me/ElonMoon2022
...
/* Token contract */
contract ElonMoon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xC76035F7aE405e0de1C6c29CE73b622Fb3109Ca7;
    ...
    // Name and symbol
    string constant _name = "ElonMoon";
    string constant _symbol = "$EMO";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 10%
  ...
  // Sell fees
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC76035F7aE405e0de1C6c29CE73b622Fb3109Ca7;
