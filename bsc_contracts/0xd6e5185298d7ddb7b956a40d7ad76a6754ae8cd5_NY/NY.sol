...
contract NY is ERC20 {

    uint tokenTotalSupply = 413; // 413 token supply

    constructor() public ERC20("413NEWYEAR", "413NEWYEAR") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 413 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "413 NEW YEAR";
    string private _symbol = "413NY";
    ...
    uint256 public _maxTxAmount = 413 * 10**6 * 10**9;
