...
contract OldXRP is ERC20, Ownable {
    ...
    OldXRPDividendTracker public dividendTracker;
    ...
    constructor() ERC20("OLD XRP", "OGXRP") {
        marketingWallet = payable(0x3F44891e2c5636F62261E600b197A0aABb2248BE);
        devWallet = payable(0x6954935C240B3767735528569b0d088b0e8e91EB);
        ...
        dividendTracker = new OldXRPDividendTracker(
            payable(this),
            router,
...
contract OldXRPDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        OldXRPContract = OldXRP(mainContract);
    ...
    function _transfer(
        ...
        require(false, "OldXRP_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "OldXRP_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main OldXRP contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(OldXRPContract);

            uint256 prevBalance = OldXRPContract.balanceOf(address(this));
            ...
            {
                uint256 received = OldXRPContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    OldXRPContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
