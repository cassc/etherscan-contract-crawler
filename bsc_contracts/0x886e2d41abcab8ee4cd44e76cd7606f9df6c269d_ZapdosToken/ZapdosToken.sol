...
Telegram - https://t.me/zapdostoken                      

 ______     ______     ______   _____     ______     ______        ______   ______     __  __     ______     __   __    
/\___  \   /\  __ \   /\  == \ /\  __-.  /\  __ \   /\  ___\      /\__  _\ /\  __ \   /\ \/ /    /\  ___\   /\ "-.\ \   
\/_/  /__  \ \  __ \  \ \  _-/ \ \ \/\ \ \ \ \/\ \  \ \___  \     \/_/\ \/ \ \ \/\ \  \ \  _"-.  \ \  __\   \ \ \-.  \  
  /\_____\  \ \_\ \_\  \ \_\    \ \____-  \ \_____\  \/\_____\       \ \_\  \ \_____\  \ \_\ \_\  \ \_____\  \ \_\\"\_\ 
  \/_____/   \/_/\/_/   \/_/     \/____/   \/_____/   \/_____/        \/_/   \/_____/   \/_/\/_/   \/_____/   \/_/ \/_/ 
             
                                                                                                                        
Welcome to Zapdos Token
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN BABYAPTOS
    IBEP20  BABYAPTOS = IBEP20(0xe4c6dD06da4c0934d265d6CB6875E576485CF332);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BABYAPTOS.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(BABYAPTOS);
        ...
        uint256 amount = BABYAPTOS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BABYAPTOS.transfer(shareholder, amount);
...
/* Token contract */
contract ZapdosToken is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BABYAPTOS = 0xe4c6dD06da4c0934d265d6CB6875E576485CF332; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address CALL = 0xEFE713EeFbc89D117E6bdB0B1419a312DA56fa93;
    ...
    // Name and symbol
    string constant _name = "Zapdos";
    string constant _symbol = "ZAPDOS";
    ...
    uint256 public swapThreshold = _totalSupply * 125 / 10000; // 1.25% of supply
    ...
    function checkMaxWallet(address sender, address recipient, uint256 amount) internal view {
        if (!authorizations[sender] && recipient != owner && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver && recipient != CALL){
    ...
    function swapBack() internal swapping {
        ...
        (bool successDev, /* bytes memory data */) = payable(CALL).call{value: amountBNBDev, gas: 30000}(""); 
