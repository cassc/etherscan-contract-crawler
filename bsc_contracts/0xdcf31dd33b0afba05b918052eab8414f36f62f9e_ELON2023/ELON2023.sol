...
contract ELON2023 is IBEP20, Auth {
    ...
    string constant _name = "Elon 2023";
    string constant _symbol = unicode"ELON23";
    ...
    function BlacklistWallet() external onlyOwner{
    ...
    // Exclude bots
    function BlacklistWallet(address _address, bool _value) public onlyOwner{
