...
contract MinuCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Minu Coin";
    string private _symbol = "$MINU";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xC1228082ef6C72C2a1ed10D827B61f13d4Cc9BF7); 
    ...
    uint256 public _maxTxAmount = _totalSupply.div(3); 
