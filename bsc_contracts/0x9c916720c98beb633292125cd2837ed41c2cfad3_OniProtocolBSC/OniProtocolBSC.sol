...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcA2cc7B58F6E715D57f4b4b45803bF140b1214F5; // owner address
...
contract OniProtocolBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Oni Procotol";
    string private _symbol = "OP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcA2cc7B58F6E715D57f4b4b45803bF140b1214F5); // Marketing Address
    address payable public teamWalletAddress = payable(0xcA2cc7B58F6E715D57f4b4b45803bF140b1214F5); // Team Address
