...
/*
FoodAI bot allows you to choose the best meal for your day. Bot will ask you questions about your preferences, and any allergies you may have. Based on the information provided, it generates personalized recommendations tailored to your needs. Additionally, it also provides nutritional information so that you can make an informed decision about what to eat. You can save time and energy by easily finding the meals that fit all of your criteria. Enjoy!

Telegram - t.me/foodaibsc
Food AI Bot - t.me/foodai_bot
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb93cfB500bd82063308A23787aB6B4880c46096A; // owner address
...
contract FoodAI is Context, IERC20, Ownable {
    ...
    string private _name = "Food AI";
    string private _symbol = "FOODAI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb93cfB500bd82063308A23787aB6B4880c46096A); // Marketing Address
    address payable private teamWalletAddress = payable(0xb93cfB500bd82063308A23787aB6B4880c46096A); // Team Address
