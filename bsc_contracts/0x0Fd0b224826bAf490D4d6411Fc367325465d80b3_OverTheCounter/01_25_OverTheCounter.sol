...
contract OverTheCounter is IERC721Receiver, Ownable, ReentrancyGuard {
  ...
  // referrer => ERC20 token => amount volume
  ...
  function swapPool(
    ...
    referralVolume[_referrer][_pool.token0] += _amount0ToSend;
  ...
  function acceptPackageOffer(
    ...
    referralVolume[_referrer][_offer.assetContract] += _offer.amount;
  ...
  function buyItNow(
    ...
    referralVolume[_referrer][_pkg.buyItNowAsset] += _pkg.buyItNowAmount;
