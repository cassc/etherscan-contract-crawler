...
contract PublicSale is Ownable, Pausable {
    ...
    uint256 public tokenPriceRate = 19000000000000000; // $0.019
    uint256 public minBuy = 10000000000000000000; // $10
    uint256 public maxBuy = 50000000000000000000; // $50
    uint256 public openSale = 1685577600; // 2023-06-01 00:00:00
    uint256 public endSale = 1686959999; // 2023-06-15 23:59:59
    uint256 public timeTGE = 9999999999;
    uint256 public startUnlock = 9999999999;
    uint256 public timePeriod = 2592000; // 30 days
    uint256 public tgeUnlock = 25; // 25%
    uint256 public receivePercentage = 25; // 25%
    uint256 public divPercentage = 1e2;
    ...
    function buy(uint256 _paymentAmount) public whenNotPaused {
        require(
            totalBuy(msg.sender) + _paymentAmount >= minBuy &&
                totalBuy(msg.sender) + _paymentAmount <= maxBuy,
            "limit min/max buy token"
        );
        require(
