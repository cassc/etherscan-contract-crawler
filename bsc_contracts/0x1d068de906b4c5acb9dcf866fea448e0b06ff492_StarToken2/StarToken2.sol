...
contract StarToken2 is Context, Ownable, IERC20 {
    ...
    address payable private marketingAddress = payable(address(0xe2A757F0504Db41FA04B61d7b9954F2dd06D439C));
    address payable private liqAddress = payable(address(0x5ba87a8555E073d412b4341cdA02D7f2542E8d64));

    uint256 constant private buyAllocation = 50;
    uint256 constant private sellAllocation = 50;

    IRouter02 public swapRouter;
    string constant private _name = "Star Token 2";
    string constant private _symbol = "STAR2";
