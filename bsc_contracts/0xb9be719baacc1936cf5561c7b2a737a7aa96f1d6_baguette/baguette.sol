...
contract baguette is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "baguette";
    string private _symbol = "baguette";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x9b25484CdEa3FC70F875Fbe9e067a35379D34362);
