...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3ea805Abc8cd6e12FE9799DE889a14B05aB0F10D; // owner address
...
contract PEPEMONKEY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe Monkey";
    string private _symbol = "PM";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x3ea805Abc8cd6e12FE9799DE889a14B05aB0F10D); // Marketing Address
    address payable private teamWalletAddress = payable(0x3ea805Abc8cd6e12FE9799DE889a14B05aB0F10D); // Team Address
