...
import "./eGBP_AccessControlUpgradeable.sol";
    ...
    WhitelistUpgradeable
{
    ...
    function initialize() public initializer {
         ...
         */
        _grantRole(ADMIN_eGBP, msg.sender);
        _grantRole(ADMIN_eGBP, multiSigTreasury);
     ...
     */
    function addToWhitelist(address account) public onlyRole(ADMIN_eGBP) {
     ...
     */
    function removeFromWhitelist(address account) public onlyRole(ADMIN_eGBP) {
     ...
     */
    function bridgePause() public onlyRole(ADMIN_eGBP) {
        require(_bridgePaused == false, "Bridge paused");
        _bridgePaused = true;
     ...
     */
    function bridgeUnpause() public onlyRole(ADMIN_eGBP) {
     ...
     */
    function setMinimumFee(uint256 fee) public onlyRole(ADMIN_eGBP) {
     ...
     */
    function setBridgeFee(uint256 percent) public onlyRole(ADMIN_eGBP) {
     ...
     * @dev set minimum percentage of bridge transaction fee
     */
    function setMinimumSentToChainAmount(uint256 amount) public onlyRole(ADMIN_eGBP) {
     ...
     */
    function setBridgeOwner(address payable account) public onlyRole(ADMIN_eGBP) {
     ...
     */
    function setFeeTreasury(address account) public onlyRole(ADMIN_eGBP) {
        require(account != address(0), "Zero address");
     ...
     */
    function addSameToken(uint256 chainId, address token) public onlyRole(ADMIN_eGBP) {
    ...
    function removeSameToken(uint256 chainId) public onlyRole(ADMIN_eGBP) {
