...
contract SCROGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Santa Croge";
    string private _symbol = "SCROGE";
    uint8 private _decimals = 9;

    address payable private MarketingWallet = payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6); // Marketing Address
    address payable private TeamWallet = payable(0xc7BF8bA50D7A17acE6114FA6f157B28de422de56); // Buy Back Address
