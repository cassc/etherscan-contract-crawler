...
contract ArcadiaChain is ERC20, Ownable {
    ...
    uint256 antiSnipingTime = 1 seconds;
    ...
    constructor() ERC20("Arcadia Chain", unicode"ARCADIA") {
        ...
        marketingWallet = address(0x3493E161646879d3e6fde38e608c741f81D26625); 
        devWallet = address(0x3493E161646879d3e6fde38e608c741f81D26625); 
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _burnFee) external onlyOwner {
        require(_marketingFee + _liquidityFee + _devFee + _burnFee <= 100, "Must keep fees at 30% or less");
