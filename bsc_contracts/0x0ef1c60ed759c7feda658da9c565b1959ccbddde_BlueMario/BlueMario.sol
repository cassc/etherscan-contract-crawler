...
contract BlueMario is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "BLUEMARIO";
    string private constant _symbol = unicode"$BLUEM";
    ...
    address payable public DevWallet = payable(0xfaf524630DfA47755baDB28eA76a3cd9eFfe6A9B);
    address payable public MarketingWallet = payable(0x2ACA858EEE0BaaD85803535ba2226B2ca6e19d65);
