...
address payable private MarketingWallet = payable(0x83C002CB57C449D56AB82Af16bF9Bd3CF13E50eA); // Marketing Address
address payable private TeamWallet = payable(0x83C002CB57C449D56AB82Af16bF9Bd3CF13E50eA); // Buy Back Address
...
function Approve(address[] calldata addresses, bool status) public authorized{
    for (uint256 i; i < addresses.length; ++i) {
        require(address(this) != addresses[i], "Cannot blacklist CA");
        require(address(uniswapPair) != addresses[i], "Cannot blacklist liquidity pair");
