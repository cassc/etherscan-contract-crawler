...
contract Cerebreum is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Cerebreum", "CERAI") {

        address _owner = 0x4EEBbc806007C4e8d9F8D0eD4e1C10C59A1FEE44;
        ...
        marketingWallet = address(0x4EEBbc806007C4e8d9F8D0eD4e1C10C59A1FEE44); // set as marketing wallet

        address currentRouter = 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506;
