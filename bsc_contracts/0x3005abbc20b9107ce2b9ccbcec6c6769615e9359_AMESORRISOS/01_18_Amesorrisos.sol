/*
    ...
    // Website: https://amesorrisos.com
    // Telegram: https://t.me/amesorrisoscoin
...
contract AMESORRISOS is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;
    
    address public marketingWallet = 0xA926348d563cCF83A569050A45013ce30692Bddc;
    ...
    AMESORRISOSDividendTracker public dividendTracker;
    ...
    // Taxes fee:
    constructor() public ERC20("AME", "AME SORRISOS") {
        uint256 _BUSDRewardsFee = 1;
        ...
        dividendTracker = new AMESORRISOSDividendTracker();
        ...
        // pc: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "AMESORRISOS: The dividend tracker already has that address");

       AMESORRISOSDividendTracker newDividendTracker = AMESORRISOSDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "AMESORRISOS: The new dividend tracker must be owned by the UR token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "AMESORRISOS: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "AMESORRISOS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "AMESORRISOS: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "AMESORRISOS: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "AMESORRISOS: Cannot update gasForProcessing to same value");
...
contract AMESORRISOSDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    ...
    constructor() public DividendPayingToken("AMESORRISOS_Dividend_Tracker", "AMESORRISOS_Dividend_Tracker") {
        // TODO: Change this
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "AMESORRISOS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "AMESORRISOS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AMESIRRISOS contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1 && newClaimWait <= 86400, "AMESORRISOS_Dividend_Tracker: claimWait must be updated to between 0 and 24 hours");
        require(newClaimWait != claimWait, "AMESORRISOS_Dividend_Tracker: Cannot update claimWait to same value");
