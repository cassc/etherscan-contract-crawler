...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5147cA3E1435D37D5B0962E142a8656DDc05708A; // owner address
...
contract pepejet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE JET";
    string private _symbol = "JET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5147cA3E1435D37D5B0962E142a8656DDc05708A); // Marketing Address
    address payable public teamWalletAddress = payable(0x5147cA3E1435D37D5B0962E142a8656DDc05708A); // Team Address
