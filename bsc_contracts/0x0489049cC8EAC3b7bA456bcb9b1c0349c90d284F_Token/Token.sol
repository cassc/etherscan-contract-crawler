...
abstract contract LotToken is IERC20, Ownable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    address public fundAddress;
    address public fundAddress2;
    address public LPreceiveAddress = 0xDB4a6CAD1f56d4C288c66A8fcE8b134F1d4dD865;
    ...
    constructor (
        ...
        holderRewardCondition = 500 * usdtUnit;
...
contract Token is LotToken {
    constructor() LotToken(
        ...
        18,
        21000,
        address(0xDB4a6CAD1f56d4C288c66A8fcE8b134F1d4dD865),
        address(0xDB4a6CAD1f56d4C288c66A8fcE8b134F1d4dD865),
        address(0xDB4a6CAD1f56d4C288c66A8fcE8b134F1d4dD865),
        0,
        0,
