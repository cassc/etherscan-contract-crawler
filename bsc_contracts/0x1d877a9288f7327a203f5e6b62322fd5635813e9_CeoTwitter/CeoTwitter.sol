...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBF237B7aFd3d8d3eEF626A6693d44fb362Db0051; // owner address
...
contract CeoTwitter is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CeoTwitter";
    string private _symbol = "CEO Twitter";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBF237B7aFd3d8d3eEF626A6693d44fb362Db0051); // Marketing Address
    address payable public teamWalletAddress = payable(0xBF237B7aFd3d8d3eEF626A6693d44fb362Db0051); // Team Address
