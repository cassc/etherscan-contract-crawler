...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81872Ae1240e07883D2A31Ec0683910C313BDB11; 
...
contract LuckyFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lucky Floki";
    string private _symbol = "LuckyFloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x81872Ae1240e07883D2A31Ec0683910C313BDB11); 
    address payable public teamWalletAddress = payable(0x81872Ae1240e07883D2A31Ec0683910C313BDB11); 
    ...
    uint256 public _walletMax = 80000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 80000 * 10**_decimals; 
