...
contract PurgeTown is ERC20, Ownable {
    ...
    event LogUpdateBuyFees(uint256 _liquidity, uint256 _marketing);
    event LogUpdateSellFees(uint256 _liquidity, uint256 _marketing);
    ...
    function updateBuyFees(
        ...
        emit LogUpdateBuyFees(_liquidityFee, _marketingFee);
    }
    ...
    function updateSellFees(
        ...
        emit LogUpdateSellFees(_liquidityFee, _marketingFee);
    }
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> PURGE swap when swap+liquify is triggered
