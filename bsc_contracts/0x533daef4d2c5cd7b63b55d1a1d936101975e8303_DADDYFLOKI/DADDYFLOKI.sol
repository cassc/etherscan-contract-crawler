...
contract DADDYFLOKI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Daddy Floki";
    string private constant _symbol = unicode"DADDYFLOKI";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**6 * 10**_decimals;

    address payable public DevWallet = payable(0xE0B6Ed7f20623931c23BA4Ac618BCE90647550cc);
    address payable public MarketingWallet = payable(0xE0B6Ed7f20623931c23BA4Ac618BCE90647550cc);
