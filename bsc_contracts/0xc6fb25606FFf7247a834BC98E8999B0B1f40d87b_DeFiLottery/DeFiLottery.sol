...
contract DeFiLottery is Context, Ownable {
  ...
  function lotteryParticipate(uint256 id, uint256 tickets) external payable isContractStarted {
    ...
    unchecked {
      if (currentLotteryData.maxTicketsPerParticipant > 0) {
        ...
        require(total + tickets <= currentLotteryData.maxTicketsPerParticipant, "Participation exceeded for this lottery round.");
      }
