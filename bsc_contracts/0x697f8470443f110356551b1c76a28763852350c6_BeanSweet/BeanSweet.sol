...
abstract contract Project {
    address public marketingWallet = 0x5bb085B78A76387Fd7B91846b057f94eAE75ffA1;
    address public treasuryWallet = 0x5bb085B78A76387Fd7B91846b057f94eAE75ffA1;

    string constant _name = "BeanSweet";
    string constant _symbol = "BS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 200) / 10000; // (_totalSupply * 1) / 1000 [this equals 1%]
...
contract BeanSweet is Project, IBEP20, Auth {
    using SafeMath for uint256;
