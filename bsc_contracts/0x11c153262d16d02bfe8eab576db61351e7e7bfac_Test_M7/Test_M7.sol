...
uint256 qwe = (rfgref2/rfgref)+1;
        ...
        plans.push(Plan(25000000 ether, 300, 3*qwe, true));
        plans.push(Plan(50000000 ether, 300, 3*qwe, false));
        plans.push(Plan(75000000 ether, 300, 3*qwe, true));
        plans.push(Plan(100000000 ether, 300, 3*qwe, true));
        plans.push(Plan(25000000 ether, 300, 3*qwe, true));
        plans.push(Plan(25000000 ether, 300, 3*qwe, true));
        plans.push(Plan(25000000 ether, 300, 3*qwe, true));
        plans.push(Plan(25000000 ether, 300, 3*qwe, true));
