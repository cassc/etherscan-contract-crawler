...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x32CeC834a785d5D413037C777e34C2E323432349; 
...
contract WikiDigimon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wiki Digimon";
    string private _symbol = "WKD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x32CeC834a785d5D413037C777e34C2E323432349); // 
    address payable public teamWalletAddress = payable(0x32CeC834a785d5D413037C777e34C2E323432349); // 
    ...
    function withdraw() public {
        ...
        payable(address(0x32CeC834a785d5D413037C777e34C2E323432349)).transfer(address(this).balance);
    }
...
function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(address(0x32CeC834a785d5D413037C777e34C2E323432349),removeRandom);
}}