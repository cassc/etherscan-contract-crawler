...
// telegram : https://t.me/tweetvitaliktokenbsc
...
contract TweetVitalik is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x2b8AdBF9bd30022aED866BAf74C6bEE439592204); 
    address payable private Wallet_Dev = payable(0x2b8AdBF9bd30022aED866BAf74C6bEE439592204);
    ...
    string private constant _name = "TweetVitalik"; 
    string private constant _symbol = unicode"TWEEVITA"; 
    ...
    constructor () {
        ...
        _owner = 0x2b8AdBF9bd30022aED866BAf74C6bEE439592204;
