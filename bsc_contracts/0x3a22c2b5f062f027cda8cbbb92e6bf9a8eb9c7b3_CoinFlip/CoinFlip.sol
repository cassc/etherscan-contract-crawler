...
contract CoinFlip is Ownable {
    ...
    address public _houseFeeReceiver = address(0xc14649dA458493b61010b4696b13E07fed98F793);
    uint8 public _houseFeePercentage = 30; 

    address public _devFeeReceiver = address(0xc14649dA458493b61010b4696b13E07fed98F793);
    ...
    function completeQueuedGames() internal {
        while (_globalQueueSize > _queueResetSize) {
            ...
            game.winner = (rand() % 10) == game.predictedOutcome;
