...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x379132d160D531661AEf33eF8ECa761C6765234D;
...
contract GucciApe is Context, IERC20, Ownable {
    ...
    string private _name = "GUCCI APE";
    string private _symbol = "GAPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x379132d160D531661AEf33eF8ECa761C6765234D);
    address payable public teamWalletAddress = payable(0x379132d160D531661AEf33eF8ECa761C6765234D);
