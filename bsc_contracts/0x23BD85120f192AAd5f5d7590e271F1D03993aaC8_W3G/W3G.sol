...
contract W3G is BEP20, Auth {
    using SafeMath for uint256;
    address immutable WBNB;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO = 0x0000000000000000000000000000000000000000;
    string public constant name = "WEB3GOLD";
    string public constant symbol = "WEB3G";
...
event config_SwapAndSendFeeSettings(uint256 Amount, bool Enabled);
    ...
    constructor () Auth(msg.sender) {
        ...
        treasuryFeeReceiver = 0xB1Dcb89DD4765184482028c6d62841b3a991dfA2;
        devFeeReceiver = 0xd247ACd3c0B48AC77F01C7Fd0697018067432cF6;
