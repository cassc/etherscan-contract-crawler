...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x5A64F85c97C77d7C1C6D184e2E7BD8e49B9989B6; // owner address
...
contract CDogeCto is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crazy Doge Cto";
    string private _symbol = "CDogeCto";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1EAE3BcbA97D87d917741f69Befa4C21879B706E); // Marketing Address
    address payable public teamWalletAddress = payable(0x1EAE3BcbA97D87d917741f69Befa4C21879B706E); // Team Address
