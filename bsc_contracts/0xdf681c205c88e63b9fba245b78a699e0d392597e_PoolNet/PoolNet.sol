...
//https://t.me/PoolNetworkAnn
// https://poolnetwork.xyz/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe758F6A06f56edF87cD819591817E45Cf078367e; // owner address
...
contract PoolNet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pool Network";
    string private _symbol = "Pool";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe758F6A06f56edF87cD819591817E45Cf078367e); // Marketing Address
    address payable public teamWalletAddress = payable(0xe758F6A06f56edF87cD819591817E45Cf078367e); // Team Address
