...
contract BAFCCommonNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_TX_MINT = 50;
    uint256 public MAX_WALLET_MINT = 50;
    uint256 public PRICE_PER_MINT = 1 ether;
    ...
    constructor() ERC721("BAFC Common NFT", "BAFCCommonNFT") {
