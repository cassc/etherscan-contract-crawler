...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5b34bc5A35545Cc0e763f5e9263EDDdCd5ef59aB;
...
contract LUCKYDRAWToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8A4eA89F4ED967e8bAe519E62fBEE93d54A52756;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LUCKYDRAWToken";
    string private _symbol = "LDT";
