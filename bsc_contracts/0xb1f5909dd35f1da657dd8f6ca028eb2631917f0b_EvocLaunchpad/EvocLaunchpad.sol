...
contract EvocLaunchpad is Ownable, ReentrancyGuard {
    ...
    function balanceOfPayment(
        uint256 launchId, address account,
    ...
    function claimFunds(uint256 PartnerId) public nonReentrant isPausable {
        ...
        PartnerRegister[PartnerId].UserConfig[wallet].claimTokens = true;
    }
     ...
     * ----------------------
     */
    event WithdrawnUser(address indexed from, uint256 amount, address contractAdd);
