...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x45289007706E7Ee7B42b1fA506661d97740Edfb4);
...
contract BabyFlokiCEO is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x44a8CA8308580CDf256Bba0Ead2380823E4b7C9D;

    string constant _name = "BabyFlokiCEO";
    string constant _symbol = "BABYFLOKICEO";
