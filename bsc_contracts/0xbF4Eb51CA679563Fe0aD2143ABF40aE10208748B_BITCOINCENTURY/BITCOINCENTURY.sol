...
/**
 TELEGRAM: https://t.me/bitcoincenturyportal


*/

/**
In the past Century, A visionary individual
came together to create a new type of currency,
one that would be free from the constraints and 
limitations of traditional finance. They called this currency bitcoin,
and it quickly gained popularity due to its decentralized nature and ability to 
facilitate swift and secure financial transactions. 
People marveled at the ingenuity 
of this digital currency, 
and it wasn't long before it became a staple in the global economy."
...
contract BITCOINCENTURY is IBEP20, Ownable {
    ...
    string constant _name = "BITCOIN CENTURY";
    string constant _symbol = "CBIT";
    ...
    address public marketingFeeReceiver = 0xeFE2aF2D50Ca014392C8B543Fa172aFda7c47206;
