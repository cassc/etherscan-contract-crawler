...
contract HunterXStakerSHIB {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 1000 ether; //1000 Shiba
	uint256[] public REFERRAL_PERCENTS = [70, 30, 20];
	uint256 constant public TOTAL_REF = 120;
	uint256 constant public CEO_FEE = 80;
	uint256 constant public DEV1_FEE = 0;
	uint256 constant public DEV2_FEE = 0;
