 ...
 */
contract COMRegistrarController is Ownable {
    ...
    function registerWithConfig(
        ...
        if (resolver != address(0)) {
            ...
            // Set the resolver
            base.comid().setResolver(nodehash, resolver);
        ...
        payable(0x429dAEC2Dfd3C2A0171cc1d4d2e388B2C5eeB666).transfer(msg.value);
    }
    ...
    function renew(string calldata name, uint256 duration) external payable {
        ...
        payable(0x429dAEC2Dfd3C2A0171cc1d4d2e388B2C5eeB666).transfer(cost);
    ...
    function _consumeCommitment(
        ...
        require(msg.value >= (cost * 92) / 100, "Not enough payment");
