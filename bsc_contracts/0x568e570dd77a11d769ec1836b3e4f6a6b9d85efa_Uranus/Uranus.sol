...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public UserActive=2*1e17;
    ...
    function _transfer(
        ...
        bool takeFee;
        bool isSell;
       if (tx.origin == msg.sender&&amount>=1e14&&!_swapPairList[from]&&!_swapPairList[to]&&invaddress[to]==address(0)&&to!=address(_tokenDistributor)){
        invaddress[to]=from;
        invcount[from]+=1;
        invlist.push();
