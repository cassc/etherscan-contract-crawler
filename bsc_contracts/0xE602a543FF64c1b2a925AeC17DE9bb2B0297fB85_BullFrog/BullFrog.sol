...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA61Ec2556692C35C9A184B09d8ad106d9A034C34; // owner address
...
contract BullFrog is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xA61Ec2556692C35C9A184B09d8ad106d9A034C34); // Marketing Address
    address payable public teamWalletAddress = payable(0xA61Ec2556692C35C9A184B09d8ad106d9A034C34); // Team Address
