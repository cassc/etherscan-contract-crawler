...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //69
    IBEP20 RewardToken = IBEP20(0xB52575Ce47c4534f7B0ba88acfba7546350197d8); //PERRY
...
contract BabyPerry is IBEP20, Auth { //69
    
    using SafeMath for uint256;

    string constant _name = "Baby Perry";
    ...
    address RewardToken = 0xB52575Ce47c4534f7B0ba88acfba7546350197d8;
    ...
    uint256 public sellMultiplier = 40;

    uint256 public totalFee = 20;
    uint256 public totalFeeIfSelling = 80;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xE89dB383d911Eeb808b95929C1f2e13a3712749D;  // 69
        lotteryWallet = 0xE89dB383d911Eeb808b95929C1f2e13a3712749D;  
