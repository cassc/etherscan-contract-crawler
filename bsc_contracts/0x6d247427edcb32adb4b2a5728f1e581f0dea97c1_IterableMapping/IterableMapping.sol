...
contract EquitableGrowthOpportunity is Ownable, ERC20 {
	...
	function _transfer(
		...
		if(!_isAllowedToTradeWhenDisabled[from] && !_isAllowedToTradeWhenDisabled[to]) {
			...
			require((_timestampAllowsTrading(currentTimestamp) && isAllDayTradingEnabled == false), "EquitableGrowthOpportunity: Trading is currently disabled.");
