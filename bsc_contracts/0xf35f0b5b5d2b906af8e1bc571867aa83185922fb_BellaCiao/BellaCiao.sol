...
/**
   ...
   #PIG+#SAFEMOON+#SHIB+#DOGE, combine together to #BellaCiao  

    I make this #BellaCiao to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BellaCiao
   ...
   I will renounce the ownership to burn addresses to transfer #BellaCiao to the community, make sure it's 100% safe.

   I will add 0.5 BNB and all the left 49.5% total supply to the pool
   Can you make #BellaCiao 10000000X? 
   ...
   it's the best part of the #BellaCiao idea, increasing the liquidity pool automatically, 
...
contract BellaCiao is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "BellaCiao";
  string private _name = "BCIAO";
