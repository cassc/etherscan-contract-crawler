...
contract AlaskanBullWorm is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Alaskan Bull Worm";
    string private constant _symbol = "BullWorm";
    ...
    address payable private feeAddress =
        payable(0x5F1952625F6397Af8D51907f6e2EFCC66FDBeB9F);
