...
/**
TG: @handsomesquidward_BSC
twitter: HandsomeBSC_
*/
...
contract handsomesquidward is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    handsomesquidwardDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Handsome Squidward", "HSQUID") {
        marketingWallet = payable(0xDb14d9dB157f923a73e3738e8a45534C9799d569);
        devWallet = payable(0x74f6368446cDCDD44dC468A6d0f1067085A08e11);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 1;
        sellDeadFees = 1;
        buyMarketingFees = 98;
        sellMarketingFees = 98;
        buyLiquidityFee = 1;
        sellLiquidityFee = 1;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new handsomesquidwardDividendTracker(
            payable(this),
            router,
            0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d,
            "handsomesquidwardTRACKER",
            "HSQUIDTRACKER"
        );
...
contract handsomesquidwardDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    handsomesquidward public handsomesquidwardContract;
    ...
    constructor(
        ...
        defaultToken = token;
        handsomesquidwardContract = handsomesquidward(mainContract);
    ...
    function _transfer(
        ...
        require(false, "handsomesquidward_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "handsomesquidward_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main handsomesquidward contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(handsomesquidwardContract);

            uint256 prevBalance = handsomesquidwardContract.balanceOf(address(this));
            ...
            {
                uint256 received = handsomesquidwardContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    handsomesquidwardContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
