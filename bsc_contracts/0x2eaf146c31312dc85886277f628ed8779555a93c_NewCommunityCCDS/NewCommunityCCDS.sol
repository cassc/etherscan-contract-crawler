...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0xc60cF3197D140377BB9f742aE8Ae2dfb061025D8;
...
contract NewCommunityCCDS is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "New Community CCDS";
    string constant _symbol = "cCCDS";
    ...
    address public devFeeReceiver = 0xc60cF3197D140377BB9f742aE8Ae2dfb061025D8;
    address public buybackFeeReceiver = 0xc60cF3197D140377BB9f742aE8Ae2dfb061025D8;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        if(launchedAt + 0 >= block.number){ return feeDenominator.sub(1); }
