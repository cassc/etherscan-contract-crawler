...
contract TokenM is ERC20 {
    ...
    IUserAmountChange public userchange;
	mapping(address => bool) private _isExcludedFromFees;
    mapping(address => bool) private _isExcludedFromVipFees;

    constructor(address tokenOwner) ERC20("Evolia", "EVO") {
        ...
        userchange = new UserAmountChange();
    ...
    function changeUserAmountOutIn(IUserAmountChange _userchange) public onlyOwner {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
			...
			if(from == uniswapV2Pair){
                ...
                userchange.addInAmount(to, amount);
            }else if(to == uniswapV2Pair){
				userchange.addOutAmount(from, amount);
            }else{
                userchange.addOutAmount(from, amount);
                takeFee = false;
            }
