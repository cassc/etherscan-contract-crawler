...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFA493dF721aFC3d557Ee468A8bE564AD7B3FA777; // Superman
...
contract Superman is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xFA493dF721aFC3d557Ee468A8bE564AD7B3FA777); // Superman
    address payable public earnWalletAddress = payable(0xFA493dF721aFC3d557Ee468A8bE564AD7B3FA777); //Superman
    ...
    uint256 public _liquidityShare = 14; 
    ...
    uint256 public _totalDistributionShares = 47;  
