...
contract IKOLF is Context, IERC20, Ownable {
    ...
    string private _name = "IKOLF";
    string private _symbol = "$IKOLF";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xed4d268990a34F75a2e760FcC0b4487b3cFAC9Fc);
    address payable public liqWalletAddress = payable(0xed4d268990a34F75a2e760FcC0b4487b3cFAC9Fc);
    ...
    uint256 public _buyMarketingFee = 34;

    uint256 public _sellLiquidityFee = 1;
    uint256 public _sellMarketingFee = 39;
