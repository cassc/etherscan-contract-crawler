...
contract Purplepandabsc is ERC20, Ownable {
    ...
    string private _name = "Purple Panda BSC"; // token name
    string private _symbol = "PPB"; // token ticker
  ...
  function enableTrading(bool _tradingActive) external onlyOwner {
    ...
    if (_tradingActive) {
        ...
        tradingActiveBlock = 0; // reset the block number when trading is turned off
    }
}
