...
contract ToownTown is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 20080919 * (10**8) * (10**9);
    ...
    string private constant _name = "Toon Town";
    string private constant _symbol = "TOON";
    uint8 private constant _decimals = 9;

    address payable private _marketingAddress = payable(0xb110409845b1ac58A68C5BFad039DfED649983de);
    address payable private _marketing2Address = payable(0xb110409845b1ac58A68C5BFad039DfED649983de);
    address payable private _marketing3Address = payable(0xb110409845b1ac58A68C5BFad039DfED649983de);
