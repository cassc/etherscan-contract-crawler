...
contract PIGPT4 is Context, IERC20, Ownable {
    ...
    string private constant _name = "PI GPT4";
    string private constant _symbol = "PIGPT4";
    uint8 private constant _decimals = 9;
    
    uint256 private _tTotal = 314000 * 10**9 * 10**9;
