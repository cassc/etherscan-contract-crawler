...
Let's Join this Party! 
Telegram Group : https://t.me/cheemsluna_portal
...
contract CHEEMSLUNA is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "CHEEMS LUNA";
    string constant public symbol = "$CLUNA";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 89 * 10**7 * 10**decimals;
