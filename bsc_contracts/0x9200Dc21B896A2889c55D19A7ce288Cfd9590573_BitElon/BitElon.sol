...
contract   BitElon  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "8-Bit Elon";
    string private _symbol = "8-BitElon";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x9C1444873FB3b36D3A9E6A0e179131115EF98afF);
