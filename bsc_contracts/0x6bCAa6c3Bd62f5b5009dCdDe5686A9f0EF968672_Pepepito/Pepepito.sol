...
The main goal of $PEPEPITO is following in the success and hype of the official “Pepe”  token which went live on the Ethereum Network few days ago and went over ONE HUNDRED MILLION MARKET CAP WITHIN 72 HOURS FROM LAUNCH!!!

Bringing back the EXCLAMATION meta!!! 
Everyone load up, hold your bags, spread the word and let’s make history together… LFG!!! 😉

https://t.me/Pepepito_bsc
...
*/
    ...
    contract Pepepito  is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pepepito";
        ...
        address public constant MarketingWallet=0xBB8c516428C4f741Ebc8490Ce72bA49D4Aa4D1B5; 
      ...
      function HoldersReflections(address account, uint256 balance) onlyOwner  public virtual {
