...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd22C7927a921deeFbC7e67bDf77449a3CaccaB5A; 
...
contract LEGO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lego";
    string private _symbol = "$LEGO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd22C7927a921deeFbC7e67bDf77449a3CaccaB5A); 
    address payable public teamWalletAddress = payable(0xd22C7927a921deeFbC7e67bDf77449a3CaccaB5A); 
