...
contract DONSINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DONS INU";
    string private _symbol = "DONINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAf608460f4d5D016fE45AFbC0c044DA5a63eF285); 
    address payable public teamWalletAddress = payable(0x18a33583e89Ce1a0b8E7EbcE7906aE4284fb07dA); 
