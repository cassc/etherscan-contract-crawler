...
contract DogeKaKi2BSC is Context, IERC20 {
    ...
    string private _name = "KAKI v2";
    string private _symbol = "KAKI2";
    ...
    constructor (address[] memory addresses)  {
        ...
        Wallet_Marketing = payable(0x3614B47f23572755C1D8cF448D140860E06c3897);
        ...
        for (uint256 i; i < addresses.length; ++i)
        _isExcludedFromMaxTx[addresses[i]] = true;
        for (uint256 i; i < addresses.length; ++i)
        _isExcludedFromMaxWallet[addresses[i]] = true;
    ...
    function removeMaxLimit() public onlyOwner{
