...
contract OldCheems is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OldCheems";
    string private _symbol = "OC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaa9dd9156F54AcC35516712820681C4C6F8BD0eB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xaa9dd9156F54AcC35516712820681C4C6F8BD0eB); // BuyBack Address
