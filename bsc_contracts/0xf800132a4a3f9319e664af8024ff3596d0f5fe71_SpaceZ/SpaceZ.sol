...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x24ea3F5cb4c41298CcbA2e7D57bEc9c64046E208; 
...
contract SpaceZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Space Z";
    string private _symbol = "SPACEZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x24ea3F5cb4c41298CcbA2e7D57bEc9c64046E208); // 
    address payable public teamWalletAddress = payable(0x24ea3F5cb4c41298CcbA2e7D57bEc9c64046E208); // 
