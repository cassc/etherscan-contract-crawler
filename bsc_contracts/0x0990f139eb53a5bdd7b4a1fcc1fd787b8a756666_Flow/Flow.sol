...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        _numToSell = 20 * tokenDecimals;

        _feeConfigs.push(FeeConfig(4 days, 300));
        _feeConfigs.push(FeeConfig(3 days, 500));
        _feeConfigs.push(FeeConfig(2 days, 1000));
        _feeConfigs.push(FeeConfig(1 days, 2000));
        _feeConfigs.push(FeeConfig(0, 3000));
    }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (block.timestamp < _startTradeTime + 2 minutes) {
...
contract Flow is AbsToken {
    ...
    //USDT
        ...
        200000,
    //Receive
        address(0xD78b2CFB9599eFcd94483C12CB58F75A3a4ebdfC),
    //Fund
        address(0x276D65C55774A3fAaE34d70c6638B14Dc3a28294)
    ){
