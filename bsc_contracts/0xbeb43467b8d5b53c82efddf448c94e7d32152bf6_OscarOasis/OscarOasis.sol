...
contract OscarOasis is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet =
        payable(0x8adca03c41A4C3492605a42DC4cF8Ede96Ef7594);
    //adding customer wallet to send supply and exclude from fees.
    address payable public safuWallet =
        payable(0x41222AcB26BEb847eE3D844d640D9A44bAd1Bb34);

    //Dead Wallet for Contract
    ...
    //Supply Definition.
    uint256 private _tTotal = 787_000_000_000_000 ether;
    uint256 private _tFeeTotal;
    //Token Definition.
    string public constant name = "Oscar Oasis";
