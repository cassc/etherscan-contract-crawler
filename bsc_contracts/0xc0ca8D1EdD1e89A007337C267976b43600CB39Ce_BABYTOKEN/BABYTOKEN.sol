...
abstract contract TOKEN is IERC20, Ownable {
    ...
    function setSellFundFee(uint256 fundFee) private onlyOwner {
    ...
    function excludeFee_(address addr, bool enable) public onlyOwner {
    ...
    function claimBalance() private {
        payable(fundAddress).transfer(address(this).balance);
    }

    function claimToken(address token, uint256 amount, address to) private onlyFunder {
    ...
    function setWhitelist(address addr, uint256 enable) public onlyFunder {
...
contract BABYTOKEN is TOKEN {
    ...
    constructor() TOKEN(
        ...
        address(0x48aEc625866EB651448550ABDC54a2Ecec110351),
