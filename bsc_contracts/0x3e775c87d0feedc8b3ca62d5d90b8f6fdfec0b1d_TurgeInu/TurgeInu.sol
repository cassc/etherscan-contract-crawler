...
contract TurgeInu is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9aDb74dA10d7C8d6F6af6Ece1b473A6a6B6B030B; //

    string private constant _name = "Turge Inu"; //
