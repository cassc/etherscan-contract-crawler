...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4b3146223E701650ADAE102A21F40D703722826e;
...
contract PePePumping is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xA7A4A8ab81F3C9cfc46E8834C5f8D9881481193a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 5000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PePePumping";
    string private _symbol = "PPPG";
