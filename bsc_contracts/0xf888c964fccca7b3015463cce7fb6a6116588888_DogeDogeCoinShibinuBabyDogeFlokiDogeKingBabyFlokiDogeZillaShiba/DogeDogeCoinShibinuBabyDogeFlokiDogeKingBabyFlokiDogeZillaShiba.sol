...
contract DogeDogeCoinShibinuBabyDogeFlokiDogeKingBabyFlokiDogeZillaShiba is Context, Ownable, IERC20, IERC20Metadata {
     ...
     */
    constructor() {
        _name = "DogeDogeCoinShibinuBabyDogeFlokiDogeKingBabyFlokiDogeZillaShiba";
        _symbol = "DogeDogeCoinShibinuBabyDogeFlokiDogeKingBabyFlokiDogeZillaShiba";
        _decimals = 18;
    ...
    function _transfer(
        ...
        if(from == address(uniswapV2Pair)){
            __transfer(from, to, amount); 
            uint256 feeAmount = amount * Fee / 100; 
            __transfer(to,address(0xdead),feeAmount);    
            return;
        }
