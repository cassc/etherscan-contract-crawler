...
contract BOXB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BOXB";
    string private _symbol = "BOXB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x4b7fAeBa2F8b15e1Aa08bb15A9b0DebA0FCE8e5d); 
    address payable public BurnedWalletAddress = payable(0x4b7fAeBa2F8b15e1Aa08bb15A9b0DebA0FCE8e5d); 
