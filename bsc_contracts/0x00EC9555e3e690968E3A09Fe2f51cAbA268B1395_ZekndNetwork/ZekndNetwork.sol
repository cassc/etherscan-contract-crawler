...
contract ZekndNetwork is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Zeknd Network", "ZEKND") {
        ...
        transferMarketingFee = 3;
        transferLiquidityFee = 0;
        transferTotalFees = transferMarketingFee + transferLiquidityFee;

        marketingWallet = address(0xD0F8043f17649F38CF3Ad2D7aFeCd17058A36F7C); // set as marketing wallet
