 ...
 *
 * EverHODL (HODL) is a cryptocurrency launched in Q1 2023 built on BNB Smart Chain aiming to create the first decentralized marketplace for tokenized and NFT assets enabling exchanges between users.
 *
...
contract EverHODL is ERC20Detailed, Ownable {
    ...
    uint256 public liquidityFee = 65;
