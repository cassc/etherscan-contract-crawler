...
contract OpenPepeAI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Open Pepe AI";
    string private constant _symbol = "Open Pepe AI";
