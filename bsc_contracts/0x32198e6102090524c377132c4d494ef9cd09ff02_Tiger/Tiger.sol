...
contract Tiger is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Tiger";
    string private _symbol = unicode"Tiger";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0x977DE3eafD7CB4f46D38Fb3840269DfB94927a54);
    address payable private taxWallet2 = payable(0x977DE3eafD7CB4f46D38Fb3840269DfB94927a54);
    ...
    uint256 private _totalSupply = 70_000_000_000_000_000 * 10**9;
