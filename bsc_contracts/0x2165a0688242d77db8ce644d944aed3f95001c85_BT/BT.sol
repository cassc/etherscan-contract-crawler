...
contract BT is Context, IERC20, Ownable {
    ...
    string private constant _name = "BINANCE TERRESTRIAL"; // 
    string private constant _symbol = "BT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x0a70618598F03859652f6F1aCeb35f45cE9A0Fd6;
