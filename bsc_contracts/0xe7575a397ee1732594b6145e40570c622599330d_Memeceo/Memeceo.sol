...
contract Memeceo is ERC20, Ownable {
    ...
    constructor() ERC20("MEME CEO", "MEMECEO") {
        ...
        marketingWallet = address(0x031B5DC96876F8E05256035AfFa6e291a1608B90); // set as marketing wallet
        devWallet = address(0x031B5DC96876F8E05256035AfFa6e291a1608B90); // set as dev wallet
