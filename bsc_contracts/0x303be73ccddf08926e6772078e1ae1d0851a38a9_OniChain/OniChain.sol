...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4eaa8D41Ad462216Ce5b3D250081A8349f5AF2e7; // owner address
...
contract OniChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OniChain";
    string private _symbol = "ONI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4eaa8D41Ad462216Ce5b3D250081A8349f5AF2e7); // Marketing Address
    address payable public teamWalletAddress = payable(0x4eaa8D41Ad462216Ce5b3D250081A8349f5AF2e7); // Team Address
