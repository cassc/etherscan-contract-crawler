...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfb4d45b5B4f86AfE0F405D7226dBf50b2C1aa4bd; // owner address
...
contract FlokiIna is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Ina";
    string private _symbol = "FI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfb4d45b5B4f86AfE0F405D7226dBf50b2C1aa4bd); // Marketing Address
    address payable public teamWalletAddress = payable(0xfb4d45b5B4f86AfE0F405D7226dBf50b2C1aa4bd); // Team Address
