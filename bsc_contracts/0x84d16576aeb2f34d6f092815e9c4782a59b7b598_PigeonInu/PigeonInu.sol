...
contract PigeonInu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "PigeonInu"; 
    string private constant _symbol = "PIGNU";
    ...
    Tax public sellTax = Tax(8,0,2);
    
    address public treasuryWallet = 0x38Ae2653Dc2abcD12235e3A603E933555438fa4F;
    address public devWallet = 0xdaAB397AEfa05880CE632494ab9a2e5a447DB226;
