...
contract DB is IERC20, tokenStaking, Ownable {
    ...
    constructor() Ownable(msg.sender) {
        ...
        stakingContract = stakeIntegration(0xa2Df7954c0617407E559331c328461F768d3349F);
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        if(marketingAmount > 0){distributeETH(marketing_receiver, marketingAmount);}
        ...
        if(excessAmount > uint256(0)){distributeETH(development_receiver, excessAmount);}
    }

    function distributeETH(address recipient, uint256 amount) internal {
        (bool sending,) = payable(recipient).call{value: amount}("");
        sending = false;
    }
