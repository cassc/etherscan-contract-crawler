...
/**
*   Website: https://obidienttoken.xyz/
*   Telegram: https://t.me/Obidienttoken2
*/
library SafeMath {
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x6Ec90334d89dBdc89E08A133271be3d104128Edb); //WKT
...
contract ObidientToken is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string constant _name = "Obidient Token";
    string constant _symbol = "OBT";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken =   0x6Ec90334d89dBdc89E08A133271be3d104128Edb; //WKT

    uint256 _totalSupply = 220000000 * (10 ** _decimals);
    ...
    constructor () {
        ...
        marketingWallet = 0x9952591872032Bc3975bED185F47a1133E15d49b;  // teamwallet
        
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee).add(burnFee);
