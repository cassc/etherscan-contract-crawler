...
contract FREETRUMP is ERC20, Ownable {
    ...
    constructor() payable ERC20("Free Trump Dao", "FREETRUMP") {
        ...
        marketingWallet = 0x0788968950C122508891E1d79eEDDD685c914df3;

        dividendTracker = new DividendTracker(450 * 10**5, rewardToken);
