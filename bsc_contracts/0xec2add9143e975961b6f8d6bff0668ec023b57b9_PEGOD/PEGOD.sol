...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd72f95723919fC90C157A12974480ff2FB73BFfc; // owner address
...
contract PEGOD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " PEGOD ";
    string private _symbol = "PEGOD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd72f95723919fC90C157A12974480ff2FB73BFfc); // Marketing Address
    address payable public teamWalletAddress = payable(0xd72f95723919fC90C157A12974480ff2FB73BFfc); // Team Address
