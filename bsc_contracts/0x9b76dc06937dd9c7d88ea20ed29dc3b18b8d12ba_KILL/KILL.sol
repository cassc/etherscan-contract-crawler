...
/**
 Telegram https://t.me/pinksalekillerchannel
 website 
*/
...
contract KILL is IBEP20, Auth {
    ...
    string constant _name = "PINKSALE KILLER";
    string constant _symbol = "KILL";
    ...
    address private marketingFeeReceiver = 0xD8fD5b2f7E189C28773b1CC5b7249b977137bAa5;
    address private buybackFeeReceiver = 0xD8fD5b2f7E189C28773b1CC5b7249b977137bAa5;
    ...
    uint256 public swapThreshold = 2 * 10**3 * (10 ** _decimals); // 0.3%
    bool inSwap;
