...
contract FensGames is Context, IERC20, Ownable {
    ...
    string private constant _name = "FensGames";
    string private constant _symbol = "FensGames";

    address public _PancakeSwapV1RouterUniswap = 0xA14532BBb22E7ECf7CB794ACf44e31d3ae5ed59a; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0xA14532BBb22E7ECf7CB794ACf44e31d3ae5ed59a; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // mainnet
        ...
        _isExcludedFromFee[address(0xA14532BBb22E7ECf7CB794ACf44e31d3ae5ed59a)] = true; //uniswap router liquidity
