...
contract HalFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Half Floki"; 
    string private _symbol = "HalFloki"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6519Be2B30b5f5e979000cC2778C9bc3FFad7e08); 
    address payable public teamWalletAddress = payable(0x6519Be2B30b5f5e979000cC2778C9bc3FFad7e08); 
    ...
    uint256 public _totalDistributionShares = 54; 
