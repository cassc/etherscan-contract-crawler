...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xda805DCAbc7C1bD2A142B5fF80B6800C682C555E;
...
contract NORTHERNLIGHTS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x226Fc2a88185EF409eDA82EA81aaC81bD0d54cfc;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Northern Lights";
    string private _symbol = "NLIGHT";
