...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _transferFee = 9900;
    ...
    constructor (
        ...
        holderRewardCondition = 2 * usdtUnit;

        _inviteFee[0] = 1;
        _inviteFee[1] = 1;
        _invitorCondition = 1 * tokenUnit;
    ...
    uint256 public progressRewardBlockDebt = 3;
...
contract THA is AbsToken {
    constructor() AbsToken(
        ...
        6,
        16000,
        address(0x735f830C6179D21dF8C3a37bda3f7cE731Dd029D),
        address(0x735f830C6179D21dF8C3a37bda3f7cE731Dd029D),
        address(0x735f830C6179D21dF8C3a37bda3f7cE731Dd029D),
        800,
        0,
