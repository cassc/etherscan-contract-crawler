...
contract ShibaBurnTribe is ERC20, Ownable {
    ...
    ShibaBurnTribeDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xC4558763a9605805d1d27C76Ea06862DaB96ae58;
    address public devWallet = 0xf5c9d3f40840f76b37Ec8aA320F9370294ce84CA;
    address public ShibaInuCA = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;
    ...
    uint256 public swapTokensAtAmount = (_tTotal/1e3);
    uint256 public maxWalletBalance = (_tTotal*3/1e2);
    uint256 public maxBuyAmount = (_tTotal*3/1e2);
    uint256 public maxSellAmount = (_tTotal*3/1e2);
    ...
    constructor() ERC20("Shiba Burn Tribe", "SBT") {
        dividendTracker = new ShibaBurnTribeDividendTracker();
        ...
        excludeFromFees(ShinaInuBurnAddress, true);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ShibaBurnTribeDividendTracker newDividendTracker = ShibaBurnTribeDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "ShibaBurnTribe: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount <= 1e8, "Cannot set swap threshold amount higher than 1% of tokens");
    ...
    function setBuyTaxes(uint256 _rewards, uint256 _marketing, uint256 _dev, uint256 _liquidity, uint256 _burn, uint256 _ShibaBurn) external onlyOwner{
        require((_rewards + _marketing + _dev +_liquidity + _burn + _ShibaBurn) <= 12, "Must keep fees at 12% or less");
    ...
    function setAntiBotBlocks(uint256 numberOfBlocks) external onlyOwner{
        ...
        require(numberOfBlocks < 5,"antiBotBlocks should be less than 5 Blocks");
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "ShibaBurnTribe: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "ShibaBurnTribe: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "ShibaBurnTribe: Cannot update gasForProcessing to same value"
        );
...
contract ShibaBurnTribeDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("ShibaBurnTribe_Dividen_Tracker", "ShibaBurnTribe_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 1e6* 5 * (10**decimals()); 
    }
    ...
    function _transfer(
        ...
        require(false, "ShibaBurnTribe_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "ShibaBurnTribe_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "ShibaBurnTribe_Dividend_Tracker: Cannot update claimWait to same value"
        );
