...
contract DOGECEO is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 1e14 * 10e18;
    
    address public marketingWallet = 0xC58f5D49Cf5Efa7F3A55d56C8D1B8DF6E797DcdD;
    ...
    Taxes public taxes = Taxes(7,3,0);
    Taxes public sellTaxes = Taxes(7,3,0);
    ...
    constructor() ERC20("DOGECEO", "DOGECEO") {
