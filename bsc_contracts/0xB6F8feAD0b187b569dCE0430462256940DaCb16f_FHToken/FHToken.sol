...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x55d398326f99059fF775485246999027B3197955); // DOGE
...
contract FHToken is ERC20, Ownable {
    ...
    address public immutable token = address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); // DOGE
    ...
    constructor() ERC20("FH1", "FH1") {
        address newOwner = address(0x33d1FC883CE9D9C4c5e3A3f1360bF690BCC54bB4);
    
        uint256 totalSupply = 1000000 * 1e18;
        
        maxTransactionAmount = 1000000 * 1e18; // 0.5% maxTransactionAmountTxn
        swapTokensAtAmount = 1 * 1e18; // 0.05% swap tokens amount

        rewardsSellFee = 60;
        marketingSellFee = 10;
        liquiditySellFee = 10;
        buyBackSellFee = 10;
        totalSellFees = rewardsSellFee + marketingSellFee + liquiditySellFee + buyBackSellFee;
        
        rewardsBuyFee = 60;
        marketingBuyFee = 10;
        liquidityBuyFee = 10;
        buyBackBuyFee = 10;
        totalBuyFees = rewardsBuyFee + marketingBuyFee + liquidityBuyFee + buyBackBuyFee;
        
    	dividendTracker = new DividendTracker();
    	
    	marketingWallet = address(0xb42E0d0b87c1c83Da062546e8C3Ae0D2c3ECd720); // set as marketing wallet
        buyBackWallet = address(0xb42E0d0b87c1c83Da062546e8C3Ae0D2c3ECd720); // set as marketing wallet
    ...
    function updateMaxAmount(uint256 newNum) external onlyOwner {
        require(newNum > (totalSupply() * 1 / 10000)/1e18, "Cannot set maxTransactionAmount lower than 0.5%");
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 1000, "Must keep fees at 20% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 1000, "Must keep fees at 30% or less");
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && totalSellFees > 0){
                ...
                tokensForBuyBack += fees * buyBackSellFee / totalSellFees;
            }
            // on buy
                ...
                tokensForBuyBack += fees * buyBackBuyFee / totalBuyFees;
            }
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForRewards + tokensForBuyBack;
        ...
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForRewards - ethForBuyBack;
