...
contract ShareInu is Ownable, ERC20("ShareNow.io", "SHAREINU"), ReentrancyGuard {
//contract ShareInu is Ownable, ERC20("XXTEPA", "XXTEPA"), ReentrancyGuard {
    ...
    uint public maxWallet = 1e24;
    uint public maxTransfer = 1e24;
