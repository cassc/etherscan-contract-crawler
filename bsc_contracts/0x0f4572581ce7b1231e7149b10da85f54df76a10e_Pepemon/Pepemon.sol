...
contract Pepemon is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x85Aa0e14Dcc14A1B0af48E7AE4eE204FfDfB50B6); // Marketing Address
        
    address payable public teamAddress =
        payable(0x85Aa0e14Dcc14A1B0af48E7AE4eE204FfDfB50B6); // Team Address
        
    address payable public liquidityAddress =
        payable(0x85Aa0e14Dcc14A1B0af48E7AE4eE204FfDfB50B6); // Liquidity Address
    ...
    string private constant _symbol = "PMON";
