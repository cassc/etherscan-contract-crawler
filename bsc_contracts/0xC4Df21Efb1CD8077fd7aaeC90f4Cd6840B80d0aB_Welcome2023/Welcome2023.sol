...
interface IDEXRouter {
 ...
 contract Welcome2023 is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Welcome2023";
    string constant _symbol = "Welcome2023";
    ...
    address public devFeeReceiver = 0x9E2f3105CE73C17476Fe762856794e625E0fdE8f;
    address public marketingFeeReceiver = 0xCc4ad0842FE07889D29dd54B0E808236575a5555;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBbuyback = amountBNB.mul(marketingFee).div(totalBNBFee);
        ...
        (bool BuyBackSuccess, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBbuyback, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFeeReceiver(address _devFeeReceiver, address _buybackFeeReceiver) external authorized {
        ...
        marketingFeeReceiver = _buybackFeeReceiver;
    }
