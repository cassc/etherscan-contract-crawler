...
library Address{
 ...
 contract NPC is Context, BEP20, Ownable {
    ...
    address public marketingWallet = 0xa6Ac7544f26eaC9671de8fD6f3facE03b41dfa73;
    address public developmentWallet = 0xC500274187399a846A046CdAa090F0BbaF319b83;
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _development) public onlyOwner {
        buytotaltaxes = _rfi + _marketing + _liquidity + _development; 
        require(buytotaltaxes <= 5, "Must keep taxes at 5% or less"); 
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _development) public onlyOwner {
        selltotaltaxes = _rfi + _marketing + _liquidity + _development; 
        require(selltotaltaxes <= 5, "Must keep sell taxes at 5% or less"); 
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell) external onlyOwner{
        require(maxBuy >= 10000000, "Can't set lower than 1% of the total supply.");
        require(maxSell >= 10000000, "Can't set lower than 1% of the total supply.");
        maxBuyLimit = maxBuy * 10**decimals();
        maxSellLimit = maxSell * 10**decimals();
    }
    
    function updateMaxWalletlimit(uint256 amount) external onlyOwner{
        require(amount >= 10000000, "Can't set lower than 1% of the total supply.");
