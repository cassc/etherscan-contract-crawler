...
contract Spoody is IBEP20, Ownable {
    ...
    string constant _name = "Spoody";
    string constant _symbol = "Spoody";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 3) / 100;  //100% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 3) / 100;  //100% max wallet
    ...
    address public marketingFeeReceiver = 0x8b6aa5b6Af8a319672ea8B112C414707BE4FC747;
