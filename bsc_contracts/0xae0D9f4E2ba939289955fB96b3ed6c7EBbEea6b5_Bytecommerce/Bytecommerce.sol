...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd72d841456b85eAD9326bA947480A8f3f6f37b2A;
...
contract Bytecommerce is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x36F9aaBf3fD0E2bAD287302619C05Cd1437DEAcD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000000000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Bytecommerce";
    string private _symbol = "bytc";
