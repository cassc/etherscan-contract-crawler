...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x98CC60f5984bf5938422c62c50048bD7dd4A3fd8; // owner address
...
contract  SHANGHAIINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "  SHANGHAI INU ";
    string private _symbol = " SHANG ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x98CC60f5984bf5938422c62c50048bD7dd4A3fd8); // 
    address payable public teamWalletAddress = payable(0x98CC60f5984bf5938422c62c50048bD7dd4A3fd8); // 
