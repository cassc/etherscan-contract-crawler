...
/**
A Lord to rule all the Inu's and CEO's around.
*/

/**
 Telegram: https://t.me/LordInu
...
contract LordInu is BEP20, Auth {
    ...
    string public constant name = "Lord Inu";
    string public constant symbol = "$LORD";
    uint8 public constant decimals = 4;

    uint256 public constant totalSupply = 21 * 10**6 * 10**decimals;
