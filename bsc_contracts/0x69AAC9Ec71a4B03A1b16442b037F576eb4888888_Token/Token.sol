...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "DigimonBaby";
    string private _symbol = "DBABY";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0xfe61f0857f25Fd2f421023D06Bc0A4F7F11A3140);
    address payable public lpWallet = payable(0xfe61f0857f25Fd2f421023D06Bc0A4F7F11A3140);
    ...
    function setBuyTaxes(uint256 buyMarketingFeeNew, uint256 buyLpFeeNew) external onlyOwner(){
        ...
        require(_totalTaxIfBuying <= 30 , "Max buy fee under 30%");
    }
    ...
    function setsellTaxes(uint256 sellMarketingFeeNew, uint256 sellLpFeeNew) external onlyOwner(){
        ...
        require(_totalTaxIfSelling <= 30 , "Max sell fee under 30%");
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBForMarketing = BNBBalance.mul(_marketingShare).div(_totalDistributionShares);
