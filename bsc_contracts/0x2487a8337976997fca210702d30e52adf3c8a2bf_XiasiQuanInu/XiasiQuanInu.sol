...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x92577CB6c429BB36909e7c22d1E293F3B7Ea6A7A; // owner address
...
contract XiasiQuanInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xiasi Quan Inu";
    string private _symbol = "XQINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAb1f437dCB06773179f6df2eb987f8FD369da6FD); // 
    address payable public teamWalletAddress = payable(0xAb1f437dCB06773179f6df2eb987f8FD369da6FD); // 
