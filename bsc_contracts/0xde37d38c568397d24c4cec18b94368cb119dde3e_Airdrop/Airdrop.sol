...
contract Airdrop {
    ...
    function batchTransferMainToken(
        address[] memory receivers,
        uint256[] memory amounts
    ) public payable {
        require(receivers.length == amounts.length, "!length");
    ...
    function batchTransferMainTokenSimple(
        address[] memory receivers,
        uint256 amount
    ) public payable {
    ...
    function batchTransferERC20Token(
    ...
    function batchTransferERC20TokenSimple(
        address tokenAddress,
        address[] memory receivers,
        uint256 amount
    ) public {
