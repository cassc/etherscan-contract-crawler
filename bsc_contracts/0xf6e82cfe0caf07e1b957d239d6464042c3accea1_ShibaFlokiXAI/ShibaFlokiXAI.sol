...
contract ShibaFlokiXAI is Context, IERC20, Ownable {
    ...
    string private constant _name = " Shiba Floki XAI "; // 
    string private constant _symbol = " ShibFlokiXAI "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xF19849D96BA606a4B91db1Bc7a632C086a9F4dfc;
