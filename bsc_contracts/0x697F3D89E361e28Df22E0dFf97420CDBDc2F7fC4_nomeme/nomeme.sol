...
contract nomeme is ERC20, Ownable {
    ...
    constructor() ERC20("nomeme", "NOMEME") {
        ...
        maxWallet = 250_000_000 * 1e18; // 0.25% 
        ...
        marketingWallet = address(0x9B498eEd98e93481Ab1a4A7A1DE8085D232B9EAe); // set as marketing wallet
        devWallet = address(0x9B498eEd98e93481Ab1a4A7A1DE8085D232B9EAe); // set as dev wallet
