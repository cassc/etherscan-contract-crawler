...
// UzumakiFloki is here to take anvantage of the MEME hype put together! 
// Mixing the best of both worlds leaves us open to more and more eyes on us. 
// join us! and don't miss it this launch.
// Submitted for Telegram: https://t.me/UzumakiFlokiEntry
...
contract  UzumakiFLoki  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Uzumaki Floki";
    string private _symbol = "U-FLOKI";
