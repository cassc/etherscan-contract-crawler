...
contract flokidragon is Context, IERC20, Ownable {
    ...
    string private _name = "Floki Dragon";
    string private _symbol = "FLOKI DRAGON";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8bDB1b9448538450145310f9A9b7964744982803); // Marketing Address
    address payable public teamWalletAddress = payable(0x8bDB1b9448538450145310f9A9b7964744982803); // Team Address
