...
//Telegram : https://t.me/TeleTweetsCrypto
...
contract TheProtocol is ERC20, Auth {
    ...
    string constant private _name = "THE Protocol";
    string constant private _symbol = "THE";
    ...
    address private autoLiquidityReceiver =  0x2427405Ff577eFCf1154eE35C0DBd1d55C6d9687;
    address private MarketingFeeReceiver = 0x2427405Ff577eFCf1154eE35C0DBd1d55C6d9687;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBOTS[recipient] && !isBOTS[sender], 'Address is Rewarded');
    ...
    function BotDetected(address _address, bool _value) public authorized{
        isBOTS[_address] = _value;
    }
