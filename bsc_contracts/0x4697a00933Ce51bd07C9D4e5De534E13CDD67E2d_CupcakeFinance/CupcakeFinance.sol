...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3C1f5aD4Cb3d3Ff09E31312Bb9158A6AC3a62271; // owner address
...
contract CupcakeFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Cupcake Finance";
    string private _symbol = unicode"CUPCAKE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3C1f5aD4Cb3d3Ff09E31312Bb9158A6AC3a62271); // Marketing Address
    address payable public teamWalletAddress = payable(0x3C1f5aD4Cb3d3Ff09E31312Bb9158A6AC3a62271); // Team Address
