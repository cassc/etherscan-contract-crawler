...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x6A684b3578f5B07c0Aa02fAFc33ED248AE0c2dB2); // TECH TREES COIN CA
...
contract BTTC is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Tech Trees Coin";
    string constant _symbol = "$BTTC";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x6A684b3578f5B07c0Aa02fAFc33ED248AE0c2dB2;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x881f8Baf8884761E859027a8DE0e2939CC505218;
        marketingWallet = 0x881f8Baf8884761E859027a8DE0e2939CC505218;  // marketingwallet
        teamWallet = 0xD770a0a576487B351cE34F68998727fD6F5a12B7;  // team
        
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee).add(teamFee);
        totalFeeIfSelling = totalFee + 2;
    ...
    function setFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newTeamWallet) external authorized {
