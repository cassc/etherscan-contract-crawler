...
contract KingElonMusk is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "King ElonMusk";
    string private _symbol = "King-ELon";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x8B0B734fF371C5e4F4690157023121f71F8516DC);
    address payable public liqWalletAddress = payable(0x8B0B734fF371C5e4F4690157023121f71F8516DC);
