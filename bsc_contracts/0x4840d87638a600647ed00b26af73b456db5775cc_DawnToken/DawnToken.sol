...
contract DawnToken is Context, IERC20, Ownable {
    ...
    address public marketAddr1 = 0xFCE5007E7D5f144fe9183C77F68f45f0A18f1Cfd;
    address public marketAddr2 = 0x0a98906804c85040F8AA829a6596D0bFA8Ff7F69;
    address public manageAddr = 0xA11f8EFdDC5770C115290b769DD13B426c4a093A;
    ...
    uint256 public swapMinAcc = 5 * 10**18;
    bool public swapByMin = true;
    bool public excLock = false;
    mapping(address => bool) public whiteList;
    mapping(address => bool) public blackList;
    uint256[] public feeRate = [5,15,60,920];
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(lpAddr == sender || lpAddr == recipient){
            ...
            if(address(this) != sender && lpAddr == recipient ){
