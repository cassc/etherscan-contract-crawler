...
/**
Telegram: https://t.me/pepejackBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x688650836Adc2688c96f6a470365A33889DAacb5; // owner address
...
contract PEPEJACK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " PEPE JACK";
    string private _symbol = "PEPEJACK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaE370Ca9a748D536ca7f2B9F405B641c91C678E3); // Marketing Address
    address payable public teamWalletAddress = payable(0xaE370Ca9a748D536ca7f2B9F405B641c91C678E3); // Team Address
