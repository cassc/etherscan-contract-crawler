...
contract TigerCEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x21ECB3546205E750e2D71144Ff1B79E4D6b1e2d4;

    string private constant _name = "TigerCEO";
    string private constant _symbol = "TigerCEO";
    ...
    // tax 6% reflection, 3% mkt, 1% for dev
    Taxes public taxes = Taxes(6, 3, 1);
    ...
    function _getTValues(
        ...
        uint256 temp = taxes.marketing + taxes.dev;
        s.tRfi = (tAmount * taxes.rfi) / 100;
        s.tMarketing = (tAmount * temp) / 100;
        s.tTransferAmount =
            tAmount -
            s.tRfi -
            s.tMarketing;
