...
/** 
CAP is now trending on Twitter. 
Contract renounced - zero tax - Liquidity locked.
Huge community around CapoElmo - soon the new Pepe Coin. 

Telegram: https://t.me/CapoElmo
Website: https://www.CapoElmo.com
**/
...
contract CapoElmo {
    ...
    function symbolCAP() public view virtual returns (string memory) {
        return 'memesymbol is CAP';
    }

    function symbolCAP2() public view virtual returns (string memory) {
        return 'mysymbol is CAP';
    }
