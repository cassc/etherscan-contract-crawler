...
contract LandOfVega is Context, IERC20, Ownable {
    ...
    string private constant _name = " Land Of Vega "; // 
    string private constant _symbol = " $VEGA "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x8a0af8a36CdDF581B4251634b50558f57D945Dba;
