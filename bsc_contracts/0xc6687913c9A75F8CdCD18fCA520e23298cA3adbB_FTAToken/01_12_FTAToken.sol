...
contract FTAToken is ERC20, ERC20Burnable, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE2");
    IMEVChecker checker;

    constructor(address _checker) ERC20("FTA", "FTA") {
