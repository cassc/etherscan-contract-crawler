...
contract FlokakiraInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Flokakira Inu";
    string constant _symbol = "FLOKA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**17 * 10**_decimals;
