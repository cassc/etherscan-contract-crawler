...
abstract contract DividendFee is Ownable, DexBaseUSDT, ERC20 {
    ...
    uint256 constant distributorGas = 200000;
...
abstract contract InviteFee is Ownable, ERC20 {
    ...
    uint256 public minInvite = 10000000000 * 1e18;
    ...
    function _takeInviterFee(
        ...
        uint8[3] memory inviteRate = [0, 0, 0];
        address cur = sender;
...
uint256 constant marketFee = 18; 
uint256 constant burnFee = 0; 

address constant marketAddr = 0xda3c2C50285e4C26D55c633B903284532391679D; 
...
contract FactoryAssembly {
    ...
    function getBytecode(address _owner) public pure returns (bytes memory) {
        bytes memory bytecode = type(GD2).creationCode;
