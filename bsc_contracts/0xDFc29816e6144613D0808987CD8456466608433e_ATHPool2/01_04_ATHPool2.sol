...
contract ATHPool2 is Ownable {
    ...
    constructor(IATHPool _athPool, IATHPool _athPool1, IATHPool _athPool2) {
        athPool = _athPool;
        athPool1 = _athPool1;
        athPool2 = _athPool2;
    ...
    function availableClaimAmount(uint _pid, address _user) public view returns(uint available) {
        ...
        uint userClaimed = athPool.claimed(_user, idoToken) + athPool1.claimed(_user, idoToken) + athPool2.claimed(_user, idoToken);
