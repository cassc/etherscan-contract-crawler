...
contract FlokiDrip is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Drip";
    ...
    constructor (address marketingAddress) {
        ...
        sellFee.liquidity = 24;
        sellFee.marketing = 16;
