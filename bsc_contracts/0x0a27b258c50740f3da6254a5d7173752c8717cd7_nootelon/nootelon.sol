...
contract nootelon is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x90dE1D681D6C430EC805aCA546600c309A9b3467);
    address payable private _twdmkt = payable(0x90dE1D681D6C430EC805aCA546600c309A9b3467);
    
    string private constant _name = "NOOT ELON";
    string private constant _symbol = "NOOTELON";
