...
contract HyperloopNetwork is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x3FD81a25457259C1F8766d91399044c937cda71a);
    address payable private _twdmkt = payable(0x3FD81a25457259C1F8766d91399044c937cda71a);
    
    string private constant _name = "HyperloopNetwork";
