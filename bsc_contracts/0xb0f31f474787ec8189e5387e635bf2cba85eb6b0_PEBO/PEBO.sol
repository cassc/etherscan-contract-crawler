...
/**
    ...
    TELEGRAM: https://t.me/PeboOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1F93BcF9901a15cdaA98A9FDa5b1344D0cdfE09A; // owner address
...
contract PEBO is Context, IERC20, Ownable {
    ...
    string private _name = "PEBO";
    string private _symbol = "PEBO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x707aE174f9e892A694502DdAa785cFA8CC97A661); // Marketing Address
    address payable private teamWalletAddress = payable(0x707aE174f9e892A694502DdAa785cFA8CC97A661); // Team Address
