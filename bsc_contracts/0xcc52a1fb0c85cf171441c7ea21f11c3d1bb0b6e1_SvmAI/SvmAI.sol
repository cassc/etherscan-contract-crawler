...
contract SvmAI is ERC20, Ownable {
    ...
    constructor() payable ERC20("SvmAI", "SvmAI") {
        ...
        treasuryWallet = 0xa2A60024bC577e14abFc87f0a4cD3eB91bdEC807;
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _treasuryFeeOnSell, uint256 _rewardsFeeOnSell) external onlyOwner {
        ...
        require(totalSellFee <= 8, "Sell fee cannot be more than 8%");
