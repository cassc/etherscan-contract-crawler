...
contract Repressed is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Repressed";
    string private _symbol = "Repressed";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc45CF12d724ED17238e93da728A35E654DCEFa12);
    address payable public teamWalletAddress = payable(0xc45CF12d724ED17238e93da728A35E654DCEFa12);
