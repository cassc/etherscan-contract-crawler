...
contract FLYCAT is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "FCAT";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x3d0B506819F92655D50a42E2DbffC847853E8573);
    address payable private _marketingAddress = payable(0x3d0B506819F92655D50a42E2DbffC847853E8573);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 85, "Redis cannot be more than 15.");
	    require(redisFeeOnSell < 85, "Redis cannot be more than 15.");
	    require(taxFeeOnBuy < 85, "Tax cannot be more than 15.");
	    require(taxFeeOnSell < 85, "Tax cannot be more than 15.");
