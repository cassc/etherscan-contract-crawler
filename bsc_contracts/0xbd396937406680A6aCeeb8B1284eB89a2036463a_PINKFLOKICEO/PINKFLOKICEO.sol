...
contract PINKFLOKICEO is IBEP20, Auth {
    using SafeMath for uint256;

    address PINK;
    address public WETH = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    string constant _name = "Pink Floki CEO";
    string constant _symbol = "PINKFLOKICEO";
    ...
    uint256 public adminTax = 700;
    uint256 public dividenTax = 300;
    ...
    function setDenominator(uint256 _feeDenominator) external authorized {
        feeDenominator = _feeDenominator;
        require(
            dividenTax + adminTax <= feeDenominator / 8,
            "Can't set fees more than 12.5%"
        );
    }
