...
contract FLOKISZN is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOKI SZN";
    string private constant _symbol = "$FSZN";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            ...
            if (from != uniswapV2Pair) {
                require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount"); if (tx.gasprice > maxGwei) return;
