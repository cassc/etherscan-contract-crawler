 ...
 * Staking of : NFT MOSS
 * NFT Address : 0xA20349eC1035Fa8cab8ce2230060739f2d184863
 * Number of schemes : 1
...
contract MOSStaking {
	...
	uint256 public dailyInterestRate_1 = uint256(15000);
	uint256 public dailyInterestRate_2 = uint256(100000);
...
*/
	function stake(uint256 _tokenId) public {
		...
		ERC721(0xA20349eC1035Fa8cab8ce2230060739f2d184863).safeTransferFrom(msg.sender, address(this), _tokenId);
...
*/
	function unstake(uint256 _tokenId) public {
		...
		ERC721(0xA20349eC1035Fa8cab8ce2230060739f2d184863).safeTransferFrom(address(this), msg.sender, _tokenId);
...
*/
	function withdrawInterestWithoutUnstaking(uint256 _withdrawalAmt, uint256 _tokenId) external {
		...
		record memory thisRecord = addressMap[_tokenId];
		require((thisRecord.staker == msg.sender), "You do not own this token");
		addressMap[_tokenId]  = record (thisRecord.staker, thisRecord.stakeTime, minUIntPair(block.timestamp, (thisRecord.stakeTime + (uint256(30000) * uint256(864)))), (totalInterestEarnedTillNow - _withdrawalAmt), (thisRecord.amtWithdrawn + _withdrawalAmt));
