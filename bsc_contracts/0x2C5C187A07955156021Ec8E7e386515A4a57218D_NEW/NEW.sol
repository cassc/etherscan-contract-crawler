...
contract NEW is Context, IERC20, Ownable {
    ...
    string private _name = "2023.1.1";
    string private _symbol = "2023.1.1";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3828756Ed8F4BDe26b03F4AE43811e1103475BE);
    address payable public teamWalletAddress = payable(0x71015bB9B88Fc72C82723E417C56D4412E3878DC);
    ...
    uint256 private _totalSupply =  202311 * 10**_decimals;
    uint256 public _maxTxAmount =   202311 * 10**_decimals; 
    uint256 public _walletMax =     202311 * 10**_decimals;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(!blackList[sender] && !blackList[recipient], "address is black list");
    ...
    function setBlackList(address account, bool newValue) public onlyOwner {
