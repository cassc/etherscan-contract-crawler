...
Telegram Chat : https://t.me/ChiefTwit
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x55eB627F0D6A6E14f7027Dd319eBACfCd35db888; // owner address
...
contract ChiefTwit is Context, IERC20, Ownable {
    ...
    string private _symbol = "CTWT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x62173709c62828ac2389eABC4C7ffCE9c0408a25); // Marketing Address
    address payable public teamWalletAddress = payable(0x55eB627F0D6A6E14f7027Dd319eBACfCd35db888); // Team Address
