...
contract PooToken is IBEP20, Auth {
    ...
    string constant _name = "PooToken";
    string constant _symbol = "POT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 20;
    uint256 public _maxWalletSize = (_totalSupply * 2) / 10;
    ...
    address private marketingFeeReceiver = 0x0D3bE5cE5b54cb267649Ef4AC7DE08c9383A75Fc;
    address private developmentFeeReceiver = 0x9C929089890CFAc2D1f0F02C9525Fed2107ED796;
