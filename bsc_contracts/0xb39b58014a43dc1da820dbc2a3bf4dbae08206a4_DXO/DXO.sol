...
contract DXO is IERC20, Liquifier {
    using SafeMath for uint256;
    ...
    //uint256 private _getValues;
    //uint256 public _getRate;
    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 21 * 10**12 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'DXO';
    string private _symbol = 'DXO';
    ...
    function _beforeTokenTransfer(address sender, address , uint256) internal {
