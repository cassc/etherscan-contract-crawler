...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90854579F2bB9A09BD1e2Ed120373d937A3151Bc; // owner address
...
contract RabbitChain is Context, IERC20, Ownable {
    ...
    string private _symbol = "RCHAIN";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x518ACa0ffc6424a1b3308560855239eCf346be3b); // Marketing Address
    address payable private teamWalletAddress = payable(0x90854579F2bB9A09BD1e2Ed120373d937A3151Bc); // Team Address
