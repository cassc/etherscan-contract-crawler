...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x513BE4D00737685c5B0Dd4d2896ADc408085925d;
...
contract Bambi is Context, IERC20, Ownable {
    ...
    string private _name = "Bambi";
    string private _symbol = "Bambi";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x513BE4D00737685c5B0Dd4d2896ADc408085925d);
    address payable public teamWalletAddress = payable(0x513BE4D00737685c5B0Dd4d2896ADc408085925d);
