...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 poolAmount = tAmount * 100 / 10000;
            if (poolAmount > 0) {
                feeAmount += poolAmount;
                _takeTransfer(sender, address(_mainPair), poolAmount);
            }
            
            uint256 swapAmount;
            swapAmount = tAmount * 200 / 10000;
...
contract HKwb3 is AbsToken {
    constructor() AbsToken( 
        ...
        18,
        100000000000000,
        address(0x5Ef871f1D76433B99C4bBc1AE173F6d76cd1E8Eb),
        address(0xef8CF0C07fa59895Bd4D395a130BB1B8F668d3C0)
    ){
