...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xec33F9c16108BbA2c644f5Cd4A455edaae8ef724; // owner address
...
contract DigimonApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Digimon Ape";
    string private _symbol = "DA";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0xec33F9c16108BbA2c644f5Cd4A455edaae8ef724); 
    address payable public teamWalletAddress = payable(0xec33F9c16108BbA2c644f5Cd4A455edaae8ef724);
