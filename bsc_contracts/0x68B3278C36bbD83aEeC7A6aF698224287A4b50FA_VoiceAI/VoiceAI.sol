...
contract VoiceAI is ERC20, Ownable {
    ...
    constructor () ERC20("Voice AI", "VoiceAI") 
    {   
        ...
        devWallet       = 0x2194078943a8DbF48e38f83253CfEbB75C0b49fD;
...
//------------------FeeManagement------------------//
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _devFeeOnBuy ) external onlyOwner {
        ...
        require(_totalFeesOnBuy + _totalFeesOnSell <= 7, "Total Fees cannot be more than 7%");
    ...
    function updateWalletToWalletTransferFee(uint256 _walletToWalletTransferFee) external onlyOwner{
        require(_walletToWalletTransferFee <= 7, "Wallet to Wallet Transfer Fee cannot be more than 7%");
