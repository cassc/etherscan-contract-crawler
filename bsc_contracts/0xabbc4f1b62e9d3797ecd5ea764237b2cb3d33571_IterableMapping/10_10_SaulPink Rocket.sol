...
contract SaulPink is ERC20, Ownable {
    ...
    SaulPinkDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xa678EDC5d9a73dF4CDeD39C1AD35C3C91c377a9A;
    address public devWallet = 0xa678EDC5d9a73dF4CDeD39C1AD35C3C91c377a9A;

    uint256 public swapTokensAtAmount = 1e8 * 10**9;
    ...
    Taxes public buyTaxes = Taxes(2, 2, 0, 0);
    Taxes public sellTaxes = Taxes(5, 3, 3, 0);
    ...
    constructor() ERC20("SaulPink Rocket", "SaulPink") {
        dividendTracker = new SaulPinkDividendTracker();
        ...
        */
        _tokengeneration(owner(), 1e11 * (10**9));
    }

    receive() external payable {}

    function updateDividendTracker(address newAddress) public onlyOwner {
        SaulPinkDividendTracker newDividendTracker = SaulPinkDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "SaulPink: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount < 1e9,"Swap Threshold should be less than 1% of total supply");
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "SaulPink: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "SaulPink: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "SaulPink: Cannot update gasForProcessing to same value"
        );
...
contract SaulPinkDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("SaulPink_Dividen_Tracker", "SaulPink_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "SaulPink_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "SaulPink_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "SaulPink_Dividend_Tracker: Cannot update claimWait to same value"
        );
