...
contract AIBOY is IBEP20, Ownable {
    ...
    string constant _name = "AI-Boy";
    string constant _symbol = "$AB";
    ...
    address public marketingFeeReceiver = 0x4035Affec62f38a319A76b429493787C54fd9F7d;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 30; // 0.3%
    bool inSwap;
