...
contract BoboGrow is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xc45ea38b2762d5cD40c25D60A38F80E2EcfaBf85); // Marketing Address
        
    address payable public teamAddress =
        payable(0xc45ea38b2762d5cD40c25D60A38F80E2EcfaBf85); // Team Address
        
    address payable public liquidityAddress =
        payable(0xc45ea38b2762d5cD40c25D60A38F80E2EcfaBf85); // Liquidity Address
    ...
    string private constant _name = "BoboGrow";

    string private constant _symbol = "BoboGrow";
