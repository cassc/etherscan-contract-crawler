...
/* 
🤖‍🌌 $GALACTICAI 🌌🤖
🤖‍🌌 $GALACTICAI 🌌🤖 is a 100% meme based and decentralized community token based on an Game
✨ $GALACTICAI We are a decentralized, deflationary cryptocurrency with instant 4% rewards to holders. 
...
abstract contract ContextAIBEP20 {
...
contract OwnableAIBEP20 is ContextAIBEP20 {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableAIBEP20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableAIBEP20: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract GALACTICAI is ContextAIBEP20, AIBEP20, OwnableAIBEP20 {
    ...
    string private _name = 'GALACTICAI';
    string private _symbol = '$GALACTIC';
