...
contract OktaGamma is Context, IERC20, Ownable {
    ...
    string private constant _name = "Okta Gamma"; // 
    string private constant _symbol = "OGAMM"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x0e5f7f59DA8bFe749Ab4B86737f9072f6F0310fd;
