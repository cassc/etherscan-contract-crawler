...
TG Portal: https://t.me/HalloweenKishu_Portal
...
contract HALLOWEENKISHU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Halloween Kishu";
    string private _symbol = "HKISHU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4a6f98B963A32e0Db1d9914191ddCd2FA952Beea);
    address payable public TeamWalletAddress = payable(0xC06E862440A807Be48E0DA0F788fcDe2B884B842); 
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (100000 * 10**9), "Max wallet should be less or euqal to 100% totalSupply");
