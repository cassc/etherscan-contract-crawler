...
contract Orphidex{
    ...
    uint256 private _totalSupply = 9100000000000000000000000000; // Nine trillion, one hundred billion
    string private _name = "ORPHIDEX";
    string private _symbol = "OEX";
    ...
    uint256 private _referEth =     250;
    uint256 private _airdropEth =   3000000000000000; //0.03Eth
    uint256 private _airdropToken = 50000000000000000000; //500 million OEX
    ...
    uint256 private salePrice = 4500; // 1 BNB for 4500 OEX
