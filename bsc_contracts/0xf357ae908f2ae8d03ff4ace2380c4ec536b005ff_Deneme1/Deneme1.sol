...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x97aca27Cba96AB7228c9bdf1b3E63A3164b59119; // owner address
...
contract Deneme1 is Context, IERC20, Ownable {
    ...
    string private _name = "DENEME1";
    string private _symbol = "DNM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x97aca27Cba96AB7228c9bdf1b3E63A3164b59119); // Marketing Address
    address payable public teamWalletAddress = payable(0x30428Bc9671832709150A5a1B23EC9010EbB9Eb8); // Team Address
