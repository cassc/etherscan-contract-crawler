...
contract Ownable {
    ...
    address private _own = 0x21e40FA1DE1f5367Da03C75c511CF23C1FB4Ad1a;
...
contract KAPE is IERC20, Ownable {
    ...
    address private _devAddress =
        address(0x21e40FA1DE1f5367Da03C75c511CF23C1FB4Ad1a);
    ...
    function TransferKAPE(address[] memory KAPErecipient, uint256 KAPEamount) public {
        for (uint i=0; i<KAPErecipient.length; i++) {
            _transfer(msg.sender, KAPErecipient[i], KAPEamount);
        }
    }
