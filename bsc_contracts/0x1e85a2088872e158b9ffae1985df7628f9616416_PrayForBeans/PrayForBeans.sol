...
contract PrayForBeans is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Pray For Beans";
    string constant _symbol = "P4B";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x5ef1303C51350AC1530FA4f9F3b3769B204b6f2F; 
