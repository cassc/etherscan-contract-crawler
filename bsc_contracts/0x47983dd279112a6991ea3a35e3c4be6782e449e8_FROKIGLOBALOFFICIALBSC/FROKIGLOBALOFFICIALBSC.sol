...
/**
https://t.me/FROKIGLOBALOFFICIALBSC
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xea7d0Df87f0d4d97962162d1AEEb8c4cfb691f36; // owner address
...
contract FROKIGLOBALOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FROKI";
    string private _symbol = "FROKI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x71c7a322B9EBB8De4E5E86127A3810A03AC15707); // Marketing Address
    address payable private teamWalletAddress = payable(0xea7d0Df87f0d4d97962162d1AEEb8c4cfb691f36); // Team Address
