...
contract BatchFetcher {
    ...
    function fetchUserInfo(address _userAddress) public returns (uint256 lockEndTime, uint256 lockedAmount, bool isActive) {
    ...
    function batchFetchUserInfo(address[] calldata _userAddresses) public returns (
