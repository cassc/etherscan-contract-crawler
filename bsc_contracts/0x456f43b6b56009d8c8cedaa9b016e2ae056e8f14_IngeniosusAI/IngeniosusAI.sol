...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC51857Dde235f8B25261A3672a98b20cB3B072eb;
...
contract IngeniosusAI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x06516E45B5dFB4985d1d068f6cf5D7dd1FF3cdB2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "IngeniosusAI";
    string private _symbol = "IGIS";
