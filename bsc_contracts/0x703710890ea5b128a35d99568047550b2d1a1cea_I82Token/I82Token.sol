...
// I82 is a token to raise funds for a blockchain project with a layer 1 coin and its applications

// For more information, please visit: https://i-82.cc/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcFa18BED02F8D607f7854861999584Fa4f0Ba1de;
...
contract I82Token is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xbDE8d95dAE7D9cD7b828E776499678ED87b30951;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 50000000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "I-82";
    string private _symbol = "I82";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**2;
    uint256 private numTokensSellToAddToLiquidity = 35000000 * 10**2;
