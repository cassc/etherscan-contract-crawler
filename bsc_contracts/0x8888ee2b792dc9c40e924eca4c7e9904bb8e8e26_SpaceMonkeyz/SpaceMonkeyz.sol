...
/**
TG https://t.me/spacemonkeyzportal
...
/* Token contract */
contract  SpaceMonkeyz  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xC132b3F8d0e9E395BFAC59A25EdfDE0F04332350;
    ...
    // Name and symbol
    string constant _name = "Space Monkeyz";
    string constant _symbol = "SpaceMonkeyz";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 20000; // 2%
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 20000; // 2%
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 20000; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xC132b3F8d0e9E395BFAC59A25EdfDE0F04332350;
