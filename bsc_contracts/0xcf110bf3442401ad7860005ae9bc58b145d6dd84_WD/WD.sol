...
contract WD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Waddle Dee";
    string private _symbol = "DEE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb1364E913B2e211DF562b9962Bf1794457653BbB);
    address payable private DevelopmentWalletAddress = payable(0xb1364E913B2e211DF562b9962Bf1794457653BbB);
    ...
    uint256 public _walletMax = 1500000000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 15 * 10**9; 
