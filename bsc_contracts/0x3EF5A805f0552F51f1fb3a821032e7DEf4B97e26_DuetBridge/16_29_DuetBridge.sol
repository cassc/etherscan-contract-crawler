...
contract DuetBridge is ReentrancyGuardUpgradeable, PausableUpgradeable, Adminable, IMessageReceiverApp {
    ...
    function _transferXForUser(
        ...
        emit TransferX(user_, originalToken_, amount_, action_, destChainId_, msg.value, celerFee);
    }
    ...
    function getTransferXFee(address user_) public view returns (uint256) {
        return _calcUserFee(abi.encodePacked(user_, ACTION_TRANSFER_X));
    }
