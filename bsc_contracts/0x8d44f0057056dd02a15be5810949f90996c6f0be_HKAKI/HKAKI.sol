...
contract HKAKI  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HKAKI ";
    string private _symbol = "HKAKI ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD8c53011c82E501Db7A05837dA9D7802cCD166B4);
    address payable public teamWalletAddress = payable(0xD8c53011c82E501Db7A05837dA9D7802cCD166B4);
    address public immutable deadAddress = 0xD8c53011c82E501Db7A05837dA9D7802cCD166B4;
