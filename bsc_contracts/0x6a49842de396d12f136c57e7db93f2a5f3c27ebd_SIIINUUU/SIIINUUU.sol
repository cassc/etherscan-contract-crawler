...
Join Telegram: https://t.me/SIIINUUU
...
contract SIIINUUU is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SIIINUUU"; // To Do
    string constant _symbol = "SIIINUUU"; // To Do
    ...
    address public marketingFeeReceiver = 0xCb8e9BC7BA1E9029dBA6484C873162F92Dd2793D;
    address public devFeeReceiver = 0xCb8e9BC7BA1E9029dBA6484C873162F92Dd2793D;
    address public buybackFeeReceiver = 0xCb8e9BC7BA1E9029dBA6484C873162F92Dd2793D;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = tokensToSell / (totalFee) * (liquidityFee) / (3);
        ...
        uint256 totalBNBFee = totalFee - (liquidityFee / (3));
        
        uint256 amountBNBLiquidity = amountBNB * (liquidityFee) / (totalBNBFee) / (3);
