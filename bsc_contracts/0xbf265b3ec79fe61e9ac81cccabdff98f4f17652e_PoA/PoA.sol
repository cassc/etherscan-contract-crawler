...
contract PoA is Context, IERC20, Ownable {
    ...
    string private _name = "Proof of Aptos";
    string private _symbol = "PoA";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xc9f6576577A4d87D3eDc5B906E49cB14A702E728); 
    address payable public BuyBackWalletAddress = payable(0xc9f6576577A4d87D3eDc5B906E49cB14A702E728); 
