...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x019aC54056c6dd926ba68BbCb41cE045A2fBC81B; // owner address
...
contract nekoma is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Nekoma";
    string private _symbol = "Nekoma";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x019aC54056c6dd926ba68BbCb41cE045A2fBC81B); // Marketing Address
    address payable public teamWalletAddress = payable(0x019aC54056c6dd926ba68BbCb41cE045A2fBC81B); // Team Address
