...
/*
Insight
UTILIZING AI TECHNOLOGY IN WEB 3.0
Insight AI are a team of developers and engineers that are training an AI model to bring new advancements to the blockchain space.
‍Our first product is an AI predictive tool for cryptocurrencies.
By analyzing historical & instant market data, this protocol is 
specifically designed to predict the price of cryptocurrencies 
through analyzing parameters such as trading volume, price movements, and network usage.
Building The Future Of Blockchain Technology
Team Of Engineers Programming an AI Predictive Model
http://insa.io
Test Our Beta - http://beta-insai.web.app
#INSAI #InsightAI
*/
...
contract Insight  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'Insight';
    string private _symbol = 'INSAI';
