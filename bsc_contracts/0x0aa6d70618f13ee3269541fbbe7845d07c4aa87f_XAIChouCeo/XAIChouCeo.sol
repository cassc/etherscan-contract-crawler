...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9A4b83530fBd7997D344B54A2cF9e6688c5bb545; // owner address
...
contract XAIChouCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XAI ChouCeo";
    string private _symbol = "XAICHOUCEO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x5984546d4200b2C2821F5D3945a8A92bB748081a); // Marketing Address
    address payable private teamWalletAddress = payable(0x5984546d4200b2C2821F5D3945a8A92bB748081a); // Team Address
