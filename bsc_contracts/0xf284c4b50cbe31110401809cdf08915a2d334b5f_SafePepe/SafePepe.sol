...
contract SafePepe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SafePepe";
    string constant _symbol = "SPP";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = .02 * 10**10 * 10**_decimals; // 200 Million Total Supply
