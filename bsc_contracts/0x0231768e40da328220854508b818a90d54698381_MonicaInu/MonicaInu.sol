...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7Dfe22eaB3b9176C06A7a24431567dEd94EADf5d; // owner address
...
contract MonicaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Monica Inu";
    string private _symbol = "$MONICA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x7Dfe22eaB3b9176C06A7a24431567dEd94EADf5d); // Marketing Address
    address payable private teamWalletAddress = payable(0xb7F2BC0446CceC9367207eC0C02A1B8557152753); // Team Address
