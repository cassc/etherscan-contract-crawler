...
contract Topper is Context, IERC20, Ownable {
    ...
    string private constant _name = "Topper";
    string private constant _symbol = "Topper";
    ...
    bool private isToppertoken = false;
