...
contract StruggleRabbit is ERC20, Ownable {
    using SafeMath for uint256;

    string private _name = "StruggleRabbit";
    string private _symbol = "SGRabbit";
    uint8 constant _decimals = 18;
    uint256 _totalSupply = 20231688 * 10**_decimals;
    ...
    uint256 maxgasprice = 75 * 10**8;
    uint256 maxamount = (_totalSupply * 1) / 1000;
    ...
    function takeFee(
        ...
        if (pair == recipient) {
            ...
            if (launchedBlock == 0 || (isContract(recipient) && tx.gasprice > maxgasprice  && amount > maxamount )) {
