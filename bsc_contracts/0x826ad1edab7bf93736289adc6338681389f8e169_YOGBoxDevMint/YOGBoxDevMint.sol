...
contract YOGBoxDevMint is Ownable {
    /* ========== LIBs ========== */
    ...
    uint256 public maxBuyAmount = 20;
    ...
    function mintBox(address to, uint256 boxType, uint256 amount)
        external
        onlyOwner
    {
        ...
        for (uint256 i = 0; i < amount; i++) {
            nftBoxToken.safeMint(to, boxType, 99);
        }
