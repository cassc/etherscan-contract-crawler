...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Old Pacman"; //
    string private constant _symbol = "OPac"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x5358D2e725baceA03B9EAd02813d2ae6FB5FBa9E;
