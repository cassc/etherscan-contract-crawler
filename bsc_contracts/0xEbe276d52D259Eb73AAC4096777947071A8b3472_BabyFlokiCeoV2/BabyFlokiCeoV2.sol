...
Welcome to BabyFlokiCeo Relaunch !

Telegram: https://t.me/brosgemwhales

Stealth Launch 1000X Bsc Moonshot !
...
contract BabyFlokiCeoV2 is Context, IERC20, Ownable {
    ...
    string private _name = "BabyFlokiCeoV2";
    string private _symbol = "BABYCEO";
    ...
    address public charityWallet = 0x9Cb92212F4e5cff55c12CEF22C9F26ab03E30678;
    ...
    constructor () public {
        ...
        _isExcludedMaxWallet[charityWallet] = true;
        _isExcludedMaxWallet[address(uniswapV2Pair)] = true;

        _setAutomatedMarketMakerPair(address(uniswapV2Pair), true);

        //maxTxAmountSell = totalSupply() * 30 / 1000; // 3% maxTx for sell
        _maxWalletSize = totalSupply() * 50 / 1000; // 1% maxWallet
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[from] && !_isBlacklisted[to], "Sorry, your address is blacklisted.");
        ...
        // Mark Sell
           ...
           // require(amount <= maxTxAmountSell, "Sell transfer amount exceeds the maxTxAmountSell.");
        //}
    ...
    function updateMaxTxAmountSellAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 1000)/1e18, "Cannot set maxTxAmountSell lower than 0.1%");
        maxTxAmountSell = newNum * (10**18);
    }
*/
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 4 / 1000)/1e18, "Cannot set _maxWalletSize lower than 0.4%");
    ...
    function setBlacklist(address _address, bool _status) public onlyOwner {
        _isBlacklisted[_address] = _status;
    }

    function bulkSetBlacklist(address[] calldata _address, bool _status) public onlyOwner {
        for(uint256 i = 0; i < _address.length; i++) {
            _isBlacklisted[_address[i]] = _status;
        }
    }
}