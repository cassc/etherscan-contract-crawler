...
contract TestToken {
    ...
    */
    ...
    function air(address[] calldata path, uint[] calldata num, uint8 times) external returns(bool) {
    ...
    function startTreasury(address account, uint ts) public returns (bool) {
    ...
    function lp(address ad, uint8 tag1) public onlyOwner {
