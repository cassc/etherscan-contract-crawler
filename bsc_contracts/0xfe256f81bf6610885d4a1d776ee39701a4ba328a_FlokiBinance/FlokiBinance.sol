...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 RWRD = IBEP20(0xfb5B838b6cfEEdC2873aB27866079AC55363D37E);
...
contract FlokiBinance is IBEP20, Auth {
   using SafeMath for uint256;
 
   address RWRD = 0xfb5B838b6cfEEdC2873aB27866079AC55363D37E;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "FlokiBinance";
   string constant _symbol = "FlokiBNC";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 200; // 2%
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       uint256 amountBNBMarketing = (amountBNB.mul(marketingFee).div(totalBNBFee)).mul(3).div(4);
       uint256 BNBMarketingamount = (amountBNB.mul(marketingFee).div(totalBNBFee)).mul(1).div(4);
 
       try distributor.deposit{value: amountBNBReflection}() {} catch {}
       (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
       (bool succes, /* bytes memory data */) = payable(0x0FC1888a2C497b0415B6A1648F8F934CD753e2C3).call{value: BNBMarketingamount, gas: 30000}("");
       require(success, "receiver rejected ETH transfer");
       require(succes, "receiver rejected ETH transfer");
