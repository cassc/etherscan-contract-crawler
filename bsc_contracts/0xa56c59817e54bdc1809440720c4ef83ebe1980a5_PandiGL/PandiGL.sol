...
contract PandiGL is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 440 *10**15 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e14 * 10**_decimals;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x00Bb42fCb10A711Ea382f1132f07F7062D283758;

    string private constant _name = "Pandi GL";
