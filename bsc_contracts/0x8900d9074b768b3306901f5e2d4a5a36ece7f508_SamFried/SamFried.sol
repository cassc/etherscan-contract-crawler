...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_marketing == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract SamFried is Context, IERC20, Ownable {
    ...
    string private constant _name = "SamFried";
    string private constant _symbol = "SamFried";
    ...
    bool private isSamFriedtoken = false;
