...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5bECcb68716852A3Fe104D1314F34B22172b367B; // owner address
...
contract babypikaBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby PikaBNB";
    string private _symbol = "PikaBNB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5bECcb68716852A3Fe104D1314F34B22172b367B); // Marketing Address
    address payable public teamWalletAddress = payable(0x5bECcb68716852A3Fe104D1314F34B22172b367B); // Team Address
    ...
    uint256 public _totalDistributionShares = 0;  // original 12
