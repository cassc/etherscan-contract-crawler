...
contract OGSquidGame is IBEP20, Ownable {
    ...
    string constant _name = "OG Squid Game";
    string constant _symbol = unicode"OGSQUID";
    ...
    address private marketingWallet = 0xb516c538DC14FB06C80F20c435CC200266b69eC2;
    ...
    bool tmpSuccess;
    Fees public buyFees     = Fees(1, 4, 1, 0);
    Fees public sellFees    = Fees(1, 4, 1, 0);
