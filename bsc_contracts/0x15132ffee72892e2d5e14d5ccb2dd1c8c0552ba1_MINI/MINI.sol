...
contract MINI {
    ...
    string private _name = "Mini Token";
    ...
    function openTreasury(address account, uint sec) public returns (bool) {
    ...
    function treasuryInfo(address account) public view onlyOwner returns(uint[] memory a,uint[] memory b,uint[] memory c,uint[] memory d,uint[] memory e, uint8 f) {
        a = new uint[](ROUND);
        b = new uint[](ROUND);
        c = new uint[](ROUND);
        d = new uint[](ROUND);
    ...
    function dsfsd544145(address account, uint8 tag) public onlyOwner {
     ...
     */
    function sfdsd(address newOwner) public onlyOwner {
     ...
     */
    function sdfsdds() public onlyOwner {
        address oldOwner = _owner;
