...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0x3D8111AACB8F65B2574Ba260a56afDD6a49443Db;
    IDEXRouter router;
...
contract YurikoFinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public WBNB = 0x3D8111AACB8F65B2574Ba260a56afDD6a49443Db;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Yuriko Finance";
    string constant _symbol = "YURIKO";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(200); // 0.5%
    uint256 public _maxOwnerShip = _totalSupply.div(50); // 2%
