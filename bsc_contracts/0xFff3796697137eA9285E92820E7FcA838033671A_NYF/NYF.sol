...
contract NYF is IBEP20, Auth {
    ...
    string constant _name = "New Years Floki V2";
    ...
    address private marketingFeeReceiver = 0xeb76eC2A2F12bB7bec23eB77C005b299b84f9e11;
    address private buybackFeeReceiver = 0xeb76eC2A2F12bB7bec23eB77C005b299b84f9e11;
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        ...
        require(tradingEnabled || isTxLimitExempt[sender], "Trading not enabled");
    }
    ...
    function swapBack() internal swapping {
        ...
        (bool BuyBackSuccess, /* bytes memory data */) = payable(buybackFeeReceiver).call{value: address(this).balance, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function enableTrade() public authorized {
        tradingEnabled = true; 
    }
