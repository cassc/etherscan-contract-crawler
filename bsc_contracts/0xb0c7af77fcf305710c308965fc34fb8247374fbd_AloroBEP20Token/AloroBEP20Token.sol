...
contract AloroBEP20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("KINGPEDRO", "KPO", 18) 
    ERC20Permit("KINGPEDRO") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 360000000000000000000000000000); 
