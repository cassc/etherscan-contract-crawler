...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeB743A1e1EBA76A97439d2ACAB0051091818fa50 ; //
...
contract YushakiInu is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7000000 * 10**9; //
    string private constant _name = "Yushaki Inu"; // 
    string private constant _symbol = "Yushaki"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6; //
    uint256 public _liquidityFee = 2; //
    address payable public  _marketingWallet = payable(0x801AcD54b115C4FB3B0584B8616EceC064B862CA); //
