...
contract UnoAssetRouterPancakeswap is Initializable, PausableUpgradeable, UUPSUpgradeable {
    ...
    function _removeLiquidity(
        ...
        IBEP20(lpPair).approve(address(PancakeswapRouter), amount);
    ...
    function _removeLiquidityETH(
        ...
        IBEP20(lpPair).approve(address(PancakeswapRouter), amount);
        (amountToken, amountETH) = PancakeswapRouter.removeLiquidityETH(token, amount, amountTokenMin, amountETHMin, recipient, block.timestamp);
    }
