...
/**
   Telegram: https://t.me/jack_inu
   Twitter : https://twitter.com/JACKINUBEP20
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9a85EFf6a1Ef137ef60Eb85dDF6A8a00A0216266; // owner address
...
contract JackInu is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x9a85EFf6a1Ef137ef60Eb85dDF6A8a00A0216266); // Marketing Address
    address payable private teamWalletAddress = payable(0x9a85EFf6a1Ef137ef60Eb85dDF6A8a00A0216266); // Team Address
