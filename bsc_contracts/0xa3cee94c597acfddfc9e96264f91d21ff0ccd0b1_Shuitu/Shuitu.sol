...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1A5ba4C1F66253127EB6213eCbB36e773c884A75; 
...
contract Shuitu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shuitu";
    string private _symbol = "$Shuitu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A5ba4C1F66253127EB6213eCbB36e773c884A75); // 
    address payable public teamWalletAddress = payable(0x1A5ba4C1F66253127EB6213eCbB36e773c884A75); // 
