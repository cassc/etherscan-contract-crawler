...
#ELON WILL CHANGE TWITTER TO bros&sister
INITIAL LP:0.1 BNB
LOW TAX:5/5 (HIGH SELL TAX AT LAUNCH TO PREVENT SNIPERS)
TG:https://t.me/cryptobrosnsisters
*/
...
contract DOGGER  is Context, IERC20, Ownable {
    ...
    string private _name = "cryptobros&sisters";
    string private _symbol = "bros&sis";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x0327Bd1354F031081DF1895822a2f7333DA1C1Ec); 
    address payable public teamWalletAddress = payable(0x0327Bd1354F031081DF1895822a2f7333DA1C1Ec); 
