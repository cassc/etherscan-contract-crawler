 ...
 * Telegram : https://t.me/ikigamisurge
 */
...
contract IKIGAMISURGE is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "IKIGAMI SURGE";
    string private constant _symbol = "IKIGAMI";
    ...
    //Tax wallets
    address public teamWallet = 0x5F9aF08C9dB911c0336A525DEF2c095AaCCf9b0A;
    address public treasuryWallet = 0x0b884c459d3fA6956684b221bA4cF6b0E8d9c6d2;
