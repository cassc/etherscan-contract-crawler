...
//telegram:https://t.me/digimonflokiportal
interface IERC20 {
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7E48CbfF73294B57C45591c5427E90a7EBb61441;
...
contract DIGIMON is Context, IERC20, Ownable {
    ...
    string private constant _name = "DIGIMON FLOKI"; // 
    string private constant _symbol = "DFK"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0x7E48CbfF73294B57C45591c5427E90a7EBb61441);
