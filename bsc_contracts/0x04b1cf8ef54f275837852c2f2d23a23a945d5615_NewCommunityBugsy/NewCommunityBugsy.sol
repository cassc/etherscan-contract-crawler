...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa51151cC813669d06DCb8C1AA1829694b646a47a; // owner address
...
contract NewCommunityBugsy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Community Bugsy";
    string private _symbol = "cBUGSY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa51151cC813669d06DCb8C1AA1829694b646a47a); // Marketing Address
    address payable public teamWalletAddress = payable(0xa51151cC813669d06DCb8C1AA1829694b646a47a); // Team Address
