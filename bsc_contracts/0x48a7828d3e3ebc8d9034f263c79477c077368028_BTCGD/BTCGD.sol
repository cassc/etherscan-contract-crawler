...
contract BTCGD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BTCGD";
    string private _symbol = "BTCGD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28Fd999d188Ee49C1765B2A86df7c674dcBCdB00);
    address payable public teamWalletAddress = payable(0x28Fd999d188Ee49C1765B2A86df7c674dcBCdB00);
    address public immutable deadAddress = 0x28Fd999d188Ee49C1765B2A86df7c674dcBCdB00;
