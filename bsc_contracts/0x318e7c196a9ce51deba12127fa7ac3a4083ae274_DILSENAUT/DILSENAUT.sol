...
// SPDX-License-Identifier: UNILICENSE
    ...
    contract DILSENAUT is Context, IERC20, Ownable {
        ...
        string private constant _name = "DILSENAUT";
        string private constant _symbol = "DILSEN";
        ...
        constructor () {
            ...
            MarketingAddress= 0x00A748a03FBCcf74D1a76A6eF0FD7432B413d996; // Marketing wallet
        ...
        function setFeeRates(uint8 _rfi, uint8 _Marketing) public onlyOwner {
        feeRates.rfi = _rfi;
