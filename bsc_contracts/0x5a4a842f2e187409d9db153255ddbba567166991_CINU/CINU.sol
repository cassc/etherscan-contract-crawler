...
contract CINU is ERC20, Ownable {
    ...
    constructor(address _router) ERC20("COW INU", "CINU") payable
    {
        ...
        // External wallets 
        taxWallets["marketing"] = 0x8B1fcC7403F5653528D03518820EA49C9E1dA480;
        taxWallets["dev"] = 0x2b8b0C60813Cd63821AE247C2DB3cf5966a59c74;

        maxTxAmount = initialSupply * 500 / 10000;
        maxOwnedAmount = initialSupply * 500 / 10000;
