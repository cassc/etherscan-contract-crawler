...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9829cf139850adfFb55831e7b044BD7FA0576C2A; 
...
contract RobinCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Robin Cat";
    string private constant _symbol = unicode"ROBINCAT";
    uint8 private _decimals = 9;

    //mapping(address => bool) public _isBlacklisted;
    address payable public marketingWalletAddress = payable(0x9829cf139850adfFb55831e7b044BD7FA0576C2A); // Marketing Address
    address payable public teamWalletAddress = payable(0x9829cf139850adfFb55831e7b044BD7FA0576C2A); // Team Address
