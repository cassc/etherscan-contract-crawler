...
contract SIBI is Context, IERC20, Ownable {
    ...
    string private _name = "Sibbalo Inu";
    string private _symbol = "SIBI";
    uint8 private _decimals = 18;
    
    uint256 public _RewardFee = 1;
    uint256 private _previousRewardFee = _RewardFee;
    
    uint256 public _OnlySellLiquidityFee = 0;
    uint256 private _previousOnlySellLiquidityFee = _OnlySellLiquidityFee;

    uint256 public _burnFee = 1;
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _marketingFee = 4;
    address public marketingWallet = 0x35B9D00f80DaCA373C937257D994cfbF3E898520;
    uint256 private _previousmarketingFee = _marketingFee;
    
    uint256 public _DevelopmentFee = 2;
    address public DevelopmentWallet = 0x56C59d673c77f1ffafAFd446f9592893347f8Be7;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 tLiquidity = calculateOnlySellLiquidityFee(tAmount);
    ...
    function calculateOnlySellLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_OnlySellLiquidityFee).div(
            10**2
        );
    }
    
    function removeAllFee() private {
        if(_RewardFee == 0 && _OnlySellLiquidityFee == 0 && _marketingFee==0 && _burnFee==0 && _DevelopmentFee==0) return;
        
        _previousRewardFee = _RewardFee;
        _previousOnlySellLiquidityFee = _OnlySellLiquidityFee;
        _previousBurnFee = _burnFee;
        _previousmarketingFee = _marketingFee;
        _previousDevelopmentFee = _DevelopmentFee;
        
        _RewardFee = 0;
        _OnlySellLiquidityFee = 0;
        _DevelopmentFee = 0;
        _marketingFee = 0;
        _burnFee = 0;
    }
    ...
    function restoreAllFee() private {
       ...
       _OnlySellLiquidityFee = _previousOnlySellLiquidityFee;
