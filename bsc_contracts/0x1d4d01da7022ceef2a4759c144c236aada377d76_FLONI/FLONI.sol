...
contract FLONI is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    string private constant _name = "FLONI INU";
    string private constant _symbol = unicode"FLONI";
    ...
    address payable public DevWallet = payable(0x85d89A5E0b800D729570DD5F641cCfAb66e77D0d);
    address payable public MarketingWallet = payable(0x39ba0323def1df894c2c37F72E33A38417707483);
