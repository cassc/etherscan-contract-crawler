...
https://t.me/FlokiSquidBlack

https://twitter.com/FlokiSquidBlack
...
contract FlokiSquidBlack is IBEP20, Auth {
    ...
    string constant _name = "FlokiSquidBlack";
    string constant _symbol = "BLACK";
    ...
    address public marketingFeeReceiver = 0xb05fC2449Fe033f14633b55a6eb593ee20100659;
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _ecosystemFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setFeeReceiver(address _marketingFeeReceiver, address _ecosystemFeeReceiver) external onlyOwner {
