...
contract PEPECASINO is Context, IERC20 { 
    ...
    string private constant _name = "PEPE CASINO"; 
    string private constant _symbol = unicode"$PepeCasino"; 
