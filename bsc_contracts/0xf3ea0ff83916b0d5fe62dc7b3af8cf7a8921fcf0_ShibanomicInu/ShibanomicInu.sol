...
contract ShibanomicInu is Context, IERC20, Ownable {
    ...
    string private constant _name = " Shibanomic Inu "; // 
    string private constant _symbol = " $SHINu "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xE0A1a08b92D1Aa53701eA053c56e1bEe19eDfCE1;
