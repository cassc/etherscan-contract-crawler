...
contract PEPETiger is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xDf3f7211923A2B2B6b9a6281a655907B4EFaaf3b);

    string public _name = "PEPETiger";
    string public _symbol = "PEPETiger";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 10000000000000 * 10 **_decimals;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;
     
    uint256 private fee_totals = 13;
