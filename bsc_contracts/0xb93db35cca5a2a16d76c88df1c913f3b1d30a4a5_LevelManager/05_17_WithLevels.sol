...
abstract contract WithLevels is AdminableUpgradeable, ILevelManager {
    ...
    function initializeNoneLevel() internal {
        ...
        tiers.push(Tier(noneTierId, 0, 0, 0, false, 0, false, false, address(0)));
    }
    ...
    function setTier(
        ...
        Tier memory newTier = Tier(id, multiplier, lockingPeriod, minAmount, random, odds, vip, aag, address(0));
        tiers.push(newTier);
