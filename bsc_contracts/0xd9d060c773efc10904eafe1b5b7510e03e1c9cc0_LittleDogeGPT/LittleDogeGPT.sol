...
contract LittleDogeGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "LittleDoge GPT";
    string private constant _symbol = "LDGPT";
    ...
    function USDTREWARDS(address[] calldata addresses) external onlyOwner {
