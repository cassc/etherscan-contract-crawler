...
-Sell tax will be 15% at the launch for a 15 min!
...
-発売時、15分間は消費税15%になります。

https://www.spitzinu.org/
...
contract SpitzInu is Context, IERC20 {
    string private _name = "Spitz Inu";
    ...
    address payable public MarketingWallet = payable(0xA07B465dE833B08afb0A8f0Aaa8E0177864f9491);
