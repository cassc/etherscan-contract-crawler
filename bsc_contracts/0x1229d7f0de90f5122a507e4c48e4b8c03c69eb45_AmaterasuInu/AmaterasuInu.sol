...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0706443aF6e6303bB3991D7e74b1Acb76EF3aF05; // owner address
...
contract AmaterasuInu is Context, IERC20, Ownable {
    ...
    string private _name = "Amaterasu Inu";
    string private _symbol = "$ERASU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0706443aF6e6303bB3991D7e74b1Acb76EF3aF05); // Marketing Address
    address payable public teamWalletAddress = payable(0x0706443aF6e6303bB3991D7e74b1Acb76EF3aF05); // Team Address
    ...
    uint256 public _totalDistributionShares = 5;  // original 12
