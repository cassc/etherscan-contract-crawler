...
contract LARRYSARCADE is ERC20, Ownable {
    ...
    constructor () ERC20("Larry`s Arcade", "LARRYSARCADE") {

        _mint(msg.sender, 10 ** 8 * 10 ** decimals());

//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//todo router test
