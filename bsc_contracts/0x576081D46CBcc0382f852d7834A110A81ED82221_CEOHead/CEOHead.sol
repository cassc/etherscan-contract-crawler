...
contract CEOHead is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CEO Head";
    string private _symbol = "CEO Head";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8250E3aaC0b43Ae93B0Fc5d775B6e41A2C1dDf57); // Marketing Address
    address payable public teamWalletAddress = payable(0x8250E3aaC0b43Ae93B0Fc5d775B6e41A2C1dDf57); // Team Address
