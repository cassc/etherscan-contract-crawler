...
contract ZEROPERCENTCHADS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "0% CHADS";
    string private _symbol = "ZERO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9241c6FA193b19f03bd7E3759749fAc3700741a4);
    address payable private DevelopmentWalletAddress = payable(0x9241c6FA193b19f03bd7E3759749fAc3700741a4);
    ...
    uint256 public _walletMax = 420000000000000 * 10**9;
