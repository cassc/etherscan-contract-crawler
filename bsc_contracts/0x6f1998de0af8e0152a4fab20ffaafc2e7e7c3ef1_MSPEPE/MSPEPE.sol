...
contract MSPEPE is ERC20, Ownable {
    ...
    constructor () ERC20("Ms. Pepe", "MSPEPE") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xb3e9d16ae784f6E33B300b5523DC4Fe94831E11f;
    ...
    function updateFees(uint256 _marketingFeeOnSell, uint256 _marketingFeeOnBuy) external onlyOwner {
        ...
        require(marketingFeeOnSell <= 12, "Total Fees cannot exceed the maximum");
        require(marketingFeeOnBuy <= 12, "Total Fees cannot exceed the maximum");
