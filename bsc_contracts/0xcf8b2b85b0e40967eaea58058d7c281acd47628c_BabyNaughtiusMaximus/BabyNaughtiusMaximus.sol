...
contract BabyNaughtiusMaximus is Context, IBEP20, Ownable {
    ...
    uint256 private maxB = 1888 * 10 ** 18;
    uint256 private maxS = 1888 * 10 ** 18;
    ...
    uint256 private WalletM = 1888 * 10 ** 18;
    ...
    */
    ...
    constructor(address Tokencontract, address payable airdropWalletS) {
        _name = "BabyNaughtiusMaximus";
        _symbol = "BabyNaughtiusMaximus";
        _decimals = 18;
        _totalSupply = 1888 * 10 ** 18;
