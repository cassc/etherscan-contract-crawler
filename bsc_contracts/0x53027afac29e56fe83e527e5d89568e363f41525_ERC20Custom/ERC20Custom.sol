...
contract ERC20Custom is ERC20, Ownable, Pausable {
    ...
    function mintByOwner(address address_, uint256 amount_) public virtual onlyOwner {
        _mint(address_, amount_);
    }
    
    function burnByOwner(address address_, uint256 amount_) public virtual onlyOwner {
