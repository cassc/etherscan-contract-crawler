...
contract CatMoon is Context, IERC20, Ownable {
    ...
    address public _marketingWallet =
        payable(address(0xFFe561C2B94Dc8484A2C014a3c8E5b57af0121E2));
    ...
    uint256 public constant BLOCKCOUNT = 0; 
    ...
    constructor() {
        ...
        maxSellAmount = totalSupply().mul(100).div(100); // 0.5% of the supply
        maxBuyAmount = totalSupply().mul(100).div(100);// 0.5% of the supply
        maxWalletAmount = totalSupply().mul(100).div(100); // 1.5% of the supply
    ...
    function setBuyFee(uint16 market, uint16 Liquidity, uint16 tax) external onlyOwner {
        ...
        require(totalBuyFee < 99, "Buy fees should be less than 15%");
    }
    ...
    function setSellFee(
        ...
        require(totalSellFee < 99, "Sell fees should be less than 15%");
    }
