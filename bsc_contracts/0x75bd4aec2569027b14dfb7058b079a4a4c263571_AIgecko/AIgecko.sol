...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE7FcF9B5A5793798bA6b5f6d5d9638d8814A455F;
...
contract AIgecko is Context, IERC20, Ownable {
    ...
    string private constant _name = "AI GECKO"; // 
    string private constant _symbol = "AIG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address payable public  _marketingWallet = payable(0xE7FcF9B5A5793798bA6b5f6d5d9638d8814A455F);
