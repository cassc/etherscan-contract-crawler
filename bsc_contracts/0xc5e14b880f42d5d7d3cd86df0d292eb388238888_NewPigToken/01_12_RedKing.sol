...
LET'S GO BACK TO GOLDEN YEAR OF PIG TOKEN
PIG TOKENS DEPLOYER AND OG MEMBERS SUPPORT US
✅Initial LP：1500usdt
✅Tax：3/3(1LP 2MARKETING)
(high sell tax at launch to prevent sniper bots)
TG:https://t.me/newpigtoken
TWITTER:https://twitter.com/newpigtokenbsc
WEBSITE:http://www.newpigtoken.pw/
*/
...
contract NewPigToken is ERC20, Ownable {
    using SafeMath for uint256;

    string private name_ = "New Pig Token";
    string private symbol_ = "Pig";
    uint256 private totalSupply_ =10000000000* 10 **18;

    uint256 public buyLiquidityFee= 1;
    uint256 public buyMarketingFee = 2;
    uint256 public sellLiquidityFee= 1;
    uint256 public sellMarketingFee = 44;

    address public marketingWalletAddress = 0x6CA40D9f5C9102bA891b04b2DBdE02dcBD157FBB;
    address public lpReceiveWallet = 0x6CA40D9f5C9102bA891b04b2DBdE02dcBD157FBB;

    uint256 public maxTxBuyAmount = 10000000000 * 10 ** 18;
    uint256 public maxHolderAmount = 10000000000* 10 ** 18;

    uint256 public airdropAccountEveryTrade = 6;
