...
contract FLOKIBONK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki Bonk";
    string private _symbol = "FLONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01813a97Cf60471cE89C08F1d8AAa88F39d67071);
    address payable public BuyBackWalletAddress = payable(0x01813a97Cf60471cE89C08F1d8AAa88F39d67071);
