...
contract RoleGenerator {
    ...
    function CreateRoleFixedNoMintNoBurnNoPause(
        string memory name,
        ...
        RoleFixedNoMintNoBurnNoPause token = factoryRoleFixedNoMintNoBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleFixedNoMintNoBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleFixedNoMintNoBurnCanPause token = factoryRoleFixedNoMintNoBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleFixedNoMintCanBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleFixedNoMintCanBurnCanPause token = factoryRoleFixedNoMintCanBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleFixedNoMintCanBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleFixedNoMintCanBurnNoPause token = factoryRoleFixedNoMintCanBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleUnlimitCanMintCanBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleUnlimitCanMintCanBurnCanPause token = factoryRoleUnlimitCanMintCanBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleUnlimitCanMintNoBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleUnlimitCanMintNoBurnCanPause token = factoryRoleUnlimitCanMintNoBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleUnlimitCanMintNoBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleUnlimitCanMintNoBurnNoPause token = factoryRoleUnlimitCanMintNoBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleUnlimitCanMintCanBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleUnlimitCanMintCanBurnNoPause token = factoryRoleUnlimitCanMintCanBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleCappedCanMintCanBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleCappedCanMintCanBurnCanPause token = factoryRoleCappedCanMintCanBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleCappedCanMintNoBurnCanPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleCappedCanMintNoBurnCanPause token = factoryRoleCappedCanMintNoBurnCanPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleCappedCanMintCanBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleCappedCanMintCanBurnNoPause token = factoryRoleCappedCanMintCanBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
    ...
    function CreateRoleCappedCanMintNoBurnNoPause(
        string memory name,
        string memory symbol,
        uint256 initialSupply,
        address owner,
        ...
        RoleCappedCanMintNoBurnNoPause token = factoryRoleCappedCanMintNoBurnNoPause.create(
            name,
            symbol,
            initialSupply,
            owner,
