...
$IGGY is described as a particularly antisocial dog with a bad personality.

Iggy is a particularly unpleasant, unruly, and rude dog. 
For instance, he enjoys chewing on human hair and farting in human faces.

Telegram    : https://t.me/Iggybsc
...
contract IGGY is Context, IERC20, Ownable {
    ...
    string private _name = "Iggy The Dog";
    string private _symbol = "IGGY";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xbA6A060B9101a96b67Aa1dca9726CA8A5972a141);
    ...
    function setSelTaxes(uint256 newLiquidityTax, uint256 newMarketingTax)
        external
        onlyOwner
    {
