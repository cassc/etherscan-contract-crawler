...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA95c6A594dcdE4D685e8E595B859De2fc65cC4E7; // owner address
...
contract FlokiRise is Context, IERC20, Ownable {
    ...
    string private _name = "Floki Rise";
    string private _symbol = "FLORISE"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA95c6A594dcdE4D685e8E595B859De2fc65cC4E7); // Marketing Address
    address payable public teamWalletAddress = payable(0xD0fcaB1fD31323Ee4DEea44bA0F2004B651687CD); // Team Address
