...
contract ThePepePot is IBEP20 {
    string private _name = "The Pepe Pot";
    string private _symbol = "PEPEPOT";
    uint8 constant _decimals = 18;
    uint256 _totalSupply = 1_000_000 * (10**_decimals);

    address public constant CEO = 0xF1342d6e5CBD853aB87a87a56D106A25467ea87a;
