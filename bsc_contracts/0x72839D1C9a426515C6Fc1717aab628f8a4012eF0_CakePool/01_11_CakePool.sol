...
import "./interfaces/IMasterChimpyV2.sol";
...
contract CakePool is Ownable, Pausable {
    ...
    IMasterChimpyV2 public immutable masterchefV2;
     ...
     * @param _masterchefV2: MasterChimpyV2 contract
     * @param _admin: address of the admin
     * @param _treasury: address of the treasury (collects fees)
     * @param _operator: address of operator
     * @param _pid: cake pool ID in MasterChimpyV2
     */
    constructor(
        IERC20 _token,
        IMasterChimpyV2 _masterchefV2,
        address _admin,
        address _treasury,
        address _operator,
        uint256 _pid
