...
contract Governance is UUPSUpgradeable, OwnableUpgradeable {
    ...
    mapping(address=>bool) private isLoanMap;
    ...
    modifier onlyLoan() {
        require(isLoanMap[msg.sender], "Caller is not owner!");
        _;
    }
    ...
    function increaseCreditAmountOfUser(address _borrower, uint256 _amount) public onlyLoan {
        creditAmount[_borrower] = creditAmount[_borrower] + _amount;
    }
