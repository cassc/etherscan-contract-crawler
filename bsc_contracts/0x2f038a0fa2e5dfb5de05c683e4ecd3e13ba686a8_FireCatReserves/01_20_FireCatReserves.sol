 ...
 */
contract FireCatReserves is UUPSUpgradeable, IFireCatReserves, FireCatTransfer, FireCatAccessControl {
    ...
    */
    ...
    /// @inheritdoc IFireCatReserves
    function addReserves(address user, uint256 addAmount) external onlyRole(FIRECAT_GATE) returns (uint256) {
