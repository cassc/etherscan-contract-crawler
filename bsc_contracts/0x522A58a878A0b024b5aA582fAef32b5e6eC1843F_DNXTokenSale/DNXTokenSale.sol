...
contract DNXToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "DNX";
    string private _name= "DINEXO COIN";
...
contract DNXTokenSale {
    address payable admin;
    DNXToken public tokenContract;
    ...
    constructor(DNXToken _tokenContract, uint256 _tokensSold)  {
