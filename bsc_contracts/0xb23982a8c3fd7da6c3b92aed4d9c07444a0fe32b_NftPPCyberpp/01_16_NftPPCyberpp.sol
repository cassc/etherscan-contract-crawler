  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        ...
        '", "attributes": [ {"trait_type": "clan", "value": "CYBERPP", }, { "trait_type": "caractere", "value": "Male"}, { "trait_type": "defense", "value": "',strPoints,'"}, { "trait_type": "attaque", "value": "',strStars,'"}, {"trait_type": "maxCollectionId", "value": "',strMaxCollectionId,'"}, { "trait_type": "collectionId", "value": "',strCollectionId,'"} ]}'
      )
    );
