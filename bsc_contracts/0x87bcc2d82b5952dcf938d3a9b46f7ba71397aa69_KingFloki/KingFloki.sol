...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x71122B771a5F75d35649899Aaf0e1263Cb626281; // owner address
...
contract KingFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "King Floki";
    string private _symbol = "kingfloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x71122B771a5F75d35649899Aaf0e1263Cb626281); // Marketing Address
    address payable public teamWalletAddress = payable(0x71122B771a5F75d35649899Aaf0e1263Cb626281); // Team Address
