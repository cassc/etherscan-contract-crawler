...
contract LaserPEPE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x420CA3Fb9dB38eBd1bd31Cb471Bdb0bd9d2F258c); // Marketing Address
    ...
    string private _name = "Laser Pepe";
    string private _symbol = "LPEPE";
    ...
    uint256 public _maxTxAmount = 90000 * 10**6 * 10**18;
