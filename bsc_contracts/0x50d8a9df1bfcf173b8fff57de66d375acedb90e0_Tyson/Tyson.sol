...
contract Tyson is Context, IERC20, Ownable {
    ...
    string private _name = "Mike Tyson";
    string private _symbol = "Tyson";
    uint8 private _decimals = 2;

    address payable public marketingWalletAddress = payable(0x3cab5515d723b7F346848fbA2Dd088BFd604EB6a); 
    address payable public BurnedWalletAddress = payable(0x3cab5515d723b7F346848fbA2Dd088BFd604EB6a); 
