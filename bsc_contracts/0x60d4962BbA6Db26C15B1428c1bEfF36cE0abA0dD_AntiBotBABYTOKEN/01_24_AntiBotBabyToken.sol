...
contract AntiBotBABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        address[4] memory addrs, // reward, router, marketing wallet,, anti bot
        ...
        cronosPadAntiBot = ICronosPadAntiBot(addrs[3]);
    ...
    function _transfer(
        ...
        if (enableAntiBot) {
            cronosPadAntiBot.onPreTransferCheck(from, to, amount);
        }
