...
https://t.me/kiku_inu
https://www.kikuinu.com/

 ___  __     ___   ___  __     ___  ___          ___   ________    ___  ___     
|\  \|\  \  |\  \ |\  \|\  \  |\  \|\  \        |\  \ |\   ___  \ |\  \|\  \    
\ \  \/  /|_\ \  \\ \  \/  /|_\ \  \\\  \       \ \  \\ \  \\ \  \\ \  \\\  \   
 \ \   ___  \\ \  \\ \   ___  \\ \  \\\  \       \ \  \\ \  \\ \  \\ \  \\\  \  
  \ \  \\ \  \\ \  \\ \  \\ \  \\ \  \\\  \       \ \  \\ \  \\ \  \\ \  \\\  \ 
...
contract KIKUINU is Ownable, IBEP20 {
    ...
    string constant _name = "KIKU INU";
    ...
    mapping (address => bool) isantiboted;

    mapping (address => bool) isFeeExempt;
    mapping (address => bool) isTxLimitExempt;

    uint256 private liquidityFee   = 10;
    uint256 private marketingFee   = 40;
    ...
    uint256 public MaxGas = 8 * 1 gwei;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xe67B35FD15A4a9748931F1aFEE40183423df3176;
        devFeeReceiver = 0x135Df7527a4E44fbD7238A2e1a648762932A1a69;
    ...
    function updateMaxWallet(uint256 maxWallPercent_base1000) external onlyOwner {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(antibotMode){
                require(isantiboted[recipient],"Not Whitelisted");    
            }
        }
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != stakingFeeReceiver && recipient != devFeeReceiver && recipient != marketingFeeReceiver && !isTxLimitExempt[recipient]){
    ...
    function set_antibot(bool _status) external onlyOwner {
        antibotMode = _status;
    ...
    function addtoantibot(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
    ...
    function setTax(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _devFee, uint256 _stakingFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setTaxReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _devFeeReceiver, address _stakingFeeReceiver, address _teamFeeReceiver) external onlyOwner {
