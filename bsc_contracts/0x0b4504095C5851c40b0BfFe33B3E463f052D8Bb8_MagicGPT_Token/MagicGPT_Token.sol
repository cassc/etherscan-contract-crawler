...
contract MagicGPT_Token is ERC20, Ownable {
    using Address for address payable;

    uint256 public _totalFeesOnBuy = 3;
    uint256 public _totalFeesOnSell = 3;

    address public  marketingWallet = 0xE97Cf34e9F6f41580f77A8179Aa7a9200a813740;
    ...
    function changeOperator(address newOperator) onlyOperator public {
        require(newOperator != operator, "New operator is the same as the old one");
        ...
        onlyOperator
    {
        require(
            pair != uniswapV2Pair,
            "The PancakeSwap pair cannot be removed from the automatedMarketMakerPairs"
        );
