...
/**
 *Submitted for verification at Bscscan.io on 2023-05-10
*/

// Get your SAFU contract now via kickstartlabs.io
...
contract DIRTY is ERC20, Ownable {
    ...
    constructor () ERC20("DIRTY GIRL", "GIRL") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xa3352FCFa9406836B7e6A5E52b9D32560FC0573a;

        _isExcludedFromFees[owner()] = true;
        _isExcludedFromFees[address(0xa3352FCFa9406836B7e6A5E52b9D32560FC0573a)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true; //pinklock
        _isExcludedFromFees[0xa3352FCFa9406836B7e6A5E52b9D32560FC0573a] = true;

        _mint(address(0xa3352FCFa9406836B7e6A5E52b9D32560FC0573a), 100e9 * (10 ** decimals()));
