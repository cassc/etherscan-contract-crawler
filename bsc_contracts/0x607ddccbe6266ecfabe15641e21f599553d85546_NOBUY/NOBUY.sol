...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x381Fd22610D711F7A77fE15a411fB8Bb8D7b3D90; // owner address
...
contract NOBUY is Context, IERC20, Ownable {
    ...
    string private _name = "TEST NO BUY";
    string private _symbol = "TNB";
    uint8 private _decimals = 6;

    address payable public marketingWalletAddress = payable(0x00BBcbEFa197C401a019934CAb539d0c3ab4BEE6); 
    address payable public teamWalletAddress = payable(0x00BBcbEFa197C401a019934CAb539d0c3ab4BEE6);
