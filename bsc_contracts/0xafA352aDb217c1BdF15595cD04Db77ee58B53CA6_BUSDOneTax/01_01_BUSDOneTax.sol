...
contract BUSDOneTax {
    BONEStakingInfo public stakingInfo =
        BONEStakingInfo(0xCA8A92f2FEF0b437927B119F5c5594D16eaf183E);
    ...
    function payTax(uint256 amount, uint256 coveringAmount) public {
        ...
        if (coveredAmount[msg.sender] == 0) {
            coveredAmount[msg.sender] = totalClaimed + coveringAmount;
        } else {
            coveredAmount[msg.sender] += coveringAmount;
        }
    }
