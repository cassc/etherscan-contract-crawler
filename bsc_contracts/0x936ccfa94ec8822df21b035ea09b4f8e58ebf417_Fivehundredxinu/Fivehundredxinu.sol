...
contract Fivehundredxinu is ERC20, Ownable {
    ...
    constructor() ERC20("Five Hundred", "FHX") 
    {
        ...
        taxWallets["liquidity"] = address(0xF189Cb09eB4E4798a1a4e2A2007f8ec80310598F); //
        setBuyTax(4,0); //marketing tax, liquidity tax
        setSellTax(50,0); //marketing tax, liquidity tax
        setEarlyTax(60,0); // early sell marketing tax, early sell liquidity tax
        
        setTaxWallet(address(0xF189Cb09eB4E4798a1a4e2A2007f8ec80310598F)); // 
        exclude(msg.sender);
    ...
    function setBuyTax(uint256 marketing,uint256 liquidity) public onlyOwner {
        require (marketing + liquidity <= 60, "Max Buy Tax limit is 60%");
