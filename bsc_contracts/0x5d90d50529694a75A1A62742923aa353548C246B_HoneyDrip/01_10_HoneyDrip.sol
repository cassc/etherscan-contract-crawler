...
/*
 * HoneyDrip 
 * App:             https://honeydrip.io
 * Twitter:         https://twitter.com/honeydripbsc
 */
...
interface IHelp {
    function Bytecode_2_2_7() external view returns (bool);
}

contract HoneyDrip is Ownable, ReentrancyGuard {
