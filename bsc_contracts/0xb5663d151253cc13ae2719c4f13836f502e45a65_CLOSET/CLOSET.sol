...
contract CLOSET is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "CLOSET";
    string private _symbol = "CLO";
    ...
    uint256 public buyFee = 20; // Token Buy Fee
    uint256 public sellFee = 20; // Token Sell Fee
    ...
    constructor() {
        ...
        maxTokenPercentage = 70; // 7% of total supply
    ...
    // Here 1% = 10 , 2% = 20, 5% = 50 etc...
    function setCharityFee(uint256 _newCharityFee) public onlyOwner {
        charityFee = _newCharityFee;
        require(charityFee <= 100, "Fees cannot be greater than 10%");
    }
    ...
    function calculateCharityFee(
        ...
        return _amount.mul(charityFee).div(1000);
    }
    ...
    function calculateBurnFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(burnFee).div(1000);
    }
    ...
    function _beforeTokenTransfer(
        ...
        uint256 _totalTax = calculateCharityFee(_amount);
        ...
        if (_isPairAddress[recipient]) {
            // Sell Fees
            _balances[charityAddress] = _balances[charityAddress].add(
                _sellTax
            );
            _balances[address(this)] = _balances[address(this)].add(_LpTax);
            _balances[deadAddress] = _balances[deadAddress].add(_BurnTax);
            amount = amount.sub(_sellTax);
            amount = amount.sub(_LpTax);
            amount = amount.sub(_BurnTax);
    ...
    function ERecover() public onlyOwner {
