...
contract RabbitXRabbit is Context, IERC20, Ownable {
    ...
    string private constant _name = "RabbitXRabbit"; // 
    string private constant _symbol = " $RABBITXRABBIT"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x52E8CFf542b745fd517341Af2Aa8A31334A76C6E;
