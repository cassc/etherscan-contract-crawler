...
contract SPOOKYMUSK is IBEP20, Auth {
   using SafeMath for uint256;
 
   address BUST = 0x9dA40179eB17320136242B21fFEAc8743f7006Fc;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Spooky Musk";
   string constant _symbol = "SM";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = ( _totalSupply * 1 ) / 100 ; //max tx base 100
   
   //max wallet holding  
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; //max wallet base 100
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0x9dA40179eB17320136242B21fFEAc8743f7006Fc; 
       marketingFeeReceiver = 0x78615B153f0953C9a74519C1b0cBCA6A4fb7dd15; 
       buybackFeeReceiver = 0x1A9525Adc076B0880Ddc27CE68Fb5D1f4eedE094; 
