...
// Micro Aptos - Following the Aptos hype, Baby Aptos is mooning hard. Micro Aptos aims to follow its footstep, starting with a micro marketcap of 88usd starting LP.
// Low tax 5/5, LP will be 100% burned and CA renounced! Community is key to moon this!
// https://t.me/MicroAptos
...
contract  NYOKO  is Context, IERC20, Ownable {
    ...
    string private constant _name = "NYOKO"; // 
    string private constant _symbol = "NYOKO"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xC3ae335030A92298310B2f16A1cC2bDCae31bAAd;
    ...
    function setFee(uint256 liquidityFee, uint256 marketingFee) public onlyOwner {
