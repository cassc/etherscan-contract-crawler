...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1966941A225adFC5f2e5880918e43cD486B2beDf; // owner address
...
contract BoneInu is Context, IERC20, Ownable {
    ...
    string private _name = "BoneInu";
    string private _symbol = "BInu"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB3312b925F4Baa4BdB5270d0A3Cdaa2143C8e7F5); // Marketing Address
    address payable public teamWalletAddress = payable(0xB3312b925F4Baa4BdB5270d0A3Cdaa2143C8e7F5); // Team Address
