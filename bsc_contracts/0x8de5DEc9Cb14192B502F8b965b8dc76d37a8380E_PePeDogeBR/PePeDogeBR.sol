...
$PPD 🐸
Memecoin VIP.
Somos VIP porque seremos o maior Memecoin.
#MPDvip🌟
Contrato renunciado após o lançamento ✔️
O sapo, o melhor meme, pepeDoge🚀
2% auto 🔥

https://t.me/PePeDogeBr
*/
...
contract PePeDogeBR is Context, IERC20 {
    string private _name = unicode"PePeDogeBR🇧🇷";
    string private _symbol = "$PPD";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    uint256 private _tTotal = 40000000000000 * 10**_decimals;
    uint256 public _maxTransactionAmt = _tTotal * 10 / 100;
    uint256 public _maxWalletToken = _tTotal * 30 / 100;
    ...
    address payable public MarketingWallet = payable(0xD997De9BB016Fe224dC50B177FFbb3E51Aa5d64e);
