...
/**
$JEFE SmartContract on Binance Smart Chain
...
contract TheJEFEToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TheJEFETokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("JEFE", "JEFE") {
        marketingWallet = payable(0x484f7670783ea8bdF6578C87B5b3AF101FfD1166);
        devWallet = payable(0x06b7317a96f663EAdE241D86A9Ac2cf0AbA2a05f);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 0;
        sellDeadFees = 0;
        buyMarketingFees = 10;
        sellMarketingFees = 19;
        buyLiquidityFee = 0;
        sellLiquidityFee = 0;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new TheJEFETokenDividendTracker(
            payable(this),
            router,
    ...
    function updateFees(
        ...
        require(totalSellFees <= 20 && totalBuyFees <= 20, "total fees cannot exceed 20% sell or buy");
...
contract TheJEFETokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    TheJEFEToken public TheJEFETokenContract;
    ...
    constructor(
        ...
        defaultToken = token;
        TheJEFETokenContract = TheJEFEToken(mainContract);
    ...
    function _transfer(
        ...
        require(false, "TheJEFEToken_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "TheJEFEToken_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TheJEFEToken contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TheJEFETokenContract);

            uint256 prevBalance = TheJEFETokenContract.balanceOf(address(this));
            ...
            {
                uint256 received = TheJEFETokenContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TheJEFETokenContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
