...
/*
EUREKA TOKEN is  the first big memecoin of the new bull run, get in here to own the libs,  get in early before the dev sends it to the moon!

Tg: https://t.me/EurekaTokenPortal
*/
...
contract EurekaToken is IBEP20, Auth {
    using SafeMath for uint256;

    address constant WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO = 0x0000000000000000000000000000000000000000;
    address constant DEV = 0x56c796A560C043C33a28DaEac977A1f976b2684B;

    string constant _name = "EUREKA TOKEN";
