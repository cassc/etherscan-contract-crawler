...
https://link.medium.com/gItitC35rzb
*/
...
contract BuffedPepe is Context, IERC20, Ownable {
    ...
    address payable public  _marketingWallet = payable (0x845256110776809722d6f459d2d8Ee48d6ea24C7);
    ...
    string private constant _name = "Buffed Pepe";
    string private constant _symbol = "$BUFFEDPEPE";
