...
contract RobotFlokiGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = " Robot Floki GPT "; // 
    string private constant _symbol = " $ROKIGPT "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 9;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x790F9cd1A0B9ED29db8740F5e78938d5bCdD1849;
