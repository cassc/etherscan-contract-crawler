...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4B703460BC79b339B180A21F1a2244eA366760a0; // owner address
...
contract DOTBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOTBSC";
    string private _symbol = ".BSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4B703460BC79b339B180A21F1a2244eA366760a0); // Marketing Address
    address payable public teamWalletAddress = payable(0x4B703460BC79b339B180A21F1a2244eA366760a0); // Team Address
