...
https://t.me/Floki1996Community
Don’t miss another life changing opportunity.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFb067c35C6d7968ff3FA4E86412728F49766A3f6; // owner address
...
contract Floki1996Community is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Floki 1996";
    string private _symbol = "F1996";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD6B9EAAf23C385A81Fc2A6a0387Bef089244b513); // Marketing Address
    address payable private teamWalletAddress = payable(0xD6B9EAAf23C385A81Fc2A6a0387Bef089244b513); // Team Address
