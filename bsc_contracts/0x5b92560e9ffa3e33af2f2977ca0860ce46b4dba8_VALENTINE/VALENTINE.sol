...
contract VALENTINE is Context, IERC20, Ownable {
    ...
    string private _name = "RABBIT VALENTINE";
    string private _symbol = "VALENTINE";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x4b0848F1Eb5C198A6B48b57A0A88756dC3eF144A); // Marketing Address
    address payable public BuyBackWallet = payable(0x4b0848F1Eb5C198A6B48b57A0A88756dC3eF144A); // Team Address
    ...
    function BlacklistAddresses(address[] calldata addresses, bool status) public onlyOwner {
