...
//SPDX-License-Identifier: MIT
        ...
        /**
            TG: https://t.me/RizzToken
            Website: https://rizzcoin.app/
            Twitter: https://twitter.com/rizztoken
        */
        ...
        contract Ownable is Context {
            ...
            constructor() {
                _owner = 0xe660cF4b5f2011cb0DbaF65AA4DA71bE5824a144;
        ...
        contract Rizz is IERC20, Context, Ownable, ReentrancyGuard {
            event Bought(
            ...
            uint256 public maxBag = _totalSupply * 9900/100 / 100;
            uint256 public maxTX = _totalSupply * 9900/100 / 100;
            
            //Tax collection
            uint256 public taxBalance = 0;

            //Tax wallets
            address public teamWallet = 0xe660cF4b5f2011cb0DbaF65AA4DA71bE5824a144;
            address public treasuryWallet = 0xe660cF4b5f2011cb0DbaF65AA4DA71bE5824a144;
