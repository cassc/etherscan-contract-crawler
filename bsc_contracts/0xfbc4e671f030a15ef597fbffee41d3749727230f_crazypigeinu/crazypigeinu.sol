...
//TELEGRAM: https://t.me/crazypigeinu
...
contract crazypigeinu is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xf48bc5D197a8058693866F468A7fF976CD37BA3B;
    address public devAddress = 0x60D9dFC56C71409cb8B85A72AA38b83A1Caee29b;

    string private constant _name = "crazy pige inu";
    ...
    Taxes public taxes = Taxes(0,0,20,2);
    Taxes public sellTaxes = Taxes(0,0,20,2);
