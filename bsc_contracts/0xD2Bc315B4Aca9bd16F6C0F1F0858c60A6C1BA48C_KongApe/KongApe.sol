...
/*
Custom Smart Contract for KongApe Project.

KongApe project is built on the believe that, through the power of collective decentralization we can build something stronger than a centralized team ever could create. 
A community-run token is nothing without the united individuals who give it purpose.

A community is held together by hundred, if not thousands, of interconnected moments. 
By studying those drawn to the Shiba project, we realize that true power doesn't come from a single perspective, 
it comes from working together in harmony.

We must keep in mind that by being a part of the KongApeArmy, we are also contributing greatly to saving the lives of what's left of the Ape population in our world. 
Donations will be made to relevant organizations, to support this beautiful cause globally. 
Funding will be made from the 1% Tax fee that is charged from every transaction that is being made with the $KONGAPE Token.

With Doge and Shiba as our mentors, we begin developing the Kong Ape Ecosystem.

Join us today, using the social links on the website:
...
contract KongApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kong Ape";
    string private constant _symbol = "KONGAPE";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xb7BD83e9B0312D7168AA0179d7e221b201CB69C9);
    address payable private _marketingAddress = payable(0x09Cf244379ADC98831a3025dECC7C75660C3f74d);
