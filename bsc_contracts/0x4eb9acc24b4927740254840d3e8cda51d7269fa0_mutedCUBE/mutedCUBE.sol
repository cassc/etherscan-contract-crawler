...
mutedCUBE
@MutedCUBE
mutedCUBE is a privacy-focused product that enables users to access applications privately and securely, while ensuring compliance with regulatory requirements.
*/
...
contract mutedCUBE  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'mutedCUBE';
    string private _symbol = 'mCUBE';
