...
contract BNBBIBI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNB BIBI";
    string private _symbol = "BNBBIBI";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x5bAb8a2E86B596C472d8e34713cD6e48b2ae26f8); 
    address payable private teamWalletAddress = payable(0x5bAb8a2E86B596C472d8e34713cD6e48b2ae26f8); 
    ...
    uint256 private minimumTokensBeforeSwap = 5* 10**10 * 10**_decimals;
