...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2F26364C5AB40EA08Cbf8e593d8FA722af8A46DB ;
...
contract show is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd44A9a7FD0fE873fC83F9DB5ea07c6cA3dE7a6eF;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "show";
    string private _symbol = "shw";
