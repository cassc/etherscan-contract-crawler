...
contract FT is Token {
    constructor() ERC20(
        "FT",   // 名字
        "FT"   // 符号
    ) {
        uint256 _totalSupply = 1000 ether; 
        address _marketing = address(0xca23fd27CA668F735e8E1c9975De8f03E038770A); // 
        address _receive = address(0x14d886265BfE2D35D2B5Ae63837bC984e579765b);   //
        ...
        super.setSurprise(
            9000,              
            3,              
            address(0xca23fd27CA668F735e8E1c9975De8f03E038770A)   
        );
        super.__Token_init(_totalSupply, _marketing, _receive, _usdt, _isDividend);
        setSwapTokensAt(5 ether);  
        setInitPrice(10 ether); 
        feeMarketingTo2 = address(0xca23fd27CA668F735e8E1c9975De8f03E038770A);   
        feeEarn = 1000; 
    }
}