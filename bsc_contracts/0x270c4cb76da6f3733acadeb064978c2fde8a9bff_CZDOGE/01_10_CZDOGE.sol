...
contract CZDOGE is ERC20, Ownable {
    ...
    CZDOGEDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xF875BD0d39aC3E37526A645Af2Fe3Ac1Ec23aAb4;
    address public devWallet = 0xF875BD0d39aC3E37526A645Af2Fe3Ac1Ec23aAb4;
    ...
    Taxes public sellTaxes = Taxes(1, 4, 0, 1);
    ...
    constructor() ERC20("CZDoge Inu ", "CZDOGE") {
        dividendTracker = new CZDOGEDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        CZDOGEDividendTracker newDividendTracker = CZDOGEDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "CZDOGE: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "CZDOGE: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "CZDOGE: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "CZDOGE: Cannot update gasForProcessing to same value"
        );
...
contract CZDOGEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("CZDOGE_Dividen_Tracker", "CZDOGE_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "CZDOGE_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "CZDOGE_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "CZDOGE_Dividend_Tracker: Cannot update claimWait to same value"
        );
