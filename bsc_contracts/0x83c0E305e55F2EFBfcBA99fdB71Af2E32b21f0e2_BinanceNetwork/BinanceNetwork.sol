...
Telegram: https://t.me/BinanceNetworkGlobal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd4a85bdA1B121da74F9ACcB1a55DF404Ec544850;
...
contract BinanceNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BINANCE NETWORK";
    string private _symbol = "BNBNET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd4a85bdA1B121da74F9ACcB1a55DF404Ec544850);
    address payable public teamWalletAddress = payable(0xd4a85bdA1B121da74F9ACcB1a55DF404Ec544850);
