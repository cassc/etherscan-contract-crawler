...
contract BeNTFTurkei is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(address _walletPool, address _walletDonation, address _usdt, string memory _baseuri) ERC721("Maras & Hatay Charity", "M&HC") {
        USDT = IERC20(_usdt);
    ...
    function safeMint() public {
        ...
        USDT.transferFrom(msg.sender, WalletPool, price.mul(75).div(100));
        USDT.transferFrom(msg.sender, WalletDonation, price.mul(25).div(100));
    }
