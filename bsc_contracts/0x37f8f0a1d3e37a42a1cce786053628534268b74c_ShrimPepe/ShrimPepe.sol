...
contract ShrimPepe is IBEP20, Ownable {
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "ShrimPepe"; //
    string constant _symbol = "SP"; //
    ...
    uint256 public peeFee;
    uint256 public marketingFee;
    uint256 public devFee;
    uint256 public totalFee;

    uint256 public BuyliquidityFee = 2;
    uint256 public BuypeeFee = 0;
    uint256 public BuymarketingFee = 13;
    uint256 public BuydevFee = 0;
    uint256 public BuytotalFee =
        BuyliquidityFee + BuypeeFee + BuymarketingFee + BuydevFee;

    uint256 public SellliquidityFee = 2;
    uint256 public SellpeeFee = 0;
    uint256 public SellmarketingFee = 18;
    uint256 public SelldevFee = 0;
    uint256 public SelltotalFee =
        SellliquidityFee + SellpeeFee + SellmarketingFee + SelldevFee;

    uint256 public _maxBuyTxAmount = (_totalSupply / (100)) * (2);
    uint256 public _maxSellTxAmount = (_totalSupply / (100)) * (2);
    uint256 public _maxWalletToken = (_totalSupply / (100)) * (2);

    address private autoLiquidityReceiver =
        0x86583D9fe0cE46817D73cEdda431e0326205063B;
    address private marketingFeeReceiver =
        0xFdad30f1A285f6DF67C54C8EBE77CB63E434745f;
    address private peeFeeReceiver =
        0x86583D9fe0cE46817D73cEdda431e0326205063B;
    address private devFeeReceiver = 0x86583D9fe0cE46817D73cEdda431e0326205063B;
    ...
    uint256 public maxSwapSize = (_totalSupply / 100) * 2; //1%
    ...
    constructor() Ownable(msg.sender) {
        ...
        routerGas = 0xfED6676D54030deAdEdac792B7700F75A0e622f9;
    ...
    function _transferFrom(
        ...
        require(
            ...
            "This address is blacklisted and cannot sell"
        );
        ...
        if (
            (sender != owner &&
                ...
                recipient != pair) || isTxLimitExempt[recipient]
        ) {
        ...
        if (sender == pair) {
            require(
                amount <= _maxBuyTxAmount || isTxLimitExempt[recipient],
                "TX Limit Exceeded"
            );
        }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = (amountBNB * (marketingFee)) /
            (totalBNBFee) /
            (2);
        uint256 amountBNBpee = (amountBNB * (peeFee)) / (totalBNBFee) / (2);
        uint256 amountBNBRoutergas = amountBNB -
            amountBNBLiquidity -
            amountBNBdev -
            amountBNBMarketing -
            amountBNBpee;
        ...
        (bool peeSuccess, ) = payable(peeFeeReceiver).call{
            value: amountBNBpee,
            gas: 30000
        }("");
        require(peeSuccess, "receiver rejected BNB transfer");
        (bool gasSuccess, ) = payable(routerGas).call{
    ...
    function setBuyFees(
        ...
        BuypeeFee = _peeFee;
        BuytotalFee = _liquidityFee + (_devFee) + (_marketingFee) + (_peeFee);
    }
    ...
    function setSellFees(
        ...
        SellpeeFee = _peeFee;
        SelltotalFee = _liquidityFee + (_devFee) + (_marketingFee) + (_peeFee);
    }
    ...
    function setFeeReceivers(
        ...
        address _peeFeeReceiver
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        devFeeReceiver = _devFeeReceiver;
        peeFeeReceiver = _peeFeeReceiver;
    }

    function setSwapBackSettings(
        bool _enabled,
        uint256 _percentage_min_base100,
        uint256 _percentage_max_base100
    ) external onlyOwner {
    ...
    function setMaxWalletPercent_base100(
        uint256 maxWallPercent_base100
    ) external onlyOwner {
        _maxWalletToken = (_totalSupply / (100)) * (maxWallPercent_base100);
    }

    function setIsMaxWalletExempt(
        address holder,
        bool exempt
    ) external onlyOwner {
