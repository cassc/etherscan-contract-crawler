    ...
    IBitXGoldSwap
{
    ...
    function addReferral(address[] memory _referrals, address _referral)
        public
    {
    ...
    function setStakingContract(IBitXStaking _staking)
        public
        onlyRole(ADMIN_ROLE)
    {
        Stake = _staking;
    ...
    function getStakingContract() public view returns (IBitXStaking) {
        return Stake;
    }
}