...
//Telegram group will be published with self message.
//Burned Liquid
...
contract ND is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Neorbit Doge";
    string private _symbol = unicode"ND";

    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x44Bef4740f346AC332915832e0AF85F08e9460f9); 
    address payable public BurnedWalletAddress = payable(0x44Bef4740f346AC332915832e0AF85F08e9460f9); 
