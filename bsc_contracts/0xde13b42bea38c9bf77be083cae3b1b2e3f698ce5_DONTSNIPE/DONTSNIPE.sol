...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5C80b2dF93AC95392d440d52662916F569875Fe0;
...
contract DONTSNIPE is Context, IERC20, Ownable {
    ...
    string private _name = "AS HOLL";
    string private _symbol = "SUCK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5C80b2dF93AC95392d440d52662916F569875Fe0);
    address payable public teamWalletAddress = payable(0x5C80b2dF93AC95392d440d52662916F569875Fe0);
