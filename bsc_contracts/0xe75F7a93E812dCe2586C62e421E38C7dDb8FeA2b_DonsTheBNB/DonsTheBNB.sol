...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xb793EE0A830D17b32F69E71a22e1752587707855;
...
contract DonsTheBNB is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Dons The BNB"; 
    string private constant _symbol = unicode"DnsBNB"; 
    ...
    uint256 public _BuyFee = 100; // in 0.1% units
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0xb793EE0A830D17b32F69E71a22e1752587707855), BNB_Tot);
            }
