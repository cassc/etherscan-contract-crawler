...
contract EMCLockedStaking is Ownable{
    using SafeMath for uint256;

    IBEP20 public emcToken;
    ...
    constructor() {
        emcToken = IBEP20(0x48a9fDAc66AD79483244957C37C0c37d3CB87f40);
        marketingAddress = payable(owner);
        plans.push(Plan(365, 12));
    }
    
    function feePayout(uint256 amt) internal{
        emcToken.transfer(marketingAddress, amt);
    ...
    function invest(address referrer, uint256 depAmount) public {
        ...
        emcToken.transferFrom(msg.sender, address(this), depAmount);
    ...
    function withdraw() public {
        ...
        uint256 contractBalance = emcToken.balanceOf(address(this));
        ...
        emcToken.transfer(payable(msg.sender), withdrawAmount);
    ...
    function getContractBalance() public view returns (uint256) {
        return emcToken.balanceOf(address(this));
    }
    ...
    function emergencyWithdraw() public onlyOwner {
        emcToken.transfer(msg.sender, emcToken.balanceOf(address(this)));
    }
}
