 ...
 *
*/
//Dev of berylbit camel launching with new tech
//Join our telegram! https://t.me/New_year_doge
...
contract NEWYEA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "New Year Doge";
    string private _symbol ="$NEWYEAR";
