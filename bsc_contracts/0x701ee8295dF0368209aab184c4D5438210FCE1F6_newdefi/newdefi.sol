...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x207CC68D7ac662DbCB74E7b4204bfa9322A30dC0;
...
contract newdefi is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x89d8C89020df892482A7A5B5B4e478B68e29b721;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Olivia";
    string private _symbol = "OLIV";
