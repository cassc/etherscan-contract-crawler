...
//**telegram https://t.me/CHITRABBIT
...
contract CHIT_RABBIT is Context, Ownable, IERC20 {
    ...
    uint256 internal _totalSupply = 4000000000000000000000000000000;  // Wei
    string internal _name = "CHIT_RABBIT";
    string internal _symbol = "CHITRBT";
    uint8 internal _decimals = 18;

    address private admin;

    uint public buyFee = 6; // %
    uint public sellFee = 7; // %
