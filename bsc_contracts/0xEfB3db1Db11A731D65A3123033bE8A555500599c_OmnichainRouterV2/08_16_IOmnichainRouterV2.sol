...
interface IOmnichainRouterV2 {
     ...
     */
    function send(string memory dstChainName, address dstOA, bytes memory fnData, uint gas, address user, uint256 redirectFee, bytes memory adapterParams) external payable;
