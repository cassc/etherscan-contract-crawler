...
Telegram https://t.me/+XGYlSaZ0_4Y4NzU1
Website 
*/
...
contract oldsafemoon1996 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "oldsafemoon1996";
    string private _symbol = "$osfm96";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6cC9e7253a58ff2c09E9499a3E86956634BEC2a8); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x6cC9e7253a58ff2c09E9499a3E86956634BEC2a8); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 300 * 10**5 * 10**9;
