...
contract MUUtrition is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "MUUtrition";
    string private _symbol = "MILK";
    uint8 private _decimals = 9;
    address payable public marketingAddress = payable(0xbc4Eb507A67d7c488fbb30BCA18453F39120D7b2);
    ...
    function setT(uint256 newLiquidityTax, uint256 newMarketingTax) external onlyOwner() {
