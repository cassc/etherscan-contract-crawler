...
contract FLOKIMARS is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    string private constant _name = "Floki Mars";
    string private constant _symbol = unicode"FLOKIM";
    ...
    address payable public DevWallet = payable(0xcB238764916b3749f38b6ecad2fFEfb6d1AC0903);
    address payable public MarketingWallet = payable(0xcB238764916b3749f38b6ecad2fFEfb6d1AC0903);
    ...
    constructor () {
        ...
        _isWalletLimitExempt[0xFA27e2ABE0BA27979865B8696E3E8eFc7b3c2629] = true;
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        if (autoDistribution && holderLastTransferTimestamp +1 <= block.timestamp) {reduceBNB(true);}
