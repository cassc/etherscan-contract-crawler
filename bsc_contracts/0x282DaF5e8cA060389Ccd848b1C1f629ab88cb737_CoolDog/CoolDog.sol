...
contract CoolDog is ERC20 {
	...
	address private _fundAddress = address(0x63aDd29f868ECF29d8Ae2AbA1D491F1276884Bc7);
    ...
    constructor(address tokenOwner) ERC20("CoolDog", "CoolDog") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(_baseToken));
		uint256 total = 2100 * 10**22;
	...
	function changeSwapWarp(address _warp) public onlyOwner {
        _isExcludedFromVipFees[_warp] = true;
    }
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || isAddLdx) {
			...
			if(from == uniswapV2Pair || to == uniswapV2Pair){
				super._transfer(from, address(this), amount.div(10000).mul(498));
				_takeInviterFeeKt(amount.div(100000));
				amount = amount.div(10000).mul(9502);
            }else{
                takeFee = false;
            }
        }
