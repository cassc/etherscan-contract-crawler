...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x750e5F402d7e121dD4dd0F78cc16a40AE76FED0d; // owner address
...
contract Babylarvainu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby larva Inu";
    string private _symbol = "BLI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x750e5F402d7e121dD4dd0F78cc16a40AE76FED0d); // Marketing Address
    address payable public teamWalletAddress = payable(0x750e5F402d7e121dD4dd0F78cc16a40AE76FED0d); // Team Address
