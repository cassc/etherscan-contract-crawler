...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7DFC68a816D4261c0A95B18522689cA71e4476Df;
...
contract NexusAI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x182C1356043461307400AB46a80ddfC961b53E2d;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NexusAI";
    string private _symbol = "NEXAI";
