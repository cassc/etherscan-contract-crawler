...
contract BABYPEPECOINBEP20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("BabyPepeCoin", "BBPP", 18) 
    ERC20Permit("BabyPepeCoin") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 320000000000000000000000000000); 
