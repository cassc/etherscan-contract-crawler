...
contract DynastyExchangeVentures is Context, Ownable {
    ...
    function Deposit(address _upline, uint256 amount) external {
        require(amount >= 20 ether, "Minimum Deposit is 20 USDT!");
    ...
    function Reinvest() external {   
        ...
        require(player.dividends >= 10 ether, "Minimum reinvest is 10 USDT.");
    ...
    function Payout() external {      
        ...
        require(player.dividends >= 10 ether, "Minimum payout is 10 USDT.");
