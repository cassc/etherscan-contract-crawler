...
contract PythonChain is Context, IERC20, Ownable {
    ...
    string private _name = "Python Chain";
    ...
    address payable public marketingWalletAddress = payable(0x64e80110BE1202BF1dC71321e8A97dF58445C922); // Marketing Address
    address payable public teamWalletAddress = payable(0xAFf778edDb14e6b6328a4D54a1a9d7fd53E20C45); // Team Address
