...
/**
6% Pepe Rewards
https://t.me/ThePepeFatherBSC

Rewards CA: 0x9498c4383406A5bDD9100cFF3fE0B550A111dD3D
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTCB = IBEP20(0x9498c4383406A5bDD9100cFF3fE0B550A111dD3D);
...
/* Token contract */
contract ThePepeFather is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BTCB = 0x9498c4383406A5bDD9100cFF3fE0B550A111dD3D; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xC8b631080d30542AEc4ef034F29dc96Bb451aB37;
    ...
    // Name and symbol
    string constant _name = "The PepeFather";
    string constant _symbol = "TPF";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 250 / 10000; // 2% (200 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 250 / 10000; // 1% (100 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 250 ) / 10000; // 2% (200 mil)
    ...
    uint256 public totalFeeSell = 18;
