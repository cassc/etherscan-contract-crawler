...
contract BaseChatGPT is IERC20, Ownable {
...
contract ChatGPT is BaseChatGPT {
    bool private inSwap;
    ...
    constructor() { 
        ...
        address ReceiveAddress = 0x33761787f4B5dd311277A971b66570e211111111;

        _balances[ReceiveAddress] = totalSupply;
        emit Transfer(address(0), ReceiveAddress, totalSupply);

        fundAddress = 0x33761787f4B5dd311277A971b66570e211111111;
