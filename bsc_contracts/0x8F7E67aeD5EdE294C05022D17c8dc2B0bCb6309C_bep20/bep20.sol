...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0bf4e5Cc3B2E980fe7872bea96bc12F2f434F2d6; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "New Bitcoin Bsc";
    string private _symbol = "newbtc";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0bf4e5Cc3B2E980fe7872bea96bc12F2f434F2d6); // Marketing Address
    address payable public teamWalletAddress = payable(0x0bf4e5Cc3B2E980fe7872bea96bc12F2f434F2d6); // Team Address
