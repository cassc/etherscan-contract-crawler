...
/**
Telegram   : https://t.me/SmartNetworkCom
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfdb9D74Cf418bf3c2A2D0F78f0e2b0029550fAcB; 
...
contract ESpeed is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SmartNetworK";
    string private _symbol = "SNK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6bf17A0A2F79105266fAC342AEd83Ed4FaC0E54d); // 
    address payable public teamWalletAddress = payable(0x6bf17A0A2F79105266fAC342AEd83Ed4FaC0E54d); // 
