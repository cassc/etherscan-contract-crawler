...
contract WC is
    ...
    ERC1155Supply
{
    string public name = unicode"⚽ World Cup 2022 - currentpot.com";
    ...
    constructor(
        ...
        ERC1155("ipfs://QmVSrC5ZoJDthxvPeXD3QLv6T4La9TaGSPouBK48dEdn1u/")
        VRFV2Consumer(
            subscriptionId,
            _VRFConsumerBaseV2,
            _callbackGasLimit,
    ...
    function setWinner(uint256 teamId) public onlyRole(MANAGEMENT_ROLE) {
        ...
        winsPerShare = totalContribution / totalShares;
