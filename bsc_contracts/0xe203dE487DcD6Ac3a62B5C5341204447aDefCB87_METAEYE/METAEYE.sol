...
contract METAEYE is ERC20, ERC20Detailed, Pausable {

    using SafeMath for uint256;
    uint256 tokenBalance;
    uint256 deployTime;
    uint256 maxSlotTime = 5256000; // 10 years
    ...
    constructor()
    ERC20Detailed("METAEYE.FINANCE", "MTY",18)
    {
        deployTime = block.timestamp;
        RemainingReward = 9000000*(10**18);
        _isExcluded[msg.sender] = true;
        _isExcluded[address(this)] = true;
        _mint(owner(),(1000000*(10**18)));
        _mint(address(this), 9000000*(10**18));
