...
contract FegCeo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Feg Ceo";
    string private constant _symbol = "FegCeo";
    ...
    function AntiBot(address[] calldata addresses) external onlyOwner {
