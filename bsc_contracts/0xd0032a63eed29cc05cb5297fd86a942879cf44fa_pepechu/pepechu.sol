...
// Symbol           : PEPECHU
// Name             : PEPE CHAIN UNIVERSE
// Total supply     : 1,000,000,000,000
// Decimals         : 18
// Telegram Group   : https://t.me/pepechubsc
// Twitter          : @pepechuniv
// Website          : https://pepe-chain.pro 
...
contract pepechu is Context, IERC20, Ownable {
    ...
    string private _name = unicode"Pepe Chain Universe";
    string private _symbol = unicode"PEPECHU";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x798540aADb86cD43588543D194396370af172bB7); 
    address payable public BurnedWalletAddress = payable(0x992a3bAb9b57D9A58223ddbfB42DD62FC09C5E85); 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 20 / 1000;  
