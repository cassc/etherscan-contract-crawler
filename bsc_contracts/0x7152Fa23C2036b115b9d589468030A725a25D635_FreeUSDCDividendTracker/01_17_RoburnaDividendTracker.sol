...
contract FreeUSDCDividendTracker is Ownable, DividendPayingToken, ERC20TokenRecover, IRoburnaDividendTracker {
    ...
    constructor(address dividendToken, address _parentToken)
        DividendPayingToken("FreeUSDC Dividend Tracker", "FREEUSDcDT", dividendToken)
    {
        claimWait = 3600;
