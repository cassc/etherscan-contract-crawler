...
/**
 * @title OnAvaxArtTradablePrivate
 * OnAvaxArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract OnAvaxArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // OnAvax Marketplace contract
    address marketplace;
    // OnAvax Bundle Marketplace contract
    ...
    {
        // Whitelist OnAvax marketplace, bundle marketplace contracts for easy trading.
