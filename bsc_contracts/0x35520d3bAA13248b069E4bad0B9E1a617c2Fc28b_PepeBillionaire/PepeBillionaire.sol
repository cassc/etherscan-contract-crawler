...
contract PepeBillionaire is Ownable, IBEP20 {
    ...
    string constant _name = "Pepe Billionaire";
    string constant _symbol = "PEPEBN";
    ...
    uint256 public percentForLPBurn = 20; //.10% LP burn
    ...
    uint256 private swapThreshold = _totalSupply * 25 / 1000;
    bool inSwap;
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0xa76DAc9ad5149f5f96F7EE6C1f90d497C68C2c93;
