...
/*
EasterBTC is a meme token built on binance smart chain, base on the festive period and the BTC pump XD. Gg don't fade the Easter hip 

https://t.me/+wd4_z-uw-kk2MGU1

🔐 LIQUIDITY LOCKED
🟩 Renounced contract 🟩
🏡 PURE COMMUNITY DRIVEN-TOKEN
🔥NEXT MOONS
*/
...
contract Easterbtc is IBEP20, Auth {
    ...
    address constant DEV = 0xe4Ab4a6BD327dA6fa3472F5cb309818683875d20;


    string constant _name = "EasterBTC";
    string constant _symbol = "$EBTC";
    uint8 constant _decimals = 18;

    uint256 constant _totalSupply = 1000000000 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 5 / 1000;
    uint256 public _maxSellTxAmount = _totalSupply * 5 / 1000;
