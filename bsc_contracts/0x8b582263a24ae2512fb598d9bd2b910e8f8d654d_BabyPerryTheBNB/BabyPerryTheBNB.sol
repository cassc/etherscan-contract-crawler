...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x699197f60b5a5Baae1d0d0bE42bc09605Fc61E43;
...
contract BabyPerryTheBNB  is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Baby Perry The BNB";
    string private _symbol = "BabyPerry";
