...
contract BallerGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BallerGPT";
    string private _symbol = "BallerGPT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4BdF35FFd0e50F6699a013Ae9c954bff7A427c02); // Marketing Address
    address payable public teamWalletAddress = payable(0x54FC1Da26d812C194480B4Aa9b1Db19F4B3D0020); // Team Address
