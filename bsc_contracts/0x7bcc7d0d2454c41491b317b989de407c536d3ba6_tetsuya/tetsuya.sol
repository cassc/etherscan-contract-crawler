...
contract tetsuya is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 40_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "Tetsuya"; // 
    string private constant _symbol = "TSUYA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE4D328de425F7Ebf36bE480B510A710124CbD340;
