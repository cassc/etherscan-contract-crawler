...
contract ZUSDTrade is Ownable {
    ...
    bool public enableLP = false;
    uint256 public priceAdj = 100;
    ...
    function sellAmount(uint256 _amount) public view returns (uint){
        ...
        return _amount*curPrice*(10000 - mainToken.getTaxPercent())/10000/10**8;
    }
    ...
    function getPriceToken() public view returns (uint){
        uint256 price = pancakeRouter.getAmountsOut(100,path)[1]/priceAdj;
        return price;
    }
