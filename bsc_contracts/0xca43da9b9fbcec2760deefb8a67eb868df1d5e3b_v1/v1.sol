...
"Elon Musk might like the name Stellarion for a few reasons. First, "stellar" refers to anything 
related to stars or space, which would align with his interest in space exploration and his 
company SpaceX. The suffix "-ion" often implies a sense of action or motion, which could evoke 
the idea of exploring the cosmos and pushing the boundaries of what is possible."

"Additionally, the name Stellarion has a unique and memorable quality that could make it stand 
out among other space-related names. It also has a futuristic sound to it, which could appeal 
to Musk's vision of advancing space exploration and making life multi-planetary."

"Ultimately, the name Stellarion might resonate with Musk's interests and vision for space 
exploration, and its distinctiveness and futuristic sound could make it a strong contender 
for a space-related brand name or company name."
...
contract v1 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Stellarion"; // 
    string private constant _symbol = "STELLARION"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x36E4c2d75Ff14C14a70C4E0370d8a70d5A712F64;
