...
contract SheikhBebe is Context, IERC20 {
    ...
    string private _name = "Sheikh Bebe";
    string private _symbol = unicode"$SheikhBebe";
    ...
    uint256 public _maxWalletToken = _tTotal * 40 / 100;
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0xfcC60c84ef731b680232C3CB1fCD701fAC739e90);
