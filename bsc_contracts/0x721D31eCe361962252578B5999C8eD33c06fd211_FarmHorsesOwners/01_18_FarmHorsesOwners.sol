...
contract FarmHorsesOwners is ChainlinkClient, ConfirmedOwner, ReentrancyGuard {
    using Chainlink for Chainlink.Request;    

    
    uint256 public fee;    
    uint256 public fee_bnb = 2000000000000000;
    ...
    address operator = 0xcF331459281820c4594552a1D7a9196a3e4f2bfF; // BSC MAINNET
    // address operator = 0xcF331459281820c4594552a1D7a9196a3e4f2bfF; // BSC TESTNET
    ...
    constructor() ConfirmedOwner(msg.sender) {
        ...
        fee = (1 * LINK_DIVISIBILITY) / 1000; // 0,001 * 10**18 (Varies by network and job) // BSC MAINNET
     ...
     */
    function claimOwner()  public payable nonReentrant {
        require(msg.value == fee_bnb, "Incorrect BNB fee");
        ...
        (bool success,) = payable(operator).call{value: address(this).balance}("");
    ...
    function setFeeBnb(uint256 _fee_bnb) public onlyOwner {
        fee_bnb = _fee_bnb;
    }
