...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd3C6D12E23778251Ce69433FaA6C85c3e7991B62;
...
contract Kartel is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2Ee5291d7cd19c7d4938d94FeF29eD1196Af3566;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 450000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Kartel";
    string private _symbol = "Kartel";
    ...
    uint256 public _maxTxAmount = 450000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 450000000 * 10**18;
