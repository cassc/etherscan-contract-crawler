...
contract Pepecoin is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x6705eE16AeBa720F0351D04E774e91dBBEbaaffE);

    string public _name = "PepeCoin";
    string public _symbol = unicode"PepeCoin";
    uint8 private _decimals = 9;
    uint256 public _tTotal = 420000000000 * 10 **_decimals;

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;
     
    uint256 private fee_totals = 4;
    uint256 public buying_fee = 2;
    uint256 public selling_fee = 2;
    ...
    uint256 public _maxWalletToken = _tTotal.mul(6).div(100);
