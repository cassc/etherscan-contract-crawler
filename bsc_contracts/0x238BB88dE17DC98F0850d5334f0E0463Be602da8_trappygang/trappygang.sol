...
contract trappygang is ERC721A, Ownable, ReentrancyGuard {
 using Strings for uint256;
 uint256 public constant Max_Supply = 9999;

 string contractmeta = "ipfs://QmVMMXJwdxdCJwDh5zdF8frNS695h3xdnM8dphUvxCJu2e";

 string private _baseTokenURI = "ipfs://QmfLQWcZfHhvtC2cnGF95qkudMCtBbrEGMBorq7aXmC86Y/";
 ...
 constructor () ERC721A("trappygang", "tgng") {
 ...
 function findPrice() pure public returns (uint256) {
 uint256 _price = 0;
 return _price;
 }
