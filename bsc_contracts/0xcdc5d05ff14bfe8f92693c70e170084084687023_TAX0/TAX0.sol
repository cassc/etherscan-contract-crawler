...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2377896DDDCAC043470dB92c8E66A34DE65886C6; // owner address
...
contract TAX0 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tax0-0";
    string private _symbol = "00";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2377896DDDCAC043470dB92c8E66A34DE65886C6); // Marketing Address
    address payable public teamWalletAddress = payable(0x2377896DDDCAC043470dB92c8E66A34DE65886C6); // Team Address
