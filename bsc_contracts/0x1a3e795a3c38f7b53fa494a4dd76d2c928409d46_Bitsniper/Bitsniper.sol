...
contract Bitsniper is ERC20, Ownable {
    ...
    {   
        transferOwnership(0xE90bDD11caf8dd32f4df104faD77459525d47499);
        ...
        walletToWalletTransferFee = 7;

        developmentWallet = 0x2F84054509f85fEbFEd81Eee4abc689ad4C08D15;
        marketingWallet   = 0x31076D783a5aBb08fDa53A2f23E6e9CB497A66b1;
        stakingWallet     = 0x7606b0347c10DE4Edb7aBAAC4634Fff19B241BDB;
    ...
    function updateBuyFees(uint256 _developmentFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _stakingFeeOnBuy) external onlyOwner {
        require(_developmentFeeOnBuy + _marketingFeeOnBuy + _stakingFeeOnBuy <= 10, "Buy Fees cannot be more than 10%");
    ...
    function updateSellFees(uint256 _developmentFeeOnSell, uint256 _marketingFeeOnSell, uint256 _stakingFeeOnSell) external onlyOwner {
        require(_developmentFeeOnSell + _marketingFeeOnSell + _stakingFeeOnSell <= 10, "Sell Fees cannot be more than 10%");
