...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa9C763039370b167F69e419E9E79747eb95C9368; // owner address
...
contract HoopNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Hoop Network";
    string private _symbol = unicode"HOOP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa9C763039370b167F69e419E9E79747eb95C9368); // Marketing Address
    address payable public teamWalletAddress = payable(0xa9C763039370b167F69e419E9E79747eb95C9368); // Team Address
