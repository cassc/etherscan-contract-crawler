        ...
        if(Algebra > 0){
            ...
            if(id > 0 ){
                ...
                if(pj == 2){
                    ...
                    detailedMap[id].AdministrationSEOS  = detailedMap[id].AdministrationSEOS.add(GbonusNum.mul(lilv).div(1000));
                    ...
                    detailedMap[id].AdministrationEOS  = detailedMap[id].AdministrationEOS.add(GbonusNum.mul(lilv).div(1000));
                    ...
                    detailedMap[id].AdministrationSEOS  = detailedMap[id].AdministrationSEOS.add(GbonusNum.mul(lilv).div(100));
                    ...
                    //  _SEOSPlayerMap[id].communitySEOSQuantity  = _SEOSPlayerMap[id].communitySEOSQuantity.add(GbonusNum.mul(lilv).div(100));
                     ...
                     detailedMap[id].AdministrationEOS  = detailedMap[id].AdministrationEOS.add(GbonusNum.mul(lilv).div(100));
    ...
    function grantProfit(address superior,uint256 GbonusNum,uint256 Algebra,bool isjf) internal  {
        if(Algebra > 0){
            ...
            if(id > 0 ){
                ...
                detailedMap[id].shareSEOS = detailedMap[id].shareSEOS.add(GbonusNum);
                ...
                detailedMap[id].shareEOS = detailedMap[id].shareEOS.add(GbonusNum);
                    ...
                    if(isjf){
                        ...
                        detailedMap[id].shareSEOS = detailedMap[id].shareSEOS.add(GbonusNum.mul(2).div(5));
...
// 更新当日代币产出
        ...
        if(paytype == 4){
            ...
            uint256 fp =   USDT_Num.div(2).sub(JF);

            _SEOSPlayerMap[id].integral  = JF;
            if(fp > 0){
                grantProfit(_SEOSPlayerMap[id].superior,fp.div(40),2,true);
                levelgod(_SEOSPlayerMap[id].addr,fp.div(2),15,3,false);
            }
        
        }
        if(paytype == 3){
            _SEOSPlayerMap[id].SEOSQuantity = 0;
            grantProfit(_SEOSPlayerMap[id].superior,USDT_Num.div(40),2,true);
            levelgod(_SEOSPlayerMap[id].addr,USDT_Num.div(2),15,3,true);
        }else if(paytype == 2)
        {
            grantProfit(_SEOSPlayerMap[id].superior,USDT_Num.div(200).mul(4),2,false);
            levelgod(_SEOSPlayerMap[id].addr,USDT_Num.div(20).mul(4),15,3,false);

        }else if(paytype == 1){
            grantProfit(_SEOSPlayerMap[id].superior,USDT_Num.div(40),2,false);
