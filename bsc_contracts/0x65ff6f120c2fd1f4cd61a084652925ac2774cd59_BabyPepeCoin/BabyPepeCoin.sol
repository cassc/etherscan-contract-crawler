...
██████╔╝██║  ██║██████╔╝   ██║       ██║     ███████╗██║     ███████╗    ╚██████╗╚██████╔╝██║██║ ╚████║
╚═════╝ ╚═╝  ╚═╝╚═════╝    ╚═╝       ╚═╝     ╚══════╝╚═╝     ╚══════╝     ╚═════╝ ╚═════╝ ╚═╝╚═╝  ╚═══╝
https://t.me/BabyPepeCoinBSC
web coming soon.
First Baby Pepe coin with Pepe rewards thats 100% safu on BSC. 
Marketing push starts after launch. Lp will be burnt and ca will be renounced.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x0A97f12B90127A5025ba310b41A434445AcF5f8C);
...
contract BabyPepeCoin is IBEP20, Auth {
    ...
    address DEV = 0x46E3cFe534cb859eEf08982F5e4E2cd52735439e;

    string constant _name = "Baby Pepe Coin";
    string constant _symbol = "BPC";
