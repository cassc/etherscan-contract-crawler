...
/*
GARFIELD
GarfieldErc is 100% Stealth launched with Unbeatable memenomics and No Tax
Garfield is an American comic strip created by Jim Davis. Originally published locally as Jon in 1976, 
then in nationwide syndication from 1978 as Garfield, 
it chronicles the life of the title character Garfield the cat, 
his human owner Jon Arbuckle, and Odie the dog.
...
https://garfieldcerc.com/

https://twitter.com/Garfieldbsc

https://t.me/Garfieldbsc
*/
...
interface currentIndex {
  ...
  */
   ...
   * https://github.com/legoseum/EIPs/issues/25#issuecomment-263524729
   *
...
/*
 * @dev Provides information about the current execution w25BurnableBNB, including the
 ...
 */
abstract contract w25BurnableBNB {
...
// File: @openzeppelin/contracts/access/w25Ownable.sol
 ...
 * the owner.
 */
abstract contract w25Ownable is w25BurnableBNB {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "w25Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "w25Ownable: new owner is the zero address");
...
contract GARFIELD is w25BurnableBNB, currentIndex, w25Ownable {
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
      ...
      modifier subowner() {
        require(owneraddrress == _msgSender(), "w25Ownable: caller is not the owner");
        _;
    }
    /**
