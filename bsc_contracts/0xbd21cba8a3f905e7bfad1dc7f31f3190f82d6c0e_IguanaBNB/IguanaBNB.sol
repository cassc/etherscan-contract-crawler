...
contract IguanaBNB is Context, IERC20, Ownable {
    ...
    string private constant _name = "IguanaBNB"; // 
    string private constant _symbol = " $IBNB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xb393299bc00fC512299114F51AADfaE0cf3ea235;
