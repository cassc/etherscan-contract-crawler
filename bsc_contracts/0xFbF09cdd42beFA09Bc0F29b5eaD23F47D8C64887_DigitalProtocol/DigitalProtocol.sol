...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA73184123AC2b7c05A8a33d4462948e9e1b3668d; // owner address
...
contract DigitalProtocol is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Digital Protocol";
    string private _symbol = unicode"DigiPro";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA73184123AC2b7c05A8a33d4462948e9e1b3668d); // Marketing Address
    address payable public teamWalletAddress = payable(0xA73184123AC2b7c05A8a33d4462948e9e1b3668d); // Team Address
