...
contract OpenAuction is Context, IERC20, Ownable {
    ...
    string private constant _name = "OpenAuction"; // 
    string private constant _symbol = " $OPENAUCTION"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xeA7a61F2Eb91D42fCE4202f8f2373c8D78176945;
