...
contract MONKEYCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Monkey Ceo";
    string private _symbol = "MCEO";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x27d288c97b13F3368E147f81C338168539347f01); // Marketing Address
    address payable public teamWalletAddress = payable(0xd5E06F38519b439bAcFaFc3Fc0d1EbeA1219c840); // Team Address
    ...
    uint256 public _marketingShare = 34;
    uint256 public _teamShare = 4;

    uint256 public _totalTaxIfBuying = 7;
    uint256 public _totalTaxIfSelling = 38;
