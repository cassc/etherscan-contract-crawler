...
contract NOJEETS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NO JEETS ALLOWED"; 
    string private _symbol = "$NOJEETS"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc137d3CDB3aF20Ea167d7a583336C1C706839edB); 
    address payable public teamWalletAddress = payable(0xc137d3CDB3aF20Ea167d7a583336C1C706839edB); 
