...
// Portal Community : https://t.me/NaughtiusMaximusExclamation3
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 urREWARDS = IBEP20(0x00a964d6F740B5E000A3A6d2b8a6983717Ed5798);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = urREWARDS.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(urREWARDS);
        ...
        uint256 amount = urREWARDS.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            urREWARDS.transfer(shareholder, amount);
...
contract NaughtiusMaximusExclamation is IBEP20, Auth {
    using SafeMath for uint256;

    address urREWARDS = 0x00a964d6F740B5E000A3A6d2b8a6983717Ed5798;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Naughtius Maximus !!!";
    string constant _symbol = "$NaughtiusMaximus!!!";
