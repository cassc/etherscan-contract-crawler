...
// Join Our Group : https://t.me/@razyMonkCommunity                                                                                                   
...
contract CrazyMonk is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x9Da1491E927003fF21117f1aC2f63f336188355c); 
    address payable public Wallet_Dev = payable(0x9Da1491E927003fF21117f1aC2f63f336188355c);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "Crazy Monk"; 
    string private constant _symbol = unicode"CRAZYMONK"; 
    ...
    constructor () {
        _owner =0x9Da1491E927003fF21117f1aC2f63f336188355c;
