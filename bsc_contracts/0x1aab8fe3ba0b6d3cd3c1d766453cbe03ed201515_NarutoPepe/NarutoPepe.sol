...
contract NarutoPepe is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Naruto Pepe";
    string constant _symbol = "nPEPE";
    ...
    uint256 public extraFeeOnSell = 19;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x71b1e9b9BefdfDEb70b124705B4f2bb97B08EE6F;
