...
contract BabyChineseRabbit is ERC20, Ownable {

    uint256 public transactionFeeRate = 3; // 3% transaction fee on buy and sell
    uint256 public _maxTxAmount = 100000000 * 10 ** 18;
    address public marketingWallet = 0xC59e854c4Ee7353846BF5Ef6AE5bdF2599Cded4c; 

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("BabyChineseRabbit", "BABYCH") {
