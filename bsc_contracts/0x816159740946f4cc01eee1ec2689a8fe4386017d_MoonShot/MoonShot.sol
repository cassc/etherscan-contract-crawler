...
contract MoonShot is Context, IERC20 { 
    ...
    address payable public Wallet_Development = payable(0x8ddbB280ee3d817A46c69e87008E8498F89759Cc); // Building dApp
    address payable public Wallet_Team = payable(0x8ddbB280ee3d817A46c69e87008E8498F89759Cc); // Pay Team Shill - Raid
    address payable public constant Wallet_Burn = payable(0xC80369fB996dA77F78fc7CB897A2F149E401CB8C); // Burn Wallet
    address payable public constant Lp_Reciever = payable(0xC80369fB996dA77F78fc7CB897A2F149E401CB8C); // Salary Dev
    ...
    uint256 public Percent_Development = 20;
    uint256 public Percent_Team = 20;
    uint256 public Percent_Burn = 0;
    uint256 public Percent_AutoLP = 10;

    uint256 public _maxWalletToken = _tTotal * 30 / 1000; // 30 Millions
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal * 30 / 1000; // 30 Millions
    ...
    constructor () {
        ...
        _owner = 0xC80369fB996dA77F78fc7CB897A2F149E401CB8C;
        ...
        _isExcludedFromFee[Lp_Reciever] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_M = contractTokenBalance * Percent_Development / 100;
            ...
            uint256 split_M = Percent_Development * 100 / (Percent_AutoLP + Percent_Development + Percent_Team);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Team * 100 / (Percent_AutoLP + Percent_Development + Percent_Team);
            ...
            sendToWallet(Wallet_Development, BNB_M);
