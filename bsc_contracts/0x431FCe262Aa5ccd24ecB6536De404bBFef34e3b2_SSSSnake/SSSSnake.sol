...
contract SSSSnake is Context, IERC20, Ownable {
    ...
    string private constant _name = "SSSSnake";
    string private constant _symbol = "SSSS";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x61516cd04f7b9a0C18bfA552Fd75AafA716C4D0e;  
