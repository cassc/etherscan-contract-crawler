...
library Address{
 ...
 contract NPCBlockCoin is Context, IERC20, Ownable {
    ...
    address public walletMarketing = 0xC7D8AFB755e266CA6482344A76E0Ed29bDeDDf8A;
    address public walletDevelopment = 0x92358736E181319055a23ADf9649544f03e8DaF0;

    string private constant _name = "NPC Block";
    string private constant _symbol = "NPCB";
    ...
    Taxes public taxFeeBuy = Taxes(1, 1, 1, 1);
    Taxes public taxFeeSell = Taxes(1, 1, 1, 1);
    ...
    function rescueBNBFromContract(uint256 weiAmount) external onlyOwner{
