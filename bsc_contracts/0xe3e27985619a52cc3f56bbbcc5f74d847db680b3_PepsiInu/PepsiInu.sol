...
/*
百事可樂是世界上最著名的飲料公司。
Pepsi Inu 的誕生是為了為狗模因令牌創建一個新的生態系統，並將其與百事可樂相結合。
有了強大的社區，我們可以輕鬆地將這個代幣推向月球

Telegram : https://t.me/PepsiInuOfficial
*/
...
contract PepsiInu is ERC20, Ownable {
    ...
    constructor() ERC20("Pepsi Inu", "PINU") {
        ...
        maxTransactionAmount = 4 * 1e10 * 1e18; 
        maxWallet = 4 * 1e10 * 1e18; 
        ...
        devWallet = address(0xfA7D3A2F547FaF47DE5F40Cf1D63Aec0449D7727); 
