...
/**
 *  Created By: https://t.me/dragneel168
...
abstract contract TYGToken is IERC20, Ownable {
    ...
    uint256 public checkBClistedBlockNumber = 1;
    ...
    function _transfer(
        ...
        if (antiBotEnable){
            if (startTradeBlock + checkBClistedBlockNumber < block.number){
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xDd3994ac23e6c0e58c211347111825cB5E31A0fF;
...
contract ShenLong is TYGToken {
    constructor() TYGToken(
        ...
        18,
        120000000,
        address(0xe745BfedfF921F348f71f573E8d3D562e2a373DF),
        address(0xDd3994ac23e6c0e58c211347111825cB5E31A0fF)
    ){
