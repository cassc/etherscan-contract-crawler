...
/**               
🔥🐰 Yakuza Bunny 🐰🔥
Telegram : https://t.me/Yakuzabunnybsc
Website : TBA
...
contract YakuzaBunny is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    YakuzaBunnyDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Yakuza Bunny", "Yakuza") {
        ...
        dividendTracker = new YakuzaBunnyDividendTracker(
            payable(this),
            router,
...
contract YakuzaBunnyDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    YakuzaBunny public YakuzaBunnyContract;
    ...
    constructor(
        ...
        defaultToken = token;
        YakuzaBunnyContract = YakuzaBunny(mainContract);
    ...
    function _transfer(
        ...
        require(false, "YakuzaBunny_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "YakuzaBunny_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main YakuzaBunny contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(YakuzaBunnyContract);

            uint256 prevBalance = YakuzaBunnyContract.balanceOf(address(this));
            ...
            {
                uint256 received = YakuzaBunnyContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    YakuzaBunnyContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
