...
contract Niotic is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 45000000 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Niotic";
    ...
    address payable public marketingWallet = payable(0x368baceD7D3a33499E7b63B74b4AC34ff7b30054);
