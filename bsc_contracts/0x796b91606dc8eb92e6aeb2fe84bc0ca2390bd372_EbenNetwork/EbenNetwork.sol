...
/*
/**
Telegram https://t.me/ebennetworkannouncemment
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd12fc214B650fc8262843386992146F402E1cD0a;
...
contract EbenNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EBEN NETWORK";
    string private _symbol = "EBEN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd12fc214B650fc8262843386992146F402E1cD0a);
    address payable public teamWalletAddress = payable(0xd12fc214B650fc8262843386992146F402E1cD0a);
