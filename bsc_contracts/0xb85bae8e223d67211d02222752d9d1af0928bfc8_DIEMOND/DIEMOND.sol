...
Welcome to the depths of the Afterworld.

Diemond is meme crypto currency here to bring some spice to the BSC space. Diemond will be a community token with the only purpose to take us to the afterworld, where Valhalla awaits. 
All taxes will be used for buybacks & marketing. 

We will be starting with a higher sell tax to punish the early jeets and will be lowered to 5-5 final.

#DIEMOND #DIE
https://t.me/diemond_bsc
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); //btc
...
contract DIEMOND is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "DIEMOND";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x392AB8e6ea19334c106C6238cCF4E37958d748a9;
        marketingWallet = 0x21021F765E01C673a7860Fc6a11C4922AB3cD5e1;  
        anothermarketingWallet = 0xb30E281CC6103fEa24D385FAbf3c83E3b0FaEA87;
