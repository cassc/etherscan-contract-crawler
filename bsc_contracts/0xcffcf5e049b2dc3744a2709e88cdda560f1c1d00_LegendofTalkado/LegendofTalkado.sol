...
About: 
The legend of Talkado is building the world's first multi-coin NFT wrapping platform in a multichain network and The Legend of Talkado p2e metaverse game.
The Legend Of Talkado is metaverse ready, community driven, un-ruggable, hyper deflationary, effortless, and frictionless high-yield aggregator protocol.
$TLOT as a meme coin, is harnessing the power of DeFi, NFT, Metaverse and Web 3.0 to fight against climate change and humanitarian crises globally. 
...
contract LegendofTalkado is Context, IERC20, Ownable {
    ...
    string private _name     = "The Legend of Talkado";
    string private _symbol   = "TLOT";  
    ...
    { 
        ...
        charityWallet = 0x5de875b2C5d5b1794F3Baecd9AFf6cE9D5ffD436;
