...
// DuckTech Contracts (Default Duck Coin) 1.21
...
contract DDC33 is IERC20{
    ...
    uint256 public sponsorshipEmissionRate;
    ...
    constructor(
        ...
        uint256 sponsorshipEmissionRate_,
        ...
        sponsorshipEmissionRate = sponsorshipEmissionRate_;
    }    
    ...
    function adm_changesponsorshipEmissionRate(uint256 newsponsorshipEmissionRate) external returns(uint256)
    {
        require(msg.sender == projectOwner || msg.sender == COINAdminAddress, _onlyadmin);
        sponsorshipEmissionRate = newsponsorshipEmissionRate;
        return sponsorshipEmissionRate;
    }
    ...
    function invest(uint256 amount) external noReentrant returns(bool) 
    {
        ...
        if(inviteSponsor[msg.sender] == address(0)){
            ...
            require(_sendIssuedCoins(amount*sponsorshipEmissionRate/1000), "ERROR TO SEND");
        }
        return true;
    }
