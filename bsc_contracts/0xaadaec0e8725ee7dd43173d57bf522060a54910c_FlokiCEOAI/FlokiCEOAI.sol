...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x603C151C87043BA908e6D815B0ea63a0eA23593e; // owner address
...
contract FlokiCEOAI is Context, IERC20, Ownable {
    ...
    string private _symbol = "FCAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x603C151C87043BA908e6D815B0ea63a0eA23593e); // Marketing Address
    address payable public teamWalletAddress = payable(0x603C151C87043BA908e6D815B0ea63a0eA23593e); // Team Address
