...
/**
🌐 Telegram Group: https://t.me/SuperMarioVerse 

🐦Twitter: https://twitter.com/SuperMarioVerse

📰Medium Page: http://medium.com/@supermarioverse

🖥 Sticker Pack: https://t.me/addstickers/SuperMarioVerse
*/
...
contract SuperMarioVerse is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'SuperMarioVerse';
    string private constant _symbol = '$SMV';
    ...
    uint256 swapTimes;
    bool swapping; 
    uint256 swapThreshold = ( _totalSupply * 100 ) / 100000;
    uint256 _minTokenAmount = ( _totalSupply * 100 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address public constant liquidity_receiver = 0x000000000000000000000000000000000000dEaD; 
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant marketing_receiver = 0xB386387E571939B67951159c9aC7d235eDCf8D85;
    ...
    function setFee (uint256 _fee,uint256 _sellFee) public onlyOwner{
        totalFee = _fee;
        sellFee = _sellFee;
    }
