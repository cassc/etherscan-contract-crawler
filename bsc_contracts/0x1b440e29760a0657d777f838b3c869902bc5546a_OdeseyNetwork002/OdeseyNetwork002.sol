...
/*
https://t.me/OdeseyNetwork
https://twitter.com/OdeseyNetworkOfc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD75Cc62125624ba149b756C1b33D445F168e5c8E; 
...
contract OdeseyNetwork002 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ODESEY NETWORK";
    string private _symbol = "ODSY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD75Cc62125624ba149b756C1b33D445F168e5c8E); 
    address payable public teamWalletAddress = payable(0xD75Cc62125624ba149b756C1b33D445F168e5c8E); 
