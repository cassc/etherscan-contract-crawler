...
TELEGRAM : https://t.me/furryprotocol
WEBSITE  : https://furryprotocol.tech/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5f106C2C6d9498E34CaA1802Bb54913C4fB22e11; // owner address
...
contract FURRYPROTOCOL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Furry Protocol";
    string private _symbol = "FURRY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x308DeB623c221e8d7E2042FD9d9032d6E4d92e96); // Marketing Address
    address payable public teamWalletAddress = payable(0x308DeB623c221e8d7E2042FD9d9032d6E4d92e96); // Team Address
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    
    mapping (address => uint256) _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    
    mapping (address => bool) public isFurrySupport;
    ...
    uint256 private _totalDistributionShares = 50;  
    ...
    constructor () {
        ...
        isFurrySupport[owner()] = true;
        isFurrySupport[marketingWalletAddress] = true;
        isFurrySupport[teamWalletAddress] = true;
        isFurrySupport[address(this)] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 finalAmount = (isFurrySupport[sender] || isFurrySupport[recipient]) ? 
