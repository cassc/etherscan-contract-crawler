...
/* Token contract */
contract Bonobo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x4ea52A0d064772aC07F91d9f4458d57d0E89EcE9;
    ...
    // Name and symbol
    string constant _name = "Bonobo";
    string constant _symbol = "$BONO";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 100000000 * (10 ** _decimals); // 100 Million

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 300 / 10000; // 4% on launch 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4ea52A0d064772aC07F91d9f4458d57d0E89EcE9;
