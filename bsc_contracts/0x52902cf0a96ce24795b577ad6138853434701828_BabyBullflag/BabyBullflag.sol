...
contract BabyBullflag is Context, IBEP20, Ownable {
    ...
    string private _name = "BabyBullFlag"; // token name
    string private _symbol = "BBF"; // token ticker  //contract by TechAddict90 YT
