...
Telegram https://t.me/aichristmasoffical
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8Bc0972A6141eD2AE8D15Cf656306386c7c8c1bC;
...
contract AICHRISTMAS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AI CHRISTMAS";
    string private _symbol = "AIC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8Bc0972A6141eD2AE8D15Cf656306386c7c8c1bC);
    address payable public teamWalletAddress = payable(0x8Bc0972A6141eD2AE8D15Cf656306386c7c8c1bC);
