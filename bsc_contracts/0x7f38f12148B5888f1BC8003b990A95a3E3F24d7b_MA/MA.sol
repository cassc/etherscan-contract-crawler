...
contract  MA  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Micro Aptos"; // 
    string private constant _symbol = unicode"$MAPT"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xE9042D3781e222367dC30Ee3D3C52823E5a0d2E6;
