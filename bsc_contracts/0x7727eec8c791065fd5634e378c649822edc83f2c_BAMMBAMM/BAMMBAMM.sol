...
/*
Telegram: https://t.me/bammbammflintstone

It's time for Bamm Bamm Flinstones to start his crypto journey and find treasures! 
Join him on his hunt for x1000 and be rich together!
*/
...
contract BAMMBAMM is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bamm Bamm"; //
    string private constant _symbol = "STONE"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address private _marketingWallet = 0x00665f6Fb56FcbDEbD1fe56901d85078B9abdf9A ;
