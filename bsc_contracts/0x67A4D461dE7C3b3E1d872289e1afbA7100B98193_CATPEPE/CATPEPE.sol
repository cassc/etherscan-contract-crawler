...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xe95a8Ba0f145f8A9eB73dC3B1987C5DE261F571B; // owner address
...
contract CATPEPE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xe95a8Ba0f145f8A9eB73dC3B1987C5DE261F571B); // Marketing Address
    address payable public teamWalletAddress = payable(0xe95a8Ba0f145f8A9eB73dC3B1987C5DE261F571B); // Team Address
