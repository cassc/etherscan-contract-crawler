...
contract CHECKBUF is IBEP20, Auth {
    ...
    string constant _name = "CHECKBUF";
    string constant _symbol = "CHECKBUF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply;  //no  max tx
    uint256 public _maxWalletSize = _totalSupply;  //no max wallet
    ...
    address private marketingFeeReceiver =0x0ac80480339d73fB15794FA8Bca5712eff4E3F26;
    address private teamFeeReceiver =0x0ac80480339d73fB15794FA8Bca5712eff4E3F26;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x0ac80480339d73fB15794FA8Bca5712eff4E3F26;
