...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6ed25D2b1C5d0d566c66E1C14f84d97563b90223; // owner address
...
contract LINDACEOTWITTER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Linda CEO";
    string private _symbol = "TWITTER";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x792e48333Bd2B972f6ECf6dd28e58Be7968f4104); // Marketing Address
    address payable private teamWalletAddress = payable(0x6ed25D2b1C5d0d566c66E1C14f84d97563b90223); // Team Address
