...
contract LUFFYBART is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Luffy Bart ";
    string private _symbol = " $BART " ;
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9030739723De7D5B219BF628914E8cE44BBF9503); 
    address payable public teamWalletAddress = payable(0x9030739723De7D5B219BF628914E8cE44BBF9503); 
