...
/**
TELEGRAM : https://t.me/BabySUIcommunity
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1DC22d3e8fE97535C7917d0E03B765e3300e5aCB; // owner address
...
contract BabySUI is Context, IERC20, Ownable {
    ...
    string private _name = "BabySUI";
    string private _symbol = "BSUI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x26046B9568c08dEd7C2871bb610e3F6c39D6410f); // Marketing Address
    address payable public teamWalletAddress = payable(0x1DC22d3e8fE97535C7917d0E03B765e3300e5aCB); // Team Address
