...
contract QuantumBNBTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QuantumBNBTiger";
    string private _symbol = "QuantumBNBTiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50aEc38BF6d0289f0FB3005caAA4DdFe09F9D146); // Marketing Address
    address payable public teamWalletAddress = payable(0x5Ae094e9F352A6719c783385d018159e9a3bFaA2); // Team Address
