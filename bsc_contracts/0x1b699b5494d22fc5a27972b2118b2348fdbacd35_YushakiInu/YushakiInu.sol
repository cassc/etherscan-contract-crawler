...
//Following the Inu hype, bullish name Yushaki Inu🐕 and big marketing planned, let's see how is this goes, We hope willing to push this to Millions!
//A lot of big callers will be supported us!
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x90189a29BCA3b40f2C21fd4D2c17b6EBaFA94944 ; //
...
contract YushakiInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "Yushaki Inu"; //    
