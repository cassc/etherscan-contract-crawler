...
// Twitter: https://twitter.com/HoppyInu
// STEALTH LAUNCH
...
abstract contract Auth {
    ...
    function setswap(address adr) public onlyOwner {
...
contract DividendDistributor is IDividendDistributor {
 ...
 contract RABBIT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Hoppy Inu";
    ...
    uint256 public swapThreshold = _totalSupply * 40 / 8000;
    bool inSwap;
