...
/**
hello HELLO 100x and elon musk support 
*/
...
contract ByDogeCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ByDogeCeo";
    string private _symbol = "ByDogeCeo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x64Cee229fb5Ef1A07a1537CaF166C25a272202ee); // Marketing Address
    address payable public teamWalletAddress = payable(0x64Cee229fb5Ef1A07a1537CaF166C25a272202ee); // Team Address
