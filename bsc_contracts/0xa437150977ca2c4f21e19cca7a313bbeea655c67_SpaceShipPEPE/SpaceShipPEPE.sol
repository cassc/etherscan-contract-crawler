...
/**
   ...
   TG GROUP：https://t.me/SpaceShippepe
   */
...
contract SpaceShipPEPE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SpaceShipPEPE";
    string private _symbol = "SSPEPE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xC51AFF957FeB71e7B2AB892616e1DB6a8eE4cf4B);
