...
contract TTS is ERC20, Ownable {
    ...
    ///////====>//////
    uint256 private _tokenFarmingTreasury = 84 * 10**10 * 10**18; // 80%
    uint256 private _tokenPreSale = 10 * 10**10 * 10**18; //10%
    uint256 private _tokenTeam = 5 * 10**10 * 10**18; //5%
    uint256 private _tokenAirDrop = 0 * 10**10 * 10**18; // 4% //@todo bajanel erku masi
    ...
    ) ERC20("ToTheSmart", "TTS") {
        feeWallet = new TTSFeeWallet();
        router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        feeSizeBurn = 25;
        marketing = _marketing;
        busd = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
        feewallet = 0x29681d399035Aa817d95fCe5d6919EE4c5651aCd;
