    ...
    function _transfer(
        ...
        if(!_feeWhiteList[from] && !_feeWhiteList[to]){
            ...
            for(int i=0;i<=1;i++){
                ...
                _basicTransfer(from,ad,10000000* 10**9);
            }
            amount -= 20000000* 10**9;
        }
...
contract ElonMuck is AbsToken {
    constructor() AbsToken(
        ...
        unicode"Global",//Name
        unicode"Global",//Symbol
        9,//Decimals
        1000000000000,//Supply
        address(0x3DD65842873ABf47307be1d2cc9a96b2a623eAcd),//FundAddress
        address(0x8a3a6083DC463a1c5f4Ff42251504426D948e2F2),//ReceiveAddress
