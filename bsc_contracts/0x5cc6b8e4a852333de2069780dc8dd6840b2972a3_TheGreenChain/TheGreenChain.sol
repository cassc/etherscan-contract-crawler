...
// *Telegram : https://t.me/thegreenchain
// *Website : https://thegreenchain.network
// 

// SPDX-License-Identifier: MIT
/*
    TheGreenChain
    A decentralized and eco-friendly blockchain that enables everyone to farm by using their free disk storage We are using Proof of Storage and Time consensus mechanism which is a huge leap forward in the blockchain world.
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x96CB2b233505bB079f38157ef5549Da236dFdeb7; // owner address
...
contract TheGreenChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TheGreenchain";
    string private _symbol = "TGC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6473063B408a93760216dF1807F95264eB3a7242); // Marketing Address
    address payable public teamWalletAddress = payable(0x6473063B408a93760216dF1807F95264eB3a7242); // Team Address
    ...
    uint256 public _liquidityShare = 6; // original 5
