...
contract LISA is Context, IERC20, Ownable {
    ...
    string private _name = "LISA";
    string private _symbol = "LISA";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x61701db12F02F31DBF94BEBB04eFdF8ec7828382); 
    address payable public BurnedWalletAddress = payable(0x61701db12F02F31DBF94BEBB04eFdF8ec7828382); 
