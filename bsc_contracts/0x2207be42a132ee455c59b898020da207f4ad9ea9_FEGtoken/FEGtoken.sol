...
contract FEGtoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "FEG token"; // 
    string private constant _symbol = " $FEGTOKEN"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xF21B59E21CBacC4c1C0a43ACe6863A3F1d19995A;
