            ...
            if (isAddLP) {
                ...
                if (destroyFeeAmount > 0) {
                    ...
                    if (destroyAmount > 0) {
                        ...
                        _takeTransfer(sender, address(0x5310C4462142B4b0f84d694589Ea105afF953A47), destroyAmount);
                    }
                }
...
contract SUIDAO is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000,
        address(0x5310C4462142B4b0f84d694589Ea105afF953A47),
        address(0x5310C4462142B4b0f84d694589Ea105afF953A47),
        address(0x5310C4462142B4b0f84d694589Ea105afF953A47),
        address(0xc41b38a432f99F7bd98b3dE9133c1588a3Aac936),
        10000,
        0,
        10000
    ){
