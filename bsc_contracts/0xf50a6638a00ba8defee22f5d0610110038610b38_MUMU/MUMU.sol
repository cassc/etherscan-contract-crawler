...
/**
*/
// https://t.me/Mumubep20              https://twitter.com/Mumubep20
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xca74CB2eaB27720af70a10300E70E0079024c940 ; // owner address
...
contract MUMU is Context, IERC20, Ownable {
    ...
    string private _name = "MUMU";
    string private _symbol = "$MUMU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xca74CB2eaB27720af70a10300E70E0079024c940); // Marketing Address
    address payable public teamWalletAddress = payable(0xca74CB2eaB27720af70a10300E70E0079024c940); // Team Address
