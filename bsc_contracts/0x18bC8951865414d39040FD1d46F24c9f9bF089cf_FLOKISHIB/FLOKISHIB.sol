...
contract FLOKISHIB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKISHIB";
    string private _symbol = "FLOKISHIB";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x96BACE187486480a01e0A1722D833474F0B87Da9); 
    address payable private teamWalletAddress = payable(0x96BACE187486480a01e0A1722D833474F0B87Da9); 
