...
contract sohi is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "sohi";
    string private _symbol = "sohi";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xdAFc94cAF0a26B712Ae1240929F82859037ffF57);
