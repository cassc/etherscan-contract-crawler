...
contract RamadanKareem is Context, IERC20, Ownable {
    ...
    string private constant _name = "RAMADAN KAREEM"; // 
    string private constant _symbol = "RAKA"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xa6A161A3dE5238392AD6BA199358Cde18097B0Bc;
