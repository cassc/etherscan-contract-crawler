...
// Telegram: https://t.me/magnetoinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4E1097d4BD09E1500B176D12B63E88ef066f8DE1;
...
contract MagnetoInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Magneto Inu";
    string private _symbol = "$MI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4E1097d4BD09E1500B176D12B63E88ef066f8DE1);
    address payable public teamWalletAddress = payable(0x4E1097d4BD09E1500B176D12B63E88ef066f8DE1);
    ...
    uint256 private minimumTokensBeforeSwap = 1500000 * 10**_decimals; 
