...
contract PICKLE is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal * 2 / 100; 
    uint256 public maxTxAmountSell = _tTotal * 2 / 100;  
    ...
    constructor() {
        ...
        treasuryAddress = payable(0xFCe7D792ec63D9A6421571f3ff5174614c10fa76);
    ...
    function setMaxTransactionAmount(
        ...
        maxTxAmountBuy = _tTotal * _maxTxAmountBuyPct/100;
        maxTxAmountSell = _tTotal * _maxTxAmountSellPct/100;
    }
    ...
    function manualSwapPercentage(uint256 tokenpercentage) external onlyOwner {
  	  swapTokensForETH((balanceOf(address(this))*tokenpercentage)/1000);
    ...
    function rescueAnyBEP20Tokens(address _tokenAddr, uint _amount) public  {
        IERC20(_tokenAddr).transfer(devAddress, _amount);
    }
    ...
    function setMaxWalletAmount(uint256 _maxWalletAmountPct) external onlyOwner {
        maxWalletAmount = _tTotal * _maxWalletAmountPct/100; 
