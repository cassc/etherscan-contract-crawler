...
contract Rabbit_Chicken is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Rabbit Chicken";
    string private _symbol = unicode"鸡王";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5d68235dBB48826B9CfEC73d9C7706A5a5f71929); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x5d68235dBB48826B9CfEC73d9C7706A5a5f71929); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 12000000 * 5 / 1000;
    uint256 public _walletMax = 12000000 * 1 / 100;
