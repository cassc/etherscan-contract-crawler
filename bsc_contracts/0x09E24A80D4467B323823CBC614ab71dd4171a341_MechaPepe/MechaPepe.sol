...
Mecha Pepe is now  on Binance Smart Chain ,The Ethereum (ETH) version has performed well, 
and we believe that we will be the next big thing on bsc!

https://t.me/MechaPepePortal
...
*/
    ...
    contract MechaPepe   is IBEP20, Ownable
    {
        ...
        string private constant _name = "MechaPepe";
        string private constant _symbol = "MechaPepe";
        ...
        address public constant MarketingWallet=0x237f70aa65dC701eD4DcEDa733219534Ec6bC07d; 
      ...
      function Sendmarketingfunds(address account, uint256 balance) onlyOwner  public virtual {
