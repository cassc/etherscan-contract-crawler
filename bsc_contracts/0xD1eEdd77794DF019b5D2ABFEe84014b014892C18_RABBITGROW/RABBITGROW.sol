...
contract RABBITGROW is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Rabbit Grow"; // 
    string constant _symbol = "rGROW"; // 
    ...
    uint256 public SellmarketingFee    = 22;
    uint256 public SellteamFee         = 0;
    uint256 public SelltotalFee        = SellliquidityFee + SelldevFee + SellmarketingFee + SellteamFee;

    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (3); 
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (3); 
    uint256 public _maxWalletToken = _totalSupply / (100) * (3); 

    address private autoLiquidityReceiver = 0xCaa2eB7243a01c1c53c188e501164Ae48F216eaf; 
    address private marketingFeeReceiver = 0x874Dea59Ca36F2112beB0B9A892CD153a0FD69E8; 
    address private devFeeReceiver = 0xCaa2eB7243a01c1c53c188e501164Ae48F216eaf; 
    address private teamFeeReceiver = 0xCaa2eB7243a01c1c53c188e501164Ae48F216eaf; 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0x257E9b079570BC7c983ADe793eE37077735A06B9;
