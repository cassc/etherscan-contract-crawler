...
contract MemeGold {
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        ...
        uint256 burnAmount = (amount * BURN_RATE) / 100000; // Calculate burn amount (0.001% burn rate)
    ...
    function claimTokens() public {
        ...
        if (_balances[msg.sender] == 0) {
            uint256 claimAmount = (_totalSupply * BURN_RATE) / 100000; // Calculate claim amount (0.001% burn rate)
