...
/**
 * @title OnAvaxNFTTradablePrivate
 * OnAvaxNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract OnAvaxNFTTradablePrivate is ERC721, Ownable {
