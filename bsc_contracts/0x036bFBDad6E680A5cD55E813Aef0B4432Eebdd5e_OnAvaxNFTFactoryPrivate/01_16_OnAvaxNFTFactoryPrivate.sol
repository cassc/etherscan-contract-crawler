...
import "./OnAvaxNFTTradablePrivate.sol";

contract OnAvaxNFTFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice OnAvax auction contract address;
    address public auction;

    /// @notice OnAvax marketplace contract address;
    address public marketplace;

    /// @notice OnAvax bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new OnAvaxNFTTradable contract
        ...
        returns (address)
    {
        ...
        OnAvaxNFTTradablePrivate nft = new OnAvaxNFTTradablePrivate(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering existing OnAvaxNFTTradable contract
    ...
    /// @notice Method for disabling existing OnAvaxNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
