...
contract McWojak is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x862DA8eA72a6b9bfC525D0A1e03D229444cb9707); // Marketing Address
    ...
    uint256 private _tTotal = 690000000 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "McWojak";
    string private _symbol = "MCWOJAK";
    ...
    uint256 public _maxTxAmount = 600000000 * 10**6 * 10**18;
    uint256 private minimumTokensBeforeSwap = 1 * 10**1 * 10**18; 
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x06Df02BB31151dA34611662d71a892130Ac3D89e)] = true;
