...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC1EF899660325fA5cf3dCe3178D859e3bFBEbC3a;
...
contract INDIANPEPE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3081F38B603648aA5a926C13990d51c5B66a6295;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "INDIAN PEPE";
    string private _symbol = "INDPEPE";
