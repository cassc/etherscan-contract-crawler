...
import { ERC20PairFee } from "./utils/ERC20PairFee.sol";

contract ERC20 is Context, IERC20, IERC20Metadata, ERC20PairFee {
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        (uint256 toAmount, uint256 fee) = calculateFee(from, to, amount);
        if (fee > 0) {
