...
contract dogewtf is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "doge.wtf";

    string private _symbol = "doge.wtf";

    uint8 private _decimals = 9;

    address public _marketingWallet = 0x28E71A02E0535E9337d4e3aE7Bf2dbCb130388fD;
