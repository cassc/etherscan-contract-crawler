...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFaCFcF92314DA99EB1dfCb68184F7417457eA022; // owner address
...
contract BattleOfCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Battle Of Coin";
    string private _symbol = unicode"BOC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFaCFcF92314DA99EB1dfCb68184F7417457eA022); // Marketing Address
    address payable public teamWalletAddress = payable(0xFaCFcF92314DA99EB1dfCb68184F7417457eA022); // Team Address
