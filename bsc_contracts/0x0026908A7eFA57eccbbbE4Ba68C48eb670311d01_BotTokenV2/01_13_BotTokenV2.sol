...
contract BotTokenV2 is ERC20, Ownable {
    ...
    constructor() ERC20("BOT", "BOT") {
        ...
        _configs[INITIAL_TOKEN_OWNER].isExcludedFromFee = true;
        _configs[INITIAL_TOKEN_OWNER].isExcludedFromMaxWalletAmount = true;
        _configs[INITIAL_TOKEN_OWNER].isExcludedFromMaxTxAmount = true;
        ...
        _mint(INITIAL_TOKEN_OWNER, MAX_SUPPLY);
