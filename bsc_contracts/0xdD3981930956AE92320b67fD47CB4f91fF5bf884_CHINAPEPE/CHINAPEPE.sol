...
// CHINA PEPE 🐸 is a Pepe Meme coin but with great hype
// Telegram : https://t.me/CHINA_PEPE                                                                                             
...
contract CHINAPEPE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb182f6EAb5cC869132Ba4E0391EDD516E4DaafC6); 
    address payable public Wallet_Dev = payable(0xb182f6EAb5cC869132Ba4E0391EDD516E4DaafC6);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "CHINA PEPE"; 
    string private constant _symbol = unicode"CHINAPEPE"; 
    ...
    uint256 public Percent_Burn = 16;
    ...
    constructor () {
        _owner =0xb182f6EAb5cC869132Ba4E0391EDD516E4DaafC6;
