...
/**
Welcome to 🦖🐸PEPE SAURUS🐸🦖

The most memeable memecoin in existence. The dogs have had their day, it’s time for Pepe Saurus to take reign.

Pepe Saurus Launch 14 May at 6:30 PM UTC

ABOUT
Pepe Saurus is tired of watching everyone play hot potato with the endless derivative ShibaCumGMElonKishuTurboAssFlokiMoon Inu coins. The Inu’s have had their day. It’s time for the most recognizable meme in the world to take his reign as king of the memes.
Bibi is here to make memecoins great again. Zero taxes, LP Locked and contract renounced, $PSAURUS is a coin for the people, forever. Fueled by pure memetic power, let $PSAURUS show you the way.
...
Join Our Pepe Saurus Community Now:

Telegram:
https://t.me/PepeSaurusBSC
*/
...
contract PepeSaurus is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "Pepe Saurus"; // token name
    string public _symbol = "PSAURUS"; // token ticker
    uint8 public _decimals = 9; // token decimals
    ...
    uint256 public minTokenToSwap = 100000000000 * 1e9; // 100k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 100000000000 * 1e9;
    uint256 public minBuyLimit = 100000000000 * 1e9;
    ...
    // buy tax fee
    uint256 private reflectionFeeOnBuying = 0;
    uint256 private liquidityFeeOnBuying = 0;
    uint256 private marketWalletFeeOnBuying = 0;
    uint256 private burnFeeOnBuying = 0;

    // sell tax fee
    uint256 private reflectionFeeOnSelling = 0;
    uint256 private liquidityFeeOnSelling = 0;
    uint256 private marketWalletFeeOnSelling = 0;
    uint256 private burnFeeOnSelling = 0;
