...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x58e86Ae42B9401C36ee73dffF09fBB7730c32f8E; // owner address
...
contract BABYHOBBESBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BABY HOBBES BSC";
    string private _symbol = "BAHOBBES";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x58e86Ae42B9401C36ee73dffF09fBB7730c32f8E); // Marketing Address
    address payable public teamWalletAddress = payable(0x58e86Ae42B9401C36ee73dffF09fBB7730c32f8E); // Team Address
