...
// 0 tax BSC gem 10000x Potential
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9796e4fADf327dD0B12889510c370216038Dd814; // owner address
...
contract Grimace is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x177551181ff90A0b121aE0ffee9f2d0E0B078221); 
    address payable public teamWalletAddress = payable(0x177551181ff90A0b121aE0ffee9f2d0E0B078221);
