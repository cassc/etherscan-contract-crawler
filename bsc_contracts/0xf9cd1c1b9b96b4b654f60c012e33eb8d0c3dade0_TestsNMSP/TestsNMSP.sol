...
contract TestsNMSP is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Nemesis PRO", "sNMSP", 9) ERC20Permit() {
    ...
    /**
        @notice increases sNMSP supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sNMSP
