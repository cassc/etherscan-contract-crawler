...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6ca2C4492957D15Fc7A14696ef114d8F2c0C0752;
...
contract KELA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6310e309A5DA90438685Dd121720a062f2Fd9F71;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KELA";
    string private _symbol = "KELA";
