...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x164F2aE8eFE372D8c219DfF159bf1ab37c4D117F; // owner address
...
contract Porteum is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Porteum";
    string private _symbol = unicode"PORT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x164F2aE8eFE372D8c219DfF159bf1ab37c4D117F); // Marketing Address
    address payable public teamWalletAddress = payable(0x164F2aE8eFE372D8c219DfF159bf1ab37c4D117F); // Team Address
