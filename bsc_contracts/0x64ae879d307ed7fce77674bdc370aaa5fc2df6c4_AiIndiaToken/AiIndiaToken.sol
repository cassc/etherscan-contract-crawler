...
/* 
⚔️Looking for new Hype and Bullish Project ? 👀

🅰🅸 🅸🅽🅳🅸🅰

🔜Let's start the year on the right foot, let's explode the market with Max x's 
🅰🅸 🅸🅽🅳🅸🅰 is HYPE AND BULLISH Celebration 🎉 to the  AI India Expo (Feb 2023) . and aims to spread awareness about crypto investments
...
💰  Rewards
🔥 Aggressive Burn
🔥 Tokenomics at Launch To avoid snip

Telegram : https://t.me/AiIndiaToken
website :https://humans.ai/
🔝 Previous ATH 386k MC (350x since launch)
...
abstract contract ContextBinanceAI {
...
contract OwnableBinanceAI is ContextBinanceAI {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBinanceAI: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBinanceAI: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract AiIndiaToken is ContextBinanceAI, BinanceAI, OwnableBinanceAI {
    ...
    string private _name = 'Ai India Token';
    string private _symbol = '$AII';
