...
/* Token contract */
contract TheBossBaby is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "The Boss Baby";
    string constant _symbol = "The Boss Baby";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 50) / 10000; // 1% on launch or 20k tokens
    uint256 public _maxSellTxAmount = (_totalSupply * 50) / 10000; // 0.5% or 10k tokens
    uint256 public _maxWalletToken = (_totalSupply * 100) / 10000; // 1% or 20k tokens
    ...
    uint256 public marketingFeeBuy = 13;
    ...
    uint256 public reflectionFeeSell = 11;
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xB73737b30a1A01da80131F55A99E88766E75f28C;
        devFeeReceiver = 0xB73737b30a1A01da80131F55A99E88766E75f28C;
