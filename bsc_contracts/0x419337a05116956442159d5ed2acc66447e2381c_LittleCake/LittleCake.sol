...
/*
Missed Cake? Don't miss Little Cake! Second chances dont come around often.
Is PancakeSwap safe? Has PancakeSwap been Audited?
See for yourself:
Check out these PancakeSwap security audits
Transparent:
We’re built on open-source software: our site and all our Smart Contracts are publicly visible for maximum transparency.
Our contracts are verified on blockchain explorers, so you know that what you see is what you get. Check them out here.
...
contract LittleCake is w20Burnable, currentIndex, w20Ownable {
