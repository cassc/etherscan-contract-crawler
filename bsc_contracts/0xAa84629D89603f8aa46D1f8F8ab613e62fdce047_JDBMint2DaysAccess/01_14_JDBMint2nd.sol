...
contract JDBMint2DaysAccess is ERC721, Ownable{
    ...
    uint256 public nftTypeIdentifier = 2;
    uint256 public _totalSupply;
    // 10% from total of 10000
    uint256 public discount = 1000; 
    uint256 public refPercent = 20;
    ...
    function validSubscription(address wallet) public view returns (bool) {
        ...
        if (mintDates[wallet] > 0) {
            valid = (block.timestamp <= (mintDates[wallet] + 3 days));
        }
