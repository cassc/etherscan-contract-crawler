...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEF06a182b2834024f427bE14D68bB12136774F4b;
...
contract Chewbacca is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1F53ED9Cd6078D8B497c1713649D2b1CEF98e1CF;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Chewbacca";
    string private _symbol = "Chewie";
