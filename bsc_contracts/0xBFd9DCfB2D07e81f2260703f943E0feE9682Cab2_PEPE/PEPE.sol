...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb1c6316D6209B56689b63F0b8f722796a95cB14e; // owner address
...
contract PEPE is Context, IERC20, Ownable {
    ...
    string private _name = "PEPE CEO";
    string private _symbol = "CEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb1c6316D6209B56689b63F0b8f722796a95cB14e); // Marketing Address
    address payable public teamWalletAddress = payable(0xb1c6316D6209B56689b63F0b8f722796a95cB14e); // Team Address
