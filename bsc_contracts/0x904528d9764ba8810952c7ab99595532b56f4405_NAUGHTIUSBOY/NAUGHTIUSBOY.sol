...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8Cf5b2489592f25E8e1ef909E1A3048E13fBF52c; // owner address
...
contract NAUGHTIUSBOY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Naughtius Boy";
    string private _symbol = "Naughtius Boy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01bE11582929e3Fd9C6eDc5B70e5bf479D3E7fB1); // Marketing Address
    address payable public teamWalletAddress = payable(0x01bE11582929e3Fd9C6eDc5B70e5bf479D3E7fB1); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 10;  // original 8
    uint256 public _totalTaxIfSelling = 10;  // original 8
    uint256 public _totalDistributionShares = 8;  // original 8
