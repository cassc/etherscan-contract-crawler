...
contract HeadGames is Context, IBEP20, Ownable {
    ...
    uint256 public maxWalletLimit = 10e9 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 3;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x99A69285DD282D5E5C32Fa61Ce9704800833f488;
    address public DevelopmentWallet = 0x5a24A49c9A5A601b391f0242A9Fd1E601eedC90f;

    string private constant _name = "Head Games";
    string private constant _symbol = "HEAD";
    ...
    Taxes public sellTaxes = Taxes(0, 4, 0, 0);
    ...
    function setTaxes(
        ...
        require((_rfi + _marketing + _liquidity + _Development ) <= 4, "Must keep fees at 4% or less");
