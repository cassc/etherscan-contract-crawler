...
contract ManekiPaws is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "ManekiPaws";
    string private _symbol = "Maneki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x83694dA30829fBC9F637A77a5a4685c4814C4c29); // Marketing Address
    address payable public teamWalletAddress = payable(0x83694dA30829fBC9F637A77a5a4685c4814C4c29); // Team Address
