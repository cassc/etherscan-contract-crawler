...
contract Xettiu2 is IERC20, Ownable {
    ...
    {
        (tTransferAmount, tFee, tLiquidity, tCharity, tBurn) = _getTValues(
            tAmount
        );
    ...
    function updateCharityFee(uint16 _sellCharityFee, uint16 _buyCharityFee)
        external
        onlyOwner
    {
        require(
