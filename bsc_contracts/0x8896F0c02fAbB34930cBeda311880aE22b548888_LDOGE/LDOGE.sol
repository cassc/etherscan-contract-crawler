...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _distributeInviteReward(address current, uint256 reward, address sender) private {
        ...
        if (fundAmount > 100) {
            ...
            _tokenTransfer(sender, fundAddress, fundAmount, false);
        }
    }
    ...
    uint256 public constant _lpRewardTimeDebt = 8 hours;
    ...
    uint256 public constant _dogeLPRewardTimeDebt = 24 hours;
...
contract LDOGE is AbsToken {
    ...
    //SwapRouter
        ...
        30000,
    //Receive
        address(0x62FAfB748a98E0a79f1DF041dC85c109568bBeda),
    //Fund
        address(0x480AdcFd0f9f148e20b7b32703A4D2c4Bc3035b7)
    ){
