...
contract SingularityInu is Context, IERC20, Ownable {
    ...
    string private _name = "Singularity Inu";
    string private _symbol = "SingularityInu";
    ...
    address public _marketingWallet =
        payable(address(0x994a8Fffd27209667EF63628c7A9150F97d33B91));
    ...
    uint256 public constant BLOCKCOUNT = 25; // Blacklist first 25 blocks buys Once Enable Trading is called
    ...
    uint256 private numTokensSellToAddToLiquidity = 300000000 * 10**18 * 10**18;
    ...
    constructor() {
        ...
        maxSellAmount = totalSupply().mul(500).div(100000); // 0.5% of the supply
        maxBuyAmount = totalSupply().mul(500).div(100000);// 0.5% of the supply
    ...
    function setBuyFee(uint16 market, uint16 Liquidity, uint16 tax) external onlyOwner {
        ...
        buyFee.taxFee = tax;
        uint256 totalBuyFee = market + Liquidity + tax;
        require(totalBuyFee < 20, "Buy fees should be less than 15%");
    }
    ...
    function setSellFee(
        ...
        sellFee.taxFee = tax;
        uint256 totalSellFee = liq + market + tax;
        require(totalSellFee < 20, "Sell fees should be less than 15%");
    }
