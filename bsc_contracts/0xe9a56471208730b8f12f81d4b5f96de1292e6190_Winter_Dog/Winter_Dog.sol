...
contract Winter_Dog is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 3_000_000 * 10**9;
    ...
    address public marketingWallet = 0x596A307eCfFCF451D19F72343102D340003B7EB0;
    ...
    Taxes public taxes = Taxes(8, 1);
    Taxes public sellTaxes = Taxes(8, 1);
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require(tokenLiquidityThreshold > 0, "tokenLiquidityThreshold sould be > 0");
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 amount) external onlyOwner {
        ...
        require(amount >= 10_000_000, "Cannot set max wallet amount lower than 1%");
