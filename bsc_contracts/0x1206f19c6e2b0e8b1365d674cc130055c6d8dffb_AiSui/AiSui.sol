...
/**
TG : https://t.me/aisuichat website: aisui.org
*/
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0xc432545671232Beea88B9E9470519e70A0dBDEbD;
...
contract AiSui is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Ai Sui";
    string constant _symbol = "AiSui";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 210000000000000000 * (10 ** _decimals);
    ...
    address public devFeeReceiver = 0x8d525A08d2b1daA55A6626581Dcd77207817b853;
    address public buybackFeeReceiver = 0x8d525A08d2b1daA55A6626581Dcd77207817b853;
