...
/**
 *https://t.me/ellu_p247
 *https://twitter.com/Ellu_P247
*/
...
/*
 ***Main features - subject to change until contract renouncement***
* 0 % Tax Fee (Holders)
* Total buy tax = 5%
* Total sell tax = 10%
* Max transaction = 250 million
* Max Wallet = 500 million
* Total Supply = 2,020,000,000,000
*/
 ...
 */
contract ELLU_P is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private constant _tTOTAL = 202 * 1e10 * 10**_DECIMALS;
    uint256 private _rTotal = (MAX - (MAX % _tTOTAL));
    uint256 private _tFeeTotal;
    uint256 public  maxWallet = 500 * 1e6 * 10**_DECIMALS;
     ...
     * construction.
     */
    string private constant _NAME = "ELLU P";
    string private constant _SYMBOL = "ELLU P";
    ...
    mapping (address => uint256) _balances;
     ...
     /**
     * @dev Percentage of charity fee
     */   
    uint256 public _buyCharityFee = 1;
    uint256 public _sellCharityFee = 2;

    address public charityWallet = 0x24ad17B3054AD1b2334346deae1700cF68CB27d3;
     ...
     * Whale actions.
     */       
    uint256 public _maxTxAmount = 250 * 1e6 * 10**_DECIMALS;
    ...
    constructor () {
        ...
        IPancakeRouter02 _pancakeswapV2Router = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //main- 0x10ED43C718714eb63d5aA57B78B54704E256024E 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 testnet
        ...
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyBurnFee).add(_buyCharityFee);
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellBurnFee).add(_sellCharityFee);
        ...
        maxWallet = 500 * 1e6 * 10**_DECIMALS;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender == pancakeswapV2Pair) {
            burnAmt = amount.mul(_buyBurnFee).div(100);
            charityAmt = amount.mul(_buyCharityFee).div(100);
            _buyLiquidityFee = _liquidityFee;
        }
        else if(recipient == pancakeswapV2Pair) {
            burnAmt = amount.mul(_sellBurnFee).div(100);
            charityAmt = amount.mul(_sellCharityFee).div(100);
            _sellLiquidityFee = _liquidityFee;
        }

        // For sell transactions, update burnAmt and charityAmt with the sell fees
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newBurnTax, uint256 newCharityTax) external onlyOwner() {
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newBurnTax, uint256 newCharityTax) external onlyOwner() {
    ...
    /**
     * @dev Call this function if required to set a different Charity wallet.
     *
     * Requirements:
     *
