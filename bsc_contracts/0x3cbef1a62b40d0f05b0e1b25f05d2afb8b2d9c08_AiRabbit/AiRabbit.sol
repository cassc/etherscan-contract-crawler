...
//AiRabbit is built by a well-known DEV, and has done several times as high as hundreds of times the increase in tokens
//AiRabbit是有知名的DEV打造，曾经做过多次高达几百倍涨幅的代币
//Tg：@AiRabbit2023CN  Launched at 5:00am utc on January 31, 2023
//电报群：@AiRabbit2023CN 北京时间2023年1月31号下午13:00准时公平发射
//Token:100000000000   pinksale lock 5%Token 95%+LP  lp lock 180Day 0/0Tax  Go buy to the moon
...
contract AiRabbit is Context, Ownable, IERC20, IERC20Metadata {
    ...
    uint256 public holderMax =  100000000000 * 1e18;
    ...
    function _transfer(
        ...
        if(block.timestamp <= startTime + oneday){
            // 24 limit
            require(balanceOf(to) + amount <= holderMax, "holding limit exceeded");
        }      
