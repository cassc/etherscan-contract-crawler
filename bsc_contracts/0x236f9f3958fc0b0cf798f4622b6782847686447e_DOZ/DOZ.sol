...
contract DOZ is Context, IERC20, Ownable {
    ...
    uint256 public bRate = 30;
    bool public swapAction = false;
    string private _name = "DOZ";
    string private _symbol = "DOZ";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address private _receive = address(0x63674a9cACd617aE2018e50AF4f7a4F17Fd88117);
    address _tokenOwner;
    ...
    constructor (address tokenOwner){
        ...
        _approve(address(this), address(0x55d398326f99059fF775485246999027B3197955), _tTotal.mul(200));
    ...
    function getBool(
        address from,
        address to
    )view public  returns(bool,bool,bool,bool,bool){
        return (
                !swapping,
                _tokenOwner != from,
                _tokenOwner != to,
    ...
    function swapAndLiquify() public {
        ...
        if(balance > _maxTxAmount){
			...
			// uint usdtBalance = IERC20(0x55d398326f99059fF775485246999027B3197955).balanceOf(address(this));
            IERC20(address(this)).transfer( _receive, balance );
        }
    }
        ...
        if (takeFee) {
            ...
            if(sender == uniswapV2Pair){
                _takeTransfer(
                    sender,
                    address(this),
                    tAmount.div(rateTotal.div(bRate)),
                    currentRate
                );
            }else{
                _takeTransfer(
                    sender,
                    address(this),
                    tAmount.div(rateTotal.div(rate)),
                    currentRate
                );
            }
            // _takeTransfer(
