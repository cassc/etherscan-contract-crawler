...
contract PROXIMITY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PROXIMITY", "PROX") {
        marketingWallet = payable(0x4CE2C18882427018eA8dC97008350E3d1E1729A6);
        devWallet = payable(0xC56a47Ab89A80b50DFD512FE8E7ca93D3d6a6695);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    PROXIMITY public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = PROXIMITY(mainContract);
