...
contract Pepenime is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepenime";
    string private constant _symbol = "Pepenime";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xC078f70a49C655b811c5AA73797739F0128059E7);
    address payable private _marketingAddress = payable(0x83a76E96888A56B6A92C43ed9aD235Ff369Cb507);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 2, "Redis cannot be more than 6.");
	    require(redisFeeOnSell < 2, "Redis cannot be more than 6.");
	    require(taxFeeOnBuy < 4, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 4, "Tax cannot be more than 6.");
