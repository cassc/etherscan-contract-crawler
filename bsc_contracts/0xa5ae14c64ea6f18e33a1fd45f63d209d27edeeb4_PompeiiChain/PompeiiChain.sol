...
// https://t.me/PompeiiChain
// https://pompeii-chain.space/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x12ea80cB82D70E0F701B51351342c07A3C544FF0; // owner address
...
contract PompeiiChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pompeii Chain";
    string private _symbol = "PPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12ea80cB82D70E0F701B51351342c07A3C544FF0); // Marketing Address
    address payable public teamWalletAddress = payable(0x12ea80cB82D70E0F701B51351342c07A3C544FF0); // Team Address
