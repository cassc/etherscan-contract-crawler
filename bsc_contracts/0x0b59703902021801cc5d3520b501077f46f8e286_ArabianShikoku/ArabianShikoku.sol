...
contract ArabianShikoku is Context, IERC20, Ownable {
    ...
    string private constant _name = "Arabian Shikoku";
    string private constant _symbol = "ARSHI";
