...
pragma solidity ^0.6.12;
    ...
    contract SPOOKYRIP is Context, IERC20, Ownable {
        ...
        string private _name = 'SPOOKY RIP';
        string private _symbol = 'SPOOKYRIP';
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x8CfC68c2a6c2d812a28E519A1968780D37667f2d, 'We can not exclude Uniswap router.');
