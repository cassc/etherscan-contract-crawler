...
contract SnakeMoon is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x28bD303180dB7E4189665294bC207fB49C600d5B); // Marketing Address
        
    address payable public teamAddress =
        payable(0x991647e9cFbC562975521CFe2F854a56624cC20f); // Team Address
        
    address payable public liquidityAddress =
        payable(0x991647e9cFbC562975521CFe2F854a56624cC20f); // Liquidity Address
    ...
    string private constant _name = "SnakeMoon";
    string private constant _symbol = "SnakeMoon";
