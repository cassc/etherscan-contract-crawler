...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "VAVA";
    string private _symbol = "VA";
    uint8  private _decimals = 18;

    uint256 private _taxFee = 4;
    uint256 private _previousTaxFee = _taxFee;

    uint256 private _elseFee = 6;
    uint256 private _previousElseFee = _elseFee;

    address public burnAddress = address(0x0000000000000000000000000000000000000000);
    address public mainAddres = address(0x6d0869C2b9b03929fBD88762f83575AC83b86c41);
    address public marketAddress = address(0x5d22148dF0F97f7c6E8EAB65A26c876F46f9E909);
    address public fundAddress = address(0xcCd9bEda875692c16C315840a12C0C1e558f0Ab2);
    address public liquidAddress = address(0x7559F700A101CC175140356403EF87840E075AEA);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if (balanceOf(burnAddress) < 100000000000000000000000000 * 10 ** 18 
        ...
        _takeLiquidity(sender, tElseFee / 4); 
        _takeBurn(sender, tElseFee / 4);      
        _takeMarket(sender, tElseFee / 4);   
        _takeFund(sender, tElseFee / 4);     
    ...
    function _takeInviterFee(
        ...
        uint8[8] memory inviteRate = [5, 5, 5, 5, 5, 5, 5, 5];
