...
/** 2% fee auto add to the liquidity 3%market 
  TO the Moon DAO？
  */
...
contract SS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8d1BfE7A0C8F1Eabd1CED06AF55aACf72d2790cc); 
    address payable public teamWalletAddress = payable(0x8d1BfE7A0C8F1Eabd1CED06AF55aACf72d2790cc); 
    ...
    uint256 private _totalSupply = 10* 10**9 * 5**_decimals;
