...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x58544FF43aa1C4c717Ec35799a2e05c3DEeFde47; 
...
contract SLOWCOIN is Context, IERC20, Ownable {
    ...
    string private _name = "SLOW COIN";
    string private _symbol = "SWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x12eCD1Cc4d1D8F236545538C13f68212B6D50A36); 
    address payable public teamWalletAddress = payable(0xc6c9CA738E0E3303f5313E32aC8d70e6d49D8894); 
