...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdD0Be42F0d9317008749ECd719D3904026E9b449; // owner address
...
contract Ghostshiba is Context, IERC20, Ownable {
    ...
    string private _name = "Ghost Shiba";
    string private _symbol = "GS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdD0Be42F0d9317008749ECd719D3904026E9b449); // Marketing Address
    address payable public teamWalletAddress = payable(0xdD0Be42F0d9317008749ECd719D3904026E9b449); // Team Address
