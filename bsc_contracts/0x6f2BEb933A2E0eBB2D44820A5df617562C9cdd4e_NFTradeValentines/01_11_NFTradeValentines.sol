...
contract NFTradeValentines is ERC1155, AccessControl {
    ...
    constructor() public ERC1155("") {
        _name = "A Valentine's Crush NFTrade Edition";
        _symbol = "ValentinesNFTrade";
    ...
    function addNFT(uint256 tokenId, string memory _tokenURI) external onlyRole(DEFAULT_ADMIN_ROLE) {
