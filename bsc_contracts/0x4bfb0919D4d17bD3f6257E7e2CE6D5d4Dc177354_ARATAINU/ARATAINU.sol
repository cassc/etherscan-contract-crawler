...
contract ARATAINU is Ownable, IERC20 {
    ...
    function changeFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newRefundFee, uint256 newNativeFee, uint256 extraSellFee) external authorized{
    ...
    function AuthorizeLPAdditionWallet(address target) public onlyOwner{
