...
/**
Telegram: https://t.me/wikiakitabsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7D6e2f760c46D37BA590526f09290c3A88aC1b7A; // owner address
...
contract WikiAkita is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Wiki Akita";
    string private _symbol = "WIKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7D6e2f760c46D37BA590526f09290c3A88aC1b7A); // 
    address payable public teamWalletAddress = payable(0x7D6e2f760c46D37BA590526f09290c3A88aC1b7A); // 
