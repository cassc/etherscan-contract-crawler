...
//https://t.me/DIGIMONSQUIDOFFICIAL
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5F123383a96DA3E8a698C829EED58196FAfCfbec; // owner address
...
contract DIGIMONSQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DigimonSquid";
    string private _symbol = "Dsquid";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe202aA8e5458d84f1f5f9b6d42439Aec64c85DDd); // Marketing Address
    address payable public teamWalletAddress = payable(0x9dcB4BED67Dcf43F881B6573bbacDCcd9ABFFC82); // Team Address
