...
// RED POWER RANGER CEO

// 0%TAX

// Telegram: https://t.me/RedPowerRangerCEO
...
contract POWERANGER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "RED POWER RANGER CEO";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "REDCEO";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x50d989A474bc8eD550563aCc598a6826dBFAedCA;
        marketingFeeReceiver = 0x50d989A474bc8eD550563aCc598a6826dBFAedCA;
