...
/*
Website : BillGatesBSC.com

Telegram : t.me/BillGatesBSC
*/
...
contract BILLGATES is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bill Gates", "BILLGATES") {
        ...
        maxBuyTransactionAmount = 40000000 * (10**18); // 4%
        maxSellTransactionAmount = 10000000 * (10**18); // 1%
    	...
    	marketingWallet = address(0x8dEb4904210381a19bBcB2f1e8D21Ac9956bc9Fe); // set as marketing wallet
    ...
    function setMaxWalletTokens(uint256 _maxToken) external onlyOwner {
     ...
     function setMaxBuytx(uint256 _maxBuyTxAmount) public onlyOwner {
         require(_maxBuyTxAmount >= totalSupply() * 1 / 100, "maxBuy token cannot be lower than 1% total supply.");
        maxBuyTransactionAmount = _maxBuyTxAmount;
    }

    function setMaxSelltx(uint256 _maxSellTxAmount) public onlyOwner {
        require(_maxSellTxAmount >= totalSupply() * 1 / 100, "maxSell token cannot be lower than 1% total supply.");
