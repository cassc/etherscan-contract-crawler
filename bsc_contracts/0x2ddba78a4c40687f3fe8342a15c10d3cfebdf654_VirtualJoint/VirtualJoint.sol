...
// https://t.me/virtual_joint_portal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7b0A63acF9f85e8Da00cC725289Fc2d89438BEEB;
...
contract VirtualJoint is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4BcF558E5Dc9dD71722434Ef87b37147CdDc8dBa;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Virtual Joint";
    string private _symbol = "VJ";
