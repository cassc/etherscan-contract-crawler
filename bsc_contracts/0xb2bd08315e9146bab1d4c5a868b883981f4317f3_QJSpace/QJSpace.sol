...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0xB0200e89121EF3AE697721BC32060cDD5Cf88B8c;//
...
contract QJSpace is AbsToken {
    constructor() AbsToken(
        ...
        unicode"QJSpace",//Name
        unicode"QJSpace",//Symbol
        9,//Decimals
        5500,//Supply
        address(0xB0200e89121EF3AE697721BC32060cDD5Cf88B8c),//FundAddress
        address(0xB0200e89121EF3AE697721BC32060cDD5Cf88B8c)//ReceiveAddress
    ){
    }
}