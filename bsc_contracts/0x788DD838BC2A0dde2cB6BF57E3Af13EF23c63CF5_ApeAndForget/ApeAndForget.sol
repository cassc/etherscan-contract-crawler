...
/**
Telegram: https://t.me/ApeAndForget
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2e2f6E6257bd5dcEACfB3f1327B8Ee0496227545;
...
contract ApeAndForget is Context, IERC20, Ownable {
    ...
    uint256 public _maxWalletTokens = 30000000000 * 10**9;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 3 * 10**9; //
    string private constant _name = "Ape And Forget"; // 
    string private constant _symbol = "APEFORGET"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x2e2f6E6257bd5dcEACfB3f1327B8Ee0496227545);
