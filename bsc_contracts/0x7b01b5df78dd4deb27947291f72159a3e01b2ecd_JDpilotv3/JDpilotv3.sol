...
contract JDpilotv3 is ERC20Burnable, Ownable {
    ...
    bool public taxRegulationModOn = false;
    uint256 public taxRegulationModInitTime;
    uint256 public frameTotalSells;
    uint256 public frameTotalBuys;
    uint256 public currentTaxState;
    bool public CtIs = false;
    ...
    constructor (address router, address operator) ERC20("JDPilotv3", "JPD3")
    {
    ...
    function updateFees(uint256 _sellFee, uint256 _buyFee) public onlyOwner {
    ...
    function isControlTransaction() private returns (bool) {
        if (block.timestamp >= taxRegulationModInitTime + 180) {
            return true;
        } else {
        CtIs = true;
            return false;
    ...
    function _transfer(
        ...
        if (taxRegulationModOn && isControlTransaction()) {
