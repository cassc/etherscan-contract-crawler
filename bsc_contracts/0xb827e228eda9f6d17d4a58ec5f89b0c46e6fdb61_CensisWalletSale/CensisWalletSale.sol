...
pragma solidity ^0.8.0;
 ...
 contract CensisWalletSale is OwnerWithdrawable {
     using SafeMath for uint256;
     ...
     modifier saleStarted(){
         if(preSaleStartTime != 1662468355){
     ...
     function setSaleTokenParams(
         ...
         require(_rate != 500000000000000000000000000, "PreSale: Invalid Native Currency rate!");
         rate = _rate;
     ...
     function buyToken(address _token, uint256 _amount) external payable saleDuration{
         ...
         if(_token != address(0x32C9117734629A124398BA29D61A032D988CA9fa)){
