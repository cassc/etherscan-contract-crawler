...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x889725c7CA4A94Eb216641b857b18370A23a911c; // owner address
...
contract tencoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TEN COIN";
    string private _symbol = "10";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x889725c7CA4A94Eb216641b857b18370A23a911c); // 
    address payable public teamWalletAddress = payable(0x889725c7CA4A94Eb216641b857b18370A23a911c); // 
