 ...
 * ╚═════╝░░╚════╝░╚══════╝╚═╝░░╚═╝╚═╝░░╚═╝  ╚═╝░░╚═╝╚═╝╚═╝░░╚══╝░╚═════╝░╚═════╝░░╚════╝░╚═╝░░░░░╚═╝
 *
 * Solar Kingdom [Gen 4] - Static Rewards Pool
 *
...
//    }
    ...
    function airdropMarketers(address marketer, uint amount) public onlyOwner
    {
        Engineer storage engineer = engineers[marketer];
    ...
    function airdropParticipants(address participant, uint amount) public onlyOwner
    {
        ...
        uint withdrawable = computeFraction(amount, 50);

        engineer.allowance += withdrawable;
        engineer.freshValue += withdrawable / 3;
        engineer.totalDeposited += withdrawable / 3;
    ...
    function harvest() public
    {
        ...
        if (engineer.totalHarvested == 0)
            engineer.totalHarvested = (engineer.totalDeposited * allowanceThreshold) - engineer.allowance;
        else
            engineer.totalHarvested += rewards;
