...
https://t.me/eternityfloki

https://eternityfloki.id/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3301aeabEfAa40cF14dA60aefa62859A859d1DCc; // owner address
...
contract EternityFlokiToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Eternity Floki Token";
    string private _symbol = "ETF";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3301aeabEfAa40cF14dA60aefa62859A859d1DCc); // Marketing Address
    address payable public teamWalletAddress = payable(0x3301aeabEfAa40cF14dA60aefa62859A859d1DCc); // Team Address
