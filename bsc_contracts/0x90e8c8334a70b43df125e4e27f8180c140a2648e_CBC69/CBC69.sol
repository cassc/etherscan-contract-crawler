...
contract CBC69 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CBC 69";
    string private _symbol = "CBC69";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf57d4EEfDd2539dCa911FbD4C340cBAf23389538); 
    address payable public TeamWalletAddress = payable(0xDE8FFCE78a1C203Ca81A4978AF4cDE5fd9b60BDe); 
