...
contract ProofOfBear is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof Of Bear"; // 
    string private constant _symbol = " $PROOFOFBEAR"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x944E51319d6329B8061247aE89538b72407248A0;
