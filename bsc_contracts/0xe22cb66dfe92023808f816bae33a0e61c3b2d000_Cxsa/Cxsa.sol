...
contract Cxsa is Context, Ownable, IERC20, IERC20Metadata {
    ...
    uint256 public maxHold = 1000 * (10 ** uint256(_decimals));
    ...
    constructor() {
        _name = "Constellation shib Alliance";
        _symbol = "Cxsa";
        ...
        usdt.approve(address(uniswapV2Router), MAX);
    }
    ...
    function setMaxHold(uint256 value) public onlyOwner{
        maxHold = value;
    }
    ...
    function _transfer(
        ...
        // maxHold
        if (maxHold>0 && to!=address(uniswapV2Pair)) require(_balances[to] + amount <= maxHold, "ERC20: transfer amount exceeds max hold");
        // transfer
