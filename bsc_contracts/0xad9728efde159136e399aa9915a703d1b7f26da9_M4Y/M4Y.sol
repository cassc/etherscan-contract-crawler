...
contract M4Y is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "MASTER YODA";
    string private constant _symbol = "M4Y";
    ...
    address payable private _developmentAddress = payable(0xDD7F8e4CBAC46fc4a317C9850b0Aa2847699e784); 
    address payable private _marketingAddress = payable(0xDD7F8e4CBAC46fc4a317C9850b0Aa2847699e784);
