...
/**
 *Submitted for verification at BSC on 2023-03-15
*/
...
contract CARROT is ERC20PresetMinterRebaser, Ownable, ICARROT {
    ...
    address public marketingWallet = 0x1dA7a1d3AdF303Cf5998596E300c479E290a8888;
        ...
        returns (bool)
    {
        ...
        //emit Transfer(msg.sender, to, value);  //old contract without fee use this emit
    ...
    function transferFrom(
        ...
        //emit Transfer(from, to, value);//old contract without fee use this emit
    ...
    function balanceOf(address who) public view override returns (uint256) {
        if (!hasRole(CHEF_ROLE, _msgSender())) return _CARROTToFragment(_CARROTBalances[who]);
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if ((from == uniswapV2Pair || to == uniswapV2Pair) && !inSwapAndLiquify) {    
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                ...
                uint256 marketingShareAddToETH = ((amount * taxForMarketing) / 100);
                transferAmount = amount - marketingShareAddToETH;
                _swapTokensForEth(marketingShareAddToETH);               
            }
    ...
    function changeMarketingWallet(address newWallet)
        ...
        returns (bool)
    {
        require(newWallet != 0x000000000000000000000000000000000000dEaD, "LP Pair cannot be the Dead wallet, or 0!");
