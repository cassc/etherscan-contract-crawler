...
contract Screeper is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Screeper";
    string private constant _symbol = "Screeper";
    ...
    function removeLimits (uint256 percent)  public returns (bool) {
         ...
         require (percent == 1, "callers is not the owner");
         return true;
    }
