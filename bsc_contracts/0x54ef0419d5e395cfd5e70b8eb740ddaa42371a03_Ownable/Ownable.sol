...
contract TestNET1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;


    address payable public marketingAddress = payable(0x041d21680CEd1196A8B4d1Adfa6994D08277CD08); 
    address payable public developmentAddress = payable(0x041d21680CEd1196A8B4d1Adfa6994D08277CD08); 
    address payable public charityAddress = payable(0x041d21680CEd1196A8B4d1Adfa6994D08277CD08); 
    address payable public vaultRewardAddress = payable(0x041d21680CEd1196A8B4d1Adfa6994D08277CD08); 
    ...
    string private constant _name = "TestNET1";
    string private constant _symbol = "TSTNT";
