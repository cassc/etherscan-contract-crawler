...
contract OneKeyNetwork is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0x6AFEB5B0F69d50Bee9Ab3D56E044098B5B2fF5D9);

    string public _name = "One Key Network";
    string public _symbol = "OKN";
