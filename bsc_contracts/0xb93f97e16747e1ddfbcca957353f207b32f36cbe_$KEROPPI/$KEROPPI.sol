...
// SPDX-License-Identifier: MIT     https://t.me/keroppibsc
...
contract $KEROPPI is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KEROPPI";
    string constant _symbol = "$KEROPPI";
