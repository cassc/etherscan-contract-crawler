...
contract TwitterCeoFloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public AmountTokenRewardsFee=0;
    uint256 public AmountMarketingFee=0;

    address public _marketingWalletAddress1=0x861f3CeccF865CFE35a85ae3Ec057175bE2A3436;
    ...
    constructor()  payable ERC20("TwitterCeoFloki","TwitterCeoFloki")  {
        uint256 totalSupply = 1000000000000000* (10**18);//500T
        swapTokensAtAmount = 500000000000* (10**18); //0.5T
        ...
        _mint(_marketingWalletAddress1, totalSupply.div(2));
        _mint(deadWallet, totalSupply.div(2));
    }
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            swapping = true;
            if(AmountMarketingFee > 0) swapAndSendToEth(AmountMarketingFee);
	...
	function swapAndSendToEth(uint256 tokens) private  {
		...
		payable(_marketingWalletAddress1).transfer(newBalance);
