...
contract Meta is Context, IERC20, Ownable {
    ...
    constructor (
        ...
        _maxTxAmount =   totalSupply_ * 10**_decimals;     
        _walletMax =     totalSupply_ * 10**_decimals;      
        minimumTokensBeforeSwap = totalSupply_.mul(2).div(10**6) * 10**_decimals; 
        marketingWalletAddress= payable(address(msg.sender) );
        teamWalletAddress= payable(address(msg.sender) );
