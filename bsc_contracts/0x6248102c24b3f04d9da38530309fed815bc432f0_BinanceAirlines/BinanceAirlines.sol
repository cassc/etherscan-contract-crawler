...
/*
Binance  Airlines is a pioneer of conventional financial new enterprise systems to drive business 
and foster innovation acrossthe blockchain space. As the first blockchain-enabled platform to facilitate 
the use of traditional digital currencies (familiar and stable units of accounting),
Binance Airlines has democratized cross-border transactions across blockchains.  Binance Airlines offers Flight tickets on all airlines using the $BNA currency and allows all holders to take advantage of the opportunity in the shortest possible time.
✈️Website  : https://BinanceAirlines.exchange 
✈️Telegram : https://t.me/BinanceAirlines
*/
...
contract BinanceAirlines is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Binance Airlines";
    string private _symbol = "$BNA";
    uint8 private _decimals = 9;

    address public marketingWallet = 0xce03bB592EEbcCF4d2BfB236c4fcB8BA5dc8e7fA;
    address public developerWallet = 0xce03bB592EEbcCF4d2BfB236c4fcB8BA5dc8e7fA;
    ...
    uint256 public _maxTxAmount =  _totalSupply.mul(30).div(denominator);     //3%
    uint256 public _walletMax = _totalSupply.mul(30).div(denominator);    //3%
