...
contract AntiElonToken is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0xF319aa7A5b821D3CB8AA4B4b7B383970e993f637); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x90CC7B192A844FCBEEDf9913c8F13A7C5b712ef7); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0x545F4496d3D644dE93664Bea0Cc8bD471a39B150); // charity Wallet Address
    address payable public devWalletAddress = payable(0x5196a3b30136a554Bba08f1aa04a70629Ee9E22A); // dev Wallet Address
    ...
    string private constant _name = "AntiElonToken";
    ...
    constructor () {
        address _owner = 0xDe5EA5aea4E96B4230Ffd9bc7aCc6546Dc791e67;
