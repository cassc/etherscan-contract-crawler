...
contract BitBurnReflect is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SpookyBurn", "SB") {
        marketingWallet = payable(0x42D6Ed4Db69F5f006F225723390B2eCc64Ca70a0);
        devWallet = payable(0xfE356742b20794ed9Dd43da7E5A348d0B4e2d7B7);
...
contract BitBurnReflectDividendTracker is DividendPayingToken, Ownable {
    ...
    BitBurnReflect public BitBurnReflectContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BitBurnReflectContract = BitBurnReflect(mainContract);
