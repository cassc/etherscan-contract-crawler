...
contract MiniBeer is Context, IERC20, Ownable {
    ...
    string private _name = "MiniBeer";
    string private _symbol = "MBEER";
    ...
    address payable public marketingWallet = payable(0x90CAEE057Ec29fB7Cafc8fa7478076cC7e375498);
    ...
    uint256 public _maxWalletLimit = 50000000 * 10**18;
    address admin;
