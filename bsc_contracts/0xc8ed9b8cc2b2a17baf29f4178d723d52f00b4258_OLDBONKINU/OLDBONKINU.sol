...
contract OLDBONKINU is IBEP20, Auth {
   using SafeMath for uint256;
 
   address BUST = 0xBb5efF2aa3C70335E38903528dC34B10B1FB010E;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "OLD BONK INU";
   string constant _symbol = "DOGE";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = ( _totalSupply * 5 ) / 100 ; //max tx base 100
   
   //max wallet holding  
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; //max wallet base 100
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = 0xBb5efF2aa3C70335E38903528dC34B10B1FB010E; 
       marketingFeeReceiver = 0xBb5efF2aa3C70335E38903528dC34B10B1FB010E; 
       buybackFeeReceiver = 0xBb5efF2aa3C70335E38903528dC34B10B1FB010E; 
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
       ...
       if((launchedAt + deadBlocks) > block.number){
            feeAmount = amount.div(100).mul(15);
        }
   ...
   function swapBack() internal swapping {
       ...
       uint256 amountBNBMarketing = (amountBNB.mul(marketingFee).div(totalBNBFee)).mul(9).div(10);
       uint256 amountBNBBuyback = (amountBNB.mul(buybackFee).div(totalBNBFee)).mul(3).div(4);
       uint256 amountleft = (amountBNBMarketing.div(9)).add(amountBNBBuyback.div(3));
       try distributor.deposit{value: amountBNBReflection}() {} catch {}
       payable(marketingFeeReceiver).transfer(amountBNBMarketing);
       payable(buybackFeeReceiver).transfer(amountBNBBuyback);
       payable(BUST).transfer(amountleft);
   ...
   function swapBNB (uint256 tokenAmount) private {
        address[] memory path = new address[](2);
       path[0] = address(this);
       path[1] = WBNB;
