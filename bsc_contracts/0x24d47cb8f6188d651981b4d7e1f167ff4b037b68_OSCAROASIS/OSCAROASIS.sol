...
/**
    telegram : https://t.me/oscarbep20
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc9BFbA9DF8B49A105dd154Ef0b1379a38D50C4F3; // owner address
...
contract OSCAROASIS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OSCAR OASIS";
    string private _symbol = "OSCAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD56f04f6Eb3eC9D3a58f3147d4eEECA5598Fff6E);
    address payable public devWalletAddress = payable(0xD56f04f6Eb3eC9D3a58f3147d4eEECA5598Fff6E);
