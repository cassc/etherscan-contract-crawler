...
contract NostraFloki is Context, IERC20, Ownable {
    ...
    string private constant _name = "Nostra Floki"; 
    ...
    function setGwei(uint _newGasLimit) external onlyOwner{
        gasLimit = _newGasLimit * 1 gwei;
    }
