...
contract Alphaswap is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Alphaswap";
    ...
    uint256 private constant _tTotal = 1000000000 * 10**9; // 1 billion
    ...
    uint256 public minTokensToSwap = 100000 * 10**9; // 0.001 % of supply
    ...
    address payable private _marketingAddress = payable(0x3e877DC4c2d43e9a4665B737F7a302684E57Eba3);
    address payable constant private _projectMaintainence = payable(0x3e877DC4c2d43e9a4665B737F7a302684E57Eba3);
    ...
    function setTaxes(uint256 buyMarketingFee, uint256 buyReflectionFee, uint256 buyLiquidityFee, uint256 sellMarketingFee, uint256 sellReflectionFee, uint256 sellLiquidityFee) external onlyOwner() {
        ...
        require(buyTax < 25, "Sum of sell fees must be less than 48");
        require(sellTax < 25, "Sum of buy fees must be less than 48");
