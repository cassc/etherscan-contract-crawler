...
// Telegram : https://t.me/spookytsukaportal

// SPDX-License-Identifier: UNLICENSED

/**

╚S╝╚P╝╚O╝╚O╝╚K╝╚Y╝╚T╝╚S╝╚U╝╚K╝╚A╝
++++++++++++++++++++++++++++++
╚S╝╚P╝╚O╝╚O╝╚K╝╚Y╝╚T╝╚S╝╚U╝╚K╝╚A╝
...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    PCSRouter router;
...
contract SPOOKYTSUKA is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "SPOOKYTSUKA";
    string constant public symbol = "SPKT";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 1 * 10**7 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 30 / 1000;
    uint256 public _maxWalletToken = totalSupply * 30 / 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xa8a967FDeF597CA071A3c1478A637e63bb68D349;
        devFeeReceiver = 0xa8a967FDeF597CA071A3c1478A637e63bb68D349;
