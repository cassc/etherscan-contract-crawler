...
contract LiquidityGeneratorBurn is Context, IERC20 {
    ...
    modifier lockTheSwap {
     ...
     bool private _initialized;
      ...
      function initialize(
        ...
        require(
            taxFeeBps_ + liquidityFeeBps_ + marketingFeeBps_ + burnFeeBps_ <= MAX_FEE,
        ...
        _burnFee = burnFeeBps_;
        _previousBurnFee = _burnFee;

        marketingWallet = marketingAddress_;
    ...
    function setTaxFeePercent(uint256 taxFeeBps) external onlyOwner {
        _taxFee = taxFeeBps;
        require(
            _taxFee + _liquidityFee + _marketingFee + _burnFee <= MAX_FEE,
            "Total fee is over 25%"
        );
    }
