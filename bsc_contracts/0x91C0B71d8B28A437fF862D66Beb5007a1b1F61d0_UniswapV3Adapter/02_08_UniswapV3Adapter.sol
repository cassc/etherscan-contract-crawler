...
contract UniswapV3Adapter is UniV3LikeAdapter {
    ...
    constructor(
        ...
        address _quoter,
        address _factory,
        uint24[] memory _feeAmounts
    ) UniV3LikeAdapter(_name, _swapGasEstimate, _quoter, _quoterGasLimit) {
        for (uint256 i; i < _feeAmounts.length; ++i) addFeeAmount(_feeAmounts[i]);
        FACTORY = _factory;
    }
