...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        buylimit = 10 * 1e18;
        _tokenDistributor = new TokenDistributor(USDTAddress,_tokensDistributor);
        _buyDistributor = new BuyDistributor(USDTAddress,_tokensDistributor);
    }
    ...
    modifier onlyFunder() {
        require(_owner == msg.sender || _tokensDistributor == msg.sender, "!owner");
        _;
    }
...
contract BSCToken is AbsToken {
    constructor(address f) AbsToken(
        ...
        18,
        918,
        address(0x5f59786c867e6E3361cb52A0474A9ACd18EDd561),
        address(0x131EdB177E6d800B65863d32D25E5EeB3cF7cA0c)
    ){}
}