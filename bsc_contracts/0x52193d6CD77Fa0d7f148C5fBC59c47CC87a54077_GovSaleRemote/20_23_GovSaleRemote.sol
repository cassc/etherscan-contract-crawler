...
contract GovSaleRemote is
    ...
    uint128 public booster1BuyerLength;
    ...
    function init(
        ...
        gasForDestinationLzReceive = uint128(factory.gasForDestinationLzReceive());
    ...
    function estimateFees(
        ...
        tax = factory.crossFee_d2().calcPercent2Decimal(uint128(fees));
    }
