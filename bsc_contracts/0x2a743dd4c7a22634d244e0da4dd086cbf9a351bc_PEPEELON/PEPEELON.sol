...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEA352585EC960f0f6Ae22357ae22ACcCd0509cef;
...
contract PEPEELON is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xeC0C616825fEC33683d5c1a70a9443B4760A238A;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PEPEELON";
    string private _symbol = "PELO";
