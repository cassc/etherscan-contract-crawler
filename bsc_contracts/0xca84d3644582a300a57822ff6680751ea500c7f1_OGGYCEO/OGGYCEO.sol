...
contract OGGYCEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x24ceBc6B4f2e9772394515aa273742D0593ACB3B;

    string private constant _name = "Oggy CEO";
    string private constant _symbol = "OGGYCEO";
