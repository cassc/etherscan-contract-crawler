...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0B7498253E98BbF9104658DfA515203498CAbaAA; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Soccer Inu";
    string private _symbol = "babysoccerinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0B7498253E98BbF9104658DfA515203498CAbaAA); // Marketing Address
    address payable public teamWalletAddress = payable(0x0B7498253E98BbF9104658DfA515203498CAbaAA); // Team Address
    ...
    uint256 public _totalDistributionShares = 50;  // original 12
