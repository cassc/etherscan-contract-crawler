...
contract   Yangzhenning  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = " Yangzhenning";
    string private _symbol = "Yangzhenning";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x139FbF162Bd71D2e043660D54C7B29A0ca8e60A6);
