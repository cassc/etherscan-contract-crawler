...
Gate.io creatively proposed a solution with NFT Fraction Token.
The top NFT anchored in this issue is: Bored Ape Yacht Club BAYC The Bored Ape Yacht Club NFTs are a collection of 10,000 unique Bored Ape Non Fungible Tokens.
Each token is a unique work of art, featuring one of many bored apes.
...
contract BAYCFractionToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BAYC Fraction Token";
    string constant _symbol = "IBAYC";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xBd340817205675de15900dAb4eA456E70029D8f2;
        teamFeeReceiver = 0xad88f18a01bF19E78084FB783C22da325D55F9d8;
