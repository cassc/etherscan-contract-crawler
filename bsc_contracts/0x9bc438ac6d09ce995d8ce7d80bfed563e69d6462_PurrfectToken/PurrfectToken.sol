...
contract PurrfectToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x561bA243C4c8251bD024324568664C40B6095546;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "PURRFECT TOKEN";
    string constant _symbol = "$PURR";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x11d9A473bd920305bD530C38836EA822a63AEE00;
