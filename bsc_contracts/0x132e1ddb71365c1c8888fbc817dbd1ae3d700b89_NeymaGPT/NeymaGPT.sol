...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc3310B56C1C95bBCF73dCd99bDCB22a8Eff301df;
...
contract NeymaGPT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Neyma GPT";
    string private _symbol = "NEYMAGPT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc3310B56C1C95bBCF73dCd99bDCB22a8Eff301df);
    address payable public teamWalletAddress = payable(0xc3310B56C1C95bBCF73dCd99bDCB22a8Eff301df);
