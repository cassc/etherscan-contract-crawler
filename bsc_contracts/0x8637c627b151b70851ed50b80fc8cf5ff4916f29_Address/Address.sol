...
contract Cerium is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 80000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Cerium";
    string private _symbol = "Cerium";
    ...
    address public marketingWallet = 0xBEcd5ED2f8D11Ea276D68615596D71894BcB161B;
    uint256 private _previousmarketingFee = _marketingFee;

    uint256 public _ecosystem = 1;
    address public ecosystem = 0xFb910E0F2902a48C8b061FD442e4a7f5e9cB6630;
    ...
    function removeAllFee() private {
        if(_RewardFee == 0 && _liquidityFee == 0 && _marketingFee==0 && _burnFee==0) return;
