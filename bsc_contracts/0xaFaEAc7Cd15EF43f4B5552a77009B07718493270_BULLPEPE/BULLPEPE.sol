...
contract BULLPEPE is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x8bFE54c63eDEccaEFB679de67c34E32b9e357e1a); 
    address payable public Wallet_Team = payable(0xD4D644Bfc68Dba00675548727BfE5cB6eB138745);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000000 * 10**2* 10**2 * 10**_decimals;
    string private constant _name = "BULLPEPE"; 
    string private constant _symbol = unicode"BLLP"; 
    ...
    constructor () {
        _owner =0x51EaE6B3F1c790fCCCc713712B1bAf01D3b3F35E;
