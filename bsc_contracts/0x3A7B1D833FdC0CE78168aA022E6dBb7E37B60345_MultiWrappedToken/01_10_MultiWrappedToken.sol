...
contract MultiWrappedToken is Initializable, Ownable, ReentrancyGuard, ERC20
{
	...
	{
		// one time execution after upgrade
		if (tokenInfo[5].token == 0x381e7d98Df8ffd6A399fb2CE11Ad56eBF2a6119c && tokenInfo[5].amount == 0) {
			tokenInfo[5].wrapped = true;
		}
		if (tokenInfo[6].token == 0x7142154B14Bd56410cFFC7d42fe2b635409e57c3 && tokenInfo[6].amount == 0) {
			tokenInfo[6].wrapped = true;
		}
		if (tokenInfo[7].token == 0xa9f9F29EA81AE7BDb180a15096C3307fB33EBB4C && tokenInfo[7].amount == 0) {
