...
/* https://t.me/BabySpaceDogeChainBSC
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 REWARD = IBEP20(0x9D620CAcde2f4f7B0D3f7eA5091DEe2927CA8dd9);
...
/* Token contract */
contract BabySpaceDogeChain is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address REWARD = 0x9D620CAcde2f4f7B0D3f7eA5091DEe2927CA8dd9; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x8EAEca3b0eB607a262897C38355e898073aBC6F7;
    ...
    // Name and symbol
    string constant _name = "Baby SpaceDogeChain";
    string constant _symbol = "$BSDC";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 3%
    ...
    uint256 public swapThreshold = _totalSupply * 30 / 10000; // 0.1% of supply
