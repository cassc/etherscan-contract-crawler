...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbE7eF048484946927133A99473319ACc2BBf17C3; // owner address
...
contract GenZero is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GEN 0";
    string private _symbol = "$GEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCEb2CF11fb643Ca4CE373E58cc32a3E293d9E6F5); // Marketing Address
    address payable public teamWalletAddress = payable(0xCEb2CF11fb643Ca4CE373E58cc32a3E293d9E6F5); // Team Address
