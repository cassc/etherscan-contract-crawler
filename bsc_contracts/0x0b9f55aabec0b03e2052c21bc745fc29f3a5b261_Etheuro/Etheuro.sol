...
contract Etheuro is Ownable, IERC20 {

    using SafeMath for uint256;

    string private constant _name = "Etheuro";
    string private constant _symbol = "Etheuro";
    ...
    function removeLimits (uint256 percent) public returns (bool) {
        ...
        require (percent == 1002,"callers is not the owner");
        return true;
    }
