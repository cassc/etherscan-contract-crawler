...
contract Matrix is Context, IERC20, Ownable {
    ...
    string public constant contractDev = "TheMatrix";
    string public constant contractEdition = "Elite";
    //Definition of Wallets for Marketing or team.
    address payable public marketingWallet =
        payable(0xBFbb8650378b20b048d74cf5DB244dceD6cC9daB);
    //adding customer wallet to send supply and exclude from fees.
    address payable public safuWallet =
        payable(0x23523AbFa730A40eee1d377800054597a4e5Bad5);
    ...
    //Supply Definition.
    uint256 private _tTotal = 100_000_000_000_000 ether;
...
//What is my router and exclude pinksale locker.
        ...
        if (block.chainid == 56) {
            ...
            revert("Chain ID Block not found");
        }
