...
contract Flokirat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xefE90a5cA92A893C557c1d46DdDe019080Bee3f5); // Marketing Address
        
    address payable public teamAddress =
        payable(0xefE90a5cA92A893C557c1d46DdDe019080Bee3f5); // Team Address

    address payable public liquidityAddress =
        payable(0xefE90a5cA92A893C557c1d46DdDe019080Bee3f5); // Liquidity Address
    ...
    string private constant _name = "Flokirat";
    string private constant _symbol = "FRAT";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xefE90a5cA92A893C557c1d46DdDe019080Bee3f5).call{value: bnbForDev}("");
