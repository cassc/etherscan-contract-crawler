...
contract ONECCToken is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 10000000000000000000000000* 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'SHUMAOGUQUAN';
    string private _symbol = '数贸股权';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = 0x9C4D81701044298833093ACCCF9cF21D409c9B6F;
