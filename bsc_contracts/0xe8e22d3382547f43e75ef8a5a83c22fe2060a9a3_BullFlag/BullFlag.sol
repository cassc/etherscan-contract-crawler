...
contract BullFlag is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        development: payable(0x282Bf8d16B5f4C4EcB041860C336681aa4daECD8)
    });
    ...
    function intializeContract(address _antiSnipe) external onlyOwner {
        ...
        protections = Protections(_antiSnipe);
        ...
        finalizeTransfer(_owner, _taxWallets.marketing, _tTotal / 20, false, false, true);
        finalizeTransfer(_owner, _taxWallets.development, _tTotal / 100, false, false, true);
...
//===============================================================================================================
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
     ...
     function setRatios(uint16 reflection, uint16 marketing, uint16 development, uint16 burn) external onlyOwner {
