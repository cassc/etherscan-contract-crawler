...
contract XAIGPT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "X.AI GPT";
    string constant _symbol = "X.AI";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x816f610597f3dFD9b547ABA8130c20D10806de0B;
