 ...
 */
contract ByBarterCoin is Context, IERC20, Ownable {
     ...
     */
    constructor() {
        _name = "ByBarter Token";
        _symbol = "BYB";
        _decimals = 18;

        // minting occurs only once and will never be called again
        _mint(_msgSender(), 1 * 10**9 * 10 ** _decimals);
    }
