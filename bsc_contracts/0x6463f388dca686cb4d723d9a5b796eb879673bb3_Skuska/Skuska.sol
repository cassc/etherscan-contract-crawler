...
contract Skuska is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Skuska";
    string private _symbol = "LOL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1F39b42997F8333736Af5FEB6391CaD243abC3f2); // Marketing Address
    address payable public teamWalletAddress = payable(0x5541eD5666299f3544453dE20Db58fBC1D116DCd); // Team Address
