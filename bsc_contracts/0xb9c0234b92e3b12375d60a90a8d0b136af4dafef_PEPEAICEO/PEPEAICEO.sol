...
//--- Contract v2 ---//
contract PEPEAICEO is Context, Ownable, IERC20 {
    ...
    uint256 private swapThreshold = _totalSupply / 7_000;
    ...
    address payable private marketingAddress = payable(0x62856231feB60923d964243004277cd0e4c7b5Ca);


    IRouter02 public swapRouter;
    string constant private _name = "PEPEAICEO";
    string constant private _symbol = "PEPEAICEO";
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        function setPresaleAddress(address presale, bool yesno) external onlyOwner {
            require(presale != address(0),"address 0");
