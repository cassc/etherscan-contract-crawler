...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC1228082ef6C72C2a1ed10D827B61f13d4Cc9BF7; // owner address
...
contract FatToken is Context, IERC20, Ownable {
    ...
    string private _name = "PlayStationClassic";
    string private _symbol = "PSX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC1228082ef6C72C2a1ed10D827B61f13d4Cc9BF7);
    address payable public teamWalletAddress = payable(0xC1228082ef6C72C2a1ed10D827B61f13d4Cc9BF7);
