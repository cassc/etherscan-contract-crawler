...
Gamble play boys, dev is vouched by some callers. Ape wisely!
dyor! nfa!

https://t.me/halfflokibsc
*/
...
contract HalfFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x7EEdCa0D78F6101c0f722BA89620749F153aE54C;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "Half Floki";
    string constant _symbol = "HFLOKI";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xA6713c3bd43b37F0af095c57381d91BA8bba5636;
