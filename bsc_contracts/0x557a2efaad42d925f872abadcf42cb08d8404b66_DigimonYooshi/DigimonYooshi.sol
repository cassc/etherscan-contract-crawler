...
contract DigimonYooshi is Context, IERC20, Ownable {
    ...
    string private constant _name = "Digimon Yooshi";
    string private constant _symbol = "DGY";
