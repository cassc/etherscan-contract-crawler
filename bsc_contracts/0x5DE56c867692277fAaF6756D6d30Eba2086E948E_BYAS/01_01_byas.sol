...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "BYAS TOKEN";
    string internal constant SYMBOL = "BYAS";
     ...
     */
    uint256 internal constant maxWalletBalance = 0; // unlimited max
    ...
    address internal charityAddress = 0x81Cf636a5651256fDb0D76a2c9FCfBCE2B433c5B;
    address internal burnAddress = 0x0000dE00000000Ad000000000000DE00000000AD;

    

    enum FeeType { Burn, Rfi, Charity }
    struct Fee {
        FeeType name;
        uint256 value;
        address recipient;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.Charity, 10, charityAddress );
...
abstract contract Liquifier is Ownable, Manageable {
 ...
 abstract contract SwapToken is BaseRfiToken, Liquifier {
   ...
   // function _getFees(uint256, uint256) internal view  returns (uint256){
   //     return _getSumOfFees(address, uint256);
    
    function _getSumOfFees(address, uint256) internal view override returns (uint256){ 
        return 10 * _getFeesCount(); 
    }
...
contract BYAS is SwapToken{

    constructor() SwapToken(Env.MainnetV2){
