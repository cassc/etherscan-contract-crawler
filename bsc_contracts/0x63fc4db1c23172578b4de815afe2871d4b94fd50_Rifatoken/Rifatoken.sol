...
contract Rifatoken is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private _tSupply = 20000000 * _decimalFactor; // Supply Token
    uint256 public buyFee = 99; // Taxa de Compra
    uint256 private previousBuyFee; // Armazena Taxa de Compra
    uint256 public sellFee = 40; // Taxa de Venda
    ...
    uint256 public maxWalletBalance = 500000 * _decimalFactor; // 5% do Supply
    uint256 public maxBuyAmount = 80000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 80000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 80000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "Rifa Token";
