...
contract PEPExToken is IERC20 {
    string public constant name = "Pepe The CEO";
    ...
    constructor() {
        uint256 initialSupply = 42000000000 * (10 ** uint256(decimals));
...
// Send 91% of the total supply to the 0x000000000000000000000000000000000000dEaD address
        uint256 deadBalance = initialSupply * 81 / 100;
