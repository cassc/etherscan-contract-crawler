...
contract WallOfPepe is ERC20, Ownable {
    struct Tax {
    ...
    //Wallets
    address public marketingWallet = 0x6dbdC397013F4bcf9BDc5565D30a89D7dD8ce75A;
    ...
    constructor() ERC20("Wall Of Pepe", "WPEPE") {
        ...
        whitelisted[0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE] = true;
        whitelisted[0x690269963244bF6Ff0854C70F171069559cDe432] = true;     
        whitelisted[0xf4b804756196dACdad6d1ccED108Aee1673684b0] = true;             
        _mint(0xf4b804756196dACdad6d1ccED108Aee1673684b0, _totalSupply);
    ...
    function setBuyTaxes(uint256 _marketingTax) external onlyOwner {
        ...
        require(_marketingTax <= 2, "Can not set buy fees higher than 2%");
    ...
    function setTransferFees(uint256 _transferTaxes) external onlyOwner {
        ...
        require(_transferTaxes <= 2, "Can not set transfer tax higher than 2%");
