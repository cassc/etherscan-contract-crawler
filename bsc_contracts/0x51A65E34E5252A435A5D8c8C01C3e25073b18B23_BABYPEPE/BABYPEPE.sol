...
BABYPEPE Smart Contract

Buy: 1% Auto Burn 2% lp 2% marketing 5% PEPE Rewards
Sell: 1% Auto Burn 4% lp 3% marketing 7% PEPE Rewards

//Telegram: https://t.me/babypepeprotocol
...
contract BABYPEPE is ERC20, Ownable {
    ...
    constructor() ERC20("BABYPEPE", "BABYPEPE") {
        marketingWallet = payable(0x7D3aA50e25D79FdeE563B98eA5E2a14C1E2d3e58);
        devWallet = payable(0x21D6fFc765e6F5E2fc8BD19Ed06c9Ce00f0d7842);
        ...
        dividendTracker = new BABYPEPEDividendTracker(
            payable(this),
            router,
            0xC191931Bb0565e1BEFba5621E634E079241551e9,
            "BABYPEPETRACKER",
            "BABYPEPETRACKER"
        );
    ...
    function updateFees(
        ...
        require(totalSellFees <= 30 && totalBuyFees <= 15, "total fees cannot exceed 30% sell or 15% buy");
...
contract BABYPEPEDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BABYPEPE public BABYPEPEContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BABYPEPEContract = BABYPEPE(mainContract);
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "BABYPEPE_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BABYPEPEContract);

            uint256 prevBalance = BABYPEPEContract.balanceOf(address(this));
            ...
            {
                uint256 received = BABYPEPEContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BABYPEPEContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
