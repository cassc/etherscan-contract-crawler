...
/**
 *  Telegram: https://t.me/FomoNetworkBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x577FbaE991740bb13E3E817304C982049C7Ea3e7; // owner address
...
contract FomoNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Fomo Network";
    string private _symbol = "FNET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x577FbaE991740bb13E3E817304C982049C7Ea3e7); // 
    address payable public teamWalletAddress = payable(0x577FbaE991740bb13E3E817304C982049C7Ea3e7); // 
