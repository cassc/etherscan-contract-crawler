...
/**
Mumu
Mumu has taken control of the market once again, join the community of bulls and never cry again!

Telegram: https://t.me/Mumu_coin
...
contract  Mumu  is IBEP20, Auth {
    ...
    address DEV = 0x782e922Cc2Ac8b7a7Bb06aefec8f56195d3167A4;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 20000; // 2%
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 20000; // 2%
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 20000; // 2%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x782e922Cc2Ac8b7a7Bb06aefec8f56195d3167A4;
