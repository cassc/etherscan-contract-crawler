...
contract CiqraToken is ERC20, Ownable {
    IRouter public uniswapV2Router;
    address public immutable uniswapV2Pair;

    string private constant _name = "CIQRA TOKEN";
    string private constant _symbol = "CIQRA";
	...
	function claimLaunchTokens() external onlyOwner {
		...
		require(block.number - _launchBlockNumber > 5, "CIQRA: Only claim launch tokens after launch");
