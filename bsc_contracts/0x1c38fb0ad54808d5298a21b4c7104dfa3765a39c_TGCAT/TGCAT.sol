...
contract TGCAT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TELEGRAM CAT", "TGCAT") {
        ...
        marketingWallet = address(0x07dE8CC0Ebe13c033A2Fc58acDB0bb98b4fE0F58); // set as marketing wallet
        devWallet = address(0x07dE8CC0Ebe13c033A2Fc58acDB0bb98b4fE0F58); // set as dev wallet
