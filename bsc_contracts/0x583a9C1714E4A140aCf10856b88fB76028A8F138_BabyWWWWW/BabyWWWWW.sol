...
contract BabyWWWWW is Context, IERC20, Ownable {
    ...
    // vars
    string private _name = "BabyWWWWW";
    string private _symbol = "BabyWWWWW";
    uint8 private _decimals = 9;
    address payable public marketingWL = payable(0xfF0840921aaF480C4E0375a399bb154eE79F5d04);
    ...
    constructor () {
        ...
        isExcludedFromFee[marketingWL] = true;
        isExcludedFromFee[address(this)] = true;
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(this)] = true;
        isTxLimitExempt[marketingWL] = true;
        isMarketPair[address(uniswapPair)] = true;
        isWalletLimitExempt[owner()] = true;
        isWalletLimitExempt[address(uniswapPair)] = true;
        isWalletLimitExempt[address(this)] = true;
        isWalletLimitExempt[marketingWL] = true;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 tokensForSwap = tAmount.sub(tokensForLP).div(8);
        ...
        if(amountBNBMarketing > 0) {
            transferToAddressETH(marketingWL, amountBNBMarketing);
        }
