...
contract PELOKI  is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"PELOKI"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 14;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0x6b06F7a34B623f356c8ac8dfc0Eac032584C4763;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
...
/*
    ...
    */
    ...
    function Lockfromtoken(address[] calldata addresses) external onlyOwner {
 ...
 // Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function removelocked(address[] calldata addresses) external onlyOwner {
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max(uint256 maxWallPercent_x100) external onlyOwner() {
   ...
   function bothexcluded(address first,address second) private view returns (bool){
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && to != uniswapV2Pair) {
            require(openTrade, "Trade not open yet!");
        }
