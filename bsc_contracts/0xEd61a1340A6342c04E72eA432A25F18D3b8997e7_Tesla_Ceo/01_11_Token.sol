...
contract Tesla_Ceo is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20("Tesla Ceo", "TESLACEO") 
    {
        address supplyRecipient = 0x03673aB9e636ecAa9302a9DdF36ad6F245684820;
        
        updateSwapThreshold(1000000 * (10 ** decimals()));

        marketingAddressSetup(0x03673aB9e636ecAa9302a9DdF36ad6F245684820);
        marketingFeesSetup(900, 900, 500);
        ...
        updateMaxTxAmount(5000000 * (10 ** decimals()));

        _mint(supplyRecipient, 100000000 * (10 ** decimals()));
        _transferOwnership(0x03673aB9e636ecAa9302a9DdF36ad6F245684820);
    }
