...
***/
contract THISCONTRACT is ERC20, Ownable{
    ...
    constructor() ERC20("Ibiza City Credits", "IBIZA") {
        _mint(msg.sender, 450_000_000_000_000 * 10 ** decimals());
        _mint(team, 25_000_000_000_000 * 10 ** decimals());
        _mint(gate, 25_000_000_000_000 * 10 ** decimals());
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if(recipient == pair) {
            ...
            if (amount >= 8e12 * 10 ** decimals()) { tttPretzels = Pretzels(25,0,0); }   //Add
