...
// Telegram: https://t.me/horizonnetwork
...
contract Horizonnetwork is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "Horizon nNetwork";                                          // name
    string private _symbol = "Horizon";                                             // symbol
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x0950Fc87D05ffFf1d423320BbA400C2877f452E2),                             // Dev+Team wallet
        payable(0x2B7e032Fd9c65773ddFc65854FEf69F85cD471DD),                             // Marketing wallet
