...
contract ETS2 is Context, IERC20, Ownable { 
    ...
    address payable public WalletMarketing = payable(0x179092A179BA41B34b5e47F6c9Bc2a2be3fdf7b3);
    ...
    string public _name = "ETS2";
    string public _symbol = "ETS";
