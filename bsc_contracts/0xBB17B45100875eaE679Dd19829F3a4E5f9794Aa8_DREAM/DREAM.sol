...
contract DREAM is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x77112a4918717ed3A5A3AFA53Fa2067987b6e258); // Marketing Address
        
    address payable public teamAddress =
        payable(0x77112a4918717ed3A5A3AFA53Fa2067987b6e258); // Team Address
        
    address payable public liquidityAddress =
        payable(0x77112a4918717ed3A5A3AFA53Fa2067987b6e258); // Liquidity Address
