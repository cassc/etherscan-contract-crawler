...
contract DosaGrow is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB                        = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD                        = 0x000000000000000000000000000000000000dEaD;
    address ZERO                        = 0x0000000000000000000000000000000000000000;
    address devFeeReceiver              = 0xEe26ABce5654831E8DE60bc391f2848f67675c4c; 
    address public marketingFeeReceiver = 0xEe26ABce5654831E8DE60bc391f2848f67675c4c;
    address public autoLiquidityReceiver;

    string constant _name               = "DosaGrow";
    string constant _symbol             = "DOSAGROW";
    ...
    uint256 private totalFee            = marketingFee + reflectionFee + liquidityFee + devFee + burnFee;
...
uint256 targetLiquidity             = 85;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != devFeeReceiver  && recipient != autoLiquidityReceiver && recipient != DEAD){
