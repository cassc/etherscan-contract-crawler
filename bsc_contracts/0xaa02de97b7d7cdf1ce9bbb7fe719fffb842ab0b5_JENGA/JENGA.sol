...
contract JENGA  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JENGA";
    string private _symbol = "JNG";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x08c64d619350Cc6961C60F77C70d6b11745fDA0d);
    ...
    uint256 public _TreasuryFeeBuy = 1;
    uint256 public _LiquidityFeeSell = 1;
    uint256 public _TreasuryFeeSell = 1;
