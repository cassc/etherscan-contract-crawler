        ...
        if (lpAmount > 0) {
            ...
            if (lpusdtt > 0) {//=0xB821bb072f08A338962272923f9f4221B69094FC (配置地址，不能改，改了会产生错误）
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpusdtt, 0, 0, address(0x34eaC539053a02212c5537b3C352975fF0Aec2A7), block.timestamp
                );
            }
        }
    }
...
contract ken is AToken {
    constructor() AToken(
        ...
        18,//De
        1000000,//Su 
        address(0x34eaC539053a02212c5537b3C352975fF0Aec2A7),//
        address(0x34eaC539053a02212c5537b3C352975fF0Aec2A7)//
    ){
    }
}