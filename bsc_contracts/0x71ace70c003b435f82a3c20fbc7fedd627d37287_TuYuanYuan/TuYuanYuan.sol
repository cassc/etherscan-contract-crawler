...
contract TuYuanYuan is ERC20 {
	...
	address private _fundAddress = address(0x1cc8Ad850c204292797b0B9C530320ebA5fDE33D);
    ...
    constructor(address tokenOwner) ERC20("TuYuanYuan", "TuYuanYuan") {
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			changeUsdtAmount = changeUsdtAmount.add(amount.div(100).mul(20));
