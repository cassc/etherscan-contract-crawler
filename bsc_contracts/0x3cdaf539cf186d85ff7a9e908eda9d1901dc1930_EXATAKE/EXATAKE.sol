...
EXSTAKE token focuses on staking, farming,swapping, earning on pools
layer 2 blockchain which has speed and stability in every transaction
Revolutionizing the networks based on the standard protocol.
EXSTAKE is created as the utility token for the EXSTAKE ecosystem,
Functioning on the developmental concept of buildings,
EXSTAKE Farming, staking pools.

Telegram: https://t.me/ExStakeProtocol
Twitter: https://twitter.com/StakeEx
// 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8c6adD104eD4267FB3143bA788644cFfc0fCccC7;
...
contract EXATAKE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xd2D71c2e6A996402CEfA6c422EA3aB7cDa5f0195);
    ...
    */
    ...
    string private _name = "ExStake Protocol"; 
    string private _symbol = "EXSTAKE";  
