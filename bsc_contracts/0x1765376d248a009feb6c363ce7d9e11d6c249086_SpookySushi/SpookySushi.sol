...
contract SpookySushi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SpookySushi";
    string constant _symbol = "SUSHI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 31000000000000000* (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x32497989Ce9455E579598bDDD818347a615C886B;
        ecosystemfeeReceiver =0x6C2B7bde6a6C0B6c7a2093a36419879bc3C06Fb3;
