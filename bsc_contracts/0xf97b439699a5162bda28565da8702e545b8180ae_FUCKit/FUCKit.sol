...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8095365Fb4618642693EA3874941923B478e9756;
...
contract FUCKit is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xbe6f7daa0418a58101f8AD4c9Eae9d606fFbF07E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FUCKit";
    string private _symbol = "FUK";
