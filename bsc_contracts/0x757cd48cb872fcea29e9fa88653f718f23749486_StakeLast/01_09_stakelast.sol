...
contract StakeLast is Ownable, ReentrancyGuard, Pausable {
	...
	function clcDay() public view returns (uint256) {
       return (block.timestamp - (nextRewardTime - 5 minutes)) / 5 minutes;
    }
	...
	function updatePool() public {
		if(clcDay() > 0)
		{
			...
			nextRewardTime += numdays * 5 minutes;
