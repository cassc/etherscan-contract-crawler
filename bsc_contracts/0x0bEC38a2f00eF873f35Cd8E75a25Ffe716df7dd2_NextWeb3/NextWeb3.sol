...
/** Created for NextWeb3 Contracts - /*  https://nextweb3development.com */
...
interface IDividendDistributor {
    ...
    IBEP20 public Tokenrewards = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Tokenrewards.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(Tokenrewards);
        ...
        uint256 amount = Tokenrewards.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Tokenrewards.transfer(shareholder, amount);
    ...
    address Tokenrewards = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB =     0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD =     0x000000000000000000000000000000000000dEaD;
    address ZERO =     0x0000000000000000000000000000000000000000;

    string constant _name = "Jaguar";
    string constant _symbol = "JGR";
    ...
    address public pair;
    address  Private = 0x2a9fD09A8359Fc3F8b996c110c62FCdbf428F98f;
    address  Fair_PinkSale = 0x5E7d8A585649d2Cd1b7b618648B67d58c93eDD71;
    address  Airdrop_Wallet = 0x68532Cfc0F9Ac6014060cD5873aA209d8ca94dc2;
    address  Vesting_Team = 0x33174DE9AC8058d6A58542b190a0a44Cf3453375;//Block 90 Days
    ...
    constructor () Auth(msg.sender) {
        ...
        _balances[Private] = ((_totalSupply * 30) / 100);
        _balances[Fair_PinkSale] = ((_totalSupply * 50) / 100);
        _balances[Airdrop_Wallet] = ((_totalSupply * 10) / 100);
        _balances[Vesting_Team] = ((_totalSupply * 10) / 100);

        emit Transfer(address(0), Private, ((_totalSupply * 30) / 100));
        emit Transfer(address(0), Fair_PinkSale, ((_totalSupply * 50) / 100));
        emit Transfer(address(0), Airdrop_Wallet, ((_totalSupply * 10) / 100));
        emit Transfer(address(0), Vesting_Team, ((_totalSupply * 10) / 100));
    }
    ...
    function setTxLimit(uint256 BuyAmount, uint256 SellAmount) external authorized {
    ...
    function setIsMaxWalletExempt(address holder, bool exempt) external authorized {
     ...
     function setBuyFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _projectFee,  uint256 _buyfeeburning) external authorized {
    ...
    function setSellFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _projectFee, uint256 _sellfeeburning) external authorized {
