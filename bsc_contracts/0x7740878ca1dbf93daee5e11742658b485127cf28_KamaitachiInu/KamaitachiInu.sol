...
//Telegram : https://t.me/KamaitachiInuBSC
...
contract KamaitachiInu is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Kamaitachi Inu";
    ...
    uint256 public _walletMax =   3000000000000000 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x0e07359a3AAEEB76a4267bCf4534c4a9B8A35eeb;

        marketingWallet = 0x0e07359a3AAEEB76a4267bCf4534c4a9B8A35eeb;

        devWallet = 0x0e07359a3AAEEB76a4267bCf4534c4a9B8A35eeb;
