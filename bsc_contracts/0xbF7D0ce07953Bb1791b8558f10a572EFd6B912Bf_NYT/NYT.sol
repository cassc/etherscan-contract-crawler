...
contract  NYT is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x492C4E4C9803c4853d056E6e9615f6AAb984fFd6));
        ruinWalletAddress = payable(address(0x492C4E4C9803c4853d056E6e9615f6AAb984fFd6));
