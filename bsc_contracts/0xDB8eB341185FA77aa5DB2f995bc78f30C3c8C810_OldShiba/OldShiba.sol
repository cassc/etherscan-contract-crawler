...
contract OldShiba is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x70B676B334A08132DBB83b15fa307C642c3B9b3a); 
    address payable public Wallet_Dev = payable(0x70B676B334A08132DBB83b15fa307C642c3B9b3a);
    address payable public constant Wallet_Burn = payable(0x70B676B334A08132DBB83b15fa307C642c3B9b3a); 
    ...
    string private constant _symbol = unicode"OldSHIBA"; 
    ...
    constructor () {
        ...
        _owner = 0x70B676B334A08132DBB83b15fa307C642c3B9b3a;
