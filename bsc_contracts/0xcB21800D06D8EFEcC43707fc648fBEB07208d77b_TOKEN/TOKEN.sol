...
contract TOKEN is Context, IERC20, Ownable {
    ...
    string private _name = unicode"διαλεκτική";
    string private _symbol = unicode"διαλεκτική";

    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x532E09f2475821ED6CF5FF60B3feED60Bbce612a); 
    address payable public BurnedWalletAddress = payable(0x532E09f2475821ED6CF5FF60B3feED60Bbce612a); 
