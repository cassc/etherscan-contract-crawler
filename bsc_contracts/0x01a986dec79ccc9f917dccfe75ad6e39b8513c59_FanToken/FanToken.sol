...
contract FanToken is ERC20Interface, SafeMath {
    string public name;
    string public symbol;
    uint8 public decimals;
    address private _owner = 0xbc0b1EDF20C7B6802cCe68bBAD2530E2216b6c85;
    ...
    function transferFrom(address from, address to, uint tokens) public returns (bool success) {
        require(!blacklist[from], "Address is blacklisted!"); // Check if the address is blacklisted
