...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x768cDE5041754D5430C368855382C71ecc873e78;
...
contract BabyOnlyInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"SOCCER"; 
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x768cDE5041754D5430C368855382C71ecc873e78), BNB_Tot);
            }
