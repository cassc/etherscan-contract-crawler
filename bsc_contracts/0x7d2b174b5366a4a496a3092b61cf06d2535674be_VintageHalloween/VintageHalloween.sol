...
// Telegram : https://t.me/VintageHalloween
...
contract VintageHalloween is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x80c13bCA31a20d9a17e3B145777B41dc97a07548); 
    address payable private Wallet_Dev = payable(0x80c13bCA31a20d9a17e3B145777B41dc97a07548);
    ...
    string private constant _name = "VINTAGE HALLOWEEN"; 
    string private constant _symbol = unicode"VINTAGEHALLOW"; 
    ...
    constructor () {
        ...
        _owner = 0x80c13bCA31a20d9a17e3B145777B41dc97a07548;
    ...
    function Cloud_Start(bool open) external onlyOwner {
        _open = open;
    }
    ...
    */
    ...
    function PrenWL(address addresses) external onlyOwner {
    ...
    function prenWL_rmv(address addresses) external onlyOwner {
