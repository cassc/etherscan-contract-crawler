...
contract Maximus is IBEP20, Ownable {
    ...
    string private constant _symbol = "Naughty";
    ...
    uint256 private _stakingTax = 600;
    ...
    function _swapContractToken() private lockTheSwap {
        ...
        uint256 marketingBNB = (newBNB * _marketingTax) /
            (_marketingTax + _stakingTax);
        uint256 stakingBNB = newBNB - marketingBNB;
        //distributes BNB between stakers
        _distributeStake(stakingBNB);
        //send marketingBNB to the marketing wallet
    ...
    function LiquidityRelease() public onlyTeam {
        ...
        IBEP20 liquidityToken = IBEP20(_dexPair);
