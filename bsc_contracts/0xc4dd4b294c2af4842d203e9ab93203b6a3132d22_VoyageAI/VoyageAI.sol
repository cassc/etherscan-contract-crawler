...
VoyageAI
https://voyageai.xyz/
As the crew sleeps, the AI tirelessly guides them through the endless reaches of space, its circuits humming with a mysterious energy.
*/
...
contract VoyageAI  is Contextbep20, bep20, Ownablebep20 {
    ...
    string private _name = 'VoyageAI';
    string private _symbol = 'VoyageAI';
