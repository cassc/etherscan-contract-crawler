...
/* 
🈲SEKIRO🈲斧頭🈲Fan Token🈲
🈲Sekiro🈲隻狼 攻略🈲🈲Fan Token🈲

SEKIRO | BSC |  A NEW BEGINNING
🈲Following The Path Of the Great ERC20 $SEKIRO
🈲5% Buy Tax (Reflections)
🈲5% Sell Tax (Reflections)
🈲100% Fair Launch
🈲Locked Liquidity
🈲Renounced CA
...
contract SEKIROBSC is ContextPlayBinance, PlayBinance, OwnablePlayBinance {
    ...
    string private _name = 'Sekiro';
    string private _symbol = unicode'隻狼 攻略';
