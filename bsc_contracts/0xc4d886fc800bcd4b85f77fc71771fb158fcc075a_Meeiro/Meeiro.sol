...
contract Meeiro is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Meeiro";
    string private _symbol = "MEE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaecAc4562b2BAfD042659Fb89aDDbC4cc23c179E);
    address payable public teamWalletAddress = payable(0xaecAc4562b2BAfD042659Fb89aDDbC4cc23c179E);
