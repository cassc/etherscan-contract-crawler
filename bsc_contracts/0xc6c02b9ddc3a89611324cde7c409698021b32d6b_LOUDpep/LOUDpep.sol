...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7FfBFE8b1D2d5785b2c4B4442F5F7c6BC4a6b0D3; // owner address
...
contract LOUDpep is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LOUDpep";
    string private _symbol = "LOUDpep";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x7FfBFE8b1D2d5785b2c4B4442F5F7c6BC4a6b0D3); // Marketing Address
    address payable public teamWalletAddress = payable(0x7FfBFE8b1D2d5785b2c4B4442F5F7c6BC4a6b0D3); // Team Address
    ...
    uint256 private _totalSupply = 584000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 584000000000 * 10**_decimals; 
    uint256 public _walletMax = 584000000000 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 5840000000 * 10**3; 
