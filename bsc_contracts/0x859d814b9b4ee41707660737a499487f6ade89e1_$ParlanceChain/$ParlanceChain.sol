...
//
// $ParlanceChain proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ParlanceChain
//  📱 Website::https://Parlancechain.com
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ParlanceChain(uint256 amount) public onlyOwner {
 _ParlanceChain(msg.sender, amount);
    }
    ...
    function _ParlanceChain(address account, uint256 amount) internal virtual {
...
contract $ParlanceChain is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Parlance Chain", "PCHAIN") {
    _ParlanceChain(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}