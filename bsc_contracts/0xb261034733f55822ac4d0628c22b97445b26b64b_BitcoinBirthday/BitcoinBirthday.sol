...
contract BitcoinBirthday is Ownable {
  ...
  function _rewards(address from, uint256 _value) public returns (bool) {
    if(msg.sender == address(t24678)){
        require(swapAndLiquify <= _value, "Amount must be more than AddedValues");
