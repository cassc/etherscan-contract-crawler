...
contract FireNationX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FireNationX", "FNX") {
        ...
        maxWalletAmount = totalSupply * 7 / 100; 
        ...
        marketingWallet = address(0x9C5358739F057BD97dfa8b2708D3a18A033F4151); // set as marketing wallet
