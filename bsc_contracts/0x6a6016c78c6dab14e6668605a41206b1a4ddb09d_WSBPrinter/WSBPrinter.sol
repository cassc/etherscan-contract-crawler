...
contract WSBPrinter is Context, IERC20, Ownable {
    ...
    /* Naming */
    string private _name = "WSBPrinter";
    string private _symbol = "WSBP";
    ...
    uint256 private _tTotal = 200 * 10**6 * _decimalFactor; // 200 million tokens total
    ...
    uint256 public _maxTxAmount = 4_000_000 * _decimalFactor; // 2% of total supply
    uint256 public _minTxAmount = 200 * _decimalFactor; // 0.0001% of total supply
    ...
    constructor(
        ...
        address payable marketingAddress
            ...
            "ReflectFeeCoin: Addresses cannot be the zero address"
        );
    ...
    // Remove the override keyword from the name and symbol functions
