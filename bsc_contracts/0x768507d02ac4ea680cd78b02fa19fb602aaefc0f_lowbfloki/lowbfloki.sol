...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x843D4a358471547f51534e3e51fae91cb4Dc3F28);
...
contract lowbfloki is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x48A0db465ca4b6f7f248f61B3F85a1C6BBdB0Be5;

    string constant _name = "LowbFloki";
    string constant _symbol = "lowbfloki";
