...
twitter : https://twitter.com/FlokiChairman
Telegram: https://t.me/flokichairmangroup
reddit  : https://www.reddit.com/r/FlokiChairman
**/
...
contract FLOKICHAIRMAN is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x37c55fDC707CBbD0dFCA25a14d06f9840e6ef085;

    string private constant _name = "FLOKI CHAIRMAN";
    string private constant _symbol = "CHAIRMAN";
    ...
    // A one time function Enable Trade
    ...
    function updateSwapTokensAtAmount(uint256 amount) external onlyOwner {
        require(amount <= 1e12, "Cannot set swap threshold amount higher than 1% of tokens");
