...
contract PundPuppyDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PundPuppyDAO";
    string private _symbol = "PPUPPY"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x52a0F9a22D9B9F314E5C568faEa737b0EbcBFc9D); 
    address payable public teamWalletAddress = payable(0xf2220236840c16AD8369Cf625735F99ddcF3B9d8);
