...
contract LunaHalf is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xCBa02271C2479D0e65B36a955C9E85b148Fe3f20);
    address payable public Wallet_Dev =
        payable(0x9ca9De95A3eBEeD7BFCD493eD5eD9D2A901bf390);
    ...
    string private constant _name = "LunaHalf";
    string private constant _symbol = unicode"LunaHalf";
    ...
    constructor() {
        _owner = 0x9ca9De95A3eBEeD7BFCD493eD5eD9D2A901bf390;
