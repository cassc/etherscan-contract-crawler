...
/**
   Telegram: https://t.me/BITCOINPIZZADAYBSC
   Twitter : https://twitter.com/BTCPIZZADAYCOIN
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf757A79365180CdDcA6fA8CcBB8029e32dc0A024; // owner address
...
contract BITCOINPIZZADAY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " BITCOIN PIZZA DAY ";
    string private _symbol = " BTC PIZZA  ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xf757A79365180CdDcA6fA8CcBB8029e32dc0A024); // Marketing Address
    address payable private teamWalletAddress = payable(0xf757A79365180CdDcA6fA8CcBB8029e32dc0A024); // Team Address
