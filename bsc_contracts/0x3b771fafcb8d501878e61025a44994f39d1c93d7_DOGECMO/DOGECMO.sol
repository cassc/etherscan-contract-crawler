...
contract DOGECMO is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x88f9Bb9b9771De51d229e37909c41383414924C8); 
    address payable public Wallet_Dev = payable(0x88f9Bb9b9771De51d229e37909c41383414924C8);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =1000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "DOGE CMO"; 
    string private constant _symbol = unicode"DCMO"; 
    ...
    constructor () {
        _owner =0x88f9Bb9b9771De51d229e37909c41383414924C8;
