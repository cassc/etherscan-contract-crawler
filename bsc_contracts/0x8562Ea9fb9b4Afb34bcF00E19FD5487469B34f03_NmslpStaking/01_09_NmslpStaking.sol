...
contract NmslpStaking is Ownable, ReentrancyGuard, Pausable {
    ...
    constructor () {
	   ...
	   rewardPoolBalance = 20000 * 10**18; 
	   rewardPercent = 200;
	   decayPercent = 100;
	   nextRewardTime = 1676505600;
	   NMSLP = address(0x2CBceE506304b579149749758BBF877B4b40E6d2);
	   supplyContract = address(0xC721bBb09717eA0F9Ed09C96EdC3D5A531d5A445);
    }
