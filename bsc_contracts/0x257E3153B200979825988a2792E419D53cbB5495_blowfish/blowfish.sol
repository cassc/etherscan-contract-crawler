...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xAdF38847d5a40cab95269d43eA18aa8667d4D819;
...
contract blowfish is Context, IERC20, Ownable { 
    ...
    address payable public tax = payable(0xAdF38847d5a40cab95269d43eA18aa8667d4D819);
    ...
    string private constant _name = unicode"Blowfish"; 
    string private constant _symbol = unicode"BLOW🐡"; 

    uint256 public P_DevReward = 95;
    uint256 public Part_AutoLiquidity = 5; 
    ...
    uint256 public _maxWalletToken = _tTotal.div(24);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tDev  = contractTokenBalance * P_DevReward / 100;

            uint256 balanceBeforeSwap = address(this).balance;
            swapTokensForBNB(tLPhalf+tDev);
            uint256 BNB_Tot = address(this).balance - balanceBeforeSwap;

            uint256 split_D = P_DevReward * 100 / (Part_AutoLiquidity  + P_DevReward);
