 ...
 */
contract OnAvaxAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event OnAvaxAuctionContractDeployed();
        ...
        initializer
    {
        require(
            ...
            "OnAvaxAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit OnAvaxAuctionContractDeployed();
 ...
 */
        ...
        nonReentrant
    {
        ...
        IOnAvaxMarketplace marketplace = IOnAvaxMarketplace(
        ...
        emit AuctionResulted(
            ...
            winner,
            auction.payToken,
            IOnAvaxMarketplace(addressRegistry.marketplace()).getPrice(
                auction.payToken
            ),
            winningBid
        );
