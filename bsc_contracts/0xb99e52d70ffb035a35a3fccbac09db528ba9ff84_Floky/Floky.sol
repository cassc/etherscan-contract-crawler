...
/**
Meet Floky, the adorable dog whose parents are from two different breeds

    Telegram : https://t.me/FlokyBSC
    Website : https://floky.club/
*/
...
contract Floky is IBEP20, Auth {
    ...
    string constant private _name = "Floky";
    string constant private _symbol = "$FLOKY";
