...
contract SuperMarioPepe is Context, IERC20, Ownable {
    ...
    string private constant _name = " Super Mario Pepe "; // 
    string private constant _symbol = " $SMPepe "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xD2EE5654A60d1FC5f367F5933A4A8B92EbFEf255;
