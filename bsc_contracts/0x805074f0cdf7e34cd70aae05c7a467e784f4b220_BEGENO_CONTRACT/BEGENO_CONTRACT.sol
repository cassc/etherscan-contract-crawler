...
contract BEGENO_CONTRACT {
    ...
    function registerandbuy(address _userwallet, uint256 investment)
        public
        payable
    {
    ...
    function withdrawincome(address payable _userAddress, uint256 WithAmt)
        public
    {
        require(msg.sender == owner, "onlyOwner");
    ...
    function withdrawLostTokenFromBalance(uint256 QtyAmt, IBEP20 _TKN) public {
        require(msg.sender == owner, "onlyOwner");
