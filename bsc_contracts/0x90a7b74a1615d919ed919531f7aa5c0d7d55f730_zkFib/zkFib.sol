...
https://pub.towardsai.net/the-fibonacci-sequence-an-algorithm-for-perfection-1d79768da9f7

.....and this exercise is how I see the world.
...
contract zkFib is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("zk-Fib", "Spiral") {
        ...
        marketingWallet = address(0xde5a20B805441a161B79775E0b7B42e96d92b3Cd); // set as marketing wallet
        devWallet = address(0xde5a20B805441a161B79775E0b7B42e96d92b3Cd); // set as dev wallet
