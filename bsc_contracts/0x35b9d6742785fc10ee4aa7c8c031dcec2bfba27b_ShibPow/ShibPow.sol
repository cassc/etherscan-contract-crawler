...
Telegram : https://t.me/shibpowbsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1A25B0D15eCe4d151814cCE9204E0D9cb398680b; // owner address
...
contract ShibPow is Context, IERC20, Ownable {
    ...
    string private _name = "ShibPow";
    string private _symbol = "$SPOW";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A25B0D15eCe4d151814cCE9204E0D9cb398680b); // Marketing Address
    address payable public teamWalletAddress = payable(0x1A25B0D15eCe4d151814cCE9204E0D9cb398680b); // Team Address
