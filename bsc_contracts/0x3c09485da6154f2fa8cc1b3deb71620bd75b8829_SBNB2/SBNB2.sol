...
/*
https://t.me/ProofOfSpookyBNB2_0
*/
...
contract SBNB2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Proof Of Spooky";
    string private _symbol = "SBNB2.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x037e3cdAcD5B788cf84bB1aCf328557decA1DC98);
    address payable public BuyBackWalletAddress = payable(0x24E9a76adF6984Bd5409Bfcf0c5f7Fda19bdF433); 
    ...
    uint256 private _totalSupply = 9876543210 * 10**9;
    uint256 public _maxTxAmount = 197530865 * 10**9;
    uint256 public _walletMax = 197530865 * 10**9;
