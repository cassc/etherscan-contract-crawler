...
contract COKI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "COKI";
    string private _symbol = "COKI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e0cd023923814C5f542f95adC72f9ed87c8610d); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x9e0cd023923814C5f542f95adC72f9ed87c8610d); // Development Address
    ...
    uint256 public _walletMax = 25000* 10**6 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (1000* 10**6 * 10**9), "Max wallet should be less or euqal to 2% totalSupply");
