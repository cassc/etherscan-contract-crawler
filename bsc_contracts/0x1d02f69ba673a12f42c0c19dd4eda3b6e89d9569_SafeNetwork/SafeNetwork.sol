...
contract SafeNetwork is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1D60E6566E69c37DBec1A8638C229b7B4Bc4DcC8); 
    address payable public Wallet_Dev = payable(0x1D60E6566E69c37DBec1A8638C229b7B4Bc4DcC8);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "Safe Network AI"; 
    string private constant _symbol = unicode"$SAFEAI"; 
