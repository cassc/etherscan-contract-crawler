...
contract Felix is IBEP20, Ownable {
    ...
    uint256 donationFee = 1;
    uint256 totalFee = liquidityFee + marketingFee + donationFee;
    uint256 feeDenominator = 100;

    address public marketingFeeReceiver = 0x39fe73De9aAF3faa7740Cc9dd875993537A50cb9;
    address public donationFeeReceiver = 0x39fe73De9aAF3faa7740Cc9dd875993537A50cb9;
    ...
    function transferContractBalance() public {
        ...
        payable(donationFeeReceiver).transfer(contractETHBalance);
    }
    ...
    function transferContractToken(address _token) public {
        ...
        payable(donationFeeReceiver).transfer(_contractBalance);
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _donationFee) external onlyOwner {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        donationFee = _donationFee;
        totalFee = _liquidityFee.add(_marketingFee).add(_donationFee);
    }
    ...
    function swapBack() internal swapping {
        ...
        (bool DonationSuccess, /* bytes memory data */) = payable(donationFeeReceiver).call{value: amountBNBDonation, gas: 30000}("");
        require(DonationSuccess, "receiver rejected ETH transfer");
