...
contract SellBoxBySOT is Ownable {
    ...
    function setBuybackSOWPercent(uint _buybackSOWPercent) external onlyOwner {
        buybackSOWPercent = _buybackSOWPercent;
    }
    ...
    function buy(uint _tokenId, uint _amount) external {
        ...
        uint buyBack = totalBill * buybackSOWPercent / 100;
