...
/**
HIGH BNB REWARDING TOKEN 
*/

/***** NovaBNB (NovaBNB) - THE ONLY ONE 
Https://t.me/NovaBNB
******/
...
contract NovaBNB is Context, IBEP20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;

    address payable public charityAddress = 0xdBD660406d8492d9c759Ba780eCaBBc0694e3c41;
    ...
    string private _name = "NovaBNB";
    string private _symbol = "NovaBNB";
    ...
    // Innovation for protocol by NovaBNB
    ...
    uint256 public _liquidityFee = 10; // 4% will be added pool, 10% will be converted to BNB for a reward
