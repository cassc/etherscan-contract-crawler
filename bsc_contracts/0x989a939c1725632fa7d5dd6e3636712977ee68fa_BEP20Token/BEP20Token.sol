...
Metaverse Hedge Corporation (METRIKA)
Token Metaverse Decentralized Ecosystem / Protocol Hedge Stable Finance
...
contract BEP20Token is IBEP20, SafeMath {
    ...
    constructor() {
        name = "Metaverse Hedge Corporation";
        symbol = "METRIKA";
        decimals = 18;
        _totalSupply =  3000000000 * 10**18;

        _admin = 0x447978A54C5ECb0D0A373d35EB1c8A43703dcd06; // admin account
    ...
    */
    ...
    /*
    "allowance" function - The BEP-20 standard allows an address to give permission 
    ...
    */
    function burn(uint256 _value) public onlyOwner returns (bool success) {
        require(_value <= balances[msg.sender], "BEP20: small balances");
