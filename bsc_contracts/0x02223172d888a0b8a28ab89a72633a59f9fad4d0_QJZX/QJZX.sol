...
contract QJZX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QJZX";
    string private _symbol = "QJZX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaA79e7565fB526cded1C7e098506A3F6fD91C2a3);
    address payable public teamWalletAddress = payable(0xaA79e7565fB526cded1C7e098506A3F6fD91C2a3);
    address public immutable deadAddress = 0xaA79e7565fB526cded1C7e098506A3F6fD91C2a3;
