    ...
    ReentrancyGuardUpgradeable
{
    ...
    function addMargin(
        ...
        futuresAdapter.crossBlockchainCall(
            ...
            abi.encode(_positionManager, _amount, _busdBonusAmount, msg.sender)
        );
    }
    ...
    function deposit(
        ...
        // real busd amount = total initial margin amount - busd bonus amount
        uint256 assetMarginWithoutFee = _amount - _busdBonusAmount;
