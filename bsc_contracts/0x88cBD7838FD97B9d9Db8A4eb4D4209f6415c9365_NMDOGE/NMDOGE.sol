...
contract NMDOGE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Naughtius Maximus DOGE";
    string private constant _symbol = "NM DOGE";
