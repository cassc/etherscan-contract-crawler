...
// Hyper protocol community rewards for the hottest tokens in BSC while getting good pumps
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  function updateDividendUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "HYPERPROTOCOL: The router already has that address");
  ...
  constructor() {
    ...
    ammIsWhiteListed[address(0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F)] = true; // Sushiswaprouter
        ...
        whiteListRewardTokens[address(0x156ab3346823B651294766e23e6Cf87254d68962)] = true; // LUNA


        
    InvestorAddress = payable(0x95bE7Ce8B7E8497766e3806f116044DC2819B8F0);
  }
...
contract HYPERPROTOCOL is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public defaultToken = 0x156ab3346823B651294766e23e6Cf87254d68962;
    ...
    constructor() ERC20("THEHYPERPROTOCOL", "PROTOCOL", 18) {
    	...
    	operationsWallet = address(0x29f10dfA7b57fC028d752Ec71e4a19814816731e);
    	investorWallet = address(0x95bE7Ce8B7E8497766e3806f116044DC2819B8F0);
    	marketingWallet = address(0xcAC1A822dFFc2C5304D357790F0f3375941c3109);
        buybackWallet = address(0x3c8298f9d8a7773bC2FF6158993c3993FE4c1378);
    ...
    function updateMaxAmount(uint256 newNum) external onlyOwner {
  	...
  	function setWhiteListAMM(address ammAddress, bool isWhiteListed) external onlyOwner {
  	  require(isContract(ammAddress), "HYPERPROTOCOL: setWhiteListAMM:: AMM is a wallet, not a contract");
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	...
  	function updateDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(dividendTracker), "HYPERPROTOCOL: The dividend tracker already has that address");

        DividendTracker newDividendTracker = DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "HYPERPROTOCOL: The new dividend tracker must be owned by the Inuko token contract");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != uniswapV2Pair, "HYPERPROTOCOL: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) external onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "HYPERPROTOCOL: The liquidity wallet is already this address");
    ...
    function updateOperationsWallet(address newOperationsWallet) external onlyOwner {
        require(newOperationsWallet != operationsWallet, "HYPERPROTOCOL: The operations wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "HYPERPROTOCOL: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "HYPERPROTOCOL: Cannot update gasForProcessing to same value");
    ...
    // @dev User Callable Functions start here! ---------------------------------------------
  	...
  	function setRewardToken(address rewardTokenAddress) external returns (bool) {
  	    require(isContract(rewardTokenAddress), "HYPERPROTOCOL: setRewardToken:: Address is a wallet, not a contract.");
  	    require(rewardTokenAddress != address(this), "HYPERPROTOCOL: setRewardToken:: Cannot set reward token as this token due to Router limitations.");
  	    require(isWhitelistedToken(rewardTokenAddress), "HYPERPROTOCOL: setRewardToken:: Reward Token must be whitelisted to be used as rewards.");
  	...
  	function setRewardTokenWithCustomAMM(address rewardTokenAddress, address ammContractAddress) external returns (bool) {
  	    require(isContract(rewardTokenAddress), "HYPERPROTOCOL: setRewardToken:: Address is a wallet, not a contract.");
  	    require(ammContractAddress != address(uniswapV2Router), "HYPERPROTOCOL: setRewardToken:: Use setRewardToken to use default Router");
  	    require(rewardTokenAddress != address(this), "HYPERPROTOCOL: setRewardToken:: Cannot set reward token as this token due to Router limitations.");
  	    require(isWhitelistedToken(rewardTokenAddress), "HYPERPROTOCOL: setRewardToken:: Reward Token must be whitelisted to be used as rewards.");
  	    require(isAMMWhitelisted(ammContractAddress) == true, "HYPERPROTOCOL: setRewardToken:: AMM is not whitelisted!");
    ...
    function buyBackTokensWithNoFees() external payable returns (bool) {
        ...
        require(userBNBDividends >= holderBNBUsedForBuyBacks[msg.sender].add(msg.value), "HYPERPROTOCOL: buyBackTokensWithNoFees:: Cannot Spend more than earned.");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "HYPERPROTOCOL: Automated market maker pair is already set to that value");
...
contract DividendTracker is DividendPayingToken {
    ...
    function withdrawDividend() pure external override {
        require(false, "HYPERPROTOCOL_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Inuko contract.");
    }
