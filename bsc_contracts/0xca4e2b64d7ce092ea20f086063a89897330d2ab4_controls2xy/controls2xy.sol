...
contract controls2xy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "controls2xy";
    string private _symbol = "$cs2xyz";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x21a38b4C5098290BEcfBfAD44d330BF4e77d805D); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x21a38b4C5098290BEcfBfAD44d330BF4e77d805D); // BuyBack Address
