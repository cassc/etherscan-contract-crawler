...
contract RedeemAirdropVault is ERC20, Pausable, Ownable {
    IERC20 public immutable token;

    constructor(address _token) ERC20("GemzstoneToken IOU", "GEMZS IOU") {
        token = IERC20(_token);
    }
    ...
    function withdraw(uint _receiptTokens) external whenNotPaused {
