...
contract BNKAKI  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNKAKI ";
    string private _symbol = "BNKAKI ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x85CE1F0ed648B8619510A01c4Ba6724598cBe108);
    address payable public teamWalletAddress = payable(0x85CE1F0ed648B8619510A01c4Ba6724598cBe108);
    address public immutable deadAddress = 0x85CE1F0ed648B8619510A01c4Ba6724598cBe108;
