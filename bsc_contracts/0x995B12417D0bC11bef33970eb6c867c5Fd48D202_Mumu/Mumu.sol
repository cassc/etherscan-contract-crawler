...
/*
Mumu is known as the mascot of what many call, the Bull Market. Mumu the bull is forever in a battle with the bears, and other common business and finance memes such as Apu, to dominate and control market sentiments and direction. Mumu had complete control of the market in 2021, and has made his return this Spring of 2023.

Telegram: https://t.me/Mumubep20
*/
...
contract Mumu is IBEP20, Auth {
    ...
    address DEV = 0x40722A19EeD2960276cF8dC2fA845C70e35684b3;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "Mumu";
    string constant _symbol = "MUMU";
    uint8 constant _decimals = 12;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 20 / 1000;
    uint256 public _maxSellTxAmount = _totalSupply * 20 / 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0fb9aa40882c2A9E1dC5cc51b6eF171100ef1B00;
