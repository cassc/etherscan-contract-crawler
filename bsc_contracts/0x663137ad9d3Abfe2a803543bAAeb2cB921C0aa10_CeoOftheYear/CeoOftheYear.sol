...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaED1Fc4581ebF514661a6d2aaBf8C6a20a4858Ed; // owner address
...
contract CeoOftheYear is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ceo Of The Year";
    string private _symbol = "$COTY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xd5d28B31b890804926034Af19f993D2c97A29318); // Marketing Address
    address payable private teamWalletAddress = payable(0xaED1Fc4581ebF514661a6d2aaBf8C6a20a4858Ed); // Team Address
