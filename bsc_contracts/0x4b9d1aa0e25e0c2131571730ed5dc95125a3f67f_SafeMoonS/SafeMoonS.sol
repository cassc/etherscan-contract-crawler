...
contract SafeMoonS is IToken, Ownable {
  ...
  string private _name = "SafeMoonS";
  ...
  constructor() {
    ...
    erc20Rate[0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5] = 5 * 10 ** 9; // 0.5 busd per token
  }
  ...
  function withdrawDepositTokens(address token, address account, uint256 amount) public onlyOwner {
