...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5EE5aEa633620C301B620a624059635d7369B0b7;
...
contract ThreeBsc is Context, IERC20, Ownable { 
    ...
    address payable private Wallet_Dev = payable(0x5EE5aEa633620C301B620a624059635d7369B0b7);
    ...
    uint256 private _tTotal = 3 * 10**18;
    ...
    // Update main wallet
    function UpdateDevWallet(address payable wallet) public onlyOwner() {
        Wallet_Dev = wallet;
        _isExcludedFromFee[Wallet_Dev] = true;
    }
