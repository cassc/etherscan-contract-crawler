...
contract SO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "SO";
    string private _symbol = "SO";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x07B5Ebca3Ede16CD239577DeB2b54177A605e7B8));
        marketingWalletAddress = payable(address(0xDE5F46e0e746aB6A03913f60bc7205a999168692));
