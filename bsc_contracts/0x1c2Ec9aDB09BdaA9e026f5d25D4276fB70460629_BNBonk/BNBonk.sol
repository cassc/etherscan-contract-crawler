...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x366D406C3494978CFa8774C794119A5E8E9f5092; // owner address
...
contract BNBonk is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBonk!";
    string private _symbol = "BNBONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x366D406C3494978CFa8774C794119A5E8E9f5092); // Marketing Address
    address payable public teamWalletAddress = payable(0x366D406C3494978CFa8774C794119A5E8E9f5092); // Team Address
