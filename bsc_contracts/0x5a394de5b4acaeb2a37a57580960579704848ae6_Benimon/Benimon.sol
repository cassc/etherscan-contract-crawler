...
contract Benimon is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    BenimonDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Benimon", "BENI") {
        marketingWallet = payable(0xB03fA0b5792476c8fdE8F63B202bb37cf2Ba3C87);
        devWallet = payable(0xB03fA0b5792476c8fdE8F63B202bb37cf2Ba3C87);
        ...
        dividendTracker = new BenimonDividendTracker(
            payable(this),
            router,
...
contract BenimonDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Benimon public BenimonContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BenimonContract = Benimon(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Benimon_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Benimon_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Benimon contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BenimonContract);

            uint256 prevBalance = BenimonContract.balanceOf(address(this));
            ...
            {
                uint256 received = BenimonContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BenimonContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
