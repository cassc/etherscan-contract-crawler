...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x38581F3144E2A0B1812128eBB49bdeaa9927C68D;
...
contract ThaMachine is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5c2Da90C5924903505d098eD707E9E86F724Ed33;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 25000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Tha Machine";
    string private _symbol = "CPU";
