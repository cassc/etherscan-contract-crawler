...
$$ |  $$ |$$ |  $$ |$$ |  $$ |$$   ____|$$  __$$ |$$ |  $$ |        $$ |  $$ |  $$ |$$ |  $$ |
\$$$$$$  |$$ |  $$ |\$$$$$$$ |\$$$$$$$\ \$$$$$$$ |\$$$$$$$ |      $$$$$$\ $$ |  $$ |\$$$$$$  |
 \______/ \__|  \__| \_______| \_______| \_______| \_______|      \______|\__|  \__| \______/ 
...
contract UndeadInuOfficial is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    uint256 public swapThreshold = _totalSupply * 82 / 10000;
    bool inSwap;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0xFd38792859127342Cd84Bcc51FB413D05B0BfC45;
        teamFeeReceiver = 0xFd38792859127342Cd84Bcc51FB413D05B0BfC45;
        devFeeReceiver = 0xFd38792859127342Cd84Bcc51FB413D05B0BfC45;
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 40000}("");
        (tmpSuccess,) = payable(teamFeeReceiver).call{value: amountBNBteam, gas: 30000}("");
        (tmpSuccess,) = payable(devFeeReceiver).call{value: amountBNBdev, gas: 50000}("");
