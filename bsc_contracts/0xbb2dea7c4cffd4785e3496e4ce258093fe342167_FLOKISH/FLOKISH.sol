...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 CAKE = IBEP20(0xfb5B838b6cfEEdC2873aB27866079AC55363D37E);
...
/* Token contract */
contract FLOKISH is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0xfb5B838b6cfEEdC2873aB27866079AC55363D37E; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x81c43C783057e2C40C956eA7B2A7f3c234e1658e;
    ...
    // Name and symbol
    string constant _name = "Flokish";
    string constant _symbol = "Flokish";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 100m 
