...
//https://t.me/PepeKidoOficiallportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6D2c1d3941541872ae8c0C88F774b5B6c89c3B17; // owner address
...
contract  PepeKido is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeKido";
    string private _symbol = "PPK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6D2c1d3941541872ae8c0C88F774b5B6c89c3B17); // Marketing Address
    address payable public teamWalletAddress = payable(0x6D2c1d3941541872ae8c0C88F774b5B6c89c3B17 ); // Team Address
