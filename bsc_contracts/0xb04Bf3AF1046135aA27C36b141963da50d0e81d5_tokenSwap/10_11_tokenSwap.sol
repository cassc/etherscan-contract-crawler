...
contract tokenSwap {
    ...
    address private constant BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD
    ...
    address private constant ADR = 0x6984a72B81d269f2de608526e0a44f9D2bC892Bb; // ADR
    ...
    function fundFlashSwapContract(
        ...
        require(_owner == address(ADR), "Sender should match this contract");

        IERC20(BUSD).safeApprove(address(PANCAKE_ROUTER), MAX_INT);

        IERC20(BUSD).transferFrom(_owner, address(this), _amount);
    }

    function fundingFlashSwapContract(
        address _owner,
        address _token,
        uint256 _amount
    ) external {
