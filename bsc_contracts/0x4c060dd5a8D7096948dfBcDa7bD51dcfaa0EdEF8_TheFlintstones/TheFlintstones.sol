...
/*
TG- https://t.me/+gKNv97n_PLs0ZWVk
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract TheFlintstones is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "THE FLINTSTONES";
    string private _symbol = "$Flintstones";
    uint8 private _decimals =  18;

    address payable public marketingWalletAddress = payable(0x8357451FA3DEf527404E87A98801bB422A5525C8);
    address payable public devWalletAddress = payable(0x5d86a16F7977CC79D8373Af193940c924D47E885);
    ...
    constructor ()  {
       ...
       _totalDistributionShares = _liquidityShare.add(_marketingShare).add(_teamShare);
        ...
        isWalletLimitExempt[0x10ED43C718714eb63d5aA57B78B54704E256024E] = true;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(blacklistMode){
            require(!isBlacklisted[sender] || isWalletLimitExempt[sender], "Blacklisted");
        }

        if(inSwapAndLiquify)
        {
            ret = _basicTransfer(sender, recipient, amount);
        }
        else
        {
        ...
        _checkBot(sender, recipient);
        return ret;
    }

    function _checkBot(address sender, address recipient) internal {
        if (antibots && sender != deadAddress) {
