...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyLittleNFTFee = 25;
    uint256 public _buyLPDividendFee = 25;

    uint256 public _sellLargeNFTFee = 50;
    uint256 public _sellLittleNFTFee = 25;
    uint256 public _sellLPDividendFee = 25;
    ...
    uint256 public _releaseLPDailyRate = 1000;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (_swapPairList[sender]) {//Buy
                ...
                uint256 largeNFTFeeAmount = tAmount * _sellLargeNFTFee / 10000;
                if (largeNFTFeeAmount > 0) {
                    feeAmount += largeNFTFeeAmount;
                    _takeTransfer(sender, address(_tokenDistributor), largeNFTFeeAmount);
                }
                uint256 littleNFTFeeAmount = tAmount * _sellLittleNFTFee / 10000;
                if (littleNFTFeeAmount > 0) {
                    feeAmount += littleNFTFeeAmount;
                    _takeTransfer(sender, address(_littleNFTRewardDistributor), littleNFTFeeAmount);
                }
...
contract LX is AbsToken {
    ...
    //ShareHolder NFT
        address(0xDd3E13DFA04035cAb5Fe41BEB7479BC806249ac1),
    //Studio NFT
        address(0xd03F37D237C4d1Ba4ebD9F652318c8654B89466F),
        "LX",
        "LX",
        18,
        2999,
    //Receive
        address(0x7203d30abf734FffFDF9bCc6B526d2ee8d67395F),
    //Fund
        address(0x7203d30abf734FffFDF9bCc6B526d2ee8d67395F),
    //Limit
        10
