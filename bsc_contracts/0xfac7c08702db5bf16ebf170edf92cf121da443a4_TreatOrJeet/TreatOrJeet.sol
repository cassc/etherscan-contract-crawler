...
// https://twitter.com/treatorjeet
// https://treat.mottaverse.com
...
contract TreatOrJeet is IBEP20, Ownable {
    ...
    uint256 private constant INITIAL_SUPPLY = 666_666_666 * 10**TOKEN_DECIMALS;
    ...
    TaxWallets public _taxWallet =
        TaxWallets({
            dev: 0xdADA25804E6906E41332Cd097449e73ea1776152,
            TreatBag: 0x4Cbf75772776C75f1665D08E11358F6C036741e0,
            PartySupplies: 0xA5eB05906E7ba0698161346DdD8A341eF295ebD8
        });
