...
contract BAOToken is BEP20Detailed, BEP20 {
  ...
  constructor() BEP20Detailed("BA", "BA", 18) {
    uint256 totalTokens = 10000000000000000 * 10**uint256(decimals());
  ...
  function setLiquidityPoolStatus(address _lpAddress, bool _status) external isAuth {
    liquidityPool[_lpAddress] = _status;
    emit changeLiquidityPoolStatus(_lpAddress, _status);
  }

  function setMarketingPool(address _marketingPool) external isAuth {
