...
contract BabyMarioInu is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Mario Inu";
    string private _symbol = "BABYMARIO";
    ...
    address payable public marketingWallet = payable(0x555F67ac45d2BFDCd7BD115CA2A06404f040D127);
