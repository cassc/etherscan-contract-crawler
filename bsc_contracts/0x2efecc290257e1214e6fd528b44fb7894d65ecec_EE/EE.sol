...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(uint256 minBalance, address _rewardToken) DividendPayingToken(
        "Reward Tracker", "DividendTracker", _rewardToken
        ) {
        claimWait = 3600;
...
contract EE is ERC20, Ownable {
    ...
    string public constant webSite      = "xxx";
    string public constant telegram     = "xxx";
    string public constant twitter      = "xxx";
...
//Repeated addresses for testnet only. In mainnet there will be 2 different addresses
    address public constant marketingWallet1 = payable(0xCBf9053f51E7869309112F48b52994b30534E7AC);
    address public constant marketingWallet2 = payable(0xCBf9053f51E7869309112F48b52994b30534E7AC);
    ...
    address public constant rewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    ...
    constructor() ERC20("ET", "E") {
        ...
        //Repeated addresses for testnet only. In mainnet there will be 7 different addresses
        developmentWallets.developmentWallet0 = payable(0xCBf9053f51E7869309112F48b52994b30534E7AC);
        developmentWallets.developmentWallet1 = payable(0xCBf9053f51E7869309112F48b52994b30534E7AC);
        developmentWallets.developmentWallet2 = payable(0xCBf9053f51E7869309112F48b52994b30534E7AC);
        developmentWallets.developmentWallet3 = payable(0xCBf9053f51E7869309112F48b52994b30534E7AC);
        developmentWallets.developmentWallet4 = payable(0xCBf9053f51E7869309112F48b52994b30534E7AC);
        developmentWallets.developmentWallet5 = payable(0xCBf9053f51E7869309112F48b52994b30534E7AC);
        developmentWallets.developmentWallet6 = payable(0xCBf9053f51E7869309112F48b52994b30534E7AC);
