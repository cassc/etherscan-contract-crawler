...
/**
 Telegram: https://t.me/AIGorillaCEORecycleSystem
 Website: https://gorillaresyclesytem.wixsite.com/aigrs
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x859FB90B52fF0CBC9C04b7234C40122d7Dcb15e6);
        _token = msg.sender;
    }
...
/* Token contract */
contract AIGRS is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CC = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x859FB90B52fF0CBC9C04b7234C40122d7Dcb15e6;
    ...
    // Name and symbol
    string constant _name = "AiGorillaCeoRecycleSystem";
    string constant _symbol = "AIGRS";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000000000 * (10 ** _decimals); // 1m 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x859FB90B52fF0CBC9C04b7234C40122d7Dcb15e6;
