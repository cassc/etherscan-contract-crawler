...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20 (0xf241A54924DB1556340Cbd5079333097fa9FeEBc);
...
contract UMA is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x129c953c29F5C7b2A66ea021fe3aE87BB05b7E41;

    string constant _name = "Ukraine MIL-AID";
    string constant _symbol = "UMA";
