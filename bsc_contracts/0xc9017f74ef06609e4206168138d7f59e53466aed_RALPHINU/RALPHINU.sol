...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x99606Bbf77bE4301a66a9aA6A0F33Debb839C6F8; // owner address
...
contract RALPHINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RALPH INU";
    string private _symbol = "RALPH INU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x99606Bbf77bE4301a66a9aA6A0F33Debb839C6F8); // Marketing Address
    address payable private teamWalletAddress = payable(0x99606Bbf77bE4301a66a9aA6A0F33Debb839C6F8); // Team Address
