...
contract EVM is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0x4bF2f80Cc7b687c65B18e780E91ae5D25639d3cb;
    address public devAddress = 0x45776DB69a33B835e2b07dC285d67298bb1d5553;

    string private constant _name = "EVM AI";
    ...
    // Owner cannot transfer out EVM from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out EVM!");
