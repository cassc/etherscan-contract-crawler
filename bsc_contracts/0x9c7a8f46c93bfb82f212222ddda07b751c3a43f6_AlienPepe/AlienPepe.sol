...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x9418fE4f3ef8dab095B806F21C479cE364fDe285);
...
contract AlienPepe is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Alien Pepe";
    string constant _symbol = "ALPP";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x9418fE4f3ef8dab095B806F21C479cE364fDe285;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xF5330feFED70B1715Ab829114Bbfd2f03cdeA229;  //marketingwallet
        teamWallet = 0xF5330feFED70B1715Ab829114Bbfd2f03cdeA229; //backup wallet
