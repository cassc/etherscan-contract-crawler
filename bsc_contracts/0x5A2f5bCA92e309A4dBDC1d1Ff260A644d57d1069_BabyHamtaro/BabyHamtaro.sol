...
/**
 #Hamtaro
   ...
   Hello Everyone We are from Hamtaro Team, We apologize for what happened to Hamtaroboy.
   We have tried our best but it still doesn't work. We are here to discuss with you our next plans. 
   Our developer is furious about what happened to HamtaroBoy, and now he wants to get in on the act with his next project. 
   If you are still interested in us you can join via the link below or you can ignore it.
   
*/

// Telegram: https://t.me/babyhamtaro_official
...
contract BabyHamtaro is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Baby Hamtaro";
   string constant _symbol = "BHAM";
