                ...
                if (_swapPairList[to]) {
                    if (!inSwap) {
                        ...
                        if (contractTokenBalance > swapTokensAtAmount) {
                            uint256 swapFee = _buyFundFee + _buyLPDividendFee + _sellFundFee + _sellLPDividendFee + _sellLPFee + _markFee;
...
contract MetaGod is AbsToken {
    constructor() AbsToken(
        ...
        18,
        10000000,
        address(0xec13225469D333d796c69C332301424e9A1A3BA3),
        address(0x1374C58D71F1720Aa1E0CD6Bb381598655FB9e82),
