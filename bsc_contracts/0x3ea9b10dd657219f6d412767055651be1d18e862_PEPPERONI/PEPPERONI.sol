...
contract PEPPERONI is Context, IERC20, Ownable {
    ...
    string private _name     = "PEPPERONI COIN";
    string private _symbol   = "PEPENI";
    ...
    { 
        ...
        marketingWallet = 0xa1852f8e7eBfeCB7Ae5C1790d5691B82f746c86e;
        ...
        _isExcludedFromFees[address(0xa19AbA865fCDB23E4b48a3BFf981f1997159C8c2)] = true;
        _isExcludedFromFees[address(0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE)] = true; //pinklock
        _isExcludedFromFees[address(0xb0F9753a96fBE9228FB7Bd46d9b1eaa2b42d2572)] = true; //presale

        _isExcluded[address(this)] = true;
        _isExcluded[address(0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE)] = true; //pinklock
        _isExcluded[address(0xb0F9753a96fBE9228FB7Bd46d9b1eaa2b42d2572)] = true; //presale
        _isExcluded[address(DEAD)] = true;
        _isExcluded[address(uniswapV2Pair)] = true;

        _rOwned[address(0xa19AbA865fCDB23E4b48a3BFf981f1997159C8c2)] = _rTotal;
        _tOwned[address(0xa19AbA865fCDB23E4b48a3BFf981f1997159C8c2)] = _tTotal;

        emit Transfer(address(0), address(0xa19AbA865fCDB23E4b48a3BFf981f1997159C8c2), _tTotal);
    }
