...
/**
 Hedgehog Inu is a community driven meme token that comes with NFT minting and future listing exchange. 
   
🔶 GENIOUS DEV🔶

Previous project all time high made million marketcap with the help of community. I truly believe it can happen again!


Telegram: https://t.me/Hedgehoginubsc
Twitter: https://twitter.com/Hedgehoginubsc
...
contract HEDGEHOG is Context, IERC20, Ownable {
    ...
    string private constant _name = "HedgeHog Inu"; // 
    string private constant _symbol = "HEDGEHOG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 10;
    uint256 private _liquidityFee = 0;
    address private  _marketingWallet = 0x900170a4ecf4a95Da2C653Cc122270533DF40169;
