...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
     ...
     * the total supply {USED ONLY ONCE AT DEPPLOYMENT}.
     *
...
contract BEP20 is ERC20 {
    ...
    constructor(
        ...
        uint256 _buyMarketingFee = marketingFee;
        uint256 _buyLiquidityFee = marketingFee;

        uint256 _sellMarketingFee = liquidityFee;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0) {
                feesAmount = amount * sellTotalFees / 100;
                tokensForLiquidity +=
            ...
            // on buy
                ...
                feesAmount = amount * buyTotalFees / 100;
                tokensForLiquidity +=
