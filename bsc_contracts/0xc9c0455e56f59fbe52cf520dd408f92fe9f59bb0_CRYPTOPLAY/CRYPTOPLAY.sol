...
Crypto Play ($CPlay) is a decentralized movie 
streaming platform built on the Binance Smart Chain (Bep-20). 

The platform enables crypto enthusiasts to easily 
search for and enjoy movies while also fostering 
community interaction. 

It utilizes blockchain technology to ensure transparency, 
security, and low transaction fees. 


Telegram https://t.me/cryptoplaycoin
Website https://cryptoplaybsc.com
...
contract CRYPTOPLAY is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Crypto Play", "CPlay") {
        ...
        // tax is higher at launch to prevent from bot attack, final tax will be 3/6
        ...
        marketingWallet = address(0xD0d5A53A1C3E4921bB4748Dda34Ee11EeCCe70Da); // set as marketing wallet
        devWallet = address(0xD0d5A53A1C3E4921bB4748Dda34Ee11EeCCe70Da); // set as dev wallet
