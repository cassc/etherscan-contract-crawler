...
/* 
Gary (Garald Betram Snail)
Spongebobs pet official crypto token 
------------------------------------
---------- $GARY -------------------
------------------------------------
TG: https://t.me/garyofficial
*/
...
contract GARY is Context, IERC20 {
    ...
    uint256 public _maxWalletToken = _tTotal * 90 / 100;

    uint256 public _maxTxAmount = _tTotal * 90 / 100;
    ...
    constructor ()  {
        ...
        Wallet_Marketing = payable(0x7eD33F8D68ceB375205a57871e076159d44cecDe);
