...
contract ArduiXPresaleBUSD is Context, ReentrancyGuard {
   ...
   modifier onlyOwner() {
    ...
    constructor (uint256 __rate, address payable _wallet90, address payable _wallet10, IERC20 __token, address busd) {
        _owner = msg.sender;
        ...
        require(busd != address(0), "PRESALE: BUSD address is the zero address");
    ...
    function buyTokens(address beneficiary, uint256 amount) public nonReentrant {
        ...
        _busd.safeTransferFrom(beneficiary, _wallet, amount90);
        _busd.safeTransferFrom(beneficiary, _wallet2, amount10);
