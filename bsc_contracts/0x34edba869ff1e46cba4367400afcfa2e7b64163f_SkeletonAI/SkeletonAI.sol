...
/**
Telegram : https://t.me/skeleton_ai
Website  : https://skeletonai.online
*/
...
contract SkeletonAI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SkeletonAI";
    string private _symbol = "SAI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x803fc0A13636355caa01E4C64630ec6995e512b1);
    address payable public BurnedWalletAddress =
        payable(0xa53327da791e8570266Ee86A68B452b6A28E1f31);
