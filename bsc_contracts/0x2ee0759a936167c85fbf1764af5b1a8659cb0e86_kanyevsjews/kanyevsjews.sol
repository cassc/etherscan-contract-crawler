...
Telegram - https://t.me/kanyevsjews                       
...
/* Token contract */
contract kanyevsjews is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Kanye Vs Jews";
    string constant _symbol = "KANYEVSJEWS";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000 * (10 ** _decimals); // 100k 
