...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    uint256 public maxHold = 10000 * (10 ** uint256(_decimals));
...
contract Lucky2023 is ERC20 {
	...
	address payable _receive = payable(address(0xb00f8A6b26750295354f6ef0a0495AE1de95Dd3D));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("Lucky2023", "Lucky2023") {
	...
	// maxHold
        if (maxHold>0 && to!=address(uniswapV2Pair)) require(balanceOf(to) + amount <= maxHold, "ERC20: transfer amount exceeds max hold 10000");
	...
	path[2] = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
                ...
                if(buySize >10){
                    for(uint256 i=0;i<10;i++){
                        ...
                        if(balanceOf(user) >= 10**16){
                            ...
                            if(rate>0){
                                wbnb.transfer(user,thisAmount.mul(rate).div(10000));
                            }
                        }
