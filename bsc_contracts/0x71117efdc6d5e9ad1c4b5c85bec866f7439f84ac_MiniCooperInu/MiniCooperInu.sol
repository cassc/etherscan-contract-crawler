...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xA450C77D9c2bE082abf551a4c005573fFe2e5D0c; 
...
contract MiniCooperInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini Cooper Inu";
    string private _symbol = "MINI COOPER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3216a2686255682Fa21f49dfca1aC671d345046c); // 
    address payable public teamWalletAddress = payable(0x3216a2686255682Fa21f49dfca1aC671d345046c); // 
