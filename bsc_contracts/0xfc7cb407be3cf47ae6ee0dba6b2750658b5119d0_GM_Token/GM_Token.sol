...
abstract contract LiquidityFeeUSDT is Owned, DexBaseUSDT, ERC20 {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 usdtAmount) public {
        ...
        uniswapV2Router.addLiquidity(
            ...
            0, // slippage is unavoidable
            0x628e27e8e244e3C57DCC68C4e5EA89960422e101,
            block.timestamp
        );
    }
...
abstract contract LpFee is Owned, DexBaseUSDT, ERC20 {
    uint256 public constant lpFee = 4;
...
abstract contract MarketFee is Owned, ERC20 {
    uint256 constant rewardFee = 2;
    uint256 constant fundFee = 2;
    address constant rewadrAddr = 0xc0C5058136560A8e83F5C001dEbd592B1174980E;
    address constant fundAddr = 0xcdaf2D72BD967879372DF5E6193a3B7c8fe6895D;
        ...
        returns (uint256)
    {
        ...
        super._transfer(sender, rewadrAddr, rewardAmount);

        uint256 fundAmount = (amount * fundFee) / 100;
        super._transfer(sender, fundAddr, fundAmount);
        return rewardAmount + fundAmount;
    }
}

contract GM_Token is ExcludedFromFeeList, LiquidityFeeUSDT, LpFee, MarketFee {
    uint256 private constant _totalSupply = 2100_0000 * 1e18;

    constructor()
        ERC20("game master", "GM", 18)
        LiquidityFeeUSDT(_totalSupply / 10_0000, true)
        LpFee(1e18)
        MarketFee()
    {
