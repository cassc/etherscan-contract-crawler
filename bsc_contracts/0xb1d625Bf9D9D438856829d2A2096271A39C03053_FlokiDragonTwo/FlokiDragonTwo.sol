...
contract FlokiDragonTwo is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiDragon 2.0";
    string private constant _symbol = "DRAGON2.0";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 3000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 90000000 * 10**_decimals;
    uint256 public _maxWalletAmount = 90000000 * 10**_decimals;
