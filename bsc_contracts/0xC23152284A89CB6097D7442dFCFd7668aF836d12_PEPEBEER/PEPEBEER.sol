...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53715AaDA27b84dcD388b9F897c4b3d131f29420;
...
contract PEPEBEER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe Beer";
    string private _symbol = "BeerPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x53715AaDA27b84dcD388b9F897c4b3d131f29420);
    address payable public teamWalletAddress = payable(0x53715AaDA27b84dcD388b9F897c4b3d131f29420);
