...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xF538ccf49852736f0088af7314F59EFa7090B8db; // owner address
...
contract FLOKIXAI is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiXAI";
    string private _symbol = "FlokiXAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF538ccf49852736f0088af7314F59EFa7090B8db); // Marketing Address
    address payable public teamWalletAddress = payable(0xF538ccf49852736f0088af7314F59EFa7090B8db); // Team Address
