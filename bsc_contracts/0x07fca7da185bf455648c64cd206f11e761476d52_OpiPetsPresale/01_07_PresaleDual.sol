...
contract OpiPetsPresale is Ownable, ReentrancyGuard, PriceConsumerV3 {
    ...
    // function setmaxBuyPerWallet (uint256 newMax) external onlyOwner {
    //     maxBuyPerWallet = newMax;
    // }
    ...
    function collectBUSD() external onlyOwner {
        ...
        IERC20(BUSD).transfer(msg.sender, fundsToSend);

        emit BUSDWithdrawn(msg.sender, fundsToSend);
    }
}
