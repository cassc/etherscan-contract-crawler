...
contract RIBBIT is Context, IERC20, Ownable {
    ...
    string private constant _name = "PePeHum";
    ...
    address payable private _developmentAddress = payable(0x3c0A18F929Ff2AFe9F1cd2906044FFb5409f4483); 
    address payable private _marketingAddress = payable(0x3c0A18F929Ff2AFe9F1cd2906044FFb5409f4483);
    ...
    uint256 public _swapTokensAtAmount = _tTotal.mul(9).div(100);
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            //Trade start check
            //This section of the contract has been modified by Trestilo on 2AM UTC 15/1/23
            //Added: MaxWallet and Maxtxn control with exclusions availability
            if (!tradingOpen) {
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _developmentAddress.transfer(amount.mul(0).div(5));
    }
    ...
    //This function has been added by Trestilo on 2AM UTC 15/1/23
