...
contract NFTByHandContract is ERC721URIStorage {
    ...
    constructor() ERC721("NFT by Hand", "NFTBH") {
    ...
    /* allow the owner of the contract to change the price */
    ...
    /* allow the owner of the contract to change the URI */
