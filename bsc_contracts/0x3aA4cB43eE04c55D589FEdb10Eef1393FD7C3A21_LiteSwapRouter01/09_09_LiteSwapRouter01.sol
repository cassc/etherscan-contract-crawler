...
contract LiteSwapRouter01 is IPancakeRouter01 {
    address public immutable override factory;
    address public immutable override WETH;

    modifier ensure(uint deadline) {
        require(deadline >= block.timestamp, "LiteSwapRouter: EXPIRED");
        _;
    }
        ...
        if (reserveA == 0 && reserveB == 0) {
            ...
            if (amountBOptimal <= amountBDesired) {
                require(
                    ...
                    "LiteSwapRouter: INSUFFICIENT_B_AMOUNT"
                );
                ...
                require(
                    ...
                    "LiteSwapRouter: INSUFFICIENT_A_AMOUNT"
                );
    ...
    function removeLiquidity(
        ...
        require(amountB >= amountBMin, "LiteSwapRouter: INSUFFICIENT_B_AMOUNT");
    }
    ...
    function swapExactTokensForTokens(
        ...
        require(
            ...
            "LiteSwapRouter: INSUFFICIENT_OUTPUT_AMOUNT"
        );
    ...
    function swapTokensForExactTokens(
        ...
        require(
            ...
            "LiteSwapRouter: EXCESSIVE_INPUT_AMOUNT"
        );
        TransferHelper.safeTransferFrom(
            path[0],
            msg.sender,
    ...
    {
        require(path[0] == WETH, "LiteSwapRouter: INVALID_PATH");
    ...
    function swapTokensForExactETH(
        ...
        require(path[path.length - 1] == WETH, "LiteSwapRouter: INVALID_PATH");
        amounts = PancakeLibrary.getAmountsIn(factory, amountOut, path);
        require(
            amounts[0] <= amountInMax,
            "LiteSwapRouter: EXCESSIVE_INPUT_AMOUNT"
