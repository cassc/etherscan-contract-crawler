...
contract token is Context, IERC20, Ownable {
    ...
    string private _name = "JimmyCarter ";
    string private _symbol = "CarTer ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x03c397Ff037057AE2a89157b4e51102a71f36FF5);
    address payable public liqWalletAddress = payable(0x03c397Ff037057AE2a89157b4e51102a71f36FF5);
    ...
    uint256 private _totalSupply =  1000000000000 * 18**_decimals;
    uint256 public _maxTxAmount =   1000000000000 * 18**_decimals;
    uint256 public _walletMax =     1000000000000 * 18**_decimals;
    uint256 private minimumTokensBeforeSwap = 1 * 18**_decimals;
