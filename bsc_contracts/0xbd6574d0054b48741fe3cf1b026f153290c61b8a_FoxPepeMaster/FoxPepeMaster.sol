...
contract FoxPepeMaster is Context, IERC20, Ownable {
    ...
    string private constant _name = " Fox Pepe Master "; // 
    string private constant _symbol = " $FPM "; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 8;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0xF3804626cC900Dd6B310980fac9A48A8a614Bd7B;
