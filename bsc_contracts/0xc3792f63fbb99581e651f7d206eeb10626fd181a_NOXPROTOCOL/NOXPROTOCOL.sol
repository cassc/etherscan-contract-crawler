...
/**
// TELEGRAM : https://t.me/NoxPROTOCOL
*/
...
contract NOXPROTOCOL is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x451F434270a6FF73C67521269312De3ceDBf969E); 
    address payable public Wallet_Dev = payable(0x451F434270a6FF73C67521269312De3ceDBf969E);
    ...
    string private constant _name = " NOX PROTOCOL"; 
    string private constant _symbol = unicode" NOXPROTOCOL "; 
    ...
    constructor () {
        ...
        _owner = 0x451F434270a6FF73C67521269312De3ceDBf969E;
