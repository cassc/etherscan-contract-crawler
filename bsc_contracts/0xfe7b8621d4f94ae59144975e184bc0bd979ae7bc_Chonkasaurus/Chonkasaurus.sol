...
contract Chonkasaurus is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =  0x9690B028FC23FE0Ab48b85b1A127DB2114bde8Cd;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Chonckasauras";
    string private _symbol = "Chonka";
