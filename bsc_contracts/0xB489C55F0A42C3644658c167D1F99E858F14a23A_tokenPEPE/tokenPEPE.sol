...
contract tokenPEPE  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE moon";
    string private _symbol = unicode"🐸pepemoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe83482E1b8dc91e2a2FCAd831430257bB960177a); // Marketing Address
    address payable public teamWalletAddress = payable(0xe83482E1b8dc91e2a2FCAd831430257bB960177a); // Team Address
