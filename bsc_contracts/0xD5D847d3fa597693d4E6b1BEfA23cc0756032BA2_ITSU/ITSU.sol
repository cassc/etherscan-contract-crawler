...
contract ITSU is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "ITSUKI INU";
    string private _symbol = "ITSU";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x447EDdEB3796BF65240608C0dE6eEF90b92c4d50);
