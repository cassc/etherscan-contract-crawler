...
contract BRABUS is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BRABUS", "BRABUS") {
        ...
        marketingWallet = 0xD1d6CAa69D20E7dCC7beB8359cF3D46CB55033c5; // set as marketing wallet
        ...
        /*
                ...
                */
        _mint(msg.sender, tTotal * 75 / 100);
        _mint(marketingWallet, tTotal * 25 / 100);
    }
