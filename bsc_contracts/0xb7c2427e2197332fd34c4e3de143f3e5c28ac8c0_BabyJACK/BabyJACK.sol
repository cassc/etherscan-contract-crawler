...
contract BabyJACK is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BabyJACK";
    string private _symbol = "BabyJACK";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x66cC3f4456210CFb497b9605fE0b9FDDcA8A3d58);
