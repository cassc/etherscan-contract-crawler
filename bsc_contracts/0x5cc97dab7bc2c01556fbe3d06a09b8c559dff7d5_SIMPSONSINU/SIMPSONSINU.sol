...
contract SIMPSONSINU is Context, IERC20, Ownable {
    ...
    string private _name     = "The Simpsons Inu";
    string private _symbol   = "SIMPSONSINU";
    uint8  private _decimals = 9;
   
    uint256 private constant MAX = type(uint256).max;
    uint256 private _tTotal = 420_690_000_000_000 * (10 ** _decimals);
    uint256 internal _tTotalVisual = 420_690_000_000_000 * (10 ** _decimals);
    ...
    {        
        ...
        marketingWallet = 0x1478fDbC46F432e6c48866bCC7a21285C00f31Ed;
