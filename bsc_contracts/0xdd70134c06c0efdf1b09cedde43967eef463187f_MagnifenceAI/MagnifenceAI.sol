...
Telegram https://t.me/magnifenceaiofficial
Website https://magnifence-ai.tech/
*/
...
contract MagnifenceAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MAGNIFENCE AI";
    string private _symbol = "$MAGNI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xBccbe9251F9e45820145Eb47f8F76026242e5088); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xBccbe9251F9e45820145Eb47f8F76026242e5088); // BuyBack Address
    ...
    uint256 public _walletMax = 200 * 10**5 * 10**9;
