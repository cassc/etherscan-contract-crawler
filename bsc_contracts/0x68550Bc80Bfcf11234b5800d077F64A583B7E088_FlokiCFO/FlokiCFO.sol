...
contract FlokiCFO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FLOKI CFO"; 
    string private _symbol = "$FLOKI CFO"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD1f207A99374e60E6cE3feaF5439aCB4D2EdE626); 
    address payable public teamWalletAddress = payable(0xD1f207A99374e60E6cE3feaF5439aCB4D2EdE626); 
