...
contract TigerPEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tiger PEPE";
    string private _symbol = "Tiger PEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8915B3448C93BeD6C169bF52308ECF93e700E5E2); // Marketing Address
    address payable public teamWalletAddress = payable(0xabc149d236C6caBA0bE485268C0d1ECf7b3fC94F); // Team Address
