...
/** 
PECA is now trending on Twitter. 
Contract renounced - zero tax - Liquidity locked.
Huge community around PepeCapo - soon the new Pepe Coin. 

Telegram: https://t.me/PepeCapo
Website: https://www.PepeCapo.com
**/
...
contract PepeCapo {
    ...
    function symbolPECA() public view virtual returns (string memory) {
        return 'memesymbol is PECA';
    }

    function symbolPECA2() public view virtual returns (string memory) {
        return 'mysymbol is PECA';
    }
