...
contract DustiJohn is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Hello John";
    string private constant _symbol = "Hello Dusti";
    ...
    function Adsdyf(uint256 Freazh, uint256 afc , uint256 requ , string memory afk) public {
        afc = 1; requ = 2; afk = "afk";
        Freazh = NewThreeD[0][0];
            NewDis = Freazh;  
    }
