...
abstract contract DividendFee is Owned, DexBaseUSDT, ERC20 {
    ...
    address public marketAddr = 0xcF24d2A17D660B82aDba36c55A7E2eB15D9B7D71;
...
contract Token1040 is ExcludedFromFeeList, DividendFee, RegimentalList {
    uint256 private constant _totalSupply = 1040 * 1e18;
    uint256 public _maxHavAmount = 5 * 1e18;
    bool public presaleEnded = false;
    mapping(address => bool) isHavLimitExempt;
    mapping(address => bool) isbuy;
    uint public count = 0;

    constructor() ERC20("1040", "1040", 18) DividendFee(1e17, true, USDT, 2) {
