...
contract DoraTheBNB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dora The BNB";
    string private _symbol = "DORA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf6Fb1CDf5F7BA0E1A7804747C0756C5FFfd79Ff9); 
    address payable public teamWalletAddress = payable(0xce154F6aBA96ba70037576a0206B86c2C691f2e6); 
    ...
    uint256 public _walletMax = 3000000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 6000000 * 10**9; 
