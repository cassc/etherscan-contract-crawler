        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xF78ea32E0132Bf36fA973Aca1aD3AfEDe3bEC510), block.timestamp
                );
            }
        }
    }
...
contract PEPEzilla is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000,
        address(0x9EDE3765E695B0b16E122f3ba83D9A950038d70c),
        address(0xF78ea32E0132Bf36fA973Aca1aD3AfEDe3bEC510)
    ){
    }
}