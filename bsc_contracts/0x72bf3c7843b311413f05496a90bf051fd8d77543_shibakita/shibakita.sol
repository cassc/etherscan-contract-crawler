...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0xed80d7AC6a8E6e37fE7A5483Db32a9e7EB885dD8 ; // owner address
...
contract shibakita is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIBAKITA";
    string private _symbol = "SAKITA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xed80d7AC6a8E6e37fE7A5483Db32a9e7EB885dD8); // Marketing Address
    address payable public teamWalletAddress = payable(0xed80d7AC6a8E6e37fE7A5483Db32a9e7EB885dD8); // Team Address
