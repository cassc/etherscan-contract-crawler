...
// jojo the Frog 
// t.me/jojo
// jojoCoin: A froggy-themed crypto token that brings meme culture to the blockchain with hoppy humor and viral value. 🐸💰
//
...
contract JojoCoin is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() ERC20("JojoCoin", "JOJO") {
    ...
    function _getTValues(uint256 amount, address from)
        private
        view
        returns (uint256)
    {
