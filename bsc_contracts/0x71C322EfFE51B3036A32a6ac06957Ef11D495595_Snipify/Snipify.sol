...
Buy:  8% marketing, 2% LP, 0% rewards
Sell: 8% marketing, 2% LP, 0% rewards
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 BETH = IBEP20(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1);
...
/* Token contract */
contract Snipify is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x4945bC4E28fC2aD9efbbf519F6Af5CbE877Cd5b4;
    ...
    // Name and symbol
    string constant _name = "Snipify";
    string constant _symbol = "SNIP";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 3000 / 10000; // 2%
    uint256 public _maxSellTxAmount = _totalSupply * 50 / 10000; // 0.5%
    uint256 public _maxWalletToken = ( _totalSupply * 3000 ) / 10000; // 2%
    ...
    uint256 public marketingFeeBuy = 190;
    uint256 devFeeBuy = 0;
  ...
  // Sell fees
    ...
    uint256 public marketingFeeSell = 250;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x412597C48A5fD9b99e217a1cF78eD4864281d6A3;
