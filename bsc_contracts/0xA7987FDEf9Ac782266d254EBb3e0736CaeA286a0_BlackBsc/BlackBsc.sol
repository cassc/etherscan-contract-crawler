...
/**
 ...
 Telegram:  https://t.me/blackbsctoken
...
contract BlackBsc  is Ownable, IERC20 {
    ...
    uint256 public _maxTxAmount = 90000000000000 * 10 ** _decimals;

    uint256 public _fee = 2;

    string private _name = "Black Bsc";

    string private _symbol = "BlackB";
