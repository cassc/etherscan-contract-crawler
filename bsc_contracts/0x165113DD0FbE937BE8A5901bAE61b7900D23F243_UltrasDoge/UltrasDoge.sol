...
contract UltrasDoge is Context, IERC20, Ownable {
    ...
    string private constant _name = "UltrasDoge"; //
    string private constant _symbol = "ULTRAS DOGE"; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0x22392a41C395a26183bfd104712d8AacEA38d4fc;
