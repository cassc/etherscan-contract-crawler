...
// Telegram and Website we will drop after launch.
...
contract MRAT is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "OLD MRAT";
    string private constant _symbol = unicode"OLD MRAT";
    ...
    address payable public DevWallet = payable(0x5d21aca590b9ce9d0101C3Ac00717779bDbe2DDe);
    address payable public MarketingWallet = payable(0x5d21aca590b9ce9d0101C3Ac00717779bDbe2DDe);
    address payable private TeamWallet01 = payable(0xA2A440CB40185cD27173e6DD7B7f7529e2C1a10d);
