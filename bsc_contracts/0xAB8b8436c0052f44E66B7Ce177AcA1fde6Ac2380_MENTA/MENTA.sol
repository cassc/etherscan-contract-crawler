...
contract MENTA is BEP20, Ownable { 
    using SafeMath for uint256;
    ...
    constructor() BEP20("MENTA", "MNT") { 
        marketingWallet = payable(0x994D626d9046080fB777241bebED6a60E4C40778); 
        devwallet = payable(0xb8bb317E52234AB9B7df89BA7e1989c7f90a1d4b); 
        ...
        uint256 totalSupply = (1_000_000) * (10**18); // TOTAL SUPPLY IS SET HERE
