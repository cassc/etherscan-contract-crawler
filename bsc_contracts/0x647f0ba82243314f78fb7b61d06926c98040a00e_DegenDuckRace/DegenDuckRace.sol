...
Welcome to DegenDuckRace, a fun, decentralised betting platform!

Website: https://ddr.bet
Telegram: https://t.me/DegenDuckRace
Twitter: https://twitter.com/DegenDuckRace
...
contract DegenDuckRace is Context, IERC20, Ownable {
    ...
    address payable private disPosible = payable(0x5490e32e73Db80551690Dac803fA571D5c53203b); 
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 15, "Taxes cannot be set higher than 15%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 15, "Taxes cannot be set higher than 15%");
