...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0xb83Db9502fd658ca010525B385230522Fd4eB8Bf;
...
contract ONVO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "One Voice";
    string private _symbol = "ONVO";
    ...
    uint256 internal _tokenTotal = 5_000_000_000_000e18;
    ...
    uint256 public _burnFee = 0; // means 3% it menas on burn 
    
    uint256 public operatingFee = 200; //200 means 2% will send to Operating tax
    
    
    address operatingAddress = 0xb83Db9502fd658ca010525B385230522Fd4eB8Bf; //
    ...
    uint256 roundValue = value.ceil(operatingFee);
    uint256 onePercent = roundValue.mul(operatingFee).div(10000);
    return onePercent;
  }
    ...
    function _transfer(
        ...
        if(isFeeActive && !isTaxless[_msgSender()] && !isTaxless[recipient] && !inSwapAndLiquify){
            ...
            _reflectionBalance[operatingAddress] = _reflectionBalance[operatingAddress].add(tokensToBurn.mul(rate));
        
            emit Transfer(sender, operatingAddress, tokensToBurn);
        }
    ...
    function setOperatingFee(uint256 amount) external onlyOwner {
        operatingFee = amount;
    }
