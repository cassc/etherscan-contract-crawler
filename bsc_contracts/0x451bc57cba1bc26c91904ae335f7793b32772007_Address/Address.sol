...
contract PEPE is Context, IERC20, Ownable {
    ...
    string private _name = "Congo Pepe";
    string private _symbol = "CPEPE";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x8438D35F3530E70A3708F956620f23581D341714); 
    address payable public teamWalletAddress = payable(0x8438D35F3530E70A3708F956620f23581D341714); 
