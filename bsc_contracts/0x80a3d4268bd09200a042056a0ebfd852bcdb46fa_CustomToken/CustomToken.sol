...
contract CustomToken is ERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        // Apply fees and reflection if not whitelisted
        ...
        if (!whitelist[sender] && !whitelist[recipient]) {
            ...
            amount -= burnAmount + reflectionAmount;
    ...
    function setFees(uint256 newBurnRate, uint256 newReflectionRate, uint256 newBuyFee, uint256 newSellFee) public onlyOwner {
        require(newSellFee <= 25, "Sell fee cannot be more than 25%");
        require(newBuyFee <= 25, "buy fee cannot be more than 25%");
