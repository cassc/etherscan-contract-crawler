...
NO JEETS ALLOWED BSC🚫
ARE YOU A JEET?! 
IF YOU ARE THEN YOU AREN’T ALLOWED HERE.

✅️ SAFE DEV(PREVIOUS 112k)
✅️ HUGE MARKETING 
✅️ NEXT 100X PROJECT
✅️ NO JEETS ALLOWED HERE!

JOIN TG IF YOU’RE A BASED CHAD!
https://t.me/nojeetsallowedbsc
...
contract NOJEETSALLOWED is ERC20, Ownable {
    uint256 public marketingFeeOnBuy  = 10;
    uint256 public marketingFeeOnSell = 10;

    address public marketingWallet = 0x7b60ed485ddfF72503c9C0c7777bA020368e5c2c;
    ...
    constructor () ERC20("No Jeets Allowed", "$NOJEETSALLOWED") 
    {   
        ...
        _mint(owner(),999999999999 * (10 ** 18));
