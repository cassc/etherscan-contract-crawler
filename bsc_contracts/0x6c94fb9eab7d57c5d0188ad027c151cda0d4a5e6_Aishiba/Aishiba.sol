...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4a275CDE6B40ECE7a422aA8aE640020cdE02893b; // owner address
...
contract Aishiba is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x4a275CDE6B40ECE7a422aA8aE640020cdE02893b); // Marketing Address
    address payable public teamWalletAddress = payable(0x4a275CDE6B40ECE7a422aA8aE640020cdE02893b); // Team Address
