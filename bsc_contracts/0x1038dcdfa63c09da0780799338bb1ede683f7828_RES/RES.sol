...
abstract contract ERC20 {
    ...
    uint256 public constant TOTAL_SUPPLY = 100_000_000_000_000_000 * 1e9;
...
contract RES is ERC20, Owned {
    ...
    uint256 private constant _ONE_TOKENS = 1e9;
    ...
    constructor(
        address marketing_,
        address master_,
        uint32 handleInterval_,
        uint112 sellRequire_
    ) ERC20("Reversal", "RES", 9) Owned(msg.sender) {
