...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x43E198D900B733B1c4FC1A8B594ECf73979C19bF; // owner address
...
contract Spongee is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Spongee";
    string private _symbol = "$SPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x43E198D900B733B1c4FC1A8B594ECf73979C19bF); // Marketing Address
    address payable public teamWalletAddress = payable(0x43E198D900B733B1c4FC1A8B594ECf73979C19bF); // Team Address
