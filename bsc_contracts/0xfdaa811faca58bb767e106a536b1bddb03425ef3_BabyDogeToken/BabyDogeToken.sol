...
contract BabyDogeToken is ERC20, Ownable {
    ...
    constructor() ERC20("BAby Doge Token", "BabyDToken") {
        marketingWallet = payable(0xBa89bD9817dB742400a687E75ACce78714c21dbD);
        LiquidWallet = payable(0xB373788c6263dd73ec27021ad318c83Ac465f3E9);
    ...
    // set cooldown timer, can only be 1 second (1s max)
    ...
    function updateTransferFee(uint256 newTransferFee) public onlyOwner {
        require (newTransferFee <= 100, "transfer 100");
