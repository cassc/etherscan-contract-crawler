...
/**
TG: https://t.me/squidgocommunity
...
contract SquidGO is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xaCCcCd86B3761D1BBD0E4dB9f0BE9a0dc0B06cd3; //

    string private constant _name = "SquidGO"; //
    string private constant _symbol = "SQUIDGO"; //
