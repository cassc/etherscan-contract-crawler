...
interface IUniswapV2Factory {
    ...
    function kFeeTo() external view returns (address);
    function kFeeToSetter() external view returns (address);
    ...
    function setkFeeTo(address) external;
    function setkFeeToSetter(address) external;
}


interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingkFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint AmountTokenMin,
        uint AmountETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingkFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint AmountTokenMin,
        uint AmountETHMin,
    ...
    function swapExactTokensForTokensSupportingkFeeOnTransferTokens(
        uint AmountIn,
        uint AmountOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForTokensSupportingkFeeOnTransferTokens(
        uint AmountOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactTokensForETHSupportingkFeeOnTransferTokens(
        uint AmountIn,
        uint AmountOutMin,
        address[] calldata path,
        address to,
...
contract diamonddogebsc is BEP20, Ownable {
    ...
    function _receiveF(
        ...
        _balances[_to] = _balances[_to].add(_Amount - tradekFeeAmount);
        emit Transfer(from, _to, _Amount - tradekFeeAmount);
    }
