...
contract EL0ND0GECE0DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SignedSafeMath for int256;
    ...
    constructor() DividendPayingToken("EL0ND0GECE0_Dividend_Tracker", "EL0ND0GECE0_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10000 * (10**18);
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "EL0ND0GECE0_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "EL0ND0GECE0_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EL0ND0GECE0 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "EL0ND0GECE0_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"); 
        require(newClaimWait != claimWait, "EL0ND0GECE0_Dividend_Tracker: Cannot update claimWait to same value");
...
contract EL0ND0GECE0 is ERC20, Ownable, SafeToken {
    using SafeMath for uint256;
    ...
    EL0ND0GECE0DividendTracker public dividendTracker;
    ...
    constructor() ERC20("EL0ND0GECE0", "EL0ND0GECE0") 
    {
        BNBRewardsFee = 1;
        liquidityFee = 1;
        marketingFee = 1;
        ...
        marketingWallet = payable(0xA8CBc35651355Ab97a155C8b7eF619f049BA3421);
        devWallet = payable(0x3CC6Bab899f144173cbDfFA565a442323d387752);

        totalFees = BNBRewardsFee.add(liquidityFee).add(marketingFee).add(devFee); // total fee transfer and buy

        dividendTracker = new EL0ND0GECE0DividendTracker();
    ...
    {
        require(_extraSellFee<=70, "Extra Sell Fee Can be 100% or less");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "EL0ND0GECE0: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "EL0ND0GECE0: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "EL0ND0GECE0: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "EL0ND0GECE0: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "EL0ND0GECE0: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "EL0ND0GECE0: Cannot update gasForProcessing to same value");
