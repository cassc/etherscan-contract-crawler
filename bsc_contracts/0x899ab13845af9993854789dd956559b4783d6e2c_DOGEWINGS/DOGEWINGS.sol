...
interface IDEXRouter {
 ...
 contract DOGEWINGS is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "DOGEWINGS";
    string constant _symbol = "DWINGS";
