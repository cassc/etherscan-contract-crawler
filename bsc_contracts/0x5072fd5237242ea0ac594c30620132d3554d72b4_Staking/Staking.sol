...
contract Staking is Ownable {
    ...
    constructor(address _myToken) {
        ...
        apr[StakingPeriod.ONE_MONTH] = 5000;    // 50%
        apr[StakingPeriod.TWO_MONTH] = 12500;   // 125% 
        apr[StakingPeriod.THREE_MONTH] = 27500; // 275%
        apr[StakingPeriod.SIX_MONTH] = 70000;   // 700%
        apr[StakingPeriod.ONE_YEAR] = 150000;   // 1500%
    }
