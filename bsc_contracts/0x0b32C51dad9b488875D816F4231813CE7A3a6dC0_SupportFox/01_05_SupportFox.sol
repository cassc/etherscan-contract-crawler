...
// SupportFox is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterFox.
contract SupportFox {
    ...
    // Info of each user.
    struct UserInfo {
        uint256 amount; // How many FOXLAYERSPLIT tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws FOXLAYERSPLIT tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes FoxlayerSplit tokens.
    ...
    // Deposit FoxlayerSplit tokens to SupportFox for Reward allocation.
    ...
    // Withdraw FoxlayerSplit tokens from SupportFox.
