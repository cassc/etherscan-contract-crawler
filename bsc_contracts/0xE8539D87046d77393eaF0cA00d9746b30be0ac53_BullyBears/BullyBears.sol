...
contract BullyBears is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "Bully Bears";                                          // name
    string private _symbol = "$BB";                                             // symbol
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0xb3eEc1F12161BE8d98f8aF38e002781E17A07640),                             // Dev+Team wallet
        payable(0xb3eEc1F12161BE8d98f8aF38e002781E17A07640),                             // Marketing wallet
        payable(0xb3eEc1F12161BE8d98f8aF38e002781E17A07640)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
