...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //btc
...
contract FATCAT is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "FAT CAT";
    string constant _symbol = "FCAT";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x1044EA707f742eEEeC9cb10bCD717BFBA60aA2E3;
        marketingWallet = 0x1044EA707f742eEEeC9cb10bCD717BFBA60aA2E3;  
        anothermarketingWallet = 0x1044EA707f742eEEeC9cb10bCD717BFBA60aA2E3;
