...
contract BabyCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Cat";
    string private constant _symbol = "CAT";
    uint8 private constant _decimals = 9;

    address payable private _marketingAddress = payable(0x7E38908fE1C17068CEC258f17D6b3b7eb44A2660);
    address payable private _burnAddress = payable(0xE2aB376d0b2EF649e0AbCdd7A4a346134e801E61);
