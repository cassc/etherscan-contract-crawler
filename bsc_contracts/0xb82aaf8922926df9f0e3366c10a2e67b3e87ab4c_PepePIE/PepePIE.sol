...
contract PepePIE is PepePIEDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private PepePIETeam;
    address private CharityPepePIE;
    ...
    string public override name = "PepePIE";
    string public override symbol = "PepePIE";
    ...
    constructor(uint totalSupplyValue, address PepePIETeamAddress, address CharityPepePIEAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        PepePIETeam = PepePIETeamAddress;
        CharityPepePIE = CharityPepePIEAddress;
        
        // split the tokens according to agreed upon percentages
        balances[PepePIETeam] =  totalSupply * 4 / 100;
        balances[CharityPepePIE] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's PepePIETeam pot
