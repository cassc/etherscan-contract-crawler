...
/**
 *TWITTORO DOGE | THE FUSION OF 3 POWERFUL ELEMENTS | TWITTER + ETORO + DOGE = TWITTORO DOGE |
*/

/**
 *Website: www.twittorodoge.com | Telegram: https://t.me/TwittoroDoge
*/
...
library SafeMath {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "SafeMath: addition overflow & Twittoge");

        return c;
    }
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMath: subtraction overflow & Twittoge");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMath: multiplication overflow use only $TWITTOGE ");
...
contract TWITTORODOGE is Ownable, IBEP20 {
    ...
    string constant _name = "TWITTORO DOGE";
    string constant _symbol = "TWITTOGE";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0x7FE1e245A73D2Dd83551E3FE490f0AdB752b3019;
        marketingFeeReceiver = 0x7FE1e245A73D2Dd83551E3FE490f0AdB752b3019;
