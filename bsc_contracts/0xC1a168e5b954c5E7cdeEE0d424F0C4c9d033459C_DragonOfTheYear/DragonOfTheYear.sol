...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDeBd40b044394Db81f551cb1e080c6c721c4f52e; // owner address
...
contract DragonOfTheYear is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dragon Of The Year";
    string private _symbol = "DOTY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x83743C156C1E139Fd3D9d33Fb61aE6752E4579C7); // Marketing Address
    address payable private teamWalletAddress = payable(0x83743C156C1E139Fd3D9d33Fb61aE6752E4579C7); // Team Address
