...
LindaPepe
Linda Pepe
Strategic Marketing | Business Development | Digital Marketing | Creative Direction | Design & Branding
https://www.linkedin.com/in/lindapepe
http://www.lindapepe.com/home.html
*/
...
contract LindaPepetOKEN is Context, LindaPepebep20ECO, Ownable {
    ...
    string private _name = 'LindaPepe';
    string private _symbol = 'LindaPepe';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_isExcluded[sender] && !_isExcluded[recipient]) {
            ...
            _transferToExcludedone(sender, recipient, amount);
        } else if (!_isExcluded[sender] && !_isExcluded[recipient]) {
    ...
    function _transferToExcludedone(address sender, address recipient, uint256 tAmount) private {
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee) = _getValues(tAmount);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
