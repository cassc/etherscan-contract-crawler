...
contract DurtStake is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint16 public constant MAX_WITHDRAWAL_FEE_BP = 900;
    uint16 public constant MAX_DEPOSIT_FEE_BP = 900;
