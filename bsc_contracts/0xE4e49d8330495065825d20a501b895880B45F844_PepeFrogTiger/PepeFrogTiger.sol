...
contract PepeFrogTiger is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe Frog Tiger";
    string private _symbol = "Pepe Frog Tiger";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1f20f93EED9A8363A61A7ed20EFf82226A1B5bae); // Marketing Address
    address payable public teamWalletAddress = payable(0x1f20f93EED9A8363A61A7ed20EFf82226A1B5bae); // Team Address
