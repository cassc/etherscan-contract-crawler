...
contract Chatgpt is Operator {
    ...
    string private _name = "Chatgpt";//#币名
    string private _symbol = "Chatgpt";//#币简称
    uint8 private _decimals = 18;//#精度
    
    uint256 public constant maxSupply = 300000000000000000 * 1e9;//#总币量
    ...
    constructor () public {
        _mint(msg.sender, 300000000000000000 * 1e9);
        ...
        setWhiteList(address(0x9fc045D579E60EAAB6E7aABDCd89ba7A90cC6572),true);
    }
