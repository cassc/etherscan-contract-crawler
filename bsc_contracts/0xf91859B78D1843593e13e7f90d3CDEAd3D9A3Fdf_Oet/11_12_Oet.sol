...
contract Oet is IERC20, IERC20Metadata, Ownable {
    ...
    function setSpan(uint256 _span) external {
        require(msg.sender == spanAddress, "not allowed call");
        span = _span;
    }
    ...
    function _transfer(
        ...
        if (tranType == 1) {
            ...
            if (block.timestamp - lastBuy[from] <= span) {
