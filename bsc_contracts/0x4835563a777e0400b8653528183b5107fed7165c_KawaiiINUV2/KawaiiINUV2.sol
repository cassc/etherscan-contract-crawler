...
contract KawaiiINUV2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "KawaiINU V2"; // 
    string private constant _symbol = "KAWAIIV2"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x9d5DF3FFb0341f44D8fa8663FddfaaC2FD0a8482;
