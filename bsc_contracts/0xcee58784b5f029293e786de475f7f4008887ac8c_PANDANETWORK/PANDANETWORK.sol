...
https://t.me/PandaNetworkOfficial
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1F704a8Ec84CE78df7052b2704dF9B312A58473C; // owner address
...
contract PANDANETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Panda Network";
    string private _symbol = "PANDANETWORK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4aA72766d6e3383d099fe0D8072d288CA415B02c); // Marketing Address
    address payable public teamWalletAddress = payable(0x1F704a8Ec84CE78df7052b2704dF9B312A58473C); // Team Address
