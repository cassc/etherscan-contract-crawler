...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x56C18411d2772ef5680ECB9d62b2193ABee42820;
...
contract DongFang is AbsToken {
    constructor() AbsToken(
        ...
        address(0xeD04D493f4DF7e8450bd97BF27398d2fbD73FA85),
    
        address(0xBC6B6E16f20AC85e8bB0dDc419E9997f5ca2498E)
    ){
