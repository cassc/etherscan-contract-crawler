...
The token that created to enable tokens in the Bsc, Eth and Alvey network to display purchases in telegram groups.

https://jeastbuybot.com/

https://t.me/JeastOfficial
...
contract JEAST is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Jeast Buy Bot";
    string private constant _symbol = "JEAST";
