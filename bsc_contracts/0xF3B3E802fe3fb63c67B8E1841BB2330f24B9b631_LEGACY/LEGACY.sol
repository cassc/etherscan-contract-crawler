...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE1EDe1177Bd160A4ED5BD63982Ce9913b8880F11;
...
contract LEGACY is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x9E7f6f09AbF47eDDCD0EF0CC91FAfa4e33661c5a;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LEGACY";
    string private _symbol = "LGY";
