...
contract XN is ERC20, Ownable{
    ...
    address public marketingWallet = 0xCd17BE6656bADda1E9FCFFA4F19409b62463b142;  //营
    ...
    constructor() ERC20("XN", "XN") {   
        _mint(msg.sender, 520 * 10 ** decimals());  
