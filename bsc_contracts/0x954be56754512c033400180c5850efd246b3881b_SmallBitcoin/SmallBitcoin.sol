...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2f38c7FAf7acA22794AD65bfd169edFC5a5Ba51b; 
...
contract SmallBitcoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Small Bitcoin";
    string private _symbol = "sBTC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2f38c7FAf7acA22794AD65bfd169edFC5a5Ba51b); // 
    address payable public teamWalletAddress = payable(0xf04aAf0deA7778621013693f3A0fbA808155bcBE); // 
