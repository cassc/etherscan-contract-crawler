...
// https://t.me/morphchain_bsc
// https://twitter.com/morphchain_bsc
...
contract MorphChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MORPH CHAIN";
    string private _symbol = "MORPH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf109d05Bd9303a1558c2A2bcA934bEcE124d1cb0); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xd3BC62bec4BCA00b8b713F500f717292CDf1faa3); // Development Address
    ...
    uint256 public _walletMax = 1 * 10**13 * 10**9;
