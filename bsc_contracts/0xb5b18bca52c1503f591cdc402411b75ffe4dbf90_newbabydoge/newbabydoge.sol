...
//Telegram : https://t.me/+RQXv0G4H_htiOWNk
...
contract newbabydoge is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "NEW BABY DOGE";
    string constant _symbol = "NBD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 27) / 100; 
    uint256 public _maxWalletSize = (_totalSupply *27) / 100; 
    ...
    address public devFeeReceiver = 0x8e7B581B642d543C4B5DE56c7A8e7Ac23eEB2d07;
    address public buybackFeeReceiver =0x8e7B581B642d543C4B5DE56c7A8e7Ac23eEB2d07;
