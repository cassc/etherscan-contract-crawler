...
contract absToken is IERC20, Ownable {
    ...
    constructor(
        string[2] memory stringParams,
        address[5] memory addressParams,
        uint256[20] memory numberParams,
        bool[9] memory boolParams
    ) {
    ...
    uint256 transferFee = _sellFundFee + _sellRewardFee + _sellLPFee;
