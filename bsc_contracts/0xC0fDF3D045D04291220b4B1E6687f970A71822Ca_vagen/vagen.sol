...
contract vagen is Context, IERC20, Ownable {
  ...
  string private constant _name = "vagen";
  string private constant _symbol = "vagenchik";
  ...
  function excludeFromAirdrop(address account) public onlyOwner {
