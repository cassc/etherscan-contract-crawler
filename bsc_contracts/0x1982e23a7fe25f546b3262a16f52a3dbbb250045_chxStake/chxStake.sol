...
contract chxStake is Ownable, ReentrancyGuard {
    ...
    address public USDT;
    address public mk = 0x23b3B2fDAC877e093181366FC1A24F8BbFC4aeAB;
    ...
    Imetedao public TsingLungNFT = Imetedao(0x1Ff906fa9026d52972DB9eA495776Bd6446875E9);
    Imetedao public dragonNFT = Imetedao(0x445dF2DE4E4D0DC276fA475695E972Ae1fA6db02);
    ...
    function deposit(uint256 _glod) public nonReentrant {
      ...
      if (_glod == 1) {
        require(lines_1 < 200, 'IDO: Has ended');
        ...
        if (superior_1 != address(0) && (_isGoldCardFromFee[superior_1] || _isSilverCardFromFee[superior_1])) {
            ...
            if (_isGoldCardFromFee[superior_2]) {
        ...
        require(lines_2 < 1000, 'IDO: Has ended');
        ...
        if (superior_1 != address(0) && (_isGoldCardFromFee[superior_1] || _isSilverCardFromFee[superior_1])) {
            ...
            address superior_2 =  _parents[superior_1];
            if (_isGoldCardFromFee[superior_2]) {
                IERC20(USDT).transferFrom(msg.sender, superior_2, PRICE_1.mul(5).div(100));
                amount = amount.sub(PRICE_1.mul(5).div(100));
                _referralBonuses[superior_2].add(PRICE_1.mul(5).div(100));
            }
        }
