...
contract StakeKing is IBEP20, Ownable {
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Stake King BSC"; //
    string constant _symbol = "SKB"; //
    ...
    uint256 public BuytotalFee =
        BuyliquidityFee + BuyteamFee + BuymarketingFee + BuydevFee;
    ...
    uint256 public SelltotalFee =
        SellliquidityFee + SellteamFee + SellmarketingFee + SelldevFee;
    ...
    address private autoLiquidityReceiver =
        0xaa6E076ACd4ca931ade7355A99703f6d552CBf81;
    address private marketingFeeReceiver =
        0x65cb4C1036f7cdD300DAFcbdFa0561d775e57C46;
    address private teamFeeReceiver =
        0xAE7e03FbFfCE0e28f8FC76e41201a567B68f3f86;
    address private devFeeReceiver = 0xa1518802136C7a4C3abCEa1A76DbD3fd7e4f32EC;
    ...
    constructor() Ownable(msg.sender) {
        ...
        routerGas = 0x7757D1fE0617D984308640f20087ef89bB1da8FE;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(tradingOpen || sender == owner || recipient == owner || sender == address(this), "Trading is not enabled yet");
        if (inSwap) {
    ...
    function swapBack() internal swapping {
        ...
        (bool teamSuccess, ) = payable(teamFeeReceiver).call{
            value: amountBNBteam,
            gas: 30000
        }("");
    ...
    function setBuyFees(
        ...
        BuyteamFee = _teamFee;
        BuytotalFee = _liquidityFee + (_devFee) + (_marketingFee) + (_teamFee);
    }
    ...
    function setSellFees(
        ...
        SelltotalFee = _liquidityFee + (_devFee) + (_marketingFee) + (_teamFee);
    }
