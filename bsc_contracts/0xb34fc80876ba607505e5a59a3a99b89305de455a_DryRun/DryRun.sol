...
abstract contract Project {
    ...
    string constant _name = "Maximus General";
    string constant _symbol = "MaxiGen";
    ...
    uint256 public swapRewardFee      = 15;
 ...
 * MainContract
 */
contract DryRun is Project, IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function setRewardTokenForShareholder(address RWRD) external returns (bool) {
    ...
    function setLimitForCustomRewards(uint256 numberTokens) external onlyOwner {
        thresholdForCustomRewards = numberTokens;
    }

    function getLimitForCustomRewards() public view returns (uint256) {
