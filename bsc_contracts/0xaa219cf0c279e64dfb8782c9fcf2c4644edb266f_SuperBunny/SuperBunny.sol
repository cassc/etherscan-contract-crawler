...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaC91C21d68a61101D0DfDe85220B31287607AcBe; // owner address
...
contract SuperBunny is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SuperBuny";
    string private _symbol = "SBUNNY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x72B4f86800520B93F842d28184c12804A6f65873); // Marketing Address
    address payable public teamWalletAddress = payable(0xaC91C21d68a61101D0DfDe85220B31287607AcBe); // Team Address
