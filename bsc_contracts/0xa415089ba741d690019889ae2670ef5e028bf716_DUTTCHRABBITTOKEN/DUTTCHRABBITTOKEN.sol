...
abstract contract Project {
    address public marketingWallet = 0x553A04BEdB2EDb31d5a9815feD29ECa476cD9bB0;
    address public treasuryWallet = 0x553A04BEdB2EDb31d5a9815feD29ECa476cD9bB0;

    string constant _name = "DUTTCHRABBIT TOKEN";
    string constant _symbol = "DURT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 50) / 1000; // (_totalSupply * 50) / 1000 [this equals 1%]
    uint256 public _maxWalletToken = _maxTxAmount * 50; //
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x6Ec90334d89dBdc89E08A133271be3d104128Edb);
...
contract DUTTCHRABBITTOKEN is Project, IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function setSwapFees(uint256 _newSwapLpFee, uint256 _newSwapRewardFee, uint256 _newSwapMarketingFee, uint256 _newSwapTreasuryFee, uint256 _feeDenominator) external authorized {
        ...
        require(swapTotalFee < feeDenominator/3, "Fees cannot be more than 7%");
    }
