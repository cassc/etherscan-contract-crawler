...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC66993D2619b7206004480F6497F8b6F4F514101; // owner address
...
contract LindaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Linda Inu";
    string private _symbol = "Linda";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x43688745E05C05C7481148aB51420Ed9a5BeC4c5); // Marketing Address
    address payable private teamWalletAddress = payable(0xC66993D2619b7206004480F6497F8b6F4F514101); // Team Address
