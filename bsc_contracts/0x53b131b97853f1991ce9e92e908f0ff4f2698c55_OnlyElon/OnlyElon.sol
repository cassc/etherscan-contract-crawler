...
contract OnlyElon is Context, IERC20, Ownable {
    ...
    string private constant _name = "OnlyElon"; 
    string private constant _symbol = "ONLYELON";
    ...
    Tax public buyTax = Tax(2,2,2,2);
    Tax public sellTax = Tax(2,2,2,2);
    
    address private marketingWallet = 0xcF6FF15D8F29EAD0638630AAaC8eB3C724AB0b36;
    address private devWallet = 0xcF6FF15D8F29EAD0638630AAaC8eB3C724AB0b36;
    address private pumpkinWallet = 0xcF6FF15D8F29EAD0638630AAaC8eB3C724AB0b36;
