...
contract CATSHIKO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CATSHIKO"; 
    string private _symbol = "$CAT"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x34d3cAE1093185fABF00AB8C8f39f73116CbF1b9); 
    address payable public teamWalletAddress = payable(0x0A877C47af12a3897aCA4B263AA638B221Ce955f); 
