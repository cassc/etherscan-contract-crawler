...
contract juddd is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "juddd";
    string private _symbol = unicode"juddd";

    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x1dCDB13972B0597AE002F28c5b53af394bf83237); 
    address payable public BurnedWalletAddress = payable(0x1dCDB13972B0597AE002F28c5b53af394bf83237); 
