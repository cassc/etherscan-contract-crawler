...
// TELEGRAM : https://t.me/Pepexel
// WEBSITE  : https://pepexel.tech/
...
contract PEPEXEL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPEXEL";
    string private _symbol = "PEPEXEL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x514fC0be9a249b05d0F413b10Dcee531B493a3BF); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xcD9F8b50d70aE229F82f41Ca01fB4758D01B5064); // Development Address
    ...
    uint256 public _walletMax = 1000000 * 10**6 * 10**9;
