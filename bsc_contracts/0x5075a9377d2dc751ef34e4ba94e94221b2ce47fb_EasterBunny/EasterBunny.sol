...
contract EasterBunny is Context, IERC20, Ownable {
    ...
    string private constant _name = "EasterBunny";
    string private constant _symbol = "EASTERBUNNY";
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 0, // 0 RFI rate, in %
            dev: 25, // dev team fee in %
            treasury: 0, // treasury fee in %
            lp: 2, // lp rate in %
            toSwap: 27 // treasury + dev + lp
        });
