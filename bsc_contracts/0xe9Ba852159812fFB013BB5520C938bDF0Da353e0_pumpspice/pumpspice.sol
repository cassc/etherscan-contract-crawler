...
//https://t.me/PumpKinSpiceBSC
//https://pumpkinspice.fun/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x78a1558dabcE59fc558874525B5917272471399d;
...
contract pumpspice is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"PumpKinSpice"; 
    string private constant _symbol = unicode"🎃SPICE"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x78a1558dabcE59fc558874525B5917272471399d), BNB_Tot);
            }
