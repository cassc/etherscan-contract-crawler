...
contract MBTToken is Context, IERC20, Ownable {
    ...
    string private _name = "MBT";
    string private _symbol = "MBT";
    
    uint public _lqFee = 20;
    uint public _mk1Fee = 20;
    uint public _mk2Fee = 10;
    uint public totalFee = 50;

    address public tokenReceiver;
    address constant public mk1Address = address(0x8E59821ca0Bb7b05cC2138481c27CfE95AA997d8);
    address constant public mk2Address = address(0xe5c752E80e6e140cEBFd644f7319F1671bdc620f);
    ...
    function _transfer(
        ...
        if( IERC20(uniswapV2Pair).totalSupply() == 0 && ammPairs[to] ){
            require( from == owner(),"not allow");
        }
