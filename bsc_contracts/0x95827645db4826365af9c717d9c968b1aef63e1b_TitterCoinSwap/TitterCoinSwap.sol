...
/**
https://t.me/tittercoinswap
https://titterchain.network
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFd1655392Dc45c4835ceEde432eF00128410d11E; // owner address
...
contract TitterCoinSwap is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " TitterCoinSwap ";
    string private _symbol = " TCOIN ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFd1655392Dc45c4835ceEde432eF00128410d11E); // 
    address payable public teamWalletAddress = payable(0xFd1655392Dc45c4835ceEde432eF00128410d11E); // 
