...
contract Flokitas is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    address public RewardToken = 0xFF107D6b39737828552A4B2f2a7e5cb33a2A8423;
    address private TeamReceiver = 0xa207695eE19f0260400F4D29E8f6615CCecB302D; 
    ...
    function rewardinTokens(bool _paysInTokens) public onlyOwner {
        paysInTokens = _paysInTokens;
    ...
    function setFees(uint256 _newdevReward, uint256 _newmintReward) public onlyOwner {
    ...
    {
        // Checks
        require(_winner != address(0), "Cannot giveaway to zero address");
        require(_amount > 0, " You have to giveaway at least one");
        require(lastSupply != 0, "Sold out");
  ...
  function withdraw() public payable onlyOwner {
    ...
    function handleMintReward(uint256 _amount) private {
        ...
        uint256 teamShare = _amount.sub(mintShare).sub(devShare);
