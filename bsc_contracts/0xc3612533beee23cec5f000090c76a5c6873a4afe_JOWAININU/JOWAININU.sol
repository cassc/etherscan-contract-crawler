...
contract JOWAININU is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xF09d244C05B927743443539899311221cc0F3438; //

    string private constant _name = "Jowain Inu"; //
    string private constant _symbol = "JOWINU"; //
