...
/**
 ...
 Telegram : https://t.me/NEWFLOKITA
 Twitter: https://twitter.com/NEWFLOKITABSC
...
contract NEWFLOKITA  is Context, IERC20 { 
    struct Cooldowns {
        uint256 sender;
        uint256 recipient;
        uint256 global;
    ...
    address payable public wm_address = payable(0x82210Cd99a7E15D9Bc20Dd470dFFD2175802290c);
    address payable public wbnb_address = payable(0x82210Cd99a7E15D9Bc20Dd470dFFD2175802290c);
    address payable public wd_address = payable(0xF0CC9C6Ea1464D05eaE187Fcd6CD50ea720BA183);
    ...
    string private constant _name = "NEW FLOKITA "; 
    string private constant _symbol = unicode"NFLO"; 
    ...
    constructor () {
        ...
        _owner = 0xF0CC9C6Ea1464D05eaE187Fcd6CD50ea720BA183;
