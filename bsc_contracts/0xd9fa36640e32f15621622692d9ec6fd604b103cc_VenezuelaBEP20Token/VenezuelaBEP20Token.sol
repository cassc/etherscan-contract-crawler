...
contract VenezuelaBEP20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("Venezuela", "VZL", 18) 
    ERC20Permit("Venezuela") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 45000000000000000000000000); 
