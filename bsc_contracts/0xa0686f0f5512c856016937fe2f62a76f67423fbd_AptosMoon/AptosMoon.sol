...
contract AptosMoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AptosMoon";
    string private _symbol = "APTM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4aD403E69FC901aF99DE88E22f9667E4EEF6817e); // Marketing Address
    address payable public DevelopmentAddress = payable(0x4aD403E69FC901aF99DE88E22f9667E4EEF6817e); // Development Address
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBBuyBack = amountReceived.mul(_DevShare).div(totalBNBFee);
        ...
        if(amountBNBBuyBack > 0)
            transferToAddressETH(DevelopmentAddress, amountBNBBuyBack);
