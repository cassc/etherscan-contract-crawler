...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Pi Classic";
    string internal constant SYMBOL = "PIC";
    ...
    uint256 internal constant TOTAL_SUPPLY = 31415 * ZEROES;
    ...
    address internal charityAddress = 0xca53D522dE07ebFe94ef7c18B8DcB82713e1F33F;
    address internal projectAddress = 0xca53D522dE07ebFe94ef7c18B8DcB82713e1F33F;
    address internal marketingAddress = 0xca53D522dE07ebFe94ef7c18B8DcB82713e1F33F;
     ...
     */
    address internal burnAddress = address(0);
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 10, address(projectAddress) );
    }
...
abstract contract BasePICToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    constructor(){
        ...
        // exclude owner, this contract and project address from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(projectAddress)] = true;
    ...
    function burn(uint256 amount) external {
        ...
        require(sender != address(0), "BasePICToken: burn from the zero address");
        require(sender != address(burnAddress), "BasePICToken: burn from the burn address");

        uint256 balance = balanceOf(sender);
        require(balance >= amount, "BasePICToken: burn amount exceeds balance");
    ...
    function _approve(address owner, address spender, uint256 amount) internal {
        require(owner != address(0), "BasePICToken: approve from the zero address");
        require(spender != address(0), "BasePICToken: approve to the zero address");
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        require(sender != address(0), "BasePICToken: transfer from the zero address");
        require(recipient != address(0), "BasePICToken: transfer to the zero address");
        require(sender != address(burnAddress), "BasePICToken: transfer from the burn address");
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    */
    ...
    /**
     * @dev Use this delegate instead of having (unnecessarily) extend `BasePICToken` to gained access 
...
abstract contract PiClassic is BasePICToken, Liquifier, Antiwhale {
    ...
    function _takeFeeToETH(uint256 amount, uint256 currentRate, uint256 fee, address recipient, uint256 index) private {
        ...
        _approveDelegate(address(this), address(_router), tAmount);
        ...
        // emit FeeToETH(tAmount, recipient);
    }
...
contract PiClassicToken is PiClassic{

    constructor() PiClassic(Env.Testnet){
