...
🟩Introducing : 
✅DeployerLowTax provides a secure and transparent financial transaction solution with low fees and high speed. 
Built using the Proof of Stake (PoS) concept, this platform will save cost and secure the transaction 
used for mining and transaction validation compared to the Proof of Work (PoW) concept commonly used in other blockchains.

TG: https://t.me/DeployerLowTax
TG: https://t.me/DeployerLowTax
TG: https://t.me/DeployerLowTax
TG: https://t.me/DeployerLowTax
...
contract HELPSTARSHIPELON is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 public buyFee = 6; // Taxa de Compra
    uint256 private previousBuyFee; // Armazena Taxa de Compra
    uint256 public sellFee = 99; // Taxa de Venda
    uint256 private previousSellFee; // Armazena Taxa de Venda
    uint256 private limitBurn = 1000 * _decimalFactor;
    uint256 public liquidityPercent = 1; // Taxa de Liquidez 10%
    uint256 public maxWalletBalance = 10000000 * _decimalFactor; // 2% do Supply
    uint256 public maxBuyAmount = 10000000 * _decimalFactor; // 2% do Supply
    uint256 public maxSellAmount = 10000000 * _decimalFactor; // 2% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 100000 * _decimalFactor; // 1% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "HELP STARSHIP ELON";
    string private _symbol =  "HSE";
    /*=== Modifiers ===*/
