...
contract  YYDS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xCb17307Af31a826994B9acF32354E3c3dd7B4F09);
    address payable public teamWalletAddress = payable(0xB0F48DB64F7010d97aCeeD0fb5EC88b760BA762b);
    ...
    uint256 private _totalSupply =  6600 * 10**_decimals;
