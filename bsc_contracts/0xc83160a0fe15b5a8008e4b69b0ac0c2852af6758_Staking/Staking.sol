...
contract Staking is Auth, stakeIntegration, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() Auth(msg.sender) {
        stakingToken = IERC20(0x95195645459D9f0cE4faD6Cb673b23E5c358281f);
        rewardsToken = IERC20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
        rewardPerBlock = 600000000000;
