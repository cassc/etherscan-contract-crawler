...
contract MLP is Context, IERC20, Ownable {
    ...
    constructor(address routerAddress) {
        ...
        pair = IPancakePair(IPancakeFactory(_router.factory()).createPair(address(this), address(_router.WETH())));
