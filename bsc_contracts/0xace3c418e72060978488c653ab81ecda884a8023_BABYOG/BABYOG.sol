...
contract BABYOG is IBEP20, Auth {
    ...
    string constant _symbol = "BO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 100;  // 4% Buy
    uint256 public _maxWalletSize = (_totalSupply * 4) / 100; // 4% Wallet 
    ...
    address private marketingFeeReceiver = 0x2EC7753B1D53C19947b292Bac1431DD2de182a18;
    address private teamFeeReceiver = 0x56578a26075f6BB3738588D70df681C1d91080AF;
