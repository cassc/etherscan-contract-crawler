...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1Bc24Db48C9e74d601629262d8Acd590502A9C21; // owner address
...
contract PepeBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pepe BSC";
    string private _symbol = "PEPE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x1Bc24Db48C9e74d601629262d8Acd590502A9C21); // Marketing Address
    address payable private teamWalletAddress = payable(0x1Bc24Db48C9e74d601629262d8Acd590502A9C21); // Team Address
