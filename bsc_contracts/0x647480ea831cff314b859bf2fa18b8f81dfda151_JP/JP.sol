...
contract JP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JAKE PAUL"; 
    string private _symbol = "JakePaul"; 
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x04916cd03b1e440aa8a2967b66DFb4725a550822); 
    address payable public teamWalletAddress = payable(0x01009f456e5CB920F2d65d66e48DDb908f928AE4); 
