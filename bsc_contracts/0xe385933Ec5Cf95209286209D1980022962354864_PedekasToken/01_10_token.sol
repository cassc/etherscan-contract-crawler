...
contract PedekasToken is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x0000000000000000000000000000000000000000);
    ...
    */
    ...
    string private _name = "PedekasToken"; 
    string private _symbol = "PEDE";  
