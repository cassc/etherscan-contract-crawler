...
// Telegram: https://t.me/Creepy_Moon
// Twitter: https://twitter.com/CreepyMoonBSC
...
contract CMOON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Creepy Moon";
    string private _symbol = "CMOON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6ABd4Ec1C904592587BfF61f8DCa692F00B0BE90); // Marketing Address
    address payable public teamWalletAddress = payable(0x6ABd4Ec1C904592587BfF61f8DCa692F00B0BE90); // Team Address
