...
contract OOCrossChainAndSwap is MessageSenderApp, MessageReceiverApp, ReentrancyGuard, Initializable{
    ...
    function setMinBridgeAmount(MsgDataTypes.BridgeSendType _type, address _token, uint256 _minBridgeAmount) external onlyOwner {
        minBridgeAmounts[_type][_token] = _minBridgeAmount;
    }
