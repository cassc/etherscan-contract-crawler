...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3Eaadb2f1B2E6F2fc2093657b2E5729D13e2C572;
...
contract ACEBC3 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xace870e46a743a0E6FAe79F8c28CE378c7941F10;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ACEBC3";
    string private _symbol = "ACE3";
