...
contract babyPOV is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "babyPOV";
    string private _symbol = "babyPOV";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0xC67e069979706a9C9A75A7f68ECC634b7507Af2b);
