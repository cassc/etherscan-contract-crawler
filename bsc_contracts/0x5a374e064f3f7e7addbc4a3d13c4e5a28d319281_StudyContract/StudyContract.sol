...
/**
Telegram : https://t.me/study
Twitter : https://twitter.com/study
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8D5612631B719B1922baFe7dB3Ee4d8D82CC5f91; // owner address
...
contract StudyContract is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Study Contract";
    string private _symbol = "Study";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9f9B27aF16BF04D098d5D370C0D3f635cd55Dc53); // Marketing Address
    address payable public teamWalletAddress = payable(0x9f9B27aF16BF04D098d5D370C0D3f635cd55Dc53); // Team Address
