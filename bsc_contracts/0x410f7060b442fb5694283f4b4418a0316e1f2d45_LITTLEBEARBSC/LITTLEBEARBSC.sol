...
contract LITTLEBEARBSC is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xb7524337C92aa340fb02A2ef15d8709A41FFfB81); 
    address payable public Wallet_Dev = payable(0xb7524337C92aa340fb02A2ef15d8709A41FFfB81);
    ...
    string private constant _name = "LITTLEBEARBSC"; 
    string private constant _symbol = unicode"LBB"; 
    ...
    constructor () {
        ...
        _owner = 0xb7524337C92aa340fb02A2ef15d8709A41FFfB81;
