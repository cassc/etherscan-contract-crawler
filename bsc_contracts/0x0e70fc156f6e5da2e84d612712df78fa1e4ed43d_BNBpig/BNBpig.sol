...
contract BNBpig is ERC20 {
	...
	address private _fundAddress = address(0x2F788211eCECDcb794ECCCf839D6ec6C8c7F863c);
    ...
    constructor(address tokenOwner) ERC20("BNBpig", "BNBpig") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
        .createPair(address(this), address(_baseToken));
		uint256 total = 1000000000 * 10**26;
    ...
    function _transfer(
        ...
        if (takeFee) {
			...
			changeUsdtAmount = changeUsdtAmount.add(amount.div(100).mul(9));
