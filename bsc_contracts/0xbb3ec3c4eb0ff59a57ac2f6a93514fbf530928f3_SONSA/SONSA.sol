...
contract SONSA is Ownable, ERC20 {
    
    uint256 private _totalSupply = 5_000_000_000 * 10 ** 18;
    ...
    constructor() ERC20("SONSAcoin", "SONSA") {
        setCooldownEnabled(true, 20);
        tradingEnabled = true;
        _setOwner(0xcc4F314e7DD0eBF5c87CF8e0FB2C769f579279b7);
