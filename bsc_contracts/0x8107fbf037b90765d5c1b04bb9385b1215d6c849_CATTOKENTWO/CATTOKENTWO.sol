...
contract CATTOKENTWO is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "CAT TOKEN 2.0"; // 
    string constant _symbol = "CAT2"; // 
    ...
    uint256 public BuydevFee          = 3;//buyback
    ...
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (1); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (2); // 2%

    // Fees receivers
    address private autoLiquidityReceiver = 0x7aFC1539d0a0474476F7c17536Bc527AdcAaC467; //LP receiver
    address private marketingFeeReceiver = 0x7690B4E0e2A22931bf2c41978A2bf7CaBEAc4730; //mkt
    address private devFeeReceiver = 0x0DbE93918f20B5A40cA2DbE64410db15D040aFe6; //31 BuyBack
    address private teamFeeReceiver = 0xAd84544A0c7118c2104AE6C345bBD0b8b41EFA38; //32 
    ...
    constructor () Ownable(msg.sender) {
        ...
        routerGas = 0x22248515B55f1659fB8FD46A5EF20Aab93D21397;
