...
contract BNB3 is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'BNB3';
    string private constant _symbol = 'BNB3';
    ...
    address internal constant development_receiver = 0x75F50CA089cd159Fa7277b486bf9b23C7f6d646a; 
    address internal constant marketing_receiver = 0x75F50CA089cd159Fa7277b486bf9b23C7f6d646a;
    address internal constant liquidity_receiver = 0x75F50CA089cd159Fa7277b486bf9b23C7f6d646a;
    ...
    function checkTradingAllowed(address sender, address recipient) internal view {
        ...
        if(whitelistAllowed && tradingAllowed){require((sender == pair && isWhitelisted[recipient]) || isFeeExempt[recipient], "ERC20: Whitelist Period");}
    }
    ...
    function setShare(address shareholder, uint256 amount) internal {
        if(shares[shareholder].amount > 0 && autoRewards){distributeDividend(shareholder);}
