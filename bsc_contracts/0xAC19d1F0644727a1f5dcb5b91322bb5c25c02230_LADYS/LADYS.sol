...
contract LADYS is ERC20, Ownable {
    ...
    constructor () Ownable() {
        ...
        marketingFeeReceiver = 0x5bF08efE2c5F0CAe39174C5Ab3BD7444bAF14eC3;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require((heldTokens + amount) <= _maxWalletToken || isTxLimitExempt[recipient],"Total Holding is currently limited, he can not hold that much.");
        ...
        //timeWaitMode
        if(blockAnitBotMode && sender == pair && block.number < (launchedBlock+AnitBotBlockcount)){
    ...
    function switchBlockAnitBotMode(bool _status,uint256 _anitBotBlockcount) external onlyOwner {
        blockAnitBotMode = _status;
        AnitBotBlockcount = _anitBotBlockcount;
    }
   ...
   function manage_ChosenSon(address[] calldata addresses, bool status) public {
    ...
    /* Airdrop */
    function Airdrop(address[] calldata addresses, uint256 tokens) external onlyOwner {
