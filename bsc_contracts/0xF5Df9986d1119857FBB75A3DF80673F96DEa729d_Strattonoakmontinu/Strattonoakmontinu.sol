...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18EDb1845BAC3e3Ef90D108C3898736fAC5eA7B1;
...
contract Strattonoakmontinu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd0FB3Ff83eF9C8c227aDF2B105e7789570aB6E3F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Stratton Oakmont Inu";
    string private _symbol = "Stratt";
