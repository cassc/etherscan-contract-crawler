...
contract Wojak is ERC20, Ownable {
    ...
    constructor() ERC20("Wojak", "WOJAK")  {
        ...
        _marketingWalletAddress = 0xD03D0A819cfb21dF76f22611f25f13F9B4301348;
        ...
        uint256 totalSupply = 69000000000000* (10**18);
        swapTokensAtAmount = totalSupply.mul(2).div(10**6); // 0.002%

        // use by default 300,000 gas to process auto-claiming dividends
        gasForProcessing = 300000;

        _node = 0xD03D0A819cfb21dF76f22611f25f13F9B4301348;
