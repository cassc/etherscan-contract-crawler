...
interface IKochiLock {
  ...
  event ExtendedLock(address beneficiary, uint256 uid, uint256 deadline);

  event ExtendedLiquidityLock(address beneficiary, uint256 uid, uint256 deadline);

  function lock(address token, uint256 amount, address beneficiary, uint256 deadline) external;
  ...
  function lpLockETH(address token, uint256 amount, uint256 lock_per_mille, address beneficiary, string memory dex, uint256 deadline) external payable;

  function lpLock(address token0, address token1, uint256 amount0, uint256 amount1, uint256 lock_per_mille, address beneficiary, string memory dex, uint256 deadline) external;
