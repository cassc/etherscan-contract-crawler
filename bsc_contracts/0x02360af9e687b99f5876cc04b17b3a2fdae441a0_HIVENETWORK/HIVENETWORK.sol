...
Telegram : https://t.me/HiveNetworkGlobal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf97A73BB4610d7A7bB40D39f4b441268F2c44fbc; // owner address
...
contract HIVENETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "HIVENETWORK ";
    string private _symbol = " HIVEN ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9b66b9437aDFEF4274c0EcD141f3EC3B5E117644); // 
    address payable public teamWalletAddress = payable(0xf97A73BB4610d7A7bB40D39f4b441268F2c44fbc); // 
    ...
    uint256 public _maxTxAmount = 238000000000 * 10**_decimals; 
    uint256 public _walletMax = 238000000000 * 10**_decimals;
