...
contract FrogInuToken is ERC20, Ownable {
    ...
    event wallet1Changed(address wallet1);
    ...
    constructor(
        ...
        payable
        ERC20("Frog Inu Token", "FGIT")
    {
        uint256 totalSupply_ = 100_000_000;
        buyFee = 2;
        sellFee = 5;
    ...
    function claimStuckBNB() external onlyOwner {
        sendBNB(payable(wallet01), address(this).balance);
    }
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 15 && _sellFee <= 15, "Fees must be less than 15%");
        buyFee = _buyFee;
        sellFee = _sellFee;
