...
contract GhostDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Ghost Doge";
    string private _symbol = "GDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x55A3954589Dad1219096aF547d8ECF6AF013834d); // Marketing Address
    address payable private developmentWalletAddress = payable(0x55A3954589Dad1219096aF547d8ECF6AF013834d); // Development Address
    ...
    uint256 public _liquidityShares = 6;
    ...
    uint256 public _walletMax = 20 * 10**12 * 10**9;
