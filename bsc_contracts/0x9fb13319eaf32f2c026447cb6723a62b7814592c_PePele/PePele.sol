...
//     Fees on Buy: 8%   Sell:8% 
// *                          
// *      https://t.me/pepelebsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x8226E2eABB7b7FE3B55A9fEd5EdC44A87Cae375f); 
...
contract PePele  is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PePele";
    string constant _symbol = "PePele ";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x8226E2eABB7b7FE3B55A9fEd5EdC44A87Cae375f;
    ...
    address public marketingWallet=0x2e95E23Cb4380E520d9e516Ceb45449BA06A2e6F;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet =0x12039176c1374248448B4E2ff6ce72905738ECC3;
