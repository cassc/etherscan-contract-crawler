...
contract COYT is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "DexCoyote Foundation";
    string private _symbol = "COYT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x3630f5FCd104FcB260bF5318b3977D0Bf38581A4); // Marketing Address
    address payable public teamWalletAddress = payable(0x3630f5FCd104FcB260bF5318b3977D0Bf38581A4); // Team Address
    ...
    bool public _canModifyCommission = true;
    ...
    function deactivateModifyCommission() external onlyOwner {
        _canModifyCommission = false;
    }

    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        require(_canModifyCommission, 'Commission immutable');
