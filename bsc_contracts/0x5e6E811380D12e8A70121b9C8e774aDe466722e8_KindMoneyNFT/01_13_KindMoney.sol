...
contract KindMoneyNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;

    uint256 public cost            = 0.5 ether;
    uint256 public presaleCost     = 0.005 ether;
    uint256 public privateSaleCost = 0.000005 ether;
    ...
    function description() public pure returns (string memory) {
        string memory desc = "Kind Money is a collection of 601 NFT bills created for Kind NFT project, with the highest quality of detalization and different properties.";
        return desc;
    }
