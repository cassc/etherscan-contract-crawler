...
contract BNBVision is Ownable, ReentrancyGuard {

	uint256 public ROI = 1000;
	uint256 public referralIncome = 3000;
	...
	uint256 public GameCountdown = 1671102000;
	...
	function BNBPrice(uint256 amount) external onlyOwner {
