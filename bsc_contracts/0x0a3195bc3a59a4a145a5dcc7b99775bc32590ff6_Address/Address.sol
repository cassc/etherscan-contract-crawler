...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaeE5F950cA6cDF298b1aDa1726eD5abAC67Baa8c;
...
contract NEMOToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5BBF77f96B70aA435B34A2beF79a0ce3ef884a07;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 17000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "NEMOToken";
    ...
    uint256 public _maxTxAmount = 17000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 8500000 * 10**18;
