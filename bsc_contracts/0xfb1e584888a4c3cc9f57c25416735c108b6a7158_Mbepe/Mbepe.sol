...
contract Mbepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Kylian";
    string private _symbol = "MBEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1C55DD7723504DFD57667F8eCdC7D32882C13190); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x60E1D73217c09C86c12802Dd34Dd030033870CAB); // Development Address
    ...
    uint256 public _maxTxAmount = 4 * 10**6 * 10**9;
