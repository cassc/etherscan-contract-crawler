...
contract BitXStaking is IBitXStaking, ReentrancyGuardUpgradeable, OwnableUpgradeable {
  IERC20 public bxg;
  ...
  function addReferral(address[] memory _referrals, address staker) external override{
