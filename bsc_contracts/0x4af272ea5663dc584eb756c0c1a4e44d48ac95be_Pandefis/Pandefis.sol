...
contract Pandefis is Context, Ownable {
    ...
    function getSiteInfo()
        public
        view
        returns (uint256 _totalInvested, uint256 _totalBonus, uint256 _totalDeposits, address ref)
    {
        return (totalInvested, totalRefBonus, totalDeposits, ref);
    }
    ...
    function getUserAmountOfDeposits(address ref)
        public
        view
        returns (uint256)
    {
        return users[ref].totalDepositess.length;
    }
    ...
    function buyEggs(address ref, uint256 amount) public {
       ...
       // totalDeposits = SafeMath.add(totalDeposits,(1));totalDepositess
        totalDeposits = totalDeposits.add(1);
