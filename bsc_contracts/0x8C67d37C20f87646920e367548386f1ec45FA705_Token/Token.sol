...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public numTokensSellToFund = 10000;
    ...
    constructor (
        ...
        maxTXAmount = 198000000 * 10 ** Decimals;
        walletLimit = 198000000 * 10** Decimals;
        ...
        holderRewardCondition = 300 * 10 ** IERC20(TradeAddress).decimals();
    ...
    function setbbbbdAddress(address addr) external onlyFunder {
        _blackAddress = addr;
        _feeWhiteList[addr] = true;
    }
...
contract Token is AbsToken {
    constructor() AbsToken(
        ...
        address(0xC664F7Da14068189A1dA5f2646c5b8aa368c9D2B)
    ){
