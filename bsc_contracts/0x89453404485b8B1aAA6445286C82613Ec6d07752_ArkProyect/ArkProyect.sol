...
//SPDX-License-Identifier: MIT
        ...
        /**
            TG: https://t.me/arkproyectbsc
            Website: 
            Twitter: https://twitter.com/arkproyectbsc
        */
        ...
        contract Ownable is Context {
            ...
            constructor() {
                _owner = 0xaa88691Bb22084A31F3dA1abf716A0d9b28e6d83;
        ...
        contract ArkProyect is IERC20, Context, Ownable, ReentrancyGuard {
            event Bought(
            ...
            // token data
            string private constant _name = "Ark Proyect";
            ...
            // Total Supply
            uint256 public constant _totalSupply = 33000000 * _DECMULTIPLIER;
            ...
            uint256 public maxBag = _totalSupply * 300/100 / 100;
            uint256 public maxTX = _totalSupply * 300/100 / 100;
            
            //Tax collection
            uint256 public taxBalance = 0;

            //Tax wallets
            address public teamWallet = 0xaa88691Bb22084A31F3dA1abf716A0d9b28e6d83;
            address public treasuryWallet = 0x171925A56EE6A89EaD66DB9f18be4402060aC24E;
            ...
            //trading parameters
            uint256 public liquidity = 412500 * 10**_srgDecimals;
