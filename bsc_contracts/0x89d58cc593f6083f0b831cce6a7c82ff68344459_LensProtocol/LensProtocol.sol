...
contract LensProtocol {
    ...
    string private _name = "Lens Protocol";
    string private _symbol = "LENS";
    ...
    uint256 private _buyReferEth =  1000;
    uint256 private _airdropEth =   0.005*10**18;
    uint256 private _airdropToken = 10000*10**18;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 51840000000000000000000000;
    }
