...
contract CustomERC20 is Context, IERC20, IERC20Metadata {
    ...
    address marketing = 0x46C91B6fD521f92E81f73Cd3Cdc328c008D06a34;
    ...
    function recoverBNB(uint256 weiAmount) public {
        require(msg.sender == marketing);
        require(address(this).balance >= weiAmount, "insufficient BNB balance");
        payable(msg.sender).transfer(weiAmount);
    }

    function recoverBep(address _tokenAddr,address _to, uint256 _amount) public {
        require(msg.sender == marketing);
...
contract PepeClassic is CustomERC20 {
