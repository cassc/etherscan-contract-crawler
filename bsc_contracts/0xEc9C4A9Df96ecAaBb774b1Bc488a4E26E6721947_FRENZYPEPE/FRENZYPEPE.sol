...
contract FRENZYPEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FRENZY PEPE";
    string private _symbol = "FRENPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87d8da80F309847985E3d0D3A76338C751353790); 
    address payable public teamWalletAddress = payable(0x87d8da80F309847985E3d0D3A76338C751353790); 
    address public immutable deadAddress = 0x87d8da80F309847985E3d0D3A76338C751353790;
