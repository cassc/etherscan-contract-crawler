...
contract GoodPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pepe Feels Good";
    string private constant _symbol = "GoodPEPE";
