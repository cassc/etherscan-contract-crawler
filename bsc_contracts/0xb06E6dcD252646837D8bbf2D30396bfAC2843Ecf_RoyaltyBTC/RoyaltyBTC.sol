...
abstract contract Project {
    address public marketingWallet = 0x588d0f8Ad3Ee00739a2Bd23021F161b809B728cE;
    address public treasuryWallet = 0x588d0f8Ad3Ee00739a2Bd23021F161b809B728cE;

    string constant _name = "Royalty BTC";
    string constant _symbol = "Royalty BTC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**15 * 10**_decimals;

    uint256 public _maxTxAmount = (_totalSupply * 1) / 100; // (_totalSupply * 1) / 1000 [this equals 1%]
...
contract RoyaltyBTC is Project, IBEP20, Auth {
    using SafeMath for uint256;
