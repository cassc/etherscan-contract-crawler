...
contract Ownable is Context {
    ...
    constructor () {
        _owner =0x6B7A15a7374c237E70eb40c961f88974f3b27631;
...
contract PROOFOFWHALES is Context, IERC20, Ownable {
    ...
    string private constant _name = "PROOF OF WHALES"; // 
    string private constant _symbol = "$POW"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 0;
    address payable public  _marketingWallet = payable(0x6B7A15a7374c237E70eb40c961f88974f3b27631);
