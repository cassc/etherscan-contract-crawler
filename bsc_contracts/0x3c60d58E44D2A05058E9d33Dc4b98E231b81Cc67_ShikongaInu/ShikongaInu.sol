...
contract ShikongaInu is Context, IBEP20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "Shikonga Inu";                                          // name
    string private _symbol = "$SI";                                             // symbol
    ...
    uint256 public defaultLiquidityFee = 3;
    ...
    uint256 public _liquidityFee4Sellers = 10;
    ...
    uint256[] public _liquidityFeeSplit = [80,20];                                       // % division between swap+liquify & wallets
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0xEBBB144808064e9CEd91dc7338DbCbE1774BdD49),                             // Dev+Team wallet
        payable(0xEBBB144808064e9CEd91dc7338DbCbE1774BdD49),                             // Marketing wallet
        payable(0xEBBB144808064e9CEd91dc7338DbCbE1774BdD49)                              // 
    ];
    // ********************************** END VARIABLES ***********************************
