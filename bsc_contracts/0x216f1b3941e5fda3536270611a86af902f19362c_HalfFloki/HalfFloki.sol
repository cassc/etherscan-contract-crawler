...
contract HalfFloki is ERC20, Ownable {
    ...
    constructor() ERC20("Half Floki", "Floki 0.5") {
        ...
        marketingWallet = address(0xcDF084Ca7aDACFE06873345F58121f06636fb13d); // set as marketing wallet
        devWallet = address(0xcDF084Ca7aDACFE06873345F58121f06636fb13d); // set as dev wallet
