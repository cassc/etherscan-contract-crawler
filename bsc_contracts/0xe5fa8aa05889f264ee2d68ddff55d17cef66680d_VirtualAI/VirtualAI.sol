...
contract VirtualAI is IERC20 {
    ...
    string constant private _name = "Virtual AI";
    string constant private _symbol = "VirtualAI";
    ...
    address payable public marketingWallet = payable(0xF8ada7a6D99fa1264D77Ee5652475eF72E56D4cD);
    ...
    uint256 public lpBurnTimeLimit = 2 minutes;
...
//================================================ BLACKLIST
    ...
    function setSwapSettings(uint256 thresholdPercent, uint256 thresholdDivisor, uint256 amountPercent, uint256 amountDivisor) external onlyOwner {
        ...
        require(swapAmount <= (balanceOf(lpPair) * 100) / masterTaxDivisor, "Cannot be above 1.5% of current PI.");
        require(swapAmount >= _tTotal / 21_000, "Cannot be lower than 0.00001% of total supply.");
        require(swapThreshold >= _tTotal / 21_000, "Cannot be lower than 0.00001% of total supply.");
    }

    function setPriceImpactSwapAmount(uint256 priceImpactSwapPercent) external onlyOwner {
        require(priceImpactSwapPercent <= 100, "Cannot set above 1.5%.");
    ...
    function setLpBurnTimeLimit(uint256 timeInSeconds) external onlyOwner {
        require(timeInSeconds >= 2 minutes, "Cannot set below 2 minutes.");
