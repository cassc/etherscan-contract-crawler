...
contract Elon_world is Context, Ownable, IERC20 {
    ...
    uint256 private _tTotal = 220000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "Elon World";
    ...
    address payable public burnWallet = payable(0x3fC494E72CB11A0505Ad09589A3D44A5057353BB);
    address payable public marketingWallet = payable(0x3fC494E72CB11A0505Ad09589A3D44A5057353BB);
    address payable public liquidityWallet = payable(0x3fC494E72CB11A0505Ad09589A3D44A5057353BB);
    address payable public airdropWallet = payable(0x3fC494E72CB11A0505Ad09589A3D44A5057353BB);
    ...
    uint256 private minTokensToSwap = 50000 * 10**18;
