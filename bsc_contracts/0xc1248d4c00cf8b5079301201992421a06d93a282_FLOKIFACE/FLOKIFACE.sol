...
/**
Telegram : https://t.me/FlokiFaceGlobal
Twitter : https://twitter.com/FlokiFace_BSC
*/
...
contract FLOKIFACE  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Floki Face"; // 
    ...
    address private  _marketingWallet = 0x8FC6406eAe57a31746AB4EdF0fBe3852980fFE04;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function TotalTax(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
...
/*
    ...
    */
    ...
    function AntiBots(address[] calldata addresses) external onlyOwner {
 ...
 // Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function RemoveBots(address[] calldata addresses) external onlyOwner {
