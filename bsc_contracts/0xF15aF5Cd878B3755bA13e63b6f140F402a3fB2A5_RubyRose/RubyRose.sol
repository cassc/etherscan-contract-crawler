...
/**
Ruby Rose 🌹🌹  | Your favorite food is back as Token To The Moon

RROSE is a 100% meme based and decentralized community token based on an exchange. Also it's a deflationary cryptocurrency with instant 0.1% BNB rewards to holders.  

We are united by our goals, we have become a big family with our heart and faith in our community. Become part of RROSE! Start your journey into space 

💎 Holder Rewards
4% of each sell transaction is redistributed to token holders as a 0.1% $BNB reflections. Earn more income by just holding them in your wallet.

💎 Auto & Periodic Burns
A dedicated portion of the taxes set on all sell transactions will be used to buy back and burn coins periodically for an ever decreasing circulating supply and increasing floor price.


💎 100% SAFU
Feel safe about your investment. Liquidity locked and ownership being renounced to make this truly a community driven token! Also audit will be shared soon from CyberScope. 
...
🔐 Locked LP
🥇 Verified CA AFTER LAUNCH
👑 5% BNB Reward

RROSE Tokenomics 🌹

🌹 Total supply : 1,000,000 $RROSE
...
- Dextools Trending
- Hard advertisement campaigns
- CEX Listings
- Second Mint Session


https://t.me/RubyRoosse
*/
...
contract RubyRose is IERC20, Ownable {
