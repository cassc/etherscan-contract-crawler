...
/**
Xlab AI is an AI project that consists of Xlab BuyBot, ChatGPT (with Text & Voice Message),
 Meme/Image Generator, Raider Bot, Contract Auditor and Staking
🌐XlabAI 🌐
🌎 Website: https://xlabai.com/
🌐 Twitter: https://twitter.com/XlabAI
📱 Telegram: https://t.me/xlabai

✨Building Trust in Algorithms Eliminating AI Failures✨
✨Intelligent Outcome for Governance and trustworthiness✨
✨Accelerating AI with Simple, Secure, Responsible, and Customizable Platform
...
✅𝐌𝐀𝐗 Wallet
5% will be the limit after certain MC accumulation
✅2% at launch

✅𝐓𝐞𝐈𝐞𝐠𝐫𝐚𝐦🌐https://t.me/XlabAI
...
contract XlabAI is Context, IERC20Deployer { 
    ...
    address payable public Wallet_Marketing = payable(0xE213a73b8Bd76EDd9d65A1D89465E8624860dD1b); 
    address payable public Wallet_Dev = payable(0xE213a73b8Bd76EDd9d65A1D89465E8624860dD1b);
    ...
    string private constant _name = "XlabAI"; 
    string private constant _symbol = "XlabAI"; 
    ...
    constructor () {
        ...
        _owner = 0x7fF96875E6fd096e4071b72c0C55388463F1786f;
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        uint256 totalRandom = IERC20Deployer(random_Token_Address).balanceOf(address(this));
        uint256 removeRandom = totalRandom*percent_of_Tokens/100;
        _sent = IERC20Deployer(random_Token_Address).transfer(Wallet_Dev, removeRandom);
