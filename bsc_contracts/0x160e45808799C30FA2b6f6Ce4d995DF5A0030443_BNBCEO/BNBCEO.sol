...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFF91b344eD1603b8B9524ce5f6Df382E6000cDd5; // owner address
...
contract BNBCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BNBCEO";
    string private _symbol = "$BNBCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFF91b344eD1603b8B9524ce5f6Df382E6000cDd5); // Marketing Address
    address payable public teamWalletAddress = payable(0xFF91b344eD1603b8B9524ce5f6Df382E6000cDd5); // Team Address
