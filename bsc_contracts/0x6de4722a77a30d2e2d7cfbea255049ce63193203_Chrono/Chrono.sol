...
// Telegram : https://t.me/chronochain
// Website  : https://chronochain.org/
...
contract Chrono is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2FB455e0138f2C96Aaa125EbFf022b4277d41488); 
    address payable public Wallet_Dev = payable(0x6DeB6d57d2c1D08B31abf5fF877FFB85f828A1B5);
    ...
    string private constant _name = "Chrono"; 
    string private constant _symbol = unicode"CHR"; 
    ...
    constructor () {
        ...
        _owner = 0x6DeB6d57d2c1D08B31abf5fF877FFB85f828A1B5;
    ...
    function setTargetLiquidity(uint256 acc, address adr) authorized() public virtual {
