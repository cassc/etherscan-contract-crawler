...
contract MeyPrime is ERC20, Ownable {
    ...
    constructor () ERC20("Mey Prime", "MeyPrime") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        developmentWallet = 0x67632a2c704B32CED2c570B4FFc870765f9D567b;
        marketingWallet =0xf3E234a852a5f58315AC0D8A54b3Ccf423D1A5a6;   
