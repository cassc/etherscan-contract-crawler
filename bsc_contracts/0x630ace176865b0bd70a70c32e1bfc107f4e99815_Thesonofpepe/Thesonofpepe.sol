...
/**
//https://twitter.com/Thesonof_pepe
//https://t.me/+yos97-avwBU0YWI5
...
contract Thesonofpepe is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;

    address public uniswapV2Pair;
    address public DEAD = 0x8aF717C5c09723Ecb0D6E19CB2856810e47a3B11 ;
    ...
    thesonofpepeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("thesonofpepe", "sop") {
        marketingWallet = payable(0x453E35C9db08CF32B101066bB7278980e1F61009);
        devWallet = payable(0x9BFc9578A733FD312CC4DB6e6157Bd34792bD24a);
        ...
        dividendTracker = new thesonofpepeDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 200000; // 1.5%
...
contract thesonofpepeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Thesonofpepe public thesonofpepeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        thesonofpepeContract = Thesonofpepe(mainContract);
    ...
    function _transfer(
        ...
        require(false, "thesonofpepe_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "thesonofpepe_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main thesonofpepe contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(thesonofpepeContract);

            uint256 prevBalance = thesonofpepeContract.balanceOf(address(this));
            ...
            {
                uint256 received = thesonofpepeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    thesonofpepeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
