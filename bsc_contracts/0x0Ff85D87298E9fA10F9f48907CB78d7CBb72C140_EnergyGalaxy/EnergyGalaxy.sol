    ...
    function buyGemstones(address ref) external payable{
       ...
       possessions[msg.sender].gemBalance += gemsAmount;
        ...
        if(possessions[msg.sender].parentRef != address(0)){
            ...
            possessions[level_1].essentialsBalance += (gemsAmount * 4) /100 * 10;
            possessions[level_1].refEss += (gemsAmount * 4) /100 * 10;
            ...
            if(possessions[level_1].parentRef != address(0)){
                ...
                possessions[level_2].essentialsBalance += (gemsAmount * 3) /100 * 10;
                possessions[level_2].refEss += (gemsAmount * 3) /100 * 10;
                ...
                if(possessions[level_2].parentRef != address(0)){
                    ...
                    possessions[level_3].essentialsBalance += (gemsAmount * 3) /100 * 10;
                    possessions[level_3].refEss += (gemsAmount * 3) /100 * 10;
                    ...
                    if(possessions[level_3].parentRef != address(0)){
                        ...
                        possessions[level_4].essentialsBalance += (gemsAmount * 2) /100 * 10;
                        possessions[level_4].refEss += (gemsAmount * 2) /100 * 10;
                        ...
                        if(possessions[level_4].parentRef != address(0)){
                            ...
                            possessions[level_5].essentialsBalance += (gemsAmount * 1) /100 * 10;
                            possessions[level_5].refEss += (gemsAmount * 1) /100 * 10;
