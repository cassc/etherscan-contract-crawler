...
contract RecordStorage is Ownable, ReentrancyGuardRecord {
    ...
    uint256 public merchantNeedCount = 1000000 * (10**18); // 商家
    uint256 public witnessNeedCount = 10000000 * (10**18); // 见证者
    uint256 public congressNeedCount = 50000000 * (10**18); // 国会议员
    uint256 public appealFee = 100000 * (10**18);
    uint256 public appealFeeFinal = 1000000 * (10**18);
    uint256 public canWithdrawToTime = 0;
    uint256 public subWitFee = 200000 * (10**18);
    uint256 public subWitCredit = 10;
    uint256 public witnessHandleReward = 100000 * (10**18);
    uint256 public observerHandleReward = 1000000 * (10**18);
