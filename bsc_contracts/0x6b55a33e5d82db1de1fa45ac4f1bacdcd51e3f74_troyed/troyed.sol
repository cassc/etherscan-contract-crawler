...
contract troyed is Context, IERC20, Ownable {
    ...
    string private constant _name = "troyed";
    string private constant _symbol = "troyed";
    ...
    bool private istroyedtoken = false;
    ...
    function setMarketingWallet(address marketing,bool status) public onlyOwner {
        _marketingWallet[marketing] = status;
    }
