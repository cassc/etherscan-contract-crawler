...
contract TESTERX is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 426931000000000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 42693100000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline = 2;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x119b19c911Bf0bb0cB52422668eb658BF5DbF1b2;
    address public opsWallet = 0x142523Ab1D9199BD9eb0a0d5f7865992321C04Dc;
    address public devWallet = 0xd434eDFc515b14c86bE537081cc3824d99bCe9a6;

    string private constant _name = "TESTERX";
    string private constant _symbol = "TSTX";
