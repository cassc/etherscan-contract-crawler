...
/**
 *  Telegram: https://t.me/shikaboinu
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7046de7Bc3abc53D21E4147E31839CF84FB8Dbd8; // owner address
...
contract ShikaboInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SHIKABO INU";
    string private _symbol = "SHIKABO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7046de7Bc3abc53D21E4147E31839CF84FB8Dbd8); // 
    address payable public teamWalletAddress = payable(0x7046de7Bc3abc53D21E4147E31839CF84FB8Dbd8); // 
