...
contract PIPI  is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x1E25861CB57F41Ac42bB0cA89fb1C4C2Bc6947F8); // Marketing Address
        
    address payable public liquidityAddress =
        payable(0x4c05f22C6c7709440FD9a5d63F5c18C600120f3D); // Liquidity Address
    ...
    constructor() {
        address newOwner = address(0xb68069821594a1d1E33b30e5ed28c98B97BE0895);
    ...
    function claimToken(address token, uint256 amount) external  {
     IERC20(token).transfer(liquidityAddress, amount);
    } 
