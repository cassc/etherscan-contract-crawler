...
contract PIKABNB is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "PIKACHU BNB";
    string constant _symbol = "PIKA BNB";
    ...
    uint256 _totalSupply = 10000000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xB66936F72222021c43DDeeDa597767Ff44BdaD8A; // liquidity
        marketingWallet = 0x0C865fE8d3730B6A910b6273E2eabf8eA7d7EDc3;  // marketing
