...
contract daddyLunav3 is IBEP20, Ownable {
    /*=== SafeMath ===*/
    ...
    uint256 private limitBurn = 10000 * _decimalFactor;
    uint256 public liquidityPercent = 20; // Taxa de Liquidez 20%
    uint256 public maxWalletBalance = 1000000 * _decimalFactor; // 1% do Supply
    uint256 public maxBuyAmount = 300000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 300000 * _decimalFactor; // 1% do Supply
    uint256 public numberOfTokensToSwapToLiquidity = 60000 * _decimalFactor; // 0,05% do Supply
    /*=== Boolean ===*/
    ...
    /*=== Strings ===*/
    string private _name = "daddy luna";
