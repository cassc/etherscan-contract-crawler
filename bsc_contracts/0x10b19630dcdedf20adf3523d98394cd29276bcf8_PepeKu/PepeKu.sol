...
contract PepeKu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PepeKu";
    string private _symbol = "PepeKu";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0xBc405A7fD71D4c34F9D7e9Ee2B227F313051daDf); // Marketing Address
    address payable public teamWalletAddress = payable(0xBc405A7fD71D4c34F9D7e9Ee2B227F313051daDf); // Team Address
