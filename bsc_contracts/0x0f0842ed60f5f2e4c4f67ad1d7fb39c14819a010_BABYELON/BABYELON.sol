...
contract BABYELON is ERC20, Ownable {
    ...
    constructor () ERC20("BABY ELON", "BABYELON") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x75591cC9A6c20358d79aE2D5A1695B66d67F7b43;
        developmentWallet = 0x510fd435a343C3270B1f63d25B63fFE394092a6A;
    ...
    function enableTrade() external onlyOwner{
        require(!tradeEnabled, "TRADE already enabled.");
        tradeEnabled = true;
        swapEnabled = true;
    }
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        require(tradeEnabled || _isExcludedFromFees[from] || _isExcludedFromFees[to], "TRADE not yet enabled!");
