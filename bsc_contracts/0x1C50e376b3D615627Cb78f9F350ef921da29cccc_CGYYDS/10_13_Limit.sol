...
abstract contract Limit is ERC20, Ownable, Excludes {
    ...
    function checkLimitTokenBuy(uint256 amount) internal view {
        if (isLimited) require(amount <= _LimitBuy, "exceeds of buy amount Limit");
    }
    ...
    function removeLimit() internal {isLimited = false;}
}