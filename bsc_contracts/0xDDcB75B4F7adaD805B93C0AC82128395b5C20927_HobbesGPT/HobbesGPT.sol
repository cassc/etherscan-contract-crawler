...
/**
       __  __      __    __                 __________  ______    __ __
      / / / /___  / /_  / /_  ___  _____   / ____/ __ \/_  __/   / // /
     / /_/ / __ \/ __ \/ __ \/ _ \/ ___/  / / __/ /_/ / / /_____/ // /_
    / __  / /_/ / /_/ / /_/ /  __(__  )  / /_/ / ____/ / /_____/__  __/
   /_/ /_/\____/_.___/_.___/\___/____/   \____/_/     /_/        /_/   
                                                                    
 Telegram: https://t.me/HobbesGPT4
...
contract HobbesGPT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x5A4d9d7eb20b884f7272f48B6E274F2512a4be1F); // Marketing Address
        
    address payable public teamAddress =
        payable(0x5A4d9d7eb20b884f7272f48B6E274F2512a4be1F); // Team Address
        
    address payable public liquidityAddress =
        payable(0x5A4d9d7eb20b884f7272f48B6E274F2512a4be1F); // Liquidity Address
    ...
    string private constant _name = "Hobbes GPT-4";
    ...
    function setMaxWallet(uint256 amount) external onlyOwner returns (bool) {
        maxWallet = amount;
        return true;
    }
