...
contract TTMDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TTMDAO";
    string private _symbol = "TTMDAO";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x347567107082B96e313221007E180336b382Ab2a); 
    address payable public BurnedWalletAddress = payable(0x347567107082B96e313221007E180336b382Ab2a); 
