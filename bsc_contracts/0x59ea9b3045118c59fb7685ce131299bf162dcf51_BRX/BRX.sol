...
contract BRX is IERC20, Ownable {
    ...
    constructor() {
       ...
       /* fundAddress = 0x6D4cC2F6f634cD5f6841d420E8D7FC4f4606484e;

        currency = 0xaB1a4d4f1D656d2450692D237fdD6C7f9146e814; //USDT
        ISwapRouter swapRouter = ISwapRouter(
            0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        ); //router
        address ReceiveAddress = 0x6D4cC2F6f634cD5f6841d420E8D7FC4f4606484e;
        //lpRewardAddress
        lpRewardAddress = 0xD51b818EE40007CBb8B34aA713318BCC0D08aa11;

        ETH = 0xaB1a4d4f1D656d2450692D237fdD6C7f9146e814;*/ //usdt
        //testnet   end

        maxWalletAmount = 1900000000 * 10 ** _decimals;
        maxTransferAmount = 950000000 * 10 ** _decimals;
    ...
    function changeTransferLimit(uint256 _amount) external onlyOwner {
    ...
    function disableWalletLimit(bool _opne) public onlyOwner {
        enableWalletLimit = _opne;
    }
}