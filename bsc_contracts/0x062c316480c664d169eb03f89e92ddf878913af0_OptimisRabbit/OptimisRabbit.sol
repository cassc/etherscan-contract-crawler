...
//   📱Website ::https://OptimisRabbit.com/
/*
...
contract OptimisRabbit is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("OptimisRabbit", "OptimisRabbit") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "OptimisRabbit";
    string private _symbol = "OptimisRabbit";
