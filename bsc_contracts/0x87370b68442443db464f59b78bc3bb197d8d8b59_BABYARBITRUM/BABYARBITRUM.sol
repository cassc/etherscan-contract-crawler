...
Telegram :https://t.me/BabyArbitrumofficialBsc
...
contract BABYARBITRUM is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Arbitrum"; 
    string private _symbol = "BABYARB";
    ...
    uint256 public _totalTax = 6;

    uint256 private _totalSupply = 10_0 * 10**18;
    uint256 public _maxTxAmount = 3 * 10**18;
    uint256 public _walletMax = 3 * 10**18;
    uint256 private minimumTokensBeforeSwap = 20 * 10**18; 
