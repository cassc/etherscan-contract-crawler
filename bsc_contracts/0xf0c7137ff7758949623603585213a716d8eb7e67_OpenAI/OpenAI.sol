...
contract OpenAI is Context, IERC20 { 
    ...
    // Contract Wallets
    address private _owner = payable(0x8B6CcED3fb0DCa49c8de752BF48225Ce79d4ca8b);
    ...
    // Token Info
    string private  _name = "OpenAI Pro";
    string private  _symbol = "PRIMUS";
    ...
    function Contract_SetUp_2_Fees_on_Sell(
        ...
        if (LaunchPhase) {
            ...
            // During first 30 mins only the sell fee can be set up to 30%
            sell_Fee_Limit = 30;
        }
    ...
    */
    ...
    function _transfer(
        ...
        // First 30 mins have higher sell fees (up to 30%) these will automatically adjust after 30 minutes
...
// License is not open source - Can not be copied / forked.
// Smart Contract Code by Gen, www.GenTokens.com