...
contract FlokiX is IBEP20, Auth {
    ...
    address DEV = 0xFd3cE71E2B0BabE0fd7fAB9BcbBa3B6c48b5343B;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    string constant _name = "FLOKI X";
    string constant _symbol = "$FLKX";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x85072b76272DEd543AADA23375edBf143982dCAf;
