...
A globally connected eco-system.
The future is ONE. 🟢

-OneLifeDev Launch 💹 (Previous ATH 700K)
-Low Supply 💥
-3% $ONE Reflections 🟢
...
contract ONE is IERC20, Ownable {
    ...
    uint256 _totalSupply = 3700 * 10**_decimals;
  ...
  /* rOwned = ratio of tokens owned relative to [[circulating]] supply */
    ...
    uint256 smallSwapThreshold = 11 * 10**_decimals; 
    uint256 largeSwapThreshold = 15 * 10**_decimals; 
    ...
    constructor () {
        ...
        devFeeReceiver = 0x64090198aAC6aA97eC0A628D2b7735fB3C4E6c69;
        marketingFeeReceiver = 0x0c67f69641AC2ECf0750a137b2CA077A6d0798dE;
