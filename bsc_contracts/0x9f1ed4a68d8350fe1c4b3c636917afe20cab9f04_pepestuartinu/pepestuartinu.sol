...
contract pepestuartinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPE STUART INU";
    string private _symbol = "$PSI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x999EBACF2F8c81826dF73A080A417e651Fb8c81E);
    address payable public teamWalletAddress = payable(0x999EBACF2F8c81826dF73A080A417e651Fb8c81E);
    ...
    uint256 public _sellMarketingFee = 82;
