...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeD1C7D8e48603674c4464aE686797aB83B4a7041; // owner address
...
contract BabySowlToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x720205d925C4Ab0C1738a0ef45370406b2afc79f); // Marketing Address
    address payable public teamWalletAddress = payable(0x720205d925C4Ab0C1738a0ef45370406b2afc79f); // Team Address
