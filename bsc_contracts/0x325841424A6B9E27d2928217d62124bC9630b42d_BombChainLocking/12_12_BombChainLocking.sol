...
contract BombChainLocking is ContextUpgradeable {
    ...
    function updateTierData() public onlyOwner {
        ...
        tierInfo = TierInfo({
            ...
            tier4multiplier: 250,
            tier4maxAmount: 1000000 ether,
            tier4currentAmount: currentTierInfo.tier4currentAmount
        });
    }
    ...
    function deposit(uint256 _tier, uint256 _amount) public {
        address _sender = _msgSender();
        require(_tier >= 1 && _tier <= 4, "Tier must be between 1 and 4");
        ...
        require(
            _amount <= maxAmount - tierInfo.tier1maxAmount - currentAmount,
        ...
        if (_amount > 0) {
            ...
            if (_tier == 1) {
                ...
                tierInfo.tier4currentAmount = currentAmount.add(_amount);
                currentAmount = tierInfo.tier4currentAmount;
            }
