...
contract DORAINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DORAINU";
    string private _symbol = "DORA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe96698263691030ef4F165726e526FDad63FC07A);
    address payable public teamWalletAddress = payable(0xe96698263691030ef4F165726e526FDad63FC07A);
