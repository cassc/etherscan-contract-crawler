...
/**
 * @title WakToken
 * @notice ERC20 token for the Green Block mining platform, has a sell tax of 10% that is used for the purchase of mining equipment.
 */
contract WakToken is ERC20, ERC20Burnable, Ownable {
    //---------- Contracts ----------//
    ...
    //---------- Constructor ----------//
    constructor(IRouterV2 _dexRouter) ERC20("Wak Token", "Wak") {
