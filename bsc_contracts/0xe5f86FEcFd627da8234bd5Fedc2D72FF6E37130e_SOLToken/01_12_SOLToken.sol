...
contract SOLToken is ERC20, ERC20Burnable, AccessControl {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE_SOL");
    IMEVChecker checker;

    constructor(address _checker) ERC20("SOL", "SOL") {
