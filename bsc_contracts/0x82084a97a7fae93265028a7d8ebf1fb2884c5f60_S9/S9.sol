...
contract S9 is Context, IERC20, Ownable {
  
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "9S";
    string private _symbol = "9S";
    uint8 private _decimals = 0;

    uint public launchedBlock;
    uint private small = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x5640d8789dA7b194ce3dB7D74577Bc83C644F3f6); // Marketing Address
