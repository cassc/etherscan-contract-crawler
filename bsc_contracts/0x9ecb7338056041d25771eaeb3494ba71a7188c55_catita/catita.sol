...
/**
Telegram: https://t.me/catita_inu
*/
...
contract catita is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Catita Inu";
    string private _symbol = "Catita";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0x71EE05BB1Ba110750295171953a66A294825931f);
