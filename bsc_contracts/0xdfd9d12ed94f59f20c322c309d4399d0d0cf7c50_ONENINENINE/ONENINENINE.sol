...
contract ONENINENINE is Context, IERC20, Ownable {
    ...
    string private constant _name = "199";
    string private constant _symbol = "199";
    uint8 private constant _decimals = 9;
    
    uint256 private _tTotal = 1990 * 10**9 * 10**9;
