...
contract MrGreenRewards is IBEP20{
	...
	function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(conditionsToSwapAreMet(sender) && !newIdeaActive) letTheContractSell();
...
////////////////////////////////////// Rewards functions //////////////////////////
    ...
    function addAndLockLiquidityAndLaunch(uint256 gas, uint256 antiBlocks, uint256 lockTime, address[] memory airdropWallets, uint256[] memory amount) external payable contractSelling onlyOwner{
