...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x501E8cbb54d87Deed8c585D576dbC3964CfFea4F;
...
contract ARENAGLOBAL is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"ARENA GLOBAL"; 
    string private constant _symbol = unicode"$ARENA"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x501E8cbb54d87Deed8c585D576dbC3964CfFea4F), BNB_Tot);
            }
