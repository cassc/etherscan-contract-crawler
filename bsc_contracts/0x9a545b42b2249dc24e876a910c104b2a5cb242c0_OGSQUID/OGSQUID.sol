...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xad834E602C38F801Ea44F38C9e0e58fB80788f04; // owner address
...
contract OGSQUID is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OG SQUID";
    string private _symbol = "OG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xad834E602C38F801Ea44F38C9e0e58fB80788f04); // Marketing Address
    address payable public teamWalletAddress = payable(0xad834E602C38F801Ea44F38C9e0e58fB80788f04); // Team Address
