        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0x2888D4A3F2a8db7CDb3FAe11c1261C250636d1c3), block.timestamp
                );
            }
        }
    }
...
contract FeelsGuy is AbsToken {
    constructor() AbsToken(
        ...
        9,
        1000000000000000,
        address(0x2888D4A3F2a8db7CDb3FAe11c1261C250636d1c3),
        address(0x2888D4A3F2a8db7CDb3FAe11c1261C250636d1c3)
    ){
    }
}