...
/**
---------------------------------------------------------------------------------------------------
 Contract Developed by Anoop [Developed over 300+ contracts]: 
...
contract DIAMOND_CEO is ERC20, Ownable {
    ...
    DIAMOND_DividendTracker public dividendTracker;
    
    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x7a73873727B99737456E305D8C567f39775D7d3b;
    ...
    constructor() ERC20("DIAMOND CEO", "DIAMOND") {
        dividendTracker = new DIAMOND_DividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        DIAMOND_DividendTracker newDividendTracker = DIAMOND_DividendTracker(
            payable(newAddress)
        );
...
contract DIAMOND_DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("DIAMOND_Dividen_Tracker", "DIAMOND_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "DIAMOND_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "DIAMOND_Dividend_Tracker: Cannot update claimWait to same value"
        );
