...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xDDc5143c65Cf95BCa50486abF8e631c214355897);
...
contract BABYNOBORU is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV =  0x4a8647B10f81b8AEdA8DdDf6fb85021E7e6C42a9;

    string constant _name = "BABY NOBORU";
    string constant _symbol = "BNOBORU";
