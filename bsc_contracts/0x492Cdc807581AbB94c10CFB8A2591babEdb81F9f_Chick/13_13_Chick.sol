...
contract Chick is ReentrancyGuard, Pausable
{
	...
	uint256 public bnb_per_busd_vault_ratio_e4 = 4901; // bnb is 49.01%
	...
	{
		bnb_per_busd_vault_ratio_e4 = _bnd_ratio;
	...
	function _squeeze_juice(address _native_token) internal
	{
		...
		uint256 amount_busd = (amount_token * bnb_per_busd_vault_ratio_e4) / 1e4;
