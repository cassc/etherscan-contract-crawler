...
contract POPE is IBEP20, Auth {
   ...
   string constant _name = "POPE";
   string constant _symbol = "POPE";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 800; // 2%
...
uint256 reflectionFee = 0;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x3913808F7925aF5bBeB0A14b55edFA53Bfa48BfB; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0x3913808F7925aF5bBeB0A14b55edFA53Bfa48BfB; //Can be change to any wallet you want
       marketingFeeReceiver = 0x3913808F7925aF5bBeB0A14b55edFA53Bfa48BfB; //Can be change to any wallet you want
