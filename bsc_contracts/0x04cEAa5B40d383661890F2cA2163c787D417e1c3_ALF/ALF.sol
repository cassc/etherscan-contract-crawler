...
contract ALF is ERC20, ERC20Burnable, ERC20Permit, Ownable {
    constructor() ERC20("ALF", "ALF") ERC20Permit("ALF") {
        _mint(msg.sender, 420420000000000 * 10 ** decimals());
    }
}