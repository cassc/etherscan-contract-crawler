...
contract BABYREDFLOKICEO is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "BABYREDFLOKICEO";
    string constant _symbol = "$BRFC";
    ...
    uint256 public BNBRewardFee = 5;
    uint256 public BNBRewardFeeSell = 5;

    uint256 public totalFee = 10;
    uint256 public totalFeeSell = 10;

    address public autoLiquidityReceiver = address(this);
    address private marketingWallet = 0xfF8b70ba42fFE32029469aa43E4b4E032cC04256;
    address private BNBRewardWallet = 0xfF8b70ba42fFE32029469aa43E4b4E032cC04256;
