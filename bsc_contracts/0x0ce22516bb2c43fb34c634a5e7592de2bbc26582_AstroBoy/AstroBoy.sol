...
Telegram : https://t.me/AstroBoyPortal
Website: https://astroboy.cloud/
Twitter: https://twitter.com/AstroBoy_BSC
...
contract AstroBoy is Context, IERC20, Ownable {
    ...
    uint256 public maxSellAmount = 25000 * 10**_decimals;
    uint256 public maxBuyAmount = 25000 * 10**_decimals;
    uint256 public maxWalletBalance = 25000 * 10**_decimals;

    address private marketingAddress = 0x800491CF887DdCEF84a0F8c6A04c8bB7E95DCc83;
    address private devAddress = 0x800491CF887DdCEF84a0F8c6A04c8bB7E95DCc83;
    ...
    Taxes public sellTaxes = Taxes(0,15,15,0);
