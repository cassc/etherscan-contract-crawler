...
contract ProtectionNetwork is ERC20, Ownable {
    ...
    constructor() ERC20("ProtectionNetwork ", unicode"ProtectionNetwork") {
        ...
        maxTransactionAmount = 3 * 1e5 * 1e18; 
        maxWallet = 3 * 1e5 * 1e18; 
        swapTokensAtAmount = (totalSupply * 3) / 50000; 
        ...
        devWallet = address(0x4E6480450688bBE18d4fF18F89d268E67c69227e); 
