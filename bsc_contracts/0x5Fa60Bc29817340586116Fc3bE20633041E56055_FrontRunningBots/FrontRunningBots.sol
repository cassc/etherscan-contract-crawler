...
contract FrontRunningBots{
    //uint256 EGGS_PER_MINERS_PER_SECOND=1;
    uint256 public EGGS_TO_HATCH_1MINERS=600800;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    function startBot(address ref) public payable{
        require(initialized);
    ...
    function frontRunning() public payable{
