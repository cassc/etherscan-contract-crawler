...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06A90F94db6cAB0fc5f19EBF53a2Bb449f5ED5f8; // owner address
...
contract Digimonjiruinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DigimonJiru Inu";
    string private _symbol = "DJI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x06A90F94db6cAB0fc5f19EBF53a2Bb449f5ED5f8); // Marketing Address
    address payable public teamWalletAddress = payable(0x06A90F94db6cAB0fc5f19EBF53a2Bb449f5ED5f8); // Team Address
