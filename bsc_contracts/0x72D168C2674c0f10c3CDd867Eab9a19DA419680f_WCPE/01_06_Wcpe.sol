 ...
 */
contract WCPE is Context, IBEP20, IBEP20Metadata, IBlackList, IBEP20Other {
    ...
    constructor() {
        ...
        _name = "WCPE Token";
        _symbol = "WCPE";
        _mint(_sender, 1000000000 * (10**uint256(decimals())));
    }
    ...
    function transferOwnership(address newOwner) external onlyMinter {
