...
REVO is a Web 3.0 video NFT social networking service that enables users to watch-to-earn and trade video NFTs. 
...
contract REVO is IBEP20, Auth {
    ...
    string constant _name = "REVO";
    string constant _symbol = "R3VO";
