...
contract BusdCrops {
	...
	uint256 public COMPOUND_BONUS_MAX_TIMES = 2; /** 6 times / 3 days. **/
    uint256 public COMPOUND_STEP = 1 * 60 * 60; /** every 6 hours. **/
	...
	uint256 public CUTOFF_STEP = 12 * 60 * 60; /** 48 hours  **/
