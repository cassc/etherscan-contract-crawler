...
/*
Telegram: https://t.me/CryptoPogs
Website: https://cryptopogs.co.uk
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC698c034EE0e6Bf01744dC00D61eAB4584716575; 
...
contract CryptoPogs is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CryptoPogs";
    string private _symbol = "POGS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC698c034EE0e6Bf01744dC00D61eAB4584716575); // 
    address payable public teamdevWalletAddress = payable(0xC698c034EE0e6Bf01744dC00D61eAB4584716575); // 
    ...
    constructor () {
        ...
        isExcludedFromFee[teamdevWalletAddress] = true;
        ...
        isWalletLimitExempt[teamdevWalletAddress] = true;
        
        isTxLimitExempt[owner()] = true;
        isTxLimitExempt[address(this)] = true;
        isTxLimitExempt[marketingWalletAddress] = true;
        isTxLimitExempt[teamdevWalletAddress] = true;
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        if(amountBNBTeam > 0)
            transferToAddressETH(teamdevWalletAddress, amountBNBTeam);
