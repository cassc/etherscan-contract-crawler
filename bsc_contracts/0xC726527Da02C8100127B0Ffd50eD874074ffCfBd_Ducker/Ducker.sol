...
contract Ducker is IBEP20, Ownable {
    ...
    address internal constant development_receiver = 0x475bE51fBb1E7af10eDaA855a9Dd4F2b32EE28A8; 
    address public constant marketing_receiver = 0x475bE51fBb1E7af10eDaA855a9Dd4F2b32EE28A8;
    address public constant liquidity_receiver = 0x475bE51fBb1E7af10eDaA855a9Dd4F2b32EE28A8;
    address internal constant pinksale_lock = 0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE;
    ...
    constructor() Ownable(msg.sender) {
        ...
        isFeeExempt[pinksale_lock].FeeExempt = true;
    ...
    function AutomaticTaxLoweringSystem() internal {
        if(launchTime.add(5 minutes) <= block.timestamp){totalFee = uint256(700); sellFee =uint256(700);}
        if(launchTime.add(1 hours) <= block.timestamp){totalFee = uint256(300); sellFee =uint256(300);
            _maxTxAmount = _totalSupply; _maxWalletToken = _totalSupply;}
        if(launchTime.add(2 hours) <= block.timestamp){totalFee = uint256(100); sellFee =uint256(100);
            ATLSCompletion = true;}
    }
