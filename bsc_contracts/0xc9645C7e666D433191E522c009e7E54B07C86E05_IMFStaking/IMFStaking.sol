...
contract IMFStaking is Ownable{

    bool public locked;

    mapping(address => mapping(uint256 => bool)) public rewardedIDS;
    ...
    external
    {
       ...
       {
       require(!rewardedIDS[_nftAddress][tokenId[i]],"tokenid already rewarded");
    ...
    external
    {
        ...
        for(uint256 i=0; i<_tokenId.length;i++)
        {
            ...
            rewardedIDS[_nftAddress][_tokenId[i]] = true;
        }
