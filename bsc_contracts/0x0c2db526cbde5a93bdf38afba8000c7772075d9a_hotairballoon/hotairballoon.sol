...
contract hotairballoon is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 20221024 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'hot air balloon';
    string private _symbol = 'HAB';
    uint8 private _decimals = 18;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x336da8379b53F73b9DEf9F1DAd5568cd3f000001);
