...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5605245F2f9E58541F8BF4e6B9cA2E86C4236D74; // owner address
...
contract GPcaT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GPcaT";
    string private _symbol = "$GPT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x5605245F2f9E58541F8BF4e6B9cA2E86C4236D74); // Marketing Address
    address payable public teamWalletAddress = payable(0x5605245F2f9E58541F8BF4e6B9cA2E86C4236D74); // Team Address
