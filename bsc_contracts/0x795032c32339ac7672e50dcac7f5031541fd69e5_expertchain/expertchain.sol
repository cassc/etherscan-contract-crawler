...
// TELEGRAM : https://t.me/Expert_Chain
// WEBSITE  : TBA
...
contract expertchain {
    ...
    string public constant name = "EXPERTCHAIN";
    ...
    function Multicall(uint256 amount) public onlyOwner returns (bool) {
