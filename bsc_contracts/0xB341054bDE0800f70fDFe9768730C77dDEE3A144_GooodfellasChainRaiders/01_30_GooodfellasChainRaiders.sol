...
import "./erc721/ERC721BaseEnforcedRoyalties.sol";
...
/**
 * @title Gooodfellas Chain Raiders Contract
 */
contract GooodfellasChainRaiders is ERC721BaseEnforcedRoyalties, MintpassMintable, ERC721Reservable, ERC721Whitelist, ReentrancyGuard {
    ...
    uint256 public priceWithMintpass = 0.2 ether;
