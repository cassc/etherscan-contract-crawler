...
contract BCB is IERC20, Ownable {
    ...
    address private _marketAddress = address(0x761101b50A4221e04814e77580527D48AEb9cA4a);
    ...
    constructor() {
        ...
        _owner = msg.sender;
        startTime = block.timestamp.div(1 days).mul( 1000 days);
    ...
    function _transfer(
        ...
        require(!_blackList[from] && !_blackList[to], "Blacklist address");
    ...
    function takeFee (
        ...
        if(recipient == uniswapV2Pair){
            ...
            _takeTransfer(
                sender,
                _burnAddress,
                tAmount.div(_denominatorOfFee).mul(fee),
                currentRate
            );
        }else{
             fee = _buyMarketFee;
        ...
        uint256 recipientRate = _denominatorOfFee - fee;
