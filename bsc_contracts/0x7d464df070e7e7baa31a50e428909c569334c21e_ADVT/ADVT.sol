...
contract ADVT is
    ...
    ERC20Burnable
{
    string constant private _name = "ADVT";
    string constant private _symbol = "ADVT";
    uint8 constant private _decimals = 18;
    uint256 constant private _initial_supply = 500_000_000;
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "ADVT/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "ADVT/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "ADVT/approve : Should not approve zero address"
        );
