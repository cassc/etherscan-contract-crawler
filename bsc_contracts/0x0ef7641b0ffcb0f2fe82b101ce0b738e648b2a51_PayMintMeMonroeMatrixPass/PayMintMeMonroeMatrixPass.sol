...
/**
 * @title Counters
 * @author Meaghan Monroe PayMintMe 
...
pragma solidity ^0.8.9;
 ...
 // dont use space here 
contract PayMintMeMonroeMatrixPass is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;
// save as property of contract
  address public crossmintAddress;
//
  constructor(string memory customBaseURI_)
    ERC721("Crown Pay-Mint.Me Access Pass ", "Pay-Mint.Me Pass") // first name and last initial. 
  {
  ...
  uint256 public constant MAX_SUPPLY =  111111111;
  ...
  function CustomMint(uint256 count) public nonReentrant  payable  {
    ...
    require(count <= MAX_MULTIMINT, "Mint at most 11 at a time");
