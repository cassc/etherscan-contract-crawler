...
contract BAIT is ERC20, Ownable {
    ...
    constructor () ERC20("Body AI", "BAIT") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x55d2279D69C729284a1e3d01CA70676A58fa63d3;
        treasuryWallet = 0x956Cf7601835E3a2e238dcAb94C2D5c40E1decEd;
        developmentWallet = 0xeFa0991489cAeAbEFCc13CDC6D168d4b348DD4Ba;
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        payable(marketingWallet).sendValue(oneThird);
        payable(developmentWallet).sendValue(oneThird);
