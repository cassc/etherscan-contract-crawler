...
Buy:  6% marketing, 4% LP, 0% rewards
Sell: 18% marketing, 7% LP, 0% rewards
...
contract InuYasha is IBEP20, Auth {
    ...
    address DEV = 0x6d7E443E1855668926Ab29A0DA748E75A9E2bf75;
    ...
    // Name and symbol
    string constant _name = "Inu Yasha";
    string constant _symbol = "Inuya";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 10%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1%
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 10000; // 5%
    ...
    uint256 public marketingFeeBuy = 60;
    uint256 devFeeBuy = 0;
    uint256 public totalFeeBuy = 100;

  // Sell fees
    uint256 public liquidityFeeSell = 70;
    uint256 buybackFeeSell = 0;
    uint256 public reflectionFeeSell = 0;
    uint256 public marketingFeeSell = 180;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x3BeBD9935925e61a2b91cc09127B5c39d95b0981;
