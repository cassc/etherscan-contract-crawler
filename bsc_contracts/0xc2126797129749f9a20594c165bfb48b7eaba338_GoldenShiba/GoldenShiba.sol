...
contract GoldenShiba is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9bAEcA702A79e67273934Ba6aDAd24358A0FCFB0); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x9D15e64338141Ff211d7ac23C74C673213929eB5); // Reserve Wallet Address
    address payable public stakingWalletAddress = payable(0xdc7CC06E729f2be741d9CC5509e16c0a12Ec525d); // Staking Wallet Address
    address payable public devWalletAddress = payable(0xA9F87F9D05728CD1Fd353637B93bbC4Bd8B972fe); // Dev Wallet Address
    ...
    string private constant _name = "Golden Shiba";
    string private constant _symbol = "GOLDSHIB";
    ...
    constructor () {
        address _owner = 0xB85994C3519c2c79E7Fb3653A3b42ede85E2bdc1;
    ...
    function setSaleFee() private {
        ...
        totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _stakingFee; 
    }
