...
contract WORPrivateSale is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("WOR - Private Sale", "WOR") {
    ...
    function buyPrivateByBNB() 
        ...
        unchecked {
            ...
            IERC20(addressWOR).transferFrom(
                privateSaleWalletBonus, msg.sender, amountBuy * bonus / denominatorBonus
                );
    ...
    function buyPrivateByBUSD(uint256 amountBUSD)
    ...
    function buyPrivateByUSDT(uint256 amountUSDT)
        external nonReentrant() {
        require(isOpenPrivate, "Private not opened yet");
        require(totalSoldInBNB <= hardCapPrivate, "Sales limit reached");
