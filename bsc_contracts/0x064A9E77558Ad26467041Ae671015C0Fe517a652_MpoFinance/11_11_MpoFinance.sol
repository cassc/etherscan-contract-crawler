...
contract MpoFinance is OwnableUpgradeable {
    // ADDRESS
    ...
    function buyIdo(address inv_) public returns (bool) {
        ...
        IERC20(USDT).transferFrom(msg.sender, address(this), ido.price);
        ...
        returns (uint aa)
    {
        ...
        aa =
            IMPOT(MPO).checkPhaseUserBonus(p, user_) -
            f_userInfo[p][user_].claimed;
    }
