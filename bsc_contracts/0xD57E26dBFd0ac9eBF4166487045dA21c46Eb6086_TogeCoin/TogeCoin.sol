...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x293c5052BF5456f3C64bAF9ee050b990820B055E; // owner address
...
contract TogeCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Toge";
    string private _symbol = "Toge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc846f773F5B509cD5D7BD60a1C87ef4f00d78eF7); // Marketing Address
    address payable public teamWalletAddress = payable(0x293c5052BF5456f3C64bAF9ee050b990820B055E); // Team Address
    ...
    uint256 private _teamShare = 3; // original 12
