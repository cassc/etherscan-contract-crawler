...
contract SUKUNAINU is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Sukuna Inu";
    string private constant _symbol = unicode"SUKUNAINU";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**11 * 10**_decimals;

    address payable public DevWallet = payable(0x0C6023867563103Ee0Ef1944D547b54681FDEa8c);
    address payable public MarketingWallet = payable(0x9bD76F1982269F82eAdBEDc50247d249E8ec2937);
