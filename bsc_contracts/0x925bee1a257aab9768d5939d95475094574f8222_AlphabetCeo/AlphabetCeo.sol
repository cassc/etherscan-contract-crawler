...
contract AlphabetCeo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AlphabetCeo";
    string private _symbol = "Alpceo";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = true;
    address payable public marketingWalletAddress = payable(0x25Ab29c5B2f8DED1082069cC7e903d34B9132e9c); // Marketing Address
    address payable public teamWalletAddress = payable(0x25Ab29c5B2f8DED1082069cC7e903d34B9132e9c); // Team Address
