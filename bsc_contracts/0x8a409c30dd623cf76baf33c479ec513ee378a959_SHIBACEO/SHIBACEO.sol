...
contract SHIBACEO is Context, IERC20, Ownable {
    ...
    uint256 public _marketingFee = 16; // original: 1
    uint256 public _buyBackFee = 2;
    uint256 public _extraFeeOnSell = 10; // original: 0
    uint256 public _totalTaxIfBuying = 20; // original: 5
    uint256 public _totalTaxIfSelling = 30; // original: 5
