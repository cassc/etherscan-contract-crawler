...
interface IVeloStableVaultToken {
    /*** Tarot ERC20 ***/
    ...
    function coreStableToken() external view returns (address);
    ...
    function updateCoreStableToken(address _newCoreStableToken) external;
