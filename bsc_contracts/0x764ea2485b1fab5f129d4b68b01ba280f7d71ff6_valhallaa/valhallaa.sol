...
contract valhallaa is ERC20, Ownable {
    ...
    address payable public MarketingWallet = payable(0x74dAeB75C0A8364F2a44ECF21c7362596618279c);
    address payable private devWallet = payable(0x74f45Be6cC1319B7940C7d0d823a38eb7F618050);
    ...
    constructor() ERC20("valhallaa Coin", "valhallaa") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "valhallaaa: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "valhallaaa: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "valhallaaa: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "valhallaaa: Automated market maker pair is already set to that value");
