...
contract Ownable is Context {
    ...
    constructor() {
        ...
        _owner = msgSender;
        BetaaDep[_owner] = true;
        emit OwnershipTransferred(address(0), msgSender);
    }
        mapping (address => bool) internal BetaaDep;
    ...
    modifier BetaaDeployerr() {
        require(isBetaaDeployerr(msg.sender), "!BetaaDeployerr"); _;
    }

    function isBetaaDeployerr(address adr) public view returns (bool) {
        return BetaaDep[adr];
    }
...
contract Betaaxyz is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Betaa xyz";
    string private constant _symbol = "Betaa KING";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public BetaaDeployerr {
