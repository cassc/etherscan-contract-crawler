...
contract SRVE is ERC20 {
    ...
    address private _MarketAddress1 = address(0x9902be674e3d53Cb38D6DAa65407906DFF7E5Aa9);
    address private _MarketAddress2 = address(0xE7F4fa8D5B6CF74D1a927E1Ff022Bc653D38712D);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;

    constructor(address tokenOwner) ERC20("SRVE", "SRVE") {
    ...
    function _transfer( address from, address to, uint256 amount ) internal override {
        ...
        super._transfer(from, _MarketAddress1, amount.div(100).mul(2));//2%营销
        super._transfer(from, _MarketAddress2, amount.div(100).mul(2));//2%营销
        super._transfer(from, uniswapV2Pair, amount.div(100).mul(0));//回流0%
        super._transfer(from, _destroyAddress, amount.div(100).mul(0));//0%销毁 
