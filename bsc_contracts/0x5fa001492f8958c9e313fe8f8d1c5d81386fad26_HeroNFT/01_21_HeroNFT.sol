...
contract HeroNFT is BaseNFT {
  ...
  function syncFOTAOwnPrice(uint[] calldata _tokenIds, uint[] calldata _fotaOwnPrices) onlyMainAdmin external {
  ...
  function syncFOTAProfited(uint[] calldata _tokenIds, uint[] calldata _fotaProfited) onlyMainAdmin external {
