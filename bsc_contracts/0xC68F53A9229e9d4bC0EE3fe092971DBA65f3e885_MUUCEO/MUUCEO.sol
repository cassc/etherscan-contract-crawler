...
TG : https://t.me/muuceobsc
Website : https://twitter.com/Muu_Ceo
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdF3f5e0e4B654E41A949db5e052506aDB1722D47; // owner address
...
contract MUUCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MUU CEO";
    string private _symbol = "$MUU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xdF3f5e0e4B654E41A949db5e052506aDB1722D47); // Marketing Address
    address payable public teamWalletAddress = payable(0xdF3f5e0e4B654E41A949db5e052506aDB1722D47); // Team Address
