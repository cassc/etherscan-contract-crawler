...
/*
Telegram:https://t.me/PeepoGlobalchat
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xbE29afd3308140785261E3566BBD50eD39A3517f;
...
contract Peepo is Context, IERC20, Ownable {
    ...
    string private _name = "Peepo";
    string private _symbol = "$PEEPO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbE29afd3308140785261E3566BBD50eD39A3517f);
    address payable public teamWalletAddress = payable(0xbE29afd3308140785261E3566BBD50eD39A3517f);
