...
contract ELONCEO is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x17A6d16E2da1167c2eDad3D1bA5791C98fc727f9;

    string private constant _name = "Elon CEO";
    string private constant _symbol = "ELONCEO";
    ...
    function rescueBNB(uint256 weiAmount) external onlyOwner {
        require(weiAmount >= 0, "insufficient BNB balance");
