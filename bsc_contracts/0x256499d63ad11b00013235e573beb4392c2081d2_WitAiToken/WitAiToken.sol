...
✅Build Natural Language Experiences
✅Turn What Your Users Say Into Actions
✅Empowering Developers for Today and for the Future

📜  Ca: 0xf5761352b9c4cb45b42b886f3ce03bc659e987df

📊 Chart: https://poocoin.app/tokens/0xf5761352b9c4cb45b42b886f3ce03bc659e987df
...
contract WitAiToken is WitAiDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private WitAiTeam;
    address private CharityWitAi;
    ...
    string public override name = "WitAi";
    string public override symbol = "WitAi";
    ...
    constructor(uint totalSupplyValue, address WitAiTeamAddress, address CharityWitAiAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        WitAiTeam = WitAiTeamAddress;
        CharityWitAi = CharityWitAiAddress;
        
        // split the tokens according to agreed upon percentages
        balances[WitAiTeam] =  totalSupply * 4 / 100;
        balances[CharityWitAi] = totalSupply * 4 / 100;
    ...
    // Get the address of the token's WitAiTeam pot
