...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3451501da7EA8B16ED0D9DfE692559108e9DBc75; 
...
contract ShibkokuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shibkoku Inu";
    string private _symbol = "shibkoku";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3451501da7EA8B16ED0D9DfE692559108e9DBc75); // 
