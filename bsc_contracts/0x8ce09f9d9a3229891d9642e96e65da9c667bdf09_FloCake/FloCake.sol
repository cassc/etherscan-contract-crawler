...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
...
/* Token contract */
contract FloCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xfcEC9E876E7F2d25E46962c267cA2Bb14d4247D5;
    ...
    // Name and symbol
    string constant _name = "FloCake";
    string constant _symbol = "FLOKE";
    ...
    uint256 public swapThreshold = _totalSupply * 60 / 10000; // 0.25%
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0x8F1fECf7F0A6C71c0113d674199ffE88c837C94d;
