...
/**
Nano🪜build 🏗️ is a token created to show the power of Nano, 
how far we could go & how strong 💪 we could be.📌. Gg Hold & let build 🏗️🪜
...
contract Nanobuild is Ownable, IERC20 {
    ...
    string private _name = "Nano Build";
    string private _symbol = "$NanoBuild";
