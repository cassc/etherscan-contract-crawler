...
contract SQUIDWARD is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 10000_0 * 10**8;
    uint256 public _maxTxAmount = 100 * 10**8;
    uint256 public _walletMax = 100 * 10**8;
    uint256 private minimumTokensBeforeSwap = 20 * 10**8; 
