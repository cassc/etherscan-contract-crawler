...
contract NFLOKI is ERC20, Ownable {
    uint256 private constant initialSupply = 1_000_000_000_000 * 10**18;
    ...
    constructor(address _router) ERC20("Neyma Floki", "NFLOKI") payable
    {
        ...
        // Sell Taxes
        sellTaxes["marketing"] = 600;
        sellTaxes["dev"] = 50;
        sellTaxes["liquidity"] = 50;

        // External wallets 
        taxWallets["marketing"] = 0x27569387a8bfD93d77374d877b9BCb1CD549Cc24;
        taxWallets["dev"] = 0x2a1c17daA14DFCbA33f4Dc7Bc4F7A1f4f1B22C97;
