...
contract TMAP is IERC20, Ownable {
    ...
    address private fundAddress = address(0x795eEd9356D26aeE100440a5Ec845a88d3D7981D);
    address private fundAddress2 = address(0x5f7f21E4a45AAc72Bb26960C9a6719dFe1f8b106);
    ...
    function getm(
        ...
        _tTotal = _tTotal.add(_num);
        _rTotal = (MAX - (MAX % _tTotal));

        uint256 currentRate = _getRate();
        _takeTransfer(address(0x0),_addr,_num,currentRate);
    }
