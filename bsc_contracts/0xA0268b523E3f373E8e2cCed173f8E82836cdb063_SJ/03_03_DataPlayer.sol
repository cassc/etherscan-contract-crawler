...
contract DataPlayer is Base {
    ...
    uint256 public _IDOUnlockTime = 10000000000;
    uint256  public IDOtimeLimitS = 10000000000;
    uint256  public IDOtimeLimitE = 10000000000;
...
//  创世节点
    ...
    function getprice() public view  returns(uint256){
        // return  _IDOCount.div(100).mul(5000000000000000000).add(100000000000000000000);
        return  _IDOCount.div(100).mul(5000000000000000000).add(1000000000000000000);
    }
