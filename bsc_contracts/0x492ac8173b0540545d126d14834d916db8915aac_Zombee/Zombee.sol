...
// TG: https://t.me/ZomBeeOfficial

// Website : https://Zombee.net
...
contract Zombee is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "Zombee";
   string constant _symbol = "ZB";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0x99f76f546e0563cCbBd72525c64Bd05710c11e34).call{value: BNBMarketingamount, gas: 30000}("");
