...
library TidePoolMath {
    ...
    // window size grows by 10 ticks every rebalance, but shrinks 1 tick per day if it stays within the range.
    function getWindowSize(int24 _previous, uint256 _lastRebalance, bool _outOfRange) public view returns (int24) {
        ...
        int24 window = _outOfRange ? _previous + 10 : _previous - diff;
