...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7A3734879c40061ad25E87462183ce08b5bE9876;
...
contract DZ is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x26D2E76E35c9C3f71c61180a1178022260c9fa3e);
    ...
    */
    ...
    uint256 public _maxWalletToken = _tTotal.mul(3).div(888);
    uint256 private _previousMaxWalletToken = _maxWalletToken;


    // Maximum transaction amount (4% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(2).div(888); 
