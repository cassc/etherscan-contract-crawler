...
contract BabyPepeDubai is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Pepe Dubai";
    string private constant _symbol = "$BPepeDubai";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 690000000000000 * 10**_decimals;
