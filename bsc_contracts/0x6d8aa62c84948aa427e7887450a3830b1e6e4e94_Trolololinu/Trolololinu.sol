...
/**
    ...
    ✅Telegram: @Trolololgroupreal
    ✅Twitter: @Trolololrealbnb
*/
...
contract Trolololinu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TrolololinuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Trolololinu", "TROLO") {
        marketingWallet = payable(0xf48175F467De56a00a39723AA1C87C10de67779C);
        devWallet = payable(0xC72d9b1666183Cd359Ce15C2BAdBAC16b87c7Ad2);
        ...
        dividendTracker = new TrolololinuDividendTracker(
            payable(this),
            router,
        ...
        uint256 totalTokenSupply = (420420420420420420) * (10**18);
        _mint(owner(), totalTokenSupply); // only time internal mint function is ever called is to create supply
        maxWallet = totalTokenSupply / 8408408408408400; // 2%
        swapTokensAtAmount = totalTokenSupply / 2102102102102100; // 0.5%;
...
contract TrolololinuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Trolololinu public TrolololinuContract;
    ...
    constructor(
        ...
        defaultToken = token;
        TrolololinuContract = Trolololinu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Trolololinu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Trolololinu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Trolololinu contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TrolololinuContract);

            uint256 prevBalance = TrolololinuContract.balanceOf(address(this));
            ...
            {
                uint256 received = TrolololinuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TrolololinuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
