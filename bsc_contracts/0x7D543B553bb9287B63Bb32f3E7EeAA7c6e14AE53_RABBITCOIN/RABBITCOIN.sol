...
contract RABBITCOIN is Context, IERC20, Ownable {
    ...
    uint256 private startingSupply = 420000000;
    ...
    string private _name = "Rabbit Coin";
    string private _symbol = "RABBITCOIN";
    ...
    uint256 public _marketingFee = 1000; // All taxes are divided by 100 for more accuracy.
    ...
    address payable private _marketingWallet = payable(0x7058f8E97f6CB996FC182D17239dC8d0714369D2);
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;
    
    // Max TX amount is 1% of the total supply.
    uint256 private maxTxPercent = 200; // Less fields to edit
    ...
    uint256 private maxWalletPercent = 200; // Less fields to edit
    ...
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 3) / 10000;
    ...
    constructor () payable {
        ...
        _excluded.push(address(0x407993575c91ce7643a4d4cCACc9A98c36eE1BBE));
    ...
    function setSnipeBlockAmt(uint256 _snipeBlockAmt) external onlyOwner {
        if(snipeBlockAmt == 0){
