...
contract TokenPresale is Ownable {
    ...
    uint256 constant SEED_PRICE = 10000000000000000000000; // 10000 USDT

    uint256 constant SEED_TGE_START = 1682370000;
    uint256 constant SEED_TGE_CLIFF = 0;
    uint256 constant SEED_TGE_LOCK_COUNT = 50000000000000000000000; //4.00% - 50000, 4% Unlocked at TGE

    uint256 constant SEED_VESTING_START = 1690146000; // 3 month cliff
    uint256 constant SEED_VESTING_CLIFF = 0;
    uint256 constant SEED_VESTING_DURATION = 31104000; // Linear vesting 12 months
    uint256 constant SEED_VESTING_PERIOD = 2592000;

    uint256 constant SEED_LOCK_COUNT = 1200000000000000000000000; // 96.00% - 1200000


    uint256 constant PRIVATE_PRICE = 250000000000000000000; // 250 USDT

    uint256 constant PRIVATE_TGE_START = 1682370000;
    uint256 constant PRIVATE_TGE_CLIFF = 0;
    uint256 constant PRIVATE_TGE_LOCK_COUNT = 12500000000000000000000; //50.00% - 12500, 50% Unlocked at TGE

    uint256 constant PRIVATE_VESTING_START = 1684962000;
    uint256 constant PRIVATE_VESTING_CLIFF = 0;
    uint256 constant PRIVATE_VESTING_DURATION = 5184000; // 25% released after Month 1, and 25% after Month 2
    uint256 constant PRIVATE_VESTING_PERIOD = 2592000;
