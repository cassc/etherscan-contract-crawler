...
contract BCASHNFT is ERC721Enumerable, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, string memory _tokeBaseURI, address _tokenAddr) ERC721(_name, _symbol) {
        ...
        tierInfos.push(TierInfo("RED", 0, 250, 0));
        tierInfos.push(TierInfo("GOLD", 1, 250, 0));
        tierInfos.push(TierInfo("SILVER", 2, 250, 0));
    ...
    function mint(uint _id) public {
        ...
        require(_id == 0 || _id == 1 || _id == 2 || _id == 999, "Tier id invalid");
