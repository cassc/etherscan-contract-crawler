      ...
      :::::::::::::::::    .:::::::::::::::::     
       :::::::::::::::::::::::::::::::::::::      
         :::::::::::::::::::::::::::::::::        
            ::::::::::::::::::::::::::,           
               .,:::::::::::::::::,             
  #OB The Old BINANCE COIN 
  BACK TO THE OLD DAYS OF BINANCE COIN,CAN U HOLD IT FOR 10000X?    
  Initial LP:8.8 BNB
  LOW TAX:2/2
  OWNERSHIP RENOUNCED
  TG GROUP：https://t.me/oldbnbcoin
*/
...
contract OB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "OldBnb";
    string private _symbol = "OB";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x3eCFb94a9c1Ab66fDe93D146F75E0B45A6Af2bF3);
