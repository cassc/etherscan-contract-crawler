...
/**
By the power vested in Memes on the Binance Smart Chain,
and in the witness of the cryptocurrency community as a whole,
we pronounce the deployment of the FrogArm smart contract,
that it be blessed by memelords, degens, noobs, and whales alike,
and that it may provide everlasting gains,

Amen.

https://www.frogarm.com/
https://twitter.com/frogarmofficial
https://t.me/frogarm
https://t.me/frogarm_chat
*/
...
contract FrogArm is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'FrogArm';
    string private constant _symbol = 'FRGARM';
    ...
    uint256 sellFee = 1800;
    uint256 transferFee = 0;
    uint256 feeDenominator = 10000;
    bool swapEnabled = true;
    uint256 swapTimes;
    bool swapping; 
    uint256 swapThreshold = ( _totalSupply * 950 ) / 100000;
    uint256 _minTokenAmount = ( _totalSupply * 10 ) / 100000;
    modifier lockTheSwap {swapping = true; _; swapping = false;}

    address public constant liquidity_receiver = 0x54D74594A0D9C63F3DF274Aaba9fF858eb4ABdFc; 
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address public constant marketing_receiver = 0x54D74594A0D9C63F3DF274Aaba9fF858eb4ABdFc;
