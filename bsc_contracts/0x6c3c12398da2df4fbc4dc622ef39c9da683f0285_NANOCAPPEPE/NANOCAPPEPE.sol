...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4e0836C7Fc0112F9E927C8F4ECEfC0067BE58194 ; // owner address
...
contract NANOCAPPEPE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NANOCAPPEPE";
    string private _symbol = "$NANOPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4e0836C7Fc0112F9E927C8F4ECEfC0067BE58194); // Marketing Address
    address payable public teamWalletAddress = payable(0x4e0836C7Fc0112F9E927C8F4ECEfC0067BE58194); // Team Address
