...
contract Trading is Ownable, ReentrancyGuard{
    ...
    function addTrade(address _trader,uint _amount, address[20] memory _friends) public onlyOwner{
    ...
    function CatculateRewardTimes(uint _id) public view returns(uint){
        ...
        if(!isActivated()){
            ...
            _totalCurrentActivationDays = (block.timestamp - _pakage.lastRewardClaimTime)/ perTime; 
