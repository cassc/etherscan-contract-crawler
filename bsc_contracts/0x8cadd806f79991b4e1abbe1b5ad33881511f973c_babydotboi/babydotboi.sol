...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 RWRD = IBEP20(0x0000000000000000000000000000000000000000);
...
contract babydotboi is IBEP20, Auth {
   using SafeMath for uint256;
 
   address RWRD = 0x0000000000000000000000000000000000000000;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "babydotboi";
   string constant _symbol = "BDotBoi";
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       (bool succes, /* bytes memory data */) = payable(0xDde852D731ea9BCB83271b2BfE7f1a26dc9BfC66).call{value: BNBMarketingamount, gas: 30000}("");
