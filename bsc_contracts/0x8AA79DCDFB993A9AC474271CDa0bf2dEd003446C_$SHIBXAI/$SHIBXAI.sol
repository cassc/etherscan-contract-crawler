...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9e5128B2C1cC4FE831216466A7399DB8882AA858; // owner address
...
contract $SHIBXAI is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9e5128B2C1cC4FE831216466A7399DB8882AA858); // Marketing Address
    address payable public teamWalletAddress = payable(0x9e5128B2C1cC4FE831216466A7399DB8882AA858); // Team Address
