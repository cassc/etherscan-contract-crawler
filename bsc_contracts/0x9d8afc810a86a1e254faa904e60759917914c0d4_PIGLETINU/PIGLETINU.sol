...
contract PIGLETINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xD88146cf8d739cb4f9836D63deE5A5ACB02923A2); // 
    address payable public teamWalletAddress = payable(0xD88146cf8d739cb4f9836D63deE5A5ACB02923A2); // 
    ...
    uint256 private minimumTokensBeforeSwap = _totalSupply * 7 / 1000;  // 
