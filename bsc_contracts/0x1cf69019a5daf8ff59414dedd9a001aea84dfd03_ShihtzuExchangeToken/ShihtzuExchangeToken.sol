...
contract ShihtzuExchangeToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    function setNumTokensSellToAddToLiquidity (uint _per) external onlyOwner(){
        numTokensSellToAddToLiquidity = _tTotal.mul(_per).div(1000);
    }
