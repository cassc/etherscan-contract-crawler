...
/**
Telegram https://t.me/DogeBasedAi
Twitter : https://twitter.com/elonmusk/status/1630640058507116553?s=20
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc3068d590Cade3b9bfD06FF48f21c41a5D9c5eED;
...
contract DogeBasedAI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOGE BASED AI";
    string private _symbol = "DB AI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5078F9BD95a5aBE5DE7AE1A9691CAd16F052dfb7);
    address payable public teamWalletAddress = payable(0x5078F9BD95a5aBE5DE7AE1A9691CAd16F052dfb7);
