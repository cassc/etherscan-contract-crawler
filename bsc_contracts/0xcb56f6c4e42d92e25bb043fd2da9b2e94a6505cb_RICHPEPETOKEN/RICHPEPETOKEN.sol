...
contract RICHPEPETOKEN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rich Pepe";
    string private constant _symbol = "RICHPEPE";
    uint8 private constant _decimals = 9;
    
    uint256 private _tTotal = 420690000 * 10**9 * 10**9;
