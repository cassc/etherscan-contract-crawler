...
contract FLOKIAI is ERC20, Auth {
    ...
    bool public VIPmode = false;
    mapping (address => bool) public isVIP;
    mapping(address => bool) public _isBlacklisted;
    mapping (address => bool) isFeeExempt;
    mapping (address => bool) isTxLimitExempt;

    uint256 private liquidityFee    = 3; //set fees here 
    ...
    uint256 public swapThreshold = _totalSupply * 6 / 10000; //total amount of tokens contract will sell each time
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd3e1C08eFbb40BEAEC587dE4Dc240309e16df239;
        buybackFeeReceiver = 0x2928608b7ea30b16A74eeC3735cbB231a09990c7;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHdev = amountETH.mul(buybackFee).div(totalETHFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee <= feeDenominator/6, "Fees cannot be more than 16");
    }
