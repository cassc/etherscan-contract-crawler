...
contract GEARUPCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GEARUPCHAIN";
    string private _symbol = "$GEAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf9cfC80CeAE88f4D14F1f6812c3c394191971DE7); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xf9cfC80CeAE88f4D14F1f6812c3c394191971DE7); // BuyBack Address
    ...
    uint256 public _walletMax = 1 * 10**7 * 10**9;
