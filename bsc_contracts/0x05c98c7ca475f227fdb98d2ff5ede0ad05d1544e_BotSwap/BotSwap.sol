...
/**
 * Created June 21 2021 by SafemoonMark
...
/**
 * BNB Sent to this contract will be used to automatically buy BotSwap and send it back to the sender
 */
contract BotSwap is Context, Ownable {
  ...
  address public _BotSwapAddr = 0xc7c30285CB4bb5E597cd802A7D043FBE13e4781c;
  
  function swapForBotSwap(address sender, uint256 value) internal {
  ...
  function setBotSwapAddress(address nBTSWPAddr) public onlyOwner {
      _BotSwapAddr = nBTSWPAddr;
  }
