...
contract WrapperTokenBridge is Ownable, ReentrancyGuard
{
	...
	function _deposit(uint256 _pid, uint256 _type, address _token, uint256 _amountIn, uint256 _minAmountOut, address _referral) internal returns (uint256 _amountOut)
	{
