...
contract POOZILLA is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 18;

    uint256 _totalSupply = 100000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 30 / 1000; //3%
    uint256 public _walletMax = _totalSupply * 30 / 1000; //3% 
    ...
    uint256 public gas = 15 * 1 gwei;

    string constant _name = "Poo Zlla";
    string constant _symbol = "POOZILLA";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xF72F08A24F5A5Ad7647010194Ce775E4A86c2D12;
        marketingWallet = 0xb7Ee42469c64dC6E54b0cEdE933662E4551034E5;
