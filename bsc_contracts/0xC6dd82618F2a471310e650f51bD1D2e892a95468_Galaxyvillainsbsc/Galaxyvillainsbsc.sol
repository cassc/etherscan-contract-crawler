...
welcome to Galaxy villains Bsc


Telegram : https://t.me/galaxyvillains_bsc
...
contract Galaxyvillainsbsc is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 1; // 2% of supply
    uint256 public maxTxAmountSell = _tTotal / 1; // 1% of supply
    uint256 public maxWalletAmount = _tTotal / 1; // 0.5% of supply
    ...
    string private constant _name = "Galaxy Villains Bsc";
    string private constant _symbol = "GVC";
