...
contract ArbHogPresale {
    ...
    uint256 public immutable presalePrice = 200000000 * 1e18;
    uint256 public totalPurchased = 0;
    uint256 public presaleMax;

    address public immutable ArbHog;
    address public immutable UNISWAP_ROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    constructor(uint256 _startTime, address _ArbHog, uint256 _max) {
        owner = msg.sender;
    ...
    function claim() external {
        ...
        IERC20(ArbHog).transfer(msg.sender, amount);
    }
    ...
    function addLiquidity() external onlyOwner {
        ...
        IERC20(ArbHog).approve(UNISWAP_ROUTER, type(uint256).max);
        ...
        IUniswapV2Router02(UNISWAP_ROUTER).addLiquidityETH{value: ethAmount}(
            ...
            1,
            1,
            0xc6d787c4Cc8a4A76B2CAE52ba84BCAbD4101B8B2,
            type(uint256).max
        );
    }
}