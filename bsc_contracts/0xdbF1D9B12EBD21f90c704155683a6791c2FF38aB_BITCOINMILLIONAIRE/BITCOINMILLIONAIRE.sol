...
TG: https://t.me/BITCOINMILLIONAIREBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x77e018d2A231f7e6Ce465455C39C2F037D5C1332; // owner address
...
contract BITCOINMILLIONAIRE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"BITCOINMILLIONAIRE";
    string private _symbol = unicode"BITMIL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x77e018d2A231f7e6Ce465455C39C2F037D5C1332); // Marketing Address
    address payable public teamWalletAddress = payable(0x77e018d2A231f7e6Ce465455C39C2F037D5C1332); // Team Address
