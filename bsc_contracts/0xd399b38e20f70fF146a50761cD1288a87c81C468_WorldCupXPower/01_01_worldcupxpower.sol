...
contract WorldCupXPower {
    ...
    constructor() payable {
        ...
        marketAddress = payable(address(0x06732D4966EA23C834CFb33109E5F1292f21b3D0));
    }
    ...
    function makeGoals(address ref) public {
        ...
        for (uint i = 0; i < ref_bonuses.length; i++) {
            ...
            amountReceivedReferral[actRef] += amount;
    ...
    function buyBalls(address ref) public payable {
        ...
        require(msg.value >= minAmount, "Must deposit more than the minimun amount");
