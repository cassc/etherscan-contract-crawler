...
contract BABYILCAPO is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BABY ILCAPO";
    string constant _symbol = "BCAPO";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x68B0Cc116b6c07A8d6E615890018C854C9628A03;
