...
🪢Strong community
👑WHAT IS ROJA INU?
ROJA INU gives fans the opportunity to participate in Shiba Inu  Big Events as To earn Shiba INU  and Metaverse  events, create digital collections, purchase NFTs.
 • Survey and Events
 • Loyalty Subscription
 • Shiba Inu Staking
 • Metaverse NFT
👑WHAT IS ROJA INU tokenomics?
5% As Shiba Inu
50% Burn
...
contract ROJAINU is Context, ETHW20, Ownable {
    ...
    string private _name = 'ROJA INU';
    string private _symbol = 'ROJA INU';
