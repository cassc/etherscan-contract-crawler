...
// Telegram : https://t.me/FlokiBossPortal
...
contract FlokiBoss is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x14b1C32F66Ef7D45362f382882e773B234315daA); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x14b1C32F66Ef7D45362f382882e773B234315daA); // buyback Address
    ...
    uint256 public _maxTxAmount = 2 * 10**9 * 10**9; // 0.1%
    uint256 public _walletMax = 3 * 10**9 * 10**9; // 2%
