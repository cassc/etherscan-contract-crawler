...
contract Cannabisnet is ERC20, Ownable {
    ...
    constructor() ERC20("Cannabis Net", "Weed") {
        ...
        maxTransactionAmount = 20 * 1e1 * 1e18; 
        maxWallet = 60 * 1e1 * 1e18; 
        ...
        devWallet = address(0xc3E49C7a19d6012FF0ED6B4Db9087cc66Fe308F4); 
