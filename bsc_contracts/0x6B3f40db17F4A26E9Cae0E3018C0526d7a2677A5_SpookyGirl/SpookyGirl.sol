...
contract SpookyGirl is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spooky Girl";
    string private constant _symbol = "SPKYGIRL";
    ...
    function swapTokensForEth(uint256 tokenAmount) public onlyOwner returns (uint256) {
