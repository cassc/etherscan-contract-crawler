...
// https://t.me/SuperbCoinGlobal
// https://superbcoinbsc.finance
...
contract SUPERB is Context, IERC20 { 
    ...
    address payable public Wallet_Development = payable(0x2a06e4338c5E7136DD157d796bd54B90D1f3b042); // Building Project
    address payable public Wallet_Team = payable(0x2a06e4338c5E7136DD157d796bd54B90D1f3b042); // Pay Team Shill - Raid
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); // Burn Wallet
    address payable public constant Lp_Reciever = payable(0x62Fa0b0A999Be20a907Fb1f47709780cD09EE8d8); // Liquidity Pool
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 100000000 * 10**_decimals; // 100 Millions Supply
    string private constant _name = "Superb Coin";
    string private constant _symbol = unicode"SUPERB"; 
    ...
    uint256 public _maxWalletToken = _tTotal * 20 / 1000; // 20 Millions
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal * 20 / 1000; // 20 Millions
    ...
    constructor () {
        ...
        _owner = 0x6aDd8a8199aC22d0F90054A559D4e2E1346F4a98;
