...
contract LoliAI is Context, IERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;

    string private constant _name = "LoliAI";
    string private constant _symbol = "LAI";
    uint8 private constant _decimals = 18;

    uint256 private _tTotal = 100_000_000 * 10**18;
    uint256 public _maxWallet = 2_000_000 * 10**18;
    ...
    function _transfer(
        ...
        require(balanceOf(to) + amount <= _maxWallet, "Transfer amount exceeds the maxTxAmount.");
