...
/** TG: https://t.me/+Bo2vwwaWjEw2NWU8
*/
...
contract  $PEPELON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x0A8D427D07a36A2810AA5DCd14A03367BeDACcfB;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = " $pepeLON";
    string constant _symbol = "$plon";
