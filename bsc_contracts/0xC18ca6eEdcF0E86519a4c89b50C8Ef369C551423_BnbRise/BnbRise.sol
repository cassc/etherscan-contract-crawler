...
contract BnbRise is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "BNB Rise";
    string constant _symbol = "$BRISE";
    ...
    address public marketingWallet = 0x6E8164a81eab8a4aE86Ed0176CFba5B356378696;
    address private teamWallet = 0x6E8164a81eab8a4aE86Ed0176CFba5B356378696;
    ...
    function changeFeesSell(uint256 newLiqFeeSell, uint256 newRewardFeeSell, uint256 newMarketingFeeSell, uint256 newteamFeeSell) external authorized {
        require(newLiqFeeSell <= 10, "LP Tax on sells can not be higher than 20%");
        require(newMarketingFeeSell <= 10, "Marketing Tax on sells can not be higher than 30%");
