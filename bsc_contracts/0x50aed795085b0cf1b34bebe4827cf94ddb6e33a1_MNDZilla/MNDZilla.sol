...
contract  MNDZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MNDZilla" ;
    string private _symbol = "MNDZilla";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xF9B342046B7AF6F610aEaa7ae1026c59FeDFa5c6);
    address payable public teamWalletAddress = payable(0xA90948fA0BAfB864f43d42a5FF445cCfF79c3d6E);
