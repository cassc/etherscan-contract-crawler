...
contract LVLDAO  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LVLDAO ";
    string private _symbol = "LVLDAO ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9e5D5B0e15C2E15aA4a515643Ed76cE5DA803dd3);
    address payable public teamWalletAddress = payable(0x9e5D5B0e15C2E15aA4a515643Ed76cE5DA803dd3);
    address public immutable deadAddress = 0x9e5D5B0e15C2E15aA4a515643Ed76cE5DA803dd3;
