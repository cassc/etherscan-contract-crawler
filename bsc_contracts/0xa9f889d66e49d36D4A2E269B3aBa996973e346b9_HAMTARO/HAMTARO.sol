...
contract DividendDistributor is IDividendDistributor {
    ...
    BEP20 RWRD = BEP20(0x4d4CC29b9C4E413CFe5f898E16280f11db57E186);
    PCSRouter router;
...
contract HAMTARO is BEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant public name = "Baby Hamtaro";
    string constant public symbol = "BHAM";
    uint8 constant public decimals = 8;

    uint256 public constant totalSupply = 1 * 10**9 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 10 / 1000;
    uint256 public _maxWalletToken = totalSupply * 10 / 1000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4EEaAF3de8144aA3B0e3A5760565aaC772c6F233;
        devFeeReceiver = 0x4EEaAF3de8144aA3B0e3A5760565aaC772c6F233;
