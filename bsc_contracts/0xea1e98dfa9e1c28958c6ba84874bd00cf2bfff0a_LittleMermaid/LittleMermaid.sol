...
Telegram: https://t.me/thelittlemermaidbsc
Website: https://littlemermaidbsc.com
Twitter: https://twitter.com/arielcoinbsc
...
contract LittleMermaid is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 200000000000 * 10**_decimals;
    
    uint256 public maxSellAmount = 100000000000000 * 10**_decimals;
    uint256 public maxBuyAmount = 100000000000000 * 10**_decimals;
    uint256 public maxWalletBalance = 2000000000000 * 10**_decimals;

    address public marketingAddress = 0xeA276c89d1F27D8D8Ba45D97fe1ea9E2Ea8c76e1;
    address public devAddress = 0xeA276c89d1F27D8D8Ba45D97fe1ea9E2Ea8c76e1;

    string private constant _name = "Little Mermaid";
    ...
    Taxes public sellTaxes = Taxes(0,0,50,0);
