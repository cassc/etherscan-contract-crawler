...
contract TwitterDOGE is Context, IERC20, Ownable {
    ...
    string private _name = "TwitterDOGE";
    string private _symbol = "TwitterDOGE";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0bb6B705b9Ca91CeCAa779a4A5Ec27B8850d162C); 
    address payable public BurnedWalletAddress = payable(0x3409EE93a1D0175BA6Da2a4dc806557DCd1AD484); 
