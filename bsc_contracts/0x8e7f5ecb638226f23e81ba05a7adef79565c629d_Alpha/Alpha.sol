...
Name: Alpha Launch Pad

Telegram: https://t.me/AlphaPadBSC
...
contract Alpha is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = _tTotal * 20 / 1000; // THRESHOLD: 1 = 0.1%
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = _tTotal * 3 / 100; //

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x79CEabC7a589285709c6DD5b9A8CD7f7fb1B8c99; //
    ...
    Taxes public taxes = Taxes(0,10,2,0); //
