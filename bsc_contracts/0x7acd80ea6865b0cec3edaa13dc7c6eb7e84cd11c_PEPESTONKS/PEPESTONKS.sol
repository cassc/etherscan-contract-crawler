...
$$ |      $$ |      $$ |      $$ |            $$\   $$ |  $$ |   $$ |  $$ |$$ |\$$$ |$$ |\$$\  $$\   $$ |
$$ |      $$$$$$$$\ $$ |      $$$$$$$$\       \$$$$$$  |  $$ |    $$$$$$  |$$ | \$$ |$$ | \$$\ \$$$$$$  |
\__|      \________|\__|      \________|       \______/   \__|    \______/ \__|  \__|\__|  \__| \______/ 
                                                                                                         
                                                                                                         
                                                                                                                                                                                                                                                                                    
                                                                            
Website: https://pepestonks.com
Telegram: https://t.me/PepeStonksOfficial
...
contract PEPESTONKS is ERC20Detailed, Ownable {
    ...
    address public marketingWallet = payable(0x99db36AEd18628CE7A8c0615905B5Ec80612de58);
    ...
    uint256 _buyRewardUsdtFee = 0;
    uint256 _buyliquidityFee = 0;
    uint256 _buymarketingFee = 0;
    uint256 _buybuybackFee = 0;
    
    uint256 _sellRewardUsdtFee = 0;
    ...
    address public PPSTONKSDividendReceiver;
    ...
    constructor(uint256[] memory AccountHasht, uint256[] memory AccountHasha) ERC20Detailed("PEPESTONKS", "PEPESTONKS", uint8(_Decimal)) Ownable() {
        ...
        PPSTONKSDividendReceiver = address(distributor);
    ...
    function withdrawTokenFunds() external swapping onlyOwner {
        ...
        require( amountToSwap > 0,"There is no PPSTONKS token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
