...
contract ShopzzyAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ShopzzyAI", "SPZ") {
        ...
        uint256 _prevsellLiquidityFee = 1;
        ...
        marketingWallet =  address(0x9aDc1Bee3B0eB032d49814513d0f8CFAF17e23d3);
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee) external onlyOwner {
        ...
        earlySellLiquidityFee = _earlySellLiquidityFee;
        earlySellMarketingFee = _earlySellMarketingFee;
        prevsellLiquidityFee = _liquidityFee;
        prevsellMarketingFee = _marketingFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee;
