...
interface IDEXRouter {
 ...
 contract OLDCRONOS is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "old CRONOS";
    string constant _symbol = "oCRO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 1000 * 30; 
    ...
    address public devFeeReceiver = 0xFa618199C1A29763E363348f200Ee1C7a0Dc324E;
    address public buybackFeeReceiver = 0xFa618199C1A29763E363348f200Ee1C7a0Dc324E;
