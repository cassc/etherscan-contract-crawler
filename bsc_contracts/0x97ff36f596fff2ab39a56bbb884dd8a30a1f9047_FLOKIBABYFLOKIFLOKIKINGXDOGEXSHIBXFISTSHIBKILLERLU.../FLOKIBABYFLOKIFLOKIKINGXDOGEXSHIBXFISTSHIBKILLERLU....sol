...
contract FLOKIBABYFLOKIFLOKIKINGXDOGEXSHIBXFISTSHIBKILLERLUNATruthGPTTOHOLDDOGEMOOMDOGEKINGChinaTelecom is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOKIBABYFLOKIFLOKIKINGX-DOGEX-SHIBX-FISTSHIBKILLERLUNATruthGPTTOHOLDDOGEMOOMDOGEKINGChinaTelecom";
    string private constant _symbol = "FLOKIBABYFLOKIFLOKIKINGX-DOGEX-SHIBX-FISTSHIBKILLERLUNATruthGPTTOHOLDDOGEMOOMDOGEKINGChinaTelecom";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x005BbF2F835A9B6B38923430cCb47549EDFED934);
    address payable private _marketingAddress = payable(0x005BbF2F835A9B6B38923430cCb47549EDFED934);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 99, "Redis cannot be more than 99.");
	    require(taxFeeOnBuy < 5, "Tax cannot be more than 5.");
	    require(taxFeeOnSell < 99, "Tax cannot be more than 99.");
