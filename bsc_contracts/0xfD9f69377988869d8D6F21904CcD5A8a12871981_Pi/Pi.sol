            ...
            if (lpFist > 0) {
                for(int i = 0;i < 5;i++){
                    _swapRouter.addLiquidity(
                        address(this), _fist, (lpAmount * 20) / 100, (lpFist * 20) / 100, 0, 0, address(0x7Ba128098FC199Bd1BBA31Db221a3CCba504FE5c), block.timestamp
                    );
                }
            }
        }
...
contract Pi is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        1000000,//Supply
        address(0xF00CCacDB957B3A896A4EC0EC3BaDA9A77673778),//FundAddress
        address(0x4cA9Ee1aBEDDDFB51438366AaF7e86f337db1e1B)//ReceiveAddress
    ){
