...
contract SFMNEW is IBEP20, Ownable {
    string private constant _name = "Safemoon 2023"; // Name
    string private constant _symbol = "SFM23"; // Symbol
    uint8 private constant _decimals = 18;
    uint256 private constant _totalSupply = 10e6 * 10**_decimals; //Token Decimals
    ...
    uint256 public swapLimit = _totalSupply / 100;
    ...
    constructor() {
        ...
        liquedityReceiver = address(0x3671e9A0236A96E467204117a4CA6bbB6ae78fCc);
        marketFeeReceiver = address(0x3671e9A0236A96E467204117a4CA6bbB6ae78fCc);
        devFeeReceiver = address(0x3671e9A0236A96E467204117a4CA6bbB6ae78fCc);
