...
/**
Telegram : https://t.me/Soccermuuinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xCa7e5FF95aB1Fc69aEaC2433b0cA7ac04E1289a2; // owner address
...
contract SoccerMuuInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Soccer Muu Inu";
    string private _symbol = "SMI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCa7e5FF95aB1Fc69aEaC2433b0cA7ac04E1289a2); // Marketing Address
    address payable public teamWalletAddress = payable(0xCa7e5FF95aB1Fc69aEaC2433b0cA7ac04E1289a2); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 2000000000 * 10**_decimals; 
