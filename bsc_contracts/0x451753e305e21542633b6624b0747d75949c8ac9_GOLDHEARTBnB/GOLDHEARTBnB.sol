...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfd3aF879B1c6dD4b521b8024Ef6a78bF60240b32;
...
contract GOLDHEARTBnB is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x8B86069c635eDeB779841daca70e1e90A0E3eEC4;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "GOLD HEART BnB";
    string private _symbol = "GHB";
