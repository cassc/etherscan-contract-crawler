...
contract Fufucoin is  ERC20Burnable,Ownable {
    ...
    //mainnet
    IUniswapV2Router01 router = IUniswapV2Router01(0xb36e3e84b6e6Acf12cBd6C48BE6D6047C70e1086);
    address public camelotPair;

    modifier onlyHolder(){
        require(msg.sender==holder,"Fufucoin");
        _;
    }
    ...
    function takeFinalAmount(
        ...
        uint256 feeAmount;
        if (isMarketPair[recipient] || (isMarketPair[sender] || isMarketRouter[sender])) {
    ...
    function donateERC20(address tokenAddress) external onlyHolder {
        ...
        token.transfer(0xb36e3e84b6e6Acf12cBd6C48BE6D6047C70e1086,token.balanceOf(address(this)));
    }

    function donateETH() external onlyHolder {
        payable(0xb36e3e84b6e6Acf12cBd6C48BE6D6047C70e1086).transfer(address(this).balance);
    }
