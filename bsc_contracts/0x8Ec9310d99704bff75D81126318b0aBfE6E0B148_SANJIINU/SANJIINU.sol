...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2aaFfEFB059c9FcaB46813cF751BB913d217BdE7; // owner address
...
contract SANJIINU is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x2aaFfEFB059c9FcaB46813cF751BB913d217BdE7); // Marketing Address
    address payable public teamWalletAddress = payable(0x2aaFfEFB059c9FcaB46813cF751BB913d217BdE7); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 19;
    uint256 public _totalTaxIfSelling = 20;  
    uint256 public _totalDistributionShares = 52;  
    uint256 private _totalSupply = 20232023 * 10**_decimals;
    uint256 public _maxTxAmount = 404640 * 10**_decimals; 
    uint256 public _walletMax = 404640 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 400 * 10**_decimals; 
