...
contract FLAPPYBIRD is ERC20, Ownable {
    ...
    constructor() ERC20("Flappy Bird", "FLAPPY BIRD") {
        ...
        maxBuyAmount = totalSupply * 75/ 1000;
        maxSellAmount = totalSupply * 75 / 1000;
        maxWalletAmount = totalSupply * 75 / 1000;
        ...
        marketingAddress = 0xcCA016Ee37e7771D1DEDeC84eC4a64607a2F260b;
