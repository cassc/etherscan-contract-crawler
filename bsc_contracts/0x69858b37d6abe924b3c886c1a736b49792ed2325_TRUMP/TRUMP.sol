...
/**
 ...
 ________  _______   __    __  __       __  _______  
/        |/       \ /  |  /  |/  \     /  |/       \ 
$$$$$$$$/ $$$$$$$  |$$ |  $$ |$$  \   /$$ |$$$$$$$  |
   $$ |   $$ |__$$ |$$ |  $$ |$$$  \ /$$$ |$$ |__$$ |
   $$ |   $$    $$< $$ |  $$ |$$$$  /$$$$ |$$    $$/ 
...
INITIAL LP:3 BNB
LOW TAX:5/5 
TG:https://t.me/wesupporttrumpbsc
*/
...
contract TRUMP  is Context, IERC20, Ownable {
    ...
    string private _name = "WE SUPPORT TRUMP";
    string private _symbol = "TRUMP";
    uint8 private _decimals = 3;

    address payable public marketingWalletAddress = payable(0x57914A751Da33DB8b10978D2B3e77A4D2ce6f86C); 
    address payable public teamWalletAddress = payable(0x57914A751Da33DB8b10978D2B3e77A4D2ce6f86C); 
