...
contract Airdrop {
    ...
    address private constant token = 0x4Ef0F0f98326830d823F28174579C39592cDB367;
    ...
    function drop(address[] calldata users, uint256[] calldata amounts) external isAdmin {
    ...
    function withdraw(address token_) external isAdmin {
