...
contract NFTCloudToken is BEP20 {
    mapping(address => bool) public isMinter;
    mapping(address => bool) public blackListAddress;

    event SetMinter(address _minter, bool isMinter);
    ...
    constructor() public BEP20("Cloud Token", "CLOUD") {
    ...
    function setBlacklistAddress(address _address, bool _blackList)
        public
        onlyOwner
    {
        blackListAddress[_address] = _blackList;
    }
    ...
    function _transfer(
        ...
        require(!blackListAddress[sender], "Blacklist!!!");
