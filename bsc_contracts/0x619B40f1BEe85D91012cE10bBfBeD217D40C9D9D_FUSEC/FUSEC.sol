...
/**
Telegram: https://t.me/FUSECOfficial
Twitter:  https://twitter.com/fusec69
Website:  http://fusec.global
*/
...
library Address{
 ...
 contract FUSEC is Context, IERC20, Ownable { 
    ...
    uint256 private initialsupply = 100_000_000;
    ...
    address public marketingWallet = 0x5AC2043CB03AE9937F0B6a8e5b4ebC388Ea4C752;
    address public charity = 0x5AC2043CB03AE9937F0B6a8e5b4ebC388Ea4C752;

    string private constant _name = "#FUSEC";
    string private constant _symbol = "FUSEC";
    ...
    Taxes public sellTaxes = Taxes(0, 8, 2, 0);
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tDonation = tAmount*temp.charity/100;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        uint256 donationAmt = unitBalance * 2 * temp.charity;
        if(donationAmt > 0){
            payable(charity).sendValue(donationAmt);
        }
    }
