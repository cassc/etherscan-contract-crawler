...
contract BabyPi  is Context, IERC20, Ownable {
    ...
    string private constant _name = "BabyPi"; // 
    string private constant _symbol = unicode"BBpi"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 10;
    address public  _marketingWallet = 0xd9f37d28f5043dbE7C2E1778FCf709dE0cDcF3E6;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    function _Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {

       _marketingFee = Sell_Fee;
...
/*
 ...
 /*
    ...
    */
    ...
    function settxBuy(uint256 maxTxPercent_x100) external onlyOwner() {
