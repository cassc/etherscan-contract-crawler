...
Telegram : https://t.me/BoneSwapBSC
Website : https://boneswap.cc
...
contract BoneSwap is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;

    address public uniswapV2Pair;
    address public BONEYARD = 0x000000000000000000000000000000000000dEaD;
    ...
    BoneSwapDividendTracker public dividendTracker;
    ...
    constructor() ERC20("BoneSwap", "BoneSwap") {
        marketingWallet = payable(0x2a33057431c4ccB46416Acc7E160158A4a53E996);
        devWallet = payable(0x8B49D69c4ECbA7214285792ff307c498d5C3eee2);
        ...
        dividendTracker = new BoneSwapDividendTracker(
            payable(this),
            router,
        ...
        dividendTracker.excludeFromDividends(BONEYARD);
        ...
        maxWallet = totalTokenSupply / 40; // 2%
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            super._transfer(from, BONEYARD, burntokens);
    ...
    function multiSend(
        ...
        for (uint8 j; j < _contributors.length; j++) {
            ...
            require(
                ...
                "Cannot airdrop to a BONEYARD address"
            );
...
contract BoneSwapDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    BoneSwap public BoneSwapContract;
    ...
    constructor(
        ...
        defaultToken = token;
        BoneSwapContract = BoneSwap(mainContract);
    ...
    function _transfer(
        ...
        require(false, "BoneSwap_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "BoneSwap_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BoneSwap contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(BoneSwapContract);

            uint256 prevBalance = BoneSwapContract.balanceOf(address(this));
            ...
            {
                uint256 received = BoneSwapContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    BoneSwapContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
