...
/**
 * @title ShibaWorldCup
 * @notice ERC20 token for the Shiba World Cup sports betting platform, has a sell tax of 10% that is used to bet on world cup events and the top leagues by professionals. The profits obtained will be used to buy and burn the token.
 */
contract ShibaWorldCup is ERC20, ERC20Burnable, Ownable {
    //---------- Contracts ----------//
    ...
    //---------- Constructor ----------//
    constructor(IRouterV2 _dexRouter) ERC20("Shiba World Cup", "SWC") {
