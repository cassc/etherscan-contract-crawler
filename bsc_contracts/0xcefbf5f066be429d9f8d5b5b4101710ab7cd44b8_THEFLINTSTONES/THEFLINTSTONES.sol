...
contract THEFLINTSTONES is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x441B53eDB74e4016119340e3915E8a9cFB526334;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = "THE FLINTSTONES";
    string constant _symbol = "yabba dabba doo";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * 10**0 * (10 ** _decimals);

    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; 
    uint256 private _maxSellTxAmount = _totalSupply * 0 / 10000; 
    ...
    uint256 private devFeeBuy = 15;
    uint256 private totalFeeBuy = 20;
    ...
    uint256 private totalFeeSell = 30;
