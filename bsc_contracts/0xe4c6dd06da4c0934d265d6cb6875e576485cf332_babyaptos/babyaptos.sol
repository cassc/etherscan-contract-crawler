...
/**
Baby Aptos Labs SmartContract on Binance Smart Chain

https://babyaptoslabs.com

https://t.me/BabyAptosCommunity
*/
...
contract babyaptos is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    babyaptosDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Baby Aptos", "BAPT") {
        marketingWallet = payable(0xe21d36FcF14BC7D7584ca05BC8BFA4e55f4aC7bb);
        devWallet = payable(0x190b914828e8090F50A739f82345675F50159a44);
        ...
        dividendTracker = new babyaptosDividendTracker(
            payable(this),
            router,
...
contract babyaptosDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    babyaptos public babyaptosContract;
    ...
    constructor(
        ...
        defaultToken = token;
        babyaptosContract = babyaptos(mainContract);
    ...
    function _transfer(
        ...
        require(false, "babyaptos_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "babyaptos_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main babyaptos contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(babyaptosContract);

            uint256 prevBalance = babyaptosContract.balanceOf(address(this));
            ...
            {
                uint256 received = babyaptosContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    babyaptosContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
