...
/**
 * Website https://babyceofloki.com/
 * Telegram https://t.me/babyceoflokibsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7E6528514c8edD90b9e2204fE418D4D64F00deAD; // owner address
...
contract BabyCeoFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby CEO Floki";
    string private _symbol = "BabyCeoFloki";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x333504e8f4603537b3D4342627dbEF5f3a091E9d); // Marketing Address
    address payable public teamWalletAddress = payable(0x333504e8f4603537b3D4342627dbEF5f3a091E9d); // Team Address
    ...
    uint256 public _marketingShare = 36;
    ...
    uint256 private _totalSupply = 2500000000 * 10**_decimals;
