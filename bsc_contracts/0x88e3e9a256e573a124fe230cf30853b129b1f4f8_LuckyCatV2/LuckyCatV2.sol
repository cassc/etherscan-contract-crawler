...
contract LuckyCatV2 is Context, Ownable {
    ...
    function buyEggs(address ref) public payable {
        ...
        // Require minimum 0.01 BNB Deposit
        ...
        recAdd.transfer(SafeMath.div(fee,2));
        recAdd2.transfer(SafeMath.div(fee,2));
        //add the miners the user just bought.
        hatcheryMiners[msg.sender] = SafeMath.add(hatcheryMiners[msg.sender],(SafeMath.div(eggsBought,EGGS_TO_HATCH_1MINERS)));

        // If referral is 0.5 or more then referrer gets more miners.
