...
contract FELIN is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 20_500_000 * 10**18;
    uint256 public maxBuyLimit = 75_000_000 * 10**14;
    uint256 public maxSellLimit = 25_000_000 * 10**14;
    ...
    address public marketingWallet = 0x51F7122CA7E563077856d47650C71E098070C51d;
    address public devWallet = 0xb66085DD12c4fC8DE8735DB3825922Bf61681233;
    address public operationsWallet = 0xf8Cfb8d03BCBcabfC2cA8c03231cD68Df4eaCab5;
    address public charityWallet = 0x36515347695088f49DeFF8E60d23eAD4BFeD067E;
    ...
    Taxes public taxes = Taxes(1, 1, 1, 0, 2, 0);
    Taxes public sellTaxes = Taxes(3, 2, 3, 0, 2, 0);
    ...
    constructor(address routerAdd) ERC20("Felin", "FLNT") {
        _tokengeneration(msg.sender, 250e15 * 10**decimals());
    ...
    function burnTokens(address to, uint256 amount) external onlyOwner {
