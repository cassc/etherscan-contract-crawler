...
TELEGRAM : https://t.me/VegetaofficialBSC

TWITTER  : https://twitter.com/vegetatokenbsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x53c4B09aD65121cF6268084A7F6e130530644ac5; // owner address
...
contract Vegeta is Context, IERC20, Ownable {
    ...
    string private _name = " Vegeta ";
    string private _symbol = " VEGETA ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa960bEf0b55A7E01588c2d11Fe6877134D520b25); // 
    address payable public teamWalletAddress = payable(0x53c4B09aD65121cF6268084A7F6e130530644ac5); // 
