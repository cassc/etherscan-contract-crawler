...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD7B65039b5a490701468722E84Dce104116C8f6C; // owner address
...
contract ABBEYSIMPSON is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Abbey Simpson";
    string private _symbol = "ASIMPSON";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xe95AfF003928792754927d8cC2fb13D31B3DcD24); // Marketing Address
    address payable private teamWalletAddress = payable(0xD7B65039b5a490701468722E84Dce104116C8f6C); // Team Address
