...
contract CATHONGKONG is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Cat Hongkong";
    string private constant _symbol = unicode"CATHONGKONG";
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint8 private _TxCount = 0;
    uint256 private _tTotal = 10**6 * 10**_decimals;

    address payable public DevWallet = payable(0x857b2825f7a5B81473E59E9849d3F904fEE92dE1);
    address payable public MarketingWallet = payable(0xC994F5F8Ca46887c7B1465CA7EAd7dAa64276E0C);
