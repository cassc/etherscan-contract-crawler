...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 650;
    ...
    constructor (
        ...
        holderCondition = 100000 * 10 ** Decimals;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.number < startTradeBlock + 11) {
...
contract Jarvis is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),
        address(0x55d398326f99059fF775485246999027B3197955),
        address(0x55d398326f99059fF775485246999027B3197955),
        "AI IntelligenceJarvis",
        "Jarvis",
        18,
        2100000,
        address(0x0c8d41Fc0497AD2fbe60Bc6c482403DdD14E5AB3),
        address(0x0c8d41Fc0497AD2fbe60Bc6c482403DdD14E5AB3),
        address(0x25b8F538538397853b33611B11e4A55F1c05646b)
    ){
