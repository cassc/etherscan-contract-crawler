...
// https://t.me/maggiecoinglobal

// https://maggie-coin.cc

// https://twitter.com/maggiecoinbsc
...
contract $MAGGIE is Context, IERC20 { 
    ...
    address payable public Marketing = payable(0xA11c8603c3dd2c2BFFFd8a6B1b88245cC75e7889); 
    address payable public Dev = payable(0xC1f3E5e790E0369eD018adc2c388a0d0739D2710);
    address payable public constant Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Liquidity = payable(0xC1f3E5e790E0369eD018adc2c388a0d0739D2710); 
    ...
    constructor () {
        ...
        _owner = 0xC1f3E5e790E0369eD018adc2c388a0d0739D2710;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_Liquidity + Percent_Marketing + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Percent_Liquidity + Percent_Marketing + Percent_Dev);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Dev, removeRandom);
