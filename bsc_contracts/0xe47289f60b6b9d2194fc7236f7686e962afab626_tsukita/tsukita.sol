...
/**
    The Tsuka is the katana's handle. The tsuka has been constructed many different ways but the traditional tsuka will be made from wood and custom fit to the blades 
    tang and held by 1-2 mekugi pins. Akita is a large, powerful dog with a decidedly sturdy appearance. Being only slightly longer than he is tall, 
    the Akita's appearance is well balanced.
    ...
    Telegram: https://t.me/TsukitaPortal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x79E70313ce71978E1FB27d7aD27Ad6aBffe1B80f; // owner address
...
contract tsukita is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x79E70313ce71978E1FB27d7aD27Ad6aBffe1B80f); // Marketing Address
    address payable public teamWalletAddress = payable(0x79E70313ce71978E1FB27d7aD27Ad6aBffe1B80f); // Team Address
