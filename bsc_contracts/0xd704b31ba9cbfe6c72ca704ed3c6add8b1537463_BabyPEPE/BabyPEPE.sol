...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9d30966A104cBF58CcF071d6247532bA2637703a; // owner address
...
contract BabyPEPE is Context, IERC20, Ownable {
    ...
    string private _symbol = "Baby PEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9d30966A104cBF58CcF071d6247532bA2637703a); // Marketing Address
    address payable public teamWalletAddress = payable(0x9d30966A104cBF58CcF071d6247532bA2637703a); // Team Address
