...
contract  MktCap is Ownable {
    ...
    constructor(address ceo_,address baseToken_,address router_){
        ...
        allot=Allot(29,0,0,29);
        autoSell=autoConfig(true,5,10000,500000);
        marketingAddress=[0xb12063208bA7ba8CE9F391F29AC521D1aEa594B9];
        marketingShare=[100];
        sharetotal=100;
    } 
...
contract HUSKY is Token{
    constructor() Token("HUSKY","HUSKY",1e15) {
    }
}