...
contract Coin9Seconds is IBEP20, Ownable {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public _dexRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    string constant _name = "9s Coin";
    string constant _symbol = "9s";
    ...
    function checkTxLimit(address sender, uint256 amount) internal view {
        if(!isTxLimitExempt[sender] && launchedAtTimestamp + 30 minutes > block.timestamp) {
