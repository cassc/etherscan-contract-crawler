...
contract STARBUCKS is Context, IERC20, Ownable {
    ...
    string private _name = "STAR BUCKS";
    string private _symbol = "BUCKS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x65681Af878da52F90efEA0f9Fbf7a1c790846c4b);
    address payable public liqWalletAddress = payable(0xbDC35d92Bc5bDF2e568f689fEdC74AAd67B9DF4D);
