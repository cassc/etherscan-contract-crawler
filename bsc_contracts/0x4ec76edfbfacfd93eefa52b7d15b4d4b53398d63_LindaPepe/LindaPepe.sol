...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf66592f85B0302a581B26c05003ba3800b005fCB; // owner address
...
contract LindaPepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Linda Pepe ";
    string private _symbol = "LINDAPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf66592f85B0302a581B26c05003ba3800b005fCB); // Marketing Address
    address payable public teamWalletAddress = payable(0xf66592f85B0302a581B26c05003ba3800b005fCB); // Team Address
