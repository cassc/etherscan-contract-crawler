...
/**
    ...
    Telegram: https://t.me/ermnmusk_BSCportal

    Twitter: https://twitter.com/elonmusk/status/1654276122056564736
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x13946A9B9bDa1de5b2E2FE19cea9A8Af68e5339f; // owner address
...
contract ErmnMusk is Context, IERC20, Ownable {
    ...
    string private _name = " ErmnMusk ";
    string private _symbol = "ERM";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x13946A9B9bDa1de5b2E2FE19cea9A8Af68e5339f); // Marketing Address
    address payable public teamWalletAddress = payable(0x13946A9B9bDa1de5b2E2FE19cea9A8Af68e5339f); // Team Address
