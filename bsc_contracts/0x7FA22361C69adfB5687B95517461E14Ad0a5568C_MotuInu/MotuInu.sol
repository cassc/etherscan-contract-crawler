...
contract MotuInu is ERC20, Ownable {
    ...
    constructor() ERC20(" MotuInu ", "MOTU") {
        ...
        maxTransactionAmount = 3 * 1e2 * 1e18; 
        maxWallet = 3 * 1e2 * 1e18; 
        ...
        devWallet = address(0x4548dd8876C91FA2041eccb4b2DBfB8E47677A73); 
