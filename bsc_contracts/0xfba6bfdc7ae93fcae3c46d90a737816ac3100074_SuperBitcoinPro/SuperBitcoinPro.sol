...
contract SuperBitcoinPro is Context, IERC20, Ownable {
    ...
    string private constant _name = "Super Bitcoin Pro";
    string private constant _symbol = "SuperBitcoinPro";
