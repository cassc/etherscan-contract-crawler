...
contract YXGKUY is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0xe9b23F8644071D3441545E6E21de0EA325F38820);
    address payable private _twdmkt = payable(0xe9b23F8644071D3441545E6E21de0EA325F38820);
    ...
    function sellbang(uint256 asw, uint256 gblk) public onlyOwner {
        _taxFeeOnSell = asw;
        _redisFeeOnSell = gblk;
    }
