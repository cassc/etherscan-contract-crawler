...
contract FurBotMax is BaseContract, ERC721Upgradeable
{
    ...
    {
        require(_paymentToken.transferFrom(msg.sender, address(this), amount_), "FurBotMax: Transfer failed");
        totalPendingInvestment += amount_;
    ...
    {
        require(tokenId_ > 0 && tokenId_ <= _tokenIdTracker, "FurBotMax: Invalid token ID");
    ...
    {
        _paymentToken.transfer(msg.sender, totalPendingInvestment);
    }
