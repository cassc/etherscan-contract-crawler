...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x8226C082D575155ef62BB32B31eA0F610D6083e6;
...
contract BNBBURNTHAIR is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"BNBURNTHAIR"; 
    string private constant _symbol = unicode"$BBH"; 
    ...
    uint256 public _maxWalletToken = 90 * _tTotal.div(1000);
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x8226C082D575155ef62BB32B31eA0F610D6083e6), BNB_Tot);
            }
