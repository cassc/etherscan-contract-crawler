...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf69C538124704d4B7ea49C5da8C7F8782Fb95346; // owner address
...
contract GyoshiDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GyoshiDoge";
    string private _symbol = "GYODO";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xf69C538124704d4B7ea49C5da8C7F8782Fb95346); // Marketing Address
    address payable private teamWalletAddress = payable(0xf69C538124704d4B7ea49C5da8C7F8782Fb95346); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 1000000000000 * 10**3; 
