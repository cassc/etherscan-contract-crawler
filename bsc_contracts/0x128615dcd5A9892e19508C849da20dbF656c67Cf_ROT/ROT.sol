...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x645600e703d77bB450E9640ca718Ea0E73E145C2;
...
contract ROT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xDDaABccbFce12595F7920Ec0D8eeEBe1000Be9DD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 420000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Rich Off Tokens";
    string private _symbol = "ROT";
