...
/* Token contract */
contract LunaFlareSickRewards is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Luna Flare";
    string constant _symbol = "LUNF";
    ...
    uint256 public swapThreshold = (_totalSupply * 3) / 10000; // 0,03% of supply
