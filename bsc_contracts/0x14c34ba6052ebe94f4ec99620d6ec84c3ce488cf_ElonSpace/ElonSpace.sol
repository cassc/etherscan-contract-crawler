...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x28dF30F9AAC99f372a3685271f8A983CF8659B15; 
...
contract ElonSpace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
  
    string private _name = "Elon Space";
    string private _symbol = "ELONSPACE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xD30a5ad750E2cC34C5BEbf24EAd01de942c149fc); 
    address payable public teamWalletAddress = payable(0xEebba9dcde8278d0bF495d66EC8132d764F989E7); 
