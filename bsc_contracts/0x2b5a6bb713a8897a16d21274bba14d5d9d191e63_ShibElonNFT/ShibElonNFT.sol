...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract ShibElonNFT is ERC721Enumerable, Ownable {
        ...
        uint256 public price = 0.25 ether; //0.25 BNB
        uint256 public BUYBACK_PERCENTAGE = 10; //10%
        string baseTokenURI;
        ...
        constructor(string memory baseURI) ERC721("ShibElon NFT", "SHIBELON") {
            ...
            receiverAddress = 0x3de2894d63334dB3a283b759b6d94491Fe5a3Da7; // Marketing Wallet
            ...
            baseTokenAddress = 0xC183062db25FC96325485ea369C979CE881Ac0eA; //SHIBELON
            ...
            baseTokenAddress = 0xaB1a4d4f1D656d2450692D237fdD6C7f9146e814; //tBUSD
            */
        ...
        function randomAirdropNew(address[] calldata _walletAddresses) external onlyOwner {
        ...
        function setBuyBackPercentage(uint256 _buyBackPercentage) external onlyOwner{
            BUYBACK_PERCENTAGE = _buyBackPercentage;
        }

        function buyBack() public payable returns(bool) {
            uint256 swapAmount = (msg.value * BUYBACK_PERCENTAGE) / 100;
            executeSwapNativeCoinWithBaseToken(swapAmount);
            return true;
        }

        function executeSwapNativeCoinWithBaseToken(uint256 _amount) public returns(bool){ // SWAP BNB with BUSD
