...
// Telegram : https://t.me/flopebscportal
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1B4A482E749c16Af025f17f1EbFcFA0B0D84795C;
...
contract FLOPE is Context, IERC20, Ownable {
    ...
    string private _name = "FLOPE";
    string private _symbol = "FLOPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1B4A482E749c16Af025f17f1EbFcFA0B0D84795C);
    address payable public teamWalletAddress = payable(0x1B4A482E749c16Af025f17f1EbFcFA0B0D84795C);
