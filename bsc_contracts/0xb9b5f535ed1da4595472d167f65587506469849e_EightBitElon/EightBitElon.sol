...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb700180D86Cd9E1C0ae6442e2986DAb5dee98D1e; // owner address
...
contract EightBitElon is Context, IERC20, Ownable {
    ...
    string private _symbol = "8BITELON";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xb700180D86Cd9E1C0ae6442e2986DAb5dee98D1e); // Marketing Address
    address payable private teamWalletAddress = payable(0xb700180D86Cd9E1C0ae6442e2986DAb5dee98D1e); // Team Address
