...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6A80495c2B5A3a5A8D8A1cfE843F4523187F6872;
...
contract CryptoBallZ is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xC3954C248e3BFA110E567527eAE962C47792B52B;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CryptoBallZ";
    string private _symbol = "CBZ";
