...
contract BAFCLegendaryNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 public MAX_SUPPLY = 8;
    uint256 public MAX_TX_MINT = 8;
    uint256 public MAX_WALLET_MINT = 8;
    uint256 public PRICE_PER_MINT = 75 ether;
    ...
    constructor() ERC721("BAFC Legendary NFT", "BAFCLegendaryNFT") {
