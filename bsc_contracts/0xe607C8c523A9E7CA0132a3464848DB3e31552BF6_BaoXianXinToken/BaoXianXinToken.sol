...
contract  BaoXianXinToken is IERC20, Ownable {
    ...
    //address public _tokenBaoxian = 0xBDbF06044DE12C72EC93003C292F21aF0F1135eC;
   ...
   constructor() {
            ...
            _name = "BAOXIAN";
            _symbol = "BAOXIAN PRODEUCT";
            _decimals= 18;
            _tTotal = 6000* (10**uint256(_decimals));//数量
            _burnFee = 500;
	    _marketingFee = 100;
            _LPFee = 300;
            // marketAddr = msg.sender; //营销钱包
	    marketAddr = 0x56d093dCc0D9fb7c1a8966D722236B759d3aF21B;
            _tOwned[adminAddress] = _tTotal;
           
            _intervalSecondsForSwap = 15;//杀多少秒机器人
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
		...
		IERC20(_token).transfer(marketAddr,  tokenBal.div(10000).mul(_marketingFee));
