...
contract DogeZeus is ERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Doge Zeus", "DGZ") {
        ...
        //tTotal = x * 1e9;
        tTotal = 100000000 * 1e9;
        _rTotal = (MAX - (MAX % tTotal));

        maxTransactionAmount = (tTotal * 5) / 1000; // 5% maxTransactionAmountTxn
        maxWallet = (tTotal * 1) / 1000; // 1% maxWallet
    ...
    function updateBuyFees(
        ...
        buyBurnFee = _burnFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyBurnFee;
        require(buyTotalFees <= 90, "Must keep fees at 10% or less");
    }
