...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb37D880D8110d254B2a505295204268a045deef8;
...
contract SKAI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xb37D880D8110d254B2a505295204268a045deef8;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TESTNET";
    string private _symbol = "TNET";
    ...
    function getMaxWalletAmount() public view returns (uint256) {
        return (_tTotal.mul(maxWalletPercentage).div(100));
    }
