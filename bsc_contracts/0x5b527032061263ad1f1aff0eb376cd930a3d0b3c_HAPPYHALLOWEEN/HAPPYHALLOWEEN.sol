...
//Masquerade season trend, we will transform into the character Azzen'ka

// telegram : https://t.me/happyhalloween_2022
...
contract HAPPYHALLOWEEN is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x2227B4869F00661aef521Acf6c277eA3B38422D8); 
    address payable private Wallet_Dev = payable(0x2227B4869F00661aef521Acf6c277eA3B38422D8);
    ...
    string private constant _symbol = unicode"HHLW"; 
    ...
    uint256 private Percent_Marketing = 5;
    uint256 private Percent_Dev = 95;
    ...
    constructor () {
        ...
        _owner = 0x2227B4869F00661aef521Acf6c277eA3B38422D8;
    ...
    function Trade_Op(bool open) external onlyOwner {
        _open = open;
    }
    ...
    */
    ...
    function PriorOnly(address addresses) external onlyOwner {
    ...
    function WL_rmv(address addresses) external onlyOwner {
    ...
    function Limit_txh(uint256 maxTxPercent_x100) external onlyOwner() {
