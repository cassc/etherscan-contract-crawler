...
/**
Imagine owning a token with a name like "Fucking Token".
*/
...
contract ThatFuckingToken  is Context, IERC20, Ownable {
    ...
    string private _name     = "ThatFuckingToken";
    ...
    uint256 public totalFees = taxFee + marketingFee;

    uint256 public launchTime;

    address public marketingWallet = 0xa1003314FB6aDd8D8DF217A9CBF63eaBe892A77a;
    address public newOwner = 0xa1003314FB6aDd8D8DF217A9CBF63eaBe892A77a;
    ...
    constructor() 
    { 
        newOwner = 0xa1003314FB6aDd8D8DF217A9CBF63eaBe892A77a;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 tTransferAmount = tAmount - tFee - tMarketing;
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tMarketing, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
        ...
        uint256 rTransferAmount = rAmount - rFee - rMarketing;
    ...
    function removeAllFee() private {
        if(taxFee == 0 && marketingFee == 0) return;
    ...
    function setFeePercent(uint256 _taxFee , uint256 _marketing) external onlyOwner() {
        require(
            (launchTime > 0 && launchTime + 14 days < block.timestamp) ||
            _taxFee + _marketing  <= totalFees,
            "Owner can not increase taxes in the first 14 days from listing"
        );
        marketingFee = _marketing;
        taxFee = _taxFee;
        totalFees = taxFee + marketingFee;
