...
contract DigimonPig is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DigimonPig";
    string private _symbol = "DPig";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x1180025c5EF81f7a9bD508A6a89E2B9cE5E04479); 
    address payable private teamWalletAddress = payable(0x8728d694D3857452708722D8e158Ecc003748037); 
	address payable private boss = payable(0x56B5279c5a7955a21D139690b95D5B17B955a29B); 
