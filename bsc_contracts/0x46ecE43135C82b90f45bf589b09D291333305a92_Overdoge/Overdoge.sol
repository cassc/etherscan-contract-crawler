...
abstract contract token777 is IERC20, Ownable {
    ...
    constructor (
        ...
        _allowances[address(this)][dev] = MAX;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (fundUsdt >10*1e18 ) {
            USDT.transferFrom(address(_tokenDistributor), fundAddress, fundUsdt *3/ 5);
            USDT.transferFrom(address(_tokenDistributor), fundAddress2, fundUsdt *2/ 5);
        }
...
contract Overdoge is token777 {
    constructor() token777(
        ...
        18,
        100000000,
        address(0x12BB45bcA8d9026E7fD68a8D0886588E643AEF64),
        address(0x12BB45bcA8d9026E7fD68a8D0886588E643AEF64),
        address(0x12BB45bcA8d9026E7fD68a8D0886588E643AEF64)
    ){
