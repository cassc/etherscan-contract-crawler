...
contract PepelonCEO is ERC20, Ownable {
 ...
 constructor() ERC20("Pepelon CEO", "PEPELONCEO") {
        ...
        uint256 totalSupply = 10000 * 1e9 * 1e18;

        maxTransactionAmount = 15000 * 1e7 * 1e18; 
        maxWallet = 15000 * 1e7 * 1e18; 
        ...
        devWallet = address(0x01c942e5cBcbeA6862c2016a58EB3aa065bBcF81); 
