...
contract FLOKIGIRL  is Context, IERC20, Ownable {
    ...
    string private constant _name = "FlokiGirl"; 
    string private constant _symbol = "FLOKIGIRL";
    ...
    Tax public buyTax = Tax(10,0,5);
    Tax public sellTax = Tax(10,0,5);
    
    address public treasuryWallet = 0xC15DF932bFa90a9Ff4Fb1B8b288e2F7867BC2658;
    address public devWallet = 0xC15DF932bFa90a9Ff4Fb1B8b288e2F7867BC2658;
...
//============== Owner Functions ===========//
    ...
    function owner_setSellTaxes(uint8 marketingTax, uint8 devTax, uint8 lpTax) external onlyOwner{
        uint tTax = marketingTax + devTax + lpTax;
        require(tTax <= 90, "Can't set tax too high");
