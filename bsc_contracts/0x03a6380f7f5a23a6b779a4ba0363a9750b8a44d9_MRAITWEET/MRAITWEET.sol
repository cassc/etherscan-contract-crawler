...
contract MRAITWEET is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "MR AI TWEET";
    string private _symbol = "MAT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x6F5e64f1F030a4265Ea5A9e3Da251529b3319452);
    address payable public liqWalletAddress = payable(0x6F5e64f1F030a4265Ea5A9e3Da251529b3319452);
    ...
    uint256 public _walletMax =     7777777 * 10**_decimals;
