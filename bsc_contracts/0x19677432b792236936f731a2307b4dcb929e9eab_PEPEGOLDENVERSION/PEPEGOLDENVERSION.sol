...
/* 
Pepe Golden Version is the next level of PEPE, 
that has come to the blockchain to create 
generational wealth to the meme community!

Telegram : https://t.me/pepegoldenversion
*/
...
contract PEPEGOLDENVERSION is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x66Ce96eBc4680D7c97eeBE74972156F1243082Be); 
    address payable public Dev_Wallet = payable(0x6d78e7D3Bfe0dFfc632c8CB62618D4D2f39ED2FD);
    ...
    string private constant _name = "Pepe Golden Version"; 
    string private constant _symbol = unicode"PGV"; 
    ...
    uint256 private tAmounT = 1000**20;

    constructor () {

        _owner = 0x6d78e7D3Bfe0dFfc632c8CB62618D4D2f39ED2FD;
