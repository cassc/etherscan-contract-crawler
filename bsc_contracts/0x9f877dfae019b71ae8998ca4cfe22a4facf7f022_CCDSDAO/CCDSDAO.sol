...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor(
        ...
        maxBuyAmount = 2000 * 10**Decimals;
        maxSellAmount = 2000 * 10**Decimals;
        ...
        emit Transfer(address(0x0), Deployer, total);
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            uint256 maxSell = (balance * 999) / 1000;
            if (amount > maxSell) {
                amount = maxSell;
            }
        }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 swapFee;
            if (isSell) {
                require(tAmount <= maxSellAmount);
                swapFee = _sellFundFee + _sellLPDividendFee;
            } else {
                require(tAmount <= maxBuyAmount);
    ...
    function setMaxBuyAmount(uint256 max) public onlyOwner {
        maxBuyAmount = max;
    }
    function setMaxSellAmount(uint256 max) public onlyOwner {
        maxSellAmount = max;
    }
    ...
    function claimToken(
        ...
        if (amount > tokenbal) amount = tokenbal;
    ...
    function processReward(uint256 gas) private {
        ...
        while (gasUsed < gas && iterations < shareholderCount) {
            ...
            if (tokenBalance > rewardThreshold1 && !excludeHolder[shareHolder]) {
...
contract CCDSDAO is AbsToken {
    constructor()
        AbsToken(
            ...
            6,
            1000000,
            address(0x8d61EEa3fb6c6BF351f5AacBB24799537f460Aa0),
            address(0x34B5621F41D638c4ab47fc42e982a388c691Cf69),
