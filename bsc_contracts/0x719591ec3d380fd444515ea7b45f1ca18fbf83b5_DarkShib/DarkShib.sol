...
/**
 Dark Shib
 * Telegram https://t.me/darkshibsc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x476C3FE23510EF786706f8c489EA2c785e507897; // owner address
...
contract DarkShib is Context, IERC20, Ownable {
    ...
    string private _name = "DarkShib";
    string private _symbol = "$DSHIB";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x648d9Ab9F7CDC55D4C2800c818c8ce4314341bB8); // Marketing Address
    address payable public teamWalletAddress = payable(0x648d9Ab9F7CDC55D4C2800c818c8ce4314341bB8); // Team Address
