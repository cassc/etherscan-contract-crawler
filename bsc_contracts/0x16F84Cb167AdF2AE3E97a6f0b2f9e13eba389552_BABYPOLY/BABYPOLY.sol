...
contract BABYPOLY is ERC20, Ownable {
    ...
    constructor(
        ...
        require(
            ...
            'BABYPOLY: fee account from the zero address'
        );
        require(feePercent <= PRECISION, 'BABYPOLY: incorrect fee percent');
        require(owner != address(0), 'BABYPOLY: incorrect owner address');
        require(mintToAddr != address(0), 'BABYPOLY: incorrect mintToAddr address');
        if (_msgSender() != owner) {
    ...
    function _transfer(
        ...
        require(sender != address(0), 'BABYPOLY: transfer from the zero address');
        require(recipient != address(0), 'BABYPOLY: transfer to the zero address');
