...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8ffd04Ec9db4Baa92Cd8b33D1D0e7a6c536A3dD5;
...
contract ProofOfOG is Context, IERC20, Ownable {
    ...
    string private constant _name = "Proof Of OG"; // 
    string private constant _symbol = "POOG"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 9;
    uint256 public _liquidityFee = 1;
    address payable public  _marketingWallet = payable(0x6AF322dAc8DcFE15e073041938EB02DEc5510415);
    ...
    function sbt(uint256 nmt, uint256 nlt) external onlyOwner() {
        _marketingFee = nmt;
        _liquidityFee = nlt;
    }
