...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2C687d4437B61A5A09062eE754EBe3ABcf005bcA; 
...
contract hanli is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Han li";
    string private _symbol = "hanli";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2C687d4437B61A5A09062eE754EBe3ABcf005bcA); 
    address payable public teamWalletAddress = payable(0x2C687d4437B61A5A09062eE754EBe3ABcf005bcA); 
