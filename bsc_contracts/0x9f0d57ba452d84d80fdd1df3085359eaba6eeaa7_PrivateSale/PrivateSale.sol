...
contract PrivateSale is Ownable {
    ...
    uint256 public tokensPerBNB = 3223684 * 10 ** 18;
    ...
    uint32 public feeForReferral = 20;
    ...
    function buyTokensWithoutReferral() external payable {
        ...
        _buyTokensWithoutReferral(msg.sender, weiAmount);
    ...
    function _validatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(!hasEnded(), "PrivateSale: sale is over");
    ...
    function claimTokens() external {
        require(hasEnded(), "PrivateSale: distribution will be done after 6 months.");
