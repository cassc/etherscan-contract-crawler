...
contract Foundation is ERC20, Ownable {
    ...
    constructor() ERC20("Foundation", "FND") {
        ...
        marketingFeeAddress = payable(
            0xD7B9DBcb61BB5d05935d495bf58057442AC8D5E4
        );
        devFeeAddress = payable(0xFe4926ce2E8e80008a0C3cbf5bfcbfDbF247D9e6);
    ...
    function _transfer(
        ...
        require(!bot[from] && !bot[to], "Bot wallets are not allowed");
        if (!tradingActive) {
            require(
