...
contract TOken is Context, IERC20, Ownable {
    ...
    string private _name = "MuskCEO";
    string private _symbol = "MuskCEO";
    uint8 private _decimals = 18;
    

    address payable public marketingWalletAddress = payable(0x1B9f35A583AaeCE510e109E283C561a051A2641a); 
    address payable public BurnedWalletAddress = payable(0x1B9f35A583AaeCE510e109E283C561a051A2641a); 
    address public  deadAddress = 0x89f9bEF3B45169667463c72a08af924672e848DB;
    ...
    uint256 private minimumTokensBeforeSwap = 100000000 * 10**8 * 10**_decimals;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapPair;

     uint256 public genesisBlock;
    uint256 public coolBlock = 2;
