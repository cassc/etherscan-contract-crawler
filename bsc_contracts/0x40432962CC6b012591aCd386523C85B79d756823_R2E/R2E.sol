...
contract R2E is ERC20, Ownable {
    ...
    event FeesChanged(uint256 totalFeesOnBuy, uint256 totalFeesOnSell);


    constructor () ERC20("Report2Earn", "R2E") 
    {       
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x63fe4689c0D41b600De779AecEb6EE5187e7a078;
...
//------------------FeeManagement------------------//
    ...
    function changeMarketingWallet(address _marketingWallet) external onlyOwner{
        ...
        require(!_marketingWallet.isContract(),"Marketing wallet cannot be a contract");
...
//------------------Swap------------------//
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount > 1 ether, "SwapTokensAtAmount must be greater than 0.001% of total supply");
