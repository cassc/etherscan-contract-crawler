...
contract CARDGAME is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x84F1bcde9276cd70aFbBbBd87977138De00D0d85; //

    string private constant _name = "Card Game"; //
    string private constant _symbol = "WHOT"; //
    ...
    function Contract_SetUp_05__Bot_Protection(
        ...
        require (Early_Buy_Timer_in_Seconds <= 20, "E07"); // Max early buy timer is 20 seconds 
        EarlyBuyTime = Early_Buy_Timer_in_Seconds;

         Block_Early_Buyer_Sells;
