...
contract HallowBunny is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x117bBF520CBa5a47289749082eD2acf492962bfF); 
    address payable public Wallet_Buyback = payable(0xfa4Dd9B8bF1Ee5149F090BbF311b3991D0080223);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x1966941A225adFC5f2e5880918e43cD486B2beDf); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10000000 * 10**_decimals;
    string private constant _name = "HallowBunny"; 
    string private constant _symbol = unicode"HBUNNY"; 
    ...
    uint256 public Percent_Buyback = 10;
    ...
    constructor () {
        ...
        _owner = 0x1966941A225adFC5f2e5880918e43cD486B2beDf;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_Buyback / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Buyback);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Buyback * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Buyback);
            ...
            sendToWallet(Wallet_Buyback, BNB_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_Buyback, removeRandom);
