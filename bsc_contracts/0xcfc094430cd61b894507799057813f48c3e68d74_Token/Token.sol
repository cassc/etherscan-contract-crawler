...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "New 413";
    string private constant _symbol = "N413";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 4130 * 10**_decimals;
    uint256 public _maxTxAmount = 2065 * 10**8;
    uint256 public _maxWalletAmount = 2065 * 10**8;
    ...
    function feesInclude(address[] calldata addresses) external onlyOwner {
