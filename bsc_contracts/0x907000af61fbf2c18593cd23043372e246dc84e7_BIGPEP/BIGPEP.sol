...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd822147845b934843c4F711C9b0edaf64e44bfEC;
...
contract BIGPEP is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd822147845b934843c4F711C9b0edaf64e44bfEC;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BIGPEPE";
    string private _symbol = "BIGPEP";
