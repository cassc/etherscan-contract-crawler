...
https://t.me/LAKERSINUOFFICIALBSC
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xFc629A52b5aD33bA8Aa96cbe1c01a1337d2124e6; // owner address
...
contract LAKERSINUOFFICIALBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "LAKERS INU";
    string private _symbol = "LAKERSINU";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xce2fbA36085A7B8e2Ce302581881e3cc57f5529E); // Marketing Address
    address payable private teamWalletAddress = payable(0xFc629A52b5aD33bA8Aa96cbe1c01a1337d2124e6); // Team Address
