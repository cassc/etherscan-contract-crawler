...
contract DependencyTech is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x731eeb5be8d98f1e86f0668D717dB76272737eF8); // Marketing Address
        
    address payable public teamAddress =
        payable(0x731eeb5be8d98f1e86f0668D717dB76272737eF8); // Team Address
        
    address payable public liquidityAddress =
        payable(0x731eeb5be8d98f1e86f0668D717dB76272737eF8); // Liquidity Address
    ...
    string private constant _name = "DependencyTech";

    string private constant _symbol = "Dependency";
    
    uint8 private constant _decimals = 18;
    
    uint256 private constant BUY = 15;
    uint256 private constant SELL = 25;
