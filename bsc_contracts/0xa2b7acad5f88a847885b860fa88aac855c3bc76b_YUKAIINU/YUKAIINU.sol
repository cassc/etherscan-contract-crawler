...
contract YUKAIINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YUKAI INU";
    string private _symbol = "$YUKAI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC1e24F52853427cdE6EaDd3362a627b3Dc314D9f); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xC1e24F52853427cdE6EaDd3362a627b3Dc314D9f); // Development Address
    ...
    uint256 public _maxTxAmount = 100 * 10**10 * 10**9;
    uint256 public _walletMax = 100 * 10**10 * 10**9;
