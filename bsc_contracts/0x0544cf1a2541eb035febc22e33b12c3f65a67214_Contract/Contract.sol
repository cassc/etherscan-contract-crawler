...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Robot Rabbit"; //
    string private constant _symbol = "Robot Rabbit"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x66EF3b9F2AE82422F83E7DFFd4cCa2e5eadeE987;
