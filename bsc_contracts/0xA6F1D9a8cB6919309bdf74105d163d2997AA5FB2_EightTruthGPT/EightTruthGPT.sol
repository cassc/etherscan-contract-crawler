...
contract EightTruthGPT is IBEP20, Auth {
    ...
    string constant _name = "8TRUTHGPT";
    string constant _symbol = "8TGPT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 8888 * (10 ** _decimals);
