...
contract Token {
  ...
  string public name; // Holds the name of the token
    ...
    constructor() {
        name = "International Crypto Coin"; // Sets the name of the token, i.e Ether
        symbol = "ICC"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 100000 * 10 ** 18; // Holds an initial supply of coins
