...
/** 
    Project: Karma Bragons Sweep Staking
    Website: https://app.karmabragons.com/
...
contract KBSweepStaking is NFTStaking {
    constructor(
        address _token,
        address _nftAddress,
        uint256 _stakeRate
    ...
    function coinBalance(address _wallet) external view returns (uint256) {
