...
Nano Floki
Launching today at vc time
Might do well 
Gamble play 

Join tg for now 👀

https://t.me/+tlZ7h7xzSxwzZjNi
*/
...
contract NanoFloki is Context, IERC20 {
    using SafeMath for uint256;
    using Address for address;
    address private _owner;

    string private constant _name = "Nano Floki";
    string private constant _symbol = "NFLOKI";
    ...
    address payable public DevWallet = payable(0x8c190095055Aaf36FaA8927b48d17bF4e51FcCc8);
    address payable public MarketingWallet = payable(0xcb65a2f424DC96327eBCD4836151556f70700837);
    address payable private TeamWallet01 = payable(0xd02B10d7522853c26a55d33e71e17f6a344b628a);
    address payable private TeamWallet02 = payable(0x47D9eF2A0EE17160f5920121Add938EDeFcA4A5e);
    address payable private TeamWallet03 = payable(0x035880756f99Bf21c2EFeC657C01d27B31B20C9C);
