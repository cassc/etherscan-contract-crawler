...
Portal: https://t.me/dialecticinu
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x516929e027FC4C227eB3E512479cD43ae6D259cC; // owner address
...
contract Dialectit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dialectic Inu";
    string private _symbol = "$ELON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x516929e027FC4C227eB3E512479cD43ae6D259cC); // Marketing Address
    address payable public teamWalletAddress = payable(0x516929e027FC4C227eB3E512479cD43ae6D259cC); // Team Address
