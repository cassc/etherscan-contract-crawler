...
contract Rockocoin is Context, IERC20, Ownable {
    ...
    string private _name     = "Rockocoin";
    ...
    { 
        ...
        marketingWallet = 0x54A08aaDFBBFA1eCdb480A0D4380a56D477A9FD9;
        ...
        _isExcludedFromFees[address(0x54A08aaDFBBFA1eCdb480A0D4380a56D477A9FD9)] = true;
        _isExcludedFromFees[address(0x54A08aaDFBBFA1eCdb480A0D4380a56D477A9FD9)] = true; //pinklock

        _isExcluded[address(this)] = true;
        _isExcluded[address(0x54A08aaDFBBFA1eCdb480A0D4380a56D477A9FD9)] = true; //pinklock
        _isExcluded[address(DEAD)] = true;
        _isExcluded[address(uniswapV2Pair)] = true;

        _rOwned[address(0x54A08aaDFBBFA1eCdb480A0D4380a56D477A9FD9)] = _rTotal;
        _tOwned[address(0x54A08aaDFBBFA1eCdb480A0D4380a56D477A9FD9)] = _tTotal;

        emit Transfer(address(0), address(0x54A08aaDFBBFA1eCdb480A0D4380a56D477A9FD9), _tTotal);
    }
