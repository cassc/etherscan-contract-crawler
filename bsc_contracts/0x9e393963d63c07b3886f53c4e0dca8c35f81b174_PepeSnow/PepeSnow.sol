...
// Telegram Group: https://t.me/PepeSnowBSC     * ETH Reflections
...
contract PepeSnow is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Pepe Snow BSC";
    string constant _symbol = "PEPESNOW";
