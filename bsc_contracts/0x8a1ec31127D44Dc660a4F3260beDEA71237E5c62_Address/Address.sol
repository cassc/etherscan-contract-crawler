...
contract KhabyWorld is BEP20, Ownable {
    ...
    address public marketingWallet = 0x1cd66BE01bf4C69a8C865fcFbd42c0B14e2ab41E;
    address public nftRewardsWallet =
        0x000000000000000000000000000000000000dEaD;
    address public teamWallet = 0x000000000000000000000000000000000000dEaD;
    address public buybacksWallet = 0x000000000000000000000000000000000000dEaD;
    ...
    Taxes public taxes = Taxes(4, 0, 5, 4, 1);
    Taxes public sellTaxes = Taxes(4, 0, 5, 4, 1);
    ...
    constructor() BEP20("KhabyWorld", "KWorld") {
        ...
        exemptFee[nftRewardsWallet] = true;
        exemptFee[teamWallet] = true;
        exemptFee[buybacksWallet] = true;
        ...
        lockTheSwap
    {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            uint256 nftRewardsAmt = unitBalance * 2 * swapTaxes.nftRewards;
            if (nftRewardsAmt > 0) {
                payable(nftRewardsWallet).sendValue(nftRewardsAmt);
            }
            ...
            uint256 buybacksAmt = unitBalance * 2 * swapTaxes.buybacks;
            if (buybacksAmt > 0) {
                payable(buybacksWallet).sendValue(buybacksAmt);
            }
        }
    }
    ...
    function SetBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity, _nftRewards, _team, _buybacks);
    }
    ...
    function updateNftRewardsWallet(address newWallet) external onlyOwner {
        require(newWallet != address(0), "Fee Address cannot be zero address");
        nftRewardsWallet = newWallet;
    }
    ...
    function withdrawBEP20(address tokenAdd, uint256 amount)
        external
        onlyOwner
    {
        require(
