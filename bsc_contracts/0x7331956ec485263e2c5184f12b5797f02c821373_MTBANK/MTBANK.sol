...
pragma solidity ^0.6.2;
contract MTBANK is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _markAddress = 0x8af7d8e750be30a840856791F70c1D2729AEDd89;
    ...
    constructor() public ERC20("MTBANK", "MTBANK") {
        ...
        excludeFromFees(_markAddress, true);
    ...
    function _transfer(
        ...
        if(takeFee) {
        	...
        	uint256 lpfees = amount.mul(45).div(1000);
        	amount = amount.sub(lpfees).sub(deadfees);
            super._transfer(from, _deadAddress, deadfees);
    ...
    function _swapAndLiquid() private {
        ...
        if(fistval > 0){
            uint256 dr = fistval.div(9);
            uint256 mr = fistval.sub(dr);
            IERC20(USDTs).transfer(_markAddress, dr);
    ...
    function _swapTokenForTokenFIST(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount, 0, path, 0x7DDfA2676fa5C229532468651cB99D8BB3a171D2, block.timestamp);
        uint256 amount = IERC20(USDTs).balanceOf(0x7DDfA2676fa5C229532468651cB99D8BB3a171D2);
        if (IERC20(USDTs).allowance(0x7DDfA2676fa5C229532468651cB99D8BB3a171D2, address(this)) >= amount) {
            IERC20(USDTs).transferFrom(0x7DDfA2676fa5C229532468651cB99D8BB3a171D2, address(this), amount);
        }
    }
}