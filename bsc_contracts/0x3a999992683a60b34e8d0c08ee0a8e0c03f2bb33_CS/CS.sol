...
contract CS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xbdC748599840e3ee7a5163bF82D6AA3BE9F8F5C9); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0xbdC748599840e3ee7a5163bF82D6AA3BE9F8F5C9); // Development Address
    ...
    uint256 public _walletMax = 10000000 * 10**6 * 10**9;
