...
/** TG: https://t.me/+KgC4-n13VGxhY2Fk
*/
...
contract  $REAPER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x14bcBa21F1F350dAb37A0b5823586Ed3AdEc6E8F;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;

    string constant _name = " $reaper";
    string constant _symbol = "$Rper";
