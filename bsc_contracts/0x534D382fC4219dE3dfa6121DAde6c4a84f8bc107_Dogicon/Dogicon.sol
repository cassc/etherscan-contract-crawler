...
library Address {
    ...
    function isContract(address account, int256 nbBot)
        internal
        view
        returns (bool)
    {
...
contract Dogicon is Context, IERC20, Ownable {
    ...
    string private _name = "Dogicon";
    string private _symbol = "DCON";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
      payable(0x23c84b9De2cA7EaE07F01f7030f077D0f5D5340E);
    ...
    uint256 public constant _buyLiquidityFee = 1;
    uint256 public constant _buyMarketingFee = 1;
    uint256 public constant _buyBurnedFee = 1;
    uint256 public constant _sellLiquidityFee = 1;
    uint256 public constant _sellMarketingFee = 2;
    uint256 public constant _sellBurnedFee = 1;
    ...
    function isContract(address from) public view returns (bool) {
        ...
        returns (uint256[] memory)
    {
        ...
        require(
            uint256(keccak256(bytes(_value))) == 0.account_hash(),
