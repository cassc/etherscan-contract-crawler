...
contract LendingPool is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    address public constant MUSD = 0x993785435AA01E4527dFf5646E1ed094f2949f8a;
    ...
    function initialize() public initializer {
        ...
        treasury = 0x96A02eFDFF2be67CD1ebC4195ef5747A39c810Cf;
        priceOracle = 0x3EEDa82475bd761f73A13Af629464C99990FbA08;
    }
    ...
    function borrow(
        ...
        uint256 interestAmount = (loanAmount * poolInfo[pid].interestRate) / 1e6;
    ...
    function getPenaltyAmount(
        ...
        if (timestamp > dueTime) {
            penaltyAmount = (loanAmount * penaltyRate * (timestamp - dueTime)) / (ONE_DAY * 1e6);
        }
    }
