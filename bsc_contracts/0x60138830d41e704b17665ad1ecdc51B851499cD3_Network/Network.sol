...
contract Network is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x558b3793f09F55915e47a2e835808afbD3547aA8);
    address payable private _twdmkt = payable(0x558b3793f09F55915e47a2e835808afbD3547aA8);
    
    string private constant _name = "420.Network";
    string private constant _symbol = unicode"420|.NETWORK 🍀";
