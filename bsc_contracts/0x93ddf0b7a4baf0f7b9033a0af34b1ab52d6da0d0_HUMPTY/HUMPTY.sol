...
contract HUMPTY is Ownable, IBEP20 {
    ...
    string constant _name = "Humpty Dumpty";
    string constant _symbol = "HUMPTY";
    ...
    constructor () {
        ...
        marketingFeeReceiver =0xad4e6227537C9693C44F8b4C595CF65009eCb441;
