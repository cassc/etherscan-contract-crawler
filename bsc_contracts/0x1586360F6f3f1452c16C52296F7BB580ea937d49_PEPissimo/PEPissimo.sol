...
interface Cashier {
    ...
    function tallyZero(address user, uint256 amount) external;
...
contract PEPissimo is IERC20 {
    ...
    string constant private _name = "PEPissimo";
    string constant private _symbol = "PEPissimo";
    ...
    address payable public marketingWallet = payable(0x17CB8EB7f67436595Dc5BBB7eA1cbA4b6A4E4078);
    Cashier cashier;
...
//===============================================================================================================
    ...
    function setDividendExcluded(address account, bool enabled) public onlyOwner {
        ...
        if (enabled) {
            try cashier.tallyZero(account, 0) {} catch {}
        } else {
