...
/*
DOLLAR! LET'S MAKE THEM AFRO!!

https://t.me/afrodollar
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x863E048aE14bd0c3eF07C0C2cdcE0Ec6E65D7D4c; // owner address
...
contract AfroDollar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Afro Dollar";
    string private _symbol = "$AD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x863E048aE14bd0c3eF07C0C2cdcE0Ec6E65D7D4c); // 
    address payable public teamWalletAddress = payable(0x863E048aE14bd0c3eF07C0C2cdcE0Ec6E65D7D4c); // 
