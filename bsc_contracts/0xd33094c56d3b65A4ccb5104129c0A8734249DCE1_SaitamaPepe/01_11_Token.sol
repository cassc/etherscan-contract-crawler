...
contract SaitamaPepe is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20("SaitamaPepe", "SaitPePe") 
    {
        address supplyRecipient = 0xF4109566F2c8266eC46d6638ED79c08aa7d4D137;
        
        updateSwapThreshold(500 * (10 ** decimals()));

        marketingwalletAddressSetup(0xF90ed82A1B9e70FF13ecFbeeDbE72dB6E79f2440);
        ...
        _transferOwnership(0xF4109566F2c8266eC46d6638ED79c08aa7d4D137);
    }
