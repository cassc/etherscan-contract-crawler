...
contract DEX is Context, IERC20, Ownable {
    ...
    string private _name = "Debug Error Xaara";
    ...
    address payable public marketingWallet = payable(0xDE2ba4E5B720bb604f131C35d4dbEB08Dd7253b8);
    ...
    uint256 public _maxTxAmount = 42000000000 * 10**18;
