...
contract ATLVaultAdminStorage {
    ...
    */
    ...
    /**
    * @notice Active brains of ATL Vault
    */
    address public implementation;

    /**
    * @notice Pending brains of ATL Vault
    */
    address public pendingATLVaultImplementation;
}

contract ATLVaultStorageV1 is ATLVaultAdminStorage {
    /// @notice Guard variable for re-entrancy checks
    bool internal _notEntered;

    /// @notice The reward token store
    address public atlStore;

    /// @notice The atl token address
    address public atlAddress;
...
contract ATLVaultStorage is ATLVaultStorageV1 {
