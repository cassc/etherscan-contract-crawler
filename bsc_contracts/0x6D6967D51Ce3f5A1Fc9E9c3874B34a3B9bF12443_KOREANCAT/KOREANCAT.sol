...
//TELEGRAM: https://t.me/koreancatbsc
//안녕! 우리 커뮤니티에 오신 것을 환영합니다. 라이딩에 참여하고 백만 시가 총액 목표를 달성합시다.
...
contract KOREANCAT is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 5000000 * 10**_decimals;
    uint256 public maxWalletBalance = 5000000 * 10**_decimals;

    address public marketingAddress = 0x02dc23AB77460DD4AFa8dea373460E4EF8c79CB7;
    address public devAddress = 0x02dc23AB77460DD4AFa8dea373460E4EF8c79CB7;

    string private constant _name = "KOREANCAT";
    ...
    Taxes public taxes = Taxes(1,4,2,0);
    Taxes public sellTaxes = Taxes(1,4,2,0);
