...
TG: https://t.me/ZipSniperbotchannel
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x439787fa1BaBbfA7b569884f8df73C7eb60D1bDF; // owner address
...
contract ZipSniperBot is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"Zip Sniper Bot";
    string private _symbol = unicode"ZIP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x439787fa1BaBbfA7b569884f8df73C7eb60D1bDF); // Marketing Address
    address payable public teamWalletAddress = payable(0x439787fa1BaBbfA7b569884f8df73C7eb60D1bDF); // Team Address
