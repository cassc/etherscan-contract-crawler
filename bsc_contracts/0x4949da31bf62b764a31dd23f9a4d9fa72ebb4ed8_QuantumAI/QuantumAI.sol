...
contract QuantumAI is BEP20, Ownable {
    ...
    address public marketingWallet = 0x329456727c84315a0A06Ac79545162c4179507C9;
    ...
    constructor() BEP20("QuantumAI", "QuantumAI") {
        _tokengeneration(msg.sender, 100e6 * 10**decimals());
