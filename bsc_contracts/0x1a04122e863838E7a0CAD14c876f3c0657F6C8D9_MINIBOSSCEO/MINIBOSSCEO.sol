...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45D02177106Ce088D7355e9112b1E5c0CF31ac04;
...
contract MINIBOSSCEO is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x45D02177106Ce088D7355e9112b1E5c0CF31ac04;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MiniBoss CEO";
    string private _symbol = "MiniCEO";
