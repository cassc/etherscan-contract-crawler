...
contract FCDS is ERC20, Ownable {
    ...
    constructor() ERC20("FLOKI CEO DOGE SHIBA", unicode"FCDS") {
        ...
        maxTransactionAmount = 3 * 1e12 * 1e18; 
        maxWallet = 3 * 1e12 * 1e18; 
        ...
        devWallet = address(0x720B9e7D06362d537E0f9f631916C3DBCa702882); 
