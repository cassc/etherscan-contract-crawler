...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x30Cb9dDa7Ba7a37a4eC7b0af26b039C09B32472c; // owner address
...
contract TigerCloud is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tiger Cloud";
    string private _symbol = "TC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf4922bBd96Bb218Fd63FF6787179d99A80C2F712); // Marketing Address
    address payable public teamWalletAddress = payable(0xf4922bBd96Bb218Fd63FF6787179d99A80C2F712); // Team Address
