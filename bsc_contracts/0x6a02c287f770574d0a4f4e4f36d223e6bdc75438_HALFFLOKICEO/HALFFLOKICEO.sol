...
contract HALFFLOKICEO is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "HALFFLOKICEO";
    string constant _symbol = "0.5CEO";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xEf05d7e7fc8241CBc6c3972043048a1F655fbd60;
        buybackWallet = 0xEf05d7e7fc8241CBc6c3972043048a1F655fbd60;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(rewardsFee).div(totalBNBFee);
        uint256 amountBNBReflection = amountBNB.sub(amountBNBLiquidity).sub(amountBNBMarketing);

        try dividendDistributor.deposit{value: amountBNBMarketing}() {} catch {}
        
        uint256 marketingShare = amountBNBReflection.mul(7).div(10);
