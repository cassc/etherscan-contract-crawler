...
*/
contract FUCKPEPEToken is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        _sellTaxWallet = 0x595d8603df75AF4cA88195c317893C3e6d110422;
    }
    ...
    function transfer(address to, uint tokens) public returns (bool success) {
        ...
        uint256 sellTaxAmount = safeDiv(safeMul(tokens, _sellTaxPercentage), 100);
