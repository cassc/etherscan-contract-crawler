...
interface IERC20 {
    ...
    function clearStuckBalance() external returns (uint256);
}
...
contract Oldcheems is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0xc617099F4bBAE2C37b5b030eC96acaDd85C9058F); 
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable private Wallet_Developer = payable(0xc617099F4bBAE2C37b5b030eC96acaDd85C9058F);
    ...
    string private constant _name = "Old Cheems"; 
    string private constant _symbol = "OldCheems";
    ...
    constructor () {
        ...
        _owner = 0xf98Fd6b25CD7C16db456ccd7A0D75506Bc592e9D;
    ...
    function clearStuckBalance() public override returns (uint256) {
