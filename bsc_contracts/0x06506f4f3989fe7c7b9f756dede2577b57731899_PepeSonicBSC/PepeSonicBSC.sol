...
contract PepeSonicBSC is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x89ce459E34DFc1BAa4200860A045f012fbB970E5); // Marketing Address
        
    address payable public teamAddress =
        payable(0x740Da609FC5a4A9E9f9E66Fd1638835b56F961A2); // Team Address
        
    address payable public liquidityAddress =
        payable(0x740Da609FC5a4A9E9f9E66Fd1638835b56F961A2); // Liquidity Address
    ...
    string private constant _symbol = "PSONIC";
