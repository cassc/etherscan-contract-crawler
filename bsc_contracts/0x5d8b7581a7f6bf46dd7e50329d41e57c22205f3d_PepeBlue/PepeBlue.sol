...
contract PepeBlue is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xFE32f9d9D45771af905727312bCf7fA651f479Af);

    string public _name = "Pepe Blue";
    string public _symbol = unicode"PEBLUE ";
