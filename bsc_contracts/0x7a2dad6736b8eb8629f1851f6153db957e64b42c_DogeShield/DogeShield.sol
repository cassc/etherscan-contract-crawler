...
contract DogeShield is ERC20, Ownable {
    ...
    bool public DeveloperJoeyop = true;
    ...
    constructor() ERC20("DogeShield", "DogeS") {
        ...
        maxTransactionAmount = 50 * 1e8 * 1e18; 
        maxWallet = 50 * 1e10 * 1e8; 
        ...
        devWallet = address(0x429A30b62431F0cd068227451D51d671BB760E67); 
