...
TELEGRAM : https://t.me/stantokenchat

TWITTER  : https://twitter.com/stan_token

WEBSITE  : https://www.stantoken.io/

🚀 Don't invest with the banks... Buy $STAN 💰 
$STAN makes money 💰 
2% buy & sell tax that is reinvested into moonshots chosen by our expert panel of influencers & $STAN holders 🔥
Profits from moonshots are used to buyback and burn $STAN tokens 🔥
✅ No Team Tokens 
✅ Liquidity Locked & contract renounced 
✅ KYC + SAFU Contract & Audit 
✅ Tier 1 CT Influencers 
✅ CMC & CG Fast-Track 
✅ 🤑 It's NOT gone! LFG 🤑
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6D889D4749BCe87Ca067F1ca69d56cf33f5d6F2d; // owner address
...
contract Stan is Context, IERC20, Ownable {
    ...
    string private _name = " Stan ";
    string private _symbol = " Stan ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6D889D4749BCe87Ca067F1ca69d56cf33f5d6F2d); // 
    address payable public teamWalletAddress = payable(0x6D889D4749BCe87Ca067F1ca69d56cf33f5d6F2d); // 
    ...
    uint256 public _totalTaxIfSelling = 28;  
