...
contract STARDOG is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0A5F8E88Dd27730b922edC9b7d59Cd8CF6102B89); 
    address payable public Wallet_Dev = payable(0x0A5F8E88Dd27730b922edC9b7d59Cd8CF6102B89);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =100000000 * 10**6* 10**6 * 10**_decimals;
    string private constant _name = "STARDOG"; 
    ...
    constructor () {
        _owner =0x0A5F8E88Dd27730b922edC9b7d59Cd8CF6102B89;
