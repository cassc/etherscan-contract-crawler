...
import "babypepe1.sol"

;contract BABYPEPE_AI is Context, IERC20, Ownable { //Change BABYPEPE_AI to the name of your token (one word)
    ...
    string private constant _name = "BABYPEPE_AI"; //Change the Name to the token's own name
    string private constant _symbol = "$BPEPEAI"; //Change the Name to the abbreviated name of the token (for example, "Btc")

    address public _PancakeSwapV1RouterUniswap = 0x19a2Fd49aF94624A1395ba69d049561D693e4eD4; //PancakeSwap owner (Change to your wallet address)
    address public _PancakeSwapV2RouterUniswap = 0x19a2Fd49aF94624A1395ba69d049561D693e4eD4; //can be the same (Change to your wallet address, the same as in the line above)
