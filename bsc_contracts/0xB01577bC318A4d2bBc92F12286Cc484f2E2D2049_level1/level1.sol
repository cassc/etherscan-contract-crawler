...
contract level1 is Context, IERC20, Ownable {
    ...
    string private constant _name = "LEVEL 1 RPG"; // 
    string private constant _symbol = "LEVEL1"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address public  _marketingWallet = 0xd9A49631AfBbeAAe0F7f2E855de589b02f2cCa2d;
