...
/**
    ...
    ✅TrumpArmy is the V2 of TrumpCEO. Hitting a 12x and distirbuting over $130k of rewards in the first week
    V2 is needed to enable us to get CEX listings without problems.
...
contract TRUMPARMY is ERC20, Ownable {
    ...
    address public marketingAddress = address(0xB00A8703Dd034209a00B0F4260D4242ca1a1b6BD);
    ...
    constructor() payable ERC20("TrumpArmy", "TRUMPARMY") {
