...
*//*TELEGRAM:https://t.me/fifashibainubsc
 WEBSITE: www.fifashibainu.com
...
contract FifaShibaInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FifaShibaInu";
    string constant _symbol = "FSINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 2 ) / 300; // 2%
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 300; // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x6cbCc0515ad8e461Ad72839D467F053a8e91f2E1;
