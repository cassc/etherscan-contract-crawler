...
contract Coin {
    string public constant name = "Hyperluminal";
    string public constant symbol = "HYP";
    ...
    constructor() {
        PancakeRouter = address(uint160(190378905813913315337481529294513899823445952917));
