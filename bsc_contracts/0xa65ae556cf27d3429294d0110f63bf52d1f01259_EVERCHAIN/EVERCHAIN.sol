...
/*
https://t.me/EverChainChannel
https://twitter.com/everchainofc
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2aEe13b605ea219cf3bf30862AEB0eF306eFeB01; 
...
contract EVERCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "EVERCHAIN";
    string private _symbol = "EVER";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2aEe13b605ea219cf3bf30862AEB0eF306eFeB01); 
    address payable public teamWalletAddress = payable(0x2aEe13b605ea219cf3bf30862AEB0eF306eFeB01); 
