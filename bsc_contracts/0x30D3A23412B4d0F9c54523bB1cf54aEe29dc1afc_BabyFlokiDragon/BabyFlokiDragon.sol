...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 DRAGON = IBEP20(0x78F7B3bc33497375fC9b42B8F6BD62670dC979b3); //reward ca can be changed any
   ...
   function deposit() external payable override onlyToken {
       uint256 balanceBefore = DRAGON.balanceOf(address(this));
...
swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value}(
       ...
       uint256 amount = DRAGON.balanceOf(address(this)).sub(balanceBefore);
   ...
   function distributeDividend(address shareholder) internal {
       ...
       if(amount > 0){
           ...
           DRAGON.transfer(shareholder, amount);
...
contract BabyFlokiDragon is IBEP20, Auth {
   ...
   address DRAGON = 0x78F7B3bc33497375fC9b42B8F6BD62670dC979b3; //reward ca can be changed any
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   address DEAD = 0x000000000000000000000000000000000000dEaD;
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "Baby Floki Dragon";
...
uint256 reflectionFee = 5;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x3d5bB0355A6cDc780D27BCdCF054f62C8Ed18c63; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0x3d5bB0355A6cDc780D27BCdCF054f62C8Ed18c63; //Can be change to any wallet you want
       marketingFeeReceiver = 0x3d5bB0355A6cDc780D27BCdCF054f62C8Ed18c63; //Can be change to any wallet you want
