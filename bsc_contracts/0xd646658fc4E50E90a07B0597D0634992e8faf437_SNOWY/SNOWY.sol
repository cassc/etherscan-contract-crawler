...
contract SNOWY is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_Market = payable(0xadb461FdE8fD71242b6070C32258237469ebec3c);

    string public _name = "SNOWY";
    string public _symbol = "SNOWY";
