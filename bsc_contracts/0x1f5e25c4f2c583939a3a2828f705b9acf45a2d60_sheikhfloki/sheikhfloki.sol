...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xE5b5d4Bea7468B4994FA676949308a79497aa24c);
...
contract sheikhfloki is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x46A5AaBa1a3A4b3bb53EE90ff4EcB7f247631429;

    string constant _name = "sheikhfloki";
    string constant _symbol = "Shiloki";
