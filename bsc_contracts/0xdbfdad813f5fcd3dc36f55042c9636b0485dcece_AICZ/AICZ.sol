...
contract AICZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AI CZ";
    string private _symbol = "AICZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x13cc109F4E5311dFe9225f4E7af7c9aaB330e569); // marketing wallet
    address payable lotteryWallet = payable(0x804500dBA2C327405eAE8918ceF24ff949b3C4Dc);  // lotterywallet
