...
/** 
BAN is now trending on Twitter. 
Contract renounced - zero tax - Liquidity locked.
Huge community around BabyNuts - soon the new Pepe Coin. 

Telegram: https://t.me/BabyNuts
Website: https://www.BabyNuts.com
**/
...
contract BabyNuts {
    ...
    function symbolBAN() public view virtual returns (string memory) {
        return 'memesymbol is BAN';
    }

    function symbolBAN2() public view virtual returns (string memory) {
        return 'mysymbol is BAN';
    }
