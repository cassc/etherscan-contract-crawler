...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x843714121cBb4db64871e8c49b0E3dc24729685A;
...
contract OnlyAHobby is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x843714121cBb4db64871e8c49b0E3dc24729685A;
    address private _burnWallet = 0x000000000000000000000000000000000000dEaD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18; //total supply : 1 trillion tokens
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "OnlyAHobby";
    string private _symbol = "CASE";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20; //reward for holders 2%
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 0; //1% dev fee
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _liquidityFee = 10; //1% lp fee
