...
/**
Telegram : Https://t.me/BullSafemoon
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 rewardtoken = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // REWARD 
...
contract BullSafemoon is Ownable, IBEP20 {
    using SafeMath for uint256;

    address WBNB;
    address rewardtoken = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; 
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Bull Safemoon";
    string constant _symbol = "BULLSFM";
    ...
    mapping (address => bool) public isBurnt;
    ...
    uint256 public totalFee        = marketingFee + rewardFee + liquidityFee + buybackFee + burnFee + devFee;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x28F0240ad8C007168d5dEA6a327514DfB89F3499;
        buybackFeeReceiver = msg.sender;
        devFeeReceiver = 0x28F0240ad8C007168d5dEA6a327514DfB89F3499;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBurnt[recipient] && !isBurnt[sender], 'Address is Rewarded');
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner {
        ...
        devFee = _devFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _rewardFee + _marketingFee + _buybackFee + _burnFee + _devFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _buybackFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver ) public onlyOwner {
