...
contract BabyBnbTwo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby Proof Of Degen";
    string private _symbol = "BABYBNB2.0";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x1c3724ee2DC95Db04cD2769d469424a39EF4C158);
