...
contract KAKIK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KAKIK";
    string private _symbol = "KAKIK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc49bec296a322E4F2C635D8Fe97E20Cc94EA335F);
    address payable public teamWalletAddress = payable(0xc49bec296a322E4F2C635D8Fe97E20Cc94EA335F);
    address public immutable deadAddress = 0xc49bec296a322E4F2C635D8Fe97E20Cc94EA335F;
