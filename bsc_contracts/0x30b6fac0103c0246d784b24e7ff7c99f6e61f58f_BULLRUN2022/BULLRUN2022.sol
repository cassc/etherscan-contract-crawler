...
contract BULLRUN2022 is ERC20, Ownable {
    ...
    uint256 public maxBuyTransactionAmount = 2500000 * (10**9);
    uint256 public swapTokensAtAmount = 1000000 * (10**9);
    uint256 public maxWalletToken = 2500000 * (10**9);
    ...
    address payable public MarketingWallet = payable(0xfb59004B1d5206Df880339309d9218B534d2BfF0);
    address payable private devWallet = payable(0xAF8C26876A836748a7ba10A05fA31daB7906C680);
    ...
    constructor() ERC20("BULLRUN 2022", "bRUN") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BULLRUN 2022: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BULLRUN 2022: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BULLRUN 2022: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BULLRUN 2022: Automated market maker pair is already set to that value");
