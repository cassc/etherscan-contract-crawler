...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1FA160b514d2898DC91522e06B970E0288B248aC; // owner address
...
contract Tissue is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tissue";
    string private _symbol = "TISSUE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1FA160b514d2898DC91522e06B970E0288B248aC); // Marketing Address
    address payable public teamWalletAddress = payable(0x1FA160b514d2898DC91522e06B970E0288B248aC); // 
    ...
    uint256 private minimumTokensBeforeSwap = 1400 * 10**_decimals; 
