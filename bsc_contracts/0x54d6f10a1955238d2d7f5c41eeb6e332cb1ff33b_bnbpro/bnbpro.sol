...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE); // xrp Token
    ...
    function deposit() external payable override onlyToken {
        ...
        path[0] = router.WETH();
        path[1] = address(0x97749c9B61F878a880DfE312d2594AE07AEd7656);
        path[2] = address(0x654bAc3eC77d6dB497892478f854cF6e8245DcA9);
...
contract bnbpro is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "bnbpro";
    string constant _symbol = "bnbpro";
    ...
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; // pcs Router
    address RewardToken = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE; // xrp Token
