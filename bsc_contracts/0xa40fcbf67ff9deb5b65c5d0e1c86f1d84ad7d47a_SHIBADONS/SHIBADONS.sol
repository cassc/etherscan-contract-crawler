...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x49e0afB032C93928086789cBDA8BB3c6f1ffB32f; // owner address
...
contract SHIBADONS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Shiba DONS  ";
    string private _symbol = " SHIBADONS ";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x49e0afB032C93928086789cBDA8BB3c6f1ffB32f); // Marketing Address
    address payable private teamWalletAddress = payable(0x49e0afB032C93928086789cBDA8BB3c6f1ffB32f); // Team Address
    ...
    uint256 public _totalDistributionShares = 45;  // original 12
