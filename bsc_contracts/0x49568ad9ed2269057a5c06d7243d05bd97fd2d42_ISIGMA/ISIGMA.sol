...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0fa52513CE40822DDf8181E022279783A4FeB71;
...
contract ISIGMA is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x72dA9649122B83C7FEe9A3F7C608dD6042AAd168;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ISIGMA";
    string private _symbol = "ISIG";
