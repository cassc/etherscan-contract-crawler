...
contract SJ
 is Context, IERC20, Ownable {
    ...
    string private _name = " SJ";
    string private _symbol = " SHENJI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x391F34e99565a406d50827b7a3e7FA0F995B4F49);
    address payable public teamWalletAddress = payable(0x391F34e99565a406d50827b7a3e7FA0F995B4F49);
    address public immutable deadAddress =0x391F34e99565a406d50827b7a3e7FA0F995B4F49;
    ...
    uint256 public _maxTxAmount =   2023 * 10**_decimals; 
    uint256 public _walletMax =     2023 * 10**_decimals;
