...
contract Fliba is IBEP20, Auth {
    ...
    // Name and symbol
    string constant _name = "Fliba";
    string constant _symbol = "FLIBA";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 200) / 10000; // 2% on launch or 20k tokens
    uint256 public _maxSellTxAmount = (_totalSupply * 100) / 10000; // 1% or 10k tokens
    uint256 public _maxWalletToken = (_totalSupply * 200) / 10000; // 2% or 20k tokens
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc94a95a12DBDe59Fd5B11f1B09023a44E4d045F8;
        devFeeReceiver = 0x05953762fC31d07eBB915Cf3d22013896Bb3101e;
