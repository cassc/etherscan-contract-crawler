...
contract PrayOfMillionaire is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Pray Of Millionaire";
    string private _symbol = unicode"POM";

    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x0d924B8F322e8BcA152201648D0D4AF7b9b74239); 
    address payable public BurnedWalletAddress = payable(0x0d924B8F322e8BcA152201648D0D4AF7b9b74239); 
