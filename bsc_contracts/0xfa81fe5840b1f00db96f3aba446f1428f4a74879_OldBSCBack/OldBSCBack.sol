...
/**
  ...
  FOR THOSE OF YOU WHO MISS OLD BSC, LET'S BE STRONG BACK!!!
  TELEGRAM NOT READY NOW. GIVE ME 1K FOR STRONG FLOOR AND 
  I GIVE YOU BEST MARKETING IN CRYPTO CURRENCY
  ----------------------------------------------------------
  SHILL FOR 1K I BOUGHT OLD CALLERS TO TEAM THIS PROJECT
*/
...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC412b9Bb662ca9bc5CDBE5EEB5A5D0592843751c;
...
contract OldBSCBack is Context, IERC20, Ownable {
    ...
    string private constant _name = "OldBSCBack"; // 
    string private constant _symbol = "OLDFAMS"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 6;
    address payable public  _marketingWallet = payable(0xC412b9Bb662ca9bc5CDBE5EEB5A5D0592843751c);
