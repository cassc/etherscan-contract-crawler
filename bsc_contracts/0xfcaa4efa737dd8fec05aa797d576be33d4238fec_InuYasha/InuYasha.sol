...
Buy:  6% marketing, 2% LP, 0% rewards
Sell: 6% marketing, 2% LP, 0% rewards
...
contract InuYasha is IBEP20, Auth {
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 30000; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1%
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 30000; // 3%
