...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _buyLPDividendFee = 0;//NO
    uint256 public _sellLPDividendFee = 0;//NO
    uint256 public _sellFundFee = 200;
    uint256 public _sellLPFee = 0;//NO
    ...
    constructor (
        ...
        maxBuyAmount = total;
        maxSellAmount = total;
        walletLimit =  20000000000000 * 10** Decimals;
        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xA3f5E161ee49e4cCe826CF2BAba5f38651Aa40D9), block.timestamp
                );
            }
        }
    }
...
contract xinb is AbsToken {
    constructor() AbsToken(
        address(0x10ED43C718714eb63d5aA57B78B54704E256024E),//Ro
        address(0x55d398326f99059fF775485246999027B3197955),//US
        "YFIDAO",//Na
        "YFIDAO",//Sy
        18,//De
        10000000,//Su
        address(0xA3f5E161ee49e4cCe826CF2BAba5f38651Aa40D9),//
        address(0xA3f5E161ee49e4cCe826CF2BAba5f38651Aa40D9)//
    ){
    }
}