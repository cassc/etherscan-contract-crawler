...
interface IRidottoLottery is IRidottoLotteryEvents {
	...
	function setMaxBuyForOthers(uint256 _maxNumberReceiversBuyForOthers) external;

	function setMaxNumberTicketsPerBuy(uint256 _maxNumberTicketsPerBuy) external;
