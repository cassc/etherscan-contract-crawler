...
contract OmnibridgeInfo is VersionableBridge {
    ...
    {
        // The major version increased by 1 to reflect difference from
        // the original contract: the bridging of native tokens is forbidden,
        // bridge will be not maintained after some period of time
        return (4, 0, 0);
    }
...
contract ForeignOmnibridge is BasicOmnibridge, GasLimitManager {
    ...
    function bridgeSpecificActionsOnTokenTransfer(
        ...
        require(nativeToken != address(0), "Bridging of native tokens is forbidden");
