...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _sellFundFee2 = 1610;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            if (isAddLP) {
                ...
                uint256 fundAmount = tAmount * (_buyFundFee + _buyFundFee2 + _buyFundFee3 + _buyLPDividendFee + _buyLPFee + _buyBuybackFee) / 10000;
                if (fundAmount > 0) {
                ...
                uint256 fundAmount = tAmount * (_sellFundFee + _sellFundFee2 + _sellFundFee3 + _sellLPDividendFee + _sellLPFee + _sellBuybackFee) / 10000;
                if (fundAmount > 0) {
                    feeAmount += fundAmount;
                    _takeTransfer(sender, address(this), fundAmount);
                }
    ...
    function setBuyFee(
        ...
        uint256 lpDividendFee, uint256 lpFee, uint256 buybackFee
    ) external onlyOwner {
...
contract AI is AbsToken {
    constructor() AbsToken(
        ...
        address(0x7fc757e24412F945F820f7694ecE241631666666),
        "AI",
        "AI",
        18,
        6666,
        address(0xEC2B794B92D4578755DACAe5097AcC5f4Fe26137),
        address(0xEC2B794B92D4578755DACAe5097AcC5f4Fe26137),
        address(0xEC2B794B92D4578755DACAe5097AcC5f4Fe26137),
        address(0x217A24B116CC8C2EB9b73857f7255d035d9A28e6),
        10,
        0,
        10
    ){
