...
/**
TG : https://t.me/IntelligenceNetwork 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xfDd3200b33EbdAa393DA7E7d5DB996f297BF946C; // Inutube
...
contract IntelligenceNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Intelligence Network";
    string private _symbol = "InNet";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7bD496593bD0BE169cd49A023679f5EEDB1e533f); //  Marketing
    address payable public earnWalletAddress = payable(0x7bD496593bD0BE169cd49A023679f5EEDB1e533f); // Earning Pool
