...
contract QSTAKE {
    ...
    //STAKING DURATION
    uint256[4] public Duration = [2 days, 4 days, 7 days, 14 days];

    //APY BONUS IN PERCENTAGE 
    uint256[4] public Bonus = [50, 100, 300, 500];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address TKN_WBNB = 0xc4c26dE6084C7350EA3F8fE01d7824F713d00C61; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0x4D2Dd399f1BCF111bA2C760CcBb251b57e1E2d8E); // TKN Token address 
