...
Join us on this blazing journey and be a part of the next big thing in crypto.
...
contract EnjiInu is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0x6F8f83972Dbac01c128bcC3E55052BA723da9ABB));

    address private liquidityReceiver =
        0xA53A544965D645A0F2fE5B3b851f40E7A4A885ba;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = false;

    string private _name = "Enji Inu";
    string private _symbol = "ENJI";
    uint8 private _decimals = 9;

    uint256 public _maxTxAmount = 20000000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 2154875457 * 10**9;
    ...
    event SwapAndLiquify(
        ...
        payable(address(0xA53A544965D645A0F2fE5B3b851f40E7A4A885ba));
