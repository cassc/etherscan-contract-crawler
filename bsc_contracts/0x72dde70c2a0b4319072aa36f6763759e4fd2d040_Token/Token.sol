...
/**
TELEGRAM : https://t.me/crazywhalebsc
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Crazy Whale";
    string private _symbol = "CRAZYWHALE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf8660DB1381a6984CF9599449245F7ff98615730); // Marketing Address
    address payable public teamWalletAddress = payable(0x4095E2898D4484AC44FD6784c9E23586e4DD0fa9); // Team Address
    ...
    uint256 private _totalSupply = 10000000000* 10**6* 10**6 * 10**_decimals;
    uint256 public _maxTxAmount = 10000000000* 10**6 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 10000000000* 10**6 * 10**6* 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 10000000000* 10**6* 10**_decimals; 
