...
/**
 ...
 Telegram : https://t.me/DOGEBREADOFFICIAL

 Website : https://dogebread.webflow.io/
...
contract Dogebread is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x91Ff11Ec0666eA9fAB3bBB94e9aDA28B3594d641); 
    address payable public Wallet_Utility = payable(0x44cA25d77A48cdf802aA31EE0E1373Ec32C3eB26);
    ...
    uint256 private _tTotal = 30* 10**6 * 10**_decimals;
    string private constant _name = "DogeBread"; 
    string private constant _symbol = unicode"DOGEBREAD";
    ...
    constructor () {
        ...
        _owner = 0x44cA25d77A48cdf802aA31EE0E1373Ec32C3eB26;
