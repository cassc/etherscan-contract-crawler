...
/**                                                                                                                                                              
   ...
   #Binance was reported, and millions of investors in crypto got hurt, will you wait for the #Binance team's stupid plan or join and create a new #Bnb community to give it a second new life?                                        
                                                                                                            
   TG GROUP；https://t.me/newcommunitybnbbsc
    */
/**
*/
...
contract cBnb is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "New Community Bnb";
    string private _symbol = "cBnb";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x38326226b6F36996256172b2516D614E3A8eFf12);
