...
contract PepeGrow is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x5dBB9F8f2E64C8E60208566389735011d8ED01bC;
    address private feeTwo = 0x6d9Bc04A14DcA60466a818D253A7342577eFd00e;    
    mapping(address => uint256) private _balances;
    mapping(address => bool) private _taxes;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "PepeGrow";
    string private _symbol = "PepeGrow";
