...
contract TwoBrother is ERC20, Ownable {
    ...
    constructor() ERC20("TwoBrother", "TBR") {
        _mint(msg.sender, 1000000000000 * 10**decimals());

        marketingFeeAddress = payable(
            0x5BF7C733e2513Bac4b8a7e4ba842B20D190eD61b
        );
        stakingFeeAddress = payable(0x4c2c5fE4AD970eC180e9ad64A9ffBc652192a819);
        ...
        bridgeAddress = 0x7b4EC53e0D5a7294Bd81A87b35e746fBbE2114eC;
