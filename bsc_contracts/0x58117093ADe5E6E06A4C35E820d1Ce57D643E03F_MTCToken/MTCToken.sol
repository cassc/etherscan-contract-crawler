...
contract MTCToken is ERC20, Ownable {
    ...
    constructor(
        ...
        swapTokensAtAmount = totalSupply.mul(2).div(10**5);
    ...
    function _transfer(
        ...
        if(amount == 0 || swapping || _isExcludedFromFees[from] || _isExcludedFromFees[to]) { super._transfer(from, to, amount); return;}
        ...
        if( contractTokenBalance >= swapTokensAtAmount &&
            ...
            swapping = true;
            swapTokensForUSDT(contractTokenBalance, lpRewardReceiveAddress);
            swapping = false;
        }
