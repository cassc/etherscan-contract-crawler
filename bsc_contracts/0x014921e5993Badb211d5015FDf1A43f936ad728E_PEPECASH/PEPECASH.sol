...
/**
 *https://t.me/bscpepecash
 *PEPECASH 7 % BUSD Rewards
*/
...
contract PEPECASH is IERC20, tokenStaking, Ownable {
    ...
    address internal development_receiver = 0xbCDAAD7BE9106eF18D7921e6372FD552fEc9F8eF; 
    address internal marketing_receiver = 0xbCDAAD7BE9106eF18D7921e6372FD552fEc9F8eF;
    address internal liquidity_receiver = 0xbCDAAD7BE9106eF18D7921e6372FD552fEc9F8eF;
    address internal staking_receiver = 0xbCDAAD7BE9106eF18D7921e6372FD552fEc9F8eF;
    address internal token_receiver = 0xbCDAAD7BE9106eF18D7921e6372FD552fEc9F8eF;
    ...
    function setStructure(uint256 _liquidity, uint256 _marketing, uint256 _token, uint256 _development, uint256 _staking, uint256 _total, uint256 _sell, uint256 _trans) external onlyOwner {
        ...
        RewardFee = _development; totalFee = _total; sellFee = _sell; transferFee = _trans;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        uint256 _denominator = (liquidityFee.add(1).add(marketingFee).add(RewardFee).add(stakingFee)).mul(2);
