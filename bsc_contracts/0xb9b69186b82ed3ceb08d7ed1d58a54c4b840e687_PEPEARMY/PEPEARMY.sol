...
contract PEPEARMY is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PEPEARMY";
    string private _symbol = "PEPEARMY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xaE8dB01A64E28fbaa338A8e1337b239817C1C5ff); // Marketing Address
    address payable public teamWalletAddress = payable(0xaE8dB01A64E28fbaa338A8e1337b239817C1C5ff); // Team Address
