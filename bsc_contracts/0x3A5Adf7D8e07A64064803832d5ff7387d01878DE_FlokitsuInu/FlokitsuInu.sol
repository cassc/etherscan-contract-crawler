...
contract FlokitsuInu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Flokitsu Inu"; 
    string private constant _symbol = "FLOKITSU";
    ...
    Tax public buyTax = Tax(5,0,2);
    Tax public sellTax = Tax(5,0,2);
    
    address public treasuryWallet = 0xaA0b9dBe6AA5Cf8Fa20cB573be23e58Db06C3ba2;
    address public devWallet = 0xaA0b9dBe6AA5Cf8Fa20cB573be23e58Db06C3ba2;
...
//============== Owner Functions ===========//
    ...
    function owner_setSellTaxes(uint8 marketingTax, uint8 devTax, uint8 lpTax) external onlyOwner{
        uint tTax = marketingTax + devTax + lpTax;
        require(tTax <= 50, "Can't set tax too high");
