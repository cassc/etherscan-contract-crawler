...
contract PepeClub is Context, IERC20, Ownable {
    ...
    constructor() {
        _name = "Pepe Club"; //  Name
        _symbol = "PepeClub"; //  Symbol
        _decimals = 18; //  Decimal 
        _tTotal = 1000000000000 * 10**_decimals; // total supply 
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 15000000000 * 10**_decimals;  // 0.5% of total supply
        _maxTxAmount = 30000000000 * 10**_decimals; // 3% of total supply
        _maxWalletBalance = 30000000000 * 10**_decimals; // 3% of total supply
        _marketingWalletAddress = 0xA93D4dF73970DD11CDC4Ef8782FD0E5C31723ec1; // Marketing wallet 
        _devWalletAddress = 0x9504f7de208292d10fCfb1dBC04Bab32a092b27c; // Dev wallet 
