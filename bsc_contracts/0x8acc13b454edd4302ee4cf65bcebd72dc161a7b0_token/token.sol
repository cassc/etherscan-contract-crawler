...
contract token is ERC20 {
    ...
    string internal tokenName = "QJDAO";
    string internal tokenSymbol = "QJDAO";
    uint256 constant total  =  10000000 * 10**18;
    address public marketAddress = address(0xc4366811EFf57b0b6eaD1837CE2E7Ce728522F9E);
    uint256 buyFee = 20;
    uint256 sellFee = 970;
