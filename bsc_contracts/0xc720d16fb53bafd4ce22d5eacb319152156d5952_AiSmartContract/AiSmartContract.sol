...
/**
    ...
    Telegram: https://t.me/AiSmartContract

    Twitter: https://twitter.com/AlSmartContract
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x85cd5a4b3D5DD63417bFDE2761ef9062dc233cfe; // owner address
...
contract AiSmartContract is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = " Ai Smart Contract ";
    string private _symbol = "AISMARTCONTRACT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x85cd5a4b3D5DD63417bFDE2761ef9062dc233cfe); // Marketing Address
    address payable public teamWalletAddress = payable(0x85cd5a4b3D5DD63417bFDE2761ef9062dc233cfe); // Team Address
