...
contract test is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    string private constant _symbol = "TEST12";
    ...
    // Total Supply
    uint256 public constant _totalSupply = 10**7 * _DECMULTIPLIER;
    ...
    uint256 public maxBag = _totalSupply * 1 / 100;
    ...
    //Tax wallets
    address public teamWallet = 0xD36312dFD078416c94F8bE76F5BE98c80Bfe2f59;
    address public treasuryWallet = 0xD36312dFD078416c94F8bE76F5BE98c80Bfe2f59;

    // Tax Split
    uint256 public teamShare = 0;
    uint256 public treasuryShare = 900;
    uint256 public rewardShare = 0;
    ...
    //trading parameters
    uint256 public liquidity = 400000*10**_srgDecimals;
