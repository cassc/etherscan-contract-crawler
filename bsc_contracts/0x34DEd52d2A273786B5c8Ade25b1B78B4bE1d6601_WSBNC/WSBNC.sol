...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x283858C0dFe84956fE7070cfc93fB891A16e2669; // owner address
...
contract WSBNC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WSB New Community Coin";
    string private _symbol = "$WSBNC";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x188F5dBF8FD15CF6E14DCD490B7dB99eE8243226); // Marketing Address
    address payable private teamWalletAddress = payable(0x283858C0dFe84956fE7070cfc93fB891A16e2669); // Team Address
