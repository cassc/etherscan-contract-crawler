...
contract DigimonAI is IBEP20, Auth {
    ...
    string constant _name = "DigimonAI ";
    string constant _symbol = "DAI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 420000000000000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9f505Ba01fc18Caf3D59e394B304A2EAb912D6e2;
