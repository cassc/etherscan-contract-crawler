...
abstract contract Ownable {
    ...
    constructor () {
        address msgSender = 0x636F879679a4C776aE54c34484F3f464C5c78F1F;
        _owner = msgSender;
...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public partnerAddress = address(0x0dBEc7E0AA0f0c604f2514d670788E63E6c8a6D7);
    ...
    uint256 public _partnerFee = 100;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            uint256 swapFee = _fundFee + _partnerFee;
            ...
            if (_swapPairList[recipient]) {
                if (!inSwap) {
                    ...
                    uint256 numTokensSellToFund = holderRewardCondition;
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        USDT.transferFrom(tokenDistributor, partnerAddress, usdtBalance - fundUsdt);
    }
    ...
    function setPartnerFee(uint256 fee) external onlyOwner {
        _partnerFee = fee;
    }
...
contract FZM is AbsToken {
    ...
    //USDT
        ...
        1199,
    //Fund
        address(0xD2EdE92cfE885dcd55C96Fbd3869AeD6979d4b6D),
    //Receive
        address(0xD77Bb06333bAA9F03a2918E483B9664776C71D69)
    ){
