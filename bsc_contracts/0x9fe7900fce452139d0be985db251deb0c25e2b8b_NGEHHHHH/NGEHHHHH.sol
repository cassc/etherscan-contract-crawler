...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEd4658B2C4D53186C1eC8483DCe4A6c7F29aFE24; // owner address
...
contract NGEHHHHH is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NGEHHHHH";
    string private _symbol = "NGEHE";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xEd4658B2C4D53186C1eC8483DCe4A6c7F29aFE24); // Marketing Address
    address payable private teamWalletAddress = payable(0xEd4658B2C4D53186C1eC8483DCe4A6c7F29aFE24); // Team Address
    ...
    function ngentot(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
