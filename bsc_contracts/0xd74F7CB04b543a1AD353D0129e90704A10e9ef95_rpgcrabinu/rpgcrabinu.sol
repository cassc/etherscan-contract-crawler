...
contract rpgcrabinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RPG CRAB INU";
    string private _symbol = "CRABINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0ea1070C2362629170C7F0081197dF3690dF84Cc);
    address payable public teamWalletAddress = payable(0x0ea1070C2362629170C7F0081197dF3690dF84Cc);
