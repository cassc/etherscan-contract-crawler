...
// BASED OF SHYTOSHI NEW TWEET WOOF
// PORTAL: https://t.me/WoofPortal
...
contract WOOF is IBEP20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "WOOF";
    ...
    uint256 private buyCharityFee = 3;
    uint256 private buyTotalFee = buyDevFee + buyMarketingFee + buyCharityFee;

    //Sell Fees Variables
    uint256 private sellDevFee = 5;
    uint256 private sellMarketingFee = 10;
    uint256 private sellCharityFee = 5;
    uint256 private sellTotalFee = sellDevFee + sellMarketingFee + sellCharityFee;

    //Max Transaction & Wallet
    uint256 public _maxTxAmount = _totalSupply * 150 / 10000; //Initial 1.5%
    uint256 public _maxWalletSize = _totalSupply * 200 / 10000; //Initial 2%

    // Fees Receivers
    address public devFeeReceiver = 0xE92FA7F9AB7Bf03DaEb9eFa0Dd4D4d3EdbEc8C4d;
    address public marketingFeeReceiver = 0xE92FA7F9AB7Bf03DaEb9eFa0Dd4D4d3EdbEc8C4d;
    address public charityFeeReceiver = 0xE92FA7F9AB7Bf03DaEb9eFa0Dd4D4d3EdbEc8C4d;
