...
contract zkSui is Context, IERC20, Ownable {
    ...
    string private _name     = "zkSui";
    string private _symbol   = "zkSui";
    ...
    { 
        ...
        marketingWallet = 0x0aFA1B2f0CE687111451Fdc1a39A8EcE4E581dd6;
        ...
        _isExcludedFromFees[address(0x0aFA1B2f0CE687111451Fdc1a39A8EcE4E581dd6)] = true;
        _isExcludedFromFees[address(0x0aFA1B2f0CE687111451Fdc1a39A8EcE4E581dd6)] = true; //pinklock

        _isExcluded[address(this)] = true;
        _isExcluded[address(0x0aFA1B2f0CE687111451Fdc1a39A8EcE4E581dd6)] = true; //pinklock
        _isExcluded[address(DEAD)] = true;
        _isExcluded[address(uniswapV2Pair)] = true;

        _rOwned[address(0x0aFA1B2f0CE687111451Fdc1a39A8EcE4E581dd6)] = _rTotal;
        _tOwned[address(0x0aFA1B2f0CE687111451Fdc1a39A8EcE4E581dd6)] = _tTotal;

        emit Transfer(address(0), address(0x0aFA1B2f0CE687111451Fdc1a39A8EcE4E581dd6), _tTotal);
    }
