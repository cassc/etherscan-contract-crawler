...
contract ShibaMaximusToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiba Maximus"; //
    string private constant _symbol = "SMX"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x404F34EE32Fe0aCE940722BEE71EcA0aA81E0613;
