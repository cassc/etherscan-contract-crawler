...
https://t.me/EiffelCoinofficial

Join this project and MOOON
...
contract EIFFELCOIN is IBEP20, Ownable {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "EIFFELCOIN"; // 
    string constant _symbol = "EFL"; // 
    ...
    uint256 public _maxBuyTxAmount = _totalSupply / (100) * (20); // 20%
    uint256 public _maxSellTxAmount = _totalSupply / (100) * (2); // 2%
    uint256 public _maxWalletToken = _totalSupply / (100) * (40); // 40%

    // Fees receivers
    address private autoLiquidityReceiver = 0xCACA3E4850Fe649cEf63E4D76eA7cd4Aa92FfaC6; //LP receiver
    address private marketingFeeReceiver = 0xCACA3E4850Fe649cEf63E4D76eA7cd4Aa92FfaC6; //mkt
    address private devFeeReceiver = 0xCACA3E4850Fe649cEf63E4D76eA7cd4Aa92FfaC6; //31 BuyBack
    address private teamFeeReceiver = 0xCACA3E4850Fe649cEf63E4D76eA7cd4Aa92FfaC6; //32 
