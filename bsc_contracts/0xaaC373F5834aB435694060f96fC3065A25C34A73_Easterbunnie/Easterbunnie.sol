...
/**
https://t.me/EasterBunnieOffical                                                                                                                                                                                              
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); //BTC
...
contract Easterbunnie is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "Easter Bunnie";
    string  _symbol = "$EB";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 500 * 10**3 * 10**_decimals;
    ...
    uint256 public swapThreshold = _totalSupply * 865 / 10000;
    bool inSwap;
    ...
    constructor () {
       router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        marketingFeeReceiver = 0x2992876A41ccDcd5f5c96c1904Dd81fDe6736BCF;
        teamFeeReceiver = 0x2992876A41ccDcd5f5c96c1904Dd81fDe6736BCF;
        devFeeReceiver = 0x2992876A41ccDcd5f5c96c1904Dd81fDe6736BCF;
