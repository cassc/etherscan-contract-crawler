...
/* Token contract */
contract UPRISE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address CALLS = 0xE76353Dae9453fE3a37E940CBe15f2E1d9A51E5A;
    ...
    // Name and symbol
    string constant _name = "UPRISE";
    string constant _symbol = "UP";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10Mil 
