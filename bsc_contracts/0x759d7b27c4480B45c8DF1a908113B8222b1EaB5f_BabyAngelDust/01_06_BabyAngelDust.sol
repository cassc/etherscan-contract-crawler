...
contract BabyAngelDust is IERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "baby Angel Dust";
    string constant _symbol = "bAD";
    ...
    address public marketingFeeReceiver = 0xE25FF1396B0aD1220C3EDdc4D239Bc534CF290f9;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0xE25FF1396B0aD1220C3EDdc4D239Bc534CF290f9] = true;
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0xE25FF1396B0aD1220C3EDdc4D239Bc534CF290f9] = true;
