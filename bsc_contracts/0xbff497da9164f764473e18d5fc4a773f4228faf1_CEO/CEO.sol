...
contract CEO is Context, IERC20, Ownable {
    ...
    string private _name = "CEO INU";
    string private _symbol = "$CEO";
    uint8 private _decimals = 9;

    address payable public MarketingWallet = payable(0x0a4157be593111F7E80871106502b0e3306b7f40); // Marketing Address
    address payable public BuyBackWallet = payable(0x0a4157be593111F7E80871106502b0e3306b7f40); // Team Address
