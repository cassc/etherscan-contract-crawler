...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6E1CDF5FA4bDa17Ebd35AcCe0Dc47336d7822334; // owner address
...
contract AIBONK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AI BONK!";
    string private _symbol = "AIBONK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6E1CDF5FA4bDa17Ebd35AcCe0Dc47336d7822334); // Marketing Address
    address payable public teamWalletAddress = payable(0x6E1CDF5FA4bDa17Ebd35AcCe0Dc47336d7822334); // Team Address
