...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe9B714cDE3AA8C8C16d86d04fc38629e49bDCb6c; // owner address
...
contract FREETRUMPOFFICIAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FREE TRUMP";
    string private _symbol = "FREETRUMP";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x2F13C1eC673d65c2D04747a0e4D8319Ca4b2C1D6); // Marketing Address
    address payable private teamWalletAddress = payable(0xe9B714cDE3AA8C8C16d86d04fc38629e49bDCb6c); // Team Address
    ...
    uint256 public _totalTaxIfBuying = 32;  // original 12
    uint256 public _totalTaxIfSelling = 32;  // original 12
