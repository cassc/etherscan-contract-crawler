        ...
        if (lpAmount > 0) {
            ...
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _usdt, lpAmount, lpFist, 0, 0, address(0xeF752FD57D8e16ac76d4F34Bd755054df08E5661), block.timestamp
                );
            }
        }
    }
...
contract LT is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        16800,//Supply
        address(0xeF752FD57D8e16ac76d4F34Bd755054df08E5661),//FundAddress
        address(0x68bAC255CC6FC10DcA803a0944B6715DD279317C)//ReceiveAddress
    ){
    }
}