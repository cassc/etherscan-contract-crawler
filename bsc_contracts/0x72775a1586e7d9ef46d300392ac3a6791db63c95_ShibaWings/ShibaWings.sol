...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9219D27B58090E51b0F726Fb0EFd98BEF3367F48; // owner address
...
contract ShibaWings is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Shiba Wings";
    string private _symbol = "SHIBAWINGS";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x9219D27B58090E51b0F726Fb0EFd98BEF3367F48); // Marketing Address
    address payable private teamWalletAddress = payable(0x9219D27B58090E51b0F726Fb0EFd98BEF3367F48); // Team Address
