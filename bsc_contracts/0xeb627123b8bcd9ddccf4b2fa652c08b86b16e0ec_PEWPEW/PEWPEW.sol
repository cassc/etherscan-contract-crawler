...
contract PEWPEW is Context, IERC20, Ownable {
    ...
    string private _name = "PEwPEw";
    string private _symbol = "PEwPEw";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0d2D4Ce6E96B094d58f7EF332e9C3c9f7e68351d); 
    address payable public buyBackWalletAddress = payable(0x488158795FBA9371b55EBFd7d4260334b050b0f0); 
    ...
    uint256 private _totalSupply = 420000000000 * 10**9;
    uint256 public _maxTxAmount = 4200000000 * 10**9; 
    uint256 public _walletMax = 16800000000 * 10**9; 
    uint256 private minimumTokensBeforeSwap = 25200000 * 10**9; 
