...
contract CEO is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 15e2 * 10e18;
    
    address public marketingWallet = 0x7774Df936feE7ea97119a7b561a4f46a64Fc22de;
    ...
    Taxes public sellTaxes = Taxes(5,1,0);
    ...
    constructor() ERC20("TESTE CAPITAL", "TESTE") {
        _mint(msg.sender, 420e12 * 10 ** decimals());
