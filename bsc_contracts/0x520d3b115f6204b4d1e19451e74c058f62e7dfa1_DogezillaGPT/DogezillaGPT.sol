...
contract DogezillaGPT is Context, IERC20, Ownable {
    ...
    string private constant _name = "DogeZilla GPT";
    string private constant _symbol = "DZGPT";
