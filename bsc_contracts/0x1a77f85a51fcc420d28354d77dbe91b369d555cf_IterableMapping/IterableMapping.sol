...
*/
/**
 𝑻𝑯𝑬 𝑴𝑬𝑴𝑬 𝑶𝑭 𝑴𝑬𝑴𝑬𝑺 𝑻𝑯𝑬 𝑭𝑨𝑽𝑶𝑹𝑰𝑻𝑬 𝑶𝑭 𝑻𝑯𝑬 𝑪𝑶𝑴𝑴𝑼𝑵𝑰𝑻𝑰𝑬𝑺 𝑻𝑯𝑬 𝑼𝑵𝑩𝑬𝑨𝑻𝑨𝑩𝑳𝑬 𝑫𝑶𝑮 𝑶𝑭 𝑬𝑳𝑶𝑵 𝑴𝑼𝑺𝑲
*/
/**
     Telegram : https://t.me/ElonFlokiCeoOfficial
     Twitter : https://twitter.com/ELON_FLOKI_CEO
     Instagram : https://www.instagram.com/elonflokiceo
     Website  : https://www.elonflokiceo.com
     Contact : [email protected]
     Hold Elon Floki CEO, Earn $BUSD
    */
...
contract ElonFloki is ERC20, Ownable {
    ...
    constructor() payable ERC20("Elon Floki CEO", "ElonFloki") {
        ...
        marketingWallet = 0x2e6312DA7541e67bfa5d945aD200043A6e28fB68;
        ...
        transferOwnership(address(0x655776fC999B3Ece67d6124952FEdB598481A35d));
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _rewardsFeeOnBuy, uint256 _trueBurnFeeOnBuy) external onlyOwner {
        ...
        require(totalBuyFee <= 20, "Buy fee cannot be more than 20%");
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _rewardsFeeOnSell, uint256 _trueBurnFeeOnSell) external onlyOwner {
        ...
        require(totalSellFee <= 20, "Sell fee cannot be more than 20%");
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        uniswapV2Router.addLiquidityETH{value: newBalance}(
            ...
            0, // slippage is unavoidable
            address(0x2e6312DA7541e67bfa5d945aD200043A6e28fB68),
            block.timestamp
        );
