...
/**
Telegram : https://t.me/rapperspepe
Website : http://peperap.cryptobsc.trade/
Twitter : https://twitter.com/rapperspepe
*/
...
contract rapperspepe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "RAPPERS PEPE";
    string private _symbol = "PEPERAP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2A87434460917569F0eA31bBb311bCFB711889fd); // Marketing Address
    address payable public buybackWalletAddress = payable(0x2A87434460917569F0eA31bBb311bCFB711889fd); // buyback Address
    ...
    uint256 public _walletMax = 15 * 10**6 * 10**18;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (500 * 10**6 * 10**18), "Max wallet should be less or euqal to 5% totalSupply");
