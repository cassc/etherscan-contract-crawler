...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x35b0D73Ac104B16B35344e2aE47Dd5F9893e317B; // owner address
...
contract Boruto is Context, IERC20, Ownable {
    ...
    string private _name = "Boruto";
    string private _symbol = "Boruto";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x35b0D73Ac104B16B35344e2aE47Dd5F9893e317B); // Marketing Address
    address payable public teamWalletAddress = payable(0x35b0D73Ac104B16B35344e2aE47Dd5F9893e317B); // Team Address
