...
contract LiberaMiner2_upgradeable_v1 is Initializable, UUPSUpgradeable, AuthUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        ...
        AUTO_CONTRACT = IAutoMiner(0x925fE9068B55bce6Eed454ccD6d53Bf5C32c1304); //todo: add auto contract here
        ...
        MIN_INVEST_LIMIT = 5 * 1e18; // 1 LP ~ 1.2 usd
        WALLET_DEPOSIT_LIMIT = 50000000000000000000000 * 1e18; /** 50000 LP ~ 60000 usd **/
        ...
        ZERO_STEP = COMPOUND_STEP + 1 * 3600; //1 hours later

        WITHDRAW_TAX = 200; // 20%
        WITHDRAW_LIMIT = 2000 * 1e18; // 2000 LP ~ 2400 usd
        ...
        AUTO_MIN_DEPOSIT = 1000 * 10**18; // 60 LP ~ 1200 usd
        WHALE_TAX_MULTIPLIER=5;

        BIGGEST_BUYER_PERCENTAGE = 5; // 0.5%
        ...
        //to do: every thing
        marketEggs = 900117670140813;
        totalStaked = 1502946368667604529006167;
        totalUsers = 4127;
        totalCompound = 3405111833143812257152837;
        totalRefBonus = 118469668631135735736299;
        totalWithdrawn = 371744948697629656394780;
        totalTaxWithDrawn = 133186814846459587005147;
        totalMinersAdjusted = 10468486;
        totalAutoPaid = 101962683672501732159630;
