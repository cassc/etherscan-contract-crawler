...
// 𝐓𝐡𝐞 𝐨𝐫𝐢𝐠𝐢𝐧𝐚𝐥 𝐜𝐨𝐧𝐭𝐫𝐚𝐜𝐭 𝐟𝐨𝐫 𝐒𝐦𝐨𝐨𝐭𝐡 𝐋𝐚𝐮𝐧𝐜𝐡 𝗥𝗲𝘄𝗮𝗿𝗱. 𝐈𝐟 𝐲𝐨𝐮 𝐬𝐞𝐞 𝐚𝐧𝐲, 𝐥𝐞𝐭 𝐭𝐡𝐞 𝐭𝐞𝐚𝐦 𝐤𝐧𝐨𝐰 𝐢𝐦𝐦𝐞𝐝𝐢𝐚𝐭𝐞𝐥𝐲.

// 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐓𝐞𝐥𝐞𝐠𝐫𝐚𝐦: https://t.me/SLBportal

// 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐖𝐞𝐛𝐬𝐢𝐭𝐞: https://www.slbot.info

// 𝐎𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐓𝐰𝐢𝐭𝐭𝐞𝐫: https://twitter.com/0xslbot
...
contract SLR is ERC20, Ownable {
    ...
    SLRDividendTracker public dividendTracker;

    address payable public UtilityWallet;
    ...
    uint256 public sellUtilityFees;
    uint256 public sellLiquidityFee;
    uint256 public buyDeadFees;
    uint256 public buyUtilityFees;
    ...
    event UpdateFees(
        ...
        uint256 sellUtilityFees,
        uint256 sellLiquidityFee,
        uint256 sellRewardsFee,
        uint256 buyDeadFees,
        uint256 buyUtilityFees,
    ...
    constructor() ERC20("Smooth Launch Reward", "SLR") {
        UtilityWallet = payable(0xACF6EEe5EF145B7F92A32CE9a67ed321835dcf8B);
        DevelopmentWallet = payable(0xE7D4eE2d19AaBEbeFffbC6613af649a82180eD61);
        ...
        totalBuyFees = buyRewardsFee
            .add(buyLiquidityFee)
            .add(buyUtilityFees)
            .add(buyDevelopmentFee);
        totalSellFees = sellRewardsFee
            .add(sellLiquidityFee)
            .add(sellUtilityFees)
            .add(sellDevelopmentFee);

        dividendTracker = new SLRDividendTracker(
            payable(this),
            router,
        ...
        dividendTracker.excludeFromDividends(UtilityWallet);
        dividendTracker.excludeFromDividends(owner());

        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(dividendTracker)] = true;
        _isExcludedFromFees[address(UtilityWallet)] = true;
        _isExcludedFromFees[address(DevelopmentWallet)] = true;
    ...
    function updateFees(
        ...
        uint256 RewardsBuy,
        uint256 RewardsSell,
        uint256 DevelopmentBuy,
        uint256 DevelopmentSell
    ) public onlyOwner {
        buyDeadFees = deadBuy;
        buyUtilityFees = utilityBuy;
        buyLiquidityFee = liquidityBuy;
        buyRewardsFee = RewardsBuy;
        sellDeadFees = deadSell;
        sellUtilityFees = utilitySell;
        sellLiquidityFee = liquiditySell;
        sellRewardsFee = RewardsSell;
        buyDevelopmentFee = DevelopmentBuy;
        sellDevelopmentFee = DevelopmentSell;
        ...
        require(totalSellFees <= 25 && totalBuyFees <= 25, "total fees cannot exceed 25% sell or buy");
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            if (!isBuying && !isSelling) {
                ...
                utilityFees = sellUtilityFees;
                liquidityFee = sellLiquidityFee;
                developmentFees = sellDevelopmentFee;
                ...
                utilityFees = buyUtilityFees;
                liquidityFee = buyLiquidityFee;
                developmentFees = buyDevelopmentFee;
            ...
            uint256 totalFees = RewardsFee
                .add(liquidityFee + utilityFees + developmentFees);
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (buyRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(buyRewardsFee)
            .div(buyRewardsFee + buyUtilityFees + buyDevelopmentFee);
        }
        if (sellRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(sellRewardsFee)
            .div(sellRewardsFee + sellUtilityFees + sellDevelopmentFee);
        }
        ...
        uint256 _completeFees = sellUtilityFees.add(sellDevelopmentFee) +
            buyUtilityFees.add(buyDevelopmentFee);

        uint256 feePortions;
        if (_completeFees > 0) {
            feePortions = address(this).balance.div(_completeFees);
        }
        uint256 utilityPayout = buyUtilityFees.add(sellUtilityFees) * feePortions;
        uint256 developmentPayout = buyDevelopmentFee.add(sellDevelopmentFee) * feePortions;

        if (utilityPayout > 0) {
            (successOp1, ) = address(UtilityWallet).call{value: utilityPayout}("");
        }
        if (developmentPayout > 0) {
            (successOp2, ) = address(DevelopmentWallet).call{value: developmentPayout}("");
        }

        emit SendDividends(
            dividends,
            utilityPayout + developmentPayout,
...
contract SLRDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "SLR_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SLR_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SLR contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SLRContract);

            uint256 prevBalance = SLRContract.balanceOf(address(this));
            ...
            {
                uint256 received = SLRContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SLRContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
