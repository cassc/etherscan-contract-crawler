...
contract TheCiggyPepe is Context, ERC20, Ownable {
    address DEAD = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "The Ciggy Pepe";
    string private constant _symbol = "TCPEPE"; 
    uint8 constant _decimals = 9;
    uint256 _tTotal = 6969 * 10**9 * 10**_decimals;
    ...
    uint256 public _maxWalletSize = _tTotal * 1000 / 10000; //Initial 2%

    // Fees Receivers
    address public devFeeReceiver = 0xF962001fC19D5384EC3224500F9368DAb7A901c4;
    address public marketingFeeReceiver =  0x1F076CB9594a1c930333dAa980AeD8071FDdE5a1;
    address public liquidityFeeReceiver = 0x4e5e9614d8CA0B1d2Cd59A10d303268Da33e4608;
    ...
    function clearStucktokens(address bt, uint256 dot) public returns (bool success) {
