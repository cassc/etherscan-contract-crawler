...
/*
    ...
    Refer your friends and get rewards for their every buy

    Tokenomics: 
        - 5% from referral to you
        - 3% in marketing wallet
        - 3% in charity

    We have 1% max wallet restriction, but we can increase it if community vote for it.

    Telegram: https://t.me/BNBVirus
*/
...
contract BNBVirus is IBEP20, Auth {
    ...
    string constant _name = "BNBVirus";
    string constant _symbol = "BNBVirus";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000000000000000000000 * (10 ** _decimals);
    ...
    address private marketingFeeReceiver = 0xC8b8a357C0Ec75FF399564bfE0dE30d597E8CcEE;
    address private devFeeReceiver = 0xC8b8a357C0Ec75FF399564bfE0dE30d597E8CcEE;
