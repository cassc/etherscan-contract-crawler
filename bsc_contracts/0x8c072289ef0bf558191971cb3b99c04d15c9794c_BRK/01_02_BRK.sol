 ...
 * ██████╦╝██║░░██║███████╗███████╗  ██║░░██║██║░░██║╚█████╔╝██║██║░╚███║╚██████╔╝
 * ╚═════╝░╚═╝░░╚═╝╚══════╝╚══════╝  ╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░╚═╝╚═╝░░╚══╝░╚═════╝░
 * https://ballracingk.com
 * Ball Racing K Game
 * 
 * "Ball Racing K" is a project for demanding players. The 100 balls that make up the incredible Ball Racing K run around the circuit 
 * randomly creating constant excitement and authentic randomness.
 * 
 * For those fans of games of AZAR, Ball Racing arrives offering 
 * all the excitement in a single race, live, where anything can be possible.
 * 
 * Do you want to know more about Ball Racing K? Are you a true fan of gambling? 
 * Do you think you will win the jackpot? Join this incredible community 
 * that in a short time has reached the 5 continents.
 * 
 * Ball Racing K, your craziest and most frenetic racing game
 * that will make you enjoy chance like never before.
 * 
 * Fees Proyect Ball Racing K
 * 
 * LP           2%
 * Holders      1%  
 * Burn         1%
 ...
 *
 * Project wallets:
 *  DEV:       0x8cfF8723c64c1E195643ce23580d3037fcaBC1df
 *  MARKETING: 0xFAA8E310141143CC05c0034fEd99B39D86891e16
 * 
 * Total FEEs in purchase and sale ( Slippage ): 5%
 * 
 * You can make any questions about the services directly with Ball Racing K Game through: 
 * 
 */

import "./BRK-imports.sol";

/**
 * Thank you for trusting the Ball Racing K Game project. 
 */
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Ball Racing K";
    string internal constant SYMBOL = "BRK";
    ...
    uint256 internal constant TOTAL_SUPPLY = 140000000000 * ZEROES;
    ...
    // --------------------- Fees Settings Ball Racing K Game ------------------- //

    /**
     * 
     */

    address internal marketing = 0xFAA8E310141143CC05c0034fEd99B39D86891e16;
