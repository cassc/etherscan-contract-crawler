...
📈Renounce 📈
📈Tax 3% 📈
CA : 0x96Ba3738894175100bA8b072A35e1aA0D345Ba71
Charts : https://poocoin.app/tokens/0x96Ba3738894175100bA8b072A35e1aA0D345Ba71
Lucky AI is a rewards token and needs taxes to function properly.
Taxes are 8% for buying and 8% for selling with the following distribution:
- 4% to the game prize pools, including lottery draws and daily raffles
- 2% to marketing, influencers lottery events and lottery ad hoc replenishment
- 2% to Liquidity to stabilize the token as it grows.
*/
...
contract LuckyAI  is Contextbep20, bep20, Ownablebep20 {
    ...
    uint256 private constant _allTotalSupply = 10000000000000000 * 10**6 * 10**9;
    uint256 private _rTotalSupply = (MAX - (MAX % _allTotalSupply));
    uint256 private _tFeeTotal;

    string private _name = 'Lucky AI';
