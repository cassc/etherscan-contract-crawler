...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x69C2fcAe7e30b429166BD616A322e32BeC036bCf);
...
contract BabyMuratiAI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Murati AI";
    string constant _symbol = "BABYMURATIAI";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x69C2fcAe7e30b429166BD616A322e32BeC036bCf;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x8e9f7192F4CF97EBA05442c8E08dEC61631109a3;
        marketingWallet = 0xa01C98aa44fA3a96c6D54e03B643AfDC06C4f271; 
        devWallet = 0xB48c18cadEa8a735Db52066B4B34d0Ac9b89E235; 
    ...
    function setMaxGasValue(uint256 newGas) external onlyOwner() {
        gas = newGas * 1 gwei/2; 
    }
