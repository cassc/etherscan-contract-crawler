...
APE GPT 111 111 will be launched silently Low Tax, Owner Abandoned and Liquidity Long Locking Time is 1 month, we will provide the best to all $APEGPT Holders.

APEGPT $APEGPT
► Initial Supply : 111,111 
► Trade Tax : 5% Buy & 5% Sell

The intelligence of Ape GPT is limited 111,111
🗣
Telegram : 
https://t.me/Ape_GPT
*/
...
contract ApeGPT is Context, IERC20, Ownable {
    ...
    string private _name = "Ape GPT";
    string private _symbol = "ApeGPT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd7aE3a895304e95eEFB9b037AE0740CE0EA742b9);
    address payable public liqWalletAddress = payable(0xd7aE3a895304e95eEFB9b037AE0740CE0EA742b9);
    ...
    uint256 private _totalSupply =  111111 * 10**_decimals;
