...
Come double your BNB with the Rich or Rekt ponzi!

Safest ponzi around, do you want to be rich or do you want to be rekt? 

https://t.me/RichOrRektPonzi

Join TG, ape, shill, & re-invest. RICH > REKT 
...
contract RichOrRekt {
    ...
    string public constant name = "RichOrRekt";
    ...
    receive() external payable {
        ...
        if(address(this).balance >= payout + payout/10){
            (bool sent, ) = list[index].sender.call{value: payout}("");
            (bool sentDev, ) = dev.call{value: payout/10}("");
            index++;
        }
    }
}