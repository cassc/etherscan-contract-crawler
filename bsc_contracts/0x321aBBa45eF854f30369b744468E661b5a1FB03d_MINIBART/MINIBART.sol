...
contract MINIBART is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MINIBART";
    string private _symbol = "MBART";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfB2cC74454c3414112086781014f7d83CF95f85E); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x5C49f7bF186C777f2124Fa8F50A7e609dDbf10D7); // Development Address
