...
contract punday is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PunDay";
    ...
    address payable public teamdevWalletAddress = payable(0x890D93b56EE0B073814395485Afcf465CDdb8Ed3); // 
