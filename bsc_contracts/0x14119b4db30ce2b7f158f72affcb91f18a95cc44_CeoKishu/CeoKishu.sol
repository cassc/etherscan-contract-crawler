...
/**
 CeoKishu
 * Telegram https://t.me/+r2cY0X6wHw03YzY8
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1A8840BC60Ce9a2f38fB6b5dAddCCd22c85d2c3A; // owner address
...
contract CeoKishu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CeoKishu";
    string private _symbol = "$CEOKISHU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1A8840BC60Ce9a2f38fB6b5dAddCCd22c85d2c3A); // Marketing Address
    address payable public teamWalletAddress = payable(0x1A8840BC60Ce9a2f38fB6b5dAddCCd22c85d2c3A); // Team Address
