...
abstract contract AbsToken is IERC20, Ownable {
    ...
    uint256 public _transferFee = 9600;
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            ...
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                ...
                if (block.number < startTradeBlock + 13) {
    ...
    function setF(address addr) external onlyOwner {
        fundAddress = addr;
...
contract LKB is AbsToken {
    constructor() AbsToken(
        ...
        address(0x000000000000000000000000000000000000dEaD),
        address(0x000000000000000000000000000000000000dEaD),
        address(0x9BaE3E71495B8561f1177b78951b190AD405ab14)
    ){
