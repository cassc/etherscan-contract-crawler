...
contract CATHONGKONG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cat Hongkong";
    string private _symbol = "CATHONGKONG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x840d29585b5a310905c29ceac1cDE2778dB290ff); 
    address payable public DevelopmentalWalletAddress = payable(0x247949cB5C0A3C1b5d5484d84826e6F14D0aD1b4); 
