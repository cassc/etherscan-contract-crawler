...
// 1000x 
// Join $PEPE Community here: https://t.me/pepemoon_1000x
...
contract PepeMoon is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xfE3037B4fCDF1789b569C1247c94B63ae9246F9B); 
    address payable public Wallet_Dev = payable(0x52Ed47DbdF9e6552fE0FbA889d506824CA1ef2ea);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =10000000000 * 10**6* 10**6 * 10**_decimals;
    ...
    constructor () {
        _owner =0x52Ed47DbdF9e6552fE0FbA889d506824CA1ef2ea;
