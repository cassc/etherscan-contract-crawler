...
contract Chart is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x98F6e5D42e74C57a4e84a50BfEA3452a1C1BF48b); // Marketing Address
        
    address payable public teamAddress =
        payable(0x98F6e5D42e74C57a4e84a50BfEA3452a1C1BF48b); // Team Address
        
    address payable public liquidityAddress =
        payable(0x98F6e5D42e74C57a4e84a50BfEA3452a1C1BF48b); // Liquidity Address
    ...
    string private constant _name = "Chart?";

    string private constant _symbol = "Chart?";
