...
=== 'BillionsBNB' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2021 onwards BillionsBNB
-------------------------------------------------------------------
*/ 
...
contract BillionsBNB is owned {
    
    using SafeMath for uint256;

    string constant private _name = "BillionsBNB";
    string constant private _symbol = "BILB";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 100000000000 * (10**_decimals);
