...
contract PEPWEET is Context, IERC20 {
    string private _name = "PEPWEET";
    string private _symbol = "PEPWEET";
    ...
    address payable public MarketingWallet = payable(0x0992848bfAd65c1F940483fd121a93941D5783BC);
