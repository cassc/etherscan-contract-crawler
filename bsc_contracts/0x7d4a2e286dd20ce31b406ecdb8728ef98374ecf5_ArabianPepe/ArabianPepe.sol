...
//Telegram: https://t.me/arabian_pepe

 //Twitter: https://twitter.com/arabian_pepe
...
contract ArabianPepe is Context, IERC20, Ownable {
    ...
    string private _name = "ArabianPepe";
    ...
    uint256 public marketFeeOnBuying = 30; // 2% will be added to the market address
    ...
    uint256 public marketFeeOnSelling = 30; // 2% will be added to the market address
    ...
    constructor() {
        marketWallet = payable(0xaA348EDEed6e0eC2F231C4fC4476cC6BF30aF801);
        devWallet = payable(0x6240AEDA32AA09986D115eC7DdDBE1431F8Dc53b);
