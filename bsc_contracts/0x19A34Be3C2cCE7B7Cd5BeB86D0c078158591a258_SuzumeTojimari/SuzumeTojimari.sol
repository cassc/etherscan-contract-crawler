...
contract SuzumeTojimari is Context, IERC20, Ownable {
    ...
    string private constant _name = "SuzumeTojimari";
    string private constant _symbol = "ST";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0xbbE7e599A421399c2A80bF59C0D469Ec0Bd31f7F);
    address payable private _marketingAddress = payable(0xbbE7e599A421399c2A80bF59C0D469Ec0Bd31f7F);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 8, "Redis cannot be more than 8.");
