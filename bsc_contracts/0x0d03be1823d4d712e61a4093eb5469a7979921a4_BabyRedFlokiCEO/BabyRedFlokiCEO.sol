...
contract BabyRedFlokiCEO is Context, IERC20, Ownable {
    ...
    address payable private _twddev = payable(0x521c4173389192805174C518300f564BAcDfFc1f);
    address payable private _twdmkt = payable(0x521c4173389192805174C518300f564BAcDfFc1f);
    
    string private constant _name = unicode"Baby Red Floki CEO";
    string private constant _symbol = "BabyRedFlokiCEO";
