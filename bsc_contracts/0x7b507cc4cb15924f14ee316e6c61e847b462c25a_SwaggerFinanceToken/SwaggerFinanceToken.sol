...
contract SwaggerFinanceToken is Context, SwaggerFinanceECO, Ownable {
    ...
    string private _name = 'Swagger Finance';
    string private _symbol = 'Swagger Finance';
