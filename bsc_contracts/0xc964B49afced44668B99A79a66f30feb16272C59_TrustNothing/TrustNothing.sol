...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xAB3dA40414F343Fc1Da5eAd709cf5e12f007Ce14; // owner address
...
contract TrustNothing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trust Nothing";
    string private _symbol = "$Nothing";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xAB3dA40414F343Fc1Da5eAd709cf5e12f007Ce14); // Marketing Address
    address payable private teamWalletAddress = payable(0xAB3dA40414F343Fc1Da5eAd709cf5e12f007Ce14); // Team Address
