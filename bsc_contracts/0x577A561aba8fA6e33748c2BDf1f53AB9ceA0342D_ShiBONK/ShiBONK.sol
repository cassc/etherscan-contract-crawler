...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x41E80F3c9F6C847D682782BA206448B514151cE3; // owner address
...
contract ShiBONK is Context, IERC20, Ownable {
    ...
    string private _symbol = "ShiBONK!";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x41E80F3c9F6C847D682782BA206448B514151cE3); // Marketing Address
    address payable public teamWalletAddress = payable(0x41E80F3c9F6C847D682782BA206448B514151cE3); // Team Address
