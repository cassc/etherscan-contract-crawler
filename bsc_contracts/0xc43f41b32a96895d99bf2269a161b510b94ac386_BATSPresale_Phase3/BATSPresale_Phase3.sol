...
contract BATSPresale_Phase3 is ReentrancyGuard, Ownable, Pausable {
    ...
    constructor() {
        ...
        baseDecimals = (10 ** 18);
        salePrice = 55 * (10 ** 15); //0.055 USD
        hardcapSize = 101_000_000;
        hardcapsizeUSD = 500;
        ibatDiscount = 10;
        totalIBATUSDHardcap = 200;
        totalTokensForPresale = 101_000_000;
        totalUsdValueForPresale = 500;
        minimumBuyAmount = 20;
        totalIBATUSDvalueSold=0;
        inSale = totalTokensForPresale;
        inSaleUSDvalue = 500000000000000000000;
    ...
    function settotalIBATUSDHardcap(uint _value) external onlyOwner {
        totalIBATUSDHardcap = _value;
    }
