...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF8BDAf1BE28cB5bE30D3C68DC349aEeCeefC0059; // owner address
...
contract DARTHPEPE is Context, IERC20, Ownable {
    ...
    string private _name = " Darth Pepe ";
    string private _symbol = "DARTHPEPE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF8BDAf1BE28cB5bE30D3C68DC349aEeCeefC0059); // Marketing Address
    address payable public teamWalletAddress = payable(0xF8BDAf1BE28cB5bE30D3C68DC349aEeCeefC0059); // Team Address
