...
//
//
//   📱Telegram::https://t.me/+xcG-kIBoeflmMTA1
//   📱Website ::https://www.redbubble.com/i/postcard/Cheems-Egg-by-CapyBoii/56194743.V7PMD/
/*
...
contract CheemsEGG is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CheemsEGG", "CheemsEGG") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CheemsEGG";
    string private _symbol = "CheemsEGG";
