...
contract Again2023 is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xBf7b7ADDE22ab0C12Ccff5F984943DDdfB58a7B3;
    address public devWallet = 0x3E56d188019dE32fe03e945765c7D94F85AAbc7C;

    string private constant _name = "Again 2023";
    string private constant _symbol = "AG2023";
    ...
    Taxes public taxes = Taxes(3, 5, 3, 1);
    Taxes public sellTaxes = Taxes(3, 5, 3, 1);
