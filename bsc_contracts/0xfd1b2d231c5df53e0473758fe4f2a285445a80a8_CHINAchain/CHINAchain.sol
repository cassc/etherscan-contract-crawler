...
/**
    CHINAchain 是成本最低、速度最快、更复杂的去中心化区块链

    CHINAchain 采用最佳可用的区块链技术精心打造，使其高效、可扩展和可访问。
*/
...
contract CHINAchain is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1294d15d697Bc233a6dCc858be5a560D8E7943Df);
    address payable public teamWalletAddress = payable(0x901249aA795207E4259896f3CADb2AF826Ef8402);
    ...
    string private _name = "CHINAchain";
    string private _symbol = "CHINAchain";
