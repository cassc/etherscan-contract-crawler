...
//https://t.me/OldBinanceBSC
//https://twitter.com/OldBinance
...
contract OLDBNB is Context, IERC20, Ownable {
    ...
    constructor ()
    {
        ...
        marketWallet = payable(0x1ce7123a69311BAA7DC6663557C8DC14CE3C9a9e);
        teamWallet= payable(0x006AD90a8527B1f462D706033e98f8E57d01D605);
        ...
        _maxWalletSize = 40000000 * 10**_decimals;
    ...
    function MaxExempt(address holder, bool exempt) external onlyOwner {
    ...
    function MaxTxn(uint256 newMaxOnceEat) external onlyOwner() {
    ...
    function MaxWallet(uint256 newMaxTotalEat) external onlyOwner {
    ...
    function NewMarketingWallet(address newAddress) external onlyOwner() {
