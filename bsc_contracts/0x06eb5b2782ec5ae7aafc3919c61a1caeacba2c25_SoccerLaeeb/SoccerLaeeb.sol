...
contract SoccerLaeeb is Context, IERC20, Ownable {
    ...
    string private constant _name = "Soccer Laeeb"; // 
    string private constant _symbol = "$SocLB"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 3;
    address private  _marketingWallet = 0x342000358673eaCA54a228498F2093c9754E49CD;
