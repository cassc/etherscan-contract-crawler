...
contract TEST is ERC20, Ownable, Pausable {
    ...
    function setTaxWallets(address marketing, address community) external onlyOwner {
        require(marketing != address(0) && community != address(0), "TEST: Invalid address");
        require(marketing != marketingWallet && community != communityWallet, "TEST: Value already set to that option");
