...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x11d7f16f8cA6326CC1A7347B39635009b0117954; // owner address
...
contract FlokiCEOAIOFFICIAL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FlokiCEO AI";
    string private _symbol = "FCA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0x0058a706A3f3fFCd77A30324BB3Ab4ba1393DEE4); // Marketing Address
    address payable private teamWalletAddress = payable(0x11d7f16f8cA6326CC1A7347B39635009b0117954); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 24;  // original 12
