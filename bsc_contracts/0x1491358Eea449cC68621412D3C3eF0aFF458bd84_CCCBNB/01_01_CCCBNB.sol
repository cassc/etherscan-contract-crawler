...
contract CCCBNB is Ownable{
    ...
    IERC20 public CCCBNBLP = IERC20(0x0eD7e52944161450477ee417DE9Cd3a859b14fD0); //CAKEBNB-LP
    ...
    function Claim() public updateReward(msg.sender) checkStart{
        ...
        if (reward > 0) {
            ...
            CCCToken.safeTransfer(msg.sender, reward);
    ...
    function set_admin_address(address _admin, address _rewardaddress)public onlyOwner{
