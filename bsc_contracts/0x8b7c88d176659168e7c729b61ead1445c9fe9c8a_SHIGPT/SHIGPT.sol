...
contract SHIGPT is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "SHIGPT";
    string private constant _symbol = "SHIGPT";
    ...
    address payable private _developmentAddress = payable(0xbE19409a507453A79387833589FAd30d0925bB11); 
    address payable private _marketingAddress = payable(0xbE19409a507453A79387833589FAd30d0925bB11);
    ...
    uint256 public _maxTxAmount = 16666666666666 * 10**9; 
    uint256 public _maxWalletSize = 16666666666666 * 10**9; 
