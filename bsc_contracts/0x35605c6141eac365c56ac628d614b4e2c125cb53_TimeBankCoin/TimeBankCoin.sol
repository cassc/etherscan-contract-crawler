...
contract TimeBankCoin is IERC20, Ownable {
    ...
    address private fundAddress = address(0xbbAd97f43249C7d8E03bdb23d58F371b7b00Ce2e);
    ...
    function _transfer(
        ...
        bool takeFee = true;
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to] || destroyAmount >= _tTotal){
            takeFee = false;
