...
contract IACOIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IACOIN";
    string private _symbol = "AI";
    uint8 private _decimals = 4;

    address payable public marketingWalletAddress = payable(0x3dE4c343e931303e1403719b3aAF2DFe37B93F00);
    address payable public DevFee = payable(0x3dE4c343e931303e1403719b3aAF2DFe37B93F00);
    ...
    uint256 private _devShare = 0;

    uint256 private _totalTaxIfBuying = 0;
    uint256 private _totalTaxIfSelling = 0;
    uint256 private _totalDistributionShares = 0;

    uint256 public _totalSupply = 1 * 10**8 * 10**4;
    uint256 public _maxTxAmount = 1 * 10**8 * 10**4;
    uint256 public _walletMax = 1 * 10**8 * 10**4;
