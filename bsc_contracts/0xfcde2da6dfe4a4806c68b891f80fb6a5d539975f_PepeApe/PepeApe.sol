...
/**
https://t.me/pepeapebsc

https://pepeape.vip/

https://twitter.com/pepeapebsc
*/
...
contract PepeApe is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x9Cf85586c4ac0F51E6781A020cA28e4bcA7F09d3); // Marketing Address
        
    address payable public teamAddress =
        payable(0xf632c12b0C4958Cdf8C59A4Ad39E74BBfA9fDA55); // Team Address
        
    address payable public liquidityAddress =
        payable(0x9Cf85586c4ac0F51E6781A020cA28e4bcA7F09d3); // Liquidity Address
    ...
    uint256 private constant _tTotal = 420 * 1e12 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "PEPE APE";
