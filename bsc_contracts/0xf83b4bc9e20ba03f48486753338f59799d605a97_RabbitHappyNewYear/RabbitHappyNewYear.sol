...
/* 
🐰  RABBIT HAPPY NEW YEAR  TRENDING BSC TODAY 🐰
...
💬TeIegram : https://t.me/RabbitHappyNewYear
...
abstract contract ContextBinanceNewYear {
...
contract OwnableBinanceNewYear is ContextBinanceNewYear {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableBinanceNewYear: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableBinanceNewYear: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract RabbitHappyNewYear is ContextBinanceNewYear, BinanceNewYear, OwnableBinanceNewYear {
    ...
    string private _name = 'Rabbit Happy New Year';
    string private _symbol = 'HNYRABBIT';
