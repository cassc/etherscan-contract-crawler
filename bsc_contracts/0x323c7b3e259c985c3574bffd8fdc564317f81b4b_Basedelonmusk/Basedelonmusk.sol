...
Telegram: https://t.me/basedelonmusk
tax 2/2 
Based on elon new tweet
...
contract Basedelonmusk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x776550271E0854C8D42f2079153C5F886C076e6e); // Marketing Address
        
    address payable public teamAddress =
        payable(0x776550271E0854C8D42f2079153C5F886C076e6e); // Team Address

    address payable public liquidityAddress =
        payable(0x776550271E0854C8D42f2079153C5F886C076e6e); // Liquidity Address
    ...
    string private constant _name = "Based ElonMusk";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0x776550271E0854C8D42f2079153C5F886C076e6e).call{value: bnbForDev}("");
