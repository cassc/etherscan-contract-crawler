...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF50924087BB84CAA88d1dE700dAD681EDE404d8E;
...
contract NEKOPEPE  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xB11324949550544E6B325dc7Db960124d091E955;

   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 1**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "NEKOPEPE";
    string private _symbol = "NEKOPEPE";
