...
contract DOGEZILLA is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOGEZILLA";
    string private constant _symbol = "DOGEZILLA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x189246E13da42ba58a729DFe4fd9D6c65dbcd4cC);
    address payable private _marketingAddress = payable(0x189246E13da42ba58a729DFe4fd9D6c65dbcd4cC);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 6, "Redis cannot be more than 6.");
	    require(redisFeeOnSell < 60, "Redis cannot be more than 60.");
	    require(taxFeeOnBuy < 6, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 60, "Tax cannot be more than 60.");
