...
contract MortyInuBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Morty Inu";
    string private _symbol = "$MORTY";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xfa8b5C638E9FCc56E80ECeB58D51181d7c550859); // Marketing Address
