...
contract OldschoolPepe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    OldschoolPepeDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Oldschool Pepe", "$OSP") {
        marketingWallet = payable(0x6A5e8870EEc8dB797b93BD8DF63d3fc6f09aAFF7);
        devWallet = payable(0xC5954AE5Bb3764ea8226b4e128345625C4D4FAB6);
        address router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

        buyDeadFees = 0;
        sellDeadFees = 0;
        buyMarketingFees = 17;
        sellMarketingFees = 26;
        buyLiquidityFee = 2;
        sellLiquidityFee = 2;
        buyRewardsFee = 0;
        sellRewardsFee = 0;
        ...
        dividendTracker = new OldschoolPepeDividendTracker(
            payable(this),
            router,
            0x893535ED1b5C6969E62a10bABfED4F5fF8373278,
            "Oldschool PepeTRACKER",
            "$OSPTRACKER"
        );
...
contract OldschoolPepeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    OldschoolPepe public OldschoolPepeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        OldschoolPepeContract = OldschoolPepe(mainContract);
    ...
    function _transfer(
        ...
        require(false, "OldschoolPepe_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Oldschool Pepe_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Oldschool Pepe contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(OldschoolPepeContract);

            uint256 prevBalance = OldschoolPepeContract.balanceOf(address(this));
            ...
            {
                uint256 received = OldschoolPepeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    OldschoolPepeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
