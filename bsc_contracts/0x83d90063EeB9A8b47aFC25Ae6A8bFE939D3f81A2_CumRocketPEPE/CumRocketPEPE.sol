...
contract CumRocketPEPE is Context, IERC20, Ownable {
    ...
    string private constant _name = 'CumRocketPEPE';
    string private constant _symbol = 'PEPPIES';
