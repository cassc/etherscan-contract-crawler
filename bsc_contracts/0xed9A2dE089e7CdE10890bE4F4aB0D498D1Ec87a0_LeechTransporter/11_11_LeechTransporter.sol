...
contract LeechTransporter is Ownable, ILeechTransporter {
    ...
    */
    ILeechSwapper public leechSwapper = ILeechSwapper(address(0));
    ...
    function sendTo(
        ...
        if (address(leechSwapper) == address(0)) revert("Init swapper");
        ...
        if (path[0] != path[1]) {
            uint256[] memory swapedAmounts = leechSwapper.swap(amount, path);
    ...
    function initTransporter(
        ...
        leechSwapper = ILeechSwapper(_leechSwapper);
