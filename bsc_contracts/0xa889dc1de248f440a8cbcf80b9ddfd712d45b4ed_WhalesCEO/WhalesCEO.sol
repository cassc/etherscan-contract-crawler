...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9B5B120955c55806A851254dF0e7DB08Ad3E964F; 
...
contract WhalesCEO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WhalesCEO";
    string private _symbol = "WCEO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9B5B120955c55806A851254dF0e7DB08Ad3E964F); // 
    address payable public teamWalletAddress = payable(0x9B5B120955c55806A851254dF0e7DB08Ad3E964F); // 
