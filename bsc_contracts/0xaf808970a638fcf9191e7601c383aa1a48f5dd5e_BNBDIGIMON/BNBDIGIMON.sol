...
contract BNBDIGIMON is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "BNB DIGIMON";
    string constant _symbol = "BDRB";
    ...
    uint256 _totalSupply = 100000000000 * 10**6 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        // NAIS!
        autoLiquidityReceiver = 0xf26D594289ee3b46541cfba3c76cB7a2465199cB; // liquidity
