...
https://t.me/SatoshiNekoBSC TG

10% $BTC REWARDS, 21 Million $SNEKO
...
contract SatoshiNeko is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Satoshi Neko";
    string constant _symbol = "SNEKO";
