...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Happy Miyabi New Year"; //
    string private constant _symbol = "Happy Miyabi NY"; //
    uint8 private constant _decimals = 9; //

    uint256 public _marketingFee = 2;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x859B2553B7D47b89c1Ef053426a1eFE67A143da2;
