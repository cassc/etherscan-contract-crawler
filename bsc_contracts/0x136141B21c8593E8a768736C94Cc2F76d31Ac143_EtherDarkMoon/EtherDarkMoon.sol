...
contract  EtherDarkMoon  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ether DarkMoon"; // 
    string private constant _symbol = unicode"EDM"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 3;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x4501E79C4A2a3Af24B2d669039fbf70Cfbdc28fc;
