...
contract ShrekaiContract is Context, Ownable, IERC20 {
    ...
    uint256 internal _totalSupply = 5000000000000000000000000000;
    string internal _name = "ShrekAI";
    string internal _symbol = "ShrekAI";
