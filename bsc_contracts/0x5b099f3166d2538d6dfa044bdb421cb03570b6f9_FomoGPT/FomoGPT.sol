...
contract FomoGPT is Context, IERC20, Ownable {

using SafeMath for uint256;
using Address for address;

string private _name = "FomoGPT";
string private _symbol = "FGPT";
uint8 private _decimals = 9;

address payable private MarketingWallet = payable(0x2851b2D10449637d0cd350bB39739dBa74589322); // Marketing Address
address payable private TeamWallet = payable(0x2851b2D10449637d0cd350bB39739dBa74589322); // Buy Back Address
