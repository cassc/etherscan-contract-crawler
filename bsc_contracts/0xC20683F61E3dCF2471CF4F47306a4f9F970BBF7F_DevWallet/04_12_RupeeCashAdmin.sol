...
contract RupeeCashAdmin is OwnableUpgradeable {
    ...
    function auto_settlement_transfer(address to, uint amount, uint settlement_id, string memory private_tx_hash) external onlyGatekeeper {
        ...
        emit Auto_Settlement_Transfer(to, settlement_id, private_tx_hash, amount, auto_exchange[to]);
    }
