...
contract CustomTreasury is Initializable, PendingOwnableUpgradeable {
    ...
    /**
        ...
        @param _billContract address
     */
    function toggleBillContract(address _billContract) external onlyOwner {
        ...
        billContract[_billContract] = !isBillActive;
        emit BillContractToggled(_billContract, !isBillActive);
    }
}