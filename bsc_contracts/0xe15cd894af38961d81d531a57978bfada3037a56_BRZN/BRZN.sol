...
// Telegram : https://t.me/BrazzersNetworkBSC
// 
...
contract BRZN is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Brazzers Network";
    string private _symbol = "BRZN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4638E084173c311f50db8ce30AcA452Fbc9dCc11); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x4638E084173c311f50db8ce30AcA452Fbc9dCc11); // BuyBack Address
