...
contract TigerNetworX is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tiger NetworX"; // 
    string private constant _symbol = " $TIGERNETWORX"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 2;
    address private  _marketingWallet = 0x80C21D78BC3a3AcFB3Dc8a5b64470aE77d431935;
