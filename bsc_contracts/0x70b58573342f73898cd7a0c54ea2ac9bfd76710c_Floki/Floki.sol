...
//SPDX-License-Identifier: MIT
  ...
  FLOKI  is the people's cryptocurrency and the utility token of the Floki Ecosystem. 
   It is a cryptocurrency birthed by fans and members of the Shiba Inu (SHIB) community and is inspired by (and named after) Elon Musk’s Shiba Inu.
   Surge Protocol:https://surgeprotocol.io
   Website: Floki.com
   Valhalla: Valhalla.Game
   Linktree: https://linktr.ee/Floki_Inu
   https://t.me/Floki_Surge
...
contract Floki is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Floki Surge";
    ...
    // Total Supply
    uint256 public constant _totalSupply = 100**8 * _DECMULTIPLIER ;
    ...
    //Tax wallets
    address public teamWallet = 0x2b83ADF7bA5D01C40fcA9d097B6c9f6e729f4bAB;
    address public treasuryWallet = 0x2b83ADF7bA5D01C40fcA9d097B6c9f6e729f4bAB;
