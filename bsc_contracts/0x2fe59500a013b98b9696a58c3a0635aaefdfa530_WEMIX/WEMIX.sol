...
contract WEMIX is ERC20, Ownable {
    using SafeMath for uint256;
	...
	address public _devAddress2 = 0x45a5A1C912b860108A21D6AeC56b492655B59040;
   ...
   mapping(address => bool) public _isBlacklisted;
    ...
    constructor() payable ERC20("WEMIX Token", "WEMIX") {
        uint256 totalSupply = 100000 * (10**18);
        swapTokensAtAmount = 30 * 10**18;
   ...
   function setDeadFee(uint256 val) public onlyOwner {
    ...
    function updateDistributorGas(uint256 newValue) public onlyOwner {
        require(newValue >= 100000 && newValue <= 400000, "distributorGas must be between 160,000 and 500,000");
