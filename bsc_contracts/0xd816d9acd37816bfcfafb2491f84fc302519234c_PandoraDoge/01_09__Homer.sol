...
contract PandoraDoge is BaseErc20, AntiSniper, Burnable, Taxable, Dividends {
    using SafeMath for uint256;

    constructor () {
        configure(0xC831a54EfE0aDE8901Eac6868E996E6DDCA096d2);
        ...
        taxDistributor.createWalletTax("Marketing", 500, 500, 0xCecb17d4c2aeA0714B5207E1a96cA3ff7F76254e, true);
        taxDistributor.createWalletTax("Development", 200, 200, 0xCecb17d4c2aeA0714B5207E1a96cA3ff7F76254e, true);
        ...
        _totalSupply = _totalSupply.add(10_000_000_000 * 10 ** decimals);
...
contract DividendDistributor is IDividendDistributor {
    ...
    function distributeTokenDividend(address shareholder) private returns (uint256){
        ...
        if (tokenAmount > 0) {
            ...
            tokenContract.transfer(shareholder, tokenAmount);
