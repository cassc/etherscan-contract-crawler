...
/*
SparxToken ($PX) is the Native currency Token for the Sparx Ecosystem (Lottery & Sport Betting, E-Commerc & More Utilities). You Also Earn 1% USDT Reward Reflection for Holding $PX.

https://t.me/SparxToken
*/
...
contract SparxToken is IERC20 {
    ...
    uint256 constant private startingSupply = 100000000000000;
    string constant private _name = "SPARX TOKEN";
    string constant private _symbol = "$PX";
    ...
    address payable public marketingWallet = payable(0x37F8CD3CDdF2fEdbCE1411d6FC0472d9031a797b);
