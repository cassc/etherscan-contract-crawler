...
contract DecentraBrowseOne is ERC20, Ownable {
    ...
    constructor() ERC20("Decentra Browse One", "$DBO") {
        ...
        maxTransactionAmount = 2 * 1e14 * 1e18; 
        maxWallet = 4 * 1e14 * 1e18; 
        ...
        devWallet = address(0x6B023D14d9d7cBab790bF4Cae694fDAa570fE07d); 
