...
/**
 *Submitted for verification at Bscscan.io on
*/


/**

//  telegram : https://t.me/CruxNetworkBSC
//  website : 
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x335891af54CB2057E0C03e17D84Ebf95235Ed171; // Crux Network
...
contract CruxNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crux Network";
    string private _symbol = "CRUX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x335891af54CB2057E0C03e17D84Ebf95235Ed171); // Crux Network
    address payable public earnWalletAddress = payable(0x335891af54CB2057E0C03e17D84Ebf95235Ed171); // Crux Network
    ...
    uint256 public _buyEarnFee = 0;
    
    uint256 public _sellLiquidityFee = 15;
    uint256 public _sellMarketingFee = 20;
    uint256 public _sellEarnFee = 0;

    uint256 public _liquidityShare = 22; 
    uint256 public _marketingShare = 38;
    uint256 public _earnShare = 0; 
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBEarn = amountReceived.mul(_earnShare).div(totalBNBFee);
        uint256 amountBNBMarketing = amountReceived.sub(amountBNBLiquidity).sub(amountBNBEarn);

        if(amountBNBMarketing > 0)
            transferToAddressETH(marketingWalletAddress, amountBNBMarketing);

        if(amountBNBEarn > 0)
            transferToAddressETH(earnWalletAddress, amountBNBEarn);
