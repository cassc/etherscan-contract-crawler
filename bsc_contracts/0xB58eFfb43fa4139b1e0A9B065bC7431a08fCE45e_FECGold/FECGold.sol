...
contract FECGold is ERC20 {
    ...
    address public marketAddress = 0x7aA208fD65e0a908A484232fFC91513A4EC15543;
    ...
    string internal tokenName = "FEC-Gold";
    string internal tokenSymbol = "FEC-Gold";
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if(to == uniswapV2Pair || from == uniswapV2Pair ){
                ...
                uint256 allFee = amount.div(1000).mul(lpFee + marketFee);
                ...
                amount = amount.div(1000).mul(1000 - (lpFee + marketFee));
