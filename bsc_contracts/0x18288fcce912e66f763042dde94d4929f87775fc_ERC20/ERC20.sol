...
//The best known as one of the main characters in the 16th-century Chinese novel Journey to the West 
//and many later stories and adaptations. In said novel, Sun Wukong is a monkey born from a stone 
//who acquires supernatural powers through Taoist practices.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_, uint8 decimals_, uint256 taxFee_) {
        ...
        _totalSupply = 19000000000000 * (10 ** uint256(decimals_));
