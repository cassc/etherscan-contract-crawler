...
contract NPCInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc71aD15C748d95D648f16E3B149C6CDC397d3233); 
    address payable public Wallet_Dev = payable(0x76A0Fae467a38cCb30B6Bc6f255ec8F67603053d);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1* 10**6 * 10**_decimals;
    string private constant _name = "NPC Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x76A0Fae467a38cCb30B6Bc6f255ec8F67603053d;
