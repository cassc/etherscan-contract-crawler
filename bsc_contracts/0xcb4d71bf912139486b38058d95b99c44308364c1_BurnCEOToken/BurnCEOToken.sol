...
// File: contracts/BurnCEOToken.sol
...
((_)_  /((_)(()\   )\ ) )\___ ((_)  ((_)  
 ...
 |___/ \_,_||_|  |_||_|  \___||___|\___/  
  ...
  This contract has been developed by the BurnCEO
  blockchain development team.

  All variables are baked into the code, cannot
  ever be changed. This allows maximum peace of
  mind for new investors.
...
// Main Contract
contract BurnCEOToken is IERC20Metadata, Ownable {
    ...
    // General
    string private _name = 'BurnCEO Token';
    string private _symbol = '$BCEO';
    ...
    address payable public taxWallet = payable(0x936FF9804c8BD23b86279Cdf9563f314823c55e5);
    address payable public stakingWallet = payable(0x4390121Bc0E2A539D59B9cf514A68e6F795F7d42);
    ...
    uint256 public burnTaxB  = 1;
    uint256 public burnTaxT  = 1;
    uint256 public taxTaxS  = 4;
    uint256 public taxTaxB  = 4;
    uint256 public taxTaxT  = 4;
    ...
    constructor() {
        ...
        _isTaxExempt[stakingWallet] = true;
        ...
        maxWalletExempt[stakingWallet] = true;
    }
