...
contract SLP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SM LP";
    string private _symbol = unicode"SLP";

    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0xA196A17c018f044658A7e83C90Dc448689Da282D); 
    address payable public BurnedWalletAddress = payable(0xA196A17c018f044658A7e83C90Dc448689Da282D); 
