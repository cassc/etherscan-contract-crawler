...
contract nauth is IBEP20, Auth {
    ...
    string constant _name = "Naughtius Maximus";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xb7983089bD440DE656eFd8BE822Ca38Eed687fcd;
        marketingFeeReceiver = 0xfA566708fbae24F4AC7f3f06a6eE21Bcf2EA9e52;
