...
contract sss is Context, IERC20, Ownable {
    ...
    string private _symbol = unicode"sss";


    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x4F85BA8b3dd3E14Da565a6C3B3120Ca57bb1e8b4); 
    address payable public BurnedWalletAddress = payable(0x4F85BA8b3dd3E14Da565a6C3B3120Ca57bb1e8b4); 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            uint256 finalAmount = (isExcludedFromFee[sender] || isExcludedFromFee[recipient]) ? 
                                         takeFee(sender, recipient, amount) : takeFee(sender, recipient, amount);
