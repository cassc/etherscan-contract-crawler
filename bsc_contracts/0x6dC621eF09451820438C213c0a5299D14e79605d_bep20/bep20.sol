...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa54D6B8353122Cbcea256b25aC6Fa3F5c6567b4d; // owner address
...
contract bep20 is Context, IERC20, Ownable {
    ...
    string private _name = "Baby Aidoge";
    string private _symbol = "babyaidoge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa54D6B8353122Cbcea256b25aC6Fa3F5c6567b4d); // Marketing Address
    address payable public teamWalletAddress = payable(0xa54D6B8353122Cbcea256b25aC6Fa3F5c6567b4d); // Team Address
