...
contract KolStrategyThenaUsdPlus is Initializable, UUPSUpgradeable, FeeManager {
    ...
    function initialize() public initializer {
        ...
        address ETS = 0x5B852898CD47d2Be1d77D30377b3642290f5Ec75; // ETS
        address USDPLUS = 0xe80772Eaf6e2E18B651F160Bc9158b2A5caFCA65; // USDPLUS

        address _want = 0x92573046BD4abA37d875eb45a0A1182ac63d5580; //USDPLUS-ETS LP
        address _gauge = 0x8871105347CA6b8e35fB689EEA11AA0AAA3651E4;//USDPLUS-ETS Thena Gauge
        ...
        if (USDPLUS == chainNative) {
            ...
            _outputToLp1Route = new ISolidlyRouter.route[](3);
            ...
            _outputToLp1Route[1].to = HAY;
            _outputToLp1Route[1].stable = true;

            _outputToLp1Route[2].from = HAY;
    ...
    function testAddLiquidity() external onlyManager {
        addLiquidity();
    }

    function getLiquidity() external view returns(uint256 lp0Amt, uint256 lp1Amt ) {
        uint256 outputBal = IERC20Upgradeable(output).balanceOf(address(this));
        lp0Amt = outputBal / 2;
