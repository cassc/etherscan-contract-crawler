...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xBca511F1be1F0DEA439cBFe5A9706AA5ea4c2784;
...
contract flokiqueen is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKI QUEEN";
    string private _symbol = "FKQUEEN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb3EC29eE100B067C26BaBBb44f7a54621187e47e);
    address payable public teamWalletAddress = payable(0xBca511F1be1F0DEA439cBFe5A9706AA5ea4c2784);
