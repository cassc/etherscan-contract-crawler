...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x890D93b56EE0B073814395485Afcf465CDdb8Ed3; 
...
contract uytrewe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "uytrewe";
    string private _symbol = unicode"uytrewe";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x890D93b56EE0B073814395485Afcf465CDdb8Ed3); // 
    address payable public teamWalletAddress = payable(0x890D93b56EE0B073814395485Afcf465CDdb8Ed3); // 
