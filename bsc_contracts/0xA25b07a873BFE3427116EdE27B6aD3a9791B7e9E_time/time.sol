...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address private _nftAddress = 0x3cF2e9f807DDecc6F5339fEdE8F0bF33e71C4653;
    ...
    uint256 public _nftDividendFee = 1; 
    ...
    function swapTokenForFund(uint256 tokenAmount) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), _nftAddress, usdtBalance / _txFee * _nftDividendFee);
...
contract time is AbsToken {
    constructor() AbsToken(
        "24h",
        "24h",
        18,
        1 * 10 ** 8,
        address(0x1a06DC558702be38380d3CFf234CD6c430B46A7B)
    ){
