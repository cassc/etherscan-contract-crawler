...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4F6dd6995260d446Be62b032DDa41399Aa7D5A4b; // owner address
...
contract NEWSHIBA2023 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"NEWSHIBA2023";
    string private _symbol = unicode"NSHIB23";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4F6dd6995260d446Be62b032DDa41399Aa7D5A4b); // Marketing Address
    address payable public teamWalletAddress = payable(0x4F6dd6995260d446Be62b032DDa41399Aa7D5A4b); // Team Address
