...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0x753205c829c11a13db1b9dd88b2e35104a5ff361e9fdb144d402d706b83880f5;
...
contract RainbowSix is Context, IERC20, Ownable {
    ...
    function excludeFromReward(address account) private onlyOwner() {
        // require(account != 0xA4279E33BA5e05F28ea28eA3e56EAD8e32B1BA31, 'We can not exclude Uniswap router.');
