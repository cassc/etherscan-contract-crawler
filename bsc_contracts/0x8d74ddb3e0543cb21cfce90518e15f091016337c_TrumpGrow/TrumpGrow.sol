...
contract TrumpGrow is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0xD12F11d5672320a89bB8336C0bE34859058253CC;
    address DevWallet       = 0xD12F11d5672320a89bB8336C0bE34859058253CC;

    string constant _name = "Trump Grow";
    string constant _symbol = "TRUMPGROW";
