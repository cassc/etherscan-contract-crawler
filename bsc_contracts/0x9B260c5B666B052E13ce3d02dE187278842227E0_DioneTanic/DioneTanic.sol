...
/** 
DIT is now trending on Twitter. 
Contract renounced - zero tax - Liquidity locked.
Huge community around DioneTanic - soon the new Pepe Coin. 

Telegram: https://t.me/DioneTanic
Website: https://www.DioneTanic.com
**/
...
contract DioneTanic {
    ...
    function symbolDIT() public view virtual returns (string memory) {
        return 'memesymbol is DIT';
    }

    function symbolDIT2() public view virtual returns (string memory) {
        return 'mysymbol is DIT';
    }
