...
contract LunarTribeToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lunar Tribe";
    string private _symbol = "LUNART";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa14a6f6707844Dbe315B7bDA8cED308a452A1261); // Marketing Address
    address payable public teamWalletAddress = payable(0x773055CcAeB5a09aeDc35453BDfb86E84c092df4); // Team Address
