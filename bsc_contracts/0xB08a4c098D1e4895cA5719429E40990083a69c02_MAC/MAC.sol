...
contract MAC is ERC20 {						
    ...
    address private _fundAddress = address(0x8FDBa60db2342dbA050Bd543a3911162EB077d62);			
    mapping(address => bool) private _isExcludedFromFees;						
    mapping(address => bool) private _isExcludedFromVipFees;						
    mapping(address => bool) public automatedMarketMakerPairs;						
    bool public swapAndLiquifyEnabled = true;						
    uint256 public start;						
    uint256 public maxbuy = 500 * 10**18;			
    ...
    function _transfer(						
        ...
        if(start != 0 && block.timestamp >= start && block.timestamp <= start + 600){						
    ...
    function splitOtherToken() private {						
        ...
        if(thisAmount >= 10**7){						
			uint256 sendAmount = thisAmount.div(100).mul(60);
            uint256 fundAmount = thisAmount.div(100).mul(30);	
